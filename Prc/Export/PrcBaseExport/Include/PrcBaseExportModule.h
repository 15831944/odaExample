...
#ifndef _OD_PRCBASE_EXPORT_MODULE_INCLUDED_
#define _OD_PRCBASE_EXPORT_MODULE_INCLUDED_
...
*/
class OdPrcEXPORT_DLL OdPrcBaseExportModule : public OdRxModule
{
protected:
  /** \details
...
SMARTPTR(OdPrcBaseExportModule);

#endif //_OD_PRCBASE_EXPORT_MODULE_INCLUDED_
