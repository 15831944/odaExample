...
/************************************************************************/
/* PrcPublish3dCmdsModule.cpp: Defines the entry points for the DLL      */
/************************************************************************/
#include "OdaCommon.h"

#include "PrcPublish3dCmdsModule.h"
...
#include "PrcPublish3dCmdDef.h"

#undef CMD_DEF_CLASS
#undef CMD_DEF


ODRX_DEFINE_DYNAMIC_MODULE(OdPrcPublish3dCmdsModule);


void OdPrcPublish3dCmdsModule::initApp()
{
...
void OdPrcPublish3dCmdsModule::uninitApp()
{
  OdEdCommandStackPtr pCommands = odedRegCmds();
#define CMD_DEF(CmdName, GroupName) \
