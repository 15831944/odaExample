...
OdResult PublishTemplate2(OdDbBaseHostAppServices* pHostApp, const OdStreamBufPtr& pStreamPrc, const OdGiRasterImagePtrArray& arrPreviewImg, const OdGeExtents3d& extPrc,
                          const OdString& sOutPdf, const OdStringArray& nodeNames)
{
  ...
  pAnnot->setPartsList(nodeNames, OdRect(642, 832, 30, 530), headers, columns);
...
OdResult PublishTemplate2(OdDbBaseHostAppServices* pHostApp, const OdString& prc_file_name, const OdStringArray& arrPreviewFileNames, const OdGeExtents3d& extPrc,
                          const OdString& sOutPdf , const OdStringArray& nodeNames)
{
  ...
  return PublishTemplate2(pHostApp, pStreamPrc, arrPreviewImages, extPrc, sOutPdf, nodeNames);
}
