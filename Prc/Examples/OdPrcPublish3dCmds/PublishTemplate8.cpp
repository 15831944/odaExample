...
{
  if (pStreamPrc.isNull() || arrPreviewImg.size() != 7 || !extPrc.isValidExtents() || sOutPdf.isEmpty())
  {
  ...
  //Front
  addView(pArtwork, OdGePoint3d(0, -1, 0), OdGePoint3d::kOrigin, OdGeVector3d::kZAxis, L"Front", L"Front", Camera::kPerspective, field_w, field_h, extPrc/*, Rendering::kIllustration, Lighting::kNight*/ );
  //Back
  addView(pArtwork, OdGePoint3d(0, 1, 0), OdGePoint3d::kOrigin, OdGeVector3d::kZAxis, L"Back", L"Back", Camera::kPerspective, field_w, field_h, extPrc);
  //Top
  addView(pArtwork, OdGePoint3d(0, 0, 1), OdGePoint3d::kOrigin, OdGeVector3d::kYAxis, L"Top", L"Top", Camera::kPerspective, field_w, field_h, extPrc);
  //Bottom
  addView(pArtwork, OdGePoint3d(0, 0, -1), OdGePoint3d::kOrigin, -OdGeVector3d::kYAxis, L"Bottom", L"Bottom", Camera::kPerspective, field_w, field_h, extPrc);
  //Right
  addView(pArtwork, OdGePoint3d(1, 0, 0), OdGePoint3d::kOrigin, OdGeVector3d::kZAxis, L"Right", L"Right", Camera::kPerspective, field_w, field_h, extPrc);
  //Left
  addView(pArtwork, OdGePoint3d(-1, 0, 0), OdGePoint3d::kOrigin, OdGeVector3d::kZAxis, L"Left", L"Left", Camera::kPerspective, field_w, field_h, extPrc);
  //Default View
  ...
  addView(pArtwork, defCamPos, OdGePoint3d::kOrigin, defUpVec, L"Default", L"Default", Camera::kPerspective, field_w, field_h, extPrc, Rendering::kDefault, Lighting::kDefault, true);
...
OdResult PublishTemplate8(OdDbBaseHostAppServices* pHostApp, const OdString& prc_file_name, const OdStringArray& arrPreviewFileNames, const OdGeExtents3d& extPrc, const OdString& sOutPdf)
{
  ...
  return PublishTemplate8(pHostApp, pStreamPrc, arrPreviewImages, extPrc, sOutPdf);
}
