...
OdResult PublishTemplate1(OdDbBaseHostAppServices* pHostApp, const OdString& prc_file_name, const OdStringArray& arrPreviewFileNames, const OdGeExtents3d& extPrc, const OdString& sOutPdf)
{
  ...
  return PublishTemplate1(pHostApp, pStreamPrc, arrPreviewImages, extPrc, sOutPdf);
}
