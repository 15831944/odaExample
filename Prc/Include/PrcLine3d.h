...
#ifndef _PRCCRVLINE3d_INCLUDED_
#define _PRCCRVLINE3d_INCLUDED_ 
...
Class implements a three-dimensional line.
...
*/
class PRC_TOOLKIT OdPrcLine3d : public OdPrcCurve3d
{
public:
  //DOM-IGNORE-BEGIN
  ODPRC_DECLARE_MEMBERS_CRV(OdPrcLine3d)
  //DOM-IGNORE-END
...
SMARTPTR(OdPrcLine3d);

#endif // _PRCCRVLINE3d_INCLUDED_
