...
#ifndef _PRCCRVEQUATION3d_INCLUDED_
#define _PRCCRVEQUATION3d_INCLUDED_ 
...
Class implements a three-dimensional curve defined by mathematical functions of one variable on the X, Y and Z axis. 
...
*/
class PRC_TOOLKIT OdPrcEquationCurve3d : public OdPrcCurve3d
{
public:
  //DOM-IGNORE-BEGIN
  ODPRC_DECLARE_MEMBERS_CRV(OdPrcEquationCurve3d)
  //DOM-IGNORE-END

  /** \details
  Destroys the equation curve object.
  */
  ~OdPrcEquationCurve3d();
  ...
  */
  const OdPrcMath1dPtr &functionZ() const;
};
SMARTPTR(OdPrcEquationCurve3d);

#endif // _PRCCRVEQUATION3d_INCLUDED_
