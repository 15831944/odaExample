...
#ifndef _PRCREFERENCE_INCLUDED_
#define _PRCREFERENCE_INCLUDED_
 

#include "PrcUserData.h"
#include "PrcContentEntityReference.h"

SMARTPTR(OdPrcReference);
...
*/
class PRC_TOOLKIT OdPrcReference : public OdPrcContentEntityReference
{
public:
  //DOM-IGNORE-BEGIN
  ODPRC_DECLARE_MEMBERS_PRCBASE(OdPrcReference)
  //DOM-IGNORE-END
