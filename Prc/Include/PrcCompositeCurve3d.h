...
#ifndef _PRCCRVCOMPOSITE3d_INCLUDED_
#define _PRCCRVCOMPOSITE3d_INCLUDED_ 
...
\remarks
Each of the sub curves must also be a three-dimensional and piecewise continuous curve. 
...
*/
class PRC_TOOLKIT OdPrcCompositeCurve3d : public OdPrcCurve3d
{
public:
  //DOM-IGNORE-BEGIN
  ODPRC_DECLARE_MEMBERS_CRV(OdPrcCompositeCurve3d)
  //DOM-IGNORE-END

  /** \details
  Destroys the composite curve.
  */
  ~OdPrcCompositeCurve3d();
...
SMARTPTR(OdPrcCompositeCurve3d);

#endif // _PRCCRVCOMPOSITE3d_INCLUDED_
