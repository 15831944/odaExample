...
#ifndef _PRCCRVHYPERBOLA3d_INCLUDED_
#define _PRCCRVHYPERBOLA3d_INCLUDED_ 
...
Class implements a three-dimensional hyperbola defined on the [-infinite, infinite] interval.
...
*/
class PRC_TOOLKIT OdPrcHyperbola3d : public OdPrcCurve3d
{
public:
  //DOM-IGNORE-BEGIN
  ODPRC_DECLARE_MEMBERS_CRV(OdPrcHyperbola3d)
  //DOM-IGNORE-END
...
SMARTPTR(OdPrcHyperbola3d);

#endif // _PRCCRVHYPERBOLA3d_INCLUDED_
