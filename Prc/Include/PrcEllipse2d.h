...
#ifndef _PRCCRVELLIPSE_2D_INCLUDED_
#define _PRCCRVELLIPSE_2D_INCLUDED_ 
...
Transformation can be one of the following:
  ...
  OdPrcEllipse2d inherits the OdPrcCurve class and can be reparameterized and trimmed using the OdPrcParameterization class and setParameterization() method. 
*/
class PRC_TOOLKIT OdPrcEllipse2d : public OdPrcCurve2d
{
public:
  //DOM-IGNORE-BEGIN
  ODPRC_DECLARE_MEMBERS_CRV(OdPrcEllipse2d)
  //DOM-IGNORE-END
...
SMARTPTR(OdPrcEllipse2d);

#endif // _PRCCRVELLIPSE_2D_INCLUDED_
