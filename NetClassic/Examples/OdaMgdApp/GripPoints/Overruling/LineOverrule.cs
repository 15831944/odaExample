...
namespace OdaMgdApp
{
  ...
  public class LineOverrule : GripOverrule
  {
    ...
    {
      Line ln = (Line)entity;
      gripPoints.Add(ln.StartPoint); // start
      gripPoints.Add(ln.EndPoint); // end
      gripPoints.Add(ln.StartPoint + (ln.EndPoint - ln.StartPoint) / 2); // middle
      gripPoints.Add(ln.StartPoint + (ln.EndPoint - ln.StartPoint) / 4); // 1/4
      gripPoints.Add(ln.StartPoint + (ln.EndPoint - ln.StartPoint) / 4 * 3); // 3/4
    }
