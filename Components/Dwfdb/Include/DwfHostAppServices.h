...
// This class is the base class for platform specific operations within ODA Platform.
// Library: TDwfDb
...
public:
  ...
  /** \details
    ...
    This function is called by ODA Platform when access is needed to a
    ...
    kTXApplication          7         ODA Platform Xtension file.       TX
  ...
  */
  ...
  /** \details
    Notification function called whenever ODA Platform no longer needs the specified
    ProgressMeter object.

    \param pProgressMeter [in]  Pointer to the ProgressMeter object no longer needed by ODA Platform.
  ...
  */
  ...
  /** \details
    ...
    \param partialLoad [in]  Controls the partial loading of .dwg files.
    \param password [in]  Password for file.
    \param bDwf3dOrthoOnly [in] Use true to set orthographic projection
  */
  virtual OdSmartPtr<OdDwfDatabase> readFile(
    OdStreamBuf* pStreamBuf,
    bool partialLoad = true,
...
//#endif
  ...
  /** \details
    Returns true if and only if ODA Platform is to do full-time CRC checking on database filing operations.
  ...
  */
  ...
  /** \details
    Returns an alternate UndoController object for ODA Platform.
  ...
  */
  ...
  /** \details
    Enable/disable loading of 3d Object Properties.
    Initially disabled to improve performance.
  */
  void enable3dObjectPropsLoading(bool value);

  typedef enum {
    en3dModelTransform_Default,         // uses to block empiric adjusting
    en3dModelTransform_AdjustedDefault, // initially default with empiric adjusting by camera
    en3dModelTransform_Identity         // is ok only for OrientationIssue.dwfx of PROD-134 now
  } Dwf3dModelTransformType;

  Dwf3dModelTransformType dwf3dModelTransformType() const;
  void setDwf3dModelTransformType(Dwf3dModelTransformType type);

  void setMarkupEnabled(bool bValue);
...
protected:
  ...
  bool m_bLoad3dObjectProperties,
       m_useMarkup;
  Dwf3dModelTransformType m_typeDwf3dModelTransform;
