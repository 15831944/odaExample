...
public:
  ...
  */
  virtual OdResult getGroupShell(OdGePoint3dArray  &vertices, OdGePoint2dArray  &texCoo,
    OdGeVector3dArray &normals, OdUInt32Array &faces, OdArray< OdMtlPtr > &faceMaterials) = 0;

  /** \details
  Collects all material of the group in one shell and returns
  */
  virtual OdResult getFaceMaterials(OdArray< OdMtlPtr > &faceMaterials) = 0;
};
...
public:
  ...
  */
  virtual OdResult getBrep(OdBrBrep &brep, const OdObjSurface *pSurface) = 0;
