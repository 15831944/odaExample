...
//-----------------------------------------------------------------------------------------------------------
                              ...
                              )
  {
    ...
    if( pElm->isKindOf( OdDgArc3d::desc()) )
    {
      ...
      vrMajor3d.transformBy( pArc->getRotation().getMatrix().transpose() );
      vrMinor3d.transformBy( pArc->getRotation().getMatrix().transpose() );
    ...
    else if( pElm->isKindOf( OdDgEllipse3d::desc()) )
    {
      ...
      vrMajor3d = OdGeVector3d::kXAxis;
      vrMinor3d = OdGeVector3d::kYAxis;
      vrMajor3d.transformBy( pEllipse->getRotation().getMatrix().transpose() );
      vrMinor3d.transformBy( pEllipse->getRotation().getMatrix().transpose() );
      ...
      vrNormal.transformBy(pEllipse->getRotation().getMatrix().transpose());
      vrNormal.normalize();
