...
OdDbEntityPtr createHatchEntity( const OdGePoint3dArray& arrPts, bool b3dPoints = true );
OdDbEntityPtr createHatchEntity( const OdDbObjectIdArray& arrElements, bool bSplitContours = false, bool b3dPoints = true );
void importGradient( OdDbHatchPtr& pHatch, const OdDgGradientFill& gradientFill );
void importCrossPattern( OdDbHatchPtr& pHatch, OdDgElement* pElm, const OdDgCrossHatchPatternPtr& pPaternLinkage,
                          double dUORsToModelScale );
void importLinearPattern( OdDbHatchPtr& pHatch, OdDgElement* pElm, const OdDgLinearHatchPatternPtr& pPaternLinkage,
                          double dUORsToModelScale );
void importDwgBasedPattern( OdDbHatchPtr& pHatch, OdDgElement* pElm, const OdDgDWGHatchPatternPtr& pPaternLinkage,
                           double dUORsToModelScale );
void importSymbolPattern( OdDbHatchPtr& pHatch, OdDgElement* pElm, const OdDgSymbolHatchPatternPtr& pPaternLinkage, 
