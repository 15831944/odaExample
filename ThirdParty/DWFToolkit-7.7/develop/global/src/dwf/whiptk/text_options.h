...
protected:
    ...
    WT_Text_Option_Scoring(WT_Text_Option_Scoring const & scoring) ;
...
public:
    ...
    WT_Text_Option_Scoring const &  operator= (WT_Text_Option_Scoring const & scoring) ;
    //@}
...
protected:
    ...
    WT_Text_Option_Bounds(WT_Text_Option_Bounds const & bounds) ;
...
public:
    ...
    WT_Text_Option_Bounds const &   operator=(WT_Text_Option_Bounds const & bounds) ;
    //@}
...
protected:
    ...
    WT_Text_Option_Reserved(WT_Text_Option_Reserved const & reserved) ;
...
public:
    ...
    WT_Text_Option_Reserved const &  operator= (WT_Text_Option_Reserved const & reserved) ;
    //@}
