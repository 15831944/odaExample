...
protected:
    WT_XAML_Polygon(void)
		:WT_Polygon()
	{}
    WT_XAML_Polygon(int count, WT_Logical_Point const *points, WT_Boolean copy) 
		: WT_Polygon(count, points, copy) 
	{}
    
	WT_XAML_Polygon(const WT_Polygon& polygon) 
		: WT_Polygon(polygon) 
	{}
...
public:
     ...
     */
    WT_XAML_Polygon const & operator= (const WT_XAML_Polygon & polygon) 
    {
