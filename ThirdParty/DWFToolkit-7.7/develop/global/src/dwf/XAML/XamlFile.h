...
public:
    ...
    tMemoryBuffer*              getBuffer( size_t nMinLengthInBytes ) ;
    void                        releaseBuffer( tMemoryBuffer *pBuffer ) ;
    tMemoryBuffer*              exchangeBuffer( tMemoryBuffer*, size_t nMinLengthInBytes ) ;
