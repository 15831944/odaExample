...
#if defined(OD_DWF_TRACE) // !defined(NDEBUG) // _DEBUG
public:
  _DWFCORE_API static void trace(const char* pcszTxt);
  _DWFCORE_API static void trace1(const char* pcszTxt, void* val);
  _DWFCORE_API static void trace2(const char* pcszTxt, const wchar_t* pBuf, size_t nbytes);
#endif
...
#if defined(OD_DWF_TRACE) // !defined(NDEBUG) // _DEBUG
#define OD_TRACE(pcszTxt) DWFString::trace(pcszTxt)
#define OD_TRACE1(pcszTxt, val) DWFString::trace1(pcszTxt, (void*)(size_t) val)
#define OD_TRACE2(pcszTxt, pBuf, nbytes) DWFString::trace2(pcszTxt, (const wchar_t*) pBuf, (size_t) nbytes)
#else
#define OD_TRACE(pcszTxt)
#define OD_TRACE1(pcszTxt, val)
#define OD_TRACE2(pcszTxt, pBuf, nbytes)
#endif
