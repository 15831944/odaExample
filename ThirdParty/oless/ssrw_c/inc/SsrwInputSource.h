 ...
 */
_OLESS_API SSRW_INT64 SsrwFtell(
    SSRWIS* in_pIS);
 ...
 * @return 0 on success, nonzero on failure.
 */
_OLESS_API int SsrwDisconnect(SSRWIS* in_pIS);
