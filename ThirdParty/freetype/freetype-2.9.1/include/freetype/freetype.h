...
#define FT_STYLE_FLAG_BOLD    ( 1 << 1 )
  ...
  /*                                                                       */
  /*    {                                                                  */
  /*      scaled_ascender = FT_MulFix_oda( face->ascender,                     */
  ...
  /*      {                                                                */
  /*        ascender  = ROUND( FT_MulFix_oda( face->ascender,                  */
  /*                                      size_metrics->y_scale ) );       */
  /*        descender = ROUND( FT_MulFix_oda( face->descender,                 */
  /*                                      size_metrics->y_scale ) );       */
  /*      }                                                                */
  /*      else                                                             */
  /*      {                                                                */
