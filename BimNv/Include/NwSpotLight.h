...
/** \details
  This class represents a spot light of a model.
...
public:
  /** \details
    Default constructor. Creates a new object of the OdNwSpotLight
    class.
  */
  OdNwSpotLight();
...
public:
  ...
  */
  ...
  /** \details
    Returns the dropoff rate of the light.

    \returns Returns a double value with the dropoff rate of the light.
  */
  double getDropoffRate() const;

  /** \details
    Returns the cutoff angle of the light.

    \returns Returns a double value with the cutoff angle of the light.
  */
