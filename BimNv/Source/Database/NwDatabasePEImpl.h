...
///////////////////////////////////////////////////////////////////////////////
#ifndef __NW_DB_PE_IMPL_H__
#define __NW_DB_PE_IMPL_H__
...
class OdNwDatabasePEImpl : public OdBaseDatabasePEImpl
{
public:
...
class OdNwUnderlayLayerImpl : public OdRxObject
{
  class OdUnderlayLayer* m_pLayer;
public: 
  ODRX_DECLARE_MEMBERS(OdNwUnderlayLayerImpl);

  OdNwUnderlayLayerImpl()
    : m_pLayer(NULL)
  {
  }
...
typedef OdSmartPtr<OdNwUnderlayLayerImpl> OdNwUnderlayLayerImplPtr;

class OdNwUnderlayLayerIterator : public OdRxObject
{
  OdArray<OdNwUnderlayLayerImplPtr> m_layers;
  OdUInt32 m_index;
public:
  ODRX_DECLARE_MEMBERS(OdNwUnderlayLayerIterator);

  OdNwUnderlayLayerIterator() 
    : m_index(0) 
  {
  }
  void start() 
  ...
  {
    ODA_ASSERT_ONCE_X(TNW, pLayer);
    OdNwUnderlayLayerImplPtr pLayerImpl = OdRxObjectImpl<OdNwUnderlayLayerImpl>::createObject();
    pLayerImpl->setUnderlayLayer(pLayer);
    m_layers.push_back(pLayerImpl);
  }
};
typedef OdSmartPtr<OdNwUnderlayLayerIterator> OdNwUnderlayLayerIteratorPtr;

//----------------------------------------------------------
// OdNwBaseLayerPEImpl

class OdNwBaseLayerPEImpl : public OdBaseLayerPEImpl
{
public:
...
//----------------------------------------------------------
// OdNwBaseLayoutPEImpl

class OdNwBaseLayoutPEImpl : public OdBaseLayoutPEImpl
{
public:
...
class OdNwVisualStylePEImpl : public OdBaseVisualStylePEImpl
{
public:
  virtual OdString name(const OdRxObject* obj) const override;
  virtual bool isInternal(const OdRxObject* obj) const override;
};

#endif //__NW_DB_PE_IMPL_H__
