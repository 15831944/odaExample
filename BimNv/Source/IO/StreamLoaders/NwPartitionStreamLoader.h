...
class OdNwPartitionStreamLoader : public OdNwStreamLoader
{
public:
  OdNwPartitionStreamLoader(const std::shared_ptr<OdNwStreamContext> &ctx);
...
public:
  OdNwPartitionNodePtr getPartition() const;
