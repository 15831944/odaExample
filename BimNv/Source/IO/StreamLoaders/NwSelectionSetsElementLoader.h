...
///////////////////////////////////////////////////////////////////////////////
#ifndef __NW_SELECTION_SETS_ELEMENT_LOADER_H__
#define __NW_SELECTION_SETS_ELEMENT_LOADER_H__

#include "NwStreamLoader.h"
#include "NwObject.h"

class OdNwSelectionSetsElementLoader : public OdNwStreamLoader
{
public:
  OdNwSelectionSetsElementLoader(const std::shared_ptr<OdNwStreamContext> &ctx);
  virtual ~OdNwSelectionSetsElementLoader();
  ...
  OdNwObjectId getSelectionSetsElement();
...
#endif  //__NW_SELECTION_SETS_ELEMENT_LOADER_H__
