...
///////////////////////////////////////////////////////////////////////////////
#ifndef __NW_XREFTABLESTREAMLOADER_H__
#define __NW_XREFTABLESTREAMLOADER_H__
...
class OdNwXRefTableStreamLoader : public OdNwStreamLoader
{
public:
  OdNwXRefTableStreamLoader(const std::shared_ptr<OdNwStreamContext> &ctx);
  virtual ~OdNwXRefTableStreamLoader();
...
#endif // __NW_XREFTABLESTREAMLOADER_H__
