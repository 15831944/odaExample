...
class OdNwSavedViewsElementStreamLoader : public OdNwStreamLoader
{
public:
  OdNwSavedViewsElementStreamLoader(const std::shared_ptr<OdNwStreamContext> &ctx);
...
public:
  OdNwObjectId getSavedViewsElement();
