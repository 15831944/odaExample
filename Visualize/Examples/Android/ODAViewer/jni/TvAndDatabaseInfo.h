...
#ifndef TVANDDATABASEINFO_H
#define TVANDDATABASEINFO_H
 ...
 */
class TvAndDatabaseInfo : public OdTvFilerTimeProfiling
{
public:
    ...
    TvAndDatabaseInfo() : m_iLoadTime(0), m_iVectorizingTime(0), m_iTvCreationTime(0), m_iFirstUpdateTime(0)
