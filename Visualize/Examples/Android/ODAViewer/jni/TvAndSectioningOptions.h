...
#ifndef TVANDSECTIONINGOPTIONS_H
#define TVANDSECTIONINGOPTIONS_H

#define ODTVUI_CUTTINGPLANESMAXNUM 5

#include "OdaCommon.h"

class TvAndSectioningOptions
{
public:
    TvAndSectioningOptions() : m_bShow(true), m_bFill(true), m_iFillingColor(ODRGBA(255, 0, 0, 255)) {}
...
#endif //TVANDSECTIONINGOPTIONS_H
