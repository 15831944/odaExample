...
OdResult OdStlImportTypeProperty::subGetValue(const OdRxObject* pO, OdRxValue& value) const
{
  OdStlImportPtr pStlImport = OdStlImport::cast(pO);

  if (pStlImport.isNull())
