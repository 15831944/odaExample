...
/** \details
    This class represents PlotSettings objects in an OdTvDbDatabase instance.
...
*/
class TOOLKIT_EXPORT OdTvDbPlotSettings : public OdTvDbObject
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbPlotSettings);
  ...
  */
  ...
  /** \details
    ...
    \sa
    OdTvDbPlotSettingsValidator::getLocaleMediaName()
  */
  ...
  */
  OdTvDbPlotSettings::PlotPaperUnits plotPaperUnits() const;
  ...
  */
  OdTvDbPlotSettings::PlotRotation plotRotation() const;
  ...
  */
  OdTvDbPlotSettings::PlotType plotType() const;
  ...
  */
  OdTvDbPlotSettings::StdScaleType stdScaleType() const;
  ...
  */
  OdTvDbPlotSettings::ShadePlotType shadePlot() const;
  ...
  */
  OdResult setShadePlot(
    OdTvDbPlotSettings::ShadePlotType shadePlot);
  ...
  */
  OdTvDbPlotSettings::ShadePlotResLevel shadePlotResLevel() const;
  ...
  */
  void setShadePlotResLevel(
    OdTvDbPlotSettings::ShadePlotResLevel shadePlotResLevel);
...
// Returns the OdTvDbObjectId of the OdTvDbVisualStyle or OdTvDbRenderSettings object
// referenced by this object.
  ...
  */
  OdResult        setShadePlot(OdTvDbPlotSettings::ShadePlotType type,
                               OdTvDbObjectId shadePlotId);
  /** \details
  ...
  */
  ...
  /** \details
    Returns true if and only if transparencies plotting is enabled for this OdTvDbRenderSettings object.
  */
  bool plotTransparency() const;
  /** \details
    Enables or disables transparencies plotting for this OdTvDbRenderSettings object.
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbPlotSettings object pointers.
*/
typedef OdSmartPtr<OdTvDbPlotSettings> OdTvDbPlotSettingsPtr;
