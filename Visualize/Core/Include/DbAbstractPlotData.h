...
/** \details
    This class is the base class for Protocol Extension classes for OdTvDbViewport and OdTvDbPlotSettings objects.
...
*/
class TOOLKIT_EXPORT OdTvDbAbstractPlotData : public OdRxObject
{
  public:
    ODRX_DECLARE_MEMBERS(OdTvDbAbstractPlotData);
    ...
    */
    ...
    /** \details
      ...
      \param pPlotObj [in]  Pointer to the Plot object.
    */
    virtual OdTvDbPlotSettings::StdScaleType standardScale(const OdRxObject* pPlotObj) const = 0;
    ...
    */
    virtual void setStandardScale(OdRxObject* pPlotObj, const OdTvDbPlotSettings::StdScaleType standardScale) const = 0;
    ...
    */
    ...
    /** \details
      ...
      \param pPlotObj [in]  Pointer to the Plot object.
    */
    virtual OdTvDbPlotSettings::ShadePlotType shadePlot(const OdRxObject* pPlotObj) const = 0;
    ...
    */
    virtual void setShadePlot(OdRxObject* pPlotObj, OdTvDbPlotSettings::ShadePlotType shadePlotSet) const = 0;

    /** \details
      Returns the OdTvDbObjectId of the OdTvDbVisualStyle or OdTvDbRenderSettings object referenced by this object.
      \param pPlotObj [in]  Pointer to the Plot object.
    */
    virtual OdTvDbObjectId shadePlotId(const OdRxObject* pPlotObj) const = 0;

    /** \details
      Sets the shade plot type and OdTvDbObjectId of the OdTvDbVisualStyle or OdTvDbRenderSettings object for this Plot object.
      \param pPlotObj [in]  Pointer to the Plot object.
      \param type [in]  New shade plot setting.
      \param shadePlotId [in]  OdTvDbObjectId of the OdTvDbVisualStyle or OdTvDbRenderSettings object for this Plot object.
    */
    virtual void setShadePlot(OdRxObject* pPlotObj, OdTvDbPlotSettings::ShadePlotType type, OdTvDbObjectId shadePlotId) const = 0;
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbAbstractPlotData object pointers.
*/
typedef OdSmartPtr<OdTvDbAbstractPlotData> OdTvDbAbstractPlotDataPtr;
