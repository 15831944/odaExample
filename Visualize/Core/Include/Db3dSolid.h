...
/** \details
This template class is a specialization of the OdSmartPtr class for OdTvDb3dSolid object pointers.
*/
typedef OdSmartPtr<OdTvDb3dSolid> OdTvDb3dSolidPtr;

/** \details
This template class is a specialization of the OdArray class for OdTvDb3dSolid object pointer arrays.
*/
typedef OdArray<OdTvDb3dSolidPtr> OdTvDb3dSolidPtrArray;


/** \details
    This class represents 3D Solid entities in an OdTvDbDatabase instance.

    \sa
    TD_Db
    
    \remarks
    An OdTvDb3dSolid entity is a wrapper for an ACIS model that represents
    the geometry of the OdTvDb3dSolid entity.
    
    <group OdTvDb_Classes> 

*/
class DBENT_EXPORT OdTvDb3dSolid : public OdTvDbEntity
{
public:

  DWGMAP_DECLARE_MEMBERS(OdTvDb3dSolid);
...
* angleOfRevolution >= 1e-6
  ...
  */
    virtual OdResult booleanOper(OdDb::BoolOperType operation, OdTvDb3dSolid* solid);
...
* non-spline fit OdTvDb3dPolyline
  ...
  */
  virtual OdResult extrudeAlongPath(const OdTvDbRegion* region, const OdTvDbCurve* path, double taperAngle = 0.0);
...
* Face
  ...
  */
  ...
  /** \details
    ...
    \param newSolids [out] A reference to an array of pointers to OdTvDb3dSolid objects representing the additional disjoint volumes. 
  ...
  */
  ...
  /** \details
    ...
    for other modelers. 
  */
  virtual OdResult createExtrudedSolid ( OdTvDbEntity* pSweepEnt,
  ...
  */
  virtual OdResult createLoftedSolid (
    ...
    OdTvDbEntity* pPathCurve, OdTvDbLoftOptions& loftOptions );
...
* 3 <= sides <= 64.
  */
  ...
  /** \details
    ...
    for other modelers. 
  */
  virtual OdResult createRevolvedSolid ( OdTvDbEntity* pRevEnt,
  ...
  */
  ...
  /** \details
    ...
    for other modelers. 
  */
  virtual OdResult createSweptSolid ( OdTvDbEntity *pSweepEnt,
    const OdDbSubentId& faceSubentId,
  ...
  */
  ...
  /** \details
    Copies the specified edge as a separate entity (instance of OdTvDbLine, OdTvDbCircle, OdTvDbArc, OdTvDbEllipse, OdTvDbSpline class).
    ...
    for other modelers. 
    */
  virtual OdResult copyEdge(const OdDbSubentId &subentId, OdTvDbEntityPtr &newEntity);
  
  /** \details
    Copies the specified face as a separate entity (OdTvDbRegion or otherwise will be OdTvDbBody).
    ...
    \remarks
    If face is planar, an OdTvDbRegion entity is created. Otherwise an OdTvDbBody entity is created. 
    The properties of the resulting entity (color, layer, line type, lineweight) are inherited from the corresponding current document.
    ...
    for other modelers. 
  */
  virtual OdResult copyFace(const OdDbSubentId &subentId, OdTvDbEntityPtr &newEntity);
...
* polyline with constant width and thickness
  ...
  */
  virtual OdResult convertToBrepAtSubentPaths(const OdTvDbFullSubentPathArray& /*paths*/);
  ...
  /** \details
    ...
    When an OdTvDbPoint is specified as the entity to be projected, the result of the projection will be an AcTvDbPoint representing the nearest point on the solid.
	
    This method is implemented only for Spatial modeler and returns eNotImplementedYet status
    for other modelers. 
  */
  OdResult projectOnToSolid( const OdTvDbEntity*   pEntityToProject,
  ...
  /** \details
    ...
    This method is not implemented. 
  */
  OdResult createSculptedSolid(OdTvDbEntityPtrArray& limitingBodies,
