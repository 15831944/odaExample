...
/** \details
    This class is the Protocol Extension class for OdTvDbObjectContext objects.
    
    \remarks
    Implement this interface to use OdTvDbObjectContext objects, which can determine 
...
*/
class TOOLKIT_EXPORT OdTvDbObjectContextInterface : public OdRxObject
{
public:

  ODRX_DECLARE_MEMBERS(OdTvDbObjectContextInterface);
   ...
   */
    ...
    const OdTvDbObject*        pObject,
    const OdTvDbObjectContext& context ) const = 0;
...
typedef OdSmartPtr<OdTvDbObjectContextInterface> OdTvDbObjectContextInterfacePtr;
