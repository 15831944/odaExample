...
/** \details
    This class represents OdTvDbPolyFaceMesh vertices in an OdTvDbDatabase instance.
...
*/
class DBENT_EXPORT OdTvDbPolyFaceMeshVertex : public OdTvDbVertex
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbPolyFaceMeshVertex);

  OdTvDbPolyFaceMeshVertex();
