...
/** \details
    This class represents Leader entities in an OdTvDbDatabase instance.

    <group OdTvDb_Classes>
*/
class DBDIM_EXPORT OdTvDbLeader : public OdTvDbCurve
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbLeader);
  ...
  */
  ...
  /** \details
    Returns the dimension style (OdTvDbDimStyleTableRecord) used by this Leader entity (DXF 3).
  */
  virtual OdTvDbHardPointerId dimensionStyle() const;

  /** \details
    Sets the dimension style (OdTvDbDimStyleTableRecord) to used by this Leader entity (DXF 3).
    
    \param dimStyleId [in]  Object ID of the dimension style.
  */
  virtual void setDimensionStyle(
    const OdTvDbHardPointerId& dimStyleId);
  ...
  /** \details
    ...
    kMText      OdTvDbMText            MText 
    kFcf        OdTvDbFcf              Feature control frame (Tolerance)  
    kBlockRef   OdTvDbBlockReference   Block reference
    </table>
  ...
  */
  virtual OdTvDbObjectId annotationObjId() const;
  ...
  */
  ...
  /** \details
    ...
    kMText         annotationOffset() + OdTvDbMText::location() ± OdGeVector3d(dimgap(), 0, 0) 
    kFcf           annotationOffset() + OdTvDbFcf::location()   ± OdGeVector3d(dimgap(), 0, 0)
    kBlockRef      annotationOffset() + OdTvDbBlockReference::position()
    kNoAnno        lastVertex() 
    </table>
  ...
  */
  ...
  /** \details
    ...
    <table>
    annoType()     Final Leader Endpoint
    kMText         annotationOffset() + OdGeVector3d(± dimgap(), 0, 0) + OdTvDbMText::location()
    kFcf           annotationOffset() + OdGeVector3d(± dimgap(), 0, 0) + OdTvDbFcf::location()
    kBlockRef      annotationOffset() + OdTvDbBlockReference::position()
    kNoAnno        lastVertex() 
    </table>
  ...
  */
  ...
  enum AnnoType
  { 
    kMText      = 0,   // OdTvDbMText
    kFcf        = 1,   // OdTvDbFcf
    kBlockRef   = 2,   // OdTvDbBlockReference.
  ...
  /** \details
    ...
    kMText      0        OdTvDbMText            MText 
    kFcf        1        OdTvDbFcf              Feature control frame (Tolerance)  
    kBlockRef   2        OdTvDbBlockReference   Block reference
    kNoAnno     3        --                   No annotation
    </table>
  */
  ...
  */
   virtual OdTvCmColor dimclrd() const;
  ...
  */
   virtual OdTvDbObjectId dimldrblk() const;
  ...
  */
   virtual OdTvDbObjectId dimtxsty() const;
  ...
  */
  ...
  virtual OdResult subGetTransformedCopy(
    ...
    OdTvDbEntityPtr& pEnt) const ODRX_OVERRIDE;
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbLeader object pointers.
*/
typedef OdSmartPtr<OdTvDbLeader> OdTvDbLeaderPtr;
