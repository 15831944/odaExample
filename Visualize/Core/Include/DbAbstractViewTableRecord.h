...
/** \details
    This class is the base class for OdTvDbViewTableRecord and OdTvDbViewportTableRecord.
...
*/
class TOOLKIT_EXPORT OdTvDbAbstractViewTableRecord : public OdTvDbSymbolTableRecord
{
public:

  ODDB_DECLARE_MEMBERS(OdTvDbAbstractViewTableRecord);

  OdTvDbAbstractViewTableRecord();

  /** \details
    Returns the DSC center point of this View. 
    \remarks
    *  DXF 10 for OdTvDbViewTableRecord.
    *  DXF 12 for OdTvDbViewportTableRecord.
  */
  ...
  */
  ...
  /** \details
    ...
    \remarks
    DXF 41 contains the width : height ratio for OdTvDbViewportTableRecord.
  */
  double width() const;
  ...
  */
  void setWidth(
   ...
   /** \details
    ...
    \remarks
    *  DXF 12 for OdTvDbViewTableRecord. 
    *  DXF 17 for OdTvDbViewportTableRecord.    
   */
  ...
  */
  ...
  /** \details
    ...
    \remarks
    *  DXF 11 for OdTvDbViewTableRecord. 
    *  DXF 16 for OdTvDbViewportTableRecord.    
  */
 ...
 void setViewDirection(
  ...
  /** \details
    ...
    \remarks
    *  DXF 50 for OdTvDbViewTableRecord 
    *  DXF 51 for OdTvDbViewportTableRecord.    
  ...
  */
  ...
  void setBackground(const OdTvDbObjectId& background);
  ...
  void setAmbientLightColor(const OdTvCmColor& color);
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbViewportTableRecord object pointers.
*/
typedef OdSmartPtr<OdTvDbAbstractViewTableRecord> OdTvDbAbstractViewTableRecordPtr;
