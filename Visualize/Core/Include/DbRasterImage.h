...
/** \details
    This class represents RasterImage entities in an OdTvDbDatabase instance.
...
*/
class ISM_EXPORT OdTvDbRasterImage : public OdTvDbImage
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbRasterImage);
  ...
  */
  virtual void setImageDefId(
    OdTvDbObjectId imageDefId);

  /** \details
    Returns the Object ID of the OdTvDbRasterImageDef object associated with this raster image entity (DXF 340).
  */
  virtual OdTvDbObjectId imageDefId() const;

  /** \details
    Sets the OdTvDbRasterImageDefReactor object associated with this raster image entity (DXF 360).
    \param reactorId [in]  Object ID of reactor for this image.
    
    \remarks
    Each OdTvDbRasterImage object must have an OdTvDbRasterImageDefReactor associated with the OdTvDbRasterImageDef
    object it is using. This call makes this OdTvDbRasterImage object the owner of the reactor object.
  */
  virtual void setReactorId(
    OdTvDbObjectId reactorId);

  /** \details
    Returns the Object ID of the OdTvDbRasterImageDefReactor object associated with this raster image entity (DXF 360).

    \remarks
    Each OdTvDbRasterImage object must have an OdTvDbRasterImageDefReactor associated with the OdTvDbRasterImageDef
    object it is using.
  */
  virtual OdTvDbObjectId reactorId() const;
  ...
  */
  ...
  /** \details
    ...
    \param getCachedValue [in]  True to always return cached value. False to return the value from the OdTvDbRasterImageDef
                        object of available.  
  */
  ...
  */
  ...
  /*
     virtual void subSwapIdWith(OdTvDbObjectId otherId, bool swapXdata = false, bool swapExtDict = false);
  */
 ...
 /* virtual OdResult subGetClassID(
  ...
  virtual OdTvDbObjectPtr subDeepClone(
    OdTvDbIdMapping& ownerIdMap, OdTvDbObject*, bool bPrimary) const ODRX_OVERRIDE;
  ...
  virtual void getOsnapPoints( OdDb::OsnapMode osnapMode,
    ...
    OdGePoint3dArray& snapPoints, OdTvDbIntArray& geomIds) const;

  virtual void getGripPoints(OdGePoint3dArray& gripPoints,
    OdTvDbIntArray& osnapModes, OdTvDbIntArray& geomIds) const;

  virtual void moveGripPointsAt(const OdTvDbIntArray& indices, const OdGeVector3d& offset);

  virtual void getStretchPoints(OdGePoint3dArray& stretchPoints) const;

  virtual void moveStretchPointsAt(const OdTvDbIntArray& indices, const OdGeVector3d& offset);

  virtual void transformBy(const OdGeMatrix3d& xform);
  virtual void getTransformedCopy(const OdGeMatrix3d& xform, OdTvDbEntity** ent) const;
  ...
  virtual void getSubentPathsAtGsMarker(OdDb::SubentType type,
    ...
    OdTvDbFullSubentPath*& subentPaths, int numInserts = 0,
    OdTvDbObjectId* entAndInsertStack = 0) const;

  virtual void getGsMarkersAtSubentPath(
    const OdTvDbFullSubentPath& subPath,
    OdGsMarkerArray& gsMarkers) const;

  virtual OdTvDbEntityPtr subentPtr(const OdTvDbFullSubentPath& id) const;
  virtual void saveAs(OdGiWorldDraw* mode, OdDb::EntSaveAsType st);
  virtual void intersectWith(const OdTvDbEntity* ent,
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbRasterImage object pointers.
*/
typedef OdSmartPtr<OdTvDbRasterImage> OdTvDbRasterImagePtr;
