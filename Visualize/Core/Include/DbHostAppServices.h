...
class OdTvDbKey;
class OdTvDbAbstractClipBoundaryDefinition;
class ClipBoundaryArray;
class OdHatchPatternManager;
class OdTvDbPageController;
...
/** \details
    ...
    {noAutoLink}
*/
class ODRX_ABSTRACT TOOLKIT_EXPORT OdTvDbHostAppServices : public OdDbBaseHostAppServices
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbHostAppServices);

  OdTvDbHostAppServices();
  virtual ~OdTvDbHostAppServices();
  ...
  /** \details
    ...
    the application can handle that string in OdTvDbSystemServices::createFile.
  */
  ...
  */
  ...
  /** \details
    ...
    \remarks
    Returns OdTvDbDatabase::desc();
  */
  virtual OdRxClass* databaseClass() const;

  /** \details
    Creates an instance of an OdTvDbDatabase object.
  ...
  */
  virtual OdTvDbDatabasePtr createDatabase(
  ...
  */
  virtual OdTvDbDatabasePtr readFile(
  ...
  */
  virtual OdTvDbDatabasePtr recoverFile(
    OdStreamBuf* pStreamBuf,
  ...
  */
    ...
    const OdPassword& password = OdPassword())
  {
    ...
    return readFile(odTvSystemServices()->createFile(filename, nDesiredAccess, shareMode),
  ...
  /** \details
    ...
    \remarks
    The default implementation of this function returns odtvdbGetLibraryInfo()->getLibName()
  */
  ...
  */
  ...
  /** \details
    ...
    \remarks
    The default implementation of this function returns odtvdbGetLibraryInfo()->getCompanyName().
  */
  ...
  */
  ...
  /** \details
    ...
    \remarks
    The default implementation of this function returns odtvdbGetLibraryInfo()->getLibVersion().
  */
  ...
  */
  ...
  /** \details
    ...
    \remarks
    These functions call odTvSystemServices()->warning(message) to display the warning.
  */
  TD_USING(OdDbBaseHostAppServices::warning);
  //virtual void warning(
  //  const OdString& message) { odTvSystemServices()->warning(NULL, message); };
  //virtual void warning(
  //  const char* warnVisGroup,
  //  const OdString& message) { odTvSystemServices()->warning(warnVisGroup, message); };
  //virtual void warning(
  ...
  virtual void warning(
    OdWarning warningOb,
    OdTvDbObjectId objectId) { warning(NULL, warningOb, objectId); }
  virtual void warning(
    const char* warnVisGroup,
    OdWarning warningOb,
  ...
  */
  ...
  /** \details
    ...
    associated with it.
  */
  virtual OdTvDbPlotSettingsValidator* plotSettingsValidator();
...
#undef REGVAR_DEF
  ...
  */
  ...
  /** \details
    ...
    \remarks
    The paging type will be determined by the overridden OdTvDbPageController::pagingType
    ...
    The default implementation of this function always returns a null SmartPointer.
  */
  virtual OdTvDbPageControllerPtr newPageController();
  ...
  */
  ...
  virtual OdTvDbLayoutManagerPtr layoutManager() const;
  ...
  */
  ...
  virtual OdStreamBufPtr getHistoryFile(OdTvDbDatabase*);
  ...
  virtual OdString fixName(const OdTvDbSymbolTableRecord* pRecord);

#ifdef SWIG
  friend class OdTvDbHostAppServices2;
private:
#endif
  virtual OdTvDbKey* key() const = 0;
protected:
  OdMutex                       m_LayoutManagerMutex;
  OdMutex                       m_ValidatorMutex;
  OdMutex                       m_PwdCacheMutex;
//  OdMutex                       m_WarningMutex;
  OdTvDbLayoutManagerPtr          m_pLayoutManager;
  OdTvDbPlotSettingsValidatorPtr  m_pValidator;
...
/** \details
    ...
    <group OdTvDb_Classes>
*/
class ODRX_ABSTRACT OdTvDbHostAppServices2 : public OdTvDbHostAppServices
{
