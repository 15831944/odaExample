...
/** \details
    This class represents OLE2 entities in an OdTvDbDatabase instance.
    ...
    <group OdTvDb_Classes>
*/
class DBENT_EXPORT OdTvDbOle2Frame : public OdTvDbOleFrame
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbOle2Frame);
  ...
  */
  ...
  /** \details
    ...
    \remarks
    Was not accessible in DD1.12 (OdTvDbOle2FrameImpl::m_UnknownFromDWG)
  ...
  */
  ...
  /** \details
    ...
    \remarks
    Still unknown. OdTvDbOle2Frame::getUnknown1() in DD1.12
  ...
  */
  ...
  /** \details
    ...
    \remarks
    Still unknown. OdTvDbOle2Frame::getUnknown2() in DD1.12
  ...
  */
  ...
  /** \details
    ...
    \remarks
    OdTvDbOle2Frame::getPixelWidth() in DD1.12
  ...
  */
  ...
  /** \details
    ...
    \remarks
    OdTvDbOle2Frame::getPixelHeight() in DD1.12
  ...
  */
  ...
  void subSetDatabaseDefaults(OdTvDbDatabase *pDb, bool);
};

/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbOld2Frame object pointers.
*/
typedef OdSmartPtr<OdTvDbOle2Frame> OdTvDbOle2FramePtr;
