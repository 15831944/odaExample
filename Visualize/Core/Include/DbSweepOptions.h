...
class OdTvDbSweepOptionsImpl;

/** \details
Class for setting options used for creating swept surfaces and swept solids (by calling OdTvDbSweptSurface::createSweptSurface() or OdTvDb3dSolid::createSweptSolid() methods).
Sweep options are used to control the shape of the resulting surface or solid object.

<group OdTvDb_Classes>
*/
class DBENT_EXPORT OdTvDbSweepOptions
{
public:
  /** \details 
  ...
  */
  OdTvDbSweepOptions ( const OdTvDbSweepOptions& src );
  ...
  */
  OdTvDbSweepOptions& operator = ( const OdTvDbSweepOptions& src );

  /** \details
    Compares two OdTvDbSweepOptions objects, returns true when their values are equal,
    or false when their values are not equal.

    \param opt [in] Another OdTvDbSweepOptions object to compare.
  */
  bool operator == (const OdTvDbSweepOptions& opt) const;
  ...
  */
  OdTvDbSweepOptions::AlignOption  align () const;
  ...
  */
  void  setAlign ( OdTvDbSweepOptions::AlignOption val );

  /** \details
  Returns the miter option.
  */
  OdTvDbSweepOptions::MiterOption  miterOption () const;
  ...
  */
  void  setMiterOption ( OdTvDbSweepOptions::MiterOption val );
  ...
  */
  OdResult  setSweepEntityTransform ( OdTvDbEntityPtrArray& sweepEntities,  bool displayErrorMessages = false );
  ...
  */
  OdResult  setPathEntityTransform ( OdTvDbEntity *pPathEnt,  bool displayErrorMessages = false );
  ...
  */
  OdResult  checkSweepCurve ( OdTvDbEntity *pSweepEnt,
  ...
  */
  OdResult  checkPathCurve ( OdTvDbEntity *pPathEnt,    bool displayErrorMessages = false );

private:
  friend class OdTvDbSweepOptionsImpl;
  OdTvDbSweepOptionsImpl *m_pImpl;
};
