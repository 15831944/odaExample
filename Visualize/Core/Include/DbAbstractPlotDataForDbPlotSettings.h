...
/** \details
    This class is the Protocol Extension class for OdTvDbPlotSettings objects.
    
    Corresponding C++ library: TD_Db

    <group OdTvDb_Classes> 
*/
class TOOLKIT_EXPORT OdTvDbAbstractPlotDataForDbPlotSettings : public OdTvDbAbstractPlotData
{
  public:
    ODRX_DECLARE_MEMBERS(OdTvDbAbstractPlotDataForDbPlotSettings);
    ...
    */
    ...
    /** \details
      ...
      \param pPlotObj [in]  Pointer to the Plot object.
    */
    OdTvDbPlotSettings::StdScaleType standardScale(const OdRxObject* pPlotObj) const;
    ...
    */
    void setStandardScale(OdRxObject* pPlotObj, const OdTvDbPlotSettings::StdScaleType standardScale) const;
    ...
    */
    ...
    /** \details
      ...
      \param pPlotObj [in]  Pointer to the Plot object.
    */
    OdTvDbPlotSettings::ShadePlotType shadePlot(const OdRxObject* pPlotObj) const;
    ...
    */
    void setShadePlot(OdRxObject* pPlotObj, OdTvDbPlotSettings::ShadePlotType shadePlotSet) const;

    /** \details
      Returns the OdTvDbObjectId of the OdTvDbVisualStyle or OdTvDbRenderSettings object referenced by this object.
      \param pPlotObj [in]  Pointer to the Plot object.
    */
    OdTvDbObjectId shadePlotId(const OdRxObject* pPlotObj) const;
    ...
    */
    void setShadePlot(OdRxObject* pPlotObj, OdTvDbPlotSettings::ShadePlotType type, OdTvDbObjectId shadePlotId) const;
