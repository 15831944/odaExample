...
/** \details
    This class represents Arc Dimension entities in an OdTvDbDatabase instance.
...
*/
class DBDIM_EXPORT OdTvDbArcDimension : public OdTvDbDimension
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbArcDimension);
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbArcDimension object pointers.
*/
typedef OdSmartPtr<OdTvDbArcDimension> OdTvDbArcDimensionPtr;
