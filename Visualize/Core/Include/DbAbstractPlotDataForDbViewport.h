...
/** \details
    This class is the Protocol Extension class for OdTvDbViewport objects.
    
    Corresponding C++ library: TD_Db

    <group OdTvDb_Classes> 
*/
class DBENT_EXPORT OdTvDbAbstractPlotDataForDbViewport : public OdTvDbAbstractPlotData
{
  public:
    ODRX_DECLARE_MEMBERS(OdTvDbAbstractPlotDataForDbViewport);
