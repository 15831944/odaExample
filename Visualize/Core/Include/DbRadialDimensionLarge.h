...
/** \details
    This class represents Large (Jogged) Radial Dimension entities in an OdTvDbDatabase instance.
...
*/
class DBDIM_EXPORT OdTvDbRadialDimensionLarge : public OdTvDbDimension
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbRadialDimensionLarge);

  OdTvDbRadialDimensionLarge();
  ...
  */
  ...
  OdTvDbObjectId       dimStyle = OdTvDbObjectId::kNull);
  */
};

/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbRadialDimensionLarge object pointers.
*/
typedef OdSmartPtr<OdTvDbRadialDimensionLarge> OdTvDbRadialDimensionLargePtr;
