...
class TFDLL_EXPORT OdTvDbObjectSchemaIterator : public OdRxObject {
public:
  ODRX_DECLARE_MEMBERS(OdTvDbObjectSchemaIterator);

  virtual bool seekClass(const OdRxClass* pClass, OdTvDbHostAppServices* pAppServices) = 0;
...
typedef OdSmartPtr<OdTvDbObjectSchemaIterator> OdTvDbObjectSchemaIteratorPtr;
