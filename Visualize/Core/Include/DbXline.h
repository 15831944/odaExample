...
/** \details
  ...
  OdTvDbRay, OdTvDbLine classes
*/
class DBENT_EXPORT OdTvDbXline : public OdTvDbCurve
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbXline);
  ...
  */
  ...
  /** \details
    ...
    OdTvDbXline::setBasePoint() method
  */
  ...
  */
  ...
  /** \details
    ...
    OdTvDbXline::getPlane(), OdTvDbEntity::isPlanar() methods
  */
  ...
  /** \details
    ...
    OdTvDbXline::isPlanar(), OdTvDbEntity::getPlane() methods
  */
...
/** \details
  ...
  class is specialization of the OdSmartPtr class for the OdTvDbXline class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbXline> OdTvDbXlinePtr;
