...
*/
class DBENT_EXPORT OdTvDbTableTemplate : public OdTvDbTableContent
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbTableTemplate);

  OdTvDbTableTemplate();
  OdTvDbTableTemplate(const OdTvDbTable* pTable, OdDb::TableCopyOption nCopyOption);
  ...
  */
  virtual OdResult capture(const OdTvDbTable* pTable, OdDb::TableCopyOption nCopyOption);
  ...
  /** \details
    ...
    Returns eOk if successful. Otherwise, returns eInvalidInput.
  */
  virtual OdResult createTable(OdTvDbTable* pTable, OdDb::TableCopyOption nCopyOption);
...
/** \details
  This template class is a specialization of the OdSmartPtr class template for OdTvDbTableTemplate object pointers.
*/
typedef OdSmartPtr<OdTvDbTableTemplate> OdTvDbTableTemplatePtr;
