...
/** \details
  ...
  <group Join_Classes>
*/
class DBENT_EXPORT OdTvDbJoinEntityPE : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbJoinEntityPE);
  ...
  */
  virtual OdResult joinEntities(OdTvDbEntityPtr primaryEntity, const OdTvDbEntityPtrArray& otherEntities, OdGeIntArray& joinedEntityIndices) const = 0;
  ...
  */
  virtual OdResult joinEntity(OdTvDbEntityPtr primaryEntity, OdTvDbEntityPtr secondaryEntity) const;
};
...
*/
typedef OdSmartPtr<OdTvDbJoinEntityPE> OdTvDbJoinEntityPEPtr;
