...
/** \details
    This struct is used by OdTvDbMText::getParagraphsIndent() to return indentation and tab data.
    Corresponding C++ library: TD_Db
    <group !!RECORDS_TD_APIRef>
*/
struct OdTvDbMTextIndent
{
...
typedef int(*OdTvDbMTextEnum)(
    OdTvDbMTextFragment *,
    void *);

typedef OdArray<OdTvDbMTextIndent> OdTvDbMTextIndents;
...
/** \details
    ...
    This class represents paragraph (multi-line) text (MText) entities in an OdTvDbDatabase instance.
    ...
    OdTvDbText, OdTvDbMline classes
*/
class DBENT_EXPORT OdTvDbMText : public OdTvDbEntity
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbMText);
  ...
  */
  OdTvDbObjectId textStyle() const;
  ...
  */
  ...
  /** \details
    ...
    \sa
    OdTvDbMText::setAttachmentMovingLocation() method
  */
  void setAttachment(
  ...
  */
  ...
  /** \details
    ...
    \remarks
    This value will probably be different than that returned by OdTvDbMText::width().
  */
  ...
  */
  ...
  /** \details
    ...
    The prototype of the fragment elaboration is as follows:
            ...
            int (*OdTvDbMtextEnum)(OdTvDbMTextFragment *fragment, void *param)
  ...
  */
  ...
  /** \details
    ...
    \sa
    OdTvDbMText::setAttachment() method
  */
  ...
  */
  OdTvCmColor getBackgroundFillColor() const;
  ...
  */
  OdTvCmTransparency getBackgroundTransparency() const;
  ...
  */
  void getParagraphsIndent(
    OdTvDbMTextIndents& indents) const;

  OdTvDbObjectId setField(
    const OdString& fieldName,
    OdTvDbField* pField);
  OdResult removeField(
    OdTvDbObjectId fieldId);
  OdTvDbObjectId removeField(
    const OdString& fieldName);
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbMText object pointers.
*/
typedef OdSmartPtr<OdTvDbMText> OdTvDbMTextPtr;
