...
#define ODED_EDITOR_OBJ OD_T("OdTvEditor")
...
/** \details
    ...
    <group Other_Classes>
*/
class TOOLKIT_EXPORT OdTvEditorReactor : public OdTvRxEventReactor 
{ 
public:
  ODRX_DECLARE_MEMBERS(OdTvEditorReactor);
  ...
  */
  ...
  /** \details
    Notification function called whenever an OdTvDbDatabase instance is about to be closed.
  ...
  */
  virtual void xrefSubcommandPathItem(
    int activity, OdTvDbObjectId blockId, 
  ...
  */
      virtual void objectsLazyLoaded(const OdTvDbObjectIdArray& objectIds);
  ...
  */
  ...
  virtual void sysVarChanged(OdTvDbDatabase* pDb, const OdString& varName);
  
  virtual void sysVarWillChange(OdTvDbDatabase* pDb, const OdString& varName);

  virtual void xrefSubCommandStart(OdTvDbDatabase* pHostDb, OdXrefSubCommand subCmd, const OdTvDbObjectIdArray& btrIds,
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvEditorReactor object pointers.
*/
typedef OdSmartPtr<OdTvEditorReactor> OdEditorReactorPtr;

/** \details
    This class manages application level OdTvEditorReactor instances.
    
    Corresponding C++ library: TD_Db
    <group Other_Classes>
*/
class TOOLKIT_EXPORT OdTvEditor : public OdTvRxEvent 
{ 
public:
  ODRX_DECLARE_MEMBERS(OdTvEditor);
};

/** \details
This template class is a specialization of the OdSmartPtr class for OdTvEditor object pointers.
*/
typedef OdSmartPtr<OdTvEditor> OdTvEditorPtr;

TOOLKIT_EXPORT OdTvEditorPtr odtvedEditor();
