...
*/
class TOOLKIT_EXPORT OdTvDbMaterial : public OdTvDbObject
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbMaterial);
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbMaterial object pointers.
*/
typedef OdSmartPtr<OdTvDbMaterial> OdTvDbMaterialPtr;
