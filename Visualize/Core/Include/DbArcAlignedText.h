...
/** \details
    This class represents Arc-Aligned Text entities in an OdTvDbDatabase instance.

    Corresponding C++ library: ATEXT

    <group OdTvDb_Classes>
*/
class ATEXT_EXPORT OdTvDbArcAlignedText : public OdTvDbEntity
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbArcAlignedText);

  OdTvDbArcAlignedText();
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbArcAlignedText object pointers.
*/
typedef OdSmartPtr<OdTvDbArcAlignedText> OdTvDbArcAlignedTextPtr;
