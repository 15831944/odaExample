...
/** \details
    This class represents Ordinate Dimension entities in an OdTvDbDatabase instance.
...
*/
class DBDIM_EXPORT OdTvDbOrdinateDimension : public OdTvDbDimension
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbOrdinateDimension);

  OdTvDbOrdinateDimension();
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbOrdinateDimension object pointers.
*/
typedef OdSmartPtr<OdTvDbOrdinateDimension> OdTvDbOrdinateDimensionPtr;
