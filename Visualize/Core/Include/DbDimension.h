...
/** \details
    This class is the base class for all Dimension classes in an OdTvDbDatabase instance.
...
*/
class DBDIM_EXPORT OdTvDbDimension : public OdTvDbEntity
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbDimension);
  ...
  */
  ...
  /** \details
    Returns the Object ID of the dimension style (OdTvDbDimStyleTableRecord) for this Dimension entity (DXF 3).
  */
  OdTvDbObjectId dimensionStyle() const;

  /** \details
    Sets the Object ID of the dimension style (OdTvDbDimStyleTableRecord) for this Dimension entity (DXF 3).
  ...
  */
  OdTvDbMText::AttachmentPoint textAttachment() const;
  ...
  */
  void setTextAttachment(
    OdTvDbMText::AttachmentPoint attachmentPoint);
  ...
  */
  void getDimstyleData(
    OdTvDbDimStyleTableRecord *pRecord) const;
  ...
  */
  void setDimstyleData(
    const OdTvDbDimStyleTableRecord* pDimstyle);
  ...
  */
  ...
  /** \details
    Returns the Object ID of the dimension block (OdTvDbBlockTableRecord) associated with this Dimension entity (DXF 2).
  */
  OdTvDbObjectId dimBlockId() const;

  /** \details
    Sets the Object ID of the dimension block (OdTvDbBlockTableRecord) associated with this Dimension entity.
   
    \param dimBlockId [in]  Object ID of the OdTvDbBlockTableRecord.
  ...
  */
  ...
  /** \details
    ...
    \remarks
    The OdTvDbBlockTableRecord of the dimension block is updated to reflect any changes made to this Dimension
    entity since the last time the block table record was updated.

    \param forceUpdate [in]  If true, the OdTvDbBlockTableRecord is updated even if the dimension has not been changed.
  */
  ...
  */
  OdUInt16 getBgrndTxtColor(OdTvCmColor& bgrndTxtColor) const;
  ...
  */
  void setBgrndTxtColor(const OdTvCmColor& bgrndTxtColor, OdUInt16 bgrndTxtFlags );
  ...
  */
  OdTvDbObjectId getDimLinetype() const;
  ...
  */
  void setDimLinetype(const OdTvDbObjectId& linetypeId);

  /** \details
    Returns the Object ID of the first extension line linetype for this Dimension entity.
  */
  OdTvDbObjectId getDimExt1Linetype() const;
  ...
  */
  void setDimExt1Linetype(const OdTvDbObjectId& linetypeId);

  /** \details
    Returns the Object ID of the second extension line linetype for this Dimension entity.
  */
  OdTvDbObjectId getDimExt2Linetype() const;
  ...
  */
  void setDimExt2Linetype(const OdTvDbObjectId& linetypeId);
...
#undef  VAR_DEF
  ...
  virtual OdResult subGetTransformedCopy(
    ...
    OdTvDbEntityPtr& pCopy) const ODRX_OVERRIDE;
  ...
  */
  ...
  virtual void appendToOwner(
    ...
    OdTvDbIdMapping& ownerIdMap) ODRX_OVERRIDE;
  ...
  */
  ...
  OdTvDbObjectPtr dimBlock(OdDb::OpenMode openMode = OdDb::kForRead);

  /*
      void generateLayout();
      void getOsnapPoints(OdDb::OsnapMode osnapMode, const OdTvDbFullSubentPath& subentId,
  ...
  */
  ...
  void fieldToMText(OdTvDbMTextPtr& pDimMText);
  void fieldFromMText(OdTvDbMTextPtr& pDimMText);
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbDimension object pointers.
*/
typedef OdSmartPtr<OdTvDbDimension> OdTvDbDimensionPtr;

class OdTvDbDimensionObjectContextData;
  ...
  /** \details
    ...
    <group OdTvDb_Classes>
  */
class DBDIM_EXPORT OdTvDbDimensionRecomputePE : public OdRxObject
{
public:
  /** \details
  ...
  */
  static void setMeasurementValue(OdTvDbDimension* pDimension, double measurementValue);
  /** \details
  ...
  */
  static void resetDimBlockInsertParams(OdTvDbDimension* pDimension);

  ODRX_DECLARE_MEMBERS(OdTvDbDimensionRecomputePE);
  ...
  /** \details
    ...
    \param pDimension [in]  Pointer to the dimension entity.
  */
  virtual void recomputeDimMeasurement(OdTvDbDimension* pDimension) = 0;
  ...
  /** \details
    ...
    \param pDimension [in]  Pointer to the dimension entity.
  */
  virtual void recomputeDimBlock(OdTvDbDimension* pDimension, OdTvDbDimensionObjectContextData* ctx) = 0;
  ...
  /** \details
    ...
    effective dimension style.
  */
  virtual void formatMeasurement(OdTvDbDimension* pDimension, OdString& formattedMeasurement, 
     double measurementValue, const OdString& dimensionText ) = 0;
};

/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbDimensionRecomputePE object pointers.
*/
typedef OdSmartPtr<OdTvDbDimensionRecomputePE> OdTvDbDimensionRecomputePEPtr;
