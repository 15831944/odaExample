...
class OdTvDbField;
typedef OdSmartPtr<OdTvDbField> OdTvDbFieldPtr;

/** \details
    This template class is a specialization of the OdArray class for OdTvDbField object pointers.
*/
typedef OdArray<OdTvDbFieldPtr> OdTvDbFieldArray;
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbField object pointers.
*/
typedef OdSmartPtr<OdTvDbField> OdTvDbFieldPtr;
...
/** \details
    This class represents Field objects in an OdTvDbDatabase instance.
...
*/
class DBENT_EXPORT OdTvDbField : public OdTvDbObject
{
public:
  enum State
  {
...
public:
  ODDB_DECLARE_MEMBERS(OdTvDbField);
  
  OdTvDbField();

  // OdTvDbField(const OdString& fieldCode, bool bTextField = false);
  // ~OdTvDbField(void);
  ...
  */
  OdTvDbField::EvalStatus evaluationStatus() const; 
                                          // OdUInt32* errCode = 0, 
  ...
  */
  OdTvDbField::EvalOption evaluationOption() const;
  ...
  */
  OdResult setEvaluationOption(
    OdTvDbField::EvalOption evaluationOption);
  ...
  */
  OdTvDbField::FilingOption filingOption() const;
  ...
  */
  OdResult setFilingOption(
    OdTvDbField::FilingOption filingOption);
  ...
  */
  ...
  // OdString getFieldCode     (OdTvDbField::FieldCodeFlag nFlag, OdArray<OdTvDbField*>* pChildFields = 0, 
  ...
  */
  OdString getFieldCode(
    OdTvDbField::FieldCodeFlag flags);

  //                      OdArray<OdTvDbField*>* pChildFields = 0, 
  //                      OdDb::OpenMode mode = OdDb::kForRead) const;
  ...
  */
  OdResult setFieldCode(
    ...
    OdTvDbField::FieldCodeFlag flags = (OdTvDbField::FieldCodeFlag) 0,
    OdTvDbFieldArray* pChildFields = 0);
  ...
  */
  ...
  /** \details
    ...
    \param predefined OdTvDbField::EvalContext enum flags or a user-defined context flag.
  ...
  */
  virtual OdTvDbObjectId setField(const OdString& propName, OdTvDbField* pField) ODRX_OVERRIDE;
  ...
  /** \details
    ...
    Returns eOk if successful, or an appropriate error code if not.
  */
  OdResult removeField(OdTvDbObjectId fieldId);
public:
...
DBENT_EXPORT OdTvDbFieldPtr copyTextFieldToObject(OdTvDbFieldPtr srcField, OdTvDbObject* pObj);
DBENT_EXPORT OdTvDbFieldPtr copyFieldWithChild(OdTvDbFieldPtr srcField);
