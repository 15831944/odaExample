...
/** \details
    This class represents tiled viewport records in the OdTvDbViewportTable in an OdTvDbDatabase instance.
...
*/
class TOOLKIT_EXPORT OdTvDbViewportTableRecord : public OdTvDbAbstractViewTableRecord
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbViewportTableRecord);

  OdTvDbViewportTableRecord();

  typedef OdTvDbViewportTable TableType;
...
*/
typedef OdSmartPtr<OdTvDbViewportTableRecord> OdTvDbViewportTableRecordPtr;
