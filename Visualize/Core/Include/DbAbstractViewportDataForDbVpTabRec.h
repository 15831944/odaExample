...
*/
class TOOLKIT_EXPORT OdTvDbAbstractViewportDataForDbVpTabRec : public OdTvDbAbstractViewportDataForAbstractViewTabRec
{
public:
  ODRX_DECLARE_MEMBERS( OdTvDbAbstractViewportDataForDbVpTabRec );
