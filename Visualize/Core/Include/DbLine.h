...
/** \details
  ...
  OdTvDbXline, OdTvDbRay, OdTvDbMline classes
*/
class DBENT_EXPORT OdTvDbLine : public OdTvDbCurve
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbLine);
  ...
  */
  ...
  /** \details
    ...
    OdTvDbLine::setStartPoint(), OdTvDbLine::endPoint() method
  */
  ...
  /** \details
    ...
    OdTvDbLine::startPoint(), OdTvDbLine::setEndPoint() methods
  */
  ...
  /** \details
    ...
    OdTvDbLine::setEndPoint(), OdTvDbLine::startPoint() methods
  */
  ...
  /** \details
    ...
    OdTvDbLine::endPoint(), OdTvDbLine::setStartPoint() methods
  */
  ...
  /** \details
    ...
    OdTvDbLine::setThickness() method
  */
  ...
  */
  ...
  /** \details
    ...
    OdTvDbLine::getPlane(), OdTvDbEntity::isPlanar() methods
  */
  ...
  /** \details
    ...
    OdTvDbLine::isPlanar(), OdTvDbEntity::getPlane() methods
  */
...
/** \details
  ...
  is specialization of the OdSmartPtr class for the OdTvDbLine class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbLine> OdTvDbLinePtr;
