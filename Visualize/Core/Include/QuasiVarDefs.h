...
#ifndef ODTLAYOUTID
#define ODTLAYOUTID  OdTvDbObjectId /*!DOM*/
#define DOUNDEF_ODTLAYOUTID
#endif

#ifndef ODTTEXTSTYLEID
#define ODTTEXTSTYLEID  OdTvDbObjectId /*!DOM*/
...
QVAR_DEF_RO(ODTDIST,              BACKZ,            TvValidateNone()    )
...
/**
  ...
  <group TD_SysVars_C>
*/
//<dom_var_def>OdTvDbObjectId CTAB;
QVAR_DEF   (ODTLAYOUTID,          CTAB,             TvValidateLayout()  )
...
QVAR_DEF   (OdString,             CPLOTSTYLE,       TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              CVPORT,           TvValidateNone()    )
...
QVAR_DEF_RO(OdString,             DWGNAME,          TvValidateNone()    )
...
QVAR_DEF_RO(OdString,             DWGPREFIX,        TvValidateNone()    )
...
QVAR_DEF_RO(ODTBOOL,              DWGTITLED,        TvValidateNone()    )

QVAR_DEF   (ODTDIST,              ELEVATION,        TvValidateNone()    )
QVAR_DEF_RO(OdGePoint3d,          EXTMAX,           TvValidateNone()    )
QVAR_DEF_RO(OdGePoint3d,          EXTMIN,           TvValidateNone()    )
...
QVAR_DEF_RO(ODTDIST,              FRONTZ,           TvValidateNone()    )
...
QVAR_DEF   (ODTBOOL,              GRIDMODE,         TvValidateBOOL()    )
...
QVAR_DEF   (OdGePoint2d,          GRIDUNIT,         TvValidateNone()    )

QVAR_DEF   (OdGePoint3d,          INSBASE,          TvValidateNone()    )
QVAR_DEF_RO(ODTDIST,              LENSLENGTH,       TvValidateNone()    )
QVAR_DEF   (ODTBOOL,              LIMCHECK,         TvValidateBOOL()    )
QVAR_DEF   (OdGePoint2d,          LIMMAX,           TvValidateNone()    )
QVAR_DEF   (OdGePoint2d,          LIMMIN,           TvValidateNone()    )
...
QVAR_DEF   (ODTANGLE,             SNAPANG,          TvValidateNone()    )
...
QVAR_DEF   (OdGePoint2d,          SNAPBASE,         TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              SNAPISOPAIR,      TvValidateNone()    )
...
QVAR_DEF   (ODTBOOL,              SNAPMODE,         TvValidateBOOL()    )
...
QVAR_DEF   (ODTBOOL,              SNAPSTYL,         TvValidateBOOL()    )
...
QVAR_DEF   (OdGePoint2d,          SNAPUNIT,         TvValidateNone()    )
...
/**
  ...
  <table>
    ...
    OdTvDbDatabase::getSysVar()
    &nbsp;
    OdTvDbHostAppServices::setSystemCodePage()    
  </table>
...
QVAR_DEF_RO(OdCodePageId,         SYSCODEPAGE,      TvValidateNone()    )
...
QVAR_DEF_RO(OdGePoint3d,          TARGET,           TvValidateNone()    )
...
QVAR_DEF   (ODTBOOL,              UCSFOLLOW,        TvValidateBOOL()    )
...
QVAR_DEF   (OdInt16,              UCSICON,          TvValidateNone()    )
...
QVAR_DEF   (ODTBOOL,              UCSVP,            TvValidateBOOL()    )

QVAR_DEF_RO(ODTUCSNAME,           UCSNAME,          TvValidateNone()    )
QVAR_DEF_RO(OdGePoint3d,          UCSORG,           TvValidateNone()    )
QVAR_DEF_RO(OdGeVector3d,         UCSXDIR,          TvValidateNone()    )
QVAR_DEF_RO(OdGeVector3d,         UCSYDIR,          TvValidateNone()    )
...
QVAR_DEF_RO(OdGePoint3d,          VIEWCTR,          TvValidateNone()    )
...
QVAR_DEF_RO(OdGeVector3d,         VIEWDIR,          TvValidateNone()    )
...
QVAR_DEF_RO(OdInt16,              VIEWMODE,         TvValidateNone()    )
...
QVAR_DEF_RO(ODTDIST,              VIEWSIZE,         TvValidateNone()    )
...
QVAR_DEF_RO(ODTORIENT,            VIEWTWIST,        TvValidateNone()    )
...
QVAR_DEF_RO(OdInt16,              WORLDUCS,         TvValidateNone()    )

QVAR_DEF_RO(OdString,             LOGINNAME,        TvValidateNone()    )
QVAR_DEF_RO(OdTvDbDate,             DATE,             TvValidateNone()    )
QVAR_DEF_RO(double,               CDATE,            TvValidateNone()    )
...
QVAR_DEF_RO(double,               CANNOSCALEVALUE,  TvValidateNone()    )
QVAR_DEF   (ODTBOOL,              ANNOALLVISIBLE,   TvValidateBOOL()    )
...
/**
  ...
  <table>
    ...
    OdTvDbDatabase::getSysVar()
    &nbsp;
    OdTvDbDatabase::getDIMANNO()
  </table>
  
  <group TD_SysVars_D>
*/
//<dom_var_def>bool DIMANNO;
QVAR_DEF_RO(ODTBOOL,              DIMANNO,          TvValidateNone()    )

/* TODO:
 GRIDMAJOR
*/

QVAR_DEF   (ODTBOOL,              PERSPECTIVE,      TvValidateNone()    )
QVAR_DEF   (OdInt16,              DIMUNIT,          TvValidateNone()    )
...
*/
QVAR_DEF   (OdInt16,              IMAGEFRAME,          TvValidateNone()    )
QVAR_DEF   (OdInt16,              FRAME,               TvValidateNone()    )
QVAR_DEF   (OdInt16,              PDFFRAME,            TvValidateNone()    )
QVAR_DEF   (OdInt16,              XCLIPFRAME,          TvValidateNone()    )
QVAR_DEF   (OdInt8,               DWFFRAME,            TvValidateNone()    )
QVAR_DEF   (OdInt8,               DGNFRAME,            TvValidateNone()    )
QVAR_DEF   (OdInt8,               OLEFRAME,            TvValidateNone()    )
QVAR_DEF   (OdInt16,              WIPEOUTFRAME,        TvValidateNone()    )
QVAR_DEF   (OdInt16,              POINTCLOUDCLIPFRAME, TvValidateNone()    )

QVAR_DEF   (ODTTEXTSTYLEID,       TEXTSTYLE,           TvValidateTextStyle())
QVAR_DEF   (double,               TEXTSIZE,            TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              GRIDDISPLAY,         TvValidateNone()    )
...
odPrintConsoleString(L"nGrid major = %d", major);
  ...
  <code>
OdRusBufPtr pRb = OdTvResBuf::newRb(OdTvResBuf::kRtInt16, 10);
...
QVAR_DEF   (OdInt16,              GRIDMAJOR,           TvValidateNone()    )

QVAR_DEF   (OdInt16,              VSBACKGROUNDS,       TvValidateNone()    )
...
QVAR_DEF   (OdString,             VSEDGECOLOR,         TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSEDGEJITTER,        TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSEDGELEX,           TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSEDGEOVERHANG,      TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSEDGES,             TvValidateNone()    )
...
odPrintConsoleString(L"nAngle = %d", angle);
  ...
  For example, to set the value:
  <code>
OdRusBufPtr pRb = OdTvResBuf::newRb(OdTvResBuf::kRtInt16, 90);
...
QVAR_DEF   (OdInt16,              VSEDGESMOOTH,        TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSFACECOLORMODE,     TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSFACEHIGHLIGHT,     TvValidateNone()    )
...
odPrintConsoleString(L"nTransparency level = %d", transparency);
  ...
  For example, to set the value:
  <code>
OdRusBufPtr pRb = OdTvResBuf::newRb(OdTvResBuf::kRtInt16, 50);
...
QVAR_DEF   (OdInt16,              VSFACEOPACITY,       TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSFACESTYLE,         TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSHALOGAP,           TvValidateNone()    )
...
odPrintConsoleString(L"nColor of intersection = %s", tint);
  ...
  For example, to set the value:
  <code>
OdRusBufPtr pRb = OdTvResBuf::newRb(OdTvResBuf::kRtString, L"128");
...
QVAR_DEF   (OdString,             VSINTERSECTIONCOLOR, TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSINTERSECTIONEDGES, TvValidateNone()    )
...
odPrintConsoleString(L"nIntersection linetype = %d", linetype);
  ...
  For example, to set the value:
  <code>
OdRusBufPtr pRb = OdTvResBuf::newRb(OdTvResBuf::kRtInt16, 5);
...
QVAR_DEF   (OdInt16,              VSINTERSECTIONLTYPE, TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSISOONTOP,          TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSLIGHTINGQUALITY,   TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSMATERIALMODE,      TvValidateNone()    )
...
QVAR_DEF   (OdString,             VSMONOCOLOR,         TvValidateNone()    )
...
QVAR_DEF   (OdString,             VSOBSCUREDCOLOR,     TvValidateNone()    )
...
odPrintConsoleString(L"nObscured edges display status = %d", status);
  ...
  For example, to set the value:
  <code>
OdRusBufPtr pRb = OdTvResBuf::newRb(OdTvResBuf::kRtInt16, 0);
...
QVAR_DEF   (OdInt16,              VSOBSCUREDEDGES,     TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSOBSCUREDLTYPE,     TvValidateNone()    )
...
QVAR_DEF   (OdString,             VSOCCLUDEDCOLOR,     TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSOCCLUDEDEDGES,     TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSOCCLUDEDLTYPE,     TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSSHADOWS,           TvValidateNone()    )
...
QVAR_DEF   (OdInt16,              VSSILHEDGES,         TvValidateNone()    )
...
odPrintConsoleString(L"nSilhouette width = %d", width);
  ...
  For example, to set the value:
  <code>
OdRusBufPtr pRb = OdTvResBuf::newRb(OdTvResBuf::kRtInt16, 12);
...
QVAR_DEF   (OdInt16,              VSSILHWIDTH,         TvValidateNone()    )
...
/**
  ...
  <table>
   ...
   viewport (OdTvDbViewport or OdTvDbViewportTableRecord) depending
  ...
  <table>
   ...
   viewport (OdTvDbViewport if a paper layout is active or
   OdViewportTableRecord if model space is active). See also
   OdTvDbAbstractViewportData::navvcubeddisplay() and
   OdTvDbAbstractViewportData::setNavvcubeddisplay() methods.
...
QVAR_DEF   (OdInt16,              NAVVCUBEDISPLAY,     TvValidateRange(0, 3))
...
/**
  ...
  <table>
    ...
    OdTvDbAbstractViewTableRecord::isDefaultLightingOn()
    OdTvDbAbstractViewTableRecord::setDefaultLightingOn()
    OdTvDbViewport::isDefaultLightingOn()
    OdTvDbViewport::setDefaultLightingOn()
  </table>   
   
  <group TD_SysVars_D>
  */
//<dom_var_def>OdInt16 DEFAULTLIGHTING;
QVAR_DEF   (OdInt16,              DEFAULTLIGHTING,     TvValidateRange(0, 1))
...
/**
  ...
  <table>
    ...
    OdTvDbAbstractViewTableRecord::defaultLightingType()
    OdTvDbAbstractViewTableRecord::setDefaultLightingType()
    OdTvDbViewport::defaultLightingType()
    OdTvDbViewport::setDefaultLightingType()
  </table>
   
  <group TD_SysVars_D>
  */
//<dom_var_def>OdInt16 DEFAULTLIGHTINGTYPE;
QVAR_DEF   (OdInt16,              DEFAULTLIGHTINGTYPE, TvValidateRange(0, 1))
...
/**
  ...
  <table>
    <b>Access Methods</b>
    OdTvDbDatabase::getSysVar()
    OdTvDbDatabase::isEMR()
  </table>
  <group TD_SysVars_S>
*/
//<dom_var_def>bool STUDENTDRAWING;
QVAR_DEF_RO(ODTBOOL,              STUDENTDRAWING,        TvValidateNone()    )
