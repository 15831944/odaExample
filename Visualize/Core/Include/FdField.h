...
public:
  ...
  */
  virtual const OdString evaluatorId(OdTvDbField* pField) const = 0;
  /** \details
  ...
  */
  virtual OdResult initialize(OdTvDbField* pField) const = 0; 
...
//    The field framework calls this method to compile a field when the field code is changed.   
  ...
  */
  virtual OdResult compile(OdTvDbField* pField, 
    OdTvDbDatabase* pDb,
...
//    to be evaluated.
  ...
  /** \details
    ...
    \param nContext [in]  Input context in which the field is evaluated; this context flag is passed to the evaluator and can be one of the predefined OdTvDbField::EvalContext enum flags or a user-defined context flag 
  ...
  */
  virtual OdResult evaluate(OdTvDbField* pField, 
    int nContext, 
    OdTvDbDatabase* pDb, 
    OdFdFieldResult* pResult) const = 0;
...
//      to get the evaluated field value as a string. The evaluator can 
  ...
  */
  virtual OdResult format(OdTvDbField* pField, OdString& pszValue) const = 0;
};
...
*/
DBENT_EXPORT OdFdFieldEnginePtr odtvdbGetFieldEngine();

DBENT_EXPORT OdString odtvdbGetFieldEngineValueByError(const OdString& sPrevValue);
DBENT_EXPORT OdString odtvdbSetFieldEngineValueFormatByError(
...
public:
  ...
  */
  virtual void setEvaluationStatus(OdTvDbField::EvalStatus errorStatus, int errorCode = 0, const OdString& errorMessage = OdString()) = 0;
};
...
public:
  ...
  */
  virtual OdResult getSheetSetProperty(OdString& propValue, OdTvDbField* pField, OdTvDbDatabase* pDb) = 0;
  ...
  */
  virtual bool parseObjProp(const OdString& prop, OdTvDbDatabase* pDb, OdTvDbObjectId& objId, OdString& propName) = 0;
  ...
  /** \details
    ...
    Returns 'true' on success, otherwise returns 'false'.
  */
  virtual bool getObjPropValue(const OdString& propName, OdInt32 paramId, const OdTvDbObjectId& objId, OdFdFieldResult& result) = 0;
  ...
  /** \details
    ...
    Returns pointer to the current OdTvDbDatabase object.
  */
  virtual OdTvDbDatabase* getCurrentDb() = 0;

  /** \details
    Returns the name of the file associated with this database object.
    Differs from the current behavior of OdTvDbDatabase::getFilename(),
    which returns autobackup filename, because OdTvDbDatabase::writeFile()
    always sets m_currentFileName.

    \param pDb [in]  database
  */
  virtual OdString getFileName(OdTvDbDatabase* pDb) = 0;
  ...
  */
  ...
  /** \details
  Returns OdTvDbTable entity ID which is supposed to be the owner of the field object.
  ...
  */
  virtual OdTvDbObjectId getOwnerTable(const OdTvDbField* field) = 0;
};
...
/** \details
    ...
    \param nContext [in]  Input context in which the field is evaluated, which can be a predefined *OdTvDbField::EvalContext* enum flag or a user-defined context flag; this context flag is passed to the evaluator
...
*/
DBENT_EXPORT OdResult odtvdbEvaluateFields( 
  OdTvDbDatabase* pDb,
  int nContext,
