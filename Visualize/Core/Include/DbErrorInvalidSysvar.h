...
/** \details
    ...
    <group Error_Classes> 
*/
class TOOLKIT_EXPORT OdError_TvInvalidSysvarValue : public OdError
{
public:
  ...
  */
  OdError_TvInvalidSysvarValue(const OdString& name);
  OdError_TvInvalidSysvarValue(const OdString& name, int limmin, int limmax);
  OdError_TvInvalidSysvarValue(const OdString& name, double limmin, double limmax);
#if OD_SIZEOF_LONG == 4
  OdError_TvInvalidSysvarValue(const OdString& name, OdInt32 limmin, OdInt32 limmax);
#endif
  OdTvResBufPtr limmin() const;
  /** \details
    Returns the upper limit for the Sysvar associated with this OdError object.
  */
  OdTvResBufPtr limmax() const;
  /** \details
...
/** \details
    ...
    <group Error_Classes> 
*/
class TOOLKIT_EXPORT OdError_TvUnknownSysvar : public OdError
{
public:
  /** \param name [in]  Name of Sysvar.
  */
  OdError_TvUnknownSysvar(const OdString& name);
  /** \details
    Returns the name of the Sysvar associated with this OdError object.
  */
  OdString name() const;
...
/** \details
    ...
    <group Error_Classes> 
*/
class TOOLKIT_EXPORT OdError_TvModelSpaceSysvar : public OdError
{
public:
  /** \param name [in]  Name of Sysvar.
  */
  OdError_TvModelSpaceSysvar(const OdString& name);
  /** \details
    Returns the name of the Sysvar associated with this OdError object.
  */
  OdString name() const;
