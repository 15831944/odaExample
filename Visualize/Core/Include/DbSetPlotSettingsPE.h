...
/** \details
This class is a plot settings protocol extension class. The methods of the OdTvDbSetPlotSettingsPE provide the direct access to OdTvDbPlotSettings fields. 
Unlike the OdTvDbPlotSettingsValidator class, which can also be used for defining plot settings, OdTvDbSetPlotSettingsPE allows you to set data without validation.
<group OdTvDb_Classes> 

*/
class TOOLKIT_EXPORT OdTvDbSetPlotSettingsPE : public OdRxObject
{
public:
  //DOM-IGNORE-BEGIN
  ODRX_DECLARE_MEMBERS(OdTvDbSetPlotSettingsPE);
  //DOM-IGNORE-END
  ...
  */
  virtual OdResult setPlotCfgName(OdTvDbPlotSettings *pPlotSettings, const OdString &plotCfgName);
  ...
  /** \details
	...
	\returns Returns eOk if successful or an appropriate error code otherwise. 
  */
  virtual OdResult setPlotLayoutFlags(OdTvDbPlotSettings *pPlotSettings, OdInt16 flags);
  ...
  /** \details
	...
	\returns Returns eOk if successful or an appropriate error code otherwise.
  */
  virtual OdResult setMargins(OdTvDbPlotSettings *pPlotSettings, double left, double Bottom, double right, double top);
  ...
  /** \details
	...
	\returns Returns eOk if successful or an appropriate error code otherwise.
  */
  virtual OdResult setPlotPaperSize(OdTvDbPlotSettings *pPlotSettings, double paperWidth, double paperHeight);
  ...
  /** \details
    ...
    \returns Returns eOk if successful or an appropriate error code otherwise.
  */
  virtual OdResult setMediaName(OdTvDbPlotSettings *pPlotSettings, OdString mediaName);
  ...
  /** \details
	...
	\returns Returns eOk if successful or an appropriate error code otherwise.
  */
  virtual OdResult setOrigin(OdTvDbPlotSettings *pPlotSettings, const OdGePoint2d &origin);
  ...
  /** \details
	...
	\returns Returns eOk if successful or an appropriate error code otherwise.
  */
  virtual OdResult setPlotPaperUnits(OdTvDbPlotSettings *pPlotSettings, OdTvDbPlotSettings::PlotPaperUnits units);
  ...
  /** \details
	...
	\returns Returns eOk if successful or an appropriate error code otherwise.
  */
  virtual OdResult setPlotRotation(OdTvDbPlotSettings *pPlotSettings, OdTvDbPlotSettings::PlotRotation plotRotation);
  ...
  /** \details
	...
	\returns Returns eOk if successful or an appropriate error code otherwise.
  */
  virtual OdResult setPlotType(OdTvDbPlotSettings *pPlotSettings, OdTvDbPlotSettings::PlotType plotType);
  ...
  /** \details
	...
	\returns Returns eOk if successful or an appropriate error code otherwise.
  */
  virtual OdResult setPlotWindowArea(OdTvDbPlotSettings *pPlotSettings, double xmin, double ymin, double xmax, double ymax);
  ...
  /** \details
    ...
    \returns Returns eOk if successful or an appropriate error code otherwise.
  */
  virtual OdResult setPlotView(OdTvDbPlotSettings* pPlotSettings, OdTvDbObjectId plotViewId);
  ...
  /** \details
	...
	\returns Returns eOk if successful or an appropriate error code otherwise.
  */
  virtual OdResult setPrintScale(OdTvDbPlotSettings* pPlotSettings, double numerator, double denominator);
  ...
  /** \details
	...
	\returns Returns eOk if successful or an appropriate error code otherwise.
  */
  virtual OdResult setStyleSheet(OdTvDbPlotSettings* pPlotSettings, OdString styleSheet);
  ...
  /** \details
	...
	\returns Returns eOk if successful or an appropriate error code otherwise.
  */
  virtual OdResult setScaleType(OdTvDbPlotSettings* pPlotSettings, OdTvDbPlotSettings::StdScaleType scaleType);
  ...
  */
  virtual OdResult setScaleFactor(OdTvDbPlotSettings* pPlotSettings, double dScaleFactor);
};

/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbSetPlotSettingsPE object pointers.
*/
typedef OdSmartPtr<OdTvDbSetPlotSettingsPE> OdTvDbSetPlotSettingsPEPtr;
