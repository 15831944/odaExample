...
/** \details
    This class implements Iterator objects that traverse OdTvDbLongTransaction worksets.

    <group OdTvDb_Classes> 
*/
class ODRX_ABSTRACT TOOLKIT_EXPORT OdTvDbLongTransWorkSetIterator : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbLongTransWorkSetIterator);
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbLongTransWorkSetIterator object pointers.
*/
typedef OdSmartPtr<OdTvDbLongTransWorkSetIterator> OdTvDbLongTransWorkSetIteratorPtr;
...
/** \details
    ...
    and returns the object ID of the OdTvDbLongTransaction object. Destruction of the
    OdTvDbLongTransaction object is handled by the database.

    <group OdTvDb_Classes> 
*/
class TOOLKIT_EXPORT OdTvDbLongTransaction : public OdTvDbObject
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbLongTransaction);

  OdTvDbLongTransaction();
  ...
  */
  OdTvDbObjectId originBlock() const;

  /** \details
    Returns the object ID of the block to which the entities are cloned.
  */
  OdTvDbObjectId destinationBlock() const;
  ...
  */
  OdResult addToWorkSet(OdTvDbObjectId ObjectId);
  /** \details
    ...
    Returns eOk if successful, or an appropriate error code if not.   
  */
  OdResult removeFromWorkSet(OdTvDbObjectId id);
  ...
  */
  OdTvDbLongTransWorkSetIteratorPtr newWorkSetIterator(
    bool incRemovedObjs = false, 
  ...
  */
  OdTvDbObjectId originObject(
    OdTvDbObjectId workSetId) const;
  ...
  */
  bool workSetHas(OdTvDbObjectId 
    ObjectId, 
    bool getErased = false) const;
  
  /** \details
    Returns a pointer to the OdTvDbMapping object used for OdLongTransationReactor callbacks used for checkin/checkout.
  */
  OdTvDbIdMapping* activeIdMap();

  void applyPartialUndo(OdTvDbDwgFiler* pUndoFiler, OdRxClass* pClassObj);
  virtual OdResult dwgInFields(OdTvDbDwgFiler* pFiler);
  virtual void dwgOutFields(OdTvDbDwgFiler* pFiler) const;
  virtual OdResult subErase(bool erasing);
};

typedef OdSmartPtr<OdTvDbLongTransaction> OdTvDbLongTransactionPtr;
