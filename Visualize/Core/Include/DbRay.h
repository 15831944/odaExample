...
*/
class DBENT_EXPORT OdTvDbRay : public OdTvDbCurve
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbRay);
  ...
  */
  ...
  /** \details
    ...
    OdTvDbRay::getPlane(), OdTvDbEntity::isPlanar() methods
  */
  ...
  /** \details
    ...
    OdTvDbRay::isPlanar(), OdTvDbEntity::getPlane() methods
  */
...
/** \details
  ...
  is specialization of the OdSmartPtr class for the OdTvDbRay class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbRay> OdTvDbRayPtr;
