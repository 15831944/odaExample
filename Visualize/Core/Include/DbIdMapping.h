...
/** \details
This template class is a specialization of the OdSmartPtr class for OdTvDbIdMapping object pointers.
*/
typedef OdSmartPtr<OdTvDbIdMapping> OdTvDbIdMappingPtr;

/** \details
    This class is the element class for OdTvDbMapping, 
...
{
public:
  /** \param source [in]  OdTvDbIdPair to be copied.
  ...
  */
  OdTvDbObjectId key() const { return m_Key; } 

  /** \details
    Returns the value for this IdPair object.
  */
  OdTvDbObjectId value() const { return m_Value; }
  ...
  */
  void setKey(
    const OdTvDbObjectId& key) { m_Key = key; }
  ...
  */
  void setValue(
    const OdTvDbObjectId& value) { m_Value = value; }
...
private:
  OdTvDbObjectId m_Key;
  OdTvDbObjectId m_Value;
  bool m_bCloned;
  bool m_bOwnerXlated;
  bool m_bPrimary;
};

class OdTvDbIdMappingIter;

/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbIdMappingIter object pointers.
*/
typedef OdSmartPtr<OdTvDbIdMappingIter> OdTvDbIdMappingIterPtr;
...
namespace OdDb
{
  enum DeepCloneType
  {
    ...
    kDcWblock         = 7,    // Wblock
    kDcObjects        = 8,    // OdTvDbDatabase::deepCloneObjects()
...
/** \details
    This class is used in deepclone operations to map, using OdTvDbIdPair objects,
    Object IDs from the original objects to their clones.
    ...
    \remarks
    There is no mechanism to clear all the mappings in an OdTvDbIdMapping instance; a new
    instance must be created for each deepclone operation.

    <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbIdMapping : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbIdMapping);

  OdTvDbIdMapping() {}
  
  static OdTvDbIdMappingPtr createObject(OdDb::DeepCloneType);
  ...
  */
  virtual OdTvDbDatabase* origDb() const = 0;
  ...
  */
  virtual OdTvDbObjectId insertingXrefBlockId() const = 0;
...
/** \details
    ...
    traverse OdTvDbIdPair records in OdTvDbIdMapping instances.

    \sa
    TD_Db
  
    \remarks
    Instances are returned by OdTvDbIdMapping::newIterator().

    <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbIdMappingIter : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbIdMappingIter);
