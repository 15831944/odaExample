...
/** \details
    This class represents a visual style (a collection of properties) in an OdTvDbDatabase instance.

    <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbVisualStyle : public OdTvDbObject
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbVisualStyle);
  ...
  */
  ...
  /** \details
      Sets a color property of the visual style by the given OdTvCmColor value.

      \param prop [in]  OdGiVisualStyleProperties::Property to set.
      \param pColor [in]  Pointer to the OdTvCmColor value to set.
      \param op [in]  OdGiVisualStyleOperations::Operation to use for setting the property. 
  */
  void setTrait(OdGiVisualStyleProperties::Property prop, const OdTvCmColor *pColor,
                OdGiVisualStyleOperations::Operation op = OdGiVisualStyleOperations::kSet);
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbVisualStyle object pointers.
*/
typedef OdSmartPtr<OdTvDbVisualStyle> OdTvDbVisualStylePtr;
