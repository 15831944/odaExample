...
TOOLKIT_EXPORT OdRxClass* odtvdbDwgClassMapDesc(OdUInt16 nDwgType);
...
# define CLASSDEF(DWGTYPE,ClassName, BaseClassName,DwgVer,MaintVer,DxfName,AppName,ProxyFlags,CustomFlags)\
  kDwgId_OdTvDb##ClassName = DWGTYPE,
...
# undef __DUMMY_
  ...
  kDwgId_OdTvDbProxyObject  = kOdDbDwgClassMapSize,
  kDwgId_OdTvDbProxyEntity,
  kDwgId_OdTvDbVertex,
  kDwgId_OdTvDbDimension,
...
public:                                                                                              \
  ...
  static OdRxClass* desc() { return ::odtvdbDwgClassMapDesc(kDwgId_##ClassName); }                     \
                                                                                                     \
