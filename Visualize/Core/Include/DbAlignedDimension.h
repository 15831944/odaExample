...
/** \details
    This class represents Aligned Dimension entities in an OdTvDbDatabase instance.
...
*/
class DBDIM_EXPORT OdTvDbAlignedDimension : public OdTvDbDimension
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbAlignedDimension);
  
  OdTvDbAlignedDimension();
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbAlignedDimension object pointers.
*/
typedef OdSmartPtr<OdTvDbAlignedDimension> OdTvDbAlignedDimensionPtr;
