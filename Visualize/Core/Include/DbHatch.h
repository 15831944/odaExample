...
/** \details
    This class represents Hatch entities in an OdTvDbDatabase instance.
...
*/
class DBENT_EXPORT OdTvDbHatch : public OdTvDbEntity
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbHatch);
  ...
  */
  ...
  /** \details
    ...
    \param loopType [in]  Type of loop being appended.
    \param dbObjIds [in]  Array of OdTvDbEntity Object IDs that comprise the loop.
  ...
  */
  void appendLoop(
    OdInt32 loopType, 
    const OdTvDbObjectIdArray& dbObjIds);
  ...
  */
  void getAssocObjIdsAt(
    int loopIndex, 
    OdTvDbObjectIdArray& dbObjIds) const;
  ...
  */
  OdTvDbHatch::HatchPatternType patternType() const;
  ...
  */
  void setPattern(
    OdTvDbHatch::HatchPatternType patType, 
 ...
 */
  ...
  */
  OdTvDbHatch::HatchStyle hatchStyle() const;
  ...
  */
  void setHatchStyle(
    OdTvDbHatch::HatchStyle hatchStyle);
  ...
  */
  ...
  OdTvDbObjectPtr decomposeForSave(
    OdDb::DwgVersion ver,
  ...
  */
  OdTvDbHatch::HatchObjectType hatchObjectType() const;
  ...
  */
  void setHatchObjectType(
    OdTvDbHatch::HatchObjectType hatchObjectType);
  ...
  */
  OdTvDbHatch::GradientPatternType gradientType() const;
  ...
  */
  void setGradient(
    OdTvDbHatch::GradientPatternType gradientType, 
  ...
  */
  virtual OdTvDbRegionPtr getRegionArea() const;
  ...
  */
  static OdResult makeClosedLoop(EdgeArray& edgePtrs, const OdTvDbObjectIdArray& dbObjIds, const OdGeTol& gapTolerance, const bool& isEdgeArrayConsistent);
  ...
  /** \details
    ...
    Use makeClosedLoop to mark loop and recalculate by OdTvDbHatch::updateMarkedLoops() if OdTvDbHatchWatcherPE(or derived) classes implemented.
  */
  ...
  */
  ...
  /** \details
    ...
    \remarks
    Returns an array containing loop indices written with OdTvDbHatch::markModifiedLoop
  */
  ...
  /** \details
    ...
    \remarks
    Clear recalculate loop list written with OdTvDbHatch::markModifiedLoop.
  */
  ...
  /** \details
    ...
    \returns eOk if recalculation is success. 
             ...
             eEmptySet if recalculate loop list is empty (use OdTvDbHatch::markModifiedLoop to fill this list)

    \remarks
    To mark loops use OdTvDbHatch::markModifiedLoop.
  */
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbHatch object pointers.
*/
typedef OdSmartPtr<OdTvDbHatch> OdTvDbHatchPtr;

DBENT_EXPORT EdgeArray odtvdbCreateEdgesFromEntity(const OdTvDbEntity* pEnt, const OdGePlane& hatchPlane, const bool bLeadToXAxis = false);
