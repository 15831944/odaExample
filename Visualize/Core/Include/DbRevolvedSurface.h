...
*/
class DBENT_EXPORT OdTvDbRevolvedSurface: public OdTvDbSurface
{
public:
  OdTvDbRevolvedSurface ();
  ODDB_DECLARE_MEMBERS(OdTvDbRevolvedSurface);
  ...
  */
  ...
  Revolve options are stored in the passed OdTvDbRevolveOptions object.  
  
  \param revolveOptions [out]  A passed-in parameter for returning current revolve options.
  */
  void getRevolveOptions ( OdTvDbRevolveOptions& revolveOptions ) const;
  
  /** \details
  Sets the revolve options for the surface.
  
  \param revolveOptions [in]  An OdTvDbRevolveOptions object with the new values of revolution options to be set.
  
  \remarks
  This method is implemented only for Spatial modeler and returns eNotImplementedYet status
  for other modelers. 
  */
  void setRevolveOptions ( const OdTvDbRevolveOptions& revolveOptions );
  ...
  */
  void setRevolve ( const OdGePoint3d& axisPnt, const OdGeVector3d& axisVec,
    double revAngle, const OdTvDbRevolveOptions& revolveOptions );
...
/** \details
This template class is a specialization of the OdSmartPtr class for OdTvDbRevolvedSurface object pointers.
*/
typedef OdSmartPtr<OdTvDbRevolvedSurface> OdTvDbRevolvedSurfacePtr;
