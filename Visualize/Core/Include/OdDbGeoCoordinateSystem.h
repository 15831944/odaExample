...
class OdTvDbGeoCoordinateSystemCategory;
class OdTvDbGeoCoordinateSystem;
class OdTvDbGeoCoordinateSystemTransformer;
typedef OdSmartPtr<OdTvDbGeoCoordinateSystemCategory> OdTvDbGeoCoordinateSystemCategoryPtr;
typedef OdSmartPtr<OdTvDbGeoCoordinateSystem> OdTvDbGeoCoordinateSystemPtr;
typedef OdSmartPtr<OdTvDbGeoCoordinateSystemTransformer> OdTvDbGeoCoordinateSystemTransformerPtr;

struct OdTvDbGeoDatum
{
  OdString id;
  OdString desc;
};

struct OdTvDbGeoEllipsoid
{
  OdString id;
  OdString desc;
  double   polarRadius; 
...
struct OdTvDbGeoProjectionParameter
{
  OdString name;
  double   value;
};
...
*/
class TOOLKIT_EXPORT OdTvDbGeoCoordinateSystemCategory : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbGeoCoordinateSystemCategory);
  
  /** \details
    Default constructor.
  */
  OdTvDbGeoCoordinateSystemCategory();
  /** \details
    Virtual destructor.
  */
  virtual ~OdTvDbGeoCoordinateSystemCategory();
  ...
  */
  ...
  /** \details
    ...
    \param pCoordSys [in/out] Pointer to an OdTvDbGeoCoordinateSystem object.
        
    \returns Returns eOK if successful, or an appropriate error code if not.
  */
  virtual OdResult getCoordinateSystemAt(int index, OdTvDbGeoCoordinateSystemPtr& pCoordSys) const = 0;
  ...
  /** \details
    ...
    \returns Returns eOK if successful, or an appropriate error code if not.
  */
  static  OdResult createAll(OdArray<OdTvDbGeoCoordinateSystemCategoryPtr>& allCategories);
};
...
/** \details
  ...
  <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbGeoCoordinateSystem : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbGeoCoordinateSystem);
  ...
  */
  ...
  /** \details
    Default constructor.
  */
  OdTvDbGeoCoordinateSystem();
  /** \details
    Virtual destructor.
  */
  virtual ~OdTvDbGeoCoordinateSystem();
  /** \details
  ...
  */
  ...
  /** \details
    ...
    \returns Returns eOK if successful, or an appropriate error code if not. 
  */
  virtual OdResult getType(OdTvDbGeoCoordinateSystem::Type& type) const = 0;
  /** \details
  ...
  */
  virtual OdResult getUnit(OdTvDbGeoCoordinateSystem::Unit& unit) const = 0;
  /** \details
  ...
  */
  ...
  /** \details
    ...
    \returns Returns eOK if successful, or an appropriate error code if not.
  */
  virtual OdResult getProjectionCode(OdTvDbGeoCoordinateSystem::ProjectionCode& prjCode) const = 0;
  /** \details
    ...
    \returns Returns eOK if successful, or an appropriate error code if not.
  */
  virtual OdResult getProjectionParameters(OdArray<OdTvDbGeoProjectionParameter>& prjParams,
  ...
  /** \details
    ...
    \returns Returns eOK if successful, or an appropriate error code if not.
  */
  virtual OdResult getDatum(OdTvDbGeoDatum& datum) const = 0;
  /** \details
  ...
  */
  virtual OdResult getEllipsoid(OdTvDbGeoEllipsoid& ellipsoid) const = 0;
  /** \details
  ...
  */
  ...
  /** \details
    Creates and returns a new OdTvDbGeoCoordinateSystem object from the current virtual catalog.
  ...
  */
  static OdResult create(const OdString& coordSysIdOrFullDef, 
    OdTvDbGeoCoordinateSystemPtr& pCoordSys);
  /** \details
    Creates and returns a new OdTvDbGeoCoordinateSystem object for every existing, 
    ...
    \returns Returns eOK if successful, or an appropriate error code if not.
  */
  static OdResult createAll(const OdGePoint3d& geoPt, OdArray<OdTvDbGeoCoordinateSystemPtr>& allCoordSys);
  /** \details
    Creates and returns a new OdTvDbGeoCoordinateSystem object for every existing, 
  ...
  */
  static OdResult createAll(OdArray<OdTvDbGeoCoordinateSystemPtr>& allCoordSys,
    const OdTvDbGeoCoordinateSystemCategory* pCategory = NULL);
  ...
  */
  static OdString unitNameToString(OdTvDbGeoCoordinateSystem::Unit eUnit);
};
...
/** \details
  ...
  <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbGeoCoordinateSystemTransformer : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbGeoCoordinateSystemTransformer);
  /** \details
    Default constructor.
  */
  OdTvDbGeoCoordinateSystemTransformer();
  /** \details
    Virtual destructor.
  */
  virtual ~OdTvDbGeoCoordinateSystemTransformer();
  /** \details
  ...
  */
  ...
  /** \details
    Creates a new OdTvDbGeoCoordinateSystemTransformer object from the source CRS and target CRS.
    
    \param sourceCoordSysId [in] Source CRS's ID.
    \param targetCoordSysId [in] Target CRS's ID.
    \param pCoordSysTransformer [out] New OdTvDbGeoCoordinateSystemTransformer object.
    
    \returns Returns eOK if successful, or an appropriate error code if not.
  */
  static OdResult create(const OdString& sourceCoordSysId, 
    const OdString& targetCoordSysId,
    OdTvDbGeoCoordinateSystemTransformerPtr& pCoordSysTransformer);
};
