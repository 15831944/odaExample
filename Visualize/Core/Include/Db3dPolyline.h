...
/** \details
    This class represents 3D Polyline entities in an OdTvDbDatabase instance.

    \sa
    TD_Db
    <group OdTvDb_Classes> 
*/
class DBENT_EXPORT OdTvDb3dPolyline: public OdTvDbCurve
{
public:

  DWGMAP_DECLARE_MEMBERS(OdTvDb3dPolyline);
  ...
  */
  OdTvDbObjectId appendVertex(
    OdTvDb3dPolylineVertex* pVertex);
  ...
  */
  OdTvDbObjectId insertVertexAt(
    const OdTvDb3dPolylineVertex* pIndexVert, 
    OdTvDb3dPolylineVertex* pVertex);
  ...
  */
  OdTvDb3dPolylineVertexPtr openVertex(
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDb3dPolyline object pointers.
*/
typedef OdSmartPtr<OdTvDb3dPolyline> OdTvDb3dPolylinePtr;
