...
*/
class TOOLKIT_EXPORT OdTvDbObjectContext : public OdRxObject
{
public:

  ODRX_DECLARE_MEMBERS(OdTvDbObjectContext);

  virtual ~OdTvDbObjectContext ();
...
typedef OdSmartPtr<OdTvDbObjectContext> OdTvDbObjectContextPtr;
