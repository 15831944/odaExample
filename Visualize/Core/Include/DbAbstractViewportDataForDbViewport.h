...
*/
class DBENT_EXPORT OdTvDbAbstractViewportDataForDbViewport : public OdTvDbAbstractViewportData
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAbstractViewportDataForDbViewport);
