...
/** \details
    This class represents OdTvDbPolygonMesh vertices in an OdTvDbDatabase instance.
...
*/
class DBENT_EXPORT OdTvDbPolygonMeshVertex: public OdTvDbVertex
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbPolygonMeshVertex);

  /** \remarks
    Newly created vertices are of type OdDb::k3dSimpleVertex.
  */
  OdTvDbPolygonMeshVertex();
