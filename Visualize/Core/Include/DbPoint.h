...
*/
class DBDIM_EXPORT OdTvDbPoint : public OdTvDbEntity
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbPoint);
  ...
  */
  OdTvDbPoint();
  OdTvDbPoint( const OdGePoint3d& gePoint );
  ...
  /** \details
    ...
    OdTvDbPoint::setPosition() method
  */
  ...
  */
  ...
  /** \details
    ...
    OdTvDbPoint::setThickness() method
  */
  ...
  */
  ...
  /** \details
    ...
    OdTvDbPoint::setEcsRotation() method
  */
  ...
  /** \details
    ...
    OdTvDbPoint::ecsRotation() method
  */
  ...
  /** \details
    ...
    OdTvDbPoint::getPlane(), OdTvDbEntity::isPlanar() method
  */
  ...
  /** \details
    ...
    OdTvDbPoint::isPlanar(), OdTvDbEntity::getPlane() methods
  */
...
/** \details
  ...
  is specialization of the OdSmartPtr class for the OdTvDbPoint class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbPoint> OdTvDbPointPtr;
