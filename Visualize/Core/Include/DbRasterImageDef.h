...
/** \details
    This virtual base class defines raster image definition objects in an OdTvDbDatabase instance.
    ...
    \remarks
    Raster image definitions (OdTvDbRasterImageDef objects) work with raster image (OdTvDbRasterImage) entities
    in much the same way that block table records (OdTvDbBlockTableRecord objects) work with block references
    (OdTvDbBlockReference entities).

    <group OdTvDb_Classes>
*/
class ISM_EXPORT OdTvDbRasterImageDef : public OdTvDbObject
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbRasterImageDef);

  typedef OdGiRasterImage::Units Units;

  OdTvDbRasterImageDef();
  ...
  */
  ...
  /** \details
    ...
    \param modifyDatabase [in]  If and only if true, marks the associated OdTvDbDatabase instance as modified.
  ...
  */
  ...
  /** \details
    Creates an image dictionary, if it is not already present, in the specified OdTvDbDatabase instance.
  ...
  */
  static OdTvDbObjectId createImageDictionary(OdTvDbDatabase* pDb);

  /** \details
    Returns the object ID of the image dictionary in the specified OdTvDbDatabase instance.
    \param pDb [in]  Pointer to the database.  
  */
  static OdTvDbObjectId imageDictionary(OdTvDbDatabase* pDb);
  ...
  */
  static OdString suggestName(const OdTvDbDictionary* pImageDictionary,
...
/** \details
    This class implements raster image definition reactor objects in an OdTvDbDatabase instance.
    
    \sa
    TD_Db
    
    \remarks
    Raster image definition reactor (OdTvDbRasterImageDefReactor) objects are used 
    to notify raster image (OdTvDbRasterImage) objects 
    of changes to their associated raster image definition (OdTvDbRasterImage) objects.
    ...
    <group OdTvDb_Classes>
*/
class ISM_EXPORT OdTvDbRasterImageDefReactor : public OdTvDbObject
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbRasterImageDefReactor);

  OdTvDbRasterImageDefReactor();
  ...
  */
  ...
  /** \details
    Controls notifications of OdTvDbRasterImage object events.
  ...
  */
  ...
  /** \details
    Notification function called whenever an OdTvDbRasterImageDef object is about to be unloaded or erased.
    
    \param pImageDef [in]  Pointer to the OdTvDbRasterImageDef object sending this notification.
  ...
  */
  virtual bool onDeleteImage( 
    const OdTvDbRasterImageDef* pImageDef,
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbRasterImageDefReactor object pointers.
*/
typedef OdSmartPtr<OdTvDbRasterImageDefReactor> OdTvDbRasterImageDefReactorPtr;

/** \details
    This class implements raster image definition transient reactor objects in an OdTvDbDatabase instance.
    Corresponding C++ library: TD_Db
    <group OdTvDb_Classes>
*/
class ISM_EXPORT OdTvDbRasterImageDefTransReactor : public OdTvDbObjectReactor
{
protected:
  OdTvDbRasterImageDefTransReactor() {}
public:
  ODRX_DECLARE_MEMBERS(OdTvDbRasterImageDefTransReactor);
  ...
  /** \details
    ...
    <table>
    Name                                 Value
    OdTvDbRasterImageDefReactor::kUnload   1
    OdTvDbRasterImageDefReactor::kErase    2
    </table>
  */
  virtual bool onDeleteImage( const OdTvDbRasterImageDef* pImageDef,
                              OdTvDbRasterImageDefReactor::DeleteImageEvent event,
...
/** \details
  <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbRasterImageDefFileAccessReactor : public OdTvDbObjectReactor
{
protected:
  OdTvDbRasterImageDefFileAccessReactor() {}
public:
  ODRX_DECLARE_MEMBERS(OdTvDbRasterImageDefFileAccessReactor);
  
  /** \details
    Function is called whenever a new raster image is about to attach to the current drawing.

    \param OdTvDbRasterImageDef  [in]  Input pointer to the affected RasterImageDef object.  	
    \param pPath  [in]  Input raster image file name.  	
  */
  virtual void onAttach(const OdTvDbRasterImageDef*, const OdString& pPath) = 0;
  ...
  /** \details
    ...
    \param pPath  [in]  Input raster image file name.  	
  */
  virtual void onDetach(const OdTvDbRasterImageDef*, const OdString& pPath) = 0;
  ...
  */
  virtual bool onOpen(const OdTvDbRasterImageDef*, const OdString& pPath,
  ...
  /** \details
    ...
    \param replacementPath  [in]  Input replacement raster image file name.  	
  */
  virtual bool onPathChange(const OdTvDbRasterImageDef*,
  ...
  /** \details
    ...
    \param pPath  [in]  Input saved raster image file name.  	
  */
  virtual void onClose(const OdTvDbRasterImageDef*, const OdString& pPath) = 0;
  ...
  */
  virtual void onDialog(OdTvDbRasterImageDef*,
...
inline OdTvDbObjectId OdTvDbRasterImageDef::createImageDictionary(OdTvDbDatabase* pDb) {
  if (!pDb)
    throw OdError(eNoDatabase);
  OdTvDbDictionaryPtr pRootDict;
  try
  {
    pRootDict = pDb->getNamedObjectsDictionaryId().safeOpenObject( OdDb::kForWrite );
  }
  catch( OdError& )
  {
    return OdTvDbObjectId();
  }
  OdTvDbObjectId ImgDictId = pRootDict->getAt(TV_ACAD_IMAGE_DICT);
  if (ImgDictId.isNull()) {
    OdTvDbObjectPtr pImgDict = OdTvDbDictionary::createObject();
    ImgDictId = pRootDict->setAt(TV_ACAD_IMAGE_DICT, pImgDict);
  }
  return ImgDictId;
}

inline OdTvDbObjectId OdTvDbRasterImageDef::imageDictionary(OdTvDbDatabase* pDb) {
  if (!pDb)
    throw OdError(eNoDatabase);
  OdTvDbDictionaryPtr pDict = pDb->getNamedObjectsDictionaryId().safeOpenObject();
  return pDict->getAt(TV_ACAD_IMAGE_DICT);
}

inline OdString OdTvDbRasterImageDef::suggestName(const OdTvDbDictionary* pDic, const OdString& strPath, int nMaxLength) {
  return pDic->suggestName(strPath, nMaxLength);
}

/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbRasterImageDef object pointers.
*/
typedef OdSmartPtr<OdTvDbRasterImageDef> OdTvDbRasterImageDefPtr;
