...
class OdTvDbSurface;
class OdTvDbNurbSurface;

/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbNurbSurface object pointers.
*/  
typedef OdSmartPtr<OdTvDbNurbSurface> OdTvDbNurbSurfacePtr;

/** \details
  This template class is a specialization of the OdArray class for OdTvDbSurface object pointer arrays.
*/
typedef OdArray<OdTvDbNurbSurfacePtr> OdTvDbNurbSurfacePtrArray;

/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbSurfacePtr object pointers.
*/
typedef OdSmartPtr<OdTvDbSurface> OdTvDbSurfacePtr;
...
*/
class DBENT_EXPORT OdTvDbSurface : public OdTvDbEntity
{
public:
  OdTvDbSurface();
  ODDB_DECLARE_MEMBERS(OdTvDbSurface);
  ...
  */
  ...
  /** \details
    ...
    for other modelers. 
  */
  static OdResult createFrom ( const OdTvDbEntity* pFromEntity, OdTvDbSurfacePtr& pNewSurface );

  /** \details
    Creates region (OdTvDbRegion class) entities for each face of the surface. 

    \param regions [out]  Reference to an array of the OdTvDbRegion entities created from the face of the surface.
  
    \returns Returns eOk if successful, or an appropriate error code otherwise.
    
    \remarks
    The surface must be planar. 
    Regions created by the method are not included in the database, so the caller is responsible for managing memory of the created OdTvDbRegion objects.
  ...
  */
  ...
  virtual OdTvDbEntityPtr subSubentPtr(const OdTvDbFullSubentPath& id) const;
  /** \details
    ...
    \param interferenceObjects [out]  Output array of interference entities, which can contain OdTvDbSurface or curve entities.
    \param pEntity             [in]   Pointer to an entity the surface must be interfered with. pEntity can point to the following entity types: OdTvDbSurface, OdTvDb3dSolid, OdTvDbRegion, or OdTvDbBody.
  ...
  */
  ...
  /** \details
    ...
    for other modelers. 
  */
  virtual OdResult booleanUnion(const OdTvDbSurfacePtr pSurface, OdTvDbSurfacePtr& pNewSurface);
  ...
  /** \details
    ...
    for other modelers. 
  */
  virtual OdResult booleanSubtract(const OdTvDbSurfacePtr pSurface, OdTvDbSurfacePtr& pNewSurface);
  ...
  /** \details
    ...
    for other modelers. 
  */
  virtual OdResult booleanSubtract(const OdTvDb3dSolidPtr pSolid, OdTvDbSurfacePtr& pNewSurface);
  ...
  /** \details
	...
	The resulting array can contain the following entity types: OdTvDbSurface, OdTvDbLine, OdTvDbCircle, OdTvDbArc, OdTvDbEllipse, and OdTvDbSpline.
    ...
    for other modelers. 
  */
  virtual OdResult booleanIntersect(const OdTvDbSurfacePtr pSurface2, OdTvDbEntityPtrArray& intersectionEntities);
  ...
  /** \details
	...
	The resulting array can contain the following types of entities: OdTvDbSurface, OdTvDbLine, OdTvDbCircle, OdTvDbArc, OdTvDbEllipse, and OdTvDbSpline.
    ...
    for other modelers. 
  */
  virtual OdResult booleanIntersect(const OdTvDb3dSolidPtr pSolid, OdTvDbEntityPtrArray& intersectionEntities);
  ...
  /** \details
	...
	The specified entity must one of the following types: OdTvDbCurve, OdTvDb3dSolid, OdTvDbSurface, OdTvDbBody, OdTvDbRegion, OdTvDbTrace, OdTvDbSolid, or OdTvDbFace.
    ...
    for other modelers. 
*/
  virtual OdResult imprintEntity(const OdTvDbEntityPtr pEntity);
  ...
  */
  virtual OdResult sliceByPlane(const OdGePlane& slicePlane,
                                OdTvDbSurfacePtr& pNegHalfSurface, 
                                OdTvDbSurfacePtr& pNewSurface);
  /** \details
    ...
    for other modelers. 
  */
  virtual OdResult sliceBySurface(const OdTvDbSurfacePtr pSlicingSurface, 
                                  OdTvDbSurfacePtr& pNegHalfSurface,
                                  OdTvDbSurfacePtr& pNewSurface);
  ...
  */
  ...
  virtual OdResult setSubentMaterial(const OdDbSubentId& subentId, const OdTvDbObjectId& matId);
  virtual OdResult getSubentMaterial(const OdDbSubentId& subentId, OdTvDbObjectId& matId) const;
  ...
  */
  static OdResult trimSurface(const OdTvDbObjectId&      blankSurfaceId, 
                              const OdTvDbObjectIdArray& toolIds,
  ...
  /** \details
    ...
    \param pEntityToProject 		[in] Pointer to the entity to be projected. If the entity to project is represented by an OdTvDbPoint object, an OdTvDbPoint object, representing the nearest point on the surface, is returned. 
    ...
    for other modelers. 
  */
  OdResult projectOnToSurface(const OdTvDbEntity*   pEntityToProject,
  ...
  */
  ...
  static OdResult createOffsetSurface ( OdTvDbEntity* pInputSurface,
                                        double dOffsetDistance,
                                        OdTvDbEntityPtr& offsetSurface);
  ...
  */
  ...
  static OdResult createOffsetSurface ( OdTvDbEntity* pInputSurface,
                                        double dOffsetDistance,
                                        bool  bAssociativeEnabled,
                                        OdTvDbObjectId& offsetSurfaceId);

  /** \details  
    This method is not implemented. 
  */
  static OdResult createFilletSurface ( const OdTvDbObjectId&  surfId1,
                                        const OdGePoint3d&   pickPt1,
                                        const OdTvDbObjectId&  surfId2,
                                        const OdGePoint3d&   pickPt2,
                                        double               dRadius,
                                        OdDb::FilletTrimMode trimMode,
                                        const OdGeVector3d&  projDir,
                                        OdTvDbSurface*&        filletSurface);
  ...
  */
  static OdResult createFilletSurface ( const OdTvDbObjectId&  surfId1,
                                        ...
                                        const OdGeVector3d&  projDir,
                                        bool                 bAssociativeEnabled,
                                        OdTvDbObjectId&        filletSurfaceId);

  /**  \details   
    This method is not implemented. 
  */
  static OdResult createExtendSurface ( OdTvDbObjectId                 sourceSurface, 
                                        const OdArray<OdDbSubentId>& edgesId,  
                                        double                       dExtDist, 
                                        EdgeExtensionType            extOption, 
                                        bool                         bAssociativeEnabled, 
                                        OdTvDbObjectId&                newExtendSurfaceId );

  /** \details
    This method is not implemented. 
  */
  OdResult extendEdges( OdTvDbFullSubentPathArray& edgesId,
                        double                   dExtDist, 
                        EdgeExtensionType        extOption, 
                        bool                     bAssociativeEnabled );
