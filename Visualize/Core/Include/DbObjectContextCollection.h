...
class OdTvDbObjectContextCollectionIterator;
typedef OdSmartPtr<OdTvDbObjectContextCollectionIterator> OdTvDbObjectContextCollectionIteratorPtr;

/** \details
    This class represents a collection of objects that have context items defined.

    \remarks
    Implement this interface and register it with OdTvDbObjectContextContextManager
...
*/
class TOOLKIT_EXPORT ODRX_ABSTRACT OdTvDbObjectContextCollection : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbObjectContextCollection);
   ...
   */
  virtual OdTvDbObjectContextPtr currentContext(
    const OdTvDbObject* pRequestingObject) const = 0;
   ...
   */
   virtual OdResult setCurrentContext(
    const OdTvDbObjectContext* pContext) = 0;
   ...
   */
  virtual OdTvDbObjectContextPtr getContext(
  ...
  */
   ...
   */
  virtual OdTvDbObjectContextCollectionIteratorPtr newIterator() const = 0;
};
...
/** \details
	...
	stored in a context collection (using the OdTvDbObjectContextCollections class).

    \remarks
    If an application supports context collections, you must implement this class. You
	can get an Iterator using OdTvDbObjectContextCollection::newIterator().
    ...
    <group OdTvDb_Classes> 
*/
class TOOLKIT_EXPORT ODRX_ABSTRACT OdTvDbObjectContextCollectionIterator : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbObjectContextCollectionIterator);
  ...
  virtual bool done() const = 0;
   ...
   /** \details
	...
	Iterator.
   */
  virtual OdTvDbObjectContextPtr getContext() const = 0;
};
