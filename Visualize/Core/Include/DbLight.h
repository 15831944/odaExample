...
*/
class SCENEOE_EXPORT OdTvDbLight : public OdTvDbEntity
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbLight);

  /** \details
    Default constructor for the OdTvDbLight class. Creates an object with default properties of the OdTvDbLightImpl object. 
  */
  OdTvDbLight();
  ...
  */
  void setLightColor(const OdTvCmColor& color);
  ...
  */
  OdTvCmColor resultingColor() const;
  ...
  */
  ...
  /** \details
    Reads the .vsf file specific data of this object. 
  ...
  */
  ...
  /** \details
    Writes the .vsf file specific data of this object. 
...
/** \details
  A data type that represents a smart pointer to an <link OdTvDbLight, OdTvDbLight> object.
*/
typedef OdSmartPtr<OdTvDbLight> OdTvDbLightPtr;
