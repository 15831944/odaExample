...
class OdTvDbBlockReferenceImpl;
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbAttribute object pointers.
*/
typedef OdSmartPtr<OdTvDbAttribute> OdTvDbAttributePtr;
...
/** \details
    This class represents block references (Inserts) in an OdTvDbDatabase instance.
...
*/
class TOOLKIT_EXPORT OdTvDbBlockReference : public OdTvDbEntity
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbBlockReference);

  OdTvDbBlockReference();
  
  /** \details
    Returns the Object ID of the block table record associated with this OdTvDbBlockReference (DXF 2).
  */
  OdTvDbObjectId blockTableRecord() const;

  /** \details
    Sets the Object ID of the block table record associated with this OdTvDbBlockReference (DXF 2).
  ...
  */
  ...
  /** \details
    Appends the specified OdTvDbAttribute to the attribute list of this block reference.
  ...
  */
  OdTvDbObjectId appendAttribute(
    OdTvDbAttribute* pAttr);
  ...
  */
  OdTvDbAttributePtr openAttribute(
    OdTvDbObjectId ObjId,
    OdDb::OpenMode mode, 
    bool openErasedOne = false);

  /** \details
    Opens the OdTvDbSequenceEnd entity for this block reference.
  ...
  */
  OdTvDbObjectIteratorPtr attributeIterator() const;
  ...
  */
  virtual OdResult explodeToBlock(
    OdTvDbBlockTableRecord *BlockRecord, 
  ...
  */
  ...
  /** \details
    ...
    returned. 
    4) Call the OdTvDbDwgFiler(pFiler) methods to read each of the object's data items in the 
  ...
  */
  ...
  /** \details
    ...
    returned. 
    4) Call the OdTvDbDxfFiler(pFiler) methods to read each of the object's data items in the 
    order they were written. 
    5) Return pFiler->filerStatus().
  */
 ...
 */
  ...
  /** \details
    ...
    3) Use pFiler to call the OdTvDbDxfFiler methods to write each of the object's data items in 
  ...
  */    
  ...
  /** \details
    This is subGetTransformedCopy, a member of class OdTvDbBlockReference.
  ...
  */
  ...
  /** \details
    This is treatAsOdTvDbBlockRefForExplode, a member of class OdTvDbBlockReference.
    Determines how the entity should be exploded.  
  */
  virtual bool treatAsOdTvDbBlockRefForExplode() const;
  ...
  */
  ...
  /** \details
    ...
    which owns the current OdTvDbBlockReference object that calls this method. 
  ...
  */
  ...
  /** \details
    This is subGetSubentPathsAtGsMarker, a member of class OdTvDbBlockReference.
    ...
    \param subentPaths [out] Array of OdTvDbFullSubentPath objects.
 ...
 */
  ODRX_SEALED_VIRTUAL OdResult subGetSubentPathsAtGsMarker(OdDb::SubentType type,
                                    ...
                                    const OdTvDbObjectIdArray* pEntAndInsertStack) const ODRX_OVERRIDE;
  
  /** \details
    This is subGetGsMarkersAtSubentPath, a member of class OdTvDbBlockReference.
    ...
    Returns eOk if successful, or an appropriate error code if not. 
  */ 
  ODRX_SEALED_VIRTUAL OdResult subGetGsMarkersAtSubentPath(const OdTvDbFullSubentPath& subPath, 
                                    OdGsMarkerArray& gsMarkers) const ODRX_OVERRIDE;
};
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbBlockReference object pointers.
*/
typedef OdSmartPtr<OdTvDbBlockReference> OdTvDbBlockReferencePtr;

TOOLKIT_EXPORT void tvDecompTransform(
...
TOOLKIT_EXPORT void tvDecompTransform(
    ...
    const OdTvDbBlockTableRecordPtr pBlockTableRecord);
