...
/** \details
    This class represents Attribute entities in an OdTvDbDatabase instance.
...
*/
class DBENT_EXPORT OdTvDbAttribute : public OdTvDbText
{
public:
  
  DWGMAP_DECLARE_MEMBERS(OdTvDbAttribute);
  OdTvDbAttribute();
  ...
  */
  ...
  /** \details
    ...
    blkXform is the transformation matrix returned by the OdTvDbBlockReference::blockTransform() function
    of the OdTvDbBlockReference that will own this attribute.
  */
  ...
  */ 
  virtual void setAttributeFromBlock(
    const OdTvDbAttributeDefinition* pAttDef, 
    const OdGeMatrix3d& blkXform);
  ...
  */
  ...
  OdTvDbMTextPtr getMTextAttribute() const;
  void setMTextAttribute(OdTvDbMText*);
