...
public:
  ...
  OdValue(const OdTvDbObjectId& objectId);
  OdValue(const OdTvResBufPtr& resBuf);
  ...
  */
  ...
  OdValue& operator=(const OdTvDbObjectId& objectId);
  OdValue& operator=(const OdTvResBufPtr& resBuf);
  ...
  */
  ...
  /** \details
      ...
      Returns true if and only if successful.
  */
  bool get(OdTvDbObjectId& objectId) const;
  /** \details
      Returns the value of this FieldValue object.
      ...
      Returns true if and only if successful.
  */
  bool get(OdTvResBufPtr& resBuf) const;
  ...
  */
  ...
  /** \details
      ...
      Returns true if and only if successful.
  */
  bool set(const OdTvDbObjectId& objectId);
  /** \details
      Sets the value for this FieldValue object.
      ...
      Returns true if and only if successful.
  */
  bool set(const OdTvResBufPtr& resBuf);
...
//                                             const AcTvDbObjectId* pTextStyleId);
// 

  OdString  format(OdTvDbDatabase* pDb = 0) const;
  OdString format(OdValue::FormatOption nOption, OdTvDbDatabase* pDb = 0);
  OdString format(const OdString& pszFormat, OdValue::FormatOption nOption, OdTvDbDatabase* pDb = 0);
  bool format(const OdString& pszFormat, OdString& pszValue, OdTvDbDatabase* pDb = 0) const;
