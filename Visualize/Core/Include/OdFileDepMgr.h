...
/** \details
    ...
    <group Other_Classes> 
*/
class TOOLKIT_EXPORT OdTvFileDependencyInfo : public OdRxObject
{
protected:
  OdTvFileDependencyInfo();

public:
  ODRX_DECLARE_MEMBERS(OdTvFileDependencyInfo);
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvFileDependencyInfo object pointers.
*/
typedef OdSmartPtr<OdTvFileDependencyInfo> OdFileDependencyInfoPtr;
...
/** \details
    ...
    \remarks
    Every OdTvDbDatabase instance has permanently associated with it an instance of the this class.
    <group Other_Classes> 
*/
class TOOLKIT_EXPORT OdTvFileDependencyManager : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvFileDependencyManager);

  OdTvFileDependencyManager() {};
