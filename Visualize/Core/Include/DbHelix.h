...
/** \details
    ...
    This class represents Helix entities in an OdTvDbDatabase instance.

    Corresponding C++ library: TD_Db
*/
class DBENT_EXPORT OdTvDbHelix : public OdTvDbSpline
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbHelix);
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbHelix object pointers.
*/
typedef OdSmartPtr<OdTvDbHelix> OdTvDbHelixPtr;
