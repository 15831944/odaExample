...
/** \details
    This class is the base class of Protocol Extension classes for OdTvDbViewport and OdTvDbViewportTableRecord objects.
    ...
    *  OdTvDbViewport
    *  OdTvDbViewportTableRecord
    *  Derivatives of one of the above

    <group OdTvDb_Classes> 
*/
class TOOLKIT_EXPORT OdTvDbAbstractViewportData : public OdAbstractViewPE
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAbstractViewportData);
  ...
  */
  ...
  /** \details
    ...
    \param pViewport [in] Input pointer to the viewport object.
  */
  virtual OdTvCmColor ambientLightColor(const OdRxObject* pViewport) const = 0;
  /** \details
    Sets the ambient light color to the specified viewport object.
    \param pViewport [in] Input pointer to the viewport object.
    \param color [in] Input ambient light color.
  */
  virtual void setAmbientLightColor(OdRxObject* pViewport, const OdTvCmColor& color) const = 0;
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbAbstractViewportData object pointers.
*/
typedef OdSmartPtr<OdTvDbAbstractViewportData> OdTvDbAbstractViewportDataPtr;
...
public:
  ...
  {
    if ((m_pObj = OdTvDbObject::cast(pRxObj)).isNull())
      return;
