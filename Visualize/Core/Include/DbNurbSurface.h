...
/** \details
  This template class is a specialization of the OdArray class for OdTvDbCurve object pointer arrays.
*/
typedef OdArray<OdTvDbCurvePtr> OdTvDbCurvePtrArray;
...
*/
class DBENT_EXPORT OdTvDbNurbSurface : public OdTvDbSurface
{
public:
  /** \details 
    Creates an OdTvDbNurbSurface object.
  */
  OdTvDbNurbSurface ();
  //virtual ~OdTvDbNurbSurface();
  ODDB_DECLARE_MEMBERS(OdTvDbNurbSurface);
  ...
  */
  ...
  \returns Returns eOk if successful. If the surface doesn't contain any NURBS information, returns eFail. 
  */
  OdResult getIsolineAtU(double dU, OdTvDbCurvePtrArray& lineSegments) const;
  ...
  */
  OdResult getIsolineAtV(double dV, OdTvDbCurvePtrArray& lineSegments) const;
...
*/
  ...
  */
  OdResult convertFrom(OdTvDbSurface* pSource, OdDb::DwgVersion version, bool transferId = true);
  // Overridden methods from AcTvDbEntity
