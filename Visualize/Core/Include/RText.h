...
/** \details
    This class represents Reactive text (RText) entities in an OdTvDbDatabase instance.
    ...
    <group Other_Classes>
*/
class RTEXT_EXPORT RText : public OdTvDbEntity
{
public:
  ...
  */
  void setTextStyle(OdTvDbObjectId textStyleId);
  /** \details
    Sets the TextStyle of this RText entity.
