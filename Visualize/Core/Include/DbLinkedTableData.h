...
/** \details
  This class represents LinkedTableData objects in an OdTvDbDatabase instance.
...
*/
class DBENT_EXPORT OdTvDbLinkedTableData : public OdTvDbLinkedData
{
public:
  //DOM-IGNORE-BEGIN
  ODDB_DECLARE_MEMBERS(OdTvDbLinkedTableData);
  //DOM-IGNORE-END

  /** \details
    Default constructor. Creates an object of the OdTvDbLinkedTableData class.
  */
  OdTvDbLinkedTableData();
  ...
  */
  ...
  /** \details
    Returns the field ID of a cell as an object of the OdTvDbObjectId class.

    \param nRow [in]  Row index of the cell.
    \param nCol [in]  Column index of the cell.
    \returns Field ID of the cell.
  */
  virtual OdTvDbObjectId getFieldId(
    OdInt32 nRow, 
    OdInt32 nCol) const;
  ...
  */
  virtual OdTvDbFieldPtr getField(
    OdInt32 nRow, 
    OdInt32 nCol, 
    OdUInt32 nContent,
  ...
  /** \details
    ...
    object of the OdTvDbObjectId class.

    \param nRow [in]  Row index of the cell.
    \param nCol [in]  Column index of the cell.
    \returns ID of the block table record.
  */
  virtual OdTvDbObjectId getBlockTableRecordId(
    OdInt32 nRow, 
    OdInt32 nCol) const;

  /** \details
    Returns the ID of the block table record of the specified content of a cell
    as an object of the OdTvDbObjectId class.
  ...
  */
  virtual OdString getBlockAttributeValue(
    OdInt32 nRow, 
    OdInt32 nCol, 
    const OdTvDbObjectId& idAttDef) const;
  ...
  */
  ...
  /** \details
    Returns the data link  object ID (OdTvDbDataLink) for the specified row and column.

    \param nRow [in]  Row index of the cell.
    \param nCol [in]  Column index of the cell.
    \returns Data link  object ID.
  */
  virtual OdTvDbObjectId getDataLink(
    OdInt32 nRow, 
    OdInt32 nCol) const;
  ...
  */
  virtual OdTvDbDataLinkPtr getDataLink(
    OdInt32 nRow, 
    OdInt32 nCol, 
    OdDb::OpenMode mode) const;

  /** \details
    Returns the number of data links (OdTvDbDataLink) for the specified cell range.
  ...
  */
  ...
  /** \details
    Sets the data link object ID (OdTvDbDataLink) for the specified cell range.
  ...
  */
  virtual void copyFrom(const OdTvDbLinkedTableData* pSrc,
...
/** \details
  ...
  pointers to objects of the OdTvDbLinkedTableData class.
*/
typedef OdSmartPtr<OdTvDbLinkedTableData> OdTvDbLinkedTableDataPtr;
