...
/** \details
    ...
    This class represents Shape entities in an OdTvDbDatabase instance.
    ...
    OdTvDbMText, OdTvDbText classes
*/
class DBENT_EXPORT OdTvDbShape : public OdTvDbEntity
{
public:

  /*
    OdTvDbShape(const OdGePoint3d& position,
      double size,
      const OdChar* name,
      double rotation = 0,
  ...
  */
  ...
  DWGMAP_DECLARE_MEMBERS(OdTvDbShape);
 ...
 */
  ...
  */
  ...
  /** \details
    Returns the Object ID of the OdTvDbTextStyleTableRecord containing
  ...
  */
  OdTvDbObjectId styleId() const;

  /** \details
    Sets the Object ID of the OdTvDbTextStyleTableRecord containing
    the SHX font file for this Shape entity.
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbShape object pointers.
*/
typedef OdSmartPtr<OdTvDbShape> OdTvDbShapePtr;
