...
/** \details
    Represents a CAseDLPNTableRecord in an OdTvDbDatabase instance.

    <group Other_Classes>
*/
class DBENT_EXPORT CAseDLPNTableRecord : public OdTvDbObject
{
public:
  ODRX_DECLARE_MEMBERS(CAseDLPNTableRecord);
  
  CAseDLPNTableRecord();
  CAseDLPNTableRecord(OdTvDbObjectImpl* pImpl);
};
