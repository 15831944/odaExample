...
*/
class UNDERLAY_EXPORT OdTvDbDgnUnderlayItem : public OdTvDbUnderlayItem
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbDgnUnderlayItem);
...
typedef OdSmartPtr<OdTvDbDgnUnderlayItem> OdTvDbDgnUnderlayItemPtr;
