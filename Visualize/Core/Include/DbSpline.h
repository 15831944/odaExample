...
/** \details
    This class represents Spline entities in an OdTvDbDatabase instance.

    \sa
    TD_Db
    <group OdTvDb_Classes> 
*/
class DBENT_EXPORT OdTvDbSpline : public OdTvDbCurve
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbSpline);
  ...
  */
  ...
  TD_USING(OdTvDbCurve::getSplitCurves);
...
*/
  ...
  */
  ...
  /** \details
    ...
    itself, the resulting curve can be OdTvDbPolyline, OdTvDb2dPolyline or
    OdTvDb3dPolyline.
    OdTvDb3dPolyline will always have line segments. Otherwise, the resulting
  ...
  */
  OdResult toPolyline(OdTvDbCurve*& pCurve, 
  ...
  /** \details
    ...
    \param bToLWPolyline [in]  Indicating whether to convert to OdTvDbPolyline or OdTvDb2dPolyline when spline is planar.
    \param precision [in]  Target precision value.
    \param maxSuggestedPrecision [out]  (When not NULL) suggested precision value.
    \param numOfVerticesThreshold [in]  Vertices threshold value.
    ...
    \remarks
    The resulting curve can be OdTvDbPolyline, OdTvDb2dPolyline or OdTvDb3dPolyline.
    If at least one of the points of the spline does not lie on the XY plane,
    then an OdTvDb3dPolyline will be created from linear segments. If the spline is flat,
    ...
    and bToLWPolyline is true, then the result will be OdTvDbPolyline,
    otherwise it will be OdTvDb2dPolyline.
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbSpline object pointers.
*/
...
/** \details
    ...
    <group OdTvDb_Classes> 
*/
class DBENT_EXPORT OdTvDbSplinePE : public OdRxObject
{
public:
    ODRX_DECLARE_MEMBERS(OdTvDbSplinePE);

  virtual OdResult getParamAtPoint(
    const OdTvDbCurve* pCurve,
    const OdGePoint3d& pointOnCurve,
...
/** \details
This template class is a specialization of the OdSmartPtr class for OdTvDbSplinePE object pointers.
*/
typedef OdSmartPtr<OdTvDbSplinePE> OdTvDbSplinePEPtr;
