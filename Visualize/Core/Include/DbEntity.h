...
class OdGePlane;
class OdGeMatrix3d;
class OdTvDbFullSubentPath;
class OdGePoint3d;
class OdGeVector3d;
class OdTvDbBlockTableRecord;

/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbEntity pointers.
*/
typedef OdSmartPtr<OdTvDbEntity> OdTvDbEntityPtr;

/** \details
  This template class is a specialization of the OdArray class for OdTvDbEntity object SmartPointers.
*/
typedef OdArray<OdTvDbEntityPtr> OdTvDbEntityPtrArray;
...
/** \details
    This class is the base class for all graphical objects contained in an OdTvDbDatabase instance.
...
*/
class TOOLKIT_EXPORT OdTvDbEntity : public OdTvDbObject
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbEntity);

  OdTvDbEntity();

  /** \details
    Returns the Object ID of the OdTvDbBlockTableRecord that owns this entity.
  */
  OdTvDbObjectId blockId() const;

  /** \details
    Returns the color information of this entity as an OdTvCmColor instance.
  */
  OdTvCmColor color() const;

  /** \details
    Sets the color information of this entity from an OdTvCmColor instance.

    \param color [in]  OdTvCmColor object.
  ...
  */
  ...
  /** \details
      Returns the Object ID of the OdTvDbColor object referenced by this entity.
  */
  OdTvDbObjectId colorId() const;

  /** \details
    Assigns the specified OdTvDbColor object to this entity.

    \param colorId [in]  Object ID of the OdTvDbColor object.
    \param doSubents [in]  If and only if true, applies the change to all sub-entities owned by
                  this entity.
  ...
  */
  ...
  /** \details
    ...
    \param transparency [in]  OdTvCmTransparency object be assigned.
    \param doSubents [in]  If and only if true, applies the change to all sub-entities owned by
                  this entity.
    ...
    If you override this function, you must call OdTvDbEntity::setTransparency(), passing to it the calling arguments.
  */
  ...
  */
  OdDb::PlotStyleNameType getPlotStyleNameId(OdTvDbObjectId& plotStyleNameId) const;
  ...
  */
  virtual OdResult setPlotStyleName(
    ...
    OdTvDbObjectId plotStyleNameId = OdTvDbObjectId::kNull,
    bool doSubents = true);
  ...
  */
  ...
  /** \details
    Returns the Object ID of the OdTvDbLayerTableRecord referenced by this entity.
  */
 ...
 */
  ...
  */
  ODRX_SEALED_VIRTUAL OdResult getTransformedCopy(
    ...
    OdTvDbEntityPtr& pCopy) const ODRX_SEALED;
  ...
  */
  virtual OdResult explodeToBlock(
    OdTvDbBlockTableRecord *pBlockRecord,
    OdTvDbObjectIdArray *ids = 0);
...
/* No implementation
  ...
  */
  ...
  ODRX_SEALED_VIRTUAL void highlight(bool bDoIt = true, const OdTvDbFullSubentPath* pSubId = 0,
  ...
  */
  ...
  /** \details
    Returns OdTvDbGripData objects for grip points of this entity.

    \param grips [in/out] Receives an array of OdTvDbGripData objects.
  ...
  */
  ...
  /** \details
    ...
    \param gripAppData [in]  Array of appData pointers from the OdTvDbGripData objects (one for each grip point to be moved).
    \param offset [in] The direction and magnitude of the grip points offset (WCS).
  */
  ODRX_SEALED_VIRTUAL OdResult moveGripPointsAt(
  ...
  */
  ODRX_SEALED_VIRTUAL OdResult intersectWith(const OdTvDbEntity* pEnt, OdDb::Intersect intType,
  ...
  */
  OdResult boundingBoxIntersectWith(const OdTvDbEntity* pEnt, OdDb::Intersect intType,
  ...
  */
  ...
  ODRX_SEALED_VIRTUAL OdResult getSubentPathsAtGsMarker(OdDb::SubentType type, OdGsMarker gsMark, 
										...
										const OdTvDbObjectIdArray* pEntAndInsertStack = 0) const ODRX_SEALED;
  ...
  */
  ...
  ODRX_SEALED_VIRTUAL OdResult getGsMarkersAtSubentPath( const OdTvDbFullSubentPath& subPath, 
  ...
  /** \details
	...
	\param grips [in/out] Receives an array of pointers of OdTvDbGripData objects, one object for each grip point in the subentity.
  ...
  */
  ...
  ODRX_SEALED_VIRTUAL OdResult getGripPointsAtSubentPath( const OdTvDbFullSubentPath& path, OdDbGripDataPtrArray& grips,
  ...
  /** \details
	...
	\param gripAppData [in]  The array of pointers of OdTvDbGripData objects.
	\param offset [in]  The vector (in WCS coordinates) indicating the direction and magnitude of the translation.
	\param bitflags [in]  The bitmap of one or more flags specified by the GetGripPointsFlags enumeration.
  */

  ODRX_SEALED_VIRTUAL OdResult moveGripPointsAtSubentPaths( const OdTvDbFullSubentPathArray& paths,
  ...
  */
  ...
  ODRX_SEALED_VIRTUAL OdResult deleteSubentPaths(const OdTvDbFullSubentPathArray& paths) ODRX_SEALED;
  ...
  */
  ...
  ODRX_SEALED_VIRTUAL OdResult addSubentPaths(const OdTvDbFullSubentPathArray& paths) ODRX_SEALED;
  ...
  */
  ...
  ODRX_SEALED_VIRTUAL OdTvDbEntityPtr subentPtr(const OdTvDbFullSubentPath& path) const ODRX_SEALED;
  ...
  */
  ...
  ODRX_SEALED_VIRTUAL OdResult transformSubentPathsBy(const OdTvDbFullSubentPathArray &paths, const OdGeMatrix3d & xform) ODRX_SEALED;
  ...
  */
  ...
  ODRX_SEALED_VIRTUAL OdResult getSubentClassId( const OdTvDbFullSubentPath& path, void* clsId ) ODRX_SEALED;
  ...
  */
  ...
  ODRX_SEALED_VIRTUAL OdResult getSubentPathGeomExtents( const OdTvDbFullSubentPath& path, OdGeExtents3d& extents ) ODRX_SEALED;

  ODRX_SEALED_VIRTUAL  void  subentGripStatus(OdDb::GripStat status, const OdTvDbFullSubentPath& subentity) ODRX_SEALED;
...
protected:
  ...
  virtual OdResult subIntersectWith(const OdTvDbEntity* pEnt, OdDb::Intersect intType,
    OdGePoint3dArray& points, OdGsMarker thisGsMarker = 0,
  ...
  virtual void subHighlight(bool bDoIt = true, const OdTvDbFullSubentPath* pSubId = 0,
  ...
  virtual OdResult subDeleteSubentPaths(const OdTvDbFullSubentPathArray& paths);
  virtual OdResult subAddSubentPaths(const OdTvDbFullSubentPathArray& paths);

  virtual OdResult subMoveGripPointsAtSubentPaths( const OdTvDbFullSubentPathArray& paths, 
    const OdDbVoidPtrArray& gripAppData, const OdGeVector3d& offset, const OdUInt32 bitflags);
  virtual OdResult subGetGripPointsAtSubentPath( const OdTvDbFullSubentPath& path, OdDbGripDataPtrArray& grips,
    const double curViewUnitSize, const int gripSize,
  ...
  virtual OdTvDbEntityPtr subSubentPtr(const OdTvDbFullSubentPath& path) const;
  virtual OdResult subTransformSubentPathsBy(const OdTvDbFullSubentPathArray &paths, const OdGeMatrix3d & xform);
  virtual OdResult subGetSubentClassId( const OdTvDbFullSubentPath& path, void* clsId ) const;
  virtual OdResult subGetSubentPathGeomExtents( const OdTvDbFullSubentPath& path, OdGeExtents3d& extents ) const;
  virtual void subSubentGripStatus(OdDb::GripStat status, const OdTvDbFullSubentPath& subentity);

  friend class OdTvDbPropertiesOverrule;
  friend class OdTvDbOsnapOverrule;
  friend class OdTvDbTransformOverrule;
  friend class OdTvDbGripOverrule;
  friend class OdTvDbSubentityOverrule;
  friend class OdTvDbHighlightOverrule;
  friend class OdTvDbVisibilityOverrule;
  friend class OdTvDbGeometryOverrule;
};
