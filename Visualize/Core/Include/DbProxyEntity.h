...
/** \details
    ...
    from OdTvDbEntity in an OdTvDbDatabase instance.
...
*/
class DBIO_EXPORT OdTvDbProxyEntity : public OdTvDbEntity
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbProxyEntity);
  ...
  */
  virtual OdTvDbProxyEntity::GraphicsMetafileType graphicsMetafileType() const;
  ...
  */
  virtual OdResult setPlotStyleName(
    ...
    OdTvDbObjectId newId = OdTvDbObjectId::kNull, 
    bool doSubents = true);
  /** \details
    This function honors proxyFlags().
  */
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbProxyEntity object pointers.
*/
typedef OdSmartPtr<OdTvDbProxyEntity> OdTvDbProxyEntityPtr;
