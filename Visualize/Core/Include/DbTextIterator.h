...
class TOOLKIT_EXPORT OdTvDbTextIterator;

/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbTextIterator object pointers.
*/
typedef OdSmartPtr<OdTvDbTextIterator> OdTvDbTextIteratorPtr;
...
*/
class TOOLKIT_EXPORT OdTvDbTextIterator : public OdBaseTextIterator
{
public:
  /** \details
    ...
    \returns
    Returns a SmartPointer to the new OdTvDbTextIterator object.
  */
  static OdTvDbTextIteratorPtr createObject(const OdChar* textString, 
                                          int length, 
                                          bool raw, 
