...
/** \details
  ...
  OdTvDbLinetypeTable class
*/
class TOOLKIT_EXPORT OdTvDbLinetypeTableRecord : public OdTvDbSymbolTableRecord
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbLinetypeTableRecord);
  ...
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::setComments() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::comments() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::setIsScaledToFit() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::isScaledToFit() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::setPatternLength() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::patternLength() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::setNumDashes() method
  */
  int numDashes() const;
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::numDashes() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::setDashLengthAt() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::dashLengthAt() method
  */
  ...
  /** \details
    ...
    (OdTvDbTextStyleTableRecord class) which specifies the characteristics of the shape 
    ...
    OdTvDbLinetypeTableRecord::setShapeStyleAt() method
  */
  OdTvDbObjectId shapeStyleAt( int dashIndex ) const;


  /** \details
    Sets the Object ID associated with an instance of the text style record object 
    (OdTvDbTextStyleTableRecord class) for the linetype dash at the specified index as the
    ...
    OdTvDbLinetypeTableRecord::shapeStyleAt() method
  */
  void setShapeStyleAt( int dashIndex, OdTvDbObjectId idTextStyle );
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::setShapeNumberAt() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::shapeNumberAt() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::setTextAt() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::textAt() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::setShapeOffsetAt() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::shapeOffsetAt() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::setShapeScaleAt() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::shapeScaleAt() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::setShapeRotationAt() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::shapeRotationAt() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::setShapeIsUcsOrientedAt() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::shapeIsUcsOrientedAt() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::setShapeIsUprightAt() method
  */
  ...
  /** \details
    ...
    OdTvDbLinetypeTableRecord::shapeIsUprightAt() method
  */
...
/** \details
  ...
  specialization of the OdSmartPtr class for the OdTvDbLinetypeTableRecord object.
