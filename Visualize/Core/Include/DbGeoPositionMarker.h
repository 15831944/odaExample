...
*/
class DBENT_EXPORT OdTvDbGeoPositionMarker : public OdTvDbEntity
{
public:
  /** \details
  ...
  */
  ...
  ODDB_DECLARE_MEMBERS(OdTvDbGeoPositionMarker);
  /** \details
  Creates an instance of the OdTvDbGeoPositionMarker class.
  
  \remarks
  Use the static pseudo-constructor createObject() instead of it.
  */ 
  OdTvDbGeoPositionMarker();
  
  virtual ~OdTvDbGeoPositionMarker();
  ...
  */  
  ...
  \param pMText [in] A new multiline text label value to be set, which is represented as a pointer to an OdTvDbMText.
  ...
  */
  OdResult          setMText(const OdTvDbMText * pMText);
  ...
  */
  ...
  /** \details 
  Returns the current value of the label text style of the position marker as an OdTvDbObjectId.
  */
  ...
  virtual void subSetDatabaseDefaults(OdTvDbDatabase* pDb, bool doSubents);
};
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbGeoPositionMarker object pointers.
*/
typedef OdSmartPtr<OdTvDbGeoPositionMarker> OdTvDbGeoPositionMarkerPtr;
