...
*/
class TOOLKIT_EXPORT OdTvDbGripPointsPE : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbGripPointsPE);
  ...
  */
  ...
  /** \details
    ...
    \param pEntity [in]  Pointer to the entity.
    \param grips [in]  Array of OdTvDbGripData identifiers.
    \param offset [in] The direction and magnitude of the grip points offset (WCS).
  ...
  */
  ...
  virtual OdResult getGripPointsAtSubentPath(   const OdTvDbEntity* pEntity,
                        const OdTvDbFullSubentPath& path, OdDbGripDataPtrArray& grips,
  ...
  */
  ...
  virtual OdResult moveGripPointsAtSubentPaths(OdTvDbEntity* pEntity,
                        const OdTvDbFullSubentPathArray& paths, const OdDbVoidPtrArray& gripAppData,
												const OdGeVector3d& offset, const OdUInt32 bitflags);
};

/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbGripPointsPE object pointers.
*/
typedef OdSmartPtr<OdTvDbGripPointsPE> OdTvDbGripPointsPEPtr;
