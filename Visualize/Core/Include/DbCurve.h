...
class OdTvDbSpline;
typedef OdSmartPtr<OdTvDbSpline> OdTvDbSplinePtr;

class OdTvDbCurveImpl;
class OdTvDbCurve;

/** \details
This template class is a specialization of the OdSmartPtr class for OdTvDbCurve object pointers.
*/
typedef OdSmartPtr<OdTvDbCurve> OdTvDbCurvePtr;
/** \details
...
*/
class DBENT_EXPORT OdTvDbCurve : public OdTvDbEntity
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbCurve);
  ...
  */
  ...
  /** \details
    Returns OdTvDbSpline approximation of this Curve object.    
    \param spline [out]  Receives a SmartPointer to the OdTvDbSpline.

    \returns
    Returns eOk if successful, or an appropriate error code if not.
  */
  virtual OdResult getSpline (
    OdTvDbSplinePtr* spline) const;
  ...
  */
  virtual OdResult getOrthoProjectedCurve(const OdGePlane& projPlane,
    OdTvDbCurvePtr* pProjCurve) const;
  ...
  */
  virtual OdResult getProjectedCurve(const OdGePlane& projPlane,
    const OdGeVector3d& projDirection, OdTvDbCurvePtr* pProjCurve) const;
  ...
  */
  ...
  /** \details
    Returns an OdGeCurve3d that is geometrically identical to this OdTvDbCurve.
    \param pGeCurve [out]  Receives a pointer to an OdGeCurve3d object that is geometrically identical to this OdTvDbCurve.
  ...
  */
  ...
  /** \details
    Takes an OdGeCurve3d and returns an OdTvDbCurve that is geometrically identical to the OdGeCurve3d.
    \param geCurve [in]  Reference to an OdGeCurve3d.
    \param pDbCurve [out]  Receives a pointer to an OdTvDbCurve object that is geometrically identical to geCurve.
    The caller of this function is responsible for deleting this OdTvDbCurve object or adding it to the database.
    ...
    Returns eOk if successful.
  */
  static OdResult  createFromOdGeCurve ( const OdGeCurve3d& geCurve, OdTvDbCurve*& pDbCurve,
                                                               OdGeVector3d *normal = NULL,
                                                               const OdGeTol& tol = OdGeContext::gTol );

  /** \details
    Takes an OdGeCurve3d and sets this OdTvDbCurve to be geometrically identical to the OdGeCurve3d.
    \param geCurve [in]  reference to an OdGeCurve3d.
    \param normal [in]  Optional normal vector. If this parameter is supplied then it must be a valid vector that 
    is perpendicular to the input geCurve, and this vector will become the normal vector of the output pDbCurve.
    If this parameter is not supplied, then this function will compute the normal vector itself.
  ...
  */
  ...
  virtual OdInt32 findVertexIndex(const OdTvDbVertex* vert) const { return 0; }
};
