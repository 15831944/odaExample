...
/** \details
    ...
    additional information for an OdTvDbDatabase as Summary Information.
...
*/
class TOOLKIT_EXPORT OdTvDbDatabaseSummaryInfo : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbDatabaseSummaryInfo);

  OdTvDbDatabaseSummaryInfo();
  ...
  */
  ...
  /** \details
    Returns the OdTvDbDatabase associated with this Summary Information.
  */
  virtual OdTvDbDatabase* database() const = 0; 
  
  /** \details
    Sets the OdTvDbDatabase associated with this Summary Information.
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbDatabaseSummaryInfo object pointers.
*/
typedef OdSmartPtr<OdTvDbDatabaseSummaryInfo> OdTvDbDatabaseSummaryInfoPtr;


TOOLKIT_EXPORT OdDbLibraryInfo*           odtvdbGetLibraryInfo(void);
TOOLKIT_EXPORT OdTvDbDatabaseSummaryInfoPtr odtvdbGetSummaryInfo(OdTvDbDatabase* pDb);
TOOLKIT_EXPORT void                       odtvdbPutSummaryInfo(const OdTvDbDatabaseSummaryInfo* pInfo);
