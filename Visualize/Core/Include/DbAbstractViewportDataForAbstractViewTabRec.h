...
/** \details
    This class is the Protocol Extension class for OdTvDbViewportTableRecord objects.
...
*/
class TOOLKIT_EXPORT OdTvDbAbstractViewportDataForAbstractViewTabRec : public OdTvDbAbstractViewportData
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAbstractViewportDataForAbstractViewTabRec);
  ...
  TD_USING(OdTvDbAbstractViewportData::setView);
  TD_USING(OdTvDbAbstractViewportData::setUcs);
  ...
  OdTvCmColor ambientLightColor(const OdRxObject* pViewport) const;
  void setAmbientLightColor(OdRxObject* pViewport, const OdTvCmColor& color) const;
