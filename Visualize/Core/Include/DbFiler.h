...
*/
class TOOLKIT_EXPORT OdTvDbFiler : public OdRxObject
{
public:
  OdTvDbFiler() {}

  ODRX_DECLARE_MEMBERS(OdTvDbFiler);
  ...
  */
  OdTvDbAuditInfo * getAuditInfo() const;
  ...
  */
  virtual void setController(
    OdTvDbFilerController * pFilerController);

  /** \details
    Returns the FilerController with which this Filer object is associated.
  */
  virtual OdTvDbFilerController* controller() const;
};
...
*/
class TOOLKIT_EXPORT OdTvDxfCode
{
public:
  /** \details
...
/** \details
    ...
    <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbDxfFiler : public OdTvDbFiler
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbDxfFiler);
  OdTvDbDxfFiler() {}
  ...
  */
  virtual OdTvDbObjectId rdObjectId() = 0;
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbDxfFiler object pointers.
*/
typedef OdSmartPtr<OdTvDbDxfFiler> OdTvDbDxfFilerPtr;
...
/** \details
    ...
    <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbDwgFiler : public OdTvDbFiler
{
public:
  OdTvDbDwgFiler() {}

  ODRX_DECLARE_MEMBERS(OdTvDbDwgFiler);
  ...
  */
  ...
  /** \details
  */
  virtual void addReference(OdTvDbObjectId id, OdDb::ReferenceType rt);
...
class TOOLKIT_EXPORT OdDbDwgFiler : public OdTvDbDwgFiler
{

};

/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbDwgFiler object pointers.
*/
typedef OdSmartPtr<OdTvDbDwgFiler> OdTvDbDwgFilerPtr;
...
/** \details
    ...
    <group Other_Classes>
*/
class TOOLKIT_EXPORT OdTvIdFiler : public OdTvDbDwgFiler
{
public:
  OdTvIdFiler() : m_pController(NULL) {}
  ...
  void setController(
    OdTvDbFilerController* pFilerController) { m_pController = pFilerController; }
  OdTvDbFilerController* controller() const { return m_pController; }
private:
