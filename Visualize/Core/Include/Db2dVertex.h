...
/** \details
    This class represents OdTvDb2Polyline vertices in an OdTvDbDatabase instance.
...
*/
class DBENT_EXPORT OdTvDb2dVertex: public OdTvDbVertex
{
public:

  DWGMAP_DECLARE_MEMBERS(OdTvDb2dVertex);
  ...
  */
  ...
  /** \details
    Returns the OdTvDb2dPolyline OCS position of this entity (DXF 10).

    \remarks
    Each OdTvDb2dPolyline is described a series of OCS OdTvDb2dVertices and an elevation.
    
    While Z coordinates are set and retrieved by setPosition() and position() respectively,
    they are ignored by the Polyline.
    
    The elevation of the Polyline can be changed only with OdTvDb2dPolyline::setElevation(). 
      
  */
  OdGePoint3d position() const;

  /** \details
    Sets the OdTvDb2dPolyline OCS position of this entity (DXF 10).
  ...
  */
  ...
  /** \details
    ...
    \remarks
    This is the angle between the OdTvDb2dPolyline OCS X-axis and the tangent direction.
  ...
  */
  ...
  virtual OdResult subGetTransformedCopy(
    const OdGeMatrix3d& mat, OdTvDbEntityPtr& pCopy) const;
};
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDb2dVertex object pointers.
*/
typedef OdSmartPtr<OdTvDb2dVertex> OdTvDb2dVertexPtr;
