...
/** \details
    This class is the abstract base class for Proxy objects in an OdTvDbDatabase instance.
...
*/
class DBIO_EXPORT OdTvDbProxyObject : public OdTvDbObject
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbProxyObject);
  ...
  virtual OdResult dxfIn(OdTvDbDxfFiler* filer);
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbProxyObject object pointers.
*/
typedef OdSmartPtr<OdTvDbProxyObject> OdTvDbProxyObjectPtr;
