...
/** \details
    This class represents Field Values for OdField objects in an OdTvDbDatabase instance.
...
public:
  ...
  */
  ...
  OdFieldValue(const OdTvDbObjectId& objectId);
  OdFieldValue(const OdTvResBuf& resBuf);
