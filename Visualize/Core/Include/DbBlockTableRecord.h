...
class OdTvDbBlockBegin;
class OdTvDbBlockEnd;
class OdTvDbBlockTableRecord;
class OdTvDbBlockTable;
class OdBinaryData;
class OdTvDbSortentsTable;
...
/** \details
    This class represents Block records in the OdTvDbBlockTable in an OdTvDbDatabase instance.
...
*/
class TOOLKIT_EXPORT OdTvDbBlockTableRecord : public OdTvDbSymbolTableRecord
{
public:

  DWGMAP_DECLARE_MEMBERS(OdTvDbBlockTableRecord);

  OdTvDbBlockTableRecord();

  typedef OdTvDbBlockTable TableType;
  ...
  */
  OdTvDbObjectId appendOdTvDbEntity(OdTvDbEntity* pEntity);

  /** \details
  Inserts the specified entity to this Block after 'pPrevEntity' entity

  \param pPrevEntity [in]  Pointer to the previous entity.
  \param pEntity [in]  Pointer to the entity.

  \returns
  Returns the Object ID of the newly inserted entity.
  */
  OdTvDbObjectId insertOdTvDbEntityAt(OdTvDbEntity* pPrevEntity, OdTvDbEntity* pEntity);
  
  /** \details
  Moves the specified entity after "pPrevEntity" entity.
  \param pPrevEntity  [in]  Pointer to the previous entity.
  \param pEntity      [in]  Pointer to the entity.
  \returns
  Returns the Object ID of the moved entity.
  */
  OdTvDbObjectId moveOdTvDbEntityAfter( OdTvDbEntity* pPrevEntity, OdTvDbEntity* pEntity );
  
  /** \details
  Moves specified entity to the end of entities list.
  \param pEntity [in]  Pointer to the entity.
  \returns
  Returns the Object ID of the moved entity.
  */
  OdTvDbObjectId moveOdTvDbEntityAfterLast( OdTvDbEntity* pEntity );
  ...
  */
  OdTvDbObjectIteratorPtr newIterator(
  ...
  */
  ...
  /** \details
    Opens and returns the OdTvDbBlockBegin object associated with this Block.

    \param openMode [in]  Mode in which to open the object.

    \remarks
    This function allows client applications to access the OdTvDbBlockBegin object 
    to store and retrieve Xdata in a manner compatible with AutoLISP applications.
  */
  OdTvDbBlockBeginPtr openBlockBegin(OdDb::OpenMode openMode = OdDb::kForRead);

  /** \details
    Opens and returns the OdTvDbBlockEnd object associated with this Block.

    \param openMode [in]  Mode in which to open the object.

    \remarks
    This function allows client applications to access the OdTvDbBlockEnd object 
    to store and retrieve Xdata in a manner compatible with AutoLISP applications.
  */
  OdTvDbBlockEndPtr openBlockEnd(OdDb::OpenMode openMode = OdDb::kForRead);
  ...
  */
  ...
  /** \details
    Returns the Object ID of the OdTvDbLayout associated with this Block.
  */
  OdTvDbObjectId getLayoutId() const;

  /** \details
    Sets the Object ID of the OdTvDbLayout associated with this Block.
    
    \param layoutId [in]  Layout ID.
  */
  void setLayoutId(const OdTvDbObjectId& layoutId);

  /** \details
    Returns the Object ID's of all OdTvDbBlockReference entities that reference this Block.
  ...
  */
  void getBlockReferenceIds(
    OdTvDbObjectIdArray& referenceIds,
    bool directOnly = true, 
    bool forceValidity = false);

  /** \details
    Returns the Object ID's of all erased OdTvDbBlockReference entities that directly reference this Block.
  ...
  */
  void getErasedBlockReferenceIds(OdTvDbObjectIdArray& referenceIds);
  ...
  */  
  ...
  /** \details
    ...
    1) Call assertWriteEnabled(). 2) Call the parent class's dwgInFields(pFiler).
    3) If it returns eOK, continue; otherwise return whatever the parent's dxfInFields(pFiler) returned. 
    4) Call the OdTvDbDxfFiler(pFiler) methods to read each of the object's data items in the order they 
    were written. 
    5) Return pFiler->filerStatus().
  */
  ...
  */ 
  ...
  /** \details
    ...
    When overriding this function: 
    1) If the OdTvDbObject's state is incorrect, return something other than eOk. 
  ...
  */ 
  ...
  /** \details
    ...
    This function can be overridden in custom classes.
  */ 
  virtual void subHandOverTo(OdTvDbObject* pNewObject) ODRX_OVERRIDE;
  ...
  */
  OdTvDbDatabase* xrefDatabase(bool includeUnresolved = false) const;
  ...
  */
  ...
  /** \details
    This is subWblockClone, a member of class OdTvDbBlockTableRecord.
  */
  ...
  /** \details
    ...
    OdTvDbSortentsTable
  */
  OdTvDbSortentsTablePtr getSortentsTable(bool createIfNotFound = true);
  ...
  */
  virtual OdResult assumeOwnershipOf(OdTvDbObjectIdArray entitiesToMove);
