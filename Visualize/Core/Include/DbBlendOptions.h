...
class OdTvDbBlendOptionsImpl;

/** \details
Class for setting options used for creating blend surfaces and lofted solids (by calling OdTvDbLoftedSurface::createBlendSurface() or OdTvDb3dSolid::createBlendSolid() methods).
Loft and blend options are used to control the shape of the resulting surface or solid object.

<group OdTvDb_Classes>
*/
class DBENT_EXPORT OdTvDbBlendOptions
{
public:
  /** \details
  Creates an OdTvDbBlendOptions object.
  */
  OdTvDbBlendOptions();

  /** \details
  Copy constructor for the OdTvDbBlendOptions class.
  */
  //OdTvDbBlendOptions(const OdTvDbBlendOptions& src);

  /** \details
  Destroys the OdTvDbBlendOptions object.
  */
  ~OdTvDbBlendOptions();

  /** \details
  Assigns to the OdTvDbBlendOptions object another object (assignment operator).

  \param rhs [in] Another OdTvDbBlendOptions object to assign.
  */
  OdTvDbBlendOptions& operator = (const OdTvDbBlendOptions& rhs);
  ...
  ///
  OdTvDbBlendOptions::DriveModeType  driveMode() const;
  ...
  /// <returns>Return Acad::eOk if successful</returns>
  ///
  OdResult  setDriveMode(OdTvDbBlendOptions::DriveModeType val);


private:
  friend class OdTvDbBlendOptionsImpl;
  OdTvDbBlendOptionsImpl *m_pImpl;
};
