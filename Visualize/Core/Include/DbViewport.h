...
/** \details
    This class represents PaperSpace Viewport entities in an OdTvDbDatabase instance.
  
    \sa
    TD_Db
    <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbViewport : public OdTvDbEntity
{
protected:
  /* void dxfOutXData(OdTvDbDxfFiler* pFiler) const;
  */
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbViewport);
  ...
  */
  void freezeLayersInViewport(
    const OdTvDbObjectIdArray& layerIds);
  ...
  */
  bool isLayerFrozenInViewport(
    const OdTvDbObjectId& layerId) const;
  ...
  */
  void getFrozenLayerList(
    OdTvDbObjectIdArray& layerIds) const;
  ...
  */
  OdTvDbObjectId nonRectClipEntityId() const;
  ...
  */
  void setNonRectClipEntityId(
    OdTvDbObjectId clipEntityId);
  
  /*
     virtual void erased(const OdTvDbObject* , bool);
     virtual void modified(const OdTvDbObject *);
     virtual void copied(const OdTvDbObject* pDbObj,const OdTvDbObject* pNewObj);
     virtual void subObjModified(const OdTvDbObject* pDbObj, const OdTvDbObject* pSubObj);
  */
  ...
  */
  void setUcs(
    OdDb::OrthographicView viewType, const OdTvDbDatabase* pDb = 0);
  ...
  */
  OdTvDbObjectId shadePlotId() const;
  ...
  */
  void         setShadePlot(const ShadePlotType type, const OdTvDbObjectId& shadePlotId);
  ...
  */
  OdTvDbObjectId background() const;
  ...
  */
  void         setBackground(const OdTvDbObjectId& backgroundId);
  ...
  */
  OdTvDbObjectId visualStyle() const;
  ...
  */
  void         setVisualStyle(const OdTvDbObjectId& visualStyle);
  ...
  */
  OdTvCmColor           ambientLightColor() const;
  ...
  */
  void                setAmbientLightColor(const OdTvCmColor& clr);
  ...
  */
  OdTvDbObjectId        setSun(OdTvDbSun* pSun);
  ...
  */
  ...
  /** \details
    ...
    * eInvalidObjectId - The 'objId' is not a valid OdTvDbObjectId in this database.
    * eInvalidXrefObjectId - The 'objId' is not a valid OdTvDbXrefObjectId.
    * eUnableToSetViewAssociation - Application cannot associate the view with this viewport.
  */
  void setModelView(const OdTvDbXrefObjectId &objId);
  ...
  */
  OdTvDbXrefObjectId getModelView() const;
  ...
  */
  ...
  /** \details
    Updates (syncronizes) parameters of the OdTvDbViewport object with parameters in the associated view.
    \returns
    Returns one of the following values that represents a result of method execution:
    * eOk - Updated successfully.
    * eUnableToSyncModelView - Unable to get the model view, or its resolved external reference ID (resolved to OdTvDbObjectId) is not valid.
  ...
  */
  void setSheetView(const OdTvDbObjectId &objId);
  ...
  */
  OdTvDbObjectId getSheetView() const;
  ...
  */
  ...
  /** \details
    Associates a label block (OdTvDbBlockReference) with this viewport.
    
    \param objId [in]   Object ID of the label block to be associated with this viewport.
  */
  void setLabelBlock(const OdTvDbObjectId objId);
  
  /** \details
    Retrieves an object identifier of the label block (OdTvDbBlockReference) associated with this viewport.
    \remarks
    This method can throw the 'eUnableToGetViewAssociation' error if it fails to get the view association.
  */
  OdTvDbObjectId getLabelBlock() const;
  
  /** \details
    Removes the label block (OdTvDbBlockReference) associated with this viewport.
  */
  ...
  */
  ...
  /** \details
    ...
    3. Call the OdTvDbDxfFiler(pFiler) methods to write each of the object's data items in the order they were written. 
    </ol>
  */
  ...
  */
  void modified(const OdTvDbObject* pObj);
  ...
  */
  void erased(const OdTvDbObject* pObj, bool pErasing);
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbViewport object pointers.
*/
typedef OdSmartPtr<OdTvDbViewport> OdTvDbViewportPtr;
