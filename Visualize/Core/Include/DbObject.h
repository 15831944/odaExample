...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbXrecord object pointers.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbXrecord> OdTvDbXrecordPtr;

/** \details
    Declares the member functions for classes derived from OdTvDbObject. 
        
    \param ClassName [in]  Name of the derived class.
    
    \remarks
    Classes derived 
    from OdTvDbObject should invoke this macro in their class definitions, 
    passing the name of the derived class.
*/
#define ODDB_DECLARE_MEMBERS(ClassName)\
protected:                                \
  ClassName(OdTvDbObjectImpl* pImpl);       \
public:                                   \
...
/** \details
    This class is the base class for all objects contained in an OdTvDbDatabase instance (OdDb objects).

    \remarks
    
    Creating and Deleting Database Objects
    
    * Database objects are normally created by calling OdTvDbXXXXX::createObject().
    ...
    * OdTvDbObject instances should be created by calling the createObject() method.
    * OdTvDbObject instances are created in kOpenForWrite mode.  
    * Depending on other OdTvDbObject instances while constructing or deleting instances is prohibited.
    * OdTvDbObject instances should be deleted from an OdTvDbDatabase with erase().
    * Never access a pointer to a closed object.
    * The delete operator must never be called on OdTvDbObject instances. Instead, the erase() method
       should be called, which marks this object as erased.
    
    Accessing Database Objects
    
    * Database objects must be opened before they can be accessed.  
    * Given a valid OdTvDbObjectId, a database object is opened by calling OdTvDbObjectId::safeOpenObject().  
...
*/
class TOOLKIT_EXPORT OdTvDbObject : public OdGiDrawable
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbObject);
...
public:
  ...
  */
  ...
  /** \details
    ...
    \remarks
    Returns a null ID if this object has not been added to a database,
    or if OdTvDbObject::setOwnerId has not been called.
  ...
  */
  ...
  /** \details
    Returns the OdTvDbDatabase that contains this object.
  */
  OdTvDbDatabase* database() const;
  
  /** \details
    Creates an OdTvDbDictionary extension dictionary of this object.
  ...
  */
  OdTvDbObjectId extensionDictionary() const;
  ...
  */
  OdTvDbXrecordPtr createXrecord(
  ...
  */
  ...
  /** \details
    ...
    1)  If the OdTvDbObject's state is incorrect, return 
  ...
  */
  ...
  /** \details
    ...
    1)  If the OdTvDbObject's state is incorrect, throw exception.
  ...
  */
  ...
  /** \details
    ...
    When overriding this function for a custom class, first call OdTvDbObject::audit(pAuditInfo) 
  ...
  */
  ...
  /** \details
    ...
    4)  Use pFiler to call the OdTvDbDxfFiler methods to write each of the object's data items in the order they were written.
  */
...
//  void setModified (bool bModified);
  ...
  */
  ...
  /** \details
    Returns true if and only if an object derived from OdTvDbEntity has been modified.
    
    \remarks
    
    This function returns true if and only if an object derived from OdTvDbEntity
    either
...
//  bool isCancelling() const;
  ...
  */
  ...
  /** \details
    Controls the undo recording of this object in OdTvDbDatabase.
    ...
    Undo recording is initially off for newly created OdTvDbDatabase objects.
  */
  ...
  */
  ...
  /** \details
    ...
    <table>
    Exception                   Cause
    eNotThatKindOfClass         pClassObj != OdTvDbObject::desc()
    </table>
  */
  ...
  */
  void addReactor(
    OdTvDbObjectReactor* pReactor) const;
  ...
  */
  bool hasPersistentReactor(
    const OdTvDbObjectId& objId) const;

  /** \details
    Returns Object IDs of this object's persistent reactors.
  */
  OdTvDbObjectIdArray getPersistentReactors() const;

  /** \details
    Returns this object's transient reactors.
  */
  OdTvDbObjectReactorArray getTransientReactors() const;
  ...
  */
  ...
  /** \details
    ...
    OdTvDbDatabaseReactors attached to it. This function can be
    overridden in custom classes.
  ...
  */
  ...
  /** \details
    ...
    This function should not be called by client code; use OdTvDbDatabase::deepCloneObjects() instead.
    ...
    \sa
    <link OdTvDbObject::subDeepClone@OdTvDbIdMapping&@OdDbObject*@bool@const, subDeepClone()>
    <link OdTvDbObject::wblockClone@OdTvDbIdMapping&@OdDbObject*@bool@const, wblockClone()>
    <link OdTvDbObject::appendToOwner@OdTvDbIdPair&@OdDbObject*@OdDbIdMapping&, appendToOwner()>
  */
  ODRX_SEALED_VIRTUAL OdTvDbObjectPtr deepClone(OdTvDbIdMapping& idMap, OdTvDbObject* pOwner, bool bPrimary = true) const ODRX_SEALED;
  ...
  /** \details
    ...
    This function should not be called by client code; use OdTvDbDatabase::wblockCloneObjects() instead.

    The default implementation of this function calls subWblockClone() for all objects hard-referenced by this object.
    This function can be overridden in custom classes.

    \sa
    <link OdTvDbObject::subWblockClone@OdTvDbIdMapping&@OdDbObject*@bool@const, subWblockClone()>
    <link OdTvDbObject::deepClone@OdTvDbIdMapping&@OdDbObject*@bool@const, deepClone()>
    <link OdTvDbObject::appendToOwner@OdTvDbIdPair&@OdDbObject*@OdDbIdMapping&, appendToOwner()>
  */
  ODRX_SEALED_VIRTUAL OdTvDbObjectPtr wblockClone(OdTvDbIdMapping& idMap, OdTvDbObject* pOwner, bool bPrimary = true) const ODRX_SEALED;
  ...
  /** \details
    ...
    The default implementation appends this object to OdTvDbDictionary or throws
  ...
  */
  ...
  /** \details
    ...
    \remarks
    The flags are cleared when the OdTvDbObject::subDeepClone or OdTvDbObject::subWblockClone() operation has been completed.
  */
  void setOdTvDbObjectIdsInFlux();
  
  /** \details
      Returns true if and only if this object's Object ID is not valid because
      the OdTvDbObject::subDeepClone or OdTvDbObject::subWblockClone() have yet to be completed.
  */
  bool isOdTvDbObjectIdsInFlux() const;
  ...
  */
  ...
  /** \details
    ...
    * Returns an OdTvDbObjectPtr for a non- database -resident (NDBRO) replacement object, setting replaceId to OdTvDbObjectId::kNull.
    * Returns NULL, setting replaceId for a database -resident (DBRO) replacement object.
    ...
    The default implementation returns NULL and sets replaceId to OdTvDbObjectId::kNull.  This function can be
    overridden in custom classes.

    The method is not intended to be called by client code. For processing owned objects use *convertForSave()*
    method.
  */
  virtual OdTvDbObjectPtr decomposeForSave(
    OdDb::DwgVersion ver, 
  ...
  */
  ...
  /*
    ...
    virtual void swapReferences (const OdTvDbIdMapping& idMap);
    virtual OdGiDrawable* drawable ();
    OdTvDbObjPtrArray* reactors (); 
    virtual OdRxObjectPtr clone (OdTvDbIdMapping& ownerIdMap) const;
  */
  ...
  */
  virtual OdTvDbObjectId setField(
    const OdString& fieldName, 
    OdTvDbField* pField);
  ...
  */
  virtual OdTvDbObjectId removeField(
    const OdString& fieldName);

  /** \details
    Returns the field dictionary of this Object.
  */
  OdTvDbObjectId getFieldDictionary() const;
  
  /** \details
    Returns, and optionally opens, the field dictionary of this Object.
    \param mode [in]  Open mode.
  */
  OdTvDbObjectPtr getFieldDictionary(
    OdDb::OpenMode mode) const;
...
protected: // overridables
  ...
  virtual OdTvDbObjectPtr subDeepClone(OdTvDbIdMapping& ownerIdMap, OdTvDbObject* pOwner, bool bPrimary) const;
  virtual OdTvDbObjectPtr subWblockClone(OdTvDbIdMapping& ownerIdMap, OdTvDbObject* pOwner, bool bPrimary) const;

  friend class OdTvDbSystemInternals;
  friend class OdTvDbObjectOverrule;
  friend class OdTvDbPropertiesOverrule;
...
/** \details
    ...
    \remarks
    Each OdTvResBuf in the list contains a single DXF group code and data value pertaining 
    to the object.
    ...
    via the returned OdTvResBuf data, odtvdbEntMod must be called.

    throws:
    An OdError exception will be thrown if the passed in object cannot be opened.
*/
DBIO_EXPORT OdTvResBufPtr odtvdbEntGet( const OdTvDbObject* pObj, const OdString& regapps = OdString::kEmpty );

inline OdTvResBufPtr odtvdbEntGet( const OdTvDbObjectId& id, const OdString& regapps = OdString::kEmpty )
{
  return odtvdbEntGet(id.safeOpenObject(), regapps);
}
...
/** \details
    ...
    mode.
*/
DBIO_EXPORT OdResult odtvdbEntMod( OdTvDbObject* pObj, OdTvResBuf* pRb );

inline OdResult odtvdbEntMod( const OdTvDbObjectId& id, OdTvResBuf* pRb )
{
  return odtvdbEntMod(id.safeOpenObject(OdDb::kForWrite), pRb);
}

TOOLKIT_EXPORT OdTvDbObjectId odtvdbEntNext(OdTvDbObjectId id, OdTvDbDatabase* db);
TOOLKIT_EXPORT OdTvDbObjectId odtvdbEntLast(OdTvDbDatabase* db);

DBIO_EXPORT OdResult odtvdbEntMake(OdTvDbDatabase* pDb, OdTvResBuf* pRb, OdTvDbObjectPtr& pObj);
DBIO_EXPORT OdResult odtvdbEntMakeX(OdTvDbDatabase* pDb, OdTvResBuf* pRb, OdTvDbObjectPtr& pObj);
