...
/** \details
    This class represents 3-Point Angular Dimension entities in an OdTvDbDatabase instance.

    \remarks
    A 3-Point Angular Dimension entity dimensions the angle defined by three points.
    
    \sa
    OdTvDb2LineAngularDimension
...
*/
class DBDIM_EXPORT OdTvDb3PointAngularDimension : public OdTvDbDimension
{
public:

  DWGMAP_DECLARE_MEMBERS(OdTvDb3PointAngularDimension);

  OdTvDb3PointAngularDimension();
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDb3PointAngularDimension object pointers.
*/
typedef OdSmartPtr<OdTvDb3PointAngularDimension> OdTvDb3PointAngularDimensionPtr;
