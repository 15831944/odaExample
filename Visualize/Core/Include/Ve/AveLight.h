...
/** \details
    ...
    \remarks
    AVE Light properties may be attached to OdTvDbBlockReference objects.
...
public:
  ...
  /** \details
    Creates a Light object from the specified OdTvDbBlockReference.
  ...
  */
  static OdAveLightPtr getLight(const OdTvDbObjectId& blockRefId);
  /** \details
    Returns the Light name from the specified OdTvDbBlockReference.
    
    \param blockRefId [in]  Object ID of the block reference.
  */
  static OdString getLightName(const OdTvDbObjectId& blockRefId);

  /** \details
    Saves the Light properties to the OdTvDbBlockReference to which this Light object is associated.
  ...
  */
  OdResult writeLight(OdTvDbDatabase* pDb = 0, const OdDbHandle& holderHandle = 0, const OdTvDbObjectId& ownerId = OdTvDbObjectId::kNull);
  ...
  */
  void shadowBoundingObjects(OdTvDbObjectIdArray& objectIds) const;
  /** \details
    Sets the shadow bounding objects for this Light object.
    \param objectIds [in]  Array of Object IDs. 
  */
  void setShadowBoundingObjects(const OdTvDbObjectIdArray& objectIds);
  /** \details
    Adds the specified OdTvDbDatabase object to the shadow bounding objects for this Light object.
    \param objectId [in]  Object ID to add. 
  */
  void addShadowBoundingObject(const OdTvDbObjectId& objectId);

  /** \details
    Returns the Object ID of the OdTvDbBlockReference associated with this Light object.
  */
...
/** \details
  ...
  \param pDb [in]  Pointer to the database.
*/
AVE_EXPORT OdRxIteratorPtr odtvdbGetLights(OdTvDbDatabase* pDb);
