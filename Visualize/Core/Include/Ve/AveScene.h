...
public:
  ...
  /** \details
    Creates a Scene object from the specified OdTvDbBlockReference.
  ...
  */
  static OdAveScenePtr getScene(const OdTvDbObjectId& blockRefId);
  /** \details
    Returns the Scene name from the specified OdTvDbBlockReference.
    
    \param blockRefId [in]  Object ID of the block reference.
    \param name [out]  Receives the Scene name.
  */
  static void getSceneName(const OdTvDbObjectId& blockRefId, OdString& name);

  /** \details
    Saves the Scene properties to the OdTvDbBlockReference to which this Scene object is attached.
  ...
  */
  OdResult writeScene(OdTvDbDatabase* pDb = 0);
  ...
  */
  ...
  /** \details
    Returns the OdTvDbViewTableRecord associated with this Scene object.
  */
  OdTvDbObjectId view() const;
  /** \details
    Sets the OdTvDbViewTableRecord associated with this Scene object.
  ...
  */
  void lights(OdTvDbObjectIdArray& blockRefIds) const;
  /** \details
  ...
  */
  void setLights(const OdTvDbObjectIdArray& blockRefIds);
  /** \details
  ...
  */
  void addLight(const OdTvDbObjectId& blockRefId);
...
/** \details
  ...
  \param pDb [in]  Pointer to the database.
*/
AVE_EXPORT OdRxIteratorPtr odtvdbGetScenes(OdTvDbDatabase* pDb);
