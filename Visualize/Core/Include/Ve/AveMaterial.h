...
/** \details
    ...
    \remarks
    AVE Material properties may be attached to OdTvDbEntity and
    OdTvDbLayerTableRecord objects, and to color indicies (ACIs).
...
public:
  ...
  /** \details
    Creates a Material object from the specified OdTvDbBlockReference.
  ...
  */
  static OdAveMaterialPtr getMaterial(const OdTvDbObjectId& blockRefId);

  /** \details
    Returns the Material name from the specified OdTvDbBlockReference.
    
    \param blockRefId [in]  Object ID of the block reference.
  */
  static OdString getMaterialName(const OdTvDbObjectId& blockRefId);

  /** \details
    Saves the Material properties to the OdTvDbBlockReference to which this Material object is associated.
  ...
  */
  OdResult writeMaterial(OdTvDbDatabase* pDb = NULL, const OdDbHandle& holderHandle = 0);

  /** \details
    Attaches this Material object to the specified OdTvDbEntity.
    \param entityId [in]  Object ID of the entity.
    \returns
    Returns true if and only if successful.
  */
  bool attachToObject(OdTvDbObjectId entityId);

  /** \details
    Attaches this Material object to the specified OdTvDbLayerTableRecord.
    \param layerId [in]  Object ID of the layer table record.
    \returns
    Returns true if and only if successful.
  */
  bool attachToLayer(OdTvDbObjectId layerId);
  ...
  */
  ...
  /** \details
    Detaches this Material object from the specified OdTvDbEntity.
    \param entityId [in]  Object ID of the entity.
  */
  static void detachFromObject(OdTvDbObjectId entityId);

  /** \details
    Detaches this Material object from the specified OdTvDbLayerTableRecord.
    \param layerId [in]  Object ID of the layer table record.
  */
  static void detachFromLayer(OdTvDbObjectId layerId);
  ...
  /** \details
    ...
    OdCmEntityColor
  */
  static void detachFromACI(OdTvDbDatabase* pDb, OdUInt16 colorIndex);
  
  /** \details
    Returns the object ID of the OdTvDbBlockReference associated with the material to which 
    the specified OdTvDbEntity or OdTvDbLayerTableRecord is attached.

    \param sourceId [in]  Object ID of the entity or layer table record.
    \param blockRefId [out]  Object ID of OdTvDbBlockReference associated with the material.

    \returns
    Returns true if and only if a material is attached.
  */
  static bool getAttachedMaterial(const OdTvDbObjectId& sourceId, OdTvDbObjectId& blockRefId);
  ...
  /** \details
    ...
    Returns true if and only if a material is attached.
  */
  static bool getAttachedMaterial(OdTvDbDatabase* pDb, OdUInt16 colorIndex, OdTvDbObjectId& blockRefId);

  /** \details
    Returns the ACI Material Map for the specified OdTvDbDatabase. 
    ...
    blockRefIds are the object IDs of the OdTvDbBlockReferences associated with the materials.
  */
  static void getAciMaterialMap(OdTvDbDatabase* pDb, OdTvDbObjectIdArray& blockRefIds);
  ...
  */
  ...
  /** \details
    Returns the Object ID of the OdTvDbBlockReference associated with this Material object.
  */
  OdTvDbObjectId holderId() const;
...
*/
AVE_EXPORT OdRxIteratorPtr odtvdbGetMaterials(OdTvDbDatabase* pDb);

AVE_EXPORT void odtvdbGetMaterialIds(OdTvDbDatabase* pDb, OdTvDbObjectIdArray& ids);

AVE_EXPORT OdRxIteratorPtr odtvdbGetMaterials(OdStreamBuf* pStreamBuf);
