...
/** \details
    This class represents Radial Dimension entities in an OdTvDbDatabase instance.
...
*/
class DBDIM_EXPORT OdTvDbRadialDimension : public OdTvDbDimension
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbRadialDimension);

  OdTvDbRadialDimension();
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbRadialDimension object pointers.
*/
typedef OdSmartPtr<OdTvDbRadialDimension> OdTvDbRadialDimensionPtr;
