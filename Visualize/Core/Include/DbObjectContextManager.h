...
class OdTvDbObjectContextCollection;
class OdTvDbObjectContext;
class OdTvDbObjectContextManagerImpl;
...
*/
class TOOLKIT_EXPORT OdTvDbObjectContextManager : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbObjectContextManager);

  OdTvDbObjectContextManager(OdTvDbObjectContextManagerImpl*);

  virtual ~OdTvDbObjectContextManager();
  ...
  */
    ...
    OdTvDbObjectContextCollection* pCollection);
  ...
  */
   ...
   */
     OdTvDbObjectContextCollection* contextCollection(
    const OdString& collectionName) const;

protected:
  OdTvDbObjectContextManagerImpl* m_pImpl;
};
