...
/** \details
  ...
  OdTvDbLayerTableRecord class
*/
class TOOLKIT_EXPORT OdTvDbLayerTable: public OdTvDbSymbolTable
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbLayerTable);
  ...
  */
  ...
  /** \details
    ...
    \remarks
    Usage data can be accessed via the OdTvDbLayerTableRecord::isInUse() method.
  */
...
/** \details
  ...
  of the OdSmartPtr class for the OdTvDbLayerTable object.
