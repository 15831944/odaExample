...
public:  
  ...
  */
  ...
  virtual OdResult setSubentPath(OdBrEntity & /*pInpEnt*/, OdTvDbFullSubentPath& /*subpath*/) { return eNotImplemented; }
  ...
  */
  ...
  /** \details
    Explodes this ModelerGeometry object into a set of OdTvDbEntity objects.  
  ...
  */
  virtual bool explode(OdTvDbEntityPtrArray& entitySet) const = 0;
  ...
  */
  virtual OdResult extrude(const OdTvDbRegion* pRegion, double height, double taperAngle, bool isSolid = true) = 0;
  ...
  */
  virtual OdResult revolve(const OdTvDbRegion* pRegion, const OdGePoint3d& axisPoint, 
  ...
  */
  virtual OdResult booleanOper(OdTvDbDatabase* database, OdDb::BoolOperType operation, OdSmartPtr<OdModelerGeometry> otherRegion) = 0;
  ...
  /** \details
    ...
    Possible operation types are: 
      ...
      * kBoolSubtract - Subtracts the second ModelerGeometry object from the first one.
  */
  virtual OdResult booleanOper(OdDb::BoolOperType operation, const OdSmartPtr<OdModelerGeometry> pModelerPar, OdTvDbEntityPtrArray& intersectionEntities) = 0;
...
* OdTvDbSpline
* OdTvDb2dPolyline
* non-spline fit OdTvDb3dPolyline

    \param taperAngle [in] Extrusion taper angle in radians. Default value is 0.0. 
    Value must be between 0.5 pi and -0.5 pi. 
    If the path represented by the OdTvDbCurve object is closed, the taper angle parameter is ignored.
  ...
  */
  virtual OdResult extrudeAlongPath(const OdTvDbRegion* region, const OdTvDbCurve* path, double taperAngle = 0.0, bool isSolid = true) = 0;
...
* Face
  ...
  */
  virtual OdResult imprintEntity(const OdTvDbEntity *pEntity) = 0;
  ...
  */
  virtual OdResult getSection(const OdGePlane& plane, OdTvDbRegionPtr &sectionRegion, OdTvDbEntityPtrArray* pSectionCurves = NULL) const = 0;
  ...
  */
  virtual OdResult getSlice(const OdGePlane& plane, bool getNegHalfToo, OdTvDb3dSolidPtr &negHalfSolid) = 0;
  ...
  */
  virtual OdResult getSlice(OdTvDbSurface* pSurface, bool bGetNegHalfToo, OdTvDb3dSolidPtr& pNegHalfSolid) = 0;
  ...
  */
  ...
  //virtual OdResult offsetBody(OdTvDbEntity* pOffsetEnt, double offsetDistance) = 0;
  /** \details
    ...
    \param newSolids [out] Reference to an array of pointers to OdTvDb3dSolid objects representing the additional disjoint volumes. 
  ...
  */
  virtual OdResult separateBody(OdTvDb3dSolidPtrArray &newSolids) = 0;
  /** \details
  ...
  */
  virtual OdResult createBlendObject(
    ...
    OdTvDbBlendOptions& blendOptions,
    bool isSolid = true) = 0;
  /** \details
...
* 3 <= sides <= 64.
  ...
  */
  ...
  /** \details
    ...
    The default value for the alignment option of OdTvDbSweepOptions (returned by align() method) is kNoAlignment. 
  ...
  */
  ...
  virtual OdResult  checkSweepPathCurve ( OdTvDbEntity *pPathEnt,    bool displayErrorMessages = false ) = 0;
  ...
  */
  ...
  /** \details
    ...
    \param pFromEntity [in]  Pointer to either a planar entity with thickness, a simple, closed planar entity, or an OdTvDbSolid entity 
    pointed to by pFromEntity. 

    \returns
    Returns eOk if successful, or an appropriate error code if not. 
  */
  virtual OdResult createFrom ( const OdTvDbEntity* pFromEntity ) = 0;

  /** \details
    Creates region (OdTvDbRegion class) entities for each face of the ModelerGeometry object. 

    \param regions [out]  Reference to an array of the OdTvDbRegion entities created from the face of the ModelerGeometry object.
  
    \returns Returns eOk if successful, or an appropriate error code otherwise.
  */
  virtual OdResult convertToRegion ( OdTvDbEntityPtrArray& regions ) = 0;
  ...
  /** \details
    ...
    \param pSolid     [out] Reference to an OdTvDb3dSolid object pointer created during the thickening. If thickening fails, this parameter is NULL.
    
    \returns Returns eOk if successful, or an appropriate error code otherwise.
  */
  virtual OdResult thicken(double thickness, bool bBothSides, OdTvDb3dSolidPtr& pSolid) const = 0;
  /** \details
  ...
  */
  ...
  virtual OdResult copySubEntity(const OdDbSubentId &subentId, OdTvDbEntityPtr &newEntity) const = 0;
  /** \details
...
* negative value means inside direction
  ...
  */
  virtual OdResult getSubentPathsAtGsMarker(OdDb::SubentType type,
                                            ...
                                            const OdTvDbObjectIdArray* entAndInsertStack = 0) const = 0;
  /** \details
  ...
  */
  ...
  /** \details
    ...
    \returns Returns eOk if successful or an appropriate error code in the other case.
  */
  virtual OdResult setSubentColor(const OdDbSubentId &subentId, const OdTvCmColor &color) = 0;

  /** \details
    Returns the color of the specified subentity.

    \param subentId [in] ID of the subentity.
    \param color    [in] A reference to an OdTvCmColor object to store the current color of the specified subentity.

    \returns Returns eOk if successful or an appropriate error code in the other case.
  */
  virtual OdResult getSubentColor(const OdDbSubentId &subentId, OdTvCmColor &color) const = 0;
  ...
  */
  virtual OdResult setSubentMaterial(const OdDbSubentId &subentId, OdTvDbObjectId matId) = 0;

  /** \details
    Returns the material of the specified subentity.

    \param subentId [in] Subentity ID.
    \param matId    [in] Reference to an OdTvDbObjectId for returning the material object ID.
  ...
  */
  virtual OdResult createSectionObjects(const OdGePlane& sectionPlane, OdTvDbEntityPtrArray& sectionObjects) const = 0;
  ...
  /** \details
    ...
    \param pEntity             [in]   Pointer to an entity the object must interfere with. pEntity can point to the following entity types: OdTvDbSurface, OdTvDb3dSolid, OdTvDbRegion, or OdTvDbBody.
  ...
  */
  virtual OdResult sliceByPlane(const OdGePlane& slicePlane, OdTvDbSurfacePtr& pNegHalfSurface, OdTvDbSurfacePtr& pNewSurface, bool bNotModifyItself) = 0;
  ...
  /** \details
    ...
    \returns Returns eOk if the slicing operation is successfully performed or an appropriate error code otherwise. 
  */
  virtual OdResult sliceBySurface(const OdTvDbSurfacePtr pSlicingSurface, OdTvDbSurfacePtr& pNegHalfSurface, OdTvDbSurfacePtr& pNewSurface, bool bNotModifyItself) = 0;
...
* Non-spline fit OdTvDb3dPolyline
  ...
  */
  virtual OdResult extrudeFacesAlongPath(const OdArray<OdDbSubentId *> &faceSubentIds, const OdTvDbCurve* path) = 0;
  ...
  */
  virtual OdResult convertToNurbSurface(OdTvDbNurbSurfacePtrArray& nurbSurfaceArray) = 0;
  ...
  */
  ...
  /** \details
    ...
    \returns Returns eOk if successful or an appropriate error code in the other case.
  */
  virtual OdResult getIsolineAtU(double dNumberSegments, OdTvDbCurvePtrArray& lineSegments) const = 0;
  ...
  /** \details
    ...
    \returns Returns eOk if successful or an appropriate error code in the other case.
  */
  virtual OdResult getIsolineAtV(double dNumberSegments, OdTvDbCurvePtrArray& lineSegments) const = 0;
  ...
  */
  virtual OdResult setColorToSubents(OdTvCmColor const& color) = 0;
  ...
  */
  virtual OdResult setMaterialToSubents(OdTvDbObjectId materialId) = 0;
  ...
  */
  ...
  virtual OdResult projectOnToEntity( const OdTvDbEntity*   pEntityToProject,
                                      ...
                                      OdTvDbEntityPtrArray& projectedEntities ) const = 0;
...
* kTrimBoth
  ...
  */                                  
  ...
  /** \details 
    For internal use only.
  */  
  virtual OdResult generateSectionGeometry( SectArgs& sectArgs, OdTvDbEntity *pEnt, bool* bHasForeground ) = 0;
  ...
  */
  ...
  /** \details
   Creates a new OdTvDb3dSolid or OdTvDbSurface object.
   ...
   * eInvalidContext - if it is not possible to create a OdTvDb3dSolid.
...
*/
  virtual OdResult convertTo(const OdGePoint3dArray &arrVertexes, const OdInt32Array &arrEdges, const OdInt32Array &arrFaces, OdGiFaceData &fd,
    OdBoolArray &arrFacesColors, OdBoolArray &arrFacesMaterials, OdTvDbEntity* pEntity) = 0;

  virtual bool getFaceMesh(GeMesh::OdGeTrMesh& mesh, OdGsMarker iFace, const wrTriangulationParams& triangulationParams) = 0;

  virtual OdResult auditAcisData(OdTvDbAuditInfo* pInfo, const OdRxObject* pObj) { return eNotImplemented; }
