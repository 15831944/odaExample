...
/** \details
    ...
    \remarks
    Database-resident OdTvDbRenderSettings objects are stored in the NamedObjectsDictionary
    under TV_ACAD_RENDER_SETTINGS. 
    
    In addition, the active RenderSettings are stored in the NamedObjectsDictionary 
    under TV_ACAD_RENDER_ACTIVE_SETTINGS. 

    \sa
    TD_Db
    <group OdTvDb_Classes> 
*/
class SCENEOE_EXPORT OdTvDbRenderSettings : public OdTvDbObject
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbRenderSettings);

  OdTvDbRenderSettings();
  virtual ~OdTvDbRenderSettings();
  ...
  */
  ...
  /** \details
    ...
    \remarks
    The DisplayIndex specfies the display order in the UI of the entries in the TV_ACAD_RENDER_SETTINGS dictionary.
  ...
  */
  ...
  virtual bool operator==(const OdTvDbRenderSettings& settings);

  static OdSmartPtr<OdTvDbRenderSettings> castByClassName(OdRxObject* obj) {
    return ::odrxCastByClassName<OdTvDbRenderSettings>(obj, "AcTvDbRenderSettings");
  }
};

/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbRenderSettings object pointers.
*/
typedef OdSmartPtr<OdTvDbRenderSettings> OdTvDbRenderSettingsPtr;
...
/** \details
    ...
    \remarks
    Database-resident OdTvDbMentalRayRenderSettings objects are stored in the NamedObjectsDictionary
    under TV_ACAD_RENDER_SETTINGS. 
    ...
    <group OdTvDb_Classes> 
*/
class SCENEOE_EXPORT OdTvDbMentalRayRenderSettings : public OdTvDbRenderSettings
{
public:
  /** \details
...
public:
  ODDB_DECLARE_MEMBERS(OdTvDbMentalRayRenderSettings);

  OdTvDbMentalRayRenderSettings();

  virtual ~OdTvDbMentalRayRenderSettings();
...
\remarks
  ...
  */
  ...
  virtual bool operator==(const OdTvDbMentalRayRenderSettings& settings);
};

/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbMentalRayRenderSettings object pointers.
*/
typedef OdSmartPtr<OdTvDbMentalRayRenderSettings> OdTvDbMentalRayRenderSettingsPtr;
...
/** \details
    ...
    \remarks
    Database-resident OdTvDbRapidRTRenderSettings objects are stored in the NamedObjectsDictionary
    under TV_ACAD_RENDER_RAPIDRT_SETTINGS.

    In addition, the active RenderSettings are stored in the NamedObjectsDictionary
    under TV_ACAD_RENDER_ACTIVE_RAPIDRT_SETTINGS.

    \sa
    TD_Db
    <group OdTvDb_Classes>
*/
class SCENEOE_EXPORT OdTvDbRapidRTRenderSettings : public OdTvDbRenderSettings
{
public:
  /** \details
...
public:
  ODDB_DECLARE_MEMBERS(OdTvDbRapidRTRenderSettings);

  OdTvDbRapidRTRenderSettings();

  virtual ~OdTvDbRapidRTRenderSettings();
  ...
  */
  ...
  virtual bool operator==(const OdTvDbRapidRTRenderSettings& settings);
};

/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbRapidRTRenderSettings object pointers.
*/
typedef OdSmartPtr<OdTvDbRapidRTRenderSettings> OdTvDbRapidRTRenderSettingsPtr;


/** \details

    \remarks
    Database-resident OdTvDbRenderEnvironment objects are stored in the NamedObjectsDictionary
    under TV_ACAD_RENDER_ENVIRONMENT. 
    
    \sa
    TD_Db
    <group OdTvDb_Classes> 
*/
class SCENEOE_EXPORT OdTvDbRenderEnvironment : public OdTvDbObject
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbRenderEnvironment);

  OdTvDbRenderEnvironment();
  virtual ~OdTvDbRenderEnvironment();
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbRenderEnvironment object pointers.
*/
typedef OdSmartPtr<OdTvDbRenderEnvironment> OdTvDbRenderEnvironmentPtr;
...
/** \details
    ...
    \remarks
    Database-resident OdTvDbRenderGlobal objects are stored in the NamedObjectsDictionary
    under TV_ACAD_RENDER_GLOBAL.
    
    \sa
    TD_Db
    <group OdTvDb_Classes> 
*/
class SCENEOE_EXPORT OdTvDbRenderGlobal : public OdTvDbObject
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbRenderGlobal);
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbRenderGlobal object pointers.
*/
typedef OdSmartPtr<OdTvDbRenderGlobal> OdTvDbRenderGlobalPtr;


/** \details

    \remarks
    Database-resident OdTvDbRenderEntry objects are stored in the NamedObjectsDictionary
    under TV_ACAD_RENDER_ENTRIES.
    
    \sa
    TD_Db
    <group OdTvDb_Classes> 
*/
class SCENEOE_EXPORT OdTvDbRenderEntry : public OdTvDbObject
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbRenderEntry);

  OdTvDbRenderEntry();
  virtual ~OdTvDbRenderEntry();
  ...
  OdResult setStartTime(const OdTvDbDate &date);
  const OdTvDbDate &startTime() const;

  OdResult setEndTime(const OdTvDbDate &date);
  const OdTvDbDate &endTime() const;
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbRenderEntry object pointers.
*/
typedef OdSmartPtr<OdTvDbRenderEntry> OdTvDbRenderEntryPtr;


TOOLKIT_EXPORT OdTvDbObjectId odtvdbGetRenderSettingsDictionaryId(OdTvDbDatabase* pDb, bool createIfNotFound = false);
TOOLKIT_EXPORT OdTvDbDictionaryPtr odtvdbGetRenderSettingsDictionary(OdTvDbDatabase* pDb, OdDb::OpenMode mode, bool createIfNotFound = false);
TOOLKIT_EXPORT OdTvDbObjectId odtvdbGetRenderPlotSettingsDictionaryId(OdTvDbDatabase* pDb, bool createIfNotFound = false);
TOOLKIT_EXPORT OdTvDbDictionaryPtr odtvdbGetRenderPlotSettingsDictionary(OdTvDbDatabase* pDb, OdDb::OpenMode mode, bool createIfNotFound = false);
TOOLKIT_EXPORT OdTvDbObjectId odtvdbGetRenderGlobalObjectId(OdTvDbDatabase* pDb, bool createIfNotFound = false);
TOOLKIT_EXPORT OdTvDbRenderGlobalPtr odtvdbGetRenderGlobalObject(OdTvDbDatabase* pDb, OdDb::OpenMode mode, bool createIfNotFound = false);
TOOLKIT_EXPORT OdTvDbObjectId odtvdbGetRenderEnvironmentObjectId(OdTvDbDatabase* pDb, bool createIfNotFound = false);
TOOLKIT_EXPORT OdTvDbRenderEnvironmentPtr odtvdbGetRenderEnvironmentObject(OdTvDbDatabase* pDb, OdDb::OpenMode mode, bool createIfNotFound = false);
TOOLKIT_EXPORT OdTvDbObjectId odtvdbGetActiveRenderSettingsObjectId(OdTvDbDatabase* pDb, bool createIfNotFound = false);
TOOLKIT_EXPORT OdTvDbRenderSettingsPtr odtvdbGetActiveRenderSettingsObject(OdTvDbDatabase* pDb, OdDb::OpenMode mode, bool createIfNotFound = false);
TOOLKIT_EXPORT OdTvDbObjectId odtvdbGetRenderEntriesDictionaryId(OdTvDbDatabase* pDb, bool createIfNotFound = false);
TOOLKIT_EXPORT OdTvDbDictionaryPtr odtvdbGetRenderEntriesDictionary(OdTvDbDatabase* pDb, OdDb::OpenMode mode, bool createIfNotFound = false);
TOOLKIT_EXPORT OdTvDbObjectId odtvdbGetRenderRapidRTSettingsDictionaryId(OdTvDbDatabase* pDb, bool createIfNotFound = false);
TOOLKIT_EXPORT OdTvDbDictionaryPtr odtvdbGetRenderRapidRTSettingsDictionary(OdTvDbDatabase* pDb, OdDb::OpenMode mode, bool createIfNotFound = false);
TOOLKIT_EXPORT OdTvDbObjectId odtvdbGetActiveRenderRapidRTSettingsObjectId(OdTvDbDatabase* pDb, bool createIfNotFound = false);
TOOLKIT_EXPORT OdTvDbRenderSettingsPtr odtvdbGetActiveRenderRapidRTSettingsObject(OdTvDbDatabase* pDb, OdDb::OpenMode mode, bool createIfNotFound = false);
