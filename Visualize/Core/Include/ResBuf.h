...
class is specialization of the OdSmartPtr class for the OdTvResBuf class.
...
*/
class TOOLKIT_EXPORT OdTvResBuf : public OdRxObject
{
public:

  ODRX_DECLARE_MEMBERS(OdTvResBuf);
  ...
  */
  ...
  /** \details
    ...
    <link db_rb.html, Working with Tagged Data>
  */
  bool operator==( const OdTvResBuf& Rb ) const;
...
//  kRtModeless                 = 5027,
  ...
  /** \details
    ...
    \remarks
    Use the OdTvDxfCode::_getType() static method to determine the type of data associated 
    ...
    OdTvResBuf::ValueType enumerator

    OdTvResBuf::setRestype() method
  */
  int restype() const;
  ...
  */
  ...
  /** \details
    ...
    OdTvResBuf::last(), OdTvResBuf::setNext() methods
  */
  OdTvResBufPtr next() const;
  ...
  /** \details
    ...
    OdTvResBuf::next(), OdTvResBuf::setNext() methods
  */
  OdTvResBufPtr last() const;
  ...
  /** \details
    ...
    OdTvResBuf::next(), OdTvResBuf::last(), OdTvResBuf::setNext() methods
  */
  OdTvResBufPtr insert( OdTvResBuf* pRb );
  ...
  /** \details
    ...
    OdTvResBuf::next(), OdTvResBuf::last(), OdTvResBuf::insert() methods
  */
  OdTvResBufPtr setNext( OdTvResBuf* pRb );
  ...
  /** \details
    ...
    OdTvResBuf::setString(), OdTvResBuf::restype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::getString(), OdTvResBuf::setRestype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::setBool(), OdTvResBuf::restype(), OdTvDxfCode::_getType() methods
  */
  bool getBool() const;
  ...
  /** \details
    ...
    OdTvResBuf::getBool(), OdTvResBuf::setRestype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::setInt8(), OdTvResBuf::restype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::getInt8(), OdTvResBuf::setRestype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::setInt16(), OdTvResBuf::restype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::getInt16(), OdTvResBuf::setRestype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::setInt32(), OdTvResBuf::restype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::getInt32(), OdTvResBuf::setRestype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::setInt64(), OdTvResBuf::restype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::getInt64(), OdTvResBuf::setRestype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::setDouble(), OdTvResBuf::restype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::getDouble(), OdTvResBuf::setRestype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::setPoint2d(), OdTvResBuf::restype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::getPoint2d(), OdTvResBuf::setRestype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::setPoint3d(), OdTvResBuf::restype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::getPoint3d(), OdTvResBuf::setRestype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::setVector2d(), OdTvResBuf::restype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::getVector2d(), OdTvResBuf::setRestype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::setVector3d(), OdTvResBuf::restype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::getVector3d(), OdTvResBuf::setRestype(), OdTvDxfCode::_getType() methods
  */
  ...
  /** \details
    ...
    OdTvResBuf::setBinaryChunk(), OdTvResBuf::restype(), OdTvDxfCode::_getType() methods
  ...
  */
  ...
  /** \details
    ...
    OdTvResBuf::getBinaryChunk(), OdTvResBuf::setRestype(), OdTvDxfCode::_getType() methods
  ...
  */
  ...
  /** \details
    ...
    to kRtColor. The OdTvDxfCode::_getType() method returns Unknown type for it.
    ...
    OdTvResBuf::setColor(), OdTvResBuf::restype() methods
  */
  const OdTvCmColor& getColor() const;


  /** \details
    Sets the data content of the ResBuf object using the specified Color instance 
    only if the group code is set to OdTvResBuf::kRtColor.
      
    \param cmColor [in]  Color instance to be set.

    \remarks
    This method generates the OdError_InvalidResBuf exception when the stored group code is not set 
    to kRtColor. The passed value must be the OdTvCmColor instance. The OdTvDxfCode::_getType() 
    ...
    OdTvResBuf::getColor(), OdTvResBuf::setRestype() methods
  */
  ...
  /** \details
    ...
    \remarks
    This method generates the OdError_InvalidResBuf exception when the stored group code is not set 
    to kRtResBuf. The OdTvDxfCode::_getType() method returns Unknown type for it.
    ...
    OdTvResBuf::setResBuf(), OdTvResBuf::restype() methods
  */
  OdTvResBufPtr getResBuf() const;


  /** \details
    Sets the data content of the ResBuf object using the specified ResBuf instance 
    only if the group code is set to OdTvResBuf::kRtResBuf.
    ...
    OdTvResBuf::getResBuf(), OdTvResBuf::setRestype() methods
  */
  void setResBuf( const OdTvResBuf* pResBuf );
  ...
  /** \details
    ...
    OdTvResBuf::setHandle(), OdTvResBuf::restype(), OdTvDxfCode::_getType() methods
  ...
  */
  ...
  /** \details
    ...
    OdTvResBuf::getHandle(), OdTvResBuf::setRestype(), OdTvDxfCode::_getType() methods
  ...
  */
  ...
  /** \details
    Returns the data content of the ResBuf object as an OdTvDbObjectId instance.
    ...
    OdTvResBuf::setObjectId(), OdTvResBuf::restype(), OdTvDxfCode::_getType() methods

    OdTvDbObjectId, OdDbHandle classes
  */
  const OdTvDbObjectId& getEntName() const;
  ...
  /** \details
    ...
    \remarks
    This method generates the OdError_InvalidResBuf exception when the stored data type does not 
    correspond to the ObjectId type. The passed value must be the OdTvDbObjectId instance.
    ...
    OdTvResBuf::getEntName(), OdTvResBuf::setRestype(), OdTvDxfCode::_getType() methods

    OdTvDbObjectId, OdDbHandle classes
  */
  void setObjectId( const OdTvDbObjectId& idObject );


  /** \details
    Returns the data content of the ResBuf object as an OdTvDbObjectId instance using the 
    ...
    OdTvResBuf::setObjectId(), OdTvResBuf::restype(), OdTvDxfCode::_getType() methods
  */
  OdTvDbObjectId getObjectId( const OdTvDbDatabase* pDb ) const;
  ...
  */
  void setPickSet(const OdTvDbSelectionSet* pSSet);
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType = OdTvResBuf::kRtNone);
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, bool resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
    pRes->setBool(resVal);
    return pRes;
  }
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, OdInt8 resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
    pRes->setInt8(resVal);
    return pRes;
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, OdUInt8 resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
    pRes->setInt8(resVal);
    return pRes;
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, OdInt16 resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, OdUInt16 resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
    pRes->setInt16(resVal);
    return pRes;
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, OdInt32 resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, OdUInt32 resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
    pRes->setInt32(resVal);
    return pRes;
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, OdInt64 resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, OdUInt64 resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
    pRes->setInt64(resVal);
    return pRes;
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, double resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, const OdGePoint2d& resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, const OdGePoint3d& resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, const OdGeVector2d& resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, const OdGeVector3d& resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, const OdString& resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, const OdChar* resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
    pRes->setString(resVal);
    return pRes;
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, const __wchar_t* resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
    pRes->setString(resVal);
    return pRes;
...
/** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, const OdTvCmColor& resVal)
  {
    OdTvResBufPtr pRes = newRb(resType);
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, const OdTvDbObjectId& id)
  {
    OdTvResBufPtr pRes = newRb(resType);
    pRes->setObjectId(id);
    return pRes;
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, const OdTvDbSelectionSet* pSSet)
  {
    OdTvResBufPtr pRes = newRb(resType);
  ...
  /** \details
    ...
    <link db_rb_data_object.html, Getting and Setting Objects>
  */
  static OdTvResBufPtr newRb(int resType, const OdTvResBuf* pNestedRb)
  {
    OdTvResBufPtr pRes = newRb(resType);
...
protected:
  ...
  */
  ...
  OdTvResBufPtr m_pNext;   // Smart pointer to another instance for attaching in a sequence
};

inline bool
OdTvResBuf::operator!=( const OdTvResBuf& other ) const
{
...
*/
TOOLKIT_EXPORT bool odtvdbCompareRbChains(const OdTvResBuf* pRb1, const OdTvResBuf* pRb2);
