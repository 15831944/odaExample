...
*/
class DBENT_EXPORT OdTvDbCurvePE : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbCurvePE);
  ...
  */
  virtual OdResult getOrthoProjectedCurve(const OdTvDbCurve* pCurve, 
    const OdGePlane& projPlane, 
    OdTvDbCurvePtr* pProjCurve) const = 0;
 ...
 /** \details
    ...
    Returns eOk if successful, or an appropriate error code if not.
 */
  virtual OdResult getProjectedCurve(const OdTvDbCurve* pCurve, 
    const OdGePlane& projPlane,
  ...
  */
  virtual OdResult getOffsetCurves(const OdTvDbCurve* pCurve, 
  ...
  /** \details
    ...
    Pointers to all new curves are appended to the offsetCurves array.
  */
  virtual OdResult getOffsetCurvesGivenPlaneNormal(const OdTvDbCurve* pCurve, 
  ...
  */
  virtual OdResult getSplitCurves (const OdTvDbCurve* pCurve, 
  ...
  */
  ...
  /** \details
    ...
    Returns eOk if successful, or an appropriate error code if not.
  */
  virtual OdResult extend(OdTvDbCurve* pCurve, 
    double param) = 0;
  ...
  /** \details
    ...
    Returns eOk if successful, or an appropriate error code if not.
  */
  virtual OdResult extend(OdTvDbCurve* pCurve, bool extendStart,
    const OdGePoint3d& toPoint) = 0;


  /** \details
    Returns an OdTvDbSpline approximation of the specified Curve object.
    ...
    Returns eOk if successful, or an appropriate error code if not.
  */
  virtual OdResult getSpline (const OdTvDbCurve* pCurve, 
    OdTvDbSplinePtr* spline) const = 0;
  ...
  /** \details
    ...
    Returns eOk if successful, or an appropriate error code if not.
  */
  virtual OdResult getClosestPointTo(const OdTvDbCurve* pCurve, 
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbCurvePE object pointers.
*/
typedef OdSmartPtr<OdTvDbCurvePE> OdTvDbCurvePEPtr;
