...
/** \details
    This class implements bidirectional Iterator objects that traverse entries in OdTvDbBlockTable objects in an OdTvDbDatabase instance.

    Corresponding C++ library: TD_Db

    <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbBlockTableIterator : public OdTvDbSymbolTableIterator
{
public:
  
  ODRX_DECLARE_MEMBERS(OdTvDbBlockTableIterator);
  
protected:

  OdTvDbBlockTableIterator();
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbBlockTableIterator object pointers.
*/
typedef OdSmartPtr<OdTvDbBlockTableIterator> OdTvDbBlockTableIteratorPtr;


/** \details
    This class implements the BlockTable, which represents block definitions in an OdTvDbDatabase instance.
    ...
    <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbBlockTable : public OdTvDbSymbolTable
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbBlockTable);

  /** \details
    Client applications typically do not use this constructor, insofar as 
    the OdTvDbDatabase class creates its own instance.
  */
  OdTvDbBlockTable();
  ...
  */
  const OdTvDbObjectId& getModelSpaceId() const;

  /** \details
    Returns the Object ID of the Paper Space record within this BlockTable object.
  */
  const OdTvDbObjectId& getPaperSpaceId() const;
  ...
  /** \details
    ...
    4) Call the OdTvDbDwgFiler(pFiler) methods to read each of the object's data items in
  ...
  */
  ...
  /** \details
    ...
    3) Call the OdTvDbDwgFiler(pFiler) methods to write each of the object's data items 
  ...
  */ 
  virtual void applyPartialUndo(OdTvDbDwgFiler* pFiler, OdRxClass* pClass);
};
