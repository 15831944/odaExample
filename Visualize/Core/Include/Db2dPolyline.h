...
/** \details
    This class represents 2D Polyline entities in an OdTvDbDatabase instance.
...
*/
class DBENT_EXPORT OdTvDb2dPolyline: public OdTvDbCurve
{
public:

  DWGMAP_DECLARE_MEMBERS(OdTvDb2dPolyline);
  ...
  */
  OdTvDbObjectId insertVertexAt(
    const OdTvDbObjectId& indexVertId, 
    OdTvDb2dVertex* pVertex);
  ...
  */
  OdTvDbObjectId insertVertexAt(
    const OdTvDb2dVertex* pIndexVert, 
    OdTvDb2dVertex* pVertex);
  ...
  */
  OdTvDb2dVertexPtr openVertex(
    OdTvDbObjectId vertId, 
    OdDb::OpenMode mode, 
    bool openErasedOne = false);

  /** \details
    Opens the OdTvDbSequenceEnd entity for this Polyline entity.
  ...
  */
  OdGePoint3d vertexPosition(
    const OdTvDb2dVertex& vertex) const;
  ...
  */
  ...
  virtual OdInt32 findVertexIndex(const OdTvDbVertex* vert) const;
};
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDb2dPolyline object pointers.
*/
typedef OdSmartPtr<OdTvDb2dPolyline> OdTvDb2dPolylinePtr;


/*

inline void OdTvDb2dPolyline::extend(double)
{
