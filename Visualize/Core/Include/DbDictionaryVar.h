...
/** \details
    This class represents Dictionary Variable objects in an OdTvDbDatabase instance.
    
    Corresponding C++ library: TD_Db

    <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbDictionaryVar : public OdTvDbObject
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbDictionaryVar);
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbDictionaryVar object pointers.
*/
