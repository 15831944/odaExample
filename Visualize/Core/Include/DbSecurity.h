...
/** \details
    This class represents the security parameters used by OdTvDbCrypt classes.
...
/** \details
    ...
    <group Other_Classes>
*/
class TOOLKIT_EXPORT OdTvDbCrypt : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbCrypt);

  /** \details
    Initializes this OdTvDbCrypt object with the specified security parameters.
  ...
  */
  ...
  /** \details
     \returns
     Returns true if and only if trusted certificate was found during OdTvDbCrypt initialization.
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbCrypt object pointers.
*/
typedef OdSmartPtr<OdTvDbCrypt> OdTvDbCryptPtr;
