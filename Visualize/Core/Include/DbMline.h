...
/** \details
  This struct contains enumerated types and data used by OdTvDbMline.
...
/** \details
    ...
    This class represents multi-line entities in an OdTvDbDatabase instance.
    ...
    OdTvDbXline, OdTvDbLine classes
*/
class DBENT_EXPORT OdTvDbMline : public OdTvDbEntity
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbMline);
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbMline object pointers.
*/
typedef OdSmartPtr<OdTvDbMline> OdTvDbMlinePtr;
