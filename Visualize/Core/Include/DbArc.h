...
/** \details
  ...
  OdTvDbCircle, OdTvDbEllipse classes
*/
class DBENT_EXPORT OdTvDbArc : public OdTvDbCurve
{
public:

  DWGMAP_DECLARE_MEMBERS(OdTvDbArc);
  ...
  */
  ...
  /** \details
    ...
    OdTvDbArc::setStartAngle(), OdTvDbArc::endAngle() methods
  */
  ...
  /** \details
    ...
    OdTvDbArc::startAngle(), OdTvDbArc::setEndAngle() methods
  */
  ...
  /** \details
    ...
    OdTvDbArc::setEndAngle(), OdTvDbArc::startAngle() methods
  */
  ...
  /** \details
    ...
    OdTvDbArc::endAngle(), OdTvDbArc::setStartAngle() methods
  */
  ...
  */
  ...
  /** \details
    ...
    OdTvDbArc::getPlane(), OdTvDbEntity::isPlanar() methods
  */
  ...
  */
  ...
  /*
     OdTvDbArc(const OdGePoint3d& center, double radius,
             double startAngle, double endAngle);
     OdTvDbArc(const OdGePoint3d& center, const OdGeVector3d& normal,
...
/** \details
  ...
  template class is specialization of the OdSmartPtr class for the OdTvDbArc class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbArc> OdTvDbArcPtr;
