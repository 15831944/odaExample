...
/** \details
    This class implements Spatial Filter objects in an OdTvDbDatabase instance.
...
*/
class TOOLKIT_EXPORT OdTvDbSpatialFilter : public OdTvDbFilter
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbSpatialFilter);
  ...
  */
  ...
  OdResult generateClipBoundaryFromPline(OdTvDbObjectId id);
};

/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbSpatialFilter object pointers.
*/
typedef OdSmartPtr<OdTvDbSpatialFilter> OdTvDbSpatialFilterPtr;
