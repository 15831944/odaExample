...
class OdTvDbLayerStateManagerReactor;
class OdTvDbLayerStateManagerImpl;
...
*/
class TOOLKIT_EXPORT OdTvDbLayerStateManager: public OdRxObject
{
protected:
  OdTvDbLayerStateManager(OdTvDbLayerStateManagerImpl*);
public:
//DOM-IGNORE-BEGIN
  ODRX_DECLARE_MEMBERS(OdTvDbLayerStateManager);
//DOM-IGNORE-END

  /** \details
    Default constructor for objects of the OdTvDbLayerStateManager class.
  */
  OdTvDbLayerStateManager();

  /** \details
    Default destructor for objects of the OdTvDbLayerStateManager class.
  */
  ~OdTvDbLayerStateManager();
  ...
  */
  ...
  /** \details
    ...
    \param OdTvDbLayerStateManagerReactor [in]  Pointer to the state manager reactor object to be added.
  ...
  */
  bool                addReactor(OdTvDbLayerStateManagerReactor * pReactor);

  /** \details
    Removes a state manager reactor to this state manager object.

    \param OdTvDbLayerStateManagerReactor [in]  Pointer to the state manager reactor object to be removed.

    \returns True if the state manager reactor was removed successfully; false
             otherwise.
  */
  bool                removeReactor(OdTvDbLayerStateManagerReactor * pReactor);
  ...
  /** \details
    ...
    otherwise.
  */
  OdTvDbObjectId        layerStatesDictionaryId(bool bCreateIfNotPresent=false);
  ...
  */
  ...
  /** \details
    ...
    \returns eOk if operation succeeded; error code otherwise.
  */
  OdResult   saveLayerState(const OdString& sName, LayerStateMask mask, const OdTvDbObjectId& idVp);
  ...
  /** \details
    ...
    \returns eOk if operation succeeded; error code otherwise.
  */
  OdResult   restoreLayerState(const OdString& sName, const OdTvDbObjectId& idVp, int nRestoreFlags = 0, const LayerStateMask* pClientMask = NULL);
  ...
  */
  ...
  /** \details
    ...
    \returns eOk if operation succeeded; error code otherwise.
  */
  OdResult   importLayerStateFromDb(const OdString& pStateName, OdTvDbDatabase* pDb);
  ...
  */
  ...
  /** \details
    ...
    \returns eOk if operation succeeded; error code otherwise.
  */
  OdResult   getLastRestoredLayerState(OdString& sName, OdTvDbObjectId &restoredLSId);
  ...
  */
  bool       compareLayerStateToDb(const OdString& sName, const OdTvDbObjectId& idVp);
  ...
  /** \details
    ...
    \returns eOk if operation succeeded; error code otherwise.
  */
  OdResult   addLayerStateLayers(const OdString& sName, const OdTvDbObjectIdArray& layerIds);
  ...
  */
  OdTvDbDatabase* getDatabase() const;

protected:
  OdTvDbLayerStateManagerImpl* m_pImpl;
  friend class OdTvDbLayerStateManagerImpl;
...
/** \details
  ...
  of the OdTvDbLayerStateManager class).

  Corresponding C++ library: TD_Db
  <group OdTvDb_Classes> 
*/
class TOOLKIT_EXPORT OdTvDbLayerStateManagerReactor : public OdRxObject
{
public:
//DOM-IGNORE-BEGIN
  ODRX_DECLARE_MEMBERS(OdTvDbLayerStateManagerReactor);
//DOM-IGNORE-END
  ...
  /** \details
    ...
    \param layerStateId   [in]  ID of the corresponding OdTvDbLayerState object.
  */
  virtual void layerStateCreated(const OdString& layerStateName,
    const OdTvDbObjectId& layerStateId);
...
/** \details
  ...
  OdTvDbLayerStateManagerReactor object pointers.
*/
typedef OdSmartPtr<OdTvDbLayerStateManagerReactor> OdTvDbLayerStateManagerReactorPtr;

/** \details
  This class implements an interface for manipulating LayerStates in multiple OdTvDbDatabase instances.

  Corresponding C++ library: TD_Db
  <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbLayerState
{
public:
  ...
  */
  static OdTvDbObjectId dictionaryId(OdTvDbDatabase *pDb, bool createIfNotFound = false);
  ...
  */
  static bool has(OdTvDbDatabase *pDb, const OdString &layerStateName);
  ...
  */
  static void save(OdTvDbDatabase *pDb, const OdString &layerStateName, int layerStateMask, const OdTvDbObjectId &viewportId = OdTvDbObjectId::kNull);
  ...
  */
  static void restore(OdTvDbDatabase *pDb, const OdString &layerStateName,
    int flags = OdTvDbLayerStateManager::kUndefDoNothing, const int layerStateMask = -1, const OdTvDbObjectId& viewportId = OdTvDbObjectId::kNull);
  /** \details
  ...
  */
  static void setMask(OdTvDbDatabase *pDb, const OdString &layerStateName, int layerStateMask);
  ...
  */
  static int  mask(OdTvDbDatabase *pDb, const OdString &layerStateName);
  ...
  /** \details
    ...
    \param layerStateName [in]  LayerState name.
  */
  static void remove(OdTvDbDatabase *pDb, const OdString &layerStateName);
  ...
  */
  static void rename(OdTvDbDatabase *pDb, const OdString &oldName, const OdString &newName);
  ...
  */
  static ImportResult importData(OdTvDbDatabase *pDb, OdStreamBuf* pStreamBuf, OdString* pName = 0);
  ...
  /** \details
    ...
    \param layerStateName [in]  LayerState name.
  */
  static void exportData(OdTvDbDatabase *pDb, const OdString &layerStateName, OdStreamBuf* pStreamBuf);
  ...
  */
  static void setDescription(OdTvDbDatabase *pDb, const OdString &layerStateName, const OdString &description);
  /** \details
  ...
  */
  static OdString description(OdTvDbDatabase *pDb, const OdString &layerStateName);
  ...
  */
  static bool hasViewportData(OdTvDbDatabase *pDb, const OdString &layerStateName);
  ...
  /** \details
    ...
    \returns eOk if operation succeeded; error code otherwise.
  */
  static OdResult addLayerStateLayers(const OdString &sName, OdTvDbObjectIdArray layerIds);
  ...
  /** \details
    ...
    \returns eOk if operation succeeded; error code otherwise.
  */
  static OdResult removeLayerStateLayers(OdTvDbDatabase* pDb, const OdString sName, const OdStringArray& layerNames);
  ...
  /** \details
    ...
    \returns eOk if operation succeeded; error code otherwise.
  */
  static OdResult saveGroup(OdTvDbDatabase *pDb, const OdString &sName,
    const OdTvDbObjectIdArray& pLayers, int mask = OdTvDbLayerStateManager::kOn,
    int includedLayersState = OdTvDbLayerStateManager::kOn, int otherLayersState = OdTvDbLayerStateManager::kNone);
};
