...
/** \details
  ...
  OdTvDbCircle, OdTvDbArc classes
*/
class DBENT_EXPORT OdTvDbEllipse : public OdTvDbCurve
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbEllipse);
  ...
  */
  ...
  /** \details
    ...
    OdTvDbEllipse::setCenter() method
  */
  ...
  */
  ...
  /** \details
    ...
    OdTvDbEllipse::minorAxis(), OdTvDbEllipse::radiusRatio() methods
  */
  ...
  /** \details
    ...
    OdTvDbEllipse::majorAxis(), OdTvDbEllipse::radiusRatio() methods
  */
  ...
  /** \details
    ...
    OdTvDbEllipse::minorAxis(), OdTvDbEllipse::minorAxis(), OdTvDbEllipse::setRadiusRatio() methods
  */
  ...
  /** \details
    ...
    OdTvDbEllipse::minorAxis(), OdTvDbEllipse::minorAxis(), OdTvDbEllipse::radiusRatio() methods
  */
  ...
  /** \details
    ...
    OdTvDbEllipse::setStartAngle(), OdTvDbEllipse::endAngle() methods
  */
  ...
  /** \details
    ...
    OdTvDbEllipse::startAngle(), OdTvDbEllipse::setEndAngle() methods
  */
  ...
  /** \details
    ...
    OdTvDbEllipse::setEndAngle(), OdTvDbEllipse::startAngle() methods
  */
  ...
  /** \details
    ...
    OdTvDbEllipse::endAngle(), OdTvDbEllipse::setStartAngle() methods
  */
  ...
  */
  ...
  /** \details
    ...
    OdTvDbEllipse::getPlane(), OdTvDbEntity::isPlanar() methods
  */
  ...
  /** \details
    ...
    OdTvDbCircle::isPlanar(), OdTvDbEntity::getPlane() methods
  */
  ...
  /** \details
    ...
    OdTvDbEllipse::setStartParam() method sets this value. Parameter is an angle 
    ...
    OdTvDbEllipse::setStartParam(), OdTvDbEllipse::getEndParam() methods
  */
  ...
  /** \details
    ...
    OdTvDbEllipse::getStartParam(), OdTvDbEllipse::setEndParam() methods
  */
  ...
  /** \details
    ...
    OdTvDbEllipse::setEndParam() method sets this value. Parameter is an angle 
    ...
    OdTvDbEllipse::setEndParam(), OdTvDbEllipse::getStartParam() methods
  */
  ...
  /** \details
    ...
    OdTvDbEllipse::getEndParam(), OdTvDbEllipse::setStartParam() methods
  */
...
/** \details
  ...
  class is specialization of the OdSmartPtr class for the OdTvDbEllipse class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbEllipse> OdTvDbEllipsePtr;
