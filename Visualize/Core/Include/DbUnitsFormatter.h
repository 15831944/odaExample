...
*/
class ODRX_ABSTRACT TOOLKIT_EXPORT OdTvDbUnitsFormatter : public OdDbBaseUnitsFormatter
{ 
public:
  ODRX_DECLARE_MEMBERS(OdTvDbUnitsFormatter);

  /** \details
    Returns the specified color value or OdTvDbColor object as a string.
    \param value [in]  Value to format.
  */
  static OdString formatColor(const OdTvCmColor& value);

  /** \details
    Returns the specified string as an OdTvCmColor object.
    \param string [in]  String to unformat.
  */
  static OdTvCmColor unformatColor(const OdString& string);
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbUnitsFormatter object pointers.
*/
typedef OdSmartPtr<OdTvDbUnitsFormatter> OdTvDbUnitsFormatterPtr;
