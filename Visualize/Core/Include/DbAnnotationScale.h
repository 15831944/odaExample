...
class OdTvDbAnnotationScaleImpl;
class OdTvDbAnnotationScaleViewImpl;

////////////////////////////////////////////////////////////////////////
// class OdTvDbAnnotationScale
////////////////////////////////////////////////////////////////////////
...
/** \details
	...
	OdTvDbAnnotationScale context collection. An annotation scale is the ratio of paper 
...
*/
class TOOLKIT_EXPORT OdTvDbAnnotationScale : public OdTvDbObjectContext
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAnnotationScale);
 ...
 */
  ...
  /** \details
    Returns the name of the context collection (OdTvDbContextCollection) in which 
...
protected:
  OdTvDbAnnotationScale(OdTvDbAnnotationScaleImpl*);
  OdTvDbAnnotationScaleImpl* m_pImpl;
  friend class OdTvDbAnnotationScaleImpl;
};
...
/** \details
    ...
    <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbAnnotationScaleView : public OdTvDbAnnotationScale
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAnnotationScaleView);
  OdString collectionName() const;
protected:
  OdTvDbAnnotationScaleView(OdTvDbAnnotationScaleViewImpl*);
  friend class OdTvDbAnnotationScaleViewImpl;
};
...
/** \details
  <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbAnnotationScaleReactor : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAnnotationScaleReactor);

  virtual void annotationScaleChanged(const OdTvDbDatabase* pDb,
    const OdTvDbViewport* pVP,
    const OdTvDbAnnotationScale* pScale,
    const bool bInitializing);
};

// returns true if there was such reactor
// (puts it at the end of the list in any case)
TOOLKIT_EXPORT bool odtvdbAddAnnotationScaleReactor(OdTvDbAnnotationScaleReactor *pReactor);

// returns true if there was such reactor
TOOLKIT_EXPORT bool odtvdbRemoveAnnotationScaleReactor(OdTvDbAnnotationScaleReactor *pReactor);

#include "TD_PackPop.h"

typedef OdSmartPtr<OdTvDbAnnotationScale>OdTvDbAnnotationScalePtr;
