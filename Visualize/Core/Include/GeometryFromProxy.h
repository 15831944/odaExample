...
*/
DBENT_EXPORT bool odGetSatFromProxy(const OdTvDbProxyEntityPtr& adPart, OdAnsiString& sat);
...
*/
DBENT_EXPORT bool odGetSatFromProxy(const OdTvDbProxyEntityPtr& adPart, OdModelerGeometryPtr& pModelerGeometry);

DBIO_EXPORT OdTvDbProxyEntityPtr odEntityToProxy(const OdTvDbEntity &pEnt, OdDb::DwgVersion dwgVer = OdDb::kDHL_CURRENT, OdDb::MaintReleaseVer nMaintVer = OdDb::kMRelease0);

DBIO_EXPORT OdTvDbProxyObjectPtr odObjectToProxy(const OdTvDbObject &pObj, OdDb::DwgVersion dwgVer = OdDb::kDHL_CURRENT, OdDb::MaintReleaseVer nMaintVer = OdDb::kMRelease0);
