...
typedef OdSmartPtr<OdTvDbPolygonMeshVertex> OdTvDbPolygonMeshVertexPtr;
...
/** \details
    This class represents PolygonMesh entities in an OdTvDbDatabase instance.
...
*/
class DBENT_EXPORT OdTvDbPolygonMesh : public OdTvDbEntity
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbPolygonMesh);
  ...
  */
  ...
  OdTvDbObjectId appendVertex(
    OdTvDbPolygonMeshVertex* pVertex, 
  ...
  */
  OdTvDbPolygonMeshVertexPtr openVertex(
    OdTvDbObjectId vertId, 
    OdDb::OpenMode mode, 
    bool openErasedOne = false);
  
  /** \details
    Opens the OdTvDbSequenceEnd entity for this PolygonMesh entity.
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbPolygonMesh object pointers.
*/
typedef OdSmartPtr<OdTvDbPolygonMesh> OdTvDbPolygonMeshPtr;
