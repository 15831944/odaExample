...
/** \details
    This class represents feature control frames in an OdTvDbDatabase instance.

    <group OdTvDb_Classes>
*/
class DBDIM_EXPORT OdTvDbFcf : public OdTvDbEntity
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbFcf);
  ...
  */
  ...
  /** \details
    Sets the dimension style (OdTvDbDimStyleTableRecord) to used by this feature control frame (DXF 3).
    
    \param dimStyleId [in]  Object ID of the dimension style.
  */
  virtual void setDimensionStyle(
    OdTvDbHardPointerId dimStyleId);

  /** \details
    Returns the dimension style (OdTvDbDimStyleTableRecord) used by this feature control frame (DXF 3).
  */
  ...
  */
  ...
  virtual void modified(const OdTvDbObject* pObject) ODRX_OVERRIDE;
  ...
  */
  virtual void getBoundingPline(
    ...
    ptArray) const;
  /*
      virtual void getGripPoints(OdGePoint3dArray&, OdTvDbIntArray&, OdTvDbIntArray&) const;
      virtual void moveGripPointsAt(const OdTvDbIntArray&, const OdGeVector3d&);
  */
  ...
  virtual OdTvDbObjectPtr subWblockClone(OdTvDbIdMapping& idMap, OdTvDbObject* owner, bool bPrimary) const ODRX_OVERRIDE;
};
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbFcf object pointers.
*/
typedef OdSmartPtr<OdTvDbFcf> OdTvDbFcfPtr;
