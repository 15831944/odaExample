...
namespace OdTvDmUtil
{
  ...
  */
  OdTvDbObjectId TOOLKIT_EXPORT findArrowId(
    const OdString& arrowheadName, 
  ...
  /** \details
    ...
    \param pDb [in]  Database containing the arrowhead.
  */
  OdTvDbObjectId TOOLKIT_EXPORT getArrowId(
    const OdString& arrowheadName, 
    OdTvDbDatabase* pDb);

  /*
       OdString globalArrowName(const OdChar* pName);  
       OdString globalArrowName(OdTvDbObjectId blockId);
...
/** \details
    This class represents Dimension Style records in the OdTvDbDimStyleTable in an OdTvDbDatabase instance.
...
*/
class DBDIM_EXPORT OdTvDbDimStyleTableRecord: public OdTvDbSymbolTableRecord
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbDimStyleTableRecord);
  
  OdTvDbDimStyleTableRecord();
