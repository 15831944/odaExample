...
class OdTvDbGeoDataMarker;

/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbGeoDataMarker object pointers.
*/
typedef OdSmartPtr<OdTvDbGeoDataMarker> OdTvDbGeoDataMarkerPtr;

/** \details
  OdTvDbGeoDataMarker is OdTvDbGeoData location marker.
...
*/
class TOOLKIT_EXPORT OdTvDbGeoDataMarker : public OdGiDrawable
{
  OdGsViewPtr m_pView; // View in which current object is drawn.
  OdTvDbGeoDataMarker& operator = (const OdTvDbGeoDataMarker&);
  OdGsCache* m_pGsNode;
...
public:
  ...
  */
  static OdTvDbGeoDataMarkerPtr createObject();
