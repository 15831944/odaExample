...
class  OdTvDbEvalGraph;
class  OdTvDbEvalEdgeInfo;
class  OdTvDbEvalExpr;
class  OdTvDbEvalConnectable;
class  OdTvDbEvalContext;
class  OdTvDbEvalContextPair;
class  OdTvDbEvalContextIterator;
class  OdTvResBuf;
class  OdTvDbImpEvalContext;
class  OdTvDbImpEvalContextIterator;

/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbEvalGraph object pointers.
*/
typedef OdSmartPtr<OdTvDbEvalGraph> OdTvDbEvalGraphPtr;

/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbEvalContextIterator object pointers.
*/
typedef OdSmartPtr<OdTvDbEvalContextIterator> OdTvDbEvalContextIteratorPtr;

/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbEvalExpr object pointers.
*/
typedef OdSmartPtr<OdTvDbEvalExpr> OdTvDbEvalExprPtr;

typedef unsigned long OdTvDbEvalNodeId;

/** \details
    This template class is a specialization of the OdArray class for OdTvDbEvalNodeId objects.
*/
typedef OdArray<OdTvDbEvalNodeId, OdMemoryAllocator<OdTvDbEvalNodeId> > OdTvDbEvalNodeIdArray;
/** \details
    This template class is a specialization of the OdArray class for OdTvDbEvalEdgeInfo objects.
*/
typedef OdArray<OdTvDbEvalEdgeInfo> OdTvDbEvalEdgeInfoArray;
/** \details
    This template class is a specialization of the OdArray class for OdTvDbEvalExprPtr object SmartPointers.
*/
typedef OdArray<OdTvDbEvalExprPtr> OdTvDbEvalExprPtrArray;
/** \details
    This template class is a specialization of the OdArray class for OdTvResBufPtr object SmartPointers.
*/
typedef OdArray<OdTvResBufPtr> OdTvResBufArray;
...
/** \details
    ...
    \remarks
    Each element (OdTvDbEvalExpr object) depends on zero or more other elements. The
    dependencies are represented as edges to dependent nodes from the nodes
    on which they depend.

    In response to OdTvDbEvalGraph::evaluate(), this class traverses the graph and invokes
    OdTvDbEvalExpr::evaluate() for each of the elements in the graph in the proper order.

    Corresponding C++ library: TD_DynBlocks
    <group OdTvDb_Classes>

    \sa
    * OdTvDbEvalConnectable
    * OdTvDbEvalContext
    * OdTvDbEvalContextIterator
    * OdTvDbEvalContextPair
    * OdTvDbEvalEdgeInfo
    * OdTvDbEvalExpr
*/
class DYNBLOCKS_EXPORT OdTvDbEvalGraph : public OdTvDbObject
{
public:
  ...
  ODDB_DECLARE_MEMBERS(OdTvDbEvalGraph);

  OdTvDbEvalGraph();
  virtual ~OdTvDbEvalGraph();
  ...
  */
  static bool hasGraph(const OdTvDbObject* pObj,
    const OdString& key);
  ...
  */
  static OdTvDbEvalGraphPtr getGraph(const OdTvDbObject* pObj,
    const OdString& pKey,
  ...
  */
  static bool createGraph(OdTvDbObject* pObj,
    const OdString& key);
  ...
  */
  static bool removeGraph(OdTvDbObject* pObj,
    const OdString& pKey);
  ...
  /** \details
    ...
    \param key [in]  Graph key.
  */
  static bool hasGraph(OdTvDbDatabase* pDb,
    const OdString& key);
  ...
  /** \details
    ...
    \param openMode [in]  Mode in which to open the Graph object.
  */
  static OdTvDbEvalGraphPtr getGraph(OdTvDbDatabase* pDb,
    const OdString& key,
    const OdDb::OpenMode openMode = OdDb::kForRead );
  ...
  /** \details
    ...
    Returns true if and only if there was a graph with the specified key.
  */
  static bool createGraph(OdTvDbDatabase* pDb,
    const OdString& key);
  ...
  /** \details
    ...
    Returns true if and only if there was a graph with the specified key.
  */
  static bool removeGraph(OdTvDbDatabase* pDb,
    const OdString& key);
  ...
  */
  virtual OdTvDbEvalNodeId addNode(OdTvDbEvalExpr* pNode);
  ...
  */
  virtual bool removeNode  (const OdTvDbEvalNodeId& nodeId);
  ...
  */
  virtual OdTvDbEvalExprPtr getNode( const OdTvDbEvalNodeId& nodeId, OdDb::OpenMode openMode = OdDb::kForRead ) const;
  ...
  */
  virtual bool addEdge(const OdTvDbEvalNodeId& idFrom,
    const OdTvDbEvalNodeId& idTo);
  ...
  */
  ...
  /** \details
    ...
    OdError(eInvalidOwnerObject) if the specified GraphNode objects are not in the same Graph object.
  */
  virtual bool removeEdge(const OdTvDbEvalNodeId& idFrom,
    const OdTvDbEvalNodeId& idTo);
  ...
  */
  virtual void getIncomingEdges(const OdTvDbEvalNodeId& nodeId,
    OdTvDbEvalEdgeInfoArray& edges) const;
  ...
  /** \details
    ...
    \param edges [in]  Receives an array of edges.
  */
  virtual void getOutgoingEdges(const OdTvDbEvalNodeId& nodeId,
    OdTvDbEvalEdgeInfoArray& edges) const;
  ...
  /** \details
    ...
    Returns true if and only if successful.
  */
  virtual bool getEdgeInfo(const OdTvDbEvalNodeId& idFrom,
    const OdTvDbEvalNodeId& idTo, OdTvDbEvalEdgeInfo& edgeInfo) const;
  ...
  */
  virtual void addGraph(OdTvDbEvalGraph* pGraphToAdd);
  ...
  /** \details
    ...
    invoking OdTvDbEvalExpr::evaluate() on each of the visited nodes.
  ...
  */
  virtual bool evaluate(
    const OdTvDbEvalContext* pContext) const;
  ...
  */
  virtual bool evaluate(
    const OdTvDbEvalContext* pContext,
    const OdTvDbEvalNodeIdArray* pActivateNodes) const;
  ...
  */
  virtual bool activate(
    const OdTvDbEvalNodeIdArray& activatedNodes) const;
  ...
  */
  virtual bool activate(
    const OdTvDbEvalNodeIdArray& activatedNodes,
    OdTvDbEvalNodeIdArray* pActiveSubgraph) const;
  ...
  */
  virtual bool activate(
    const OdTvDbEvalNodeIdArray& activatedNodes,
    OdTvDbEvalNodeIdArray* pActiveSubgraph,
    OdTvDbEvalNodeIdArray* pCycleNodes) const;
  ...
  */
  virtual bool getIsActive(const OdTvDbEvalNodeId& nodeId,
    bool& isActive) const;
  ...
  */
  virtual bool equals(const OdTvDbEvalGraph* pOther) const;
  ...
  /** \details
    ...
    \param pOther [in]  Pointer to the other Graph object.
  */
  virtual bool isSubgraphOf(const OdTvDbEvalGraph* pOther) const;
  ...
  virtual void applyPartialUndo(OdTvDbDwgFiler* pFiler, OdRxClass* pClassObj) ODRX_OVERRIDE;
  virtual void copyFrom(const OdRxObject* p) ODRX_OVERRIDE;
  virtual OdResult postInDatabase(OdTvDbDatabase*);
  virtual void subHandOverTo(
    OdTvDbObject* pNewObject) ODRX_OVERRIDE;
};


/** \details
    This class holds the directed edge information between pairs of nodes in an OdTvDbEvalGraph instance.
    ...
    * OdTvDbEvalGraph
*/
class DYNBLOCKS_EXPORT OdTvDbEvalEdgeInfo
{
public:
  OdTvDbEvalEdgeInfo()
    : mFlags(0), mRefCount(0)
  {
    mIdFrom = OdTvDbEvalGraph::kNullNodeId;
    mIdTo = OdTvDbEvalGraph::kNullNodeId;
  }
  ...
  */
  OdTvDbEvalEdgeInfo(OdTvDbEvalNodeId fromId,
    OdTvDbEvalNodeId toId,
    long           flags,
    unsigned long  count)
  ...
  */
  ...
  bool operator == (const OdTvDbEvalEdgeInfo& other) const;

private:
  OdTvDbEvalNodeId mIdFrom;
  OdTvDbEvalNodeId mIdTo;
  long mFlags;
...
/** \details
    This class represents single nodes in OdTvDbEvalGraph objects.

    \remarks
    Each node reprsents an action or expression. The OdTvDbEvalGraph object calls each owned node's
    evaluate() method while traversing the graph within the OdTvDbEvalGraph::evaluate() method.
    ...
    * OdTvDbEvalGraph
*/
class DYNBLOCKS_EXPORT OdTvDbEvalExpr : public OdTvDbObject
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbEvalExpr);

  OdTvDbEvalExpr();
  virtual ~OdTvDbEvalExpr();

  /** \details
    Opens the OdTvDbEvalGraph object that owns this Node object.

    \param openMode [in]  Mode in which to open the Graph object.

    \returns
    Returns a SmartPointer to the opened OdTvDbEvalGraph if successful, otherwise a null SmartPointer.
  */
  OdTvDbEvalGraphPtr getGraph( OdDb::OpenMode openMode = OdDb::kForRead ) const;
  ...
  /** \details
    ...
    Returns OdTvDbGraph::kNullId if this Node object is not graph-resident.
  */
  OdTvDbEvalNodeId nodeId() const;
  ...
  /** \details
    ...
    \remarks
    Called by OdTvDbEvalGraph::addNode().

    This function is called after the operation.
  */
  virtual void addedToGraph (OdTvDbEvalGraph* pGraph);
  ...
  /** \details
    ...
    \remarks
    Called by OdTvDbEvalGraph::removeNode().

    This function is called after the operation.
  */
  virtual void removedFromGraph (OdTvDbEvalGraph* pGraph);
  ...
  /** \details
    ...
    This function is called after the operation.
  */
  virtual void adjacentNodeRemoved (const OdTvDbEvalNodeId& adjNodeId);
  ...
  /** \details
    ...
    \remarks
    Called by OdTvDbEvalGraph::removeEdge().

    This function is called after the operation.
  */
  virtual void adjacentEdgeRemoved (const OdTvDbEvalNodeId& adjEdgeNodeId);
  ...
  /** \details
    ...
    \remarks
    Called by OdTvDbEvalGraph::addEdge().

    When the edge is invertible, this function is called twice.

    This function is called after the operation.
  */
  virtual void adjacentEdgeAdded (const OdTvDbEvalNodeId& fromId,
    const OdTvDbEvalNodeId& toId,
    bool isInvertible);
  ...
  /** \details
    ...
    \remarks
    Called by OdTvDbEvalGraph::addGraph().

    This function is called before the operation.
  */
  virtual void movedFromGraph (OdTvDbEvalGraph* pFromGraph);
  ...
  /** \details
    ...
    This function is called after the operation.
  */
  virtual void movedIntoGraph (OdTvDbEvalGraph* pIntoGraph);
  ...
  /** \details
    ...
    \remarks
    Called by OdTvDbEvalGraph::copyFrom().

    This function is called after the operation.
  */
  virtual void copiedIntoGraph(OdTvDbEvalGraph* pIntoGraph);
  ...
  */
  ...
  /** \details
    ...
    \remarks
    Called by OdTvDbEvalGraph::activate() or by OdTvDbEvalGraph::evaluate().

    When the edge is invertible, this function is called twice.

    This function is called after the operation.
  */
  virtual void activated           (OdTvDbEvalNodeIdArray& argumentActiveList);
  ...
  /** \details
    ...
    \remarks
    Called by OdTvDbEvalGraph::evaluate().
  ...
  */
  virtual bool evaluate(const OdTvDbEvalContext* evalContext);
  ...
  */
  virtual bool equals(const OdTvDbEvalExpr* pOther) const;

  /** \details
    Returns the value of the evaluated expression of this Node object.
    \remarks
    The value is updated with a call to OdTvDbEvalExpr::evaluate().
  */
...
protected:
  ...
  OdTvResBufPtr m_lastValue;
  friend class OdTvDbEvalExprImpl;
};


/** \details
    This class implements a runtime inspection interface for OdTvDbEvalExpr objects.
    ...
    * OdTvDbEvalGraph
*/
class DYNBLOCKS_EXPORT OdTvDbEvalConnectable : public OdTvDbEvalExpr
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbEvalConnectable);

  virtual ~OdTvDbEvalConnectable();
  ...
  */
  virtual bool getConnectionType  (
    ...
    OdTvResBuf::ValueType& connectionType) const;
  ...
  */
  virtual OdTvResBufPtr getConnectionValue( const OdString& connectionName) const;
  ...
  /** \details
    ...
    Returns true if and only if a connection with the specified name exists.
  */
  virtual bool setConnectionValue ( const OdString& connectionName, const OdTvResBuf* pValue);
  ...
  */
  virtual bool connectTo (
    ...
    OdTvDbEvalNodeId sourceConnectableId,
  ...
  */
  virtual bool getConnectedObjects (
    const OdString&      thisConnectionName,
    OdTvDbEvalNodeIdArray& connectedObjects) const;

  /** \details
    Returns an array Connection names shared between this OdTvDbEvalConnectable object and another.
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbEvalConnectable object pointers.
*/
typedef OdSmartPtr<OdTvDbEvalConnectable> OdTvDbEvalConnectablePtr;

/** \details
    This class represents application data used during the evaluation of an OdTvDbEvalGraph object.

    \remarks
    The graph passes the OdTvDbEvalContext object passed to OdTvDbEvalGraph::evaluate() to each node
    in the graph traversed as a result of calling OdTvDbEvalExpr::evaluate().
    ...
    * OdTvDbEvalGraph
*/
class DYNBLOCKS_EXPORT OdTvDbEvalContext : public OdRxObject
{
public:
  ...
  virtual ~OdTvDbEvalContext();

  ODRX_DECLARE_MEMBERS(OdTvDbEvalContext);
  ...
  */
  virtual void insertAt (const OdTvDbEvalContextPair& pair);
  ...
  */
  virtual bool getAt (OdTvDbEvalContextPair& pair) const;


  /** \details
    Returns an Iterator object that can be used to traverse this Context object.
  */
  virtual OdTvDbEvalContextIteratorPtr newIterator() const;

private:
  OdTvDbImpEvalContext* m_pImp;
  friend class OdTvDbImpEvalContextIterator;
};

/** \details
    This class represents key - value pairs stored in an OdTvDbEvalContext object.

    \remarks
    Values stored are void pointers. Neither OdTvDbEvalContext nor OdTvDbEvalContextPair
    ...
    * OdTvDbEvalGraph
*/
class DYNBLOCKS_EXPORT OdTvDbEvalContextPair
{
public:
  ...
  */
  OdTvDbEvalContextPair(const OdString& key, void *value);

  virtual ~OdTvDbEvalContextPair();
...
/** \details
    This class implements iterators for OdTvDbEvalContextPair objects in an OdTvDbEvalContext instance.

    \remarks
    Instances are returned by OdTvDbEvalContext::newIterator()
    ...
    * OdTvDbEvalGraph
*/
class DYNBLOCKS_EXPORT OdTvDbEvalContextIterator : public OdRxObject
{
public:
  OdTvDbEvalContextIterator();

  virtual ~OdTvDbEvalContextIterator();

  ODRX_DECLARE_MEMBERS(OdTvDbEvalContextIterator);
  ...
  */
  virtual OdTvDbEvalContextPair contextPair() const;

private:
  OdTvDbImpEvalContextIterator* m_pImp;
  friend class OdTvDbImpEvalContext;
};
