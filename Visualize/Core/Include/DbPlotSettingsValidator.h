...
class OdTvDbPlotSettings;

typedef OdTvDbPlotSettings::PlotPaperUnits PlotPaperUnits;
typedef OdTvDbPlotSettings::PlotRotation   PlotRotation;
typedef OdTvDbPlotSettings::PlotType       PlotType;
typedef OdTvDbPlotSettings::StdScaleType   StdScaleType;

/** \details
    This class defines access methods that validate data for
    OdTvDbPlotSettings objects prior to setting the data on the
    objects.
...
*/
class TOOLKIT_EXPORT OdTvDbPlotSettingsValidator : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbPlotSettingsValidator);
  ...
  */
  virtual OdResult setPlotCfgName(
    OdTvDbPlotSettings* pPlotSettings,
  ...
  */
  ...
  /** \details
    ...
    PaperImageOrigin of OdTvDbPlotSettings will remain unchanged if kLayout
  ...
  */
  virtual void refreshLists(
    OdTvDbPlotSettings* pPlotSettings) = 0;
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbPlotSettingsValidator object pointers.
*/
typedef OdSmartPtr<OdTvDbPlotSettingsValidator> OdTvDbPlotSettingsValidatorPtr;
