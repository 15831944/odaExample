...
/** \details
  This class represents OdTvDbPolyFaceMesh faces in an OdTvDbDatabase instance. 

  <group OdTvDb_Classes>
*/
class DBENT_EXPORT OdTvDbFaceRecord : public OdTvDbEntity
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbFaceRecord);
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvDbFaceRecord object pointers.
*/
typedef OdSmartPtr<OdTvDbFaceRecord> OdTvDbFaceRecordPtr;
