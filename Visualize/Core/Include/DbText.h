...
/** \details
    ...
    This class represents single-line text entities in an OdTvDbDatabase instance.
    ...
    OdTvDbMText, OdTvDbShape classes
*/
class DBENT_EXPORT OdTvDbText: public OdTvDbEntity
{
public:
  
  DWGMAP_DECLARE_MEMBERS(OdTvDbText);
  ...
  */
  ...
  /* Constructor. */
  /*OdTvDbText(const OdGePoint3d& position,
      const OdChar* text,
      OdTvDbObjectId style = OdTvDbObjectId::kNull,
      double height = 0,
      double rotation = 0);
  */
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbText object pointers.
*/
typedef OdSmartPtr<OdTvDbText> OdTvDbTextPtr;
