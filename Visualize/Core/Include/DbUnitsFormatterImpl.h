...
/** \details
This class provides default implementation for OdTvDbUnitsFormatter. 
<group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbUnitsFormatterImpl : public OdTvDbUnitsFormatter
{ 
protected:
  OdTvDbUnitsFormatterImpl();
public:
  ODRX_DECLARE_MEMBERS(OdTvDbUnitsFormatterImpl);
