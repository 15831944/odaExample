...
/** \details
	...
	<group OdAp_Classes>
*/
class TOOLKIT_EXPORT OdTvApLongTransactionReactor: public OdRxObject 
{ 
public:
  ODRX_DECLARE_MEMBERS(OdTvApLongTransactionReactor);
  OdTvApLongTransactionReactor();
   ...
   */
  virtual void beginCheckOut        (OdTvDbLongTransaction& , OdTvDbObjectIdArray& originList);
 /** \details
    Completes the checkout process and returns the long transaction.
 */
  virtual void endCheckOut          (OdTvDbLongTransaction& );
   /** \details
    Begins the checkin process of the specified long transaction.
   */
  virtual void beginCheckIn         (OdTvDbLongTransaction& );
   /** \details
    Completes the checkin process of the specified long transaction.
   */
  virtual void endCheckIn           (OdTvDbLongTransaction& );
   /** \details
    Terminates the check out process and returns the aborted long transaction.
   */
  virtual void abortLongTransaction (OdTvDbLongTransaction& );
...
/** \details
    ...
    \remarks
    There is one OdTvApLongTransactionManager object per application session.  
	...
	<group OdAp_Classes> 
*/
class ODRX_ABSTRACT TOOLKIT_EXPORT OdTvApLongTransactionManager : public OdRxObject 
{ 
public:
  ODRX_DECLARE_MEMBERS(OdTvApLongTransactionManager);
  ...
  */
  virtual OdResult checkOut(OdTvDbObjectId& transId, OdTvDbObjectIdArray& objList,
    OdTvDbObjectId toBlock, OdTvDbIdMapping& errorMap, OdTvDbObjectId lockBlkRef = OdTvDbObjectId::kNull) = 0;
  ...
  */
  virtual OdResult checkIn(OdTvDbObjectId transId, OdTvDbIdMapping& errorMap, bool keepObjs = false) = 0;
  ...
  */
  virtual OdResult abortLongTransaction(OdTvDbObjectId transId, bool keepObjs = false) = 0;

  virtual OdTvDbObjectId currentLongTransactionFor(const OdTvDbDatabase* pDb) const = 0;
  /** \details
    Adds the specified reactor to this object's reactor list.
  */
  virtual void addReactor(OdTvApLongTransactionReactor*) = 0;
  /** \details
    Deletes the specified reactor from this object's reactor list.
  */
  virtual void removeReactor(OdTvApLongTransactionReactor*) = 0;
...
extern TOOLKIT_EXPORT OdTvApLongTransactionManager* odtvapLongTransactionManager();
