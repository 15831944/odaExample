...
/** \details
    This class is the Protocol Extension class for OdTvDbViewTableRecord objects.

    <group OdTvDb_Classes>
*/
class TOOLKIT_EXPORT OdTvDbAbstractViewportDataForDbViewTabRec : public OdTvDbAbstractViewportDataForAbstractViewTabRec
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAbstractViewportDataForDbViewTabRec);
