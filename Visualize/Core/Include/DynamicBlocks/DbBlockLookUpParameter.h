...
*/
class DYNBLOCKS_EXPORT OdTvDbBlockLookUpParameter : public OdTvDbBlock1PtParameter
{
public:
  ODDB_EVAL_DECLARE_MEMBERS(OdTvDbBlockLookUpParameter);
  OdTvDbBlockLookUpParameter();
  OdTvDbBlockLookupGripPtr getAssociatedLookupGrip( OdDb::OpenMode );
...
typedef OdSmartPtr<OdTvDbBlockLookUpParameter> OdTvDbBlockLookUpParameterPtr;
