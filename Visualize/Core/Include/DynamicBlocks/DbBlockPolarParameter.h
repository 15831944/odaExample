...
*/
class DYNBLOCKS_EXPORT OdTvDbBlockPolarParameter : public OdTvDbBlock2PtParameter
{
public:
  ODDB_EVAL_DECLARE_MEMBERS(OdTvDbBlockPolarParameter);
  OdTvDbBlockPolarParameter();
  //OdString angleDescription() const;
  //OdString angleName() const;
  //const OdTvDbBlockParamValueSet& angleValueSet() const;
  //double baseAngle() const;
  //OdGePoint3d baseAnglePoint() const;
  //OdString distanceDescription() const;
  //OdString distanceName() const;
  //const OdTvDbBlockParamValueSet& distanceValueSet() const;
  //OdTvDbBlockPolarGripPtr getAssociatedPolarGrip( OdTvDbBlockParameter::ParameterComponent, OdDb::OpenMode );
  //double offset();
  //void setAngleDescription(const OdString&);
  //void setAngleName(const OdString&);
  //void setAngleValueSet(class OdTvDbBlockParamValueSet const &);
  //void setDistanceDescription( const OdString&);
  //void setDistanceName( const OdString&);
  //void setDistanceValueSet(const OdTvDbBlockParamValueSet &);
  //void setOffset(double);
  //void setUpdatedAngle(double);
  //void setUpdatedDistance(double);
};

typedef OdSmartPtr<OdTvDbBlockPolarParameter> OdTvDbBlockPolarParameterPtr;
