...
*/
class OdTvDbBlockBasepointParameter : public OdTvDbBlock1PtParameter
{
public:
  ODDB_EVAL_DECLARE_MEMBERS(OdTvDbBlockBasepointParameter);
  OdTvDbBlockBasepointParameter();
...
typedef OdSmartPtr<OdTvDbBlockBasepointParameter> OdTvDbBlockBasepointParameterPtr;
