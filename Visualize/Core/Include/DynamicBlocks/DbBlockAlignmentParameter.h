...
class OdTvDbBlockAlignmentGrip;
...
*/
class OdTvDbBlockAlignmentParameter : public OdTvDbBlock2PtParameter
{
public:
  ODDB_EVAL_DECLARE_MEMBERS(OdTvDbBlockAlignmentParameter);
  OdTvDbBlockAlignmentParameter();
  bool alignPerpendicular();
  void setAlignPerpendicular(bool);
  //OdTvDbBlockAlignmentGripPtr getAssociatedAlignmentGrip( OdDb::OpenMode );
