...
*/
class DYNBLOCKS_EXPORT OdTvDbBlock2PtParameter : public OdTvDbBlockParameter
{
public:
  ODDB_EVAL_DECLARE_MEMBERS(OdTvDbBlock2PtParameter);
  ...
  OdTvDbBlockGripPtr getAssociatedGrip( OdTvDbBlockParameter::ParameterComponent, OdDb::OpenMode );
  virtual void graphEvalEnd( bool );
  //bool parameterComponentDrivesAction( OdTvDbBlockParameter::ParameterComponent, const OdTvDbBlockAction* );
  bool parameterComponentHasAction( OdTvDbBlockParameter::ParameterComponent, const OdTvDbBlockAction*);
...
typedef OdSmartPtr<OdTvDbBlock2PtParameter>OdTvDbBlock2PtParameterPtr;
