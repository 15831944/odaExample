...
*/
class DYNBLOCKS_EXPORT OdTvDbBlockPointParameter : public OdTvDbBlock1PtParameter
{
public:
  ODDB_EVAL_DECLARE_MEMBERS(OdTvDbBlockPointParameter);
  OdTvDbBlockPointParameter();
  ...
  //void setX(double);
  //void setY(double);
  //OdTvDbBlockXYGripPtr getAssociatedXYGrip( OdDb::OpenMode );
};
