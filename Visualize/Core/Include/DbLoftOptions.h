...
class OdTvDbLoftOptionsImpl;

/** \details
  Class for setting options used for creating lofted surfaces and lofted solids (by calling OdTvDbLoftedSurface::createLoftedSurface() or OdTvDb3dSolid::createLoftedSolid() methods). 
  Loft options are used to control the shape of the resulting surface or solid object. 

  <group OdTvDb_Classes>
*/
class DBENT_EXPORT OdTvDbLoftOptions
{
public:
  /** \details 
    Creates an OdTvDbLoftOptions object. 
  */
  OdTvDbLoftOptions();
  
  /** \details 
    Copy constructor for the OdTvDbLoftOptions class.
  */
  OdTvDbLoftOptions(const OdTvDbLoftOptions& src);
  
  /** \details 
    Destroys the OdTvDbLoftOptions object. 
  */
  ~OdTvDbLoftOptions();

  /** \details 
    Assigns to the OdTvDbLoftOptions object another object (assignment operator). 
  
    \param rhs [in] Another OdTvDbLoftOptions object to assign.
  */
  OdTvDbLoftOptions& operator = (const OdTvDbLoftOptions& rhs);

  /** \details 
    Compares two OdTvDbLoftOptions objects, returns true when their values are equal,
    or false when their values are not equal.
  
    \param opt [in] Another OdTvDbLoftOptions object to compare.
  */
  bool operator == (const OdTvDbLoftOptions& opt) const;
  ...
  */
  OdTvDbLoftOptions::NormalOption normal() const;
  ...
  */
  void setNormal(OdTvDbLoftOptions::NormalOption option);
  ...
  */
  OdResult setOptionsFromSysvars(const OdTvDbDatabase& pDb);
  ...
  */
  OdResult setSysvarsFromOptions(OdTvDbDatabase& pDb);
  ...
  */
  ...
  /** \details
    ...
    The method is called by createLoftedSurface() and createLoftedSolid() methods, so it is not necessary to call the method separately().
  */
  OdResult checkGuideCurves(OdTvDbEntityPtrArray& guideCurves,
    bool displayErrorMessages = false);
  ...
  /** \details
    ...
    The method is called by createLoftedSurface() and createLoftedSolid() methods, so it is not necessary to call the method separately().
  */
  OdResult checkPathCurve(OdTvDbEntity *pPathCurve,
    bool displayErrorMessages = false);


private:
  friend class OdTvDbLoftOptionsImpl;
  OdTvDbLoftOptionsImpl *m_pImpl;
};
