...
/** \details
  ...
  OdTvDbArc, OdTvDbEllipse classes
*/
class DBENT_EXPORT OdTvDbCircle : public OdTvDbCurve
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbCircle);
  ...
  */
  ...
  /** \details
    ...
    OdTvDbCircle::setThickness() method
  */
  ...
  */
  ...
  /** \details
    ...
    OdTvDbCircle::getPlane(), OdTvDbEntity::isPlanar() methods
  */
...
/** \details
  ...
  is specialization of the OdSmartPtr class for the OdTvDbCircle class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbCircle> OdTvDbCirclePtr;
