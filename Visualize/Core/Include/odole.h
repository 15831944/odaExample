...
public:
  ...
  */
  virtual IUnknown* GetIUnknown(OdTvDbObject* pObject) = 0;
  ...
  */
  virtual bool SetIUnknown(OdTvDbObject* pObject, IUnknown* pIUnknown = 0) = 0;
  ...
  */
   /** \details
    ...
    Returns NULL if no wrapper is found.
  */
  virtual IUnknown* GetIUnknown(OdTvDbDatabase * pDb) = 0;
  ...
  /** \details
    ...
    If pIUnknown is NULL, the link is removed.
  */
  virtual bool SetIUnknown(OdTvDbDatabase * pDb, IUnknown* pIUnknown = 0) = 0;
  ...
  */
  virtual IDispatch* GetDocIDispatch(OdTvDbDatabase * pDatabase) = 0;
  ...
  */
  virtual bool SetDocIDispatch(OdTvDbDatabase * pDatabase, IDispatch* pIDispatch = 0) = 0;
};
