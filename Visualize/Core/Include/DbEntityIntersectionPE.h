...
*/
class ODRX_ABSTRACT TOOLKIT_EXPORT OdTvDbEntityIntersectionPE : public OdRxObject
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbEntityIntersectionPE);
  ...
  */
  virtual OdResult intersectWith(
    const OdTvDbEntity* pThisEnt, const OdTvDbEntity* pEnt, 
...
/** \details
  ...
  for OdTvDbEntityIntersectionPE object pointers.
*/
typedef OdSmartPtr<OdTvDbEntityIntersectionPE> OdTvDbEntityIntersectionPEPtr;
