...
/** \details
    This class represents 2-Line Angular Dimension entities in an OdTvDbDatabase instance.
...
*/
class DBDIM_EXPORT OdTvDb2LineAngularDimension : public OdTvDbDimension
{
public:

  DWGMAP_DECLARE_MEMBERS(OdTvDb2LineAngularDimension);
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDb2LineAngularDimension object pointers.
*/
typedef OdSmartPtr<OdTvDb2LineAngularDimension> OdTvDb2LineAngularDimensionPtr;
