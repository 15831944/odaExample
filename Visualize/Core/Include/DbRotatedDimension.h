...
/** \details
    This class represents Rotated Dimension entities in an OdTvDbDatabase instance.
...
*/
class DBDIM_EXPORT OdTvDbRotatedDimension : public OdTvDbDimension
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbRotatedDimension);

  OdTvDbRotatedDimension();
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbRotatedDimension object pointers.
*/
typedef OdSmartPtr<OdTvDbRotatedDimension> OdTvDbRotatedDimensionPtr;
