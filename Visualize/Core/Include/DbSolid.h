...
/** \details
  ...
  OdTvDbTrace, OdTvDbEntity classes
*/
class DBENT_EXPORT OdTvDbSolid : public OdTvDbEntity
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbSolid);
  ...
  */
  ...
  /*  OdTvDbSolid(const OdGePoint3d& pt0,
  ...
  */
  ...
  /** \details
    ...
    OdTvDbSolid::setThickness() method
  */
  ...
  */
  ...
  /** \details
    ...
    OdTvDbSolid::normal() method
  */
  void setNormal( const OdGeVector3d& geVector );


  /** \details
    Gets the solid plane. This method is inherited from the OdTvDbEntity class.
...
/** \details
  ...
  This template class is specialization of the OdSmartPtr class for the OdTvDbSolid class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbSolid> OdTvDbSolidPtr;
