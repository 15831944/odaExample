...
/** \details
    This class represents Diametric Dimension entities in an OdTvDbDatabase instance.
...
*/
class DBDIM_EXPORT OdTvDbDiametricDimension : public OdTvDbDimension
{
public:

  DWGMAP_DECLARE_MEMBERS(OdTvDbDiametricDimension);

  OdTvDbDiametricDimension();
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbDiametricDimension object pointers.
*/
typedef OdSmartPtr<OdTvDbDiametricDimension> OdTvDbDiametricDimensionPtr;
