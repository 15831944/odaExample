...
namespace OdDb
{
  // OdTvDbTable and OdTbTableStyle specific enum
  //
  ...
  */
  ...
  /** \details
    This class represents the parameters of cells for OdTvDbTable entities..
...
typedef OdArray<OdCellRange> OdCellRangeArray;
 ...
 /** \details
    This class represents a grid for OdTvDbTable entities.
...
public:
  ...
  OdTvDbHardPointerId   m_linetype;
  OdTvCmColor           m_color;
...
/** \details
    This class represents TableStyles for OdTvDbTable entities in an OdTvDbDatabase instance.

    <group OdTvDb_Classes>
*/
class DBENT_EXPORT OdTvDbTableStyle : public OdTvDbObject
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbTableStyle);

  OdTvDbTableStyle();
  // virtual ~OdTvDbTableStyle();
...
*/
  ...
  */
  void setDatabaseDefaults(OdTvDbDatabase* pDb = 0);
  ...
  */
  virtual OdTvDbObjectId postTableStyleToDb(OdTvDbDatabase* pDb, const OdString& styleName);
  ...
  void copyCellStyle(const OdTvDbTableStyle* pSrc, const OdString& srcCellStyle, const OdString& targetCellStyle);
  ...
  OdTvDbObjectId textStyle(const OdString& cellStyle) const;
  void setTextStyle (const OdTvDbObjectId& id, const OdString& cellStyle);
  ...
  OdTvCmColor color(const OdString& cellStyle) const;
  void setColor(const OdTvCmColor& color, const OdString& cellStyle);

  OdTvCmColor backgroundColor(const OdString& cellStyle) const;
  void setBackgroundColor(const OdTvCmColor& color, const OdString& cellStyle);
  ...
  OdTvCmColor gridColor(OdDb::GridLineType gridLineType, const OdString& cellStyle) const;
  void setGridColor(const OdTvCmColor color, OdDb::GridLineType gridLineTypes, const OdString& cellStyle);
  ...
  OdTvDbObjectId gridLinetype(OdDb::GridLineType gridLineType, const OdString& cellStyle) const;
  void setGridLinetype(const OdTvDbObjectId& id, OdDb::GridLineType gridLineTypes, const OdString& cellStyle);
  ...
  // Template functions
  OdTvDbObjectId  getTemplate(void) const;

  void setTemplate(const OdTvDbObjectId templateId, OdDb::MergeCellStyleOption nOption);

  OdTvDbObjectId removeTemplate(void);
};

/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbTableStyle object pointers.
*/
typedef OdSmartPtr<OdTvDbTableStyle> OdTvDbTableStylePtr;
