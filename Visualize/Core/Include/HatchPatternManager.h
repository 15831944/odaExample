...
public:
  ...
  */
  virtual void setApplicationService(OdTvDbHostAppServices *pServices) = 0;
  ...
  /** \details
    ...
    OdTvDbHatch::kUserDefined     0        User-defined hatch.
    OdTvDbHatch::kPreDefined      1        Defined in acad.pat and acadiso.pat. 
    OdTvDbHatch::kCustomDefined   2        In its own PAT file.
    </table>
  ...
  */
  virtual OdResult retrievePattern(OdTvDbHatch::HatchPatternType hatchPatternType, const OdString& hatchPatternName, 
  ...
  */
  virtual void appendPattern(OdTvDbHatch::HatchPatternType hatchPatternType, const OdString& hatchPatternName, 
  ...
  */
  virtual OdResult retrievePatternList(OdTvDbHatch::HatchPatternType hatchPatternType, OdDb::MeasurementValue measurementValue,
