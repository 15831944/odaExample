...
/** \details
    ...
    vectorization of an OdTvDbDatabase.

    Corresponding C++ library: TD_Db

    <group OdTvDb_Classes> 
*/
class TOOLKIT_EXPORT OdTvGiContextForDbDatabase : public OdGiDefaultContext
{
private:
  enum
  {
  ...
  class TOOLKIT_EXPORT DatabaseHolder : public OdStaticRxObject<OdTvDbDatabaseReactor>
  {
  public:
    DatabaseHolder();
    ~DatabaseHolder();
    ...
    void setDatabase( bool bWasTrackDbDestroy, OdTvDbDatabase* pDb, bool bTrackDbDestroy );
...
protected:
  ...
  OdTvGiContextForDbDatabase();

public:

  ODRX_DECLARE_MEMBERS(OdTvGiContextForDbDatabase);
  ...
  */
  void setDatabase( OdTvDbDatabase* pDb, bool bTrackDbDestroy = true );
...
/** \details
    This template class is a specialization of the OdSmartPtr class for OdTvGiContextForDbDatabase object pointers.
*/
typedef OdSmartPtr<OdTvGiContextForDbDatabase> OdTvGiContextForDbDatabasePtr;
