...
/** \details
    This class represents Layout objects in an OdTvDbDatabase instance.
...
*/
class TOOLKIT_EXPORT OdTvDbLayout : public OdTvDbPlotSettings
{
public:
  DWGMAP_DECLARE_MEMBERS(OdTvDbLayout);
  ...
  */
  ...
  /** \details
    Returns the Object ID of the PaperSpace OdTvDbBlockTableRecord associated with this Layout object (DXF 330).
  */
  OdTvDbObjectId getBlockTableRecordId() const;

  /** \details
    Associates this Layout object with the specified PaperSpace OdTvDbBlockTableRecord (DXF 330).
    
    \param blockTableRecordId [in]  Block table record Object Id.
  */
  virtual void setBlockTableRecordId(
    const OdTvDbObjectId& blockTableRecordId);

  /** \details
    Adds this Layout object to the layout dictionary in the specified database, and associates 
    this Layout object with the specified PaperSpace OdTvDbBlockTableRecord. 
  ...
  */
  ...
  /** \details
    Returns an array of OdTvDbObjectIds of all the OdTvDbViewports that exist in the Paper Space layout.
  ...
  */
  OdTvDbObjectIdArray getViewportArray() const;
  ...
  */
  OdTvDbObjectId overallVportId() const;
...
/** \details
  This template class is a specialization of the OdSmartPtr class for OdTvDbLayout object pointers.
*/
typedef OdSmartPtr<OdTvDbLayout> OdTvDbLayoutPtr;
