...
*/
class ExDbCommandContext : public OdTvDbCommandContext
                         , protected OdTvDbUserIO
                         , protected OdEdFunctionIO
{
protected:
  ODRX_USING_HEAP_OPERATORS(OdTvDbCommandContext);
  ...
  */
  ...
  /** \details
    ...
    <table>
    Name
    OdTvResBuf::kDxfXdDist
    OdTvResBuf::kRtOrient   
    </table>
...
public:
  ...
  */
  static OdTvDbCommandContextPtr createObject(OdEdBaseIO* pIOStream, OdTvDbDatabase* pDb);
  static OdTvDbCommandContextPtr createObject(OdEdBaseIO* pIOStream, OdRxObject* pRxDb = 0);
