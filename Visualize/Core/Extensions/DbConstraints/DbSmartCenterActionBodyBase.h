...
*/
class DBCONSTRAINTS_EXPORT ODRX_ABSTRACT OdTvDbSmartCenterActionBodyBase : public OdTvDbAssocActionBody
{
public:
	ODRX_DECLARE_MEMBERS(OdTvDbSmartCenterActionBodyBase);

	/** \details
	Constructor creates an instance of this class.
	*/
	OdTvDbSmartCenterActionBodyBase();

	/////////////////////////////////////////////////////////////////////From Arx  
	// is abstract via evaluateOverride()

	//AcTvDbSmartCenterActionBodyBase(void);
	//virtual ~AcTvDbSmartCenterActionBodyBase(void);
	//void __autoclassinit2(unsigned __int64);
	//static OdTvDbSmartCenterActionBodyBase *  cast(AcRxObject const *);
	//static OdRxClass *  desc(void);

	//virtual enum OdResult dwgInFields(OdTvDbDwgFiler *);

	////virtual enum OdResult dwgOutFields(OdTvDbDwgFiler *)const;
	//virtual void dwgOutFields(OdTvDbDwgFiler *) const;

	//virtual enum OdResult dxfInFields(OdTvDbDxfFiler *);
	//
	////virtual enum OdResult dxfOutFields(OdTvDbDxfFiler *)const;
	...
	//
	//OdTvDbEdgeRef getInputEdge(int)const;
	//OdTvDbObjectId getObjectIdParam(OdString const &)const;
	...
	//enum OdResult setInputEdge(int, OdTvDbEdgeRef const &);
	//enum OdResult setObjectIdParam(OdString const &, OdTvDbObjectId);
...
*/
typedef OdSmartPtr<OdTvDbSmartCenterActionBodyBase> OdTvDbSmartCenterActionBodyBasePtr;
