...
*/
class DBCONSTRAINTS_EXPORT OdTvDbImpAssocValueDependency : public OdTvDbImpAssocDependency
{
public: 
  /** \details
    Constructor creates an instance of this class.
  */
  OdTvDbImpAssocValueDependency();
  ...
  */
  OdResult setDependentOnObjectValue(const OdTvDbEvalVariant* newObjectValue);
...
protected:
  ...
  /*!DOM*/
  OdTvDbEvalVariantPtr m_cashedValue;
};
