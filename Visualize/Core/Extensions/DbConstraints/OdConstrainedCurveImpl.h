...
protected:
  ...
  */
  OdResult getPolylineSegmentProp(const OdTvDbObjectId geomDependencyId, const OdTvDbPolylinePtr& pLinePtr,
                                  OdGePoint3d& wrdStart, OdGePoint3d& wrdEnd, double& bulge) const;

  /** \details
    Gets the segment properties for the constrained geometry object specified by ID. 
  */
  OdResult getPolylineSegmentPtIdx(const OdTvDbObjectId geomDependencyId, const OdTvDbPolylinePtr& pLinePtr,
