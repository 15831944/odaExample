...
*/
class DBCONSTRAINTS_EXPORT OdTvDbImpAssocVariable : public OdTvDbImpAssocAction
{
public:     
  /** \details
    Constructor creates an instance of this class.
  */
  OdTvDbImpAssocVariable();

  /** \details
    Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbImpAssocVariable();
  ...
  */
  OdResult setName(OdTvDbAssocVariable* pVariable, const OdString newName, bool updateReferencingExpressions);

  /** \details
    Sets the constant value for this variable.
  */
  OdResult fixVariable(const OdString& name, const OdTvDbEvalVariant* value);
  ...
  */
  static OdResult checkCyclicDependencies(OdArray<OdString>& names, OdTvDbObjectIdArray& reactors);

  /** \details
    Creating a shallow copy of the variable which is not connected to anything but
    has same name, expression, etc.
  */
  static OdTvDbAssocVariablePtr createVariableCopy(const OdTvDbAssocVariable* originalVar);
  ...
  */
  OdResult setExpression(OdTvDbAssocVariable* pVariable,
  ...
  */
  OdResult setValue(OdTvDbAssocAction* pAction, const OdTvDbEvalVariant& newValue);
  ...
  */
  OdResult dwgInFields(OdTvDbAssocAction *self, OdTvDbDwgFiler* filer);
  ...
  */
  void dwgOutFields(OdTvDbDwgFiler* pFiler, OdTvDbObjectId objectId) const;
  ...
  /** \details
    ...
    Returns the filer status.
  */
  OdResult dxfInFields(OdTvDbDxfFiler* pFiler, OdTvDbObjectId objectId);
  ...
  /** \details
    ...
    \param pFiler [in]  Pointer to the filer to which data are written.
  */
  void dxfOutFields(OdTvDbDxfFiler* pFiler, OdTvDbObjectId objectId) const;
  ...
  /*!DOM*/
  static OdTvDbAssocVariableCallback* m_assocVariableCallback;
protected:
  /*!DOM*/
  OdString m_varName;
  /*!DOM*/
