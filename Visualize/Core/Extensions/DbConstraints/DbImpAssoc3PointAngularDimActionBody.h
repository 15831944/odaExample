...
*/
class DBCONSTRAINTS_EXPORT OdTvDbImpAssoc3PointAngularDimActionBody : public OdTvDbImpAssocAnnotationActionBody
{
public:
  /** \details
  Constructor creates an instance of this class.
  */
  OdTvDbImpAssoc3PointAngularDimActionBody();

  /** \details
  Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbImpAssoc3PointAngularDimActionBody();
