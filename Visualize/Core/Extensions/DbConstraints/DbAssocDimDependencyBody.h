...
*/
class DBCONSTRAINTS_EXPORT OdTvDbAssocDimDependencyBody : public OdTvDbAssocDimDependencyBodyBase
{
public:
    ODRX_DECLARE_MEMBERS(OdTvDbAssocDimDependencyBody);

    /** \details
      Constructor creates an instance of this class.
    */
    OdTvDbAssocDimDependencyBody();

    /** \details
      Destructor destroys an instance of this class.
    */
    virtual ~OdTvDbAssocDimDependencyBody();
    ...
    */
    static OdResult
                createAndPostToDatabase(const OdTvDbObjectId& dimId,
                                        OdTvDbObjectId&       dimDepId,
                                        OdTvDbObjectId&       dimDepBodyId);
...
/** \details
  ...
  for the OdTvDbAssocDimDependencyBody class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbAssocDimDependencyBody> OdTvDbAssocDimDependencyBodyPtr;
