...
#ifndef OdTvDbAssocPolylinePersSubentIdPE_INCLUDED_
#define OdTvDbAssocPolylinePersSubentIdPE_INCLUDED_  /*!DOM*/
...
*/
class DBCONSTRAINTS_EXPORT OdTvDbAssocPolylinePersSubentIdPE : public OdTvDbAssocCurvePersSubentIdPE
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAssocPolylinePersSubentIdPE);
...
typedef OdSmartPtr<OdTvDbAssocPolylinePersSubentIdPE> OdTvDbAssocPolylinePersSubentIdPEPtr;
