...
#ifndef OdTvDbAssoc3dSolidPersSubentIdPE_INCLUDED_
#define OdTvDbAssoc3dSolidPersSubentIdPE_INCLUDED_  /*!DOM*/
...
*/
class DBCONSTRAINTS_EXPORT OdTvDbAssoc3dSolidPersSubentIdPE : public OdTvDbAssocCurvePersSubentIdPE
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAssoc3dSolidPersSubentIdPE);
...
private:
  ...
  */
  ...
  OdResult get3DSolidhistoryObject(OdTvDb3dSolidPtr pEntity, OdTvDbObjectId &historyObjId);
};

typedef OdSmartPtr<OdTvDbAssoc3dSolidPersSubentIdPE> OdTvDbAssoc3dSolidPersSubentIdPEPtr;
