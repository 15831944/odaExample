...
*/
class DBCONSTRAINTS_EXPORT OdTvDbImpAssocMLeaderActionBody : public OdTvDbImpAssocAnnotationActionBody
{
public:
  /** \details
  Constructor creates an instance of this class.
  */
  OdTvDbImpAssocMLeaderActionBody();

  /** \details
  Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbImpAssocMLeaderActionBody();
  ...
  */
  static OdResult createInstance(const OdTvDbFullSubentPathArray &entPathArray,
                                 const OdTvDbObjectId bodyId,
                                 OdGePoint3dArray &ptsSelected, const OdString mText,
                                 OdTvDbObjectId& actionBodyId);
protected:
  OdUInt32 m_version;
  OdUInt32Array m_assocDependencyIndexes;
  OdTvDbObjectIdArray m_assocDependencyIds;
};
