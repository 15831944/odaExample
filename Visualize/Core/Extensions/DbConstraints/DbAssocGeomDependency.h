...
*/
class DBCONSTRAINTS_EXPORT OdTvDbAssocGeomDependency : public OdTvDbAssocDependency
{
public: 
  ODRX_DECLARE_MEMBERS(OdTvDbAssocGeomDependency);

  /** \details
    Constructor creates an instance of this class.
  */
  OdTvDbAssocGeomDependency(bool createImp = true);

  static OdSmartPtr<OdTvDbAssocGeomDependency> createObject( OdTvDbObjectId objId, OdDbSubentId subId );
  ...
  */
  static OdResult redirectToAnotherSubentity(const OdTvDbObjectId& oldObjectId,
                                             const OdDbSubentId& oldSubentId,
                                             const OdTvDbObjectId& newObjectId,
  ...
  */
  ...
  OdResult createNewAssocSimplePersSubent(OdTvDbObjectId lineID, OdDb::SubentType type, PointPositionOnBlockLine isStartPoint);

  //void getViewPortOrBlRefFromFullSubentPath(OdTvDbViewportPtr& viewPort, OdTvDbBlockReferencePtr& blRef);
};
/** \details
  The typified smart pointer. This template class is specialization of the OdSmartPtr class 
  for the OdTvDbAssocGeomDependency class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbAssocGeomDependency> OdTvDbAssocGeomDependencyPtr;
