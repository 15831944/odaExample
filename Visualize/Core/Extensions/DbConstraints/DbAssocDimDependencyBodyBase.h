...
*/
class DBCONSTRAINTS_EXPORT OdTvDbSubentGeometry
{
public:
  /** \details
    Constructor creates an instance of this class.
  */
  OdTvDbSubentGeometry() : mSubentType(OdDb::kNullSubentType), mpCurve(NULL) {}

  OdTvDbSubentGeometry(const OdGePoint3d& pnt) 
      : mSubentType(OdDb::kVertexSubentType), mPoint(pnt), mpCurve(NULL) {}

  OdTvDbSubentGeometry(OdGeCurve3d* pCurve)
...
/** \details
  ...
  <group Contraint_Classes> 
*/
class DBCONSTRAINTS_EXPORT OdTvDbAssocDimDependencyBodyBase : public OdTvDbAssocDependencyBody
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAssocDimDependencyBodyBase);

  /** \details
    Constructor creates an instance of this class.
  */
  OdTvDbAssocDimDependencyBodyBase();

  //explicit OdTvDbAssocDimDependencyBodyBase(OdTvDbAssocCreateImpObject createImpObject = kOdDbAssocCreateImpObject);

  /** \details
    Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbAssocDimDependencyBodyBase();
  ...
  */
  OdTvDbObjectId variable() const; // of OdTvDbAssocVariable
  ...
  */
  ...
  /** \details
    Gets an array of constrained geometries.
  */
  OdResult getConstrainedGeoms(OdArray<OdTvDbFullSubentPath>& geoms) const;

  /** \details
    Gets an array of constrained geometries.
  */
  OdResult getConstrainedGeoms(OdArray<OdTvDbSubentGeometry>& geoms,
  ...
  */
  static OdResult getFromEntity(const OdTvDbObjectId& entityId, OdTvDbObjectId& dimDepBodyId);

  /** \details
    Updates the constraint geometry when dimension points are moved.
  */
  OdResult entityAttachmentPointMoved(const OdArray<OdTvDbSubentGeometry>& newAttachedGeometries,
...
/** \details
  ...
  for the OdTvDbAssocDimDependencyBodyBase class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbAssocDimDependencyBodyBase> OdTvDbAssocDimDependencyBodyBasePtr;


/** \details
  Declares the dimensional constraint types
*/
enum OdTvDbAssocConstraintType
{
