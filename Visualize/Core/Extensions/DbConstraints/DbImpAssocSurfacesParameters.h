...
#ifndef OdTvDbImpAssocSurfacesParameters_INCLUDED_
#define OdTvDbImpAssocSurfacesParameters_INCLUDED_ /*!DOM*/
#include "DbEntity.h"
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class DBCONSTRAINTS_EXPORT OdTvDbImpAssocLoftParameters : public OdTvDbImpAssocArrayParameters
{
  public:
    /// <summary>
    ...
    */
    virtual ~OdTvDbImpAssocLoftParameters() {};

    /// <summary>
    /// <para> Get continuity of a specific profile of the resulting lofted surface </para>
    /// <para>
    /// the same parameter can be accessed through class OdTvDbAssocAction by calling method 
    ...
    /// <para>
    /// the same parameter can be set through class OdTvDbAssocAction by calling method 
