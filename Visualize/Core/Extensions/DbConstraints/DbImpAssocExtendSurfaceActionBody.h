...
class DBCONSTRAINTS_EXPORT OdTvDbImpAssocExtendSurfaceActionBody : public OdTvDbImpAssocPathBasedSurfaceActionBody
{
public:
  /** \details
  Constructor creates an instance of this class.
  */
  OdTvDbImpAssocExtendSurfaceActionBody();

  /** \details
  Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbImpAssocExtendSurfaceActionBody();
