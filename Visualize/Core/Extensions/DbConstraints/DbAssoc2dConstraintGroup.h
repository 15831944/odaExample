...
*/
class DBCONSTRAINTS_EXPORT OdTvDbAssoc2dConstraintGroup : public OdTvDbAssocAction
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAssoc2dConstraintGroup);
  ...
  */
  OdTvDbAssoc2dConstraintGroup();

  ODRX_SEALED_VIRTUAL void audit(OdTvDbAuditInfo* pAuditInfo) ODRX_OVERRIDE;
  ...
  */
  OdResult addConstrainedGeometry(const OdTvDbFullSubentPath& subentPath, OdConstrainedGeometry*& pConsGeom);
  ...
  */
  ...
  OdResult deleteConstrainedGeometry(const OdTvDbObjectIdArray& dependencyIds);
  ...
  */
  static void addGlobalCallback(class OdTvDbAssoc2dConstraintCallback* pCallback);

  /** \details
    Removes the callback from this planar constraint group.
  */
  static void removeGlobalCallback(class OdTvDbAssoc2dConstraintCallback* pCallback);

  /** \details
    Returns the callback of this planar constraint group.
  */
  static class OdTvDbAssoc2dConstraintCallback* globalCallback();
#endif
...
/** \details
  ...
  for the OdTvDbAssoc2dConstraintGroup class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbAssoc2dConstraintGroup> OdTvDbAssoc2dConstraintGroupPtr;
...
/** \details
  ...
  <group Contraint_Classes> 
*/
class OdTvDbAssoc2dConstraintCallback
{
public:
  /** \details
    Constructor creates an instance of this class.
  */
  OdTvDbAssoc2dConstraintCallback() {}

  /** \details
    Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbAssoc2dConstraintCallback() {}
...
{
  /*!DOM*/
  friend class OdTvDbImpAssoc2dConstraintGroup;
  /*!DOM*/
