...
class DBCONSTRAINTS_EXPORT OdTvDbImpAssocSurfaceActionBody : public OdTvDbImpAssocParamBasedActionBody//OdTvDbImpAssocActionBody// OdTvDbImpAssocAnnotationActionBody
{
public:
...
#pragma once
  ...
  */
  OdTvDbImpAssocSurfaceActionBody();

  /** \details
  Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbImpAssocSurfaceActionBody();
  ...
  */
  ...
  OdTvDbObjectId surfaceObjectDepId() const { return m_surfaceObjectDepId; };
...
protected:
  OdUInt32 m_udef1;
  OdUInt32 m_udef2;
  OdTvDbObjectId  m_surfaceObjectDepId;
  bool m_boolUndef1;
  bool m_boolUndef2;
...
class DBCONSTRAINTS_EXPORT OdTvDbImpAssocPathBasedSurfaceActionBody : public OdTvDbImpAssocSurfaceActionBody// OdTvDbImpAssocAnnotationActionBody
{
public:
  /** \details
  Constructor creates an instance of this class.
  */
  OdTvDbImpAssocPathBasedSurfaceActionBody() { m_udefPathBased = 0; };

  /** \details
  Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbImpAssocPathBasedSurfaceActionBody() {};
  ...
  */
  virtual void dxfOutFields(OdTvDbDxfFiler* pFiler) const;
  virtual void evaluateOverride(OdTvDbObjectId parentActionId) {};
  static OdTvDbObjectId createOdDdAssocPathActionParam(const OdTvDbObjectId actionId, const OdTvDbObjectId assocOb, const OdTvDbAssocDependencyPtr pDependency, OdString paramName, int paramIndex = 0);
  virtual OdStringArray compareWith(OdTvDbImpAssocActionBody *paramIDToCompare, OdDb::DwgVersion filerVersion = OdDb::kDHL_CURRENT) const;
