...
*/
class DBCONSTRAINTS_EXPORT OdTvDbAssocArrayPolarParameters : public OdTvDbAssocArrayCommonParameters
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAssocArrayPolarParameters);

  /** \details
    Constructor creates an instance of this class.
  */
  OdTvDbAssocArrayPolarParameters(double angle = 15.0, // by ACAD // = OdaToRadian(60)
  ...
  */
  virtual ~OdTvDbAssocArrayPolarParameters(void);
...
protected:
  /*!DOM*/
  OdTvDbAssocArrayPolarParameters(class OdTvDbImpAssocArrayPolarParameters* pImpl); // disabled Copy constructor
};

/** \details
  The typified smart pointer for the array of polar parameters. This template class 
  is specialization of the OdSmartPtr class for the OdTvDbAssocArrayPolarParameters class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbAssocArrayPolarParameters> OdTvDbAssocArrayPolarParametersPtr;
