...
*/
class DBCONSTRAINTS_EXPORT OdTvDbImpAssocDependency
{
public: 
  /** \details
    Constructor creates an instance of this class.
  */
  OdTvDbImpAssocDependency();

  /** \details
    Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbImpAssocDependency();
  ...
  */
  OdResult setDependencyBody(OdTvDbObjectId dependencyBodyId, OdTvDbObjectId dependencyId);//
  ...
  */
  OdResult setStatus(OdTvDbAssocDependency *pDep, OdTvDbAssocStatus newStatus, bool notifyOwningAction);//
  ...
  */
  virtual OdResult setOwningAction(OdTvDbObjectId actionId, OdTvDbAssocDependency *pDep);//
  ...
  */
  OdResult getDependentOnCompoundObject(OdTvDbCompoundObjectId&) const;

  /** \details
    Deprecated.
  */
  OdResult getDependentOnCompoundObject(OdTvDbCompoundObjectIdPtr& pid) const {
    pid = OdTvDbCompoundObjectId::createObject();
  ...
  */
  OdResult attachToObject(const OdTvDbCompoundObjectId &compoundId, OdTvDbAssocDependency *pDep);

  /** \details
    Deprecated.
  */
  OdResult attachToObject(const OdTvDbCompoundObjectId *pCompoundId, OdTvDbAssocDependency *pDep) {
  ...
  */
  virtual bool isReadyToAttach() { return true; } //This method used in OdTvDbImpAssocGeomDependency
  ...
  */
  OdResult detachFromObject(OdTvDbAssocDependency *pDep);
  ...
  */
  virtual OdResult updateDependentOnObject(OdTvDbAssocDependency *pDep);

  /** \details
    Sets the dependent-on object for this dependency using the given compound object.
  */
  void setDependentOnObject(const OdTvDbCompoundObjectId& compoundId, OdTvDbAssocDependency *pDep);

  /** \details
    Sets the dependent-on object for this dependency using the given compound object.
  */
  void setDependentOnObject(const OdTvDbCompoundObjectId* pCompoundId, OdTvDbAssocDependency *pDep) {
  ...
  */
  virtual bool isRelevantChange(const OdTvDbAssocDependency *pDep) const;//
  ...
  */
  bool isActionEvaluationInProgress( const OdTvDbAssocDependency *pDependency ) const;
  ...
  */
  virtual void evaluate(OdTvDbAssocDependency* thisDependency);

  /** \details
    Notification callback for OdTvDbObject::erased(). This method is called when the 'dependentOnObject' is erased.
  */
  virtual void erased(const OdTvDbObject* depOnObj, OdTvDbAssocDependency *dep, bool isErasing = true);

  /** \details
    Notification callback for OdTvDbObject::modified(). This method is called when the 'dependentOnObject' is modified.
  */
  virtual void modified(const OdTvDbObject* depOnObj, OdTvDbAssocDependency *dep);

  /** \details
    Notification callback for OdTvDbObject::copied(). This method is called when the 'dependentOnObject' is copied.
  */
  virtual void copied(const OdTvDbObject* depOnObj, const OdTvDbObject* copy, OdTvDbAssocDependency *dep);
  ...
  */
  static void relinkDependenciesOn(OdTvDbObject* pObj);

  virtual OdStringArray compareWith(const OdTvDbImpAssocDependency *depIDToCompare, OdDb::DwgVersion filerVersion = OdDb::kDHL_CURRENT) const;
  /*!DOM*/
  OdResult checkGetBody(OdTvDbAssocDependencyBodyPtr& outBody, OdDb::OpenMode mode = OdDb::kForRead) const;
protected:
  /*!DOM*/
  bool isThisDependencyOn(const OdTvDbObject* object);
  /*!DOM*/
  void writeStatus(OdTvDbAssocDependency* pDbObject, OdTvDbAssocStatus newStatus);
  /*!DOM*/
  OdTvDbObjectId  m_dependencyBodyId;
  /*!DOM*/
  OdTvDbObjectId  m_dependentOnObjectId;
  /*!DOM*/
  OdTvDbObjectId  m_prevDependencyOnObjectID;
  /*!DOM*/
  OdTvDbObjectId  m_nextDependencyOnObjectID;
  /*!DOM*/
  OdTvDbAssocStatus m_nStatus;
  /*!DOM*/
  OdInt32       m_nOrder;
  /*!DOM*/
  OdUInt32      m_nIndex;
  ...
  /*!DOM*/
  OdTvDbCompoundObjectId m_refPath;
