...
*/
class DBCONSTRAINTS_EXPORT OdTvDbBlockParameterDependencyBody : public OdTvDbAssocDimDependencyBodyBase
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbBlockParameterDependencyBody);

  /** \details
    Constructor creates an instance of this class.
  */
  OdTvDbBlockParameterDependencyBody();

  /** \details
    Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbBlockParameterDependencyBody();
...
/** \details
  ...
  for the OdTvDbBlockParameterDependencyBody class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbBlockParameterDependencyBody> OdTvDbBlockParameterDependencyBodyPtr;
