...
class DBCONSTRAINTS_EXPORT OdTvDbImpAssocNetworkSurfaceActionBody : public OdTvDbImpAssocLoftedSurfaceActionBody//OdTvDbImpAssocExtrudedSurfaceActionBody// OdTvDbImpAssocAnnotationActionBody
{
public:
  /** \details
