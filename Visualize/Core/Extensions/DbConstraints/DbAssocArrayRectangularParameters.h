...
*/
class DBCONSTRAINTS_EXPORT OdTvDbAssocArrayRectangularParameters : public OdTvDbAssocArrayCommonParameters
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAssocArrayRectangularParameters);
  ...
  */
  OdTvDbAssocArrayRectangularParameters(double columnSpacing = 1.,
                                      double rowSpacing = 1.,
  ...
  */
  virtual ~OdTvDbAssocArrayRectangularParameters();
...
protected:
  /*!DOM*/
  OdTvDbAssocArrayRectangularParameters(class OdTvDbImpAssocArrayRectangularParameters* pImpl); // disabled Copy constructor
};

/** \details
  The typified smart pointer for the array of rectangular parameters. This template class 
  is specialization of the OdSmartPtr class for the OdTvDbAssocArrayRectangularParameters class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbAssocArrayRectangularParameters> OdTvDbAssocArrayRectangularParametersPtr;
