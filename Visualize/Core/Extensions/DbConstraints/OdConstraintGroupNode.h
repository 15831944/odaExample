...
class OdTvDbImpAssoc2dConstraintGroup;
//class OdTvDbAssoc2dConstraintGroupUtil;
...
public:
  ...
  */
  OdTvDbObjectId owningConstraintGroupId()const;
...
protected:
  ...
  */
  ...
  /*!DOM*/
  friend class OdTvDbAssoc2dConstraintGroup;
//  friend class OdTvDbAssoc2dConstraintGroupEvalHelper;
//  friend class OdTvDbAssoc2dConstaintGroupCloningHelper;
};
