...
///////////////////////////////////////////////////////////////////////////////
#ifndef OdTvDbImpAssocGeomDependency_INCLUDED_
#define OdTvDbImpAssocGeomDependency_INCLUDED_ /*!DOM*/
...
*/
class DBCONSTRAINTS_EXPORT OdTvDbImpAssocGeomDependency : public OdTvDbImpAssocDependency
{
public: 
  /** \details
    Constructor creates an instance of this class.
  */
  OdTvDbImpAssocGeomDependency();

  /** \details
    Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbImpAssocGeomDependency();
  ...
  */
  OdTvDbAssocPersSubentIdPtr persistentSubentId() const;
  ...
  */
  OdResult createNewSingleEdgePersSubent(const OdTvDbObjectId lineID);
  OdResult createNewEdgePersSubent(OdTvDbEntity* pEntity, OdTvDbAssocAction* pAction, OdUInt32& subentIndex);// , bool bNewPersSubentIndex);
  virtual OdResult createNewAssocSimplePersSubent(OdTvDbObjectId lineID, OdDb::SubentType type, PointPositionOnBlockLine isStartPoint);
...
protected:
  ...
  OdTvDbObjectId geomObject() const;
  /*!DOM*/
  OdTvDbAssocPersSubentIdPtr  m_pPersSubent;
  //OdTvDbAssocSingleEdgePersSubentIdPtr  m_pPersSubent;
  /*!DOM*/
