...
class DBCONSTRAINTS_EXPORT OdTvDbImpAssocPatchSurfaceActionBody : public OdTvDbImpAssocExtrudedSurfaceActionBody// OdTvDbImpAssocAnnotationActionBody
{
public:
  /** \details
  ...
  */
  ...
  /// </para><para>
  OdResult  setContinuity(int continuity, OdTvDbAssocActionPtr pAction, const OdString& expression ,
    const OdString& evaluatorId );

  /// <summary><para> 
  /// Get continuity of the resulting patch surface. 
  /// </para><para>
  int continuity(OdTvDbAssocActionPtr pAction, OdString& expression , OdString& evaluatorId ) const;

  /// <summary><para> 
  /// Set bulge factor the resulting patch surface.
  /// </para><para>
  OdResult   setBulge(double bulge, OdTvDbAssocActionPtr pAction, const OdString& expression ,
    const OdString& evaluatorId );

  /// <summary><para> 
  /// Get bulge factor of resulting patch surface.
  /// </para><para>
  double bulge(OdTvDbAssocActionPtr pAction, OdString& expression , OdString& evaluatorId ) const;

  /// <summary> 
  /// Create an instance of OdTvDbAssocPatchSurfaceActionBody
