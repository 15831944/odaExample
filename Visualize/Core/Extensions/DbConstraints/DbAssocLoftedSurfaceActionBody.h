...
#ifndef OdTvDbAssocLoftedSurfaceActionBody_INCLUDED_
#define OdTvDbAssocLoftedSurfaceActionBody_INCLUDED_ /*!DOM*/
...
/** \details
This class represents the base class OdTvDbAssocLoftedSurfaceActionBody for the action bodies.

Library: Source code provided.
<group Contraint_Classes>
*/
class DBCONSTRAINTS_EXPORT OdTvDbAssocLoftedSurfaceActionBody : public OdTvDbAssocPathBasedSurfaceActionBody
{
public:
	ODRX_DECLARE_MEMBERS(OdTvDbAssocLoftedSurfaceActionBody);

	/** \details
	Constructor creates an instance of this class.
	*/
	OdTvDbAssocLoftedSurfaceActionBody(bool createImpObj = true);

	/** \details
	Destructor destroys an instance of this class.
	*/
	virtual ~OdTvDbAssocLoftedSurfaceActionBody();
	const OdTvDbAssocLoftParametersPtr parameters() const;
...
typedef OdSmartPtr<OdTvDbAssocLoftedSurfaceActionBody> OdTvDbAssocLoftedSurfaceActionBodyPtr;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
