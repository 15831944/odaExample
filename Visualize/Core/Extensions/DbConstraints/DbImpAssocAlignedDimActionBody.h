...
*/
class DBCONSTRAINTS_EXPORT OdTvDbImpAssocAlignedDimActionBody : public OdTvDbImpAssocAnnotationActionBody
{
public:
  /** \details
  Constructor creates an instance of this class.
  */
  OdTvDbImpAssocAlignedDimActionBody();

  /** \details
  Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbImpAssocAlignedDimActionBody();
