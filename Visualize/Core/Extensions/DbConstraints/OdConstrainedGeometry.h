...
public:
  ...
  */
  OdResult init(const OdTvDbObjectId geomDependencyId);
  ...
  */
  OdResult getFullSubentPaths(OdTvDbFullSubentPathArray& subentPaths) const;
  ...
  */
  OdResult setDataFromGeomDependency(const OdTvDbObjectId geomDependencyId,
...
public:
  ...
  */
  OdResult init(const OdTvDbObjectId depId, bool bRay);
...
public:
  ...
  */
  virtual OdResult init(const OdTvDbObjectId depId, const OdGeNurbCurve3d& spline);
