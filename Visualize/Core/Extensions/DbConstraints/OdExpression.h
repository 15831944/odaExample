...
public:
  ...
  OdResult addVariable(const OdString& name, OdTvDbEvalVariantPtr value);
  int numVariables() const;
  OdResult fixVariable(const OdString& name, OdTvDbEvalVariantPtr value);
  OdResult renameVariable(const OdString& oldName, const OdString& newName);

  OdResult setExpression(const OdString& expression);

  OdTvDbEvalVariantPtr evaluate();
...
OdString createExpression(OdTvDbEvalVariantPtr value);
} // namespace OdExpression
