...
*/
class DBCONSTRAINTS_EXPORT OdTvDbCenterMarkActionBody : public OdTvDbSmartCenterActionBody
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbCenterMarkActionBody);

  /** \details
  Constructor creates an instance of this class.
  */
  OdTvDbCenterMarkActionBody(bool createImpObj = true);

  /** \details
  Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbCenterMarkActionBody();
...
typedef OdSmartPtr<OdTvDbCenterMarkActionBody> OdTvDbCenterMarkActionBodyPtr;
