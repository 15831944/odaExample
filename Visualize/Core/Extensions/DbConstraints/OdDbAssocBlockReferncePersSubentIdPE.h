...
#ifndef OdTvDbAssocBlockReferncePersSubentIdPE_INCLUDED_
#define OdTvDbAssocBlockReferncePersSubentIdPE_INCLUDED_  /*!DOM*/
...
*/
class DBCONSTRAINTS_EXPORT OdTvDbAssocBlockReferncePersSubentIdPE : public OdTvDbAssocPointBasedPersSubentIdPE
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAssocBlockReferncePersSubentIdPE);
...
typedef OdSmartPtr<OdTvDbAssocBlockReferncePersSubentIdPE> OdTvDbAssocBlockReferncePersSubentIdPEPtr;
