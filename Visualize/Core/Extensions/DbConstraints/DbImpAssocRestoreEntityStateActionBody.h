...
class DBCONSTRAINTS_EXPORT OdTvDbImpAssocRestoreEntityStateActionBody : public OdTvDbImpAssocActionBody
{
public:
	/** \details
	Constructor creates an instance of this class.
	*/
	OdTvDbImpAssocRestoreEntityStateActionBody();

	/** \details
	Destructor destroys an instance of this class.
	*/
	virtual ~OdTvDbImpAssocRestoreEntityStateActionBody();
...
private:
	...
	OdTvDbObjectId m_undefObjectDepId;
