...
*/
class DBCONSTRAINTS_EXPORT ODRX_ABSTRACT OdTvDbAssocArrayCommonParameters : public OdTvDbAssocArrayParameters
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAssocArrayCommonParameters);

  /** \details
    Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbAssocArrayCommonParameters();
...
protected:
  ...
  */
  OdTvDbAssocArrayCommonParameters(class OdTvDbImpAssocArrayCommonParameters* pImpl);
};


/** \details
  The typified smart pointer for the array of common parameters. This template class 
  is specialization of the OdSmartPtr class for the OdTvDbAssocArrayCommonParameters class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbAssocArrayCommonParameters> OdTvDbAssocArrayCommonParametersPtr;
