...
*/
class DBCONSTRAINTS_EXPORT OdTvDbAssocArrayPathParameters : public OdTvDbAssocArrayCommonParameters
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAssocArrayPathParameters);
  ...
  */
  OdTvDbAssocArrayPathParameters(double itemSpacing = 1,
                               double rowSpacing = 1,
  ...
  */
  virtual ~OdTvDbAssocArrayPathParameters();
  ...
  */
  ...
  /** \details
    Gets the item position.
  */
  OdResult getItemPosition(const OdTvDbItemLocator& locator, 
                           OdGePoint3d& position) const;

protected:
  /*!DOM*/
  OdTvDbAssocArrayPathParameters(class OdTvDbImpAssocArrayPathParameters* pImpl); // disabled Copy constructor
};

/** \details
  The typified smart pointer for the array of path parameters. This template class 
  is specialization of the OdSmartPtr class for the OdTvDbAssocArrayPathParameters class.

  \sa
  <link smart_pointers.html, Working with Smart Pointers>
*/
typedef OdSmartPtr<OdTvDbAssocArrayPathParameters> OdTvDbAssocArrayPathParametersPtr;
