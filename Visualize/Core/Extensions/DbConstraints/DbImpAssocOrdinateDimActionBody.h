...
*/
class DBCONSTRAINTS_EXPORT OdTvDbImpAssocOrdinateDimActionBody : public OdTvDbImpAssocAnnotationActionBody
{
public:
  /** \details
  Constructor creates an instance of this class.
  */
  OdTvDbImpAssocOrdinateDimActionBody();

  /** \details
  Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbImpAssocOrdinateDimActionBody();
...
private:
  ...
  OdTvDbObjectId m_undefObjectID1;
  OdTvDbObjectId m_undefObjectID2;
};
