...
class DBCONSTRAINTS_EXPORT OdTvDbImpAssocRevolvedSurfaceActionBody : public OdTvDbImpAssocPathBasedSurfaceActionBody
{
public:
  /** \details
  Constructor creates an instance of this class.
  */
  OdTvDbImpAssocRevolvedSurfaceActionBody();

  /** \details
  Destructor destroys an instance of this class.
  */
  virtual ~OdTvDbImpAssocRevolvedSurfaceActionBody();
  ...
  */
  ...
  /// </para><para>
  OdResult setRevolveAngle(OdTvDbAssocActionPtr pAction, OdDouble angle, const OdString& expression = OdString(),
    const OdString& evaluatorId = OdString());

  /// <summary><para> 
  /// Get revolve angle of the resulting surface
  /// </para><para>
  OdDouble revolveAngle(const OdTvDbAssocActionPtr pAction, OdString& expression, OdString& evaluatorId ) const;
private:
