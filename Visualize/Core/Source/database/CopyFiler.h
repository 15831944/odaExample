...
// CopyFiler.h: interface for the OdTvDwgCopyFiler class.
//
//////////////////////////////////////////////////////////////////////
...
template< class TBase>
OdTvDbFiler::FilerType OdCopyFilerImpl<TBase>::filerType() const
{
...
template< class TBase>
OdTvDbObjectId OdCopyFilerImpl<TBase>::rdSoftOwnershipId()
{
  OdTvDbObjectId id;
  TBase::stream().getBytes(&id, sizeof(OdTvDbObjectId));
  return id;
}

template< class TBase>
OdTvDbObjectId OdCopyFilerImpl<TBase>::rdHardOwnershipId()
{
  OdTvDbObjectId id;
  TBase::stream().getBytes(&id, sizeof(OdTvDbObjectId));
  return id;
...
template< class TBase>
OdTvDbObjectId OdCopyFilerImpl<TBase>::rdHardPointerId()
{
  OdTvDbObjectId id;
  TBase::stream().getBytes(&id, sizeof(OdTvDbObjectId));
  return id;
...
template< class TBase>
OdTvDbObjectId OdCopyFilerImpl<TBase>::rdSoftPointerId()
{
  OdTvDbObjectId id;
  TBase::stream().getBytes(&id, sizeof(OdTvDbObjectId));
  return id;
...
template< class TBase>
void OdCopyFilerImpl<TBase>::wrSoftOwnershipId(const OdTvDbObjectId& id)
{
  TBase::stream().putBytes(&id, sizeof(OdTvDbObjectId));
}

template< class TBase>
void OdCopyFilerImpl<TBase>::wrHardOwnershipId(const OdTvDbObjectId& id)
{
  TBase::stream().putBytes(&id, sizeof(OdTvDbObjectId));
}

template< class TBase>
void OdCopyFilerImpl<TBase>::wrSoftPointerId(const OdTvDbObjectId& id)
{
  TBase::stream().putBytes(&id, sizeof(OdTvDbObjectId));
}

template< class TBase>
void OdCopyFilerImpl<TBase>::wrHardPointerId(const OdTvDbObjectId& id)
{
  TBase::stream().putBytes(&id, sizeof(OdTvDbObjectId));
}
...
class OdTvCopyFilerBase : public TBase
{
