...
class OdTvBagFiler : public OdTvDbCommonDxfFilerImpl
{
  OdTvResBufPtr   m_pData;      // SmartPointer to the ResBuf chain of this Filer object.
  OdTvResBufPtr   m_pCurrent;   // SmartPointer to the current ResBuf in the ResBuf chain.
  OdTvDbDatabase* m_pDb;        // Pointer to the database with which this Filer object is associated.
  ...
  /**********************************************************************/
  void appendResBuf( OdTvResBufPtr rb )
  {
...
public:
  ODRX_DECLARE_MEMBERS(OdTvBagFiler);
  OdTvBagFiler();

  virtual OdTvDbDatabase* database() const;
  OdTvResBufPtr getCurrentResBuf() const;
  ...
  /**********************************************************************/
  void init( OdTvDbDatabase* db, OdDb::DwgVersion version = OdDb::kDHL_CURRENT, OdTvResBufPtr resBuf = OdTvResBufPtr() );
  ...
  virtual void writeRb(const OdTvResBuf* pRb);
  ...
  virtual OdTvDbObjectId rdObjectId();
  ...
  virtual void copyItem(OdTvDbDxfFiler * pSource);
  ...
  virtual void wrObjectId(int groupCode, OdTvDbObjectId value);
