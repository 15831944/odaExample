...
class OdTvDbUCSTableRecordImpl : public OdTvDbSymbolTableRecordImpl,
                               public OdUCSInfo
{
public:
  static OdTvDbUCSTableRecordImpl* getImpl(const OdTvDbUCSTableRecord *pObj)
  { return (OdTvDbUCSTableRecordImpl*)OdTvDbSystemInternals::getImpl(pObj);}

  OdUcsBaseOrgArray m_orthoTypesOrigins;

  OdTvDbUCSTableRecordImpl();
...
private:
  friend class OdTvDbUCSTableRecord;
