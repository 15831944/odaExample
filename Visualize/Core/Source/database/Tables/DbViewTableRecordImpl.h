...
class OdTvDbViewTableRecordImpl : public OdTvDbAbstractViewTableRecordImpl 
{
  static OdTvDbViewTableRecordImpl* getImpl(const OdTvDbViewTableRecord *pObj)
  { return (OdTvDbViewTableRecordImpl*)OdTvDbSystemInternals::getImpl(pObj);}
...
public:
  OdTvDbViewTableRecordImpl() : m_bCameraPlottable(false) { }
...
private:
  ...
  OdTvDbSoftPointerId m_liveSection;
  OdTvDbObjectId m_camera;

  OdResult dwgInFields(OdTvDbDwgFiler* pFiler);
  void dwgOutFields(OdTvDbDwgFiler* pFiler) const;
  static OdTvDbXrecordPtr viewInfo(OdTvDbObject* pObj, bool bCreate = false);
  static OdTvDbXrecordPtr thumbnail(OdTvDbObject* pObj, bool bCreate = false);

  friend class OdTvDbViewTableRecord;
