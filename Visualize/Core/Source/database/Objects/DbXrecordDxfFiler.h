...
#ifndef _OdTvDbXrecDxfFiler_h_Included_
#define _OdTvDbXrecDxfFiler_h_Included_

#include "RxObjectImpl.h"
#include "DbXrecord.h"

class TOOLKIT_EXPORT OdTvDbXrecDxfFiler : public OdTvDbDxfFiler
{
  OdRefCounter m_nRefCounter;
  OdTvDbXrecordIteratorPtr m_pIt;
  OdTvDbXrecordPtr m_pXrec;
  OdTvDbDatabase* m_pDb;

  OdTvResBufPtr   m_pRbInitial;
  OdTvResBufPtr   m_pRb;
...
public:
  ...
  OdTvDbXrecDxfFiler() { m_nRefCounter = 1; }
  OdTvDbXrecDxfFiler(OdTvDbXrecord* pXrec, OdTvDbDatabase* db);
  ~OdTvDbXrecDxfFiler() { push(); }
  ...
  /*
  Push the whole OdTvResBuf sequence into m_pXrec and then clear the sequence,
...
#endif // _OdTvDbXrecDxfFiler_h_Included_
