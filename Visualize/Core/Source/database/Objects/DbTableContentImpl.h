...
class OdTvDbTableContentImpl : public OdTvDbFormattedTableDataImpl
{
public:
  static OdTvDbTableContentImpl* getImpl(const OdTvDbTableContent *pObj)
  { return (OdTvDbTableContentImpl*)OdTvDbSystemInternals::getImpl(pObj); }

public:
  OdTvDbTableContentImpl(){};
...
private:
  friend  class OdTvDbTableContent;
};
