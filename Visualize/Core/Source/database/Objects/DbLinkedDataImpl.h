...
class OdTvDbLinkedDataImpl : public OdTvDbObjectImpl
{
public:
  static OdTvDbLinkedDataImpl* getImpl(const OdTvDbLinkedData *pObj)
  { return (OdTvDbLinkedDataImpl*)OdTvDbSystemInternals::getImpl(pObj); }


public:
  OdTvDbLinkedDataImpl(){};
