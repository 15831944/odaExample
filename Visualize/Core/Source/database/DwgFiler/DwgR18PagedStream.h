...
class OdTvDwgR18FileController;

OdUInt32 tvchecksum(OdUInt32 seed, const OdBinaryData& data);
OdUInt32 tvchecksum(OdUInt32 seed, const OdUInt8* p, OdUInt32 sz);
...
//
//----------------------------------------------------------
class OdTvStreamWithCrc32 : public OdTvStreamWithCrc
{
  OdUInt32 m_crc;
  ...
  OdTvStreamWithCrc32(OdStreamBuf* pStreamBuf) : OdTvStreamWithCrc(pStreamBuf) { initCRC(0); }
public:
  ODRX_DECLARE_MEMBERS(OdTvStreamWithCrc32);
  
  static inline OdStreamBufPtr create(OdStreamBuf* pStreamBuf)
  {
    return OdStreamBufPtr((OdRxObject*)new OdTvStreamWithCrc32(pStreamBuf), kOdRxObjAttach);
  }
...
//----------------------------------------------------------
//
// OdTvDwgR18PagedStream
//
//----------------------------------------------------------
class DBIO_EXPORT OdTvDwgR18PagedStream : public OdStreamBuf
{
// ODA_MT_DBIO_BEGIN
// OdArray<OdMutex> can not be copied safely
  OdTvDwgR18PagedStream(const OdTvDwgR18PagedStream&);
  OdTvDwgR18PagedStream& operator = (const OdTvDwgR18PagedStream&);
// ODA_MT_DBIO_END
public:
  ODRX_DECLARE_MEMBERS(OdTvDwgR18PagedStream);
  ...
  void openW();
  void openAppend();
  void setController(OdTvDwgR18FileController* pController) { m_pController = pController; }
  OdTvDwgR18FileController* getController() { return m_pController; }
...
// ODA_MT_DBIO_BEGIN
  ...
  void getPage(Page& page, OdBinaryData& pageData, OdTvDwgR18Compressor& cmpr);
// ODA_MT_DBIO_END
...
private:
  ...
  OdTvDwgR18FileController* m_pController;
};

typedef OdSmartPtr<OdTvDwgR18PagedStream> OdTvDwgR18PagedStreamPtr;

//----------------------------------------------------------
//
// OdTvDwgR18FileSection
//
//----------------------------------------------------------
class OdTvDwgR18FileSection;
typedef OdSmartPtr<OdTvDwgR18FileSection> OdTvDwgR18FileSectionPtr;

class DBIO_EXPORT OdTvDwgR18FileSection : public OdTvDwgR18PagedStream
{
public:
  static OdTvDwgR18FileSectionPtr create(OdTvDwgR18FileController* pController)
  {
    OdTvDwgR18FileSectionPtr pSec = OdRxObjectImpl<OdTvDwgR18FileSection>::createObject();
...
//----------------------------------------------------------
inline
OdUInt64 OdTvDwgR18PagedStream::curPos()
{ 
...
inline
void OdTvDwgR18PagedStream::nextPageR()
{
...
inline
void OdTvDwgR18PagedStream::nextPageW()
{
  ODA_ASSERT(m_curPage == m_pages.end());
