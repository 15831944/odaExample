...
// OdTvR12DwgFiler.h: interface for the OdTvR12DwgFiler class.
//
//////////////////////////////////////////////////////////////////////
...
class OdTvR12DwgFiler : public OdRxObjectImpl<OdTvFlatFiler>
{
  OdTvR12DwgFiler& operator = (OdTvR12DwgFiler);
  OdTvDbFilerController*    m_pController;
public:
	void          open(OdStreamBuf* pStream, OdTvDbFilerController* pController);
