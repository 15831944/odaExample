...
enum OdTvDwgR12TableRecordType
{
  R12_Symbol = 0,
  R12_Block,  
  R12_Linetype,
...
protected:
  ...
  // (order is defined by STR type <enum OdTvDwgR12TableRecordType>)
...
public:
  ...
  inline void addRecInfo (OdTvDwgR12TableRecordType nType, OdTvDbObjectId id, OdString strName);
  inline OdUInt16 getRecIndex (OdTvDwgR12TableRecordType nType, const OdTvDbObjectId& id) const;
  inline OdUInt16 getRecIndex (OdTvDwgR12TableRecordType nType, const OdDbHandle& handle) const;
  inline OdUInt16 getRecIndex (OdTvDwgR12TableRecordType nType, const OdString& str) const;
  inline OdResult getRecIndex (OdTvDwgR12TableRecordType nType, const OdTvDbObjectId& id, OdUInt16& index) const;
  inline const OdTvDbObjectId& getRecId (OdTvDwgR12TableRecordType nType, OdUInt32 nIndex) const;
  inline bool getReferencedRecId (OdTvDwgR12TableRecordType nType, OdUInt32 nIndex, OdTvDbObjectId& objId) const;
  inline bool isReferencedRec (OdTvDwgR12TableRecordType nType, OdUInt32 nIndex) const;
  inline const OdString& getRecName (OdTvDwgR12TableRecordType nType, OdUInt32 nIndex) const;
  inline OdUInt32 getTblSize (OdTvDwgR12TableRecordType nType) const { return m_TableInfo[nType].getSize(); }
  inline OdUInt16& tblRecSize (OdTvDwgR12TableRecordType nType) { return m_TableInfo[nType].m_nRecSize; }
  inline OdUInt32& tblRecNumber (OdTvDwgR12TableRecordType nType) { return m_TableInfo[nType].m_nRecNumber; }
  inline OdUInt32& tblStartAddr (OdTvDwgR12TableRecordType nType) { return m_TableInfo[nType].m_nStartAddr; }

  inline void setBlockEntitiesOffset (const OdTvDbObjectId& id, OdUInt32 nFilePos);
  ...
  inline void setViewportsOffset (const OdTvDbObjectId& id, OdUInt32 nFilePos);
  inline const ViewportsInfo* getVpInfoByPos (OdUInt32 nFilePos) const;
  inline void addViewportsInfo (OdTvDbObjectId id, OdUInt32 nOffset);
  ...
  inline void setBlockTableRecords (OdTvDbBlockTableRecord* pMSRecord, OdTvDbBlockTableRecord* pPSRecord);
  inline OdTvDbBlockTableRecord* getObjOwner() const;
...
private:
  OdTvDbBlockTableRecord* m_pMSRecord;
  OdTvDbBlockTableRecord* m_pPSRecord;
  OdDbHandle            m_Handle;
  // Progress  context
  OdUInt32              m_nPmStep;
  OdInt32               m_nPmLoaded;
...
private:
  ...
  public:
    TableInfo() { clear(); }
    inline void clear();
    inline void add(OdTvDbObjectId id, OdString strName);
    inline const OdTvDbObjectId& getRecId(OdUInt32 i, bool isRef = true) const;
    inline const OdString& getRecName(OdUInt32 i) const;
    inline OdInt32 getRecIndex(const OdTvDbObjectId& id) const;
  ...
  private:
    ...
    OdArray<OdTvDbObjectId> m_RecIds;
...
void DwgR12IOContext::TableInfo::add(OdTvDbObjectId id, OdString strName)
{
...
const OdTvDbObjectId& DwgR12IOContext::TableInfo::getRecId(OdUInt32 i, bool isRef) const
{ 
...
OdInt32 DwgR12IOContext::TableInfo::getRecIndex(const OdTvDbObjectId& id) const
{ 
...
//
//----------------------------------------------------------
OdUInt16 DwgR12IOContext::getRecIndex (OdTvDwgR12TableRecordType nType, const OdTvDbObjectId& id) const
{
...
OdResult DwgR12IOContext::getRecIndex (OdTvDwgR12TableRecordType nType, const OdTvDbObjectId& id, OdUInt16& index) const
{
  OdInt32 i = m_TableInfo[nType].getRecIndex(id);
  index = OdUInt16(i);
...
OdUInt16 DwgR12IOContext::getRecIndex (OdTvDwgR12TableRecordType nType, const OdDbHandle& handle) const
{
  if (handle.isNull())
    return 0;
  OdTvDbObjectId id = m_pDatabase->getOdTvDbObjectId (handle);
  OdInt32 i = m_TableInfo[nType].getRecIndex(id);
  return OdUInt16((i < 0 || i > 0xffff) ? 0 : i);
}

OdUInt16 DwgR12IOContext::getRecIndex (OdTvDwgR12TableRecordType nType, const OdString& str) const
{
...
void DwgR12IOContext::addViewportsInfo(OdTvDbObjectId id, OdUInt32 nOffset)
{
  ViewportsInfo info = {id, nOffset};
  m_theViewportsInfo.push_back (info);
}

void DwgR12IOContext::addRecInfo (OdTvDwgR12TableRecordType nType, OdTvDbObjectId id, OdString strName)
{
  m_TableInfo[nType].add(id, strName);
}

bool DwgR12IOContext::getReferencedRecId (OdTvDwgR12TableRecordType nType, OdUInt32 nIndex, OdTvDbObjectId& objId) const
{
  objId = nIndex < m_TableInfo[nType].getSize() 
    ? m_TableInfo[nType].getRecId(nIndex) : OdTvDbObjectId::kNull;
  return !objId.isNull();
}

const OdTvDbObjectId& DwgR12IOContext::getRecId (OdTvDwgR12TableRecordType nType, OdUInt32 nIndex) const
{
  ODA_ASSERT(nIndex < m_TableInfo[nType].getSize());
  return m_TableInfo[nType].getRecId(nIndex, false);
}

bool DwgR12IOContext::isReferencedRec (OdTvDwgR12TableRecordType nType, OdUInt32 nIndex) const
{
  return m_TableInfo[nType].isReferenced(nIndex);
}

const OdString& DwgR12IOContext::getRecName (OdTvDwgR12TableRecordType nType, OdUInt32 nIndex) const
{
...
void DwgR12IOContext::setBlockTableRecords (OdTvDbBlockTableRecord* pMSRecord,
                           OdTvDbBlockTableRecord* pPSRecord) 
{ 
  m_pMSRecord = pMSRecord; 
  m_pPSRecord = pPSRecord; 
}

OdTvDbBlockTableRecord* DwgR12IOContext::getObjOwner () const
{ 
...
void DwgR12IOContext::setBlockEntitiesOffset (const OdTvDbObjectId& id, OdUInt32 nFilePos)
{
...
void DwgR12IOContext::setViewportsOffset (const OdTvDbObjectId& id, OdUInt32 nFilePos)
{
  ...
  {
    if ( id == OdTvDbObjectId(m_theViewportsInfo[i].m_Id) )
    {
