...
class OdTvDwgR12XDataIteratorImpl : public OdTvXDataIteratorImpl
{
public:
...
#define StaticR12XDataIterator OdStaticRxObject<OdObjectWithImpl<OdTvXDataIterator, OdTvDwgR12XDataIteratorImpl> >
