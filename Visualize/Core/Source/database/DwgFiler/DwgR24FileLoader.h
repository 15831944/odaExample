...
class DBIO_EXPORT OdTvDwgR24FileLoader : public OdTvDwgR18FileLoader
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDwgR24FileLoader);
  OdTvDwgR24FileLoader();
...
// ODA_MT_DBIO_END
  ...
  // OdTvDwgR18FileLoader overridden
  void loadAppInfo();
