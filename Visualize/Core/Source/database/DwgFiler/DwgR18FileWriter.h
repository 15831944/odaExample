...
class DBIO_EXPORT OdTvDwgR18FileWriter : public OdTvDwgFileWriter,
                           public OdTvDwgR18FileController
{
public:
  ODRX_DECLARE_MEMBERS(OdTvDwgR18FileWriter);
  OdTvDwgR18FileWriter();

  void writeDatabase(OdTvDbDatabase* pDb);
  void writeDbIncremental(OdTvDbDatabase* pDb);
