...
//----------------------------------------------------------
//
// OdTvDwgR24FileSplitStream
//
//----------------------------------------------------------
class DBIO_EXPORT OdTvDwgR24FileSplitStream : public OdTvDwgR21FileSplitStream
{
protected:
  bool m_bZeroEndsMode;
public:
  ODRX_DECLARE_MEMBERS(OdTvDwgR24FileSplitStream);
  OdTvDwgR24FileSplitStream();
  ~OdTvDwgR24FileSplitStream();
...
typedef OdSmartPtr<OdTvDwgR24FileSplitStream> OdTvDwgR24FileSplitStreamPtr;
