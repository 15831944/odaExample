...
//----------------------------------------------------------
//
// OdTvDwgR18FileHeader
//
//----------------------------------------------------------
class DBIO_EXPORT OdTvDwgR18FileHeader
{
public:
  OdTvDwgR18FileHeader();
...
//----------------------------------------------------------
//
// OdTvDwgR18FileController
//
//----------------------------------------------------------
class DBIO_EXPORT OdTvDwgR18FileController : public OdTvDwgFileSecurity
{
public:
  ...
  typedef TvIncSaveNamespace::PagesMapEntryPtrsList PagesContainer;
  typedef std::map<OdInt32, TvIncSaveNamespace::PagesMapEntryPtrsList::iterator> PagesIndex;
  typedef TvIncSaveNamespace::GapsTree GapsIndex;
    
  inline OdUInt32 addPage(OdUInt32 pageSize, OdInt64 pageOffset, TvIncSaveNamespace::GapsTreeNode* pGapNode);
  inline void addSysPage(OdUInt32 pageSize, OdInt64 pageOffset, TvIncSaveNamespace::GapsTreeNode* pGapNode);
...
// ODA_MT_DBIO_END
  ...
  bool getOffsetOfSuitableGap(OdUInt32 requiredSize, OdUInt64& resultOffset, 
    TvIncSaveNamespace::GapsTreeNode*& pGapNode);

  bool registerExistingPageAsNewGap(OdUInt32 pageId);

  void checkLeftSideAndMerge(TvIncSaveNamespace::PagesMapEntryPtrsList::iterator& currentGapIt);
  void checkRightSideAndMerge(TvIncSaveNamespace::PagesMapEntryPtrsList::iterator& currentGapIt);
  void checkBothSidesAndMerge(TvIncSaveNamespace::PagesMapEntryPtrsList::iterator& currentGapIt);

  void mergeLeftSide(TvIncSaveNamespace::PagesMapEntryPtrsList::iterator& currentGapIt, 
    TvIncSaveNamespace::PagesMapEntryPtrsList::iterator& leftGapIt);
  void mergeRightSide(TvIncSaveNamespace::PagesMapEntryPtrsList::iterator& currentGapIt, 
    TvIncSaveNamespace::PagesMapEntryPtrsList::iterator& rightGapIt);
  void mergeBothSides(TvIncSaveNamespace::PagesMapEntryPtrsList::iterator& currentGapIt, 
    TvIncSaveNamespace::PagesMapEntryPtrsList::iterator& leftGapIt, 
    TvIncSaveNamespace::PagesMapEntryPtrsList::iterator& rightGapIt);
...
inline OdUInt64 OdTvDwgR18FileController::pageOffset(OdInt32 pageId)
{  
...
inline OdUInt32 OdTvDwgR18FileController::pageSize(OdInt32 pageId)
{
  return (*m_II->m_pagesIndex[pageId])->m_size;
}

inline OdUInt32 OdTvDwgR18FileController::addPage(OdUInt32 pageSize, OdInt64 pageOffset, 
  TvIncSaveNamespace::GapsTreeNode* pGapNode)
{ 
  OdUInt32 pageId = m_II->m_header.m_pagesMaxId + 1;
  m_II->m_header.m_pagesMaxId = pageId;

  TvIncSaveNamespace::PagesMapEntryPtr pPageData = 
    new TvIncSaveNamespace::PagesMapEntry(pageId, pageSize, pageOffset);
  if (!pGapNode)
  {
    m_II->m_pagesContainer.push_back(pPageData);
    TvIncSaveNamespace::PagesMapEntryPtrsList::iterator pageElemIt = --m_II->m_pagesContainer.end();
    m_II->m_pagesIndex[pageId] = pageElemIt;
  }
  else
  {
    TvIncSaveNamespace::PagesMapEntryPtrsList::iterator oldGapElemIt = pGapNode->getNodeValue();
    ...
    if (gapSize > usedPartOfGapSize)
    {
      ...
      TvIncSaveNamespace::PagesMapEntryPtr pRemainingGapData = 
        new TvIncSaveNamespace::GapsMapEntry(-absNewGapId, (OdUInt32)remainingGapSize, remainingGapOffset);

      TvIncSaveNamespace::PagesMapEntryPtrsList::iterator remainingGapElemIt = 
        m_II->m_pagesContainer.insert(++oldGapElemIt, pRemainingGapData);

      ((TvIncSaveNamespace::GapsMapEntry*)pRemainingGapData.get())->m_pTreeNode = 
...
inline void OdTvDwgR18FileController::addSysPage(OdUInt32 pageSize, OdInt64 pageOffset, 
  TvIncSaveNamespace::GapsTreeNode* pGapNode)
{ 
