...
class OdTvDwgR18Compressor
{
public:
  OdTvDwgR18Compressor();
...
//----------------------------------------------------------
inline
void OdTvDwgR18Compressor::readLongLength(int& length)
{
...
inline
void OdTvDwgR18Compressor::readLength(int& length, int opcode, int mask)
{
  length = opcode & mask;
  if (!length)
  {
...
inline
void OdTvDwgR18Compressor::readLiteral(int opcode)
{
...
inline
void OdTvDwgR18Compressor::readCompressed(int length, int offset)
{
...
inline
void OdTvDwgR18Compressor::readOffset(int& opcode1, int& opcode2, int& offset)
{
  opcode1 = *m_pSrcCurr++;
  opcode2 = *m_pSrcCurr++;
