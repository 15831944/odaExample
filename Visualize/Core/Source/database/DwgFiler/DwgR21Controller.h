...
//----------------------------------------------------------
//
// OdTvDwgR21FileSection
//
//----------------------------------------------------------
class OdTvDwgR21FileSection;
typedef OdSmartPtr<OdTvDwgR21FileSection> OdTvDwgR21FileSectionPtr;

class OdTvDwgR21FileSection : public OdTvDwgR21PagedStream
{
public:
  static OdTvDwgR21FileSectionPtr create(OdTvDwgR21FileController* pController)
  {
    OdTvDwgR21FileSectionPtr pSec = OdRxObjectImpl<OdTvDwgR21FileSection>::createObject();
...
//----------------------------------------------------------
//
// OdTvDwgR21FileHeader
//
//----------------------------------------------------------
class OdTvDwgR21FileHeader
{
public:
  OdTvDwgR21FileHeader ()
    : m_headerSize(0x70)
...
//----------------------------------------------------------
//
// OdTvDwgR21FileController
//
//----------------------------------------------------------
class OdTvDwgR21FileController : public OdTvDwgFileSecurity
{
public:
  OdTvDwgR21FileController();
  ...
  OdTvDwgR21Compressor m_cmpr;

  // Reed-Solomon encoder
  OdTvRSCoder m_rsSys;
  OdTvRSCoder m_rsData;
...
protected:
  ...
  public:
    ...
    static inline OdUInt64 toFileOffset(OdUInt64 mapOffset) { return mapOffset + (OdTvDwgR21FileHeader::OFFSET + OdTvDwgR21FileHeader::DDPAGE_SIZE); }
    static inline OdUInt64 toMapOffset(OdUInt64 fileOffset) { return fileOffset - (OdTvDwgR21FileHeader::OFFSET + OdTvDwgR21FileHeader::DDPAGE_SIZE); }
    static inline OdUInt64 alignSize(OdUInt64 pageSize) { return (pageSize + 0x20 - 1) & (OdInt64)(-0x20); }
  };
  OdTvDwgR21FileHeader  m_header;
...
//
//----------------------------------------------------------
inline OdUInt64 OdTvDwgR21FileController::pageOffset(OdInt64 pageId)
{
  return Page::toFileOffset(m_pages[pageId].m_offset);
}

inline OdUInt64 OdTvDwgR21FileController::pageSize(OdInt64 pageId)
{
  return m_pages[pageId].m_size;
}

inline OdUInt64 OdTvDwgR21FileController::sysPageSize(OdUInt64 sizeSrc)
{
