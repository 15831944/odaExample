...
void (OdTvDbDatabaseImpl::*setFun)(ValueType), 
ValueType (OdTvDbDatabaseImpl::*getFun)() const > 
struct OdTvDbDatabaseVariableSaver
{
  OdTvDbDatabaseImpl* _pDb;
  ValueType _oldValue;
  OdTvDbDatabaseVariableSaver(OdTvDbDatabaseImpl*pDb, ValueType newValue)
  {
    _pDb = pDb;
    _oldValue = (pDb->*getFun)();
    (pDb->*setFun)(newValue);
  }
  ~OdTvDbDatabaseVariableSaver()
  {
