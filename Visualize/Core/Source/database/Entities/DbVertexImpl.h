...
class OdTvDbVertexImpl : public OdTvDbEntityImpl
{
  static OdTvDbVertexImpl* getImpl(const OdTvDbVertex *pObj)
  { return (OdTvDbVertexImpl*)OdTvDbSystemInternals::getImpl(pObj);}
...
public:
  ...
  OdTvDbVertexImpl() {/*m_VertexFlags = 0;*/}
