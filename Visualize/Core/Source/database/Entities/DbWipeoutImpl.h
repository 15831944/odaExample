...
class OdTvDbWipeoutImpl : public OdTvDbRasterImageImpl
{
  static OdTvDbWipeoutImpl* getImpl(const OdTvDbWipeout *pObj)
  { return (OdTvDbWipeoutImpl*)OdTvDbSystemInternals::getImpl(pObj);}
