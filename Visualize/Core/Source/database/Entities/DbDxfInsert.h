...
#ifndef _ODDBDXFINSERT_INCLUDED_
#define _ODDBDXFINSERT_INCLUDED_

#include "DbDxfBase.h"

class OdTvDbDxfInsert : public OdTvDbDxfBase
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbDxfInsert);
...
#endif // _ODDBDXFINSERT_INCLUDED_
