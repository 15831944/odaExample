...
class OdTvDbPolygonMeshImpl : public OdPolylineBaseImpl
{
  static OdTvDbPolygonMeshImpl* getImpl(const OdTvDbPolygonMesh *pObj)
  { return (OdTvDbPolygonMeshImpl*)OdTvDbSystemInternals::getImpl(pObj);}
