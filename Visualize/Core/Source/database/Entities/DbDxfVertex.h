...
#ifndef _ODDBDXFVERTEX_INCLUDED_
#define _ODDBDXFVERTEX_INCLUDED_

#include "DbDxfBase.h"

class OdTvDbDxfVertex : public OdTvDbDxfBase
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbDxfVertex);
...
#endif // _ODDBDXFVERTEX_INCLUDED_
