...
class OdTvDbMlineImpl : public OdTvDbEntityImpl
{
  static OdTvDbMlineImpl* getImpl(const OdTvDbMline *pObj)
  { return (OdTvDbMlineImpl*)OdTvDbSystemInternals::getImpl(pObj);}
...
public:
  ...
  OdTvDbHardPointerId m_MLinestyleId;
...
private:
  ...
  bool calculateProperties(OdTvDbMlineStyleImpl* MStyle);
  void calculateSegments(OdTvDbMlineStyleImpl* MStyle);
  void recalculateElement(OdUInt32 index);
//  void calculateOffset(OdTvDbMlineStyleImpl* MStyle);
  bool calculateElementProperties(OdUInt32 index, OdTvDbMlineStyleImpl* MStyle);
  void setStyleProperties(OdTvDbMlineStyleImpl* MStyle);
