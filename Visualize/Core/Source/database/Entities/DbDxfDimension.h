...
#ifndef _ODDBDXFDIMENSION_INCLUDED_
#define _ODDBDXFDIMENSION_INCLUDED_

#include "DbDxfBase.h"

class OdTvDbDxfDimension : public OdTvDbDxfBase
{
public:
  ODDB_DECLARE_MEMBERS(OdTvDbDxfDimension);
...
#endif // _ODDBDXFDIMENSION_INCLUDED_
