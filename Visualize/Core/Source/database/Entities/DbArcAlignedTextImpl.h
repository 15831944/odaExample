...
class OdTvDbArcAlignedTextImpl : public TextStyleRef<OdTvDbEntityImpl>
                             , public OdGiTextStyle
{
  static OdTvDbArcAlignedTextImpl* getImpl(const OdTvDbArcAlignedText *pObj)
  { return (OdTvDbArcAlignedTextImpl*)OdTvDbSystemInternals::getImpl(pObj);}
...
public:
  ...
  void setArcId(OdTvDbObjectId id);
  void setArcIdAndFillData(OdTvDbObjectId id);
...
private:
  OdTvDbSoftPointerId m_ArcId;

  friend class OdTvDbArcAlignedText;
};
