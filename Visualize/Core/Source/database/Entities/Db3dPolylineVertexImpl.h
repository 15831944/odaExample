...
class OdTvDb3dPolylineVertexImpl : public OdTvDbVertexImpl
{
  static OdTvDb3dPolylineVertexImpl* getImpl(const OdTvDb3dPolylineVertex *pObj)
  { return (OdTvDb3dPolylineVertexImpl*)OdTvDbSystemInternals::getImpl(pObj);}

protected:
  OdUInt8 m_VertexFlags;

public:
  OdTvDb3dPolylineVertexImpl()
    : m_VertexFlags(OdTvDbVertexImpl::k3dPolylineVertex)
  {}
...
protected:
  ...
  friend class OdTvDb3dPolylineVertex;
  friend class OdTvDb3dPolyline;
  friend class OdTvDb3dPolylineImpl;
