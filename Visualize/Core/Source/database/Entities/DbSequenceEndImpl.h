...
#ifndef _ODDBSEQUENCEENDIMPL_INCLUDED_
#define _ODDBSEQUENCEENDIMPL_INCLUDED_

#include "DbEntityImpl.h"

class OdTvDbSequenceEndImpl : public OdTvDbEntityImpl
{
public:
...
#endif // _ODDBSEQUENCEENDIMPL_INCLUDED_
