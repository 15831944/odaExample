...
class OdTvDbFaceImpl : public OdTvDbEntityImpl
{
  static OdTvDbFaceImpl* getImpl(const OdTvDbFace *pObj)
  { return (OdTvDbFaceImpl*)OdTvDbSystemInternals::getImpl(pObj);}
