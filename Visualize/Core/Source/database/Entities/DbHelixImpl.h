...
class OdTvDbHelixImpl : public OdTvDbSplineImpl
{
  ...
  OdTvDbHelix::ConstrainType m_constrain;     // dxf 280, Constrain type  
  enum Flags
  {
  ...
  static OdTvDbHelixImpl* getImpl(const OdTvDbHelix *pObj)
  { return (OdTvDbHelixImpl*)OdTvDbSystemInternals::getImpl(pObj);}
  ...
  static OdTvDbSplinePtr getAsSpline(const OdTvDbHelix* pHelix);
public:

  OdTvDbHelixImpl();

  friend class OdTvDbHelix;
  ...
  void drawFrame(const OdTvDbSpline *pSpline, OdGiWorldDraw* pWd) const;
