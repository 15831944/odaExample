...
class OdTvDbEllipseImpl : public OdTvDbCurveImpl, public OdGeEllipArc3d
{
  static OdTvDbEllipseImpl* getImpl(const OdTvDbEllipse *pObj)
  { return (OdTvDbEllipseImpl*)OdTvDbSystemInternals::getImpl(pObj);}
...
private:
  OdResult dwgInFields(OdTvDbDwgFiler* pFiler, OdTvDbEllipse* pObj);
  void dwgOutFields(OdTvDbDwgFiler* pFiler) const;

  friend class OdTvDbEllipse;
};
