...
public:
  ...
  OdTvDbObjectId   m_attributeDefId;
  OdInt16        m_index;
  OdString       m_text;
};
...
public:
  ...
  OdTvDbObjectId   m_objectId; // field ID to text cell
...
private:
  void dwgInEdgeProperty(OdTvDbDwgFiler* pFiler, OdUInt32 flags, OdUInt32 shift);
  void dwgOutEdgeProperty(OdTvDbDwgFiler* pFiler, OdUInt32 flags, OdUInt32 shift) const;
...
public:
  ...
  void dwgOut(OdTvDbDwgFiler* pFiler, OdTvDbDatabase* pDb, const OdTvDbObjectId& textStyleId) const;

  bool dxfIn(OdTvDbDxfFiler* pFiler, OdTvDbDatabase* pDb);
  void dxfOut(OdTvDbDxfFiler* pFiler, OdTvDbDatabase* pDb, const OdTvDbObjectId& textStyleId) const;
  ...
  void setRoudtripData(double checkSum, OdUInt32 flag91, OdUInt32 flag92, const OdTvResBufPtr& xRec);
  void getRoudtripData(double& checkSum, OdUInt32& flag91, OdUInt32& flag92, OdTvResBufPtr& xRec) const;
...
public:
  ...
  OdTvDbObjectIdArray m_subTables; // Points to OdTvDbTable
...
{
public:
  OdTvDbObjectId m_contentID;
  OdTvDbObjectId m_geometryID;
...
/** Description:
  ...
  (rooted in the OdTvDbTableContent object), which coexist in parallel to the 2005 data structures.
...
class OdTvDbTableImpl : public OdTvDbBlockReferenceImpl
{
  static OdTvDbTableImpl* getImpl(const OdTvDbTable *pObj)
  { return (OdTvDbTableImpl*)OdTvDbSystemInternals::getImpl(pObj);}

public:
  OdTvDbTableImpl();

  OdTvDbHardPointerId  m_tableStyleId; 
  OdGeVector3d      m_vDir;
  ...
  OdTvDbTableContentPtr m_content;
  ...
  double  m_dBaseIndicatorSize;
  double  m_dIndicatorTextSize;
  double  m_dIndicatorGap;
  ...
  void dwgInTableOverrides(OdTvDbDwgFiler* pFiler);
  void dwgInBorderColorOverrides(OdTvDbDwgFiler* pFiler);
  void dwgInBorderLWOverrides(OdTvDbDwgFiler* pFiler);
  void dwgInBorderVisibilityOverrides(OdTvDbDwgFiler* pFiler);

  void dwgOutTableOverrides(OdTvDbDwgFiler* pFiler) const;
  void dwgOutBorderColorOverrides(OdTvDbDwgFiler* pFiler) const;
  void dwgOutBorderLWOverrides(OdTvDbDwgFiler* pFiler) const;
  void dwgOutBorderVisibilityOverrides(OdTvDbDwgFiler* pFiler) const;
  ...
  {
    OdTvDbObjectPtr pObject = m_tableStyleId.openObject();
    if( pObject.isNull() )
    {
      if ( database() )
      {
        OdTvDbTableImpl* pThis = const_cast<OdTvDbTableImpl*>(this);
  ...
  OdTvCmColor  backgroundColor(OdDb::RowType type) const;
  void setBackgroundColor(const OdTvCmColor& color, OdUInt32 rowTypes);

  OdTvCmColor contentColor(OdDb::RowType type) const;
  void setContentColor(const OdTvCmColor& color, OdUInt32 rowTypes);

  OdTvDbObjectId  textStyle(OdDb::RowType type) const;
  void setTextStyle(const OdTvDbObjectId& id, OdUInt32 rowTypes);
  ...
  OdTvCmColor gridColor(OdDb::GridLineType gridlineType, OdDb::RowType type) const;
  void setGridColor(const OdTvCmColor& color, OdUInt32 nBorders, OdUInt32 nRows);
  ...
  OdTvDbObjectId fieldId(OdUInt32 row, OdUInt32 col) const;
  void setFieldId(OdUInt32 row, OdUInt32 col, const OdTvDbObjectId& fieldId);

  OdTvDbObjectId textStyle(OdUInt32 row, OdUInt32 col) const;
  void setTextStyle(OdUInt32 row, OdUInt32 col, const OdTvDbObjectId& id);
  ...
  OdTvCmColor backgroundColor(OdUInt32 row, OdUInt32 col) const;
  void setBackgroundColor(OdUInt32 row, OdUInt32 col, const OdTvCmColor& color);

  OdTvCmColor contentColor(OdUInt32 row, OdUInt32 col) const;
  void setContentColor(OdUInt32 row, OdUInt32 col, const OdTvCmColor& color);

  bool isAutoScale(OdUInt32 row, OdUInt32 col) const;
  void setAutoScale(OdUInt32 row, OdUInt32 col, bool autoFit);

  OdTvDbObjectId blockTableRecordId(OdUInt32 row, OdUInt32 col) const;
  void setBlockTableRecordId(OdUInt32 row, OdUInt32 col, const OdTvDbObjectId& blkId, bool autoFit);
  ...
  void getBlockAttributeValue(OdUInt32 row, OdUInt32 col, const OdTvDbObjectId& attdefId, OdString& value) const;
  void setBlockAttributeValue(OdUInt32 row, OdUInt32 col, const OdTvDbObjectId& attdefId, const OdString& value);

  OdTvCmColor gridColor(OdUInt32 row, OdUInt32 col, OdDb::CellEdgeMask iEdge);
  void setGridColor(OdUInt32 row, OdUInt32 col, OdInt16 nEdges, const OdTvCmColor& color);
  ...
  OdDb::GridLineType getGridLineType(OdUInt32 row, OdUInt32 col, 
                               OdDb::CellEdgeMask iEdge, OdDb::RowType& rType); //, const OdTvDbTable* mTable);

  void calcCellGridsOnly(OdTvDbTable* table, OdTableCache& cellSet);
  void calcCells(OdTvDbTable* table, OdTableCache&);
  void calcTextCell(OdTvDbTable* table, OdUInt32 row, OdUInt32 col, 
              double CellWidth, double CellHeight, OdCellCalcCache* CellSet, OdInt32 content = -1);
  void calcBlockCell(OdTvDbTable* table, OdUInt32 row, OdUInt32 col, 
              double CellWidth, double CellHeight, OdCellCalcCache* CellSet, OdInt32 content = -1);
  void calcMultipleContentCell(OdTvDbTable* table, OdUInt32 row, OdUInt32 col, 
              double CellWidth, double CellHeight, OdCellCalcCache* CellSet, OdRowCache* cellProp = NULL);
  void calcMultipleContentCellMin(OdTvDbTable* table, OdUInt32 row, OdUInt32 col,
  ...
  bool adjustRowColumnSize(OdTvDbTable* table, OdTableCache&);
  ...
  OdInt32 getCellExtents(const OdTvDbTable* table, OdInt32 iRow, OdInt32 iCol, OdGePoint3dArray& pts);

  OdGeMatrix3d tableTranform(OdDb::FlowDirection flowDir);
  void convertToSysCodePage();
  void correctTextCoding();

  void setDefaultTableStyle(OdTvDbDatabase* pDb);
  void audit(OdTvDbAuditInfo* pAuditInfo);

  void startSettingEntities(OdTvDbBlockTableRecordPtr pRec);
  OdTvDbObjectId setEntity(OdTvDbBlockTableRecordPtr pRec, OdTvDbEntity* pEntity);
  void finishSettingEntities(OdTvDbBlockTableRecordPtr pRec, OdGeMatrix3d matr);
  ...
  OdTvResBufPtr read2007RoundTripData(OdTvResBufPtr pRb1, bool& pre2007);
  OdTvResBufPtr read2008RoundTripData(OdTvResBufPtr pRb1, OdDb::SaveType format, OdBreakData* brData);

  void composeData(OdTvDbObject *pObj, OdDb::DwgVersion version, OdDb::SaveType format, OdTvDbTableContentPtr content);
  void makeContent(OdTvDbObject *pObj, OdTvDbTableContentPtr content);
  void makeTableGeometryData(OdTvDbObject *pObj);
  void setFromContent(OdTvDbTableContentPtr content, bool bUseBreakData = false);
  void copyLockedFormat(OdTvDbObject *pObj, OdTvDbTableContentPtr content);
  ...
  OdTvDbTableContentPtr getContentPtr()
  {
    return m_content;
  }
  ...
  void splitTable(OdTvDbTablePtr table, OdBreakData& breakData);
  void calcBreakData(OdTvDbTablePtr table, bool bAdjustSize = false);
  double heightRows(OdTvDbTablePtr table, OdInt32 startRow, OdInt32 endRow);
  double widthCols(OdTvDbTablePtr table, OdInt32 startCol, OdInt32 endCol);
  void heightLabelRows(OdTvDbTablePtr table, double& topLabelHeight, double& bottomLabelHeight);
  void  getTopBottomLabels(OdTvDbTablePtr table, OdInt32& amRowsInTopLabel,  OdInt32& amRowsInBottomLabel);
  bool isLabelRow(OdTvDbTablePtr table, OdInt32 row);

  OdInt32 getLastNoMergedRow(OdTvDbTablePtr table, OdInt32 row);

  void subCloseNewTable(OdTvDbTablePtr table);

  void setSubSelection(OdInt32 rowMin, OdInt32 rowMax, OdInt32 colMin, OdInt32 colMax);
  bool hitTest(OdTvDbTablePtr table, const OdGePoint3d& wpt, const OdGeVector3d& wviewVec, double wxaper, double wyaper,
  ...
  OdInt32 findHitContent(OdTvDbTablePtr table, OdInt32 rowIndex, OdInt32 columnIndex, 
  ...
  OdInt32 getRangeIndicatorPoints(OdTvDbTablePtr pTable, OdCellRange selRange, OdGePoint3d* points);
  bool drawHighlighting(OdTvDbTablePtr table, OdGiWorldDraw* worldDraw);
  bool drawCellSelector(OdTvDbTablePtr table, OdGiWorldDraw* worldDraw,const OdGeMatrix3d& mat);
  bool drawLinkIndicator(OdTvDbTablePtr table, OdGiWorldDraw* worldDraw, const OdGeMatrix3d& mat);

  bool drawCellIndicator(OdTvDbTablePtr table, OdGiWorldDraw* worldDraw, const OdGiTextStyle& textStyle, const OdGeMatrix3d& mat);
  void drawCellIndicatorBreak(OdTvDbTablePtr pTable, OdGiWorldDraw* worldDraw, const OdGiTextStyle& textStyle, OdInt32 brkIndx, const OdGeMatrix3d& mat);
  void drawSelectIndicator(OdTvDbTablePtr pTable, OdGiWorldDraw* worldDraw, OdCellRange selRange, double topLabelheight, OdInt32 startRow, const OdGeMatrix3d& mat);
  void drawHorizontalTextLabels(OdTvDbTablePtr pTable, OdGiWorldDraw* worldDraw, const OdGiTextStyle& textStyle, const OdGeMatrix3d& mat);
  void drawVerticalTextLabels(OdTvDbTablePtr pTable, OdGiWorldDraw* worldDraw, const OdGiTextStyle& textStyle, OdInt32 brkIndx, const OdGeMatrix3d& mat);

  double indicatorRowWidth() { return m_dIndicatorTextSize*2.5 + m_dIndicatorGap; }
  double indicatorColHeight() { return m_dIndicatorTextSize + m_dIndicatorGap; }
  double indicatorTextHeight() { return m_dIndicatorTextSize; }

  void updateBaseIndicatorSize();

private:
  OdTvDbObjectIteratorPtr m_entityIter;
  friend class OdTvDbTable;
  friend class OdTvDbTableTemplate;
};
