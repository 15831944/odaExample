...
class OdTvDb2LineAngularDimensionImpl : public OdTvDb3PointAngularDimensionImpl
{
  static OdTvDb2LineAngularDimensionImpl* getImpl(const OdTvDb2LineAngularDimension *pObj)
  { return (OdTvDb2LineAngularDimensionImpl*)OdTvDbSystemInternals::getImpl(pObj);}

public:
  // OdGePoint3d m_ArcDefPt;
  ODIMPL_DEFINE_WCS_OCS_POINT(ArcDefPt);

  virtual OdUInt8 getDimTypeFlag() { return OdTvDbDimensionImpl::Dim2LineAngular; }
  ...
  */
  ...
  friend class OdTvDb2LineAngularDimension;
