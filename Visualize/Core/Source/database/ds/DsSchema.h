...
namespace OdTvDs
{
  ...
  public:
    ...
    SchemaProperty()
      ...
      , m_DxfPropFlag(0)
    {}
    SchemaProperty(OdTvDbDwgFiler* pFiler)
    {
      read(pFiler);
    }
    ...
    OdResult dxfXrecIn(OdTvDbDxfFiler* pFiler);
    void dxfXrecOut(OdTvDbDxfFiler* pFiler) const;
  ...
  public:
    ...
    SchemaAttributeData(OdTvDbDwgFiler* pFiler)
    {
      m_NameIndex = 0;
      read(pFiler);
    }
  ...
  public:
    ...
    virtual OdResult dxfXrecInFields(OdTvDbDxfFiler* pFiler);
    virtual void dxfXrecOutFields(OdTvDbDxfFiler* pFiler) const;
  ...
  //
  //----------------------------------------------------------
  void initializeDsSchema(OdTvDbDatabase* pDb, OdTvDbObjectId* pXrecIds = 0);
  void saveDsDecomposeData(OdTvDbDatabase* pDb);
}
