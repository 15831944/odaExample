...
class DBIO_EXPORT OdTvDbCommonDxfFilerImpl : public OdTvDbDxfFiler
{
protected:
  OdTvDbFilerController *m_pController;

  const OdTvDbObjectId& idLoaded(OdTvDxfCode::Type type, const OdTvDbObjectId& id);
public:
  ODRX_DECLARE_MEMBERS(OdTvDbCommonDxfFilerImpl);

  OdTvDbCommonDxfFilerImpl();
  OdTvDbFiler::FilerType filerType() const;
  virtual void setController(OdTvDbFilerController * pController);
...
class DBIO_EXPORT OdTvDbAsciiDxfFilerImpl : public OdTvDbCommonDxfFilerImpl
{
...
protected:
  ...
  void readNext();
public:
  ODRX_DECLARE_MEMBERS(OdTvDbAsciiDxfFilerImpl);
  ...
  inline OdString rdString() { return OdTvDbCommonDxfFilerImpl::rdString(); }
...
typedef OdSmartPtr<OdTvDbAsciiDxfFilerImpl> OdTvDbAsciiDxfFilerImplPtr;

// Binary DXF file functionality
class DBIO_EXPORT OdTvDbBinaryDxfFilerImpl : public OdTvDbCommonDxfFilerImpl
{
protected:  
  OdTvDbBinaryDxfFilerImpl();
...
public:
  ODRX_DECLARE_MEMBERS(OdTvDbBinaryDxfFilerImpl);
