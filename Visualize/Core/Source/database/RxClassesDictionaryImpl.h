...
// ODA_MT_DBIO_BEGIN
//class OdTvRxClassesDictionaryImpl : public OdRxDictionaryImpl<>
class OdTvRxClassesDictionaryImpl : public OdRxDictionaryImpl<std::less<OdString>, OdMutex>
// ODA_MT_DBIO_END
{
  OdTvRxClassesDictionaryImpl& operator = (const OdTvRxClassesDictionaryImpl&);
public:
...
// ODA_MT_DBIO_BEGIN
    ...
    return OdRxDictionaryImpl<std::less<OdString>, OdMutex>::putAt(key, pObject, pResId);
// ODA_MT_DBIO_END
  }
...
// ODA_MT_DBIO_BEGIN
    ...
    return OdRxDictionaryImpl<std::less<OdString>, OdMutex>::putAt(id, pObject);
// ODA_MT_DBIO_END
  }
