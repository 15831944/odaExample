...
class OdTvDwgDigitalSignature
{
public:
  OdTvDwgDigitalSignature();
  ~OdTvDwgDigitalSignature();
...
typedef OdSharedPtr<OdTvDwgDigitalSignature> OdTvDwgDigitalSignaturePtr;


inline OdTvDwgDigitalSignature::OdTvDwgDigitalSignature()
  : m_unk(0)
{
}
