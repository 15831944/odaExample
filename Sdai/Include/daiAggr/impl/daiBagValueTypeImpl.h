...
#ifndef _DAI_BAG_VALUE_TYPE_IMPL_H_
#define _DAI_BAG_VALUE_TYPE_IMPL_H_
...
namespace OdDAI
{
  ...
  */
  ...
  class BagPtrValueTypePOD : public OdRxValueTypePOD<ValueType*>
  {
  public:

    BagPtrValueTypePOD(const OdChar* name, OdRxMemberCollectionConstructorPtr memberConstruct = NULL, void* userData = NULL)
    ...
    virtual bool subToValueType(const OdRxValueType& vt, const OdRxValue& instance, OdRxValue& subVal) const ODRX_OVERRIDE
    {
      if (vt == OdRxValueType::Desc<OdArray<SubValueType> >::value())
      {
        ...
        if (!inst->isNil())
        {
          return Utils::copyTo<SubValueType, OdRxValue>(*inst, subVal);
        }
        else
        {
  ...
  */
  template<typename ValueType, typename SubValueType>
  class BagValueTypePOD : public OdRxValueTypePOD<ValueType>
  {
  public:

    BagValueTypePOD(const OdChar* name, OdRxMemberCollectionConstructorPtr memberConstruct = NULL, void* userData = NULL)
      : OdRxValueTypePOD<ValueType>(name, memberConstruct, userData)
    {
    };
...
#endif // _DAI_Bag_VALUE_TYPE_IMPL_H_
