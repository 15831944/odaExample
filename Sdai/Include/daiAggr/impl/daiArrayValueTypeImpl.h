...
#ifndef _DAI_ARRAY_VALUE_TYPE_IMPL_H_
#define _DAI_ARRAY_VALUE_TYPE_IMPL_H_
...
namespace OdDAI
{
  ...
  class ArrayPtrValueTypePOD;

  /** \details
  Template class represents value type for pointer to aggregate.
  */
  template<typename ValueType, typename SubValueType>
  class ArrayPtrValueTypePOD<ValueType, SubValueType, false> : public OdRxValueTypePOD<ValueType*>
  {
  public:

    ArrayPtrValueTypePOD(const OdChar* name, OdRxMemberCollectionConstructorPtr memberConstruct = NULL, void* userData = NULL)
  ...
  template<class AggrContainer, class ValueToPut, bool isAggrValue = has_value_type<ValueToPut>::value>
  class ArrayValueTypePOD;

  /** \details
  Template class represents value type for aggregate.
  */
  template<typename ValueType, typename SubValueType>
  class ArrayValueTypePOD<ValueType, SubValueType, false> : public OdRxValueTypePOD<ValueType>
  {
  public:
    ArrayValueTypePOD(const OdChar* name, OdRxMemberCollectionConstructorPtr memberConstruct = NULL, void* userData = NULL)
      : OdRxValueTypePOD<ValueType>(name, memberConstruct, userData)
    {
    };
