...
#ifndef _DAI_UNIQUENESS_RULE_H_
#define _DAI_UNIQUENESS_RULE_H_
...
namespace OdDAI {
  ...
  */
  class DAI_EXPORT UniquenessRule : public DictionaryInstance
  {
  public:

    //DOM-IGNORE-BEGIN
    ODRX_DECLARE_MEMBERS(UniquenessRule);
    //DOM-IGNORE-END

    static OdSmartPtr<UniquenessRule> createObject(OdDAI::Schema *schema, const OdAnsiString &label, const OdAnsiString &expression);
    static OdSmartPtr<UniquenessRule> createObject(OdDAI::Schema *schema, const OdAnsiString &label, AST *ast);
...
//DOM-IGNORE-END
  ...
  typedef OdSmartPtr<UniquenessRule> UniquenessRulePtr;

}

#endif // _DAI_UNIQUENESS_RULE_H_
