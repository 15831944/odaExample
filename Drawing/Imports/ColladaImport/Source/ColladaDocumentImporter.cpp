...
{
  DocumentImporter::DocumentImporter(const OdString &filepath, OdDbDatabase* pDatabase, bool bImportTextures, bool bConsoleOut, bool bImportLines)
    : m_strImportFilePath(filepath)
    , m_pDatabase(pDatabase)
    , m_bImportTextures(bImportTextures)
    , m_bConsoleOut(bConsoleOut)
    , m_bImportLines(bImportLines)
  {
