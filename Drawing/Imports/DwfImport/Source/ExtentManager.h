...
class DwfExtentManager
{
  ...
  OdGeExtents2d _clipRect; // CORE-16607 //WT_Logical_Box _clipRect;
public:
  ...
  OdGeExtents2d _extent; // CORE-16607 // WT_Logical_Box _extent;
  ...
  void clear();
  //
  void setClipRect(const OdGePoint2d& min, const OdGePoint2d& max); // const WT_Logical_Box& clipRect);
  //
  bool isValid() const;
};
}
