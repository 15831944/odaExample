...
public:
  ...
  */
  ...
  /** \details
    ...
    it to the range 0 to 2PI. When (StartAngle = 0) and (EndAngle = Oda2PI) or 
    |EndAngle - StartAngle| <= 1e-12, the figure is closed, that is an ellipse.
  ...
  */
  ...
  /** \details
    ...
    convertes it to the range 0 to 2PI. When (StartParam = 0) and (EndParam = Oda2PI) or 
    |EndParam - StartParam| <= 1e-7, the figure is closed, that is an ellipse.
