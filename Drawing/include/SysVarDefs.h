...
HPSMOOTHEVALUATE controls the number of segments elliptical arcs, or circle arcs on intrvals 0..Oda2PI.
Only the  database resedent hatch entity can use HPSMOOTHEVALUATE variable. If the rendering device provides non-zero deviation values, 
