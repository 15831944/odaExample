...
namespace OdDb
{
  class TOOLKIT_EXPORT FileDependency
  {
    bool m_bDependencyCreated;
    OdString m_strFilePath;
    OdString m_strFeature;
  public:
    FileDependency(const OdString& feature);
    void setFileName(const OdString&, OdDbDatabase*, bool updateDependencies = true);
    operator const OdString() const {return m_strFilePath;}
    void subClose(OdDbDatabase*);
    void subErase(bool erasing, OdDbDatabase*);
