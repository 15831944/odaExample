...
class OdDbBlock2PtParameterImpl : public OdDbBlockParameterImpl
{
  friend class OdDbBlock2PtParameter;
protected:
  OdGePoint3d m_pPoint1;
  OdGePoint3d m_pPoint2;
  OdDbEvalNodeId m_pGripNodes[4];
  OdDbBlockParameterImpl::PropertyInfo m_pProperties[4];
  ...
  virtual OdDbBlockParameter::ParameterComponent getComponentForGrip( OdDbEvalNodeId id);
public:
  OdDbBlock2PtParameter::ParameterBaseLocation baseLocation() const { return (OdDbBlock2PtParameter::ParameterBaseLocation) m_nBasePoint; }
  ...
  void setBaseLocation(OdDbBlock2PtParameter::ParameterBaseLocation l){ m_nBasePoint = (OdInt16)l;}
  ...
  OdDbBlock2PtParameterImpl();
  DECLARE_GET_IMPL(OdDbBlock2PtParameter);
};
