...
class OdDbBlockBasepointParameterImpl : public OdDbBlock1PtParameterImpl
{
  friend class OdDbBlockBasepointParameter;
protected:
  OdGePoint3d m_pBasePoint;
  OdGePoint3d m_pUpdatedBasePoint;
public:
  DECLARE_GET_IMPL(OdDbBlockBasepointParameter);
  OdDbBlockBasepointParameterImpl() : OdDbBlock1PtParameterImpl(){}
