...
class OdDbBlockLookUpParameterImpl : public OdDbBlock1PtParameterImpl
{
  friend class OdDbBlockLookUpParameter;
protected:
  OdString m_sLabel;
  OdString m_sDescription;
  OdString m_sCurrentState; // instance data
public:
  OdDbEvalNodeId m_nActionId;
  DECLARE_GET_IMPL(OdDbBlockLookUpParameter);
  OdDbBlockLookUpParameterImpl() : OdDbBlock1PtParameterImpl(), m_nActionId(0) {}
