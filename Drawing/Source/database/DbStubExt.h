...
class TOOLKIT_EXPORT OdDbStubExt : public OdDbStub
{
public:
  OdDbStubExt(OdDbBaseDatabase* pDatabase, const OdDbHandle& h)
  ...
  OdDbObjectId ownerId() const { return m_pOwner; }
  void setOwnerId(OdDbObjectId id) { m_pOwner = id; }
  ...
  { 
    ...
    // Check owners
    OdDbStubExt* pOwner = (OdDbStubExt*)owner();
    if (!pOwner)
      return false;
...
class TOOLKIT_EXPORT OdDbStubExtFactory : public OdDbStubFactory
{
public:
