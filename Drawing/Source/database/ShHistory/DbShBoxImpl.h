...
#ifndef _OD_DB_SHBOX_IMPL_
#define _OD_DB_SHBOX_IMPL_

#include "ShHistory/DbShBox.h"
#include "DbShPrimitiveImpl.h"


class OdDbShBoxImpl : public OdDbShPrimitiveImpl
{
...
//   OdInt32 m_nVersionMinor;
  ...
  friend class OdDbShBox;

public:
  OdDbShBoxImpl() : m_dLength(0)
                  , m_dWidth(0)
                  , m_dHeight(0){}
