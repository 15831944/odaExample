...
{
private:
  std::map<OdDb3dSolid*, bool> m_mapCreatedEntityCache;
protected:
...
public:
  ...
  virtual OdResult filletEdges(OdDb3dSolid* pSolid, const OdArray<OdDbSubentId *> &edgeSubentIds, const OdGeDoubleArray& radius, const OdGeDoubleArray& startSetback, const OdGeDoubleArray& endSetback);
  virtual OdResult chamferEdges(OdDb3dSolid* pSolid, const OdArray<OdDbSubentId *> &edgeSubentIds, const OdDbSubentId& baseFaceSubentId, double baseDist, double otherDist);
  virtual bool subWorldDraw(OdGiWorldDraw* pWd, const OdDb3dSolid* pSolid);
};
