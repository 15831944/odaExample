...
#ifndef _OD_DB_SHSUBENTMATERIAL_IMPL_
#define _OD_DB_SHSUBENTMATERIAL_IMPL_

#include "ShHistory/DbShSubentMaterial.h"
#include "DbShHistoryNodeImpl.h"


class OdDbShSubentMaterialImpl : public OdDbShHistoryNodeImpl
{
  OdInt32 m_iNodeId1;
  OdInt32 m_iNodeId2;
  OdDbObjectId m_materialId;

  friend class OdDbShSubentMaterial;

public:
  OdDbShSubentMaterialImpl() : m_iNodeId1(0)
                             , m_iNodeId2(0) {}
  ...
  DECLARE_GET_IMPL(OdDbShSubentMaterial);
