...
#ifndef _OD_DB_SHBREP_IMPL_
#define _OD_DB_SHBREP_IMPL_
...
class DBENT_EXPORT OdDbShBrepImpl : public OdDbShPrimitiveImpl
{
  friend class OdDbShBrep;
public:
  OdDbShBrepImpl();
