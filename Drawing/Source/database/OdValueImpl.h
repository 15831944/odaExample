...
public:
  ...
  static bool formatL(OdString& pszValue, const OdString& format, double d, OdValue::FormatOption nOption, OdDbDatabase* pDb);
  static bool formatA(OdString& pszValue, const OdString& format, double d, OdValue::FormatOption nOption, OdDbDatabase* pDb);
  enum CoordsIncluded
  {
    kXIncluded = 1,
    kYIncluded = 2, 
  ...
  static bool formatPoint(OdString& pszValue, const OdString& format, const OdGePoint3d& pt, OdValue::FormatOption nOption, OdDbDatabase* pDb, bool pt2d = false);
  bool format(const OdString& pszFormat, OdString& pszValue, OdValue::FormatOption nOption, OdDbDatabase* pDb) const;
