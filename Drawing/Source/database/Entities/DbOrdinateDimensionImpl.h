...
class OdDbOrdinateDimensionImpl : public OdDbDimensionImpl
{
  static OdDbOrdinateDimensionImpl* getImpl(const OdDbOrdinateDimension *pObj)
  { return (OdDbOrdinateDimensionImpl*)OdDbSystemInternals::getImpl(pObj);}

public:
  OdGePoint3d m_DefPoint1;
  OdGePoint3d m_DefPoint2;

  virtual OdUInt8 getDimTypeFlag() { return OdDbDimensionImpl::DimOrdinate; }
  ...
  */
  ...
  friend class OdDbOrdinateDimension;
