...
class OdDbOle2FrameImpl : public OdDbOleFrameImpl
{
  static OdDbOle2FrameImpl* getImpl(const OdDbOle2Frame *pObj)
  { return (OdDbOle2FrameImpl*)OdDbSystemInternals::getImpl(pObj);}
