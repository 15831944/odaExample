...
class OdDbNurbSurfaceImpl : public OdDbSurfaceImpl
{
...
public:
  ...
  static OdDbNurbSurfaceImpl* getImpl(const OdDbNurbSurface *pObj)
  { return (OdDbNurbSurfaceImpl*)OdDbSystemInternals::getImpl(pObj);}
