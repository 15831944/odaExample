...
class OdDbArcDimensionImpl : public OdDbDimensionImpl
{
  static OdDbArcDimensionImpl* getImpl(const OdDbArcDimension *pObj)
  { return (OdDbArcDimensionImpl*)OdDbSystemInternals::getImpl(pObj);}
...
public:
  ...
  OdDbArcDimensionImpl();
  friend class OdDbArcDimension;
