...
class OdGrDataSaver : public OdGiBaseVectorizer
                    , public OdFlatFiler
...
public:
  OdGrDataSaver();
  void init(OdStreamBuf* pBuf, OdDbDatabase* pDb, OdDb::DwgVersion ver = OdDb::kDHL_CURRENT);
  OdUInt32 numObjects();
  void save(const OdDbEntity* pEnt);
  void saveGraphics(const OdDbEntity* pEnt);
...
private:
  ...
  //OdDbDatabase* database() const { return OdGiDefaultContext::database(); }
  ////using OdGiDefaultContext::database;
  //OdDbDatabase* database() const { return m_pDb; }
  //OdDbDatabase* m_pDb;
};

class OdGrDataTransformer : public OdStaticRxObject<OdGrDataSaver>
{
protected:
...
public:
  OdGrDataTransformer(){}
  OdGrDataTransformer(const OdGeMatrix3d& xform);
...
class OdGrDataSaverR14 : public OdGrDataTransformer 
{
  OdGiStack<OdGeMatrix3d>  m_xModelStack;

public:
  OdGrDataSaverR14() : OdGrDataTransformer() {}
  OdGrDataSaverR14(const OdGeMatrix3d& xform) : OdGrDataTransformer(xform) {}
