...
class OdDbPolyFaceMeshImpl : public OdPolylineBaseImpl
{
  static OdDbPolyFaceMeshImpl* getImpl(const OdDbPolyFaceMesh *pObj)
  { return (OdDbPolyFaceMeshImpl*)OdDbSystemInternals::getImpl(pObj);}
