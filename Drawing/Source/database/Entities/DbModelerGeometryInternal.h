...
DBENT_EXPORT OdResult setModelerGeometry(OdDbEntity* pEnt, const OdModelerGeometry* pGeom);

DBENT_EXPORT OdDbEntityPtr oddbCreateEntity(OdModelerGeometry::geomType type, OdModelerGeometry* pBody);
