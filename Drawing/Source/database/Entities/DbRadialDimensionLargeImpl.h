...
class OdDbRadialDimensionLargeImpl : public OdDbDimensionImpl
{
  static OdDbRadialDimensionLargeImpl* getImpl(const OdDbRadialDimensionLarge *pObj)
  { return (OdDbRadialDimensionLargeImpl*)OdDbSystemInternals::getImpl(pObj);}
...
public:
  ...
  OdDbRadialDimensionLargeImpl();
  OdUInt8 getDimTypeFlag() { return DimRadialLarge; }

  friend class OdDbRadialDimensionLarge;
