...
class OdDbRadialDimensionImpl : public OdDbDimensionImpl
{
  static OdDbRadialDimensionImpl* getImpl(const OdDbRadialDimension *pObj)
  { return (OdDbRadialDimensionImpl*)OdDbSystemInternals::getImpl(pObj);}

public:
  OdGePoint3d m_DefPointCenter;
  double      m_dLeaderLen;

  OdDbRadialDimensionImpl()
    : m_dLeaderLen(0.0)
  { }

  virtual OdUInt8 getDimTypeFlag() { return OdDbDimensionImpl::DimRadial; }
  ...
  */
  ...
  friend class OdDbRadialDimension;
