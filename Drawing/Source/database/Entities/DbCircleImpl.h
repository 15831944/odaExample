...
class OdDbCircleImpl : public OdDbEntityImpl, public OdDb2dEntityImpl
{
  static OdDbCircleImpl* getImpl(const OdDbCircle *pObj)
  { return (OdDbCircleImpl*)OdDbSystemInternals::getImpl(pObj);}
