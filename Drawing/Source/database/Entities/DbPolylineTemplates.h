...
{
public:
  static OdResult getStartSegmentPoint(const PolyLineType* pThis, OdGePoint3d& pt, OdDbObjectIteratorPtr& pIter, unsigned i )
  {
  ...
  static OdResult getEndSegmentPoint(const PolyLineType* pThis, OdGePoint3d& pt, OdDbObjectIteratorPtr& pIter)
  {
  ...
  static OdResult getLastSegment( const PolyLineType* pThis, OdGePoint3d& pt1, OdGePoint3d& pt2, OdDbObjectIteratorPtr& pIter )
  {
    VertexPtrType pVert;
    pIter->start( false );
  ...
  static OdUInt32 getNumSegments(const PolyLineType* pThis, OdDbObjectIteratorPtr& pIter)
  {
    // pIter must points to start of polyline
    ODA_ASSERT(pIter.get() && !pIter->done());
