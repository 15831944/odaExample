...
class OdDb3PointAngularDimensionImpl : public OdDbDimensionImpl
{
  static OdDb3PointAngularDimensionImpl* getImpl(const OdDb3PointAngularDimension *pObj)
  { return (OdDb3PointAngularDimensionImpl*)OdDbSystemInternals::getImpl(pObj);}
...
public:
  ...
  virtual OdUInt8 getDimTypeFlag() { return OdDbDimensionImpl::Dim3PointAngular; }
  ...
  */
  ...
  friend class OdDb3PointAngularDimension;
