...
class OdDbLineImpl : public OdDbEntityImpl, public OdDb2dEntityImpl
{
  static OdDbLineImpl* getImpl(const OdDbLine *pObj)
  { return (OdDbLineImpl*)OdDbSystemInternals::getImpl(pObj);}
...
public:
  ...
  OdResult transformBy(const OdGeMatrix3d& trans)
  {
    ...
    return OdDb2dEntityImpl::transformBy(trans);
  }
...
private:
  ...
  friend class OdDbLine;
  friend struct OdDbLineTfPE;
};
