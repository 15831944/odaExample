...
class TOOLKIT_EXPORT OdGiFaceStyleImpl : public OdGiFaceStyle
{
public:
  ODRX_DECLARE_MEMBERS(OdGiFaceStyleImpl);
  ...
  // OdCmColor accessors
  //
  OdCmColor& monoColorImpl() { return m_MonoColor; }
...
class TOOLKIT_EXPORT OdGiEdgeStyleImpl : public OdGiEdgeStyle
{
public:
  ODRX_DECLARE_MEMBERS(OdGiEdgeStyleImpl);
  ...
  // OdCmColor accessors
  //
  OdCmColor& edgeColorImpl() { return m_EdgeColor; }
  OdCmColor& silhouetteColorImpl() { return m_SilhouetteColor; }
  OdCmColor& intersectionColorImpl() { return m_IntersectionColor; }
  OdCmColor& obscuredColorImpl() { return m_ObscuredColor; }
...
class TOOLKIT_EXPORT OdGiDisplayStyleImpl : public OdGiDisplayStyle
{
public:
  ODRX_DECLARE_MEMBERS(OdGiDisplayStyleImpl);

  OdGiDisplayStyleImpl();
...
class TOOLKIT_EXPORT OdGiVisualStyleImpl : public OdGiVisualStyle
{
public:
  ODRX_DECLARE_MEMBERS(OdGiVisualStyleImpl);
...
protected:
  OdStaticRxObject<OdGiFaceStyleImpl> m_faceStyle;
  OdStaticRxObject<OdGiEdgeStyleImpl> m_edgeStyle;
  OdStaticRxObject<OdGiDisplayStyleImpl> m_displayStyle;
  ...
  OdCmColor m_clrPencilColor;
  OdInt32 m_nBloomThreshold;
  OdInt32 m_nBloomRadius;
  OdCmColor m_clrTintColor;
