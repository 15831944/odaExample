...
/** Description:
 This class represents *TableGeometry* objects in an OdDbDatabase instance.
...
class DBENT_EXPORT OdDbTableGeometry : public OdDbObject
{
public:

  ODDB_DECLARE_MEMBERS(OdDbTableGeometry);
...
typedef OdSmartPtr<OdDbTableGeometry> OdDbTableGeometryPtr;
