...
class OdDbProxyEntityData : public OdDbObject
{
public:
  ODDB_DECLARE_MEMBERS(OdDbProxyEntityData);
  ...
  */
  ...
  static void applyTo(OdDbEntity* pEnt);
};

typedef OdSmartPtr<OdDbProxyEntityData> OdDbProxyEntityDataPtr;
