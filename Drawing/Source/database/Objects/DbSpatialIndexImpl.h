...
class OdDbSpatialIndexImpl : public OdDbIndexImpl
{
  static OdDbSpatialIndexImpl* getImpl(const OdDbSpatialIndex *pObj)
  { return (OdDbSpatialIndexImpl*)OdDbSystemInternals::getImpl(pObj);}
