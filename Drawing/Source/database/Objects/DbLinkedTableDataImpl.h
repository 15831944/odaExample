...
public:
  ...
  void dxfInLINKEDTABLEDATACOLUMN(OdDbDxfFiler* pFiler);
  void dxfInFORMATTEDTABLEDATACOLUMN(OdDbDxfFiler* pFiler);
  void dxfInTABLECOLUMN(OdDbDxfFiler* pFiler);

  void dxfOutLINKEDTABLEDATACOLUMN(OdDbDxfFiler* pFiler) const;
  void dxfOutFORMATTEDTABLEDATACOLUMN(OdDbDxfFiler* pFiler) const;
  void dxfOutTABLECOLUMN(OdDbDxfFiler* pFiler) const;
...
public: 
  ...
  // but for implementation convenience in  OdDbLinkedTableDataImpl::getCellStyle()
  ...
  void dwgInCONTENTFORMAT(OdDbDwgFiler* pFiler);
  void dwgOutCONTENTFORMAT(OdDbDwgFiler* pFiler) const;

  void dxfIn(OdDbDxfFiler* pFiler);
  void dxfInCONTENT(OdDbDxfFiler* pFiler);
  void dxfInFORMATTEDCELLCONTENT(OdDbDxfFiler* pFiler);

  void dxfOut(OdDbDxfFiler* pFiler) const;
  void dxfOutCONTENT(OdDbDxfFiler* pFiler) const;
  void dxfOutFORMATTEDCELLCONTENT(OdDbDxfFiler* pFiler) const;
};
...
{
public:
  OdDbObjectId m_dataLinkId; // This points to OdDbDataLink.
  OdInt32 m_rows;
  OdInt32 m_cols;
...
public:
  ...
  void dxfIn(OdDbDxfFiler* pFiler);
  void dxfInLINKEDTABLEDATACELL(OdDbDxfFiler* pFiler);
  void dxfInFORMATTEDTABLEDATACELL(OdDbDxfFiler* pFiler);
  void dxfInTABLECELL(OdDbDxfFiler* pFiler);

  void dxfOut(OdDbDxfFiler* pFiler) const;
  void dxfOutLINKEDTABLEDATACELL(OdDbDxfFiler* pFiler) const;
  void dxfOutFORMATTEDTABLEDATACELL(OdDbDxfFiler* pFiler) const;
  void dxfOutTABLECELL(OdDbDxfFiler* pFiler) const;
};
...
public:
  ...
  void dxfIn(OdDbDxfFiler* pFiler);
  void dxfInTABLEFORMAT(OdDbDxfFiler* pFiler);
  void dxfInTABLEROW(OdDbDxfFiler* pFiler);

  void dxfOut(OdDbDxfFiler* pFiler) const;
  void dxfOutTABLEFORMAT(OdDbDxfFiler* pFiler) const;
  void dxfOutTABLEROW(OdDbDxfFiler* pFiler) const;
};

typedef OdArray<OdRowData>  OdTableData;
typedef OdArray<OdColumnData>  OdTableColumnsData;

class OdDbLinkedTableDataImpl : public OdDbLinkedDataImpl
{
public:
  static OdDbLinkedTableDataImpl* getImpl(const OdDbLinkedTableData *pObj)
  { return (OdDbLinkedTableDataImpl*)OdDbSystemInternals::getImpl(pObj); }

public:
  OdDbLinkedTableDataImpl();

  OdDbObjectId m_tableStyleId;
  ...
  // The fields contain a collection of all fields (OdDbField) that are part of
  // all cell contents (OdCellContent::m_id in case it represents a field).
  OdArray<OdDbObjectId> m_fields;

  OdCellStyle m_tableStyleData;
  OdCellRangeArray m_mergeData;
  OdArray<OdDbObjectId> m_FieldsExpr;
...
public:
  ...
  const OdString cellStyle(OdInt32 nRow, OdInt32 nCol, bool impl = true );
  ...
  void copyFrom(const OdDbLinkedTableData* pSrc, OdDb::TableCopyOption nOption, 
    ...
    OdCellRange* pNewTargetRange = NULL, OdDbLinkedTableData* pTag = NULL);
  ...
  void resize(const OdCellRange& srcRange, const OdCellRange& targetRange, OdDbLinkedTableData* pTag);
  ...
  void attributeCheck(OdInt32 nRow, OdInt32 nCol);
