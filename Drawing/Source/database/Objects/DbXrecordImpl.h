...
class OdDbXrecordImpl : public OdDbObjectImpl
{
  static OdDbXrecordImpl* getImpl(const OdDbXrecord *pObj)
  { return (OdDbXrecordImpl*)OdDbSystemInternals::getImpl(pObj);}
...
public:
  ...
  OdResult appendRbChain(const OdResBuf* pRb, OdDbDatabase* pDb);
  
  virtual void decomposeForSave(OdDbObject *pObj, OdDb::SaveType format, OdDb::DwgVersion ver);
