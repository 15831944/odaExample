...
class OdDbModelDocViewStyleImpl : public OdDbObjectImpl
{
  static OdDbModelDocViewStyleImpl* getImpl(const OdDbModelDocViewStyle* pObj)
  { 
    return (OdDbModelDocViewStyleImpl*) OdDbSystemInternals::getImpl(pObj);
  }
protected:
  OdDbModelDocViewStyleImpl();
  ...
  OdResult setViewLabelPattern(OdDbModelDocViewStyle* pOwner, OdString& oldPattern, const OdString& newPattern, const OdDbField* pField); //to avoid using of duplicate code in Section and DetailViewStyle

  friend  class OdDbModelDocViewStyle;
