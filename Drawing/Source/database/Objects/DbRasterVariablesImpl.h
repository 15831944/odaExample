...
class OdDbRasterVariablesImpl : public OdDbObjectImpl
{
  static OdDbRasterVariablesImpl* getImpl(const OdDbRasterVariables *pObj)
  { return (OdDbRasterVariablesImpl*)OdDbSystemInternals::getImpl(pObj);}
...
public:
  OdDbRasterVariablesImpl();

private:
  OdResult dwgInFields(OdDbDwgFiler* pFiler);
  void dwgOutFields(OdDbDwgFiler* pFiler) const;

  friend class OdDbRasterVariables;
};
