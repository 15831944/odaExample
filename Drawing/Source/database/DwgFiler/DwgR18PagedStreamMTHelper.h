...
//----------------------------------------------------------
//
// OdDwgR18PagedStreamMTHelper
//
//----------------------------------------------------------
class OdDwgR18PagedStreamMTHelper : public OdRxObjectImpl<OdStreamBuf>
{
public:
  static inline OdStreamBufPtr create(OdDwgR18PagedStream* pPagedStream, OdDwgFileLoader* pLoader, int threadId)
  {
    return OdStreamBufPtr((OdStreamBuf*)new OdDwgR18PagedStreamMTHelper(pPagedStream, pLoader, threadId), kOdRxObjAttach);
  }
  OdDwgR18PagedStreamMTHelper(OdDwgR18PagedStream* pPagedStream, OdDwgFileLoader* pLoader, int threadId)
    : m_curPosInPage(0)
...
protected:
  OdDwgR18PagedStream* m_pPagedStream;
  OdDwgFileLoader* m_pLoader;
  int m_threadId;
  OdDwgR18PagedStream::OdPageArrayIterator m_curPage;
  ...
  void getPage()
  {
    ...
    OdDwgR18FileLoader::R18MTContext* pR18MTContext = (OdDwgR18FileLoader::R18MTContext*)m_pLoader->getMTContext();
    OdBinaryData& pageData = pR18MTContext->m_buffs[m_threadId];
    OdDwgR18Compressor& cmpr =  pR18MTContext->m_compressors[m_threadId];
