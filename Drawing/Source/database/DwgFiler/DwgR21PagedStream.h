...
//
//----------------------------------------------------------
class OdDwgR21PagedStream : public OdStreamBuf
{
// ODA_MT_DBIO_BEGIN
  // OdArray<OdMutex> can not be copied safely
  OdDwgR21PagedStream(const OdDwgR21PagedStream&);
  OdDwgR21PagedStream& operator = (const OdDwgR21PagedStream&);
// ODA_MT_DBIO_END
public:
  OdDwgR21PagedStream();
  ~OdDwgR21PagedStream();
  ...
  void openW();
  void setController(OdDwgR21FileController* pController) { m_pController = pController; }
  ...
  //
  static inline void decode(OdUInt8* dst, OdUInt8* src, OdUInt32 dstSize, OdUInt32 factor, OdRSCoder& rscoder);
  static inline void encode(OdUInt8* dst, OdUInt8* src, OdUInt32 srcSize, OdRSCoder& rscoder, OdUInt8* random);
  static inline void encodeRS(OdUInt8* data, OdUInt32 dataSize, OdRSCoder& rscoder, OdUInt8* parity, OdUInt8* random);
  static inline void decodeRS(OdUInt8* data, OdUInt32 dataSize, OdRSCoder& rscoder, OdUInt8* parity, OdUInt8* random);
...
// ODA_MT_DBIO_BEGIN
  ...
  void getPage(Page& page, OdBinaryData& pageData, OdBinaryData& decData, OdDwgR21Compressor& cmpr);
// ODA_MT_DBIO_END
...
private:
  ...
  OdDwgR21FileController* m_pController;
};

typedef OdSmartPtr<OdDwgR21PagedStream> OdDwgR21PagedStreamPtr;

//----------------------------------------------------------
//
// OdRSCoder inline methods
//
//----------------------------------------------------------
inline
void OdRSCoder::encode(OdUInt8* data, OdUInt8* parity)
{
...
inline
void OdRSCoder::decode(OdUInt8* data)
{
  // Cache indexes
...
//----------------------------------------------------------
inline
OdUInt64 OdDwgR21PagedStream::curPos()
{ 
...
inline
void OdDwgR21PagedStream::nextPageR()
{
...
inline
void OdDwgR21PagedStream::nextPageW()
{
  ODA_ASSERT(m_curPage == m_pages.end());
...
inline
void encodeBlock(OdUInt8* dst, OdUInt8* src, OdUInt8* parity, OdUInt32 factor, OdRSCoder& rscoder)
{
...
inline
void OdDwgR21PagedStream::encode(OdUInt8* dst, OdUInt8* src, OdUInt32 srcSize, OdRSCoder& rscoder, OdUInt8* random)
{
...
inline
void OdDwgR21PagedStream::decode(OdUInt8* dst, OdUInt8* src, OdUInt32 dstSize, OdUInt32 factor, OdRSCoder& rscoder)
{
...
// 
// CrcR is a reflected 64-bit CRC
//
struct CrcR
{
  static inline void calc1(OdUInt8* p, OdUInt64& crc)
...
{
  bool operator()(const OdDwgR21PagedStream::Page& page1, const OdDwgR21PagedStream::Page& page2) const
  {
