...
// DwgInController.h: interface for the OdDwgInController class.
//
//////////////////////////////////////////////////////////////////////
...
//
template<class T>
OdUInt32 loadSectionsMap(T* pIo, OdDwgFileSectionsInfo& secInfo)
{
  ODA_TRACE0("-----------------------------------\nRead File Sections:\n");
...
// Support funcs
//
void rdHandleRecord(OdDbDwgFiler& io, OdUInt8& nKey, OdUInt64& nHandle);
void correctRootDictionary(OdDbDatabase* pDatabase);

class OdDbHeaderLoadInfo
{
public:
  void loadR14Dimblk(OdDbDatabase* pDb);
  OdString m_strBlk;
  OdString m_strBlk1;
  OdString m_strBlk2;
};
...
//
//
class DBIO_EXPORT OdDwgInController : public OdDwgFileController
{
public:
  ODRX_DECLARE_MEMBERS(OdDwgInController);
  OdDwgInController();
...
protected:
  ...
  OdResult turnToOriginalObject(OdDbObject* pProxyObj);

  OdDbHeaderLoadInfo m_LoadInfo;
};
