...
class TOOLKIT_EXPORT OdDwgStream : public OdDbDwgFiler
{
  // state
  bool              m_bWrite;
...
public:
  ODRX_DECLARE_MEMBERS(OdDwgStream);
  OdDwgStream();
  virtual ~OdDwgStream();
  ...
  virtual FilerType     filerType() const { return OdDbFiler::kCopyFiler; }
  ...
  virtual OdDbObjectId  rdObjectId(OdDb::ReferenceType* pRefType = NULL);
...
typedef OdSmartPtr<OdDwgStream> OdDwgStreamPtr;
...
class TOOLKIT_EXPORT OdDwgR21Stream : public OdDwgStream
{
public:
  OdDwgR21Stream() {}
...
inline
void OdDwgStream::curtailEndBit(OdUInt64 endBit)
{
...
inline
void* OdDwgStream::internalRdPointer()
{
  void* res;
...
inline
void OdDwgStream::internalWrPointer(void* val)
{
  wrBytes(&val, sizeof(val));
}

inline
bool OdDwgStream::internalEof()
{
  return (internalTell() >= m_nStreamEndBit);
}

inline
void OdDwgStream::internalOpen(OdBinaryData* pBuffer)
{
...
inline
void OdDwgStream::move_to_next_bit()
{
  m_mask >>= 1;
  ++m_nBitPos;
  if(!m_mask)
...
inline
void OdDwgStream::move_to_next_bit_w()
{
  m_mask >>= 1;
  ++m_nBitPos;
  if(!m_mask)
...
inline
OdUInt32 OdDwgStream::internalRdUInt2()
{
...
inline
OdUInt32 OdDwgStream::internalRdUInt3()
{
...
inline
OdUInt32 OdDwgStream::internalRdUInt8()
{
...
inline
void OdDwgStream::internalWrUInt2(OdUInt8 nValue)
{
  if ((nValue & 2) != 0)
...
inline
void OdDwgStream::internalWrUInt3(OdUInt8 nValue)
{
  if ((nValue & 4) != 0)
    m_pBuffer->at(m_nByte) |= m_mask;
  else
...
inline
void OdDwgStream::internalWrUInt8(OdUInt8 nValue)
{
...
inline
OdUInt16 OdDwgStream::internalRdUInt16()
{
...
inline
OdUInt32 OdDwgStream::internalRdUInt32()
{
...
inline
void OdDwgStream::internalWrUInt16(OdUInt16 val)
{
...
inline
void OdDwgStream::internalWrUInt32(OdUInt32 val)
{
...
inline
void OdDwgStream::internalWrInt64(const OdInt64& val)
{
...
inline
OdUInt64 OdDwgStream::internalRdUInt64()
{
...
inline
OdUInt64 OdDwgStream::internalTell() const
{
  ODA_ASSERT(m_mask);
