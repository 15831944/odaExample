...
//
//----------------------------------------------------------
class OdDwgR21FileLoader : public OdDwgFileLoader,
                           public OdDwgR21FileController
{
public:
  ODRX_DECLARE_MEMBERS(OdDwgR21FileLoader);
  OdDwgR21FileLoader();
  ...
  // OdDbFilerController overridden
...
private:
  ...
  virtual void setPassword(const OdPassword& pass){OdDwgR21FileController::setPassword(pass);}
protected:
...
public:
  ...
  public:
    ...
    OdArray<OdDwgR21Compressor> m_compressors;
  };
protected:
  // OdDwgFileLoader overridden
