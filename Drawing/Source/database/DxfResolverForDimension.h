...
protected:
  ...
  DxfLoadResolverForDimension(OdDbObjectId id, OdString name)
...
public:
  static DxfLoadResolverPtr createObject(OdDbObjectId id, OdString name)
  {
  ...
  virtual void resolve()
  {
    if (!m_id.isErased())
    {
      OdDbDimensionPtr pEnt = m_id.safeOpenObject(OdDb::kForWrite);
      OdDbObjectId id = OdDbSymUtil::getBlockId(m_blockName, pEnt->database());
