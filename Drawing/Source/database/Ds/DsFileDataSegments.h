...
namespace OdDs
{
  ...
  public:
    DataBlobEntryReference()
      ...
      , m_lastPageSize(0)
    {}
    DataBlobEntryReference(OdDbDwgFiler* pFiler)
    {
      read(pFiler);
    }
    void read(OdDbDwgFiler* pFiler)
  ...
  public:
    ...
    DataRecordHeader(OdDbDwgFiler* pFiler)
    {
      read(pFiler);
    }
    ...
    OdResult read(OdDbDwgFiler* pFiler)
    {
  ...
  public:
    ...
    void read(OdDbDwgFiler* pFiler, FileController* pFileController, const OdUInt32Array& entryIndexes);
    void write(OdDbDwgFiler* pFiler);
    void readRecordData(OdDbDwgFiler* pFiler, OdUInt32 entryIndex, OdUInt32 maxRawSize, FileController* pFileController, const OdUInt32Array& entryIndexes);
  ...
  public:
    ...
    void read(OdDbDwgFiler* pFiler);
    void write(OdDbDwgFiler* pFiler);
    void write(OdDbDwgFiler* pFiler, const OdUInt8* pData, OdUInt32 dataSize);
