...
protected:
  ...
  DxfLoadResolverForCPConvertion(OdDbObjectId id)
    : OdRxObjectImpl<DxfLoadResolver>()
    , m_id(id)
  {}

public:
  static DxfLoadResolverPtr createObject(OdDbObjectId id)
  {
  ...
  virtual void resolve()
  {
    if (!m_id.isErased())
    {
      OdDbEntityPtr pEnt = m_id.safeOpenObject(OdDb::kForWrite);
      OdDbEntityImpl* pImpl = OdDbEntityImpl::getImpl(pEnt);
