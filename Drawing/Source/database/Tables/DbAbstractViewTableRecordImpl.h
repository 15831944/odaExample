...
class OdDbAbstractViewTableRecordImpl : public OdDbSymbolTableRecordImpl, 
                                        public OdViInfo
{
  static OdDbAbstractViewTableRecordImpl* getImpl(const OdDbAbstractViewTableRecord *pObj)
  { return (OdDbAbstractViewTableRecordImpl*)OdDbSystemInternals::getImpl(pObj);}

  bool m_bUcsSavedWithViewport;
  virtual bool isModelView() const;
public:
  OdDbAbstractViewTableRecordImpl();
...
private:
  OdResult dwgInFields(OdDbDwgFiler* pFiler)
  {
    ...
    return OdViInfo::dwgInFields(pFiler);
  }
  void dwgOutFields(OdDbDwgFiler* pFiler) const
  {
	  pFiler->wrDouble(getViewHeight());
	  pFiler->wrDouble(m_dViewWidth);
    OdViInfo::dwgOutFields(pFiler);
  }

  friend class OdDbAbstractViewTableRecord;
};
