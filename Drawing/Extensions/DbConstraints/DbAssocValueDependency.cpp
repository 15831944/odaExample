...
OdResult OdDbAssocValueDependency::getDependentOnObjectCachedValue(OdDbEvalVariantPtr& cachedValue) const
{
  assertReadEnabled();
  return ((OdDbImpAssocValueDependency*)m_pImpObj)->getDependentOnObjectCachedValue(cachedValue);
}
