...
OdResult OdDbAssocMLeaderActionBody::createInstance(OdDbFullSubentPathArray &entPathArray,
                                                    const OdDbObjectId bodyId1,
                                                    OdGePoint3dArray &ptsSelected, const OdString mText,
                                                    OdDbObjectId& actionBodyId)
{
  return OdDbImpAssocMLeaderActionBody::createInstance(entPathArray, bodyId1,
