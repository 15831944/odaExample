...
OdResult OdConstrainedGeometry::init(OdDbObjectId geomDependencyId)
{
...
OdResult OdConstrainedBoundedLine::init(OdDbObjectId depId, bool bRay)
{
...
OdResult OdConstrainedSpline::init(OdDbObjectId depId, const OdGeNurbCurve3d& spline)
{
...
OdGeMatrix3d OdConstrainedRigidSet::originalTransform() const
{
  return ((OdConstrainedRigidSetImpl*)m_pImpl)->originalTransform();
}
