...
OdSmartPtr<OdDbAssocGeomDependency> OdDbAssocGeomDependency::createObject( OdDbObjectId objId, OdDbSubentId subId )
{
    ...
    compoundObjectId.set( objId );
    pDep->attachToObject( compoundObjectId );
...
OdResult OdDbAssocGeomDependency::createNewEdgePersSubent(OdDbEntity* pEntity, OdDbAssocAction* pAction, OdUInt32& subentIndex)//, bool bPolylineGeometry)
{
  assertReadEnabled();
