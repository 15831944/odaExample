...
ODRX_NO_CONS_DEFINE_MEMBERS_ALTNAME(OdDbAssocVariableValueProviderPE, OdDbAssocValueProviderPE, L"AcDbAssocVariableValueProviderPE");
...
bool OdDbAssocVariable::isAnonymous() const {
  OdString n = name();
  return (n.isEmpty() || n[0]=='*');
}
...
{
  assertWriteEnabled();
  return ((OdDbImpAssocVariable*)m_pImpObj)->setValue(this, newValue);
}
