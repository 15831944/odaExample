...
public:
  ...
  */
  OdResult init(OdDbObjectId geomDependencyId);
...
public:
  ...
  */
  OdResult init(OdDbObjectId depId, bool bRay);
...
public:
  ...
  */
  virtual OdResult init(OdDbObjectId depId, const OdGeNurbCurve3d& spline);
