...
#include "OdDbAssocRegionPersSubentIdPE.h"
#include "OdDbAssocBodyPersSubentIdPE.h"
...
// ODRX_NO_CONS_DEFINE_MEMBERS(OdDbAssocActionModule, OdRxModule);
...
class DbConstraints_Module : public OdDbAssocActionModule {
  OdRxModulePtr m_pEntsModule;

public:
  virtual bool autoEvaluationEnabled() const { return isEditorReactorAttached(); }
  virtual void enableAutoEvaluation(bool bEnable = true) {
    if (isEditorReactorAttached() != bEnable) {
      if (bEnable)
        attachEditorReactor();
      else
        detachEditorReactor();
  ...
  void initApp() {
    m_pEntsModule = ::odrxSafeLoadApp(OdDbEntitiesAppName);
    ::odrxSafeLoadApp(Od3DSolidHistoryTxModuleName);
    ///////////////////////////////
    ...
    OdDbAssoc2dPolylinePersSubentIdPE::rxInit();
    OdDbAssoc3dPolylinePersSubentIdPE::rxInit();
    OdDbAssocAsmBasedPersSubentIdPE::rxInit();
    ...
    OdDbAssocRegionPersSubentIdPE::rxInit();
    OdDbAssocBodyPersSubentIdPE::rxInit();
    OdDbAssocTextPersSubentIdPE::rxInit();
    OdDbAssocMTextPersSubentIdPE::rxInit();
    ...
    OdDb2dPolyline::desc()->addX(OdDbAssocPersSubentIdPE::desc(), &_assoc2dPolylinePersSubentIdPE);
    OdDb3dPolyline::desc()->addX(OdDbAssocPersSubentIdPE::desc(), &_assoc3dPolylinePersSubentIdPE);
    ...
    OdDbAssocNetCloneCtx::rxInit();
    OdDbAssocNetCloneCtx::createAssocNetworkCloneReactors();
    ...
    OdDbRegion::desc()->addX(OdDbAssocPersSubentIdPE::desc(), &_assocRegionPersSubentIdPE);
    OdDbBody::desc()->addX(OdDbAssocPersSubentIdPE::desc(), &_assocBodyPersSubentIdPE);
    OdDbText::desc()->addX(OdDbAssocPersSubentIdPE::desc(), &_assocTextPersSubentIdPE);
    OdDbMText::desc()->addX(OdDbAssocPersSubentIdPE::desc(), &_assocMTextPersSubentIdPE);
  ...
  void uninitApp()
  {
    ...
    OdDbAssocNetCloneCtx::deleteAssocNetworkCloneReactors();
    OdDbAssocNetCloneCtx::rxUninit();
    OdDbAssocVariable::desc()->delX(OdDbAssocValueProviderPE::desc());

    OdDbMText::desc()->delX(OdDbAssocPersSubentIdPE::desc());
    OdDbText::desc()->delX(OdDbAssocPersSubentIdPE::desc());
    ...
    OdDb3dPolyline::desc()->delX(OdDbAssocPersSubentIdPE::desc());
    OdDb2dPolyline::desc()->delX(OdDbAssocPersSubentIdPE::desc());
    OdDbPolyline::desc()->delX(OdDbAssocPersSubentIdPE::desc());
    OdDbBody::desc()->delX(OdDbAssocPersSubentIdPE::desc());
    OdDbRegion::desc()->delX(OdDbAssocPersSubentIdPE::desc());
    ...
    OdDbAssocMTextPersSubentIdPE::rxUninit();
    OdDbAssocTextPersSubentIdPE::rxUninit();
    ...
    OdDbAssocBodyPersSubentIdPE::rxUninit();
    OdDbAssocRegionPersSubentIdPE::rxUninit();
    OdDbAssocSurfacePersSubentIdPE::rxUninit();
    OdDbAssoc3dSolidPersSubentIdPE::rxUninit();
    OdDbAssocAsmBasedPersSubentIdPE::rxUninit();
    OdDbAssoc3dPolylinePersSubentIdPE::rxUninit();
    OdDbAssoc2dPolylinePersSubentIdPE::rxUninit();
...
private:
  ...
  OdStaticRxObject<OdDbAssoc2dPolylinePersSubentIdPE> _assoc2dPolylinePersSubentIdPE;
  OdStaticRxObject<OdDbAssoc3dPolylinePersSubentIdPE> _assoc3dPolylinePersSubentIdPE;
  ...
  OdStaticRxObject<OdDbAssocRegionPersSubentIdPE> _assocRegionPersSubentIdPE;
  OdStaticRxObject<OdDbAssocBodyPersSubentIdPE> _assocBodyPersSubentIdPE;
  OdStaticRxObject<OdDbAssocTextPersSubentIdPE> _assocTextPersSubentIdPE;
  OdStaticRxObject<OdDbAssocMTextPersSubentIdPE> _assocMTextPersSubentIdPE;
  ...
  struct OdDbConstraintsInterfacePEImpl : OdStaticRxObject < OdDbConstraintsInterfacePE >
  {
    ...
    virtual OdResult setAssocVariableValue(const OdDbObject* pObject, OdDbObjectId blockId, const OdResBuf* value) ODRX_OVERRIDE
    {
      ...
      const OdString expr = OdExpression::createExpression(OdDbEvalVariant::init(*value));
      v->upgradeOpen();
      v->setExpression(expr, OdString::kEmpty, false, false);

      //Force reactors notification to dependent objects, because it doesn't happen if there is an active transaction
      v->xmitPropagateModify();
