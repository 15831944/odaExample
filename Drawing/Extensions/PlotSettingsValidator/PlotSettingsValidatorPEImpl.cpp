...
OdResult OdPlotSettingsValidatorPEImpl::getPlotStyleSheetList(OdArray<OdString> &pPlotStyleSheetList, OdDbBaseDatabase *pDb)
{
  OdDbBaseDatabasePEPtr dbPE = pDb;
  getPlotStyleSheetList(pPlotStyleSheetList, !dbPE.isNull() ? dbPE->appServices(pDb) : NULL);

  if(!pDb)
    return eOk;

  OdString hostFileName = dbPE->getFilename(pDb);
  hostFileName.replace(oldPathChar, pathChar);
  hostFileName = hostFileName.left(hostFileName.reverseFind(pathChar) + 1);

#if defined(OD_WINDOWS_DESKTOP)
  findFilesByPath(hostFileName + OD_T("\\*.ctb"), pPlotStyleSheetList);
  findFilesByPath(hostFileName + OD_T("\\*.stb"), pPlotStyleSheetList);
#else
  findFilesByPath(hostFileName + OD_T("/*.ctb"), pPlotStyleSheetList);
  findFilesByPath(hostFileName + OD_T("/*.stb"), pPlotStyleSheetList);
#endif
...
//    { OD_T("ISO expand A0 (841.00 x 1189.00 MM)")       , OD_T("ISO_expand_A0_(841.00_x_1189.00_MM)")       , 841.0      , 1189.0      , OdDbPlotSettings::kMillimeters , 5. , 10., 5. , 10. } ,
//    { OD_T("ISO A0 (841.00 x 1189.00 MM)")              , OD_T("ISO_A0_(841.00_x_1189.00_MM)")              , 841.0      , 1189.0      , OdDbPlotSettings::kMillimeters , 5. , 17., 5. , 17. } ,
//    { OD_T("ISO expand A1 (841.00 x 594.00 MM)")        , OD_T("ISO_expand_A1_(841.00_x_594.00_MM)")        , 841.0      , 594.0       , OdDbPlotSettings::kMillimeters , 5. , 10., 5. , 10. } ,
//    { OD_T("ISO expand A1 (594.00 x 841.00 MM)")        , OD_T("ISO_expand_A1_(594.00_x_841.00_MM)")        , 594.0      , 841.0       , OdDbPlotSettings::kMillimeters , 5. , 10., 5. , 10. } ,
//    { OD_T("ISO A1 (841.00 x 594.00 MM)")               , OD_T("ISO_A1_(841.00_x_594.00_MM)")               , 841.0      , 594.0       , OdDbPlotSettings::kMillimeters , 5. , 17., 5. , 17. } ,
//    { OD_T("ISO A1 (594.00 x 841.00 MM)")               , OD_T("ISO_A1_(594.00_x_841.00_MM)")               , 594.0      , 841.0       , OdDbPlotSettings::kMillimeters , 5. , 17., 5. , 17. } ,
//    { OD_T("ISO expand A2 (594.00 x 420.00 MM)")        , OD_T("ISO_expand_A2_(594.00_x_420.00_MM)")        , 594.0      , 420.0       , OdDbPlotSettings::kMillimeters , 5. , 10., 5. , 10. } ,
//    { OD_T("ISO expand A2 (420.00 x 594.00 MM)")        , OD_T("ISO_expand_A2_(420.00_x_594.00_MM)")        , 420.0      , 594.0       , OdDbPlotSettings::kMillimeters , 5. , 10., 5. , 10. } ,
//    { OD_T("ISO A2 (594.00 x 420.00 MM)")               , OD_T("ISO_A2_(594.00_x_420.00_MM)")               , 594.0      , 420.0       , OdDbPlotSettings::kMillimeters , 5. , 17., 5. , 17. } ,
//    { OD_T("ISO A2 (420.00 x 594.00 MM)")               , OD_T("ISO_A2_(420.00_x_594.00_MM)")               , 420.0      , 594.0       , OdDbPlotSettings::kMillimeters , 5. , 17., 5. , 17. } ,
//    { OD_T("ISO expand A3 (420.00 x 297.00 MM)")        , OD_T("ISO_expand_A3_(420.00_x_297.00_MM)")        , 420.0      , 297.0       , OdDbPlotSettings::kMillimeters , 5. , 10., 5. , 10. } ,
//    { OD_T("ISO expand A3 (297.00 x 420.00 MM)")        , OD_T("ISO_expand_A3_(297.00_x_420.00_MM)")        , 297.0      , 420.0       , OdDbPlotSettings::kMillimeters , 5. , 10., 5. , 10. } ,
//    { OD_T("ISO A3 (420.00 x 297.00 MM)")               , OD_T("ISO_A3_(420.00_x_297.00_MM)")               , 420.0      , 297.0       , OdDbPlotSettings::kMillimeters , 5. , 17., 5. , 17. } ,
//    { OD_T("ISO A3 (297.00 x 420.00 MM)")               , OD_T("ISO_A3_(297.00_x_420.00_MM)")               , 297.0      , 420.0       , OdDbPlotSettings::kMillimeters , 5. , 17., 5. , 17. } ,
//    { OD_T("ISO expand A4 (297.00 x 210.00 MM)")        , OD_T("ISO_expand_A4_(297.00_x_210.00_MM)")        , 297.0      , 210.0       , OdDbPlotSettings::kMillimeters , 5. , 10., 5. , 10. } ,
//    { OD_T("ISO expand A4 (210.00 x 297.00 MM)")        , OD_T("ISO_expand_A4_(210.00_x_297.00_MM)")        , 210.0      , 297.0       , OdDbPlotSettings::kMillimeters , 5. , 10., 5. , 10. } ,
//    { OD_T("ISO A4 (297.00 x 210.00 MM)")               , OD_T("ISO_A4_(297.00_x_210.00_MM)")               , 297.0      , 210.0       , OdDbPlotSettings::kMillimeters , 5. , 17., 5. , 17. } ,
//    { OD_T("ISO A4 (210.00 x 297.00 MM)")               , OD_T("ISO_A4_(210.00_x_297.00_MM)")               , 210.0      , 297.0       , OdDbPlotSettings::kMillimeters , 5. , 17., 5. , 17. } ,
