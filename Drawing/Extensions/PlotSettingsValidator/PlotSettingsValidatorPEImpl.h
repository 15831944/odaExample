...
public:
  ...
  */
  ...
  /** \details
    ...
    Note : if pDb is NULL, OdRxSystemServices::getEnvVar() will be called.
  */
  virtual OdResult getPlotStyleSheetList(OdArray<OdString> &plotStyleSheetList, OdDbBaseDatabase *pDb);
