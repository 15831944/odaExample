...
///////////////////////////////////////////////////////////////////////////////
#ifndef _ODA_OBJPROP_INCLUDED_
#define _ODA_OBJPROP_INCLUDED_
#include "ExFieldEvaluator.h"

class OdObjPropEvaluator : public OdEvaluatorBase 
{
public:
  ODRX_DECLARE_MEMBERS(OdObjPropEvaluator);
  OdObjPropEvaluator();
