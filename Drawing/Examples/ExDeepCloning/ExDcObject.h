...
#ifndef _EXDCOBJECT_INCLUDED_
#define _EXDCOBJECT_INCLUDED_

#include "ExCustObject.h"
#include "ExDeepCloningExport.h"

class EXDEEPCLONING_EXPORT ExDcObject : public ExCustObject
{
public:
  ODDB_DECLARE_MEMBERS(ExDcObject);
...
typedef OdSmartPtr<ExDcObject> ExDcObjectPtr;

#endif // _EXDCOBJECT_INCLUDED_
