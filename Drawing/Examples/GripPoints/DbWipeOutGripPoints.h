...
#ifndef _ODDBWIPEOUTGRIPPOINTS_INCLUDED
#define _ODDBWIPEOUTGRIPPOINTS_INCLUDED

#include "DbGripPoints.h"

class OdDbWipeOutGripPointsPE : public OdDbGripPointsPE
{
public:
...
#endif // _ODDBWIPEOUTGRIPPOINTS_INCLUDED
