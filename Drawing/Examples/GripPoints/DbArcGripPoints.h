...
#ifndef _ODDBARCGRIPPOINTS_INCLUDED
#define _ODDBARCGRIPPOINTS_INCLUDED
...
//  virtual OdResult moveGripPointsAt( OdDbEntity* pEntity, const OdDbVoidPtrArray& gripAppData, const OdGeVector3d& offset, int bitFlags );
...
#endif //_ODDBARCGRIPPOINTS_INCLUDED
