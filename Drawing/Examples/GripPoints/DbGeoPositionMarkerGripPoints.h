...
#ifndef _ODDBGEOPOSITIONMARKERGRIPPOINTS_INCLUDED
#define _ODDBGEOPOSITIONMARKERGRIPPOINTS_INCLUDED

#include "DbGripPoints.h"

/************************************************************************/
/* This class is an implementation of the OdDbGripPointsPE class for    */
/* OdDbGeoPositionMarker entities.                                      */
/************************************************************************/
class OdDbGeoPositionMarkerPE : public OdDbGripPointsPE
{
public:
...
#endif //_ODDBGEOPOSITIONMARKERGRIPPOINTS_INCLUDED
