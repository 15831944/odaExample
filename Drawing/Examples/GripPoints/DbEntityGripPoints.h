...
#ifndef _ODDBENTITYGRIPPOINTS_INCLUDED
#define _ODDBENTITYGRIPPOINTS_INCLUDED

#include "DbGripPoints.h"

class OdDbEntityGripPointsPE : public OdDbGripPointsPE
{
public:
...
#endif // _ODDBENTITYGRIPPOINTS_INCLUDED
