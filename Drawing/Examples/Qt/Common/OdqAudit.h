...
#ifndef __ODA_QT_AUDIT__H__
#define __ODA_QT_AUDIT__H__

#include "OdaCommon.h"
#include "DbHandle.h"
#include "DbAudit.h"

class OdqAuditInfo : public OdDbAuditInfo
{
  OdRxObject* m_pRxDatabase;

public:
  OdqAuditInfo(OdRxObject* pRxDatabase);
  virtual ~OdqAuditInfo();
  ...
  // is virtual to get access without linking only
  virtual OdRxObject* baseDatabase();
};

typedef OdSmartPtr<OdqAuditInfo> OdqAuditInfoPtr;

#endif //__ODA_QT_AUDIT__H__
