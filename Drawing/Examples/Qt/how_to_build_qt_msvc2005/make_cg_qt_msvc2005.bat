...
xcopy /S /Y make_vcproj.bat %DEST%\OdaQtOpenRL\*.* >nul:
pushd %DEST%\OdaQtOpenRL
...
call make_vcproj OdaQtOpenRLDebug %PRJDEST%\
...
call make_vcproj OdaQtOpenRLRelease %PRJDEST%\

popd 
del %DEST%\OdaQtOpenRL\make_vcproj.bat
