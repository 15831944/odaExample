...
class ExCommandsModule : public OdRxModule
{
#define CMD_DEF(CmdName, GroupName) \
...
#undef CMD_DEF
  ...
  OdStaticRxObject<CreateSurfaceCommand> m_CreateSurface;
  OdStaticRxObject<ToPolylineCommand> m_ToPolyline;
  OdStaticRxObject<ConvToMeshCommand> m_ConvToMesh;
  OdStaticRxObject<ExtrudeConnectedFacesCommand> m_extrudeMesh;
  OdStaticRxObject<ExtrudeSelectedFaces> m_extrudeSelectedFaces;
