...
#ifndef __OD_GI_CONVEYOR_GEOMETRY_DUMPER__
#define __OD_GI_CONVEYOR_GEOMETRY_DUMPER__

#include "SharedPtr.h"
#include "Gi/GiGeometrySimplifier.h"
#include "GiDumper.h"

typedef bool OdDumpFilterFunc(const class OdGiBaseVectorizer* pBaseVectorizer);
...
class OdGiConveyorGeometryDumper : public OdGiGeometrySimplifier
{
  ...
  OdDumpFilterFunc* m_pDumpFilterFunc;
  class OdGiBaseVectorizer* m_pBaseVectorizer;
  bool isEnabledByDumpFiler();
public:
  enum 
  {
  ...
  void setDumpFilter(OdDumpFilterFunc* pFilter, OdGiBaseVectorizer* pBaseVectorizer);
  ...
  /**********************************************************************/
  /* The client's version of this function will not be called in        */
  /* the current version of ODA Drawings                                */
  /**********************************************************************/
...
#endif // __OD_GI_CONVEYOR_GEOMETRY_DUMPER__
