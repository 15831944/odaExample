...
public:
  ...
  /**********************************************************************/
  /* Called by the ODA Drawings vectorization framework to update       */
...
public:
  ...
  /* vectorization.                                                     */
  /**********************************************************************/
  // Returning constant value for all cases is not a good idea. The
  // function is commented to call base class 'deviation' that calculates 
  // it via pixel size
  /*double deviation(const OdGiDeviationType, const OdGePoint3d&) const
  {
    // to force the ODA vectorization framework to use some reasonable value.
    return 0.000001; 
  }*/
