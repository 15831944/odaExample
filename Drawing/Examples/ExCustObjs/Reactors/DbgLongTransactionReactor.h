...
#ifndef _DbgLongTransactionReactor_h_Included_
#define _DbgLongTransactionReactor_h_Included_

#include "ApLongTransactions.h"

class OdDbgLongTransactionReactor : public OdApLongTransactionReactor
{ 
  void dumpTransaction(OdDbLongTransaction& tr);
public:
...
#endif // _DbgLongTransactionReactor_h_Included_
