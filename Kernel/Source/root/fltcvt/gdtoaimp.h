 ...
 *	of 32-bit ints of fractions bits (starting with the most
...
// ODA_GDTOA_CHANGES_BEGIN
//  The next defines are not used in ODA Platform implementation:
// 
...
//#endif
#ifdef DEBUG
#define Bug(x) { ODA_TRACE1("%s\n", x); ODA_FAIL(); }
#endif
// ODA_GDTOA_CHANGES_END
...
//#endif
#define MALLOC odrxAlloc
#define FREE odrxFree
// ODA_GDTOA_CHANGES_END
