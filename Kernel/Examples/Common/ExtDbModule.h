...
public:
  ...
  virtual bool isPerspective(OdRxObject* pRxDatabase, OdGsDevice* pGsDevice= NULL) = 0;
  virtual bool setPerspective(OdRxObject* pRxDatabase, bool bVal) = 0;
...
inline OdString getExtDbModuleName(OdRxObject* pRxDatabase)
{
  ...
  OdExtDbUtils::DbType dbType = OdExtDbUtils::getProduct(pRxDatabase);
  switch (dbType)
  {
  case OdExtDbUtils::kDbDwg: return OdString::kEmpty;
  case OdExtDbUtils::kDbDgn: return L"TD_DgnDb.tx";
  case OdExtDbUtils::kDbBim: return L"TD_BimDb.tx";
  case OdExtDbUtils::kDbDwf: return L"TD_DwfDb.tx";
  case OdExtDbUtils::kDbPrc: return L"TD_PrcDb.tx";
  case OdExtDbUtils::kDbIfc: return L"TD_IfcDb.tx";
  }
  ODA_FAIL_ONCE(); // TODO
  return OdString::kEmpty;
}
