...
int startFromMessage(const OdString message)
{
  int firstID = 0;
  if (!dumpAll)
  {
...
void processBrep(const OdBrBrep& aBrep)
{
  ...
  bct.setBrep(aBrep);
  int complexNum = 0;
  int firstID = startFromMessage(L"Start at which Complex (0 to start with first): ");
...
void processBrepToEdgeOnly(const OdBrBrep& aBrep)
{
  ...
  int firstID = startFromMessage(L"Start at which Edge (0 to start with first): ");
  OdBrEdge edg;
...
void processBrepToFaceOnly(const OdBrBrep& aBrep)
{
  ...
  int firstID = startFromMessage(L"Start at which Face (satfile ID; 0 to start with first): ");
  /**********************************************************************/
...
void processBrepToShellOnly(const OdBrBrep& aBrep)
{
  ...
  int firstID = startFromMessage(L"Start at which Shell (satfile ID; 0 to start with first): ");
  /**********************************************************************/
...
void processBrepToVertexOnly(const OdBrBrep& aBrep)
{
  ...
  int firstID = startFromMessage(L"Start at which Vertex (0 to start with first): ");
  /**********************************************************************/
