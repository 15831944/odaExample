...
/************************************************************************/
/* Dump the specified circle                                           */
/************************************************************************/
void dumpCircle(OdGeCircArc3d* circle)
{
  if (circle == NULL)
  {
    std::cerr << "NULL circle!\n";
    return;
  }
  std::cout << "(C,u,n,r) = (";
  OdGePoint3d C = circle->center();
  std::cout << "(" << C.x << ", " << C.y << ", " << C.z << "), ";
  OdGeVector3d u = circle->refVec();
  OdGeVector3d n = circle->normal();
  std::cout << "(" << u.x << ", " << u.y << ", " << u.z << "), ";
...
/************************************************************************/
bool edgeSearch(OdBrBrep& aBrep, int edgeNum)
{
...
/************************************************************************/
bool faceSearch(OdBrBrep& aBrep, int faceNum)
{
...
void reportEdgeAdjacencies(OdBrEdge edg)
{
  ...
  switch (type)
  {
    ...
    case OdGe::kCircArc3d:
      std::cout << "Edge lies on an circle:\n\t";
      dumpCircle(static_cast<OdGeCircArc3d*>(theCurve));
      break;
...
/************************************************************************/
bool vertexSearch(OdBrBrep& aBrep, int vertexNum)
{
