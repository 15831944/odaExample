...
namespace TD_PDF
{
  namespace PDFOCManager
  {
    ...
    PDFNamePtr PDFEXPORT_TOOLKIT CreateOC4Layer(const OdString& layer_name, PDFDocument& PDFDoc, TD_PDF::PDFResourceDictionaryPtr resource_dict, const bool bVisible, const bool bLocked = false);
    PDFNamePtr PDFEXPORT_TOOLKIT createOCG(const OdString &name, PDFOCConfigurationDictionaryPtr pOCC, const bool bVisible, const bool bLocked, PDFResourceDictionaryPtr pResource);
