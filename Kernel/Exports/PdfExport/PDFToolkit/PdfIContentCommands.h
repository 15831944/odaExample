...
public:
  ...
  virtual void d(PDFArrayPtr dashPattern, OdUInt32 dashPhase) = 0; // Set the line dash pattern
  ...
  virtual void c(double x1, double y1, double x2, double y2, double x3, double y3, bool bToInt = true) = 0;
  ...
  virtual void c(const OdGePoint2d &xy1, const OdGePoint2d &xy2, const OdGePoint2d &xy3, bool bToInt = true) { c(xy1.x, xy1.y, xy2.x, xy2.y, xy3.x, xy3.y, bToInt); }
  ...
  static void drawEllipse(PDFIContentCommands &pICommands, const OdGeEllipArc2d &ellipArc2d, bool bSkipFirstPoint = false, double deviation = 0., bool bToInt = true);
