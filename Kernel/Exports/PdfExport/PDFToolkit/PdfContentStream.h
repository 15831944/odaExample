...
protected:
  ...
  static OdUInt32 format(char* buf, const unsigned int buf_size, OdUInt32 n);

  static OdUInt32 format(char* buf, const unsigned int buf_size,  double d, int cropzeros = CROP_ZEROES_FOR_ALL);
  ...
  static OdUInt32 format(char* buf, const unsigned int buf_size, double d0, double d1, double d2, double d3, int cropzeros = CROP_ZEROES_FOR_ALL);
  static OdUInt32 format(char* buf, const unsigned int buf_size, double d0, double d1, double d2, double d3, double d4, int cropzeros = CROP_ZEROES_FOR_ALL);
  static OdUInt32 format(char* buf, const unsigned int buf_size, double d0, double d1, double d2, double d3, double d4, double d5, int cropzeros = CROP_ZEROES_FOR_ALL);

  inline void format_put_string(char* buf, const unsigned int buf_size, OdUInt32 n)
  {
    OdUInt32 len = PDFContentStream::format(m_format_buf, FORMAT_BUF_LEN, n);
    getStreamData()->putBytes(m_format_buf, len);
  }

  inline void format_put_string(char* buf, const unsigned int buf_size, double d, int cropzeros = CROP_ZEROES_FOR_ALL)
  {
    OdUInt32 len = PDFContentStream::format(m_format_buf, FORMAT_BUF_LEN, d, cropzeros);
    getStreamData()->putBytes(m_format_buf, len);
  }

  inline void format_put_string(char* buf, const unsigned int buf_size, double d0, double d1, int cropzeros = CROP_ZEROES_FOR_ALL)
  {
    OdUInt32 len = PDFContentStream::format(m_format_buf, FORMAT_BUF_LEN, d0, d1, cropzeros);
    getStreamData()->putBytes(m_format_buf, len);
  }

  inline void format_put_string(char* buf, const unsigned int buf_size, double d0, double d1, double d2, int cropzeros = CROP_ZEROES_FOR_ALL)
  {
    OdUInt32 len = PDFContentStream::format(m_format_buf, FORMAT_BUF_LEN, d0, d1, d2, cropzeros);
    getStreamData()->putBytes(m_format_buf, len);
  }

  inline void format_put_string(char* buf, const unsigned int buf_size, double d0, double d1, double d2, double d3, int cropzeros = CROP_ZEROES_FOR_ALL)
  {
    OdUInt32 len = PDFContentStream::format(m_format_buf, FORMAT_BUF_LEN, d0, d1, d2, d3, cropzeros);
    getStreamData()->putBytes(m_format_buf, len);
  }

  inline void format_put_string(char* buf, const unsigned int buf_size, double d0, double d1, double d2, double d3, double d4, int cropzeros = CROP_ZEROES_FOR_ALL)
  {
    OdUInt32 len = PDFContentStream::format(m_format_buf, FORMAT_BUF_LEN, d0, d1, d2, d3, d4, cropzeros);
    getStreamData()->putBytes(m_format_buf, len);
  }

  inline void format_put_string(char* buf, const unsigned int buf_size, double d0, double d1, double d2, double d3, double d4, double d5, int cropzeros = CROP_ZEROES_FOR_ALL)
  {
    OdUInt32 len = PDFContentStream::format(m_format_buf, FORMAT_BUF_LEN, d0, d1, d2, d3, d4, d5, cropzeros);
    getStreamData()->putBytes(m_format_buf, len);
  }

  void putString(const char* val);
  void putString(const char* val, OdUInt32 size);
...
public:
  ...
  virtual void c(double x1, double y1, double x2, double y2, double x3, double y3, bool bToInt = true);
...
public:
  ...
  virtual void c(double , double , double , double , double , double, bool = true) { }
