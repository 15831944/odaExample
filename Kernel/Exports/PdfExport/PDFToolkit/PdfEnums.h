...
enum PDFTypeId
{
  ...
  kWatermarkAnnotationDictionary,
  kFixedPrintDictionary,
  kActionDictionary,
  kURIActionDictionary,
  kGoToActionDictionary,
  k3dStream,
  ...
  kFileSpecificationDictionary,
  kEmbeddedFileStreamDictionary,
  kEmbeddedFileStream,
  kEmbeddedFileParamsDictionary
};
