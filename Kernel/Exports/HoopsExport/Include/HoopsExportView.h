...
public:
  ...
  */
  ...
  /** \details 
    ...
    \remarks 
    This method can be called by the ODA visualization framework to give a client application a chance to terminate the current rendering process. 
  */
  ...
  /** \details 
    ...
    \remarks 
    Current implementation returns a zero value (0.0) to make the ODA visualization framework use a reasonable value.
  */
  double deviation(const OdGiDeviationType, const OdGePoint3d&) const
  {
    // To force the ODA visualization framework to use a reasonable value.
    return 0.0; 
  }
