...
/** \details
  ...
  A class instance gets 3D data from the ODA visualization framework.
*/
...
public:
  ...
  */
  ...
  /** \details 
    ...
    \remarks 
    This method usually is called by a visualization framework. 
  */
  ...
  */    
  ...
  /** \details 
    ...
    \remarks 
    This method is called by the ODA visualization framework before rendering the view associated with the device.
