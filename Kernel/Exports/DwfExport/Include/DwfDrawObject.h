...
public:
  ...
  */
  ...
  // Called by the visualization framework to create an instance 
  ...
  */
  ...
  /** \details
    ...
    \param idxTransparentColor [in] Index of color in image palette to do it transparent.
  */                        
...
*/
  ...
  */
  ...
  {
    std::unique_ptr<WT_Visibility> visibility(classFactory()->Create_Visibility(bVisibility));
  ...
  */
  ...
  {
    std::unique_ptr<WT_Fill> wtFill(classFactory()->Create_Fill(bFill));
  ...
  */
  ...
  virtual void triangleOut(const OdInt32* vertices, const OdGeVector3d* normals); // CORE-14500
...
public:
  ...
  */
  ...
  /** \details
    Called by the ODA visualization framework to render each entity in this view.  
  ...
  */  
  ...
  /** \details
    ...
    \param pDrawable [in]  Graphical object.
  */ 
  void postprocess_Url(const OdGiDrawable* pDrawable);
