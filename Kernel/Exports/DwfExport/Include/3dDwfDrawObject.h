...
public:
  ...
  */
  void setContext(C3dDwfExportImpl* dwf);
...
*/
  ...
  /** \details
    Called by the ODA visualization framework to give the client application a chance to terminate the current rendering process.
  ...
  */
  ...
  {
    // To force the DA visualization framework to use some reasonable value.
    return 0.0; 
  }

  /** \details
    Called by the ODA visualization framework before rendering the view.
  */
  void update();
...
*/
  ...
  /** \details
    Retrieves the current rendering traits (color, linewidth, etc.) and sets these properties into this device.
