...
class OdGsViewPropChangeCbk : public ImplBase
{
  ...
  public:
    enum ViewProperty
    {
      ...
      kViewAntiAliasing, // anti-aliasing setting
      kViewSSAO,         // ambient occlusion setting
  ...
  public:
    ...
    {
      IsInvalidatedCallPropModified checkNCall(this, &m_bInvalidated, kViewAntiAliasing);
      ImplBase::enableAntiAliasing(nMode);
    }

    void enableSSAO(bool bEnable) ODRX_OVERRIDE
    {
      IsInvalidatedCallPropModified checkNCall(this, &m_bInvalidated, kViewSSAO);
      ImplBase::enableSSAO(bEnable);
    }
};
