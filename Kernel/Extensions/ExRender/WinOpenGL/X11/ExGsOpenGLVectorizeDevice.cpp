...
{
  if (!(const_cast<ExGsOpenGLVectorizeDevice*>(this)->properties()->has(OD_T("RasterImage"))) && m_xConnection.window)
  { XWindowAttributes wndAttr;
    XGetWindowAttributes(m_xConnection.display, m_xConnection.window, &wndAttr);
