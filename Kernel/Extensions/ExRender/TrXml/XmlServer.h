...
#ifndef ODTRXMLSERVER
#define ODTRXMLSERVER
...
class OdGsFiler;
class OdTrXmlRendition;

/** \details
    <group ExRender_Windows_Classes> 
*/
class OdTrXmlServer : public OdRxObject
{
  public:
    enum OutputState
    {
    ...
    {
      kSimpleMode = 0,
      kClientDependentSectionOnly,
      kShareableSectionOnly,
      kNormalMode
    };
    enum IdType
    {
  ...
  public:
    ...
    virtual bool DropMetafileAdded(OdTrXmlRendition& rndn, OdTrVisMetafileId& metafileId, const OdTrVisMetafileDef &pDef) { return false; }
    ...
    virtual void DropUInt8s(const char* pTagName, OdUInt32 nData, const OdUInt8* pData) = 0;
    virtual void DropUInt16s(const char* pTagName, OdUInt32 nData, const OdUInt16* pData) = 0;
    virtual void DropUInt32s(const char* pTagName, OdUInt32 nData, const OdUInt32* pData) = 0;
    virtual void DropFloats(const char* pTagName, OdUInt32 nData, const float* pData) = 0;
    virtual void DropDoubles(const char* pTagName, OdUInt32 nData, const double* pData) = 0;
    ...
    virtual void DropDbOwning(const char* pTagName, OdTrVisOwning owningId) = 0;
    ...
    virtual ProcessingMode ClientProcessingMode() const { return kNormalMode; }
...
inline
void OdTrXmlServer::DropString(const char *pTagName, const OdString &pStr)
{
...
/** \details
    <group ExRender_Windows_Classes> 
*/
class OdTrXmlServerStub : public OdTrXmlServer
{
  public:
    ...
    virtual void DropUInt8s(const char* /*pTagName*/, OdUInt32 /*nData*/, const OdUInt8* /*pData*/) { }
    virtual void DropUInt16s(const char* /*pTagName*/, OdUInt32 /*nData*/, const OdUInt16* /*pData*/) { }
    virtual void DropUInt32s(const char* /*pTagName*/, OdUInt32 /*nData*/, const OdUInt32* /*pData*/) { }
    virtual void DropFloats(const char* /*pTagName*/, OdUInt32 /*nData*/, const float* /*pData*/) { }
    virtual void DropDoubles(const char* /*pTagName*/, OdUInt32 /*nData*/, const double* /*pData*/) { }
