...
public:
  ...
  ODRX_DECLARE_DYNAMIC_PROPERTY_MAP(ExWinGsBitmapCompositeDevice);
...
ODRX_BEGIN_DYNAMIC_PROPERTY_MAP(ExWinGsBitmapCompositeDevice)
  ODRX_INHERIT_PROPERTIES(ExWinGsCompositeDevice);
  ODRX_GENERATE_PROPERTY(RasterImage)
  ODRX_GENERATE_PROPERTY(BitPerPixel)
ODRX_END_DYNAMIC_PROPERTY_MAP(ExWinGsBitmapCompositeDevice)
