...
public:
  ...
  */
  ...
  /** \details
    Setup deviation factor multiplier for this Vectorizer device.
    \param dMult [in]  Deviation factor multiplier.
  */
  void setDeviationMultiplier(double dMult) { m_dDeviationMultiplier = dMult; }
  /** \details
    Returns deviation factor multiplier for this Vectorizer device.
  */
  double deviationMultiplier() const { return m_dDeviationMultiplier; }
