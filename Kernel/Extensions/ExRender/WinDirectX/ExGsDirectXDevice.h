                          ...
                          public OdTtfFontsCacheCallback
{
  ...
  bool m_bUseTTFCache, m_bLinesRepMode, m_bRefDevice;
  ...
  mutable OdLoggerBase* m_pLogger;
  // Raster images cache
public:
...
protected:
  ...
  void logResult(const OdString& sMethod, HRESULT res) const;
...
public:
  ...
  */
  ...
  /** \details
    ...
    By default a non non-lockable back buffer is used.
  ...
  */
  ...
  Returns logger.
  */
  OdIntPtr logger() const;
  /** \details
    Set logger to device.
  */
  void setLogger(OdIntPtr pPtr);
  ...
  */
  ...
  { OdGsBaseDeviceMTSyncHelper __sync(mtDeviceSync(), OdGsBaseDeviceMTHelpers::kSyncDeviceResource);
...
public:
  ...
  */
  ExGsDirectXDevice* device() const
  {
...
protected:
  ...
  */
  const OdGsStateBranch* getCurrentVisibilityBranch() const
  {
    return currentVisibilityBranch();
  }
...
public:
  ...
  */
  ...
  void xformByMetafileTransform(OdGeMatrix3d &mtx, bool bInverse = true) const;
  void xformByMetafileTransform(OdGeVector3d &vec, bool bInverse = true) const;
...
public:
  ...
  */
  ...
  int checkLineTopology(const OdGePoint3d &pt1, const OdGePoint3d &pt2) const;
