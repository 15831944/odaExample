...
class D3dResourceSharingProvider : public D3dLostStateManager::D3dLostStateEntry
{
  ...
  protected:
    struct D3dResourceShareEntry
    {
      ...
      bool operator ==(const D3dResourceShareEntry& e2) const  {
...
class D3dMaterialViewRedirect
{
  public:
    ...
    virtual void xformByMetafileTransform(OdGeMatrix3d &mtx, bool bInverse = true) const = 0;
    virtual void xformByMetafileTransform(OdGeVector3d &vec, bool bInverse = true) const = 0;
    ...
    virtual const OdGsStateBranch* getCurrentHLTBranch() const = 0;
    /** \details
      Returns current vectorizer visibility branch.
    */
    virtual const OdGsStateBranch* getCurrentVisibilityBranch() const = 0;
    virtual bool dynamicSubEntHlt() const = 0;
    virtual bool useLutPaletteMonochrome() const = 0;
    virtual bool useLutPaletteColor() const = 0;

    virtual int checkLineTopology(const OdGePoint3d &pt1, const OdGePoint3d &pt2) const = 0;
};
...
class D3dMetafilePlayContext
{
  ...
  OdColorConverterCallbackCaching      m_colorConverter;
  // Shaders
  ...
  bool                                 m_bSuppressHighlighted;
  bool                                 m_bSuppressUnhighlighted;
  bool                                 m_bContextModified;
  bool                                 m_bMarker4Selection;
public:
...
public:
  D3dMetafilePlayContext()
    ...
    , m_bSuppressHighlighted(false)
    , m_bSuppressUnhighlighted(false)
    , m_bContextModified(false)
    , m_bMarker4Selection(false)
  {
    m_vPtr1.m_pVC = NULL;
    m_vPtr2.m_pVC = NULL;
  ...
  */
  ...
  /** \details
    Returns raster image contexts highlighting setting.
  */
  bool imageContentsHlt() const { return m_bImageHighlight; }

  /** \details
    Sets the highlighting pass in this PlayContext object.
    \param nPass [in]  Highlighting pass.
  */
  void setHighlightingPass(int nPass) { m_bSuppressHighlighted = GETBIT(nPass, 1);
                                        m_bSuppressUnhighlighted = GETBIT(nPass, 2); }
  /** \details
    Returns highlighting suppression flag by current highlighting state.
    \param bHighlight [in]  Current highlighting state.
  */
  bool highlightingSuppressed(bool bHighlight) const { return (bHighlight) ? m_bSuppressHighlighted : m_bSuppressUnhighlighted; }
  ...
  */
  inline void setSelMarks(const OdD3DSelMark *pSM, bool b4Selection = false)
  {
    m_pSelMarks = pSM; m_bMarker4Selection = b4Selection;
  }
  /** \details
  ...
  */
  inline bool isNeedOverride(DWORD color) const { return (m_bColorOverride && (m_nColorOverride != color)) ||
                                                         (m_colorConverter.colorConverterCallback() && (m_bProcessBackgroundColors || !m_bNoColorMod)); }
  /** \details
...
/** \details
  Helper reservation place for D3dPackedLwdPolylineRecordWSel objects.
  Library: Source code provided.
  <group ExRender_Windows_Classes> 
*/
struct D3dPackedLwdPolylineRecordDataReservation // #VIS-1699
{
  OdInt32 m_nInitialSelMark;
  OdInt32 m_nbSelMarks;
  D3dPackedLwdPolylineRecordDataReservation(OdInt32 nInitialSelMark, OdInt32 nbSelMarks)
    : m_nInitialSelMark(nInitialSelMark), m_nbSelMarks(nbSelMarks) { }
};
...
{
  D3dPackedLwdPolylineRecordDataReservation &selData() const
  { return *(D3dPackedLwdPolylineRecordDataReservation*)(m_pCache + m_nbLines); }
public:
  /** \param bPoints [in]  Render as points or as lines.
    \param nInitialID [in]  Index of first vertex in vertex buffer.
    \param numLines [in]  Number of line segments.
...
/** \details
  This class implements base class for Begin and End Hiding Record objects.
  Library: Source code provided.
  <group ExRender_Windows_Classes> 
*/
class D3dBaseHideRecord : public D3dBaseBeginOrEndRecord
{
public:
  /** \details
    Default constructor.
...
/** \details
  This class implements D3d Begin Hiding Record object.
  Library: Source code provided.
  <group ExRender_Windows_Classes> 
*/
class D3dBeginHideRecord : public D3dBaseHideRecord
{
public:
  /** \details
    Default constructor.
...
/** \details
  This class implements D3d End Hiding Record object.
  Library: Source code provided.
  <group ExRender_Windows_Classes> 
*/
class D3dEndHideRecord : public D3dBaseHideRecord
{
public:
  /** \details
    Default constructor.
...
public:
  /** \details
    Constructor. Creates a new D3dSelectionMarkerRecord object by the input OdGsMarker object.
  */
...
/** \details
  This class added to disable faces culling for subsequent geometry.
  Library: Source code provided.
  <group ExRender_Windows_Classes> 
*/
class D3dKillFaceCullingRecord : public D3dRecord
{
public:
  /** \details
    Default constructor.
...
public:
  ...
  */
  ...
  /** \details
    ...
    \param pRecord [in]  Pointer to the record chain.
  */
  void prependLightRecord(D3dRecord* pRecord)
  {
    pRecord->setTail(m_lightCache.tail());
    m_lightCache.setTail(pRecord);
  }

  /** \details
    Prepends the specified record chain to the light triangles cache of this Metafile object.
    \param pRecord [in]  Pointer to the record chain.
  */
  ...
  */
  ...
  /** \details
    Caclulate metafile size.
    \param bExact [in]  Calculate exact size if set, elsewhere return 0 if empty or 1 if data available.
  */
  virtual OdUInt64 metafileSize(bool bExact) const;
...
class D3dMetafilePackager
{
  public:
    ...
    */
    enum RecordType
    {
      ...
      kBeginHideRec, // Begin hiding record (called for selection mark of subentities)
      kEndHideRec // End hiding record (called for end subentity selection mark)
    };
    /** \details
  ...
  protected:
    ...
    bool                     m_bControlHidden;// Enable subentities hiding support
    bool                     m_bLastHidden;   // Last hidden state (summary for all entries)
    ...
    struct PackEntry
    {
      ...
      bool                   m_bLastHiddenState; //Last hidden state in entry
    ...
    OdD3DVertexNormalTexColArray     m_VNTCArray;       // Vertices with normals and texture coordinates.
  ...
  public:
    ...
    */
    ...
    /** \details
      Returns current hidden state for specified metafile entry type.
      \param entryType [in]  Metafile entry type.
    */
    bool curHiddenState(PackEntryType entryType) const;
    ...
    */
    ...
    /** \details
      Enable dynamic sub-entities highlighting.
      \param bSet [in]  New flag.
    */
    void enableDynamicSubEntHlt(bool bSet) { m_bDynamicSubEntHlt = bSet; }

    /** \details
      Setups appropriate array parameters for current rendering options.
...
/** \details
   This class provides tessellation functionality for the ODA vectorization framework  
   Library: Source code provided.
  <group ExRender_Windows_Classes> 
*/
class ExGiDirectXGeometry : public OdGiGeometrySimplifier, public OdGiPlineContourCalc<>
                          , public OdRxObject
{
...
public:
  ...
  */
  ...
  /** \details
    ...
    \param pMetafile [in]  Pointer to the metafile.
    \param uMetafileSize [in]  Reference to the storage for metafile size.
    \param bExactSize [in]  Set to true if exact metafile size need to be calculated, elsewhere 1 will be set if metafile is not empty.
  */
  void endMetafile(OdRxObject* pMetafile, OdUInt64 &uMetafileSize, bool bExactSize = false);
  /** \details
    Plays (draws) the specified Metafile (cache) object.
    \param pMetafile [in]  Pointer to the metafile.
    \param hltPass [in]  Current highlighting pass.
  */
  void playMetafile(const OdRxObject* pMetafile, int hltPass = 0);
  ...
  */
  ...
  void generateThinWires(bool bPline, OdInt32 faceListSize = 0, const OdInt32 *pFaceList = NULL,
                         const OdGiEdgeData *pEdgeData = NULL, const OdGiFaceData *pFaceData = NULL);
  void dropPlineCalcShellWires(bool bStrips);
  ...
  */
  ...
  /** \details
    Returns the TwoSidesMode flag from this Geometry object.
    \return True in case if TwoSideMode enabled or false otherwise.
  */
  bool twoSidesMode() const { return m_bTwoSidesMode; }

  /** \details
    Sets ShmClipped flag for this Geometry object.
    \param shmClipped [in]  New state for ShmClipped flag.
  */
  void setShmClipped(bool shmClipped) { m_bShmClipped = shmClipped; }
