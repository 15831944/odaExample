...
public:
  ...
  ODRX_DECLARE_DYNAMIC_PROPERTY_MAP(ExGsGDIBitmapVectorizeDevice);
...
ODRX_BEGIN_DYNAMIC_PROPERTY_MAP(ExGsGDIBitmapVectorizeDevice)
...
ODRX_END_DYNAMIC_PROPERTY_MAP(ExGsGDIBitmapVectorizeDevice)
...
ODRX_DEFINE_PROPERTY_METHODS_PREFIX(ExGsGDIBitmapVectorizeDevice::, GDITransparencyMode, ExGsGDIBitmapVectorizeDevice, getTransparencyMode, setTransparencyMode, getUInt8 )
ODRX_DEFINE_PROPERTY_METHODS_PREFIX(ExGsGDIBitmapVectorizeDevice::, GDIRasterMode, ExGsGDIBitmapVectorizeDevice, getRasterMode, setRasterMode, getUInt8 )
