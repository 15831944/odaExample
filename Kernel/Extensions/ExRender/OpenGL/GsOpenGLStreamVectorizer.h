...
struct OdOpenGLArrayWrapperShared : public OdRxObject, public OdOpenGLArrayWrapper
{
  ...
  /** \details
    Destructor for the OdOpenGLArrayWrapperShared class. Clears data allocated for this array.
  */
...
protected:
  ...
  void updateShmClipping(OdRxObject *pMf);
...
public:
  ...
  OdUInt8 metafileCheckMarker(OdOpenGLGsMarker gsMarker, bool bPrevState);
  ...
  bool matafileImageContentsHlt() const { return GETBIT(giContext().imageSelectionBehavior(), OdGiContext::kImageHighlight); }
