...
public:
  ...
  enum OpenGLExtension
  {
    ...
    OpenGLExtension_ARB_WinPos,    // GL_ARB_window_pos
...
public:
  ...
  /** \details
    ...
    \param xOffset [in]  Horizontal offset in pixels.
    \param yOffset [in]  Vertical offset in pixels.
    \param width [in]  Viewport width in pixels.
    \param height [in]  Viewport height in pixels.
  */
  void setGLViewport(long int xOffset, long int yOffset, long int width, long int height);

  /** \details
    Returns actual window height if this is possible.
  */
  virtual long int windowHeight() const { return vOffset() + height(); }
...
/** \details
  ...
  <group ExRender_Classes> 
*/
class OdGsOpenGLVectorizeView : public OdGiPlineContourCalc<OdGsBaseMaterialViewMT>
...
class OdOpenGLCheckMarkIface
{
  public:
    ...
    */
    ...
    virtual OdUInt8 metafileCheckMarker(OdOpenGLGsMarker gsMarker, bool bPrevState) = 0;
...
class OdOpenGLWrapResourceRelease
{
  ...
  public:
    ...
    /** \details
      Constructor for the OdOpenGLWrapResourceRelease implementation class.
      
      \param pDevice [in] a pointer to the OdGsOpenGLVectorizeDevice class that represents a device for which resources need to be released.
      
      \remarks
      Performs operations prior to releasing resources.
    */
    ...
    /** \details
      Destructor for the OdOpenGLWrapResourceRelease implementation class.
      
      \remarks
      Performs operations after releasing resources.
    */
