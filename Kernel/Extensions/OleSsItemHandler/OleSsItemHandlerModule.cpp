...
OdOleSsItemHandlerModuleImpl::OdOleSsItemHandlerModuleImpl() : m_savedConstructor(0)
{
}
...
void OdOleSsItemHandlerModuleImpl::initApp()
{
  ...
  m_savedConstructor = OdOleItemHandler::desc()->constructor();
...
void OdOleSsItemHandlerModuleImpl::uninitApp()
{
  ...
  if (OdOleItemHandler::desc()->constructor() == createOleSsItemHandler)
    OdOleItemHandler::desc()->setConstructor(m_savedConstructor);
