...
/** \details
  This class implements an OLE item handler module for Windows.
...
/** \details
  ...
  It prevents initialization and uninitialization conflicts.
  \sa
...
public:
  ...
  /** \details
    Constructor for objects of the OleInit class.
  */
  OleInit()
  {
  ...
  /** \details
    Destructor for objects of the OleInit class.
  */
  ~OleInit()
  {
