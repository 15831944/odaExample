...
#ifndef _IFC4X1_IFCALIGNMENTCURVE_AUTO_IMPL_H
#define _IFC4X1_IFCALIGNMENTCURVE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcAlignmentCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcAlignmentCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcAlignmentCurve, IfcAlignmentCurve> object.
*/
typedef OdSmartPtr<IfcAlignmentCurve> IfcAlignmentCurvePtr;

} // namespace

#endif // _IFC4X1_IFCALIGNMENTCURVE_AUTO_IMPL_H
