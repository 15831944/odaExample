...
#ifndef _IFC4X1_IFCBUILDINGSTOREY_AUTO_IMPL_H
#define _IFC4X1_IFCBUILDINGSTOREY_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcBuildingStorey : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcBuildingStorey);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcBuildingStorey, IfcBuildingStorey> object.
*/
typedef OdSmartPtr<IfcBuildingStorey> IfcBuildingStoreyPtr;

} // namespace

#endif // _IFC4X1_IFCBUILDINGSTOREY_AUTO_IMPL_H
