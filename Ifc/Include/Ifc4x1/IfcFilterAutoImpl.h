...
#ifndef _IFC4X1_IFCFILTER_AUTO_IMPL_H
#define _IFC4X1_IFCFILTER_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcFilter : public IfcFlowTreatmentDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcFilter);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcFilter, IfcFilter> object.
*/
typedef OdSmartPtr<IfcFilter> IfcFilterPtr;

} // namespace

#endif // _IFC4X1_IFCFILTER_AUTO_IMPL_H
