...
#ifndef _IFC4X1_IFCCONTROLLERTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCCONTROLLERTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcControllerType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcControllerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcControllerType, IfcControllerType> object.
*/
typedef OdSmartPtr<IfcControllerType> IfcControllerTypePtr;

} // namespace

#endif // _IFC4X1_IFCCONTROLLERTYPE_AUTO_IMPL_H
