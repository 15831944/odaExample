...
#ifndef _IFC4X1_IFCALARM_AUTO_IMPL_H
#define _IFC4X1_IFCALARM_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcAlarm : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcAlarm);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcAlarm, IfcAlarm> object.
*/
typedef OdSmartPtr<IfcAlarm> IfcAlarmPtr;

} // namespace

#endif // _IFC4X1_IFCALARM_AUTO_IMPL_H
