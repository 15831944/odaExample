...
#ifndef _IFC4X1_IFCBOUNDARYNODECONDITION_AUTO_IMPL_H
#define _IFC4X1_IFCBOUNDARYNODECONDITION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcBoundaryNodeCondition : public IfcBoundaryCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcBoundaryNodeCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcBoundaryNodeCondition, IfcBoundaryNodeCondition> object.
*/
typedef OdSmartPtr<IfcBoundaryNodeCondition> IfcBoundaryNodeConditionPtr;

} // namespace

#endif // _IFC4X1_IFCBOUNDARYNODECONDITION_AUTO_IMPL_H
