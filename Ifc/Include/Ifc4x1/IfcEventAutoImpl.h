...
#ifndef _IFC4X1_IFCEVENT_AUTO_IMPL_H
#define _IFC4X1_IFCEVENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcEvent : public IfcProcess
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcEvent);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcEvent, IfcEvent> object.
*/
typedef OdSmartPtr<IfcEvent> IfcEventPtr;

} // namespace

#endif // _IFC4X1_IFCEVENT_AUTO_IMPL_H
