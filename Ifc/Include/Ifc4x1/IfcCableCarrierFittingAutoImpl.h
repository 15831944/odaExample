...
#ifndef _IFC4X1_IFCCABLECARRIERFITTING_AUTO_IMPL_H
#define _IFC4X1_IFCCABLECARRIERFITTING_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCableCarrierFitting : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCableCarrierFitting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCableCarrierFitting, IfcCableCarrierFitting> object.
*/
typedef OdSmartPtr<IfcCableCarrierFitting> IfcCableCarrierFittingPtr;

} // namespace

#endif // _IFC4X1_IFCCABLECARRIERFITTING_AUTO_IMPL_H
