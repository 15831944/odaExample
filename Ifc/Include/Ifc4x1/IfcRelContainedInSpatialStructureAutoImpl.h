...
#ifndef _IFC4X1_IFCRELCONTAINEDINSPATIALSTRUCTURE_AUTO_IMPL_H
#define _IFC4X1_IFCRELCONTAINEDINSPATIALSTRUCTURE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelContainedInSpatialStructure : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelContainedInSpatialStructure);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelContainedInSpatialStructure, IfcRelContainedInSpatialStructure> object.
*/
typedef OdSmartPtr<IfcRelContainedInSpatialStructure> IfcRelContainedInSpatialStructurePtr;

} // namespace

#endif // _IFC4X1_IFCRELCONTAINEDINSPATIALSTRUCTURE_AUTO_IMPL_H
