...
#ifndef _IFC4X1_IFCSPATIALZONETYPE_AUTO_IMPL_H
#define _IFC4X1_IFCSPATIALZONETYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSpatialZoneType : public IfcSpatialElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSpatialZoneType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSpatialZoneType, IfcSpatialZoneType> object.
*/
typedef OdSmartPtr<IfcSpatialZoneType> IfcSpatialZoneTypePtr;

} // namespace

#endif // _IFC4X1_IFCSPATIALZONETYPE_AUTO_IMPL_H
