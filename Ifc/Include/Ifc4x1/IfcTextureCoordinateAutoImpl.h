...
#ifndef _IFC4X1_IFCTEXTURECOORDINATE_AUTO_IMPL_H
#define _IFC4X1_IFCTEXTURECOORDINATE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcTextureCoordinate : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcTextureCoordinate);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcTextureCoordinate, IfcTextureCoordinate> object.
*/
typedef OdSmartPtr<IfcTextureCoordinate> IfcTextureCoordinatePtr;

} // namespace

#endif // _IFC4X1_IFCTEXTURECOORDINATE_AUTO_IMPL_H
