...
#ifndef _IFC4X1_IFCUNITARYEQUIPMENT_AUTO_IMPL_H
#define _IFC4X1_IFCUNITARYEQUIPMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcUnitaryEquipment : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcUnitaryEquipment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcUnitaryEquipment, IfcUnitaryEquipment> object.
*/
typedef OdSmartPtr<IfcUnitaryEquipment> IfcUnitaryEquipmentPtr;

} // namespace

#endif // _IFC4X1_IFCUNITARYEQUIPMENT_AUTO_IMPL_H
