...
#ifndef _IFC4X1_IFCVOIDINGFEATURE_AUTO_IMPL_H
#define _IFC4X1_IFCVOIDINGFEATURE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcVoidingFeature : public IfcFeatureElementSubtraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcVoidingFeature);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcVoidingFeature, IfcVoidingFeature> object.
*/
typedef OdSmartPtr<IfcVoidingFeature> IfcVoidingFeaturePtr;

} // namespace

#endif // _IFC4X1_IFCVOIDINGFEATURE_AUTO_IMPL_H
