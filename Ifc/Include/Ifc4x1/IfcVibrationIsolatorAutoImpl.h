...
#ifndef _IFC4X1_IFCVIBRATIONISOLATOR_AUTO_IMPL_H
#define _IFC4X1_IFCVIBRATIONISOLATOR_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcVibrationIsolator : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcVibrationIsolator);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcVibrationIsolator, IfcVibrationIsolator> object.
*/
typedef OdSmartPtr<IfcVibrationIsolator> IfcVibrationIsolatorPtr;

} // namespace

#endif // _IFC4X1_IFCVIBRATIONISOLATOR_AUTO_IMPL_H
