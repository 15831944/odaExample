...
#ifndef _IFC4X1_IFCRELASSOCIATESCLASSIFICATION_AUTO_IMPL_H
#define _IFC4X1_IFCRELASSOCIATESCLASSIFICATION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelAssociatesClassification : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelAssociatesClassification);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelAssociatesClassification, IfcRelAssociatesClassification> object.
*/
typedef OdSmartPtr<IfcRelAssociatesClassification> IfcRelAssociatesClassificationPtr;

} // namespace

#endif // _IFC4X1_IFCRELASSOCIATESCLASSIFICATION_AUTO_IMPL_H
