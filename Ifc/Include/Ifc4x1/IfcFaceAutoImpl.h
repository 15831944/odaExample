...
#ifndef _IFC4X1_IFCFACE_AUTO_IMPL_H
#define _IFC4X1_IFCFACE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcFace : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcFace);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcFace, IfcFace> object.
*/
typedef OdSmartPtr<IfcFace> IfcFacePtr;

} // namespace

#endif // _IFC4X1_IFCFACE_AUTO_IMPL_H
