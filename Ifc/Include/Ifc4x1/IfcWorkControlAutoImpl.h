...
#ifndef _IFC4X1_IFCWORKCONTROL_AUTO_IMPL_H
#define _IFC4X1_IFCWORKCONTROL_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcWorkControl : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcWorkControl);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcWorkControl, IfcWorkControl> object.
*/
typedef OdSmartPtr<IfcWorkControl> IfcWorkControlPtr;

} // namespace

#endif // _IFC4X1_IFCWORKCONTROL_AUTO_IMPL_H
