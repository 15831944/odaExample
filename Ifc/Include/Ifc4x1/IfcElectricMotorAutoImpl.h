...
#ifndef _IFC4X1_IFCELECTRICMOTOR_AUTO_IMPL_H
#define _IFC4X1_IFCELECTRICMOTOR_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcElectricMotor : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcElectricMotor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcElectricMotor, IfcElectricMotor> object.
*/
typedef OdSmartPtr<IfcElectricMotor> IfcElectricMotorPtr;

} // namespace

#endif // _IFC4X1_IFCELECTRICMOTOR_AUTO_IMPL_H
