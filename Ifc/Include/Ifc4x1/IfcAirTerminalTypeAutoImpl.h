...
#ifndef _IFC4X1_IFCAIRTERMINALTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCAIRTERMINALTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcAirTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcAirTerminalType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcAirTerminalType, IfcAirTerminalType> object.
*/
typedef OdSmartPtr<IfcAirTerminalType> IfcAirTerminalTypePtr;

} // namespace

#endif // _IFC4X1_IFCAIRTERMINALTYPE_AUTO_IMPL_H
