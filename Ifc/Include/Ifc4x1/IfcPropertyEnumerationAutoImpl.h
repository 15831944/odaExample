...
#ifndef _IFC4X1_IFCPROPERTYENUMERATION_AUTO_IMPL_H
#define _IFC4X1_IFCPROPERTYENUMERATION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPropertyEnumeration : public IfcPropertyAbstraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPropertyEnumeration);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPropertyEnumeration, IfcPropertyEnumeration> object.
*/
typedef OdSmartPtr<IfcPropertyEnumeration> IfcPropertyEnumerationPtr;

} // namespace

#endif // _IFC4X1_IFCPROPERTYENUMERATION_AUTO_IMPL_H
