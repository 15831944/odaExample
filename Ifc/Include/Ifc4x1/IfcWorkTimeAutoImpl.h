...
#ifndef _IFC4X1_IFCWORKTIME_AUTO_IMPL_H
#define _IFC4X1_IFCWORKTIME_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcWorkTime : public IfcSchedulingTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcWorkTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcWorkTime, IfcWorkTime> object.
*/
typedef OdSmartPtr<IfcWorkTime> IfcWorkTimePtr;

} // namespace

#endif // _IFC4X1_IFCWORKTIME_AUTO_IMPL_H
