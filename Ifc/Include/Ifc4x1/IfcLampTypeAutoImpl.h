...
#ifndef _IFC4X1_IFCLAMPTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCLAMPTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcLampType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcLampType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcLampType, IfcLampType> object.
*/
typedef OdSmartPtr<IfcLampType> IfcLampTypePtr;

} // namespace

#endif // _IFC4X1_IFCLAMPTYPE_AUTO_IMPL_H
