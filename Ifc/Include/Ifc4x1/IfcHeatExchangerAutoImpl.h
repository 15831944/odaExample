...
#ifndef _IFC4X1_IFCHEATEXCHANGER_AUTO_IMPL_H
#define _IFC4X1_IFCHEATEXCHANGER_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcHeatExchanger : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcHeatExchanger);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcHeatExchanger, IfcHeatExchanger> object.
*/
typedef OdSmartPtr<IfcHeatExchanger> IfcHeatExchangerPtr;

} // namespace

#endif // _IFC4X1_IFCHEATEXCHANGER_AUTO_IMPL_H
