...
#ifndef _IFC4X1_IFCCABLEFITTINGTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCCABLEFITTINGTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCableFittingType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCableFittingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCableFittingType, IfcCableFittingType> object.
*/
typedef OdSmartPtr<IfcCableFittingType> IfcCableFittingTypePtr;

} // namespace

#endif // _IFC4X1_IFCCABLEFITTINGTYPE_AUTO_IMPL_H
