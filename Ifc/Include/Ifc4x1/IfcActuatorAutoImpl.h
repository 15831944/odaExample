...
#ifndef _IFC4X1_IFCACTUATOR_AUTO_IMPL_H
#define _IFC4X1_IFCACTUATOR_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcActuator : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcActuator);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcActuator, IfcActuator> object.
*/
typedef OdSmartPtr<IfcActuator> IfcActuatorPtr;

} // namespace

#endif // _IFC4X1_IFCACTUATOR_AUTO_IMPL_H
