...
#ifndef _IFC4X1_IFCISHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X1_IFCISHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcIShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcIShapeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcIShapeProfileDef, IfcIShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcIShapeProfileDef> IfcIShapeProfileDefPtr;

} // namespace

#endif // _IFC4X1_IFCISHAPEPROFILEDEF_AUTO_IMPL_H
