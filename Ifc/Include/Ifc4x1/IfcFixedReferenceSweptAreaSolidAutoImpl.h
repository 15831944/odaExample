...
#ifndef _IFC4X1_IFCFIXEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
#define _IFC4X1_IFCFIXEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcFixedReferenceSweptAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcFixedReferenceSweptAreaSolid);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getFixedReference() const;
  void setFixedReference(const OdDAIObjectId& FixedReference);
...
protected:
  ...
  double m_StartParam;   // IfcParameterValue  [optional]
  double m_EndParam;   // IfcParameterValue  [optional]
  OdDAIObjectId m_FixedReference;   // IfcDirection
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcFixedReferenceSweptAreaSolid, IfcFixedReferenceSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcFixedReferenceSweptAreaSolid> IfcFixedReferenceSweptAreaSolidPtr;

} // namespace

#endif // _IFC4X1_IFCFIXEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
