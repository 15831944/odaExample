...
#ifndef _IFC4X1_IFCSUBEDGE_AUTO_IMPL_H
#define _IFC4X1_IFCSUBEDGE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSubedge : public IfcEdge
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSubedge);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSubedge, IfcSubedge> object.
*/
typedef OdSmartPtr<IfcSubedge> IfcSubedgePtr;

} // namespace

#endif // _IFC4X1_IFCSUBEDGE_AUTO_IMPL_H
