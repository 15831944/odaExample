...
#ifndef _IFC4X1_IFCFACETEDBREPWITHVOIDS_AUTO_IMPL_H
#define _IFC4X1_IFCFACETEDBREPWITHVOIDS_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcFacetedBrepWithVoids : public IfcFacetedBrep
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcFacetedBrepWithVoids);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcFacetedBrepWithVoids, IfcFacetedBrepWithVoids> object.
*/
typedef OdSmartPtr<IfcFacetedBrepWithVoids> IfcFacetedBrepWithVoidsPtr;

} // namespace

#endif // _IFC4X1_IFCFACETEDBREPWITHVOIDS_AUTO_IMPL_H
