...
#ifndef _IFC4X1_IFCBOUNDARYFACECONDITION_AUTO_IMPL_H
#define _IFC4X1_IFCBOUNDARYFACECONDITION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcBoundaryFaceCondition : public IfcBoundaryCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcBoundaryFaceCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcBoundaryFaceCondition, IfcBoundaryFaceCondition> object.
*/
typedef OdSmartPtr<IfcBoundaryFaceCondition> IfcBoundaryFaceConditionPtr;

} // namespace

#endif // _IFC4X1_IFCBOUNDARYFACECONDITION_AUTO_IMPL_H
