...
#ifndef _IFC4X1_IFCINDEXEDPOLYCURVE_AUTO_IMPL_H
#define _IFC4X1_IFCINDEXEDPOLYCURVE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcIndexedPolyCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcIndexedPolyCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcIndexedPolyCurve, IfcIndexedPolyCurve> object.
*/
typedef OdSmartPtr<IfcIndexedPolyCurve> IfcIndexedPolyCurvePtr;

} // namespace

#endif // _IFC4X1_IFCINDEXEDPOLYCURVE_AUTO_IMPL_H
