...
#ifndef _IFC4X1_IFCENGINETYPE_AUTO_IMPL_H
#define _IFC4X1_IFCENGINETYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcEngineType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcEngineType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcEngineType, IfcEngineType> object.
*/
typedef OdSmartPtr<IfcEngineType> IfcEngineTypePtr;

} // namespace

#endif // _IFC4X1_IFCENGINETYPE_AUTO_IMPL_H
