...
#ifndef _IFC4X1_IFCSURFACETEXTURE_AUTO_IMPL_H
#define _IFC4X1_IFCSURFACETEXTURE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSurfaceTexture : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcSurfaceTexture);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSurfaceTexture, IfcSurfaceTexture> object.
*/
typedef OdSmartPtr<IfcSurfaceTexture> IfcSurfaceTexturePtr;

} // namespace

#endif // _IFC4X1_IFCSURFACETEXTURE_AUTO_IMPL_H
