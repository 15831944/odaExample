...
#ifndef _IFC4X1_IFCSWITCHINGDEVICE_AUTO_IMPL_H
#define _IFC4X1_IFCSWITCHINGDEVICE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSwitchingDevice : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSwitchingDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSwitchingDevice, IfcSwitchingDevice> object.
*/
typedef OdSmartPtr<IfcSwitchingDevice> IfcSwitchingDevicePtr;

} // namespace

#endif // _IFC4X1_IFCSWITCHINGDEVICE_AUTO_IMPL_H
