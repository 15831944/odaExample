...
#ifndef _IFC4X1_IFCSWEPTDISKSOLIDPOLYGONAL_AUTO_IMPL_H
#define _IFC4X1_IFCSWEPTDISKSOLIDPOLYGONAL_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSweptDiskSolidPolygonal : public IfcSweptDiskSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSweptDiskSolidPolygonal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSweptDiskSolidPolygonal, IfcSweptDiskSolidPolygonal> object.
*/
typedef OdSmartPtr<IfcSweptDiskSolidPolygonal> IfcSweptDiskSolidPolygonalPtr;

} // namespace

#endif // _IFC4X1_IFCSWEPTDISKSOLIDPOLYGONAL_AUTO_IMPL_H
