...
#ifndef _IFC4X1_IFCTRANSFORMER_AUTO_IMPL_H
#define _IFC4X1_IFCTRANSFORMER_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcTransformer : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcTransformer);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcTransformer, IfcTransformer> object.
*/
typedef OdSmartPtr<IfcTransformer> IfcTransformerPtr;

} // namespace

#endif // _IFC4X1_IFCTRANSFORMER_AUTO_IMPL_H
