...
#ifndef _IFC4X1_IFCTRIANGULATEDFACESET_AUTO_IMPL_H
#define _IFC4X1_IFCTRIANGULATEDFACESET_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcTriangulatedFaceSet : public IfcTessellatedFaceSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcTriangulatedFaceSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcTriangulatedFaceSet, IfcTriangulatedFaceSet> object.
*/
typedef OdSmartPtr<IfcTriangulatedFaceSet> IfcTriangulatedFaceSetPtr;

} // namespace

#endif // _IFC4X1_IFCTRIANGULATEDFACESET_AUTO_IMPL_H
