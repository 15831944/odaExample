...
#ifndef _IFC4X1_IFCMAPCONVERSION_AUTO_IMPL_H
#define _IFC4X1_IFCMAPCONVERSION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcMapConversion : public IfcCoordinateOperation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcMapConversion);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcMapConversion, IfcMapConversion> object.
*/
typedef OdSmartPtr<IfcMapConversion> IfcMapConversionPtr;

} // namespace

#endif // _IFC4X1_IFCMAPCONVERSION_AUTO_IMPL_H
