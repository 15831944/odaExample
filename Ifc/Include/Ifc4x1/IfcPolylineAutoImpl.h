...
#ifndef _IFC4X1_IFCPOLYLINE_AUTO_IMPL_H
#define _IFC4X1_IFCPOLYLINE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPolyline : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPolyline);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPolyline, IfcPolyline> object.
*/
typedef OdSmartPtr<IfcPolyline> IfcPolylinePtr;

} // namespace

#endif // _IFC4X1_IFCPOLYLINE_AUTO_IMPL_H
