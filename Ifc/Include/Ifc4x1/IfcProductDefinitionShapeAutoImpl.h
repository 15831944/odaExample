...
#ifndef _IFC4X1_IFCPRODUCTDEFINITIONSHAPE_AUTO_IMPL_H
#define _IFC4X1_IFCPRODUCTDEFINITIONSHAPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcProductDefinitionShape : public IfcProductRepresentation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcProductDefinitionShape);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcProductDefinitionShape, IfcProductDefinitionShape> object.
*/
typedef OdSmartPtr<IfcProductDefinitionShape> IfcProductDefinitionShapePtr;

} // namespace

#endif // _IFC4X1_IFCPRODUCTDEFINITIONSHAPE_AUTO_IMPL_H
