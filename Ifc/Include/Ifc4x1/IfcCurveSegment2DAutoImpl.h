...
#ifndef _IFC4X1_IFCCURVESEGMENT2D_AUTO_IMPL_H
#define _IFC4X1_IFCCURVESEGMENT2D_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCurveSegment2D : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcCurveSegment2D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCurveSegment2D, IfcCurveSegment2D> object.
*/
typedef OdSmartPtr<IfcCurveSegment2D> IfcCurveSegment2DPtr;

} // namespace

#endif // _IFC4X1_IFCCURVESEGMENT2D_AUTO_IMPL_H
