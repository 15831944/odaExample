...
#ifndef _IFC4X1_IFCTYPEPROCESS_AUTO_IMPL_H
#define _IFC4X1_IFCTYPEPROCESS_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcTypeProcess : public IfcTypeObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcTypeProcess);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcTypeProcess, IfcTypeProcess> object.
*/
typedef OdSmartPtr<IfcTypeProcess> IfcTypeProcessPtr;

} // namespace

#endif // _IFC4X1_IFCTYPEPROCESS_AUTO_IMPL_H
