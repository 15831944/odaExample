...
#ifndef _IFC4X1_IFCLAGTIME_AUTO_IMPL_H
#define _IFC4X1_IFCLAGTIME_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcLagTime : public IfcSchedulingTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcLagTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcLagTime, IfcLagTime> object.
*/
typedef OdSmartPtr<IfcLagTime> IfcLagTimePtr;

} // namespace

#endif // _IFC4X1_IFCLAGTIME_AUTO_IMPL_H
