...
#ifndef _IFC4X1_IFCSHADINGDEVICETYPE_AUTO_IMPL_H
#define _IFC4X1_IFCSHADINGDEVICETYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcShadingDeviceType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcShadingDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcShadingDeviceType, IfcShadingDeviceType> object.
*/
typedef OdSmartPtr<IfcShadingDeviceType> IfcShadingDeviceTypePtr;

} // namespace

#endif // _IFC4X1_IFCSHADINGDEVICETYPE_AUTO_IMPL_H
