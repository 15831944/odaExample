...
#ifndef _IFC4X1_IFCMATERIALPROFILE_AUTO_IMPL_H
#define _IFC4X1_IFCMATERIALPROFILE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcMaterialProfile : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcMaterialProfile);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcMaterialProfile, IfcMaterialProfile> object.
*/
typedef OdSmartPtr<IfcMaterialProfile> IfcMaterialProfilePtr;

} // namespace

#endif // _IFC4X1_IFCMATERIALPROFILE_AUTO_IMPL_H
