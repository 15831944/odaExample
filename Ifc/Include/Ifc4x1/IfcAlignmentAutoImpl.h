...
#ifndef _IFC4X1_IFCALIGNMENT_AUTO_IMPL_H
#define _IFC4X1_IFCALIGNMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcAlignment : public IfcLinearPositioningElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcAlignment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcAlignment, IfcAlignment> object.
*/
typedef OdSmartPtr<IfcAlignment> IfcAlignmentPtr;

} // namespace

#endif // _IFC4X1_IFCALIGNMENT_AUTO_IMPL_H
