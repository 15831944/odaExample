...
#ifndef _IFC4X1_IFCPERFORMANCEHISTORY_AUTO_IMPL_H
#define _IFC4X1_IFCPERFORMANCEHISTORY_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPerformanceHistory : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPerformanceHistory);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPerformanceHistory, IfcPerformanceHistory> object.
*/
typedef OdSmartPtr<IfcPerformanceHistory> IfcPerformanceHistoryPtr;

} // namespace

#endif // _IFC4X1_IFCPERFORMANCEHISTORY_AUTO_IMPL_H
