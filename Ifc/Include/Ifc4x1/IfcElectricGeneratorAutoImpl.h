...
#ifndef _IFC4X1_IFCELECTRICGENERATOR_AUTO_IMPL_H
#define _IFC4X1_IFCELECTRICGENERATOR_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcElectricGenerator : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcElectricGenerator);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcElectricGenerator, IfcElectricGenerator> object.
*/
typedef OdSmartPtr<IfcElectricGenerator> IfcElectricGeneratorPtr;

} // namespace

#endif // _IFC4X1_IFCELECTRICGENERATOR_AUTO_IMPL_H
