...
#ifndef _IFC4X1_IFCPRESENTATIONLAYERASSIGNMENT_AUTO_IMPL_H
#define _IFC4X1_IFCPRESENTATIONLAYERASSIGNMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPresentationLayerAssignment : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPresentationLayerAssignment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPresentationLayerAssignment, IfcPresentationLayerAssignment> object.
*/
typedef OdSmartPtr<IfcPresentationLayerAssignment> IfcPresentationLayerAssignmentPtr;

} // namespace

#endif // _IFC4X1_IFCPRESENTATIONLAYERASSIGNMENT_AUTO_IMPL_H
