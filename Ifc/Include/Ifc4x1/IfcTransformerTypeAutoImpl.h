...
#ifndef _IFC4X1_IFCTRANSFORMERTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCTRANSFORMERTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcTransformerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcTransformerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcTransformerType, IfcTransformerType> object.
*/
typedef OdSmartPtr<IfcTransformerType> IfcTransformerTypePtr;

} // namespace

#endif // _IFC4X1_IFCTRANSFORMERTYPE_AUTO_IMPL_H
