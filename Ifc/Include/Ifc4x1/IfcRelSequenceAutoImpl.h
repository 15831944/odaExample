...
#ifndef _IFC4X1_IFCRELSEQUENCE_AUTO_IMPL_H
#define _IFC4X1_IFCRELSEQUENCE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelSequence : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelSequence);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelSequence, IfcRelSequence> object.
*/
typedef OdSmartPtr<IfcRelSequence> IfcRelSequencePtr;

} // namespace

#endif // _IFC4X1_IFCRELSEQUENCE_AUTO_IMPL_H
