...
#ifndef _IFC4X1_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
#define _IFC4X1_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelServicesBuildings : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelServicesBuildings);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelServicesBuildings, IfcRelServicesBuildings> object.
*/
typedef OdSmartPtr<IfcRelServicesBuildings> IfcRelServicesBuildingsPtr;

} // namespace

#endif // _IFC4X1_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
