...
#ifndef _IFC4X1_IFCOBJECTIVE_AUTO_IMPL_H
#define _IFC4X1_IFCOBJECTIVE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcObjective : public IfcConstraint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcObjective);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcObjective, IfcObjective> object.
*/
typedef OdSmartPtr<IfcObjective> IfcObjectivePtr;

} // namespace

#endif // _IFC4X1_IFCOBJECTIVE_AUTO_IMPL_H
