...
#ifndef _IFC4X1_IFCPROPERTYTABLEVALUE_AUTO_IMPL_H
#define _IFC4X1_IFCPROPERTYTABLEVALUE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPropertyTableValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPropertyTableValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPropertyTableValue, IfcPropertyTableValue> object.
*/
typedef OdSmartPtr<IfcPropertyTableValue> IfcPropertyTableValuePtr;

} // namespace

#endif // _IFC4X1_IFCPROPERTYTABLEVALUE_AUTO_IMPL_H
