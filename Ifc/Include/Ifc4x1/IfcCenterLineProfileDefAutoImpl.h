...
#ifndef _IFC4X1_IFCCENTERLINEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X1_IFCCENTERLINEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCenterLineProfileDef : public IfcArbitraryOpenProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCenterLineProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCenterLineProfileDef, IfcCenterLineProfileDef> object.
*/
typedef OdSmartPtr<IfcCenterLineProfileDef> IfcCenterLineProfileDefPtr;

} // namespace

#endif // _IFC4X1_IFCCENTERLINEPROFILEDEF_AUTO_IMPL_H
