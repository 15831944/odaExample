...
#ifndef _IFC4X1_IFCPORT_AUTO_IMPL_H
#define _IFC4X1_IFCPORT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPort : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcPort);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPort, IfcPort> object.
*/
typedef OdSmartPtr<IfcPort> IfcPortPtr;

} // namespace

#endif // _IFC4X1_IFCPORT_AUTO_IMPL_H
