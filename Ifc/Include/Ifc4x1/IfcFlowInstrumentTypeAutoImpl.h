...
#ifndef _IFC4X1_IFCFLOWINSTRUMENTTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCFLOWINSTRUMENTTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcFlowInstrumentType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcFlowInstrumentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcFlowInstrumentType, IfcFlowInstrumentType> object.
*/
typedef OdSmartPtr<IfcFlowInstrumentType> IfcFlowInstrumentTypePtr;

} // namespace

#endif // _IFC4X1_IFCFLOWINSTRUMENTTYPE_AUTO_IMPL_H
