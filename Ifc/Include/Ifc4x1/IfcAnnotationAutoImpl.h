...
#ifndef _IFC4X1_IFCANNOTATION_AUTO_IMPL_H
#define _IFC4X1_IFCANNOTATION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcAnnotation : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcAnnotation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcAnnotation, IfcAnnotation> object.
*/
typedef OdSmartPtr<IfcAnnotation> IfcAnnotationPtr;

} // namespace

#endif // _IFC4X1_IFCANNOTATION_AUTO_IMPL_H
