...
#ifndef _IFC4X1_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
#define _IFC4X1_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSurfaceOfLinearExtrusion : public IfcSweptSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSurfaceOfLinearExtrusion);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSurfaceOfLinearExtrusion, IfcSurfaceOfLinearExtrusion> object.
*/
typedef OdSmartPtr<IfcSurfaceOfLinearExtrusion> IfcSurfaceOfLinearExtrusionPtr;

} // namespace

#endif // _IFC4X1_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
