...
#ifndef _IFC4X1_IFCAIRTERMINAL_AUTO_IMPL_H
#define _IFC4X1_IFCAIRTERMINAL_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcAirTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcAirTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcAirTerminal, IfcAirTerminal> object.
*/
typedef OdSmartPtr<IfcAirTerminal> IfcAirTerminalPtr;

} // namespace

#endif // _IFC4X1_IFCAIRTERMINAL_AUTO_IMPL_H
