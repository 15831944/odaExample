...
#ifndef _IFC4X1_IFCSHAPEMODEL_AUTO_IMPL_H
#define _IFC4X1_IFCSHAPEMODEL_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcShapeModel : public IfcRepresentation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcShapeModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcShapeModel, IfcShapeModel> object.
*/
typedef OdSmartPtr<IfcShapeModel> IfcShapeModelPtr;

} // namespace

#endif // _IFC4X1_IFCSHAPEMODEL_AUTO_IMPL_H
