...
#ifndef _IFC4X1_IFCINTERCEPTOR_AUTO_IMPL_H
#define _IFC4X1_IFCINTERCEPTOR_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcInterceptor : public IfcFlowTreatmentDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcInterceptor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcInterceptor, IfcInterceptor> object.
*/
typedef OdSmartPtr<IfcInterceptor> IfcInterceptorPtr;

} // namespace

#endif // _IFC4X1_IFCINTERCEPTOR_AUTO_IMPL_H
