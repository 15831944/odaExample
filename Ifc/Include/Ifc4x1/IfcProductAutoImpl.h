...
#ifndef _IFC4X1_IFCPRODUCT_AUTO_IMPL_H
#define _IFC4X1_IFCPRODUCT_AUTO_IMPL_H
...
*/
class IFC4X1_EXPORT IfcProduct : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcProduct);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcProduct, IfcProduct> object.
*/
typedef OdSmartPtr<IfcProduct> IfcProductPtr;

} // namespace

#endif // _IFC4X1_IFCPRODUCT_AUTO_IMPL_H
