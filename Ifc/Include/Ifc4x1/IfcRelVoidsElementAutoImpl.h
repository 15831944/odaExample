...
#ifndef _IFC4X1_IFCRELVOIDSELEMENT_AUTO_IMPL_H
#define _IFC4X1_IFCRELVOIDSELEMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelVoidsElement : public IfcRelDecomposes
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelVoidsElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelVoidsElement, IfcRelVoidsElement> object.
*/
typedef OdSmartPtr<IfcRelVoidsElement> IfcRelVoidsElementPtr;

} // namespace

#endif // _IFC4X1_IFCRELVOIDSELEMENT_AUTO_IMPL_H
