...
#ifndef _IFC4X1_IFCDISTRIBUTIONSYSTEM_AUTO_IMPL_H
#define _IFC4X1_IFCDISTRIBUTIONSYSTEM_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcDistributionSystem : public IfcSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcDistributionSystem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcDistributionSystem, IfcDistributionSystem> object.
*/
typedef OdSmartPtr<IfcDistributionSystem> IfcDistributionSystemPtr;

} // namespace

#endif // _IFC4X1_IFCDISTRIBUTIONSYSTEM_AUTO_IMPL_H
