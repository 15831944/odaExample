...
#ifndef _IFC4X1_IFCREINFORCINGMESH_AUTO_IMPL_H
#define _IFC4X1_IFCREINFORCINGMESH_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcReinforcingMesh : public IfcReinforcingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcReinforcingMesh);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcReinforcingMesh, IfcReinforcingMesh> object.
*/
typedef OdSmartPtr<IfcReinforcingMesh> IfcReinforcingMeshPtr;

} // namespace

#endif // _IFC4X1_IFCREINFORCINGMESH_AUTO_IMPL_H
