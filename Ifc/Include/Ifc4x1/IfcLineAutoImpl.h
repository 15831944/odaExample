...
#ifndef _IFC4X1_IFCLINE_AUTO_IMPL_H
#define _IFC4X1_IFCLINE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcLine : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcLine);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcLine, IfcLine> object.
*/
typedef OdSmartPtr<IfcLine> IfcLinePtr;

} // namespace

#endif // _IFC4X1_IFCLINE_AUTO_IMPL_H
