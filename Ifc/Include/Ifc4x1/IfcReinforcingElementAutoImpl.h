...
#ifndef _IFC4X1_IFCREINFORCINGELEMENT_AUTO_IMPL_H
#define _IFC4X1_IFCREINFORCINGELEMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcReinforcingElement : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcReinforcingElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcReinforcingElement, IfcReinforcingElement> object.
*/
typedef OdSmartPtr<IfcReinforcingElement> IfcReinforcingElementPtr;

} // namespace

#endif // _IFC4X1_IFCREINFORCINGELEMENT_AUTO_IMPL_H
