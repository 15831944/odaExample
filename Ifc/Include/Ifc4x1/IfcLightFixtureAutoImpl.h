...
#ifndef _IFC4X1_IFCLIGHTFIXTURE_AUTO_IMPL_H
#define _IFC4X1_IFCLIGHTFIXTURE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcLightFixture : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcLightFixture);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcLightFixture, IfcLightFixture> object.
*/
typedef OdSmartPtr<IfcLightFixture> IfcLightFixturePtr;

} // namespace

#endif // _IFC4X1_IFCLIGHTFIXTURE_AUTO_IMPL_H
