...
#ifndef _IFC4X1_IFCDUCTSEGMENTTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCDUCTSEGMENTTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcDuctSegmentType : public IfcFlowSegmentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcDuctSegmentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcDuctSegmentType, IfcDuctSegmentType> object.
*/
typedef OdSmartPtr<IfcDuctSegmentType> IfcDuctSegmentTypePtr;

} // namespace

#endif // _IFC4X1_IFCDUCTSEGMENTTYPE_AUTO_IMPL_H
