...
#ifndef _IFC4X1_IFCMATERIALUSAGEDEFINITION_AUTO_IMPL_H
#define _IFC4X1_IFCMATERIALUSAGEDEFINITION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcMaterialUsageDefinition : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcMaterialUsageDefinition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcMaterialUsageDefinition, IfcMaterialUsageDefinition> object.
*/
typedef OdSmartPtr<IfcMaterialUsageDefinition> IfcMaterialUsageDefinitionPtr;

} // namespace

#endif // _IFC4X1_IFCMATERIALUSAGEDEFINITION_AUTO_IMPL_H
