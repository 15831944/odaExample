...
#ifndef _IFC4X1_IFCPROPERTYSET_AUTO_IMPL_H
#define _IFC4X1_IFCPROPERTYSET_AUTO_IMPL_H
...
*/
class IFC4X1_EXPORT IfcPropertySet : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPropertySet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPropertySet, IfcPropertySet> object.
*/
typedef OdSmartPtr<IfcPropertySet> IfcPropertySetPtr;

} // namespace

#endif // _IFC4X1_IFCPROPERTYSET_AUTO_IMPL_H
