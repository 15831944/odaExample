...
#ifndef _IFC4X1_IFCPROJECTIONELEMENT_AUTO_IMPL_H
#define _IFC4X1_IFCPROJECTIONELEMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcProjectionElement : public IfcFeatureElementAddition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcProjectionElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcProjectionElement, IfcProjectionElement> object.
*/
typedef OdSmartPtr<IfcProjectionElement> IfcProjectionElementPtr;

} // namespace

#endif // _IFC4X1_IFCPROJECTIONELEMENT_AUTO_IMPL_H
