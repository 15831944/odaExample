...
#ifndef _IFC4X1_IFCSWEPTDISKSOLID_AUTO_IMPL_H
#define _IFC4X1_IFCSWEPTDISKSOLID_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSweptDiskSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSweptDiskSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSweptDiskSolid, IfcSweptDiskSolid> object.
*/
typedef OdSmartPtr<IfcSweptDiskSolid> IfcSweptDiskSolidPtr;

} // namespace

#endif // _IFC4X1_IFCSWEPTDISKSOLID_AUTO_IMPL_H
