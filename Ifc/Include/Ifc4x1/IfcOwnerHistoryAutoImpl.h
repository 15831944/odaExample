...
#ifndef _IFC4X1_IFCOWNERHISTORY_AUTO_IMPL_H
#define _IFC4X1_IFCOWNERHISTORY_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcOwnerHistory : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcOwnerHistory);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcOwnerHistory, IfcOwnerHistory> object.
*/
typedef OdSmartPtr<IfcOwnerHistory> IfcOwnerHistoryPtr;

} // namespace

#endif // _IFC4X1_IFCOWNERHISTORY_AUTO_IMPL_H
