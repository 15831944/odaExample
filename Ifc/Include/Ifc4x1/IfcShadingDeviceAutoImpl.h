...
#ifndef _IFC4X1_IFCSHADINGDEVICE_AUTO_IMPL_H
#define _IFC4X1_IFCSHADINGDEVICE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcShadingDevice : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcShadingDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcShadingDevice, IfcShadingDevice> object.
*/
typedef OdSmartPtr<IfcShadingDevice> IfcShadingDevicePtr;

} // namespace

#endif // _IFC4X1_IFCSHADINGDEVICE_AUTO_IMPL_H
