...
#ifndef _IFC4X1_IFCSTRUCTURALSURFACEMEMBER_AUTO_IMPL_H
#define _IFC4X1_IFCSTRUCTURALSURFACEMEMBER_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcStructuralSurfaceMember : public IfcStructuralMember
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcStructuralSurfaceMember);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcStructuralSurfaceMember, IfcStructuralSurfaceMember> object.
*/
typedef OdSmartPtr<IfcStructuralSurfaceMember> IfcStructuralSurfaceMemberPtr;

} // namespace

#endif // _IFC4X1_IFCSTRUCTURALSURFACEMEMBER_AUTO_IMPL_H
