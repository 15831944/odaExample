...
#ifndef _IFC4X1_IFCPRESENTATIONITEM_AUTO_IMPL_H
#define _IFC4X1_IFCPRESENTATIONITEM_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPresentationItem : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcPresentationItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPresentationItem, IfcPresentationItem> object.
*/
typedef OdSmartPtr<IfcPresentationItem> IfcPresentationItemPtr;

} // namespace

#endif // _IFC4X1_IFCPRESENTATIONITEM_AUTO_IMPL_H
