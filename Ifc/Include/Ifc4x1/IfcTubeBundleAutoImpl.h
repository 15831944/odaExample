...
#ifndef _IFC4X1_IFCTUBEBUNDLE_AUTO_IMPL_H
#define _IFC4X1_IFCTUBEBUNDLE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcTubeBundle : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcTubeBundle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcTubeBundle, IfcTubeBundle> object.
*/
typedef OdSmartPtr<IfcTubeBundle> IfcTubeBundlePtr;

} // namespace

#endif // _IFC4X1_IFCTUBEBUNDLE_AUTO_IMPL_H
