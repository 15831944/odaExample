...
#ifndef _IFC4X1_IFCRELCONNECTSWITHREALIZINGELEMENTS_AUTO_IMPL_H
#define _IFC4X1_IFCRELCONNECTSWITHREALIZINGELEMENTS_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelConnectsWithRealizingElements : public IfcRelConnectsElements
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelConnectsWithRealizingElements);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelConnectsWithRealizingElements, IfcRelConnectsWithRealizingElements> object.
*/
typedef OdSmartPtr<IfcRelConnectsWithRealizingElements> IfcRelConnectsWithRealizingElementsPtr;

} // namespace

#endif // _IFC4X1_IFCRELCONNECTSWITHREALIZINGELEMENTS_AUTO_IMPL_H
