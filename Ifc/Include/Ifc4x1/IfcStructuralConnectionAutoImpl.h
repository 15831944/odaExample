...
#ifndef _IFC4X1_IFCSTRUCTURALCONNECTION_AUTO_IMPL_H
#define _IFC4X1_IFCSTRUCTURALCONNECTION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcStructuralConnection : public IfcStructuralItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcStructuralConnection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcStructuralConnection, IfcStructuralConnection> object.
*/
typedef OdSmartPtr<IfcStructuralConnection> IfcStructuralConnectionPtr;

} // namespace

#endif // _IFC4X1_IFCSTRUCTURALCONNECTION_AUTO_IMPL_H
