...
#ifndef _IFC4X1_IFCAPPLICATION_AUTO_IMPL_H
#define _IFC4X1_IFCAPPLICATION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcApplication : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcApplication);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcApplication, IfcApplication> object.
*/
typedef OdSmartPtr<IfcApplication> IfcApplicationPtr;

} // namespace

#endif // _IFC4X1_IFCAPPLICATION_AUTO_IMPL_H
