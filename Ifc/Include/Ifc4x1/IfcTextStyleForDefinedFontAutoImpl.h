...
#ifndef _IFC4X1_IFCTEXTSTYLEFORDEFINEDFONT_AUTO_IMPL_H
#define _IFC4X1_IFCTEXTSTYLEFORDEFINEDFONT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcTextStyleForDefinedFont : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcTextStyleForDefinedFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcTextStyleForDefinedFont, IfcTextStyleForDefinedFont> object.
*/
typedef OdSmartPtr<IfcTextStyleForDefinedFont> IfcTextStyleForDefinedFontPtr;

} // namespace

#endif // _IFC4X1_IFCTEXTSTYLEFORDEFINEDFONT_AUTO_IMPL_H
