...
#ifndef _IFC4X1_IFCOFFSETCURVEBYDISTANCES_AUTO_IMPL_H
#define _IFC4X1_IFCOFFSETCURVEBYDISTANCES_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcOffsetCurveByDistances : public IfcOffsetCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcOffsetCurveByDistances);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcOffsetCurveByDistances, IfcOffsetCurveByDistances> object.
*/
typedef OdSmartPtr<IfcOffsetCurveByDistances> IfcOffsetCurveByDistancesPtr;

} // namespace

#endif // _IFC4X1_IFCOFFSETCURVEBYDISTANCES_AUTO_IMPL_H
