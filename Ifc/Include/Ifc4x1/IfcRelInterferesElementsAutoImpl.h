...
#ifndef _IFC4X1_IFCRELINTERFERESELEMENTS_AUTO_IMPL_H
#define _IFC4X1_IFCRELINTERFERESELEMENTS_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelInterferesElements : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelInterferesElements);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelInterferesElements, IfcRelInterferesElements> object.
*/
typedef OdSmartPtr<IfcRelInterferesElements> IfcRelInterferesElementsPtr;

} // namespace

#endif // _IFC4X1_IFCRELINTERFERESELEMENTS_AUTO_IMPL_H
