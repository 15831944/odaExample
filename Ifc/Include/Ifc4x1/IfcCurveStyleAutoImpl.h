...
#ifndef _IFC4X1_IFCCURVESTYLE_AUTO_IMPL_H
#define _IFC4X1_IFCCURVESTYLE_AUTO_IMPL_H
...
*/
class IFC4X1_EXPORT IfcCurveStyle : public IfcPresentationStyle
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCurveStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCurveStyle, IfcCurveStyle> object.
*/
typedef OdSmartPtr<IfcCurveStyle> IfcCurveStylePtr;

} // namespace

#endif // _IFC4X1_IFCCURVESTYLE_AUTO_IMPL_H
