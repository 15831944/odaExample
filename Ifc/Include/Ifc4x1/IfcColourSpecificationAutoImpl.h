...
#ifndef _IFC4X1_IFCCOLOURSPECIFICATION_AUTO_IMPL_H
#define _IFC4X1_IFCCOLOURSPECIFICATION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcColourSpecification : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcColourSpecification);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcColourSpecification, IfcColourSpecification> object.
*/
typedef OdSmartPtr<IfcColourSpecification> IfcColourSpecificationPtr;

} // namespace

#endif // _IFC4X1_IFCCOLOURSPECIFICATION_AUTO_IMPL_H
