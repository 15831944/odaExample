...
#ifndef _IFC4X1_IFCPROCESS_AUTO_IMPL_H
#define _IFC4X1_IFCPROCESS_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcProcess : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcProcess);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcProcess, IfcProcess> object.
*/
typedef OdSmartPtr<IfcProcess> IfcProcessPtr;

} // namespace

#endif // _IFC4X1_IFCPROCESS_AUTO_IMPL_H
