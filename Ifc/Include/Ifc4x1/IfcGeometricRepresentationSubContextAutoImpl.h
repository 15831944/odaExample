...
#ifndef _IFC4X1_IFCGEOMETRICREPRESENTATIONSUBCONTEXT_AUTO_IMPL_H
#define _IFC4X1_IFCGEOMETRICREPRESENTATIONSUBCONTEXT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcGeometricRepresentationSubContext : public IfcGeometricRepresentationContext
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcGeometricRepresentationSubContext);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcGeometricRepresentationSubContext, IfcGeometricRepresentationSubContext> object.
*/
typedef OdSmartPtr<IfcGeometricRepresentationSubContext> IfcGeometricRepresentationSubContextPtr;

} // namespace

#endif // _IFC4X1_IFCGEOMETRICREPRESENTATIONSUBCONTEXT_AUTO_IMPL_H
