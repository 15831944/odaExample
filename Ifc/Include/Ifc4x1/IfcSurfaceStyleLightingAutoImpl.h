...
#ifndef _IFC4X1_IFCSURFACESTYLELIGHTING_AUTO_IMPL_H
#define _IFC4X1_IFCSURFACESTYLELIGHTING_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSurfaceStyleLighting : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSurfaceStyleLighting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSurfaceStyleLighting, IfcSurfaceStyleLighting> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleLighting> IfcSurfaceStyleLightingPtr;

} // namespace

#endif // _IFC4X1_IFCSURFACESTYLELIGHTING_AUTO_IMPL_H
