...
#ifndef _IFC4X1_IFCCREWRESOURCETYPE_AUTO_IMPL_H
#define _IFC4X1_IFCCREWRESOURCETYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCrewResourceType : public IfcConstructionResourceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCrewResourceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCrewResourceType, IfcCrewResourceType> object.
*/
typedef OdSmartPtr<IfcCrewResourceType> IfcCrewResourceTypePtr;

} // namespace

#endif // _IFC4X1_IFCCREWRESOURCETYPE_AUTO_IMPL_H
