...
#ifndef _IFC4X1_IFCRELASSOCIATESLIBRARY_AUTO_IMPL_H
#define _IFC4X1_IFCRELASSOCIATESLIBRARY_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelAssociatesLibrary : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelAssociatesLibrary);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelAssociatesLibrary, IfcRelAssociatesLibrary> object.
*/
typedef OdSmartPtr<IfcRelAssociatesLibrary> IfcRelAssociatesLibraryPtr;

} // namespace

#endif // _IFC4X1_IFCRELASSOCIATESLIBRARY_AUTO_IMPL_H
