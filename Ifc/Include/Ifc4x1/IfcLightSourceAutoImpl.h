...
#ifndef _IFC4X1_IFCLIGHTSOURCE_AUTO_IMPL_H
#define _IFC4X1_IFCLIGHTSOURCE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcLightSource : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcLightSource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcLightSource, IfcLightSource> object.
*/
typedef OdSmartPtr<IfcLightSource> IfcLightSourcePtr;

} // namespace

#endif // _IFC4X1_IFCLIGHTSOURCE_AUTO_IMPL_H
