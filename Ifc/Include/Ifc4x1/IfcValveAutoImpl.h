...
#ifndef _IFC4X1_IFCVALVE_AUTO_IMPL_H
#define _IFC4X1_IFCVALVE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcValve : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcValve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcValve, IfcValve> object.
*/
typedef OdSmartPtr<IfcValve> IfcValvePtr;

} // namespace

#endif // _IFC4X1_IFCVALVE_AUTO_IMPL_H
