...
#ifndef _IFC4X1_IFCMATERIALLAYERSET_AUTO_IMPL_H
#define _IFC4X1_IFCMATERIALLAYERSET_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcMaterialLayerSet : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcMaterialLayerSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcMaterialLayerSet, IfcMaterialLayerSet> object.
*/
typedef OdSmartPtr<IfcMaterialLayerSet> IfcMaterialLayerSetPtr;

} // namespace

#endif // _IFC4X1_IFCMATERIALLAYERSET_AUTO_IMPL_H
