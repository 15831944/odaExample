...
#ifndef _IFC4X1_IFCPROPERTYDEPENDENCYRELATIONSHIP_AUTO_IMPL_H
#define _IFC4X1_IFCPROPERTYDEPENDENCYRELATIONSHIP_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPropertyDependencyRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPropertyDependencyRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPropertyDependencyRelationship, IfcPropertyDependencyRelationship> object.
*/
typedef OdSmartPtr<IfcPropertyDependencyRelationship> IfcPropertyDependencyRelationshipPtr;

} // namespace

#endif // _IFC4X1_IFCPROPERTYDEPENDENCYRELATIONSHIP_AUTO_IMPL_H
