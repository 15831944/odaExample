...
#ifndef _IFC4X1_IFCCOSTITEM_AUTO_IMPL_H
#define _IFC4X1_IFCCOSTITEM_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCostItem : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCostItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCostItem, IfcCostItem> object.
*/
typedef OdSmartPtr<IfcCostItem> IfcCostItemPtr;

} // namespace

#endif // _IFC4X1_IFCCOSTITEM_AUTO_IMPL_H
