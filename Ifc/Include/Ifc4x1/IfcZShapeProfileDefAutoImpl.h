...
#ifndef _IFC4X1_IFCZSHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X1_IFCZSHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcZShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcZShapeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcZShapeProfileDef, IfcZShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcZShapeProfileDef> IfcZShapeProfileDefPtr;

} // namespace

#endif // _IFC4X1_IFCZSHAPEPROFILEDEF_AUTO_IMPL_H
