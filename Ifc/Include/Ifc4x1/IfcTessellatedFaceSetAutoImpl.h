...
#ifndef _IFC4X1_IFCTESSELLATEDFACESET_AUTO_IMPL_H
#define _IFC4X1_IFCTESSELLATEDFACESET_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcTessellatedFaceSet : public IfcTessellatedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcTessellatedFaceSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcTessellatedFaceSet, IfcTessellatedFaceSet> object.
*/
typedef OdSmartPtr<IfcTessellatedFaceSet> IfcTessellatedFaceSetPtr;

} // namespace

#endif // _IFC4X1_IFCTESSELLATEDFACESET_AUTO_IMPL_H
