...
#ifndef _IFC4X1_IFCEVAPORATOR_AUTO_IMPL_H
#define _IFC4X1_IFCEVAPORATOR_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcEvaporator : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcEvaporator);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcEvaporator, IfcEvaporator> object.
*/
typedef OdSmartPtr<IfcEvaporator> IfcEvaporatorPtr;

} // namespace

#endif // _IFC4X1_IFCEVAPORATOR_AUTO_IMPL_H
