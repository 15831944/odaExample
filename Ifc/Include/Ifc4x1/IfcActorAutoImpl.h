...
#ifndef _IFC4X1_IFCACTOR_AUTO_IMPL_H
#define _IFC4X1_IFCACTOR_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcActor : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcActor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcActor, IfcActor> object.
*/
typedef OdSmartPtr<IfcActor> IfcActorPtr;

} // namespace

#endif // _IFC4X1_IFCACTOR_AUTO_IMPL_H
