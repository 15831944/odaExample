...
#ifndef _IFC4X1_IFCMATERIALLAYERSETUSAGE_AUTO_IMPL_H
#define _IFC4X1_IFCMATERIALLAYERSETUSAGE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcMaterialLayerSetUsage : public IfcMaterialUsageDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcMaterialLayerSetUsage);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcMaterialLayerSetUsage, IfcMaterialLayerSetUsage> object.
*/
typedef OdSmartPtr<IfcMaterialLayerSetUsage> IfcMaterialLayerSetUsagePtr;

} // namespace

#endif // _IFC4X1_IFCMATERIALLAYERSETUSAGE_AUTO_IMPL_H
