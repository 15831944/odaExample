...
#ifndef _IFC4X1_IFCFLOWMETER_AUTO_IMPL_H
#define _IFC4X1_IFCFLOWMETER_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcFlowMeter : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcFlowMeter);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcFlowMeter, IfcFlowMeter> object.
*/
typedef OdSmartPtr<IfcFlowMeter> IfcFlowMeterPtr;

} // namespace

#endif // _IFC4X1_IFCFLOWMETER_AUTO_IMPL_H
