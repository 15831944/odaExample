...
#ifndef _IFC4X1_IFCRECTANGULARTRIMMEDSURFACE_AUTO_IMPL_H
#define _IFC4X1_IFCRECTANGULARTRIMMEDSURFACE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRectangularTrimmedSurface : public IfcBoundedSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRectangularTrimmedSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRectangularTrimmedSurface, IfcRectangularTrimmedSurface> object.
*/
typedef OdSmartPtr<IfcRectangularTrimmedSurface> IfcRectangularTrimmedSurfacePtr;

} // namespace

#endif // _IFC4X1_IFCRECTANGULARTRIMMEDSURFACE_AUTO_IMPL_H
