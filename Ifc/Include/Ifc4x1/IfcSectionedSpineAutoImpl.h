...
#ifndef _IFC4X1_IFCSECTIONEDSPINE_AUTO_IMPL_H
#define _IFC4X1_IFCSECTIONEDSPINE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSectionedSpine : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSectionedSpine);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSectionedSpine, IfcSectionedSpine> object.
*/
typedef OdSmartPtr<IfcSectionedSpine> IfcSectionedSpinePtr;

} // namespace

#endif // _IFC4X1_IFCSECTIONEDSPINE_AUTO_IMPL_H
