...
#ifndef _IFC4X1_IFCEXTRUDEDAREASOLIDTAPERED_AUTO_IMPL_H
#define _IFC4X1_IFCEXTRUDEDAREASOLIDTAPERED_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcExtrudedAreaSolidTapered : public IfcExtrudedAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcExtrudedAreaSolidTapered);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcExtrudedAreaSolidTapered, IfcExtrudedAreaSolidTapered> object.
*/
typedef OdSmartPtr<IfcExtrudedAreaSolidTapered> IfcExtrudedAreaSolidTaperedPtr;

} // namespace

#endif // _IFC4X1_IFCEXTRUDEDAREASOLIDTAPERED_AUTO_IMPL_H
