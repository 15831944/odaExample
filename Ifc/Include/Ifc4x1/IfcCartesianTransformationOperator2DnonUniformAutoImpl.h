...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCartesianTransformationOperator2DnonUniform, IfcCartesianTransformationOperator2DnonUniform> object.
*/
