...
#ifndef _IFC4X1_IFCMEDICALDEVICE_AUTO_IMPL_H
#define _IFC4X1_IFCMEDICALDEVICE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcMedicalDevice : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcMedicalDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcMedicalDevice, IfcMedicalDevice> object.
*/
typedef OdSmartPtr<IfcMedicalDevice> IfcMedicalDevicePtr;

} // namespace

#endif // _IFC4X1_IFCMEDICALDEVICE_AUTO_IMPL_H
