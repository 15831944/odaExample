...
#ifndef _IFC4X1_IFCBOUNDINGBOX_AUTO_IMPL_H
#define _IFC4X1_IFCBOUNDINGBOX_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcBoundingBox : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcBoundingBox);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcBoundingBox, IfcBoundingBox> object.
*/
typedef OdSmartPtr<IfcBoundingBox> IfcBoundingBoxPtr;

} // namespace

#endif // _IFC4X1_IFCBOUNDINGBOX_AUTO_IMPL_H
