...
#ifndef _IFC4X1_IFCJUNCTIONBOX_AUTO_IMPL_H
#define _IFC4X1_IFCJUNCTIONBOX_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcJunctionBox : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcJunctionBox);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcJunctionBox, IfcJunctionBox> object.
*/
typedef OdSmartPtr<IfcJunctionBox> IfcJunctionBoxPtr;

} // namespace

#endif // _IFC4X1_IFCJUNCTIONBOX_AUTO_IMPL_H
