...
#ifndef _IFC4X1_IFCWORKCALENDAR_AUTO_IMPL_H
#define _IFC4X1_IFCWORKCALENDAR_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcWorkCalendar : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcWorkCalendar);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcWorkCalendar, IfcWorkCalendar> object.
*/
typedef OdSmartPtr<IfcWorkCalendar> IfcWorkCalendarPtr;

} // namespace

#endif // _IFC4X1_IFCWORKCALENDAR_AUTO_IMPL_H
