...
#ifndef _IFC4X1_IFCCOMPLEXPROPERTY_AUTO_IMPL_H
#define _IFC4X1_IFCCOMPLEXPROPERTY_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcComplexProperty : public IfcProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcComplexProperty);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcComplexProperty, IfcComplexProperty> object.
*/
typedef OdSmartPtr<IfcComplexProperty> IfcComplexPropertyPtr;

} // namespace

#endif // _IFC4X1_IFCCOMPLEXPROPERTY_AUTO_IMPL_H
