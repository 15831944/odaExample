...
#ifndef _IFC4X1_IFCOBJECTDEFINITION_AUTO_IMPL_H
#define _IFC4X1_IFCOBJECTDEFINITION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcObjectDefinition : public IfcRoot
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcObjectDefinition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcObjectDefinition, IfcObjectDefinition> object.
*/
typedef OdSmartPtr<IfcObjectDefinition> IfcObjectDefinitionPtr;

} // namespace

#endif // _IFC4X1_IFCOBJECTDEFINITION_AUTO_IMPL_H
