...
#ifndef _IFC4X1_IFCMANIFOLDSOLIDBREP_AUTO_IMPL_H
#define _IFC4X1_IFCMANIFOLDSOLIDBREP_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcManifoldSolidBrep : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcManifoldSolidBrep);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcManifoldSolidBrep, IfcManifoldSolidBrep> object.
*/
typedef OdSmartPtr<IfcManifoldSolidBrep> IfcManifoldSolidBrepPtr;

} // namespace

#endif // _IFC4X1_IFCMANIFOLDSOLIDBREP_AUTO_IMPL_H
