...
#ifndef _IFC4X1_IFCDUCTSILENCER_AUTO_IMPL_H
#define _IFC4X1_IFCDUCTSILENCER_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcDuctSilencer : public IfcFlowTreatmentDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcDuctSilencer);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcDuctSilencer, IfcDuctSilencer> object.
*/
typedef OdSmartPtr<IfcDuctSilencer> IfcDuctSilencerPtr;

} // namespace

#endif // _IFC4X1_IFCDUCTSILENCER_AUTO_IMPL_H
