...
#ifndef _IFC4X1_IFCFANTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCFANTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcFanType : public IfcFlowMovingDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcFanType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcFanType, IfcFanType> object.
*/
typedef OdSmartPtr<IfcFanType> IfcFanTypePtr;

} // namespace

#endif // _IFC4X1_IFCFANTYPE_AUTO_IMPL_H
