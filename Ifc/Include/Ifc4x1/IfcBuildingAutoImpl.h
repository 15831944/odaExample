...
#ifndef _IFC4X1_IFCBUILDING_AUTO_IMPL_H
#define _IFC4X1_IFCBUILDING_AUTO_IMPL_H
...
*/
class IFC4X1_EXPORT IfcBuilding : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcBuilding);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcBuilding, IfcBuilding> object.
*/
typedef OdSmartPtr<IfcBuilding> IfcBuildingPtr;

} // namespace

#endif // _IFC4X1_IFCBUILDING_AUTO_IMPL_H
