...
#ifndef _IFC4X1_IFCSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
#define _IFC4X1_IFCSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSpatialStructureElement : public IfcSpatialElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcSpatialStructureElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSpatialStructureElement, IfcSpatialStructureElement> object.
*/
typedef OdSmartPtr<IfcSpatialStructureElement> IfcSpatialStructureElementPtr;

} // namespace

#endif // _IFC4X1_IFCSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
