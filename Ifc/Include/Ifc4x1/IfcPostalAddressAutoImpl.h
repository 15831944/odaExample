...
#ifndef _IFC4X1_IFCPOSTALADDRESS_AUTO_IMPL_H
#define _IFC4X1_IFCPOSTALADDRESS_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPostalAddress : public IfcAddress
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPostalAddress);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPostalAddress, IfcPostalAddress> object.
*/
typedef OdSmartPtr<IfcPostalAddress> IfcPostalAddressPtr;

} // namespace

#endif // _IFC4X1_IFCPOSTALADDRESS_AUTO_IMPL_H
