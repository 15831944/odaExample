...
#ifndef _IFC4X1_IFCEVENTTIME_AUTO_IMPL_H
#define _IFC4X1_IFCEVENTTIME_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcEventTime : public IfcSchedulingTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcEventTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcEventTime, IfcEventTime> object.
*/
typedef OdSmartPtr<IfcEventTime> IfcEventTimePtr;

} // namespace

#endif // _IFC4X1_IFCEVENTTIME_AUTO_IMPL_H
