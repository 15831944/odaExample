...
#ifndef _IFC4X1_IFCRELASSOCIATESDOCUMENT_AUTO_IMPL_H
#define _IFC4X1_IFCRELASSOCIATESDOCUMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelAssociatesDocument : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelAssociatesDocument);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelAssociatesDocument, IfcRelAssociatesDocument> object.
*/
typedef OdSmartPtr<IfcRelAssociatesDocument> IfcRelAssociatesDocumentPtr;

} // namespace

#endif // _IFC4X1_IFCRELASSOCIATESDOCUMENT_AUTO_IMPL_H
