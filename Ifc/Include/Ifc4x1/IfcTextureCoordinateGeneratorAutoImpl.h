...
#ifndef _IFC4X1_IFCTEXTURECOORDINATEGENERATOR_AUTO_IMPL_H
#define _IFC4X1_IFCTEXTURECOORDINATEGENERATOR_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcTextureCoordinateGenerator : public IfcTextureCoordinate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcTextureCoordinateGenerator);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcTextureCoordinateGenerator, IfcTextureCoordinateGenerator> object.
*/
typedef OdSmartPtr<IfcTextureCoordinateGenerator> IfcTextureCoordinateGeneratorPtr;

} // namespace

#endif // _IFC4X1_IFCTEXTURECOORDINATEGENERATOR_AUTO_IMPL_H
