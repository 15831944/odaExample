...
#ifndef _IFC4X1_IFCLIGHTSOURCEPOSITIONAL_AUTO_IMPL_H
#define _IFC4X1_IFCLIGHTSOURCEPOSITIONAL_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcLightSourcePositional : public IfcLightSource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcLightSourcePositional);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcLightSourcePositional, IfcLightSourcePositional> object.
*/
typedef OdSmartPtr<IfcLightSourcePositional> IfcLightSourcePositionalPtr;

} // namespace

#endif // _IFC4X1_IFCLIGHTSOURCEPOSITIONAL_AUTO_IMPL_H
