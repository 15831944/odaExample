...
#ifndef _IFC4X1_IFCRELCONNECTSELEMENTS_AUTO_IMPL_H
#define _IFC4X1_IFCRELCONNECTSELEMENTS_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelConnectsElements : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelConnectsElements);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelConnectsElements, IfcRelConnectsElements> object.
*/
typedef OdSmartPtr<IfcRelConnectsElements> IfcRelConnectsElementsPtr;

} // namespace

#endif // _IFC4X1_IFCRELCONNECTSELEMENTS_AUTO_IMPL_H
