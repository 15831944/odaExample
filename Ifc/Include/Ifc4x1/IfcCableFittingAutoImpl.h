...
#ifndef _IFC4X1_IFCCABLEFITTING_AUTO_IMPL_H
#define _IFC4X1_IFCCABLEFITTING_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCableFitting : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCableFitting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCableFitting, IfcCableFitting> object.
*/
typedef OdSmartPtr<IfcCableFitting> IfcCableFittingPtr;

} // namespace

#endif // _IFC4X1_IFCCABLEFITTING_AUTO_IMPL_H
