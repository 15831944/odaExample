...
#ifndef _IFC4X1_IFCDISCRETEACCESSORYTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCDISCRETEACCESSORYTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcDiscreteAccessoryType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcDiscreteAccessoryType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcDiscreteAccessoryType, IfcDiscreteAccessoryType> object.
*/
typedef OdSmartPtr<IfcDiscreteAccessoryType> IfcDiscreteAccessoryTypePtr;

} // namespace

#endif // _IFC4X1_IFCDISCRETEACCESSORYTYPE_AUTO_IMPL_H
