...
#ifndef _IFC4X1_IFCSTRUCTURALREACTION_AUTO_IMPL_H
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcStructuralReaction, IfcStructuralReaction> object.
*/
