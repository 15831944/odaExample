...
#ifndef _IFC4X1_IFCBLOBTEXTURE_AUTO_IMPL_H
#define _IFC4X1_IFCBLOBTEXTURE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcBlobTexture : public IfcSurfaceTexture
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcBlobTexture);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcBlobTexture, IfcBlobTexture> object.
*/
typedef OdSmartPtr<IfcBlobTexture> IfcBlobTexturePtr;

} // namespace

#endif // _IFC4X1_IFCBLOBTEXTURE_AUTO_IMPL_H
