...
#ifndef _IFC4X1_IFCSUBCONTRACTRESOURCE_AUTO_IMPL_H
#define _IFC4X1_IFCSUBCONTRACTRESOURCE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSubContractResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSubContractResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSubContractResource, IfcSubContractResource> object.
*/
typedef OdSmartPtr<IfcSubContractResource> IfcSubContractResourcePtr;

} // namespace

#endif // _IFC4X1_IFCSUBCONTRACTRESOURCE_AUTO_IMPL_H
