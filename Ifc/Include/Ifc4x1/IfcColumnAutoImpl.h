...
#ifndef _IFC4X1_IFCCOLUMN_AUTO_IMPL_H
#define _IFC4X1_IFCCOLUMN_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcColumn : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcColumn);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcColumn, IfcColumn> object.
*/
typedef OdSmartPtr<IfcColumn> IfcColumnPtr;

} // namespace

#endif // _IFC4X1_IFCCOLUMN_AUTO_IMPL_H
