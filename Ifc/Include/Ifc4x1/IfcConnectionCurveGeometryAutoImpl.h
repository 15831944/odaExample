...
#ifndef _IFC4X1_IFCCONNECTIONCURVEGEOMETRY_AUTO_IMPL_H
#define _IFC4X1_IFCCONNECTIONCURVEGEOMETRY_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcConnectionCurveGeometry : public IfcConnectionGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcConnectionCurveGeometry);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcConnectionCurveGeometry, IfcConnectionCurveGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionCurveGeometry> IfcConnectionCurveGeometryPtr;

} // namespace

#endif // _IFC4X1_IFCCONNECTIONCURVEGEOMETRY_AUTO_IMPL_H
