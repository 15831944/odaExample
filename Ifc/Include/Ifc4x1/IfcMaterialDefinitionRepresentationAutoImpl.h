...
#ifndef _IFC4X1_IFCMATERIALDEFINITIONREPRESENTATION_AUTO_IMPL_H
#define _IFC4X1_IFCMATERIALDEFINITIONREPRESENTATION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcMaterialDefinitionRepresentation : public IfcProductRepresentation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcMaterialDefinitionRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcMaterialDefinitionRepresentation, IfcMaterialDefinitionRepresentation> object.
*/
typedef OdSmartPtr<IfcMaterialDefinitionRepresentation> IfcMaterialDefinitionRepresentationPtr;

} // namespace

#endif // _IFC4X1_IFCMATERIALDEFINITIONREPRESENTATION_AUTO_IMPL_H
