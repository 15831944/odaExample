...
#ifndef _IFC4X1_IFCRELDEFINESBYOBJECT_AUTO_IMPL_H
#define _IFC4X1_IFCRELDEFINESBYOBJECT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelDefinesByObject : public IfcRelDefines
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelDefinesByObject);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelDefinesByObject, IfcRelDefinesByObject> object.
*/
typedef OdSmartPtr<IfcRelDefinesByObject> IfcRelDefinesByObjectPtr;

} // namespace

#endif // _IFC4X1_IFCRELDEFINESBYOBJECT_AUTO_IMPL_H
