...
#ifndef _IFC4X1_IFCLAMP_AUTO_IMPL_H
#define _IFC4X1_IFCLAMP_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcLamp : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcLamp);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcLamp, IfcLamp> object.
*/
typedef OdSmartPtr<IfcLamp> IfcLampPtr;

} // namespace

#endif // _IFC4X1_IFCLAMP_AUTO_IMPL_H
