...
#ifndef _IFC4X1_IFCCOIL_AUTO_IMPL_H
#define _IFC4X1_IFCCOIL_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCoil : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCoil);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCoil, IfcCoil> object.
*/
typedef OdSmartPtr<IfcCoil> IfcCoilPtr;

} // namespace

#endif // _IFC4X1_IFCCOIL_AUTO_IMPL_H
