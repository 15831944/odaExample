...
#ifndef _IFC4X1_IFCOUTLETTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCOUTLETTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcOutletType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcOutletType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcOutletType, IfcOutletType> object.
*/
typedef OdSmartPtr<IfcOutletType> IfcOutletTypePtr;

} // namespace

#endif // _IFC4X1_IFCOUTLETTYPE_AUTO_IMPL_H
