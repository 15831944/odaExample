...
#ifndef _IFC4X1_IFCSTACKTERMINALTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCSTACKTERMINALTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcStackTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcStackTerminalType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcStackTerminalType, IfcStackTerminalType> object.
*/
typedef OdSmartPtr<IfcStackTerminalType> IfcStackTerminalTypePtr;

} // namespace

#endif // _IFC4X1_IFCSTACKTERMINALTYPE_AUTO_IMPL_H
