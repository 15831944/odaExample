...
#ifndef _IFC4X1_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
#define _IFC4X1_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPermeableCoveringProperties : public IfcPreDefinedPropertySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPermeableCoveringProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPermeableCoveringProperties, IfcPermeableCoveringProperties> object.
*/
typedef OdSmartPtr<IfcPermeableCoveringProperties> IfcPermeableCoveringPropertiesPtr;

} // namespace

#endif // _IFC4X1_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
