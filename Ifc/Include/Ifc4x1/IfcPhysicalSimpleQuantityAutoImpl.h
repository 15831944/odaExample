...
#ifndef _IFC4X1_IFCPHYSICALSIMPLEQUANTITY_AUTO_IMPL_H
#define _IFC4X1_IFCPHYSICALSIMPLEQUANTITY_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPhysicalSimpleQuantity : public IfcPhysicalQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcPhysicalSimpleQuantity);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPhysicalSimpleQuantity, IfcPhysicalSimpleQuantity> object.
*/
typedef OdSmartPtr<IfcPhysicalSimpleQuantity> IfcPhysicalSimpleQuantityPtr;

} // namespace

#endif // _IFC4X1_IFCPHYSICALSIMPLEQUANTITY_AUTO_IMPL_H
