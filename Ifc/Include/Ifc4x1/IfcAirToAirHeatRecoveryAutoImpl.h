...
#ifndef _IFC4X1_IFCAIRTOAIRHEATRECOVERY_AUTO_IMPL_H
#define _IFC4X1_IFCAIRTOAIRHEATRECOVERY_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcAirToAirHeatRecovery : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcAirToAirHeatRecovery);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcAirToAirHeatRecovery, IfcAirToAirHeatRecovery> object.
*/
typedef OdSmartPtr<IfcAirToAirHeatRecovery> IfcAirToAirHeatRecoveryPtr;

} // namespace

#endif // _IFC4X1_IFCAIRTOAIRHEATRECOVERY_AUTO_IMPL_H
