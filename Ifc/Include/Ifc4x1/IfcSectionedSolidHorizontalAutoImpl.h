...
#ifndef _IFC4X1_IFCSECTIONEDSOLIDHORIZONTAL_AUTO_IMPL_H
#define _IFC4X1_IFCSECTIONEDSOLIDHORIZONTAL_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSectionedSolidHorizontal : public IfcSectionedSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSectionedSolidHorizontal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSectionedSolidHorizontal, IfcSectionedSolidHorizontal> object.
*/
typedef OdSmartPtr<IfcSectionedSolidHorizontal> IfcSectionedSolidHorizontalPtr;

} // namespace

#endif // _IFC4X1_IFCSECTIONEDSOLIDHORIZONTAL_AUTO_IMPL_H
