...
#ifndef _IFC4X1_IFCCURTAINWALLTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCCURTAINWALLTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCurtainWallType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCurtainWallType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCurtainWallType, IfcCurtainWallType> object.
*/
typedef OdSmartPtr<IfcCurtainWallType> IfcCurtainWallTypePtr;

} // namespace

#endif // _IFC4X1_IFCCURTAINWALLTYPE_AUTO_IMPL_H
