...
#ifndef _IFC4X1_IFCDOORLININGPROPERTIES_AUTO_IMPL_H
#define _IFC4X1_IFCDOORLININGPROPERTIES_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcDoorLiningProperties : public IfcPreDefinedPropertySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcDoorLiningProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcDoorLiningProperties, IfcDoorLiningProperties> object.
*/
typedef OdSmartPtr<IfcDoorLiningProperties> IfcDoorLiningPropertiesPtr;

} // namespace

#endif // _IFC4X1_IFCDOORLININGPROPERTIES_AUTO_IMPL_H
