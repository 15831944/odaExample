...
#ifndef _IFC4X1_IFCRECURRENCEPATTERN_AUTO_IMPL_H
#define _IFC4X1_IFCRECURRENCEPATTERN_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRecurrencePattern : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRecurrencePattern);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRecurrencePattern, IfcRecurrencePattern> object.
*/
typedef OdSmartPtr<IfcRecurrencePattern> IfcRecurrencePatternPtr;

} // namespace

#endif // _IFC4X1_IFCRECURRENCEPATTERN_AUTO_IMPL_H
