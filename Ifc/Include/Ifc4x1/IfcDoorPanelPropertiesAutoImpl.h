...
#ifndef _IFC4X1_IFCDOORPANELPROPERTIES_AUTO_IMPL_H
#define _IFC4X1_IFCDOORPANELPROPERTIES_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcDoorPanelProperties : public IfcPreDefinedPropertySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcDoorPanelProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcDoorPanelProperties, IfcDoorPanelProperties> object.
*/
typedef OdSmartPtr<IfcDoorPanelProperties> IfcDoorPanelPropertiesPtr;

} // namespace

#endif // _IFC4X1_IFCDOORPANELPROPERTIES_AUTO_IMPL_H
