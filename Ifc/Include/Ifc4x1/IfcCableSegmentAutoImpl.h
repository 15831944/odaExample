...
#ifndef _IFC4X1_IFCCABLESEGMENT_AUTO_IMPL_H
#define _IFC4X1_IFCCABLESEGMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCableSegment : public IfcFlowSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCableSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCableSegment, IfcCableSegment> object.
*/
typedef OdSmartPtr<IfcCableSegment> IfcCableSegmentPtr;

} // namespace

#endif // _IFC4X1_IFCCABLESEGMENT_AUTO_IMPL_H
