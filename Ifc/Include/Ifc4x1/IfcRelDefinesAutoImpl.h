...
#ifndef _IFC4X1_IFCRELDEFINES_AUTO_IMPL_H
#define _IFC4X1_IFCRELDEFINES_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelDefines : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcRelDefines);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelDefines, IfcRelDefines> object.
*/
typedef OdSmartPtr<IfcRelDefines> IfcRelDefinesPtr;

} // namespace

#endif // _IFC4X1_IFCRELDEFINES_AUTO_IMPL_H
