...
#ifndef _IFC4X1_IFCMATERIALPROPERTIES_AUTO_IMPL_H
#define _IFC4X1_IFCMATERIALPROPERTIES_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcMaterialProperties : public IfcExtendedProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcMaterialProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcMaterialProperties, IfcMaterialProperties> object.
*/
typedef OdSmartPtr<IfcMaterialProperties> IfcMaterialPropertiesPtr;

} // namespace

#endif // _IFC4X1_IFCMATERIALPROPERTIES_AUTO_IMPL_H
