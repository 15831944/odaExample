...
#ifndef _IFC4X1_IFCBUILDINGELEMENTPROXY_AUTO_IMPL_H
#define _IFC4X1_IFCBUILDINGELEMENTPROXY_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcBuildingElementProxy : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcBuildingElementProxy);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcBuildingElementProxy, IfcBuildingElementProxy> object.
*/
typedef OdSmartPtr<IfcBuildingElementProxy> IfcBuildingElementProxyPtr;

} // namespace

#endif // _IFC4X1_IFCBUILDINGELEMENTPROXY_AUTO_IMPL_H
