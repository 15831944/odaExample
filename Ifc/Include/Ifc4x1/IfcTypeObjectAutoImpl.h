...
#ifndef _IFC4X1_IFCTYPEOBJECT_AUTO_IMPL_H
#define _IFC4X1_IFCTYPEOBJECT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcTypeObject : public IfcObjectDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcTypeObject);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcTypeObject, IfcTypeObject> object.
*/
typedef OdSmartPtr<IfcTypeObject> IfcTypeObjectPtr;

} // namespace

#endif // _IFC4X1_IFCTYPEOBJECT_AUTO_IMPL_H
