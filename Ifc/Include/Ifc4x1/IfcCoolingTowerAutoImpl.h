...
#ifndef _IFC4X1_IFCCOOLINGTOWER_AUTO_IMPL_H
#define _IFC4X1_IFCCOOLINGTOWER_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCoolingTower : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCoolingTower);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCoolingTower, IfcCoolingTower> object.
*/
typedef OdSmartPtr<IfcCoolingTower> IfcCoolingTowerPtr;

} // namespace

#endif // _IFC4X1_IFCCOOLINGTOWER_AUTO_IMPL_H
