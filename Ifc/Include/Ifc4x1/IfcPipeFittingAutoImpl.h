...
#ifndef _IFC4X1_IFCPIPEFITTING_AUTO_IMPL_H
#define _IFC4X1_IFCPIPEFITTING_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPipeFitting : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPipeFitting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPipeFitting, IfcPipeFitting> object.
*/
typedef OdSmartPtr<IfcPipeFitting> IfcPipeFittingPtr;

} // namespace

#endif // _IFC4X1_IFCPIPEFITTING_AUTO_IMPL_H
