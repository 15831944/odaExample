...
#ifndef _IFC4X1_IFCORIENTEDEDGE_AUTO_IMPL_H
#define _IFC4X1_IFCORIENTEDEDGE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcOrientedEdge : public IfcEdge
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcOrientedEdge);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcOrientedEdge, IfcOrientedEdge> object.
*/
typedef OdSmartPtr<IfcOrientedEdge> IfcOrientedEdgePtr;

} // namespace

#endif // _IFC4X1_IFCORIENTEDEDGE_AUTO_IMPL_H
