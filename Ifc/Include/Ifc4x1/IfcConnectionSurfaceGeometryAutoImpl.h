...
#ifndef _IFC4X1_IFCCONNECTIONSURFACEGEOMETRY_AUTO_IMPL_H
#define _IFC4X1_IFCCONNECTIONSURFACEGEOMETRY_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcConnectionSurfaceGeometry : public IfcConnectionGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcConnectionSurfaceGeometry);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcConnectionSurfaceGeometry, IfcConnectionSurfaceGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionSurfaceGeometry> IfcConnectionSurfaceGeometryPtr;

} // namespace

#endif // _IFC4X1_IFCCONNECTIONSURFACEGEOMETRY_AUTO_IMPL_H
