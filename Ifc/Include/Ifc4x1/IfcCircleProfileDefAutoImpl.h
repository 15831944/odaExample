...
#ifndef _IFC4X1_IFCCIRCLEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X1_IFCCIRCLEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCircleProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCircleProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCircleProfileDef, IfcCircleProfileDef> object.
*/
typedef OdSmartPtr<IfcCircleProfileDef> IfcCircleProfileDefPtr;

} // namespace

#endif // _IFC4X1_IFCCIRCLEPROFILEDEF_AUTO_IMPL_H
