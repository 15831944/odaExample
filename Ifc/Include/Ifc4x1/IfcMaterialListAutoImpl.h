...
#ifndef _IFC4X1_IFCMATERIALLIST_AUTO_IMPL_H
#define _IFC4X1_IFCMATERIALLIST_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcMaterialList : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcMaterialList);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcMaterialList, IfcMaterialList> object.
*/
typedef OdSmartPtr<IfcMaterialList> IfcMaterialListPtr;

} // namespace

#endif // _IFC4X1_IFCMATERIALLIST_AUTO_IMPL_H
