...
class IFC4X1_EXPORT IfcCoordinateReferenceSystem : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCoordinateReferenceSystem, IfcCoordinateReferenceSystem> object.
*/
