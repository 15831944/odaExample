...
#ifndef _IFC4X1_IFCPLATE_AUTO_IMPL_H
#define _IFC4X1_IFCPLATE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPlate : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPlate);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPlate, IfcPlate> object.
*/
typedef OdSmartPtr<IfcPlate> IfcPlatePtr;

} // namespace

#endif // _IFC4X1_IFCPLATE_AUTO_IMPL_H
