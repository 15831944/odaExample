...
#ifndef _IFC4X1_IFCCIRCULARARCSEGMENT2D_AUTO_IMPL_H
#define _IFC4X1_IFCCIRCULARARCSEGMENT2D_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCircularArcSegment2D : public IfcCurveSegment2D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCircularArcSegment2D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCircularArcSegment2D, IfcCircularArcSegment2D> object.
*/
typedef OdSmartPtr<IfcCircularArcSegment2D> IfcCircularArcSegment2DPtr;

} // namespace

#endif // _IFC4X1_IFCCIRCULARARCSEGMENT2D_AUTO_IMPL_H
