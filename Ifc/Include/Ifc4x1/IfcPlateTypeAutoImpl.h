...
#ifndef _IFC4X1_IFCPLATETYPE_AUTO_IMPL_H
#define _IFC4X1_IFCPLATETYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPlateType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPlateType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPlateType, IfcPlateType> object.
*/
typedef OdSmartPtr<IfcPlateType> IfcPlateTypePtr;

} // namespace

#endif // _IFC4X1_IFCPLATETYPE_AUTO_IMPL_H
