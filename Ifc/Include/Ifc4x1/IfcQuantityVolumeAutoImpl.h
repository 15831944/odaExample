...
#ifndef _IFC4X1_IFCQUANTITYVOLUME_AUTO_IMPL_H
#define _IFC4X1_IFCQUANTITYVOLUME_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcQuantityVolume : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcQuantityVolume);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcQuantityVolume, IfcQuantityVolume> object.
*/
typedef OdSmartPtr<IfcQuantityVolume> IfcQuantityVolumePtr;

} // namespace

#endif // _IFC4X1_IFCQUANTITYVOLUME_AUTO_IMPL_H
