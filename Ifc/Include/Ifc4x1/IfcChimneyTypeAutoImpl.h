...
#ifndef _IFC4X1_IFCCHIMNEYTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCCHIMNEYTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcChimneyType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcChimneyType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcChimneyType, IfcChimneyType> object.
*/
typedef OdSmartPtr<IfcChimneyType> IfcChimneyTypePtr;

} // namespace

#endif // _IFC4X1_IFCCHIMNEYTYPE_AUTO_IMPL_H
