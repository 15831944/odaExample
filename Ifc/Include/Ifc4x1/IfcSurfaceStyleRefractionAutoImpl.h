...
#ifndef _IFC4X1_IFCSURFACESTYLEREFRACTION_AUTO_IMPL_H
#define _IFC4X1_IFCSURFACESTYLEREFRACTION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSurfaceStyleRefraction : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSurfaceStyleRefraction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSurfaceStyleRefraction, IfcSurfaceStyleRefraction> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleRefraction> IfcSurfaceStyleRefractionPtr;

} // namespace

#endif // _IFC4X1_IFCSURFACESTYLEREFRACTION_AUTO_IMPL_H
