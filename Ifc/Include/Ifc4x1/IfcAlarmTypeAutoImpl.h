...
#ifndef _IFC4X1_IFCALARMTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCALARMTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcAlarmType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcAlarmType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcAlarmType, IfcAlarmType> object.
*/
typedef OdSmartPtr<IfcAlarmType> IfcAlarmTypePtr;

} // namespace

#endif // _IFC4X1_IFCALARMTYPE_AUTO_IMPL_H
