...
#ifndef _IFC4X1_IFCBEAM_AUTO_IMPL_H
#define _IFC4X1_IFCBEAM_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcBeam : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcBeam);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcBeam, IfcBeam> object.
*/
typedef OdSmartPtr<IfcBeam> IfcBeamPtr;

} // namespace

#endif // _IFC4X1_IFCBEAM_AUTO_IMPL_H
