...
#ifndef _IFC4X1_IFCSURFACECURVESWEPTAREASOLID_AUTO_IMPL_H
#define _IFC4X1_IFCSURFACECURVESWEPTAREASOLID_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSurfaceCurveSweptAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSurfaceCurveSweptAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSurfaceCurveSweptAreaSolid, IfcSurfaceCurveSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcSurfaceCurveSweptAreaSolid> IfcSurfaceCurveSweptAreaSolidPtr;

} // namespace

#endif // _IFC4X1_IFCSURFACECURVESWEPTAREASOLID_AUTO_IMPL_H
