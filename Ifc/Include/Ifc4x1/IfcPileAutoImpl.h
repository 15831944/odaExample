...
#ifndef _IFC4X1_IFCPILE_AUTO_IMPL_H
#define _IFC4X1_IFCPILE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPile : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPile);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPile, IfcPile> object.
*/
typedef OdSmartPtr<IfcPile> IfcPilePtr;

} // namespace

#endif // _IFC4X1_IFCPILE_AUTO_IMPL_H
