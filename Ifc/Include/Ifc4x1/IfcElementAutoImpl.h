...
#ifndef _IFC4X1_IFCELEMENT_AUTO_IMPL_H
#define _IFC4X1_IFCELEMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcElement : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcElement, IfcElement> object.
*/
typedef OdSmartPtr<IfcElement> IfcElementPtr;

} // namespace

#endif // _IFC4X1_IFCELEMENT_AUTO_IMPL_H
