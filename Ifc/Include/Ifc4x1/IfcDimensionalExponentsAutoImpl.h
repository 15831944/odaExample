...
#ifndef _IFC4X1_IFCDIMENSIONALEXPONENTS_AUTO_IMPL_H
#define _IFC4X1_IFCDIMENSIONALEXPONENTS_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcDimensionalExponents : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcDimensionalExponents);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcDimensionalExponents, IfcDimensionalExponents> object.
*/
typedef OdSmartPtr<IfcDimensionalExponents> IfcDimensionalExponentsPtr;

} // namespace

#endif // _IFC4X1_IFCDIMENSIONALEXPONENTS_AUTO_IMPL_H
