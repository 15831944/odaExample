...
#ifndef _IFC4X1_IFCRAMPFLIGHT_AUTO_IMPL_H
#define _IFC4X1_IFCRAMPFLIGHT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRampFlight : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRampFlight);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRampFlight, IfcRampFlight> object.
*/
typedef OdSmartPtr<IfcRampFlight> IfcRampFlightPtr;

} // namespace

#endif // _IFC4X1_IFCRAMPFLIGHT_AUTO_IMPL_H
