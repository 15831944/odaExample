...
#ifndef _IFC4X1_IFCRESOURCETIME_AUTO_IMPL_H
#define _IFC4X1_IFCRESOURCETIME_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcResourceTime : public IfcSchedulingTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcResourceTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcResourceTime, IfcResourceTime> object.
*/
typedef OdSmartPtr<IfcResourceTime> IfcResourceTimePtr;

} // namespace

#endif // _IFC4X1_IFCRESOURCETIME_AUTO_IMPL_H
