...
#ifndef _IFC4X1_IFCAUDIOVISUALAPPLIANCE_AUTO_IMPL_H
#define _IFC4X1_IFCAUDIOVISUALAPPLIANCE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcAudioVisualAppliance : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcAudioVisualAppliance);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcAudioVisualAppliance, IfcAudioVisualAppliance> object.
*/
typedef OdSmartPtr<IfcAudioVisualAppliance> IfcAudioVisualAppliancePtr;

} // namespace

#endif // _IFC4X1_IFCAUDIOVISUALAPPLIANCE_AUTO_IMPL_H
