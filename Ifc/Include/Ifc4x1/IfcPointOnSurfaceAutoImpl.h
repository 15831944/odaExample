...
#ifndef _IFC4X1_IFCPOINTONSURFACE_AUTO_IMPL_H
#define _IFC4X1_IFCPOINTONSURFACE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPointOnSurface : public IfcPoint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPointOnSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPointOnSurface, IfcPointOnSurface> object.
*/
typedef OdSmartPtr<IfcPointOnSurface> IfcPointOnSurfacePtr;

} // namespace

#endif // _IFC4X1_IFCPOINTONSURFACE_AUTO_IMPL_H
