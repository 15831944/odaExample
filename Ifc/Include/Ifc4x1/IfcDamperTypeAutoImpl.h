...
#ifndef _IFC4X1_IFCDAMPERTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCDAMPERTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcDamperType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcDamperType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcDamperType, IfcDamperType> object.
*/
typedef OdSmartPtr<IfcDamperType> IfcDamperTypePtr;

} // namespace

#endif // _IFC4X1_IFCDAMPERTYPE_AUTO_IMPL_H
