...
#ifndef _IFC4X1_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRampFlightType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRampFlightType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRampFlightType, IfcRampFlightType> object.
*/
typedef OdSmartPtr<IfcRampFlightType> IfcRampFlightTypePtr;

} // namespace

#endif // _IFC4X1_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
