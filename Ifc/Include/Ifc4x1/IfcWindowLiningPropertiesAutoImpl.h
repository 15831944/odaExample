...
#ifndef _IFC4X1_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
#define _IFC4X1_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcWindowLiningProperties : public IfcPreDefinedPropertySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcWindowLiningProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcWindowLiningProperties, IfcWindowLiningProperties> object.
*/
typedef OdSmartPtr<IfcWindowLiningProperties> IfcWindowLiningPropertiesPtr;

} // namespace

#endif // _IFC4X1_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
