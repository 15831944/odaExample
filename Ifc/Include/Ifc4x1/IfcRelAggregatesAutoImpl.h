...
#ifndef _IFC4X1_IFCRELAGGREGATES_AUTO_IMPL_H
#define _IFC4X1_IFCRELAGGREGATES_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelAggregates : public IfcRelDecomposes
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelAggregates);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelAggregates, IfcRelAggregates> object.
*/
typedef OdSmartPtr<IfcRelAggregates> IfcRelAggregatesPtr;

} // namespace

#endif // _IFC4X1_IFCRELAGGREGATES_AUTO_IMPL_H
