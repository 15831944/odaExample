...
#ifndef _IFC4X1_IFCROOF_AUTO_IMPL_H
#define _IFC4X1_IFCROOF_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRoof : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRoof);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRoof, IfcRoof> object.
*/
typedef OdSmartPtr<IfcRoof> IfcRoofPtr;

} // namespace

#endif // _IFC4X1_IFCROOF_AUTO_IMPL_H
