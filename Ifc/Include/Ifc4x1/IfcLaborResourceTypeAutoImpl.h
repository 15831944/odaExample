...
#ifndef _IFC4X1_IFCLABORRESOURCETYPE_AUTO_IMPL_H
#define _IFC4X1_IFCLABORRESOURCETYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcLaborResourceType : public IfcConstructionResourceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcLaborResourceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcLaborResourceType, IfcLaborResourceType> object.
*/
typedef OdSmartPtr<IfcLaborResourceType> IfcLaborResourceTypePtr;

} // namespace

#endif // _IFC4X1_IFCLABORRESOURCETYPE_AUTO_IMPL_H
