...
#ifndef _IFC4X1_IFCMATERIALPROFILESETUSAGE_AUTO_IMPL_H
#define _IFC4X1_IFCMATERIALPROFILESETUSAGE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcMaterialProfileSetUsage : public IfcMaterialUsageDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcMaterialProfileSetUsage);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcMaterialProfileSetUsage, IfcMaterialProfileSetUsage> object.
*/
typedef OdSmartPtr<IfcMaterialProfileSetUsage> IfcMaterialProfileSetUsagePtr;

} // namespace

#endif // _IFC4X1_IFCMATERIALPROFILESETUSAGE_AUTO_IMPL_H
