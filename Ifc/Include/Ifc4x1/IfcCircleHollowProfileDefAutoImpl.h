...
#ifndef _IFC4X1_IFCCIRCLEHOLLOWPROFILEDEF_AUTO_IMPL_H
#define _IFC4X1_IFCCIRCLEHOLLOWPROFILEDEF_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCircleHollowProfileDef : public IfcCircleProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCircleHollowProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCircleHollowProfileDef, IfcCircleHollowProfileDef> object.
*/
typedef OdSmartPtr<IfcCircleHollowProfileDef> IfcCircleHollowProfileDefPtr;

} // namespace

#endif // _IFC4X1_IFCCIRCLEHOLLOWPROFILEDEF_AUTO_IMPL_H
