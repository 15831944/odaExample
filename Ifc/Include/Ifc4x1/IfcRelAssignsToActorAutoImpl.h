...
#ifndef _IFC4X1_IFCRELASSIGNSTOACTOR_AUTO_IMPL_H
#define _IFC4X1_IFCRELASSIGNSTOACTOR_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelAssignsToActor : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelAssignsToActor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelAssignsToActor, IfcRelAssignsToActor> object.
*/
typedef OdSmartPtr<IfcRelAssignsToActor> IfcRelAssignsToActorPtr;

} // namespace

#endif // _IFC4X1_IFCRELASSIGNSTOACTOR_AUTO_IMPL_H
