...
#ifndef _IFC4X1_IFCREGULARTIMESERIES_AUTO_IMPL_H
#define _IFC4X1_IFCREGULARTIMESERIES_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRegularTimeSeries : public IfcTimeSeries
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRegularTimeSeries);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRegularTimeSeries, IfcRegularTimeSeries> object.
*/
typedef OdSmartPtr<IfcRegularTimeSeries> IfcRegularTimeSeriesPtr;

} // namespace

#endif // _IFC4X1_IFCREGULARTIMESERIES_AUTO_IMPL_H
