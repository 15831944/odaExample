...
#ifndef _IFC4X1_IFCPILETYPE_AUTO_IMPL_H
#define _IFC4X1_IFCPILETYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPileType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPileType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPileType, IfcPileType> object.
*/
typedef OdSmartPtr<IfcPileType> IfcPileTypePtr;

} // namespace

#endif // _IFC4X1_IFCPILETYPE_AUTO_IMPL_H
