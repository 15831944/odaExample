...
#ifndef _IFC4X1_IFCELECTRICAPPLIANCETYPE_AUTO_IMPL_H
#define _IFC4X1_IFCELECTRICAPPLIANCETYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcElectricApplianceType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcElectricApplianceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcElectricApplianceType, IfcElectricApplianceType> object.
*/
typedef OdSmartPtr<IfcElectricApplianceType> IfcElectricApplianceTypePtr;

} // namespace

#endif // _IFC4X1_IFCELECTRICAPPLIANCETYPE_AUTO_IMPL_H
