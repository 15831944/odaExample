...
#ifndef _IFC4X1_IFCSPATIALELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCSPATIALELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSpatialElementType : public IfcTypeProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcSpatialElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSpatialElementType, IfcSpatialElementType> object.
*/
typedef OdSmartPtr<IfcSpatialElementType> IfcSpatialElementTypePtr;

} // namespace

#endif // _IFC4X1_IFCSPATIALELEMENTTYPE_AUTO_IMPL_H
