...
#ifndef _IFC4X1_IFCPIPEFITTINGTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCPIPEFITTINGTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPipeFittingType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPipeFittingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPipeFittingType, IfcPipeFittingType> object.
*/
typedef OdSmartPtr<IfcPipeFittingType> IfcPipeFittingTypePtr;

} // namespace

#endif // _IFC4X1_IFCPIPEFITTINGTYPE_AUTO_IMPL_H
