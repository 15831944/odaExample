...
#ifndef _IFC4X1_IFCRELNESTS_AUTO_IMPL_H
#define _IFC4X1_IFCRELNESTS_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelNests : public IfcRelDecomposes
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelNests);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelNests, IfcRelNests> object.
*/
typedef OdSmartPtr<IfcRelNests> IfcRelNestsPtr;

} // namespace

#endif // _IFC4X1_IFCRELNESTS_AUTO_IMPL_H
