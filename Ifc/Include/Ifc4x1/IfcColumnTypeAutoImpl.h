...
#ifndef _IFC4X1_IFCCOLUMNTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCCOLUMNTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcColumnType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcColumnType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcColumnType, IfcColumnType> object.
*/
typedef OdSmartPtr<IfcColumnType> IfcColumnTypePtr;

} // namespace

#endif // _IFC4X1_IFCCOLUMNTYPE_AUTO_IMPL_H
