...
#ifndef _IFC4X1_IFCCOMPRESSOR_AUTO_IMPL_H
#define _IFC4X1_IFCCOMPRESSOR_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCompressor : public IfcFlowMovingDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCompressor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCompressor, IfcCompressor> object.
*/
typedef OdSmartPtr<IfcCompressor> IfcCompressorPtr;

} // namespace

#endif // _IFC4X1_IFCCOMPRESSOR_AUTO_IMPL_H
