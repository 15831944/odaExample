...
#ifndef _IFC4X1_IFCBOUNDARYEDGECONDITION_AUTO_IMPL_H
#define _IFC4X1_IFCBOUNDARYEDGECONDITION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcBoundaryEdgeCondition : public IfcBoundaryCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcBoundaryEdgeCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcBoundaryEdgeCondition, IfcBoundaryEdgeCondition> object.
*/
typedef OdSmartPtr<IfcBoundaryEdgeCondition> IfcBoundaryEdgeConditionPtr;

} // namespace

#endif // _IFC4X1_IFCBOUNDARYEDGECONDITION_AUTO_IMPL_H
