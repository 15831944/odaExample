...
#ifndef _IFC4X1_IFCSTRUCTURALCURVEREACTION_AUTO_IMPL_H
#define _IFC4X1_IFCSTRUCTURALCURVEREACTION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcStructuralCurveReaction : public IfcStructuralReaction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcStructuralCurveReaction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcStructuralCurveReaction, IfcStructuralCurveReaction> object.
*/
typedef OdSmartPtr<IfcStructuralCurveReaction> IfcStructuralCurveReactionPtr;

} // namespace

#endif // _IFC4X1_IFCSTRUCTURALCURVEREACTION_AUTO_IMPL_H
