...
#ifndef _IFC4X1_IFCANNOTATIONFILLAREA_AUTO_IMPL_H
#define _IFC4X1_IFCANNOTATIONFILLAREA_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcAnnotationFillArea : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcAnnotationFillArea);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcAnnotationFillArea, IfcAnnotationFillArea> object.
*/
typedef OdSmartPtr<IfcAnnotationFillArea> IfcAnnotationFillAreaPtr;

} // namespace

#endif // _IFC4X1_IFCANNOTATIONFILLAREA_AUTO_IMPL_H
