...
#ifndef _IFC4X1_IFCCLASSIFICATION_AUTO_IMPL_H
#define _IFC4X1_IFCCLASSIFICATION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcClassification : public IfcExternalInformation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcClassification);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcClassification, IfcClassification> object.
*/
typedef OdSmartPtr<IfcClassification> IfcClassificationPtr;

} // namespace

#endif // _IFC4X1_IFCCLASSIFICATION_AUTO_IMPL_H
