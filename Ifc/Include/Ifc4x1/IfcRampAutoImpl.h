...
#ifndef _IFC4X1_IFCRAMP_AUTO_IMPL_H
#define _IFC4X1_IFCRAMP_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRamp : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRamp);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRamp, IfcRamp> object.
*/
typedef OdSmartPtr<IfcRamp> IfcRampPtr;

} // namespace

#endif // _IFC4X1_IFCRAMP_AUTO_IMPL_H
