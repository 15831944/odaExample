...
#ifndef _IFC4X1_IFCMATERIALCONSTITUENTSET_AUTO_IMPL_H
#define _IFC4X1_IFCMATERIALCONSTITUENTSET_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcMaterialConstituentSet : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcMaterialConstituentSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcMaterialConstituentSet, IfcMaterialConstituentSet> object.
*/
typedef OdSmartPtr<IfcMaterialConstituentSet> IfcMaterialConstituentSetPtr;

} // namespace

#endif // _IFC4X1_IFCMATERIALCONSTITUENTSET_AUTO_IMPL_H
