...
#ifndef _IFC4X1_IFCOFFSETCURVE2D_AUTO_IMPL_H
#define _IFC4X1_IFCOFFSETCURVE2D_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcOffsetCurve2D : public IfcOffsetCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcOffsetCurve2D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcOffsetCurve2D, IfcOffsetCurve2D> object.
*/
typedef OdSmartPtr<IfcOffsetCurve2D> IfcOffsetCurve2DPtr;

} // namespace

#endif // _IFC4X1_IFCOFFSETCURVE2D_AUTO_IMPL_H
