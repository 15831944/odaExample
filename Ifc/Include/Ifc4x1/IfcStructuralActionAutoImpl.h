...
#ifndef _IFC4X1_IFCSTRUCTURALACTION_AUTO_IMPL_H
#define _IFC4X1_IFCSTRUCTURALACTION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcStructuralAction : public IfcStructuralActivity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcStructuralAction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcStructuralAction, IfcStructuralAction> object.
*/
typedef OdSmartPtr<IfcStructuralAction> IfcStructuralActionPtr;

} // namespace

#endif // _IFC4X1_IFCSTRUCTURALACTION_AUTO_IMPL_H
