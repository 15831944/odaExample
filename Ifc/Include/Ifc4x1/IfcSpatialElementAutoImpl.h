...
#ifndef _IFC4X1_IFCSPATIALELEMENT_AUTO_IMPL_H
#define _IFC4X1_IFCSPATIALELEMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSpatialElement : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcSpatialElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSpatialElement, IfcSpatialElement> object.
*/
typedef OdSmartPtr<IfcSpatialElement> IfcSpatialElementPtr;

} // namespace

#endif // _IFC4X1_IFCSPATIALELEMENT_AUTO_IMPL_H
