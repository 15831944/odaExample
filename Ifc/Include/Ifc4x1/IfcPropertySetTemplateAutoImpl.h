...
#ifndef _IFC4X1_IFCPROPERTYSETTEMPLATE_AUTO_IMPL_H
#define _IFC4X1_IFCPROPERTYSETTEMPLATE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPropertySetTemplate : public IfcPropertyTemplateDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPropertySetTemplate);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPropertySetTemplate, IfcPropertySetTemplate> object.
*/
typedef OdSmartPtr<IfcPropertySetTemplate> IfcPropertySetTemplatePtr;

} // namespace

#endif // _IFC4X1_IFCPROPERTYSETTEMPLATE_AUTO_IMPL_H
