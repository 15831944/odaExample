...
#ifndef _IFC4X1_IFCSTRUCTURALPOINTCONNECTION_AUTO_IMPL_H
#define _IFC4X1_IFCSTRUCTURALPOINTCONNECTION_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcStructuralPointConnection : public IfcStructuralConnection
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcStructuralPointConnection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcStructuralPointConnection, IfcStructuralPointConnection> object.
*/
typedef OdSmartPtr<IfcStructuralPointConnection> IfcStructuralPointConnectionPtr;

} // namespace

#endif // _IFC4X1_IFCSTRUCTURALPOINTCONNECTION_AUTO_IMPL_H
