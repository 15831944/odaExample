...
#ifndef _IFC4X1_IFCHALFSPACESOLID_AUTO_IMPL_H
#define _IFC4X1_IFCHALFSPACESOLID_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcHalfSpaceSolid : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcHalfSpaceSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcHalfSpaceSolid, IfcHalfSpaceSolid> object.
*/
typedef OdSmartPtr<IfcHalfSpaceSolid> IfcHalfSpaceSolidPtr;

} // namespace

#endif // _IFC4X1_IFCHALFSPACESOLID_AUTO_IMPL_H
