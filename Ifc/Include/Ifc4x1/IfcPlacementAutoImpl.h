...
#ifndef _IFC4X1_IFCPLACEMENT_AUTO_IMPL_H
#define _IFC4X1_IFCPLACEMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPlacement : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcPlacement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPlacement, IfcPlacement> object.
*/
typedef OdSmartPtr<IfcPlacement> IfcPlacementPtr;

} // namespace

#endif // _IFC4X1_IFCPLACEMENT_AUTO_IMPL_H
