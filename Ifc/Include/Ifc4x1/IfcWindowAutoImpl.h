...
#ifndef _IFC4X1_IFCWINDOW_AUTO_IMPL_H
#define _IFC4X1_IFCWINDOW_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcWindow : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcWindow);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcWindow, IfcWindow> object.
*/
typedef OdSmartPtr<IfcWindow> IfcWindowPtr;

} // namespace

#endif // _IFC4X1_IFCWINDOW_AUTO_IMPL_H
