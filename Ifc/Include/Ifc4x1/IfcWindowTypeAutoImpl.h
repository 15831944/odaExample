...
#ifndef _IFC4X1_IFCWINDOWTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCWINDOWTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcWindowType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcWindowType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcWindowType, IfcWindowType> object.
*/
typedef OdSmartPtr<IfcWindowType> IfcWindowTypePtr;

} // namespace

#endif // _IFC4X1_IFCWINDOWTYPE_AUTO_IMPL_H
