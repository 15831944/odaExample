...
#ifndef _IFC4X1_IFCSWEPTSURFACE_AUTO_IMPL_H
#define _IFC4X1_IFCSWEPTSURFACE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSweptSurface : public IfcSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcSweptSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSweptSurface, IfcSweptSurface> object.
*/
typedef OdSmartPtr<IfcSweptSurface> IfcSweptSurfacePtr;

} // namespace

#endif // _IFC4X1_IFCSWEPTSURFACE_AUTO_IMPL_H
