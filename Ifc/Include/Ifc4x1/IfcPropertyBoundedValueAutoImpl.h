...
#ifndef _IFC4X1_IFCPROPERTYBOUNDEDVALUE_AUTO_IMPL_H
#define _IFC4X1_IFCPROPERTYBOUNDEDVALUE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPropertyBoundedValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPropertyBoundedValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPropertyBoundedValue, IfcPropertyBoundedValue> object.
*/
typedef OdSmartPtr<IfcPropertyBoundedValue> IfcPropertyBoundedValuePtr;

} // namespace

#endif // _IFC4X1_IFCPROPERTYBOUNDEDVALUE_AUTO_IMPL_H
