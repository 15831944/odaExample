...
#ifndef _IFC4X1_IFCEXTERNALSPATIALELEMENT_AUTO_IMPL_H
#define _IFC4X1_IFCEXTERNALSPATIALELEMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcExternalSpatialElement : public IfcExternalSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcExternalSpatialElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcExternalSpatialElement, IfcExternalSpatialElement> object.
*/
typedef OdSmartPtr<IfcExternalSpatialElement> IfcExternalSpatialElementPtr;

} // namespace

#endif // _IFC4X1_IFCEXTERNALSPATIALELEMENT_AUTO_IMPL_H
