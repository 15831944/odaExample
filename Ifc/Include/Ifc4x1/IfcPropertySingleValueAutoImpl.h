...
#ifndef _IFC4X1_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
#define _IFC4X1_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPropertySingleValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPropertySingleValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPropertySingleValue, IfcPropertySingleValue> object.
*/
typedef OdSmartPtr<IfcPropertySingleValue> IfcPropertySingleValuePtr;

} // namespace

#endif // _IFC4X1_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
