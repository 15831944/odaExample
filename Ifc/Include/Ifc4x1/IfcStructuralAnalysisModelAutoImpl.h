...
#ifndef _IFC4X1_IFCSTRUCTURALANALYSISMODEL_AUTO_IMPL_H
#define _IFC4X1_IFCSTRUCTURALANALYSISMODEL_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcStructuralAnalysisModel : public IfcSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcStructuralAnalysisModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcStructuralAnalysisModel, IfcStructuralAnalysisModel> object.
*/
typedef OdSmartPtr<IfcStructuralAnalysisModel> IfcStructuralAnalysisModelPtr;

} // namespace

#endif // _IFC4X1_IFCSTRUCTURALANALYSISMODEL_AUTO_IMPL_H
