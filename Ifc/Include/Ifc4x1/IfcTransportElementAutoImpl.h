...
#ifndef _IFC4X1_IFCTRANSPORTELEMENT_AUTO_IMPL_H
#define _IFC4X1_IFCTRANSPORTELEMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcTransportElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcTransportElement);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcTransportElementTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcTransportElement, IfcTransportElement> object.
*/
typedef OdSmartPtr<IfcTransportElement> IfcTransportElementPtr;

} // namespace

#endif // _IFC4X1_IFCTRANSPORTELEMENT_AUTO_IMPL_H
