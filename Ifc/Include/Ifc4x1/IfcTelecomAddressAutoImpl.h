...
#ifndef _IFC4X1_IFCTELECOMADDRESS_AUTO_IMPL_H
#define _IFC4X1_IFCTELECOMADDRESS_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcTelecomAddress : public IfcAddress
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcTelecomAddress);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcTelecomAddress, IfcTelecomAddress> object.
*/
typedef OdSmartPtr<IfcTelecomAddress> IfcTelecomAddressPtr;

} // namespace

#endif // _IFC4X1_IFCTELECOMADDRESS_AUTO_IMPL_H
