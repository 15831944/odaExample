...
#ifndef _IFC4X1_IFCPERSON_AUTO_IMPL_H
#define _IFC4X1_IFCPERSON_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPerson : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPerson);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPerson, IfcPerson> object.
*/
typedef OdSmartPtr<IfcPerson> IfcPersonPtr;

} // namespace

#endif // _IFC4X1_IFCPERSON_AUTO_IMPL_H
