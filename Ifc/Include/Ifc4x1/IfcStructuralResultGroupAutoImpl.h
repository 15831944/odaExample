...
#ifndef _IFC4X1_IFCSTRUCTURALRESULTGROUP_AUTO_IMPL_H
#define _IFC4X1_IFCSTRUCTURALRESULTGROUP_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcStructuralResultGroup : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcStructuralResultGroup);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcStructuralResultGroup, IfcStructuralResultGroup> object.
*/
typedef OdSmartPtr<IfcStructuralResultGroup> IfcStructuralResultGroupPtr;

} // namespace

#endif // _IFC4X1_IFCSTRUCTURALRESULTGROUP_AUTO_IMPL_H
