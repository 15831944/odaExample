...
#ifndef _IFC4X1_IFCPROPERTY_AUTO_IMPL_H
#define _IFC4X1_IFCPROPERTY_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcProperty : public IfcPropertyAbstraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcProperty);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcProperty, IfcProperty> object.
*/
typedef OdSmartPtr<IfcProperty> IfcPropertyPtr;

} // namespace

#endif // _IFC4X1_IFCPROPERTY_AUTO_IMPL_H
