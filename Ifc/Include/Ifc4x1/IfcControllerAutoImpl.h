...
#ifndef _IFC4X1_IFCCONTROLLER_AUTO_IMPL_H
#define _IFC4X1_IFCCONTROLLER_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcController : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcController);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcController, IfcController> object.
*/
typedef OdSmartPtr<IfcController> IfcControllerPtr;

} // namespace

#endif // _IFC4X1_IFCCONTROLLER_AUTO_IMPL_H
