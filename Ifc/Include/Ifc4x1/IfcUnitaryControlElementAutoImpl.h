...
#ifndef _IFC4X1_IFCUNITARYCONTROLELEMENT_AUTO_IMPL_H
#define _IFC4X1_IFCUNITARYCONTROLELEMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcUnitaryControlElement : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcUnitaryControlElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcUnitaryControlElement, IfcUnitaryControlElement> object.
*/
typedef OdSmartPtr<IfcUnitaryControlElement> IfcUnitaryControlElementPtr;

} // namespace

#endif // _IFC4X1_IFCUNITARYCONTROLELEMENT_AUTO_IMPL_H
