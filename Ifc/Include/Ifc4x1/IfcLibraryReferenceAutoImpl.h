...
#ifndef _IFC4X1_IFCLIBRARYREFERENCE_AUTO_IMPL_H
#define _IFC4X1_IFCLIBRARYREFERENCE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcLibraryReference : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcLibraryReference);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcLibraryReference, IfcLibraryReference> object.
*/
typedef OdSmartPtr<IfcLibraryReference> IfcLibraryReferencePtr;

} // namespace

#endif // _IFC4X1_IFCLIBRARYREFERENCE_AUTO_IMPL_H
