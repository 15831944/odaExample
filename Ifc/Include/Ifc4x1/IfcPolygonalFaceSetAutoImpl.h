...
#ifndef _IFC4X1_IFCPOLYGONALFACESET_AUTO_IMPL_H
#define _IFC4X1_IFCPOLYGONALFACESET_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPolygonalFaceSet : public IfcTessellatedFaceSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPolygonalFaceSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPolygonalFaceSet, IfcPolygonalFaceSet> object.
*/
typedef OdSmartPtr<IfcPolygonalFaceSet> IfcPolygonalFaceSetPtr;

} // namespace

#endif // _IFC4X1_IFCPOLYGONALFACESET_AUTO_IMPL_H
