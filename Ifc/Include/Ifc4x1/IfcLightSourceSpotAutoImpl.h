...
#ifndef _IFC4X1_IFCLIGHTSOURCESPOT_AUTO_IMPL_H
#define _IFC4X1_IFCLIGHTSOURCESPOT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcLightSourceSpot : public IfcLightSourcePositional
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcLightSourceSpot);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcLightSourceSpot, IfcLightSourceSpot> object.
*/
typedef OdSmartPtr<IfcLightSourceSpot> IfcLightSourceSpotPtr;

} // namespace

#endif // _IFC4X1_IFCLIGHTSOURCESPOT_AUTO_IMPL_H
