...
#ifndef _IFC4X1_IFCSLAB_AUTO_IMPL_H
#define _IFC4X1_IFCSLAB_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSlab : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSlab);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSlab, IfcSlab> object.
*/
typedef OdSmartPtr<IfcSlab> IfcSlabPtr;

} // namespace

#endif // _IFC4X1_IFCSLAB_AUTO_IMPL_H
