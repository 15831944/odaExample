...
#ifndef _IFC4X1_IFCREVOLVEDAREASOLIDTAPERED_AUTO_IMPL_H
#define _IFC4X1_IFCREVOLVEDAREASOLIDTAPERED_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRevolvedAreaSolidTapered : public IfcRevolvedAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRevolvedAreaSolidTapered);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRevolvedAreaSolidTapered, IfcRevolvedAreaSolidTapered> object.
*/
typedef OdSmartPtr<IfcRevolvedAreaSolidTapered> IfcRevolvedAreaSolidTaperedPtr;

} // namespace

#endif // _IFC4X1_IFCREVOLVEDAREASOLIDTAPERED_AUTO_IMPL_H
