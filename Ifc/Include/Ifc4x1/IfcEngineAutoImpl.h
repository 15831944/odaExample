...
#ifndef _IFC4X1_IFCENGINE_AUTO_IMPL_H
#define _IFC4X1_IFCENGINE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcEngine : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcEngine);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcEngine, IfcEngine> object.
*/
typedef OdSmartPtr<IfcEngine> IfcEnginePtr;

} // namespace

#endif // _IFC4X1_IFCENGINE_AUTO_IMPL_H
