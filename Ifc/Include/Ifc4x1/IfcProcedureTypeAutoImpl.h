...
#ifndef _IFC4X1_IFCPROCEDURETYPE_AUTO_IMPL_H
#define _IFC4X1_IFCPROCEDURETYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcProcedureType : public IfcTypeProcess
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcProcedureType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcProcedureType, IfcProcedureType> object.
*/
typedef OdSmartPtr<IfcProcedureType> IfcProcedureTypePtr;

} // namespace

#endif // _IFC4X1_IFCPROCEDURETYPE_AUTO_IMPL_H
