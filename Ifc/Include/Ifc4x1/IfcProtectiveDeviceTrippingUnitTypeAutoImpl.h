...
#ifndef _IFC4X1_IFCPROTECTIVEDEVICETRIPPINGUNITTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCPROTECTIVEDEVICETRIPPINGUNITTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcProtectiveDeviceTrippingUnitType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcProtectiveDeviceTrippingUnitType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcProtectiveDeviceTrippingUnitType, IfcProtectiveDeviceTrippingUnitType> object.
*/
typedef OdSmartPtr<IfcProtectiveDeviceTrippingUnitType> IfcProtectiveDeviceTrippingUnitTypePtr;

} // namespace

#endif // _IFC4X1_IFCPROTECTIVEDEVICETRIPPINGUNITTYPE_AUTO_IMPL_H
