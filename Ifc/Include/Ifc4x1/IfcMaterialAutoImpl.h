...
#ifndef _IFC4X1_IFCMATERIAL_AUTO_IMPL_H
#define _IFC4X1_IFCMATERIAL_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcMaterial : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcMaterial);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcMaterial, IfcMaterial> object.
*/
typedef OdSmartPtr<IfcMaterial> IfcMaterialPtr;

} // namespace

#endif // _IFC4X1_IFCMATERIAL_AUTO_IMPL_H
