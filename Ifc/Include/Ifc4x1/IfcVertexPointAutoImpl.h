...
#ifndef _IFC4X1_IFCVERTEXPOINT_AUTO_IMPL_H
#define _IFC4X1_IFCVERTEXPOINT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcVertexPoint : public IfcVertex
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcVertexPoint);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcVertexPoint, IfcVertexPoint> object.
*/
typedef OdSmartPtr<IfcVertexPoint> IfcVertexPointPtr;

} // namespace

#endif // _IFC4X1_IFCVERTEXPOINT_AUTO_IMPL_H
