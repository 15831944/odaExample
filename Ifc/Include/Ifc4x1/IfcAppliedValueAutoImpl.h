...
#ifndef _IFC4X1_IFCAPPLIEDVALUE_AUTO_IMPL_H
#define _IFC4X1_IFCAPPLIEDVALUE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcAppliedValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcAppliedValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcAppliedValue, IfcAppliedValue> object.
*/
typedef OdSmartPtr<IfcAppliedValue> IfcAppliedValuePtr;

} // namespace

#endif // _IFC4X1_IFCAPPLIEDVALUE_AUTO_IMPL_H
