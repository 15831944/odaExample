...
#ifndef _IFC4X1_IFCCHIMNEY_AUTO_IMPL_H
#define _IFC4X1_IFCCHIMNEY_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcChimney : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcChimney);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcChimney, IfcChimney> object.
*/
typedef OdSmartPtr<IfcChimney> IfcChimneyPtr;

} // namespace

#endif // _IFC4X1_IFCCHIMNEY_AUTO_IMPL_H
