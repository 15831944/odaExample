...
#ifndef _IFC4X1_IFCRESOURCE_AUTO_IMPL_H
#define _IFC4X1_IFCRESOURCE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcResource : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcResource, IfcResource> object.
*/
typedef OdSmartPtr<IfcResource> IfcResourcePtr;

} // namespace

#endif // _IFC4X1_IFCRESOURCE_AUTO_IMPL_H
