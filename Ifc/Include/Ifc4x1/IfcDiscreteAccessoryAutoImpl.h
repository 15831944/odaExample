...
#ifndef _IFC4X1_IFCDISCRETEACCESSORY_AUTO_IMPL_H
#define _IFC4X1_IFCDISCRETEACCESSORY_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcDiscreteAccessory : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcDiscreteAccessory);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcDiscreteAccessory, IfcDiscreteAccessory> object.
*/
typedef OdSmartPtr<IfcDiscreteAccessory> IfcDiscreteAccessoryPtr;

} // namespace

#endif // _IFC4X1_IFCDISCRETEACCESSORY_AUTO_IMPL_H
