...
#ifndef _IFC4X1_IFCLIGHTSOURCEDIRECTIONAL_AUTO_IMPL_H
#define _IFC4X1_IFCLIGHTSOURCEDIRECTIONAL_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcLightSourceDirectional : public IfcLightSource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcLightSourceDirectional);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcLightSourceDirectional, IfcLightSourceDirectional> object.
*/
typedef OdSmartPtr<IfcLightSourceDirectional> IfcLightSourceDirectionalPtr;

} // namespace

#endif // _IFC4X1_IFCLIGHTSOURCEDIRECTIONAL_AUTO_IMPL_H
