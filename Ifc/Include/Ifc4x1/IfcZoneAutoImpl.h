...
#ifndef _IFC4X1_IFCZONE_AUTO_IMPL_H
#define _IFC4X1_IFCZONE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcZone : public IfcSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcZone);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcZone, IfcZone> object.
*/
typedef OdSmartPtr<IfcZone> IfcZonePtr;

} // namespace

#endif // _IFC4X1_IFCZONE_AUTO_IMPL_H
