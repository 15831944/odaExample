...
#ifndef _IFC4X1_IFCWORKSCHEDULE_AUTO_IMPL_H
#define _IFC4X1_IFCWORKSCHEDULE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcWorkSchedule : public IfcWorkControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcWorkSchedule);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcWorkSchedule, IfcWorkSchedule> object.
*/
typedef OdSmartPtr<IfcWorkSchedule> IfcWorkSchedulePtr;

} // namespace

#endif // _IFC4X1_IFCWORKSCHEDULE_AUTO_IMPL_H
