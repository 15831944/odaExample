...
#ifndef _IFC4X1_IFCCONNECTIONGEOMETRY_AUTO_IMPL_H
#define _IFC4X1_IFCCONNECTIONGEOMETRY_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcConnectionGeometry : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcConnectionGeometry);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcConnectionGeometry, IfcConnectionGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionGeometry> IfcConnectionGeometryPtr;

} // namespace

#endif // _IFC4X1_IFCCONNECTIONGEOMETRY_AUTO_IMPL_H
