...
#ifndef _IFC4X1_IFCSPACE_AUTO_IMPL_H
#define _IFC4X1_IFCSPACE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSpace : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSpace);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSpace, IfcSpace> object.
*/
typedef OdSmartPtr<IfcSpace> IfcSpacePtr;

} // namespace

#endif // _IFC4X1_IFCSPACE_AUTO_IMPL_H
