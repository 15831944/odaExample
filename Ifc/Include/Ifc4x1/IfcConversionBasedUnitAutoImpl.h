...
#ifndef _IFC4X1_IFCCONVERSIONBASEDUNIT_AUTO_IMPL_H
#define _IFC4X1_IFCCONVERSIONBASEDUNIT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcConversionBasedUnit : public IfcNamedUnit
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcConversionBasedUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcConversionBasedUnit, IfcConversionBasedUnit> object.
*/
typedef OdSmartPtr<IfcConversionBasedUnit> IfcConversionBasedUnitPtr;

} // namespace

#endif // _IFC4X1_IFCCONVERSIONBASEDUNIT_AUTO_IMPL_H
