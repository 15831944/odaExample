...
#ifndef _IFC4X1_IFCEXTENDEDPROPERTIES_AUTO_IMPL_H
#define _IFC4X1_IFCEXTENDEDPROPERTIES_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcExtendedProperties : public IfcPropertyAbstraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcExtendedProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcExtendedProperties, IfcExtendedProperties> object.
*/
typedef OdSmartPtr<IfcExtendedProperties> IfcExtendedPropertiesPtr;

} // namespace

#endif // _IFC4X1_IFCEXTENDEDPROPERTIES_AUTO_IMPL_H
