...
#ifndef _IFC4X1_IFCCYLINDRICALSURFACE_AUTO_IMPL_H
#define _IFC4X1_IFCCYLINDRICALSURFACE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCylindricalSurface : public IfcElementarySurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCylindricalSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCylindricalSurface, IfcCylindricalSurface> object.
*/
typedef OdSmartPtr<IfcCylindricalSurface> IfcCylindricalSurfacePtr;

} // namespace

#endif // _IFC4X1_IFCCYLINDRICALSURFACE_AUTO_IMPL_H
