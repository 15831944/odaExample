...
#ifndef _IFC4X1_IFCRELCOVERSBLDGELEMENTS_AUTO_IMPL_H
#define _IFC4X1_IFCRELCOVERSBLDGELEMENTS_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelCoversBldgElements : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelCoversBldgElements);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelCoversBldgElements, IfcRelCoversBldgElements> object.
*/
typedef OdSmartPtr<IfcRelCoversBldgElements> IfcRelCoversBldgElementsPtr;

} // namespace

#endif // _IFC4X1_IFCRELCOVERSBLDGELEMENTS_AUTO_IMPL_H
