...
#ifndef _IFC4X1_IFCDISTRIBUTIONELEMENT_AUTO_IMPL_H
#define _IFC4X1_IFCDISTRIBUTIONELEMENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcDistributionElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcDistributionElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcDistributionElement, IfcDistributionElement> object.
*/
typedef OdSmartPtr<IfcDistributionElement> IfcDistributionElementPtr;

} // namespace

#endif // _IFC4X1_IFCDISTRIBUTIONELEMENT_AUTO_IMPL_H
