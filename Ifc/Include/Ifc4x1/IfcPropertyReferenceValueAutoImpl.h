...
#ifndef _IFC4X1_IFCPROPERTYREFERENCEVALUE_AUTO_IMPL_H
#define _IFC4X1_IFCPROPERTYREFERENCEVALUE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcPropertyReferenceValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcPropertyReferenceValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcPropertyReferenceValue, IfcPropertyReferenceValue> object.
*/
typedef OdSmartPtr<IfcPropertyReferenceValue> IfcPropertyReferenceValuePtr;

} // namespace

#endif // _IFC4X1_IFCPROPERTYREFERENCEVALUE_AUTO_IMPL_H
