...
#ifndef _IFC4X1_IFCEXTRUDEDAREASOLID_AUTO_IMPL_H
#define _IFC4X1_IFCEXTRUDEDAREASOLID_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcExtrudedAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcExtrudedAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcExtrudedAreaSolid, IfcExtrudedAreaSolid> object.
*/
typedef OdSmartPtr<IfcExtrudedAreaSolid> IfcExtrudedAreaSolidPtr;

} // namespace

#endif // _IFC4X1_IFCEXTRUDEDAREASOLID_AUTO_IMPL_H
