...
#ifndef _IFC4X1_IFCTYPERESOURCE_AUTO_IMPL_H
#define _IFC4X1_IFCTYPERESOURCE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcTypeResource : public IfcTypeObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x1::IfcTypeResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcTypeResource, IfcTypeResource> object.
*/
typedef OdSmartPtr<IfcTypeResource> IfcTypeResourcePtr;

} // namespace

#endif // _IFC4X1_IFCTYPERESOURCE_AUTO_IMPL_H
