...
#ifndef _IFC4X1_IFCREFERENT_AUTO_IMPL_H
#define _IFC4X1_IFCREFERENT_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcReferent : public IfcPositioningElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcReferent);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcReferent, IfcReferent> object.
*/
typedef OdSmartPtr<IfcReferent> IfcReferentPtr;

} // namespace

#endif // _IFC4X1_IFCREFERENT_AUTO_IMPL_H
