...
#ifndef _IFC4X1_IFCTRIMMEDCURVE_AUTO_IMPL_H
#define _IFC4X1_IFCTRIMMEDCURVE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcTrimmedCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcTrimmedCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcTrimmedCurve, IfcTrimmedCurve> object.
*/
typedef OdSmartPtr<IfcTrimmedCurve> IfcTrimmedCurvePtr;

} // namespace

#endif // _IFC4X1_IFCTRIMMEDCURVE_AUTO_IMPL_H
