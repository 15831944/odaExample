...
#ifndef _IFC4X1_IFCSPACEHEATER_AUTO_IMPL_H
#define _IFC4X1_IFCSPACEHEATER_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSpaceHeater : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSpaceHeater);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSpaceHeater, IfcSpaceHeater> object.
*/
typedef OdSmartPtr<IfcSpaceHeater> IfcSpaceHeaterPtr;

} // namespace

#endif // _IFC4X1_IFCSPACEHEATER_AUTO_IMPL_H
