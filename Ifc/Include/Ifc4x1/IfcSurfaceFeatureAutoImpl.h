...
#ifndef _IFC4X1_IFCSURFACEFEATURE_AUTO_IMPL_H
#define _IFC4X1_IFCSURFACEFEATURE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSurfaceFeature : public IfcFeatureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSurfaceFeature);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSurfaceFeature, IfcSurfaceFeature> object.
*/
typedef OdSmartPtr<IfcSurfaceFeature> IfcSurfaceFeaturePtr;

} // namespace

#endif // _IFC4X1_IFCSURFACEFEATURE_AUTO_IMPL_H
