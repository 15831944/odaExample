...
#ifndef _IFC4X1_IFCSPACEHEATERTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCSPACEHEATERTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcSpaceHeaterType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcSpaceHeaterType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcSpaceHeaterType, IfcSpaceHeaterType> object.
*/
typedef OdSmartPtr<IfcSpaceHeaterType> IfcSpaceHeaterTypePtr;

} // namespace

#endif // _IFC4X1_IFCSPACEHEATERTYPE_AUTO_IMPL_H
