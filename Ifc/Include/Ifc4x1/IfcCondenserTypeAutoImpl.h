...
#ifndef _IFC4X1_IFCCONDENSERTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCCONDENSERTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCondenserType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCondenserType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCondenserType, IfcCondenserType> object.
*/
typedef OdSmartPtr<IfcCondenserType> IfcCondenserTypePtr;

} // namespace

#endif // _IFC4X1_IFCCONDENSERTYPE_AUTO_IMPL_H
