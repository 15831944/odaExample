...
#ifndef _IFC4X1_IFCELECTRICTIMECONTROL_AUTO_IMPL_H
#define _IFC4X1_IFCELECTRICTIMECONTROL_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcElectricTimeControl : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcElectricTimeControl);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcElectricTimeControl, IfcElectricTimeControl> object.
*/
typedef OdSmartPtr<IfcElectricTimeControl> IfcElectricTimeControlPtr;

} // namespace

#endif // _IFC4X1_IFCELECTRICTIMECONTROL_AUTO_IMPL_H
