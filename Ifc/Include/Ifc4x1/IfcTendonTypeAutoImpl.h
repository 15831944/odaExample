...
#ifndef _IFC4X1_IFCTENDONTYPE_AUTO_IMPL_H
#define _IFC4X1_IFCTENDONTYPE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcTendonType : public IfcReinforcingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcTendonType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcTendonType, IfcTendonType> object.
*/
typedef OdSmartPtr<IfcTendonType> IfcTendonTypePtr;

} // namespace

#endif // _IFC4X1_IFCTENDONTYPE_AUTO_IMPL_H
