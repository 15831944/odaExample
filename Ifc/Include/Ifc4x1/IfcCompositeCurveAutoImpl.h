...
#ifndef _IFC4X1_IFCCOMPOSITECURVE_AUTO_IMPL_H
#define _IFC4X1_IFCCOMPOSITECURVE_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcCompositeCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcCompositeCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcCompositeCurve, IfcCompositeCurve> object.
*/
typedef OdSmartPtr<IfcCompositeCurve> IfcCompositeCurvePtr;

} // namespace

#endif // _IFC4X1_IFCCOMPOSITECURVE_AUTO_IMPL_H
