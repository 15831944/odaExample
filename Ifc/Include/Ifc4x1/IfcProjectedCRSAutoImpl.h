...
#ifndef _IFC4X1_IFCPROJECTEDCRS_AUTO_IMPL_H
#define _IFC4X1_IFCPROJECTEDCRS_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcProjectedCRS : public IfcCoordinateReferenceSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcProjectedCRS);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcProjectedCRS, IfcProjectedCRS> object.
*/
typedef OdSmartPtr<IfcProjectedCRS> IfcProjectedCRSPtr;

} // namespace

#endif // _IFC4X1_IFCPROJECTEDCRS_AUTO_IMPL_H
