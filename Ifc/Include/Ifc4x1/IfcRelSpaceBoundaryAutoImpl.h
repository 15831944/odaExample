...
#ifndef _IFC4X1_IFCRELSPACEBOUNDARY_AUTO_IMPL_H
#define _IFC4X1_IFCRELSPACEBOUNDARY_AUTO_IMPL_H
...
class IFC4X1_EXPORT IfcRelSpaceBoundary : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x1::IfcRelSpaceBoundary);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x1::IfcRelSpaceBoundary, IfcRelSpaceBoundary> object.
*/
typedef OdSmartPtr<IfcRelSpaceBoundary> IfcRelSpaceBoundaryPtr;

} // namespace

#endif // _IFC4X1_IFCRELSPACEBOUNDARY_AUTO_IMPL_H
