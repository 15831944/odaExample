...
#ifndef _IFC4X3_RC4_IFCPLANAREXTENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPLANAREXTENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPlanarExtent : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPlanarExtent);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPlanarExtent, IfcPlanarExtent> object.
*/
typedef OdSmartPtr<IfcPlanarExtent> IfcPlanarExtentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPLANAREXTENT_AUTO_IMPL_H
