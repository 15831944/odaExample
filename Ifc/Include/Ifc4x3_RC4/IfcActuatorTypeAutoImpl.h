...
#ifndef _IFC4X3_RC4_IFCACTUATORTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCACTUATORTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcActuatorType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcActuatorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcActuatorType, IfcActuatorType> object.
*/
typedef OdSmartPtr<IfcActuatorType> IfcActuatorTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCACTUATORTYPE_AUTO_IMPL_H
