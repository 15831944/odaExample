...
#ifndef _IFC4X3_RC4_IFCAXIS1PLACEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCAXIS1PLACEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcAxis1Placement : public IfcPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcAxis1Placement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcAxis1Placement, IfcAxis1Placement> object.
*/
typedef OdSmartPtr<IfcAxis1Placement> IfcAxis1PlacementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCAXIS1PLACEMENT_AUTO_IMPL_H
