...
#ifndef _IFC4X3_RC4_IFCMAPCONVERSION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMAPCONVERSION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMapConversion : public IfcCoordinateOperation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMapConversion);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_Eastings;   // IfcLengthMeasure
  double m_Northings;   // IfcLengthMeasure
  double m_OrthogonalHeight;   // IfcLengthMeasure
  double m_XAxisAbscissa;   // IfcReal  [optional]
  double m_XAxisOrdinate;   // IfcReal  [optional]
  double m_Scale;   // IfcReal  [optional]
  double m_ScaleY;   // IfcReal  [optional]
  double m_ScaleZ;   // IfcReal  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMapConversion, IfcMapConversion> object.
*/
typedef OdSmartPtr<IfcMapConversion> IfcMapConversionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMAPCONVERSION_AUTO_IMPL_H
