...
#ifndef _IFC4X3_RC4_IFCQUANTITYTIME_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCQUANTITYTIME_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcQuantityTime : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcQuantityTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcQuantityTime, IfcQuantityTime> object.
*/
typedef OdSmartPtr<IfcQuantityTime> IfcQuantityTimePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCQUANTITYTIME_AUTO_IMPL_H
