...
#ifndef _IFC4X3_RC4_IFCLIBRARYREFERENCE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCLIBRARYREFERENCE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcLibraryReference : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcLibraryReference);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getLanguage() const;
  void setLanguage(const OdAnsiString& Language);
  const OdDAIObjectId& getReferencedLibrary() const;
  void setReferencedLibrary(const OdDAIObjectId& ReferencedLibrary);
  void getInvLibraryRefForObjects(OdDAIObjectIds& LibraryRefForObjects) const;
...
protected:
  ...
  IfcLanguageId m_Language;   // IfcLanguageId  [optional]
  OdDAIObjectId m_ReferencedLibrary;   // IfcLibraryInformation  [optional]

  // Declare friend classes for inverse attributes functionality: 
  friend class IfcRelAssociatesLibrary;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcLibraryReference, IfcLibraryReference> object.
*/
typedef OdSmartPtr<IfcLibraryReference> IfcLibraryReferencePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCLIBRARYREFERENCE_AUTO_IMPL_H
