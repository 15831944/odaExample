...
#ifndef _IFC4X3_RC4_IFCROOFTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCROOFTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRoofType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRoofType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcRoofTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcRoofTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcRoofTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRoofType, IfcRoofType> object.
*/
typedef OdSmartPtr<IfcRoofType> IfcRoofTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCROOFTYPE_AUTO_IMPL_H
