...
#ifndef _IFC4X3_RC4_IFCFLOWSEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFLOWSEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFlowSegment : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFlowSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFlowSegment, IfcFlowSegment> object.
*/
typedef OdSmartPtr<IfcFlowSegment> IfcFlowSegmentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFLOWSEGMENT_AUTO_IMPL_H
