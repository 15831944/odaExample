...
#ifndef _IFC4X3_RC4_IFCTIMESERIESVALUE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTIMESERIESVALUE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTimeSeriesValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTimeSeriesValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTimeSeriesValue, IfcTimeSeriesValue> object.
*/
typedef OdSmartPtr<IfcTimeSeriesValue> IfcTimeSeriesValuePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTIMESERIESVALUE_AUTO_IMPL_H
