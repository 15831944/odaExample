...
#ifndef _IFC4X3_RC4_IFCRELASSOCIATESPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELASSOCIATESPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelAssociatesProfileDef : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelAssociatesProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelAssociatesProfileDef, IfcRelAssociatesProfileDef> object.
*/
typedef OdSmartPtr<IfcRelAssociatesProfileDef> IfcRelAssociatesProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELASSOCIATESPROFILEDEF_AUTO_IMPL_H
