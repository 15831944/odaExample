...
#ifndef _IFC4X3_RC4_IFCZSHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCZSHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcZShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcZShapeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcZShapeProfileDef, IfcZShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcZShapeProfileDef> IfcZShapeProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCZSHAPEPROFILEDEF_AUTO_IMPL_H
