...
#ifndef _IFC4X3_RC4_IFCADDRESS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCADDRESS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcAddress : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcAddress);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_Purpose;   // IfcAddressTypeEnum  [optional]
  OdAnsiString m_Description;   // IfcText  [optional]
  OdAnsiString m_UserDefinedPurpose;   // IfcLabel  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcAddress, IfcAddress> object.
*/
typedef OdSmartPtr<IfcAddress> IfcAddressPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCADDRESS_AUTO_IMPL_H
