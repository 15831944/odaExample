...
#ifndef _IFC4X3_RC4_IFCFLOWMETERTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFLOWMETERTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFlowMeterType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFlowMeterType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFlowMeterType, IfcFlowMeterType> object.
*/
typedef OdSmartPtr<IfcFlowMeterType> IfcFlowMeterTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFLOWMETERTYPE_AUTO_IMPL_H
