...
#ifndef _IFC4X3_RC4_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRampFlightType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRampFlightType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRampFlightType, IfcRampFlightType> object.
*/
typedef OdSmartPtr<IfcRampFlightType> IfcRampFlightTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
