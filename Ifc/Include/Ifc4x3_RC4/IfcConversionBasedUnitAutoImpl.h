...
#ifndef _IFC4X3_RC4_IFCCONVERSIONBASEDUNIT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONVERSIONBASEDUNIT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcConversionBasedUnit : public IfcNamedUnit
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcConversionBasedUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcConversionBasedUnit, IfcConversionBasedUnit> object.
*/
typedef OdSmartPtr<IfcConversionBasedUnit> IfcConversionBasedUnitPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONVERSIONBASEDUNIT_AUTO_IMPL_H
