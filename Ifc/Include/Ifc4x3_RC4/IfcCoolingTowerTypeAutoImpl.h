...
#ifndef _IFC4X3_RC4_IFCCOOLINGTOWERTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOOLINGTOWERTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCoolingTowerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCoolingTowerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCoolingTowerType, IfcCoolingTowerType> object.
*/
typedef OdSmartPtr<IfcCoolingTowerType> IfcCoolingTowerTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOOLINGTOWERTYPE_AUTO_IMPL_H
