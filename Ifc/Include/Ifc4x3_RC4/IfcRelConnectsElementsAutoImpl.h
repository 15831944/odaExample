...
#ifndef _IFC4X3_RC4_IFCRELCONNECTSELEMENTS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELCONNECTSELEMENTS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelConnectsElements : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelConnectsElements);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelConnectsElements, IfcRelConnectsElements> object.
*/
typedef OdSmartPtr<IfcRelConnectsElements> IfcRelConnectsElementsPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELCONNECTSELEMENTS_AUTO_IMPL_H
