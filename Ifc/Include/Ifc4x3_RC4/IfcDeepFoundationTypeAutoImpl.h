...
#ifndef _IFC4X3_RC4_IFCDEEPFOUNDATIONTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDEEPFOUNDATIONTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDeepFoundationType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDeepFoundationType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDeepFoundationType, IfcDeepFoundationType> object.
*/
typedef OdSmartPtr<IfcDeepFoundationType> IfcDeepFoundationTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDEEPFOUNDATIONTYPE_AUTO_IMPL_H
