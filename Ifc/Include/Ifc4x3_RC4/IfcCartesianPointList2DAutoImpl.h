...
#ifndef _IFC4X3_RC4_IFCCARTESIANPOINTLIST2D_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCARTESIANPOINTLIST2D_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCartesianPointList2D : public IfcCartesianPointList
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCartesianPointList2D);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::List<OdDAI::Aggr*> m_CoordList; // LIST [1:?] of LIST [2:2] of IfcLengthMeasure
  OdDAI::OdAnsiStringList m_TagList; // LIST [1:?] of IfcLabel [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCartesianPointList2D, IfcCartesianPointList2D> object.
*/
typedef OdSmartPtr<IfcCartesianPointList2D> IfcCartesianPointList2DPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCARTESIANPOINTLIST2D_AUTO_IMPL_H
