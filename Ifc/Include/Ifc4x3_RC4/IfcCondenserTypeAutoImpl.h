...
#ifndef _IFC4X3_RC4_IFCCONDENSERTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONDENSERTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCondenserType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCondenserType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCondenserType, IfcCondenserType> object.
*/
typedef OdSmartPtr<IfcCondenserType> IfcCondenserTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONDENSERTYPE_AUTO_IMPL_H
