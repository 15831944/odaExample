...
#ifndef _IFC4X3_RC4_IFCADVANCEDBREPWITHVOIDS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCADVANCEDBREPWITHVOIDS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcAdvancedBrepWithVoids : public IfcAdvancedBrep
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcAdvancedBrepWithVoids);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcAdvancedBrepWithVoids, IfcAdvancedBrepWithVoids> object.
*/
typedef OdSmartPtr<IfcAdvancedBrepWithVoids> IfcAdvancedBrepWithVoidsPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCADVANCEDBREPWITHVOIDS_AUTO_IMPL_H
