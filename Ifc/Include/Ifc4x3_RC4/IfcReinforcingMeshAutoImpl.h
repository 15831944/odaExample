...
#ifndef _IFC4X3_RC4_IFCREINFORCINGMESH_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCREINFORCINGMESH_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcReinforcingMesh : public IfcReinforcingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcReinforcingMesh);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Enum m_PredefinedType;   // IfcReinforcingMeshTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcReinforcingMesh, IfcReinforcingMesh> object.
*/
typedef OdSmartPtr<IfcReinforcingMesh> IfcReinforcingMeshPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCREINFORCINGMESH_AUTO_IMPL_H
