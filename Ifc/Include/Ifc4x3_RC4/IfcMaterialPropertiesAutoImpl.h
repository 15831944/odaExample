...
#ifndef _IFC4X3_RC4_IFCMATERIALPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMATERIALPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMaterialProperties : public IfcExtendedProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMaterialProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMaterialProperties, IfcMaterialProperties> object.
*/
typedef OdSmartPtr<IfcMaterialProperties> IfcMaterialPropertiesPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMATERIALPROPERTIES_AUTO_IMPL_H
