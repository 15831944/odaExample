...
#ifndef _IFC4X3_RC4_IFCRELDECLARES_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELDECLARES_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelDeclares : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelDeclares);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatingContext() const;
  void setRelatingContext(const OdDAIObjectId& RelatingContext);
  void getRelatedDefinitions(OdArray<OdDAI::Select >& RelatedDefinitions) const;
  void getRelatedDefinitionsWrapperArray(OdArray<IfcDefinitionSelect>& RelatedDefinitions) const;
  OdDAI::Set<OdDAI::Select>& relatedDefinitions();
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatingContext;   // IfcContext
  OdDAI::Set<OdDAI::Select> m_RelatedDefinitions; // SET [1:?] of IfcDefinitionSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelDeclares, IfcRelDeclares> object.
*/
typedef OdSmartPtr<IfcRelDeclares> IfcRelDeclaresPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELDECLARES_AUTO_IMPL_H
