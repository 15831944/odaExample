...
#ifndef _IFC4X3_RC4_IFCCOMPOSITECURVESEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOMPOSITECURVESEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCompositeCurveSegment : public IfcSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCompositeCurveSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCompositeCurveSegment, IfcCompositeCurveSegment> object.
*/
typedef OdSmartPtr<IfcCompositeCurveSegment> IfcCompositeCurveSegmentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOMPOSITECURVESEGMENT_AUTO_IMPL_H
