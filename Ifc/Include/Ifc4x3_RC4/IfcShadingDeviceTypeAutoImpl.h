...
#ifndef _IFC4X3_RC4_IFCSHADINGDEVICETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSHADINGDEVICETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcShadingDeviceType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcShadingDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcShadingDeviceType, IfcShadingDeviceType> object.
*/
typedef OdSmartPtr<IfcShadingDeviceType> IfcShadingDeviceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSHADINGDEVICETYPE_AUTO_IMPL_H
