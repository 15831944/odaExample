...
#ifndef _IFC4X3_RC4_IFCGRID_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCGRID_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcGrid : public IfcPositioningElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcGrid);
  //DOM-IGNORE-END
...
public:
  ...
  void getUAxes(OdDAIObjectIds& UAxes) const;
  OdDAI::OdDAIObjectIdList& uAxes();
  void getVAxes(OdDAIObjectIds& VAxes) const;
  OdDAI::OdDAIObjectIdList& vAxes();
  void getWAxes(OdDAIObjectIds& WAxes) const;
  OdDAI::OdDAIObjectIdList& wAxes();
  IfcGridTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcGridTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_UAxes; // LIST [1:?] of IfcGridAxis
  OdDAI::OdDAIObjectIdList m_VAxes; // LIST [1:?] of IfcGridAxis
  OdDAI::OdDAIObjectIdList m_WAxes; // LIST [1:?] of IfcGridAxis [optional]

  OdDAI::Enum m_PredefinedType;   // IfcGridTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcGrid, IfcGrid> object.
*/
typedef OdSmartPtr<IfcGrid> IfcGridPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCGRID_AUTO_IMPL_H
