...
#ifndef _IFC4X3_RC4_IFCFASTENER_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFASTENER_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFastener : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFastener);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcFastenerTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFastener, IfcFastener> object.
*/
typedef OdSmartPtr<IfcFastener> IfcFastenerPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFASTENER_AUTO_IMPL_H
