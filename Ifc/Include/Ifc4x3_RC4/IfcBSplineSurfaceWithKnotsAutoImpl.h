...
#ifndef _IFC4X3_RC4_IFCBSPLINESURFACEWITHKNOTS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBSPLINESURFACEWITHKNOTS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBSplineSurfaceWithKnots : public IfcBSplineSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBSplineSurfaceWithKnots);
  //DOM-IGNORE-END
...
public:
  ...
  void getUMultiplicities(OdArray<int >& UMultiplicities) const;
  OdDAI::IntList& uMultiplicities();
  void getVMultiplicities(OdArray<int >& VMultiplicities) const;
  OdDAI::IntList& vMultiplicities();
  void getUKnots(OdArray<double >& UKnots) const;
  OdDAI::DoubleList& uKnots();
  void getVKnots(OdArray<double >& VKnots) const;
  OdDAI::DoubleList& vKnots();
  IfcKnotType getKnotSpec() const;
  void setKnotSpec(IfcKnotType KnotSpec);
...
protected:
  // Fields declaration: 
  OdDAI::IntList m_UMultiplicities; // LIST [2:?] of IfcInteger
  OdDAI::IntList m_VMultiplicities; // LIST [2:?] of IfcInteger
  OdDAI::DoubleList m_UKnots; // LIST [2:?] of IfcParameterValue
  OdDAI::DoubleList m_VKnots; // LIST [2:?] of IfcParameterValue
  OdDAI::Enum m_KnotSpec;   // IfcKnotType
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBSplineSurfaceWithKnots, IfcBSplineSurfaceWithKnots> object.
*/
typedef OdSmartPtr<IfcBSplineSurfaceWithKnots> IfcBSplineSurfaceWithKnotsPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBSPLINESURFACEWITHKNOTS_AUTO_IMPL_H
