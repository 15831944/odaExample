...
#ifndef _IFC4X3_RC4_IFCEXTERNALLYDEFINEDTEXTFONT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCEXTERNALLYDEFINEDTEXTFONT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcExternallyDefinedTextFont : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcExternallyDefinedTextFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcExternallyDefinedTextFont, IfcExternallyDefinedTextFont> object.
*/
typedef OdSmartPtr<IfcExternallyDefinedTextFont> IfcExternallyDefinedTextFontPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCEXTERNALLYDEFINEDTEXTFONT_AUTO_IMPL_H
