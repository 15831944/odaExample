...
#ifndef _IFC4X3_RC4_IFCACTIONREQUEST_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCACTIONREQUEST_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcActionRequest : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcActionRequest);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcActionRequest, IfcActionRequest> object.
*/
typedef OdSmartPtr<IfcActionRequest> IfcActionRequestPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCACTIONREQUEST_AUTO_IMPL_H
