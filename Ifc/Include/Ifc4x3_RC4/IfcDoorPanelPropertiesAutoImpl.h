...
#ifndef _IFC4X3_RC4_IFCDOORPANELPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDOORPANELPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDoorPanelProperties : public IfcPreDefinedPropertySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDoorPanelProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDoorPanelProperties, IfcDoorPanelProperties> object.
*/
typedef OdSmartPtr<IfcDoorPanelProperties> IfcDoorPanelPropertiesPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDOORPANELPROPERTIES_AUTO_IMPL_H
