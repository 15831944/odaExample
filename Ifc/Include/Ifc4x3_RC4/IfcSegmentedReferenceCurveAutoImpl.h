...
#ifndef _IFC4X3_RC4_IFCSEGMENTEDREFERENCECURVE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSEGMENTEDREFERENCECURVE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSegmentedReferenceCurve : public IfcCompositeCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSegmentedReferenceCurve);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getBaseCurve() const;
  void setBaseCurve(const OdDAIObjectId& BaseCurve);
  const OdDAIObjectId& getEndPoint() const;
  void setEndPoint(const OdDAIObjectId& EndPoint);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_BaseCurve;   // IfcBoundedCurve
  OdDAIObjectId m_EndPoint;   // IfcPlacement  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSegmentedReferenceCurve, IfcSegmentedReferenceCurve> object.
*/
typedef OdSmartPtr<IfcSegmentedReferenceCurve> IfcSegmentedReferenceCurvePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSEGMENTEDREFERENCECURVE_AUTO_IMPL_H
