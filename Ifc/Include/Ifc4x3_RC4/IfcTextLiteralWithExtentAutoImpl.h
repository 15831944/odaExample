...
#ifndef _IFC4X3_RC4_IFCTEXTLITERALWITHEXTENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTEXTLITERALWITHEXTENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTextLiteralWithExtent : public IfcTextLiteral
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTextLiteralWithExtent);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getExtent() const;
  void setExtent(const OdDAIObjectId& Extent);
  const OdAnsiString& getBoxAlignment() const;
  void setBoxAlignment(const OdAnsiString& BoxAlignment);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Extent;   // IfcPlanarExtent
  IfcBoxAlignment m_BoxAlignment;   // IfcBoxAlignment
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTextLiteralWithExtent, IfcTextLiteralWithExtent> object.
*/
typedef OdSmartPtr<IfcTextLiteralWithExtent> IfcTextLiteralWithExtentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTEXTLITERALWITHEXTENT_AUTO_IMPL_H
