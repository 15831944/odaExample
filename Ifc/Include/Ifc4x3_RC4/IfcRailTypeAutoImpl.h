...
#ifndef _IFC4X3_RC4_IFCRAILTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRAILTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRailType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRailType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcRailTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcRailTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcRailTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRailType, IfcRailType> object.
*/
typedef OdSmartPtr<IfcRailType> IfcRailTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRAILTYPE_AUTO_IMPL_H
