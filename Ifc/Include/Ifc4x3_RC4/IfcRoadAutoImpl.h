...
#ifndef _IFC4X3_RC4_IFCROAD_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCROAD_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRoad : public IfcFacility
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRoad);
  //DOM-IGNORE-END
...
public:
  ...
  IfcRoadTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcRoadTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcRoadTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRoad, IfcRoad> object.
*/
typedef OdSmartPtr<IfcRoad> IfcRoadPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCROAD_AUTO_IMPL_H
