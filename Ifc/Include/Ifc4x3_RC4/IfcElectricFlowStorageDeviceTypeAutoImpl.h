...
#ifndef _IFC4X3_RC4_IFCELECTRICFLOWSTORAGEDEVICETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCELECTRICFLOWSTORAGEDEVICETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcElectricFlowStorageDeviceType : public IfcFlowStorageDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcElectricFlowStorageDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcElectricFlowStorageDeviceType, IfcElectricFlowStorageDeviceType> object.
*/
typedef OdSmartPtr<IfcElectricFlowStorageDeviceType> IfcElectricFlowStorageDeviceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCELECTRICFLOWSTORAGEDEVICETYPE_AUTO_IMPL_H
