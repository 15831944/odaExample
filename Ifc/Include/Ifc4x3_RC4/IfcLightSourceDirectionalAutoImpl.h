...
#ifndef _IFC4X3_RC4_IFCLIGHTSOURCEDIRECTIONAL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCLIGHTSOURCEDIRECTIONAL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcLightSourceDirectional : public IfcLightSource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcLightSourceDirectional);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcLightSourceDirectional, IfcLightSourceDirectional> object.
*/
typedef OdSmartPtr<IfcLightSourceDirectional> IfcLightSourceDirectionalPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCLIGHTSOURCEDIRECTIONAL_AUTO_IMPL_H
