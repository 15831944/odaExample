...
#ifndef _IFC4X3_RC4_IFCPAVEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPAVEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPavementType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPavementType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcPavementTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcPavementTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcPavementTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPavementType, IfcPavementType> object.
*/
typedef OdSmartPtr<IfcPavementType> IfcPavementTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPAVEMENTTYPE_AUTO_IMPL_H
