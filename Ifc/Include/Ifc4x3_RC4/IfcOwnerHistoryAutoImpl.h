...
#ifndef _IFC4X3_RC4_IFCOWNERHISTORY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCOWNERHISTORY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcOwnerHistory : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcOwnerHistory);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_OwningUser;   // IfcPersonAndOrganization
  OdDAIObjectId m_OwningApplication;   // IfcApplication
  OdDAI::Enum m_State;   // IfcStateEnum  [optional]
  OdDAI::Enum m_ChangeAction;   // IfcChangeActionEnum  [optional]
  int m_LastModifiedDate;   // IfcTimeStamp  [optional]
  OdDAIObjectId m_LastModifyingUser;   // IfcPersonAndOrganization  [optional]
  OdDAIObjectId m_LastModifyingApplication;   // IfcApplication  [optional]
  int m_CreationDate;   // IfcTimeStamp
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcOwnerHistory, IfcOwnerHistory> object.
*/
typedef OdSmartPtr<IfcOwnerHistory> IfcOwnerHistoryPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCOWNERHISTORY_AUTO_IMPL_H
