...
#ifndef _IFC4X3_RC4_IFCTABLE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTABLE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTable : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTable);
  //DOM-IGNORE-END
...
public:
  ...
  void getRows(OdDAIObjectIds& Rows) const;
  OdDAI::OdDAIObjectIdList& rows();
  void getColumns(OdDAIObjectIds& Columns) const;
  OdDAI::OdDAIObjectIdList& columns();
...
protected:
  ...
  OdDAI::OdDAIObjectIdList m_Rows; // LIST [1:?] of IfcTableRow [optional]

  OdDAI::OdDAIObjectIdList m_Columns; // LIST [1:?] of IfcTableColumn [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTable, IfcTable> object.
*/
typedef OdSmartPtr<IfcTable> IfcTablePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTABLE_AUTO_IMPL_H
