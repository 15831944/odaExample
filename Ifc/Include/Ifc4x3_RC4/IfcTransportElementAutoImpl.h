...
#ifndef _IFC4X3_RC4_IFCTRANSPORTELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTRANSPORTELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTransportElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTransportElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTransportElement, IfcTransportElement> object.
*/
typedef OdSmartPtr<IfcTransportElement> IfcTransportElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTRANSPORTELEMENT_AUTO_IMPL_H
