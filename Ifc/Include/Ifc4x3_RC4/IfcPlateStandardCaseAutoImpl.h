...
#ifndef _IFC4X3_RC4_IFCPLATESTANDARDCASE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPLATESTANDARDCASE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPlateStandardCase : public IfcPlate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPlateStandardCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPlateStandardCase, IfcPlateStandardCase> object.
*/
typedef OdSmartPtr<IfcPlateStandardCase> IfcPlateStandardCasePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPLATESTANDARDCASE_AUTO_IMPL_H
