...
#ifndef _IFC4X3_RC4_IFCPROTECTIVEDEVICETRIPPINGUNIT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROTECTIVEDEVICETRIPPINGUNIT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcProtectiveDeviceTrippingUnit : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcProtectiveDeviceTrippingUnit);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcProtectiveDeviceTrippingUnitTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcProtectiveDeviceTrippingUnit, IfcProtectiveDeviceTrippingUnit> object.
*/
typedef OdSmartPtr<IfcProtectiveDeviceTrippingUnit> IfcProtectiveDeviceTrippingUnitPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROTECTIVEDEVICETRIPPINGUNIT_AUTO_IMPL_H
