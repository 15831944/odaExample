...
#ifndef _IFC4X3_RC4_IFCDISTRIBUTIONCHAMBERELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDISTRIBUTIONCHAMBERELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDistributionChamberElementType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDistributionChamberElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDistributionChamberElementType, IfcDistributionChamberElementType> object.
*/
typedef OdSmartPtr<IfcDistributionChamberElementType> IfcDistributionChamberElementTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDISTRIBUTIONCHAMBERELEMENTTYPE_AUTO_IMPL_H
