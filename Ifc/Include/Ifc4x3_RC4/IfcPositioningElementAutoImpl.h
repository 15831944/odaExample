...
#ifndef _IFC4X3_RC4_IFCPOSITIONINGELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPOSITIONINGELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPositioningElement : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPositioningElement);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvPositions(OdDAIObjectIds& Positions) const;
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPositioningElement, IfcPositioningElement> object.
*/
typedef OdSmartPtr<IfcPositioningElement> IfcPositioningElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPOSITIONINGELEMENT_AUTO_IMPL_H
