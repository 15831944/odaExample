...
#ifndef _IFC4X3_RC4_IFCSINE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSINE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSine : public IfcSpiral
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSine);
  //DOM-IGNORE-END
...
public:
  ...
  double getSineTerm() const;
  void setSineTerm(double SineTerm);
...
protected:
  // Fields declaration: 
  double m_SineTerm;   // IfcLengthMeasure
  double m_LinearTerm;   // IfcLengthMeasure  [optional]
  double m_ConstantTerm;   // IfcLengthMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSine, IfcSine> object.
*/
typedef OdSmartPtr<IfcSine> IfcSinePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSINE_AUTO_IMPL_H
