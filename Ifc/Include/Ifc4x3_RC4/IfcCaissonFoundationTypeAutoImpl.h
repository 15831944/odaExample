...
#ifndef _IFC4X3_RC4_IFCCAISSONFOUNDATIONTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCAISSONFOUNDATIONTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCaissonFoundationType : public IfcDeepFoundationType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCaissonFoundationType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcCaissonFoundationTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcCaissonFoundationTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCaissonFoundationTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCaissonFoundationType, IfcCaissonFoundationType> object.
*/
typedef OdSmartPtr<IfcCaissonFoundationType> IfcCaissonFoundationTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCAISSONFOUNDATIONTYPE_AUTO_IMPL_H
