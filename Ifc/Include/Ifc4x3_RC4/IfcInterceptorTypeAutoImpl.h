...
#ifndef _IFC4X3_RC4_IFCINTERCEPTORTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCINTERCEPTORTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcInterceptorType : public IfcFlowTreatmentDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcInterceptorType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcInterceptorTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcInterceptorTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcInterceptorTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcInterceptorType, IfcInterceptorType> object.
*/
typedef OdSmartPtr<IfcInterceptorType> IfcInterceptorTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCINTERCEPTORTYPE_AUTO_IMPL_H
