...
#ifndef _IFC4X3_RC4_IFCSURFACECURVESWEPTAREASOLID_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSURFACECURVESWEPTAREASOLID_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSurfaceCurveSweptAreaSolid : public IfcDirectrixCurveSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSurfaceCurveSweptAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSurfaceCurveSweptAreaSolid, IfcSurfaceCurveSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcSurfaceCurveSweptAreaSolid> IfcSurfaceCurveSweptAreaSolidPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSURFACECURVESWEPTAREASOLID_AUTO_IMPL_H
