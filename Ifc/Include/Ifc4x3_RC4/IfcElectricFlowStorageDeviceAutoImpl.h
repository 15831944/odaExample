...
#ifndef _IFC4X3_RC4_IFCELECTRICFLOWSTORAGEDEVICE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCELECTRICFLOWSTORAGEDEVICE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcElectricFlowStorageDevice : public IfcFlowStorageDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcElectricFlowStorageDevice);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcElectricFlowStorageDeviceTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcElectricFlowStorageDevice, IfcElectricFlowStorageDevice> object.
*/
typedef OdSmartPtr<IfcElectricFlowStorageDevice> IfcElectricFlowStorageDevicePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCELECTRICFLOWSTORAGEDEVICE_AUTO_IMPL_H
