...
#ifndef _IFC4X3_RC4_IFCSWEPTDISKSOLID_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSWEPTDISKSOLID_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSweptDiskSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSweptDiskSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSweptDiskSolid, IfcSweptDiskSolid> object.
*/
typedef OdSmartPtr<IfcSweptDiskSolid> IfcSweptDiskSolidPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSWEPTDISKSOLID_AUTO_IMPL_H
