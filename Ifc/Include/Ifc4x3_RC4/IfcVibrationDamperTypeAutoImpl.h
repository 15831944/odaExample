...
#ifndef _IFC4X3_RC4_IFCVIBRATIONDAMPERTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCVIBRATIONDAMPERTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcVibrationDamperType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcVibrationDamperType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcVibrationDamperType, IfcVibrationDamperType> object.
*/
typedef OdSmartPtr<IfcVibrationDamperType> IfcVibrationDamperTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCVIBRATIONDAMPERTYPE_AUTO_IMPL_H
