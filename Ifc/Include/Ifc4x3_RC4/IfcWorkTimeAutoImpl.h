...
#ifndef _IFC4X3_RC4_IFCWORKTIME_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCWORKTIME_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcWorkTime : public IfcSchedulingTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcWorkTime);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RecurrencePattern;   // IfcRecurrencePattern  [optional]
  OdAnsiString m_Start;   // IfcDate  [optional]
  OdAnsiString m_Finish;   // IfcDate  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcWorkTime, IfcWorkTime> object.
*/
typedef OdSmartPtr<IfcWorkTime> IfcWorkTimePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCWORKTIME_AUTO_IMPL_H
