...
#ifndef _IFC4X3_RC4_IFCPUMP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPUMP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPump : public IfcFlowMovingDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPump);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcPumpTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPump, IfcPump> object.
*/
typedef OdSmartPtr<IfcPump> IfcPumpPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPUMP_AUTO_IMPL_H
