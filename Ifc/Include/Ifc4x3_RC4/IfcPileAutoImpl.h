...
#ifndef _IFC4X3_RC4_IFCPILE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPILE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPile : public IfcDeepFoundation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPile);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPile, IfcPile> object.
*/
typedef OdSmartPtr<IfcPile> IfcPilePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPILE_AUTO_IMPL_H
