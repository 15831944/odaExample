...
#ifndef _IFC4X3_RC4_IFCOFFSETCURVE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCOFFSETCURVE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcOffsetCurve : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcOffsetCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcOffsetCurve, IfcOffsetCurve> object.
*/
typedef OdSmartPtr<IfcOffsetCurve> IfcOffsetCurvePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCOFFSETCURVE_AUTO_IMPL_H
