...
#ifndef _IFC4X3_RC4_IFCCONVEYORSEGMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONVEYORSEGMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcConveyorSegmentType : public IfcFlowSegmentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcConveyorSegmentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcConveyorSegmentType, IfcConveyorSegmentType> object.
*/
typedef OdSmartPtr<IfcConveyorSegmentType> IfcConveyorSegmentTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONVEYORSEGMENTTYPE_AUTO_IMPL_H
