...
#ifndef _IFC4X3_RC4_IFCLIQUIDTERMINAL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCLIQUIDTERMINAL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcLiquidTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcLiquidTerminal);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcLiquidTerminalTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcLiquidTerminal, IfcLiquidTerminal> object.
*/
typedef OdSmartPtr<IfcLiquidTerminal> IfcLiquidTerminalPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCLIQUIDTERMINAL_AUTO_IMPL_H
