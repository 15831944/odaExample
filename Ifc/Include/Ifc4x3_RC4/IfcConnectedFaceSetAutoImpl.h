...
#ifndef _IFC4X3_RC4_IFCCONNECTEDFACESET_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONNECTEDFACESET_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcConnectedFaceSet : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcConnectedFaceSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcConnectedFaceSet, IfcConnectedFaceSet> object.
*/
typedef OdSmartPtr<IfcConnectedFaceSet> IfcConnectedFaceSetPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONNECTEDFACESET_AUTO_IMPL_H
