...
#ifndef _IFC4X3_RC4_IFCCABLECARRIERFITTING_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCABLECARRIERFITTING_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCableCarrierFitting : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCableCarrierFitting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCableCarrierFitting, IfcCableCarrierFitting> object.
*/
typedef OdSmartPtr<IfcCableCarrierFitting> IfcCableCarrierFittingPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCABLECARRIERFITTING_AUTO_IMPL_H
