...
#ifndef _IFC4X3_RC4_IFCCOURSE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOURSE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCourse : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCourse);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCourseTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCourse, IfcCourse> object.
*/
typedef OdSmartPtr<IfcCourse> IfcCoursePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOURSE_AUTO_IMPL_H
