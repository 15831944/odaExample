...
#ifndef _IFC4X3_RC4_IFCEXTERNALLYDEFINEDHATCHSTYLE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCEXTERNALLYDEFINEDHATCHSTYLE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcExternallyDefinedHatchStyle : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcExternallyDefinedHatchStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcExternallyDefinedHatchStyle, IfcExternallyDefinedHatchStyle> object.
*/
typedef OdSmartPtr<IfcExternallyDefinedHatchStyle> IfcExternallyDefinedHatchStylePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCEXTERNALLYDEFINEDHATCHSTYLE_AUTO_IMPL_H
