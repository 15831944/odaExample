...
#ifndef _IFC4X3_RC4_IFCAPPROVAL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCAPPROVAL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcApproval : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcApproval);
  //DOM-IGNORE-END
...
protected:
  ...
  OdAnsiString m_TimeOfApproval;   // IfcDateTime  [optional]
  OdAnsiString m_Status;   // IfcLabel  [optional]
  OdAnsiString m_Level;   // IfcLabel  [optional]
  OdAnsiString m_Qualifier;   // IfcText  [optional]
  OdDAI::Select m_RequestingApproval;   // IfcActorSelect  [optional]
  OdDAI::Select m_GivingApproval;   // IfcActorSelect  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcApproval, IfcApproval> object.
*/
typedef OdSmartPtr<IfcApproval> IfcApprovalPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCAPPROVAL_AUTO_IMPL_H
