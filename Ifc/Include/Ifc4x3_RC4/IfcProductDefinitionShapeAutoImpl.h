...
#ifndef _IFC4X3_RC4_IFCPRODUCTDEFINITIONSHAPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPRODUCTDEFINITIONSHAPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcProductDefinitionShape : public IfcProductRepresentation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcProductDefinitionShape);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvShapeOfProduct(OdDAIObjectIds& ShapeOfProduct) const;
...
protected:
  using IfcProductRepresentation::getAttr;
  using IfcProductRepresentation::putAttr;
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcProductDefinitionShape, IfcProductDefinitionShape> object.
*/
typedef OdSmartPtr<IfcProductDefinitionShape> IfcProductDefinitionShapePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPRODUCTDEFINITIONSHAPE_AUTO_IMPL_H
