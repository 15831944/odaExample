...
#ifndef _IFC4X3_RC4_IFCGEOGRAPHICELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCGEOGRAPHICELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcGeographicElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcGeographicElementType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcGeographicElementTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcGeographicElementTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcGeographicElementTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcGeographicElementType, IfcGeographicElementType> object.
*/
typedef OdSmartPtr<IfcGeographicElementType> IfcGeographicElementTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCGEOGRAPHICELEMENTTYPE_AUTO_IMPL_H
