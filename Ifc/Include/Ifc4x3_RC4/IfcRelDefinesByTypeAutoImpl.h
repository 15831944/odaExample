...
#ifndef _IFC4X3_RC4_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelDefinesByType : public IfcRelDefines
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelDefinesByType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelDefinesByType, IfcRelDefinesByType> object.
*/
typedef OdSmartPtr<IfcRelDefinesByType> IfcRelDefinesByTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
