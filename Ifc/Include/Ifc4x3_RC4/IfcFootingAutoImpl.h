...
#ifndef _IFC4X3_RC4_IFCFOOTING_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFOOTING_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFooting : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFooting);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcFootingTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFooting, IfcFooting> object.
*/
typedef OdSmartPtr<IfcFooting> IfcFootingPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFOOTING_AUTO_IMPL_H
