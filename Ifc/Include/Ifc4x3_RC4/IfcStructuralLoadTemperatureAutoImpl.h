...
#ifndef _IFC4X3_RC4_IFCSTRUCTURALLOADTEMPERATURE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTRUCTURALLOADTEMPERATURE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStructuralLoadTemperature : public IfcStructuralLoadStatic
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStructuralLoadTemperature);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_DeltaTConstant;   // IfcThermodynamicTemperatureMeasure  [optional]
  double m_DeltaTY;   // IfcThermodynamicTemperatureMeasure  [optional]
  double m_DeltaTZ;   // IfcThermodynamicTemperatureMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStructuralLoadTemperature, IfcStructuralLoadTemperature> object.
*/
typedef OdSmartPtr<IfcStructuralLoadTemperature> IfcStructuralLoadTemperaturePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTRUCTURALLOADTEMPERATURE_AUTO_IMPL_H
