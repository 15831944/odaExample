...
#ifndef _IFC4X3_RC4_IFCAPPLIEDVALUE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCAPPLIEDVALUE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcAppliedValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcAppliedValue);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& components();
...
protected:
  ...
  OdDAI::Select m_AppliedValue;   // IfcAppliedValueSelect  [optional]
  OdDAIObjectId m_UnitBasis;   // IfcMeasureWithUnit  [optional]
  OdAnsiString m_ApplicableDate;   // IfcDate  [optional]
  OdAnsiString m_FixedUntilDate;   // IfcDate  [optional]
  OdAnsiString m_Category;   // IfcLabel  [optional]
  OdAnsiString m_Condition;   // IfcLabel  [optional]
  OdDAI::Enum m_ArithmeticOperator;   // IfcArithmeticOperatorEnum  [optional]
  OdDAI::OdDAIObjectIdList m_Components; // LIST [1:?] of IfcAppliedValue [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcAppliedValue, IfcAppliedValue> object.
*/
typedef OdSmartPtr<IfcAppliedValue> IfcAppliedValuePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCAPPLIEDVALUE_AUTO_IMPL_H
