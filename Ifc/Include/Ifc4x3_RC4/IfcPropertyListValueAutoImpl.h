...
#ifndef _IFC4X3_RC4_IFCPROPERTYLISTVALUE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROPERTYLISTVALUE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPropertyListValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPropertyListValue);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::List<OdDAI::Select> m_ListValues; // LIST [1:?] of IfcValue [optional]

  OdDAI::Select m_Unit;   // IfcUnit  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPropertyListValue, IfcPropertyListValue> object.
*/
typedef OdSmartPtr<IfcPropertyListValue> IfcPropertyListValuePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROPERTYLISTVALUE_AUTO_IMPL_H
