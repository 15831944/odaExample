...
#ifndef _IFC4X3_RC4_IFCFOOTINGTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFOOTINGTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFootingType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFootingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFootingType, IfcFootingType> object.
*/
typedef OdSmartPtr<IfcFootingType> IfcFootingTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFOOTINGTYPE_AUTO_IMPL_H
