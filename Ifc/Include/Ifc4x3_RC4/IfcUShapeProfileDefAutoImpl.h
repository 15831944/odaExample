...
#ifndef _IFC4X3_RC4_IFCUSHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCUSHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcUShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcUShapeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcUShapeProfileDef, IfcUShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcUShapeProfileDef> IfcUShapeProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCUSHAPEPROFILEDEF_AUTO_IMPL_H
