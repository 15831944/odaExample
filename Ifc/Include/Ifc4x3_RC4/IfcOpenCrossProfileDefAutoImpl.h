...
#ifndef _IFC4X3_RC4_IFCOPENCROSSPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCOPENCROSSPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcOpenCrossProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcOpenCrossProfileDef);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::Boolean getHorizontalWidths() const;
  void setHorizontalWidths(OdDAI::Boolean HorizontalWidths);
  void getWidths(OdArray<double >& Widths) const;
  OdDAI::DoubleList& widths();
  void getSlopes(OdArray<double >& Slopes) const;
  OdDAI::DoubleList& slopes();
  void getTags(OdArray<OdAnsiString >& Tags) const;
  OdDAI::OdAnsiStringList& tags();
  const OdDAIObjectId& getOffsetPoint() const;
  void setOffsetPoint(const OdDAIObjectId& OffsetPoint);
...
protected:
  // Fields declaration: 
  OdDAI::Boolean m_HorizontalWidths;   // IfcBoolean
  OdDAI::DoubleList m_Widths; // LIST [1:?] of IfcNonNegativeLengthMeasure
  OdDAI::DoubleList m_Slopes; // LIST [1:?] of IfcPlaneAngleMeasure
  OdDAI::OdAnsiStringList m_Tags; // LIST [2:?] of IfcLabel [optional]

  OdDAIObjectId m_OffsetPoint;   // IfcCartesianPoint  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcOpenCrossProfileDef, IfcOpenCrossProfileDef> object.
*/
typedef OdSmartPtr<IfcOpenCrossProfileDef> IfcOpenCrossProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCOPENCROSSPROFILEDEF_AUTO_IMPL_H
