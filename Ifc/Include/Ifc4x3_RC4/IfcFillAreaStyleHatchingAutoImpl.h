...
#ifndef _IFC4X3_RC4_IFCFILLAREASTYLEHATCHING_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFILLAREASTYLEHATCHING_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFillAreaStyleHatching : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFillAreaStyleHatching);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Select m_StartOfNextHatchLine;   // IfcHatchLineDistanceSelect
  OdDAIObjectId m_PointOfReferenceHatchLine;   // IfcCartesianPoint  [optional]
  OdDAIObjectId m_PatternStart;   // IfcCartesianPoint  [optional]
  double m_HatchLineAngle;   // IfcPlaneAngleMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFillAreaStyleHatching, IfcFillAreaStyleHatching> object.
*/
typedef OdSmartPtr<IfcFillAreaStyleHatching> IfcFillAreaStyleHatchingPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFILLAREASTYLEHATCHING_AUTO_IMPL_H
