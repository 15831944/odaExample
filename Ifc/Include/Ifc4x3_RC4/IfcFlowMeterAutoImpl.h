...
#ifndef _IFC4X3_RC4_IFCFLOWMETER_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFLOWMETER_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFlowMeter : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFlowMeter);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcFlowMeterTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFlowMeter, IfcFlowMeter> object.
*/
typedef OdSmartPtr<IfcFlowMeter> IfcFlowMeterPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFLOWMETER_AUTO_IMPL_H
