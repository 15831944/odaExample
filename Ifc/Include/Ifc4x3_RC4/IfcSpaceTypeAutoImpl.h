...
#ifndef _IFC4X3_RC4_IFCSPACETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSPACETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSpaceType : public IfcSpatialStructureElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSpaceType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSpaceTypeEnum
  OdAnsiString m_LongName;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSpaceType, IfcSpaceType> object.
*/
typedef OdSmartPtr<IfcSpaceType> IfcSpaceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSPACETYPE_AUTO_IMPL_H
