...
#ifndef _IFC4X3_RC4_IFCWORKSCHEDULE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCWORKSCHEDULE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcWorkSchedule : public IfcWorkControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcWorkSchedule);
  //DOM-IGNORE-END
...
public:
  ...
  IfcWorkScheduleTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcWorkScheduleTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcWorkScheduleTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcWorkSchedule, IfcWorkSchedule> object.
*/
typedef OdSmartPtr<IfcWorkSchedule> IfcWorkSchedulePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCWORKSCHEDULE_AUTO_IMPL_H
