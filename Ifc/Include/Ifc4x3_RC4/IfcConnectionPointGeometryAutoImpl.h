...
#ifndef _IFC4X3_RC4_IFCCONNECTIONPOINTGEOMETRY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONNECTIONPOINTGEOMETRY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcConnectionPointGeometry : public IfcConnectionGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcConnectionPointGeometry);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcConnectionPointGeometry, IfcConnectionPointGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionPointGeometry> IfcConnectionPointGeometryPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONNECTIONPOINTGEOMETRY_AUTO_IMPL_H
