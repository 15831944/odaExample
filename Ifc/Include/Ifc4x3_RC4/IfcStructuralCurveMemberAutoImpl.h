...
#ifndef _IFC4X3_RC4_IFCSTRUCTURALCURVEMEMBER_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTRUCTURALCURVEMEMBER_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStructuralCurveMember : public IfcStructuralMember
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStructuralCurveMember);
  //DOM-IGNORE-END
...
public:
  ...
  IfcStructuralCurveMemberTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcStructuralCurveMemberTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcStructuralCurveMemberTypeEnum
  OdDAIObjectId m_Axis;   // IfcDirection
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStructuralCurveMember, IfcStructuralCurveMember> object.
*/
typedef OdSmartPtr<IfcStructuralCurveMember> IfcStructuralCurveMemberPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTRUCTURALCURVEMEMBER_AUTO_IMPL_H
