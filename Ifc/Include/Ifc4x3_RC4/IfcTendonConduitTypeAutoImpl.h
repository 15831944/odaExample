...
#ifndef _IFC4X3_RC4_IFCTENDONCONDUITTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTENDONCONDUITTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTendonConduitType : public IfcReinforcingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTendonConduitType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcTendonConduitTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcTendonConduitTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcTendonConduitTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTendonConduitType, IfcTendonConduitType> object.
*/
typedef OdSmartPtr<IfcTendonConduitType> IfcTendonConduitTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTENDONCONDUITTYPE_AUTO_IMPL_H
