...
#ifndef _IFC4X3_RC4_IFCSECTIONPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSECTIONPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSectionProperties : public IfcPreDefinedProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSectionProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSectionProperties, IfcSectionProperties> object.
*/
typedef OdSmartPtr<IfcSectionProperties> IfcSectionPropertiesPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSECTIONPROPERTIES_AUTO_IMPL_H
