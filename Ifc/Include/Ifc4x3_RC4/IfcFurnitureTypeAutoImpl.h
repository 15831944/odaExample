...
#ifndef _IFC4X3_RC4_IFCFURNITURETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFURNITURETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFurnitureType : public IfcFurnishingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFurnitureType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFurnitureType, IfcFurnitureType> object.
*/
typedef OdSmartPtr<IfcFurnitureType> IfcFurnitureTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFURNITURETYPE_AUTO_IMPL_H
