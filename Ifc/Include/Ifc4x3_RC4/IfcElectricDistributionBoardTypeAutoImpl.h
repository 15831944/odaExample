...
#ifndef _IFC4X3_RC4_IFCELECTRICDISTRIBUTIONBOARDTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCELECTRICDISTRIBUTIONBOARDTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcElectricDistributionBoardType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcElectricDistributionBoardType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcElectricDistributionBoardTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcElectricDistributionBoardTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcElectricDistributionBoardTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcElectricDistributionBoardType, IfcElectricDistributionBoardType> object.
*/
typedef OdSmartPtr<IfcElectricDistributionBoardType> IfcElectricDistributionBoardTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCELECTRICDISTRIBUTIONBOARDTYPE_AUTO_IMPL_H
