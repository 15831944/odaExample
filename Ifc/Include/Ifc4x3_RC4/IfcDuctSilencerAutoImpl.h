...
#ifndef _IFC4X3_RC4_IFCDUCTSILENCER_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDUCTSILENCER_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDuctSilencer : public IfcFlowTreatmentDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDuctSilencer);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDuctSilencer, IfcDuctSilencer> object.
*/
typedef OdSmartPtr<IfcDuctSilencer> IfcDuctSilencerPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDUCTSILENCER_AUTO_IMPL_H
