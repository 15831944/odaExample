...
#ifndef _IFC4X3_RC4_IFCSTRUCTURALCONNECTION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTRUCTURALCONNECTION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStructuralConnection : public IfcStructuralItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStructuralConnection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStructuralConnection, IfcStructuralConnection> object.
*/
typedef OdSmartPtr<IfcStructuralConnection> IfcStructuralConnectionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTRUCTURALCONNECTION_AUTO_IMPL_H
