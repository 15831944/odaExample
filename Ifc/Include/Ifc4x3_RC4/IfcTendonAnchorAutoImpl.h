...
#ifndef _IFC4X3_RC4_IFCTENDONANCHOR_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTENDONANCHOR_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTendonAnchor : public IfcReinforcingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTendonAnchor);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcTendonAnchorTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTendonAnchor, IfcTendonAnchor> object.
*/
typedef OdSmartPtr<IfcTendonAnchor> IfcTendonAnchorPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTENDONANCHOR_AUTO_IMPL_H
