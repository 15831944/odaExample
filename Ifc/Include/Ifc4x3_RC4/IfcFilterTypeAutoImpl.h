...
#ifndef _IFC4X3_RC4_IFCFILTERTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFILTERTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFilterType : public IfcFlowTreatmentDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFilterType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFilterType, IfcFilterType> object.
*/
typedef OdSmartPtr<IfcFilterType> IfcFilterTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFILTERTYPE_AUTO_IMPL_H
