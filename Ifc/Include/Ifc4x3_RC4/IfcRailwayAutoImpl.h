...
#ifndef _IFC4X3_RC4_IFCRAILWAY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRAILWAY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRailway : public IfcFacility
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRailway);
  //DOM-IGNORE-END
...
public:
  ...
  IfcRailwayTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcRailwayTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcRailwayTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRailway, IfcRailway> object.
*/
typedef OdSmartPtr<IfcRailway> IfcRailwayPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRAILWAY_AUTO_IMPL_H
