...
#ifndef _IFC4X3_RC4_IFCCONNECTIONCURVEGEOMETRY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONNECTIONCURVEGEOMETRY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcConnectionCurveGeometry : public IfcConnectionGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcConnectionCurveGeometry);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_CurveOnRelatingElement;   // IfcCurveOrEdgeCurve
  OdDAI::Select m_CurveOnRelatedElement;   // IfcCurveOrEdgeCurve  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcConnectionCurveGeometry, IfcConnectionCurveGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionCurveGeometry> IfcConnectionCurveGeometryPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONNECTIONCURVEGEOMETRY_AUTO_IMPL_H
