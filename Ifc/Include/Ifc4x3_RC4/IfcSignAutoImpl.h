...
#ifndef _IFC4X3_RC4_IFCSIGN_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSIGN_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSign : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSign);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSign, IfcSign> object.
*/
typedef OdSmartPtr<IfcSign> IfcSignPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSIGN_AUTO_IMPL_H
