...
#ifndef _IFC4X3_RC4_IFCTOPOLOGICALREPRESENTATIONITEM_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTOPOLOGICALREPRESENTATIONITEM_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTopologicalRepresentationItem : public IfcRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTopologicalRepresentationItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTopologicalRepresentationItem, IfcTopologicalRepresentationItem> object.
*/
typedef OdSmartPtr<IfcTopologicalRepresentationItem> IfcTopologicalRepresentationItemPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTOPOLOGICALREPRESENTATIONITEM_AUTO_IMPL_H
