...
#ifndef _IFC4X3_RC4_IFCOPENINGELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCOPENINGELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcOpeningElement : public IfcFeatureElementSubtraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcOpeningElement);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcOpeningElementTypeEnum  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcOpeningElement, IfcOpeningElement> object.
*/
typedef OdSmartPtr<IfcOpeningElement> IfcOpeningElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCOPENINGELEMENT_AUTO_IMPL_H
