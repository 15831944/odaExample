...
#ifndef _IFC4X3_RC4_IFCRATIONALBSPLINESURFACEWITHKNOTS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRATIONALBSPLINESURFACEWITHKNOTS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRationalBSplineSurfaceWithKnots : public IfcBSplineSurfaceWithKnots
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRationalBSplineSurfaceWithKnots);
  //DOM-IGNORE-END
...
public:
  ...
  void getWeightsData(OdArray<OdArray<double > >& WeightsData) const;
  OdDAI::List<OdDAI::Aggr*>& weightsData();
...
protected:
  // Fields declaration: 
  OdDAI::List<OdDAI::Aggr*> m_WeightsData; // LIST [2:?] of LIST [2:?] of IfcReal
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRationalBSplineSurfaceWithKnots, IfcRationalBSplineSurfaceWithKnots> object.
*/
typedef OdSmartPtr<IfcRationalBSplineSurfaceWithKnots> IfcRationalBSplineSurfaceWithKnotsPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRATIONALBSPLINESURFACEWITHKNOTS_AUTO_IMPL_H
