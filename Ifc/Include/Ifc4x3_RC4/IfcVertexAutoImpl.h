...
#ifndef _IFC4X3_RC4_IFCVERTEX_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCVERTEX_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcVertex : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcVertex);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcVertex, IfcVertex> object.
*/
typedef OdSmartPtr<IfcVertex> IfcVertexPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCVERTEX_AUTO_IMPL_H
