...
#ifndef _IFC4X3_RC4_IFCPROPERTYBOUNDEDVALUE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROPERTYBOUNDEDVALUE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPropertyBoundedValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPropertyBoundedValue);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_UpperBoundValue;   // IfcValue  [optional]
  OdDAI::Select m_LowerBoundValue;   // IfcValue  [optional]
  OdDAI::Select m_Unit;   // IfcUnit  [optional]
  OdDAI::Select m_SetPointValue;   // IfcValue  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPropertyBoundedValue, IfcPropertyBoundedValue> object.
*/
typedef OdSmartPtr<IfcPropertyBoundedValue> IfcPropertyBoundedValuePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROPERTYBOUNDEDVALUE_AUTO_IMPL_H
