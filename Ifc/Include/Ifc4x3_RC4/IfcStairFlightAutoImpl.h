...
#ifndef _IFC4X3_RC4_IFCSTAIRFLIGHT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTAIRFLIGHT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStairFlight : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStairFlight);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStairFlight, IfcStairFlight> object.
*/
typedef OdSmartPtr<IfcStairFlight> IfcStairFlightPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTAIRFLIGHT_AUTO_IMPL_H
