...
#ifndef _IFC4X3_RC4_IFCTENDONTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTENDONTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTendonType : public IfcReinforcingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTendonType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTendonType, IfcTendonType> object.
*/
typedef OdSmartPtr<IfcTendonType> IfcTendonTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTENDONTYPE_AUTO_IMPL_H
