...
#ifndef _IFC4X3_RC4_IFCVOIDSTRATUM_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCVOIDSTRATUM_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcVoidStratum : public IfcGeotechnicalStratum
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcVoidStratum);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcVoidStratum, IfcVoidStratum> object.
*/
typedef OdSmartPtr<IfcVoidStratum> IfcVoidStratumPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCVOIDSTRATUM_AUTO_IMPL_H
