...
#ifndef _IFC4X3_RC4_IFCEVAPORATIVECOOLER_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCEVAPORATIVECOOLER_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcEvaporativeCooler : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcEvaporativeCooler);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcEvaporativeCoolerTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcEvaporativeCooler, IfcEvaporativeCooler> object.
*/
typedef OdSmartPtr<IfcEvaporativeCooler> IfcEvaporativeCoolerPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCEVAPORATIVECOOLER_AUTO_IMPL_H
