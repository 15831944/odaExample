...
#ifndef _IFC4X3_RC4_IFCBUILDINGELEMENTPARTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBUILDINGELEMENTPARTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBuildingElementPartType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBuildingElementPartType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcBuildingElementPartTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcBuildingElementPartTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcBuildingElementPartTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBuildingElementPartType, IfcBuildingElementPartType> object.
*/
typedef OdSmartPtr<IfcBuildingElementPartType> IfcBuildingElementPartTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBUILDINGELEMENTPARTTYPE_AUTO_IMPL_H
