...
#ifndef _IFC4X3_RC4_IFCSIGNAL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSIGNAL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSignal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSignal);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSignalTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSignal, IfcSignal> object.
*/
typedef OdSmartPtr<IfcSignal> IfcSignalPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSIGNAL_AUTO_IMPL_H
