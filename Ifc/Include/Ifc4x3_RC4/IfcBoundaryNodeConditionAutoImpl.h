...
#ifndef _IFC4X3_RC4_IFCBOUNDARYNODECONDITION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBOUNDARYNODECONDITION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBoundaryNodeCondition : public IfcBoundaryCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBoundaryNodeCondition);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_TranslationalStiffnessX;   // IfcTranslationalStiffnessSelect  [optional]
  OdDAI::Select m_TranslationalStiffnessY;   // IfcTranslationalStiffnessSelect  [optional]
  OdDAI::Select m_TranslationalStiffnessZ;   // IfcTranslationalStiffnessSelect  [optional]
  OdDAI::Select m_RotationalStiffnessX;   // IfcRotationalStiffnessSelect  [optional]
  OdDAI::Select m_RotationalStiffnessY;   // IfcRotationalStiffnessSelect  [optional]
  OdDAI::Select m_RotationalStiffnessZ;   // IfcRotationalStiffnessSelect  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBoundaryNodeCondition, IfcBoundaryNodeCondition> object.
*/
typedef OdSmartPtr<IfcBoundaryNodeCondition> IfcBoundaryNodeConditionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBOUNDARYNODECONDITION_AUTO_IMPL_H
