...
#ifndef _IFC4X3_RC4_IFCPROTECTIVEDEVICETRIPPINGUNITTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROTECTIVEDEVICETRIPPINGUNITTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcProtectiveDeviceTrippingUnitType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcProtectiveDeviceTrippingUnitType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcProtectiveDeviceTrippingUnitTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcProtectiveDeviceTrippingUnitType, IfcProtectiveDeviceTrippingUnitType> object.
*/
typedef OdSmartPtr<IfcProtectiveDeviceTrippingUnitType> IfcProtectiveDeviceTrippingUnitTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROTECTIVEDEVICETRIPPINGUNITTYPE_AUTO_IMPL_H
