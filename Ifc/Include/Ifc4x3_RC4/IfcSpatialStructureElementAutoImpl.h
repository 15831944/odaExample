...
#ifndef _IFC4X3_RC4_IFCSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSpatialStructureElement : public IfcSpatialElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSpatialStructureElement);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_CompositionType;   // IfcElementCompositionEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSpatialStructureElement, IfcSpatialStructureElement> object.
*/
typedef OdSmartPtr<IfcSpatialStructureElement> IfcSpatialStructureElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
