...
#ifndef _IFC4X3_RC4_IFCTASKTIMERECURRING_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTASKTIMERECURRING_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTaskTimeRecurring : public IfcTaskTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTaskTimeRecurring);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRecurrence() const;
  void setRecurrence(const OdDAIObjectId& Recurrence);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Recurrence;   // IfcRecurrencePattern
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTaskTimeRecurring, IfcTaskTimeRecurring> object.
*/
typedef OdSmartPtr<IfcTaskTimeRecurring> IfcTaskTimeRecurringPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTASKTIMERECURRING_AUTO_IMPL_H
