...
#ifndef _IFC4X3_RC4_IFCDISTRIBUTIONCIRCUIT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDISTRIBUTIONCIRCUIT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDistributionCircuit : public IfcDistributionSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDistributionCircuit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDistributionCircuit, IfcDistributionCircuit> object.
*/
typedef OdSmartPtr<IfcDistributionCircuit> IfcDistributionCircuitPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDISTRIBUTIONCIRCUIT_AUTO_IMPL_H
