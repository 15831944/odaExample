...
#ifndef _IFC4X3_RC4_IFCCSGSOLID_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCSGSOLID_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCsgSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCsgSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCsgSolid, IfcCsgSolid> object.
*/
typedef OdSmartPtr<IfcCsgSolid> IfcCsgSolidPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCSGSOLID_AUTO_IMPL_H
