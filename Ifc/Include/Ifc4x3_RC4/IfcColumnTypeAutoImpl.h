...
#ifndef _IFC4X3_RC4_IFCCOLUMNTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOLUMNTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcColumnType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcColumnType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcColumnType, IfcColumnType> object.
*/
typedef OdSmartPtr<IfcColumnType> IfcColumnTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOLUMNTYPE_AUTO_IMPL_H
