...
#ifndef _IFC4X3_RC4_IFCREVOLVEDAREASOLIDTAPERED_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCREVOLVEDAREASOLIDTAPERED_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRevolvedAreaSolidTapered : public IfcRevolvedAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRevolvedAreaSolidTapered);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_EndSweptArea;   // IfcProfileDef
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRevolvedAreaSolidTapered, IfcRevolvedAreaSolidTapered> object.
*/
typedef OdSmartPtr<IfcRevolvedAreaSolidTapered> IfcRevolvedAreaSolidTaperedPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCREVOLVEDAREASOLIDTAPERED_AUTO_IMPL_H
