...
#ifndef _IFC4X3_RC4_IFCCABLESEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCABLESEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCableSegment : public IfcFlowSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCableSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCableSegment, IfcCableSegment> object.
*/
typedef OdSmartPtr<IfcCableSegment> IfcCableSegmentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCABLESEGMENT_AUTO_IMPL_H
