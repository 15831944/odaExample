...
#ifndef _IFC4X3_RC4_IFCTANK_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTANK_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTank : public IfcFlowStorageDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTank);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcTankTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTank, IfcTank> object.
*/
typedef OdSmartPtr<IfcTank> IfcTankPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTANK_AUTO_IMPL_H
