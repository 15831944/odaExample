...
#ifndef _IFC4X3_RC4_IFCUNITASSIGNMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCUNITASSIGNMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcUnitAssignment : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcUnitAssignment);
  //DOM-IGNORE-END
...
public:
  ...
  void getUnits(OdArray<OdDAI::Select >& Units) const;
  void getUnitsWrapperArray(OdArray<IfcUnit>& Units) const;
  OdDAI::Set<OdDAI::Select>& units();
...
protected:
  // Fields declaration: 
  OdDAI::Set<OdDAI::Select> m_Units; // SET [1:?] of IfcUnit
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcUnitAssignment, IfcUnitAssignment> object.
*/
typedef OdSmartPtr<IfcUnitAssignment> IfcUnitAssignmentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCUNITASSIGNMENT_AUTO_IMPL_H
