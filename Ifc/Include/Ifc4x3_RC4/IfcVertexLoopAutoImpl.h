...
#ifndef _IFC4X3_RC4_IFCVERTEXLOOP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCVERTEXLOOP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcVertexLoop : public IfcLoop
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcVertexLoop);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcVertexLoop, IfcVertexLoop> object.
*/
typedef OdSmartPtr<IfcVertexLoop> IfcVertexLoopPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCVERTEXLOOP_AUTO_IMPL_H
