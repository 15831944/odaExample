...
#ifndef _IFC4X3_RC4_IFCCONSTRUCTIONRESOURCE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONSTRUCTIONRESOURCE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcConstructionResource : public IfcResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcConstructionResource);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getUsage() const;
  void setUsage(const OdDAIObjectId& Usage);
  void getBaseCosts(OdDAIObjectIds& BaseCosts) const;
  OdDAI::OdDAIObjectIdList& baseCosts();
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Usage;   // IfcResourceTime  [optional]
  OdDAI::OdDAIObjectIdList m_BaseCosts; // LIST [1:?] of IfcAppliedValue [optional]

  OdDAIObjectId m_BaseQuantity;   // IfcPhysicalQuantity  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcConstructionResource, IfcConstructionResource> object.
*/
typedef OdSmartPtr<IfcConstructionResource> IfcConstructionResourcePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONSTRUCTIONRESOURCE_AUTO_IMPL_H
