...
#ifndef _IFC4X3_RC4_IFCWALLTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCWALLTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcWallType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcWallType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcWallType, IfcWallType> object.
*/
typedef OdSmartPtr<IfcWallType> IfcWallTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCWALLTYPE_AUTO_IMPL_H
