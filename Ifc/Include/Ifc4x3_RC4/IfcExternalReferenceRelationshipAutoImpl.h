...
#ifndef _IFC4X3_RC4_IFCEXTERNALREFERENCERELATIONSHIP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCEXTERNALREFERENCERELATIONSHIP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcExternalReferenceRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcExternalReferenceRelationship);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatingReference() const;
  void setRelatingReference(const OdDAIObjectId& RelatingReference);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatingReference;   // IfcExternalReference
  OdDAI::Set<OdDAI::Select> m_RelatedResourceObjects; // SET [1:?] of IfcResourceObjectSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcExternalReferenceRelationship, IfcExternalReferenceRelationship> object.
*/
typedef OdSmartPtr<IfcExternalReferenceRelationship> IfcExternalReferenceRelationshipPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCEXTERNALREFERENCERELATIONSHIP_AUTO_IMPL_H
