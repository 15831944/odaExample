...
#ifndef _IFC4X3_RC4_IFCHUMIDIFIER_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCHUMIDIFIER_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcHumidifier : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcHumidifier);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcHumidifierTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcHumidifier, IfcHumidifier> object.
*/
typedef OdSmartPtr<IfcHumidifier> IfcHumidifierPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCHUMIDIFIER_AUTO_IMPL_H
