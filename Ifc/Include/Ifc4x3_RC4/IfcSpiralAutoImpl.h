...
#ifndef _IFC4X3_RC4_IFCSPIRAL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSPIRAL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSpiral : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSpiral);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_Position;   // IfcAxis2Placement  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSpiral, IfcSpiral> object.
*/
typedef OdSmartPtr<IfcSpiral> IfcSpiralPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSPIRAL_AUTO_IMPL_H
