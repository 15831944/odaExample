...
#ifndef _IFC4X3_RC4_IFCFEATUREELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFEATUREELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFeatureElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFeatureElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFeatureElement, IfcFeatureElement> object.
*/
typedef OdSmartPtr<IfcFeatureElement> IfcFeatureElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFEATUREELEMENT_AUTO_IMPL_H
