...
#ifndef _IFC4X3_RC4_IFCCARTESIANTRANSFORMATIONOPERATOR2D_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCARTESIANTRANSFORMATIONOPERATOR2D_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCartesianTransformationOperator2D : public IfcCartesianTransformationOperator
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCartesianTransformationOperator2D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCartesianTransformationOperator2D, IfcCartesianTransformationOperator2D> object.
*/
typedef OdSmartPtr<IfcCartesianTransformationOperator2D> IfcCartesianTransformationOperator2DPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCARTESIANTRANSFORMATIONOPERATOR2D_AUTO_IMPL_H
