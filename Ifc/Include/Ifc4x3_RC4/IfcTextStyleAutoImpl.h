...
#ifndef _IFC4X3_RC4_IFCTEXTSTYLE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTEXTSTYLE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTextStyle : public IfcPresentationStyle
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTextStyle);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_TextCharacterAppearance;   // IfcTextStyleForDefinedFont  [optional]
  OdDAIObjectId m_TextStyle;   // IfcTextStyleTextModel  [optional]
  OdDAI::Select m_TextFontStyle;   // IfcTextFontSelect
  OdDAI::Boolean m_ModelOrDraughting;   // IfcBoolean  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTextStyle, IfcTextStyle> object.
*/
typedef OdSmartPtr<IfcTextStyle> IfcTextStylePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTEXTSTYLE_AUTO_IMPL_H
