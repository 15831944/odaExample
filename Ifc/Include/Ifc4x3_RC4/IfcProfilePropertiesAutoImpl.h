...
#ifndef _IFC4X3_RC4_IFCPROFILEPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROFILEPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcProfileProperties : public IfcExtendedProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcProfileProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcProfileProperties, IfcProfileProperties> object.
*/
typedef OdSmartPtr<IfcProfileProperties> IfcProfilePropertiesPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROFILEPROPERTIES_AUTO_IMPL_H
