...
#ifndef _IFC4X3_RC4_IFCBEARINGTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBEARINGTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBearingType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBearingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBearingType, IfcBearingType> object.
*/
typedef OdSmartPtr<IfcBearingType> IfcBearingTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBEARINGTYPE_AUTO_IMPL_H
