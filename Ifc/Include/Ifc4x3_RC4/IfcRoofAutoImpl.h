...
#ifndef _IFC4X3_RC4_IFCROOF_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCROOF_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRoof : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRoof);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRoof, IfcRoof> object.
*/
typedef OdSmartPtr<IfcRoof> IfcRoofPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCROOF_AUTO_IMPL_H
