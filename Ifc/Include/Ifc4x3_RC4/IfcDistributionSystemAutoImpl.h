...
#ifndef _IFC4X3_RC4_IFCDISTRIBUTIONSYSTEM_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDISTRIBUTIONSYSTEM_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDistributionSystem : public IfcSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDistributionSystem);
  //DOM-IGNORE-END
...
public:
  ...
  IfcDistributionSystemEnum getPredefinedType() const;
  void setPredefinedType(IfcDistributionSystemEnum PredefinedType);
...
protected:
  ...
  OdDAI::Enum m_PredefinedType;   // IfcDistributionSystemEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDistributionSystem, IfcDistributionSystem> object.
*/
typedef OdSmartPtr<IfcDistributionSystem> IfcDistributionSystemPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDISTRIBUTIONSYSTEM_AUTO_IMPL_H
