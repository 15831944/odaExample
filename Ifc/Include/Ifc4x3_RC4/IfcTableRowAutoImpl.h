...
#ifndef _IFC4X3_RC4_IFCTABLEROW_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTABLEROW_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTableRow : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTableRow);
  //DOM-IGNORE-END
...
public:
  ...
  void getRowCells(OdArray<OdDAI::Select >& RowCells) const;
  void getRowCellsWrapperArray(OdArray<IfcValue>& RowCells) const;
  OdDAI::List<OdDAI::Select>& rowCells();
  OdDAI::Boolean getIsHeading() const;
  void setIsHeading(OdDAI::Boolean IsHeading);
...
protected:
  // Fields declaration: 
  OdDAI::List<OdDAI::Select> m_RowCells; // LIST [1:?] of IfcValue [optional]

  OdDAI::Boolean m_IsHeading;   // IfcBoolean  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTableRow, IfcTableRow> object.
*/
typedef OdSmartPtr<IfcTableRow> IfcTableRowPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTABLEROW_AUTO_IMPL_H
