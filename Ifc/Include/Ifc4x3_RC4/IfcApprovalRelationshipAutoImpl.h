...
#ifndef _IFC4X3_RC4_IFCAPPROVALRELATIONSHIP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCAPPROVALRELATIONSHIP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcApprovalRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcApprovalRelationship);
  //DOM-IGNORE-END
...
public:
  ...
  void getRelatedApprovals(OdDAIObjectIds& RelatedApprovals) const;
  OdDAI::OdDAIObjectIdSet& relatedApprovals();
...
protected:
  ...
  OdDAI::OdDAIObjectIdSet m_RelatedApprovals; // SET [1:?] of IfcApproval
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcApprovalRelationship, IfcApprovalRelationship> object.
*/
typedef OdSmartPtr<IfcApprovalRelationship> IfcApprovalRelationshipPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCAPPROVALRELATIONSHIP_AUTO_IMPL_H
