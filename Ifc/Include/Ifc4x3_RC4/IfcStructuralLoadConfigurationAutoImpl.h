...
#ifndef _IFC4X3_RC4_IFCSTRUCTURALLOADCONFIGURATION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTRUCTURALLOADCONFIGURATION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStructuralLoadConfiguration : public IfcStructuralLoad
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStructuralLoadConfiguration);
  //DOM-IGNORE-END
...
public:
  ...
  void getValues(OdDAIObjectIds& Values) const;
  OdDAI::OdDAIObjectIdList& values();
  void getLocations(OdArray<OdArray<double > >& Locations) const;
  OdDAI::List<OdDAI::Aggr*>& locations();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_Values; // LIST [1:?] of IfcStructuralLoadOrResult
  OdDAI::List<OdDAI::Aggr*> m_Locations; // LIST [1:?] of LIST [1:2] of IfcLengthMeasure [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStructuralLoadConfiguration, IfcStructuralLoadConfiguration> object.
*/
typedef OdSmartPtr<IfcStructuralLoadConfiguration> IfcStructuralLoadConfigurationPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTRUCTURALLOADCONFIGURATION_AUTO_IMPL_H
