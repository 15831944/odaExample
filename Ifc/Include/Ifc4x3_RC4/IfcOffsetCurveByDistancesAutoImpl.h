...
#ifndef _IFC4X3_RC4_IFCOFFSETCURVEBYDISTANCES_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCOFFSETCURVEBYDISTANCES_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcOffsetCurveByDistances : public IfcOffsetCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcOffsetCurveByDistances);
  //DOM-IGNORE-END
...
public:
  ...
  void getOffsetValues(OdDAIObjectIds& OffsetValues) const;
  OdDAI::OdDAIObjectIdList& offsetValues();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_OffsetValues; // LIST [1:?] of IfcPointByDistanceExpression
  OdAnsiString m_Tag;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcOffsetCurveByDistances, IfcOffsetCurveByDistances> object.
*/
typedef OdSmartPtr<IfcOffsetCurveByDistances> IfcOffsetCurveByDistancesPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCOFFSETCURVEBYDISTANCES_AUTO_IMPL_H
