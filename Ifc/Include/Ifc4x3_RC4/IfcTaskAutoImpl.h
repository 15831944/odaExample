...
#ifndef _IFC4X3_RC4_IFCTASK_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTASK_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTask : public IfcProcess
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTask);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTask, IfcTask> object.
*/
typedef OdSmartPtr<IfcTask> IfcTaskPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTASK_AUTO_IMPL_H
