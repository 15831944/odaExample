...
#ifndef _IFC4X3_RC4_IFCRELADHERESTOELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELADHERESTOELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelAdheresToElement : public IfcRelDecomposes
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelAdheresToElement);
  //DOM-IGNORE-END
...
public:
  ...
  void getRelatedSurfaceFeatures(OdDAIObjectIds& RelatedSurfaceFeatures) const;
  OdDAI::OdDAIObjectIdSet& relatedSurfaceFeatures();
...
protected:
  ...
  OdDAI::OdDAIObjectIdSet m_RelatedSurfaceFeatures; // SET [1:?] of IfcSurfaceFeature
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelAdheresToElement, IfcRelAdheresToElement> object.
*/
typedef OdSmartPtr<IfcRelAdheresToElement> IfcRelAdheresToElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELADHERESTOELEMENT_AUTO_IMPL_H
