...
#ifndef _IFC4X3_RC4_IFCREPRESENTATIONMAP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCREPRESENTATIONMAP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRepresentationMap : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRepresentationMap);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getMappedRepresentation() const;
  void setMappedRepresentation(const OdDAIObjectId& MappedRepresentation);
  void getInvHasShapeAspects(OdDAIObjectIds& HasShapeAspects) const;
  void getInvMapUsage(OdDAIObjectIds& MapUsage) const;
...
protected:
  // Fields declaration: 
  OdDAI::Select m_MappingOrigin;   // IfcAxis2Placement
  OdDAIObjectId m_MappedRepresentation;   // IfcRepresentation
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRepresentationMap, IfcRepresentationMap> object.
*/
typedef OdSmartPtr<IfcRepresentationMap> IfcRepresentationMapPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCREPRESENTATIONMAP_AUTO_IMPL_H
