...
#ifndef _IFC4X3_RC4_IFCRELASSIGNSTOGROUP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELASSIGNSTOGROUP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelAssignsToGroup : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelAssignsToGroup);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelAssignsToGroup, IfcRelAssignsToGroup> object.
*/
typedef OdSmartPtr<IfcRelAssignsToGroup> IfcRelAssignsToGroupPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELASSIGNSTOGROUP_AUTO_IMPL_H
