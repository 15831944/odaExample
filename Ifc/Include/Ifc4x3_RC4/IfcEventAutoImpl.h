...
#ifndef _IFC4X3_RC4_IFCEVENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCEVENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcEvent : public IfcProcess
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcEvent);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getUserDefinedEventTriggerType() const;
  void setUserDefinedEventTriggerType(const OdAnsiString& UserDefinedEventTriggerType);
  const OdDAIObjectId& getEventOccurenceTime() const;
  void setEventOccurenceTime(const OdDAIObjectId& EventOccurenceTime);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcEventTypeEnum  [optional]
  OdDAI::Enum m_EventTriggerType;   // IfcEventTriggerTypeEnum  [optional]
  OdAnsiString m_UserDefinedEventTriggerType;   // IfcLabel  [optional]
  OdDAIObjectId m_EventOccurenceTime;   // IfcEventTime  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcEvent, IfcEvent> object.
*/
typedef OdSmartPtr<IfcEvent> IfcEventPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCEVENT_AUTO_IMPL_H
