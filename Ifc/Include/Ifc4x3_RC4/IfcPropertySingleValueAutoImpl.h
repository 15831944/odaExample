...
#ifndef _IFC4X3_RC4_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPropertySingleValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPropertySingleValue);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_NominalValue;   // IfcValue  [optional]
  OdDAI::Select m_Unit;   // IfcUnit  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPropertySingleValue, IfcPropertySingleValue> object.
*/
typedef OdSmartPtr<IfcPropertySingleValue> IfcPropertySingleValuePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
