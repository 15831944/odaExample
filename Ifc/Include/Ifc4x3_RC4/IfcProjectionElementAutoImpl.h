...
#ifndef _IFC4X3_RC4_IFCPROJECTIONELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROJECTIONELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcProjectionElement : public IfcFeatureElementAddition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcProjectionElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcProjectionElement, IfcProjectionElement> object.
*/
typedef OdSmartPtr<IfcProjectionElement> IfcProjectionElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROJECTIONELEMENT_AUTO_IMPL_H
