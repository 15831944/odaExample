...
#ifndef _IFC4X3_RC4_IFCSOLARDEVICETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSOLARDEVICETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSolarDeviceType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSolarDeviceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcSolarDeviceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcSolarDeviceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSolarDeviceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSolarDeviceType, IfcSolarDeviceType> object.
*/
typedef OdSmartPtr<IfcSolarDeviceType> IfcSolarDeviceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSOLARDEVICETYPE_AUTO_IMPL_H
