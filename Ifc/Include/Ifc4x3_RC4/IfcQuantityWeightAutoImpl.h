...
#ifndef _IFC4X3_RC4_IFCQUANTITYWEIGHT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCQUANTITYWEIGHT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcQuantityWeight : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcQuantityWeight);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_WeightValue;   // IfcMassMeasure
  OdAnsiString m_Formula;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcQuantityWeight, IfcQuantityWeight> object.
*/
typedef OdSmartPtr<IfcQuantityWeight> IfcQuantityWeightPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCQUANTITYWEIGHT_AUTO_IMPL_H
