...
#ifndef _IFC4X3_RC4_IFCPCURVE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPCURVE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPcurve : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPcurve);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getReferenceCurve() const;
  void setReferenceCurve(const OdDAIObjectId& ReferenceCurve);
...
protected:
  ...
  OdDAIObjectId m_ReferenceCurve;   // IfcCurve
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPcurve, IfcPcurve> object.
*/
typedef OdSmartPtr<IfcPcurve> IfcPcurvePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPCURVE_AUTO_IMPL_H
