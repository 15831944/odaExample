...
#ifndef _IFC4X3_RC4_IFCANNOTATIONFILLAREA_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCANNOTATIONFILLAREA_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcAnnotationFillArea : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcAnnotationFillArea);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::OdDAIObjectIdSet m_InnerBoundaries; // SET [1:?] of IfcCurve [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcAnnotationFillArea, IfcAnnotationFillArea> object.
*/
typedef OdSmartPtr<IfcAnnotationFillArea> IfcAnnotationFillAreaPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCANNOTATIONFILLAREA_AUTO_IMPL_H
