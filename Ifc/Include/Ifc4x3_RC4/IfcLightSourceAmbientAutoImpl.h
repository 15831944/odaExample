...
#ifndef _IFC4X3_RC4_IFCLIGHTSOURCEAMBIENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCLIGHTSOURCEAMBIENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcLightSourceAmbient : public IfcLightSource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcLightSourceAmbient);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcLightSourceAmbient, IfcLightSourceAmbient> object.
*/
typedef OdSmartPtr<IfcLightSourceAmbient> IfcLightSourceAmbientPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCLIGHTSOURCEAMBIENT_AUTO_IMPL_H
