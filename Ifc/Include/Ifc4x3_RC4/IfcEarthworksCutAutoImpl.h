...
#ifndef _IFC4X3_RC4_IFCEARTHWORKSCUT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCEARTHWORKSCUT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcEarthworksCut : public IfcFeatureElementSubtraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcEarthworksCut);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcEarthworksCut, IfcEarthworksCut> object.
*/
typedef OdSmartPtr<IfcEarthworksCut> IfcEarthworksCutPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCEARTHWORKSCUT_AUTO_IMPL_H
