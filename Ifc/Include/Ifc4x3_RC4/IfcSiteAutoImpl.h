...
#ifndef _IFC4X3_RC4_IFCSITE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSITE_AUTO_IMPL_H
...
*/
class IFC4X3_RC4_EXPORT IfcSite : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSite);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSite, IfcSite> object.
*/
typedef OdSmartPtr<IfcSite> IfcSitePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSITE_AUTO_IMPL_H
