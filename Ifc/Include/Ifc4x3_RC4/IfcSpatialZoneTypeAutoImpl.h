...
#ifndef _IFC4X3_RC4_IFCSPATIALZONETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSPATIALZONETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSpatialZoneType : public IfcSpatialElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSpatialZoneType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSpatialZoneType, IfcSpatialZoneType> object.
*/
typedef OdSmartPtr<IfcSpatialZoneType> IfcSpatialZoneTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSPATIALZONETYPE_AUTO_IMPL_H
