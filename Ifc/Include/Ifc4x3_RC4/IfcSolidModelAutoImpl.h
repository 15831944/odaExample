...
#ifndef _IFC4X3_RC4_IFCSOLIDMODEL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSOLIDMODEL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSolidModel : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSolidModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSolidModel, IfcSolidModel> object.
*/
typedef OdSmartPtr<IfcSolidModel> IfcSolidModelPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSOLIDMODEL_AUTO_IMPL_H
