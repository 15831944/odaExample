...
#ifndef _IFC4X3_RC4_IFCRAMPFLIGHT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRAMPFLIGHT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRampFlight : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRampFlight);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRampFlight, IfcRampFlight> object.
*/
typedef OdSmartPtr<IfcRampFlight> IfcRampFlightPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRAMPFLIGHT_AUTO_IMPL_H
