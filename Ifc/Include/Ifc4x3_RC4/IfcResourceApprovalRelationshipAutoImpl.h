...
#ifndef _IFC4X3_RC4_IFCRESOURCEAPPROVALRELATIONSHIP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRESOURCEAPPROVALRELATIONSHIP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcResourceApprovalRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcResourceApprovalRelationship);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatingApproval() const;
  void setRelatingApproval(const OdDAIObjectId& RelatingApproval);
...
protected:
  ...
  OdDAIObjectId m_RelatingApproval;   // IfcApproval
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcResourceApprovalRelationship, IfcResourceApprovalRelationship> object.
*/
typedef OdSmartPtr<IfcResourceApprovalRelationship> IfcResourceApprovalRelationshipPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRESOURCEAPPROVALRELATIONSHIP_AUTO_IMPL_H
