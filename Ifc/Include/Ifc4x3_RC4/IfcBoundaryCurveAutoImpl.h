...
#ifndef _IFC4X3_RC4_IFCBOUNDARYCURVE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBOUNDARYCURVE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBoundaryCurve : public IfcCompositeCurveOnSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBoundaryCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBoundaryCurve, IfcBoundaryCurve> object.
*/
typedef OdSmartPtr<IfcBoundaryCurve> IfcBoundaryCurvePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBOUNDARYCURVE_AUTO_IMPL_H
