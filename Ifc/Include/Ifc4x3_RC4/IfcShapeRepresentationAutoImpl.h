...
#ifndef _IFC4X3_RC4_IFCSHAPEREPRESENTATION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSHAPEREPRESENTATION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcShapeRepresentation : public IfcShapeModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcShapeRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcShapeRepresentation, IfcShapeRepresentation> object.
*/
typedef OdSmartPtr<IfcShapeRepresentation> IfcShapeRepresentationPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSHAPEREPRESENTATION_AUTO_IMPL_H
