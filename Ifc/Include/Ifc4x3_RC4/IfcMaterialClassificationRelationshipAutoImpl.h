...
#ifndef _IFC4X3_RC4_IFCMATERIALCLASSIFICATIONRELATIONSHIP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMATERIALCLASSIFICATIONRELATIONSHIP_AUTO_IMPL_H

#include "IfcEntity.h"

#include "Ifc4x3_RC4Enum.h"
#include "Ifc4x3_RC4SelectTypes.h"
...
class IFC4X3_RC4_EXPORT IfcMaterialClassificationRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMaterialClassificationRelationship);
  //DOM-IGNORE-END
...
public:
  ...
  void getMaterialClassifications(OdArray<OdDAI::Select >& MaterialClassifications) const;
  void getMaterialClassificationsWrapperArray(OdArray<IfcClassificationSelect>& MaterialClassifications) const;
  OdDAI::Set<OdDAI::Select>& materialClassifications();
  const OdDAIObjectId& getClassifiedMaterial() const;
  void setClassifiedMaterial(const OdDAIObjectId& ClassifiedMaterial);
...
protected:
  // Fields declaration: 
  OdDAI::Set<OdDAI::Select> m_MaterialClassifications; // SET [1:?] of IfcClassificationSelect
  OdDAIObjectId m_ClassifiedMaterial;   // IfcMaterial
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMaterialClassificationRelationship, IfcMaterialClassificationRelationship> object.
*/
typedef OdSmartPtr<IfcMaterialClassificationRelationship> IfcMaterialClassificationRelationshipPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMATERIALCLASSIFICATIONRELATIONSHIP_AUTO_IMPL_H
