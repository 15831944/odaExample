...
#ifndef _IFC4X3_RC4_IFCRELPROJECTSELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELPROJECTSELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelProjectsElement : public IfcRelDecomposes
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelProjectsElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelProjectsElement, IfcRelProjectsElement> object.
*/
typedef OdSmartPtr<IfcRelProjectsElement> IfcRelProjectsElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELPROJECTSELEMENT_AUTO_IMPL_H
