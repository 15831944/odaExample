...
#ifndef _IFC4X3_RC4_IFCGRIDPLACEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCGRIDPLACEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcGridPlacement : public IfcObjectPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcGridPlacement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcGridPlacement, IfcGridPlacement> object.
*/
typedef OdSmartPtr<IfcGridPlacement> IfcGridPlacementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCGRIDPLACEMENT_AUTO_IMPL_H
