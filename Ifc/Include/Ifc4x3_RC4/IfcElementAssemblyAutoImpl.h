...
#ifndef _IFC4X3_RC4_IFCELEMENTASSEMBLY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCELEMENTASSEMBLY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcElementAssembly : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcElementAssembly);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Enum m_PredefinedType;   // IfcElementAssemblyTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcElementAssembly, IfcElementAssembly> object.
*/
typedef OdSmartPtr<IfcElementAssembly> IfcElementAssemblyPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCELEMENTASSEMBLY_AUTO_IMPL_H
