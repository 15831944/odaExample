...
#ifndef _IFC4X3_RC4_IFCLINEARELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCLINEARELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcLinearElement : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcLinearElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcLinearElement, IfcLinearElement> object.
*/
typedef OdSmartPtr<IfcLinearElement> IfcLinearElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCLINEARELEMENT_AUTO_IMPL_H
