...
#ifndef _IFC4X3_RC4_IFCMEDICALDEVICETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMEDICALDEVICETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMedicalDeviceType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMedicalDeviceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcMedicalDeviceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcMedicalDeviceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcMedicalDeviceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMedicalDeviceType, IfcMedicalDeviceType> object.
*/
typedef OdSmartPtr<IfcMedicalDeviceType> IfcMedicalDeviceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMEDICALDEVICETYPE_AUTO_IMPL_H
