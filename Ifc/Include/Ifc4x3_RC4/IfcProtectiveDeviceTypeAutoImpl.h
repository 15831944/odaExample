...
#ifndef _IFC4X3_RC4_IFCPROTECTIVEDEVICETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROTECTIVEDEVICETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcProtectiveDeviceType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcProtectiveDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcProtectiveDeviceType, IfcProtectiveDeviceType> object.
*/
typedef OdSmartPtr<IfcProtectiveDeviceType> IfcProtectiveDeviceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROTECTIVEDEVICETYPE_AUTO_IMPL_H
