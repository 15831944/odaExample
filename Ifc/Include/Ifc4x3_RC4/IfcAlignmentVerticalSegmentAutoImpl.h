...
#ifndef _IFC4X3_RC4_IFCALIGNMENTVERTICALSEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCALIGNMENTVERTICALSEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcAlignmentVerticalSegment : public IfcAlignmentParameterSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcAlignmentVerticalSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcAlignmentVerticalSegment, IfcAlignmentVerticalSegment> object.
*/
typedef OdSmartPtr<IfcAlignmentVerticalSegment> IfcAlignmentVerticalSegmentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCALIGNMENTVERTICALSEGMENT_AUTO_IMPL_H
