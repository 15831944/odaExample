...
#ifndef _IFC4X3_RC4_IFCLIGHTSOURCE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCLIGHTSOURCE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcLightSource : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcLightSource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcLightSource, IfcLightSource> object.
*/
typedef OdSmartPtr<IfcLightSource> IfcLightSourcePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCLIGHTSOURCE_AUTO_IMPL_H
