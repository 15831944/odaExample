...
#ifndef _IFC4X3_RC4_IFCFACE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFACE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFace : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFace);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFace, IfcFace> object.
*/
typedef OdSmartPtr<IfcFace> IfcFacePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFACE_AUTO_IMPL_H
