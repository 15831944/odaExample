...
#ifndef _IFC4X3_RC4_IFCCONNECTIONSURFACEGEOMETRY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONNECTIONSURFACEGEOMETRY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcConnectionSurfaceGeometry : public IfcConnectionGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcConnectionSurfaceGeometry);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_SurfaceOnRelatingElement;   // IfcSurfaceOrFaceSurface
  OdDAI::Select m_SurfaceOnRelatedElement;   // IfcSurfaceOrFaceSurface  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcConnectionSurfaceGeometry, IfcConnectionSurfaceGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionSurfaceGeometry> IfcConnectionSurfaceGeometryPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONNECTIONSURFACEGEOMETRY_AUTO_IMPL_H
