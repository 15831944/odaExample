...
#ifndef _IFC4X3_RC4_IFCWALLSTANDARDCASE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCWALLSTANDARDCASE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcWallStandardCase : public IfcWall
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcWallStandardCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcWallStandardCase, IfcWallStandardCase> object.
*/
typedef OdSmartPtr<IfcWallStandardCase> IfcWallStandardCasePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCWALLSTANDARDCASE_AUTO_IMPL_H
