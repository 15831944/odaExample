...
#ifndef _IFC4X3_RC4_IFCPROJECTEDCRS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROJECTEDCRS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcProjectedCRS : public IfcCoordinateReferenceSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcProjectedCRS);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_MapProjection;   // IfcIdentifier  [optional]
  OdAnsiString m_MapZone;   // IfcIdentifier  [optional]
  OdDAIObjectId m_MapUnit;   // IfcNamedUnit  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcProjectedCRS, IfcProjectedCRS> object.
*/
typedef OdSmartPtr<IfcProjectedCRS> IfcProjectedCRSPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROJECTEDCRS_AUTO_IMPL_H
