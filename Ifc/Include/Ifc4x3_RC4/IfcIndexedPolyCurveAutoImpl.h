...
#ifndef _IFC4X3_RC4_IFCINDEXEDPOLYCURVE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCINDEXEDPOLYCURVE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcIndexedPolyCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcIndexedPolyCurve);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::List<OdDAI::Select>& segments();
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Points;   // IfcCartesianPointList
  OdDAI::List<OdDAI::Select> m_Segments; // LIST [1:?] of IfcSegmentIndexSelect [optional]

  OdDAI::Boolean m_SelfIntersect;   // IfcBoolean  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcIndexedPolyCurve, IfcIndexedPolyCurve> object.
*/
typedef OdSmartPtr<IfcIndexedPolyCurve> IfcIndexedPolyCurvePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCINDEXEDPOLYCURVE_AUTO_IMPL_H
