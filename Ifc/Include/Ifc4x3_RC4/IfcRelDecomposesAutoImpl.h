...
#ifndef _IFC4X3_RC4_IFCRELDECOMPOSES_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELDECOMPOSES_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelDecomposes : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelDecomposes);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelDecomposes, IfcRelDecomposes> object.
*/
typedef OdSmartPtr<IfcRelDecomposes> IfcRelDecomposesPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELDECOMPOSES_AUTO_IMPL_H
