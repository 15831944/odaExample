...
#ifndef _IFC4X3_RC4_IFCDERIVEDUNIT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDERIVEDUNIT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDerivedUnit : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDerivedUnit);
  //DOM-IGNORE-END
...
public:
  ...
  void getElements(OdDAIObjectIds& Elements) const;
  OdDAI::OdDAIObjectIdSet& elements();
  IfcDerivedUnitEnum getUnitType() const;
  void setUnitType(IfcDerivedUnitEnum UnitType);
  const OdAnsiString& getUserDefinedType() const;
  void setUserDefinedType(const OdAnsiString& UserDefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_Elements; // SET [1:?] of IfcDerivedUnitElement
  OdDAI::Enum m_UnitType;   // IfcDerivedUnitEnum
  OdAnsiString m_UserDefinedType;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDerivedUnit, IfcDerivedUnit> object.
*/
typedef OdSmartPtr<IfcDerivedUnit> IfcDerivedUnitPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDERIVEDUNIT_AUTO_IMPL_H
