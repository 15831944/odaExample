...
#ifndef _IFC4X3_RC4_IFCINTERCEPTOR_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCINTERCEPTOR_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcInterceptor : public IfcFlowTreatmentDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcInterceptor);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcInterceptorTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcInterceptor, IfcInterceptor> object.
*/
typedef OdSmartPtr<IfcInterceptor> IfcInterceptorPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCINTERCEPTOR_AUTO_IMPL_H
