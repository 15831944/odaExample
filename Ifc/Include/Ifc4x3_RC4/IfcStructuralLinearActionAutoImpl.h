...
#ifndef _IFC4X3_RC4_IFCSTRUCTURALLINEARACTION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTRUCTURALLINEARACTION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStructuralLinearAction : public IfcStructuralCurveAction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStructuralLinearAction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStructuralLinearAction, IfcStructuralLinearAction> object.
*/
typedef OdSmartPtr<IfcStructuralLinearAction> IfcStructuralLinearActionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTRUCTURALLINEARACTION_AUTO_IMPL_H
