...
#ifndef _IFC4X3_RC4_IFCBUILDING_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBUILDING_AUTO_IMPL_H
...
*/
class IFC4X3_RC4_EXPORT IfcBuilding : public IfcFacility
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBuilding);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBuilding, IfcBuilding> object.
*/
typedef OdSmartPtr<IfcBuilding> IfcBuildingPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBUILDING_AUTO_IMPL_H
