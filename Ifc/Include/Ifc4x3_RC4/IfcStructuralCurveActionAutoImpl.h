...
#ifndef _IFC4X3_RC4_IFCSTRUCTURALCURVEACTION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTRUCTURALCURVEACTION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStructuralCurveAction : public IfcStructuralAction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStructuralCurveAction);
  //DOM-IGNORE-END
...
public:
  ...
  IfcStructuralCurveActivityTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcStructuralCurveActivityTypeEnum PredefinedType);
...
protected:
  ...
  OdDAI::Enum m_PredefinedType;   // IfcStructuralCurveActivityTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStructuralCurveAction, IfcStructuralCurveAction> object.
*/
typedef OdSmartPtr<IfcStructuralCurveAction> IfcStructuralCurveActionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTRUCTURALCURVEACTION_AUTO_IMPL_H
