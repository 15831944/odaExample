...
#ifndef _IFC4X3_RC4_IFCSTRUCTURALSURFACEACTION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTRUCTURALSURFACEACTION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStructuralSurfaceAction : public IfcStructuralAction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStructuralSurfaceAction);
  //DOM-IGNORE-END
...
public:
  ...
  IfcProjectedOrTrueLengthEnum getProjectedOrTrue() const;
  void setProjectedOrTrue(IfcProjectedOrTrueLengthEnum ProjectedOrTrue);
  IfcStructuralSurfaceActivityTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcStructuralSurfaceActivityTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_ProjectedOrTrue;   // IfcProjectedOrTrueLengthEnum  [optional]
  OdDAI::Enum m_PredefinedType;   // IfcStructuralSurfaceActivityTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStructuralSurfaceAction, IfcStructuralSurfaceAction> object.
*/
typedef OdSmartPtr<IfcStructuralSurfaceAction> IfcStructuralSurfaceActionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTRUCTURALSURFACEACTION_AUTO_IMPL_H
