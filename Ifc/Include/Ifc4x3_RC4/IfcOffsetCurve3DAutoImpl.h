...
#ifndef _IFC4X3_RC4_IFCOFFSETCURVE3D_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCOFFSETCURVE3D_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcOffsetCurve3D : public IfcOffsetCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcOffsetCurve3D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcOffsetCurve3D, IfcOffsetCurve3D> object.
*/
typedef OdSmartPtr<IfcOffsetCurve3D> IfcOffsetCurve3DPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCOFFSETCURVE3D_AUTO_IMPL_H
