...
#ifndef _IFC4X3_RC4_IFCDOCUMENTREFERENCE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDOCUMENTREFERENCE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDocumentReference : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDocumentReference);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getReferencedDocument() const;
  void setReferencedDocument(const OdDAIObjectId& ReferencedDocument);
  void getInvDocumentRefForObjects(OdDAIObjectIds& DocumentRefForObjects) const;
...
protected:
  ...
  OdDAIObjectId m_ReferencedDocument;   // IfcDocumentInformation  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDocumentReference, IfcDocumentReference> object.
*/
typedef OdSmartPtr<IfcDocumentReference> IfcDocumentReferencePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDOCUMENTREFERENCE_AUTO_IMPL_H
