...
#ifndef _IFC4X3_RC4_IFCRATIONALBSPLINECURVEWITHKNOTS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRATIONALBSPLINECURVEWITHKNOTS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRationalBSplineCurveWithKnots : public IfcBSplineCurveWithKnots
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRationalBSplineCurveWithKnots);
  //DOM-IGNORE-END
...
public:
  ...
  void getWeightsData(OdArray<double >& WeightsData) const;
  OdDAI::DoubleList& weightsData();
...
protected:
  // Fields declaration: 
  OdDAI::DoubleList m_WeightsData; // LIST [2:?] of IfcReal
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRationalBSplineCurveWithKnots, IfcRationalBSplineCurveWithKnots> object.
*/
typedef OdSmartPtr<IfcRationalBSplineCurveWithKnots> IfcRationalBSplineCurveWithKnotsPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRATIONALBSPLINECURVEWITHKNOTS_AUTO_IMPL_H
