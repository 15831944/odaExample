...
#ifndef _IFC4X3_RC4_IFCSPHERE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSPHERE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSphere : public IfcCsgPrimitive3D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSphere);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSphere, IfcSphere> object.
*/
typedef OdSmartPtr<IfcSphere> IfcSpherePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSPHERE_AUTO_IMPL_H
