...
#ifndef _IFC4X3_RC4_IFCPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROFILEDEF_AUTO_IMPL_H
...
*/
class IFC4X3_RC4_EXPORT IfcProfileDef : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcProfileDef, IfcProfileDef> object.
*/
typedef OdSmartPtr<IfcProfileDef> IfcProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROFILEDEF_AUTO_IMPL_H
