...
#ifndef _IFC4X3_RC4_IFCPERSON_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPERSON_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPerson : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPerson);
  //DOM-IGNORE-END
...
protected:
  ...
  OdAnsiString m_FamilyName;   // IfcLabel  [optional]
  OdAnsiString m_GivenName;   // IfcLabel  [optional]
  OdDAI::OdAnsiStringList m_MiddleNames; // LIST [1:?] of IfcLabel [optional]

  OdDAI::OdAnsiStringList m_PrefixTitles; // LIST [1:?] of IfcLabel [optional]

  OdDAI::OdAnsiStringList m_SuffixTitles; // LIST [1:?] of IfcLabel [optional]

  OdDAI::OdDAIObjectIdList m_Roles; // LIST [1:?] of IfcActorRole [optional]

  OdDAI::OdDAIObjectIdList m_Addresses; // LIST [1:?] of IfcAddress [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPerson, IfcPerson> object.
*/
typedef OdSmartPtr<IfcPerson> IfcPersonPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPERSON_AUTO_IMPL_H
