...
#ifndef _IFC4X3_RC4_IFCPROPERTYABSTRACTION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROPERTYABSTRACTION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPropertyAbstraction : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPropertyAbstraction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPropertyAbstraction, IfcPropertyAbstraction> object.
*/
typedef OdSmartPtr<IfcPropertyAbstraction> IfcPropertyAbstractionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROPERTYABSTRACTION_AUTO_IMPL_H
