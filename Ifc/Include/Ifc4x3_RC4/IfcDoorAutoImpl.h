...
#ifndef _IFC4X3_RC4_IFCDOOR_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDOOR_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDoor : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDoor);
  //DOM-IGNORE-END
...
public:
  ...
  IfcDoorTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcDoorTypeEnum PredefinedType);
  IfcDoorTypeOperationEnum getOperationType() const;
  void setOperationType(IfcDoorTypeOperationEnum OperationType);
  const OdAnsiString& getUserDefinedOperationType() const;
  void setUserDefinedOperationType(const OdAnsiString& UserDefinedOperationType);
...
protected:
  // Fields declaration: 
  IfcPositiveLengthMeasure m_OverallHeight;   // IfcPositiveLengthMeasure  [optional]
  IfcPositiveLengthMeasure m_OverallWidth;   // IfcPositiveLengthMeasure  [optional]
  OdDAI::Enum m_PredefinedType;   // IfcDoorTypeEnum  [optional]
  OdDAI::Enum m_OperationType;   // IfcDoorTypeOperationEnum  [optional]
  OdAnsiString m_UserDefinedOperationType;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDoor, IfcDoor> object.
*/
typedef OdSmartPtr<IfcDoor> IfcDoorPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDOOR_AUTO_IMPL_H
