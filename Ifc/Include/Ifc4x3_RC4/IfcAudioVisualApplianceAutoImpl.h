...
#ifndef _IFC4X3_RC4_IFCAUDIOVISUALAPPLIANCE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCAUDIOVISUALAPPLIANCE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcAudioVisualAppliance : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcAudioVisualAppliance);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcAudioVisualApplianceTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcAudioVisualAppliance, IfcAudioVisualAppliance> object.
*/
typedef OdSmartPtr<IfcAudioVisualAppliance> IfcAudioVisualAppliancePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCAUDIOVISUALAPPLIANCE_AUTO_IMPL_H
