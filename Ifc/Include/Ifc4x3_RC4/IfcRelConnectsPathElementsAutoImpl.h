...
#ifndef _IFC4X3_RC4_IFCRELCONNECTSPATHELEMENTS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELCONNECTSPATHELEMENTS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelConnectsPathElements : public IfcRelConnectsElements
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelConnectsPathElements);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelConnectsPathElements, IfcRelConnectsPathElements> object.
*/
typedef OdSmartPtr<IfcRelConnectsPathElements> IfcRelConnectsPathElementsPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELCONNECTSPATHELEMENTS_AUTO_IMPL_H
