...
#ifndef _IFC4X3_RC4_IFCSTRUCTURALPOINTCONNECTION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTRUCTURALPOINTCONNECTION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStructuralPointConnection : public IfcStructuralConnection
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStructuralPointConnection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStructuralPointConnection, IfcStructuralPointConnection> object.
*/
typedef OdSmartPtr<IfcStructuralPointConnection> IfcStructuralPointConnectionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTRUCTURALPOINTCONNECTION_AUTO_IMPL_H
