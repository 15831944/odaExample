...
#ifndef _IFC4X3_RC4_IFCELECTRICDISTRIBUTIONBOARD_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCELECTRICDISTRIBUTIONBOARD_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcElectricDistributionBoard : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcElectricDistributionBoard);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcElectricDistributionBoardTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcElectricDistributionBoard, IfcElectricDistributionBoard> object.
*/
typedef OdSmartPtr<IfcElectricDistributionBoard> IfcElectricDistributionBoardPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCELECTRICDISTRIBUTIONBOARD_AUTO_IMPL_H
