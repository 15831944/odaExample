...
#ifndef _IFC4X3_RC4_IFCRELFILLSELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELFILLSELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelFillsElement : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelFillsElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelFillsElement, IfcRelFillsElement> object.
*/
typedef OdSmartPtr<IfcRelFillsElement> IfcRelFillsElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELFILLSELEMENT_AUTO_IMPL_H
