...
#ifndef _IFC4X3_RC4_IFCRAILINGTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRAILINGTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRailingType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRailingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRailingType, IfcRailingType> object.
*/
typedef OdSmartPtr<IfcRailingType> IfcRailingTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRAILINGTYPE_AUTO_IMPL_H
