...
#ifndef _IFC4X3_RC4_IFCRELSPACEBOUNDARY2NDLEVEL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELSPACEBOUNDARY2NDLEVEL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelSpaceBoundary2ndLevel : public IfcRelSpaceBoundary1stLevel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelSpaceBoundary2ndLevel);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getCorrespondingBoundary() const;
  void setCorrespondingBoundary(const OdDAIObjectId& CorrespondingBoundary);
  void getInvCorresponds(OdDAIObjectIds& Corresponds) const;
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_CorrespondingBoundary;   // IfcRelSpaceBoundary2ndLevel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelSpaceBoundary2ndLevel, IfcRelSpaceBoundary2ndLevel> object.
*/
typedef OdSmartPtr<IfcRelSpaceBoundary2ndLevel> IfcRelSpaceBoundary2ndLevelPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELSPACEBOUNDARY2NDLEVEL_AUTO_IMPL_H
