...
#ifndef _IFC4X3_RC4_IFCLAGTIME_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCLAGTIME_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcLagTime : public IfcSchedulingTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcLagTime);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_LagValue;   // IfcTimeOrRatioSelect
  OdDAI::Enum m_DurationType;   // IfcTaskDurationEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcLagTime, IfcLagTime> object.
*/
typedef OdSmartPtr<IfcLagTime> IfcLagTimePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCLAGTIME_AUTO_IMPL_H
