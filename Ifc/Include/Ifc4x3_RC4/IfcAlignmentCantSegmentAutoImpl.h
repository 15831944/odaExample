...
#ifndef _IFC4X3_RC4_IFCALIGNMENTCANTSEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCALIGNMENTCANTSEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcAlignmentCantSegment : public IfcAlignmentParameterSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcAlignmentCantSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcAlignmentCantSegment, IfcAlignmentCantSegment> object.
*/
typedef OdSmartPtr<IfcAlignmentCantSegment> IfcAlignmentCantSegmentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCALIGNMENTCANTSEGMENT_AUTO_IMPL_H
