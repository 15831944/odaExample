...
#ifndef _IFC4X3_RC4_IFCBURNER_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBURNER_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBurner : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBurner);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBurner, IfcBurner> object.
*/
typedef OdSmartPtr<IfcBurner> IfcBurnerPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBURNER_AUTO_IMPL_H
