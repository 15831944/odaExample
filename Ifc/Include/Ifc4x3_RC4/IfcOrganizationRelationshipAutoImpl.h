...
#ifndef _IFC4X3_RC4_IFCORGANIZATIONRELATIONSHIP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCORGANIZATIONRELATIONSHIP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcOrganizationRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcOrganizationRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcOrganizationRelationship, IfcOrganizationRelationship> object.
*/
typedef OdSmartPtr<IfcOrganizationRelationship> IfcOrganizationRelationshipPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCORGANIZATIONRELATIONSHIP_AUTO_IMPL_H
