...
#ifndef _IFC4X3_RC4_IFCVOIDINGFEATURE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCVOIDINGFEATURE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcVoidingFeature : public IfcFeatureElementSubtraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcVoidingFeature);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcVoidingFeature, IfcVoidingFeature> object.
*/
typedef OdSmartPtr<IfcVoidingFeature> IfcVoidingFeaturePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCVOIDINGFEATURE_AUTO_IMPL_H
