...
#ifndef _IFC4X3_RC4_IFCPROCEDURE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROCEDURE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcProcedure : public IfcProcess
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcProcedure);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcProcedure, IfcProcedure> object.
*/
typedef OdSmartPtr<IfcProcedure> IfcProcedurePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROCEDURE_AUTO_IMPL_H
