...
#ifndef _IFC4X3_RC4_IFCPOINTBYDISTANCEEXPRESSION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPOINTBYDISTANCEEXPRESSION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPointByDistanceExpression : public IfcPoint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPointByDistanceExpression);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_DistanceAlong;   // IfcCurveMeasureSelect
  double m_OffsetLateral;   // IfcLengthMeasure  [optional]
  double m_OffsetVertical;   // IfcLengthMeasure  [optional]
  double m_OffsetLongitudinal;   // IfcLengthMeasure  [optional]
  OdDAIObjectId m_BasisCurve;   // IfcCurve
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPointByDistanceExpression, IfcPointByDistanceExpression> object.
*/
typedef OdSmartPtr<IfcPointByDistanceExpression> IfcPointByDistanceExpressionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPOINTBYDISTANCEEXPRESSION_AUTO_IMPL_H
