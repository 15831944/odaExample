...
#ifndef _IFC4X3_RC4_IFCEVENTTIME_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCEVENTTIME_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcEventTime : public IfcSchedulingTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcEventTime);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_ActualDate;   // IfcDateTime  [optional]
  OdAnsiString m_EarlyDate;   // IfcDateTime  [optional]
  OdAnsiString m_LateDate;   // IfcDateTime  [optional]
  OdAnsiString m_ScheduleDate;   // IfcDateTime  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcEventTime, IfcEventTime> object.
*/
typedef OdSmartPtr<IfcEventTime> IfcEventTimePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCEVENTTIME_AUTO_IMPL_H
