...
#ifndef _IFC4X3_RC4_IFCSTRUCTURALACTION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTRUCTURALACTION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStructuralAction : public IfcStructuralActivity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStructuralAction);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Boolean m_DestabilizingLoad;   // IfcBoolean  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStructuralAction, IfcStructuralAction> object.
*/
typedef OdSmartPtr<IfcStructuralAction> IfcStructuralActionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTRUCTURALACTION_AUTO_IMPL_H
