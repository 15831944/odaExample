...
#ifndef _IFC4X3_RC4_IFCMATERIALPROFILESET_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMATERIALPROFILESET_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMaterialProfileSet : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMaterialProfileSet);
  //DOM-IGNORE-END
...
public:
  ...
  void getMaterialProfiles(OdDAIObjectIds& MaterialProfiles) const;
  OdDAI::OdDAIObjectIdList& materialProfiles();
  const OdDAIObjectId& getCompositeProfile() const;
  void setCompositeProfile(const OdDAIObjectId& CompositeProfile);
...
protected:
  ...
  OdDAI::OdDAIObjectIdList m_MaterialProfiles; // LIST [1:?] of IfcMaterialProfile
  OdDAIObjectId m_CompositeProfile;   // IfcCompositeProfileDef  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMaterialProfileSet, IfcMaterialProfileSet> object.
*/
typedef OdSmartPtr<IfcMaterialProfileSet> IfcMaterialProfileSetPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMATERIALPROFILESET_AUTO_IMPL_H
