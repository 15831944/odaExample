...
#ifndef _IFC4X3_RC4_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSurfaceOfLinearExtrusion : public IfcSweptSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSurfaceOfLinearExtrusion);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSurfaceOfLinearExtrusion, IfcSurfaceOfLinearExtrusion> object.
*/
typedef OdSmartPtr<IfcSurfaceOfLinearExtrusion> IfcSurfaceOfLinearExtrusionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
