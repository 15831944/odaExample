...
#ifndef _IFC4X3_RC4_IFCMATERIALDEFINITION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMATERIALDEFINITION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMaterialDefinition : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMaterialDefinition);
  //DOM-IGNORE-END
...
protected:
  ...
  friend class IfcMaterialProperties;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMaterialDefinition, IfcMaterialDefinition> object.
*/
typedef OdSmartPtr<IfcMaterialDefinition> IfcMaterialDefinitionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMATERIALDEFINITION_AUTO_IMPL_H
