...
#ifndef _IFC4X3_RC4_IFCRECTANGULARPYRAMID_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRECTANGULARPYRAMID_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRectangularPyramid : public IfcCsgPrimitive3D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRectangularPyramid);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  IfcPositiveLengthMeasure m_XLength;   // IfcPositiveLengthMeasure
  IfcPositiveLengthMeasure m_YLength;   // IfcPositiveLengthMeasure
  IfcPositiveLengthMeasure m_Height;   // IfcPositiveLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRectangularPyramid, IfcRectangularPyramid> object.
*/
typedef OdSmartPtr<IfcRectangularPyramid> IfcRectangularPyramidPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRECTANGULARPYRAMID_AUTO_IMPL_H
