...
#ifndef _IFC4X3_RC4_IFCRELASSOCIATESCLASSIFICATION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELASSOCIATESCLASSIFICATION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelAssociatesClassification : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelAssociatesClassification);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_RelatingClassification;   // IfcClassificationSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelAssociatesClassification, IfcRelAssociatesClassification> object.
*/
typedef OdSmartPtr<IfcRelAssociatesClassification> IfcRelAssociatesClassificationPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELASSOCIATESCLASSIFICATION_AUTO_IMPL_H
