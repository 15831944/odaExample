...
#ifndef _IFC4X3_RC4_IFCMOBILETELECOMMUNICATIONSAPPLIANCETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMOBILETELECOMMUNICATIONSAPPLIANCETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMobileTelecommunicationsApplianceType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMobileTelecommunicationsApplianceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcMobileTelecommunicationsApplianceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcMobileTelecommunicationsApplianceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcMobileTelecommunicationsApplianceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMobileTelecommunicationsApplianceType, IfcMobileTelecommunicationsApplianceType> object.
*/
typedef OdSmartPtr<IfcMobileTelecommunicationsApplianceType> IfcMobileTelecommunicationsApplianceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMOBILETELECOMMUNICATIONSAPPLIANCETYPE_AUTO_IMPL_H
