...
#ifndef _IFC4X3_RC4_IFCFACEBOUND_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFACEBOUND_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFaceBound : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFaceBound);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Boolean m_Orientation;   // IfcBoolean
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFaceBound, IfcFaceBound> object.
*/
typedef OdSmartPtr<IfcFaceBound> IfcFaceBoundPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFACEBOUND_AUTO_IMPL_H
