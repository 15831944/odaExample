...
#ifndef _IFC4X3_RC4_IFCBURNERTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBURNERTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBurnerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBurnerType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcBurnerTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcBurnerTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcBurnerTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBurnerType, IfcBurnerType> object.
*/
typedef OdSmartPtr<IfcBurnerType> IfcBurnerTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBURNERTYPE_AUTO_IMPL_H
