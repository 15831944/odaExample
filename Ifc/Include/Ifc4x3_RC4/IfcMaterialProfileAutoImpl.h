...
#ifndef _IFC4X3_RC4_IFCMATERIALPROFILE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMATERIALPROFILE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMaterialProfile : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMaterialProfile);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getProfile() const;
  void setProfile(const OdDAIObjectId& Profile);
  int getPriority() const;
  void setPriority(int Priority);
  const OdAnsiString& getCategory() const;
  void setCategory(const OdAnsiString& Category);
  OdDAIObjectId getInvToMaterialProfileSet() const;
...
protected:
  ...
  OdDAIObjectId m_Profile;   // IfcProfileDef
  ...
  friend class IfcMaterialProfileSet;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMaterialProfile, IfcMaterialProfile> object.
*/
typedef OdSmartPtr<IfcMaterialProfile> IfcMaterialProfilePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMATERIALPROFILE_AUTO_IMPL_H
