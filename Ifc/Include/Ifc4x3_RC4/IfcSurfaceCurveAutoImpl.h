...
#ifndef _IFC4X3_RC4_IFCSURFACECURVE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSURFACECURVE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSurfaceCurve : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSurfaceCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSurfaceCurve, IfcSurfaceCurve> object.
*/
typedef OdSmartPtr<IfcSurfaceCurve> IfcSurfaceCurvePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSURFACECURVE_AUTO_IMPL_H
