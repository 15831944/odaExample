...
#ifndef _IFC4X3_RC4_IFCSHAPEASPECT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSHAPEASPECT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcShapeAspect : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcShapeAspect);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& shapeRepresentations();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_ShapeRepresentations; // LIST [1:?] of IfcShapeModel
  OdAnsiString m_Name;   // IfcLabel  [optional]
  OdAnsiString m_Description;   // IfcText  [optional]
  OdDAI::Logical m_ProductDefinitional;   // IfcLogical
  OdDAI::Select m_PartOfProductDefinitionShape;   // IfcProductRepresentationSelect  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcShapeAspect, IfcShapeAspect> object.
*/
typedef OdSmartPtr<IfcShapeAspect> IfcShapeAspectPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSHAPEASPECT_AUTO_IMPL_H
