...
#ifndef _IFC4X3_RC4_IFCINDEXEDTEXTUREMAP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCINDEXEDTEXTUREMAP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcIndexedTextureMap : public IfcTextureCoordinate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcIndexedTextureMap);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcIndexedTextureMap, IfcIndexedTextureMap> object.
*/
typedef OdSmartPtr<IfcIndexedTextureMap> IfcIndexedTextureMapPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCINDEXEDTEXTUREMAP_AUTO_IMPL_H
