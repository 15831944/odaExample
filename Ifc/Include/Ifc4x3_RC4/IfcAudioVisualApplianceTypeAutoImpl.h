...
#ifndef _IFC4X3_RC4_IFCAUDIOVISUALAPPLIANCETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCAUDIOVISUALAPPLIANCETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcAudioVisualApplianceType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcAudioVisualApplianceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcAudioVisualApplianceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcAudioVisualApplianceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcAudioVisualApplianceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcAudioVisualApplianceType, IfcAudioVisualApplianceType> object.
*/
typedef OdSmartPtr<IfcAudioVisualApplianceType> IfcAudioVisualApplianceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCAUDIOVISUALAPPLIANCETYPE_AUTO_IMPL_H
