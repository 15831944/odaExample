...
#ifndef _IFC4X3_RC4_IFCDIRECTION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDIRECTION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDirection : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDirection);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::DoubleList m_DirectionRatios; // LIST [2:3] of IfcReal
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDirection, IfcDirection> object.
*/
typedef OdSmartPtr<IfcDirection> IfcDirectionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDIRECTION_AUTO_IMPL_H
