...
#ifndef _IFC4X3_RC4_IFCPROPERTYTEMPLATE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROPERTYTEMPLATE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPropertyTemplate : public IfcPropertyTemplateDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPropertyTemplate);
  //DOM-IGNORE-END
...
protected:
  ...
  friend class IfcComplexPropertyTemplate;
  friend class IfcPropertySetTemplate;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPropertyTemplate, IfcPropertyTemplate> object.
*/
typedef OdSmartPtr<IfcPropertyTemplate> IfcPropertyTemplatePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROPERTYTEMPLATE_AUTO_IMPL_H
