...
#ifndef _IFC4X3_RC4_IFCDISTRIBUTIONCONTROLELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDISTRIBUTIONCONTROLELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDistributionControlElement : public IfcDistributionElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDistributionControlElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDistributionControlElement, IfcDistributionControlElement> object.
*/
typedef OdSmartPtr<IfcDistributionControlElement> IfcDistributionControlElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDISTRIBUTIONCONTROLELEMENT_AUTO_IMPL_H
