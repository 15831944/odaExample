...
#ifndef _IFC4X3_RC4_IFCGEOMODEL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCGEOMODEL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcGeomodel : public IfcGeotechnicalAssembly
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcGeomodel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcGeomodel, IfcGeomodel> object.
*/
typedef OdSmartPtr<IfcGeomodel> IfcGeomodelPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCGEOMODEL_AUTO_IMPL_H
