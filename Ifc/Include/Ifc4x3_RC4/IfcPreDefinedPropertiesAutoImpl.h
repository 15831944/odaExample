...
#ifndef _IFC4X3_RC4_IFCPREDEFINEDPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPREDEFINEDPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPreDefinedProperties : public IfcPropertyAbstraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPreDefinedProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPreDefinedProperties, IfcPreDefinedProperties> object.
*/
typedef OdSmartPtr<IfcPreDefinedProperties> IfcPreDefinedPropertiesPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPREDEFINEDPROPERTIES_AUTO_IMPL_H
