...
#ifndef _IFC4X3_RC4_IFCRELCONNECTSPORTTOELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELCONNECTSPORTTOELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelConnectsPortToElement : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelConnectsPortToElement);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAIObjectId m_RelatedElement;   // IfcDistributionElement
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelConnectsPortToElement, IfcRelConnectsPortToElement> object.
*/
typedef OdSmartPtr<IfcRelConnectsPortToElement> IfcRelConnectsPortToElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELCONNECTSPORTTOELEMENT_AUTO_IMPL_H
