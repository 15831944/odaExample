...
#ifndef _IFC4X3_RC4_IFCRECTANGLEHOLLOWPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRECTANGLEHOLLOWPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRectangleHollowProfileDef : public IfcRectangleProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRectangleHollowProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRectangleHollowProfileDef, IfcRectangleHollowProfileDef> object.
*/
typedef OdSmartPtr<IfcRectangleHollowProfileDef> IfcRectangleHollowProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRECTANGLEHOLLOWPROFILEDEF_AUTO_IMPL_H
