...
#ifndef _IFC4X3_RC4_IFCRELCONNECTSWITHECCENTRICITY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELCONNECTSWITHECCENTRICITY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelConnectsWithEccentricity : public IfcRelConnectsStructuralMember
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelConnectsWithEccentricity);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getConnectionConstraint() const;
  void setConnectionConstraint(const OdDAIObjectId& ConnectionConstraint);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_ConnectionConstraint;   // IfcConnectionGeometry
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelConnectsWithEccentricity, IfcRelConnectsWithEccentricity> object.
*/
typedef OdSmartPtr<IfcRelConnectsWithEccentricity> IfcRelConnectsWithEccentricityPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELCONNECTSWITHECCENTRICITY_AUTO_IMPL_H
