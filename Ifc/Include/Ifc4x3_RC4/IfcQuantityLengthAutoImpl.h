...
#ifndef _IFC4X3_RC4_IFCQUANTITYLENGTH_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCQUANTITYLENGTH_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcQuantityLength : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcQuantityLength);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcQuantityLength, IfcQuantityLength> object.
*/
typedef OdSmartPtr<IfcQuantityLength> IfcQuantityLengthPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCQUANTITYLENGTH_AUTO_IMPL_H
