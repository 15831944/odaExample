...
#ifndef _IFC4X3_RC4_IFCSIGNALTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSIGNALTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSignalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSignalType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcSignalTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcSignalTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSignalTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSignalType, IfcSignalType> object.
*/
typedef OdSmartPtr<IfcSignalType> IfcSignalTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSIGNALTYPE_AUTO_IMPL_H
