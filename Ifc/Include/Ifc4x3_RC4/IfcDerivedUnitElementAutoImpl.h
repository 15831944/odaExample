...
#ifndef _IFC4X3_RC4_IFCDERIVEDUNITELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDERIVEDUNITELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDerivedUnitElement : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDerivedUnitElement);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Unit;   // IfcNamedUnit
  int m_Exponent;   // INTEGER
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDerivedUnitElement, IfcDerivedUnitElement> object.
*/
typedef OdSmartPtr<IfcDerivedUnitElement> IfcDerivedUnitElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDERIVEDUNITELEMENT_AUTO_IMPL_H
