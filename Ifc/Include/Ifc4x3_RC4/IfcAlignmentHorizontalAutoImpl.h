...
#ifndef _IFC4X3_RC4_IFCALIGNMENTHORIZONTAL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCALIGNMENTHORIZONTAL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcAlignmentHorizontal : public IfcLinearElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcAlignmentHorizontal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcAlignmentHorizontal, IfcAlignmentHorizontal> object.
*/
typedef OdSmartPtr<IfcAlignmentHorizontal> IfcAlignmentHorizontalPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCALIGNMENTHORIZONTAL_AUTO_IMPL_H
