...
#ifndef _IFC4X3_RC4_IFCCONTROLLER_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONTROLLER_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcController : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcController);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcControllerTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcController, IfcController> object.
*/
typedef OdSmartPtr<IfcController> IfcControllerPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONTROLLER_AUTO_IMPL_H
