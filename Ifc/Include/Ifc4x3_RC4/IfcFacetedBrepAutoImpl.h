...
#ifndef _IFC4X3_RC4_IFCFACETEDBREP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFACETEDBREP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFacetedBrep : public IfcManifoldSolidBrep
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFacetedBrep);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFacetedBrep, IfcFacetedBrep> object.
*/
typedef OdSmartPtr<IfcFacetedBrep> IfcFacetedBrepPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFACETEDBREP_AUTO_IMPL_H
