...
#ifndef _IFC4X3_RC4_IFCCOOLEDBEAMTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOOLEDBEAMTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCooledBeamType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCooledBeamType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCooledBeamType, IfcCooledBeamType> object.
*/
typedef OdSmartPtr<IfcCooledBeamType> IfcCooledBeamTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOOLEDBEAMTYPE_AUTO_IMPL_H
