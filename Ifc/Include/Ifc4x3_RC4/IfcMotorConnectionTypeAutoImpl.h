...
#ifndef _IFC4X3_RC4_IFCMOTORCONNECTIONTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMOTORCONNECTIONTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMotorConnectionType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMotorConnectionType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMotorConnectionType, IfcMotorConnectionType> object.
*/
typedef OdSmartPtr<IfcMotorConnectionType> IfcMotorConnectionTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMOTORCONNECTIONTYPE_AUTO_IMPL_H
