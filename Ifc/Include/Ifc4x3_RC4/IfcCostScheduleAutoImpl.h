...
#ifndef _IFC4X3_RC4_IFCCOSTSCHEDULE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOSTSCHEDULE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCostSchedule : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCostSchedule);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getSubmittedOn() const;
  void setSubmittedOn(const OdAnsiString& SubmittedOn);
  const OdAnsiString& getUpdateDate() const;
  void setUpdateDate(const OdAnsiString& UpdateDate);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCostScheduleTypeEnum  [optional]
  OdAnsiString m_Status;   // IfcLabel  [optional]
  OdAnsiString m_SubmittedOn;   // IfcDateTime  [optional]
  OdAnsiString m_UpdateDate;   // IfcDateTime  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCostSchedule, IfcCostSchedule> object.
*/
typedef OdSmartPtr<IfcCostSchedule> IfcCostSchedulePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOSTSCHEDULE_AUTO_IMPL_H
