...
#ifndef _IFC4X3_RC4_IFCZONE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCZONE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcZone : public IfcSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcZone);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcZone, IfcZone> object.
*/
typedef OdSmartPtr<IfcZone> IfcZonePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCZONE_AUTO_IMPL_H
