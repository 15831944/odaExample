...
#ifndef _IFC4X3_RC4_IFCSURFACEREINFORCEMENTAREA_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSURFACEREINFORCEMENTAREA_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSurfaceReinforcementArea : public IfcStructuralLoadOrResult
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSurfaceReinforcementArea);
  //DOM-IGNORE-END
...
public:
  ...
  void getSurfaceReinforcement1(OdArray<double >& SurfaceReinforcement1) const;
  OdDAI::DoubleList& surfaceReinforcement1();
  void getSurfaceReinforcement2(OdArray<double >& SurfaceReinforcement2) const;
  OdDAI::DoubleList& surfaceReinforcement2();
  double getShearReinforcement() const;
  void setShearReinforcement(double ShearReinforcement);
...
protected:
  // Fields declaration: 
  OdDAI::DoubleList m_SurfaceReinforcement1; // LIST [2:3] of IfcLengthMeasure [optional]

  OdDAI::DoubleList m_SurfaceReinforcement2; // LIST [2:3] of IfcLengthMeasure [optional]

  double m_ShearReinforcement;   // IfcRatioMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSurfaceReinforcementArea, IfcSurfaceReinforcementArea> object.
*/
typedef OdSmartPtr<IfcSurfaceReinforcementArea> IfcSurfaceReinforcementAreaPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSURFACEREINFORCEMENTAREA_AUTO_IMPL_H
