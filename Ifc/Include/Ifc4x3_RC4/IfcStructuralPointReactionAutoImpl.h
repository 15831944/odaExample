...
#ifndef _IFC4X3_RC4_IFCSTRUCTURALPOINTREACTION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTRUCTURALPOINTREACTION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStructuralPointReaction : public IfcStructuralReaction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStructuralPointReaction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStructuralPointReaction, IfcStructuralPointReaction> object.
*/
typedef OdSmartPtr<IfcStructuralPointReaction> IfcStructuralPointReactionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTRUCTURALPOINTREACTION_AUTO_IMPL_H
