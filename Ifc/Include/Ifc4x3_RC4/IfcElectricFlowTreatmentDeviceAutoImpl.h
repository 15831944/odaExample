...
#ifndef _IFC4X3_RC4_IFCELECTRICFLOWTREATMENTDEVICE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCELECTRICFLOWTREATMENTDEVICE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcElectricFlowTreatmentDevice : public IfcFlowTreatmentDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcElectricFlowTreatmentDevice);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcElectricFlowTreatmentDeviceTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcElectricFlowTreatmentDevice, IfcElectricFlowTreatmentDevice> object.
*/
typedef OdSmartPtr<IfcElectricFlowTreatmentDevice> IfcElectricFlowTreatmentDevicePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCELECTRICFLOWTREATMENTDEVICE_AUTO_IMPL_H
