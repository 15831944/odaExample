...
#ifndef _IFC4X3_RC4_IFCTRANSPORTELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTRANSPORTELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTransportElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTransportElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTransportElementType, IfcTransportElementType> object.
*/
typedef OdSmartPtr<IfcTransportElementType> IfcTransportElementTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTRANSPORTELEMENTTYPE_AUTO_IMPL_H
