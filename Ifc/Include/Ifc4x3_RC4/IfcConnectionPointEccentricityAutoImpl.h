...
#ifndef _IFC4X3_RC4_IFCCONNECTIONPOINTECCENTRICITY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONNECTIONPOINTECCENTRICITY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcConnectionPointEccentricity : public IfcConnectionPointGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcConnectionPointEccentricity);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcConnectionPointEccentricity, IfcConnectionPointEccentricity> object.
*/
typedef OdSmartPtr<IfcConnectionPointEccentricity> IfcConnectionPointEccentricityPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONNECTIONPOINTECCENTRICITY_AUTO_IMPL_H
