...
#ifndef _IFC4X3_RC4_IFCEXTERNALLYDEFINEDSURFACESTYLE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCEXTERNALLYDEFINEDSURFACESTYLE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcExternallyDefinedSurfaceStyle : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcExternallyDefinedSurfaceStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcExternallyDefinedSurfaceStyle, IfcExternallyDefinedSurfaceStyle> object.
*/
typedef OdSmartPtr<IfcExternallyDefinedSurfaceStyle> IfcExternallyDefinedSurfaceStylePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCEXTERNALLYDEFINEDSURFACESTYLE_AUTO_IMPL_H
