...
#ifndef _IFC4X3_RC4_IFCTEXTSTYLETEXTMODEL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTEXTSTYLETEXTMODEL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTextStyleTextModel : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTextStyleTextModel);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getTextAlign() const;
  void setTextAlign(const OdAnsiString& TextAlign);
  const OdAnsiString& getTextDecoration() const;
  void setTextDecoration(const OdAnsiString& TextDecoration);
  IfcSizeSelect letterSpacing();
  IfcSizeSelect wordSpacing();
  const OdAnsiString& getTextTransform() const;
  void setTextTransform(const OdAnsiString& TextTransform);
...
protected:
  // Fields declaration: 
  OdDAI::Select m_TextIndent;   // IfcSizeSelect  [optional]
  OdAnsiString m_TextAlign;   // IfcTextAlignment  [optional]
  OdAnsiString m_TextDecoration;   // IfcTextDecoration  [optional]
  OdDAI::Select m_LetterSpacing;   // IfcSizeSelect  [optional]
  OdDAI::Select m_WordSpacing;   // IfcSizeSelect  [optional]
  OdAnsiString m_TextTransform;   // IfcTextTransformation  [optional]
  OdDAI::Select m_LineHeight;   // IfcSizeSelect  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTextStyleTextModel, IfcTextStyleTextModel> object.
*/
typedef OdSmartPtr<IfcTextStyleTextModel> IfcTextStyleTextModelPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTEXTSTYLETEXTMODEL_AUTO_IMPL_H
