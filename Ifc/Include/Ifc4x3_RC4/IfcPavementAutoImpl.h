...
#ifndef _IFC4X3_RC4_IFCPAVEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPAVEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPavement : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPavement);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcPavementTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPavement, IfcPavement> object.
*/
typedef OdSmartPtr<IfcPavement> IfcPavementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPAVEMENT_AUTO_IMPL_H
