...
#ifndef _IFC4X3_RC4_IFCCONSTRUCTIONEQUIPMENTRESOURCETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONSTRUCTIONEQUIPMENTRESOURCETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcConstructionEquipmentResourceType : public IfcConstructionResourceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcConstructionEquipmentResourceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcConstructionEquipmentResourceType, IfcConstructionEquipmentResourceType> object.
*/
typedef OdSmartPtr<IfcConstructionEquipmentResourceType> IfcConstructionEquipmentResourceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONSTRUCTIONEQUIPMENTRESOURCETYPE_AUTO_IMPL_H
