...
#ifndef _IFC4X3_RC4_IFCCOSINE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOSINE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCosine : public IfcSpiral
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCosine);
  //DOM-IGNORE-END
...
public:
  ...
  double getCosineTerm() const;
  void setCosineTerm(double CosineTerm);
...
protected:
  // Fields declaration: 
  double m_CosineTerm;   // IfcLengthMeasure
  double m_ConstantTerm;   // IfcLengthMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCosine, IfcCosine> object.
*/
typedef OdSmartPtr<IfcCosine> IfcCosinePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOSINE_AUTO_IMPL_H
