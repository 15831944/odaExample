...
#ifndef _IFC4X3_RC4_IFCFLOWMOVINGDEVICETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFLOWMOVINGDEVICETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFlowMovingDeviceType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFlowMovingDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFlowMovingDeviceType, IfcFlowMovingDeviceType> object.
*/
typedef OdSmartPtr<IfcFlowMovingDeviceType> IfcFlowMovingDeviceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFLOWMOVINGDEVICETYPE_AUTO_IMPL_H
