...
#ifndef _IFC4X3_RC4_IFCSECTIONEDSOLID_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSECTIONEDSOLID_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSectionedSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSectionedSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSectionedSolid, IfcSectionedSolid> object.
*/
typedef OdSmartPtr<IfcSectionedSolid> IfcSectionedSolidPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSECTIONEDSOLID_AUTO_IMPL_H
