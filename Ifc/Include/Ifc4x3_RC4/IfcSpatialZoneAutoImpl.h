...
#ifndef _IFC4X3_RC4_IFCSPATIALZONE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSPATIALZONE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSpatialZone : public IfcSpatialElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSpatialZone);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSpatialZone, IfcSpatialZone> object.
*/
typedef OdSmartPtr<IfcSpatialZone> IfcSpatialZonePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSPATIALZONE_AUTO_IMPL_H
