...
#ifndef _IFC4X3_RC4_IFCDISTRIBUTIONCONTROLELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDISTRIBUTIONCONTROLELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDistributionControlElementType : public IfcDistributionElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDistributionControlElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDistributionControlElementType, IfcDistributionControlElementType> object.
*/
typedef OdSmartPtr<IfcDistributionControlElementType> IfcDistributionControlElementTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDISTRIBUTIONCONTROLELEMENTTYPE_AUTO_IMPL_H
