...
#ifndef _IFC4X3_RC4_IFCEXTERNALREFERENCE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCEXTERNALREFERENCE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcExternalReference : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcExternalReference);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvExternalReferenceForResources(OdDAIObjectIds& ExternalReferenceForResources) const;
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcExternalReference, IfcExternalReference> object.
*/
typedef OdSmartPtr<IfcExternalReference> IfcExternalReferencePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCEXTERNALREFERENCE_AUTO_IMPL_H
