...
#ifndef _IFC4X3_RC4_IFCBSPLINECURVE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBSPLINECURVE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBSplineCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBSplineCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBSplineCurve, IfcBSplineCurve> object.
*/
typedef OdSmartPtr<IfcBSplineCurve> IfcBSplineCurvePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBSPLINECURVE_AUTO_IMPL_H
