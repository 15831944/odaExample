...
#ifndef _IFC4X3_RC4_IFCORIENTEDEDGE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCORIENTEDEDGE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcOrientedEdge : public IfcEdge
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcOrientedEdge);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcOrientedEdge, IfcOrientedEdge> object.
*/
typedef OdSmartPtr<IfcOrientedEdge> IfcOrientedEdgePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCORIENTEDEDGE_AUTO_IMPL_H
