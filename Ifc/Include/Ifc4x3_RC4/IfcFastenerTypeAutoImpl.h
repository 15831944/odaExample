...
#ifndef _IFC4X3_RC4_IFCFASTENERTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFASTENERTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFastenerType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFastenerType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcFastenerTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcFastenerTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcFastenerTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFastenerType, IfcFastenerType> object.
*/
typedef OdSmartPtr<IfcFastenerType> IfcFastenerTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFASTENERTYPE_AUTO_IMPL_H
