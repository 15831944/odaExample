...
#ifndef _IFC4X3_RC4_IFCSIGNTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSIGNTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSignType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSignType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcSignTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcSignTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSignTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSignType, IfcSignType> object.
*/
typedef OdSmartPtr<IfcSignType> IfcSignTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSIGNTYPE_AUTO_IMPL_H
