...
#ifndef _IFC4X3_RC4_IFCSOLARDEVICE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSOLARDEVICE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSolarDevice : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSolarDevice);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSolarDeviceTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSolarDevice, IfcSolarDevice> object.
*/
typedef OdSmartPtr<IfcSolarDevice> IfcSolarDevicePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSOLARDEVICE_AUTO_IMPL_H
