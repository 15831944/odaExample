...
#ifndef _IFC4X3_RC4_IFCAPPLICATION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCAPPLICATION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcApplication : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcApplication);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getApplicationDeveloper() const;
  void setApplicationDeveloper(const OdDAIObjectId& ApplicationDeveloper);
  const OdAnsiString& getVersion() const;
  void setVersion(const OdAnsiString& Version);
  const OdAnsiString& getApplicationFullName() const;
  void setApplicationFullName(const OdAnsiString& ApplicationFullName);
  const OdAnsiString& getApplicationIdentifier() const;
  void setApplicationIdentifier(const OdAnsiString& ApplicationIdentifier);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_ApplicationDeveloper;   // IfcOrganization
  OdAnsiString m_Version;   // IfcLabel
  OdAnsiString m_ApplicationFullName;   // IfcLabel
  OdAnsiString m_ApplicationIdentifier;   // IfcIdentifier
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcApplication, IfcApplication> object.
*/
typedef OdSmartPtr<IfcApplication> IfcApplicationPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCAPPLICATION_AUTO_IMPL_H
