...
#ifndef _IFC4X3_RC4_IFCALIGNMENTCANT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCALIGNMENTCANT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcAlignmentCant : public IfcLinearElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcAlignmentCant);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcAlignmentCant, IfcAlignmentCant> object.
*/
typedef OdSmartPtr<IfcAlignmentCant> IfcAlignmentCantPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCALIGNMENTCANT_AUTO_IMPL_H
