...
#ifndef _IFC4X3_RC4_IFCLIGHTDISTRIBUTIONDATA_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCLIGHTDISTRIBUTIONDATA_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcLightDistributionData : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcLightDistributionData);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::DoubleList& secondaryPlaneAngle();
  void getLuminousIntensity(OdArray<double >& LuminousIntensity) const;
  OdDAI::DoubleList& luminousIntensity();
...
protected:
  // Fields declaration: 
  double m_MainPlaneAngle;   // IfcPlaneAngleMeasure
  OdDAI::DoubleList m_SecondaryPlaneAngle; // LIST [1:?] of IfcPlaneAngleMeasure
  OdDAI::DoubleList m_LuminousIntensity; // LIST [1:?] of IfcLuminousIntensityDistributionMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcLightDistributionData, IfcLightDistributionData> object.
*/
typedef OdSmartPtr<IfcLightDistributionData> IfcLightDistributionDataPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCLIGHTDISTRIBUTIONDATA_AUTO_IMPL_H
