...
#ifndef _IFC4X3_RC4_IFCMATERIALCONSTITUENTSET_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMATERIALCONSTITUENTSET_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMaterialConstituentSet : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMaterialConstituentSet);
  //DOM-IGNORE-END
...
public:
  ...
  void getMaterialConstituents(OdDAIObjectIds& MaterialConstituents) const;
  OdDAI::OdDAIObjectIdSet& materialConstituents();
...
protected:
  ...
  OdDAI::OdDAIObjectIdSet m_MaterialConstituents; // SET [1:?] of IfcMaterialConstituent [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMaterialConstituentSet, IfcMaterialConstituentSet> object.
*/
typedef OdSmartPtr<IfcMaterialConstituentSet> IfcMaterialConstituentSetPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMATERIALCONSTITUENTSET_AUTO_IMPL_H
