...
#ifndef _IFC4X3_RC4_IFCCOMPOSITECURVEONSURFACE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOMPOSITECURVEONSURFACE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCompositeCurveOnSurface : public IfcCompositeCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCompositeCurveOnSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCompositeCurveOnSurface, IfcCompositeCurveOnSurface> object.
*/
typedef OdSmartPtr<IfcCompositeCurveOnSurface> IfcCompositeCurveOnSurfacePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOMPOSITECURVEONSURFACE_AUTO_IMPL_H
