...
#ifndef _IFC4X3_RC4_IFCRECURRENCEPATTERN_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRECURRENCEPATTERN_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRecurrencePattern : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRecurrencePattern);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& timePeriods();
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_RecurrenceType;   // IfcRecurrenceTypeEnum
  OdDAI::IntSet m_DayComponent; // SET [1:?] of IfcDayInMonthNumber [optional]

  OdDAI::IntSet m_WeekdayComponent; // SET [1:?] of IfcDayInWeekNumber [optional]

  OdDAI::IntSet m_MonthComponent; // SET [1:?] of IfcMonthInYearNumber [optional]

  int m_Position;   // IfcInteger  [optional]
  int m_Interval;   // IfcInteger  [optional]
  int m_Occurrences;   // IfcInteger  [optional]
  OdDAI::OdDAIObjectIdList m_TimePeriods; // LIST [1:?] of IfcTimePeriod [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRecurrencePattern, IfcRecurrencePattern> object.
*/
typedef OdSmartPtr<IfcRecurrencePattern> IfcRecurrencePatternPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRECURRENCEPATTERN_AUTO_IMPL_H
