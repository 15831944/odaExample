...
#ifndef _IFC4X3_RC4_IFCMETRIC_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMETRIC_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMetric : public IfcConstraint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMetric);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_Benchmark;   // IfcBenchmarkEnum
  OdAnsiString m_ValueSource;   // IfcLabel  [optional]
  OdDAI::Select m_DataValue;   // IfcMetricValueSelect  [optional]
  OdDAIObjectId m_ReferencePath;   // IfcReference  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMetric, IfcMetric> object.
*/
typedef OdSmartPtr<IfcMetric> IfcMetricPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMETRIC_AUTO_IMPL_H
