...
#ifndef _IFC4X3_RC4_IFCCOLOURRGBLIST_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOLOURRGBLIST_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcColourRgbList : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcColourRgbList);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::List<OdDAI::Aggr*> m_ColourList; // LIST [1:?] of LIST [3:3] of IfcNormalisedRatioMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcColourRgbList, IfcColourRgbList> object.
*/
typedef OdSmartPtr<IfcColourRgbList> IfcColourRgbListPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOLOURRGBLIST_AUTO_IMPL_H
