...
#ifndef _IFC4X3_RC4_IFCPLATE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPLATE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPlate : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPlate);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcPlateTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPlate, IfcPlate> object.
*/
typedef OdSmartPtr<IfcPlate> IfcPlatePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPLATE_AUTO_IMPL_H
