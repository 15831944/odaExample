...
#ifndef _IFC4X3_RC4_IFCDEEPFOUNDATION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDEEPFOUNDATION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDeepFoundation : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDeepFoundation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDeepFoundation, IfcDeepFoundation> object.
*/
typedef OdSmartPtr<IfcDeepFoundation> IfcDeepFoundationPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDEEPFOUNDATION_AUTO_IMPL_H
