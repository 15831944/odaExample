...
#ifndef _IFC4X3_RC4_IFCFEATUREELEMENTADDITION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFEATUREELEMENTADDITION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFeatureElementAddition : public IfcFeatureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFeatureElementAddition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFeatureElementAddition, IfcFeatureElementAddition> object.
*/
typedef OdSmartPtr<IfcFeatureElementAddition> IfcFeatureElementAdditionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFEATUREELEMENTADDITION_AUTO_IMPL_H
