...
#ifndef _IFC4X3_RC4_IFCRELASSIGNSTOGROUPBYFACTOR_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELASSIGNSTOGROUPBYFACTOR_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelAssignsToGroupByFactor : public IfcRelAssignsToGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelAssignsToGroupByFactor);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_Factor;   // IfcRatioMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelAssignsToGroupByFactor, IfcRelAssignsToGroupByFactor> object.
*/
typedef OdSmartPtr<IfcRelAssignsToGroupByFactor> IfcRelAssignsToGroupByFactorPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELASSIGNSTOGROUPBYFACTOR_AUTO_IMPL_H
