...
#ifndef _IFC4X3_RC4_IFCUNITARYEQUIPMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCUNITARYEQUIPMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcUnitaryEquipment : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcUnitaryEquipment);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcUnitaryEquipmentTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcUnitaryEquipment, IfcUnitaryEquipment> object.
*/
typedef OdSmartPtr<IfcUnitaryEquipment> IfcUnitaryEquipmentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCUNITARYEQUIPMENT_AUTO_IMPL_H
