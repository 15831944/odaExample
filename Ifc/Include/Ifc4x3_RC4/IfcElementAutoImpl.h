...
#ifndef _IFC4X3_RC4_IFCELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcElement : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcElement, IfcElement> object.
*/
typedef OdSmartPtr<IfcElement> IfcElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCELEMENT_AUTO_IMPL_H
