...
#ifndef _IFC4X3_RC4_IFCCONTEXT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONTEXT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcContext : public IfcObjectDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcContext);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcContext, IfcContext> object.
*/
typedef OdSmartPtr<IfcContext> IfcContextPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONTEXT_AUTO_IMPL_H
