...
#ifndef _IFC4X3_RC4_IFCALIGNMENTSEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCALIGNMENTSEGMENT_AUTO_IMPL_H

#include "IfcLinearElementAutoImpl.h"
...
class IFC4X3_RC4_EXPORT IfcAlignmentSegment : public IfcLinearElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcAlignmentSegment);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getDesignParameters() const;
  void setDesignParameters(const OdDAIObjectId& DesignParameters);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_DesignParameters;   // IfcAlignmentParameterSegment
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcAlignmentSegment, IfcAlignmentSegment> object.
*/
typedef OdSmartPtr<IfcAlignmentSegment> IfcAlignmentSegmentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCALIGNMENTSEGMENT_AUTO_IMPL_H
