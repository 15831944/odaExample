...
#ifndef _IFC4X3_RC4_IFCCOLOURSPECIFICATION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOLOURSPECIFICATION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcColourSpecification : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcColourSpecification);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcColourSpecification, IfcColourSpecification> object.
*/
typedef OdSmartPtr<IfcColourSpecification> IfcColourSpecificationPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOLOURSPECIFICATION_AUTO_IMPL_H
