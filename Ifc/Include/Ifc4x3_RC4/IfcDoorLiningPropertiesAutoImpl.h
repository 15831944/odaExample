...
#ifndef _IFC4X3_RC4_IFCDOORLININGPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDOORLININGPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDoorLiningProperties : public IfcPreDefinedPropertySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDoorLiningProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDoorLiningProperties, IfcDoorLiningProperties> object.
*/
typedef OdSmartPtr<IfcDoorLiningProperties> IfcDoorLiningPropertiesPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDOORLININGPROPERTIES_AUTO_IMPL_H
