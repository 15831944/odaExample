...
#ifndef _IFC4X3_RC4_IFCRELASSIGNSTOPROCESS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELASSIGNSTOPROCESS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelAssignsToProcess : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelAssignsToProcess);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_RelatingProcess;   // IfcProcessSelect
  OdDAIObjectId m_QuantityInProcess;   // IfcMeasureWithUnit  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelAssignsToProcess, IfcRelAssignsToProcess> object.
*/
typedef OdSmartPtr<IfcRelAssignsToProcess> IfcRelAssignsToProcessPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELASSIGNSTOPROCESS_AUTO_IMPL_H
