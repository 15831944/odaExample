...
#ifndef _IFC4X3_RC4_IFCARBITRARYCLOSEDPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCARBITRARYCLOSEDPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcArbitraryClosedProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcArbitraryClosedProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcArbitraryClosedProfileDef, IfcArbitraryClosedProfileDef> object.
*/
typedef OdSmartPtr<IfcArbitraryClosedProfileDef> IfcArbitraryClosedProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCARBITRARYCLOSEDPROFILEDEF_AUTO_IMPL_H
