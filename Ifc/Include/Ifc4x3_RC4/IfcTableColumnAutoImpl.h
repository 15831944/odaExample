...
#ifndef _IFC4X3_RC4_IFCTABLECOLUMN_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTABLECOLUMN_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTableColumn : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTableColumn);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAIObjectId m_ReferencePath;   // IfcReference  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTableColumn, IfcTableColumn> object.
*/
typedef OdSmartPtr<IfcTableColumn> IfcTableColumnPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTABLECOLUMN_AUTO_IMPL_H
