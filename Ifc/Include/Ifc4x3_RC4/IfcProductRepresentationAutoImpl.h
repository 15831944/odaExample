...
#ifndef _IFC4X3_RC4_IFCPRODUCTREPRESENTATION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPRODUCTREPRESENTATION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcProductRepresentation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcProductRepresentation);
  //DOM-IGNORE-END
...
public:
  ...
  void getRepresentations(OdDAIObjectIds& Representations) const;
  OdDAI::OdDAIObjectIdList& representations();
...
protected:
  ...
  OdDAI::OdDAIObjectIdList m_Representations; // LIST [1:?] of IfcRepresentation
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcProductRepresentation, IfcProductRepresentation> object.
*/
typedef OdSmartPtr<IfcProductRepresentation> IfcProductRepresentationPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPRODUCTREPRESENTATION_AUTO_IMPL_H
