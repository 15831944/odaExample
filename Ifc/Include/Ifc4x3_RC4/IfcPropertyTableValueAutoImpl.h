...
#ifndef _IFC4X3_RC4_IFCPROPERTYTABLEVALUE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROPERTYTABLEVALUE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPropertyTableValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPropertyTableValue);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::List<OdDAI::Select>& definingValues();
  ...
  OdDAI::List<OdDAI::Select>& definedValues();
...
protected:
  // Fields declaration: 
  OdDAI::List<OdDAI::Select> m_DefiningValues; // LIST [1:?] of IfcValue [optional]

  OdDAI::List<OdDAI::Select> m_DefinedValues; // LIST [1:?] of IfcValue [optional]

  OdAnsiString m_Expression;   // IfcText  [optional]
  OdDAI::Select m_DefiningUnit;   // IfcUnit  [optional]
  OdDAI::Select m_DefinedUnit;   // IfcUnit  [optional]
  OdDAI::Enum m_CurveInterpolation;   // IfcCurveInterpolationEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPropertyTableValue, IfcPropertyTableValue> object.
*/
typedef OdSmartPtr<IfcPropertyTableValue> IfcPropertyTableValuePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROPERTYTABLEVALUE_AUTO_IMPL_H
