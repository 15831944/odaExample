...
#ifndef _IFC4X3_RC4_IFCPIPESEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPIPESEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPipeSegment : public IfcFlowSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPipeSegment);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcPipeSegmentTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPipeSegment, IfcPipeSegment> object.
*/
typedef OdSmartPtr<IfcPipeSegment> IfcPipeSegmentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPIPESEGMENT_AUTO_IMPL_H
