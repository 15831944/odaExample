...
#ifndef _IFC4X3_RC4_IFCSUBCONTRACTRESOURCETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSUBCONTRACTRESOURCETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSubContractResourceType : public IfcConstructionResourceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSubContractResourceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcSubContractResourceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcSubContractResourceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSubContractResourceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSubContractResourceType, IfcSubContractResourceType> object.
*/
typedef OdSmartPtr<IfcSubContractResourceType> IfcSubContractResourceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSUBCONTRACTRESOURCETYPE_AUTO_IMPL_H
