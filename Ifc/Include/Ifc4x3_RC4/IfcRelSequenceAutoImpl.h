...
#ifndef _IFC4X3_RC4_IFCRELSEQUENCE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELSEQUENCE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelSequence : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelSequence);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAIObjectId m_RelatedProcess;   // IfcProcess
  OdDAIObjectId m_TimeLag;   // IfcLagTime  [optional]
  OdDAI::Enum m_SequenceType;   // IfcSequenceEnum  [optional]
  OdAnsiString m_UserDefinedSequenceType;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelSequence, IfcRelSequence> object.
*/
typedef OdSmartPtr<IfcRelSequence> IfcRelSequencePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELSEQUENCE_AUTO_IMPL_H
