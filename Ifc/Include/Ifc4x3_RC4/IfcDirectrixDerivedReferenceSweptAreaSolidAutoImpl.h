...
#ifndef _IFC4X3_RC4_IFCDIRECTRIXDERIVEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDIRECTRIXDERIVEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDirectrixDerivedReferenceSweptAreaSolid : public IfcFixedReferenceSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDirectrixDerivedReferenceSweptAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDirectrixDerivedReferenceSweptAreaSolid, IfcDirectrixDerivedReferenceSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcDirectrixDerivedReferenceSweptAreaSolid> IfcDirectrixDerivedReferenceSweptAreaSolidPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDIRECTRIXDERIVEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
