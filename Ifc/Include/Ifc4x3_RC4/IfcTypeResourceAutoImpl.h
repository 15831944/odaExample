...
#ifndef _IFC4X3_RC4_IFCTYPERESOURCE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTYPERESOURCE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTypeResource : public IfcTypeObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTypeResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTypeResource, IfcTypeResource> object.
*/
typedef OdSmartPtr<IfcTypeResource> IfcTypeResourcePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTYPERESOURCE_AUTO_IMPL_H
