...
#ifndef _IFC4X3_RC4_IFCBOILER_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBOILER_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBoiler : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBoiler);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcBoilerTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBoiler, IfcBoiler> object.
*/
typedef OdSmartPtr<IfcBoiler> IfcBoilerPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBOILER_AUTO_IMPL_H
