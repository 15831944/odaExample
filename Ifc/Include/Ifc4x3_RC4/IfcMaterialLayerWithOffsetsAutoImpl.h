...
#ifndef _IFC4X3_RC4_IFCMATERIALLAYERWITHOFFSETS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMATERIALLAYERWITHOFFSETS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMaterialLayerWithOffsets : public IfcMaterialLayer
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMaterialLayerWithOffsets);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMaterialLayerWithOffsets, IfcMaterialLayerWithOffsets> object.
*/
typedef OdSmartPtr<IfcMaterialLayerWithOffsets> IfcMaterialLayerWithOffsetsPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMATERIALLAYERWITHOFFSETS_AUTO_IMPL_H
