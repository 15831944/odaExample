...
#ifndef _IFC4X3_RC4_IFCMATERIALPROFILESETUSAGETAPERING_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMATERIALPROFILESETUSAGETAPERING_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMaterialProfileSetUsageTapering : public IfcMaterialProfileSetUsage
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMaterialProfileSetUsageTapering);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getForProfileEndSet() const;
  void setForProfileEndSet(const OdDAIObjectId& ForProfileEndSet);
  int getCardinalEndPoint() const;
  void setCardinalEndPoint(int CardinalEndPoint);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_ForProfileEndSet;   // IfcMaterialProfileSet
  int m_CardinalEndPoint;   // IfcCardinalPointReference  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMaterialProfileSetUsageTapering, IfcMaterialProfileSetUsageTapering> object.
*/
typedef OdSmartPtr<IfcMaterialProfileSetUsageTapering> IfcMaterialProfileSetUsageTaperingPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMATERIALPROFILESETUSAGETAPERING_AUTO_IMPL_H
