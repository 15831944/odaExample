...
#ifndef _IFC4X3_RC4_IFCREINFORCEDSOIL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCREINFORCEDSOIL_AUTO_IMPL_H

#include "IfcEarthworksElementAutoImpl.h"
...
class IFC4X3_RC4_EXPORT IfcReinforcedSoil : public IfcEarthworksElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcReinforcedSoil);
  //DOM-IGNORE-END
...
public:
  ...
  IfcReinforcedSoilTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcReinforcedSoilTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcReinforcedSoilTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcReinforcedSoil, IfcReinforcedSoil> object.
*/
typedef OdSmartPtr<IfcReinforcedSoil> IfcReinforcedSoilPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCREINFORCEDSOIL_AUTO_IMPL_H
