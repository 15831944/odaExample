...
#ifndef _IFC4X3_RC4_IFCPERMIT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPERMIT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPermit : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPermit);
  //DOM-IGNORE-END
...
public:
  ...
  IfcPermitTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcPermitTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcPermitTypeEnum  [optional]
  OdAnsiString m_Status;   // IfcLabel  [optional]
  OdAnsiString m_LongDescription;   // IfcText  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPermit, IfcPermit> object.
*/
typedef OdSmartPtr<IfcPermit> IfcPermitPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPERMIT_AUTO_IMPL_H
