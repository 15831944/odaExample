...
#ifndef _IFC4X3_RC4_IFCRELREFERENCEDINSPATIALSTRUCTURE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELREFERENCEDINSPATIALSTRUCTURE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelReferencedInSpatialStructure : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelReferencedInSpatialStructure);
  //DOM-IGNORE-END
...
public:
  ...
  void getRelatedElements(OdArray<OdDAI::Select >& RelatedElements) const;
  void getRelatedElementsWrapperArray(OdArray<IfcSpatialReferenceSelect>& RelatedElements) const;
  OdDAI::Set<OdDAI::Select>& relatedElements();
  const OdDAIObjectId& getRelatingStructure() const;
  void setRelatingStructure(const OdDAIObjectId& RelatingStructure);
...
protected:
  // Fields declaration: 
  OdDAI::Set<OdDAI::Select> m_RelatedElements; // SET [1:?] of IfcSpatialReferenceSelect
  OdDAIObjectId m_RelatingStructure;   // IfcSpatialElement
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelReferencedInSpatialStructure, IfcRelReferencedInSpatialStructure> object.
*/
typedef OdSmartPtr<IfcRelReferencedInSpatialStructure> IfcRelReferencedInSpatialStructurePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELREFERENCEDINSPATIALSTRUCTURE_AUTO_IMPL_H
