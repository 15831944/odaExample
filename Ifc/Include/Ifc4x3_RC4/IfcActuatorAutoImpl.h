...
#ifndef _IFC4X3_RC4_IFCACTUATOR_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCACTUATOR_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcActuator : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcActuator);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcActuatorTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcActuator, IfcActuator> object.
*/
typedef OdSmartPtr<IfcActuator> IfcActuatorPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCACTUATOR_AUTO_IMPL_H
