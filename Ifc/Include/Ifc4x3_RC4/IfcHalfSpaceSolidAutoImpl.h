...
#ifndef _IFC4X3_RC4_IFCHALFSPACESOLID_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCHALFSPACESOLID_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcHalfSpaceSolid : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcHalfSpaceSolid);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Boolean m_AgreementFlag;   // IfcBoolean
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcHalfSpaceSolid, IfcHalfSpaceSolid> object.
*/
typedef OdSmartPtr<IfcHalfSpaceSolid> IfcHalfSpaceSolidPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCHALFSPACESOLID_AUTO_IMPL_H
