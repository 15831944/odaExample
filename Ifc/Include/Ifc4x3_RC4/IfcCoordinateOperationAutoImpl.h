...
#ifndef _IFC4X3_RC4_IFCCOORDINATEOPERATION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOORDINATEOPERATION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCoordinateOperation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCoordinateOperation);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_SourceCRS;   // IfcCoordinateReferenceSystemSelect
  OdDAIObjectId m_TargetCRS;   // IfcCoordinateReferenceSystem
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCoordinateOperation, IfcCoordinateOperation> object.
*/
typedef OdSmartPtr<IfcCoordinateOperation> IfcCoordinateOperationPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOORDINATEOPERATION_AUTO_IMPL_H
