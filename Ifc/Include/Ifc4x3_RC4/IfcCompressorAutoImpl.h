...
#ifndef _IFC4X3_RC4_IFCCOMPRESSOR_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOMPRESSOR_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCompressor : public IfcFlowMovingDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCompressor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCompressor, IfcCompressor> object.
*/
typedef OdSmartPtr<IfcCompressor> IfcCompressorPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOMPRESSOR_AUTO_IMPL_H
