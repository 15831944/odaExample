...
#ifndef _IFC4X3_RC4_IFCDISCRETEACCESSORYTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDISCRETEACCESSORYTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDiscreteAccessoryType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDiscreteAccessoryType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDiscreteAccessoryType, IfcDiscreteAccessoryType> object.
*/
typedef OdSmartPtr<IfcDiscreteAccessoryType> IfcDiscreteAccessoryTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDISCRETEACCESSORYTYPE_AUTO_IMPL_H
