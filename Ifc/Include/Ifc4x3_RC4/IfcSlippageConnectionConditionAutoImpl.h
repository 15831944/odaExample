...
#ifndef _IFC4X3_RC4_IFCSLIPPAGECONNECTIONCONDITION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSLIPPAGECONNECTIONCONDITION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSlippageConnectionCondition : public IfcStructuralConnectionCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSlippageConnectionCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSlippageConnectionCondition, IfcSlippageConnectionCondition> object.
*/
typedef OdSmartPtr<IfcSlippageConnectionCondition> IfcSlippageConnectionConditionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSLIPPAGECONNECTIONCONDITION_AUTO_IMPL_H
