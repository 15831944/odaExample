...
#ifndef _IFC4X3_RC4_IFCMATERIALCONSTITUENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMATERIALCONSTITUENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMaterialConstituent : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMaterialConstituent);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAIObjectId getInvToMaterialConstituentSet() const;
...
protected:
  ...
  OdDAIObjectId m_Material;   // IfcMaterial
  IfcNormalisedRatioMeasure m_Fraction;   // IfcNormalisedRatioMeasure  [optional]
  OdAnsiString m_Category;   // IfcLabel  [optional]

  // Declare friend classes for inverse attributes functionality: 
  friend class IfcMaterialConstituentSet;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMaterialConstituent, IfcMaterialConstituent> object.
*/
typedef OdSmartPtr<IfcMaterialConstituent> IfcMaterialConstituentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMATERIALCONSTITUENT_AUTO_IMPL_H
