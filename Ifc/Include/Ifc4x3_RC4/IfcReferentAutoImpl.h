...
#ifndef _IFC4X3_RC4_IFCREFERENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCREFERENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcReferent : public IfcPositioningElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcReferent);
  //DOM-IGNORE-END
...
public:
  ...
  IfcReferentTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcReferentTypeEnum PredefinedType);
  double getRestartDistance() const;
  void setRestartDistance(double RestartDistance);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcReferentTypeEnum  [optional]
  double m_RestartDistance;   // IfcLengthMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcReferent, IfcReferent> object.
*/
typedef OdSmartPtr<IfcReferent> IfcReferentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCREFERENT_AUTO_IMPL_H
