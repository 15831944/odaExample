...
#ifndef _IFC4X3_RC4_IFCOBJECTPLACEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCOBJECTPLACEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcObjectPlacement : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcObjectPlacement);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_PlacementRelTo;   // IfcObjectPlacement  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcObjectPlacement, IfcObjectPlacement> object.
*/
typedef OdSmartPtr<IfcObjectPlacement> IfcObjectPlacementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCOBJECTPLACEMENT_AUTO_IMPL_H
