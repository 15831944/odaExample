...
#ifndef _IFC4X3_RC4_IFCSCHEDULINGTIME_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSCHEDULINGTIME_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSchedulingTime : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSchedulingTime);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Enum m_DataOrigin;   // IfcDataOriginEnum  [optional]
  OdAnsiString m_UserDefinedDataOrigin;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSchedulingTime, IfcSchedulingTime> object.
*/
typedef OdSmartPtr<IfcSchedulingTime> IfcSchedulingTimePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSCHEDULINGTIME_AUTO_IMPL_H
