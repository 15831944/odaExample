...
#ifndef _IFC4X3_RC4_IFCEARTHWORKSELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCEARTHWORKSELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcEarthworksElement : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcEarthworksElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcEarthworksElement, IfcEarthworksElement> object.
*/
typedef OdSmartPtr<IfcEarthworksElement> IfcEarthworksElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCEARTHWORKSELEMENT_AUTO_IMPL_H
