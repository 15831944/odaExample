...
#ifndef _IFC4X3_RC4_IFCCLOTHOID_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCLOTHOID_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcClothoid : public IfcSpiral
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcClothoid);
  //DOM-IGNORE-END
...
public:
  ...
  void setClothoidConstant(double ClothoidConstant);
...
protected:
  // Fields declaration: 
  double m_ClothoidConstant;   // IfcLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcClothoid, IfcClothoid> object.
*/
typedef OdSmartPtr<IfcClothoid> IfcClothoidPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCLOTHOID_AUTO_IMPL_H
