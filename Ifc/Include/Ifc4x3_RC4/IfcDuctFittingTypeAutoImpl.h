...
#ifndef _IFC4X3_RC4_IFCDUCTFITTINGTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDUCTFITTINGTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDuctFittingType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDuctFittingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDuctFittingType, IfcDuctFittingType> object.
*/
typedef OdSmartPtr<IfcDuctFittingType> IfcDuctFittingTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDUCTFITTINGTYPE_AUTO_IMPL_H
