...
#ifndef _IFC4X3_RC4_IFCRESOURCECONSTRAINTRELATIONSHIP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRESOURCECONSTRAINTRELATIONSHIP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcResourceConstraintRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcResourceConstraintRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcResourceConstraintRelationship, IfcResourceConstraintRelationship> object.
*/
typedef OdSmartPtr<IfcResourceConstraintRelationship> IfcResourceConstraintRelationshipPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRESOURCECONSTRAINTRELATIONSHIP_AUTO_IMPL_H
