...
#ifndef _IFC4X3_RC4_IFCTRANSFORMER_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTRANSFORMER_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTransformer : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTransformer);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcTransformerTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTransformer, IfcTransformer> object.
*/
typedef OdSmartPtr<IfcTransformer> IfcTransformerPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTRANSFORMER_AUTO_IMPL_H
