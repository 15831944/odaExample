...
#ifndef _IFC4X3_RC4_IFCEXTERNALSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCEXTERNALSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcExternalSpatialStructureElement : public IfcSpatialElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcExternalSpatialStructureElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcExternalSpatialStructureElement, IfcExternalSpatialStructureElement> object.
*/
typedef OdSmartPtr<IfcExternalSpatialStructureElement> IfcExternalSpatialStructureElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCEXTERNALSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
