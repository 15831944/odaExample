...
#ifndef _IFC4X3_RC4_IFCSTRUCTURALLOADSINGLEDISPLACEMENTDISTORTION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTRUCTURALLOADSINGLEDISPLACEMENTDISTORTION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStructuralLoadSingleDisplacementDistortion : public IfcStructuralLoadSingleDisplacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStructuralLoadSingleDisplacementDistortion);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStructuralLoadSingleDisplacementDistortion, IfcStructuralLoadSingleDisplacementDistortion> object.
*/
typedef OdSmartPtr<IfcStructuralLoadSingleDisplacementDistortion> IfcStructuralLoadSingleDisplacementDistortionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTRUCTURALLOADSINGLEDISPLACEMENTDISTORTION_AUTO_IMPL_H
