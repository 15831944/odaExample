...
#ifndef _IFC4X3_RC4_IFCFACEOUTERBOUND_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFACEOUTERBOUND_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFaceOuterBound : public IfcFaceBound
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFaceOuterBound);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFaceOuterBound, IfcFaceOuterBound> object.
*/
typedef OdSmartPtr<IfcFaceOuterBound> IfcFaceOuterBoundPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFACEOUTERBOUND_AUTO_IMPL_H
