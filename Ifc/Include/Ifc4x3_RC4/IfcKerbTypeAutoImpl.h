...
#ifndef _IFC4X3_RC4_IFCKERBTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCKERBTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcKerbType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcKerbType);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::Boolean getMountable() const;
  void setMountable(OdDAI::Boolean Mountable);
...
protected:
  // Fields declaration: 
  OdDAI::Boolean m_Mountable;   // IfcBoolean
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcKerbType, IfcKerbType> object.
*/
typedef OdSmartPtr<IfcKerbType> IfcKerbTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCKERBTYPE_AUTO_IMPL_H
