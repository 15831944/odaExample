...
#ifndef _IFC4X3_RC4_IFCDAMPER_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDAMPER_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDamper : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDamper);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcDamperTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDamper, IfcDamper> object.
*/
typedef OdSmartPtr<IfcDamper> IfcDamperPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDAMPER_AUTO_IMPL_H
