...
#ifndef _IFC4X3_RC4_IFCCOMMUNICATIONSAPPLIANCETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOMMUNICATIONSAPPLIANCETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCommunicationsApplianceType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCommunicationsApplianceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCommunicationsApplianceType, IfcCommunicationsApplianceType> object.
*/
typedef OdSmartPtr<IfcCommunicationsApplianceType> IfcCommunicationsApplianceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOMMUNICATIONSAPPLIANCETYPE_AUTO_IMPL_H
