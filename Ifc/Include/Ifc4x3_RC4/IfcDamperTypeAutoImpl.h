...
#ifndef _IFC4X3_RC4_IFCDAMPERTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDAMPERTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDamperType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDamperType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDamperType, IfcDamperType> object.
*/
typedef OdSmartPtr<IfcDamperType> IfcDamperTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDAMPERTYPE_AUTO_IMPL_H
