...
#ifndef _IFC4X3_RC4_IFCROOT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCROOT_AUTO_IMPL_H
...
*/
class IFC4X3_RC4_EXPORT IfcRoot : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRoot);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRoot, IfcRoot> object.
*/
typedef OdSmartPtr<IfcRoot> IfcRootPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCROOT_AUTO_IMPL_H
