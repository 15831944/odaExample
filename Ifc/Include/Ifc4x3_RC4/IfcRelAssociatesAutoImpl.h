...
#ifndef _IFC4X3_RC4_IFCRELASSOCIATES_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELASSOCIATES_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelAssociates : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelAssociates);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelAssociates, IfcRelAssociates> object.
*/
typedef OdSmartPtr<IfcRelAssociates> IfcRelAssociatesPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELASSOCIATES_AUTO_IMPL_H
