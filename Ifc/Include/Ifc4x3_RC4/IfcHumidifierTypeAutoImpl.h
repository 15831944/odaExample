...
#ifndef _IFC4X3_RC4_IFCHUMIDIFIERTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCHUMIDIFIERTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcHumidifierType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcHumidifierType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcHumidifierType, IfcHumidifierType> object.
*/
typedef OdSmartPtr<IfcHumidifierType> IfcHumidifierTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCHUMIDIFIERTYPE_AUTO_IMPL_H
