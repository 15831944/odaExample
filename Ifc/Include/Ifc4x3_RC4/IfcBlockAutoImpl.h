...
#ifndef _IFC4X3_RC4_IFCBLOCK_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBLOCK_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBlock : public IfcCsgPrimitive3D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBlock);
  //DOM-IGNORE-END
...
protected:
  ...
  IfcPositiveLengthMeasure m_ZLength;   // IfcPositiveLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBlock, IfcBlock> object.
*/
typedef OdSmartPtr<IfcBlock> IfcBlockPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBLOCK_AUTO_IMPL_H
