...
#ifndef _IFC4X3_RC4_IFCGRADIENTCURVE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCGRADIENTCURVE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcGradientCurve : public IfcCompositeCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcGradientCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcGradientCurve, IfcGradientCurve> object.
*/
typedef OdSmartPtr<IfcGradientCurve> IfcGradientCurvePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCGRADIENTCURVE_AUTO_IMPL_H
