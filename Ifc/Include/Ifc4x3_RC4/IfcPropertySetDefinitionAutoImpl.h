...
#ifndef _IFC4X3_RC4_IFCPROPERTYSETDEFINITION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROPERTYSETDEFINITION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPropertySetDefinition : public IfcPropertyDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPropertySetDefinition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPropertySetDefinition, IfcPropertySetDefinition> object.
*/
typedef OdSmartPtr<IfcPropertySetDefinition> IfcPropertySetDefinitionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROPERTYSETDEFINITION_AUTO_IMPL_H
