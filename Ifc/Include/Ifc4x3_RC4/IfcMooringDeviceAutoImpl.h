...
#ifndef _IFC4X3_RC4_IFCMOORINGDEVICE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMOORINGDEVICE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMooringDevice : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMooringDevice);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcMooringDeviceTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMooringDevice, IfcMooringDevice> object.
*/
typedef OdSmartPtr<IfcMooringDevice> IfcMooringDevicePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMOORINGDEVICE_AUTO_IMPL_H
