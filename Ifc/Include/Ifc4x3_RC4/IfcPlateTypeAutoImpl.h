...
#ifndef _IFC4X3_RC4_IFCPLATETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPLATETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPlateType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPlateType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPlateType, IfcPlateType> object.
*/
typedef OdSmartPtr<IfcPlateType> IfcPlateTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPLATETYPE_AUTO_IMPL_H
