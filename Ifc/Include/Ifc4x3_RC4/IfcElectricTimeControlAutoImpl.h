...
#ifndef _IFC4X3_RC4_IFCELECTRICTIMECONTROL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCELECTRICTIMECONTROL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcElectricTimeControl : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcElectricTimeControl);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcElectricTimeControlTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcElectricTimeControl, IfcElectricTimeControl> object.
*/
typedef OdSmartPtr<IfcElectricTimeControl> IfcElectricTimeControlPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCELECTRICTIMECONTROL_AUTO_IMPL_H
