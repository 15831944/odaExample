...
#ifndef _IFC4X3_RC4_IFCBOUNDARYNODECONDITIONWARPING_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBOUNDARYNODECONDITIONWARPING_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBoundaryNodeConditionWarping : public IfcBoundaryNodeCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBoundaryNodeConditionWarping);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_WarpingStiffness;   // IfcWarpingStiffnessSelect  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBoundaryNodeConditionWarping, IfcBoundaryNodeConditionWarping> object.
*/
typedef OdSmartPtr<IfcBoundaryNodeConditionWarping> IfcBoundaryNodeConditionWarpingPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBOUNDARYNODECONDITIONWARPING_AUTO_IMPL_H
