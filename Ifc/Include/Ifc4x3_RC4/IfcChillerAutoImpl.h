...
#ifndef _IFC4X3_RC4_IFCCHILLER_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCHILLER_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcChiller : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcChiller);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcChillerTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcChiller, IfcChiller> object.
*/
typedef OdSmartPtr<IfcChiller> IfcChillerPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCHILLER_AUTO_IMPL_H
