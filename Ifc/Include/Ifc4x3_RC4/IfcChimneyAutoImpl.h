...
#ifndef _IFC4X3_RC4_IFCCHIMNEY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCHIMNEY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcChimney : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcChimney);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcChimney, IfcChimney> object.
*/
typedef OdSmartPtr<IfcChimney> IfcChimneyPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCHIMNEY_AUTO_IMPL_H
