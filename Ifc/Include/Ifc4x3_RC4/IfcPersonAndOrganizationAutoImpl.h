...
#ifndef _IFC4X3_RC4_IFCPERSONANDORGANIZATION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPERSONANDORGANIZATION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPersonAndOrganization : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPersonAndOrganization);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getThePerson() const;
  void setThePerson(const OdDAIObjectId& ThePerson);
  const OdDAIObjectId& getTheOrganization() const;
  void setTheOrganization(const OdDAIObjectId& TheOrganization);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_ThePerson;   // IfcPerson
  OdDAIObjectId m_TheOrganization;   // IfcOrganization
  OdDAI::OdDAIObjectIdList m_Roles; // LIST [1:?] of IfcActorRole [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPersonAndOrganization, IfcPersonAndOrganization> object.
*/
typedef OdSmartPtr<IfcPersonAndOrganization> IfcPersonAndOrganizationPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPERSONANDORGANIZATION_AUTO_IMPL_H
