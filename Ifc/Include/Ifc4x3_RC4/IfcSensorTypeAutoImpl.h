...
#ifndef _IFC4X3_RC4_IFCSENSORTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSENSORTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSensorType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSensorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSensorType, IfcSensorType> object.
*/
typedef OdSmartPtr<IfcSensorType> IfcSensorTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSENSORTYPE_AUTO_IMPL_H
