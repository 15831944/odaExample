...
#ifndef _IFC4X3_RC4_IFCCURTAINWALL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCURTAINWALL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCurtainWall : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCurtainWall);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCurtainWall, IfcCurtainWall> object.
*/
typedef OdSmartPtr<IfcCurtainWall> IfcCurtainWallPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCURTAINWALL_AUTO_IMPL_H
