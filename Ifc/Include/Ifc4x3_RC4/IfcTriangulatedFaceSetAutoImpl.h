...
#ifndef _IFC4X3_RC4_IFCTRIANGULATEDFACESET_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTRIANGULATEDFACESET_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTriangulatedFaceSet : public IfcTessellatedFaceSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTriangulatedFaceSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTriangulatedFaceSet, IfcTriangulatedFaceSet> object.
*/
typedef OdSmartPtr<IfcTriangulatedFaceSet> IfcTriangulatedFaceSetPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTRIANGULATEDFACESET_AUTO_IMPL_H
