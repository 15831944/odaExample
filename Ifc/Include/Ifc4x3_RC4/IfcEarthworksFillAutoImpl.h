...
#ifndef _IFC4X3_RC4_IFCEARTHWORKSFILL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCEARTHWORKSFILL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcEarthworksFill : public IfcEarthworksElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcEarthworksFill);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcEarthworksFill, IfcEarthworksFill> object.
*/
typedef OdSmartPtr<IfcEarthworksFill> IfcEarthworksFillPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCEARTHWORKSFILL_AUTO_IMPL_H
