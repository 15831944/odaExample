...
#ifndef _IFC4X3_RC4_IFCMONETARYUNIT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMONETARYUNIT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMonetaryUnit : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMonetaryUnit);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getCurrency() const;
  void setCurrency(const OdAnsiString& Currency);
...
protected:
  // Fields declaration: 
  OdAnsiString m_Currency;   // IfcLabel
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMonetaryUnit, IfcMonetaryUnit> object.
*/
typedef OdSmartPtr<IfcMonetaryUnit> IfcMonetaryUnitPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMONETARYUNIT_AUTO_IMPL_H
