...
#ifndef _IFC4X3_RC4_IFCREINFORCINGBARTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCREINFORCINGBARTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcReinforcingBarType : public IfcReinforcingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcReinforcingBarType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcReinforcingBarTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcReinforcingBarTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcReinforcingBarTypeEnum
  ...
  IfcPositiveLengthMeasure m_BarLength;   // IfcPositiveLengthMeasure  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcReinforcingBarType, IfcReinforcingBarType> object.
*/
typedef OdSmartPtr<IfcReinforcingBarType> IfcReinforcingBarTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCREINFORCINGBARTYPE_AUTO_IMPL_H
