...
#ifndef _IFC4X3_RC4_IFCSECTIONEDSURFACE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSECTIONEDSURFACE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSectionedSurface : public IfcSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSectionedSurface);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::OdDAIObjectIdList m_CrossSectionPositions; // LIST [2:?] of IfcAxis2PlacementLinear
  OdDAI::OdDAIObjectIdList m_CrossSections; // LIST [2:?] of IfcProfileDef
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSectionedSurface, IfcSectionedSurface> object.
*/
typedef OdSmartPtr<IfcSectionedSurface> IfcSectionedSurfacePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSECTIONEDSURFACE_AUTO_IMPL_H
