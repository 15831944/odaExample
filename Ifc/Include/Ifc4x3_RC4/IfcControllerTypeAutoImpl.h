...
#ifndef _IFC4X3_RC4_IFCCONTROLLERTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONTROLLERTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcControllerType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcControllerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcControllerType, IfcControllerType> object.
*/
typedef OdSmartPtr<IfcControllerType> IfcControllerTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONTROLLERTYPE_AUTO_IMPL_H
