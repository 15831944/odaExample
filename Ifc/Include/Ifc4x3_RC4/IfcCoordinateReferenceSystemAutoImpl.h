...
#ifndef _IFC4X3_RC4_IFCCOORDINATEREFERENCESYSTEM_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOORDINATEREFERENCESYSTEM_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCoordinateReferenceSystem : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCoordinateReferenceSystem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCoordinateReferenceSystem, IfcCoordinateReferenceSystem> object.
*/
typedef OdSmartPtr<IfcCoordinateReferenceSystem> IfcCoordinateReferenceSystemPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOORDINATEREFERENCESYSTEM_AUTO_IMPL_H
