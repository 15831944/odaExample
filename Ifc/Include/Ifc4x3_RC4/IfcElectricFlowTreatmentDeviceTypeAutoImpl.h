...
#ifndef _IFC4X3_RC4_IFCELECTRICFLOWTREATMENTDEVICETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCELECTRICFLOWTREATMENTDEVICETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcElectricFlowTreatmentDeviceType : public IfcFlowTreatmentDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcElectricFlowTreatmentDeviceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcElectricFlowTreatmentDeviceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcElectricFlowTreatmentDeviceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcElectricFlowTreatmentDeviceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcElectricFlowTreatmentDeviceType, IfcElectricFlowTreatmentDeviceType> object.
*/
typedef OdSmartPtr<IfcElectricFlowTreatmentDeviceType> IfcElectricFlowTreatmentDeviceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCELECTRICFLOWTREATMENTDEVICETYPE_AUTO_IMPL_H
