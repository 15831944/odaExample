...
#ifndef _IFC4X3_RC4_IFCOBJECTDEFINITION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCOBJECTDEFINITION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcObjectDefinition : public IfcRoot
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcObjectDefinition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcObjectDefinition, IfcObjectDefinition> object.
*/
typedef OdSmartPtr<IfcObjectDefinition> IfcObjectDefinitionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCOBJECTDEFINITION_AUTO_IMPL_H
