...
#ifndef _IFC4X3_RC4_IFCRAMP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRAMP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRamp : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRamp);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcRampTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRamp, IfcRamp> object.
*/
typedef OdSmartPtr<IfcRamp> IfcRampPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRAMP_AUTO_IMPL_H
