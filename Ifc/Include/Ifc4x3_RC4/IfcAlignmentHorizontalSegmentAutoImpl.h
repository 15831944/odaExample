...
#ifndef _IFC4X3_RC4_IFCALIGNMENTHORIZONTALSEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCALIGNMENTHORIZONTALSEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcAlignmentHorizontalSegment : public IfcAlignmentParameterSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcAlignmentHorizontalSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcAlignmentHorizontalSegment, IfcAlignmentHorizontalSegment> object.
*/
typedef OdSmartPtr<IfcAlignmentHorizontalSegment> IfcAlignmentHorizontalSegmentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCALIGNMENTHORIZONTALSEGMENT_AUTO_IMPL_H
