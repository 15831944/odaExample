...
#ifndef _IFC4X3_RC4_IFCALIGNMENTVERTICAL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCALIGNMENTVERTICAL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcAlignmentVertical : public IfcLinearElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcAlignmentVertical);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcAlignmentVertical, IfcAlignmentVertical> object.
*/
typedef OdSmartPtr<IfcAlignmentVertical> IfcAlignmentVerticalPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCALIGNMENTVERTICAL_AUTO_IMPL_H
