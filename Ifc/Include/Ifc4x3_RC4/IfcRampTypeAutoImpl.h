...
#ifndef _IFC4X3_RC4_IFCRAMPTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRAMPTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRampType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRampType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcRampTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcRampTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcRampTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRampType, IfcRampType> object.
*/
typedef OdSmartPtr<IfcRampType> IfcRampTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRAMPTYPE_AUTO_IMPL_H
