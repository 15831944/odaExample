...
#ifndef _IFC4X3_RC4_IFCDUCTFITTING_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDUCTFITTING_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDuctFitting : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDuctFitting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDuctFitting, IfcDuctFitting> object.
*/
typedef OdSmartPtr<IfcDuctFitting> IfcDuctFittingPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDUCTFITTING_AUTO_IMPL_H
