...
#ifndef _IFC4X3_RC4_IFCELECTRICGENERATOR_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCELECTRICGENERATOR_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcElectricGenerator : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcElectricGenerator);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcElectricGeneratorTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcElectricGenerator, IfcElectricGenerator> object.
*/
typedef OdSmartPtr<IfcElectricGenerator> IfcElectricGeneratorPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCELECTRICGENERATOR_AUTO_IMPL_H
