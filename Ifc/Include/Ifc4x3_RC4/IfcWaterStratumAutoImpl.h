...
#ifndef _IFC4X3_RC4_IFCWATERSTRATUM_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCWATERSTRATUM_AUTO_IMPL_H

#include "IfcGeotechnicalStratumAutoImpl.h"
...
class IFC4X3_RC4_EXPORT IfcWaterStratum : public IfcGeotechnicalStratum
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcWaterStratum);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcWaterStratum, IfcWaterStratum> object.
*/
typedef OdSmartPtr<IfcWaterStratum> IfcWaterStratumPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCWATERSTRATUM_AUTO_IMPL_H
