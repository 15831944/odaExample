...
#ifndef _IFC4X3_RC4_IFCTRIMMEDCURVE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTRIMMEDCURVE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTrimmedCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTrimmedCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTrimmedCurve, IfcTrimmedCurve> object.
*/
typedef OdSmartPtr<IfcTrimmedCurve> IfcTrimmedCurvePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTRIMMEDCURVE_AUTO_IMPL_H
