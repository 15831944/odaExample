...
#ifndef _IFC4X3_RC4_IFCINDEXEDCOLOURMAP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCINDEXEDCOLOURMAP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcIndexedColourMap : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcIndexedColourMap);
  //DOM-IGNORE-END
...
protected:
  ...
  IfcNormalisedRatioMeasure m_Opacity;   // IfcNormalisedRatioMeasure  [optional]
  OdDAIObjectId m_Colours;   // IfcColourRgbList
  OdDAI::IntList m_ColourIndex; // LIST [1:?] of IfcPositiveInteger
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcIndexedColourMap, IfcIndexedColourMap> object.
*/
typedef OdSmartPtr<IfcIndexedColourMap> IfcIndexedColourMapPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCINDEXEDCOLOURMAP_AUTO_IMPL_H
