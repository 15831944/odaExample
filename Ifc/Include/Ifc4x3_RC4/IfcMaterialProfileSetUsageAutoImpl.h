...
#ifndef _IFC4X3_RC4_IFCMATERIALPROFILESETUSAGE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMATERIALPROFILESETUSAGE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMaterialProfileSetUsage : public IfcMaterialUsageDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMaterialProfileSetUsage);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMaterialProfileSetUsage, IfcMaterialProfileSetUsage> object.
*/
typedef OdSmartPtr<IfcMaterialProfileSetUsage> IfcMaterialProfileSetUsagePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMATERIALPROFILESETUSAGE_AUTO_IMPL_H
