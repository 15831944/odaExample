...
#ifndef _IFC4X3_RC4_IFCCONSTRAINT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONSTRAINT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcConstraint : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcConstraint);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Enum m_ConstraintGrade;   // IfcConstraintEnum
  OdAnsiString m_ConstraintSource;   // IfcLabel  [optional]
  OdDAI::Select m_CreatingActor;   // IfcActorSelect  [optional]
  OdAnsiString m_CreationTime;   // IfcDateTime  [optional]
  OdAnsiString m_UserDefinedGrade;   // IfcLabel  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcConstraint, IfcConstraint> object.
*/
typedef OdSmartPtr<IfcConstraint> IfcConstraintPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONSTRAINT_AUTO_IMPL_H
