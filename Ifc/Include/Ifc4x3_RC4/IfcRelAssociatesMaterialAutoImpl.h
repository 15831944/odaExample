...
#ifndef _IFC4X3_RC4_IFCRELASSOCIATESMATERIAL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELASSOCIATESMATERIAL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelAssociatesMaterial : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelAssociatesMaterial);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelAssociatesMaterial, IfcRelAssociatesMaterial> object.
*/
typedef OdSmartPtr<IfcRelAssociatesMaterial> IfcRelAssociatesMaterialPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELASSOCIATESMATERIAL_AUTO_IMPL_H
