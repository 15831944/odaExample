...
#ifndef _IFC4X3_RC4_IFCTIMESERIES_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTIMESERIES_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTimeSeries : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTimeSeries);
  //DOM-IGNORE-END
...
protected:
  ...
  OdAnsiString m_StartTime;   // IfcDateTime
  OdAnsiString m_EndTime;   // IfcDateTime
  OdDAI::Enum m_TimeSeriesDataType;   // IfcTimeSeriesDataTypeEnum
  OdDAI::Enum m_DataOrigin;   // IfcDataOriginEnum
  OdAnsiString m_UserDefinedDataOrigin;   // IfcLabel  [optional]
  OdDAI::Select m_Unit;   // IfcUnit  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTimeSeries, IfcTimeSeries> object.
*/
typedef OdSmartPtr<IfcTimeSeries> IfcTimeSeriesPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTIMESERIES_AUTO_IMPL_H
