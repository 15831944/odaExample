...
#ifndef _IFC4X3_RC4_IFCBUILDINGELEMENTPROXY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBUILDINGELEMENTPROXY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBuildingElementProxy : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBuildingElementProxy);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBuildingElementProxy, IfcBuildingElementProxy> object.
*/
typedef OdSmartPtr<IfcBuildingElementProxy> IfcBuildingElementProxyPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBUILDINGELEMENTPROXY_AUTO_IMPL_H
