...
#ifndef _IFC4X3_RC4_IFCFLOWTERMINAL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFLOWTERMINAL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFlowTerminal : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFlowTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFlowTerminal, IfcFlowTerminal> object.
*/
typedef OdSmartPtr<IfcFlowTerminal> IfcFlowTerminalPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFLOWTERMINAL_AUTO_IMPL_H
