...
#ifndef _IFC4X3_RC4_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelServicesBuildings : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelServicesBuildings);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::OdDAIObjectIdSet m_RelatedBuildings; // SET [1:?] of IfcSpatialElement
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelServicesBuildings, IfcRelServicesBuildings> object.
*/
typedef OdSmartPtr<IfcRelServicesBuildings> IfcRelServicesBuildingsPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
