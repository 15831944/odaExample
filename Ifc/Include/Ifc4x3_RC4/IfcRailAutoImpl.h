...
#ifndef _IFC4X3_RC4_IFCRAIL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRAIL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRail : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRail);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcRailTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRail, IfcRail> object.
*/
typedef OdSmartPtr<IfcRail> IfcRailPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRAIL_AUTO_IMPL_H
