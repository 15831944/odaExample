...
#ifndef _IFC4X3_RC4_IFCEVAPORATOR_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCEVAPORATOR_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcEvaporator : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcEvaporator);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcEvaporatorTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcEvaporator, IfcEvaporator> object.
*/
typedef OdSmartPtr<IfcEvaporator> IfcEvaporatorPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCEVAPORATOR_AUTO_IMPL_H
