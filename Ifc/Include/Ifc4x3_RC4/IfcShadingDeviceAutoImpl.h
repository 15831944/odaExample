...
#ifndef _IFC4X3_RC4_IFCSHADINGDEVICE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSHADINGDEVICE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcShadingDevice : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcShadingDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcShadingDevice, IfcShadingDevice> object.
*/
typedef OdSmartPtr<IfcShadingDevice> IfcShadingDevicePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSHADINGDEVICE_AUTO_IMPL_H
