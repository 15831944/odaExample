...
#ifndef _IFC4X3_RC4_IFCHEATEXCHANGER_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCHEATEXCHANGER_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcHeatExchanger : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcHeatExchanger);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcHeatExchangerTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcHeatExchanger, IfcHeatExchanger> object.
*/
typedef OdSmartPtr<IfcHeatExchanger> IfcHeatExchangerPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCHEATEXCHANGER_AUTO_IMPL_H
