...
#ifndef _IFC4X3_RC4_IFCMATERIALLIST_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMATERIALLIST_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMaterialList : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMaterialList);
  //DOM-IGNORE-END
...
public:
  ...
  void getMaterials(OdDAIObjectIds& Materials) const;
  OdDAI::OdDAIObjectIdList& materials();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_Materials; // LIST [1:?] of IfcMaterial
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMaterialList, IfcMaterialList> object.
*/
typedef OdSmartPtr<IfcMaterialList> IfcMaterialListPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMATERIALLIST_AUTO_IMPL_H
