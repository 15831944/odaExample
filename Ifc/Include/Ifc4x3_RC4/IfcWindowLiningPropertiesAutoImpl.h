...
#ifndef _IFC4X3_RC4_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcWindowLiningProperties : public IfcPreDefinedPropertySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcWindowLiningProperties);
  //DOM-IGNORE-END
...
protected:
  ...
  IfcNonNegativeLengthMeasure m_MullionThickness;   // IfcNonNegativeLengthMeasure  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcWindowLiningProperties, IfcWindowLiningProperties> object.
*/
typedef OdSmartPtr<IfcWindowLiningProperties> IfcWindowLiningPropertiesPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
