...
#ifndef _IFC4X3_RC4_IFCCOSTITEM_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOSTITEM_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCostItem : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCostItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCostItem, IfcCostItem> object.
*/
typedef OdSmartPtr<IfcCostItem> IfcCostItemPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOSTITEM_AUTO_IMPL_H
