...
#ifndef _IFC4X3_RC4_IFCRELINTERFERESELEMENTS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELINTERFERESELEMENTS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelInterferesElements : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelInterferesElements);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getInterferenceSpace() const;
  void setInterferenceSpace(const OdDAIObjectId& InterferenceSpace);
...
protected:
  // Fields declaration: 
  OdDAI::Select m_RelatingElement;   // IfcInterferenceSelect
  OdDAI::Select m_RelatedElement;   // IfcInterferenceSelect
  OdDAIObjectId m_InterferenceGeometry;   // IfcConnectionGeometry  [optional]
  OdDAIObjectId m_InterferenceSpace;   // IfcSpatialZone  [optional]
  OdAnsiString m_InterferenceType;   // IfcIdentifier  [optional]
  OdDAI::Logical m_ImpliedOrder;   // IfcLogical
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelInterferesElements, IfcRelInterferesElements> object.
*/
typedef OdSmartPtr<IfcRelInterferesElements> IfcRelInterferesElementsPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELINTERFERESELEMENTS_AUTO_IMPL_H
