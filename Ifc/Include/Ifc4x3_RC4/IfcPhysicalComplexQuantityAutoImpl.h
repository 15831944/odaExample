...
#ifndef _IFC4X3_RC4_IFCPHYSICALCOMPLEXQUANTITY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPHYSICALCOMPLEXQUANTITY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPhysicalComplexQuantity : public IfcPhysicalQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPhysicalComplexQuantity);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPhysicalComplexQuantity, IfcPhysicalComplexQuantity> object.
*/
typedef OdSmartPtr<IfcPhysicalComplexQuantity> IfcPhysicalComplexQuantityPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPHYSICALCOMPLEXQUANTITY_AUTO_IMPL_H
