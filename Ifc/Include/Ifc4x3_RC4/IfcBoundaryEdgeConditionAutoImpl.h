...
#ifndef _IFC4X3_RC4_IFCBOUNDARYEDGECONDITION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBOUNDARYEDGECONDITION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBoundaryEdgeCondition : public IfcBoundaryCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBoundaryEdgeCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBoundaryEdgeCondition, IfcBoundaryEdgeCondition> object.
*/
typedef OdSmartPtr<IfcBoundaryEdgeCondition> IfcBoundaryEdgeConditionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBOUNDARYEDGECONDITION_AUTO_IMPL_H
