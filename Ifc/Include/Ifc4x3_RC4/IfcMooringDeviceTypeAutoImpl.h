...
#ifndef _IFC4X3_RC4_IFCMOORINGDEVICETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMOORINGDEVICETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMooringDeviceType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMooringDeviceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcMooringDeviceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcMooringDeviceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcMooringDeviceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMooringDeviceType, IfcMooringDeviceType> object.
*/
typedef OdSmartPtr<IfcMooringDeviceType> IfcMooringDeviceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMOORINGDEVICETYPE_AUTO_IMPL_H
