...
#ifndef _IFC4X3_RC4_IFCNAMEDUNIT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCNAMEDUNIT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcNamedUnit : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcNamedUnit);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Dimensions;   // IfcDimensionalExponents
  OdDAI::Enum m_UnitType;   // IfcUnitEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcNamedUnit, IfcNamedUnit> object.
*/
typedef OdSmartPtr<IfcNamedUnit> IfcNamedUnitPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCNAMEDUNIT_AUTO_IMPL_H
