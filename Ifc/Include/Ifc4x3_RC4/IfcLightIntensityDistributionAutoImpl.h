...
#ifndef _IFC4X3_RC4_IFCLIGHTINTENSITYDISTRIBUTION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCLIGHTINTENSITYDISTRIBUTION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcLightIntensityDistribution : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcLightIntensityDistribution);
  //DOM-IGNORE-END
...
public:
  ...
  IfcLightDistributionCurveEnum getLightDistributionCurve() const;
  void setLightDistributionCurve(IfcLightDistributionCurveEnum LightDistributionCurve);
  void getDistributionData(OdDAIObjectIds& DistributionData) const;
  OdDAI::OdDAIObjectIdList& distributionData();
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_LightDistributionCurve;   // IfcLightDistributionCurveEnum
  OdDAI::OdDAIObjectIdList m_DistributionData; // LIST [1:?] of IfcLightDistributionData
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcLightIntensityDistribution, IfcLightIntensityDistribution> object.
*/
typedef OdSmartPtr<IfcLightIntensityDistribution> IfcLightIntensityDistributionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCLIGHTINTENSITYDISTRIBUTION_AUTO_IMPL_H
