...
#ifndef _IFC4X3_RC4_IFCGEOSLICE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCGEOSLICE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcGeoslice : public IfcGeotechnicalAssembly
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcGeoslice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcGeoslice, IfcGeoslice> object.
*/
typedef OdSmartPtr<IfcGeoslice> IfcGeoslicePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCGEOSLICE_AUTO_IMPL_H
