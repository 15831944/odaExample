...
#ifndef _IFC4X3_RC4_IFCPROJECTLIBRARY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROJECTLIBRARY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcProjectLibrary : public IfcContext
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcProjectLibrary);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcProjectLibrary, IfcProjectLibrary> object.
*/
typedef OdSmartPtr<IfcProjectLibrary> IfcProjectLibraryPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROJECTLIBRARY_AUTO_IMPL_H
