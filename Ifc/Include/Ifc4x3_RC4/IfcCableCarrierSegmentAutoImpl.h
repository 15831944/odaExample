...
#ifndef _IFC4X3_RC4_IFCCABLECARRIERSEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCABLECARRIERSEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCableCarrierSegment : public IfcFlowSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCableCarrierSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCableCarrierSegment, IfcCableCarrierSegment> object.
*/
typedef OdSmartPtr<IfcCableCarrierSegment> IfcCableCarrierSegmentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCABLECARRIERSEGMENT_AUTO_IMPL_H
