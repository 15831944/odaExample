...
#ifndef _IFC4X3_RC4_IFCTRACKELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTRACKELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTrackElement : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTrackElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTrackElement, IfcTrackElement> object.
*/
typedef OdSmartPtr<IfcTrackElement> IfcTrackElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTRACKELEMENT_AUTO_IMPL_H
