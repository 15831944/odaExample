...
#ifndef _IFC4X3_RC4_IFCDOORTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDOORTYPE_AUTO_IMPL_H

#include "IfcBuiltElementTypeAutoImpl.h"
...
class IFC4X3_RC4_EXPORT IfcDoorType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDoorType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcDoorTypeEnum
  OdDAI::Enum m_OperationType;   // IfcDoorTypeOperationEnum
  OdDAI::Boolean m_ParameterTakesPrecedence;   // IfcBoolean  [optional]
  OdAnsiString m_UserDefinedOperationType;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDoorType, IfcDoorType> object.
*/
typedef OdSmartPtr<IfcDoorType> IfcDoorTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDOORTYPE_AUTO_IMPL_H
