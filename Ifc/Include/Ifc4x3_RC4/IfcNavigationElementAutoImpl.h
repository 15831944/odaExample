...
#ifndef _IFC4X3_RC4_IFCNAVIGATIONELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCNAVIGATIONELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcNavigationElement : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcNavigationElement);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcNavigationElementTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcNavigationElement, IfcNavigationElement> object.
*/
typedef OdSmartPtr<IfcNavigationElement> IfcNavigationElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCNAVIGATIONELEMENT_AUTO_IMPL_H
