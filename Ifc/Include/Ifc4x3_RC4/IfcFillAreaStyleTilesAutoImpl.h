...
#ifndef _IFC4X3_RC4_IFCFILLAREASTYLETILES_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFILLAREASTYLETILES_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFillAreaStyleTiles : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFillAreaStyleTiles);
  //DOM-IGNORE-END
...
public:
  ...
  void getTilingPattern(OdDAIObjectIds& TilingPattern) const;
  OdDAI::OdDAIObjectIdList& tilingPattern();
  void getTiles(OdDAIObjectIds& Tiles) const;
  OdDAI::OdDAIObjectIdSet& tiles();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_TilingPattern; // LIST [2:2] of IfcVector
  OdDAI::OdDAIObjectIdSet m_Tiles; // SET [1:?] of IfcStyledItem
  IfcPositiveRatioMeasure m_TilingScale;   // IfcPositiveRatioMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFillAreaStyleTiles, IfcFillAreaStyleTiles> object.
*/
typedef OdSmartPtr<IfcFillAreaStyleTiles> IfcFillAreaStyleTilesPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFILLAREASTYLETILES_AUTO_IMPL_H
