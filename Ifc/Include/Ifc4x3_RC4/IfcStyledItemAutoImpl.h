...
#ifndef _IFC4X3_RC4_IFCSTYLEDITEM_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTYLEDITEM_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStyledItem : public IfcRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStyledItem);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::OdDAIObjectIdSet m_Styles; // SET [1:?] of IfcPresentationStyle
  OdAnsiString m_Name;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStyledItem, IfcStyledItem> object.
*/
typedef OdSmartPtr<IfcStyledItem> IfcStyledItemPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTYLEDITEM_AUTO_IMPL_H
