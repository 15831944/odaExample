...
#ifndef _IFC4X3_RC4_IFCIMPACTPROTECTIONDEVICETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCIMPACTPROTECTIONDEVICETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcImpactProtectionDeviceType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcImpactProtectionDeviceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcImpactProtectionDeviceTypeSelect predefinedType();
...
protected:
  // Fields declaration: 
  OdDAI::Select m_PredefinedType;   // IfcImpactProtectionDeviceTypeSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcImpactProtectionDeviceType, IfcImpactProtectionDeviceType> object.
*/
typedef OdSmartPtr<IfcImpactProtectionDeviceType> IfcImpactProtectionDeviceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCIMPACTPROTECTIONDEVICETYPE_AUTO_IMPL_H
