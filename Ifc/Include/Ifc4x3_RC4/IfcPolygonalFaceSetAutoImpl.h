...
#ifndef _IFC4X3_RC4_IFCPOLYGONALFACESET_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPOLYGONALFACESET_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPolygonalFaceSet : public IfcTessellatedFaceSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPolygonalFaceSet);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& faces();
  void getPnIndex(OdArray<int >& PnIndex) const;
  OdDAI::IntList& pnIndex();
...
protected:
  ...
  OdDAI::OdDAIObjectIdList m_Faces; // LIST [1:?] of IfcIndexedPolygonalFace
  OdDAI::IntList m_PnIndex; // LIST [1:?] of IfcPositiveInteger [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPolygonalFaceSet, IfcPolygonalFaceSet> object.
*/
typedef OdSmartPtr<IfcPolygonalFaceSet> IfcPolygonalFaceSetPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPOLYGONALFACESET_AUTO_IMPL_H
