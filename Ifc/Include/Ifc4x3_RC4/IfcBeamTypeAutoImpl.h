...
#ifndef _IFC4X3_RC4_IFCBEAMTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBEAMTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBeamType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBeamType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBeamType, IfcBeamType> object.
*/
typedef OdSmartPtr<IfcBeamType> IfcBeamTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBEAMTYPE_AUTO_IMPL_H
