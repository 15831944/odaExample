...
#ifndef _IFC4X3_RC4_IFCVIRTUALGRIDINTERSECTION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCVIRTUALGRIDINTERSECTION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcVirtualGridIntersection : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcVirtualGridIntersection);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& intersectingAxes();
  void getOffsetDistances(OdArray<double >& OffsetDistances) const;
  OdDAI::DoubleList& offsetDistances();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_IntersectingAxes; // LIST [2:2] of IfcGridAxis
  OdDAI::DoubleList m_OffsetDistances; // LIST [2:3] of IfcLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcVirtualGridIntersection, IfcVirtualGridIntersection> object.
*/
typedef OdSmartPtr<IfcVirtualGridIntersection> IfcVirtualGridIntersectionPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCVIRTUALGRIDINTERSECTION_AUTO_IMPL_H
