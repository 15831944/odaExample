...
#ifndef _IFC4X3_RC4_IFCCOMPOSITECURVE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOMPOSITECURVE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCompositeCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCompositeCurve);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_Segments; // LIST [1:?] of IfcSegment
  OdDAI::Logical m_SelfIntersect;   // IfcLogical
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCompositeCurve, IfcCompositeCurve> object.
*/
typedef OdSmartPtr<IfcCompositeCurve> IfcCompositeCurvePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOMPOSITECURVE_AUTO_IMPL_H
