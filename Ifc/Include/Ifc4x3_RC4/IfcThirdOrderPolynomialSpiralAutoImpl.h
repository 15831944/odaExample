...
#ifndef _IFC4X3_RC4_IFCTHIRDORDERPOLYNOMIALSPIRAL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTHIRDORDERPOLYNOMIALSPIRAL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcThirdOrderPolynomialSpiral : public IfcSpiral
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcThirdOrderPolynomialSpiral);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcThirdOrderPolynomialSpiral, IfcThirdOrderPolynomialSpiral> object.
*/
typedef OdSmartPtr<IfcThirdOrderPolynomialSpiral> IfcThirdOrderPolynomialSpiralPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTHIRDORDERPOLYNOMIALSPIRAL_AUTO_IMPL_H
