...
#ifndef _IFC4X3_RC4_IFCCOMPLEXPROPERTYTEMPLATE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOMPLEXPROPERTYTEMPLATE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcComplexPropertyTemplate : public IfcPropertyTemplate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcComplexPropertyTemplate);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getUsageName() const;
  void setUsageName(const OdAnsiString& UsageName);
  IfcComplexPropertyTemplateTypeEnum getTemplateType() const;
  void setTemplateType(IfcComplexPropertyTemplateTypeEnum TemplateType);
  void getHasPropertyTemplates(OdDAIObjectIds& HasPropertyTemplates) const;
  OdDAI::OdDAIObjectIdSet& hasPropertyTemplates();
...
protected:
  // Fields declaration: 
  OdAnsiString m_UsageName;   // IfcLabel  [optional]
  OdDAI::Enum m_TemplateType;   // IfcComplexPropertyTemplateTypeEnum  [optional]
  OdDAI::OdDAIObjectIdSet m_HasPropertyTemplates; // SET [1:?] of IfcPropertyTemplate [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcComplexPropertyTemplate, IfcComplexPropertyTemplate> object.
*/
typedef OdSmartPtr<IfcComplexPropertyTemplate> IfcComplexPropertyTemplatePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOMPLEXPROPERTYTEMPLATE_AUTO_IMPL_H
