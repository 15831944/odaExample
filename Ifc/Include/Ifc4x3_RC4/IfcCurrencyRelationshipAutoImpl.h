...
#ifndef _IFC4X3_RC4_IFCCURRENCYRELATIONSHIP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCURRENCYRELATIONSHIP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCurrencyRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCurrencyRelationship);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatingMonetaryUnit;   // IfcMonetaryUnit
  OdDAIObjectId m_RelatedMonetaryUnit;   // IfcMonetaryUnit
  IfcPositiveRatioMeasure m_ExchangeRate;   // IfcPositiveRatioMeasure
  OdAnsiString m_RateDateTime;   // IfcDateTime  [optional]
  OdDAIObjectId m_RateSource;   // IfcLibraryInformation  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCurrencyRelationship, IfcCurrencyRelationship> object.
*/
typedef OdSmartPtr<IfcCurrencyRelationship> IfcCurrencyRelationshipPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCURRENCYRELATIONSHIP_AUTO_IMPL_H
