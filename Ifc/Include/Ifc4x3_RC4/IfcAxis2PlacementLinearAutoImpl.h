...
#ifndef _IFC4X3_RC4_IFCAXIS2PLACEMENTLINEAR_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCAXIS2PLACEMENTLINEAR_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcAxis2PlacementLinear : public IfcPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcAxis2PlacementLinear);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRefDirection() const;
  void setRefDirection(const OdDAIObjectId& RefDirection);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Axis;   // IfcDirection  [optional]
  OdDAIObjectId m_RefDirection;   // IfcDirection  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcAxis2PlacementLinear, IfcAxis2PlacementLinear> object.
*/
typedef OdSmartPtr<IfcAxis2PlacementLinear> IfcAxis2PlacementLinearPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCAXIS2PLACEMENTLINEAR_AUTO_IMPL_H
