...
#ifndef _IFC4X3_RC4_IFCDIRECTRIXCURVESWEPTAREASOLID_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDIRECTRIXCURVESWEPTAREASOLID_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDirectrixCurveSweptAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDirectrixCurveSweptAreaSolid);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Select m_StartParam;   // IfcCurveMeasureSelect  [optional]
  OdDAI::Select m_EndParam;   // IfcCurveMeasureSelect  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDirectrixCurveSweptAreaSolid, IfcDirectrixCurveSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcDirectrixCurveSweptAreaSolid> IfcDirectrixCurveSweptAreaSolidPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDIRECTRIXCURVESWEPTAREASOLID_AUTO_IMPL_H
