...
#ifndef _IFC4X3_RC4_IFCCURVESEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCURVESEGMENT_AUTO_IMPL_H

#include "IfcSegmentAutoImpl.h"
...
/** \details
  This class represents a type of segment positioned along a curve cutting a segment from the parent curve. 
  The positioning curve (StartPlacement.PlacementMeasuredAlong) does not necessarily correspond with the ParentCurve.
*/
class IFC4X3_RC4_EXPORT IfcCurveSegment : public IfcSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCurveSegment);
  //DOM-IGNORE-END
...
public:
  ...
  /** \details
  Returns the value of SegmentLength attribute. SegmentLength is the length of segment measured as length or parameter value based on StartPlacement.
  \returns
  Returns the value of SegmentLength.
  */
  IfcCurveMeasureSelect segmentLength();

  /** \details
  Returns the value of ParentCurve attribute. ParentCurve is the curve to be used as base for the segment definition.
  \returns
  Returns the value of ParentCurve.
  */
  const OdDAIObjectId& getParentCurve() const;

  /** \details
  Sets the value of ParentCurve attribute. ParentCurve is the curve to be used as base for the segment definition.
  \param ParentCurve [in] ParentCurve to set.
  */
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Placement;   // IfcPlacement
  OdDAI::Select m_SegmentStart;   // IfcCurveMeasureSelect
  OdDAI::Select m_SegmentLength;   // IfcCurveMeasureSelect
  OdDAIObjectId m_ParentCurve;   // IfcCurve
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCurveSegment, IfcCurveSegment> object.
*/
typedef OdSmartPtr<IfcCurveSegment> IfcCurveSegmentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCURVESEGMENT_AUTO_IMPL_H
