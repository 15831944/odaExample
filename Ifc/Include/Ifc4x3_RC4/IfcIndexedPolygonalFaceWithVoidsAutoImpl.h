...
#ifndef _IFC4X3_RC4_IFCINDEXEDPOLYGONALFACEWITHVOIDS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCINDEXEDPOLYGONALFACEWITHVOIDS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcIndexedPolygonalFaceWithVoids : public IfcIndexedPolygonalFace
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcIndexedPolygonalFaceWithVoids);
  //DOM-IGNORE-END
...
public:
  ...
  void getInnerCoordIndices(OdArray<OdArray<int > >& InnerCoordIndices) const;
  OdDAI::List<OdDAI::Aggr*>& innerCoordIndices();
...
protected:
  // Fields declaration: 
  OdDAI::List<OdDAI::Aggr*> m_InnerCoordIndices; // LIST [1:?] of LIST [3:?] of IfcPositiveInteger
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcIndexedPolygonalFaceWithVoids, IfcIndexedPolygonalFaceWithVoids> object.
*/
typedef OdSmartPtr<IfcIndexedPolygonalFaceWithVoids> IfcIndexedPolygonalFaceWithVoidsPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCINDEXEDPOLYGONALFACEWITHVOIDS_AUTO_IMPL_H
