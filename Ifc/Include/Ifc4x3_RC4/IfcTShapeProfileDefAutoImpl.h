...
#ifndef _IFC4X3_RC4_IFCTSHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTSHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTShapeProfileDef);
  //DOM-IGNORE-END
...
protected:
  ...
  IfcNonNegativeLengthMeasure m_FlangeEdgeRadius;   // IfcNonNegativeLengthMeasure  [optional]
  IfcNonNegativeLengthMeasure m_WebEdgeRadius;   // IfcNonNegativeLengthMeasure  [optional]
  double m_WebSlope;   // IfcPlaneAngleMeasure  [optional]
  double m_FlangeSlope;   // IfcPlaneAngleMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTShapeProfileDef, IfcTShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcTShapeProfileDef> IfcTShapeProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTSHAPEPROFILEDEF_AUTO_IMPL_H
