...
#ifndef _IFC4X3_RC4_IFCSYSTEMFURNITUREELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSYSTEMFURNITUREELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSystemFurnitureElementType : public IfcFurnishingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSystemFurnitureElementType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcSystemFurnitureElementTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcSystemFurnitureElementTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSystemFurnitureElementTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSystemFurnitureElementType, IfcSystemFurnitureElementType> object.
*/
typedef OdSmartPtr<IfcSystemFurnitureElementType> IfcSystemFurnitureElementTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSYSTEMFURNITUREELEMENTTYPE_AUTO_IMPL_H
