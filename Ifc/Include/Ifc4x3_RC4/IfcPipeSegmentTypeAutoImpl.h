...
#ifndef _IFC4X3_RC4_IFCPIPESEGMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPIPESEGMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPipeSegmentType : public IfcFlowSegmentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPipeSegmentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPipeSegmentType, IfcPipeSegmentType> object.
*/
typedef OdSmartPtr<IfcPipeSegmentType> IfcPipeSegmentTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPIPESEGMENTTYPE_AUTO_IMPL_H
