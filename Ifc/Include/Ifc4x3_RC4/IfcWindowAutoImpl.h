...
#ifndef _IFC4X3_RC4_IFCWINDOW_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCWINDOW_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcWindow : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcWindow);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcWindow, IfcWindow> object.
*/
typedef OdSmartPtr<IfcWindow> IfcWindowPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCWINDOW_AUTO_IMPL_H
