...
#ifndef _IFC4X3_RC4_IFCOUTLET_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCOUTLET_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcOutlet : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcOutlet);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcOutletTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcOutlet, IfcOutlet> object.
*/
typedef OdSmartPtr<IfcOutlet> IfcOutletPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCOUTLET_AUTO_IMPL_H
