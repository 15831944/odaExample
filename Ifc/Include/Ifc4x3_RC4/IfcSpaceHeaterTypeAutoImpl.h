...
#ifndef _IFC4X3_RC4_IFCSPACEHEATERTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSPACEHEATERTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSpaceHeaterType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSpaceHeaterType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSpaceHeaterType, IfcSpaceHeaterType> object.
*/
typedef OdSmartPtr<IfcSpaceHeaterType> IfcSpaceHeaterTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSPACEHEATERTYPE_AUTO_IMPL_H
