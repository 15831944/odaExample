...
#ifndef _IFC4X3_RC4_IFCRELASSOCIATESDOCUMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELASSOCIATESDOCUMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelAssociatesDocument : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelAssociatesDocument);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelAssociatesDocument, IfcRelAssociatesDocument> object.
*/
typedef OdSmartPtr<IfcRelAssociatesDocument> IfcRelAssociatesDocumentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELASSOCIATESDOCUMENT_AUTO_IMPL_H
