...
#ifndef _IFC4X3_RC4_IFCIRREGULARTIMESERIESVALUE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCIRREGULARTIMESERIESVALUE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcIrregularTimeSeriesValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcIrregularTimeSeriesValue);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getTimeStamp() const;
  void setTimeStamp(const OdAnsiString& TimeStamp);
  void getListValues(OdArray<OdDAI::Select >& ListValues) const;
  void getListValuesWrapperArray(OdArray<IfcValue>& ListValues) const;
  OdDAI::List<OdDAI::Select>& listValues();
...
protected:
  // Fields declaration: 
  OdAnsiString m_TimeStamp;   // IfcDateTime
  OdDAI::List<OdDAI::Select> m_ListValues; // LIST [1:?] of IfcValue
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcIrregularTimeSeriesValue, IfcIrregularTimeSeriesValue> object.
*/
typedef OdSmartPtr<IfcIrregularTimeSeriesValue> IfcIrregularTimeSeriesValuePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCIRREGULARTIMESERIESVALUE_AUTO_IMPL_H
