...
#ifndef _IFC4X3_RC4_IFCELECTRICMOTORTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCELECTRICMOTORTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcElectricMotorType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcElectricMotorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcElectricMotorType, IfcElectricMotorType> object.
*/
typedef OdSmartPtr<IfcElectricMotorType> IfcElectricMotorTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCELECTRICMOTORTYPE_AUTO_IMPL_H
