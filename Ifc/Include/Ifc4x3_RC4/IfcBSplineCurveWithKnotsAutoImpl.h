...
#ifndef _IFC4X3_RC4_IFCBSPLINECURVEWITHKNOTS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBSPLINECURVEWITHKNOTS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBSplineCurveWithKnots : public IfcBSplineCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBSplineCurveWithKnots);
  //DOM-IGNORE-END
...
public:
  ...
  void getKnotMultiplicities(OdArray<int >& KnotMultiplicities) const;
  OdDAI::IntList& knotMultiplicities();
  void getKnots(OdArray<double >& Knots) const;
  OdDAI::DoubleList& knots();
...
protected:
  // Fields declaration: 
  OdDAI::IntList m_KnotMultiplicities; // LIST [2:?] of IfcInteger
  OdDAI::DoubleList m_Knots; // LIST [2:?] of IfcParameterValue
  OdDAI::Enum m_KnotSpec;   // IfcKnotType
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBSplineCurveWithKnots, IfcBSplineCurveWithKnots> object.
*/
typedef OdSmartPtr<IfcBSplineCurveWithKnots> IfcBSplineCurveWithKnotsPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBSPLINECURVEWITHKNOTS_AUTO_IMPL_H
