...
#ifndef _IFC4X3_RC4_IFCCHIMNEYTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCHIMNEYTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcChimneyType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcChimneyType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcChimneyTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcChimneyTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcChimneyTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcChimneyType, IfcChimneyType> object.
*/
typedef OdSmartPtr<IfcChimneyType> IfcChimneyTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCHIMNEYTYPE_AUTO_IMPL_H
