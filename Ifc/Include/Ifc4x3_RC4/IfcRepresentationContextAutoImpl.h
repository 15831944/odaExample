...
#ifndef _IFC4X3_RC4_IFCREPRESENTATIONCONTEXT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCREPRESENTATIONCONTEXT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRepresentationContext : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRepresentationContext);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_ContextIdentifier;   // IfcLabel  [optional]
  OdAnsiString m_ContextType;   // IfcLabel  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRepresentationContext, IfcRepresentationContext> object.
*/
typedef OdSmartPtr<IfcRepresentationContext> IfcRepresentationContextPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCREPRESENTATIONCONTEXT_AUTO_IMPL_H
