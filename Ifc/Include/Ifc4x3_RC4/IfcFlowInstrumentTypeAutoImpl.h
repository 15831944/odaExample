...
#ifndef _IFC4X3_RC4_IFCFLOWINSTRUMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFLOWINSTRUMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFlowInstrumentType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFlowInstrumentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFlowInstrumentType, IfcFlowInstrumentType> object.
*/
typedef OdSmartPtr<IfcFlowInstrumentType> IfcFlowInstrumentTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFLOWINSTRUMENTTYPE_AUTO_IMPL_H
