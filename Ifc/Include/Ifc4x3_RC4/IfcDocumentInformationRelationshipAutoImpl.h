...
#ifndef _IFC4X3_RC4_IFCDOCUMENTINFORMATIONRELATIONSHIP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDOCUMENTINFORMATIONRELATIONSHIP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDocumentInformationRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDocumentInformationRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDocumentInformationRelationship, IfcDocumentInformationRelationship> object.
*/
typedef OdSmartPtr<IfcDocumentInformationRelationship> IfcDocumentInformationRelationshipPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDOCUMENTINFORMATIONRELATIONSHIP_AUTO_IMPL_H
