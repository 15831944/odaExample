...
#ifndef _IFC4X3_RC4_IFCREINFORCINGMESHTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCREINFORCINGMESHTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcReinforcingMeshType : public IfcReinforcingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcReinforcingMeshType);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getBendingShapeCode() const;
  void setBendingShapeCode(const OdAnsiString& BendingShapeCode);
  void getBendingParameters(OdArray<OdDAI::Select >& BendingParameters) const;
  void getBendingParametersWrapperArray(OdArray<IfcBendingParameterSelect>& BendingParameters) const;
  OdDAI::List<OdDAI::Select>& bendingParameters();
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcReinforcingMeshTypeEnum
  IfcPositiveLengthMeasure m_MeshLength;   // IfcPositiveLengthMeasure  [optional]
  IfcPositiveLengthMeasure m_MeshWidth;   // IfcPositiveLengthMeasure  [optional]
  IfcPositiveLengthMeasure m_LongitudinalBarNominalDiameter;   // IfcPositiveLengthMeasure  [optional]
  IfcPositiveLengthMeasure m_TransverseBarNominalDiameter;   // IfcPositiveLengthMeasure  [optional]
  double m_LongitudinalBarCrossSectionArea;   // IfcAreaMeasure  [optional]
  double m_TransverseBarCrossSectionArea;   // IfcAreaMeasure  [optional]
  IfcPositiveLengthMeasure m_LongitudinalBarSpacing;   // IfcPositiveLengthMeasure  [optional]
  IfcPositiveLengthMeasure m_TransverseBarSpacing;   // IfcPositiveLengthMeasure  [optional]
  OdAnsiString m_BendingShapeCode;   // IfcLabel  [optional]
  OdDAI::List<OdDAI::Select> m_BendingParameters; // LIST [1:?] of IfcBendingParameterSelect [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcReinforcingMeshType, IfcReinforcingMeshType> object.
*/
typedef OdSmartPtr<IfcReinforcingMeshType> IfcReinforcingMeshTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCREINFORCINGMESHTYPE_AUTO_IMPL_H
