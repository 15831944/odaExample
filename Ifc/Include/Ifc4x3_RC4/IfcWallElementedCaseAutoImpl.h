...
#ifndef _IFC4X3_RC4_IFCWALLELEMENTEDCASE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCWALLELEMENTEDCASE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcWallElementedCase : public IfcWall
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcWallElementedCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcWallElementedCase, IfcWallElementedCase> object.
*/
typedef OdSmartPtr<IfcWallElementedCase> IfcWallElementedCasePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCWALLELEMENTEDCASE_AUTO_IMPL_H
