...
#ifndef _IFC4X3_RC4_IFCDOCUMENTINFORMATION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDOCUMENTINFORMATION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDocumentInformation : public IfcExternalInformation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDocumentInformation);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_Identification;   // IfcIdentifier
  OdAnsiString m_Name;   // IfcLabel
  OdAnsiString m_Description;   // IfcText  [optional]
  OdAnsiString m_Location;   // IfcURIReference  [optional]
  ...
  OdAnsiString m_CreationTime;   // IfcDateTime  [optional]
  OdAnsiString m_LastRevisionTime;   // IfcDateTime  [optional]
  OdAnsiString m_ElectronicFormat;   // IfcIdentifier  [optional]
  OdAnsiString m_ValidFrom;   // IfcDate  [optional]
  OdAnsiString m_ValidUntil;   // IfcDate  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDocumentInformation, IfcDocumentInformation> object.
*/
typedef OdSmartPtr<IfcDocumentInformation> IfcDocumentInformationPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDOCUMENTINFORMATION_AUTO_IMPL_H
