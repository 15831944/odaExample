...
#ifndef _IFC4X3_RC4_IFCROUNDEDRECTANGLEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCROUNDEDRECTANGLEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRoundedRectangleProfileDef : public IfcRectangleProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRoundedRectangleProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRoundedRectangleProfileDef, IfcRoundedRectangleProfileDef> object.
*/
typedef OdSmartPtr<IfcRoundedRectangleProfileDef> IfcRoundedRectangleProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCROUNDEDRECTANGLEPROFILEDEF_AUTO_IMPL_H
