...
#ifndef _IFC4X3_RC4_IFCSECONDORDERPOLYNOMIALSPIRAL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSECONDORDERPOLYNOMIALSPIRAL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSecondOrderPolynomialSpiral : public IfcSpiral
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSecondOrderPolynomialSpiral);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_QuadraticTerm;   // IfcLengthMeasure
  double m_LinearTerm;   // IfcLengthMeasure  [optional]
  double m_ConstantTerm;   // IfcLengthMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSecondOrderPolynomialSpiral, IfcSecondOrderPolynomialSpiral> object.
*/
typedef OdSmartPtr<IfcSecondOrderPolynomialSpiral> IfcSecondOrderPolynomialSpiralPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSECONDORDERPOLYNOMIALSPIRAL_AUTO_IMPL_H
