...
#ifndef _IFC4X3_RC4_IFCTEXTSTYLEFORDEFINEDFONT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTEXTSTYLEFORDEFINEDFONT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTextStyleForDefinedFont : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTextStyleForDefinedFont);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_Colour;   // IfcColour
  OdDAI::Select m_BackgroundColour;   // IfcColour  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTextStyleForDefinedFont, IfcTextStyleForDefinedFont> object.
*/
typedef OdSmartPtr<IfcTextStyleForDefinedFont> IfcTextStyleForDefinedFontPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTEXTSTYLEFORDEFINEDFONT_AUTO_IMPL_H
