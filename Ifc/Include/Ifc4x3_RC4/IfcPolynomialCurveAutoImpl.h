...
#ifndef _IFC4X3_RC4_IFCPOLYNOMIALCURVE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPOLYNOMIALCURVE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPolynomialCurve : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPolynomialCurve);
  //DOM-IGNORE-END
...
public:
  ...
  void getCoefficientsX(OdArray<double >& CoefficientsX) const;
  OdDAI::DoubleList& coefficientsX();
  void getCoefficientsY(OdArray<double >& CoefficientsY) const;
  OdDAI::DoubleList& coefficientsY();
  void getCoefficientsZ(OdArray<double >& CoefficientsZ) const;
  OdDAI::DoubleList& coefficientsZ();
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Position;   // IfcPlacement
  OdDAI::DoubleList m_CoefficientsX; // LIST [2:?] of IfcReal [optional]

  OdDAI::DoubleList m_CoefficientsY; // LIST [2:?] of IfcReal [optional]

  OdDAI::DoubleList m_CoefficientsZ; // LIST [2:?] of IfcReal [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPolynomialCurve, IfcPolynomialCurve> object.
*/
typedef OdSmartPtr<IfcPolynomialCurve> IfcPolynomialCurvePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPOLYNOMIALCURVE_AUTO_IMPL_H
