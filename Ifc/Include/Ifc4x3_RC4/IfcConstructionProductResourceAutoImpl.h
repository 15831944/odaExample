...
#ifndef _IFC4X3_RC4_IFCCONSTRUCTIONPRODUCTRESOURCE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONSTRUCTIONPRODUCTRESOURCE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcConstructionProductResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcConstructionProductResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcConstructionProductResource, IfcConstructionProductResource> object.
*/
typedef OdSmartPtr<IfcConstructionProductResource> IfcConstructionProductResourcePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONSTRUCTIONPRODUCTRESOURCE_AUTO_IMPL_H
