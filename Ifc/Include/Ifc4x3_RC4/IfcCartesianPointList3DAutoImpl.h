...
#ifndef _IFC4X3_RC4_IFCCARTESIANPOINTLIST3D_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCARTESIANPOINTLIST3D_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCartesianPointList3D : public IfcCartesianPointList
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCartesianPointList3D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCartesianPointList3D, IfcCartesianPointList3D> object.
*/
typedef OdSmartPtr<IfcCartesianPointList3D> IfcCartesianPointList3DPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCARTESIANPOINTLIST3D_AUTO_IMPL_H
