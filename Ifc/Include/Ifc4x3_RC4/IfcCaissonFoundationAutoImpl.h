...
#ifndef _IFC4X3_RC4_IFCCAISSONFOUNDATION_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCAISSONFOUNDATION_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCaissonFoundation : public IfcDeepFoundation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCaissonFoundation);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCaissonFoundationTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCaissonFoundation, IfcCaissonFoundation> object.
*/
typedef OdSmartPtr<IfcCaissonFoundation> IfcCaissonFoundationPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCAISSONFOUNDATION_AUTO_IMPL_H
