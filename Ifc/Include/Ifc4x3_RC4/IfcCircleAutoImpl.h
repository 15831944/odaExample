...
#ifndef _IFC4X3_RC4_IFCCIRCLE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCIRCLE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCircle : public IfcConic
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCircle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCircle, IfcCircle> object.
*/
typedef OdSmartPtr<IfcCircle> IfcCirclePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCIRCLE_AUTO_IMPL_H
