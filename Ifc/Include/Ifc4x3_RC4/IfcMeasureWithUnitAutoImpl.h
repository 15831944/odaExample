...
#ifndef _IFC4X3_RC4_IFCMEASUREWITHUNIT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMEASUREWITHUNIT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMeasureWithUnit : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMeasureWithUnit);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_ValueComponent;   // IfcValue
  OdDAI::Select m_UnitComponent;   // IfcUnit
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMeasureWithUnit, IfcMeasureWithUnit> object.
*/
typedef OdSmartPtr<IfcMeasureWithUnit> IfcMeasureWithUnitPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMEASUREWITHUNIT_AUTO_IMPL_H
