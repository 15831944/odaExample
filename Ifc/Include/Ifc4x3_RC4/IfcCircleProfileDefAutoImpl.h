...
#ifndef _IFC4X3_RC4_IFCCIRCLEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCIRCLEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCircleProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCircleProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCircleProfileDef, IfcCircleProfileDef> object.
*/
typedef OdSmartPtr<IfcCircleProfileDef> IfcCircleProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCIRCLEPROFILEDEF_AUTO_IMPL_H
