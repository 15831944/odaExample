...
#ifndef _IFC4X3_RC4_IFCPUMPTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPUMPTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPumpType : public IfcFlowMovingDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPumpType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPumpType, IfcPumpType> object.
*/
typedef OdSmartPtr<IfcPumpType> IfcPumpTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPUMPTYPE_AUTO_IMPL_H
