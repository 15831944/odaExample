...
#ifndef _IFC4X3_RC4_IFCENGINE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCENGINE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcEngine : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcEngine);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcEngine, IfcEngine> object.
*/
typedef OdSmartPtr<IfcEngine> IfcEnginePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCENGINE_AUTO_IMPL_H
