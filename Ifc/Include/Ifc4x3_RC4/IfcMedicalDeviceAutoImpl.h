...
#ifndef _IFC4X3_RC4_IFCMEDICALDEVICE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMEDICALDEVICE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMedicalDevice : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMedicalDevice);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcMedicalDeviceTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMedicalDevice, IfcMedicalDevice> object.
*/
typedef OdSmartPtr<IfcMedicalDevice> IfcMedicalDevicePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMEDICALDEVICE_AUTO_IMPL_H
