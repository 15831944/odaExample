...
#ifndef _IFC4X3_RC4_IFCRELDEFINESBYPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELDEFINESBYPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelDefinesByProperties : public IfcRelDefines
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelDefinesByProperties);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_RelatedObjects; // SET [1:?] of IfcObjectDefinition
  OdDAI::Select m_RelatingPropertyDefinition;   // IfcPropertySetDefinitionSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelDefinesByProperties, IfcRelDefinesByProperties> object.
*/
typedef OdSmartPtr<IfcRelDefinesByProperties> IfcRelDefinesByPropertiesPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELDEFINESBYPROPERTIES_AUTO_IMPL_H
