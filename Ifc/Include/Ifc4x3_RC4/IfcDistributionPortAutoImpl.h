...
#ifndef _IFC4X3_RC4_IFCDISTRIBUTIONPORT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDISTRIBUTIONPORT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDistributionPort : public IfcPort
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDistributionPort);
  //DOM-IGNORE-END
...
public:
  ...
  IfcFlowDirectionEnum getFlowDirection() const;
  void setFlowDirection(IfcFlowDirectionEnum FlowDirection);
  IfcDistributionPortTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcDistributionPortTypeEnum PredefinedType);
  IfcDistributionSystemEnum getSystemType() const;
  void setSystemType(IfcDistributionSystemEnum SystemType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_FlowDirection;   // IfcFlowDirectionEnum  [optional]
  OdDAI::Enum m_PredefinedType;   // IfcDistributionPortTypeEnum  [optional]
  OdDAI::Enum m_SystemType;   // IfcDistributionSystemEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDistributionPort, IfcDistributionPort> object.
*/
typedef OdSmartPtr<IfcDistributionPort> IfcDistributionPortPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDISTRIBUTIONPORT_AUTO_IMPL_H
