...
#ifndef _IFC4X3_RC4_IFCSTRUCTURALSURFACEMEMBER_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTRUCTURALSURFACEMEMBER_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStructuralSurfaceMember : public IfcStructuralMember
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStructuralSurfaceMember);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcStructuralSurfaceMemberTypeEnum
  IfcPositiveLengthMeasure m_Thickness;   // IfcPositiveLengthMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStructuralSurfaceMember, IfcStructuralSurfaceMember> object.
*/
typedef OdSmartPtr<IfcStructuralSurfaceMember> IfcStructuralSurfaceMemberPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTRUCTURALSURFACEMEMBER_AUTO_IMPL_H
