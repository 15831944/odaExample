...
#ifndef _IFC4X3_RC4_IFCDISCRETEACCESSORY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCDISCRETEACCESSORY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcDiscreteAccessory : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcDiscreteAccessory);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcDiscreteAccessoryTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcDiscreteAccessory, IfcDiscreteAccessory> object.
*/
typedef OdSmartPtr<IfcDiscreteAccessory> IfcDiscreteAccessoryPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCDISCRETEACCESSORY_AUTO_IMPL_H
