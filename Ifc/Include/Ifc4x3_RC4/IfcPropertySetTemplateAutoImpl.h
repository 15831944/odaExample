...
#ifndef _IFC4X3_RC4_IFCPROPERTYSETTEMPLATE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPROPERTYSETTEMPLATE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPropertySetTemplate : public IfcPropertyTemplateDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPropertySetTemplate);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_TemplateType;   // IfcPropertySetTemplateTypeEnum  [optional]
  OdAnsiString m_ApplicableEntity;   // IfcIdentifier  [optional]
  OdDAI::OdDAIObjectIdSet m_HasPropertyTemplates; // SET [1:?] of IfcPropertyTemplate
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPropertySetTemplate, IfcPropertySetTemplate> object.
*/
typedef OdSmartPtr<IfcPropertySetTemplate> IfcPropertySetTemplatePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPROPERTYSETTEMPLATE_AUTO_IMPL_H
