...
#ifndef _IFC4X3_RC4_IFCREINFORCINGELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCREINFORCINGELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcReinforcingElementType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcReinforcingElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcReinforcingElementType, IfcReinforcingElementType> object.
*/
typedef OdSmartPtr<IfcReinforcingElementType> IfcReinforcingElementTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCREINFORCINGELEMENTTYPE_AUTO_IMPL_H
