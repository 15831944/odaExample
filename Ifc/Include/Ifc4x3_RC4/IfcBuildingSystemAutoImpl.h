...
#ifndef _IFC4X3_RC4_IFCBUILDINGSYSTEM_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBUILDINGSYSTEM_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBuildingSystem : public IfcSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBuildingSystem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBuildingSystem, IfcBuildingSystem> object.
*/
typedef OdSmartPtr<IfcBuildingSystem> IfcBuildingSystemPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBUILDINGSYSTEM_AUTO_IMPL_H
