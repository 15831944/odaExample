...
#ifndef _IFC4X3_RC4_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPermeableCoveringProperties : public IfcPreDefinedPropertySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPermeableCoveringProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPermeableCoveringProperties, IfcPermeableCoveringProperties> object.
*/
typedef OdSmartPtr<IfcPermeableCoveringProperties> IfcPermeableCoveringPropertiesPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
