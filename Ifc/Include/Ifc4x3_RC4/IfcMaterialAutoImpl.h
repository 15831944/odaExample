...
#ifndef _IFC4X3_RC4_IFCMATERIAL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMATERIAL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMaterial : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMaterial);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMaterial, IfcMaterial> object.
*/
typedef OdSmartPtr<IfcMaterial> IfcMaterialPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMATERIAL_AUTO_IMPL_H
