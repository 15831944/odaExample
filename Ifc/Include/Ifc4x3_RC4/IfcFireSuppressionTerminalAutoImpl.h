...
#ifndef _IFC4X3_RC4_IFCFIRESUPPRESSIONTERMINAL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFIRESUPPRESSIONTERMINAL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFireSuppressionTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFireSuppressionTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFireSuppressionTerminal, IfcFireSuppressionTerminal> object.
*/
typedef OdSmartPtr<IfcFireSuppressionTerminal> IfcFireSuppressionTerminalPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFIRESUPPRESSIONTERMINAL_AUTO_IMPL_H
