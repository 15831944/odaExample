...
#ifndef _IFC4X3_RC4_IFCPRESENTATIONLAYERASSIGNMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPRESENTATIONLAYERASSIGNMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPresentationLayerAssignment : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPresentationLayerAssignment);
  //DOM-IGNORE-END
...
public:
  ...
  void getAssignedItems(OdArray<OdDAI::Select >& AssignedItems) const;
  void getAssignedItemsWrapperArray(OdArray<IfcLayeredItem>& AssignedItems) const;
  OdDAI::Set<OdDAI::Select>& assignedItems();
...
protected:
  ...
  OdDAI::Set<OdDAI::Select> m_AssignedItems; // SET [1:?] of IfcLayeredItem
  OdAnsiString m_Identifier;   // IfcIdentifier  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPresentationLayerAssignment, IfcPresentationLayerAssignment> object.
*/
typedef OdSmartPtr<IfcPresentationLayerAssignment> IfcPresentationLayerAssignmentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPRESENTATIONLAYERASSIGNMENT_AUTO_IMPL_H
