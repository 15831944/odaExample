...
#ifndef _IFC4X3_RC4_IFCRELSPACEBOUNDARY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELSPACEBOUNDARY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelSpaceBoundary : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelSpaceBoundary);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_RelatingSpace;   // IfcSpaceBoundarySelect
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelSpaceBoundary, IfcRelSpaceBoundary> object.
*/
typedef OdSmartPtr<IfcRelSpaceBoundary> IfcRelSpaceBoundaryPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELSPACEBOUNDARY_AUTO_IMPL_H
