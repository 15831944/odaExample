...
#ifndef _IFC4X3_RC4_IFCPRODUCT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPRODUCT_AUTO_IMPL_H
...
*/
class IFC4X3_RC4_EXPORT IfcProduct : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcProduct);
  //DOM-IGNORE-END
...
public:
  ...
  */
  ...
  /** \details
  Retrieves objects in which this product is referenced.
  \param PositionedRelativeTo [out] Receives an array of Data Access Interface (DAI) identifiers that represent objects in which this product is referenced.
  */
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcProduct, IfcProduct> object.
*/
typedef OdSmartPtr<IfcProduct> IfcProductPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPRODUCT_AUTO_IMPL_H
