...
#ifndef _IFC4X3_RC4_IFCACTOR_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCACTOR_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcActor : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcActor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcActor, IfcActor> object.
*/
typedef OdSmartPtr<IfcActor> IfcActorPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCACTOR_AUTO_IMPL_H
