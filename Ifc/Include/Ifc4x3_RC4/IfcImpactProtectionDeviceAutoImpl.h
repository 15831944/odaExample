...
#ifndef _IFC4X3_RC4_IFCIMPACTPROTECTIONDEVICE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCIMPACTPROTECTIONDEVICE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcImpactProtectionDevice : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcImpactProtectionDevice);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_PredefinedType;   // IfcImpactProtectionDeviceTypeSelect  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcImpactProtectionDevice, IfcImpactProtectionDevice> object.
*/
typedef OdSmartPtr<IfcImpactProtectionDevice> IfcImpactProtectionDevicePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCIMPACTPROTECTIONDEVICE_AUTO_IMPL_H
