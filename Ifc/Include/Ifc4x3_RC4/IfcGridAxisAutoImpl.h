...
#ifndef _IFC4X3_RC4_IFCGRIDAXIS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCGRIDAXIS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcGridAxis : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcGridAxis);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_AxisTag;   // IfcLabel  [optional]
  OdDAIObjectId m_AxisCurve;   // IfcCurve
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcGridAxis, IfcGridAxis> object.
*/
typedef OdSmartPtr<IfcGridAxis> IfcGridAxisPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCGRIDAXIS_AUTO_IMPL_H
