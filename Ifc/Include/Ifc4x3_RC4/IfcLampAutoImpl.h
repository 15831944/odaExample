...
#ifndef _IFC4X3_RC4_IFCLAMP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCLAMP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcLamp : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcLamp);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcLampTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcLamp, IfcLamp> object.
*/
typedef OdSmartPtr<IfcLamp> IfcLampPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCLAMP_AUTO_IMPL_H
