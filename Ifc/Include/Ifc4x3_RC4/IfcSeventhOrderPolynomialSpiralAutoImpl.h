...
#ifndef _IFC4X3_RC4_IFCSEVENTHORDERPOLYNOMIALSPIRAL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSEVENTHORDERPOLYNOMIALSPIRAL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSeventhOrderPolynomialSpiral : public IfcSpiral
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSeventhOrderPolynomialSpiral);
  //DOM-IGNORE-END
...
public:
  ...
  double getSepticTerm() const;
  void setSepticTerm(double SepticTerm);
  double getSexticTerm() const;
  void setSexticTerm(double SexticTerm);
  double getQuinticTerm() const;
  void setQuinticTerm(double QuinticTerm);
  double getQuarticTerm() const;
  void setQuarticTerm(double QuarticTerm);
...
protected:
  // Fields declaration: 
  double m_SepticTerm;   // IfcLengthMeasure
  double m_SexticTerm;   // IfcLengthMeasure  [optional]
  double m_QuinticTerm;   // IfcLengthMeasure  [optional]
  double m_QuarticTerm;   // IfcLengthMeasure  [optional]
  double m_CubicTerm;   // IfcLengthMeasure  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSeventhOrderPolynomialSpiral, IfcSeventhOrderPolynomialSpiral> object.
*/
typedef OdSmartPtr<IfcSeventhOrderPolynomialSpiral> IfcSeventhOrderPolynomialSpiralPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSEVENTHORDERPOLYNOMIALSPIRAL_AUTO_IMPL_H
