...
#ifndef _IFC4X3_RC4_IFCCONSTRUCTIONPRODUCTRESOURCETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONSTRUCTIONPRODUCTRESOURCETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcConstructionProductResourceType : public IfcConstructionResourceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcConstructionProductResourceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcConstructionProductResourceType, IfcConstructionProductResourceType> object.
*/
typedef OdSmartPtr<IfcConstructionProductResourceType> IfcConstructionProductResourceTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONSTRUCTIONPRODUCTRESOURCETYPE_AUTO_IMPL_H
