...
#ifndef _IFC4X3_RC4_IFCTEXTSTYLEFONTMODEL_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTEXTSTYLEFONTMODEL_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTextStyleFontModel : public IfcPreDefinedTextFont
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTextStyleFontModel);
  //DOM-IGNORE-END
...
public:
  ...
  void getFontFamily(OdArray<OdAnsiString >& FontFamily) const;
  OdDAI::OdAnsiStringList& fontFamily();
  const OdAnsiString& getFontStyle() const;
  void setFontStyle(const OdAnsiString& FontStyle);
  const OdAnsiString& getFontVariant() const;
  void setFontVariant(const OdAnsiString& FontVariant);
  const OdAnsiString& getFontWeight() const;
  void setFontWeight(const OdAnsiString& FontWeight);
...
protected:
  // Fields declaration: 
  OdDAI::OdAnsiStringList m_FontFamily; // LIST [1:?] of IfcTextFontName
  OdAnsiString m_FontStyle;   // IfcFontStyle  [optional]
  OdAnsiString m_FontVariant;   // IfcFontVariant  [optional]
  OdAnsiString m_FontWeight;   // IfcFontWeight  [optional]
  OdDAI::Select m_FontSize;   // IfcSizeSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTextStyleFontModel, IfcTextStyleFontModel> object.
*/
typedef OdSmartPtr<IfcTextStyleFontModel> IfcTextStyleFontModelPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTEXTSTYLEFONTMODEL_AUTO_IMPL_H
