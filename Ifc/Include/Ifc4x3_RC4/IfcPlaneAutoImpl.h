...
#ifndef _IFC4X3_RC4_IFCPLANE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCPLANE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcPlane : public IfcElementarySurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcPlane);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcPlane, IfcPlane> object.
*/
typedef OdSmartPtr<IfcPlane> IfcPlanePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCPLANE_AUTO_IMPL_H
