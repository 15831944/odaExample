...
#ifndef _IFC4X3_RC4_IFCTYPEOBJECT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTYPEOBJECT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTypeObject : public IfcObjectDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTypeObject);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTypeObject, IfcTypeObject> object.
*/
typedef OdSmartPtr<IfcTypeObject> IfcTypeObjectPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTYPEOBJECT_AUTO_IMPL_H
