...
#ifndef _IFC4X3_RC4_IFCSEAMCURVE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSEAMCURVE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSeamCurve : public IfcSurfaceCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSeamCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSeamCurve, IfcSeamCurve> object.
*/
typedef OdSmartPtr<IfcSeamCurve> IfcSeamCurvePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSEAMCURVE_AUTO_IMPL_H
