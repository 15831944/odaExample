...
#ifndef _IFC4X3_RC4_IFCREPARAMETRISEDCOMPOSITECURVESEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCREPARAMETRISEDCOMPOSITECURVESEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcReparametrisedCompositeCurveSegment : public IfcCompositeCurveSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcReparametrisedCompositeCurveSegment);
  //DOM-IGNORE-END
...
public:
  ...
  void setParamLength(double ParamLength);
...
protected:
  // Fields declaration: 
  double m_ParamLength;   // IfcParameterValue
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcReparametrisedCompositeCurveSegment, IfcReparametrisedCompositeCurveSegment> object.
*/
typedef OdSmartPtr<IfcReparametrisedCompositeCurveSegment> IfcReparametrisedCompositeCurveSegmentPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCREPARAMETRISEDCOMPOSITECURVESEGMENT_AUTO_IMPL_H
