...
#ifndef _IFC4X3_RC4_IFCBRIDGE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBRIDGE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBridge : public IfcFacility
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBridge);
  //DOM-IGNORE-END
...
public:
  ...
  IfcBridgeTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcBridgeTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcBridgeTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBridge, IfcBridge> object.
*/
typedef OdSmartPtr<IfcBridge> IfcBridgePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBRIDGE_AUTO_IMPL_H
