...
#ifndef _IFC4X3_RC4_IFCCOVERING_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOVERING_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCovering : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCovering);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvCoversSpaces(OdDAIObjectIds& CoversSpaces) const;
  void getInvCoversElements(OdDAIObjectIds& CoversElements) const;
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCoveringTypeEnum  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCovering, IfcCovering> object.
*/
typedef OdSmartPtr<IfcCovering> IfcCoveringPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOVERING_AUTO_IMPL_H
