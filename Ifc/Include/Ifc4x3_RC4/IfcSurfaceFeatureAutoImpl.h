...
#ifndef _IFC4X3_RC4_IFCSURFACEFEATURE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSURFACEFEATURE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSurfaceFeature : public IfcFeatureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSurfaceFeature);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAIObjectId getInvAdheresToElement() const;
...
protected:
  ...
  friend class IfcRelAdheresToElement;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSurfaceFeature, IfcSurfaceFeature> object.
*/
typedef OdSmartPtr<IfcSurfaceFeature> IfcSurfaceFeaturePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSURFACEFEATURE_AUTO_IMPL_H
