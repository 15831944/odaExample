...
#ifndef _IFC4X3_RC4_IFCCOLUMN_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOLUMN_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcColumn : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcColumn);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcColumn, IfcColumn> object.
*/
typedef OdSmartPtr<IfcColumn> IfcColumnPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOLUMN_AUTO_IMPL_H
