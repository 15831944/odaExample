...
#ifndef _IFC4X3_RC4_IFCSTRUCTURALLOADSTATIC_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTRUCTURALLOADSTATIC_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStructuralLoadStatic : public IfcStructuralLoadOrResult
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStructuralLoadStatic);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStructuralLoadStatic, IfcStructuralLoadStatic> object.
*/
typedef OdSmartPtr<IfcStructuralLoadStatic> IfcStructuralLoadStaticPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTRUCTURALLOADSTATIC_AUTO_IMPL_H
