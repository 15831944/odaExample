...
#ifndef _IFC4X3_RC4_IFCMARINEFACILITY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMARINEFACILITY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMarineFacility : public IfcFacility
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMarineFacility);
  //DOM-IGNORE-END
...
public:
  ...
  IfcMarineFacilityTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcMarineFacilityTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcMarineFacilityTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMarineFacility, IfcMarineFacility> object.
*/
typedef OdSmartPtr<IfcMarineFacility> IfcMarineFacilityPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMARINEFACILITY_AUTO_IMPL_H
