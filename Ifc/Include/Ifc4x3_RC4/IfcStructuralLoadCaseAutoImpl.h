...
#ifndef _IFC4X3_RC4_IFCSTRUCTURALLOADCASE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSTRUCTURALLOADCASE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcStructuralLoadCase : public IfcStructuralLoadGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcStructuralLoadCase);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::DoubleList& selfWeightCoefficients();
...
protected:
  // Fields declaration: 
  OdDAI::DoubleList m_SelfWeightCoefficients; // LIST [3:3] of IfcRatioMeasure [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcStructuralLoadCase, IfcStructuralLoadCase> object.
*/
typedef OdSmartPtr<IfcStructuralLoadCase> IfcStructuralLoadCasePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSTRUCTURALLOADCASE_AUTO_IMPL_H
