...
#ifndef _IFC4X3_RC4_IFCRELNESTS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELNESTS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelNests : public IfcRelDecomposes
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelNests);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& relatedObjects();
...
protected:
  ...
  OdDAI::OdDAIObjectIdList m_RelatedObjects; // LIST [1:?] of IfcObjectDefinition
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelNests, IfcRelNests> object.
*/
typedef OdSmartPtr<IfcRelNests> IfcRelNestsPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELNESTS_AUTO_IMPL_H
