...
#ifndef _IFC4X3_RC4_IFCLABORRESOURCE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCLABORRESOURCE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcLaborResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcLaborResource);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcLaborResourceTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcLaborResource, IfcLaborResource> object.
*/
typedef OdSmartPtr<IfcLaborResource> IfcLaborResourcePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCLABORRESOURCE_AUTO_IMPL_H
