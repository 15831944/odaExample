...
#ifndef _IFC4X3_RC4_IFCTELECOMADDRESS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTELECOMADDRESS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTelecomAddress : public IfcAddress
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTelecomAddress);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTelecomAddress, IfcTelecomAddress> object.
*/
typedef OdSmartPtr<IfcTelecomAddress> IfcTelecomAddressPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTELECOMADDRESS_AUTO_IMPL_H
