...
#ifndef _IFC4X3_RC4_IFCGEOTECHNICALASSEMBLY_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCGEOTECHNICALASSEMBLY_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcGeotechnicalAssembly : public IfcGeotechnicalElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcGeotechnicalAssembly);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcGeotechnicalAssembly, IfcGeotechnicalAssembly> object.
*/
typedef OdSmartPtr<IfcGeotechnicalAssembly> IfcGeotechnicalAssemblyPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCGEOTECHNICALASSEMBLY_AUTO_IMPL_H
