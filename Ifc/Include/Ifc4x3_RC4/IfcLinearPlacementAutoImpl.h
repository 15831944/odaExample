...
#ifndef _IFC4X3_RC4_IFCLINEARPLACEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCLINEARPLACEMENT_AUTO_IMPL_H

#include "IfcObjectPlacementAutoImpl.h"
#include "IfcAxis2PlacementLinearAutoImpl.h"
...
class IFC4X3_RC4_EXPORT IfcLinearPlacement : public IfcObjectPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcLinearPlacement);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelativePlacement() const;
  void setRelativePlacement(const OdDAIObjectId& RelativePlacement);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelativePlacement;   // IfcAxis2PlacementLinear
  OdDAIObjectId m_CartesianPosition;   // IfcAxis2Placement3D  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcLinearPlacement, IfcLinearPlacement> object.
*/
typedef OdSmartPtr<IfcLinearPlacement> IfcLinearPlacementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCLINEARPLACEMENT_AUTO_IMPL_H
