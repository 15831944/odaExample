...
#ifndef _IFC4X3_RC4_IFCCOMMUNICATIONSAPPLIANCE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCOMMUNICATIONSAPPLIANCE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcCommunicationsAppliance : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcCommunicationsAppliance);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCommunicationsApplianceTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcCommunicationsAppliance, IfcCommunicationsAppliance> object.
*/
typedef OdSmartPtr<IfcCommunicationsAppliance> IfcCommunicationsAppliancePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCOMMUNICATIONSAPPLIANCE_AUTO_IMPL_H
