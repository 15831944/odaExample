...
#ifndef _IFC4X3_RC4_IFCTESSELLATEDFACESET_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTESSELLATEDFACESET_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTessellatedFaceSet : public IfcTessellatedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTessellatedFaceSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTessellatedFaceSet, IfcTessellatedFaceSet> object.
*/
typedef OdSmartPtr<IfcTessellatedFaceSet> IfcTessellatedFaceSetPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTESSELLATEDFACESET_AUTO_IMPL_H
