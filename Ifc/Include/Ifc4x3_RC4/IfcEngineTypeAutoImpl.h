...
#ifndef _IFC4X3_RC4_IFCENGINETYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCENGINETYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcEngineType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcEngineType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcEngineType, IfcEngineType> object.
*/
typedef OdSmartPtr<IfcEngineType> IfcEngineTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCENGINETYPE_AUTO_IMPL_H
