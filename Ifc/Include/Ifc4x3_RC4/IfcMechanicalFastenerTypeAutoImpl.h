...
#ifndef _IFC4X3_RC4_IFCMECHANICALFASTENERTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCMECHANICALFASTENERTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcMechanicalFastenerType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcMechanicalFastenerType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcMechanicalFastenerTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcMechanicalFastenerTypeEnum PredefinedType);
  double getNominalDiameter() const;
  void setNominalDiameter(double NominalDiameter);
  double getNominalLength() const;
  void setNominalLength(double NominalLength);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcMechanicalFastenerTypeEnum
  IfcPositiveLengthMeasure m_NominalDiameter;   // IfcPositiveLengthMeasure  [optional]
  IfcPositiveLengthMeasure m_NominalLength;   // IfcPositiveLengthMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcMechanicalFastenerType, IfcMechanicalFastenerType> object.
*/
typedef OdSmartPtr<IfcMechanicalFastenerType> IfcMechanicalFastenerTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCMECHANICALFASTENERTYPE_AUTO_IMPL_H
