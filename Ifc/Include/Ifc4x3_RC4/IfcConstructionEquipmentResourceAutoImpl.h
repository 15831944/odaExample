...
#ifndef _IFC4X3_RC4_IFCCONSTRUCTIONEQUIPMENTRESOURCE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCCONSTRUCTIONEQUIPMENTRESOURCE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcConstructionEquipmentResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcConstructionEquipmentResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcConstructionEquipmentResource, IfcConstructionEquipmentResource> object.
*/
typedef OdSmartPtr<IfcConstructionEquipmentResource> IfcConstructionEquipmentResourcePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCCONSTRUCTIONEQUIPMENTRESOURCE_AUTO_IMPL_H
