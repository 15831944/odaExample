...
#ifndef _IFC4X3_RC4_IFCRELPOSITIONS_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELPOSITIONS_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelPositions : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelPositions);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatingPositioningElement() const;
  void setRelatingPositioningElement(const OdDAIObjectId& RelatingPositioningElement);
  void getRelatedProducts(OdDAIObjectIds& RelatedProducts) const;
  OdDAI::OdDAIObjectIdSet& relatedProducts();
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatingPositioningElement;   // IfcPositioningElement
  OdDAI::OdDAIObjectIdSet m_RelatedProducts; // SET [1:?] of IfcProduct
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelPositions, IfcRelPositions> object.
*/
typedef OdSmartPtr<IfcRelPositions> IfcRelPositionsPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELPOSITIONS_AUTO_IMPL_H
