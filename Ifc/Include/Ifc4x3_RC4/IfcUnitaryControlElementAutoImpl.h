...
#ifndef _IFC4X3_RC4_IFCUNITARYCONTROLELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCUNITARYCONTROLELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcUnitaryControlElement : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcUnitaryControlElement);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcUnitaryControlElementTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcUnitaryControlElement, IfcUnitaryControlElement> object.
*/
typedef OdSmartPtr<IfcUnitaryControlElement> IfcUnitaryControlElementPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCUNITARYCONTROLELEMENT_AUTO_IMPL_H
