...
#ifndef _IFC4X3_RC4_IFCSANITARYTERMINALTYPE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCSANITARYTERMINALTYPE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcSanitaryTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcSanitaryTerminalType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcSanitaryTerminalType, IfcSanitaryTerminalType> object.
*/
typedef OdSmartPtr<IfcSanitaryTerminalType> IfcSanitaryTerminalTypePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCSANITARYTERMINALTYPE_AUTO_IMPL_H
