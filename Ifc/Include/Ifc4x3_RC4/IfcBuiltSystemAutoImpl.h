...
#ifndef _IFC4X3_RC4_IFCBUILTSYSTEM_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCBUILTSYSTEM_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcBuiltSystem : public IfcSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcBuiltSystem);
  //DOM-IGNORE-END
...
public:
  ...
  IfcBuiltSystemTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcBuiltSystemTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcBuiltSystemTypeEnum  [optional]
  OdAnsiString m_LongName;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcBuiltSystem, IfcBuiltSystem> object.
*/
typedef OdSmartPtr<IfcBuiltSystem> IfcBuiltSystemPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCBUILTSYSTEM_AUTO_IMPL_H
