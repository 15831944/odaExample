...
#ifndef _IFC4X3_RC4_IFCINDEXEDTRIANGLETEXTUREMAP_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCINDEXEDTRIANGLETEXTUREMAP_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcIndexedTriangleTextureMap : public IfcIndexedTextureMap
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcIndexedTriangleTextureMap);
  //DOM-IGNORE-END
...
public:
  ...
  void getTexCoordIndex(OdArray<OdArray<int > >& TexCoordIndex) const;
  OdDAI::List<OdDAI::Aggr*>& texCoordIndex();
...
protected:
  // Fields declaration: 
  OdDAI::List<OdDAI::Aggr*> m_TexCoordIndex; // LIST [1:?] of LIST [3:3] of IfcPositiveInteger [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcIndexedTriangleTextureMap, IfcIndexedTriangleTextureMap> object.
*/
typedef OdSmartPtr<IfcIndexedTriangleTextureMap> IfcIndexedTriangleTextureMapPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCINDEXEDTRIANGLETEXTUREMAP_AUTO_IMPL_H
