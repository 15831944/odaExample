...
#ifndef _IFC4X3_RC4_IFCTEXTUREVERTEXLIST_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTEXTUREVERTEXLIST_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTextureVertexList : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTextureVertexList);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTextureVertexList, IfcTextureVertexList> object.
*/
typedef OdSmartPtr<IfcTextureVertexList> IfcTextureVertexListPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTEXTUREVERTEXLIST_AUTO_IMPL_H
