...
#ifndef _IFC4X3_RC4_IFCRELASSIGNSTORESOURCE_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCRELASSIGNSTORESOURCE_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcRelAssignsToResource : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcRelAssignsToResource);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_RelatingResource;   // IfcResourceSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcRelAssignsToResource, IfcRelAssignsToResource> object.
*/
typedef OdSmartPtr<IfcRelAssignsToResource> IfcRelAssignsToResourcePtr;

} // namespace

#endif // _IFC4X3_RC4_IFCRELASSIGNSTORESOURCE_AUTO_IMPL_H
