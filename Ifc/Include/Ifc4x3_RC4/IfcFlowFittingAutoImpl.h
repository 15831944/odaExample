...
#ifndef _IFC4X3_RC4_IFCFLOWFITTING_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCFLOWFITTING_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcFlowFitting : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcFlowFitting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcFlowFitting, IfcFlowFitting> object.
*/
typedef OdSmartPtr<IfcFlowFitting> IfcFlowFittingPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCFLOWFITTING_AUTO_IMPL_H
