...
#ifndef _IFC4X3_RC4_IFCTEXTURECOORDINATEGENERATOR_AUTO_IMPL_H
#define _IFC4X3_RC4_IFCTEXTURECOORDINATEGENERATOR_AUTO_IMPL_H
...
class IFC4X3_RC4_EXPORT IfcTextureCoordinateGenerator : public IfcTextureCoordinate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc4::IfcTextureCoordinateGenerator);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc4::IfcTextureCoordinateGenerator, IfcTextureCoordinateGenerator> object.
*/
typedef OdSmartPtr<IfcTextureCoordinateGenerator> IfcTextureCoordinateGeneratorPtr;

} // namespace

#endif // _IFC4X3_RC4_IFCTEXTURECOORDINATEGENERATOR_AUTO_IMPL_H
