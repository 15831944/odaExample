...
#ifndef _IFC4X3_RC1_IFCSHADINGDEVICE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSHADINGDEVICE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcShadingDevice : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcShadingDevice);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcShadingDeviceTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcShadingDevice, IfcShadingDevice> object.
*/
typedef OdSmartPtr<IfcShadingDevice> IfcShadingDevicePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSHADINGDEVICE_AUTO_IMPL_H
