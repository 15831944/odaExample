...
#ifndef _IFC4X3_RC1_IFCSOLIDSTRATUM_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSOLIDSTRATUM_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSolidStratum : public IfcGeotechnicalStratum
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSolidStratum);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSolidStratum, IfcSolidStratum> object.
*/
typedef OdSmartPtr<IfcSolidStratum> IfcSolidStratumPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSOLIDSTRATUM_AUTO_IMPL_H
