...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALLOAD_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALLOAD_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralLoad : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralLoad);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralLoad, IfcStructuralLoad> object.
*/
typedef OdSmartPtr<IfcStructuralLoad> IfcStructuralLoadPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALLOAD_AUTO_IMPL_H
