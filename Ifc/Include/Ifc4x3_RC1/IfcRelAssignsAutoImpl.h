...
#ifndef _IFC4X3_RC1_IFCRELASSIGNS_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELASSIGNS_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelAssigns : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelAssigns);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelAssigns, IfcRelAssigns> object.
*/
typedef OdSmartPtr<IfcRelAssigns> IfcRelAssignsPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELASSIGNS_AUTO_IMPL_H
