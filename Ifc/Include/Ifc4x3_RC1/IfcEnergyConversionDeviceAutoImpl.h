...
#ifndef _IFC4X3_RC1_IFCENERGYCONVERSIONDEVICE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCENERGYCONVERSIONDEVICE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcEnergyConversionDevice : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcEnergyConversionDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcEnergyConversionDevice, IfcEnergyConversionDevice> object.
*/
typedef OdSmartPtr<IfcEnergyConversionDevice> IfcEnergyConversionDevicePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCENERGYCONVERSIONDEVICE_AUTO_IMPL_H
