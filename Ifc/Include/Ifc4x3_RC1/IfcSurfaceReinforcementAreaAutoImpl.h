...
#ifndef _IFC4X3_RC1_IFCSURFACEREINFORCEMENTAREA_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSURFACEREINFORCEMENTAREA_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSurfaceReinforcementArea : public IfcStructuralLoadOrResult
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSurfaceReinforcementArea);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSurfaceReinforcementArea, IfcSurfaceReinforcementArea> object.
*/
typedef OdSmartPtr<IfcSurfaceReinforcementArea> IfcSurfaceReinforcementAreaPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSURFACEREINFORCEMENTAREA_AUTO_IMPL_H
