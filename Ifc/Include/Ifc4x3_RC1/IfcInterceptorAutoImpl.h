...
#ifndef _IFC4X3_RC1_IFCINTERCEPTOR_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCINTERCEPTOR_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcInterceptor : public IfcFlowTreatmentDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcInterceptor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcInterceptor, IfcInterceptor> object.
*/
typedef OdSmartPtr<IfcInterceptor> IfcInterceptorPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCINTERCEPTOR_AUTO_IMPL_H
