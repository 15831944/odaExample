...
#ifndef _IFC4X3_RC1_IFCPROFILEPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPROFILEPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcProfileProperties : public IfcExtendedProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcProfileProperties);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_ProfileDefinition;   // IfcProfileDef
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcProfileProperties, IfcProfileProperties> object.
*/
typedef OdSmartPtr<IfcProfileProperties> IfcProfilePropertiesPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPROFILEPROPERTIES_AUTO_IMPL_H
