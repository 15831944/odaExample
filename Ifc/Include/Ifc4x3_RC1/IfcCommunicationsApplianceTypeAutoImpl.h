...
#ifndef _IFC4X3_RC1_IFCCOMMUNICATIONSAPPLIANCETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCOMMUNICATIONSAPPLIANCETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCommunicationsApplianceType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCommunicationsApplianceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcCommunicationsApplianceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcCommunicationsApplianceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCommunicationsApplianceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCommunicationsApplianceType, IfcCommunicationsApplianceType> object.
*/
typedef OdSmartPtr<IfcCommunicationsApplianceType> IfcCommunicationsApplianceTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCOMMUNICATIONSAPPLIANCETYPE_AUTO_IMPL_H
