...
#ifndef _IFC4X3_RC1_IFCPREDEFINEDPROPERTYSET_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPREDEFINEDPROPERTYSET_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPreDefinedPropertySet : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPreDefinedPropertySet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPreDefinedPropertySet, IfcPreDefinedPropertySet> object.
*/
typedef OdSmartPtr<IfcPreDefinedPropertySet> IfcPreDefinedPropertySetPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPREDEFINEDPROPERTYSET_AUTO_IMPL_H
