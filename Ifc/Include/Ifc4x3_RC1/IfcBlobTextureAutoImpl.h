...
#ifndef _IFC4X3_RC1_IFCBLOBTEXTURE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBLOBTEXTURE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBlobTexture : public IfcSurfaceTexture
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBlobTexture);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getRasterFormat() const;
  void setRasterFormat(const OdAnsiString& RasterFormat);
  const OdAnsiString& getRasterCode() const;
  void setRasterCode(const OdAnsiString& RasterCode);
...
protected:
  // Fields declaration: 
  OdAnsiString m_RasterFormat;   // IfcIdentifier
  OdAnsiString m_RasterCode;   // IfcBinary
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBlobTexture, IfcBlobTexture> object.
*/
typedef OdSmartPtr<IfcBlobTexture> IfcBlobTexturePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBLOBTEXTURE_AUTO_IMPL_H
