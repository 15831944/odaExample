...
#ifndef _IFC4X3_RC1_IFCPROPERTYENUMERATEDVALUE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPROPERTYENUMERATEDVALUE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPropertyEnumeratedValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPropertyEnumeratedValue);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::List<OdDAI::Select> m_EnumerationValues; // LIST [1:?] of IfcValue [optional]

  OdDAIObjectId m_EnumerationReference;   // IfcPropertyEnumeration  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPropertyEnumeratedValue, IfcPropertyEnumeratedValue> object.
*/
typedef OdSmartPtr<IfcPropertyEnumeratedValue> IfcPropertyEnumeratedValuePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPROPERTYENUMERATEDVALUE_AUTO_IMPL_H
