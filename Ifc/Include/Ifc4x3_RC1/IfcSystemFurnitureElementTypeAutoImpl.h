...
#ifndef _IFC4X3_RC1_IFCSYSTEMFURNITUREELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSYSTEMFURNITUREELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSystemFurnitureElementType : public IfcFurnishingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSystemFurnitureElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSystemFurnitureElementType, IfcSystemFurnitureElementType> object.
*/
typedef OdSmartPtr<IfcSystemFurnitureElementType> IfcSystemFurnitureElementTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSYSTEMFURNITUREELEMENTTYPE_AUTO_IMPL_H
