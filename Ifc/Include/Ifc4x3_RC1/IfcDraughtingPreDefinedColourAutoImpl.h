...
#ifndef _IFC4X3_RC1_IFCDRAUGHTINGPREDEFINEDCOLOUR_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDRAUGHTINGPREDEFINEDCOLOUR_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDraughtingPreDefinedColour : public IfcPreDefinedColour
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDraughtingPreDefinedColour);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDraughtingPreDefinedColour, IfcDraughtingPreDefinedColour> object.
*/
typedef OdSmartPtr<IfcDraughtingPreDefinedColour> IfcDraughtingPreDefinedColourPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDRAUGHTINGPREDEFINEDCOLOUR_AUTO_IMPL_H
