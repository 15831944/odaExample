...
#ifndef _IFC4X3_RC1_IFCDISTRIBUTIONCIRCUIT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDISTRIBUTIONCIRCUIT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDistributionCircuit : public IfcDistributionSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDistributionCircuit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDistributionCircuit, IfcDistributionCircuit> object.
*/
typedef OdSmartPtr<IfcDistributionCircuit> IfcDistributionCircuitPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDISTRIBUTIONCIRCUIT_AUTO_IMPL_H
