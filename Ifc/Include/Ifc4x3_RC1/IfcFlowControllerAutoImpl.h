...
#ifndef _IFC4X3_RC1_IFCFLOWCONTROLLER_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFLOWCONTROLLER_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFlowController : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFlowController);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFlowController, IfcFlowController> object.
*/
typedef OdSmartPtr<IfcFlowController> IfcFlowControllerPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFLOWCONTROLLER_AUTO_IMPL_H
