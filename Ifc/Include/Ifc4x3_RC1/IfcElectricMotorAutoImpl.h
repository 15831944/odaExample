...
#ifndef _IFC4X3_RC1_IFCELECTRICMOTOR_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCELECTRICMOTOR_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcElectricMotor : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcElectricMotor);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcElectricMotorTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcElectricMotor, IfcElectricMotor> object.
*/
typedef OdSmartPtr<IfcElectricMotor> IfcElectricMotorPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCELECTRICMOTOR_AUTO_IMPL_H
