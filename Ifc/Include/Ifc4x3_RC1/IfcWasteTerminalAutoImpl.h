...
#ifndef _IFC4X3_RC1_IFCWASTETERMINAL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCWASTETERMINAL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcWasteTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcWasteTerminal);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcWasteTerminalTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcWasteTerminal, IfcWasteTerminal> object.
*/
typedef OdSmartPtr<IfcWasteTerminal> IfcWasteTerminalPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCWASTETERMINAL_AUTO_IMPL_H
