...
#ifndef _IFC4X3_RC1_IFCRELASSOCIATESCONSTRAINT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELASSOCIATESCONSTRAINT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelAssociatesConstraint : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelAssociatesConstraint);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_Intent;   // IfcLabel  [optional]
  OdDAIObjectId m_RelatingConstraint;   // IfcConstraint
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelAssociatesConstraint, IfcRelAssociatesConstraint> object.
*/
typedef OdSmartPtr<IfcRelAssociatesConstraint> IfcRelAssociatesConstraintPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELASSOCIATESCONSTRAINT_AUTO_IMPL_H
