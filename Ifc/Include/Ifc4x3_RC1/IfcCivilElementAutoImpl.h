...
#ifndef _IFC4X3_RC1_IFCCIVILELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCIVILELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCivilElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCivilElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCivilElement, IfcCivilElement> object.
*/
typedef OdSmartPtr<IfcCivilElement> IfcCivilElementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCIVILELEMENT_AUTO_IMPL_H
