...
#ifndef _IFC4X3_RC1_IFCAPPROVALRELATIONSHIP_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCAPPROVALRELATIONSHIP_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcApprovalRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcApprovalRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcApprovalRelationship, IfcApprovalRelationship> object.
*/
typedef OdSmartPtr<IfcApprovalRelationship> IfcApprovalRelationshipPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCAPPROVALRELATIONSHIP_AUTO_IMPL_H
