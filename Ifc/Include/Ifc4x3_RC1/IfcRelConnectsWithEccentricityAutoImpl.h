...
#ifndef _IFC4X3_RC1_IFCRELCONNECTSWITHECCENTRICITY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELCONNECTSWITHECCENTRICITY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelConnectsWithEccentricity : public IfcRelConnectsStructuralMember
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelConnectsWithEccentricity);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelConnectsWithEccentricity, IfcRelConnectsWithEccentricity> object.
*/
typedef OdSmartPtr<IfcRelConnectsWithEccentricity> IfcRelConnectsWithEccentricityPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELCONNECTSWITHECCENTRICITY_AUTO_IMPL_H
