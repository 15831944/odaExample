...
#ifndef _IFC4X3_RC1_IFCINDEXEDTEXTUREMAP_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCINDEXEDTEXTUREMAP_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcIndexedTextureMap : public IfcTextureCoordinate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcIndexedTextureMap);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getTexCoords() const;
  void setTexCoords(const OdDAIObjectId& TexCoords);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_MappedTo;   // IfcTessellatedFaceSet
  OdDAIObjectId m_TexCoords;   // IfcTextureVertexList
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcIndexedTextureMap, IfcIndexedTextureMap> object.
*/
typedef OdSmartPtr<IfcIndexedTextureMap> IfcIndexedTextureMapPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCINDEXEDTEXTUREMAP_AUTO_IMPL_H
