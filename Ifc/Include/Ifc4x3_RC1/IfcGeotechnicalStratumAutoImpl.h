...
#ifndef _IFC4X3_RC1_IFCGEOTECHNICALSTRATUM_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCGEOTECHNICALSTRATUM_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcGeotechnicalStratum : public IfcGeotechnicalElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcGeotechnicalStratum);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcGeotechnicalStratum, IfcGeotechnicalStratum> object.
*/
typedef OdSmartPtr<IfcGeotechnicalStratum> IfcGeotechnicalStratumPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCGEOTECHNICALSTRATUM_AUTO_IMPL_H
