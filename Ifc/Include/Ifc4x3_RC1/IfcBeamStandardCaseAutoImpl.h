...
#ifndef _IFC4X3_RC1_IFCBEAMSTANDARDCASE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBEAMSTANDARDCASE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBeamStandardCase : public IfcBeam
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBeamStandardCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBeamStandardCase, IfcBeamStandardCase> object.
*/
typedef OdSmartPtr<IfcBeamStandardCase> IfcBeamStandardCasePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBEAMSTANDARDCASE_AUTO_IMPL_H
