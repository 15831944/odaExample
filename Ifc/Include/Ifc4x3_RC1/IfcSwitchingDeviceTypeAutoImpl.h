...
#ifndef _IFC4X3_RC1_IFCSWITCHINGDEVICETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSWITCHINGDEVICETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSwitchingDeviceType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSwitchingDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSwitchingDeviceType, IfcSwitchingDeviceType> object.
*/
typedef OdSmartPtr<IfcSwitchingDeviceType> IfcSwitchingDeviceTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSWITCHINGDEVICETYPE_AUTO_IMPL_H
