...
#ifndef _IFC4X3_RC1_IFCTENDON_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTENDON_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTendon : public IfcReinforcingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTendon);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTendon, IfcTendon> object.
*/
typedef OdSmartPtr<IfcTendon> IfcTendonPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTENDON_AUTO_IMPL_H
