...
#ifndef _IFC4X3_RC1_IFCCONSTRUCTIONMATERIALRESOURCETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCONSTRUCTIONMATERIALRESOURCETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcConstructionMaterialResourceType : public IfcConstructionResourceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcConstructionMaterialResourceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcConstructionMaterialResourceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcConstructionMaterialResourceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcConstructionMaterialResourceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcConstructionMaterialResourceType, IfcConstructionMaterialResourceType> object.
*/
typedef OdSmartPtr<IfcConstructionMaterialResourceType> IfcConstructionMaterialResourceTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCONSTRUCTIONMATERIALRESOURCETYPE_AUTO_IMPL_H
