...
#ifndef _IFC4X3_RC1_IFCMATERIALDEFINITIONREPRESENTATION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMATERIALDEFINITIONREPRESENTATION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMaterialDefinitionRepresentation : public IfcProductRepresentation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMaterialDefinitionRepresentation);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRepresentedMaterial() const;
  void setRepresentedMaterial(const OdDAIObjectId& RepresentedMaterial);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RepresentedMaterial;   // IfcMaterial
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMaterialDefinitionRepresentation, IfcMaterialDefinitionRepresentation> object.
*/
typedef OdSmartPtr<IfcMaterialDefinitionRepresentation> IfcMaterialDefinitionRepresentationPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMATERIALDEFINITIONREPRESENTATION_AUTO_IMPL_H
