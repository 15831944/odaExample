...
#ifndef _IFC4X3_RC1_IFCRECTANGLEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRECTANGLEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRectangleProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRectangleProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRectangleProfileDef, IfcRectangleProfileDef> object.
*/
typedef OdSmartPtr<IfcRectangleProfileDef> IfcRectangleProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRECTANGLEPROFILEDEF_AUTO_IMPL_H
