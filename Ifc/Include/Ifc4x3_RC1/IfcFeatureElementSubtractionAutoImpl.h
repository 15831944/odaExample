...
#ifndef _IFC4X3_RC1_IFCFEATUREELEMENTSUBTRACTION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFEATUREELEMENTSUBTRACTION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFeatureElementSubtraction : public IfcFeatureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFeatureElementSubtraction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFeatureElementSubtraction, IfcFeatureElementSubtraction> object.
*/
typedef OdSmartPtr<IfcFeatureElementSubtraction> IfcFeatureElementSubtractionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFEATUREELEMENTSUBTRACTION_AUTO_IMPL_H
