...
#ifndef _IFC4X3_RC1_IFCINDEXEDTRIANGLETEXTUREMAP_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCINDEXEDTRIANGLETEXTUREMAP_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcIndexedTriangleTextureMap : public IfcIndexedTextureMap
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcIndexedTriangleTextureMap);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcIndexedTriangleTextureMap, IfcIndexedTriangleTextureMap> object.
*/
typedef OdSmartPtr<IfcIndexedTriangleTextureMap> IfcIndexedTriangleTextureMapPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCINDEXEDTRIANGLETEXTUREMAP_AUTO_IMPL_H
