...
#ifndef _IFC4X3_RC1_IFCCOLUMNTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCOLUMNTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcColumnType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcColumnType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcColumnType, IfcColumnType> object.
*/
typedef OdSmartPtr<IfcColumnType> IfcColumnTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCOLUMNTYPE_AUTO_IMPL_H
