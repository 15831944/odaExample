...
#ifndef _IFC4X3_RC1_IFCFLOWMOVINGDEVICE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFLOWMOVINGDEVICE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFlowMovingDevice : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFlowMovingDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFlowMovingDevice, IfcFlowMovingDevice> object.
*/
typedef OdSmartPtr<IfcFlowMovingDevice> IfcFlowMovingDevicePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFLOWMOVINGDEVICE_AUTO_IMPL_H
