...
#ifndef _IFC4X3_RC1_IFCSURFACE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSURFACE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSurface : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSurface, IfcSurface> object.
*/
typedef OdSmartPtr<IfcSurface> IfcSurfacePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSURFACE_AUTO_IMPL_H
