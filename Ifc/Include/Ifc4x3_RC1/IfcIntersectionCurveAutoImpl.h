...
#ifndef _IFC4X3_RC1_IFCINTERSECTIONCURVE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCINTERSECTIONCURVE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcIntersectionCurve : public IfcSurfaceCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcIntersectionCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcIntersectionCurve, IfcIntersectionCurve> object.
*/
typedef OdSmartPtr<IfcIntersectionCurve> IfcIntersectionCurvePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCINTERSECTIONCURVE_AUTO_IMPL_H
