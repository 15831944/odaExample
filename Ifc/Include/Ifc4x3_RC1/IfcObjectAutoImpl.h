...
#ifndef _IFC4X3_RC1_IFCOBJECT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCOBJECT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcObject : public IfcObjectDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcObject);
  //DOM-IGNORE-END
...
protected:
  ...
  friend class IfcRelDefinesByObject;
  friend class IfcRelDefinesByObject;
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcObject, IfcObject> object.
*/
typedef OdSmartPtr<IfcObject> IfcObjectPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCOBJECT_AUTO_IMPL_H
