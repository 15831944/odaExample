...
#ifndef _IFC4X3_RC1_IFCELEMENTARYSURFACE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCELEMENTARYSURFACE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcElementarySurface : public IfcSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcElementarySurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcElementarySurface, IfcElementarySurface> object.
*/
typedef OdSmartPtr<IfcElementarySurface> IfcElementarySurfacePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCELEMENTARYSURFACE_AUTO_IMPL_H
