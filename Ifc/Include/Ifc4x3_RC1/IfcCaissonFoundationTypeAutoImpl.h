...
#ifndef _IFC4X3_RC1_IFCCAISSONFOUNDATIONTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCAISSONFOUNDATIONTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCaissonFoundationType : public IfcDeepFoundationType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCaissonFoundationType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCaissonFoundationType, IfcCaissonFoundationType> object.
*/
typedef OdSmartPtr<IfcCaissonFoundationType> IfcCaissonFoundationTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCAISSONFOUNDATIONTYPE_AUTO_IMPL_H
