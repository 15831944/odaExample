...
#ifndef _IFC4X3_RC1_IFCBSPLINESURFACEWITHKNOTS_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBSPLINESURFACEWITHKNOTS_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBSplineSurfaceWithKnots : public IfcBSplineSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBSplineSurfaceWithKnots);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBSplineSurfaceWithKnots, IfcBSplineSurfaceWithKnots> object.
*/
typedef OdSmartPtr<IfcBSplineSurfaceWithKnots> IfcBSplineSurfaceWithKnotsPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBSPLINESURFACEWITHKNOTS_AUTO_IMPL_H
