...
#ifndef _IFC4X3_RC1_IFCOFFSETCURVEBYDISTANCES_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCOFFSETCURVEBYDISTANCES_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcOffsetCurveByDistances : public IfcOffsetCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcOffsetCurveByDistances);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_OffsetValues; // LIST [1:?] of IfcDistanceExpression
  OdAnsiString m_Tag;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcOffsetCurveByDistances, IfcOffsetCurveByDistances> object.
*/
typedef OdSmartPtr<IfcOffsetCurveByDistances> IfcOffsetCurveByDistancesPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCOFFSETCURVEBYDISTANCES_AUTO_IMPL_H
