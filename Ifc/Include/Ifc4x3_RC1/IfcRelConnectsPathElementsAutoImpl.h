...
#ifndef _IFC4X3_RC1_IFCRELCONNECTSPATHELEMENTS_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELCONNECTSPATHELEMENTS_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelConnectsPathElements : public IfcRelConnectsElements
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelConnectsPathElements);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::IntList m_RelatingPriorities; // LIST [0:?] of IfcInteger
  OdDAI::IntList m_RelatedPriorities; // LIST [0:?] of IfcInteger
  OdDAI::Enum m_RelatedConnectionType;   // IfcConnectionTypeEnum
  OdDAI::Enum m_RelatingConnectionType;   // IfcConnectionTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelConnectsPathElements, IfcRelConnectsPathElements> object.
*/
typedef OdSmartPtr<IfcRelConnectsPathElements> IfcRelConnectsPathElementsPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELCONNECTSPATHELEMENTS_AUTO_IMPL_H
