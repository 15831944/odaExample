...
#ifndef _IFC4X3_RC1_IFCBUILDINGELEMENTPROXYTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBUILDINGELEMENTPROXYTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBuildingElementProxyType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBuildingElementProxyType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBuildingElementProxyType, IfcBuildingElementProxyType> object.
*/
typedef OdSmartPtr<IfcBuildingElementProxyType> IfcBuildingElementProxyTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBUILDINGELEMENTPROXYTYPE_AUTO_IMPL_H
