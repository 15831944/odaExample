...
#ifndef _IFC4X3_RC1_IFCCARTESIANTRANSFORMATIONOPERATOR_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCARTESIANTRANSFORMATIONOPERATOR_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCartesianTransformationOperator : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCartesianTransformationOperator);
  //DOM-IGNORE-END
...
protected:
  ...
  double m_Scale;   // IfcReal  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCartesianTransformationOperator, IfcCartesianTransformationOperator> object.
*/
typedef OdSmartPtr<IfcCartesianTransformationOperator> IfcCartesianTransformationOperatorPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCARTESIANTRANSFORMATIONOPERATOR_AUTO_IMPL_H
