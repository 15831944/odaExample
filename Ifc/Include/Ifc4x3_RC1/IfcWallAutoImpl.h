...
#ifndef _IFC4X3_RC1_IFCWALL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCWALL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcWall : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcWall);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcWall, IfcWall> object.
*/
typedef OdSmartPtr<IfcWall> IfcWallPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCWALL_AUTO_IMPL_H
