...
#ifndef _IFC4X3_RC1_IFCTRACKELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTRACKELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTrackElement : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTrackElement);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcTrackElementTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTrackElement, IfcTrackElement> object.
*/
typedef OdSmartPtr<IfcTrackElement> IfcTrackElementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTRACKELEMENT_AUTO_IMPL_H
