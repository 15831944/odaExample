...
#ifndef _IFC4X3_RC1_IFCIMAGETEXTURE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCIMAGETEXTURE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcImageTexture : public IfcSurfaceTexture
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcImageTexture);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_URLReference;   // IfcURIReference
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcImageTexture, IfcImageTexture> object.
*/
typedef OdSmartPtr<IfcImageTexture> IfcImageTexturePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCIMAGETEXTURE_AUTO_IMPL_H
