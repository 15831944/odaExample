...
#ifndef _IFC4X3_RC1_IFCOPENINGSTANDARDCASE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCOPENINGSTANDARDCASE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcOpeningStandardCase : public IfcOpeningElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcOpeningStandardCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcOpeningStandardCase, IfcOpeningStandardCase> object.
*/
typedef OdSmartPtr<IfcOpeningStandardCase> IfcOpeningStandardCasePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCOPENINGSTANDARDCASE_AUTO_IMPL_H
