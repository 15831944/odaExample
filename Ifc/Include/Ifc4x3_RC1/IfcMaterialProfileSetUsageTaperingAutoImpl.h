...
#ifndef _IFC4X3_RC1_IFCMATERIALPROFILESETUSAGETAPERING_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMATERIALPROFILESETUSAGETAPERING_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMaterialProfileSetUsageTapering : public IfcMaterialProfileSetUsage
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMaterialProfileSetUsageTapering);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMaterialProfileSetUsageTapering, IfcMaterialProfileSetUsageTapering> object.
*/
typedef OdSmartPtr<IfcMaterialProfileSetUsageTapering> IfcMaterialProfileSetUsageTaperingPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMATERIALPROFILESETUSAGETAPERING_AUTO_IMPL_H
