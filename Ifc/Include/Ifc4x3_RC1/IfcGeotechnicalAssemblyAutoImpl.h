...
#ifndef _IFC4X3_RC1_IFCGEOTECHNICALASSEMBLY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCGEOTECHNICALASSEMBLY_AUTO_IMPL_H

#include "IfcGeotechnicalElementAutoImpl.h"
...
class IFC4X3_RC1_EXPORT IfcGeotechnicalAssembly : public IfcGeotechnicalElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcGeotechnicalAssembly);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcGeotechnicalAssembly, IfcGeotechnicalAssembly> object.
*/
typedef OdSmartPtr<IfcGeotechnicalAssembly> IfcGeotechnicalAssemblyPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCGEOTECHNICALASSEMBLY_AUTO_IMPL_H
