...
#ifndef _IFC4X3_RC1_IFCDIRECTRIXDISTANCESWEPTAREASOLID_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDIRECTRIXDISTANCESWEPTAREASOLID_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDirectrixDistanceSweptAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDirectrixDistanceSweptAreaSolid);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getStartDistance() const;
  void setStartDistance(const OdDAIObjectId& StartDistance);
  const OdDAIObjectId& getEndDistance() const;
  void setEndDistance(const OdDAIObjectId& EndDistance);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Directrix;   // IfcCurve
  OdDAIObjectId m_StartDistance;   // IfcDistanceExpression  [optional]
  OdDAIObjectId m_EndDistance;   // IfcDistanceExpression  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDirectrixDistanceSweptAreaSolid, IfcDirectrixDistanceSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcDirectrixDistanceSweptAreaSolid> IfcDirectrixDistanceSweptAreaSolidPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDIRECTRIXDISTANCESWEPTAREASOLID_AUTO_IMPL_H
