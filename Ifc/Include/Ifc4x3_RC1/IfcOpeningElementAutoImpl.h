...
#ifndef _IFC4X3_RC1_IFCOPENINGELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCOPENINGELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcOpeningElement : public IfcFeatureElementSubtraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcOpeningElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcOpeningElement, IfcOpeningElement> object.
*/
typedef OdSmartPtr<IfcOpeningElement> IfcOpeningElementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCOPENINGELEMENT_AUTO_IMPL_H
