...
#ifndef _IFC4X3_RC1_IFCPROCESS_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPROCESS_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcProcess : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcProcess);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcProcess, IfcProcess> object.
*/
typedef OdSmartPtr<IfcProcess> IfcProcessPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPROCESS_AUTO_IMPL_H
