...
#ifndef _IFC4X3_RC1_IFCDISTRIBUTIONCHAMBERELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDISTRIBUTIONCHAMBERELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDistributionChamberElement : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDistributionChamberElement);
  //DOM-IGNORE-END
...
public:
  ...
  IfcDistributionChamberElementTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcDistributionChamberElementTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcDistributionChamberElementTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDistributionChamberElement, IfcDistributionChamberElement> object.
*/
typedef OdSmartPtr<IfcDistributionChamberElement> IfcDistributionChamberElementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDISTRIBUTIONCHAMBERELEMENT_AUTO_IMPL_H
