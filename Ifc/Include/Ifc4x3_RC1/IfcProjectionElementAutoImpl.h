...
#ifndef _IFC4X3_RC1_IFCPROJECTIONELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPROJECTIONELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcProjectionElement : public IfcFeatureElementAddition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcProjectionElement);
  //DOM-IGNORE-END
...
public:
  ...
  IfcProjectionElementTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcProjectionElementTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcProjectionElementTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcProjectionElement, IfcProjectionElement> object.
*/
typedef OdSmartPtr<IfcProjectionElement> IfcProjectionElementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPROJECTIONELEMENT_AUTO_IMPL_H
