...
#ifndef _IFC4X3_RC1_IFCALIGNMENT2DVERTICAL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCALIGNMENT2DVERTICAL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAlignment2DVertical : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAlignment2DVertical);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_Segments; // LIST [1:?] of IfcAlignment2DVerticalSegment
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAlignment2DVertical, IfcAlignment2DVertical> object.
*/
typedef OdSmartPtr<IfcAlignment2DVertical> IfcAlignment2DVerticalPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCALIGNMENT2DVERTICAL_AUTO_IMPL_H
