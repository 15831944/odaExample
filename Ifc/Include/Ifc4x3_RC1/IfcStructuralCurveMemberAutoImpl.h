...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALCURVEMEMBER_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALCURVEMEMBER_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralCurveMember : public IfcStructuralMember
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralCurveMember);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralCurveMember, IfcStructuralCurveMember> object.
*/
typedef OdSmartPtr<IfcStructuralCurveMember> IfcStructuralCurveMemberPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALCURVEMEMBER_AUTO_IMPL_H
