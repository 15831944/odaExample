...
#ifndef _IFC4X3_RC1_IFCTEXTURECOORDINATEGENERATOR_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTEXTURECOORDINATEGENERATOR_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTextureCoordinateGenerator : public IfcTextureCoordinate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTextureCoordinateGenerator);
  //DOM-IGNORE-END
...
public:
  ...
  void getParameter(OdArray<double >& Parameter) const;
  OdDAI::DoubleList& parameter();
...
protected:
  ...
  OdDAI::DoubleList m_Parameter; // LIST [1:?] of IfcReal [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTextureCoordinateGenerator, IfcTextureCoordinateGenerator> object.
*/
typedef OdSmartPtr<IfcTextureCoordinateGenerator> IfcTextureCoordinateGeneratorPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTEXTURECOORDINATEGENERATOR_AUTO_IMPL_H
