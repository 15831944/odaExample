...
#ifndef _IFC4X3_RC1_IFCTELECOMADDRESS_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTELECOMADDRESS_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTelecomAddress : public IfcAddress
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTelecomAddress);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdAnsiStringList& telephoneNumbers();
  void getFacsimileNumbers(OdArray<OdAnsiString >& FacsimileNumbers) const;
  OdDAI::OdAnsiStringList& facsimileNumbers();
  ...
  OdDAI::OdAnsiStringList& electronicMailAddresses();
  ...
  OdDAI::OdAnsiStringList& messagingIDs();
...
protected:
  // Fields declaration: 
  OdDAI::OdAnsiStringList m_TelephoneNumbers; // LIST [1:?] of IfcLabel [optional]

  OdDAI::OdAnsiStringList m_FacsimileNumbers; // LIST [1:?] of IfcLabel [optional]

  OdAnsiString m_PagerNumber;   // IfcLabel  [optional]
  OdDAI::OdAnsiStringList m_ElectronicMailAddresses; // LIST [1:?] of IfcLabel [optional]

  OdAnsiString m_WWWHomePageURL;   // IfcURIReference  [optional]
  OdDAI::OdAnsiStringList m_MessagingIDs; // LIST [1:?] of IfcURIReference [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTelecomAddress, IfcTelecomAddress> object.
*/
typedef OdSmartPtr<IfcTelecomAddress> IfcTelecomAddressPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTELECOMADDRESS_AUTO_IMPL_H
