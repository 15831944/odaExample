...
#ifndef _IFC4X3_RC1_IFCGEOGRAPHICELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCGEOGRAPHICELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcGeographicElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcGeographicElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcGeographicElementType, IfcGeographicElementType> object.
*/
typedef OdSmartPtr<IfcGeographicElementType> IfcGeographicElementTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCGEOGRAPHICELEMENTTYPE_AUTO_IMPL_H
