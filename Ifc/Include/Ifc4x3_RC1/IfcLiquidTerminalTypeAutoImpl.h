...
#ifndef _IFC4X3_RC1_IFCLIQUIDTERMINALTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLIQUIDTERMINALTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLiquidTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLiquidTerminalType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcLiquidTerminalTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcLiquidTerminalTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcLiquidTerminalTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLiquidTerminalType, IfcLiquidTerminalType> object.
*/
typedef OdSmartPtr<IfcLiquidTerminalType> IfcLiquidTerminalTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLIQUIDTERMINALTYPE_AUTO_IMPL_H
