...
#ifndef _IFC4X3_RC1_IFCEDGELOOP_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCEDGELOOP_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcEdgeLoop : public IfcLoop
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcEdgeLoop);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcEdgeLoop, IfcEdgeLoop> object.
*/
typedef OdSmartPtr<IfcEdgeLoop> IfcEdgeLoopPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCEDGELOOP_AUTO_IMPL_H
