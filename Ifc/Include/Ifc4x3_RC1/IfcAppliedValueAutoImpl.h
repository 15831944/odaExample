...
#ifndef _IFC4X3_RC1_IFCAPPLIEDVALUE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCAPPLIEDVALUE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAppliedValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAppliedValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAppliedValue, IfcAppliedValue> object.
*/
typedef OdSmartPtr<IfcAppliedValue> IfcAppliedValuePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCAPPLIEDVALUE_AUTO_IMPL_H
