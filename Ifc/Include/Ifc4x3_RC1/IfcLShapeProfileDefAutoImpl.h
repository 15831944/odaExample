...
#ifndef _IFC4X3_RC1_IFCLSHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLSHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLShapeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLShapeProfileDef, IfcLShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcLShapeProfileDef> IfcLShapeProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLSHAPEPROFILEDEF_AUTO_IMPL_H
