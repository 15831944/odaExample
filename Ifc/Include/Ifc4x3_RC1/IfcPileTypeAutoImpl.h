...
#ifndef _IFC4X3_RC1_IFCPILETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPILETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPileType : public IfcDeepFoundationType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPileType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPileType, IfcPileType> object.
*/
typedef OdSmartPtr<IfcPileType> IfcPileTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPILETYPE_AUTO_IMPL_H
