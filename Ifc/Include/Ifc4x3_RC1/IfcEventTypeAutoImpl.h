...
#ifndef _IFC4X3_RC1_IFCEVENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCEVENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcEventType : public IfcTypeProcess
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcEventType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcEventTypeEnum
  OdDAI::Enum m_EventTriggerType;   // IfcEventTriggerTypeEnum
  OdAnsiString m_UserDefinedEventTriggerType;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcEventType, IfcEventType> object.
*/
typedef OdSmartPtr<IfcEventType> IfcEventTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCEVENTTYPE_AUTO_IMPL_H
