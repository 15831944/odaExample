...
#ifndef _IFC4X3_RC1_IFCCARTESIANPOINTLIST3D_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCARTESIANPOINTLIST3D_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCartesianPointList3D : public IfcCartesianPointList
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCartesianPointList3D);
  //DOM-IGNORE-END
...
public:
  ...
  void getCoordList(OdArray<OdArray<double > >& CoordList) const;
  OdDAI::List<OdDAI::Aggr*>& coordList();
  void getTagList(OdArray<OdAnsiString >& TagList) const;
  OdDAI::OdAnsiStringList& tagList();
...
protected:
  // Fields declaration: 
  OdDAI::List<OdDAI::Aggr*> m_CoordList; // LIST [1:?] of LIST [3:3] of IfcLengthMeasure
  OdDAI::OdAnsiStringList m_TagList; // LIST [1:?] of IfcLabel [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCartesianPointList3D, IfcCartesianPointList3D> object.
*/
typedef OdSmartPtr<IfcCartesianPointList3D> IfcCartesianPointList3DPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCARTESIANPOINTLIST3D_AUTO_IMPL_H
