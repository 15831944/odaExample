...
#ifndef _IFC4X3_RC1_IFCPROPERTY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPROPERTY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcProperty : public IfcPropertyAbstraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcProperty);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcProperty, IfcProperty> object.
*/
typedef OdSmartPtr<IfcProperty> IfcPropertyPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPROPERTY_AUTO_IMPL_H
