...
#ifndef _IFC4X3_RC1_IFCMOORINGDEVICETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMOORINGDEVICETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMooringDeviceType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMooringDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMooringDeviceType, IfcMooringDeviceType> object.
*/
typedef OdSmartPtr<IfcMooringDeviceType> IfcMooringDeviceTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMOORINGDEVICETYPE_AUTO_IMPL_H
