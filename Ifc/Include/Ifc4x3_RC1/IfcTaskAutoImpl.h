...
#ifndef _IFC4X3_RC1_IFCTASK_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTASK_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTask : public IfcProcess
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTask);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Boolean m_IsMilestone;   // IfcBoolean
  int m_Priority;   // IfcInteger  [optional]
  OdDAIObjectId m_TaskTime;   // IfcTaskTime  [optional]
  OdDAI::Enum m_PredefinedType;   // IfcTaskTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTask, IfcTask> object.
*/
typedef OdSmartPtr<IfcTask> IfcTaskPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTASK_AUTO_IMPL_H
