...
#ifndef _IFC4X3_RC1_IFCDOORTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDOORTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDoorType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDoorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDoorType, IfcDoorType> object.
*/
typedef OdSmartPtr<IfcDoorType> IfcDoorTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDOORTYPE_AUTO_IMPL_H
