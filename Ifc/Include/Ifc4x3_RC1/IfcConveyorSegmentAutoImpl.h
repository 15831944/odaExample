...
#ifndef _IFC4X3_RC1_IFCCONVEYORSEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCONVEYORSEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcConveyorSegment : public IfcFlowSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcConveyorSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcConveyorSegment, IfcConveyorSegment> object.
*/
typedef OdSmartPtr<IfcConveyorSegment> IfcConveyorSegmentPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCONVEYORSEGMENT_AUTO_IMPL_H
