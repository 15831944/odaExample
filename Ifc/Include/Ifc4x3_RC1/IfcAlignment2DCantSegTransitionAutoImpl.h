...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAlignment2DCantSegTransition, IfcAlignment2DCantSegTransition> object.
*/
typedef OdSmartPtr<IfcAlignment2DCantSegTransition> IfcAlignment2DCantSegTransitionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCALIGNMENT2DCANTSEGTRANSITION_AUTO_IMPL_H
