...
#ifndef _IFC4X3_RC1_IFCELEMENTQUANTITY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCELEMENTQUANTITY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcElementQuantity : public IfcQuantitySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcElementQuantity);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdSet& quantities();
...
protected:
  // Fields declaration: 
  OdAnsiString m_MethodOfMeasurement;   // IfcLabel  [optional]
  OdDAI::OdDAIObjectIdSet m_Quantities; // SET [1:?] of IfcPhysicalQuantity
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcElementQuantity, IfcElementQuantity> object.
*/
typedef OdSmartPtr<IfcElementQuantity> IfcElementQuantityPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCELEMENTQUANTITY_AUTO_IMPL_H
