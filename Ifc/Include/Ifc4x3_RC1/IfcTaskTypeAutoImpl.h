...
#ifndef _IFC4X3_RC1_IFCTASKTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTASKTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTaskType : public IfcTypeProcess
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTaskType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcTaskTypeEnum
  OdAnsiString m_WorkMethod;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTaskType, IfcTaskType> object.
*/
typedef OdSmartPtr<IfcTaskType> IfcTaskTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTASKTYPE_AUTO_IMPL_H
