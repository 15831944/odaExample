...
#ifndef _IFC4X3_RC1_IFCFLOWSTORAGEDEVICETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFLOWSTORAGEDEVICETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFlowStorageDeviceType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFlowStorageDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFlowStorageDeviceType, IfcFlowStorageDeviceType> object.
*/
typedef OdSmartPtr<IfcFlowStorageDeviceType> IfcFlowStorageDeviceTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFLOWSTORAGEDEVICETYPE_AUTO_IMPL_H
