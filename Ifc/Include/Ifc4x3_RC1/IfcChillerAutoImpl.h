...
#ifndef _IFC4X3_RC1_IFCCHILLER_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCHILLER_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcChiller : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcChiller);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcChiller, IfcChiller> object.
*/
typedef OdSmartPtr<IfcChiller> IfcChillerPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCHILLER_AUTO_IMPL_H
