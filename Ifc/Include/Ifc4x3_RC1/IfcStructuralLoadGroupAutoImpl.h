...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALLOADGROUP_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALLOADGROUP_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralLoadGroup : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralLoadGroup);
  //DOM-IGNORE-END
...
protected:
  ...
  double m_Coefficient;   // IfcRatioMeasure  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralLoadGroup, IfcStructuralLoadGroup> object.
*/
typedef OdSmartPtr<IfcStructuralLoadGroup> IfcStructuralLoadGroupPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALLOADGROUP_AUTO_IMPL_H
