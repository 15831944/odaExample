...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPropertySetTemplate, IfcPropertySetTemplate> object.
*/
typedef OdSmartPtr<IfcPropertySetTemplate> IfcPropertySetTemplatePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPROPERTYSETTEMPLATE_AUTO_IMPL_H
