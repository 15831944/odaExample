...
#ifndef _IFC4X3_RC1_IFCSECTIONEDSURFACE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSECTIONEDSURFACE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSectionedSurface : public IfcSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSectionedSurface);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& crossSectionPositions();
  void getCrossSections(OdDAIObjectIds& CrossSections) const;
  OdDAI::OdDAIObjectIdList& crossSections();
...
protected:
  ...
  OdDAI::OdDAIObjectIdList m_CrossSectionPositions; // LIST [2:?] of IfcDistanceExpression
  OdDAI::OdDAIObjectIdList m_CrossSections; // LIST [2:?] of IfcProfileDef
  OdDAI::Boolean m_FixedAxisVertical;   // IfcBoolean
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSectionedSurface, IfcSectionedSurface> object.
*/
typedef OdSmartPtr<IfcSectionedSurface> IfcSectionedSurfacePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSECTIONEDSURFACE_AUTO_IMPL_H
