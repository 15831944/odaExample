...
#ifndef _IFC4X3_RC1_IFCSUBCONTRACTRESOURCETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSUBCONTRACTRESOURCETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSubContractResourceType : public IfcConstructionResourceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSubContractResourceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSubContractResourceType, IfcSubContractResourceType> object.
*/
typedef OdSmartPtr<IfcSubContractResourceType> IfcSubContractResourceTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSUBCONTRACTRESOURCETYPE_AUTO_IMPL_H
