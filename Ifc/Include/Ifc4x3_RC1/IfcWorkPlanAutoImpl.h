...
#ifndef _IFC4X3_RC1_IFCWORKPLAN_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCWORKPLAN_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcWorkPlan : public IfcWorkControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcWorkPlan);
  //DOM-IGNORE-END
...
public:
  ...
  IfcWorkPlanTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcWorkPlanTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcWorkPlanTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcWorkPlan, IfcWorkPlan> object.
*/
typedef OdSmartPtr<IfcWorkPlan> IfcWorkPlanPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCWORKPLAN_AUTO_IMPL_H
