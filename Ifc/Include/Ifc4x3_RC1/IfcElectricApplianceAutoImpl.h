...
#ifndef _IFC4X3_RC1_IFCELECTRICAPPLIANCE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCELECTRICAPPLIANCE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcElectricAppliance : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcElectricAppliance);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcElectricApplianceTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcElectricAppliance, IfcElectricAppliance> object.
*/
typedef OdSmartPtr<IfcElectricAppliance> IfcElectricAppliancePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCELECTRICAPPLIANCE_AUTO_IMPL_H
