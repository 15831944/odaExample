...
#ifndef _IFC4X3_RC1_IFCTRACKELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTRACKELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTrackElementType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTrackElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTrackElementType, IfcTrackElementType> object.
*/
typedef OdSmartPtr<IfcTrackElementType> IfcTrackElementTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTRACKELEMENTTYPE_AUTO_IMPL_H
