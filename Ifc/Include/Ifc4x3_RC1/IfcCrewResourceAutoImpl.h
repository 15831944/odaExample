...
#ifndef _IFC4X3_RC1_IFCCREWRESOURCE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCREWRESOURCE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCrewResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCrewResource);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCrewResourceTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCrewResource, IfcCrewResource> object.
*/
typedef OdSmartPtr<IfcCrewResource> IfcCrewResourcePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCREWRESOURCE_AUTO_IMPL_H
