...
#ifndef _IFC4X3_RC1_IFCPROCEDURETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPROCEDURETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcProcedureType : public IfcTypeProcess
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcProcedureType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcProcedureTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcProcedureTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcProcedureTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcProcedureType, IfcProcedureType> object.
*/
typedef OdSmartPtr<IfcProcedureType> IfcProcedureTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPROCEDURETYPE_AUTO_IMPL_H
