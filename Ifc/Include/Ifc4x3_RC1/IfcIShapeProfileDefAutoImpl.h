...
#ifndef _IFC4X3_RC1_IFCISHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCISHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcIShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcIShapeProfileDef);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  IfcPositiveLengthMeasure m_OverallWidth;   // IfcPositiveLengthMeasure
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcIShapeProfileDef, IfcIShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcIShapeProfileDef> IfcIShapeProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCISHAPEPROFILEDEF_AUTO_IMPL_H
