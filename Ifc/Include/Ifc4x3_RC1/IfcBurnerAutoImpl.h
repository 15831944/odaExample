...
#ifndef _IFC4X3_RC1_IFCBURNER_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBURNER_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBurner : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBurner);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcBurnerTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBurner, IfcBurner> object.
*/
typedef OdSmartPtr<IfcBurner> IfcBurnerPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBURNER_AUTO_IMPL_H
