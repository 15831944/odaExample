...
#ifndef _IFC4X3_RC1_IFCREVOLVEDAREASOLID_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCREVOLVEDAREASOLID_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRevolvedAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRevolvedAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRevolvedAreaSolid, IfcRevolvedAreaSolid> object.
*/
typedef OdSmartPtr<IfcRevolvedAreaSolid> IfcRevolvedAreaSolidPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCREVOLVEDAREASOLID_AUTO_IMPL_H
