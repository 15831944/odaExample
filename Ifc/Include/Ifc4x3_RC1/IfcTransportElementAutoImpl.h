...
#ifndef _IFC4X3_RC1_IFCTRANSPORTELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTRANSPORTELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTransportElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTransportElement);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_PredefinedType;   // IfcTransportElementTypeSelect  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTransportElement, IfcTransportElement> object.
*/
typedef OdSmartPtr<IfcTransportElement> IfcTransportElementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTRANSPORTELEMENT_AUTO_IMPL_H
