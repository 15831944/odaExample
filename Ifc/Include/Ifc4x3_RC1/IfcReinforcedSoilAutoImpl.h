...
#ifndef _IFC4X3_RC1_IFCREINFORCEDSOIL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCREINFORCEDSOIL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcReinforcedSoil : public IfcEarthworksElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcReinforcedSoil);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcReinforcedSoil, IfcReinforcedSoil> object.
*/
typedef OdSmartPtr<IfcReinforcedSoil> IfcReinforcedSoilPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCREINFORCEDSOIL_AUTO_IMPL_H
