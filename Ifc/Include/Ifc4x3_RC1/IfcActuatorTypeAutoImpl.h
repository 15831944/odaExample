...
#ifndef _IFC4X3_RC1_IFCACTUATORTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCACTUATORTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcActuatorType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcActuatorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcActuatorType, IfcActuatorType> object.
*/
typedef OdSmartPtr<IfcActuatorType> IfcActuatorTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCACTUATORTYPE_AUTO_IMPL_H
