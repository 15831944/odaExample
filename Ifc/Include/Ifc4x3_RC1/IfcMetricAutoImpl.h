...
#ifndef _IFC4X3_RC1_IFCMETRIC_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMETRIC_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMetric : public IfcConstraint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMetric);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMetric, IfcMetric> object.
*/
typedef OdSmartPtr<IfcMetric> IfcMetricPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMETRIC_AUTO_IMPL_H
