...
#ifndef _IFC4X3_RC1_IFCOCCUPANT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCOCCUPANT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcOccupant : public IfcActor
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcOccupant);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcOccupantTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcOccupant, IfcOccupant> object.
*/
typedef OdSmartPtr<IfcOccupant> IfcOccupantPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCOCCUPANT_AUTO_IMPL_H
