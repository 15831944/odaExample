...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALLOADSINGLEFORCEWARPING_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALLOADSINGLEFORCEWARPING_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralLoadSingleForceWarping : public IfcStructuralLoadSingleForce
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralLoadSingleForceWarping);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralLoadSingleForceWarping, IfcStructuralLoadSingleForceWarping> object.
*/
typedef OdSmartPtr<IfcStructuralLoadSingleForceWarping> IfcStructuralLoadSingleForceWarpingPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALLOADSINGLEFORCEWARPING_AUTO_IMPL_H
