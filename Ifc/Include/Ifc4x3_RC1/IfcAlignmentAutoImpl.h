...
#ifndef _IFC4X3_RC1_IFCALIGNMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCALIGNMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAlignment : public IfcLinearPositioningElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAlignment);
  //DOM-IGNORE-END
...
public:
  ...
  IfcAlignmentTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcAlignmentTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcAlignmentTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAlignment, IfcAlignment> object.
*/
typedef OdSmartPtr<IfcAlignment> IfcAlignmentPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCALIGNMENT_AUTO_IMPL_H
