...
#ifndef _IFC4X3_RC1_IFCCABLEFITTINGTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCABLEFITTINGTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCableFittingType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCableFittingType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcCableFittingTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcCableFittingTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCableFittingTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCableFittingType, IfcCableFittingType> object.
*/
typedef OdSmartPtr<IfcCableFittingType> IfcCableFittingTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCABLEFITTINGTYPE_AUTO_IMPL_H
