...
#ifndef _IFC4X3_RC1_IFCPORT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPORT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPort : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPort);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvContainedIn(OdDAIObjectIds& ContainedIn) const;
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPort, IfcPort> object.
*/
typedef OdSmartPtr<IfcPort> IfcPortPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPORT_AUTO_IMPL_H
