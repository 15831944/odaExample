...
#ifndef _IFC4X3_RC1_IFCDRAUGHTINGPREDEFINEDCURVEFONT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDRAUGHTINGPREDEFINEDCURVEFONT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDraughtingPreDefinedCurveFont : public IfcPreDefinedCurveFont
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDraughtingPreDefinedCurveFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDraughtingPreDefinedCurveFont, IfcDraughtingPreDefinedCurveFont> object.
*/
typedef OdSmartPtr<IfcDraughtingPreDefinedCurveFont> IfcDraughtingPreDefinedCurveFontPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDRAUGHTINGPREDEFINEDCURVEFONT_AUTO_IMPL_H
