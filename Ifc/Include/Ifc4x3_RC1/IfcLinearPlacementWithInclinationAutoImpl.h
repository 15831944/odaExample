...
#ifndef _IFC4X3_RC1_IFCLINEARPLACEMENTWITHINCLINATION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLINEARPLACEMENTWITHINCLINATION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLinearPlacementWithInclination : public IfcLinearPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLinearPlacementWithInclination);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLinearPlacementWithInclination, IfcLinearPlacementWithInclination> object.
*/
typedef OdSmartPtr<IfcLinearPlacementWithInclination> IfcLinearPlacementWithInclinationPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLINEARPLACEMENTWITHINCLINATION_AUTO_IMPL_H
