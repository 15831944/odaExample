...
#ifndef _IFC4X3_RC1_IFCFIRESUPPRESSIONTERMINAL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFIRESUPPRESSIONTERMINAL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFireSuppressionTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFireSuppressionTerminal);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcFireSuppressionTerminalTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFireSuppressionTerminal, IfcFireSuppressionTerminal> object.
*/
typedef OdSmartPtr<IfcFireSuppressionTerminal> IfcFireSuppressionTerminalPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFIRESUPPRESSIONTERMINAL_AUTO_IMPL_H
