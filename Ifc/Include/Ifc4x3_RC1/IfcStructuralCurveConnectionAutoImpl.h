...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALCURVECONNECTION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALCURVECONNECTION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralCurveConnection : public IfcStructuralConnection
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralCurveConnection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralCurveConnection, IfcStructuralCurveConnection> object.
*/
typedef OdSmartPtr<IfcStructuralCurveConnection> IfcStructuralCurveConnectionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALCURVECONNECTION_AUTO_IMPL_H
