...
#ifndef _IFC4X3_RC1_IFCLIGHTSOURCEGONIOMETRIC_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLIGHTSOURCEGONIOMETRIC_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLightSourceGoniometric : public IfcLightSource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLightSourceGoniometric);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLightSourceGoniometric, IfcLightSourceGoniometric> object.
*/
typedef OdSmartPtr<IfcLightSourceGoniometric> IfcLightSourceGoniometricPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLIGHTSOURCEGONIOMETRIC_AUTO_IMPL_H
