...
#ifndef _IFC4X3_RC1_IFCVOIDINGFEATURE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCVOIDINGFEATURE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcVoidingFeature : public IfcFeatureElementSubtraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcVoidingFeature);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcVoidingFeatureTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcVoidingFeature, IfcVoidingFeature> object.
*/
typedef OdSmartPtr<IfcVoidingFeature> IfcVoidingFeaturePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCVOIDINGFEATURE_AUTO_IMPL_H
