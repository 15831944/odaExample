...
#ifndef _IFC4X3_RC1_IFCROAD_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCROAD_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRoad : public IfcFacility
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRoad);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRoad, IfcRoad> object.
*/
typedef OdSmartPtr<IfcRoad> IfcRoadPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCROAD_AUTO_IMPL_H
