...
#ifndef _IFC4X3_RC1_IFCLINEARPLACEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLINEARPLACEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLinearPlacement : public IfcObjectPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLinearPlacement);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getPlacementMeasuredAlong() const;
  void setPlacementMeasuredAlong(const OdDAIObjectId& PlacementMeasuredAlong);
  const OdDAIObjectId& getDistance() const;
  void setDistance(const OdDAIObjectId& Distance);
  const OdDAIObjectId& getOrientation() const;
  void setOrientation(const OdDAIObjectId& Orientation);
  const OdDAIObjectId& getCartesianPosition() const;
  void setCartesianPosition(const OdDAIObjectId& CartesianPosition);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_PlacementMeasuredAlong;   // IfcCurve
  OdDAIObjectId m_Distance;   // IfcDistanceExpression
  OdDAIObjectId m_Orientation;   // IfcOrientationExpression  [optional]
  OdDAIObjectId m_CartesianPosition;   // IfcAxis2Placement3D  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLinearPlacement, IfcLinearPlacement> object.
*/
typedef OdSmartPtr<IfcLinearPlacement> IfcLinearPlacementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLINEARPLACEMENT_AUTO_IMPL_H
