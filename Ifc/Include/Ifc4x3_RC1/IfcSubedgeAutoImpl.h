...
#ifndef _IFC4X3_RC1_IFCSUBEDGE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSUBEDGE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSubedge : public IfcEdge
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSubedge);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSubedge, IfcSubedge> object.
*/
typedef OdSmartPtr<IfcSubedge> IfcSubedgePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSUBEDGE_AUTO_IMPL_H
