...
#ifndef _IFC4X3_RC1_IFCPLANT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPLANT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPlant : public IfcGeographicElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPlant);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPlant, IfcPlant> object.
*/
typedef OdSmartPtr<IfcPlant> IfcPlantPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPLANT_AUTO_IMPL_H
