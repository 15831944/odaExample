...
#ifndef _IFC4X3_RC1_IFCRELASSIGNSTOCONTROL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELASSIGNSTOCONTROL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelAssignsToControl : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelAssignsToControl);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelAssignsToControl, IfcRelAssignsToControl> object.
*/
typedef OdSmartPtr<IfcRelAssignsToControl> IfcRelAssignsToControlPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELASSIGNSTOCONTROL_AUTO_IMPL_H
