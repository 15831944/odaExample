...
#ifndef _IFC4X3_RC1_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPermeableCoveringProperties : public IfcPreDefinedPropertySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPermeableCoveringProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPermeableCoveringProperties, IfcPermeableCoveringProperties> object.
*/
typedef OdSmartPtr<IfcPermeableCoveringProperties> IfcPermeableCoveringPropertiesPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
