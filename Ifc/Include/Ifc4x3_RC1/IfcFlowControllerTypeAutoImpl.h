...
#ifndef _IFC4X3_RC1_IFCFLOWCONTROLLERTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFLOWCONTROLLERTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFlowControllerType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFlowControllerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFlowControllerType, IfcFlowControllerType> object.
*/
typedef OdSmartPtr<IfcFlowControllerType> IfcFlowControllerTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFLOWCONTROLLERTYPE_AUTO_IMPL_H
