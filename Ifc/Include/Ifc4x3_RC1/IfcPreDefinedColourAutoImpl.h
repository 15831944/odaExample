...
#ifndef _IFC4X3_RC1_IFCPREDEFINEDCOLOUR_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPREDEFINEDCOLOUR_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPreDefinedColour : public IfcPreDefinedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPreDefinedColour);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPreDefinedColour, IfcPreDefinedColour> object.
*/
typedef OdSmartPtr<IfcPreDefinedColour> IfcPreDefinedColourPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPREDEFINEDCOLOUR_AUTO_IMPL_H
