...
#ifndef _IFC4X3_RC1_IFCLIBRARYINFORMATION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLIBRARYINFORMATION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLibraryInformation : public IfcExternalInformation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLibraryInformation);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Select m_Publisher;   // IfcActorSelect  [optional]
  OdAnsiString m_VersionDate;   // IfcDateTime  [optional]
  ...
  friend class IfcLibraryReference;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLibraryInformation, IfcLibraryInformation> object.
*/
typedef OdSmartPtr<IfcLibraryInformation> IfcLibraryInformationPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLIBRARYINFORMATION_AUTO_IMPL_H
