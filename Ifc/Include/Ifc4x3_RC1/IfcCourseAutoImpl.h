...
#ifndef _IFC4X3_RC1_IFCCOURSE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCOURSE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCourse : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCourse);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCourse, IfcCourse> object.
*/
typedef OdSmartPtr<IfcCourse> IfcCoursePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCOURSE_AUTO_IMPL_H
