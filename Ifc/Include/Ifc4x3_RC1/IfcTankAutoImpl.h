...
#ifndef _IFC4X3_RC1_IFCTANK_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTANK_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTank : public IfcFlowStorageDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTank);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTank, IfcTank> object.
*/
typedef OdSmartPtr<IfcTank> IfcTankPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTANK_AUTO_IMPL_H
