...
#ifndef _IFC4X3_RC1_IFCCLOSEDSHELL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCLOSEDSHELL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcClosedShell : public IfcConnectedFaceSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcClosedShell);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcClosedShell, IfcClosedShell> object.
*/
typedef OdSmartPtr<IfcClosedShell> IfcClosedShellPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCLOSEDSHELL_AUTO_IMPL_H
