...
#ifndef _IFC4X3_RC1_IFCRESOURCECONSTRAINTRELATIONSHIP_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRESOURCECONSTRAINTRELATIONSHIP_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcResourceConstraintRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcResourceConstraintRelationship);
  //DOM-IGNORE-END
...
public:
  ...
  void getRelatedResourceObjects(OdArray<OdDAI::Select >& RelatedResourceObjects) const;
  void getRelatedResourceObjectsWrapperArray(OdArray<IfcResourceObjectSelect>& RelatedResourceObjects) const;
  OdDAI::Set<OdDAI::Select>& relatedResourceObjects();
...
protected:
  ...
  OdDAI::Set<OdDAI::Select> m_RelatedResourceObjects; // SET [1:?] of IfcResourceObjectSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcResourceConstraintRelationship, IfcResourceConstraintRelationship> object.
*/
typedef OdSmartPtr<IfcResourceConstraintRelationship> IfcResourceConstraintRelationshipPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRESOURCECONSTRAINTRELATIONSHIP_AUTO_IMPL_H
