...
#ifndef _IFC4X3_RC1_IFCCONVERSIONBASEDUNITWITHOFFSET_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCONVERSIONBASEDUNITWITHOFFSET_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcConversionBasedUnitWithOffset : public IfcConversionBasedUnit
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcConversionBasedUnitWithOffset);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_ConversionOffset;   // IfcReal
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcConversionBasedUnitWithOffset, IfcConversionBasedUnitWithOffset> object.
*/
typedef OdSmartPtr<IfcConversionBasedUnitWithOffset> IfcConversionBasedUnitWithOffsetPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCONVERSIONBASEDUNITWITHOFFSET_AUTO_IMPL_H
