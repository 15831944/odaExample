...
#ifndef _IFC4X3_RC1_IFCDERIVEDPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDERIVEDPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDerivedProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDerivedProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDerivedProfileDef, IfcDerivedProfileDef> object.
*/
typedef OdSmartPtr<IfcDerivedProfileDef> IfcDerivedProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDERIVEDPROFILEDEF_AUTO_IMPL_H
