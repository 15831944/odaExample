...
#ifndef _IFC4X3_RC1_IFCGEOMETRICREPRESENTATIONITEM_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCGEOMETRICREPRESENTATIONITEM_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcGeometricRepresentationItem : public IfcRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcGeometricRepresentationItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcGeometricRepresentationItem, IfcGeometricRepresentationItem> object.
*/
typedef OdSmartPtr<IfcGeometricRepresentationItem> IfcGeometricRepresentationItemPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCGEOMETRICREPRESENTATIONITEM_AUTO_IMPL_H
