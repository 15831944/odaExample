...
#ifndef _IFC4X3_RC1_IFCTANKTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTANKTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTankType : public IfcFlowStorageDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTankType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTankType, IfcTankType> object.
*/
typedef OdSmartPtr<IfcTankType> IfcTankTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTANKTYPE_AUTO_IMPL_H
