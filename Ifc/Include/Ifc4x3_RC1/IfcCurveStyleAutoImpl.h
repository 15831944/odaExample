...
#ifndef _IFC4X3_RC1_IFCCURVESTYLE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCURVESTYLE_AUTO_IMPL_H
...
*/
class IFC4X3_RC1_EXPORT IfcCurveStyle : public IfcPresentationStyle
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCurveStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCurveStyle, IfcCurveStyle> object.
*/
typedef OdSmartPtr<IfcCurveStyle> IfcCurveStylePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCURVESTYLE_AUTO_IMPL_H
