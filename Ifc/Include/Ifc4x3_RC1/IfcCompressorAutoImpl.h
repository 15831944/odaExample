...
#ifndef _IFC4X3_RC1_IFCCOMPRESSOR_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCOMPRESSOR_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCompressor : public IfcFlowMovingDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCompressor);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCompressorTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCompressor, IfcCompressor> object.
*/
typedef OdSmartPtr<IfcCompressor> IfcCompressorPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCOMPRESSOR_AUTO_IMPL_H
