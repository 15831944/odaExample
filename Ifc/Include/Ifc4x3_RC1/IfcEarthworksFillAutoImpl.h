...
#ifndef _IFC4X3_RC1_IFCEARTHWORKSFILL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCEARTHWORKSFILL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcEarthworksFill : public IfcEarthworksElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcEarthworksFill);
  //DOM-IGNORE-END
...
public:
  ...
  IfcEarthworksFillTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcEarthworksFillTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcEarthworksFillTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcEarthworksFill, IfcEarthworksFill> object.
*/
typedef OdSmartPtr<IfcEarthworksFill> IfcEarthworksFillPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCEARTHWORKSFILL_AUTO_IMPL_H
