...
#ifndef _IFC4X3_RC1_IFCRECTANGLEHOLLOWPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRECTANGLEHOLLOWPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRectangleHollowProfileDef : public IfcRectangleProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRectangleHollowProfileDef);
  //DOM-IGNORE-END
...
public:
  ...
  void setInnerFilletRadius(double InnerFilletRadius);
  double getOuterFilletRadius() const;
  void setOuterFilletRadius(double OuterFilletRadius);
...
protected:
  // Fields declaration: 
  IfcPositiveLengthMeasure m_WallThickness;   // IfcPositiveLengthMeasure
  IfcNonNegativeLengthMeasure m_InnerFilletRadius;   // IfcNonNegativeLengthMeasure  [optional]
  IfcNonNegativeLengthMeasure m_OuterFilletRadius;   // IfcNonNegativeLengthMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRectangleHollowProfileDef, IfcRectangleHollowProfileDef> object.
*/
typedef OdSmartPtr<IfcRectangleHollowProfileDef> IfcRectangleHollowProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRECTANGLEHOLLOWPROFILEDEF_AUTO_IMPL_H
