...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALACTIVITY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALACTIVITY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralActivity : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralActivity);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralActivity, IfcStructuralActivity> object.
*/
typedef OdSmartPtr<IfcStructuralActivity> IfcStructuralActivityPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALACTIVITY_AUTO_IMPL_H
