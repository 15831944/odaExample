...
#ifndef _IFC4X3_RC1_IFCCOMPOSITECURVESEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCOMPOSITECURVESEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCompositeCurveSegment : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCompositeCurveSegment);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Boolean m_SameSense;   // IfcBoolean
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCompositeCurveSegment, IfcCompositeCurveSegment> object.
*/
typedef OdSmartPtr<IfcCompositeCurveSegment> IfcCompositeCurveSegmentPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCOMPOSITECURVESEGMENT_AUTO_IMPL_H
