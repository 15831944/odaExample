...
#ifndef _IFC4X3_RC1_IFCMEASUREWITHUNIT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMEASUREWITHUNIT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMeasureWithUnit : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMeasureWithUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMeasureWithUnit, IfcMeasureWithUnit> object.
*/
typedef OdSmartPtr<IfcMeasureWithUnit> IfcMeasureWithUnitPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMEASUREWITHUNIT_AUTO_IMPL_H
