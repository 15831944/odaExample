...
#ifndef _IFC4X3_RC1_IFCGRID_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCGRID_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcGrid : public IfcPositioningElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcGrid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcGrid, IfcGrid> object.
*/
typedef OdSmartPtr<IfcGrid> IfcGridPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCGRID_AUTO_IMPL_H
