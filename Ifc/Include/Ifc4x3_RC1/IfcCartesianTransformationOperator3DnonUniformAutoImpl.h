...
#ifndef _IFC4X3_RC1_IFCCARTESIANTRANSFORMATIONOPERATOR3DNONUNIFORM_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCARTESIANTRANSFORMATIONOPERATOR3DNONUNIFORM_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCartesianTransformationOperator3DnonUniform : public IfcCartesianTransformationOperator3D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCartesianTransformationOperator3DnonUniform);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCartesianTransformationOperator3DnonUniform, IfcCartesianTransformationOperator3DnonUniform> object.
*/
typedef OdSmartPtr<IfcCartesianTransformationOperator3DnonUniform> IfcCartesianTransformationOperator3DnonUniformPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCARTESIANTRANSFORMATIONOPERATOR3DNONUNIFORM_AUTO_IMPL_H
