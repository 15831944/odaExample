...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALLOADCASE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALLOADCASE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralLoadCase : public IfcStructuralLoadGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralLoadCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralLoadCase, IfcStructuralLoadCase> object.
*/
typedef OdSmartPtr<IfcStructuralLoadCase> IfcStructuralLoadCasePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALLOADCASE_AUTO_IMPL_H
