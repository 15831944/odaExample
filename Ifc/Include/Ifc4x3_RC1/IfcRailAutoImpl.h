...
#ifndef _IFC4X3_RC1_IFCRAIL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRAIL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRail : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRail);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRail, IfcRail> object.
*/
typedef OdSmartPtr<IfcRail> IfcRailPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRAIL_AUTO_IMPL_H
