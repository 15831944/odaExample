...
#ifndef _IFC4X3_RC1_IFCLIQUIDTERMINAL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLIQUIDTERMINAL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLiquidTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLiquidTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLiquidTerminal, IfcLiquidTerminal> object.
*/
typedef OdSmartPtr<IfcLiquidTerminal> IfcLiquidTerminalPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLIQUIDTERMINAL_AUTO_IMPL_H
