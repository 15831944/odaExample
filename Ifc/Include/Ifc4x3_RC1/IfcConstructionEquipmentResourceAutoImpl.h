...
#ifndef _IFC4X3_RC1_IFCCONSTRUCTIONEQUIPMENTRESOURCE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCONSTRUCTIONEQUIPMENTRESOURCE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcConstructionEquipmentResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcConstructionEquipmentResource);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcConstructionEquipmentResourceTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcConstructionEquipmentResource, IfcConstructionEquipmentResource> object.
*/
typedef OdSmartPtr<IfcConstructionEquipmentResource> IfcConstructionEquipmentResourcePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCONSTRUCTIONEQUIPMENTRESOURCE_AUTO_IMPL_H
