...
#ifndef _IFC4X3_RC1_IFCINDEXEDPOLYGONALFACEWITHVOIDS_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCINDEXEDPOLYGONALFACEWITHVOIDS_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcIndexedPolygonalFaceWithVoids : public IfcIndexedPolygonalFace
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcIndexedPolygonalFaceWithVoids);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcIndexedPolygonalFaceWithVoids, IfcIndexedPolygonalFaceWithVoids> object.
*/
typedef OdSmartPtr<IfcIndexedPolygonalFaceWithVoids> IfcIndexedPolygonalFaceWithVoidsPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCINDEXEDPOLYGONALFACEWITHVOIDS_AUTO_IMPL_H
