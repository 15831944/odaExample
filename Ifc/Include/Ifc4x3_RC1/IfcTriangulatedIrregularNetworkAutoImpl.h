...
#ifndef _IFC4X3_RC1_IFCTRIANGULATEDIRREGULARNETWORK_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTRIANGULATEDIRREGULARNETWORK_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTriangulatedIrregularNetwork : public IfcTriangulatedFaceSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTriangulatedIrregularNetwork);
  //DOM-IGNORE-END
...
public:
  ...
  void getFlags(OdArray<int >& Flags) const;
  OdDAI::IntList& flags();
...
protected:
  // Fields declaration: 
  OdDAI::IntList m_Flags; // LIST [1:?] of IfcInteger
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTriangulatedIrregularNetwork, IfcTriangulatedIrregularNetwork> object.
*/
typedef OdSmartPtr<IfcTriangulatedIrregularNetwork> IfcTriangulatedIrregularNetworkPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTRIANGULATEDIRREGULARNETWORK_AUTO_IMPL_H
