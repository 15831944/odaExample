...
#ifndef _IFC4X3_RC1_IFCBSPLINESURFACE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBSPLINESURFACE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBSplineSurface : public IfcBoundedSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBSplineSurface);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::List<OdDAI::Aggr*> m_ControlPointsList; // LIST [2:?] of LIST [2:?] of IfcCartesianPoint
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBSplineSurface, IfcBSplineSurface> object.
*/
typedef OdSmartPtr<IfcBSplineSurface> IfcBSplineSurfacePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBSPLINESURFACE_AUTO_IMPL_H
