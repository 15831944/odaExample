...
#ifndef _IFC4X3_RC1_IFCPERSONANDORGANIZATION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPERSONANDORGANIZATION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPersonAndOrganization : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPersonAndOrganization);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPersonAndOrganization, IfcPersonAndOrganization> object.
*/
typedef OdSmartPtr<IfcPersonAndOrganization> IfcPersonAndOrganizationPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPERSONANDORGANIZATION_AUTO_IMPL_H
