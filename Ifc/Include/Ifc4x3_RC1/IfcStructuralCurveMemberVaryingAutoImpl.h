...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALCURVEMEMBERVARYING_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALCURVEMEMBERVARYING_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralCurveMemberVarying : public IfcStructuralCurveMember
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralCurveMemberVarying);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralCurveMemberVarying, IfcStructuralCurveMemberVarying> object.
*/
typedef OdSmartPtr<IfcStructuralCurveMemberVarying> IfcStructuralCurveMemberVaryingPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALCURVEMEMBERVARYING_AUTO_IMPL_H
