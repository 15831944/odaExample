...
#ifndef _IFC4X3_RC1_IFCTEXTSTYLETEXTMODEL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTEXTSTYLETEXTMODEL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTextStyleTextModel : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTextStyleTextModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTextStyleTextModel, IfcTextStyleTextModel> object.
*/
typedef OdSmartPtr<IfcTextStyleTextModel> IfcTextStyleTextModelPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTEXTSTYLETEXTMODEL_AUTO_IMPL_H
