...
#ifndef _IFC4X3_RC1_IFCINCLINEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCINCLINEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H

#include "IfcDirectrixDistanceSweptAreaSolidAutoImpl.h"
#include "IfcAxisLateralInclinationAutoImpl.h"
...
class IFC4X3_RC1_EXPORT IfcInclinedReferenceSweptAreaSolid : public IfcDirectrixDistanceSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcInclinedReferenceSweptAreaSolid);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::Boolean getFixedAxisVertical() const;
  void setFixedAxisVertical(OdDAI::Boolean FixedAxisVertical);
  const OdDAIObjectId& getInclinating() const;
  void setInclinating(const OdDAIObjectId& Inclinating);
...
protected:
  // Fields declaration: 
  OdDAI::Boolean m_FixedAxisVertical;   // IfcBoolean  [optional]
  OdDAIObjectId m_Inclinating;   // IfcAxisLateralInclination
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcInclinedReferenceSweptAreaSolid, IfcInclinedReferenceSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcInclinedReferenceSweptAreaSolid> IfcInclinedReferenceSweptAreaSolidPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCINCLINEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
