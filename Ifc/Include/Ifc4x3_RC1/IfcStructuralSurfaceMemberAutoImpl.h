...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralSurfaceMember, IfcStructuralSurfaceMember> object.
*/
typedef OdSmartPtr<IfcStructuralSurfaceMember> IfcStructuralSurfaceMemberPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALSURFACEMEMBER_AUTO_IMPL_H
