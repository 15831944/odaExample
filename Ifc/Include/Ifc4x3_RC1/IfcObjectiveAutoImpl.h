...
#ifndef _IFC4X3_RC1_IFCOBJECTIVE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCOBJECTIVE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcObjective : public IfcConstraint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcObjective);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_BenchmarkValues; // LIST [1:?] of IfcConstraint [optional]

  OdDAI::Enum m_LogicalAggregator;   // IfcLogicalOperatorEnum  [optional]
  OdDAI::Enum m_ObjectiveQualifier;   // IfcObjectiveEnum
  OdAnsiString m_UserDefinedQualifier;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcObjective, IfcObjective> object.
*/
typedef OdSmartPtr<IfcObjective> IfcObjectivePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCOBJECTIVE_AUTO_IMPL_H
