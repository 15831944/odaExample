...
#ifndef _IFC4X3_RC1_IFCEXTENDEDPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCEXTENDEDPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcExtendedProperties : public IfcPropertyAbstraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcExtendedProperties);
  //DOM-IGNORE-END
...
public:
  ...
  void getProperties(OdDAIObjectIds& Properties) const;
  OdDAI::OdDAIObjectIdSet& properties();
...
protected:
  // Fields declaration: 
  OdAnsiString m_Name;   // IfcIdentifier  [optional]
  OdAnsiString m_Description;   // IfcText  [optional]
  OdDAI::OdDAIObjectIdSet m_Properties; // SET [1:?] of IfcProperty
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcExtendedProperties, IfcExtendedProperties> object.
*/
typedef OdSmartPtr<IfcExtendedProperties> IfcExtendedPropertiesPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCEXTENDEDPROPERTIES_AUTO_IMPL_H
