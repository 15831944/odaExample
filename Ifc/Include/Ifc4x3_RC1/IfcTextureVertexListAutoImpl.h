...
#ifndef _IFC4X3_RC1_IFCTEXTUREVERTEXLIST_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTEXTUREVERTEXLIST_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTextureVertexList : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTextureVertexList);
  //DOM-IGNORE-END
...
public:
  ...
  void getTexCoordsList(OdArray<OdArray<double > >& TexCoordsList) const;
  OdDAI::List<OdDAI::Aggr*>& texCoordsList();
...
protected:
  // Fields declaration: 
  OdDAI::List<OdDAI::Aggr*> m_TexCoordsList; // LIST [1:?] of LIST [2:2] of IfcParameterValue
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTextureVertexList, IfcTextureVertexList> object.
*/
typedef OdSmartPtr<IfcTextureVertexList> IfcTextureVertexListPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTEXTUREVERTEXLIST_AUTO_IMPL_H
