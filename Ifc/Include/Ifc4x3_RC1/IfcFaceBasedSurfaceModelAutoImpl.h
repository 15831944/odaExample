...
#ifndef _IFC4X3_RC1_IFCFACEBASEDSURFACEMODEL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFACEBASEDSURFACEMODEL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFaceBasedSurfaceModel : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFaceBasedSurfaceModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFaceBasedSurfaceModel, IfcFaceBasedSurfaceModel> object.
*/
typedef OdSmartPtr<IfcFaceBasedSurfaceModel> IfcFaceBasedSurfaceModelPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFACEBASEDSURFACEMODEL_AUTO_IMPL_H
