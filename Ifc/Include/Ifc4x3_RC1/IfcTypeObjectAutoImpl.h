...
#ifndef _IFC4X3_RC1_IFCTYPEOBJECT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTYPEOBJECT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTypeObject : public IfcObjectDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTypeObject);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdSet& hasPropertySets();
...
protected:
  // Fields declaration: 
  OdAnsiString m_ApplicableOccurrence;   // IfcIdentifier  [optional]
  OdDAI::OdDAIObjectIdSet m_HasPropertySets; // SET [1:?] of IfcPropertySetDefinition [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTypeObject, IfcTypeObject> object.
*/
typedef OdSmartPtr<IfcTypeObject> IfcTypeObjectPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTYPEOBJECT_AUTO_IMPL_H
