...
#ifndef _IFC4X3_RC1_IFCVERTEX_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCVERTEX_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcVertex : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcVertex);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcVertex, IfcVertex> object.
*/
typedef OdSmartPtr<IfcVertex> IfcVertexPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCVERTEX_AUTO_IMPL_H
