...
#ifndef _IFC4X3_RC1_IFCBUILDINGSYSTEM_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBUILDINGSYSTEM_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBuildingSystem : public IfcSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBuildingSystem);
  //DOM-IGNORE-END
...
public:
  ...
  IfcBuildingSystemTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcBuildingSystemTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcBuildingSystemTypeEnum  [optional]
  OdAnsiString m_LongName;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBuildingSystem, IfcBuildingSystem> object.
*/
typedef OdSmartPtr<IfcBuildingSystem> IfcBuildingSystemPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBUILDINGSYSTEM_AUTO_IMPL_H
