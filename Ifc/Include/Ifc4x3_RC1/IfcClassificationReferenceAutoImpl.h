...
#ifndef _IFC4X3_RC1_IFCCLASSIFICATIONREFERENCE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCLASSIFICATIONREFERENCE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcClassificationReference : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcClassificationReference);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getSort() const;
  void setSort(const OdAnsiString& Sort);
  void getInvClassificationRefForObjects(OdDAIObjectIds& ClassificationRefForObjects) const;
...
protected:
  // Fields declaration: 
  OdDAI::Select m_ReferencedSource;   // IfcClassificationReferenceSelect  [optional]
  OdAnsiString m_Description;   // IfcText  [optional]
  OdAnsiString m_Sort;   // IfcIdentifier  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcClassificationReference, IfcClassificationReference> object.
*/
typedef OdSmartPtr<IfcClassificationReference> IfcClassificationReferencePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCLASSIFICATIONREFERENCE_AUTO_IMPL_H
