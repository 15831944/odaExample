...
#ifndef _IFC4X3_RC1_IFCPROPERTYDEFINITION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPROPERTYDEFINITION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPropertyDefinition : public IfcRoot
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPropertyDefinition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPropertyDefinition, IfcPropertyDefinition> object.
*/
typedef OdSmartPtr<IfcPropertyDefinition> IfcPropertyDefinitionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPROPERTYDEFINITION_AUTO_IMPL_H
