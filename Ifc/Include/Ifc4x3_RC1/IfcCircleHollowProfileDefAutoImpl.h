...
#ifndef _IFC4X3_RC1_IFCCIRCLEHOLLOWPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCIRCLEHOLLOWPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCircleHollowProfileDef : public IfcCircleProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCircleHollowProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCircleHollowProfileDef, IfcCircleHollowProfileDef> object.
*/
typedef OdSmartPtr<IfcCircleHollowProfileDef> IfcCircleHollowProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCIRCLEHOLLOWPROFILEDEF_AUTO_IMPL_H
