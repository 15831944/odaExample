...
#ifndef _IFC4X3_RC1_IFCWINDOWSTYLE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCWINDOWSTYLE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcWindowStyle : public IfcTypeProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcWindowStyle);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Boolean m_ParameterTakesPrecedence;   // IfcBoolean
  OdDAI::Boolean m_Sizeable;   // IfcBoolean
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcWindowStyle, IfcWindowStyle> object.
*/
typedef OdSmartPtr<IfcWindowStyle> IfcWindowStylePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCWINDOWSTYLE_AUTO_IMPL_H
