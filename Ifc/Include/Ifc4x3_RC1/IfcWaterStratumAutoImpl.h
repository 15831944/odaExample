...
#ifndef _IFC4X3_RC1_IFCWATERSTRATUM_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCWATERSTRATUM_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcWaterStratum : public IfcGeotechnicalStratum
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcWaterStratum);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcWaterStratum, IfcWaterStratum> object.
*/
typedef OdSmartPtr<IfcWaterStratum> IfcWaterStratumPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCWATERSTRATUM_AUTO_IMPL_H
