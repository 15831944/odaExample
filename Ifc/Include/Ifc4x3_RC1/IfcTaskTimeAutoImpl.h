...
#ifndef _IFC4X3_RC1_IFCTASKTIME_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTASKTIME_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTaskTime : public IfcSchedulingTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTaskTime);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_DurationType;   // IfcTaskDurationEnum  [optional]
  OdAnsiString m_ScheduleDuration;   // IfcDuration  [optional]
  OdAnsiString m_ScheduleStart;   // IfcDateTime  [optional]
  OdAnsiString m_ScheduleFinish;   // IfcDateTime  [optional]
  OdAnsiString m_EarlyStart;   // IfcDateTime  [optional]
  OdAnsiString m_EarlyFinish;   // IfcDateTime  [optional]
  OdAnsiString m_LateStart;   // IfcDateTime  [optional]
  OdAnsiString m_LateFinish;   // IfcDateTime  [optional]
  OdAnsiString m_FreeFloat;   // IfcDuration  [optional]
  OdAnsiString m_TotalFloat;   // IfcDuration  [optional]
  OdDAI::Boolean m_IsCritical;   // IfcBoolean  [optional]
  OdAnsiString m_StatusTime;   // IfcDateTime  [optional]
  OdAnsiString m_ActualDuration;   // IfcDuration  [optional]
  OdAnsiString m_ActualStart;   // IfcDateTime  [optional]
  OdAnsiString m_ActualFinish;   // IfcDateTime  [optional]
  OdAnsiString m_RemainingTime;   // IfcDuration  [optional]
  IfcPositiveRatioMeasure m_Completion;   // IfcPositiveRatioMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTaskTime, IfcTaskTime> object.
*/
typedef OdSmartPtr<IfcTaskTime> IfcTaskTimePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTASKTIME_AUTO_IMPL_H
