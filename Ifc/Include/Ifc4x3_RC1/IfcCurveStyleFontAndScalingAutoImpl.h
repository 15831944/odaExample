...
#ifndef _IFC4X3_RC1_IFCCURVESTYLEFONTANDSCALING_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCURVESTYLEFONTANDSCALING_AUTO_IMPL_H
...
*/
class IFC4X3_RC1_EXPORT IfcCurveStyleFontAndScaling : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCurveStyleFontAndScaling);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCurveStyleFontAndScaling, IfcCurveStyleFontAndScaling> object.
*/
typedef OdSmartPtr<IfcCurveStyleFontAndScaling> IfcCurveStyleFontAndScalingPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCURVESTYLEFONTANDSCALING_AUTO_IMPL_H
