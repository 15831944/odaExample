...
#ifndef _IFC4X3_RC1_IFCMATERIALPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMATERIALPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMaterialProperties : public IfcExtendedProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMaterialProperties);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Material;   // IfcMaterialDefinition
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMaterialProperties, IfcMaterialProperties> object.
*/
typedef OdSmartPtr<IfcMaterialProperties> IfcMaterialPropertiesPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMATERIALPROPERTIES_AUTO_IMPL_H
