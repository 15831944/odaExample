...
#ifndef _IFC4X3_RC1_IFCPERFORMANCEHISTORY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPERFORMANCEHISTORY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPerformanceHistory : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPerformanceHistory);
  //DOM-IGNORE-END
...
public:
  ...
  IfcPerformanceHistoryTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcPerformanceHistoryTypeEnum PredefinedType);
...
protected:
  ...
  OdDAI::Enum m_PredefinedType;   // IfcPerformanceHistoryTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPerformanceHistory, IfcPerformanceHistory> object.
*/
typedef OdSmartPtr<IfcPerformanceHistory> IfcPerformanceHistoryPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPERFORMANCEHISTORY_AUTO_IMPL_H
