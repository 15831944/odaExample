...
#ifndef _IFC4X3_RC1_IFCCOSTITEM_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCOSTITEM_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCostItem : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCostItem);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& costValues();
  void getCostQuantities(OdDAIObjectIds& CostQuantities) const;
  OdDAI::OdDAIObjectIdList& costQuantities();
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCostItemTypeEnum  [optional]
  OdDAI::OdDAIObjectIdList m_CostValues; // LIST [1:?] of IfcCostValue [optional]

  OdDAI::OdDAIObjectIdList m_CostQuantities; // LIST [1:?] of IfcPhysicalQuantity [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCostItem, IfcCostItem> object.
*/
typedef OdSmartPtr<IfcCostItem> IfcCostItemPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCOSTITEM_AUTO_IMPL_H
