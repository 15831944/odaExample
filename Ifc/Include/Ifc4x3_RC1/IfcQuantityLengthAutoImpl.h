...
#ifndef _IFC4X3_RC1_IFCQUANTITYLENGTH_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCQUANTITYLENGTH_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcQuantityLength : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcQuantityLength);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_LengthValue;   // IfcLengthMeasure
  OdAnsiString m_Formula;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcQuantityLength, IfcQuantityLength> object.
*/
typedef OdSmartPtr<IfcQuantityLength> IfcQuantityLengthPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCQUANTITYLENGTH_AUTO_IMPL_H
