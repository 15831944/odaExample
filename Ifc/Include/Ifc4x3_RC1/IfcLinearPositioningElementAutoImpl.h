...
#ifndef _IFC4X3_RC1_IFCLINEARPOSITIONINGELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLINEARPOSITIONINGELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLinearPositioningElement : public IfcPositioningElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLinearPositioningElement);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Axis;   // IfcCurve
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLinearPositioningElement, IfcLinearPositioningElement> object.
*/
typedef OdSmartPtr<IfcLinearPositioningElement> IfcLinearPositioningElementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLINEARPOSITIONINGELEMENT_AUTO_IMPL_H
