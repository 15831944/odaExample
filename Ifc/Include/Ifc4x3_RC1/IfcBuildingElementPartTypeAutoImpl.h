...
#ifndef _IFC4X3_RC1_IFCBUILDINGELEMENTPARTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBUILDINGELEMENTPARTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBuildingElementPartType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBuildingElementPartType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBuildingElementPartType, IfcBuildingElementPartType> object.
*/
typedef OdSmartPtr<IfcBuildingElementPartType> IfcBuildingElementPartTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBUILDINGELEMENTPARTTYPE_AUTO_IMPL_H
