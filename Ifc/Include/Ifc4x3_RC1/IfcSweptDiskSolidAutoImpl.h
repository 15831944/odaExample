...
#ifndef _IFC4X3_RC1_IFCSWEPTDISKSOLID_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSWEPTDISKSOLID_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSweptDiskSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSweptDiskSolid);
  //DOM-IGNORE-END
...
protected:
  ...
  IfcPositiveLengthMeasure m_InnerRadius;   // IfcPositiveLengthMeasure  [optional]
  double m_StartParam;   // IfcParameterValue  [optional]
  double m_EndParam;   // IfcParameterValue  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSweptDiskSolid, IfcSweptDiskSolid> object.
*/
typedef OdSmartPtr<IfcSweptDiskSolid> IfcSweptDiskSolidPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSWEPTDISKSOLID_AUTO_IMPL_H
