...
#ifndef _IFC4X3_RC1_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelServicesBuildings : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelServicesBuildings);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelServicesBuildings, IfcRelServicesBuildings> object.
*/
typedef OdSmartPtr<IfcRelServicesBuildings> IfcRelServicesBuildingsPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
