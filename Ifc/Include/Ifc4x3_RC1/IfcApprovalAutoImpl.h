...
#ifndef _IFC4X3_RC1_IFCAPPROVAL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCAPPROVAL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcApproval : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcApproval);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcApproval, IfcApproval> object.
*/
typedef OdSmartPtr<IfcApproval> IfcApprovalPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCAPPROVAL_AUTO_IMPL_H
