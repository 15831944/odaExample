...
#ifndef _IFC4X3_RC1_IFCROOF_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCROOF_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRoof : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRoof);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcRoofTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRoof, IfcRoof> object.
*/
typedef OdSmartPtr<IfcRoof> IfcRoofPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCROOF_AUTO_IMPL_H
