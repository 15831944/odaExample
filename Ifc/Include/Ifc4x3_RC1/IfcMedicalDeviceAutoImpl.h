...
#ifndef _IFC4X3_RC1_IFCMEDICALDEVICE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMEDICALDEVICE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMedicalDevice : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMedicalDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMedicalDevice, IfcMedicalDevice> object.
*/
typedef OdSmartPtr<IfcMedicalDevice> IfcMedicalDevicePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMEDICALDEVICE_AUTO_IMPL_H
