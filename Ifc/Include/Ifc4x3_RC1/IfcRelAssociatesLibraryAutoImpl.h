...
#ifndef _IFC4X3_RC1_IFCRELASSOCIATESLIBRARY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELASSOCIATESLIBRARY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelAssociatesLibrary : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelAssociatesLibrary);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelAssociatesLibrary, IfcRelAssociatesLibrary> object.
*/
typedef OdSmartPtr<IfcRelAssociatesLibrary> IfcRelAssociatesLibraryPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELASSOCIATESLIBRARY_AUTO_IMPL_H
