...
#ifndef _IFC4X3_RC1_IFCDUCTSILENCER_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDUCTSILENCER_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDuctSilencer : public IfcFlowTreatmentDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDuctSilencer);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcDuctSilencerTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDuctSilencer, IfcDuctSilencer> object.
*/
typedef OdSmartPtr<IfcDuctSilencer> IfcDuctSilencerPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDUCTSILENCER_AUTO_IMPL_H
