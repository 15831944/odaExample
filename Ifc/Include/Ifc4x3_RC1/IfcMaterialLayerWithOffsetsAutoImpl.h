...
#ifndef _IFC4X3_RC1_IFCMATERIALLAYERWITHOFFSETS_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMATERIALLAYERWITHOFFSETS_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMaterialLayerWithOffsets : public IfcMaterialLayer
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMaterialLayerWithOffsets);
  //DOM-IGNORE-END
...
public:
  ...
  IfcLayerSetDirectionEnum getOffsetDirection() const;
  void setOffsetDirection(IfcLayerSetDirectionEnum OffsetDirection);
  void getOffsetValues(OdArray<double >& OffsetValues) const;
  OdDAI::DoubleArray& offsetValues();
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_OffsetDirection;   // IfcLayerSetDirectionEnum
  OdDAI::DoubleArray m_OffsetValues; // ARRAY [1:2] of IfcLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMaterialLayerWithOffsets, IfcMaterialLayerWithOffsets> object.
*/
typedef OdSmartPtr<IfcMaterialLayerWithOffsets> IfcMaterialLayerWithOffsetsPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMATERIALLAYERWITHOFFSETS_AUTO_IMPL_H
