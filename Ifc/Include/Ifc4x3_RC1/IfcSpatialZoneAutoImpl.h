...
#ifndef _IFC4X3_RC1_IFCSPATIALZONE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSPATIALZONE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSpatialZone : public IfcSpatialElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSpatialZone);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSpatialZoneTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSpatialZone, IfcSpatialZone> object.
*/
typedef OdSmartPtr<IfcSpatialZone> IfcSpatialZonePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSPATIALZONE_AUTO_IMPL_H
