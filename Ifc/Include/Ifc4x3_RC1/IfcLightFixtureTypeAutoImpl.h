...
#ifndef _IFC4X3_RC1_IFCLIGHTFIXTURETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLIGHTFIXTURETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLightFixtureType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLightFixtureType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLightFixtureType, IfcLightFixtureType> object.
*/
typedef OdSmartPtr<IfcLightFixtureType> IfcLightFixtureTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLIGHTFIXTURETYPE_AUTO_IMPL_H
