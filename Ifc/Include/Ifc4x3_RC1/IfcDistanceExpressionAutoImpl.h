...
#ifndef _IFC4X3_RC1_IFCDISTANCEEXPRESSION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDISTANCEEXPRESSION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDistanceExpression : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDistanceExpression);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_DistanceAlong;   // IfcLengthMeasure
  ...
  OdDAI::Boolean m_AlongHorizontal;   // IfcBoolean  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDistanceExpression, IfcDistanceExpression> object.
*/
typedef OdSmartPtr<IfcDistanceExpression> IfcDistanceExpressionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDISTANCEEXPRESSION_AUTO_IMPL_H
