...
#ifndef _IFC4X3_RC1_IFCCONNECTIONVOLUMEGEOMETRY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCONNECTIONVOLUMEGEOMETRY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcConnectionVolumeGeometry : public IfcConnectionGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcConnectionVolumeGeometry);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_VolumeOnRelatingElement;   // IfcSolidOrShell
  OdDAI::Select m_VolumeOnRelatedElement;   // IfcSolidOrShell  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcConnectionVolumeGeometry, IfcConnectionVolumeGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionVolumeGeometry> IfcConnectionVolumeGeometryPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCONNECTIONVOLUMEGEOMETRY_AUTO_IMPL_H
