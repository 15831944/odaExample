...
#ifndef _IFC4X3_RC1_IFCELECTRICFLOWTREATMENTDEVICETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCELECTRICFLOWTREATMENTDEVICETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcElectricFlowTreatmentDeviceType : public IfcFlowTreatmentDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcElectricFlowTreatmentDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcElectricFlowTreatmentDeviceType, IfcElectricFlowTreatmentDeviceType> object.
*/
typedef OdSmartPtr<IfcElectricFlowTreatmentDeviceType> IfcElectricFlowTreatmentDeviceTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCELECTRICFLOWTREATMENTDEVICETYPE_AUTO_IMPL_H
