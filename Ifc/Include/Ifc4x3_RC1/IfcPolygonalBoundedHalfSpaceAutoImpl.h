...
#ifndef _IFC4X3_RC1_IFCPOLYGONALBOUNDEDHALFSPACE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPOLYGONALBOUNDEDHALFSPACE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPolygonalBoundedHalfSpace : public IfcHalfSpaceSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPolygonalBoundedHalfSpace);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAIObjectId m_PolygonalBoundary;   // IfcBoundedCurve
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPolygonalBoundedHalfSpace, IfcPolygonalBoundedHalfSpace> object.
*/
typedef OdSmartPtr<IfcPolygonalBoundedHalfSpace> IfcPolygonalBoundedHalfSpacePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPOLYGONALBOUNDEDHALFSPACE_AUTO_IMPL_H
