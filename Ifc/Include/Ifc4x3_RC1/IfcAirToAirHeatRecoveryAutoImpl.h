...
#ifndef _IFC4X3_RC1_IFCAIRTOAIRHEATRECOVERY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCAIRTOAIRHEATRECOVERY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAirToAirHeatRecovery : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAirToAirHeatRecovery);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcAirToAirHeatRecoveryTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAirToAirHeatRecovery, IfcAirToAirHeatRecovery> object.
*/
typedef OdSmartPtr<IfcAirToAirHeatRecovery> IfcAirToAirHeatRecoveryPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCAIRTOAIRHEATRECOVERY_AUTO_IMPL_H
