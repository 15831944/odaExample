...
#ifndef _IFC4X3_RC1_IFCFACILITYPART_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFACILITYPART_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFacilityPart : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFacilityPart);
  //DOM-IGNORE-END
...
public:
  ...
  IfcFacilityPartTypeSelect predefinedType();
  IfcFacilityUsageEnum getUsageType() const;
  void setUsageType(IfcFacilityUsageEnum UsageType);
...
protected:
  // Fields declaration: 
  OdDAI::Select m_PredefinedType;   // IfcFacilityPartTypeSelect
  OdDAI::Enum m_UsageType;   // IfcFacilityUsageEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFacilityPart, IfcFacilityPart> object.
*/
typedef OdSmartPtr<IfcFacilityPart> IfcFacilityPartPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFACILITYPART_AUTO_IMPL_H
