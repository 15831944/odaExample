...
#ifndef _IFC4X3_RC1_IFCMOBILETELECOMMUNICATIONSAPPLIANCE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMOBILETELECOMMUNICATIONSAPPLIANCE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMobileTelecommunicationsAppliance : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMobileTelecommunicationsAppliance);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcMobileTelecommunicationsApplianceTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMobileTelecommunicationsAppliance, IfcMobileTelecommunicationsAppliance> object.
*/
typedef OdSmartPtr<IfcMobileTelecommunicationsAppliance> IfcMobileTelecommunicationsAppliancePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMOBILETELECOMMUNICATIONSAPPLIANCE_AUTO_IMPL_H
