...
#ifndef _IFC4X3_RC1_IFCRELDEFINESBYTEMPLATE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELDEFINESBYTEMPLATE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelDefinesByTemplate : public IfcRelDefines
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelDefinesByTemplate);
  //DOM-IGNORE-END
...
public:
  ...
  void getRelatedPropertySets(OdDAIObjectIds& RelatedPropertySets) const;
  OdDAI::OdDAIObjectIdSet& relatedPropertySets();
  const OdDAIObjectId& getRelatingTemplate() const;
  void setRelatingTemplate(const OdDAIObjectId& RelatingTemplate);
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_RelatedPropertySets; // SET [1:?] of IfcPropertySetDefinition
  OdDAIObjectId m_RelatingTemplate;   // IfcPropertySetTemplate
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelDefinesByTemplate, IfcRelDefinesByTemplate> object.
*/
typedef OdSmartPtr<IfcRelDefinesByTemplate> IfcRelDefinesByTemplatePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELDEFINESBYTEMPLATE_AUTO_IMPL_H
