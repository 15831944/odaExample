...
#ifndef _IFC4X3_RC1_IFCWINDOWSTANDARDCASE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCWINDOWSTANDARDCASE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcWindowStandardCase : public IfcWindow
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcWindowStandardCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcWindowStandardCase, IfcWindowStandardCase> object.
*/
typedef OdSmartPtr<IfcWindowStandardCase> IfcWindowStandardCasePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCWINDOWSTANDARDCASE_AUTO_IMPL_H
