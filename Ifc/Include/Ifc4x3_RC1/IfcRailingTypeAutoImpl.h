...
#ifndef _IFC4X3_RC1_IFCRAILINGTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRAILINGTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRailingType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRailingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRailingType, IfcRailingType> object.
*/
typedef OdSmartPtr<IfcRailingType> IfcRailingTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRAILINGTYPE_AUTO_IMPL_H
