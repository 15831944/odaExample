...
#ifndef _IFC4X3_RC1_IFCCONNECTIONCURVEGEOMETRY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCONNECTIONCURVEGEOMETRY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcConnectionCurveGeometry : public IfcConnectionGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcConnectionCurveGeometry);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcConnectionCurveGeometry, IfcConnectionCurveGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionCurveGeometry> IfcConnectionCurveGeometryPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCONNECTIONCURVEGEOMETRY_AUTO_IMPL_H
