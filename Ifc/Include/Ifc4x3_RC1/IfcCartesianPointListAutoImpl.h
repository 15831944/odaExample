...
#ifndef _IFC4X3_RC1_IFCCARTESIANPOINTLIST_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCARTESIANPOINTLIST_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCartesianPointList : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCartesianPointList);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCartesianPointList, IfcCartesianPointList> object.
*/
typedef OdSmartPtr<IfcCartesianPointList> IfcCartesianPointListPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCARTESIANPOINTLIST_AUTO_IMPL_H
