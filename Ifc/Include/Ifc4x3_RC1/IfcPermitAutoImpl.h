...
#ifndef _IFC4X3_RC1_IFCPERMIT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPERMIT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPermit : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPermit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPermit, IfcPermit> object.
*/
typedef OdSmartPtr<IfcPermit> IfcPermitPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPERMIT_AUTO_IMPL_H
