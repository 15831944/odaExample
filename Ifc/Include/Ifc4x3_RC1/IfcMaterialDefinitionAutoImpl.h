...
#ifndef _IFC4X3_RC1_IFCMATERIALDEFINITION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMATERIALDEFINITION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMaterialDefinition : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMaterialDefinition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMaterialDefinition, IfcMaterialDefinition> object.
*/
typedef OdSmartPtr<IfcMaterialDefinition> IfcMaterialDefinitionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMATERIALDEFINITION_AUTO_IMPL_H
