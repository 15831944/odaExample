...
#ifndef _IFC4X3_RC1_IFCADDRESS_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCADDRESS_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAddress : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAddress);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAddress, IfcAddress> object.
*/
typedef OdSmartPtr<IfcAddress> IfcAddressPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCADDRESS_AUTO_IMPL_H
