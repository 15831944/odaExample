...
#ifndef _IFC4X3_RC1_IFCTENDONTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTENDONTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTendonType : public IfcReinforcingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTendonType);
  //DOM-IGNORE-END
...
public:
  ...
  double getSheathDiameter() const;
  void setSheathDiameter(double SheathDiameter);
...
protected:
  ...
  IfcPositiveLengthMeasure m_SheathDiameter;   // IfcPositiveLengthMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTendonType, IfcTendonType> object.
*/
typedef OdSmartPtr<IfcTendonType> IfcTendonTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTENDONTYPE_AUTO_IMPL_H
