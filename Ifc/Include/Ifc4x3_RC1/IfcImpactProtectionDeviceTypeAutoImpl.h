...
#ifndef _IFC4X3_RC1_IFCIMPACTPROTECTIONDEVICETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCIMPACTPROTECTIONDEVICETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcImpactProtectionDeviceType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcImpactProtectionDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcImpactProtectionDeviceType, IfcImpactProtectionDeviceType> object.
*/
typedef OdSmartPtr<IfcImpactProtectionDeviceType> IfcImpactProtectionDeviceTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCIMPACTPROTECTIONDEVICETYPE_AUTO_IMPL_H
