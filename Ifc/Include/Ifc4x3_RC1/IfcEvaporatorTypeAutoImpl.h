...
#ifndef _IFC4X3_RC1_IFCEVAPORATORTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCEVAPORATORTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcEvaporatorType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcEvaporatorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcEvaporatorType, IfcEvaporatorType> object.
*/
typedef OdSmartPtr<IfcEvaporatorType> IfcEvaporatorTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCEVAPORATORTYPE_AUTO_IMPL_H
