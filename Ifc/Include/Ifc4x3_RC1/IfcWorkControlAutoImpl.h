...
#ifndef _IFC4X3_RC1_IFCWORKCONTROL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCWORKCONTROL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcWorkControl : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcWorkControl);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_CreationDate;   // IfcDateTime
  OdDAI::OdDAIObjectIdSet m_Creators; // SET [1:?] of IfcPerson [optional]

  OdAnsiString m_Purpose;   // IfcLabel  [optional]
  OdAnsiString m_Duration;   // IfcDuration  [optional]
  OdAnsiString m_TotalFloat;   // IfcDuration  [optional]
  OdAnsiString m_StartTime;   // IfcDateTime
  OdAnsiString m_FinishTime;   // IfcDateTime  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcWorkControl, IfcWorkControl> object.
*/
typedef OdSmartPtr<IfcWorkControl> IfcWorkControlPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCWORKCONTROL_AUTO_IMPL_H
