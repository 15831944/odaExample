...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALLOADPLANARFORCE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALLOADPLANARFORCE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralLoadPlanarForce : public IfcStructuralLoadStatic
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralLoadPlanarForce);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralLoadPlanarForce, IfcStructuralLoadPlanarForce> object.
*/
typedef OdSmartPtr<IfcStructuralLoadPlanarForce> IfcStructuralLoadPlanarForcePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALLOADPLANARFORCE_AUTO_IMPL_H
