...
#ifndef _IFC4X3_RC1_IFCCOOLINGTOWER_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCOOLINGTOWER_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCoolingTower : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCoolingTower);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCoolingTowerTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCoolingTower, IfcCoolingTower> object.
*/
typedef OdSmartPtr<IfcCoolingTower> IfcCoolingTowerPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCOOLINGTOWER_AUTO_IMPL_H
