...
#ifndef _IFC4X3_RC1_IFCSWEPTSURFACE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSWEPTSURFACE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSweptSurface : public IfcSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSweptSurface);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAIObjectId m_Position;   // IfcAxis2Placement3D  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSweptSurface, IfcSweptSurface> object.
*/
typedef OdSmartPtr<IfcSweptSurface> IfcSweptSurfacePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSWEPTSURFACE_AUTO_IMPL_H
