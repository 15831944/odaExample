...
#ifndef _IFC4X3_RC1_IFCSURFACESTYLEWITHTEXTURES_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSURFACESTYLEWITHTEXTURES_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSurfaceStyleWithTextures : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSurfaceStyleWithTextures);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& textures();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_Textures; // LIST [1:?] of IfcSurfaceTexture
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSurfaceStyleWithTextures, IfcSurfaceStyleWithTextures> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleWithTextures> IfcSurfaceStyleWithTexturesPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSURFACESTYLEWITHTEXTURES_AUTO_IMPL_H
