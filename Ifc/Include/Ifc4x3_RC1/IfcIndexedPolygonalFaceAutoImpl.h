...
#ifndef _IFC4X3_RC1_IFCINDEXEDPOLYGONALFACE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCINDEXEDPOLYGONALFACE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcIndexedPolygonalFace : public IfcTessellatedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcIndexedPolygonalFace);
  //DOM-IGNORE-END
...
public:
  ...
  void getCoordIndex(OdArray<int >& CoordIndex) const;
  OdDAI::IntList& coordIndex();
  void getInvToFaceSet(OdDAIObjectIds& ToFaceSet) const;
...
protected:
  // Fields declaration: 
  OdDAI::IntList m_CoordIndex; // LIST [3:?] of IfcPositiveInteger

  // Declare friend classes for inverse attributes functionality: 
  friend class IfcPolygonalFaceSet;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcIndexedPolygonalFace, IfcIndexedPolygonalFace> object.
*/
typedef OdSmartPtr<IfcIndexedPolygonalFace> IfcIndexedPolygonalFacePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCINDEXEDPOLYGONALFACE_AUTO_IMPL_H
