...
#ifndef _IFC4X3_RC1_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelDefinesByType : public IfcRelDefines
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelDefinesByType);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdSet& relatedObjects();
  const OdDAIObjectId& getRelatingType() const;
  void setRelatingType(const OdDAIObjectId& RelatingType);
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_RelatedObjects; // SET [1:?] of IfcObject
  OdDAIObjectId m_RelatingType;   // IfcTypeObject
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelDefinesByType, IfcRelDefinesByType> object.
*/
typedef OdSmartPtr<IfcRelDefinesByType> IfcRelDefinesByTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
