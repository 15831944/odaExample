...
#ifndef _IFC4X3_RC1_IFCRELASSOCIATESPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELASSOCIATESPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelAssociatesProfileDef : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelAssociatesProfileDef);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatingProfileDef() const;
  void setRelatingProfileDef(const OdDAIObjectId& RelatingProfileDef);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatingProfileDef;   // IfcProfileDef
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelAssociatesProfileDef, IfcRelAssociatesProfileDef> object.
*/
typedef OdSmartPtr<IfcRelAssociatesProfileDef> IfcRelAssociatesProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELASSOCIATESPROFILEDEF_AUTO_IMPL_H
