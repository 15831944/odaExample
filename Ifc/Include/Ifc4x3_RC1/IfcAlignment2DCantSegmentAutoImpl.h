...
#ifndef _IFC4X3_RC1_IFCALIGNMENT2DCANTSEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCALIGNMENT2DCANTSEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAlignment2DCantSegment : public IfcAlignment2DSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAlignment2DCantSegment);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvToCant(OdDAIObjectIds& ToCant) const;
...
protected:
  // Fields declaration: 
  IfcPositiveLengthMeasure m_StartDistAlong;   // IfcPositiveLengthMeasure
  ...
  friend class IfcAlignment2DCant;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAlignment2DCantSegment, IfcAlignment2DCantSegment> object.
*/
typedef OdSmartPtr<IfcAlignment2DCantSegment> IfcAlignment2DCantSegmentPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCALIGNMENT2DCANTSEGMENT_AUTO_IMPL_H
