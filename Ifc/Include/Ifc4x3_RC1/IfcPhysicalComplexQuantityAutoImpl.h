...
#ifndef _IFC4X3_RC1_IFCPHYSICALCOMPLEXQUANTITY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPHYSICALCOMPLEXQUANTITY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPhysicalComplexQuantity : public IfcPhysicalQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPhysicalComplexQuantity);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPhysicalComplexQuantity, IfcPhysicalComplexQuantity> object.
*/
typedef OdSmartPtr<IfcPhysicalComplexQuantity> IfcPhysicalComplexQuantityPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPHYSICALCOMPLEXQUANTITY_AUTO_IMPL_H
