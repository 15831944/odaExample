...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALLOADCONFIGURATION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALLOADCONFIGURATION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralLoadConfiguration : public IfcStructuralLoad
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralLoadConfiguration);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralLoadConfiguration, IfcStructuralLoadConfiguration> object.
*/
typedef OdSmartPtr<IfcStructuralLoadConfiguration> IfcStructuralLoadConfigurationPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALLOADCONFIGURATION_AUTO_IMPL_H
