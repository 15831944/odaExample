...
#ifndef _IFC4X3_RC1_IFCCABLECARRIERSEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCABLECARRIERSEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCableCarrierSegment : public IfcFlowSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCableCarrierSegment);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCableCarrierSegmentTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCableCarrierSegment, IfcCableCarrierSegment> object.
*/
typedef OdSmartPtr<IfcCableCarrierSegment> IfcCableCarrierSegmentPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCABLECARRIERSEGMENT_AUTO_IMPL_H
