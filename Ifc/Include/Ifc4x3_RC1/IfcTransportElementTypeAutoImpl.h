...
#ifndef _IFC4X3_RC1_IFCTRANSPORTELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTRANSPORTELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTransportElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTransportElementType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcTransportElementTypeSelect predefinedType();
...
protected:
  // Fields declaration: 
  OdDAI::Select m_PredefinedType;   // IfcTransportElementTypeSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTransportElementType, IfcTransportElementType> object.
*/
typedef OdSmartPtr<IfcTransportElementType> IfcTransportElementTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTRANSPORTELEMENTTYPE_AUTO_IMPL_H
