...
#ifndef _IFC4X3_RC1_IFCBRIDGEPART_AUTO_IMPL_H
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBridgePart, IfcBridgePart> object.
*/
typedef OdSmartPtr<IfcBridgePart> IfcBridgePartPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBRIDGEPART_AUTO_IMPL_H
