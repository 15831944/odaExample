...
#ifndef _IFC4X3_RC1_IFCPROPERTYTEMPLATEDEFINITION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPROPERTYTEMPLATEDEFINITION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPropertyTemplateDefinition : public IfcPropertyDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPropertyTemplateDefinition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPropertyTemplateDefinition, IfcPropertyTemplateDefinition> object.
*/
typedef OdSmartPtr<IfcPropertyTemplateDefinition> IfcPropertyTemplateDefinitionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPROPERTYTEMPLATEDEFINITION_AUTO_IMPL_H
