...
#ifndef _IFC4X3_RC1_IFCSURFACESTYLESHADING_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSURFACESTYLESHADING_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSurfaceStyleShading : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSurfaceStyleShading);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSurfaceStyleShading, IfcSurfaceStyleShading> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleShading> IfcSurfaceStyleShadingPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSURFACESTYLESHADING_AUTO_IMPL_H
