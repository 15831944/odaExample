...
#ifndef _IFC4X3_RC1_IFCVERTEXPOINT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCVERTEXPOINT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcVertexPoint : public IfcVertex
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcVertexPoint);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcVertexPoint, IfcVertexPoint> object.
*/
typedef OdSmartPtr<IfcVertexPoint> IfcVertexPointPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCVERTEXPOINT_AUTO_IMPL_H
