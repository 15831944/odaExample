...
#ifndef _IFC4X3_RC1_IFCEXTERNALLYDEFINEDTEXTFONT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCEXTERNALLYDEFINEDTEXTFONT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcExternallyDefinedTextFont : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcExternallyDefinedTextFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcExternallyDefinedTextFont, IfcExternallyDefinedTextFont> object.
*/
typedef OdSmartPtr<IfcExternallyDefinedTextFont> IfcExternallyDefinedTextFontPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCEXTERNALLYDEFINEDTEXTFONT_AUTO_IMPL_H
