...
#ifndef _IFC4X3_RC1_IFCRELASSIGNSTOPRODUCT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELASSIGNSTOPRODUCT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelAssignsToProduct : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelAssignsToProduct);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_RelatingProduct;   // IfcProductSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelAssignsToProduct, IfcRelAssignsToProduct> object.
*/
typedef OdSmartPtr<IfcRelAssignsToProduct> IfcRelAssignsToProductPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELASSIGNSTOPRODUCT_AUTO_IMPL_H
