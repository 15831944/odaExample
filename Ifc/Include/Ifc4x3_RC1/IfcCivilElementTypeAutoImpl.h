...
#ifndef _IFC4X3_RC1_IFCCIVILELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCIVILELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCivilElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCivilElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCivilElementType, IfcCivilElementType> object.
*/
typedef OdSmartPtr<IfcCivilElementType> IfcCivilElementTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCIVILELEMENTTYPE_AUTO_IMPL_H
