...
#ifndef _IFC4X3_RC1_IFCSURFACECURVE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSURFACECURVE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSurfaceCurve : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSurfaceCurve);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getCurve3D() const;
  void setCurve3D(const OdDAIObjectId& Curve3D);
  void getAssociatedGeometry(OdDAIObjectIds& AssociatedGeometry) const;
  OdDAI::OdDAIObjectIdList& associatedGeometry();
  IfcPreferredSurfaceCurveRepresentation getMasterRepresentation() const;
  void setMasterRepresentation(IfcPreferredSurfaceCurveRepresentation MasterRepresentation);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Curve3D;   // IfcCurve
  OdDAI::OdDAIObjectIdList m_AssociatedGeometry; // LIST [1:2] of IfcPcurve
  OdDAI::Enum m_MasterRepresentation;   // IfcPreferredSurfaceCurveRepresentation
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSurfaceCurve, IfcSurfaceCurve> object.
*/
typedef OdSmartPtr<IfcSurfaceCurve> IfcSurfaceCurvePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSURFACECURVE_AUTO_IMPL_H
