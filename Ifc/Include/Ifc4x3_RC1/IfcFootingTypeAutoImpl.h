...
#ifndef _IFC4X3_RC1_IFCFOOTINGTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFOOTINGTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFootingType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFootingType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcFootingTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcFootingTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcFootingTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFootingType, IfcFootingType> object.
*/
typedef OdSmartPtr<IfcFootingType> IfcFootingTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFOOTINGTYPE_AUTO_IMPL_H
