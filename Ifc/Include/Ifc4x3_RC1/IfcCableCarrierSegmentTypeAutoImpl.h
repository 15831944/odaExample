...
#ifndef _IFC4X3_RC1_IFCCABLECARRIERSEGMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCABLECARRIERSEGMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCableCarrierSegmentType : public IfcFlowSegmentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCableCarrierSegmentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCableCarrierSegmentType, IfcCableCarrierSegmentType> object.
*/
typedef OdSmartPtr<IfcCableCarrierSegmentType> IfcCableCarrierSegmentTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCABLECARRIERSEGMENTTYPE_AUTO_IMPL_H
