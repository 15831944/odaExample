...
#ifndef _IFC4X3_RC1_IFCALIGNMENT2DCANTSEGLINE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCALIGNMENT2DCANTSEGLINE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAlignment2DCantSegLine : public IfcAlignment2DCantSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAlignment2DCantSegLine);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAlignment2DCantSegLine, IfcAlignment2DCantSegLine> object.
*/
typedef OdSmartPtr<IfcAlignment2DCantSegLine> IfcAlignment2DCantSegLinePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCALIGNMENT2DCANTSEGLINE_AUTO_IMPL_H
