...
#ifndef _IFC4X3_RC1_IFCORIENTATIONEXPRESSION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCORIENTATIONEXPRESSION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcOrientationExpression : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcOrientationExpression);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getLateralAxisDirection() const;
  void setLateralAxisDirection(const OdDAIObjectId& LateralAxisDirection);
  const OdDAIObjectId& getVerticalAxisDirection() const;
  void setVerticalAxisDirection(const OdDAIObjectId& VerticalAxisDirection);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_LateralAxisDirection;   // IfcDirection
  OdDAIObjectId m_VerticalAxisDirection;   // IfcDirection
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcOrientationExpression, IfcOrientationExpression> object.
*/
typedef OdSmartPtr<IfcOrientationExpression> IfcOrientationExpressionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCORIENTATIONEXPRESSION_AUTO_IMPL_H
