...
#ifndef _IFC4X3_RC1_IFCEXTERNALSPATIALELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCEXTERNALSPATIALELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcExternalSpatialElement : public IfcExternalSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcExternalSpatialElement);
  //DOM-IGNORE-END
...
public:
  ...
  IfcExternalSpatialElementTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcExternalSpatialElementTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcExternalSpatialElementTypeEnum  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcExternalSpatialElement, IfcExternalSpatialElement> object.
*/
typedef OdSmartPtr<IfcExternalSpatialElement> IfcExternalSpatialElementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCEXTERNALSPATIALELEMENT_AUTO_IMPL_H
