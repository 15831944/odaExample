...
#ifndef _IFC4X3_RC1_IFCDISTRIBUTIONPORT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDISTRIBUTIONPORT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDistributionPort : public IfcPort
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDistributionPort);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDistributionPort, IfcDistributionPort> object.
*/
typedef OdSmartPtr<IfcDistributionPort> IfcDistributionPortPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDISTRIBUTIONPORT_AUTO_IMPL_H
