...
#ifndef _IFC4X3_RC1_IFCGEOGRAPHICELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCGEOGRAPHICELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcGeographicElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcGeographicElement);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcGeographicElementTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcGeographicElement, IfcGeographicElement> object.
*/
typedef OdSmartPtr<IfcGeographicElement> IfcGeographicElementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCGEOGRAPHICELEMENT_AUTO_IMPL_H
