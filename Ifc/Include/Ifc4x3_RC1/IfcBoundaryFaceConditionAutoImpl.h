...
#ifndef _IFC4X3_RC1_IFCBOUNDARYFACECONDITION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBOUNDARYFACECONDITION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBoundaryFaceCondition : public IfcBoundaryCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBoundaryFaceCondition);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_TranslationalStiffnessByAreaX;   // IfcModulusOfSubgradeReactionSelect  [optional]
  OdDAI::Select m_TranslationalStiffnessByAreaY;   // IfcModulusOfSubgradeReactionSelect  [optional]
  OdDAI::Select m_TranslationalStiffnessByAreaZ;   // IfcModulusOfSubgradeReactionSelect  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBoundaryFaceCondition, IfcBoundaryFaceCondition> object.
*/
typedef OdSmartPtr<IfcBoundaryFaceCondition> IfcBoundaryFaceConditionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBOUNDARYFACECONDITION_AUTO_IMPL_H
