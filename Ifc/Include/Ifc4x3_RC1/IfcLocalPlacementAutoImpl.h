...
#ifndef _IFC4X3_RC1_IFCLOCALPLACEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLOCALPLACEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLocalPlacement : public IfcObjectPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLocalPlacement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLocalPlacement, IfcLocalPlacement> object.
*/
typedef OdSmartPtr<IfcLocalPlacement> IfcLocalPlacementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLOCALPLACEMENT_AUTO_IMPL_H
