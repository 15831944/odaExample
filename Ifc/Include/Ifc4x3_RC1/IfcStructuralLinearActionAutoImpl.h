...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALLINEARACTION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALLINEARACTION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralLinearAction : public IfcStructuralCurveAction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralLinearAction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralLinearAction, IfcStructuralLinearAction> object.
*/
typedef OdSmartPtr<IfcStructuralLinearAction> IfcStructuralLinearActionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALLINEARACTION_AUTO_IMPL_H
