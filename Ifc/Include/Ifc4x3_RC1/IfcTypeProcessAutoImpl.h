...
#ifndef _IFC4X3_RC1_IFCTYPEPROCESS_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTYPEPROCESS_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTypeProcess : public IfcTypeObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTypeProcess);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getProcessType() const;
  void setProcessType(const OdAnsiString& ProcessType);
...
protected:
  ...
  OdAnsiString m_ProcessType;   // IfcLabel  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTypeProcess, IfcTypeProcess> object.
*/
typedef OdSmartPtr<IfcTypeProcess> IfcTypeProcessPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTYPEPROCESS_AUTO_IMPL_H
