...
#ifndef _IFC4X3_RC1_IFCMEMBERSTANDARDCASE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMEMBERSTANDARDCASE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMemberStandardCase : public IfcMember
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMemberStandardCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMemberStandardCase, IfcMemberStandardCase> object.
*/
typedef OdSmartPtr<IfcMemberStandardCase> IfcMemberStandardCasePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMEMBERSTANDARDCASE_AUTO_IMPL_H
