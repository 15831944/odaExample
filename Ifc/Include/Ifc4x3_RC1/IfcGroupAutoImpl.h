...
#ifndef _IFC4X3_RC1_IFCGROUP_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCGROUP_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcGroup : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcGroup);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcGroup, IfcGroup> object.
*/
typedef OdSmartPtr<IfcGroup> IfcGroupPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCGROUP_AUTO_IMPL_H
