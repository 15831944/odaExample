...
#ifndef _IFC4X3_RC1_IFCTYPERESOURCE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTYPERESOURCE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTypeResource : public IfcTypeObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTypeResource);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getResourceType() const;
  void setResourceType(const OdAnsiString& ResourceType);
...
protected:
  ...
  OdAnsiString m_ResourceType;   // IfcLabel  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTypeResource, IfcTypeResource> object.
*/
typedef OdSmartPtr<IfcTypeResource> IfcTypeResourcePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTYPERESOURCE_AUTO_IMPL_H
