...
#ifndef _IFC4X3_RC1_IFCCONSTRUCTIONRESOURCE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCONSTRUCTIONRESOURCE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcConstructionResource : public IfcResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcConstructionResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcConstructionResource, IfcConstructionResource> object.
*/
typedef OdSmartPtr<IfcConstructionResource> IfcConstructionResourcePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCONSTRUCTIONRESOURCE_AUTO_IMPL_H
