...
#ifndef _IFC4X3_RC1_IFCWINDOW_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCWINDOW_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcWindow : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcWindow);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Enum m_PredefinedType;   // IfcWindowTypeEnum  [optional]
  OdDAI::Enum m_PartitioningType;   // IfcWindowTypePartitioningEnum  [optional]
  OdAnsiString m_UserDefinedPartitioningType;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcWindow, IfcWindow> object.
*/
typedef OdSmartPtr<IfcWindow> IfcWindowPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCWINDOW_AUTO_IMPL_H
