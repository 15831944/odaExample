...
#ifndef _IFC4X3_RC1_IFCRIGHTCIRCULARCONE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRIGHTCIRCULARCONE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRightCircularCone : public IfcCsgPrimitive3D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRightCircularCone);
  //DOM-IGNORE-END
...
protected:
  ...
  IfcPositiveLengthMeasure m_BottomRadius;   // IfcPositiveLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRightCircularCone, IfcRightCircularCone> object.
*/
typedef OdSmartPtr<IfcRightCircularCone> IfcRightCircularConePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRIGHTCIRCULARCONE_AUTO_IMPL_H
