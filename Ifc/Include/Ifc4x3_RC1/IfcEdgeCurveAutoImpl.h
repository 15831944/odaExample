...
#ifndef _IFC4X3_RC1_IFCEDGECURVE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCEDGECURVE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcEdgeCurve : public IfcEdge
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcEdgeCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcEdgeCurve, IfcEdgeCurve> object.
*/
typedef OdSmartPtr<IfcEdgeCurve> IfcEdgeCurvePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCEDGECURVE_AUTO_IMPL_H
