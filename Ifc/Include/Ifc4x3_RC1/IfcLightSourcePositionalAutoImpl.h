...
#ifndef _IFC4X3_RC1_IFCLIGHTSOURCEPOSITIONAL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLIGHTSOURCEPOSITIONAL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLightSourcePositional : public IfcLightSource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLightSourcePositional);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLightSourcePositional, IfcLightSourcePositional> object.
*/
typedef OdSmartPtr<IfcLightSourcePositional> IfcLightSourcePositionalPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLIGHTSOURCEPOSITIONAL_AUTO_IMPL_H
