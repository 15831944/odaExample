...
#ifndef _IFC4X3_RC1_IFCCABLECARRIERFITTING_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCABLECARRIERFITTING_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCableCarrierFitting : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCableCarrierFitting);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCableCarrierFittingTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCableCarrierFitting, IfcCableCarrierFitting> object.
*/
typedef OdSmartPtr<IfcCableCarrierFitting> IfcCableCarrierFittingPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCABLECARRIERFITTING_AUTO_IMPL_H
