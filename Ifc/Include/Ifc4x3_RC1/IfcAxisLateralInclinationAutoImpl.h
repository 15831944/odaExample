...
#ifndef _IFC4X3_RC1_IFCAXISLATERALINCLINATION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCAXISLATERALINCLINATION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAxisLateralInclination : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAxisLateralInclination);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvToLinearAxis(OdDAIObjectIds& ToLinearAxis) const;
...
protected:
  ...
  friend class IfcLinearAxisWithInclination;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAxisLateralInclination, IfcAxisLateralInclination> object.
*/
typedef OdSmartPtr<IfcAxisLateralInclination> IfcAxisLateralInclinationPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCAXISLATERALINCLINATION_AUTO_IMPL_H
