...
#ifndef _IFC4X3_RC1_IFCSENSOR_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSENSOR_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSensor : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSensor);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSensorTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSensor, IfcSensor> object.
*/
typedef OdSmartPtr<IfcSensor> IfcSensorPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSENSOR_AUTO_IMPL_H
