...
#ifndef _IFC4X3_RC1_IFCCARTESIANTRANSFORMATIONOPERATOR3D_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCARTESIANTRANSFORMATIONOPERATOR3D_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCartesianTransformationOperator3D : public IfcCartesianTransformationOperator
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCartesianTransformationOperator3D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCartesianTransformationOperator3D, IfcCartesianTransformationOperator3D> object.
*/
typedef OdSmartPtr<IfcCartesianTransformationOperator3D> IfcCartesianTransformationOperator3DPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCARTESIANTRANSFORMATIONOPERATOR3D_AUTO_IMPL_H
