...
#ifndef _IFC4X3_RC1_IFCMOTORCONNECTION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMOTORCONNECTION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMotorConnection : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMotorConnection);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcMotorConnectionTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMotorConnection, IfcMotorConnection> object.
*/
typedef OdSmartPtr<IfcMotorConnection> IfcMotorConnectionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMOTORCONNECTION_AUTO_IMPL_H
