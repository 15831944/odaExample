...
#ifndef _IFC4X3_RC1_IFCCONSTRUCTIONEQUIPMENTRESOURCETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCONSTRUCTIONEQUIPMENTRESOURCETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcConstructionEquipmentResourceType : public IfcConstructionResourceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcConstructionEquipmentResourceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcConstructionEquipmentResourceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcConstructionEquipmentResourceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcConstructionEquipmentResourceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcConstructionEquipmentResourceType, IfcConstructionEquipmentResourceType> object.
*/
typedef OdSmartPtr<IfcConstructionEquipmentResourceType> IfcConstructionEquipmentResourceTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCONSTRUCTIONEQUIPMENTRESOURCETYPE_AUTO_IMPL_H
