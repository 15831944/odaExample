...
#ifndef _IFC4X3_RC1_IFCREINFORCEMENTDEFINITIONPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCREINFORCEMENTDEFINITIONPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcReinforcementDefinitionProperties : public IfcPreDefinedPropertySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcReinforcementDefinitionProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcReinforcementDefinitionProperties, IfcReinforcementDefinitionProperties> object.
*/
typedef OdSmartPtr<IfcReinforcementDefinitionProperties> IfcReinforcementDefinitionPropertiesPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCREINFORCEMENTDEFINITIONPROPERTIES_AUTO_IMPL_H
