...
#ifndef _IFC4X3_RC1_IFCMOTORCONNECTIONTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMOTORCONNECTIONTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMotorConnectionType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMotorConnectionType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMotorConnectionType, IfcMotorConnectionType> object.
*/
typedef OdSmartPtr<IfcMotorConnectionType> IfcMotorConnectionTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMOTORCONNECTIONTYPE_AUTO_IMPL_H
