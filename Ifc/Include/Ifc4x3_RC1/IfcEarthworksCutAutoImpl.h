...
#ifndef _IFC4X3_RC1_IFCEARTHWORKSCUT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCEARTHWORKSCUT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcEarthworksCut : public IfcFeatureElementSubtraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcEarthworksCut);
  //DOM-IGNORE-END
...
public:
  ...
  IfcEarthworksCutTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcEarthworksCutTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcEarthworksCutTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcEarthworksCut, IfcEarthworksCut> object.
*/
typedef OdSmartPtr<IfcEarthworksCut> IfcEarthworksCutPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCEARTHWORKSCUT_AUTO_IMPL_H
