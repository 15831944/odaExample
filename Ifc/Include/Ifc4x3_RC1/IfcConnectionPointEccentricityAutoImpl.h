...
#ifndef _IFC4X3_RC1_IFCCONNECTIONPOINTECCENTRICITY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCONNECTIONPOINTECCENTRICITY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcConnectionPointEccentricity : public IfcConnectionPointGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcConnectionPointEccentricity);
  //DOM-IGNORE-END
...
public:
  ...
  double getEccentricityInX() const;
  void setEccentricityInX(double EccentricityInX);
  double getEccentricityInY() const;
  void setEccentricityInY(double EccentricityInY);
  double getEccentricityInZ() const;
  void setEccentricityInZ(double EccentricityInZ);
...
protected:
  // Fields declaration: 
  double m_EccentricityInX;   // IfcLengthMeasure  [optional]
  double m_EccentricityInY;   // IfcLengthMeasure  [optional]
  double m_EccentricityInZ;   // IfcLengthMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcConnectionPointEccentricity, IfcConnectionPointEccentricity> object.
*/
typedef OdSmartPtr<IfcConnectionPointEccentricity> IfcConnectionPointEccentricityPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCONNECTIONPOINTECCENTRICITY_AUTO_IMPL_H
