...
#ifndef _IFC4X3_RC1_IFCUNITARYCONTROLELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCUNITARYCONTROLELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcUnitaryControlElementType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcUnitaryControlElementType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcUnitaryControlElementTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcUnitaryControlElementTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcUnitaryControlElementTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcUnitaryControlElementType, IfcUnitaryControlElementType> object.
*/
typedef OdSmartPtr<IfcUnitaryControlElementType> IfcUnitaryControlElementTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCUNITARYCONTROLELEMENTTYPE_AUTO_IMPL_H
