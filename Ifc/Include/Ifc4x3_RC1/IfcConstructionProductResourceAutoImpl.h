...
#ifndef _IFC4X3_RC1_IFCCONSTRUCTIONPRODUCTRESOURCE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCONSTRUCTIONPRODUCTRESOURCE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcConstructionProductResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcConstructionProductResource);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcConstructionProductResourceTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcConstructionProductResource, IfcConstructionProductResource> object.
*/
typedef OdSmartPtr<IfcConstructionProductResource> IfcConstructionProductResourcePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCONSTRUCTIONPRODUCTRESOURCE_AUTO_IMPL_H
