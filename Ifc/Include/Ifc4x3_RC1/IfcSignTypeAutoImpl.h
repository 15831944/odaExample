...
#ifndef _IFC4X3_RC1_IFCSIGNTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSIGNTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSignType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSignType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSignType, IfcSignType> object.
*/
typedef OdSmartPtr<IfcSignType> IfcSignTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSIGNTYPE_AUTO_IMPL_H
