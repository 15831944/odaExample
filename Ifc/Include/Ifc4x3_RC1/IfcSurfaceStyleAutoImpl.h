...
#ifndef _IFC4X3_RC1_IFCSURFACESTYLE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSURFACESTYLE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSurfaceStyle : public IfcPresentationStyle
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSurfaceStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSurfaceStyle, IfcSurfaceStyle> object.
*/
typedef OdSmartPtr<IfcSurfaceStyle> IfcSurfaceStylePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSURFACESTYLE_AUTO_IMPL_H
