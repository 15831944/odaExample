...
#ifndef _IFC4X3_RC1_IFCTRAPEZIUMPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTRAPEZIUMPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTrapeziumProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTrapeziumProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTrapeziumProfileDef, IfcTrapeziumProfileDef> object.
*/
typedef OdSmartPtr<IfcTrapeziumProfileDef> IfcTrapeziumProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTRAPEZIUMPROFILEDEF_AUTO_IMPL_H
