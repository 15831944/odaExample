...
#ifndef _IFC4X3_RC1_IFCFOOTING_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFOOTING_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFooting : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFooting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFooting, IfcFooting> object.
*/
typedef OdSmartPtr<IfcFooting> IfcFootingPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFOOTING_AUTO_IMPL_H
