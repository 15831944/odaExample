...
#ifndef _IFC4X3_RC1_IFCZSHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCZSHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcZShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcZShapeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcZShapeProfileDef, IfcZShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcZShapeProfileDef> IfcZShapeProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCZSHAPEPROFILEDEF_AUTO_IMPL_H
