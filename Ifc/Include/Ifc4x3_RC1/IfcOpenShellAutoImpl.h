...
#ifndef _IFC4X3_RC1_IFCOPENSHELL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCOPENSHELL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcOpenShell : public IfcConnectedFaceSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcOpenShell);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcOpenShell, IfcOpenShell> object.
*/
typedef OdSmartPtr<IfcOpenShell> IfcOpenShellPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCOPENSHELL_AUTO_IMPL_H
