...
#ifndef _IFC4X3_RC1_IFCREINFORCINGBARTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCREINFORCINGBARTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcReinforcingBarType : public IfcReinforcingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcReinforcingBarType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcReinforcingBarType, IfcReinforcingBarType> object.
*/
typedef OdSmartPtr<IfcReinforcingBarType> IfcReinforcingBarTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCREINFORCINGBARTYPE_AUTO_IMPL_H
