...
#ifndef _IFC4X3_RC1_IFCRELDEFINESBYPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELDEFINESBYPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelDefinesByProperties : public IfcRelDefines
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelDefinesByProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelDefinesByProperties, IfcRelDefinesByProperties> object.
*/
typedef OdSmartPtr<IfcRelDefinesByProperties> IfcRelDefinesByPropertiesPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELDEFINESBYPROPERTIES_AUTO_IMPL_H
