...
#ifndef _IFC4X3_RC1_IFCFURNITURETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFURNITURETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFurnitureType : public IfcFurnishingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFurnitureType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcAssemblyPlaceEnum getAssemblyPlace() const;
  void setAssemblyPlace(IfcAssemblyPlaceEnum AssemblyPlace);
  IfcFurnitureTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcFurnitureTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_AssemblyPlace;   // IfcAssemblyPlaceEnum
  OdDAI::Enum m_PredefinedType;   // IfcFurnitureTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFurnitureType, IfcFurnitureType> object.
*/
typedef OdSmartPtr<IfcFurnitureType> IfcFurnitureTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFURNITURETYPE_AUTO_IMPL_H
