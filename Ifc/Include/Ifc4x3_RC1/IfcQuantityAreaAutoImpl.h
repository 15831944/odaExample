...
#ifndef _IFC4X3_RC1_IFCQUANTITYAREA_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCQUANTITYAREA_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcQuantityArea : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcQuantityArea);
  //DOM-IGNORE-END
...
public:
  ...
  void setAreaValue(double AreaValue);
...
protected:
  // Fields declaration: 
  double m_AreaValue;   // IfcAreaMeasure
  OdAnsiString m_Formula;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcQuantityArea, IfcQuantityArea> object.
*/
typedef OdSmartPtr<IfcQuantityArea> IfcQuantityAreaPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCQUANTITYAREA_AUTO_IMPL_H
