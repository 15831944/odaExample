...
#ifndef _IFC4X3_RC1_IFCALIGNMENT2DCANT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCALIGNMENT2DCANT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAlignment2DCant : public IfcAxisLateralInclination
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAlignment2DCant);
  //DOM-IGNORE-END
...
public:
  ...
  double getRailHeadDistance() const;
  void setRailHeadDistance(double RailHeadDistance);
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_Segments; // LIST [1:?] of IfcAlignment2DCantSegment
  IfcPositiveLengthMeasure m_RailHeadDistance;   // IfcPositiveLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAlignment2DCant, IfcAlignment2DCant> object.
*/
typedef OdSmartPtr<IfcAlignment2DCant> IfcAlignment2DCantPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCALIGNMENT2DCANT_AUTO_IMPL_H
