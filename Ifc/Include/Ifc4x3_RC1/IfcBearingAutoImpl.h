...
#ifndef _IFC4X3_RC1_IFCBEARING_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBEARING_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBearing : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBearing);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcBearingTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBearing, IfcBearing> object.
*/
typedef OdSmartPtr<IfcBearing> IfcBearingPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBEARING_AUTO_IMPL_H
