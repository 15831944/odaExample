...
#ifndef _IFC4X3_RC1_IFCTSHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTShapeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTShapeProfileDef, IfcTShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcTShapeProfileDef> IfcTShapeProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTSHAPEPROFILEDEF_AUTO_IMPL_H
