...
#ifndef _IFC4X3_RC1_IFCPIXELTEXTURE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPIXELTEXTURE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPixelTexture : public IfcSurfaceTexture
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPixelTexture);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::OdAnsiStringList m_Pixel; // LIST [1:?] of IfcBinary
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPixelTexture, IfcPixelTexture> object.
*/
typedef OdSmartPtr<IfcPixelTexture> IfcPixelTexturePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPIXELTEXTURE_AUTO_IMPL_H
