...
#ifndef _IFC4X3_RC1_IFCFURNITURE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFURNITURE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFurniture : public IfcFurnishingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFurniture);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFurniture, IfcFurniture> object.
*/
typedef OdSmartPtr<IfcFurniture> IfcFurniturePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFURNITURE_AUTO_IMPL_H
