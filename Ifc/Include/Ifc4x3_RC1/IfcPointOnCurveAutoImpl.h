...
#ifndef _IFC4X3_RC1_IFCPOINTONCURVE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPOINTONCURVE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPointOnCurve : public IfcPoint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPointOnCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPointOnCurve, IfcPointOnCurve> object.
*/
typedef OdSmartPtr<IfcPointOnCurve> IfcPointOnCurvePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPOINTONCURVE_AUTO_IMPL_H
