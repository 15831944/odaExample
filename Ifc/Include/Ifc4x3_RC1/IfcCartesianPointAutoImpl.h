...
#ifndef _IFC4X3_RC1_IFCCARTESIANPOINT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCARTESIANPOINT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCartesianPoint : public IfcPoint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCartesianPoint);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCartesianPoint, IfcCartesianPoint> object.
*/
typedef OdSmartPtr<IfcCartesianPoint> IfcCartesianPointPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCARTESIANPOINT_AUTO_IMPL_H
