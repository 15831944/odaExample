...
#ifndef _IFC4X3_RC1_IFCRELCONNECTSSTRUCTURALACTIVITY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELCONNECTSSTRUCTURALACTIVITY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelConnectsStructuralActivity : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelConnectsStructuralActivity);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelConnectsStructuralActivity, IfcRelConnectsStructuralActivity> object.
*/
typedef OdSmartPtr<IfcRelConnectsStructuralActivity> IfcRelConnectsStructuralActivityPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELCONNECTSSTRUCTURALACTIVITY_AUTO_IMPL_H
