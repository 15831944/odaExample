...
#ifndef _IFC4X3_RC1_IFCAXIS2PLACEMENT2D_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCAXIS2PLACEMENT2D_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAxis2Placement2D : public IfcPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAxis2Placement2D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAxis2Placement2D, IfcAxis2Placement2D> object.
*/
typedef OdSmartPtr<IfcAxis2Placement2D> IfcAxis2Placement2DPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCAXIS2PLACEMENT2D_AUTO_IMPL_H
