...
#ifndef _IFC4X3_RC1_IFCTESSELLATEDFACESET_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTESSELLATEDFACESET_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTessellatedFaceSet : public IfcTessellatedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTessellatedFaceSet);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Coordinates;   // IfcCartesianPointList3D

  // Declare friend classes for inverse attributes functionality: 
  friend class IfcIndexedColourMap;
  friend class IfcIndexedTextureMap;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTessellatedFaceSet, IfcTessellatedFaceSet> object.
*/
typedef OdSmartPtr<IfcTessellatedFaceSet> IfcTessellatedFaceSetPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTESSELLATEDFACESET_AUTO_IMPL_H
