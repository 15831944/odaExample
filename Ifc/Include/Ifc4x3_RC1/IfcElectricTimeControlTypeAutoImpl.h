...
#ifndef _IFC4X3_RC1_IFCELECTRICTIMECONTROLTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCELECTRICTIMECONTROLTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcElectricTimeControlType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcElectricTimeControlType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcElectricTimeControlType, IfcElectricTimeControlType> object.
*/
typedef OdSmartPtr<IfcElectricTimeControlType> IfcElectricTimeControlTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCELECTRICTIMECONTROLTYPE_AUTO_IMPL_H
