...
#ifndef _IFC4X3_RC1_IFCRELFLOWCONTROLELEMENTS_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELFLOWCONTROLELEMENTS_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelFlowControlElements : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelFlowControlElements);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelFlowControlElements, IfcRelFlowControlElements> object.
*/
typedef OdSmartPtr<IfcRelFlowControlElements> IfcRelFlowControlElementsPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELFLOWCONTROLELEMENTS_AUTO_IMPL_H
