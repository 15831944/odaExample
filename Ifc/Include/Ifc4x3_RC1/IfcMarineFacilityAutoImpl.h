...
#ifndef _IFC4X3_RC1_IFCMARINEFACILITY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMARINEFACILITY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMarineFacility : public IfcFacility
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMarineFacility);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcMarineFacilityTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMarineFacility, IfcMarineFacility> object.
*/
typedef OdSmartPtr<IfcMarineFacility> IfcMarineFacilityPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMARINEFACILITY_AUTO_IMPL_H
