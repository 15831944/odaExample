...
#ifndef _IFC4X3_RC1_IFCSIGN_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSIGN_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSign : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSign);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSignTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSign, IfcSign> object.
*/
typedef OdSmartPtr<IfcSign> IfcSignPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSIGN_AUTO_IMPL_H
