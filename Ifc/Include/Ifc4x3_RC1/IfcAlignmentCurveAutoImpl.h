...
#ifndef _IFC4X3_RC1_IFCALIGNMENTCURVE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCALIGNMENTCURVE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAlignmentCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAlignmentCurve);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getHorizontal() const;
  void setHorizontal(const OdDAIObjectId& Horizontal);
  const OdDAIObjectId& getVertical() const;
  void setVertical(const OdDAIObjectId& Vertical);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Horizontal;   // IfcAlignment2DHorizontal
  OdDAIObjectId m_Vertical;   // IfcAlignment2DVertical  [optional]
  OdAnsiString m_Tag;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAlignmentCurve, IfcAlignmentCurve> object.
*/
typedef OdSmartPtr<IfcAlignmentCurve> IfcAlignmentCurvePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCALIGNMENTCURVE_AUTO_IMPL_H
