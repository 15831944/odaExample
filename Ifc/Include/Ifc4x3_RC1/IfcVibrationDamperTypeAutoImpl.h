...
#ifndef _IFC4X3_RC1_IFCVIBRATIONDAMPERTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCVIBRATIONDAMPERTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcVibrationDamperType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcVibrationDamperType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcVibrationDamperTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcVibrationDamperTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcVibrationDamperTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcVibrationDamperType, IfcVibrationDamperType> object.
*/
typedef OdSmartPtr<IfcVibrationDamperType> IfcVibrationDamperTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCVIBRATIONDAMPERTYPE_AUTO_IMPL_H
