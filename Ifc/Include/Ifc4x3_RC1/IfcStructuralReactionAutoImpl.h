...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALREACTION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALREACTION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralReaction : public IfcStructuralActivity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralReaction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralReaction, IfcStructuralReaction> object.
*/
typedef OdSmartPtr<IfcStructuralReaction> IfcStructuralReactionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALREACTION_AUTO_IMPL_H
