...
#ifndef _IFC4X3_RC1_IFCGEOSLICE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCGEOSLICE_AUTO_IMPL_H

#include "IfcGeotechnicalAssemblyAutoImpl.h"
...
class IFC4X3_RC1_EXPORT IfcGeoslice : public IfcGeotechnicalAssembly
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcGeoslice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcGeoslice, IfcGeoslice> object.
*/
typedef OdSmartPtr<IfcGeoslice> IfcGeoslicePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCGEOSLICE_AUTO_IMPL_H
