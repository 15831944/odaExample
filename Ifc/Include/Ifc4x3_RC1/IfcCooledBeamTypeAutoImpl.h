...
#ifndef _IFC4X3_RC1_IFCCOOLEDBEAMTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCOOLEDBEAMTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCooledBeamType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCooledBeamType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCooledBeamType, IfcCooledBeamType> object.
*/
typedef OdSmartPtr<IfcCooledBeamType> IfcCooledBeamTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCOOLEDBEAMTYPE_AUTO_IMPL_H
