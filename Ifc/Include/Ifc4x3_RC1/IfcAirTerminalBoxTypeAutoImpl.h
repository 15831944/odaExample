...
#ifndef _IFC4X3_RC1_IFCAIRTERMINALBOXTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCAIRTERMINALBOXTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAirTerminalBoxType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAirTerminalBoxType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAirTerminalBoxType, IfcAirTerminalBoxType> object.
*/
typedef OdSmartPtr<IfcAirTerminalBoxType> IfcAirTerminalBoxTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCAIRTERMINALBOXTYPE_AUTO_IMPL_H
