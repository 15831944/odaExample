...
#ifndef _IFC4X3_RC1_IFCSIMPLEPROPERTY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSIMPLEPROPERTY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSimpleProperty : public IfcProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSimpleProperty);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSimpleProperty, IfcSimpleProperty> object.
*/
typedef OdSmartPtr<IfcSimpleProperty> IfcSimplePropertyPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSIMPLEPROPERTY_AUTO_IMPL_H
