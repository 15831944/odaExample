...
#ifndef _IFC4X3_RC1_IFCBOUNDARYEDGECONDITION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBOUNDARYEDGECONDITION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBoundaryEdgeCondition : public IfcBoundaryCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBoundaryEdgeCondition);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_TranslationalStiffnessByLengthX;   // IfcModulusOfTranslationalSubgradeReactionSelect  [optional]
  OdDAI::Select m_TranslationalStiffnessByLengthY;   // IfcModulusOfTranslationalSubgradeReactionSelect  [optional]
  OdDAI::Select m_TranslationalStiffnessByLengthZ;   // IfcModulusOfTranslationalSubgradeReactionSelect  [optional]
  OdDAI::Select m_RotationalStiffnessByLengthX;   // IfcModulusOfRotationalSubgradeReactionSelect  [optional]
  OdDAI::Select m_RotationalStiffnessByLengthY;   // IfcModulusOfRotationalSubgradeReactionSelect  [optional]
  OdDAI::Select m_RotationalStiffnessByLengthZ;   // IfcModulusOfRotationalSubgradeReactionSelect  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBoundaryEdgeCondition, IfcBoundaryEdgeCondition> object.
*/
typedef OdSmartPtr<IfcBoundaryEdgeCondition> IfcBoundaryEdgeConditionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBOUNDARYEDGECONDITION_AUTO_IMPL_H
