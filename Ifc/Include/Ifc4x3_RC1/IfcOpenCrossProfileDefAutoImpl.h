...
#ifndef _IFC4X3_RC1_IFCOPENCROSSPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCOPENCROSSPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcOpenCrossProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcOpenCrossProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcOpenCrossProfileDef, IfcOpenCrossProfileDef> object.
*/
typedef OdSmartPtr<IfcOpenCrossProfileDef> IfcOpenCrossProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCOPENCROSSPROFILEDEF_AUTO_IMPL_H
