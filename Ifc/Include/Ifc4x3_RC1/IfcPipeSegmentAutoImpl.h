...
#ifndef _IFC4X3_RC1_IFCPIPESEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPIPESEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPipeSegment : public IfcFlowSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPipeSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPipeSegment, IfcPipeSegment> object.
*/
typedef OdSmartPtr<IfcPipeSegment> IfcPipeSegmentPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPIPESEGMENT_AUTO_IMPL_H
