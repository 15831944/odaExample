...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALLOADTEMPERATURE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALLOADTEMPERATURE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralLoadTemperature : public IfcStructuralLoadStatic
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralLoadTemperature);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralLoadTemperature, IfcStructuralLoadTemperature> object.
*/
typedef OdSmartPtr<IfcStructuralLoadTemperature> IfcStructuralLoadTemperaturePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALLOADTEMPERATURE_AUTO_IMPL_H
