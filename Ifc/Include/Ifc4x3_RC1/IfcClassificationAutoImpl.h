...
#ifndef _IFC4X3_RC1_IFCCLASSIFICATION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCLASSIFICATION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcClassification : public IfcExternalInformation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcClassification);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdAnsiStringList& referenceTokens();
...
protected:
  // Fields declaration: 
  OdAnsiString m_Source;   // IfcLabel  [optional]
  OdAnsiString m_Edition;   // IfcLabel  [optional]
  OdAnsiString m_EditionDate;   // IfcDate  [optional]
  OdAnsiString m_Name;   // IfcLabel
  OdAnsiString m_Description;   // IfcText  [optional]
  OdAnsiString m_Location;   // IfcURIReference  [optional]
  OdDAI::OdAnsiStringList m_ReferenceTokens; // LIST [1:?] of IfcIdentifier [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcClassification, IfcClassification> object.
*/
typedef OdSmartPtr<IfcClassification> IfcClassificationPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCLASSIFICATION_AUTO_IMPL_H
