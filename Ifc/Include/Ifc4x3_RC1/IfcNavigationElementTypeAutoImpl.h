...
#ifndef _IFC4X3_RC1_IFCNAVIGATIONELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCNAVIGATIONELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcNavigationElementType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcNavigationElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcNavigationElementType, IfcNavigationElementType> object.
*/
typedef OdSmartPtr<IfcNavigationElementType> IfcNavigationElementTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCNAVIGATIONELEMENTTYPE_AUTO_IMPL_H
