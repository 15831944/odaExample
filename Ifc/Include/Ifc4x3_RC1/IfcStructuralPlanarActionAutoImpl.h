...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALPLANARACTION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALPLANARACTION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralPlanarAction : public IfcStructuralSurfaceAction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralPlanarAction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralPlanarAction, IfcStructuralPlanarAction> object.
*/
typedef OdSmartPtr<IfcStructuralPlanarAction> IfcStructuralPlanarActionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALPLANARACTION_AUTO_IMPL_H
