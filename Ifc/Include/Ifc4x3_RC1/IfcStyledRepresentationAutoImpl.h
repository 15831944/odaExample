...
#ifndef _IFC4X3_RC1_IFCSTYLEDREPRESENTATION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTYLEDREPRESENTATION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStyledRepresentation : public IfcStyleModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStyledRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStyledRepresentation, IfcStyledRepresentation> object.
*/
typedef OdSmartPtr<IfcStyledRepresentation> IfcStyledRepresentationPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTYLEDREPRESENTATION_AUTO_IMPL_H
