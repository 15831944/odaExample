...
#ifndef _IFC4X3_RC1_IFCALIGNMENT2DHORIZONTAL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCALIGNMENT2DHORIZONTAL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAlignment2DHorizontal : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAlignment2DHorizontal);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& segments();
  void getInvToAlignmentCurve(OdDAIObjectIds& ToAlignmentCurve) const;
...
protected:
  // Fields declaration: 
  double m_StartDistAlong;   // IfcLengthMeasure  [optional]
  OdDAI::OdDAIObjectIdList m_Segments; // LIST [1:?] of IfcAlignment2DHorizontalSegment

  // Declare friend classes for inverse attributes functionality: 
  friend class IfcAlignmentCurve;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAlignment2DHorizontal, IfcAlignment2DHorizontal> object.
*/
typedef OdSmartPtr<IfcAlignment2DHorizontal> IfcAlignment2DHorizontalPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCALIGNMENT2DHORIZONTAL_AUTO_IMPL_H
