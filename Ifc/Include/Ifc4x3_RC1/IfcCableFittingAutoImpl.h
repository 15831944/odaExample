...
#ifndef _IFC4X3_RC1_IFCCABLEFITTING_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCABLEFITTING_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCableFitting : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCableFitting);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCableFittingTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCableFitting, IfcCableFitting> object.
*/
typedef OdSmartPtr<IfcCableFitting> IfcCableFittingPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCABLEFITTING_AUTO_IMPL_H
