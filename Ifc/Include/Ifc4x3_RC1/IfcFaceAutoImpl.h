...
#ifndef _IFC4X3_RC1_IFCFACE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFACE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFace : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFace);
  //DOM-IGNORE-END
...
public:
  ...
  void getBounds(OdDAIObjectIds& Bounds) const;
  OdDAI::OdDAIObjectIdSet& bounds();
  void getInvHasTextureMaps(OdDAIObjectIds& HasTextureMaps) const;
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_Bounds; // SET [1:?] of IfcFaceBound

  // Declare friend classes for inverse attributes functionality: 
  friend class IfcTextureMap;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFace, IfcFace> object.
*/
typedef OdSmartPtr<IfcFace> IfcFacePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFACE_AUTO_IMPL_H
