...
#ifndef _IFC4X3_RC1_IFCFASTENER_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFASTENER_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFastener : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFastener);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFastener, IfcFastener> object.
*/
typedef OdSmartPtr<IfcFastener> IfcFastenerPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFASTENER_AUTO_IMPL_H
