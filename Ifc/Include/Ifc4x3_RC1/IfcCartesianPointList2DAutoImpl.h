...
#ifndef _IFC4X3_RC1_IFCCARTESIANPOINTLIST2D_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCARTESIANPOINTLIST2D_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCartesianPointList2D : public IfcCartesianPointList
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCartesianPointList2D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCartesianPointList2D, IfcCartesianPointList2D> object.
*/
typedef OdSmartPtr<IfcCartesianPointList2D> IfcCartesianPointList2DPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCARTESIANPOINTLIST2D_AUTO_IMPL_H
