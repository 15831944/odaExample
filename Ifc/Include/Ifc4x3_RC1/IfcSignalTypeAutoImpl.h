...
#ifndef _IFC4X3_RC1_IFCSIGNALTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSIGNALTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSignalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSignalType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSignalType, IfcSignalType> object.
*/
typedef OdSmartPtr<IfcSignalType> IfcSignalTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSIGNALTYPE_AUTO_IMPL_H
