...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALANALYSISMODEL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALANALYSISMODEL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralAnalysisModel : public IfcSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralAnalysisModel);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcAnalysisModelTypeEnum
  OdDAIObjectId m_OrientationOf2DPlane;   // IfcAxis2Placement3D  [optional]
  OdDAI::OdDAIObjectIdSet m_LoadedBy; // SET [1:?] of IfcStructuralLoadGroup [optional]

  OdDAI::OdDAIObjectIdSet m_HasResults; // SET [1:?] of IfcStructuralResultGroup [optional]

  OdDAIObjectId m_SharedPlacement;   // IfcObjectPlacement  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralAnalysisModel, IfcStructuralAnalysisModel> object.
*/
typedef OdSmartPtr<IfcStructuralAnalysisModel> IfcStructuralAnalysisModelPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALANALYSISMODEL_AUTO_IMPL_H
