...
#ifndef _IFC4X3_RC1_IFCSPATIALZONETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSPATIALZONETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSpatialZoneType : public IfcSpatialElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSpatialZoneType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcSpatialZoneTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcSpatialZoneTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSpatialZoneTypeEnum
  OdAnsiString m_LongName;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSpatialZoneType, IfcSpatialZoneType> object.
*/
typedef OdSmartPtr<IfcSpatialZoneType> IfcSpatialZoneTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSPATIALZONETYPE_AUTO_IMPL_H
