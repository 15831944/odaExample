...
#ifndef _IFC4X3_RC1_IFCCAISSONFOUNDATION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCAISSONFOUNDATION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCaissonFoundation : public IfcDeepFoundation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCaissonFoundation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCaissonFoundation, IfcCaissonFoundation> object.
*/
typedef OdSmartPtr<IfcCaissonFoundation> IfcCaissonFoundationPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCAISSONFOUNDATION_AUTO_IMPL_H
