...
#ifndef _IFC4X3_RC1_IFCCONNECTIONPOINTGEOMETRY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCONNECTIONPOINTGEOMETRY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcConnectionPointGeometry : public IfcConnectionGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcConnectionPointGeometry);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_PointOnRelatingElement;   // IfcPointOrVertexPoint
  OdDAI::Select m_PointOnRelatedElement;   // IfcPointOrVertexPoint  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcConnectionPointGeometry, IfcConnectionPointGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionPointGeometry> IfcConnectionPointGeometryPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCONNECTIONPOINTGEOMETRY_AUTO_IMPL_H
