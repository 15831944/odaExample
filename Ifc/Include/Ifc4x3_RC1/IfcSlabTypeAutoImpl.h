...
#ifndef _IFC4X3_RC1_IFCSLABTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSLABTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSlabType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSlabType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSlabType, IfcSlabType> object.
*/
typedef OdSmartPtr<IfcSlabType> IfcSlabTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSLABTYPE_AUTO_IMPL_H
