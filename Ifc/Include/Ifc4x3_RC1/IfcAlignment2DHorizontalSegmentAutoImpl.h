...
#ifndef _IFC4X3_RC1_IFCALIGNMENT2DHORIZONTALSEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCALIGNMENT2DHORIZONTALSEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAlignment2DHorizontalSegment : public IfcAlignment2DSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAlignment2DHorizontalSegment);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getCurveGeometry() const;
  void setCurveGeometry(const OdDAIObjectId& CurveGeometry);
  void getInvToHorizontal(OdDAIObjectIds& ToHorizontal) const;
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_CurveGeometry;   // IfcCurveSegment2D

  // Declare friend classes for inverse attributes functionality: 
  friend class IfcAlignment2DHorizontal;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAlignment2DHorizontalSegment, IfcAlignment2DHorizontalSegment> object.
*/
typedef OdSmartPtr<IfcAlignment2DHorizontalSegment> IfcAlignment2DHorizontalSegmentPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCALIGNMENT2DHORIZONTALSEGMENT_AUTO_IMPL_H
