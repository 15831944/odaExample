...
#ifndef _IFC4X3_RC1_IFCLABORRESOURCETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLABORRESOURCETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLaborResourceType : public IfcConstructionResourceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLaborResourceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcLaborResourceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcLaborResourceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcLaborResourceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLaborResourceType, IfcLaborResourceType> object.
*/
typedef OdSmartPtr<IfcLaborResourceType> IfcLaborResourceTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLABORRESOURCETYPE_AUTO_IMPL_H
