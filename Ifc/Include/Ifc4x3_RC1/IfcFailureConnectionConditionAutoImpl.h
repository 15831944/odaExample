...
#ifndef _IFC4X3_RC1_IFCFAILURECONNECTIONCONDITION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFAILURECONNECTIONCONDITION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFailureConnectionCondition : public IfcStructuralConnectionCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFailureConnectionCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFailureConnectionCondition, IfcFailureConnectionCondition> object.
*/
typedef OdSmartPtr<IfcFailureConnectionCondition> IfcFailureConnectionConditionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFAILURECONNECTIONCONDITION_AUTO_IMPL_H
