...
#ifndef _IFC4X3_RC1_IFCCOLUMNSTANDARDCASE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCOLUMNSTANDARDCASE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcColumnStandardCase : public IfcColumn
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcColumnStandardCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcColumnStandardCase, IfcColumnStandardCase> object.
*/
typedef OdSmartPtr<IfcColumnStandardCase> IfcColumnStandardCasePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCOLUMNSTANDARDCASE_AUTO_IMPL_H
