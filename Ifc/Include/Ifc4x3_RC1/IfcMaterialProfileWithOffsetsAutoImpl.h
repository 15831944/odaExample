...
#ifndef _IFC4X3_RC1_IFCMATERIALPROFILEWITHOFFSETS_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMATERIALPROFILEWITHOFFSETS_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMaterialProfileWithOffsets : public IfcMaterialProfile
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMaterialProfileWithOffsets);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMaterialProfileWithOffsets, IfcMaterialProfileWithOffsets> object.
*/
typedef OdSmartPtr<IfcMaterialProfileWithOffsets> IfcMaterialProfileWithOffsetsPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMATERIALPROFILEWITHOFFSETS_AUTO_IMPL_H
