...
#ifndef _IFC4X3_RC1_IFCTUBEBUNDLETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTUBEBUNDLETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTubeBundleType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTubeBundleType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTubeBundleType, IfcTubeBundleType> object.
*/
typedef OdSmartPtr<IfcTubeBundleType> IfcTubeBundleTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTUBEBUNDLETYPE_AUTO_IMPL_H
