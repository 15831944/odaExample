...
#ifndef _IFC4X3_RC1_IFCPROPERTYLISTVALUE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPROPERTYLISTVALUE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPropertyListValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPropertyListValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPropertyListValue, IfcPropertyListValue> object.
*/
typedef OdSmartPtr<IfcPropertyListValue> IfcPropertyListValuePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPROPERTYLISTVALUE_AUTO_IMPL_H
