...
#ifndef _IFC4X3_RC1_IFCSTAIRTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTAIRTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStairType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStairType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcStairTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcStairTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcStairTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStairType, IfcStairType> object.
*/
typedef OdSmartPtr<IfcStairType> IfcStairTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTAIRTYPE_AUTO_IMPL_H
