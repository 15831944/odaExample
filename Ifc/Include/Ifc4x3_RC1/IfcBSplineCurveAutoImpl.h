...
#ifndef _IFC4X3_RC1_IFCBSPLINECURVE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBSPLINECURVE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBSplineCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBSplineCurve);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  int m_Degree;   // IfcInteger
  OdDAI::OdDAIObjectIdList m_ControlPointsList; // LIST [2:?] of IfcCartesianPoint
  OdDAI::Enum m_CurveForm;   // IfcBSplineCurveForm
  OdDAI::Logical m_ClosedCurve;   // IfcLogical
  OdDAI::Logical m_SelfIntersect;   // IfcLogical
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBSplineCurve, IfcBSplineCurve> object.
*/
typedef OdSmartPtr<IfcBSplineCurve> IfcBSplineCurvePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBSPLINECURVE_AUTO_IMPL_H
