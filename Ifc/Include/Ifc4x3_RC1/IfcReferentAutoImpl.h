...
#ifndef _IFC4X3_RC1_IFCREFERENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCREFERENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcReferent : public IfcPositioningElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcReferent);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcReferent, IfcReferent> object.
*/
typedef OdSmartPtr<IfcReferent> IfcReferentPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCREFERENT_AUTO_IMPL_H
