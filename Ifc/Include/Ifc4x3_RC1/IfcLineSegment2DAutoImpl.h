...
#ifndef _IFC4X3_RC1_IFCLINESEGMENT2D_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLINESEGMENT2D_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLineSegment2D : public IfcCurveSegment2D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLineSegment2D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLineSegment2D, IfcLineSegment2D> object.
*/
typedef OdSmartPtr<IfcLineSegment2D> IfcLineSegment2DPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLINESEGMENT2D_AUTO_IMPL_H
