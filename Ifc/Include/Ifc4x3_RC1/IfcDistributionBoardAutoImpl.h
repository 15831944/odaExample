...
#ifndef _IFC4X3_RC1_IFCDISTRIBUTIONBOARD_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDISTRIBUTIONBOARD_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDistributionBoard : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDistributionBoard);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcDistributionBoardTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDistributionBoard, IfcDistributionBoard> object.
*/
typedef OdSmartPtr<IfcDistributionBoard> IfcDistributionBoardPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDISTRIBUTIONBOARD_AUTO_IMPL_H
