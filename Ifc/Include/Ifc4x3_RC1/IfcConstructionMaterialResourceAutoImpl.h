...
#ifndef _IFC4X3_RC1_IFCCONSTRUCTIONMATERIALRESOURCE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCONSTRUCTIONMATERIALRESOURCE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcConstructionMaterialResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcConstructionMaterialResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcConstructionMaterialResource, IfcConstructionMaterialResource> object.
*/
typedef OdSmartPtr<IfcConstructionMaterialResource> IfcConstructionMaterialResourcePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCONSTRUCTIONMATERIALRESOURCE_AUTO_IMPL_H
