...
#ifndef _IFC4X3_RC1_IFCDOORSTANDARDCASE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDOORSTANDARDCASE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDoorStandardCase : public IfcDoor
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDoorStandardCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDoorStandardCase, IfcDoorStandardCase> object.
*/
typedef OdSmartPtr<IfcDoorStandardCase> IfcDoorStandardCasePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDOORSTANDARDCASE_AUTO_IMPL_H
