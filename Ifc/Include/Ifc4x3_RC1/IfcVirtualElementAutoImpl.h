...
#ifndef _IFC4X3_RC1_IFCVIRTUALELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCVIRTUALELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcVirtualElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcVirtualElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcVirtualElement, IfcVirtualElement> object.
*/
typedef OdSmartPtr<IfcVirtualElement> IfcVirtualElementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCVIRTUALELEMENT_AUTO_IMPL_H
