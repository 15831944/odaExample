...
#ifndef _IFC4X3_RC1_IFCDIRECTRIXCURVESWEPTAREASOLID_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDIRECTRIXCURVESWEPTAREASOLID_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDirectrixCurveSweptAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDirectrixCurveSweptAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDirectrixCurveSweptAreaSolid, IfcDirectrixCurveSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcDirectrixCurveSweptAreaSolid> IfcDirectrixCurveSweptAreaSolidPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDIRECTRIXCURVESWEPTAREASOLID_AUTO_IMPL_H
