...
#ifndef _IFC4X3_RC1_IFCSHADINGDEVICETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSHADINGDEVICETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcShadingDeviceType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcShadingDeviceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcShadingDeviceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcShadingDeviceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcShadingDeviceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcShadingDeviceType, IfcShadingDeviceType> object.
*/
typedef OdSmartPtr<IfcShadingDeviceType> IfcShadingDeviceTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSHADINGDEVICETYPE_AUTO_IMPL_H
