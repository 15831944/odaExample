...
#ifndef _IFC4X3_RC1_IFCCOMPOSITEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCOMPOSITEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCompositeProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCompositeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCompositeProfileDef, IfcCompositeProfileDef> object.
*/
typedef OdSmartPtr<IfcCompositeProfileDef> IfcCompositeProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCOMPOSITEPROFILEDEF_AUTO_IMPL_H
