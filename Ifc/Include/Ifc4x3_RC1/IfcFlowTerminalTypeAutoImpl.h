...
#ifndef _IFC4X3_RC1_IFCFLOWTERMINALTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFLOWTERMINALTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFlowTerminalType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFlowTerminalType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFlowTerminalType, IfcFlowTerminalType> object.
*/
typedef OdSmartPtr<IfcFlowTerminalType> IfcFlowTerminalTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFLOWTERMINALTYPE_AUTO_IMPL_H
