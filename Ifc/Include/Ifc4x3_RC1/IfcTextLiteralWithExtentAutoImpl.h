...
#ifndef _IFC4X3_RC1_IFCTEXTLITERALWITHEXTENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTEXTLITERALWITHEXTENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTextLiteralWithExtent : public IfcTextLiteral
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTextLiteralWithExtent);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTextLiteralWithExtent, IfcTextLiteralWithExtent> object.
*/
typedef OdSmartPtr<IfcTextLiteralWithExtent> IfcTextLiteralWithExtentPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTEXTLITERALWITHEXTENT_AUTO_IMPL_H
