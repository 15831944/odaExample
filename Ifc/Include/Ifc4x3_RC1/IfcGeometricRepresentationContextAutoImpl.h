...
#ifndef _IFC4X3_RC1_IFCGEOMETRICREPRESENTATIONCONTEXT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCGEOMETRICREPRESENTATIONCONTEXT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcGeometricRepresentationContext : public IfcRepresentationContext
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcGeometricRepresentationContext);
  //DOM-IGNORE-END
...
protected:
  ...
  double m_Precision;   // IfcReal  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcGeometricRepresentationContext, IfcGeometricRepresentationContext> object.
*/
typedef OdSmartPtr<IfcGeometricRepresentationContext> IfcGeometricRepresentationContextPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCGEOMETRICREPRESENTATIONCONTEXT_AUTO_IMPL_H
