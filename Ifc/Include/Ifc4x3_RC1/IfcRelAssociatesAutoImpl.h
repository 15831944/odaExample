...
#ifndef _IFC4X3_RC1_IFCRELASSOCIATES_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELASSOCIATES_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelAssociates : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelAssociates);
  //DOM-IGNORE-END
...
public:
  ...
  void getRelatedObjects(OdArray<OdDAI::Select >& RelatedObjects) const;
  void getRelatedObjectsWrapperArray(OdArray<IfcDefinitionSelect>& RelatedObjects) const;
  OdDAI::Set<OdDAI::Select>& relatedObjects();
...
protected:
  // Fields declaration: 
  OdDAI::Set<OdDAI::Select> m_RelatedObjects; // SET [1:?] of IfcDefinitionSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelAssociates, IfcRelAssociates> object.
*/
typedef OdSmartPtr<IfcRelAssociates> IfcRelAssociatesPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELASSOCIATES_AUTO_IMPL_H
