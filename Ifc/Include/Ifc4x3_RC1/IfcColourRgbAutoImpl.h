...
#ifndef _IFC4X3_RC1_IFCCOLOURRGB_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCOLOURRGB_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcColourRgb : public IfcColourSpecification
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcColourRgb);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcColourRgb, IfcColourRgb> object.
*/
typedef OdSmartPtr<IfcColourRgb> IfcColourRgbPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCOLOURRGB_AUTO_IMPL_H
