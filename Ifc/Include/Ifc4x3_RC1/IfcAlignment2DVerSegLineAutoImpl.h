...
#ifndef _IFC4X3_RC1_IFCALIGNMENT2DVERSEGLINE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCALIGNMENT2DVERSEGLINE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAlignment2DVerSegLine : public IfcAlignment2DVerticalSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAlignment2DVerSegLine);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAlignment2DVerSegLine, IfcAlignment2DVerSegLine> object.
*/
typedef OdSmartPtr<IfcAlignment2DVerSegLine> IfcAlignment2DVerSegLinePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCALIGNMENT2DVERSEGLINE_AUTO_IMPL_H
