...
#ifndef _IFC4X3_RC1_IFCMECHANICALFASTENER_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMECHANICALFASTENER_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMechanicalFastener : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMechanicalFastener);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Enum m_PredefinedType;   // IfcMechanicalFastenerTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMechanicalFastener, IfcMechanicalFastener> object.
*/
typedef OdSmartPtr<IfcMechanicalFastener> IfcMechanicalFastenerPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMECHANICALFASTENER_AUTO_IMPL_H
