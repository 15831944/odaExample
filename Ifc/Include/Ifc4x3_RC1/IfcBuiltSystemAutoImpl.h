...
#ifndef _IFC4X3_RC1_IFCBUILTSYSTEM_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBUILTSYSTEM_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBuiltSystem : public IfcSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBuiltSystem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBuiltSystem, IfcBuiltSystem> object.
*/
typedef OdSmartPtr<IfcBuiltSystem> IfcBuiltSystemPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBUILTSYSTEM_AUTO_IMPL_H
