...
#ifndef _IFC4X3_RC1_IFCPAVEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPAVEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPavementType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPavementType);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::Boolean getFlexible() const;
  void setFlexible(OdDAI::Boolean Flexible);
...
protected:
  // Fields declaration: 
  OdDAI::Boolean m_Flexible;   // IfcBoolean
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPavementType, IfcPavementType> object.
*/
typedef OdSmartPtr<IfcPavementType> IfcPavementTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPAVEMENTTYPE_AUTO_IMPL_H
