...
#ifndef _IFC4X3_RC1_IFCRELAGGREGATES_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELAGGREGATES_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelAggregates : public IfcRelDecomposes
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelAggregates);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatingObject;   // IfcObjectDefinition
  OdDAI::OdDAIObjectIdSet m_RelatedObjects; // SET [1:?] of IfcObjectDefinition
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelAggregates, IfcRelAggregates> object.
*/
typedef OdSmartPtr<IfcRelAggregates> IfcRelAggregatesPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELAGGREGATES_AUTO_IMPL_H
