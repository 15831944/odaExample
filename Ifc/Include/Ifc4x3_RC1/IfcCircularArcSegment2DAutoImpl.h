...
#ifndef _IFC4X3_RC1_IFCCIRCULARARCSEGMENT2D_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCIRCULARARCSEGMENT2D_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCircularArcSegment2D : public IfcCurveSegment2D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCircularArcSegment2D);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::Boolean getIsCCW() const;
  void setIsCCW(OdDAI::Boolean IsCCW);
...
protected:
  ...
  OdDAI::Boolean m_IsCCW;   // IfcBoolean
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCircularArcSegment2D, IfcCircularArcSegment2D> object.
*/
typedef OdSmartPtr<IfcCircularArcSegment2D> IfcCircularArcSegment2DPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCIRCULARARCSEGMENT2D_AUTO_IMPL_H
