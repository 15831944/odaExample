...
#ifndef _IFC4X3_RC1_IFCRELCONNECTS_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELCONNECTS_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelConnects : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelConnects);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelConnects, IfcRelConnects> object.
*/
typedef OdSmartPtr<IfcRelConnects> IfcRelConnectsPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELCONNECTS_AUTO_IMPL_H
