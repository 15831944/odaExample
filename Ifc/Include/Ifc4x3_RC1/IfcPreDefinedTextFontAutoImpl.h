...
#ifndef _IFC4X3_RC1_IFCPREDEFINEDTEXTFONT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPREDEFINEDTEXTFONT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPreDefinedTextFont : public IfcPreDefinedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPreDefinedTextFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPreDefinedTextFont, IfcPreDefinedTextFont> object.
*/
typedef OdSmartPtr<IfcPreDefinedTextFont> IfcPreDefinedTextFontPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPREDEFINEDTEXTFONT_AUTO_IMPL_H
