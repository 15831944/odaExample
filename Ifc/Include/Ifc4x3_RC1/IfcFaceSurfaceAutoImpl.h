...
#ifndef _IFC4X3_RC1_IFCFACESURFACE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFACESURFACE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFaceSurface : public IfcFace
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFaceSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFaceSurface, IfcFaceSurface> object.
*/
typedef OdSmartPtr<IfcFaceSurface> IfcFaceSurfacePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFACESURFACE_AUTO_IMPL_H
