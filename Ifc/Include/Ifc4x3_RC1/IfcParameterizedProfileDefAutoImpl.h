...
#ifndef _IFC4X3_RC1_IFCPARAMETERIZEDPROFILEDEF_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPARAMETERIZEDPROFILEDEF_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcParameterizedProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcParameterizedProfileDef);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Position;   // IfcAxis2Placement2D  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcParameterizedProfileDef, IfcParameterizedProfileDef> object.
*/
typedef OdSmartPtr<IfcParameterizedProfileDef> IfcParameterizedProfileDefPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPARAMETERIZEDPROFILEDEF_AUTO_IMPL_H
