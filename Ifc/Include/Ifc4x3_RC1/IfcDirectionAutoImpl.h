...
#ifndef _IFC4X3_RC1_IFCDIRECTION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDIRECTION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDirection : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDirection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDirection, IfcDirection> object.
*/
typedef OdSmartPtr<IfcDirection> IfcDirectionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDIRECTION_AUTO_IMPL_H
