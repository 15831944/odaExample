...
#ifndef _IFC4X3_RC1_IFCMATERIALRELATIONSHIP_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMATERIALRELATIONSHIP_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMaterialRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMaterialRelationship);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatingMaterial() const;
  void setRelatingMaterial(const OdDAIObjectId& RelatingMaterial);
  void getRelatedMaterials(OdDAIObjectIds& RelatedMaterials) const;
  OdDAI::OdDAIObjectIdSet& relatedMaterials();
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatingMaterial;   // IfcMaterial
  OdDAI::OdDAIObjectIdSet m_RelatedMaterials; // SET [1:?] of IfcMaterial
  OdAnsiString m_Expression;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMaterialRelationship, IfcMaterialRelationship> object.
*/
typedef OdSmartPtr<IfcMaterialRelationship> IfcMaterialRelationshipPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMATERIALRELATIONSHIP_AUTO_IMPL_H
