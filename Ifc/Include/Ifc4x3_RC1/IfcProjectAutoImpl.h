...
#ifndef _IFC4X3_RC1_IFCPROJECT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPROJECT_AUTO_IMPL_H
...
*/
class IFC4X3_RC1_EXPORT IfcProject : public IfcContext
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcProject);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcProject, IfcProject> object.
*/
typedef OdSmartPtr<IfcProject> IfcProjectPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPROJECT_AUTO_IMPL_H
