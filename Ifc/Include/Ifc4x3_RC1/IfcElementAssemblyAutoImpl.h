...
#ifndef _IFC4X3_RC1_IFCELEMENTASSEMBLY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCELEMENTASSEMBLY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcElementAssembly : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcElementAssembly);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcElementAssembly, IfcElementAssembly> object.
*/
typedef OdSmartPtr<IfcElementAssembly> IfcElementAssemblyPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCELEMENTASSEMBLY_AUTO_IMPL_H
