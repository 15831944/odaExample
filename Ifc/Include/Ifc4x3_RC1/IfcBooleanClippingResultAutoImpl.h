...
#ifndef _IFC4X3_RC1_IFCBOOLEANCLIPPINGRESULT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBOOLEANCLIPPINGRESULT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBooleanClippingResult : public IfcBooleanResult
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBooleanClippingResult);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBooleanClippingResult, IfcBooleanClippingResult> object.
*/
typedef OdSmartPtr<IfcBooleanClippingResult> IfcBooleanClippingResultPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBOOLEANCLIPPINGRESULT_AUTO_IMPL_H
