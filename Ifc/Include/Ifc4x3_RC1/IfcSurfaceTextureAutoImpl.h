...
#ifndef _IFC4X3_RC1_IFCSURFACETEXTURE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSURFACETEXTURE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSurfaceTexture : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSurfaceTexture);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdAnsiStringList& parameter();
...
protected:
  // Fields declaration: 
  OdDAI::Boolean m_RepeatS;   // IfcBoolean
  OdDAI::Boolean m_RepeatT;   // IfcBoolean
  OdAnsiString m_Mode;   // IfcIdentifier  [optional]
  OdDAIObjectId m_TextureTransform;   // IfcCartesianTransformationOperator2D  [optional]
  OdDAI::OdAnsiStringList m_Parameter; // LIST [1:?] of IfcIdentifier [optional]


  // Declare friend classes for inverse attributes functionality: 
  friend class IfcTextureCoordinate;
  friend class IfcSurfaceStyleWithTextures;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSurfaceTexture, IfcSurfaceTexture> object.
*/
typedef OdSmartPtr<IfcSurfaceTexture> IfcSurfaceTexturePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSURFACETEXTURE_AUTO_IMPL_H
