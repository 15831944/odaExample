...
#ifndef _IFC4X3_RC1_IFCELEMENTASSEMBLYTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCELEMENTASSEMBLYTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcElementAssemblyType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcElementAssemblyType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcElementAssemblyType, IfcElementAssemblyType> object.
*/
typedef OdSmartPtr<IfcElementAssemblyType> IfcElementAssemblyTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCELEMENTASSEMBLYTYPE_AUTO_IMPL_H
