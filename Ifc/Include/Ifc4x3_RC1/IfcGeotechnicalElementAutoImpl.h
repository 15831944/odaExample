...
#ifndef _IFC4X3_RC1_IFCGEOTECHNICALELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCGEOTECHNICALELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcGeotechnicalElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcGeotechnicalElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcGeotechnicalElement, IfcGeotechnicalElement> object.
*/
typedef OdSmartPtr<IfcGeotechnicalElement> IfcGeotechnicalElementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCGEOTECHNICALELEMENT_AUTO_IMPL_H
