...
#ifndef _IFC4X3_RC1_ENTITYTYPES_H
#define _IFC4X3_RC1_ENTITYTYPES_H
...
enum OdIfcEntityType {
  ...
  kIfcAlignment,
  kIfcAlignment2DCant,
  kIfcAlignment2DCantSegLine,
  kIfcAlignment2DCantSegTransition,
  kIfcAlignment2DCantSegment,
  kIfcAlignment2DHorizontal,
  kIfcAlignment2DHorizontalSegment,
  kIfcAlignment2DSegment,
  kIfcAlignment2DVerSegCircularArc,
  kIfcAlignment2DVerSegLine,
  kIfcAlignment2DVerSegParabolicArc,
  kIfcAlignment2DVerSegTransition,
  kIfcAlignment2DVertical,
  kIfcAlignment2DVerticalSegment,
  kIfcAlignmentCurve,
  kIfcAnnotation,
  ...
  kIfcDirectrixDistanceSweptAreaSolid,
  kIfcDiscreteAccessory,
  kIfcDiscreteAccessoryType,
  kIfcDistanceExpression,
  ...
  kIfcInclinedReferenceSweptAreaSolid,
  ...
  kIfcLine,
  kIfcLineSegment2D,
  kIfcLinearAxisWithInclination,
  kIfcLinearPlacement,
  kIfcLinearPlacementWithInclination,
  kIfcLinearPositioningElement,
  kIfcLinearSpanPlacement,
  kIfcLiquidTerminal,
...
#endif // _IFC4X3_RC1_ENTITYTYPES_H
