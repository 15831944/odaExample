...
#ifndef _IFC4X3_RC1_IFCRESOURCEAPPROVALRELATIONSHIP_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRESOURCEAPPROVALRELATIONSHIP_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcResourceApprovalRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcResourceApprovalRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcResourceApprovalRelationship, IfcResourceApprovalRelationship> object.
*/
typedef OdSmartPtr<IfcResourceApprovalRelationship> IfcResourceApprovalRelationshipPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRESOURCEAPPROVALRELATIONSHIP_AUTO_IMPL_H
