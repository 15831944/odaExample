...
#ifndef _IFC4X3_RC1_IFCBOREHOLE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBOREHOLE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBorehole : public IfcGeotechnicalAssembly
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBorehole);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBorehole, IfcBorehole> object.
*/
typedef OdSmartPtr<IfcBorehole> IfcBoreholePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBOREHOLE_AUTO_IMPL_H
