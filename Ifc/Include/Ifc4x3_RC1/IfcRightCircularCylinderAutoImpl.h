...
#ifndef _IFC4X3_RC1_IFCRIGHTCIRCULARCYLINDER_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRIGHTCIRCULARCYLINDER_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRightCircularCylinder : public IfcCsgPrimitive3D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRightCircularCylinder);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRightCircularCylinder, IfcRightCircularCylinder> object.
*/
typedef OdSmartPtr<IfcRightCircularCylinder> IfcRightCircularCylinderPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRIGHTCIRCULARCYLINDER_AUTO_IMPL_H
