...
#ifndef _IFC4X3_RC1_IFCCONTEXT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCONTEXT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcContext : public IfcObjectDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcContext);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_ObjectType;   // IfcLabel  [optional]
  OdAnsiString m_LongName;   // IfcLabel  [optional]
  OdAnsiString m_Phase;   // IfcLabel  [optional]
  OdDAI::OdDAIObjectIdSet m_RepresentationContexts; // SET [1:?] of IfcRepresentationContext [optional]

  OdDAIObjectId m_UnitsInContext;   // IfcUnitAssignment  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcContext, IfcContext> object.
*/
typedef OdSmartPtr<IfcContext> IfcContextPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCONTEXT_AUTO_IMPL_H
