...
#ifndef _IFC4X3_RC1_IFCRELCONNECTSWITHREALIZINGELEMENTS_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRELCONNECTSWITHREALIZINGELEMENTS_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRelConnectsWithRealizingElements : public IfcRelConnectsElements
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRelConnectsWithRealizingElements);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRelConnectsWithRealizingElements, IfcRelConnectsWithRealizingElements> object.
*/
typedef OdSmartPtr<IfcRelConnectsWithRealizingElements> IfcRelConnectsWithRealizingElementsPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRELCONNECTSWITHREALIZINGELEMENTS_AUTO_IMPL_H
