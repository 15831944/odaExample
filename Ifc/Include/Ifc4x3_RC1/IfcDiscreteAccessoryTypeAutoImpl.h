...
#ifndef _IFC4X3_RC1_IFCDISCRETEACCESSORYTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDISCRETEACCESSORYTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDiscreteAccessoryType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDiscreteAccessoryType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcDiscreteAccessoryTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcDiscreteAccessoryTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcDiscreteAccessoryTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDiscreteAccessoryType, IfcDiscreteAccessoryType> object.
*/
typedef OdSmartPtr<IfcDiscreteAccessoryType> IfcDiscreteAccessoryTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDISCRETEACCESSORYTYPE_AUTO_IMPL_H
