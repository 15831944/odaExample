...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcExtrudedAreaSolidTapered, IfcExtrudedAreaSolidTapered> object.
*/
typedef OdSmartPtr<IfcExtrudedAreaSolidTapered> IfcExtrudedAreaSolidTaperedPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCEXTRUDEDAREASOLIDTAPERED_AUTO_IMPL_H
