...
#ifndef _IFC4X3_RC1_IFCPREDEFINEDCURVEFONT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPREDEFINEDCURVEFONT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPreDefinedCurveFont : public IfcPreDefinedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPreDefinedCurveFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPreDefinedCurveFont, IfcPreDefinedCurveFont> object.
*/
typedef OdSmartPtr<IfcPreDefinedCurveFont> IfcPreDefinedCurveFontPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPREDEFINEDCURVEFONT_AUTO_IMPL_H
