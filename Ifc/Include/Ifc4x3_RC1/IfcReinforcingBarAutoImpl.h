...
#ifndef _IFC4X3_RC1_IFCREINFORCINGBAR_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCREINFORCINGBAR_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcReinforcingBar : public IfcReinforcingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcReinforcingBar);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Enum m_PredefinedType;   // IfcReinforcingBarTypeEnum  [optional]
  OdDAI::Enum m_BarSurface;   // IfcReinforcingBarSurfaceEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcReinforcingBar, IfcReinforcingBar> object.
*/
typedef OdSmartPtr<IfcReinforcingBar> IfcReinforcingBarPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCREINFORCINGBAR_AUTO_IMPL_H
