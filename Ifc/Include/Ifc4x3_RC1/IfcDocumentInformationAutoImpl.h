...
#ifndef _IFC4X3_RC1_IFCDOCUMENTINFORMATION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDOCUMENTINFORMATION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDocumentInformation : public IfcExternalInformation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDocumentInformation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDocumentInformation, IfcDocumentInformation> object.
*/
typedef OdSmartPtr<IfcDocumentInformation> IfcDocumentInformationPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDOCUMENTINFORMATION_AUTO_IMPL_H
