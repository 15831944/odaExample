...
#ifndef _IFC4X3_RC1_IFCSLIPPAGECONNECTIONCONDITION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSLIPPAGECONNECTIONCONDITION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSlippageConnectionCondition : public IfcStructuralConnectionCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSlippageConnectionCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSlippageConnectionCondition, IfcSlippageConnectionCondition> object.
*/
typedef OdSmartPtr<IfcSlippageConnectionCondition> IfcSlippageConnectionConditionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSLIPPAGECONNECTIONCONDITION_AUTO_IMPL_H
