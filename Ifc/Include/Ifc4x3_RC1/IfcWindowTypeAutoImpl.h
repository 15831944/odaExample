...
#ifndef _IFC4X3_RC1_IFCWINDOWTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCWINDOWTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcWindowType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcWindowType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcWindowTypeEnum
  OdDAI::Enum m_PartitioningType;   // IfcWindowTypePartitioningEnum
  OdDAI::Boolean m_ParameterTakesPrecedence;   // IfcBoolean  [optional]
  OdAnsiString m_UserDefinedPartitioningType;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcWindowType, IfcWindowType> object.
*/
typedef OdSmartPtr<IfcWindowType> IfcWindowTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCWINDOWTYPE_AUTO_IMPL_H
