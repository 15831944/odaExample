...
#ifndef _IFC4X3_RC1_IFCFURNISHINGELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFURNISHINGELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFurnishingElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFurnishingElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFurnishingElement, IfcFurnishingElement> object.
*/
typedef OdSmartPtr<IfcFurnishingElement> IfcFurnishingElementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFURNISHINGELEMENT_AUTO_IMPL_H
