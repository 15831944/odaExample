...
#ifndef _IFC4X3_RC1_IFCDUCTFITTING_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDUCTFITTING_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDuctFitting : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDuctFitting);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcDuctFittingTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDuctFitting, IfcDuctFitting> object.
*/
typedef OdSmartPtr<IfcDuctFitting> IfcDuctFittingPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDUCTFITTING_AUTO_IMPL_H
