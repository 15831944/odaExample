...
#ifndef _IFC4X3_RC1_IFCREINFORCEMENTBARPROPERTIES_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCREINFORCEMENTBARPROPERTIES_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcReinforcementBarProperties : public IfcPreDefinedProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcReinforcementBarProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcReinforcementBarProperties, IfcReinforcementBarProperties> object.
*/
typedef OdSmartPtr<IfcReinforcementBarProperties> IfcReinforcementBarPropertiesPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCREINFORCEMENTBARPROPERTIES_AUTO_IMPL_H
