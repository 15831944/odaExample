...
#ifndef _IFC4X3_RC1_IFCBUILTELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBUILTELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBuiltElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBuiltElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBuiltElementType, IfcBuiltElementType> object.
*/
typedef OdSmartPtr<IfcBuiltElementType> IfcBuiltElementTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBUILTELEMENTTYPE_AUTO_IMPL_H
