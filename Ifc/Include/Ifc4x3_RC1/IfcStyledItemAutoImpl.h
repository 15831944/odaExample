...
#ifndef _IFC4X3_RC1_IFCSTYLEDITEM_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTYLEDITEM_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStyledItem : public IfcRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStyledItem);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getItem() const;
  void setItem(const OdDAIObjectId& Item);
  void getStyles(OdArray<OdDAI::Select >& Styles) const;
  void getStylesWrapperArray(OdArray<IfcStyleAssignmentSelect>& Styles) const;
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Item;   // IfcRepresentationItem  [optional]
  OdDAI::Set<OdDAI::Select> m_Styles; // SET [1:?] of IfcStyleAssignmentSelect
  OdAnsiString m_Name;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStyledItem, IfcStyledItem> object.
*/
typedef OdSmartPtr<IfcStyledItem> IfcStyledItemPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTYLEDITEM_AUTO_IMPL_H
