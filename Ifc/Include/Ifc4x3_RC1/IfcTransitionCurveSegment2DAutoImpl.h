...
#ifndef _IFC4X3_RC1_IFCTRANSITIONCURVESEGMENT2D_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTRANSITIONCURVESEGMENT2D_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTransitionCurveSegment2D : public IfcCurveSegment2D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTransitionCurveSegment2D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTransitionCurveSegment2D, IfcTransitionCurveSegment2D> object.
*/
typedef OdSmartPtr<IfcTransitionCurveSegment2D> IfcTransitionCurveSegment2DPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTRANSITIONCURVESEGMENT2D_AUTO_IMPL_H
