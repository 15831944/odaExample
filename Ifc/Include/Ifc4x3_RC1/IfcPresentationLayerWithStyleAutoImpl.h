...
#ifndef _IFC4X3_RC1_IFCPRESENTATIONLAYERWITHSTYLE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPRESENTATIONLAYERWITHSTYLE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPresentationLayerWithStyle : public IfcPresentationLayerAssignment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPresentationLayerWithStyle);
  //DOM-IGNORE-END
...
public:
  ...
  void getLayerStyles(OdDAIObjectIds& LayerStyles) const;
  OdDAI::OdDAIObjectIdSet& layerStyles();
...
protected:
  // Fields declaration: 
  OdDAI::Logical m_LayerOn;   // IfcLogical
  OdDAI::Logical m_LayerFrozen;   // IfcLogical
  OdDAI::Logical m_LayerBlocked;   // IfcLogical
  OdDAI::OdDAIObjectIdSet m_LayerStyles; // SET [0:?] of IfcPresentationStyle
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPresentationLayerWithStyle, IfcPresentationLayerWithStyle> object.
*/
typedef OdSmartPtr<IfcPresentationLayerWithStyle> IfcPresentationLayerWithStylePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPRESENTATIONLAYERWITHSTYLE_AUTO_IMPL_H
