...
#ifndef _IFC4X3_RC1_IFCSIGNAL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSIGNAL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSignal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSignal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSignal, IfcSignal> object.
*/
typedef OdSmartPtr<IfcSignal> IfcSignalPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSIGNAL_AUTO_IMPL_H
