...
#ifndef _IFC4X3_RC1_IFCTEXTSTYLE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTEXTSTYLE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTextStyle : public IfcPresentationStyle
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTextStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTextStyle, IfcTextStyle> object.
*/
typedef OdSmartPtr<IfcTextStyle> IfcTextStylePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTEXTSTYLE_AUTO_IMPL_H
