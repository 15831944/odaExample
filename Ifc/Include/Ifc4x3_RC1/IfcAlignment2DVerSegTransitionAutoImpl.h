...
#ifndef _IFC4X3_RC1_IFCALIGNMENT2DVERSEGTRANSITION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCALIGNMENT2DVERSEGTRANSITION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAlignment2DVerSegTransition : public IfcAlignment2DVerticalSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAlignment2DVerSegTransition);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  IfcPositiveLengthMeasure m_StartRadius;   // IfcPositiveLengthMeasure  [optional]
  IfcPositiveLengthMeasure m_EndRadius;   // IfcPositiveLengthMeasure  [optional]
  OdDAI::Boolean m_IsStartRadiusCCW;   // IfcBoolean
  OdDAI::Boolean m_IsEndRadiusCCW;   // IfcBoolean
  OdDAI::Enum m_TransitionCurveType;   // IfcTransitionCurveType
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAlignment2DVerSegTransition, IfcAlignment2DVerSegTransition> object.
*/
typedef OdSmartPtr<IfcAlignment2DVerSegTransition> IfcAlignment2DVerSegTransitionPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCALIGNMENT2DVERSEGTRANSITION_AUTO_IMPL_H
