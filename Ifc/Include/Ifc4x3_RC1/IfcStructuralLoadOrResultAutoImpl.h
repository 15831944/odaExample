...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALLOADORRESULT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALLOADORRESULT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralLoadOrResult : public IfcStructuralLoad
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralLoadOrResult);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralLoadOrResult, IfcStructuralLoadOrResult> object.
*/
typedef OdSmartPtr<IfcStructuralLoadOrResult> IfcStructuralLoadOrResultPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALLOADORRESULT_AUTO_IMPL_H
