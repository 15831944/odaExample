...
#ifndef _IFC4X3_RC1_IFCLINEARSPANPLACEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLINEARSPANPLACEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLinearSpanPlacement : public IfcLinearPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLinearSpanPlacement);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  IfcPositiveLengthMeasure m_Span;   // IfcPositiveLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLinearSpanPlacement, IfcLinearSpanPlacement> object.
*/
typedef OdSmartPtr<IfcLinearSpanPlacement> IfcLinearSpanPlacementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLINEARSPANPLACEMENT_AUTO_IMPL_H
