...
#ifndef _IFC4X3_RC1_IFCAIRTERMINAL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCAIRTERMINAL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAirTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAirTerminal);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcAirTerminalTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAirTerminal, IfcAirTerminal> object.
*/
typedef OdSmartPtr<IfcAirTerminal> IfcAirTerminalPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCAIRTERMINAL_AUTO_IMPL_H
