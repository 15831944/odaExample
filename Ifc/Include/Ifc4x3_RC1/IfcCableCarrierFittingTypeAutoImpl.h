...
#ifndef _IFC4X3_RC1_IFCCABLECARRIERFITTINGTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCABLECARRIERFITTINGTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCableCarrierFittingType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCableCarrierFittingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCableCarrierFittingType, IfcCableCarrierFittingType> object.
*/
typedef OdSmartPtr<IfcCableCarrierFittingType> IfcCableCarrierFittingTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCABLECARRIERFITTINGTYPE_AUTO_IMPL_H
