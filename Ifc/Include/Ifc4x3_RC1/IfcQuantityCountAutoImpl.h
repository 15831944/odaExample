...
#ifndef _IFC4X3_RC1_IFCQUANTITYCOUNT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCQUANTITYCOUNT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcQuantityCount : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcQuantityCount);
  //DOM-IGNORE-END
...
public:
  ...
  double getCountValue() const;
  void setCountValue(double CountValue);
  const OdAnsiString& getFormula() const;
  void setFormula(const OdAnsiString& Formula);
...
protected:
  // Fields declaration: 
  double m_CountValue;   // IfcCountMeasure
  OdAnsiString m_Formula;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcQuantityCount, IfcQuantityCount> object.
*/
typedef OdSmartPtr<IfcQuantityCount> IfcQuantityCountPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCQUANTITYCOUNT_AUTO_IMPL_H
