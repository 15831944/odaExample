...
#ifndef _IFC4X3_RC1_IFCINVENTORY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCINVENTORY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcInventory : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcInventory);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcInventoryTypeEnum  [optional]
  OdDAI::Select m_Jurisdiction;   // IfcActorSelect  [optional]
  OdDAI::OdDAIObjectIdSet m_ResponsiblePersons; // SET [1:?] of IfcPerson [optional]

  OdAnsiString m_LastUpdateDate;   // IfcDate  [optional]
  OdDAIObjectId m_CurrentValue;   // IfcCostValue  [optional]
  OdDAIObjectId m_OriginalValue;   // IfcCostValue  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcInventory, IfcInventory> object.
*/
typedef OdSmartPtr<IfcInventory> IfcInventoryPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCINVENTORY_AUTO_IMPL_H
