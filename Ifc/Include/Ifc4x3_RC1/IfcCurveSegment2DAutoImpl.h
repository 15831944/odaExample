...
#ifndef _IFC4X3_RC1_IFCCURVESEGMENT2D_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCURVESEGMENT2D_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCurveSegment2D : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCurveSegment2D);
  //DOM-IGNORE-END
...
protected:
  ...
  IfcPositiveLengthMeasure m_SegmentLength;   // IfcPositiveLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCurveSegment2D, IfcCurveSegment2D> object.
*/
typedef OdSmartPtr<IfcCurveSegment2D> IfcCurveSegment2DPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCURVESEGMENT2D_AUTO_IMPL_H
