...
#ifndef _IFC4X3_RC1_IFCOFFSETCURVE2D_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCOFFSETCURVE2D_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcOffsetCurve2D : public IfcOffsetCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcOffsetCurve2D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcOffsetCurve2D, IfcOffsetCurve2D> object.
*/
typedef OdSmartPtr<IfcOffsetCurve2D> IfcOffsetCurve2DPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCOFFSETCURVE2D_AUTO_IMPL_H
