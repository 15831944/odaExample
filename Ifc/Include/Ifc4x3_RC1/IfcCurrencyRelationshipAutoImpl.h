...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCurrencyRelationship, IfcCurrencyRelationship> object.
*/
typedef OdSmartPtr<IfcCurrencyRelationship> IfcCurrencyRelationshipPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCURRENCYRELATIONSHIP_AUTO_IMPL_H
