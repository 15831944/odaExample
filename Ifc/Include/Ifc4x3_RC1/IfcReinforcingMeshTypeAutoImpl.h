...
#ifndef _IFC4X3_RC1_IFCREINFORCINGMESHTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCREINFORCINGMESHTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcReinforcingMeshType : public IfcReinforcingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcReinforcingMeshType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcReinforcingMeshType, IfcReinforcingMeshType> object.
*/
typedef OdSmartPtr<IfcReinforcingMeshType> IfcReinforcingMeshTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCREINFORCINGMESHTYPE_AUTO_IMPL_H
