...
#ifndef _IFC4X3_RC1_IFCENGINETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCENGINETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcEngineType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcEngineType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcEngineTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcEngineTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcEngineTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcEngineType, IfcEngineType> object.
*/
typedef OdSmartPtr<IfcEngineType> IfcEngineTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCENGINETYPE_AUTO_IMPL_H
