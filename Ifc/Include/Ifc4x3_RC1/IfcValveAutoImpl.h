...
#ifndef _IFC4X3_RC1_IFCVALVE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCVALVE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcValve : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcValve);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcValveTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcValve, IfcValve> object.
*/
typedef OdSmartPtr<IfcValve> IfcValvePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCVALVE_AUTO_IMPL_H
