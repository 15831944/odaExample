...
#ifndef _IFC4X3_RC1_IFCCABLESEGMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCABLESEGMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCableSegmentType : public IfcFlowSegmentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCableSegmentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCableSegmentType, IfcCableSegmentType> object.
*/
typedef OdSmartPtr<IfcCableSegmentType> IfcCableSegmentTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCABLESEGMENTTYPE_AUTO_IMPL_H
