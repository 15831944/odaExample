...
#ifndef _IFC4X3_RC1_IFCPOLYGONALFACESET_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPOLYGONALFACESET_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPolygonalFaceSet : public IfcTessellatedFaceSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPolygonalFaceSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPolygonalFaceSet, IfcPolygonalFaceSet> object.
*/
typedef OdSmartPtr<IfcPolygonalFaceSet> IfcPolygonalFaceSetPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPOLYGONALFACESET_AUTO_IMPL_H
