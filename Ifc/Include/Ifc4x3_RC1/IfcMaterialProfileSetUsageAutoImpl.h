...
#ifndef _IFC4X3_RC1_IFCMATERIALPROFILESETUSAGE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMATERIALPROFILESETUSAGE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMaterialProfileSetUsage : public IfcMaterialUsageDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMaterialProfileSetUsage);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMaterialProfileSetUsage, IfcMaterialProfileSetUsage> object.
*/
typedef OdSmartPtr<IfcMaterialProfileSetUsage> IfcMaterialProfileSetUsagePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMATERIALPROFILESETUSAGE_AUTO_IMPL_H
