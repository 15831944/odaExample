...
#ifndef _IFC4X3_RC1_IFCCOVERING_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCOVERING_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCovering : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCovering);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCovering, IfcCovering> object.
*/
typedef OdSmartPtr<IfcCovering> IfcCoveringPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCOVERING_AUTO_IMPL_H
