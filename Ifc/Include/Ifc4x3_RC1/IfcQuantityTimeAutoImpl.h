...
#ifndef _IFC4X3_RC1_IFCQUANTITYTIME_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCQUANTITYTIME_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcQuantityTime : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcQuantityTime);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_TimeValue;   // IfcTimeMeasure
  OdAnsiString m_Formula;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcQuantityTime, IfcQuantityTime> object.
*/
typedef OdSmartPtr<IfcQuantityTime> IfcQuantityTimePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCQUANTITYTIME_AUTO_IMPL_H
