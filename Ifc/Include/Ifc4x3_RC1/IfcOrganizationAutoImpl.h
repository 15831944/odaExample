...
#ifndef _IFC4X3_RC1_IFCORGANIZATION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCORGANIZATION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcOrganization : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcOrganization);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcOrganization, IfcOrganization> object.
*/
typedef OdSmartPtr<IfcOrganization> IfcOrganizationPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCORGANIZATION_AUTO_IMPL_H
