...
#ifndef _IFC4X3_RC1_IFCEVAPORATIVECOOLER_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCEVAPORATIVECOOLER_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcEvaporativeCooler : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcEvaporativeCooler);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcEvaporativeCooler, IfcEvaporativeCooler> object.
*/
typedef OdSmartPtr<IfcEvaporativeCooler> IfcEvaporativeCoolerPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCEVAPORATIVECOOLER_AUTO_IMPL_H
