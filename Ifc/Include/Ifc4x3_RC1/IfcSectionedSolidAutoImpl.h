...
#ifndef _IFC4X3_RC1_IFCSECTIONEDSOLID_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSECTIONEDSOLID_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSectionedSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSectionedSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSectionedSolid, IfcSectionedSolid> object.
*/
typedef OdSmartPtr<IfcSectionedSolid> IfcSectionedSolidPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSECTIONEDSOLID_AUTO_IMPL_H
