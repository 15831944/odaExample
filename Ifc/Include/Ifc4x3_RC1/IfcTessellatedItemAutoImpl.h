...
#ifndef _IFC4X3_RC1_IFCTESSELLATEDITEM_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTESSELLATEDITEM_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTessellatedItem : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTessellatedItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTessellatedItem, IfcTessellatedItem> object.
*/
typedef OdSmartPtr<IfcTessellatedItem> IfcTessellatedItemPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTESSELLATEDITEM_AUTO_IMPL_H
