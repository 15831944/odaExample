...
#ifndef _IFC4X3_RC1_IFCTENDONCONDUIT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTENDONCONDUIT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTendonConduit : public IfcReinforcingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTendonConduit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTendonConduit, IfcTendonConduit> object.
*/
typedef OdSmartPtr<IfcTendonConduit> IfcTendonConduitPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTENDONCONDUIT_AUTO_IMPL_H
