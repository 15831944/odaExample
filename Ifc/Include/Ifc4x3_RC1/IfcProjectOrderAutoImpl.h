...
#ifndef _IFC4X3_RC1_IFCPROJECTORDER_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPROJECTORDER_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcProjectOrder : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcProjectOrder);
  //DOM-IGNORE-END
...
public:
  ...
  IfcProjectOrderTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcProjectOrderTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcProjectOrderTypeEnum  [optional]
  OdAnsiString m_Status;   // IfcLabel  [optional]
  OdAnsiString m_LongDescription;   // IfcText  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcProjectOrder, IfcProjectOrder> object.
*/
typedef OdSmartPtr<IfcProjectOrder> IfcProjectOrderPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPROJECTORDER_AUTO_IMPL_H
