...
#ifndef _IFC4X3_RC1_IFCTEXTUREMAP_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTEXTUREMAP_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTextureMap : public IfcTextureCoordinate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTextureMap);
  //DOM-IGNORE-END
...
public:
  ...
  void getVertices(OdDAIObjectIds& Vertices) const;
  OdDAI::OdDAIObjectIdList& vertices();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_Vertices; // LIST [3:?] of IfcTextureVertex
  OdDAIObjectId m_MappedTo;   // IfcFace
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTextureMap, IfcTextureMap> object.
*/
typedef OdSmartPtr<IfcTextureMap> IfcTextureMapPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTEXTUREMAP_AUTO_IMPL_H
