...
#ifndef _IFC4X3_RC1_IFCWALLSTANDARDCASE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCWALLSTANDARDCASE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcWallStandardCase : public IfcWall
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcWallStandardCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcWallStandardCase, IfcWallStandardCase> object.
*/
typedef OdSmartPtr<IfcWallStandardCase> IfcWallStandardCasePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCWALLSTANDARDCASE_AUTO_IMPL_H
