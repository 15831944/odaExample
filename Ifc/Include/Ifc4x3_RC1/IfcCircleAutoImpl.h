...
#ifndef _IFC4X3_RC1_IFCCIRCLE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCIRCLE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCircle : public IfcConic
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCircle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCircle, IfcCircle> object.
*/
typedef OdSmartPtr<IfcCircle> IfcCirclePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCIRCLE_AUTO_IMPL_H
