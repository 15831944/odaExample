...
#ifndef _IFC4X3_RC1_IFCACTIONREQUEST_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCACTIONREQUEST_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcActionRequest : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcActionRequest);
  //DOM-IGNORE-END
...
public:
  ...
  IfcActionRequestTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcActionRequestTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcActionRequestTypeEnum  [optional]
  OdAnsiString m_Status;   // IfcLabel  [optional]
  OdAnsiString m_LongDescription;   // IfcText  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcActionRequest, IfcActionRequest> object.
*/
typedef OdSmartPtr<IfcActionRequest> IfcActionRequestPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCACTIONREQUEST_AUTO_IMPL_H
