...
#ifndef _IFC4X3_RC1_IFCCOORDINATEOPERATION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCOORDINATEOPERATION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCoordinateOperation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCoordinateOperation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCoordinateOperation, IfcCoordinateOperation> object.
*/
typedef OdSmartPtr<IfcCoordinateOperation> IfcCoordinateOperationPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCOORDINATEOPERATION_AUTO_IMPL_H
