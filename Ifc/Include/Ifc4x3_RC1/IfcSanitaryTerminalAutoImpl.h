...
#ifndef _IFC4X3_RC1_IFCSANITARYTERMINAL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSANITARYTERMINAL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSanitaryTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSanitaryTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSanitaryTerminal, IfcSanitaryTerminal> object.
*/
typedef OdSmartPtr<IfcSanitaryTerminal> IfcSanitaryTerminalPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSANITARYTERMINAL_AUTO_IMPL_H
