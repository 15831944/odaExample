...
#ifndef _IFC4X3_RC1_IFCFILTERTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFILTERTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcFilterType : public IfcFlowTreatmentDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFilterType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFilterType, IfcFilterType> object.
*/
typedef OdSmartPtr<IfcFilterType> IfcFilterTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFILTERTYPE_AUTO_IMPL_H
