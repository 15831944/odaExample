...
#ifndef _IFC4X3_RC1_IFCALIGNMENT2DSEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCALIGNMENT2DSEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAlignment2DSegment : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAlignment2DSegment);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::Boolean getTangentialContinuity() const;
  void setTangentialContinuity(OdDAI::Boolean TangentialContinuity);
...
protected:
  // Fields declaration: 
  OdDAI::Boolean m_TangentialContinuity;   // IfcBoolean  [optional]
  OdAnsiString m_StartTag;   // IfcLabel  [optional]
  OdAnsiString m_EndTag;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAlignment2DSegment, IfcAlignment2DSegment> object.
*/
typedef OdSmartPtr<IfcAlignment2DSegment> IfcAlignment2DSegmentPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCALIGNMENT2DSEGMENT_AUTO_IMPL_H
