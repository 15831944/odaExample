...
#ifndef _IFC4X3_RC1_IFCRAILTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRAILTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRailType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRailType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRailType, IfcRailType> object.
*/
typedef OdSmartPtr<IfcRailType> IfcRailTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRAILTYPE_AUTO_IMPL_H
