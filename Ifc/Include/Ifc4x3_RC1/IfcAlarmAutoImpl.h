...
#ifndef _IFC4X3_RC1_IFCALARM_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCALARM_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAlarm : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAlarm);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcAlarmTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAlarm, IfcAlarm> object.
*/
typedef OdSmartPtr<IfcAlarm> IfcAlarmPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCALARM_AUTO_IMPL_H
