...
#ifndef _IFC4X3_RC1_IFCPLATETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPLATETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPlateType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPlateType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPlateType, IfcPlateType> object.
*/
typedef OdSmartPtr<IfcPlateType> IfcPlateTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPLATETYPE_AUTO_IMPL_H
