...
#ifndef _IFC4X3_RC1_IFCCHIMNEY_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCHIMNEY_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcChimney : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcChimney);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcChimneyTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcChimney, IfcChimney> object.
*/
typedef OdSmartPtr<IfcChimney> IfcChimneyPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCHIMNEY_AUTO_IMPL_H
