...
#ifndef _IFC4X3_RC1_IFCPIPEFITTING_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPIPEFITTING_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPipeFitting : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPipeFitting);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcPipeFittingTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPipeFitting, IfcPipeFitting> object.
*/
typedef OdSmartPtr<IfcPipeFitting> IfcPipeFittingPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPIPEFITTING_AUTO_IMPL_H
