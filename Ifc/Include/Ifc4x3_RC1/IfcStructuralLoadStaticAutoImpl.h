...
#ifndef _IFC4X3_RC1_IFCSTRUCTURALLOADSTATIC_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTRUCTURALLOADSTATIC_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStructuralLoadStatic : public IfcStructuralLoadOrResult
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStructuralLoadStatic);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStructuralLoadStatic, IfcStructuralLoadStatic> object.
*/
typedef OdSmartPtr<IfcStructuralLoadStatic> IfcStructuralLoadStaticPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTRUCTURALLOADSTATIC_AUTO_IMPL_H
