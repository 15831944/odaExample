...
#ifndef _IFC4X3_RC1_IFCUNITASSIGNMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCUNITASSIGNMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcUnitAssignment : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcUnitAssignment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcUnitAssignment, IfcUnitAssignment> object.
*/
typedef OdSmartPtr<IfcUnitAssignment> IfcUnitAssignmentPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCUNITASSIGNMENT_AUTO_IMPL_H
