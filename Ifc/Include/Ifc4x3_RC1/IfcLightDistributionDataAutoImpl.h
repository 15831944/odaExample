...
#ifndef _IFC4X3_RC1_IFCLIGHTDISTRIBUTIONDATA_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLIGHTDISTRIBUTIONDATA_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLightDistributionData : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLightDistributionData);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLightDistributionData, IfcLightDistributionData> object.
*/
typedef OdSmartPtr<IfcLightDistributionData> IfcLightDistributionDataPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLIGHTDISTRIBUTIONDATA_AUTO_IMPL_H
