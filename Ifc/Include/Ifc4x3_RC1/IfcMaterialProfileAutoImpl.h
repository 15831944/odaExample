...
#ifndef _IFC4X3_RC1_IFCMATERIALPROFILE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMATERIALPROFILE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMaterialProfile : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMaterialProfile);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMaterialProfile, IfcMaterialProfile> object.
*/
typedef OdSmartPtr<IfcMaterialProfile> IfcMaterialProfilePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMATERIALPROFILE_AUTO_IMPL_H
