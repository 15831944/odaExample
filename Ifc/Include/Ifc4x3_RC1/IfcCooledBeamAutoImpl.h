...
#ifndef _IFC4X3_RC1_IFCCOOLEDBEAM_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCOOLEDBEAM_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCooledBeam : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCooledBeam);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCooledBeamTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCooledBeam, IfcCooledBeam> object.
*/
typedef OdSmartPtr<IfcCooledBeam> IfcCooledBeamPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCOOLEDBEAM_AUTO_IMPL_H
