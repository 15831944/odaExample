...
#ifndef _IFC4X3_RC1_IFCTEXTURECOORDINATE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTEXTURECOORDINATE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTextureCoordinate : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTextureCoordinate);
  //DOM-IGNORE-END
...
public:
  ...
  void getMaps(OdDAIObjectIds& Maps) const;
  OdDAI::OdDAIObjectIdList& maps();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_Maps; // LIST [1:?] of IfcSurfaceTexture
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTextureCoordinate, IfcTextureCoordinate> object.
*/
typedef OdSmartPtr<IfcTextureCoordinate> IfcTextureCoordinatePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTEXTURECOORDINATE_AUTO_IMPL_H
