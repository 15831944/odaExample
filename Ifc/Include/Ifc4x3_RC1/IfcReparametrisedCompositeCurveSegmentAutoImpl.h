...
#ifndef _IFC4X3_RC1_IFCREPARAMETRISEDCOMPOSITECURVESEGMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCREPARAMETRISEDCOMPOSITECURVESEGMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcReparametrisedCompositeCurveSegment : public IfcCompositeCurveSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcReparametrisedCompositeCurveSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcReparametrisedCompositeCurveSegment, IfcReparametrisedCompositeCurveSegment> object.
*/
typedef OdSmartPtr<IfcReparametrisedCompositeCurveSegment> IfcReparametrisedCompositeCurveSegmentPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCREPARAMETRISEDCOMPOSITECURVESEGMENT_AUTO_IMPL_H
