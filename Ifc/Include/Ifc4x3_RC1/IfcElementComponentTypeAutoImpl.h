...
#ifndef _IFC4X3_RC1_IFCELEMENTCOMPONENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCELEMENTCOMPONENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcElementComponentType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcElementComponentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcElementComponentType, IfcElementComponentType> object.
*/
typedef OdSmartPtr<IfcElementComponentType> IfcElementComponentTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCELEMENTCOMPONENTTYPE_AUTO_IMPL_H
