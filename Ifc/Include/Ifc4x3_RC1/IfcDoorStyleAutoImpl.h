...
#ifndef _IFC4X3_RC1_IFCDOORSTYLE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDOORSTYLE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDoorStyle : public IfcTypeProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDoorStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDoorStyle, IfcDoorStyle> object.
*/
typedef OdSmartPtr<IfcDoorStyle> IfcDoorStylePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDOORSTYLE_AUTO_IMPL_H
