...
#ifndef _IFC4X3_RC1_IFCFIXEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCFIXEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H

#include "IfcDirectrixCurveSweptAreaSolidAutoImpl.h"
...
class IFC4X3_RC1_EXPORT IfcFixedReferenceSweptAreaSolid : public IfcDirectrixCurveSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcFixedReferenceSweptAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcFixedReferenceSweptAreaSolid, IfcFixedReferenceSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcFixedReferenceSweptAreaSolid> IfcFixedReferenceSweptAreaSolidPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCFIXEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
