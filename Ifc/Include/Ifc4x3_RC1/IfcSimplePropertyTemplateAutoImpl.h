...
#ifndef _IFC4X3_RC1_IFCSIMPLEPROPERTYTEMPLATE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSIMPLEPROPERTYTEMPLATE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSimplePropertyTemplate : public IfcPropertyTemplate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSimplePropertyTemplate);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_TemplateType;   // IfcSimplePropertyTemplateTypeEnum  [optional]
  OdAnsiString m_PrimaryMeasureType;   // IfcLabel  [optional]
  OdAnsiString m_SecondaryMeasureType;   // IfcLabel  [optional]
  OdDAIObjectId m_Enumerators;   // IfcPropertyEnumeration  [optional]
  OdDAI::Select m_PrimaryUnit;   // IfcUnit  [optional]
  OdDAI::Select m_SecondaryUnit;   // IfcUnit  [optional]
  OdAnsiString m_Expression;   // IfcLabel  [optional]
  OdDAI::Enum m_AccessState;   // IfcStateEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSimplePropertyTemplate, IfcSimplePropertyTemplate> object.
*/
typedef OdSmartPtr<IfcSimplePropertyTemplate> IfcSimplePropertyTemplatePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSIMPLEPROPERTYTEMPLATE_AUTO_IMPL_H
