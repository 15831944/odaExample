...
#ifndef _IFC4X3_RC1_IFCLINEARAXISWITHINCLINATION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCLINEARAXISWITHINCLINATION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcLinearAxisWithInclination : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcLinearAxisWithInclination);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcLinearAxisWithInclination, IfcLinearAxisWithInclination> object.
*/
typedef OdSmartPtr<IfcLinearAxisWithInclination> IfcLinearAxisWithInclinationPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCLINEARAXISWITHINCLINATION_AUTO_IMPL_H
