...
#ifndef _IFC4X3_RC1_IFCDISTRIBUTIONFLOWELEMENT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDISTRIBUTIONFLOWELEMENT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDistributionFlowElement : public IfcDistributionElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDistributionFlowElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDistributionFlowElement, IfcDistributionFlowElement> object.
*/
typedef OdSmartPtr<IfcDistributionFlowElement> IfcDistributionFlowElementPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDISTRIBUTIONFLOWELEMENT_AUTO_IMPL_H
