...
#ifndef _IFC4X3_RC1_IFCQUANTITYVOLUME_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCQUANTITYVOLUME_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcQuantityVolume : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcQuantityVolume);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_VolumeValue;   // IfcVolumeMeasure
  OdAnsiString m_Formula;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcQuantityVolume, IfcQuantityVolume> object.
*/
typedef OdSmartPtr<IfcQuantityVolume> IfcQuantityVolumePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCQUANTITYVOLUME_AUTO_IMPL_H
