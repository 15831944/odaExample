...
#ifndef _IFC4X3_RC1_IFCPROTECTIVEDEVICETRIPPINGUNITTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPROTECTIVEDEVICETRIPPINGUNITTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcProtectiveDeviceTrippingUnitType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcProtectiveDeviceTrippingUnitType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcProtectiveDeviceTrippingUnitType, IfcProtectiveDeviceTrippingUnitType> object.
*/
typedef OdSmartPtr<IfcProtectiveDeviceTrippingUnitType> IfcProtectiveDeviceTrippingUnitTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPROTECTIVEDEVICETRIPPINGUNITTYPE_AUTO_IMPL_H
