...
#ifndef _IFC4X3_RC1_IFCTOPOLOGYREPRESENTATION_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTOPOLOGYREPRESENTATION_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTopologyRepresentation : public IfcShapeModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTopologyRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTopologyRepresentation, IfcTopologyRepresentation> object.
*/
typedef OdSmartPtr<IfcTopologyRepresentation> IfcTopologyRepresentationPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTOPOLOGYREPRESENTATION_AUTO_IMPL_H
