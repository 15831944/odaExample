...
#ifndef _IFC4X3_RC1_IFCBEARINGTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBEARINGTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBearingType : public IfcBuiltElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBearingType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcBearingTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcBearingTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcBearingTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBearingType, IfcBearingType> object.
*/
typedef OdSmartPtr<IfcBearingType> IfcBearingTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBEARINGTYPE_AUTO_IMPL_H
