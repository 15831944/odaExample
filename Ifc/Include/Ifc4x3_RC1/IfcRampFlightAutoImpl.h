...
#ifndef _IFC4X3_RC1_IFCRAMPFLIGHT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCRAMPFLIGHT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcRampFlight : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcRampFlight);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcRampFlightTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcRampFlight, IfcRampFlight> object.
*/
typedef OdSmartPtr<IfcRampFlight> IfcRampFlightPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCRAMPFLIGHT_AUTO_IMPL_H
