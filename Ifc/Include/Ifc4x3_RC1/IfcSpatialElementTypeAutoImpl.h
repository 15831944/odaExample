...
#ifndef _IFC4X3_RC1_IFCSPATIALELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSPATIALELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSpatialElementType : public IfcTypeProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSpatialElementType);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getElementType() const;
  void setElementType(const OdAnsiString& ElementType);
...
protected:
  // Fields declaration: 
  OdAnsiString m_ElementType;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSpatialElementType, IfcSpatialElementType> object.
*/
typedef OdSmartPtr<IfcSpatialElementType> IfcSpatialElementTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSPATIALELEMENTTYPE_AUTO_IMPL_H
