...
#ifndef _IFC4X3_RC1_IFCPILE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPILE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPile : public IfcDeepFoundation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPile);
  //DOM-IGNORE-END
...
public:
  ...
  IfcPileTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcPileTypeEnum PredefinedType);
  IfcPileConstructionEnum getConstructionType() const;
  void setConstructionType(IfcPileConstructionEnum ConstructionType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcPileTypeEnum  [optional]
  OdDAI::Enum m_ConstructionType;   // IfcPileConstructionEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPile, IfcPile> object.
*/
typedef OdSmartPtr<IfcPile> IfcPilePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPILE_AUTO_IMPL_H
