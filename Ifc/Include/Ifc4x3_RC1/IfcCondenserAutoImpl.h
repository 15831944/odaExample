...
#ifndef _IFC4X3_RC1_IFCCONDENSER_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCONDENSER_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCondenser : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCondenser);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCondenserTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCondenser, IfcCondenser> object.
*/
typedef OdSmartPtr<IfcCondenser> IfcCondenserPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCONDENSER_AUTO_IMPL_H
