...
#ifndef _IFC4X3_RC1_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPropertySingleValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPropertySingleValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPropertySingleValue, IfcPropertySingleValue> object.
*/
typedef OdSmartPtr<IfcPropertySingleValue> IfcPropertySingleValuePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
