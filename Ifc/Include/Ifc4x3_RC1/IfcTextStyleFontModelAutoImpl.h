...
#ifndef _IFC4X3_RC1_IFCTEXTSTYLEFONTMODEL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTEXTSTYLEFONTMODEL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTextStyleFontModel : public IfcPreDefinedTextFont
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTextStyleFontModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTextStyleFontModel, IfcTextStyleFontModel> object.
*/
typedef OdSmartPtr<IfcTextStyleFontModel> IfcTextStyleFontModelPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTEXTSTYLEFONTMODEL_AUTO_IMPL_H
