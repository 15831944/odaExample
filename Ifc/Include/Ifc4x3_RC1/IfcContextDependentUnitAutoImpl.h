...
#ifndef _IFC4X3_RC1_IFCCONTEXTDEPENDENTUNIT_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCONTEXTDEPENDENTUNIT_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcContextDependentUnit : public IfcNamedUnit
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcContextDependentUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcContextDependentUnit, IfcContextDependentUnit> object.
*/
typedef OdSmartPtr<IfcContextDependentUnit> IfcContextDependentUnitPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCONTEXTDEPENDENTUNIT_AUTO_IMPL_H
