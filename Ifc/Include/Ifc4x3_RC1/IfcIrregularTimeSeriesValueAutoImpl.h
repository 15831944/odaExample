...
#ifndef _IFC4X3_RC1_IFCIRREGULARTIMESERIESVALUE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCIRREGULARTIMESERIESVALUE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcIrregularTimeSeriesValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcIrregularTimeSeriesValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcIrregularTimeSeriesValue, IfcIrregularTimeSeriesValue> object.
*/
typedef OdSmartPtr<IfcIrregularTimeSeriesValue> IfcIrregularTimeSeriesValuePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCIRREGULARTIMESERIESVALUE_AUTO_IMPL_H
