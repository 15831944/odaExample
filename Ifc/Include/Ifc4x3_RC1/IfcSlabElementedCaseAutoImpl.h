...
#ifndef _IFC4X3_RC1_IFCSLABELEMENTEDCASE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSLABELEMENTEDCASE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSlabElementedCase : public IfcSlab
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSlabElementedCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSlabElementedCase, IfcSlabElementedCase> object.
*/
typedef OdSmartPtr<IfcSlabElementedCase> IfcSlabElementedCasePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSLABELEMENTEDCASE_AUTO_IMPL_H
