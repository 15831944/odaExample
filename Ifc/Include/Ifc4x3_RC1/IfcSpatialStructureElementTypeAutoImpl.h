...
#ifndef _IFC4X3_RC1_IFCSPATIALSTRUCTUREELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSPATIALSTRUCTUREELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSpatialStructureElementType : public IfcSpatialElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSpatialStructureElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSpatialStructureElementType, IfcSpatialStructureElementType> object.
*/
typedef OdSmartPtr<IfcSpatialStructureElementType> IfcSpatialStructureElementTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSPATIALSTRUCTUREELEMENTTYPE_AUTO_IMPL_H
