...
#ifndef _IFC4X3_RC1_IFCELLIPSE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCELLIPSE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcEllipse : public IfcConic
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcEllipse);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcEllipse, IfcEllipse> object.
*/
typedef OdSmartPtr<IfcEllipse> IfcEllipsePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCELLIPSE_AUTO_IMPL_H
