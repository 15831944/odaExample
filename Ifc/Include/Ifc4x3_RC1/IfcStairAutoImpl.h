...
#ifndef _IFC4X3_RC1_IFCSTAIR_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSTAIR_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcStair : public IfcBuiltElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcStair);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcStairTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcStair, IfcStair> object.
*/
typedef OdSmartPtr<IfcStair> IfcStairPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSTAIR_AUTO_IMPL_H
