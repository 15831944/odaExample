...
#ifndef _IFC4X3_RC1_IFCAIRTOAIRHEATRECOVERYTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCAIRTOAIRHEATRECOVERYTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAirToAirHeatRecoveryType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAirToAirHeatRecoveryType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAirToAirHeatRecoveryType, IfcAirToAirHeatRecoveryType> object.
*/
typedef OdSmartPtr<IfcAirToAirHeatRecoveryType> IfcAirToAirHeatRecoveryTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCAIRTOAIRHEATRECOVERYTYPE_AUTO_IMPL_H
