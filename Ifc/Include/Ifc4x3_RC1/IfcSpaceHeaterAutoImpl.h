...
#ifndef _IFC4X3_RC1_IFCSPACEHEATER_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCSPACEHEATER_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcSpaceHeater : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcSpaceHeater);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSpaceHeaterTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcSpaceHeater, IfcSpaceHeater> object.
*/
typedef OdSmartPtr<IfcSpaceHeater> IfcSpaceHeaterPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCSPACEHEATER_AUTO_IMPL_H
