...
#ifndef _IFC4X3_RC1_IFCOUTERBOUNDARYCURVE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCOUTERBOUNDARYCURVE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcOuterBoundaryCurve : public IfcBoundaryCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcOuterBoundaryCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcOuterBoundaryCurve, IfcOuterBoundaryCurve> object.
*/
typedef OdSmartPtr<IfcOuterBoundaryCurve> IfcOuterBoundaryCurvePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCOUTERBOUNDARYCURVE_AUTO_IMPL_H
