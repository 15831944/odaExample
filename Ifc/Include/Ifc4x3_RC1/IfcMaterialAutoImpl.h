...
#ifndef _IFC4X3_RC1_IFCMATERIAL_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCMATERIAL_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcMaterial : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcMaterial);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvHasRepresentation(OdDAIObjectIds& HasRepresentation) const;
  void getInvIsRelatedWith(OdDAIObjectIds& IsRelatedWith) const;
  void getInvRelatesTo(OdDAIObjectIds& RelatesTo) const;
...
protected:
  ...
  friend class IfcMaterialRelationship;
  friend class IfcMaterialRelationship;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcMaterial, IfcMaterial> object.
*/
typedef OdSmartPtr<IfcMaterial> IfcMaterialPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCMATERIAL_AUTO_IMPL_H
