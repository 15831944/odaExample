...
#ifndef _IFC4X3_RC1_IFCCOMPLEXPROPERTYTEMPLATE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCOMPLEXPROPERTYTEMPLATE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcComplexPropertyTemplate : public IfcPropertyTemplate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcComplexPropertyTemplate);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcComplexPropertyTemplate, IfcComplexPropertyTemplate> object.
*/
typedef OdSmartPtr<IfcComplexPropertyTemplate> IfcComplexPropertyTemplatePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCOMPLEXPROPERTYTEMPLATE_AUTO_IMPL_H
