...
#ifndef _IFC4X3_RC1_IFCBOUNDARYCURVE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCBOUNDARYCURVE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcBoundaryCurve : public IfcCompositeCurveOnSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcBoundaryCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcBoundaryCurve, IfcBoundaryCurve> object.
*/
typedef OdSmartPtr<IfcBoundaryCurve> IfcBoundaryCurvePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCBOUNDARYCURVE_AUTO_IMPL_H
