...
#ifndef _IFC4X3_RC1_IFCALIGNMENT2DVERSEGCIRCULARARC_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCALIGNMENT2DVERSEGCIRCULARARC_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAlignment2DVerSegCircularArc : public IfcAlignment2DVerticalSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAlignment2DVerSegCircularArc);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAlignment2DVerSegCircularArc, IfcAlignment2DVerSegCircularArc> object.
*/
typedef OdSmartPtr<IfcAlignment2DVerSegCircularArc> IfcAlignment2DVerSegCircularArcPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCALIGNMENT2DVERSEGCIRCULARARC_AUTO_IMPL_H
