...
#ifndef _IFC4X3_RC1_IFCJUNCTIONBOX_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCJUNCTIONBOX_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcJunctionBox : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcJunctionBox);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcJunctionBoxTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcJunctionBox, IfcJunctionBox> object.
*/
typedef OdSmartPtr<IfcJunctionBox> IfcJunctionBoxPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCJUNCTIONBOX_AUTO_IMPL_H
