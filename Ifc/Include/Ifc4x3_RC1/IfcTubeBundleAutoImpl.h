...
#ifndef _IFC4X3_RC1_IFCTUBEBUNDLE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCTUBEBUNDLE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcTubeBundle : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcTubeBundle);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcTubeBundleTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcTubeBundle, IfcTubeBundle> object.
*/
typedef OdSmartPtr<IfcTubeBundle> IfcTubeBundlePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCTUBEBUNDLE_AUTO_IMPL_H
