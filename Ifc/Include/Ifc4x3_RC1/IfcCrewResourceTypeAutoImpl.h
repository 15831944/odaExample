...
#ifndef _IFC4X3_RC1_IFCCREWRESOURCETYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCCREWRESOURCETYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcCrewResourceType : public IfcConstructionResourceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcCrewResourceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcCrewResourceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcCrewResourceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCrewResourceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcCrewResourceType, IfcCrewResourceType> object.
*/
typedef OdSmartPtr<IfcCrewResourceType> IfcCrewResourceTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCCREWRESOURCETYPE_AUTO_IMPL_H
