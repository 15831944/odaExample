...
#ifndef _IFC4X3_RC1_IFCWORKCALENDAR_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCWORKCALENDAR_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcWorkCalendar : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcWorkCalendar);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdSet& workingTimes();
  void getExceptionTimes(OdDAIObjectIds& ExceptionTimes) const;
  OdDAI::OdDAIObjectIdSet& exceptionTimes();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_WorkingTimes; // SET [1:?] of IfcWorkTime [optional]

  OdDAI::OdDAIObjectIdSet m_ExceptionTimes; // SET [1:?] of IfcWorkTime [optional]

  OdDAI::Enum m_PredefinedType;   // IfcWorkCalendarTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcWorkCalendar, IfcWorkCalendar> object.
*/
typedef OdSmartPtr<IfcWorkCalendar> IfcWorkCalendarPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCWORKCALENDAR_AUTO_IMPL_H
