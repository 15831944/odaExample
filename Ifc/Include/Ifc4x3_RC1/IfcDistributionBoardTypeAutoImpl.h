...
#ifndef _IFC4X3_RC1_IFCDISTRIBUTIONBOARDTYPE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCDISTRIBUTIONBOARDTYPE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcDistributionBoardType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcDistributionBoardType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcDistributionBoardType, IfcDistributionBoardType> object.
*/
typedef OdSmartPtr<IfcDistributionBoardType> IfcDistributionBoardTypePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCDISTRIBUTIONBOARDTYPE_AUTO_IMPL_H
