...
#ifndef _IFC4X3_RC1_IFCADVANCEDFACE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCADVANCEDFACE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcAdvancedFace : public IfcFaceSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcAdvancedFace);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcAdvancedFace, IfcAdvancedFace> object.
*/
typedef OdSmartPtr<IfcAdvancedFace> IfcAdvancedFacePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCADVANCEDFACE_AUTO_IMPL_H
