...
#ifndef _IFC4X3_RC1_IFCGEOMETRICCURVESET_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCGEOMETRICCURVESET_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcGeometricCurveSet : public IfcGeometricSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcGeometricCurveSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcGeometricCurveSet, IfcGeometricCurveSet> object.
*/
typedef OdSmartPtr<IfcGeometricCurveSet> IfcGeometricCurveSetPtr;

} // namespace

#endif // _IFC4X3_RC1_IFCGEOMETRICCURVESET_AUTO_IMPL_H
