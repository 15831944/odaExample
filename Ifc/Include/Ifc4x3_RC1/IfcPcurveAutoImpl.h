...
#ifndef _IFC4X3_RC1_IFCPCURVE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCPCURVE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcPcurve : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcPcurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcPcurve, IfcPcurve> object.
*/
typedef OdSmartPtr<IfcPcurve> IfcPcurvePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCPCURVE_AUTO_IMPL_H
