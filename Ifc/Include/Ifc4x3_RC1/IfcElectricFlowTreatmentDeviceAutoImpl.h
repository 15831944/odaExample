...
#ifndef _IFC4X3_RC1_IFCELECTRICFLOWTREATMENTDEVICE_AUTO_IMPL_H
#define _IFC4X3_RC1_IFCELECTRICFLOWTREATMENTDEVICE_AUTO_IMPL_H
...
class IFC4X3_RC1_EXPORT IfcElectricFlowTreatmentDevice : public IfcFlowTreatmentDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x3_rc1::IfcElectricFlowTreatmentDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x3_rc1::IfcElectricFlowTreatmentDevice, IfcElectricFlowTreatmentDevice> object.
*/
typedef OdSmartPtr<IfcElectricFlowTreatmentDevice> IfcElectricFlowTreatmentDevicePtr;

} // namespace

#endif // _IFC4X3_RC1_IFCELECTRICFLOWTREATMENTDEVICE_AUTO_IMPL_H
