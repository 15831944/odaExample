...
#ifndef _IFC_OPEN_MODE_H_
#define _IFC_OPEN_MODE_H_
...
namespace OdIfc {
  ...
  */
  enum OpenMode {
    //kForInitializing = -2,  // The object is open but is not initialized.
    ...
    //kForNotify = 2          // The object is open for notification.
  };

} // OdIfc
//DOM-IGNORE-END
#endif // _IFC_OPEN_MODE_H_
