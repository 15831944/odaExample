...
#ifndef _IFC2X3_IFCAIRTERMINALBOXTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCAIRTERMINALBOXTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcAirTerminalBoxType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcAirTerminalBoxType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcAirTerminalBoxType, IfcAirTerminalBoxType> object.
*/
typedef OdSmartPtr<IfcAirTerminalBoxType> IfcAirTerminalBoxTypePtr;

} // namespace

#endif // _IFC2X3_IFCAIRTERMINALBOXTYPE_AUTO_IMPL_H
