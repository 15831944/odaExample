...
#ifndef _IFC2X3_IFCQUANTITYVOLUME_AUTO_IMPL_H
#define _IFC2X3_IFCQUANTITYVOLUME_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcQuantityVolume : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcQuantityVolume);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcQuantityVolume, IfcQuantityVolume> object.
*/
typedef OdSmartPtr<IfcQuantityVolume> IfcQuantityVolumePtr;

} // namespace

#endif // _IFC2X3_IFCQUANTITYVOLUME_AUTO_IMPL_H
