...
#ifndef _IFC2X3_IFCCABLECARRIERFITTINGTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCCABLECARRIERFITTINGTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCableCarrierFittingType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCableCarrierFittingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCableCarrierFittingType, IfcCableCarrierFittingType> object.
*/
typedef OdSmartPtr<IfcCableCarrierFittingType> IfcCableCarrierFittingTypePtr;

} // namespace

#endif // _IFC2X3_IFCCABLECARRIERFITTINGTYPE_AUTO_IMPL_H
