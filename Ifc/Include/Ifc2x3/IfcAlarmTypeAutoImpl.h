...
#ifndef _IFC2X3_IFCALARMTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCALARMTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcAlarmType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcAlarmType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcAlarmType, IfcAlarmType> object.
*/
typedef OdSmartPtr<IfcAlarmType> IfcAlarmTypePtr;

} // namespace

#endif // _IFC2X3_IFCALARMTYPE_AUTO_IMPL_H
