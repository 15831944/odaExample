...
#ifndef _IFC2X3_IFCPERSONANDORGANIZATION_AUTO_IMPL_H
#define _IFC2X3_IFCPERSONANDORGANIZATION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPersonAndOrganization : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPersonAndOrganization);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPersonAndOrganization, IfcPersonAndOrganization> object.
*/
typedef OdSmartPtr<IfcPersonAndOrganization> IfcPersonAndOrganizationPtr;

} // namespace

#endif // _IFC2X3_IFCPERSONANDORGANIZATION_AUTO_IMPL_H
