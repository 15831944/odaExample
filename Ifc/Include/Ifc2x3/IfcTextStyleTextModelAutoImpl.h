...
#ifndef _IFC2X3_IFCTEXTSTYLETEXTMODEL_AUTO_IMPL_H
#define _IFC2X3_IFCTEXTSTYLETEXTMODEL_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcTextStyleTextModel : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTextStyleTextModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTextStyleTextModel, IfcTextStyleTextModel> object.
*/
typedef OdSmartPtr<IfcTextStyleTextModel> IfcTextStyleTextModelPtr;

} // namespace

#endif // _IFC2X3_IFCTEXTSTYLETEXTMODEL_AUTO_IMPL_H
