...
#ifndef _IFC2X3_IFCPROJECTORDER_AUTO_IMPL_H
#define _IFC2X3_IFCPROJECTORDER_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcProjectOrder : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcProjectOrder);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcProjectOrder, IfcProjectOrder> object.
*/
typedef OdSmartPtr<IfcProjectOrder> IfcProjectOrderPtr;

} // namespace

#endif // _IFC2X3_IFCPROJECTORDER_AUTO_IMPL_H
