...
#ifndef _IFC2X3_IFCRELNESTS_AUTO_IMPL_H
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelNests, IfcRelNests> object.
*/
typedef OdSmartPtr<IfcRelNests> IfcRelNestsPtr;

} // namespace

#endif // _IFC2X3_IFCRELNESTS_AUTO_IMPL_H
