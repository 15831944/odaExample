...
#ifndef _IFC2X3_IFCSPACETYPE_AUTO_IMPL_H
#define _IFC2X3_IFCSPACETYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcSpaceType : public IfcSpatialStructureElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcSpaceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSpaceType, IfcSpaceType> object.
*/
typedef OdSmartPtr<IfcSpaceType> IfcSpaceTypePtr;

} // namespace

#endif // _IFC2X3_IFCSPACETYPE_AUTO_IMPL_H
