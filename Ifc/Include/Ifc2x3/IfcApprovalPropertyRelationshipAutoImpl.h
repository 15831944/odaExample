...
#ifndef _IFC2X3_IFCAPPROVALPROPERTYRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCAPPROVALPROPERTYRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcApprovalPropertyRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcApprovalPropertyRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcApprovalPropertyRelationship, IfcApprovalPropertyRelationship> object.
*/
typedef OdSmartPtr<IfcApprovalPropertyRelationship> IfcApprovalPropertyRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCAPPROVALPROPERTYRELATIONSHIP_AUTO_IMPL_H
