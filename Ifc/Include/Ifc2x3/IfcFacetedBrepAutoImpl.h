...
#ifndef _IFC2X3_IFCFACETEDBREP_AUTO_IMPL_H
#define _IFC2X3_IFCFACETEDBREP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFacetedBrep : public IfcManifoldSolidBrep
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFacetedBrep);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFacetedBrep, IfcFacetedBrep> object.
*/
typedef OdSmartPtr<IfcFacetedBrep> IfcFacetedBrepPtr;

} // namespace

#endif // _IFC2X3_IFCFACETEDBREP_AUTO_IMPL_H
