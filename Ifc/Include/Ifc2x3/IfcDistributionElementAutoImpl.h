...
#ifndef _IFC2X3_IFCDISTRIBUTIONELEMENT_AUTO_IMPL_H
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDistributionElement, IfcDistributionElement> object.
*/
typedef OdSmartPtr<IfcDistributionElement> IfcDistributionElementPtr;

} // namespace

#endif // _IFC2X3_IFCDISTRIBUTIONELEMENT_AUTO_IMPL_H
