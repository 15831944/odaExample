...
#ifndef _IFC2X3_IFCELLIPSE_AUTO_IMPL_H
#define _IFC2X3_IFCELLIPSE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcEllipse : public IfcConic
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcEllipse);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcEllipse, IfcEllipse> object.
*/
typedef OdSmartPtr<IfcEllipse> IfcEllipsePtr;

} // namespace

#endif // _IFC2X3_IFCELLIPSE_AUTO_IMPL_H
