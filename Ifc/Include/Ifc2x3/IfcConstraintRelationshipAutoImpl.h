...
#ifndef _IFC2X3_IFCCONSTRAINTRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCCONSTRAINTRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcConstraintRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcConstraintRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcConstraintRelationship, IfcConstraintRelationship> object.
*/
typedef OdSmartPtr<IfcConstraintRelationship> IfcConstraintRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCCONSTRAINTRELATIONSHIP_AUTO_IMPL_H
