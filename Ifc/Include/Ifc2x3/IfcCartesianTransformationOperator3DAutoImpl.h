...
#ifndef _IFC2X3_IFCCARTESIANTRANSFORMATIONOPERATOR3D_AUTO_IMPL_H
#define _IFC2X3_IFCCARTESIANTRANSFORMATIONOPERATOR3D_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCartesianTransformationOperator3D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCartesianTransformationOperator3D, IfcCartesianTransformationOperator3D> object.
*/
typedef OdSmartPtr<IfcCartesianTransformationOperator3D> IfcCartesianTransformationOperator3DPtr;

} // namespace

#endif // _IFC2X3_IFCCARTESIANTRANSFORMATIONOPERATOR3D_AUTO_IMPL_H
