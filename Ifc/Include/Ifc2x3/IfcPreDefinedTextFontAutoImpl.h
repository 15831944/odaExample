...
#ifndef _IFC2X3_IFCPREDEFINEDTEXTFONT_AUTO_IMPL_H
#define _IFC2X3_IFCPREDEFINEDTEXTFONT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPreDefinedTextFont : public IfcPreDefinedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcPreDefinedTextFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPreDefinedTextFont, IfcPreDefinedTextFont> object.
*/
typedef OdSmartPtr<IfcPreDefinedTextFont> IfcPreDefinedTextFontPtr;

} // namespace

#endif // _IFC2X3_IFCPREDEFINEDTEXTFONT_AUTO_IMPL_H
