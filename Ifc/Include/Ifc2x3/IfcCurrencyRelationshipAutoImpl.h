...
#ifndef _IFC2X3_IFCCURRENCYRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCCURRENCYRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCurrencyRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCurrencyRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCurrencyRelationship, IfcCurrencyRelationship> object.
*/
typedef OdSmartPtr<IfcCurrencyRelationship> IfcCurrencyRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCCURRENCYRELATIONSHIP_AUTO_IMPL_H
