...
#ifndef _IFC2X3_IFCMOTORCONNECTIONTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCMOTORCONNECTIONTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcMotorConnectionType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcMotorConnectionType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcMotorConnectionType, IfcMotorConnectionType> object.
*/
typedef OdSmartPtr<IfcMotorConnectionType> IfcMotorConnectionTypePtr;

} // namespace

#endif // _IFC2X3_IFCMOTORCONNECTIONTYPE_AUTO_IMPL_H
