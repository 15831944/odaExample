...
#ifndef _IFC2X3_IFCFLOWTREATMENTDEVICE_AUTO_IMPL_H
#define _IFC2X3_IFCFLOWTREATMENTDEVICE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFlowTreatmentDevice : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFlowTreatmentDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFlowTreatmentDevice, IfcFlowTreatmentDevice> object.
*/
typedef OdSmartPtr<IfcFlowTreatmentDevice> IfcFlowTreatmentDevicePtr;

} // namespace

#endif // _IFC2X3_IFCFLOWTREATMENTDEVICE_AUTO_IMPL_H
