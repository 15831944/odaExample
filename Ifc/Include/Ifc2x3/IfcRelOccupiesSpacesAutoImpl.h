...
#ifndef _IFC2X3_IFCRELOCCUPIESSPACES_AUTO_IMPL_H
#define _IFC2X3_IFCRELOCCUPIESSPACES_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRelOccupiesSpaces : public IfcRelAssignsToActor
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRelOccupiesSpaces);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelOccupiesSpaces, IfcRelOccupiesSpaces> object.
*/
typedef OdSmartPtr<IfcRelOccupiesSpaces> IfcRelOccupiesSpacesPtr;

} // namespace

#endif // _IFC2X3_IFCRELOCCUPIESSPACES_AUTO_IMPL_H
