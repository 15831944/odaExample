...
#ifndef _IFC2X3_IFCPRESENTATIONLAYERASSIGNMENT_AUTO_IMPL_H
#define _IFC2X3_IFCPRESENTATIONLAYERASSIGNMENT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPresentationLayerAssignment : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPresentationLayerAssignment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPresentationLayerAssignment, IfcPresentationLayerAssignment> object.
*/
typedef OdSmartPtr<IfcPresentationLayerAssignment> IfcPresentationLayerAssignmentPtr;

} // namespace

#endif // _IFC2X3_IFCPRESENTATIONLAYERASSIGNMENT_AUTO_IMPL_H
