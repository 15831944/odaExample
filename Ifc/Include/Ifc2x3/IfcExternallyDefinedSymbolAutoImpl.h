...
#ifndef _IFC2X3_IFCEXTERNALLYDEFINEDSYMBOL_AUTO_IMPL_H
#define _IFC2X3_IFCEXTERNALLYDEFINEDSYMBOL_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcExternallyDefinedSymbol : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcExternallyDefinedSymbol);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcExternallyDefinedSymbol, IfcExternallyDefinedSymbol> object.
*/
typedef OdSmartPtr<IfcExternallyDefinedSymbol> IfcExternallyDefinedSymbolPtr;

} // namespace

#endif // _IFC2X3_IFCEXTERNALLYDEFINEDSYMBOL_AUTO_IMPL_H
