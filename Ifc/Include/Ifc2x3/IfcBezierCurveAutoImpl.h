...
#ifndef _IFC2X3_IFCBEZIERCURVE_AUTO_IMPL_H
#define _IFC2X3_IFCBEZIERCURVE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcBezierCurve : public IfcBSplineCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcBezierCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcBezierCurve, IfcBezierCurve> object.
*/
typedef OdSmartPtr<IfcBezierCurve> IfcBezierCurvePtr;

} // namespace

#endif // _IFC2X3_IFCBEZIERCURVE_AUTO_IMPL_H
