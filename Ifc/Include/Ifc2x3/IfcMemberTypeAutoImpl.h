...
#ifndef _IFC2X3_IFCMEMBERTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCMEMBERTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcMemberType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcMemberType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcMemberType, IfcMemberType> object.
*/
typedef OdSmartPtr<IfcMemberType> IfcMemberTypePtr;

} // namespace

#endif // _IFC2X3_IFCMEMBERTYPE_AUTO_IMPL_H
