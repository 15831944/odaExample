...
#ifndef _IFC2X3_IFCANNOTATIONFILLAREAOCCURRENCE_AUTO_IMPL_H
#define _IFC2X3_IFCANNOTATIONFILLAREAOCCURRENCE_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcAnnotationFillAreaOccurrence);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_FillStyleTarget;   // IfcPoint  [optional]
  OdDAI::Enum m_GlobalOrLocal;   // IfcGlobalOrLocalEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcAnnotationFillAreaOccurrence, IfcAnnotationFillAreaOccurrence> object.
*/
typedef OdSmartPtr<IfcAnnotationFillAreaOccurrence> IfcAnnotationFillAreaOccurrencePtr;

} // namespace

#endif // _IFC2X3_IFCANNOTATIONFILLAREAOCCURRENCE_AUTO_IMPL_H
