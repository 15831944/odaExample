...
#ifndef _IFC2X3_IFCDRAUGHTINGPREDEFINEDCURVEFONT_AUTO_IMPL_H
#define _IFC2X3_IFCDRAUGHTINGPREDEFINEDCURVEFONT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDraughtingPreDefinedCurveFont : public IfcPreDefinedCurveFont
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDraughtingPreDefinedCurveFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDraughtingPreDefinedCurveFont, IfcDraughtingPreDefinedCurveFont> object.
*/
typedef OdSmartPtr<IfcDraughtingPreDefinedCurveFont> IfcDraughtingPreDefinedCurveFontPtr;

} // namespace

#endif // _IFC2X3_IFCDRAUGHTINGPREDEFINEDCURVEFONT_AUTO_IMPL_H
