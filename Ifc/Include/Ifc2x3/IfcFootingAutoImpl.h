...
#ifndef _IFC2X3_IFCFOOTING_AUTO_IMPL_H
#define _IFC2X3_IFCFOOTING_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFooting : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFooting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFooting, IfcFooting> object.
*/
typedef OdSmartPtr<IfcFooting> IfcFootingPtr;

} // namespace

#endif // _IFC2X3_IFCFOOTING_AUTO_IMPL_H
