...
#ifndef _IFC2X3_IFCPROPERTYLISTVALUE_AUTO_IMPL_H
#define _IFC2X3_IFCPROPERTYLISTVALUE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPropertyListValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPropertyListValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPropertyListValue, IfcPropertyListValue> object.
*/
typedef OdSmartPtr<IfcPropertyListValue> IfcPropertyListValuePtr;

} // namespace

#endif // _IFC2X3_IFCPROPERTYLISTVALUE_AUTO_IMPL_H
