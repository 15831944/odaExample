...
#ifndef _IFC2X3_IFCRAILING_AUTO_IMPL_H
#define _IFC2X3_IFCRAILING_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRailing : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRailing);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRailing, IfcRailing> object.
*/
typedef OdSmartPtr<IfcRailing> IfcRailingPtr;

} // namespace

#endif // _IFC2X3_IFCRAILING_AUTO_IMPL_H
