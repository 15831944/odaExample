...
#ifndef _IFC2X3_IFCPREDEFINEDDIMENSIONSYMBOL_AUTO_IMPL_H
#define _IFC2X3_IFCPREDEFINEDDIMENSIONSYMBOL_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPreDefinedDimensionSymbol : public IfcPreDefinedSymbol
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPreDefinedDimensionSymbol);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPreDefinedDimensionSymbol, IfcPreDefinedDimensionSymbol> object.
*/
typedef OdSmartPtr<IfcPreDefinedDimensionSymbol> IfcPreDefinedDimensionSymbolPtr;

} // namespace

#endif // _IFC2X3_IFCPREDEFINEDDIMENSIONSYMBOL_AUTO_IMPL_H
