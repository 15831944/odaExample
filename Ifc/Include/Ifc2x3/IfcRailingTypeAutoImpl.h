...
#ifndef _IFC2X3_IFCRAILINGTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCRAILINGTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRailingType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRailingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRailingType, IfcRailingType> object.
*/
typedef OdSmartPtr<IfcRailingType> IfcRailingTypePtr;

} // namespace

#endif // _IFC2X3_IFCRAILINGTYPE_AUTO_IMPL_H
