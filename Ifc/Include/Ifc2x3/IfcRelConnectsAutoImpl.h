...
#ifndef _IFC2X3_IFCRELCONNECTS_AUTO_IMPL_H
#define _IFC2X3_IFCRELCONNECTS_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRelConnects : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcRelConnects);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelConnects, IfcRelConnects> object.
*/
typedef OdSmartPtr<IfcRelConnects> IfcRelConnectsPtr;

} // namespace

#endif // _IFC2X3_IFCRELCONNECTS_AUTO_IMPL_H
