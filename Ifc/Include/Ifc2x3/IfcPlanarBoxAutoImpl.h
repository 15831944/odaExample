...
#ifndef _IFC2X3_IFCPLANARBOX_AUTO_IMPL_H
#define _IFC2X3_IFCPLANARBOX_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPlanarBox : public IfcPlanarExtent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPlanarBox);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPlanarBox, IfcPlanarBox> object.
*/
typedef OdSmartPtr<IfcPlanarBox> IfcPlanarBoxPtr;

} // namespace

#endif // _IFC2X3_IFCPLANARBOX_AUTO_IMPL_H
