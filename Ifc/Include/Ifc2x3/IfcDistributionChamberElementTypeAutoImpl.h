...
#ifndef _IFC2X3_IFCDISTRIBUTIONCHAMBERELEMENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCDISTRIBUTIONCHAMBERELEMENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDistributionChamberElementType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDistributionChamberElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDistributionChamberElementType, IfcDistributionChamberElementType> object.
*/
typedef OdSmartPtr<IfcDistributionChamberElementType> IfcDistributionChamberElementTypePtr;

} // namespace

#endif // _IFC2X3_IFCDISTRIBUTIONCHAMBERELEMENTTYPE_AUTO_IMPL_H
