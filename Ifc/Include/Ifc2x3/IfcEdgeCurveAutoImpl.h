...
#ifndef _IFC2X3_IFCEDGECURVE_AUTO_IMPL_H
#define _IFC2X3_IFCEDGECURVE_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcEdgeCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcEdgeCurve, IfcEdgeCurve> object.
*/
typedef OdSmartPtr<IfcEdgeCurve> IfcEdgeCurvePtr;

} // namespace

#endif // _IFC2X3_IFCEDGECURVE_AUTO_IMPL_H
