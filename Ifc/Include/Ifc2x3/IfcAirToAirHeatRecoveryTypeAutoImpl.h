...
#ifndef _IFC2X3_IFCAIRTOAIRHEATRECOVERYTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCAIRTOAIRHEATRECOVERYTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcAirToAirHeatRecoveryType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcAirToAirHeatRecoveryType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcAirToAirHeatRecoveryType, IfcAirToAirHeatRecoveryType> object.
*/
typedef OdSmartPtr<IfcAirToAirHeatRecoveryType> IfcAirToAirHeatRecoveryTypePtr;

} // namespace

#endif // _IFC2X3_IFCAIRTOAIRHEATRECOVERYTYPE_AUTO_IMPL_H
