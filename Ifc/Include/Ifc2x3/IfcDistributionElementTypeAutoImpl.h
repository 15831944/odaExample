...
#ifndef _IFC2X3_IFCDISTRIBUTIONELEMENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCDISTRIBUTIONELEMENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDistributionElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDistributionElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDistributionElementType, IfcDistributionElementType> object.
*/
typedef OdSmartPtr<IfcDistributionElementType> IfcDistributionElementTypePtr;

} // namespace

#endif // _IFC2X3_IFCDISTRIBUTIONELEMENTTYPE_AUTO_IMPL_H
