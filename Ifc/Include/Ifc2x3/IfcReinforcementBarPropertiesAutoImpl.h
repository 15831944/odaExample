...
#ifndef _IFC2X3_IFCREINFORCEMENTBARPROPERTIES_AUTO_IMPL_H
#define _IFC2X3_IFCREINFORCEMENTBARPROPERTIES_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcReinforcementBarProperties : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcReinforcementBarProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcReinforcementBarProperties, IfcReinforcementBarProperties> object.
*/
typedef OdSmartPtr<IfcReinforcementBarProperties> IfcReinforcementBarPropertiesPtr;

} // namespace

#endif // _IFC2X3_IFCREINFORCEMENTBARPROPERTIES_AUTO_IMPL_H
