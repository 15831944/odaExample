...
#ifndef _IFC2X3_IFCPUMPTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCPUMPTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPumpType : public IfcFlowMovingDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPumpType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPumpType, IfcPumpType> object.
*/
typedef OdSmartPtr<IfcPumpType> IfcPumpTypePtr;

} // namespace

#endif // _IFC2X3_IFCPUMPTYPE_AUTO_IMPL_H
