...
#ifndef _IFC2X3_IFCPIPEFITTINGTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCPIPEFITTINGTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPipeFittingType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPipeFittingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPipeFittingType, IfcPipeFittingType> object.
*/
typedef OdSmartPtr<IfcPipeFittingType> IfcPipeFittingTypePtr;

} // namespace

#endif // _IFC2X3_IFCPIPEFITTINGTYPE_AUTO_IMPL_H
