...
#ifndef _IFC2X3_IFCANNOTATIONSURFACEOCCURRENCE_AUTO_IMPL_H
#define _IFC2X3_IFCANNOTATIONSURFACEOCCURRENCE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcAnnotationSurfaceOccurrence : public IfcAnnotationOccurrence
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcAnnotationSurfaceOccurrence);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcAnnotationSurfaceOccurrence, IfcAnnotationSurfaceOccurrence> object.
*/
typedef OdSmartPtr<IfcAnnotationSurfaceOccurrence> IfcAnnotationSurfaceOccurrencePtr;

} // namespace

#endif // _IFC2X3_IFCANNOTATIONSURFACEOCCURRENCE_AUTO_IMPL_H
