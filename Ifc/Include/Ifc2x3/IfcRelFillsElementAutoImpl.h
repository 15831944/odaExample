...
#ifndef _IFC2X3_IFCRELFILLSELEMENT_AUTO_IMPL_H
#define _IFC2X3_IFCRELFILLSELEMENT_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRelFillsElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelFillsElement, IfcRelFillsElement> object.
*/
typedef OdSmartPtr<IfcRelFillsElement> IfcRelFillsElementPtr;

} // namespace

#endif // _IFC2X3_IFCRELFILLSELEMENT_AUTO_IMPL_H
