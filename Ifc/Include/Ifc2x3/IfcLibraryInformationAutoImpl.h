...
#ifndef _IFC2X3_IFCLIBRARYINFORMATION_AUTO_IMPL_H
#define _IFC2X3_IFCLIBRARYINFORMATION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcLibraryInformation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcLibraryInformation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcLibraryInformation, IfcLibraryInformation> object.
*/
typedef OdSmartPtr<IfcLibraryInformation> IfcLibraryInformationPtr;

} // namespace

#endif // _IFC2X3_IFCLIBRARYINFORMATION_AUTO_IMPL_H
