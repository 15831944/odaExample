...
#ifndef _IFC2X3_IFCDERIVEDUNIT_AUTO_IMPL_H
#define _IFC2X3_IFCDERIVEDUNIT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDerivedUnit : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDerivedUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDerivedUnit, IfcDerivedUnit> object.
*/
typedef OdSmartPtr<IfcDerivedUnit> IfcDerivedUnitPtr;

} // namespace

#endif // _IFC2X3_IFCDERIVEDUNIT_AUTO_IMPL_H
