...
#ifndef _IFC2X3_IFCSTRUCTURALPOINTCONNECTION_AUTO_IMPL_H
#define _IFC2X3_IFCSTRUCTURALPOINTCONNECTION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcStructuralPointConnection : public IfcStructuralConnection
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcStructuralPointConnection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcStructuralPointConnection, IfcStructuralPointConnection> object.
*/
typedef OdSmartPtr<IfcStructuralPointConnection> IfcStructuralPointConnectionPtr;

} // namespace

#endif // _IFC2X3_IFCSTRUCTURALPOINTCONNECTION_AUTO_IMPL_H
