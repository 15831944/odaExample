...
#ifndef _IFC2X3_IFCPRODUCTREPRESENTATION_AUTO_IMPL_H
#define _IFC2X3_IFCPRODUCTREPRESENTATION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcProductRepresentation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcProductRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcProductRepresentation, IfcProductRepresentation> object.
*/
typedef OdSmartPtr<IfcProductRepresentation> IfcProductRepresentationPtr;

} // namespace

#endif // _IFC2X3_IFCPRODUCTREPRESENTATION_AUTO_IMPL_H
