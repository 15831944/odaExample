...
class IFC2X3_EXPORT IfcReferencesValueDocument : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcReferencesValueDocument, IfcReferencesValueDocument> object.
*/
typedef OdSmartPtr<IfcReferencesValueDocument> IfcReferencesValueDocumentPtr;

} // namespace

#endif // _IFC2X3_IFCREFERENCESVALUEDOCUMENT_AUTO_IMPL_H
