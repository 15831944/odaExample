...
#ifndef _IFC2X3_IFCDISCRETEACCESSORY_AUTO_IMPL_H
#define _IFC2X3_IFCDISCRETEACCESSORY_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDiscreteAccessory : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDiscreteAccessory);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDiscreteAccessory, IfcDiscreteAccessory> object.
*/
typedef OdSmartPtr<IfcDiscreteAccessory> IfcDiscreteAccessoryPtr;

} // namespace

#endif // _IFC2X3_IFCDISCRETEACCESSORY_AUTO_IMPL_H
