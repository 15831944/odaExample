...
#ifndef _IFC2X3_IFCFACEBOUND_AUTO_IMPL_H
#define _IFC2X3_IFCFACEBOUND_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFaceBound);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFaceBound, IfcFaceBound> object.
*/
typedef OdSmartPtr<IfcFaceBound> IfcFaceBoundPtr;

} // namespace

#endif // _IFC2X3_IFCFACEBOUND_AUTO_IMPL_H
