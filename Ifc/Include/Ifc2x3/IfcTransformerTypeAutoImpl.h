...
#ifndef _IFC2X3_IFCTRANSFORMERTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCTRANSFORMERTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcTransformerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTransformerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTransformerType, IfcTransformerType> object.
*/
typedef OdSmartPtr<IfcTransformerType> IfcTransformerTypePtr;

} // namespace

#endif // _IFC2X3_IFCTRANSFORMERTYPE_AUTO_IMPL_H
