...
#ifndef _IFC2X3_IFCFEATUREELEMENTADDITION_AUTO_IMPL_H
#define _IFC2X3_IFCFEATUREELEMENTADDITION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFeatureElementAddition : public IfcFeatureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcFeatureElementAddition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFeatureElementAddition, IfcFeatureElementAddition> object.
*/
typedef OdSmartPtr<IfcFeatureElementAddition> IfcFeatureElementAdditionPtr;

} // namespace

#endif // _IFC2X3_IFCFEATUREELEMENTADDITION_AUTO_IMPL_H
