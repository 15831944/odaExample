...
#ifndef _IFC2X3_IFCSTRUCTURALMEMBER_AUTO_IMPL_H
#define _IFC2X3_IFCSTRUCTURALMEMBER_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcStructuralMember);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvReferencesElement(OdDAIObjectIds& ReferencesElement) const;
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcStructuralMember, IfcStructuralMember> object.
*/
typedef OdSmartPtr<IfcStructuralMember> IfcStructuralMemberPtr;

} // namespace

#endif // _IFC2X3_IFCSTRUCTURALMEMBER_AUTO_IMPL_H
