...
#ifndef _IFC2X3_IFCCONDITION_AUTO_IMPL_H
#define _IFC2X3_IFCCONDITION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCondition : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCondition, IfcCondition> object.
*/
typedef OdSmartPtr<IfcCondition> IfcConditionPtr;

} // namespace

#endif // _IFC2X3_IFCCONDITION_AUTO_IMPL_H
