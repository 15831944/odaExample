...
#ifndef _IFC2X3_IFCRELAGGREGATES_AUTO_IMPL_H
#define _IFC2X3_IFCRELAGGREGATES_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRelAggregates : public IfcRelDecomposes
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRelAggregates);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelAggregates, IfcRelAggregates> object.
*/
typedef OdSmartPtr<IfcRelAggregates> IfcRelAggregatesPtr;

} // namespace

#endif // _IFC2X3_IFCRELAGGREGATES_AUTO_IMPL_H
