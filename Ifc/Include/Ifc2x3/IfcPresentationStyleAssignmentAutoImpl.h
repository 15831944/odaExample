...
#ifndef _IFC2X3_IFCPRESENTATIONSTYLEASSIGNMENT_AUTO_IMPL_H
#define _IFC2X3_IFCPRESENTATIONSTYLEASSIGNMENT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPresentationStyleAssignment : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPresentationStyleAssignment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPresentationStyleAssignment, IfcPresentationStyleAssignment> object.
*/
typedef OdSmartPtr<IfcPresentationStyleAssignment> IfcPresentationStyleAssignmentPtr;

} // namespace

#endif // _IFC2X3_IFCPRESENTATIONSTYLEASSIGNMENT_AUTO_IMPL_H
