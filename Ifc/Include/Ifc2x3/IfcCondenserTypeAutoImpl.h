...
#ifndef _IFC2X3_IFCCONDENSERTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCCONDENSERTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCondenserType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCondenserType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCondenserType, IfcCondenserType> object.
*/
typedef OdSmartPtr<IfcCondenserType> IfcCondenserTypePtr;

} // namespace

#endif // _IFC2X3_IFCCONDENSERTYPE_AUTO_IMPL_H
