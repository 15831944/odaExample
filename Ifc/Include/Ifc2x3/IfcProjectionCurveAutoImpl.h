...
#ifndef _IFC2X3_IFCPROJECTIONCURVE_AUTO_IMPL_H
#define _IFC2X3_IFCPROJECTIONCURVE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcProjectionCurve : public IfcAnnotationCurveOccurrence
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcProjectionCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcProjectionCurve, IfcProjectionCurve> object.
*/
typedef OdSmartPtr<IfcProjectionCurve> IfcProjectionCurvePtr;

} // namespace

#endif // _IFC2X3_IFCPROJECTIONCURVE_AUTO_IMPL_H
