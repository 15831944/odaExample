...
#ifndef _IFC2X3_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
#define _IFC2X3_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcSurfaceOfLinearExtrusion);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSurfaceOfLinearExtrusion, IfcSurfaceOfLinearExtrusion> object.
*/
typedef OdSmartPtr<IfcSurfaceOfLinearExtrusion> IfcSurfaceOfLinearExtrusionPtr;

} // namespace

#endif // _IFC2X3_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
