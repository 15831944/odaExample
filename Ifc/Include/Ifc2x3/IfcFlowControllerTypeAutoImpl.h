...
#ifndef _IFC2X3_IFCFLOWCONTROLLERTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCFLOWCONTROLLERTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFlowControllerType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcFlowControllerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFlowControllerType, IfcFlowControllerType> object.
*/
typedef OdSmartPtr<IfcFlowControllerType> IfcFlowControllerTypePtr;

} // namespace

#endif // _IFC2X3_IFCFLOWCONTROLLERTYPE_AUTO_IMPL_H
