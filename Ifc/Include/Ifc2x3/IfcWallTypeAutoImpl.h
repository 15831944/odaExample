...
#ifndef _IFC2X3_IFCWALLTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCWALLTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcWallType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcWallType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcWallType, IfcWallType> object.
*/
typedef OdSmartPtr<IfcWallType> IfcWallTypePtr;

} // namespace

#endif // _IFC2X3_IFCWALLTYPE_AUTO_IMPL_H
