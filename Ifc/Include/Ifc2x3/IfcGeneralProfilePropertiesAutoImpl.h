...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcGeneralProfileProperties, IfcGeneralProfileProperties> object.
*/
typedef OdSmartPtr<IfcGeneralProfileProperties> IfcGeneralProfilePropertiesPtr;

} // namespace

#endif // _IFC2X3_IFCGENERALPROFILEPROPERTIES_AUTO_IMPL_H
