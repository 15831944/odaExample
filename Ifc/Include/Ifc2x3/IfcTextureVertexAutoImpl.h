...
#ifndef _IFC2X3_IFCTEXTUREVERTEX_AUTO_IMPL_H
#define _IFC2X3_IFCTEXTUREVERTEX_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcTextureVertex : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTextureVertex);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTextureVertex, IfcTextureVertex> object.
*/
typedef OdSmartPtr<IfcTextureVertex> IfcTextureVertexPtr;

} // namespace

#endif // _IFC2X3_IFCTEXTUREVERTEX_AUTO_IMPL_H
