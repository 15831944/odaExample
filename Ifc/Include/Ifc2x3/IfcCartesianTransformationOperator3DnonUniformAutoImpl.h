...
#ifndef _IFC2X3_IFCCARTESIANTRANSFORMATIONOPERATOR3DNONUNIFORM_AUTO_IMPL_H
#define _IFC2X3_IFCCARTESIANTRANSFORMATIONOPERATOR3DNONUNIFORM_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCartesianTransformationOperator3DnonUniform);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCartesianTransformationOperator3DnonUniform, IfcCartesianTransformationOperator3DnonUniform> object.
*/
typedef OdSmartPtr<IfcCartesianTransformationOperator3DnonUniform> IfcCartesianTransformationOperator3DnonUniformPtr;

} // namespace

#endif // _IFC2X3_IFCCARTESIANTRANSFORMATIONOPERATOR3DNONUNIFORM_AUTO_IMPL_H
