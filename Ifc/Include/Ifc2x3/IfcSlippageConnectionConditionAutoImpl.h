...
#ifndef _IFC2X3_IFCSLIPPAGECONNECTIONCONDITION_AUTO_IMPL_H
#define _IFC2X3_IFCSLIPPAGECONNECTIONCONDITION_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcSlippageConnectionCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSlippageConnectionCondition, IfcSlippageConnectionCondition> object.
*/
typedef OdSmartPtr<IfcSlippageConnectionCondition> IfcSlippageConnectionConditionPtr;

} // namespace

#endif // _IFC2X3_IFCSLIPPAGECONNECTIONCONDITION_AUTO_IMPL_H
