...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcThermalMaterialProperties, IfcThermalMaterialProperties> object.
*/
typedef OdSmartPtr<IfcThermalMaterialProperties> IfcThermalMaterialPropertiesPtr;

} // namespace

#endif // _IFC2X3_IFCTHERMALMATERIALPROPERTIES_AUTO_IMPL_H
