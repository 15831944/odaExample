...
#ifndef _IFC2X3_IFCFEATUREELEMENT_AUTO_IMPL_H
#define _IFC2X3_IFCFEATUREELEMENT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFeatureElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcFeatureElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFeatureElement, IfcFeatureElement> object.
*/
typedef OdSmartPtr<IfcFeatureElement> IfcFeatureElementPtr;

} // namespace

#endif // _IFC2X3_IFCFEATUREELEMENT_AUTO_IMPL_H
