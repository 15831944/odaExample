...
#ifndef _IFC2X3_IFCCURVESTYLEFONT_AUTO_IMPL_H
#define _IFC2X3_IFCCURVESTYLEFONT_AUTO_IMPL_H
...
*/
class IFC2X3_EXPORT IfcCurveStyleFont : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCurveStyleFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCurveStyleFont, IfcCurveStyleFont> object.
*/
typedef OdSmartPtr<IfcCurveStyleFont> IfcCurveStyleFontPtr;

} // namespace

#endif // _IFC2X3_IFCCURVESTYLEFONT_AUTO_IMPL_H
