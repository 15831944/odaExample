...
#ifndef _IFC2X3_IFCOBJECTDEFINITION_AUTO_IMPL_H
#define _IFC2X3_IFCOBJECTDEFINITION_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcObjectDefinition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcObjectDefinition, IfcObjectDefinition> object.
*/
typedef OdSmartPtr<IfcObjectDefinition> IfcObjectDefinitionPtr;

} // namespace

#endif // _IFC2X3_IFCOBJECTDEFINITION_AUTO_IMPL_H
