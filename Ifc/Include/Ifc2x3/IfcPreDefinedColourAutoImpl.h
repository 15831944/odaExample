...
#ifndef _IFC2X3_IFCPREDEFINEDCOLOUR_AUTO_IMPL_H
#define _IFC2X3_IFCPREDEFINEDCOLOUR_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPreDefinedColour : public IfcPreDefinedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcPreDefinedColour);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPreDefinedColour, IfcPreDefinedColour> object.
*/
typedef OdSmartPtr<IfcPreDefinedColour> IfcPreDefinedColourPtr;

} // namespace

#endif // _IFC2X3_IFCPREDEFINEDCOLOUR_AUTO_IMPL_H
