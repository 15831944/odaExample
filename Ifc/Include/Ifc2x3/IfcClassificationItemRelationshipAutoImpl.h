...
#ifndef _IFC2X3_IFCCLASSIFICATIONITEMRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCCLASSIFICATIONITEMRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcClassificationItemRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcClassificationItemRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcClassificationItemRelationship, IfcClassificationItemRelationship> object.
*/
typedef OdSmartPtr<IfcClassificationItemRelationship> IfcClassificationItemRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCCLASSIFICATIONITEMRELATIONSHIP_AUTO_IMPL_H
