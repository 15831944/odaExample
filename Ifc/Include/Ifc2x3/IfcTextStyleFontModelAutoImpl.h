...
#ifndef _IFC2X3_IFCTEXTSTYLEFONTMODEL_AUTO_IMPL_H
#define _IFC2X3_IFCTEXTSTYLEFONTMODEL_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTextStyleFontModel);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::OdAnsiStringList m_FontFamily; // LIST [1:?] of IfcTextFontName [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTextStyleFontModel, IfcTextStyleFontModel> object.
*/
typedef OdSmartPtr<IfcTextStyleFontModel> IfcTextStyleFontModelPtr;

} // namespace

#endif // _IFC2X3_IFCTEXTSTYLEFONTMODEL_AUTO_IMPL_H
