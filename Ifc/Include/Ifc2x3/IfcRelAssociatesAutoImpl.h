...
#ifndef _IFC2X3_IFCRELASSOCIATES_AUTO_IMPL_H
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelAssociates, IfcRelAssociates> object.
*/
typedef OdSmartPtr<IfcRelAssociates> IfcRelAssociatesPtr;

} // namespace

#endif // _IFC2X3_IFCRELASSOCIATES_AUTO_IMPL_H
