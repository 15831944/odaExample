...
#ifndef _IFC2X3_IFCLIBRARYREFERENCE_AUTO_IMPL_H
#define _IFC2X3_IFCLIBRARYREFERENCE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcLibraryReference : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcLibraryReference);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcLibraryReference, IfcLibraryReference> object.
*/
typedef OdSmartPtr<IfcLibraryReference> IfcLibraryReferencePtr;

} // namespace

#endif // _IFC2X3_IFCLIBRARYREFERENCE_AUTO_IMPL_H
