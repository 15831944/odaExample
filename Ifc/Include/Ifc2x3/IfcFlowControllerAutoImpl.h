...
#ifndef _IFC2X3_IFCFLOWCONTROLLER_AUTO_IMPL_H
#define _IFC2X3_IFCFLOWCONTROLLER_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFlowController : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFlowController);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFlowController, IfcFlowController> object.
*/
typedef OdSmartPtr<IfcFlowController> IfcFlowControllerPtr;

} // namespace

#endif // _IFC2X3_IFCFLOWCONTROLLER_AUTO_IMPL_H
