...
#ifndef _IFC2X3_IFCDISTRIBUTIONFLOWELEMENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCDISTRIBUTIONFLOWELEMENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDistributionFlowElementType : public IfcDistributionElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcDistributionFlowElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDistributionFlowElementType, IfcDistributionFlowElementType> object.
*/
typedef OdSmartPtr<IfcDistributionFlowElementType> IfcDistributionFlowElementTypePtr;

} // namespace

#endif // _IFC2X3_IFCDISTRIBUTIONFLOWELEMENTTYPE_AUTO_IMPL_H
