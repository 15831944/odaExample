...
#ifndef _IFC2X3_IFCLIGHTSOURCEAMBIENT_AUTO_IMPL_H
#define _IFC2X3_IFCLIGHTSOURCEAMBIENT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcLightSourceAmbient : public IfcLightSource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcLightSourceAmbient);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcLightSourceAmbient, IfcLightSourceAmbient> object.
*/
typedef OdSmartPtr<IfcLightSourceAmbient> IfcLightSourceAmbientPtr;

} // namespace

#endif // _IFC2X3_IFCLIGHTSOURCEAMBIENT_AUTO_IMPL_H
