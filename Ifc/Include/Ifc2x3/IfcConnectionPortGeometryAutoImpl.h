...
#ifndef _IFC2X3_IFCCONNECTIONPORTGEOMETRY_AUTO_IMPL_H
#define _IFC2X3_IFCCONNECTIONPORTGEOMETRY_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcConnectionPortGeometry);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcConnectionPortGeometry, IfcConnectionPortGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionPortGeometry> IfcConnectionPortGeometryPtr;

} // namespace

#endif // _IFC2X3_IFCCONNECTIONPORTGEOMETRY_AUTO_IMPL_H
