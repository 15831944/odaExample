...
#ifndef _IFC2X3_IFCEXTERNALLYDEFINEDHATCHSTYLE_AUTO_IMPL_H
#define _IFC2X3_IFCEXTERNALLYDEFINEDHATCHSTYLE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcExternallyDefinedHatchStyle : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcExternallyDefinedHatchStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcExternallyDefinedHatchStyle, IfcExternallyDefinedHatchStyle> object.
*/
typedef OdSmartPtr<IfcExternallyDefinedHatchStyle> IfcExternallyDefinedHatchStylePtr;

} // namespace

#endif // _IFC2X3_IFCEXTERNALLYDEFINEDHATCHSTYLE_AUTO_IMPL_H
