...
#ifndef _IFC2X3_IFCCREWRESOURCE_AUTO_IMPL_H
#define _IFC2X3_IFCCREWRESOURCE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCrewResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCrewResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCrewResource, IfcCrewResource> object.
*/
typedef OdSmartPtr<IfcCrewResource> IfcCrewResourcePtr;

} // namespace

#endif // _IFC2X3_IFCCREWRESOURCE_AUTO_IMPL_H
