...
#ifndef _IFC2X3_IFCFURNISHINGELEMENT_AUTO_IMPL_H
#define _IFC2X3_IFCFURNISHINGELEMENT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFurnishingElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFurnishingElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFurnishingElement, IfcFurnishingElement> object.
*/
typedef OdSmartPtr<IfcFurnishingElement> IfcFurnishingElementPtr;

} // namespace

#endif // _IFC2X3_IFCFURNISHINGELEMENT_AUTO_IMPL_H
