...
#ifndef _IFC2X3_IFCCIRCLEPROFILEDEF_AUTO_IMPL_H
#define _IFC2X3_IFCCIRCLEPROFILEDEF_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCircleProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCircleProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCircleProfileDef, IfcCircleProfileDef> object.
*/
typedef OdSmartPtr<IfcCircleProfileDef> IfcCircleProfileDefPtr;

} // namespace

#endif // _IFC2X3_IFCCIRCLEPROFILEDEF_AUTO_IMPL_H
