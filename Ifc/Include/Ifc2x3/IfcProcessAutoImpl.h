...
#ifndef _IFC2X3_IFCPROCESS_AUTO_IMPL_H
#define _IFC2X3_IFCPROCESS_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcProcess);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcProcess, IfcProcess> object.
*/
typedef OdSmartPtr<IfcProcess> IfcProcessPtr;

} // namespace

#endif // _IFC2X3_IFCPROCESS_AUTO_IMPL_H
