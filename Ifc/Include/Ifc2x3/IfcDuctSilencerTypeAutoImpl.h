...
#ifndef _IFC2X3_IFCDUCTSILENCERTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCDUCTSILENCERTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDuctSilencerType : public IfcFlowTreatmentDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDuctSilencerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDuctSilencerType, IfcDuctSilencerType> object.
*/
typedef OdSmartPtr<IfcDuctSilencerType> IfcDuctSilencerTypePtr;

} // namespace

#endif // _IFC2X3_IFCDUCTSILENCERTYPE_AUTO_IMPL_H
