...
#ifndef _IFC2X3_IFCELEMENTASSEMBLY_AUTO_IMPL_H
#define _IFC2X3_IFCELEMENTASSEMBLY_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcElementAssembly : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcElementAssembly);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcElementAssembly, IfcElementAssembly> object.
*/
typedef OdSmartPtr<IfcElementAssembly> IfcElementAssemblyPtr;

} // namespace

#endif // _IFC2X3_IFCELEMENTASSEMBLY_AUTO_IMPL_H
