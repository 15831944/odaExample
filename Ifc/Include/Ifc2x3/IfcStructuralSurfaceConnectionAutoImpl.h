...
#ifndef _IFC2X3_IFCSTRUCTURALSURFACECONNECTION_AUTO_IMPL_H
#define _IFC2X3_IFCSTRUCTURALSURFACECONNECTION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcStructuralSurfaceConnection : public IfcStructuralConnection
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcStructuralSurfaceConnection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcStructuralSurfaceConnection, IfcStructuralSurfaceConnection> object.
*/
typedef OdSmartPtr<IfcStructuralSurfaceConnection> IfcStructuralSurfaceConnectionPtr;

} // namespace

#endif // _IFC2X3_IFCSTRUCTURALSURFACECONNECTION_AUTO_IMPL_H
