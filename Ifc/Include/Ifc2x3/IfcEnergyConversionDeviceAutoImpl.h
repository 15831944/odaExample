...
#ifndef _IFC2X3_IFCENERGYCONVERSIONDEVICE_AUTO_IMPL_H
#define _IFC2X3_IFCENERGYCONVERSIONDEVICE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcEnergyConversionDevice : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcEnergyConversionDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcEnergyConversionDevice, IfcEnergyConversionDevice> object.
*/
typedef OdSmartPtr<IfcEnergyConversionDevice> IfcEnergyConversionDevicePtr;

} // namespace

#endif // _IFC2X3_IFCENERGYCONVERSIONDEVICE_AUTO_IMPL_H
