...
#ifndef _IFC2X3_IFCDOCUMENTINFORMATIONRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCDOCUMENTINFORMATIONRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDocumentInformationRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDocumentInformationRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDocumentInformationRelationship, IfcDocumentInformationRelationship> object.
*/
typedef OdSmartPtr<IfcDocumentInformationRelationship> IfcDocumentInformationRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCDOCUMENTINFORMATIONRELATIONSHIP_AUTO_IMPL_H
