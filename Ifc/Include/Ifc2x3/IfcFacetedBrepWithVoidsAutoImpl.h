...
#ifndef _IFC2X3_IFCFACETEDBREPWITHVOIDS_AUTO_IMPL_H
#define _IFC2X3_IFCFACETEDBREPWITHVOIDS_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFacetedBrepWithVoids);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFacetedBrepWithVoids, IfcFacetedBrepWithVoids> object.
*/
typedef OdSmartPtr<IfcFacetedBrepWithVoids> IfcFacetedBrepWithVoidsPtr;

} // namespace

#endif // _IFC2X3_IFCFACETEDBREPWITHVOIDS_AUTO_IMPL_H
