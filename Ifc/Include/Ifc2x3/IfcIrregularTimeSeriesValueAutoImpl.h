...
#ifndef _IFC2X3_IFCIRREGULARTIMESERIESVALUE_AUTO_IMPL_H
#define _IFC2X3_IFCIRREGULARTIMESERIESVALUE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcIrregularTimeSeriesValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcIrregularTimeSeriesValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcIrregularTimeSeriesValue, IfcIrregularTimeSeriesValue> object.
*/
typedef OdSmartPtr<IfcIrregularTimeSeriesValue> IfcIrregularTimeSeriesValuePtr;

} // namespace

#endif // _IFC2X3_IFCIRREGULARTIMESERIESVALUE_AUTO_IMPL_H
