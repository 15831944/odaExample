...
#ifndef _IFC2X3_IFCSYSTEM_AUTO_IMPL_H
#define _IFC2X3_IFCSYSTEM_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcSystem : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcSystem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSystem, IfcSystem> object.
*/
typedef OdSmartPtr<IfcSystem> IfcSystemPtr;

} // namespace

#endif // _IFC2X3_IFCSYSTEM_AUTO_IMPL_H
