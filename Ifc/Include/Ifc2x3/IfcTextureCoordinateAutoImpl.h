...
#ifndef _IFC2X3_IFCTEXTURECOORDINATE_AUTO_IMPL_H
#define _IFC2X3_IFCTEXTURECOORDINATE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcTextureCoordinate : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcTextureCoordinate);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvAnnotatedSurface(OdDAIObjectIds& AnnotatedSurface) const;
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTextureCoordinate, IfcTextureCoordinate> object.
*/
typedef OdSmartPtr<IfcTextureCoordinate> IfcTextureCoordinatePtr;

} // namespace

#endif // _IFC2X3_IFCTEXTURECOORDINATE_AUTO_IMPL_H
