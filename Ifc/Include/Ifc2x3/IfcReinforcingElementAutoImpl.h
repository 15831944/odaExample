...
#ifndef _IFC2X3_IFCREINFORCINGELEMENT_AUTO_IMPL_H
#define _IFC2X3_IFCREINFORCINGELEMENT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcReinforcingElement : public IfcBuildingElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcReinforcingElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcReinforcingElement, IfcReinforcingElement> object.
*/
typedef OdSmartPtr<IfcReinforcingElement> IfcReinforcingElementPtr;

} // namespace

#endif // _IFC2X3_IFCREINFORCINGELEMENT_AUTO_IMPL_H
