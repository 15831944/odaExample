...
#ifndef _IFC2X3_IFCBOUNDEDCURVE_AUTO_IMPL_H
#define _IFC2X3_IFCBOUNDEDCURVE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcBoundedCurve : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcBoundedCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcBoundedCurve, IfcBoundedCurve> object.
*/
typedef OdSmartPtr<IfcBoundedCurve> IfcBoundedCurvePtr;

} // namespace

#endif // _IFC2X3_IFCBOUNDEDCURVE_AUTO_IMPL_H
