...
#ifndef _IFC2X3_IFC2DCOMPOSITECURVE_AUTO_IMPL_H
#define _IFC2X3_IFC2DCOMPOSITECURVE_AUTO_IMPL_H
...
class IFC2X3_EXPORT Ifc2DCompositeCurve : public IfcCompositeCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::Ifc2DCompositeCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::Ifc2DCompositeCurve, Ifc2DCompositeCurve> object.
*/
typedef OdSmartPtr<Ifc2DCompositeCurve> Ifc2DCompositeCurvePtr;

} // namespace

#endif // _IFC2X3_IFC2DCOMPOSITECURVE_AUTO_IMPL_H
