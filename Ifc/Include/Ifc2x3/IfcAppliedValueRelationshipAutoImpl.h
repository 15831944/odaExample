...
#ifndef _IFC2X3_IFCAPPLIEDVALUERELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCAPPLIEDVALUERELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcAppliedValueRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcAppliedValueRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcAppliedValueRelationship, IfcAppliedValueRelationship> object.
*/
typedef OdSmartPtr<IfcAppliedValueRelationship> IfcAppliedValueRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCAPPLIEDVALUERELATIONSHIP_AUTO_IMPL_H
