...
#ifndef _IFC2X3_IFCSURFACESTYLERENDERING_AUTO_IMPL_H
#define _IFC2X3_IFCSURFACESTYLERENDERING_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcSurfaceStyleRendering);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSurfaceStyleRendering, IfcSurfaceStyleRendering> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleRendering> IfcSurfaceStyleRenderingPtr;

} // namespace

#endif // _IFC2X3_IFCSURFACESTYLERENDERING_AUTO_IMPL_H
