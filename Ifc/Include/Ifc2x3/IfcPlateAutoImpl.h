...
#ifndef _IFC2X3_IFCPLATE_AUTO_IMPL_H
#define _IFC2X3_IFCPLATE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPlate : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPlate);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPlate, IfcPlate> object.
*/
typedef OdSmartPtr<IfcPlate> IfcPlatePtr;

} // namespace

#endif // _IFC2X3_IFCPLATE_AUTO_IMPL_H
