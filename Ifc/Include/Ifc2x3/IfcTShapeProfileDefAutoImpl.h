...
#ifndef _IFC2X3_IFCTSHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC2X3_IFCTSHAPEPROFILEDEF_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTShapeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTShapeProfileDef, IfcTShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcTShapeProfileDef> IfcTShapeProfileDefPtr;

} // namespace

#endif // _IFC2X3_IFCTSHAPEPROFILEDEF_AUTO_IMPL_H
