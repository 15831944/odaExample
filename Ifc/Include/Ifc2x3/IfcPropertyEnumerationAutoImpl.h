...
#ifndef _IFC2X3_IFCPROPERTYENUMERATION_AUTO_IMPL_H
#define _IFC2X3_IFCPROPERTYENUMERATION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPropertyEnumeration : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPropertyEnumeration);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPropertyEnumeration, IfcPropertyEnumeration> object.
*/
typedef OdSmartPtr<IfcPropertyEnumeration> IfcPropertyEnumerationPtr;

} // namespace

#endif // _IFC2X3_IFCPROPERTYENUMERATION_AUTO_IMPL_H
