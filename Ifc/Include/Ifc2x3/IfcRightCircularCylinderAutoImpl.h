...
#ifndef _IFC2X3_IFCRIGHTCIRCULARCYLINDER_AUTO_IMPL_H
#define _IFC2X3_IFCRIGHTCIRCULARCYLINDER_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRightCircularCylinder : public IfcCsgPrimitive3D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRightCircularCylinder);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRightCircularCylinder, IfcRightCircularCylinder> object.
*/
typedef OdSmartPtr<IfcRightCircularCylinder> IfcRightCircularCylinderPtr;

} // namespace

#endif // _IFC2X3_IFCRIGHTCIRCULARCYLINDER_AUTO_IMPL_H
