...
#ifndef _IFC2X3_IFCRELOVERRIDESPROPERTIES_AUTO_IMPL_H
#define _IFC2X3_IFCRELOVERRIDESPROPERTIES_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRelOverridesProperties : public IfcRelDefinesByProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRelOverridesProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelOverridesProperties, IfcRelOverridesProperties> object.
*/
typedef OdSmartPtr<IfcRelOverridesProperties> IfcRelOverridesPropertiesPtr;

} // namespace

#endif // _IFC2X3_IFCRELOVERRIDESPROPERTIES_AUTO_IMPL_H
