...
#ifndef _IFC2X3_IFCSURFACESTYLESHADING_AUTO_IMPL_H
#define _IFC2X3_IFCSURFACESTYLESHADING_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcSurfaceStyleShading : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcSurfaceStyleShading);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSurfaceStyleShading, IfcSurfaceStyleShading> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleShading> IfcSurfaceStyleShadingPtr;

} // namespace

#endif // _IFC2X3_IFCSURFACESTYLESHADING_AUTO_IMPL_H
