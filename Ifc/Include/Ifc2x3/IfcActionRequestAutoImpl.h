...
#ifndef _IFC2X3_IFCACTIONREQUEST_AUTO_IMPL_H
#define _IFC2X3_IFCACTIONREQUEST_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcActionRequest : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcActionRequest);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcActionRequest, IfcActionRequest> object.
*/
typedef OdSmartPtr<IfcActionRequest> IfcActionRequestPtr;

} // namespace

#endif // _IFC2X3_IFCACTIONREQUEST_AUTO_IMPL_H
