...
#ifndef _IFC2X3_IFCSURFACESTYLEREFRACTION_AUTO_IMPL_H
#define _IFC2X3_IFCSURFACESTYLEREFRACTION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcSurfaceStyleRefraction : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcSurfaceStyleRefraction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSurfaceStyleRefraction, IfcSurfaceStyleRefraction> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleRefraction> IfcSurfaceStyleRefractionPtr;

} // namespace

#endif // _IFC2X3_IFCSURFACESTYLEREFRACTION_AUTO_IMPL_H
