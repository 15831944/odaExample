...
#ifndef _IFC2X3_IFCARBITRARYPROFILEDEFWITHVOIDS_AUTO_IMPL_H
#define _IFC2X3_IFCARBITRARYPROFILEDEFWITHVOIDS_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcArbitraryProfileDefWithVoids : public IfcArbitraryClosedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcArbitraryProfileDefWithVoids);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcArbitraryProfileDefWithVoids, IfcArbitraryProfileDefWithVoids> object.
*/
typedef OdSmartPtr<IfcArbitraryProfileDefWithVoids> IfcArbitraryProfileDefWithVoidsPtr;

} // namespace

#endif // _IFC2X3_IFCARBITRARYPROFILEDEFWITHVOIDS_AUTO_IMPL_H
