...
#ifndef _IFC2X3_IFCPROJECTIONELEMENT_AUTO_IMPL_H
#define _IFC2X3_IFCPROJECTIONELEMENT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcProjectionElement : public IfcFeatureElementAddition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcProjectionElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcProjectionElement, IfcProjectionElement> object.
*/
typedef OdSmartPtr<IfcProjectionElement> IfcProjectionElementPtr;

} // namespace

#endif // _IFC2X3_IFCPROJECTIONELEMENT_AUTO_IMPL_H
