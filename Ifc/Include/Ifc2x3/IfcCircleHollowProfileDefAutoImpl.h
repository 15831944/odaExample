...
#ifndef _IFC2X3_IFCCIRCLEHOLLOWPROFILEDEF_AUTO_IMPL_H
#define _IFC2X3_IFCCIRCLEHOLLOWPROFILEDEF_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCircleHollowProfileDef : public IfcCircleProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCircleHollowProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCircleHollowProfileDef, IfcCircleHollowProfileDef> object.
*/
typedef OdSmartPtr<IfcCircleHollowProfileDef> IfcCircleHollowProfileDefPtr;

} // namespace

#endif // _IFC2X3_IFCCIRCLEHOLLOWPROFILEDEF_AUTO_IMPL_H
