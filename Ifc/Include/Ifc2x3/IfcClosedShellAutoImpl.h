...
#ifndef _IFC2X3_IFCCLOSEDSHELL_AUTO_IMPL_H
#define _IFC2X3_IFCCLOSEDSHELL_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcClosedShell : public IfcConnectedFaceSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcClosedShell);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcClosedShell, IfcClosedShell> object.
*/
typedef OdSmartPtr<IfcClosedShell> IfcClosedShellPtr;

} // namespace

#endif // _IFC2X3_IFCCLOSEDSHELL_AUTO_IMPL_H
