...
#ifndef _IFC2X3_IFCMEMBER_AUTO_IMPL_H
#define _IFC2X3_IFCMEMBER_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcMember : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcMember);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcMember, IfcMember> object.
*/
typedef OdSmartPtr<IfcMember> IfcMemberPtr;

} // namespace

#endif // _IFC2X3_IFCMEMBER_AUTO_IMPL_H
