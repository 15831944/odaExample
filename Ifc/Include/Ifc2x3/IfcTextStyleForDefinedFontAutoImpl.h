...
#ifndef _IFC2X3_IFCTEXTSTYLEFORDEFINEDFONT_AUTO_IMPL_H
#define _IFC2X3_IFCTEXTSTYLEFORDEFINEDFONT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcTextStyleForDefinedFont : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTextStyleForDefinedFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTextStyleForDefinedFont, IfcTextStyleForDefinedFont> object.
*/
typedef OdSmartPtr<IfcTextStyleForDefinedFont> IfcTextStyleForDefinedFontPtr;

} // namespace

#endif // _IFC2X3_IFCTEXTSTYLEFORDEFINEDFONT_AUTO_IMPL_H
