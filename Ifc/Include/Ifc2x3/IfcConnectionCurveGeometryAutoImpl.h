...
#ifndef _IFC2X3_IFCCONNECTIONCURVEGEOMETRY_AUTO_IMPL_H
#define _IFC2X3_IFCCONNECTIONCURVEGEOMETRY_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcConnectionCurveGeometry : public IfcConnectionGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcConnectionCurveGeometry);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcConnectionCurveGeometry, IfcConnectionCurveGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionCurveGeometry> IfcConnectionCurveGeometryPtr;

} // namespace

#endif // _IFC2X3_IFCCONNECTIONCURVEGEOMETRY_AUTO_IMPL_H
