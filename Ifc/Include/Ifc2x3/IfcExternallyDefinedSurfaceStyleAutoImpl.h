...
#ifndef _IFC2X3_IFCEXTERNALLYDEFINEDSURFACESTYLE_AUTO_IMPL_H
#define _IFC2X3_IFCEXTERNALLYDEFINEDSURFACESTYLE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcExternallyDefinedSurfaceStyle : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcExternallyDefinedSurfaceStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcExternallyDefinedSurfaceStyle, IfcExternallyDefinedSurfaceStyle> object.
*/
typedef OdSmartPtr<IfcExternallyDefinedSurfaceStyle> IfcExternallyDefinedSurfaceStylePtr;

} // namespace

#endif // _IFC2X3_IFCEXTERNALLYDEFINEDSURFACESTYLE_AUTO_IMPL_H
