...
#ifndef _IFC2X3_IFCWALLSTANDARDCASE_AUTO_IMPL_H
#define _IFC2X3_IFCWALLSTANDARDCASE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcWallStandardCase : public IfcWall
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcWallStandardCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcWallStandardCase, IfcWallStandardCase> object.
*/
typedef OdSmartPtr<IfcWallStandardCase> IfcWallStandardCasePtr;

} // namespace

#endif // _IFC2X3_IFCWALLSTANDARDCASE_AUTO_IMPL_H
