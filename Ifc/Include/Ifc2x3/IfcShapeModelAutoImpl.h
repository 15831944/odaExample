...
#ifndef _IFC2X3_IFCSHAPEMODEL_AUTO_IMPL_H
#define _IFC2X3_IFCSHAPEMODEL_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcShapeModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcShapeModel, IfcShapeModel> object.
*/
typedef OdSmartPtr<IfcShapeModel> IfcShapeModelPtr;

} // namespace

#endif // _IFC2X3_IFCSHAPEMODEL_AUTO_IMPL_H
