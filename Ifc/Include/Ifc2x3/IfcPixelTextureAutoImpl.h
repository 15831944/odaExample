...
#ifndef _IFC2X3_IFCPIXELTEXTURE_AUTO_IMPL_H
#define _IFC2X3_IFCPIXELTEXTURE_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPixelTexture);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::OdAnsiStringList m_Pixel; // LIST [1:?] of BINARY(32)
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPixelTexture, IfcPixelTexture> object.
*/
typedef OdSmartPtr<IfcPixelTexture> IfcPixelTexturePtr;

} // namespace

#endif // _IFC2X3_IFCPIXELTEXTURE_AUTO_IMPL_H
