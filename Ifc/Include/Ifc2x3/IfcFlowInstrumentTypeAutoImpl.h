...
#ifndef _IFC2X3_IFCFLOWINSTRUMENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCFLOWINSTRUMENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFlowInstrumentType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFlowInstrumentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFlowInstrumentType, IfcFlowInstrumentType> object.
*/
typedef OdSmartPtr<IfcFlowInstrumentType> IfcFlowInstrumentTypePtr;

} // namespace

#endif // _IFC2X3_IFCFLOWINSTRUMENTTYPE_AUTO_IMPL_H
