...
#ifndef _IFC2X3_IFCSHAPEREPRESENTATION_AUTO_IMPL_H
#define _IFC2X3_IFCSHAPEREPRESENTATION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcShapeRepresentation : public IfcShapeModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcShapeRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcShapeRepresentation, IfcShapeRepresentation> object.
*/
typedef OdSmartPtr<IfcShapeRepresentation> IfcShapeRepresentationPtr;

} // namespace

#endif // _IFC2X3_IFCSHAPEREPRESENTATION_AUTO_IMPL_H
