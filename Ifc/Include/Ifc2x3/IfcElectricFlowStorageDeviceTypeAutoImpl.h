...
#ifndef _IFC2X3_IFCELECTRICFLOWSTORAGEDEVICETYPE_AUTO_IMPL_H
#define _IFC2X3_IFCELECTRICFLOWSTORAGEDEVICETYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcElectricFlowStorageDeviceType : public IfcFlowStorageDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcElectricFlowStorageDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcElectricFlowStorageDeviceType, IfcElectricFlowStorageDeviceType> object.
*/
typedef OdSmartPtr<IfcElectricFlowStorageDeviceType> IfcElectricFlowStorageDeviceTypePtr;

} // namespace

#endif // _IFC2X3_IFCELECTRICFLOWSTORAGEDEVICETYPE_AUTO_IMPL_H
