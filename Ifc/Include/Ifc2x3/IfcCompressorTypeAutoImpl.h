...
#ifndef _IFC2X3_IFCCOMPRESSORTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCCOMPRESSORTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCompressorType : public IfcFlowMovingDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCompressorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCompressorType, IfcCompressorType> object.
*/
typedef OdSmartPtr<IfcCompressorType> IfcCompressorTypePtr;

} // namespace

#endif // _IFC2X3_IFCCOMPRESSORTYPE_AUTO_IMPL_H
