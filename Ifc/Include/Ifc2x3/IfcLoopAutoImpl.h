...
#ifndef _IFC2X3_IFCLOOP_AUTO_IMPL_H
#define _IFC2X3_IFCLOOP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcLoop : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcLoop);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcLoop, IfcLoop> object.
*/
typedef OdSmartPtr<IfcLoop> IfcLoopPtr;

} // namespace

#endif // _IFC2X3_IFCLOOP_AUTO_IMPL_H
