...
#ifndef _IFC2X3_IFCTIMESERIESVALUE_AUTO_IMPL_H
#define _IFC2X3_IFCTIMESERIESVALUE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcTimeSeriesValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTimeSeriesValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTimeSeriesValue, IfcTimeSeriesValue> object.
*/
typedef OdSmartPtr<IfcTimeSeriesValue> IfcTimeSeriesValuePtr;

} // namespace

#endif // _IFC2X3_IFCTIMESERIESVALUE_AUTO_IMPL_H
