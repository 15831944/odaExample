...
#ifndef _IFC2X3_IFCBUILDINGELEMENTCOMPONENT_AUTO_IMPL_H
#define _IFC2X3_IFCBUILDINGELEMENTCOMPONENT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcBuildingElementComponent : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcBuildingElementComponent);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcBuildingElementComponent, IfcBuildingElementComponent> object.
*/
typedef OdSmartPtr<IfcBuildingElementComponent> IfcBuildingElementComponentPtr;

} // namespace

#endif // _IFC2X3_IFCBUILDINGELEMENTCOMPONENT_AUTO_IMPL_H
