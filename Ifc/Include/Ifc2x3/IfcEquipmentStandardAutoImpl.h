...
#ifndef _IFC2X3_IFCEQUIPMENTSTANDARD_AUTO_IMPL_H
#define _IFC2X3_IFCEQUIPMENTSTANDARD_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcEquipmentStandard : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcEquipmentStandard);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcEquipmentStandard, IfcEquipmentStandard> object.
*/
typedef OdSmartPtr<IfcEquipmentStandard> IfcEquipmentStandardPtr;

} // namespace

#endif // _IFC2X3_IFCEQUIPMENTSTANDARD_AUTO_IMPL_H
