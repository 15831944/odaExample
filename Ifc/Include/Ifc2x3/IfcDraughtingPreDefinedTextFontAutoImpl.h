...
#ifndef _IFC2X3_IFCDRAUGHTINGPREDEFINEDTEXTFONT_AUTO_IMPL_H
#define _IFC2X3_IFCDRAUGHTINGPREDEFINEDTEXTFONT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDraughtingPreDefinedTextFont : public IfcPreDefinedTextFont
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDraughtingPreDefinedTextFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDraughtingPreDefinedTextFont, IfcDraughtingPreDefinedTextFont> object.
*/
typedef OdSmartPtr<IfcDraughtingPreDefinedTextFont> IfcDraughtingPreDefinedTextFontPtr;

} // namespace

#endif // _IFC2X3_IFCDRAUGHTINGPREDEFINEDTEXTFONT_AUTO_IMPL_H
