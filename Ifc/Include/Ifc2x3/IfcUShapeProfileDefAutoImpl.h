...
#ifndef _IFC2X3_IFCUSHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC2X3_IFCUSHAPEPROFILEDEF_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcUShapeProfileDef);
  //DOM-IGNORE-END
...
protected:
  ...
  IfcPositiveLengthMeasure m_CentreOfGravityInX;   // IfcPositiveLengthMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcUShapeProfileDef, IfcUShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcUShapeProfileDef> IfcUShapeProfileDefPtr;

} // namespace

#endif // _IFC2X3_IFCUSHAPEPROFILEDEF_AUTO_IMPL_H
