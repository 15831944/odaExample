...
#ifndef _IFC2X3_IFCVIRTUALELEMENT_AUTO_IMPL_H
#define _IFC2X3_IFCVIRTUALELEMENT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcVirtualElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcVirtualElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcVirtualElement, IfcVirtualElement> object.
*/
typedef OdSmartPtr<IfcVirtualElement> IfcVirtualElementPtr;

} // namespace

#endif // _IFC2X3_IFCVIRTUALELEMENT_AUTO_IMPL_H
