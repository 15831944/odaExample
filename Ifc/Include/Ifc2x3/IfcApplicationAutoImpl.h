...
#ifndef _IFC2X3_IFCAPPLICATION_AUTO_IMPL_H
#define _IFC2X3_IFCAPPLICATION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcApplication : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcApplication);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcApplication, IfcApplication> object.
*/
typedef OdSmartPtr<IfcApplication> IfcApplicationPtr;

} // namespace

#endif // _IFC2X3_IFCAPPLICATION_AUTO_IMPL_H
