...
#ifndef _IFC2X3_IFCPILE_AUTO_IMPL_H
#define _IFC2X3_IFCPILE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPile : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPile);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPile, IfcPile> object.
*/
typedef OdSmartPtr<IfcPile> IfcPilePtr;

} // namespace

#endif // _IFC2X3_IFCPILE_AUTO_IMPL_H
