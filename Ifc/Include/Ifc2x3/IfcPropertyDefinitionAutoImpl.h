...
#ifndef _IFC2X3_IFCPROPERTYDEFINITION_AUTO_IMPL_H
#define _IFC2X3_IFCPROPERTYDEFINITION_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcPropertyDefinition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPropertyDefinition, IfcPropertyDefinition> object.
*/
typedef OdSmartPtr<IfcPropertyDefinition> IfcPropertyDefinitionPtr;

} // namespace

#endif // _IFC2X3_IFCPROPERTYDEFINITION_AUTO_IMPL_H
