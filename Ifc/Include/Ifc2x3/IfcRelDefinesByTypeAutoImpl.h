...
#ifndef _IFC2X3_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRelDefinesByType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelDefinesByType, IfcRelDefinesByType> object.
*/
typedef OdSmartPtr<IfcRelDefinesByType> IfcRelDefinesByTypePtr;

} // namespace

#endif // _IFC2X3_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
