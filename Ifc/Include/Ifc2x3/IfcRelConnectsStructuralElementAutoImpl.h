...
#ifndef _IFC2X3_IFCRELCONNECTSSTRUCTURALELEMENT_AUTO_IMPL_H
#define _IFC2X3_IFCRELCONNECTSSTRUCTURALELEMENT_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRelConnectsStructuralElement);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatedStructuralMember() const;
  void setRelatedStructuralMember(const OdDAIObjectId& RelatedStructuralMember);
...
protected:
  ...
  OdDAIObjectId m_RelatedStructuralMember;   // IfcStructuralMember
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelConnectsStructuralElement, IfcRelConnectsStructuralElement> object.
*/
typedef OdSmartPtr<IfcRelConnectsStructuralElement> IfcRelConnectsStructuralElementPtr;

} // namespace

#endif // _IFC2X3_IFCRELCONNECTSSTRUCTURALELEMENT_AUTO_IMPL_H
