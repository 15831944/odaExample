...
#ifndef _IFC2X3_IFCSTYLEDREPRESENTATION_AUTO_IMPL_H
#define _IFC2X3_IFCSTYLEDREPRESENTATION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcStyledRepresentation : public IfcStyleModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcStyledRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcStyledRepresentation, IfcStyledRepresentation> object.
*/
typedef OdSmartPtr<IfcStyledRepresentation> IfcStyledRepresentationPtr;

} // namespace

#endif // _IFC2X3_IFCSTYLEDREPRESENTATION_AUTO_IMPL_H
