...
#ifndef _IFC2X3_IFCCARTESIANTRANSFORMATIONOPERATOR2D_AUTO_IMPL_H
#define _IFC2X3_IFCCARTESIANTRANSFORMATIONOPERATOR2D_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCartesianTransformationOperator2D : public IfcCartesianTransformationOperator
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCartesianTransformationOperator2D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCartesianTransformationOperator2D, IfcCartesianTransformationOperator2D> object.
*/
typedef OdSmartPtr<IfcCartesianTransformationOperator2D> IfcCartesianTransformationOperator2DPtr;

} // namespace

#endif // _IFC2X3_IFCCARTESIANTRANSFORMATIONOPERATOR2D_AUTO_IMPL_H
