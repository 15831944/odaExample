...
#ifndef _IFC2X3_IFCOPENINGELEMENT_AUTO_IMPL_H
#define _IFC2X3_IFCOPENINGELEMENT_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcOpeningElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcOpeningElement, IfcOpeningElement> object.
*/
typedef OdSmartPtr<IfcOpeningElement> IfcOpeningElementPtr;

} // namespace

#endif // _IFC2X3_IFCOPENINGELEMENT_AUTO_IMPL_H
