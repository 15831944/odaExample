...
#ifndef _IFC2X3_IFCCABLESEGMENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCCABLESEGMENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCableSegmentType : public IfcFlowSegmentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCableSegmentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCableSegmentType, IfcCableSegmentType> object.
*/
typedef OdSmartPtr<IfcCableSegmentType> IfcCableSegmentTypePtr;

} // namespace

#endif // _IFC2X3_IFCCABLESEGMENTTYPE_AUTO_IMPL_H
