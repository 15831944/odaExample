...
#ifndef _IFC2X3_IFCWASTETERMINALTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCWASTETERMINALTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcWasteTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcWasteTerminalType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcWasteTerminalType, IfcWasteTerminalType> object.
*/
typedef OdSmartPtr<IfcWasteTerminalType> IfcWasteTerminalTypePtr;

} // namespace

#endif // _IFC2X3_IFCWASTETERMINALTYPE_AUTO_IMPL_H
