...
#ifndef _IFC2X3_IFCSPHERE_AUTO_IMPL_H
#define _IFC2X3_IFCSPHERE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcSphere : public IfcCsgPrimitive3D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcSphere);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSphere, IfcSphere> object.
*/
typedef OdSmartPtr<IfcSphere> IfcSpherePtr;

} // namespace

#endif // _IFC2X3_IFCSPHERE_AUTO_IMPL_H
