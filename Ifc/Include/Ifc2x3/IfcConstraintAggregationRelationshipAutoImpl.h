...
#ifndef _IFC2X3_IFCCONSTRAINTAGGREGATIONRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCCONSTRAINTAGGREGATIONRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcConstraintAggregationRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcConstraintAggregationRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcConstraintAggregationRelationship, IfcConstraintAggregationRelationship> object.
*/
typedef OdSmartPtr<IfcConstraintAggregationRelationship> IfcConstraintAggregationRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCCONSTRAINTAGGREGATIONRELATIONSHIP_AUTO_IMPL_H
