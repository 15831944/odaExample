...
#ifndef _IFC2X3_IFCDOCUMENTELECTRONICFORMAT_AUTO_IMPL_H
#define _IFC2X3_IFCDOCUMENTELECTRONICFORMAT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDocumentElectronicFormat : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDocumentElectronicFormat);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDocumentElectronicFormat, IfcDocumentElectronicFormat> object.
*/
typedef OdSmartPtr<IfcDocumentElectronicFormat> IfcDocumentElectronicFormatPtr;

} // namespace

#endif // _IFC2X3_IFCDOCUMENTELECTRONICFORMAT_AUTO_IMPL_H
