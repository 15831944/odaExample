...
#ifndef _IFC2X3_IFCTUBEBUNDLETYPE_AUTO_IMPL_H
#define _IFC2X3_IFCTUBEBUNDLETYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcTubeBundleType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTubeBundleType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTubeBundleType, IfcTubeBundleType> object.
*/
typedef OdSmartPtr<IfcTubeBundleType> IfcTubeBundleTypePtr;

} // namespace

#endif // _IFC2X3_IFCTUBEBUNDLETYPE_AUTO_IMPL_H
