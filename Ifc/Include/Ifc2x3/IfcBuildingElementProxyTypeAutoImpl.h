...
#ifndef _IFC2X3_IFCBUILDINGELEMENTPROXYTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCBUILDINGELEMENTPROXYTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcBuildingElementProxyType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcBuildingElementProxyType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcBuildingElementProxyType, IfcBuildingElementProxyType> object.
*/
typedef OdSmartPtr<IfcBuildingElementProxyType> IfcBuildingElementProxyTypePtr;

} // namespace

#endif // _IFC2X3_IFCBUILDINGELEMENTPROXYTYPE_AUTO_IMPL_H
