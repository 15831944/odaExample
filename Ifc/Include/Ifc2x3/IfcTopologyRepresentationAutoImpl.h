...
#ifndef _IFC2X3_IFCTOPOLOGYREPRESENTATION_AUTO_IMPL_H
#define _IFC2X3_IFCTOPOLOGYREPRESENTATION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcTopologyRepresentation : public IfcShapeModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTopologyRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTopologyRepresentation, IfcTopologyRepresentation> object.
*/
typedef OdSmartPtr<IfcTopologyRepresentation> IfcTopologyRepresentationPtr;

} // namespace

#endif // _IFC2X3_IFCTOPOLOGYREPRESENTATION_AUTO_IMPL_H
