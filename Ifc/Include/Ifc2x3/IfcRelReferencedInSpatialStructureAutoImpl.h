...
#ifndef _IFC2X3_IFCRELREFERENCEDINSPATIALSTRUCTURE_AUTO_IMPL_H
#define _IFC2X3_IFCRELREFERENCEDINSPATIALSTRUCTURE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRelReferencedInSpatialStructure : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRelReferencedInSpatialStructure);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelReferencedInSpatialStructure, IfcRelReferencedInSpatialStructure> object.
*/
typedef OdSmartPtr<IfcRelReferencedInSpatialStructure> IfcRelReferencedInSpatialStructurePtr;

} // namespace

#endif // _IFC2X3_IFCRELREFERENCEDINSPATIALSTRUCTURE_AUTO_IMPL_H
