...
#ifndef _IFC2X3_IFCBOUNDEDSURFACE_AUTO_IMPL_H
#define _IFC2X3_IFCBOUNDEDSURFACE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcBoundedSurface : public IfcSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcBoundedSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcBoundedSurface, IfcBoundedSurface> object.
*/
typedef OdSmartPtr<IfcBoundedSurface> IfcBoundedSurfacePtr;

} // namespace

#endif // _IFC2X3_IFCBOUNDEDSURFACE_AUTO_IMPL_H
