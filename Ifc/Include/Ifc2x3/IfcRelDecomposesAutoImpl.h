...
#ifndef _IFC2X3_IFCRELDECOMPOSES_AUTO_IMPL_H
#define _IFC2X3_IFCRELDECOMPOSES_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcRelDecomposes);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelDecomposes, IfcRelDecomposes> object.
*/
typedef OdSmartPtr<IfcRelDecomposes> IfcRelDecomposesPtr;

} // namespace

#endif // _IFC2X3_IFCRELDECOMPOSES_AUTO_IMPL_H
