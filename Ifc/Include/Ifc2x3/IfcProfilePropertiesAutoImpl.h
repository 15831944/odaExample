...
#ifndef _IFC2X3_IFCPROFILEPROPERTIES_AUTO_IMPL_H
#define _IFC2X3_IFCPROFILEPROPERTIES_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcProfileProperties : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcProfileProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcProfileProperties, IfcProfileProperties> object.
*/
typedef OdSmartPtr<IfcProfileProperties> IfcProfilePropertiesPtr;

} // namespace

#endif // _IFC2X3_IFCPROFILEPROPERTIES_AUTO_IMPL_H
