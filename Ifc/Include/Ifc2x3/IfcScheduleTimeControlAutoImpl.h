...
#ifndef _IFC2X3_IFCSCHEDULETIMECONTROL_AUTO_IMPL_H
#define _IFC2X3_IFCSCHEDULETIMECONTROL_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcScheduleTimeControl);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcScheduleTimeControl, IfcScheduleTimeControl> object.
*/
typedef OdSmartPtr<IfcScheduleTimeControl> IfcScheduleTimeControlPtr;

} // namespace

#endif // _IFC2X3_IFCSCHEDULETIMECONTROL_AUTO_IMPL_H
