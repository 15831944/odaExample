...
#ifndef _IFC2X3_IFCAXIS2PLACEMENT3D_AUTO_IMPL_H
#define _IFC2X3_IFCAXIS2PLACEMENT3D_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcAxis2Placement3D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcAxis2Placement3D, IfcAxis2Placement3D> object.
*/
typedef OdSmartPtr<IfcAxis2Placement3D> IfcAxis2Placement3DPtr;

} // namespace

#endif // _IFC2X3_IFCAXIS2PLACEMENT3D_AUTO_IMPL_H
