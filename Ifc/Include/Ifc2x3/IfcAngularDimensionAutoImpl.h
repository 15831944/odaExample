...
#ifndef _IFC2X3_IFCANGULARDIMENSION_AUTO_IMPL_H
#define _IFC2X3_IFCANGULARDIMENSION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcAngularDimension : public IfcDimensionCurveDirectedCallout
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcAngularDimension);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcAngularDimension, IfcAngularDimension> object.
*/
typedef OdSmartPtr<IfcAngularDimension> IfcAngularDimensionPtr;

} // namespace

#endif // _IFC2X3_IFCANGULARDIMENSION_AUTO_IMPL_H
