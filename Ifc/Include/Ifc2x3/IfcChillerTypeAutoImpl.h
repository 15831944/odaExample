...
#ifndef _IFC2X3_IFCCHILLERTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCCHILLERTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcChillerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcChillerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcChillerType, IfcChillerType> object.
*/
typedef OdSmartPtr<IfcChillerType> IfcChillerTypePtr;

} // namespace

#endif // _IFC2X3_IFCCHILLERTYPE_AUTO_IMPL_H
