...
#ifndef _IFC2X3_IFCCLASSIFICATIONITEM_AUTO_IMPL_H
#define _IFC2X3_IFCCLASSIFICATIONITEM_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcClassificationItem : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcClassificationItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcClassificationItem, IfcClassificationItem> object.
*/
typedef OdSmartPtr<IfcClassificationItem> IfcClassificationItemPtr;

} // namespace

#endif // _IFC2X3_IFCCLASSIFICATIONITEM_AUTO_IMPL_H
