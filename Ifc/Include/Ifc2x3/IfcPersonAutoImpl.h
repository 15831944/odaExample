...
#ifndef _IFC2X3_IFCPERSON_AUTO_IMPL_H
#define _IFC2X3_IFCPERSON_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPerson : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPerson);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPerson, IfcPerson> object.
*/
typedef OdSmartPtr<IfcPerson> IfcPersonPtr;

} // namespace

#endif // _IFC2X3_IFCPERSON_AUTO_IMPL_H
