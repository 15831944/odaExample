...
#ifndef _IFC2X3_IFCMATERIALPROPERTIES_AUTO_IMPL_H
#define _IFC2X3_IFCMATERIALPROPERTIES_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcMaterialProperties : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcMaterialProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcMaterialProperties, IfcMaterialProperties> object.
*/
typedef OdSmartPtr<IfcMaterialProperties> IfcMaterialPropertiesPtr;

} // namespace

#endif // _IFC2X3_IFCMATERIALPROPERTIES_AUTO_IMPL_H
