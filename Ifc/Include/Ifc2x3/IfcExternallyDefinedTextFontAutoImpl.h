...
#ifndef _IFC2X3_IFCEXTERNALLYDEFINEDTEXTFONT_AUTO_IMPL_H
#define _IFC2X3_IFCEXTERNALLYDEFINEDTEXTFONT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcExternallyDefinedTextFont : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcExternallyDefinedTextFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcExternallyDefinedTextFont, IfcExternallyDefinedTextFont> object.
*/
typedef OdSmartPtr<IfcExternallyDefinedTextFont> IfcExternallyDefinedTextFontPtr;

} // namespace

#endif // _IFC2X3_IFCEXTERNALLYDEFINEDTEXTFONT_AUTO_IMPL_H
