...
#ifndef _IFC2X3_IFCSWITCHINGDEVICETYPE_AUTO_IMPL_H
#define _IFC2X3_IFCSWITCHINGDEVICETYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcSwitchingDeviceType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcSwitchingDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSwitchingDeviceType, IfcSwitchingDeviceType> object.
*/
typedef OdSmartPtr<IfcSwitchingDeviceType> IfcSwitchingDeviceTypePtr;

} // namespace

#endif // _IFC2X3_IFCSWITCHINGDEVICETYPE_AUTO_IMPL_H
