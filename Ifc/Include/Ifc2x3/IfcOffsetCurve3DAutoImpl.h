...
#ifndef _IFC2X3_IFCOFFSETCURVE3D_AUTO_IMPL_H
#define _IFC2X3_IFCOFFSETCURVE3D_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcOffsetCurve3D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcOffsetCurve3D, IfcOffsetCurve3D> object.
*/
typedef OdSmartPtr<IfcOffsetCurve3D> IfcOffsetCurve3DPtr;

} // namespace

#endif // _IFC2X3_IFCOFFSETCURVE3D_AUTO_IMPL_H
