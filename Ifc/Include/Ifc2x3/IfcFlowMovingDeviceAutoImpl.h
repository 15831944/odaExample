...
#ifndef _IFC2X3_IFCFLOWMOVINGDEVICE_AUTO_IMPL_H
#define _IFC2X3_IFCFLOWMOVINGDEVICE_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFlowMovingDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFlowMovingDevice, IfcFlowMovingDevice> object.
*/
typedef OdSmartPtr<IfcFlowMovingDevice> IfcFlowMovingDevicePtr;

} // namespace

#endif // _IFC2X3_IFCFLOWMOVINGDEVICE_AUTO_IMPL_H
