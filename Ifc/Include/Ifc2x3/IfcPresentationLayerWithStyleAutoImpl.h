...
#ifndef _IFC2X3_IFCPRESENTATIONLAYERWITHSTYLE_AUTO_IMPL_H
#define _IFC2X3_IFCPRESENTATIONLAYERWITHSTYLE_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPresentationLayerWithStyle);
  //DOM-IGNORE-END
...
public:
  ...
  void getLayerStyles(OdArray<OdDAI::Select >& LayerStyles) const;
  void getLayerStylesWrapperArray(OdArray<IfcPresentationStyleSelect>& LayerStyles) const;
  OdDAI::Set<OdDAI::Select>& layerStyles();
...
protected:
  ...
  OdDAI::Set<OdDAI::Select> m_LayerStyles; // SET [0:?] of IfcPresentationStyleSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPresentationLayerWithStyle, IfcPresentationLayerWithStyle> object.
*/
typedef OdSmartPtr<IfcPresentationLayerWithStyle> IfcPresentationLayerWithStylePtr;

} // namespace

#endif // _IFC2X3_IFCPRESENTATIONLAYERWITHSTYLE_AUTO_IMPL_H
