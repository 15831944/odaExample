...
#ifndef _IFC2X3_IFCTWODIRECTIONREPEATFACTOR_AUTO_IMPL_H
#define _IFC2X3_IFCTWODIRECTIONREPEATFACTOR_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcTwoDirectionRepeatFactor : public IfcOneDirectionRepeatFactor
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTwoDirectionRepeatFactor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTwoDirectionRepeatFactor, IfcTwoDirectionRepeatFactor> object.
*/
typedef OdSmartPtr<IfcTwoDirectionRepeatFactor> IfcTwoDirectionRepeatFactorPtr;

} // namespace

#endif // _IFC2X3_IFCTWODIRECTIONREPEATFACTOR_AUTO_IMPL_H
