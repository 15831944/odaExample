...
#ifndef _IFC2X3_IFCGEOMETRICREPRESENTATIONITEM_AUTO_IMPL_H
#define _IFC2X3_IFCGEOMETRICREPRESENTATIONITEM_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcGeometricRepresentationItem : public IfcRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcGeometricRepresentationItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcGeometricRepresentationItem, IfcGeometricRepresentationItem> object.
*/
typedef OdSmartPtr<IfcGeometricRepresentationItem> IfcGeometricRepresentationItemPtr;

} // namespace

#endif // _IFC2X3_IFCGEOMETRICREPRESENTATIONITEM_AUTO_IMPL_H
