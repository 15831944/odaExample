...
#ifndef _IFC2X3_IFCCONSTRUCTIONPRODUCTRESOURCE_AUTO_IMPL_H
#define _IFC2X3_IFCCONSTRUCTIONPRODUCTRESOURCE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcConstructionProductResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcConstructionProductResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcConstructionProductResource, IfcConstructionProductResource> object.
*/
typedef OdSmartPtr<IfcConstructionProductResource> IfcConstructionProductResourcePtr;

} // namespace

#endif // _IFC2X3_IFCCONSTRUCTIONPRODUCTRESOURCE_AUTO_IMPL_H
