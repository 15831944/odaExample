...
#ifndef _IFC2X3_IFCSOLIDMODEL_AUTO_IMPL_H
#define _IFC2X3_IFCSOLIDMODEL_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcSolidModel : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcSolidModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSolidModel, IfcSolidModel> object.
*/
typedef OdSmartPtr<IfcSolidModel> IfcSolidModelPtr;

} // namespace

#endif // _IFC2X3_IFCSOLIDMODEL_AUTO_IMPL_H
