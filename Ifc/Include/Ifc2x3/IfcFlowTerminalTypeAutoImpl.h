...
#ifndef _IFC2X3_IFCFLOWTERMINALTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCFLOWTERMINALTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFlowTerminalType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcFlowTerminalType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFlowTerminalType, IfcFlowTerminalType> object.
*/
typedef OdSmartPtr<IfcFlowTerminalType> IfcFlowTerminalTypePtr;

} // namespace

#endif // _IFC2X3_IFCFLOWTERMINALTYPE_AUTO_IMPL_H
