...
#ifndef _IFC2X3_IFCSHELLBASEDSURFACEMODEL_AUTO_IMPL_H
#define _IFC2X3_IFCSHELLBASEDSURFACEMODEL_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcShellBasedSurfaceModel : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcShellBasedSurfaceModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcShellBasedSurfaceModel, IfcShellBasedSurfaceModel> object.
*/
typedef OdSmartPtr<IfcShellBasedSurfaceModel> IfcShellBasedSurfaceModelPtr;

} // namespace

#endif // _IFC2X3_IFCSHELLBASEDSURFACEMODEL_AUTO_IMPL_H
