...
#ifndef _IFC2X3_IFCFASTENERTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCFASTENERTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFastenerType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFastenerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFastenerType, IfcFastenerType> object.
*/
typedef OdSmartPtr<IfcFastenerType> IfcFastenerTypePtr;

} // namespace

#endif // _IFC2X3_IFCFASTENERTYPE_AUTO_IMPL_H
