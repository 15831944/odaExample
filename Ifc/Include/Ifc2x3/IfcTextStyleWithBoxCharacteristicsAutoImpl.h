...
#ifndef _IFC2X3_IFCTEXTSTYLEWITHBOXCHARACTERISTICS_AUTO_IMPL_H
#define _IFC2X3_IFCTEXTSTYLEWITHBOXCHARACTERISTICS_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcTextStyleWithBoxCharacteristics : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTextStyleWithBoxCharacteristics);
  //DOM-IGNORE-END
...
public:
  ...
  double getBoxSlantAngle() const;
  void setBoxSlantAngle(double BoxSlantAngle);
  double getBoxRotateAngle() const;
  void setBoxRotateAngle(double BoxRotateAngle);
...
protected:
  // Fields declaration: 
  IfcPositiveLengthMeasure m_BoxHeight;   // IfcPositiveLengthMeasure  [optional]
  IfcPositiveLengthMeasure m_BoxWidth;   // IfcPositiveLengthMeasure  [optional]
  double m_BoxSlantAngle;   // IfcPlaneAngleMeasure  [optional]
  double m_BoxRotateAngle;   // IfcPlaneAngleMeasure  [optional]
  OdDAI::Select m_CharacterSpacing;   // IfcSizeSelect  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTextStyleWithBoxCharacteristics, IfcTextStyleWithBoxCharacteristics> object.
*/
typedef OdSmartPtr<IfcTextStyleWithBoxCharacteristics> IfcTextStyleWithBoxCharacteristicsPtr;

} // namespace

#endif // _IFC2X3_IFCTEXTSTYLEWITHBOXCHARACTERISTICS_AUTO_IMPL_H
