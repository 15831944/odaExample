...
#ifndef _IFC2X3_IFCANNOTATIONCURVEOCCURRENCE_AUTO_IMPL_H
#define _IFC2X3_IFCANNOTATIONCURVEOCCURRENCE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcAnnotationCurveOccurrence : public IfcAnnotationOccurrence
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcAnnotationCurveOccurrence);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcAnnotationCurveOccurrence, IfcAnnotationCurveOccurrence> object.
*/
typedef OdSmartPtr<IfcAnnotationCurveOccurrence> IfcAnnotationCurveOccurrencePtr;

} // namespace

#endif // _IFC2X3_IFCANNOTATIONCURVEOCCURRENCE_AUTO_IMPL_H
