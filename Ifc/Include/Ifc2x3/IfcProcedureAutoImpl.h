...
#ifndef _IFC2X3_IFCPROCEDURE_AUTO_IMPL_H
#define _IFC2X3_IFCPROCEDURE_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcProcedure);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcProcedure, IfcProcedure> object.
*/
typedef OdSmartPtr<IfcProcedure> IfcProcedurePtr;

} // namespace

#endif // _IFC2X3_IFCPROCEDURE_AUTO_IMPL_H
