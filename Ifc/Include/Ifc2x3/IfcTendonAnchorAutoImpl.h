...
#ifndef _IFC2X3_IFCTENDONANCHOR_AUTO_IMPL_H
#define _IFC2X3_IFCTENDONANCHOR_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcTendonAnchor : public IfcReinforcingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTendonAnchor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTendonAnchor, IfcTendonAnchor> object.
*/
typedef OdSmartPtr<IfcTendonAnchor> IfcTendonAnchorPtr;

} // namespace

#endif // _IFC2X3_IFCTENDONANCHOR_AUTO_IMPL_H
