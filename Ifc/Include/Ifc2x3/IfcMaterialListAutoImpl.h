...
#ifndef _IFC2X3_IFCMATERIALLIST_AUTO_IMPL_H
#define _IFC2X3_IFCMATERIALLIST_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcMaterialList : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcMaterialList);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcMaterialList, IfcMaterialList> object.
*/
typedef OdSmartPtr<IfcMaterialList> IfcMaterialListPtr;

} // namespace

#endif // _IFC2X3_IFCMATERIALLIST_AUTO_IMPL_H
