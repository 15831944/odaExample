...
#ifndef _IFC2X3_IFCSPATIALSTRUCTUREELEMENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCSPATIALSTRUCTUREELEMENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcSpatialStructureElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcSpatialStructureElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSpatialStructureElementType, IfcSpatialStructureElementType> object.
*/
typedef OdSmartPtr<IfcSpatialStructureElementType> IfcSpatialStructureElementTypePtr;

} // namespace

#endif // _IFC2X3_IFCSPATIALSTRUCTUREELEMENTTYPE_AUTO_IMPL_H
