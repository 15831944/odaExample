...
#ifndef _IFC2X3_IFCRADIUSDIMENSION_AUTO_IMPL_H
#define _IFC2X3_IFCRADIUSDIMENSION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRadiusDimension : public IfcDimensionCurveDirectedCallout
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRadiusDimension);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRadiusDimension, IfcRadiusDimension> object.
*/
typedef OdSmartPtr<IfcRadiusDimension> IfcRadiusDimensionPtr;

} // namespace

#endif // _IFC2X3_IFCRADIUSDIMENSION_AUTO_IMPL_H
