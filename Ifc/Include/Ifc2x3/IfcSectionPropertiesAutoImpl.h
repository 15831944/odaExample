...
#ifndef _IFC2X3_IFCSECTIONPROPERTIES_AUTO_IMPL_H
#define _IFC2X3_IFCSECTIONPROPERTIES_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcSectionProperties : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcSectionProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSectionProperties, IfcSectionProperties> object.
*/
typedef OdSmartPtr<IfcSectionProperties> IfcSectionPropertiesPtr;

} // namespace

#endif // _IFC2X3_IFCSECTIONPROPERTIES_AUTO_IMPL_H
