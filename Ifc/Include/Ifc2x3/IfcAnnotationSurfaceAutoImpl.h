...
#ifndef _IFC2X3_IFCANNOTATIONSURFACE_AUTO_IMPL_H
#define _IFC2X3_IFCANNOTATIONSURFACE_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcAnnotationSurface);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getTextureCoordinates() const;
  void setTextureCoordinates(const OdDAIObjectId& TextureCoordinates);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Item;   // IfcGeometricRepresentationItem
  OdDAIObjectId m_TextureCoordinates;   // IfcTextureCoordinate  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcAnnotationSurface, IfcAnnotationSurface> object.
*/
typedef OdSmartPtr<IfcAnnotationSurface> IfcAnnotationSurfacePtr;

} // namespace

#endif // _IFC2X3_IFCANNOTATIONSURFACE_AUTO_IMPL_H
