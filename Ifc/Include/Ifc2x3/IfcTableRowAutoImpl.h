...
#ifndef _IFC2X3_IFCTABLEROW_AUTO_IMPL_H
#define _IFC2X3_IFCTABLEROW_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcTableRow : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTableRow);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTableRow, IfcTableRow> object.
*/
typedef OdSmartPtr<IfcTableRow> IfcTableRowPtr;

} // namespace

#endif // _IFC2X3_IFCTABLEROW_AUTO_IMPL_H
