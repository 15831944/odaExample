...
#ifndef _IFC2X3_IFCFURNITURESTANDARD_AUTO_IMPL_H
#define _IFC2X3_IFCFURNITURESTANDARD_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFurnitureStandard : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFurnitureStandard);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFurnitureStandard, IfcFurnitureStandard> object.
*/
typedef OdSmartPtr<IfcFurnitureStandard> IfcFurnitureStandardPtr;

} // namespace

#endif // _IFC2X3_IFCFURNITURESTANDARD_AUTO_IMPL_H
