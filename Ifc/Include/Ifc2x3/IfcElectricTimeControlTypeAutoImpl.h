...
#ifndef _IFC2X3_IFCELECTRICTIMECONTROLTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCELECTRICTIMECONTROLTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcElectricTimeControlType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcElectricTimeControlType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcElectricTimeControlType, IfcElectricTimeControlType> object.
*/
typedef OdSmartPtr<IfcElectricTimeControlType> IfcElectricTimeControlTypePtr;

} // namespace

#endif // _IFC2X3_IFCELECTRICTIMECONTROLTYPE_AUTO_IMPL_H
