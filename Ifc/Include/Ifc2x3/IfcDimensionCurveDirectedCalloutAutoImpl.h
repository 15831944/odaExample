...
#ifndef _IFC2X3_IFCDIMENSIONCURVEDIRECTEDCALLOUT_AUTO_IMPL_H
#define _IFC2X3_IFCDIMENSIONCURVEDIRECTEDCALLOUT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDimensionCurveDirectedCallout : public IfcDraughtingCallout
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDimensionCurveDirectedCallout);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDimensionCurveDirectedCallout, IfcDimensionCurveDirectedCallout> object.
*/
typedef OdSmartPtr<IfcDimensionCurveDirectedCallout> IfcDimensionCurveDirectedCalloutPtr;

} // namespace

#endif // _IFC2X3_IFCDIMENSIONCURVEDIRECTEDCALLOUT_AUTO_IMPL_H
