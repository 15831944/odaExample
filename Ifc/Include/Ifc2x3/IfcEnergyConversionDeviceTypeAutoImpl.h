...
#ifndef _IFC2X3_IFCENERGYCONVERSIONDEVICETYPE_AUTO_IMPL_H
#define _IFC2X3_IFCENERGYCONVERSIONDEVICETYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcEnergyConversionDeviceType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcEnergyConversionDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcEnergyConversionDeviceType, IfcEnergyConversionDeviceType> object.
*/
typedef OdSmartPtr<IfcEnergyConversionDeviceType> IfcEnergyConversionDeviceTypePtr;

} // namespace

#endif // _IFC2X3_IFCENERGYCONVERSIONDEVICETYPE_AUTO_IMPL_H
