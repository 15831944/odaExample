...
#ifndef _IFC2X3_IFCSTRUCTURALCURVEMEMBERVARYING_AUTO_IMPL_H
#define _IFC2X3_IFCSTRUCTURALCURVEMEMBERVARYING_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcStructuralCurveMemberVarying : public IfcStructuralCurveMember
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcStructuralCurveMemberVarying);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcStructuralCurveMemberVarying, IfcStructuralCurveMemberVarying> object.
*/
typedef OdSmartPtr<IfcStructuralCurveMemberVarying> IfcStructuralCurveMemberVaryingPtr;

} // namespace

#endif // _IFC2X3_IFCSTRUCTURALCURVEMEMBERVARYING_AUTO_IMPL_H
