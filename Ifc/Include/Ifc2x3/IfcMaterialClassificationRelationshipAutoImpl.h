...
#ifndef _IFC2X3_IFCMATERIALCLASSIFICATIONRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCMATERIALCLASSIFICATIONRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcMaterialClassificationRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcMaterialClassificationRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcMaterialClassificationRelationship, IfcMaterialClassificationRelationship> object.
*/
typedef OdSmartPtr<IfcMaterialClassificationRelationship> IfcMaterialClassificationRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCMATERIALCLASSIFICATIONRELATIONSHIP_AUTO_IMPL_H
