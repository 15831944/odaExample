...
#ifndef _IFC2X3_IFCPREDEFINEDCURVEFONT_AUTO_IMPL_H
#define _IFC2X3_IFCPREDEFINEDCURVEFONT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPreDefinedCurveFont : public IfcPreDefinedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcPreDefinedCurveFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPreDefinedCurveFont, IfcPreDefinedCurveFont> object.
*/
typedef OdSmartPtr<IfcPreDefinedCurveFont> IfcPreDefinedCurveFontPtr;

} // namespace

#endif // _IFC2X3_IFCPREDEFINEDCURVEFONT_AUTO_IMPL_H
