...
#ifndef _IFC2X3_IFCDUCTFITTINGTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCDUCTFITTINGTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDuctFittingType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDuctFittingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDuctFittingType, IfcDuctFittingType> object.
*/
typedef OdSmartPtr<IfcDuctFittingType> IfcDuctFittingTypePtr;

} // namespace

#endif // _IFC2X3_IFCDUCTFITTINGTYPE_AUTO_IMPL_H
