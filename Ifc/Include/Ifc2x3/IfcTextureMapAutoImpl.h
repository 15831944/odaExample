...
#ifndef _IFC2X3_IFCTEXTUREMAP_AUTO_IMPL_H
#define _IFC2X3_IFCTEXTUREMAP_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTextureMap);
  //DOM-IGNORE-END
...
public:
  ...
  void getTextureMaps(OdDAIObjectIds& TextureMaps) const;
  OdDAI::OdDAIObjectIdSet& textureMaps();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_TextureMaps; // SET [1:?] of IfcVertexBasedTextureMap
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTextureMap, IfcTextureMap> object.
*/
typedef OdSmartPtr<IfcTextureMap> IfcTextureMapPtr;

} // namespace

#endif // _IFC2X3_IFCTEXTUREMAP_AUTO_IMPL_H
