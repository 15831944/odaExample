...
#ifndef _IFC2X3_IFCSLABTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCSLABTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcSlabType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcSlabType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSlabType, IfcSlabType> object.
*/
typedef OdSmartPtr<IfcSlabType> IfcSlabTypePtr;

} // namespace

#endif // _IFC2X3_IFCSLABTYPE_AUTO_IMPL_H
