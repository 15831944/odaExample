...
#ifndef _IFC2X3_IFCWALL_AUTO_IMPL_H
#define _IFC2X3_IFCWALL_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcWall : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcWall);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcWall, IfcWall> object.
*/
typedef OdSmartPtr<IfcWall> IfcWallPtr;

} // namespace

#endif // _IFC2X3_IFCWALL_AUTO_IMPL_H
