...
#ifndef _IFC2X3_IFCCOOLINGTOWERTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCCOOLINGTOWERTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCoolingTowerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCoolingTowerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCoolingTowerType, IfcCoolingTowerType> object.
*/
typedef OdSmartPtr<IfcCoolingTowerType> IfcCoolingTowerTypePtr;

} // namespace

#endif // _IFC2X3_IFCCOOLINGTOWERTYPE_AUTO_IMPL_H
