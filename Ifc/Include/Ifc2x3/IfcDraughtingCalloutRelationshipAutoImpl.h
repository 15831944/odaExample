...
#ifndef _IFC2X3_IFCDRAUGHTINGCALLOUTRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCDRAUGHTINGCALLOUTRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDraughtingCalloutRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDraughtingCalloutRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDraughtingCalloutRelationship, IfcDraughtingCalloutRelationship> object.
*/
typedef OdSmartPtr<IfcDraughtingCalloutRelationship> IfcDraughtingCalloutRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCDRAUGHTINGCALLOUTRELATIONSHIP_AUTO_IMPL_H
