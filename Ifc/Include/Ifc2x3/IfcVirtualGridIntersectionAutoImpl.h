...
#ifndef _IFC2X3_IFCVIRTUALGRIDINTERSECTION_AUTO_IMPL_H
#define _IFC2X3_IFCVIRTUALGRIDINTERSECTION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcVirtualGridIntersection : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcVirtualGridIntersection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcVirtualGridIntersection, IfcVirtualGridIntersection> object.
*/
typedef OdSmartPtr<IfcVirtualGridIntersection> IfcVirtualGridIntersectionPtr;

} // namespace

#endif // _IFC2X3_IFCVIRTUALGRIDINTERSECTION_AUTO_IMPL_H
