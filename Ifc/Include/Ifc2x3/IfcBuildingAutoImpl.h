...
#ifndef _IFC2X3_IFCBUILDING_AUTO_IMPL_H
#define _IFC2X3_IFCBUILDING_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcBuilding);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcBuilding, IfcBuilding> object.
*/
typedef OdSmartPtr<IfcBuilding> IfcBuildingPtr;

} // namespace

#endif // _IFC2X3_IFCBUILDING_AUTO_IMPL_H
