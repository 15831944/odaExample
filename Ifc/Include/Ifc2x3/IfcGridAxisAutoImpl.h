...
#ifndef _IFC2X3_IFCGRIDAXIS_AUTO_IMPL_H
#define _IFC2X3_IFCGRIDAXIS_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcGridAxis : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcGridAxis);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcGridAxis, IfcGridAxis> object.
*/
typedef OdSmartPtr<IfcGridAxis> IfcGridAxisPtr;

} // namespace

#endif // _IFC2X3_IFCGRIDAXIS_AUTO_IMPL_H
