...
#ifndef _IFC2X3_IFCFIRESUPPRESSIONTERMINALTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCFIRESUPPRESSIONTERMINALTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFireSuppressionTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFireSuppressionTerminalType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFireSuppressionTerminalType, IfcFireSuppressionTerminalType> object.
*/
typedef OdSmartPtr<IfcFireSuppressionTerminalType> IfcFireSuppressionTerminalTypePtr;

} // namespace

#endif // _IFC2X3_IFCFIRESUPPRESSIONTERMINALTYPE_AUTO_IMPL_H
