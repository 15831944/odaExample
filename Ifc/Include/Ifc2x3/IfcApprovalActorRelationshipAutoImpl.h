...
#ifndef _IFC2X3_IFCAPPROVALACTORRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCAPPROVALACTORRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcApprovalActorRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcApprovalActorRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcApprovalActorRelationship, IfcApprovalActorRelationship> object.
*/
typedef OdSmartPtr<IfcApprovalActorRelationship> IfcApprovalActorRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCAPPROVALACTORRELATIONSHIP_AUTO_IMPL_H
