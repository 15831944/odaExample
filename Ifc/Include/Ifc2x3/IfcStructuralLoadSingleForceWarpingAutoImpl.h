...
#ifndef _IFC2X3_IFCSTRUCTURALLOADSINGLEFORCEWARPING_AUTO_IMPL_H
#define _IFC2X3_IFCSTRUCTURALLOADSINGLEFORCEWARPING_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcStructuralLoadSingleForceWarping : public IfcStructuralLoadSingleForce
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcStructuralLoadSingleForceWarping);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcStructuralLoadSingleForceWarping, IfcStructuralLoadSingleForceWarping> object.
*/
typedef OdSmartPtr<IfcStructuralLoadSingleForceWarping> IfcStructuralLoadSingleForceWarpingPtr;

} // namespace

#endif // _IFC2X3_IFCSTRUCTURALLOADSINGLEFORCEWARPING_AUTO_IMPL_H
