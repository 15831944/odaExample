...
#ifndef _IFC2X3_IFCBUILDINGELEMENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCBUILDINGELEMENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcBuildingElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcBuildingElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcBuildingElementType, IfcBuildingElementType> object.
*/
typedef OdSmartPtr<IfcBuildingElementType> IfcBuildingElementTypePtr;

} // namespace

#endif // _IFC2X3_IFCBUILDINGELEMENTTYPE_AUTO_IMPL_H
