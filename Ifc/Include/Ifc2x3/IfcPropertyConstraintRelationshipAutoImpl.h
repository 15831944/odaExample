...
#ifndef _IFC2X3_IFCPROPERTYCONSTRAINTRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCPROPERTYCONSTRAINTRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPropertyConstraintRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPropertyConstraintRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPropertyConstraintRelationship, IfcPropertyConstraintRelationship> object.
*/
typedef OdSmartPtr<IfcPropertyConstraintRelationship> IfcPropertyConstraintRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCPROPERTYCONSTRAINTRELATIONSHIP_AUTO_IMPL_H
