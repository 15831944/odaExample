...
#ifndef _IFC2X3_IFCDRAUGHTINGPREDEFINEDCOLOUR_AUTO_IMPL_H
#define _IFC2X3_IFCDRAUGHTINGPREDEFINEDCOLOUR_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDraughtingPreDefinedColour : public IfcPreDefinedColour
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDraughtingPreDefinedColour);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDraughtingPreDefinedColour, IfcDraughtingPreDefinedColour> object.
*/
typedef OdSmartPtr<IfcDraughtingPreDefinedColour> IfcDraughtingPreDefinedColourPtr;

} // namespace

#endif // _IFC2X3_IFCDRAUGHTINGPREDEFINEDCOLOUR_AUTO_IMPL_H
