...
#ifndef _IFC2X3_IFCELECTRICGENERATORTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCELECTRICGENERATORTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcElectricGeneratorType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcElectricGeneratorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcElectricGeneratorType, IfcElectricGeneratorType> object.
*/
typedef OdSmartPtr<IfcElectricGeneratorType> IfcElectricGeneratorTypePtr;

} // namespace

#endif // _IFC2X3_IFCELECTRICGENERATORTYPE_AUTO_IMPL_H
