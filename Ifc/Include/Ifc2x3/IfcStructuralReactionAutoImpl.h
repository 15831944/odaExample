...
#ifndef _IFC2X3_IFCSTRUCTURALREACTION_AUTO_IMPL_H
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcStructuralReaction, IfcStructuralReaction> object.
*/
typedef OdSmartPtr<IfcStructuralReaction> IfcStructuralReactionPtr;

} // namespace

#endif // _IFC2X3_IFCSTRUCTURALREACTION_AUTO_IMPL_H
