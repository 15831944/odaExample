...
#ifndef _IFC2X3_IFCADDRESS_AUTO_IMPL_H
#define _IFC2X3_IFCADDRESS_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcAddress : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcAddress);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcAddress, IfcAddress> object.
*/
typedef OdSmartPtr<IfcAddress> IfcAddressPtr;

} // namespace

#endif // _IFC2X3_IFCADDRESS_AUTO_IMPL_H
