...
#ifndef _IFC2X3_IFCBEAMTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCBEAMTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcBeamType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcBeamType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcBeamType, IfcBeamType> object.
*/
typedef OdSmartPtr<IfcBeamType> IfcBeamTypePtr;

} // namespace

#endif // _IFC2X3_IFCBEAMTYPE_AUTO_IMPL_H
