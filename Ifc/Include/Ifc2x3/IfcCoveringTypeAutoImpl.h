...
#ifndef _IFC2X3_IFCCOVERINGTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCCOVERINGTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCoveringType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCoveringType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCoveringType, IfcCoveringType> object.
*/
typedef OdSmartPtr<IfcCoveringType> IfcCoveringTypePtr;

} // namespace

#endif // _IFC2X3_IFCCOVERINGTYPE_AUTO_IMPL_H
