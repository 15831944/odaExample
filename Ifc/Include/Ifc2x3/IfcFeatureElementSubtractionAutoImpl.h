...
#ifndef _IFC2X3_IFCFEATUREELEMENTSUBTRACTION_AUTO_IMPL_H
#define _IFC2X3_IFCFEATUREELEMENTSUBTRACTION_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcFeatureElementSubtraction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFeatureElementSubtraction, IfcFeatureElementSubtraction> object.
*/
typedef OdSmartPtr<IfcFeatureElementSubtraction> IfcFeatureElementSubtractionPtr;

} // namespace

#endif // _IFC2X3_IFCFEATUREELEMENTSUBTRACTION_AUTO_IMPL_H
