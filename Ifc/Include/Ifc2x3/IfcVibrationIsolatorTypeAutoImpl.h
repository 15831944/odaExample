...
#ifndef _IFC2X3_IFCVIBRATIONISOLATORTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCVIBRATIONISOLATORTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcVibrationIsolatorType : public IfcDiscreteAccessoryType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcVibrationIsolatorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcVibrationIsolatorType, IfcVibrationIsolatorType> object.
*/
typedef OdSmartPtr<IfcVibrationIsolatorType> IfcVibrationIsolatorTypePtr;

} // namespace

#endif // _IFC2X3_IFCVIBRATIONISOLATORTYPE_AUTO_IMPL_H
