...
#ifndef _IFC2X3_IFCPOINT_AUTO_IMPL_H
#define _IFC2X3_IFCPOINT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPoint : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcPoint);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPoint, IfcPoint> object.
*/
typedef OdSmartPtr<IfcPoint> IfcPointPtr;

} // namespace

#endif // _IFC2X3_IFCPOINT_AUTO_IMPL_H
