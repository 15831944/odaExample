...
#ifndef _IFC2X3_IFCAIRTERMINALTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCAIRTERMINALTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcAirTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcAirTerminalType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcAirTerminalType, IfcAirTerminalType> object.
*/
typedef OdSmartPtr<IfcAirTerminalType> IfcAirTerminalTypePtr;

} // namespace

#endif // _IFC2X3_IFCAIRTERMINALTYPE_AUTO_IMPL_H
