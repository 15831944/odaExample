...
#ifndef _IFC2X3_IFCSURFACESTYLEWITHTEXTURES_AUTO_IMPL_H
#define _IFC2X3_IFCSURFACESTYLEWITHTEXTURES_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcSurfaceStyleWithTextures : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcSurfaceStyleWithTextures);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSurfaceStyleWithTextures, IfcSurfaceStyleWithTextures> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleWithTextures> IfcSurfaceStyleWithTexturesPtr;

} // namespace

#endif // _IFC2X3_IFCSURFACESTYLEWITHTEXTURES_AUTO_IMPL_H
