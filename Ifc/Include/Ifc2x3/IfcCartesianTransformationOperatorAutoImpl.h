...
#ifndef _IFC2X3_IFCCARTESIANTRANSFORMATIONOPERATOR_AUTO_IMPL_H
#define _IFC2X3_IFCCARTESIANTRANSFORMATIONOPERATOR_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcCartesianTransformationOperator);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCartesianTransformationOperator, IfcCartesianTransformationOperator> object.
*/
typedef OdSmartPtr<IfcCartesianTransformationOperator> IfcCartesianTransformationOperatorPtr;

} // namespace

#endif // _IFC2X3_IFCCARTESIANTRANSFORMATIONOPERATOR_AUTO_IMPL_H
