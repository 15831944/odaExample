...
#ifndef _IFC2X3_IFCFLOWSEGMENT_AUTO_IMPL_H
#define _IFC2X3_IFCFLOWSEGMENT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFlowSegment : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFlowSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFlowSegment, IfcFlowSegment> object.
*/
typedef OdSmartPtr<IfcFlowSegment> IfcFlowSegmentPtr;

} // namespace

#endif // _IFC2X3_IFCFLOWSEGMENT_AUTO_IMPL_H
