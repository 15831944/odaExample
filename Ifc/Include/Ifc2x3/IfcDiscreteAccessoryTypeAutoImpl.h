...
#ifndef _IFC2X3_IFCDISCRETEACCESSORYTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCDISCRETEACCESSORYTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDiscreteAccessoryType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDiscreteAccessoryType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDiscreteAccessoryType, IfcDiscreteAccessoryType> object.
*/
typedef OdSmartPtr<IfcDiscreteAccessoryType> IfcDiscreteAccessoryTypePtr;

} // namespace

#endif // _IFC2X3_IFCDISCRETEACCESSORYTYPE_AUTO_IMPL_H
