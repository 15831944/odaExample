...
#ifndef _IFC2X3_IFCAPPROVALRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCAPPROVALRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcApprovalRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcApprovalRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcApprovalRelationship, IfcApprovalRelationship> object.
*/
typedef OdSmartPtr<IfcApprovalRelationship> IfcApprovalRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCAPPROVALRELATIONSHIP_AUTO_IMPL_H
