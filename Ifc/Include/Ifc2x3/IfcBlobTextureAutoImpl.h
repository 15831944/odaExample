...
#ifndef _IFC2X3_IFCBLOBTEXTURE_AUTO_IMPL_H
#define _IFC2X3_IFCBLOBTEXTURE_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcBlobTexture);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::Boolean getRasterCode() const;
  void setRasterCode(OdDAI::Boolean RasterCode);
...
protected:
  ...
  OdDAI::Boolean m_RasterCode;   // BOOLEAN
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcBlobTexture, IfcBlobTexture> object.
*/
typedef OdSmartPtr<IfcBlobTexture> IfcBlobTexturePtr;

} // namespace

#endif // _IFC2X3_IFCBLOBTEXTURE_AUTO_IMPL_H
