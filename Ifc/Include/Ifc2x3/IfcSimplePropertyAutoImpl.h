...
#ifndef _IFC2X3_IFCSIMPLEPROPERTY_AUTO_IMPL_H
#define _IFC2X3_IFCSIMPLEPROPERTY_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcSimpleProperty : public IfcProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcSimpleProperty);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSimpleProperty, IfcSimpleProperty> object.
*/
typedef OdSmartPtr<IfcSimpleProperty> IfcSimplePropertyPtr;

} // namespace

#endif // _IFC2X3_IFCSIMPLEPROPERTY_AUTO_IMPL_H
