...
#ifndef _IFC2X3_IFCSTRUCTURALPOINTREACTION_AUTO_IMPL_H
#define _IFC2X3_IFCSTRUCTURALPOINTREACTION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcStructuralPointReaction : public IfcStructuralReaction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcStructuralPointReaction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcStructuralPointReaction, IfcStructuralPointReaction> object.
*/
typedef OdSmartPtr<IfcStructuralPointReaction> IfcStructuralPointReactionPtr;

} // namespace

#endif // _IFC2X3_IFCSTRUCTURALPOINTREACTION_AUTO_IMPL_H
