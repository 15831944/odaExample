...
#ifndef _IFC2X3_IFCCOLUMN_AUTO_IMPL_H
#define _IFC2X3_IFCCOLUMN_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcColumn : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcColumn);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcColumn, IfcColumn> object.
*/
typedef OdSmartPtr<IfcColumn> IfcColumnPtr;

} // namespace

#endif // _IFC2X3_IFCCOLUMN_AUTO_IMPL_H
