...
#ifndef _IFC2X3_IFCSTRUCTURALPOINTACTION_AUTO_IMPL_H
#define _IFC2X3_IFCSTRUCTURALPOINTACTION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcStructuralPointAction : public IfcStructuralAction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcStructuralPointAction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcStructuralPointAction, IfcStructuralPointAction> object.
*/
typedef OdSmartPtr<IfcStructuralPointAction> IfcStructuralPointActionPtr;

} // namespace

#endif // _IFC2X3_IFCSTRUCTURALPOINTACTION_AUTO_IMPL_H
