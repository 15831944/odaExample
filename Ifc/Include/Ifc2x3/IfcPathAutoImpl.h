...
#ifndef _IFC2X3_IFCPATH_AUTO_IMPL_H
#define _IFC2X3_IFCPATH_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPath : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPath);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPath, IfcPath> object.
*/
typedef OdSmartPtr<IfcPath> IfcPathPtr;

} // namespace

#endif // _IFC2X3_IFCPATH_AUTO_IMPL_H
