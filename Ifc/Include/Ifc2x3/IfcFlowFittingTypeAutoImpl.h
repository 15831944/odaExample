...
#ifndef _IFC2X3_IFCFLOWFITTINGTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCFLOWFITTINGTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFlowFittingType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcFlowFittingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFlowFittingType, IfcFlowFittingType> object.
*/
typedef OdSmartPtr<IfcFlowFittingType> IfcFlowFittingTypePtr;

} // namespace

#endif // _IFC2X3_IFCFLOWFITTINGTYPE_AUTO_IMPL_H
