...
#ifndef _IFC2X3_IFCRELASSOCIATESPROFILEPROPERTIES_AUTO_IMPL_H
#define _IFC2X3_IFCRELASSOCIATESPROFILEPROPERTIES_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRelAssociatesProfileProperties);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Select m_ProfileOrientation;   // IfcOrientationSelect  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelAssociatesProfileProperties, IfcRelAssociatesProfileProperties> object.
*/
typedef OdSmartPtr<IfcRelAssociatesProfileProperties> IfcRelAssociatesProfilePropertiesPtr;

} // namespace

#endif // _IFC2X3_IFCRELASSOCIATESPROFILEPROPERTIES_AUTO_IMPL_H
