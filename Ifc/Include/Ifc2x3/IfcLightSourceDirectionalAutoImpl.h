...
#ifndef _IFC2X3_IFCLIGHTSOURCEDIRECTIONAL_AUTO_IMPL_H
#define _IFC2X3_IFCLIGHTSOURCEDIRECTIONAL_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcLightSourceDirectional : public IfcLightSource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcLightSourceDirectional);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcLightSourceDirectional, IfcLightSourceDirectional> object.
*/
typedef OdSmartPtr<IfcLightSourceDirectional> IfcLightSourceDirectionalPtr;

} // namespace

#endif // _IFC2X3_IFCLIGHTSOURCEDIRECTIONAL_AUTO_IMPL_H
