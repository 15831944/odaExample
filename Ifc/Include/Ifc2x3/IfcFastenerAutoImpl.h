...
#ifndef _IFC2X3_IFCFASTENER_AUTO_IMPL_H
#define _IFC2X3_IFCFASTENER_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFastener : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFastener);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFastener, IfcFastener> object.
*/
typedef OdSmartPtr<IfcFastener> IfcFastenerPtr;

} // namespace

#endif // _IFC2X3_IFCFASTENER_AUTO_IMPL_H
