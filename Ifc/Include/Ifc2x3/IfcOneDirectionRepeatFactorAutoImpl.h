...
#ifndef _IFC2X3_IFCONEDIRECTIONREPEATFACTOR_AUTO_IMPL_H
#define _IFC2X3_IFCONEDIRECTIONREPEATFACTOR_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcOneDirectionRepeatFactor : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcOneDirectionRepeatFactor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcOneDirectionRepeatFactor, IfcOneDirectionRepeatFactor> object.
*/
typedef OdSmartPtr<IfcOneDirectionRepeatFactor> IfcOneDirectionRepeatFactorPtr;

} // namespace

#endif // _IFC2X3_IFCONEDIRECTIONREPEATFACTOR_AUTO_IMPL_H
