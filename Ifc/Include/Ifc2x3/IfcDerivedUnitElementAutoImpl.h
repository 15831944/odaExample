...
#ifndef _IFC2X3_IFCDERIVEDUNITELEMENT_AUTO_IMPL_H
#define _IFC2X3_IFCDERIVEDUNITELEMENT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDerivedUnitElement : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDerivedUnitElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDerivedUnitElement, IfcDerivedUnitElement> object.
*/
typedef OdSmartPtr<IfcDerivedUnitElement> IfcDerivedUnitElementPtr;

} // namespace

#endif // _IFC2X3_IFCDERIVEDUNITELEMENT_AUTO_IMPL_H
