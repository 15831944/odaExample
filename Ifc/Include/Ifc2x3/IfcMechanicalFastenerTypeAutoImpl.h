...
#ifndef _IFC2X3_IFCMECHANICALFASTENERTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCMECHANICALFASTENERTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcMechanicalFastenerType : public IfcFastenerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcMechanicalFastenerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcMechanicalFastenerType, IfcMechanicalFastenerType> object.
*/
typedef OdSmartPtr<IfcMechanicalFastenerType> IfcMechanicalFastenerTypePtr;

} // namespace

#endif // _IFC2X3_IFCMECHANICALFASTENERTYPE_AUTO_IMPL_H
