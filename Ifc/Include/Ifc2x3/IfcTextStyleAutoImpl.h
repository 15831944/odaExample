...
#ifndef _IFC2X3_IFCTEXTSTYLE_AUTO_IMPL_H
#define _IFC2X3_IFCTEXTSTYLE_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTextStyle);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_TextCharacterAppearance;   // IfcCharacterStyleSelect  [optional]
  OdDAI::Select m_TextStyle;   // IfcTextStyleSelect  [optional]
  OdDAI::Select m_TextFontStyle;   // IfcTextFontSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTextStyle, IfcTextStyle> object.
*/
typedef OdSmartPtr<IfcTextStyle> IfcTextStylePtr;

} // namespace

#endif // _IFC2X3_IFCTEXTSTYLE_AUTO_IMPL_H
