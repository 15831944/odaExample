...
#ifndef _IFC2X3_IFCCOILTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCCOILTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCoilType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCoilType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCoilType, IfcCoilType> object.
*/
typedef OdSmartPtr<IfcCoilType> IfcCoilTypePtr;

} // namespace

#endif // _IFC2X3_IFCCOILTYPE_AUTO_IMPL_H
