...
#ifndef _IFC2X3_IFCSTRUCTUREDDIMENSIONCALLOUT_AUTO_IMPL_H
#define _IFC2X3_IFCSTRUCTUREDDIMENSIONCALLOUT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcStructuredDimensionCallout : public IfcDraughtingCallout
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcStructuredDimensionCallout);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcStructuredDimensionCallout, IfcStructuredDimensionCallout> object.
*/
typedef OdSmartPtr<IfcStructuredDimensionCallout> IfcStructuredDimensionCalloutPtr;

} // namespace

#endif // _IFC2X3_IFCSTRUCTUREDDIMENSIONCALLOUT_AUTO_IMPL_H
