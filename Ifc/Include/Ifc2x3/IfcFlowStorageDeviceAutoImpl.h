...
#ifndef _IFC2X3_IFCFLOWSTORAGEDEVICE_AUTO_IMPL_H
#define _IFC2X3_IFCFLOWSTORAGEDEVICE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFlowStorageDevice : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFlowStorageDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFlowStorageDevice, IfcFlowStorageDevice> object.
*/
typedef OdSmartPtr<IfcFlowStorageDevice> IfcFlowStorageDevicePtr;

} // namespace

#endif // _IFC2X3_IFCFLOWSTORAGEDEVICE_AUTO_IMPL_H
