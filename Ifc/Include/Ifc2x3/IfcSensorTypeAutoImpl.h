...
#ifndef _IFC2X3_IFCSENSORTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCSENSORTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcSensorType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcSensorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSensorType, IfcSensorType> object.
*/
typedef OdSmartPtr<IfcSensorType> IfcSensorTypePtr;

} // namespace

#endif // _IFC2X3_IFCSENSORTYPE_AUTO_IMPL_H
