...
#ifndef _IFC2X3_IFCCURVE_AUTO_IMPL_H
#define _IFC2X3_IFCCURVE_AUTO_IMPL_H
...
*/
class IFC2X3_EXPORT IfcCurve : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCurve, IfcCurve> object.
*/
typedef OdSmartPtr<IfcCurve> IfcCurvePtr;

} // namespace

#endif // _IFC2X3_IFCCURVE_AUTO_IMPL_H
