...
#ifndef _IFC2X3_IFCOPENSHELL_AUTO_IMPL_H
#define _IFC2X3_IFCOPENSHELL_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcOpenShell : public IfcConnectedFaceSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcOpenShell);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcOpenShell, IfcOpenShell> object.
*/
typedef OdSmartPtr<IfcOpenShell> IfcOpenShellPtr;

} // namespace

#endif // _IFC2X3_IFCOPENSHELL_AUTO_IMPL_H
