...
#ifndef _IFC2X3_IFCBUILDINGELEMENTPART_AUTO_IMPL_H
#define _IFC2X3_IFCBUILDINGELEMENTPART_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcBuildingElementPart : public IfcBuildingElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcBuildingElementPart);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcBuildingElementPart, IfcBuildingElementPart> object.
*/
typedef OdSmartPtr<IfcBuildingElementPart> IfcBuildingElementPartPtr;

} // namespace

#endif // _IFC2X3_IFCBUILDINGELEMENTPART_AUTO_IMPL_H
