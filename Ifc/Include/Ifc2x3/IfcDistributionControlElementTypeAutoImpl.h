...
#ifndef _IFC2X3_IFCDISTRIBUTIONCONTROLELEMENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCDISTRIBUTIONCONTROLELEMENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDistributionControlElementType : public IfcDistributionElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcDistributionControlElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDistributionControlElementType, IfcDistributionControlElementType> object.
*/
typedef OdSmartPtr<IfcDistributionControlElementType> IfcDistributionControlElementTypePtr;

} // namespace

#endif // _IFC2X3_IFCDISTRIBUTIONCONTROLELEMENTTYPE_AUTO_IMPL_H
