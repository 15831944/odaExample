...
#ifndef _IFC2X3_IFCRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRelationship : public IfcRoot
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelationship, IfcRelationship> object.
*/
typedef OdSmartPtr<IfcRelationship> IfcRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCRELATIONSHIP_AUTO_IMPL_H
