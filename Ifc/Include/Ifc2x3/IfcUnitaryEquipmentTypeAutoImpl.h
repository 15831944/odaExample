...
#ifndef _IFC2X3_IFCUNITARYEQUIPMENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCUNITARYEQUIPMENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcUnitaryEquipmentType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcUnitaryEquipmentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcUnitaryEquipmentType, IfcUnitaryEquipmentType> object.
*/
typedef OdSmartPtr<IfcUnitaryEquipmentType> IfcUnitaryEquipmentTypePtr;

} // namespace

#endif // _IFC2X3_IFCUNITARYEQUIPMENTTYPE_AUTO_IMPL_H
