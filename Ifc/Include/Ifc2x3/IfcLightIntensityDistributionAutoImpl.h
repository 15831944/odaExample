...
#ifndef _IFC2X3_IFCLIGHTINTENSITYDISTRIBUTION_AUTO_IMPL_H
#define _IFC2X3_IFCLIGHTINTENSITYDISTRIBUTION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcLightIntensityDistribution : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcLightIntensityDistribution);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcLightIntensityDistribution, IfcLightIntensityDistribution> object.
*/
typedef OdSmartPtr<IfcLightIntensityDistribution> IfcLightIntensityDistributionPtr;

} // namespace

#endif // _IFC2X3_IFCLIGHTINTENSITYDISTRIBUTION_AUTO_IMPL_H
