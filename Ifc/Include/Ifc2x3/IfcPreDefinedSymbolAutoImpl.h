...
#ifndef _IFC2X3_IFCPREDEFINEDSYMBOL_AUTO_IMPL_H
#define _IFC2X3_IFCPREDEFINEDSYMBOL_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPreDefinedSymbol : public IfcPreDefinedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcPreDefinedSymbol);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPreDefinedSymbol, IfcPreDefinedSymbol> object.
*/
typedef OdSmartPtr<IfcPreDefinedSymbol> IfcPreDefinedSymbolPtr;

} // namespace

#endif // _IFC2X3_IFCPREDEFINEDSYMBOL_AUTO_IMPL_H
