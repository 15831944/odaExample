...
#ifndef _IFC2X3_IFCELEMENTCOMPONENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCELEMENTCOMPONENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcElementComponentType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcElementComponentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcElementComponentType, IfcElementComponentType> object.
*/
typedef OdSmartPtr<IfcElementComponentType> IfcElementComponentTypePtr;

} // namespace

#endif // _IFC2X3_IFCELEMENTCOMPONENTTYPE_AUTO_IMPL_H
