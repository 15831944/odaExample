...
#ifndef _IFC2X3_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRampFlightType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRampFlightType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRampFlightType, IfcRampFlightType> object.
*/
typedef OdSmartPtr<IfcRampFlightType> IfcRampFlightTypePtr;

} // namespace

#endif // _IFC2X3_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
