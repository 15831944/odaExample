...
#ifndef _IFC2X3_IFCFILLAREASTYLE_AUTO_IMPL_H
#define _IFC2X3_IFCFILLAREASTYLE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFillAreaStyle : public IfcPresentationStyle
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFillAreaStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFillAreaStyle, IfcFillAreaStyle> object.
*/
typedef OdSmartPtr<IfcFillAreaStyle> IfcFillAreaStylePtr;

} // namespace

#endif // _IFC2X3_IFCFILLAREASTYLE_AUTO_IMPL_H
