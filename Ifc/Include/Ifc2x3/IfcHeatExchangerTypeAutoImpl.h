...
#ifndef _IFC2X3_IFCHEATEXCHANGERTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCHEATEXCHANGERTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcHeatExchangerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcHeatExchangerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcHeatExchangerType, IfcHeatExchangerType> object.
*/
typedef OdSmartPtr<IfcHeatExchangerType> IfcHeatExchangerTypePtr;

} // namespace

#endif // _IFC2X3_IFCHEATEXCHANGERTYPE_AUTO_IMPL_H
