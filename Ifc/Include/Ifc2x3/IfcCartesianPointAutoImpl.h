...
#ifndef _IFC2X3_IFCCARTESIANPOINT_AUTO_IMPL_H
#define _IFC2X3_IFCCARTESIANPOINT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCartesianPoint : public IfcPoint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCartesianPoint);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCartesianPoint, IfcCartesianPoint> object.
*/
typedef OdSmartPtr<IfcCartesianPoint> IfcCartesianPointPtr;

} // namespace

#endif // _IFC2X3_IFCCARTESIANPOINT_AUTO_IMPL_H
