...
#ifndef _IFC2X3_IFCFLOWSTORAGEDEVICETYPE_AUTO_IMPL_H
#define _IFC2X3_IFCFLOWSTORAGEDEVICETYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFlowStorageDeviceType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcFlowStorageDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFlowStorageDeviceType, IfcFlowStorageDeviceType> object.
*/
typedef OdSmartPtr<IfcFlowStorageDeviceType> IfcFlowStorageDeviceTypePtr;

} // namespace

#endif // _IFC2X3_IFCFLOWSTORAGEDEVICETYPE_AUTO_IMPL_H
