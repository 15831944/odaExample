...
#ifndef _IFC2X3_IFCEVAPORATIVECOOLERTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCEVAPORATIVECOOLERTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcEvaporativeCoolerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcEvaporativeCoolerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcEvaporativeCoolerType, IfcEvaporativeCoolerType> object.
*/
typedef OdSmartPtr<IfcEvaporativeCoolerType> IfcEvaporativeCoolerTypePtr;

} // namespace

#endif // _IFC2X3_IFCEVAPORATIVECOOLERTYPE_AUTO_IMPL_H
