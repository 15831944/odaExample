...
#ifndef _IFC2X3_IFCFLOWSEGMENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCFLOWSEGMENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFlowSegmentType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcFlowSegmentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFlowSegmentType, IfcFlowSegmentType> object.
*/
typedef OdSmartPtr<IfcFlowSegmentType> IfcFlowSegmentTypePtr;

} // namespace

#endif // _IFC2X3_IFCFLOWSEGMENTTYPE_AUTO_IMPL_H
