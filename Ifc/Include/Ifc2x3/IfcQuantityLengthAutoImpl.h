...
#ifndef _IFC2X3_IFCQUANTITYLENGTH_AUTO_IMPL_H
#define _IFC2X3_IFCQUANTITYLENGTH_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcQuantityLength : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcQuantityLength);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcQuantityLength, IfcQuantityLength> object.
*/
typedef OdSmartPtr<IfcQuantityLength> IfcQuantityLengthPtr;

} // namespace

#endif // _IFC2X3_IFCQUANTITYLENGTH_AUTO_IMPL_H
