...
#ifndef _IFC2X3_IFCDISTRIBUTIONCHAMBERELEMENT_AUTO_IMPL_H
#define _IFC2X3_IFCDISTRIBUTIONCHAMBERELEMENT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDistributionChamberElement : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDistributionChamberElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDistributionChamberElement, IfcDistributionChamberElement> object.
*/
typedef OdSmartPtr<IfcDistributionChamberElement> IfcDistributionChamberElementPtr;

} // namespace

#endif // _IFC2X3_IFCDISTRIBUTIONCHAMBERELEMENT_AUTO_IMPL_H
