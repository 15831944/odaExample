...
#ifndef _IFC2X3_IFCOCCUPANT_AUTO_IMPL_H
#define _IFC2X3_IFCOCCUPANT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcOccupant : public IfcActor
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcOccupant);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcOccupant, IfcOccupant> object.
*/
typedef OdSmartPtr<IfcOccupant> IfcOccupantPtr;

} // namespace

#endif // _IFC2X3_IFCOCCUPANT_AUTO_IMPL_H
