...
#ifndef _IFC2X3_IFCLAMPTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCLAMPTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcLampType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcLampType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcLampType, IfcLampType> object.
*/
typedef OdSmartPtr<IfcLampType> IfcLampTypePtr;

} // namespace

#endif // _IFC2X3_IFCLAMPTYPE_AUTO_IMPL_H
