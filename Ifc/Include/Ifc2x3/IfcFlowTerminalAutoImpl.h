...
#ifndef _IFC2X3_IFCFLOWTERMINAL_AUTO_IMPL_H
#define _IFC2X3_IFCFLOWTERMINAL_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFlowTerminal : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFlowTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFlowTerminal, IfcFlowTerminal> object.
*/
typedef OdSmartPtr<IfcFlowTerminal> IfcFlowTerminalPtr;

} // namespace

#endif // _IFC2X3_IFCFLOWTERMINAL_AUTO_IMPL_H
