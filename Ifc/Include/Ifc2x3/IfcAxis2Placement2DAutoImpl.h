...
#ifndef _IFC2X3_IFCAXIS2PLACEMENT2D_AUTO_IMPL_H
#define _IFC2X3_IFCAXIS2PLACEMENT2D_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcAxis2Placement2D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcAxis2Placement2D, IfcAxis2Placement2D> object.
*/
typedef OdSmartPtr<IfcAxis2Placement2D> IfcAxis2Placement2DPtr;

} // namespace

#endif // _IFC2X3_IFCAXIS2PLACEMENT2D_AUTO_IMPL_H
