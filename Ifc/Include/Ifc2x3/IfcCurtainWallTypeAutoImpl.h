...
#ifndef _IFC2X3_IFCCURTAINWALLTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCCURTAINWALLTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCurtainWallType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCurtainWallType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCurtainWallType, IfcCurtainWallType> object.
*/
typedef OdSmartPtr<IfcCurtainWallType> IfcCurtainWallTypePtr;

} // namespace

#endif // _IFC2X3_IFCCURTAINWALLTYPE_AUTO_IMPL_H
