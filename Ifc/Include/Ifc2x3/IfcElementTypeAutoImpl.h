...
#ifndef _IFC2X3_IFCELEMENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCELEMENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcElementType : public IfcTypeProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcElementType, IfcElementType> object.
*/
typedef OdSmartPtr<IfcElementType> IfcElementTypePtr;

} // namespace

#endif // _IFC2X3_IFCELEMENTTYPE_AUTO_IMPL_H
