...
#ifndef _IFC2X3_IFCCONSTRUCTIONEQUIPMENTRESOURCE_AUTO_IMPL_H
#define _IFC2X3_IFCCONSTRUCTIONEQUIPMENTRESOURCE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcConstructionEquipmentResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcConstructionEquipmentResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcConstructionEquipmentResource, IfcConstructionEquipmentResource> object.
*/
typedef OdSmartPtr<IfcConstructionEquipmentResource> IfcConstructionEquipmentResourcePtr;

} // namespace

#endif // _IFC2X3_IFCCONSTRUCTIONEQUIPMENTRESOURCE_AUTO_IMPL_H
