...
#ifndef _IFC2X3_IFCFURNISHINGELEMENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCFURNISHINGELEMENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFurnishingElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFurnishingElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFurnishingElementType, IfcFurnishingElementType> object.
*/
typedef OdSmartPtr<IfcFurnishingElementType> IfcFurnishingElementTypePtr;

} // namespace

#endif // _IFC2X3_IFCFURNISHINGELEMENTTYPE_AUTO_IMPL_H
