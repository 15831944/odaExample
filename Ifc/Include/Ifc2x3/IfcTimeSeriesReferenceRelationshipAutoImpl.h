...
#ifndef _IFC2X3_IFCTIMESERIESREFERENCERELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCTIMESERIESREFERENCERELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcTimeSeriesReferenceRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTimeSeriesReferenceRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTimeSeriesReferenceRelationship, IfcTimeSeriesReferenceRelationship> object.
*/
typedef OdSmartPtr<IfcTimeSeriesReferenceRelationship> IfcTimeSeriesReferenceRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCTIMESERIESREFERENCERELATIONSHIP_AUTO_IMPL_H
