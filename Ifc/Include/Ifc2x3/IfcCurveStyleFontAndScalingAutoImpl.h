...
#ifndef _IFC2X3_IFCCURVESTYLEFONTANDSCALING_AUTO_IMPL_H
#define _IFC2X3_IFCCURVESTYLEFONTANDSCALING_AUTO_IMPL_H
...
*/
class IFC2X3_EXPORT IfcCurveStyleFontAndScaling : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCurveStyleFontAndScaling);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCurveStyleFontAndScaling, IfcCurveStyleFontAndScaling> object.
*/
typedef OdSmartPtr<IfcCurveStyleFontAndScaling> IfcCurveStyleFontAndScalingPtr;

} // namespace

#endif // _IFC2X3_IFCCURVESTYLEFONTANDSCALING_AUTO_IMPL_H
