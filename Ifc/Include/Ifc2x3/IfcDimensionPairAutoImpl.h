...
#ifndef _IFC2X3_IFCDIMENSIONPAIR_AUTO_IMPL_H
#define _IFC2X3_IFCDIMENSIONPAIR_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDimensionPair : public IfcDraughtingCalloutRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDimensionPair);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDimensionPair, IfcDimensionPair> object.
*/
typedef OdSmartPtr<IfcDimensionPair> IfcDimensionPairPtr;

} // namespace

#endif // _IFC2X3_IFCDIMENSIONPAIR_AUTO_IMPL_H
