...
#ifndef _IFC2X3_IFCAPPROVAL_AUTO_IMPL_H
#define _IFC2X3_IFCAPPROVAL_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcApproval : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcApproval);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcApproval, IfcApproval> object.
*/
typedef OdSmartPtr<IfcApproval> IfcApprovalPtr;

} // namespace

#endif // _IFC2X3_IFCAPPROVAL_AUTO_IMPL_H
