...
#ifndef _IFC2X3_IFCPROPERTYREFERENCEVALUE_AUTO_IMPL_H
#define _IFC2X3_IFCPROPERTYREFERENCEVALUE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPropertyReferenceValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPropertyReferenceValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPropertyReferenceValue, IfcPropertyReferenceValue> object.
*/
typedef OdSmartPtr<IfcPropertyReferenceValue> IfcPropertyReferenceValuePtr;

} // namespace

#endif // _IFC2X3_IFCPROPERTYREFERENCEVALUE_AUTO_IMPL_H
