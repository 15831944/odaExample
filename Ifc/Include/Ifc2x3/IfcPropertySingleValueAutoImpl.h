...
#ifndef _IFC2X3_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
#define _IFC2X3_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPropertySingleValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPropertySingleValue, IfcPropertySingleValue> object.
*/
typedef OdSmartPtr<IfcPropertySingleValue> IfcPropertySingleValuePtr;

} // namespace

#endif // _IFC2X3_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
