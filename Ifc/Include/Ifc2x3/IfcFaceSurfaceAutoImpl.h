...
#ifndef _IFC2X3_IFCFACESURFACE_AUTO_IMPL_H
#define _IFC2X3_IFCFACESURFACE_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFaceSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFaceSurface, IfcFaceSurface> object.
*/
typedef OdSmartPtr<IfcFaceSurface> IfcFaceSurfacePtr;

} // namespace

#endif // _IFC2X3_IFCFACESURFACE_AUTO_IMPL_H
