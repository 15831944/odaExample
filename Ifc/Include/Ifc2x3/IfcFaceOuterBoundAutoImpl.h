...
#ifndef _IFC2X3_IFCFACEOUTERBOUND_AUTO_IMPL_H
#define _IFC2X3_IFCFACEOUTERBOUND_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFaceOuterBound : public IfcFaceBound
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFaceOuterBound);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFaceOuterBound, IfcFaceOuterBound> object.
*/
typedef OdSmartPtr<IfcFaceOuterBound> IfcFaceOuterBoundPtr;

} // namespace

#endif // _IFC2X3_IFCFACEOUTERBOUND_AUTO_IMPL_H
