...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcProductsOfCombustionProperties, IfcProductsOfCombustionProperties> object.
*/
typedef OdSmartPtr<IfcProductsOfCombustionProperties> IfcProductsOfCombustionPropertiesPtr;

} // namespace

#endif // _IFC2X3_IFCPRODUCTSOFCOMBUSTIONPROPERTIES_AUTO_IMPL_H
