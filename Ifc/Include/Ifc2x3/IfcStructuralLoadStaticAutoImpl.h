...
#ifndef _IFC2X3_IFCSTRUCTURALLOADSTATIC_AUTO_IMPL_H
#define _IFC2X3_IFCSTRUCTURALLOADSTATIC_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcStructuralLoadStatic : public IfcStructuralLoad
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcStructuralLoadStatic);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcStructuralLoadStatic, IfcStructuralLoadStatic> object.
*/
typedef OdSmartPtr<IfcStructuralLoadStatic> IfcStructuralLoadStaticPtr;

} // namespace

#endif // _IFC2X3_IFCSTRUCTURALLOADSTATIC_AUTO_IMPL_H
