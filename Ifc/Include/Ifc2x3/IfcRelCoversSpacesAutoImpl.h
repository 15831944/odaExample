...
#ifndef _IFC2X3_IFCRELCOVERSSPACES_AUTO_IMPL_H
#define _IFC2X3_IFCRELCOVERSSPACES_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRelCoversSpaces);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatedSpace() const;
  void setRelatedSpace(const OdDAIObjectId& RelatedSpace);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatedSpace;   // IfcSpace
  OdDAI::OdDAIObjectIdSet m_RelatedCoverings; // SET [1:?] of IfcCovering
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelCoversSpaces, IfcRelCoversSpaces> object.
*/
typedef OdSmartPtr<IfcRelCoversSpaces> IfcRelCoversSpacesPtr;

} // namespace

#endif // _IFC2X3_IFCRELCOVERSSPACES_AUTO_IMPL_H
