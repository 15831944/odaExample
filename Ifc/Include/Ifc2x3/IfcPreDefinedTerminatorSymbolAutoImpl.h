...
#ifndef _IFC2X3_IFCPREDEFINEDTERMINATORSYMBOL_AUTO_IMPL_H
#define _IFC2X3_IFCPREDEFINEDTERMINATORSYMBOL_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPreDefinedTerminatorSymbol : public IfcPreDefinedSymbol
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPreDefinedTerminatorSymbol);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPreDefinedTerminatorSymbol, IfcPreDefinedTerminatorSymbol> object.
*/
typedef OdSmartPtr<IfcPreDefinedTerminatorSymbol> IfcPreDefinedTerminatorSymbolPtr;

} // namespace

#endif // _IFC2X3_IFCPREDEFINEDTERMINATORSYMBOL_AUTO_IMPL_H
