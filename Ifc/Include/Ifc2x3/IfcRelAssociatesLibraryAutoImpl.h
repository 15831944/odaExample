...
#ifndef _IFC2X3_IFCRELASSOCIATESLIBRARY_AUTO_IMPL_H
#define _IFC2X3_IFCRELASSOCIATESLIBRARY_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRelAssociatesLibrary : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRelAssociatesLibrary);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelAssociatesLibrary, IfcRelAssociatesLibrary> object.
*/
typedef OdSmartPtr<IfcRelAssociatesLibrary> IfcRelAssociatesLibraryPtr;

} // namespace

#endif // _IFC2X3_IFCRELASSOCIATESLIBRARY_AUTO_IMPL_H
