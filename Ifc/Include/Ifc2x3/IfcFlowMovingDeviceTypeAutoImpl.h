...
#ifndef _IFC2X3_IFCFLOWMOVINGDEVICETYPE_AUTO_IMPL_H
#define _IFC2X3_IFCFLOWMOVINGDEVICETYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFlowMovingDeviceType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcFlowMovingDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFlowMovingDeviceType, IfcFlowMovingDeviceType> object.
*/
typedef OdSmartPtr<IfcFlowMovingDeviceType> IfcFlowMovingDeviceTypePtr;

} // namespace

#endif // _IFC2X3_IFCFLOWMOVINGDEVICETYPE_AUTO_IMPL_H
