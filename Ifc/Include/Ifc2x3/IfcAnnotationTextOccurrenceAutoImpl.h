...
#ifndef _IFC2X3_IFCANNOTATIONTEXTOCCURRENCE_AUTO_IMPL_H
#define _IFC2X3_IFCANNOTATIONTEXTOCCURRENCE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcAnnotationTextOccurrence : public IfcAnnotationOccurrence
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcAnnotationTextOccurrence);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcAnnotationTextOccurrence, IfcAnnotationTextOccurrence> object.
*/
typedef OdSmartPtr<IfcAnnotationTextOccurrence> IfcAnnotationTextOccurrencePtr;

} // namespace

#endif // _IFC2X3_IFCANNOTATIONTEXTOCCURRENCE_AUTO_IMPL_H
