...
#ifndef _IFC2X3_IFCIRREGULARTIMESERIES_AUTO_IMPL_H
#define _IFC2X3_IFCIRREGULARTIMESERIES_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcIrregularTimeSeries : public IfcTimeSeries
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcIrregularTimeSeries);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcIrregularTimeSeries, IfcIrregularTimeSeries> object.
*/
typedef OdSmartPtr<IfcIrregularTimeSeries> IfcIrregularTimeSeriesPtr;

} // namespace

#endif // _IFC2X3_IFCIRREGULARTIMESERIES_AUTO_IMPL_H
