...
#ifndef _IFC2X3_IFCOUTLETTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCOUTLETTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcOutletType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcOutletType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcOutletType, IfcOutletType> object.
*/
typedef OdSmartPtr<IfcOutletType> IfcOutletTypePtr;

} // namespace

#endif // _IFC2X3_IFCOUTLETTYPE_AUTO_IMPL_H
