...
#ifndef _IFC2X3_IFCEXTERNALREFERENCE_AUTO_IMPL_H
#define _IFC2X3_IFCEXTERNALREFERENCE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcExternalReference : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcExternalReference);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcExternalReference, IfcExternalReference> object.
*/
typedef OdSmartPtr<IfcExternalReference> IfcExternalReferencePtr;

} // namespace

#endif // _IFC2X3_IFCEXTERNALREFERENCE_AUTO_IMPL_H
