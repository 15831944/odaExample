...
#ifndef _IFC2X3_IFCPIPESEGMENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCPIPESEGMENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPipeSegmentType : public IfcFlowSegmentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPipeSegmentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPipeSegmentType, IfcPipeSegmentType> object.
*/
typedef OdSmartPtr<IfcPipeSegmentType> IfcPipeSegmentTypePtr;

} // namespace

#endif // _IFC2X3_IFCPIPESEGMENTTYPE_AUTO_IMPL_H
