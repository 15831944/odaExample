...
#ifndef _IFC2X3_IFCCSGSOLID_AUTO_IMPL_H
#define _IFC2X3_IFCCSGSOLID_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcCsgSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcCsgSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcCsgSolid, IfcCsgSolid> object.
*/
typedef OdSmartPtr<IfcCsgSolid> IfcCsgSolidPtr;

} // namespace

#endif // _IFC2X3_IFCCSGSOLID_AUTO_IMPL_H
