...
#ifndef _IFC2X3_IFCRESOURCE_AUTO_IMPL_H
#define _IFC2X3_IFCRESOURCE_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcResource, IfcResource> object.
*/
typedef OdSmartPtr<IfcResource> IfcResourcePtr;

} // namespace

#endif // _IFC2X3_IFCRESOURCE_AUTO_IMPL_H
