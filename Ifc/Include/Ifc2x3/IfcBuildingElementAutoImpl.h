...
#ifndef _IFC2X3_IFCBUILDINGELEMENT_AUTO_IMPL_H
#define _IFC2X3_IFCBUILDINGELEMENT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcBuildingElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcBuildingElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcBuildingElement, IfcBuildingElement> object.
*/
typedef OdSmartPtr<IfcBuildingElement> IfcBuildingElementPtr;

} // namespace

#endif // _IFC2X3_IFCBUILDINGELEMENT_AUTO_IMPL_H
