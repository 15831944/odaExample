...
#ifndef _IFC2X3_IFCWORKSCHEDULE_AUTO_IMPL_H
#define _IFC2X3_IFCWORKSCHEDULE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcWorkSchedule : public IfcWorkControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcWorkSchedule);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcWorkSchedule, IfcWorkSchedule> object.
*/
typedef OdSmartPtr<IfcWorkSchedule> IfcWorkSchedulePtr;

} // namespace

#endif // _IFC2X3_IFCWORKSCHEDULE_AUTO_IMPL_H
