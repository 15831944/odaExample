...
#ifndef _IFC2X3_IFCRELSCHEDULESCOSTITEMS_AUTO_IMPL_H
#define _IFC2X3_IFCRELSCHEDULESCOSTITEMS_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRelSchedulesCostItems : public IfcRelAssignsToControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRelSchedulesCostItems);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelSchedulesCostItems, IfcRelSchedulesCostItems> object.
*/
typedef OdSmartPtr<IfcRelSchedulesCostItems> IfcRelSchedulesCostItemsPtr;

} // namespace

#endif // _IFC2X3_IFCRELSCHEDULESCOSTITEMS_AUTO_IMPL_H
