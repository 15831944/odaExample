...
#ifndef _IFC2X3_IFCELEMENTCOMPONENT_AUTO_IMPL_H
#define _IFC2X3_IFCELEMENTCOMPONENT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcElementComponent : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcElementComponent);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcElementComponent, IfcElementComponent> object.
*/
typedef OdSmartPtr<IfcElementComponent> IfcElementComponentPtr;

} // namespace

#endif // _IFC2X3_IFCELEMENTCOMPONENT_AUTO_IMPL_H
