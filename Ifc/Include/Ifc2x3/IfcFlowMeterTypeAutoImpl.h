...
#ifndef _IFC2X3_IFCFLOWMETERTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCFLOWMETERTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFlowMeterType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFlowMeterType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFlowMeterType, IfcFlowMeterType> object.
*/
typedef OdSmartPtr<IfcFlowMeterType> IfcFlowMeterTypePtr;

} // namespace

#endif // _IFC2X3_IFCFLOWMETERTYPE_AUTO_IMPL_H
