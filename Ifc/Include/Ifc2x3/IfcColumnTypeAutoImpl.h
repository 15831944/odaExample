...
#ifndef _IFC2X3_IFCCOLUMNTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCCOLUMNTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcColumnType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcColumnType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcColumnType, IfcColumnType> object.
*/
typedef OdSmartPtr<IfcColumnType> IfcColumnTypePtr;

} // namespace

#endif // _IFC2X3_IFCCOLUMNTYPE_AUTO_IMPL_H
