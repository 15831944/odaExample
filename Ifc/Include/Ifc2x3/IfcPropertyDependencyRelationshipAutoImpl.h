...
#ifndef _IFC2X3_IFCPROPERTYDEPENDENCYRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCPROPERTYDEPENDENCYRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPropertyDependencyRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcPropertyDependencyRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPropertyDependencyRelationship, IfcPropertyDependencyRelationship> object.
*/
typedef OdSmartPtr<IfcPropertyDependencyRelationship> IfcPropertyDependencyRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCPROPERTYDEPENDENCYRELATIONSHIP_AUTO_IMPL_H
