...
#ifndef _IFC2X3_IFCSTACKTERMINALTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCSTACKTERMINALTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcStackTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcStackTerminalType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcStackTerminalType, IfcStackTerminalType> object.
*/
typedef OdSmartPtr<IfcStackTerminalType> IfcStackTerminalTypePtr;

} // namespace

#endif // _IFC2X3_IFCSTACKTERMINALTYPE_AUTO_IMPL_H
