...
#ifndef _IFC2X3_IFCSHAPEASPECT_AUTO_IMPL_H
#define _IFC2X3_IFCSHAPEASPECT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcShapeAspect : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcShapeAspect);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcShapeAspect, IfcShapeAspect> object.
*/
typedef OdSmartPtr<IfcShapeAspect> IfcShapeAspectPtr;

} // namespace

#endif // _IFC2X3_IFCSHAPEASPECT_AUTO_IMPL_H
