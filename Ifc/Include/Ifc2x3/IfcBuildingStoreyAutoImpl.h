...
#ifndef _IFC2X3_IFCBUILDINGSTOREY_AUTO_IMPL_H
#define _IFC2X3_IFCBUILDINGSTOREY_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcBuildingStorey : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcBuildingStorey);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcBuildingStorey, IfcBuildingStorey> object.
*/
typedef OdSmartPtr<IfcBuildingStorey> IfcBuildingStoreyPtr;

} // namespace

#endif // _IFC2X3_IFCBUILDINGSTOREY_AUTO_IMPL_H
