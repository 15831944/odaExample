...
#ifndef _IFC2X3_IFCRELAXATION_AUTO_IMPL_H
#define _IFC2X3_IFCRELAXATION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRelaxation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRelaxation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelaxation, IfcRelaxation> object.
*/
typedef OdSmartPtr<IfcRelaxation> IfcRelaxationPtr;

} // namespace

#endif // _IFC2X3_IFCRELAXATION_AUTO_IMPL_H
