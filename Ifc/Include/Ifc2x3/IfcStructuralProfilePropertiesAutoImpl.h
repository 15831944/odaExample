...
#ifndef _IFC2X3_IFCSTRUCTURALPROFILEPROPERTIES_AUTO_IMPL_H
#define _IFC2X3_IFCSTRUCTURALPROFILEPROPERTIES_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcStructuralProfileProperties);
  //DOM-IGNORE-END
...
protected:
  ...
  double m_CentreOfGravityInX;   // IfcLengthMeasure  [optional]
  double m_CentreOfGravityInY;   // IfcLengthMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcStructuralProfileProperties, IfcStructuralProfileProperties> object.
*/
typedef OdSmartPtr<IfcStructuralProfileProperties> IfcStructuralProfilePropertiesPtr;

} // namespace

#endif // _IFC2X3_IFCSTRUCTURALPROFILEPROPERTIES_AUTO_IMPL_H
