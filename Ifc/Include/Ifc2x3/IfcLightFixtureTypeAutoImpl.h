...
#ifndef _IFC2X3_IFCLIGHTFIXTURETYPE_AUTO_IMPL_H
#define _IFC2X3_IFCLIGHTFIXTURETYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcLightFixtureType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcLightFixtureType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcLightFixtureType, IfcLightFixtureType> object.
*/
typedef OdSmartPtr<IfcLightFixtureType> IfcLightFixtureTypePtr;

} // namespace

#endif // _IFC2X3_IFCLIGHTFIXTURETYPE_AUTO_IMPL_H
