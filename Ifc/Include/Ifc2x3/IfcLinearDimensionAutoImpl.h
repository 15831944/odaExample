...
#ifndef _IFC2X3_IFCLINEARDIMENSION_AUTO_IMPL_H
#define _IFC2X3_IFCLINEARDIMENSION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcLinearDimension : public IfcDimensionCurveDirectedCallout
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcLinearDimension);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcLinearDimension, IfcLinearDimension> object.
*/
typedef OdSmartPtr<IfcLinearDimension> IfcLinearDimensionPtr;

} // namespace

#endif // _IFC2X3_IFCLINEARDIMENSION_AUTO_IMPL_H
