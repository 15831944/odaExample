...
#ifndef _IFC2X3_IFCRIGHTCIRCULARCONE_AUTO_IMPL_H
#define _IFC2X3_IFCRIGHTCIRCULARCONE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRightCircularCone : public IfcCsgPrimitive3D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRightCircularCone);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRightCircularCone, IfcRightCircularCone> object.
*/
typedef OdSmartPtr<IfcRightCircularCone> IfcRightCircularConePtr;

} // namespace

#endif // _IFC2X3_IFCRIGHTCIRCULARCONE_AUTO_IMPL_H
