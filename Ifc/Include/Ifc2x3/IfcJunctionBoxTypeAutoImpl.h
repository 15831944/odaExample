...
#ifndef _IFC2X3_IFCJUNCTIONBOXTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCJUNCTIONBOXTYPE_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcJunctionBoxType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcJunctionBoxType, IfcJunctionBoxType> object.
*/
typedef OdSmartPtr<IfcJunctionBoxType> IfcJunctionBoxTypePtr;

} // namespace

#endif // _IFC2X3_IFCJUNCTIONBOXTYPE_AUTO_IMPL_H
