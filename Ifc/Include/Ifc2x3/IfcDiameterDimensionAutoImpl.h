...
#ifndef _IFC2X3_IFCDIAMETERDIMENSION_AUTO_IMPL_H
#define _IFC2X3_IFCDIAMETERDIMENSION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDiameterDimension : public IfcDimensionCurveDirectedCallout
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDiameterDimension);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDiameterDimension, IfcDiameterDimension> object.
*/
typedef OdSmartPtr<IfcDiameterDimension> IfcDiameterDimensionPtr;

} // namespace

#endif // _IFC2X3_IFCDIAMETERDIMENSION_AUTO_IMPL_H
