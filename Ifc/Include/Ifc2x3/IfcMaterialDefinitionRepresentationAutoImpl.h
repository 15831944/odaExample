...
#ifndef _IFC2X3_IFCMATERIALDEFINITIONREPRESENTATION_AUTO_IMPL_H
#define _IFC2X3_IFCMATERIALDEFINITIONREPRESENTATION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcMaterialDefinitionRepresentation : public IfcProductRepresentation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcMaterialDefinitionRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcMaterialDefinitionRepresentation, IfcMaterialDefinitionRepresentation> object.
*/
typedef OdSmartPtr<IfcMaterialDefinitionRepresentation> IfcMaterialDefinitionRepresentationPtr;

} // namespace

#endif // _IFC2X3_IFCMATERIALDEFINITIONREPRESENTATION_AUTO_IMPL_H
