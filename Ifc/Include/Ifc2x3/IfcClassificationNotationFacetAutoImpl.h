...
#ifndef _IFC2X3_IFCCLASSIFICATIONNOTATIONFACET_AUTO_IMPL_H
#define _IFC2X3_IFCCLASSIFICATIONNOTATIONFACET_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcClassificationNotationFacet : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcClassificationNotationFacet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcClassificationNotationFacet, IfcClassificationNotationFacet> object.
*/
typedef OdSmartPtr<IfcClassificationNotationFacet> IfcClassificationNotationFacetPtr;

} // namespace

#endif // _IFC2X3_IFCCLASSIFICATIONNOTATIONFACET_AUTO_IMPL_H
