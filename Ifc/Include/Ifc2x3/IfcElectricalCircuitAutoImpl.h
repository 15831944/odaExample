...
#ifndef _IFC2X3_IFCELECTRICALCIRCUIT_AUTO_IMPL_H
#define _IFC2X3_IFCELECTRICALCIRCUIT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcElectricalCircuit : public IfcSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcElectricalCircuit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcElectricalCircuit, IfcElectricalCircuit> object.
*/
typedef OdSmartPtr<IfcElectricalCircuit> IfcElectricalCircuitPtr;

} // namespace

#endif // _IFC2X3_IFCELECTRICALCIRCUIT_AUTO_IMPL_H
