...
#ifndef _IFC2X3_IFCVERTEXBASEDTEXTUREMAP_AUTO_IMPL_H
#define _IFC2X3_IFCVERTEXBASEDTEXTUREMAP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcVertexBasedTextureMap : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcVertexBasedTextureMap);
  //DOM-IGNORE-END
...
public:
  ...
  void getTexturePoints(OdDAIObjectIds& TexturePoints) const;
  OdDAI::OdDAIObjectIdList& texturePoints();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_TextureVertices; // LIST [3:?] of IfcTextureVertex
  OdDAI::OdDAIObjectIdList m_TexturePoints; // LIST [3:?] of IfcCartesianPoint
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcVertexBasedTextureMap, IfcVertexBasedTextureMap> object.
*/
typedef OdSmartPtr<IfcVertexBasedTextureMap> IfcVertexBasedTextureMapPtr;

} // namespace

#endif // _IFC2X3_IFCVERTEXBASEDTEXTUREMAP_AUTO_IMPL_H
