...
#ifndef _IFC2X3_IFCLOCALTIME_AUTO_IMPL_H
#define _IFC2X3_IFCLOCALTIME_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcLocalTime : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcLocalTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcLocalTime, IfcLocalTime> object.
*/
typedef OdSmartPtr<IfcLocalTime> IfcLocalTimePtr;

} // namespace

#endif // _IFC2X3_IFCLOCALTIME_AUTO_IMPL_H
