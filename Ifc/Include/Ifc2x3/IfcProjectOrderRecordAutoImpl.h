...
#ifndef _IFC2X3_IFCPROJECTORDERRECORD_AUTO_IMPL_H
#define _IFC2X3_IFCPROJECTORDERRECORD_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcProjectOrderRecord : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcProjectOrderRecord);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcProjectOrderRecord, IfcProjectOrderRecord> object.
*/
typedef OdSmartPtr<IfcProjectOrderRecord> IfcProjectOrderRecordPtr;

} // namespace

#endif // _IFC2X3_IFCPROJECTORDERRECORD_AUTO_IMPL_H
