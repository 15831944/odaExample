...
#ifndef _IFC2X3_IFCGEOMETRICCURVESET_AUTO_IMPL_H
#define _IFC2X3_IFCGEOMETRICCURVESET_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcGeometricCurveSet : public IfcGeometricSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcGeometricCurveSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcGeometricCurveSet, IfcGeometricCurveSet> object.
*/
typedef OdSmartPtr<IfcGeometricCurveSet> IfcGeometricCurveSetPtr;

} // namespace

#endif // _IFC2X3_IFCGEOMETRICCURVESET_AUTO_IMPL_H
