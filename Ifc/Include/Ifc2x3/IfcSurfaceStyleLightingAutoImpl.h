...
#ifndef _IFC2X3_IFCSURFACESTYLELIGHTING_AUTO_IMPL_H
#define _IFC2X3_IFCSURFACESTYLELIGHTING_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcSurfaceStyleLighting : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcSurfaceStyleLighting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSurfaceStyleLighting, IfcSurfaceStyleLighting> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleLighting> IfcSurfaceStyleLightingPtr;

} // namespace

#endif // _IFC2X3_IFCSURFACESTYLELIGHTING_AUTO_IMPL_H
