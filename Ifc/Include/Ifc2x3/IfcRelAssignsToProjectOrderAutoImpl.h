...
#ifndef _IFC2X3_IFCRELASSIGNSTOPROJECTORDER_AUTO_IMPL_H
#define _IFC2X3_IFCRELASSIGNSTOPROJECTORDER_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcRelAssignsToProjectOrder : public IfcRelAssignsToControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRelAssignsToProjectOrder);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelAssignsToProjectOrder, IfcRelAssignsToProjectOrder> object.
*/
typedef OdSmartPtr<IfcRelAssignsToProjectOrder> IfcRelAssignsToProjectOrderPtr;

} // namespace

#endif // _IFC2X3_IFCRELASSIGNSTOPROJECTORDER_AUTO_IMPL_H
