...
#ifndef _IFC2X3_IFCARBITRARYCLOSEDPROFILEDEF_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcArbitraryClosedProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcArbitraryClosedProfileDef, IfcArbitraryClosedProfileDef> object.
*/
typedef OdSmartPtr<IfcArbitraryClosedProfileDef> IfcArbitraryClosedProfileDefPtr;

} // namespace

#endif // _IFC2X3_IFCARBITRARYCLOSEDPROFILEDEF_AUTO_IMPL_H
