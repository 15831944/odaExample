...
#ifndef _IFC2X3_IFCFILTERTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCFILTERTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFilterType : public IfcFlowTreatmentDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFilterType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFilterType, IfcFilterType> object.
*/
typedef OdSmartPtr<IfcFilterType> IfcFilterTypePtr;

} // namespace

#endif // _IFC2X3_IFCFILTERTYPE_AUTO_IMPL_H
