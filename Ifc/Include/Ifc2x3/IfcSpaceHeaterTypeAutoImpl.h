...
#ifndef _IFC2X3_IFCSPACEHEATERTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCSPACEHEATERTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcSpaceHeaterType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcSpaceHeaterType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcSpaceHeaterType, IfcSpaceHeaterType> object.
*/
typedef OdSmartPtr<IfcSpaceHeaterType> IfcSpaceHeaterTypePtr;

} // namespace

#endif // _IFC2X3_IFCSPACEHEATERTYPE_AUTO_IMPL_H
