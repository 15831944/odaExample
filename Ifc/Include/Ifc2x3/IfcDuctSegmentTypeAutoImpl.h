...
#ifndef _IFC2X3_IFCDUCTSEGMENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCDUCTSEGMENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcDuctSegmentType : public IfcFlowSegmentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcDuctSegmentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcDuctSegmentType, IfcDuctSegmentType> object.
*/
typedef OdSmartPtr<IfcDuctSegmentType> IfcDuctSegmentTypePtr;

} // namespace

#endif // _IFC2X3_IFCDUCTSEGMENTTYPE_AUTO_IMPL_H
