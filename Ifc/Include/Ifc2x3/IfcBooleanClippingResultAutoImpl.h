...
#ifndef _IFC2X3_IFCBOOLEANCLIPPINGRESULT_AUTO_IMPL_H
#define _IFC2X3_IFCBOOLEANCLIPPINGRESULT_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcBooleanClippingResult : public IfcBooleanResult
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcBooleanClippingResult);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcBooleanClippingResult, IfcBooleanClippingResult> object.
*/
typedef OdSmartPtr<IfcBooleanClippingResult> IfcBooleanClippingResultPtr;

} // namespace

#endif // _IFC2X3_IFCBOOLEANCLIPPINGRESULT_AUTO_IMPL_H
