...
#ifndef _IFC2X3_IFCRELASSIGNSTASKS_AUTO_IMPL_H
#define _IFC2X3_IFCRELASSIGNSTASKS_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRelAssignsTasks);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelAssignsTasks, IfcRelAssignsTasks> object.
*/
typedef OdSmartPtr<IfcRelAssignsTasks> IfcRelAssignsTasksPtr;

} // namespace

#endif // _IFC2X3_IFCRELASSIGNSTASKS_AUTO_IMPL_H
