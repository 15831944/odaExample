...
#ifndef _IFC2X3_IFCANNOTATIONSYMBOLOCCURRENCE_AUTO_IMPL_H
#define _IFC2X3_IFCANNOTATIONSYMBOLOCCURRENCE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcAnnotationSymbolOccurrence : public IfcAnnotationOccurrence
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcAnnotationSymbolOccurrence);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcAnnotationSymbolOccurrence, IfcAnnotationSymbolOccurrence> object.
*/
typedef OdSmartPtr<IfcAnnotationSymbolOccurrence> IfcAnnotationSymbolOccurrencePtr;

} // namespace

#endif // _IFC2X3_IFCANNOTATIONSYMBOLOCCURRENCE_AUTO_IMPL_H
