...
#ifndef _IFC2X3_IFCTOPOLOGICALREPRESENTATIONITEM_AUTO_IMPL_H
#define _IFC2X3_IFCTOPOLOGICALREPRESENTATIONITEM_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcTopologicalRepresentationItem : public IfcRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcTopologicalRepresentationItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTopologicalRepresentationItem, IfcTopologicalRepresentationItem> object.
*/
typedef OdSmartPtr<IfcTopologicalRepresentationItem> IfcTopologicalRepresentationItemPtr;

} // namespace

#endif // _IFC2X3_IFCTOPOLOGICALREPRESENTATIONITEM_AUTO_IMPL_H
