...
#ifndef _IFC2X3_IFCFLOWFITTING_AUTO_IMPL_H
#define _IFC2X3_IFCFLOWFITTING_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFlowFitting : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFlowFitting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFlowFitting, IfcFlowFitting> object.
*/
typedef OdSmartPtr<IfcFlowFitting> IfcFlowFittingPtr;

} // namespace

#endif // _IFC2X3_IFCFLOWFITTING_AUTO_IMPL_H
