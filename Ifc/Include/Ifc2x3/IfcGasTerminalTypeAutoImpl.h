...
#ifndef _IFC2X3_IFCGASTERMINALTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCGASTERMINALTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcGasTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcGasTerminalType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcGasTerminalType, IfcGasTerminalType> object.
*/
typedef OdSmartPtr<IfcGasTerminalType> IfcGasTerminalTypePtr;

} // namespace

#endif // _IFC2X3_IFCGASTERMINALTYPE_AUTO_IMPL_H
