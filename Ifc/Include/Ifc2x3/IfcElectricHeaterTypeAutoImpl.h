...
#ifndef _IFC2X3_IFCELECTRICHEATERTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCELECTRICHEATERTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcElectricHeaterType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcElectricHeaterType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcElectricHeaterType, IfcElectricHeaterType> object.
*/
typedef OdSmartPtr<IfcElectricHeaterType> IfcElectricHeaterTypePtr;

} // namespace

#endif // _IFC2X3_IFCELECTRICHEATERTYPE_AUTO_IMPL_H
