...
#ifndef _IFC2X3_IFCZONE_AUTO_IMPL_H
#define _IFC2X3_IFCZONE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcZone : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcZone);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcZone, IfcZone> object.
*/
typedef OdSmartPtr<IfcZone> IfcZonePtr;

} // namespace

#endif // _IFC2X3_IFCZONE_AUTO_IMPL_H
