...
#ifndef _IFC2X3_IFCACTUATORTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCACTUATORTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcActuatorType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcActuatorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcActuatorType, IfcActuatorType> object.
*/
typedef OdSmartPtr<IfcActuatorType> IfcActuatorTypePtr;

} // namespace

#endif // _IFC2X3_IFCACTUATORTYPE_AUTO_IMPL_H
