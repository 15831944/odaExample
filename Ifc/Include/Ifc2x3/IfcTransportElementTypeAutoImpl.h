...
#ifndef _IFC2X3_IFCTRANSPORTELEMENTTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCTRANSPORTELEMENTTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcTransportElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcTransportElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcTransportElementType, IfcTransportElementType> object.
*/
typedef OdSmartPtr<IfcTransportElementType> IfcTransportElementTypePtr;

} // namespace

#endif // _IFC2X3_IFCTRANSPORTELEMENTTYPE_AUTO_IMPL_H
