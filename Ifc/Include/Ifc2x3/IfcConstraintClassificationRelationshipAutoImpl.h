...
#ifndef _IFC2X3_IFCCONSTRAINTCLASSIFICATIONRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X3_IFCCONSTRAINTCLASSIFICATIONRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcConstraintClassificationRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcConstraintClassificationRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcConstraintClassificationRelationship, IfcConstraintClassificationRelationship> object.
*/
typedef OdSmartPtr<IfcConstraintClassificationRelationship> IfcConstraintClassificationRelationshipPtr;

} // namespace

#endif // _IFC2X3_IFCCONSTRAINTCLASSIFICATIONRELATIONSHIP_AUTO_IMPL_H
