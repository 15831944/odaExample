...
#ifndef _IFC2X3_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
#define _IFC2X3_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
...
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcRelServicesBuildings);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcRelServicesBuildings, IfcRelServicesBuildings> object.
*/
typedef OdSmartPtr<IfcRelServicesBuildings> IfcRelServicesBuildingsPtr;

} // namespace

#endif // _IFC2X3_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
