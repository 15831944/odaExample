...
#ifndef _IFC2X3_IFCMATERIALLAYERSETUSAGE_AUTO_IMPL_H
#define _IFC2X3_IFCMATERIALLAYERSETUSAGE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcMaterialLayerSetUsage : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcMaterialLayerSetUsage);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcMaterialLayerSetUsage, IfcMaterialLayerSetUsage> object.
*/
typedef OdSmartPtr<IfcMaterialLayerSetUsage> IfcMaterialLayerSetUsagePtr;

} // namespace

#endif // _IFC2X3_IFCMATERIALLAYERSETUSAGE_AUTO_IMPL_H
