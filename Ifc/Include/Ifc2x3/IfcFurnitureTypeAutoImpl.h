...
#ifndef _IFC2X3_IFCFURNITURETYPE_AUTO_IMPL_H
#define _IFC2X3_IFCFURNITURETYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFurnitureType : public IfcFurnishingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFurnitureType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFurnitureType, IfcFurnitureType> object.
*/
typedef OdSmartPtr<IfcFurnitureType> IfcFurnitureTypePtr;

} // namespace

#endif // _IFC2X3_IFCFURNITURETYPE_AUTO_IMPL_H
