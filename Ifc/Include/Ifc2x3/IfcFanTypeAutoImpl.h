...
#ifndef _IFC2X3_IFCFANTYPE_AUTO_IMPL_H
#define _IFC2X3_IFCFANTYPE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcFanType : public IfcFlowMovingDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcFanType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcFanType, IfcFanType> object.
*/
typedef OdSmartPtr<IfcFanType> IfcFanTypePtr;

} // namespace

#endif // _IFC2X3_IFCFANTYPE_AUTO_IMPL_H
