...
#ifndef _IFC2X3_IFCSTRUCTURALCURVECONNECTION_AUTO_IMPL_H
#define _IFC2X3_IFCSTRUCTURALCURVECONNECTION_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcStructuralCurveConnection : public IfcStructuralConnection
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x3::IfcStructuralCurveConnection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcStructuralCurveConnection, IfcStructuralCurveConnection> object.
*/
typedef OdSmartPtr<IfcStructuralCurveConnection> IfcStructuralCurveConnectionPtr;

} // namespace

#endif // _IFC2X3_IFCSTRUCTURALCURVECONNECTION_AUTO_IMPL_H
