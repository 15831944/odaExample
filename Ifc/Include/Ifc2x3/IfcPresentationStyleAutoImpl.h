...
#ifndef _IFC2X3_IFCPRESENTATIONSTYLE_AUTO_IMPL_H
#define _IFC2X3_IFCPRESENTATIONSTYLE_AUTO_IMPL_H
...
class IFC2X3_EXPORT IfcPresentationStyle : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x3::IfcPresentationStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x3::IfcPresentationStyle, IfcPresentationStyle> object.
*/
typedef OdSmartPtr<IfcPresentationStyle> IfcPresentationStylePtr;

} // namespace

#endif // _IFC2X3_IFCPRESENTATIONSTYLE_AUTO_IMPL_H
