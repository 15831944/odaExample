...
#ifndef _IFC4X2_IFCMONETARYUNIT_AUTO_IMPL_H
#define _IFC4X2_IFCMONETARYUNIT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcMonetaryUnit : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcMonetaryUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcMonetaryUnit, IfcMonetaryUnit> object.
*/
typedef OdSmartPtr<IfcMonetaryUnit> IfcMonetaryUnitPtr;

} // namespace

#endif // _IFC4X2_IFCMONETARYUNIT_AUTO_IMPL_H
