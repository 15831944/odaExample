...
#ifndef _IFC4X2_IFCSTRUCTURALANALYSISMODEL_AUTO_IMPL_H
#define _IFC4X2_IFCSTRUCTURALANALYSISMODEL_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcStructuralAnalysisModel : public IfcSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcStructuralAnalysisModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcStructuralAnalysisModel, IfcStructuralAnalysisModel> object.
*/
typedef OdSmartPtr<IfcStructuralAnalysisModel> IfcStructuralAnalysisModelPtr;

} // namespace

#endif // _IFC4X2_IFCSTRUCTURALANALYSISMODEL_AUTO_IMPL_H
