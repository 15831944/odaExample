...
#ifndef _IFC4X2_IFCPARAMETERIZEDPROFILEDEF_AUTO_IMPL_H
#define _IFC4X2_IFCPARAMETERIZEDPROFILEDEF_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcParameterizedProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcParameterizedProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcParameterizedProfileDef, IfcParameterizedProfileDef> object.
*/
typedef OdSmartPtr<IfcParameterizedProfileDef> IfcParameterizedProfileDefPtr;

} // namespace

#endif // _IFC4X2_IFCPARAMETERIZEDPROFILEDEF_AUTO_IMPL_H
