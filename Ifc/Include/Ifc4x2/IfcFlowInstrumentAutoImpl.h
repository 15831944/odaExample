...
#ifndef _IFC4X2_IFCFLOWINSTRUMENT_AUTO_IMPL_H
#define _IFC4X2_IFCFLOWINSTRUMENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcFlowInstrument : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcFlowInstrument);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcFlowInstrument, IfcFlowInstrument> object.
*/
typedef OdSmartPtr<IfcFlowInstrument> IfcFlowInstrumentPtr;

} // namespace

#endif // _IFC4X2_IFCFLOWINSTRUMENT_AUTO_IMPL_H
