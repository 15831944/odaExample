...
#ifndef _IFC4X2_IFCSITE_AUTO_IMPL_H
#define _IFC4X2_IFCSITE_AUTO_IMPL_H
...
*/
class IFC4X2_EXPORT IfcSite : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSite);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSite, IfcSite> object.
*/
typedef OdSmartPtr<IfcSite> IfcSitePtr;

} // namespace

#endif // _IFC4X2_IFCSITE_AUTO_IMPL_H
