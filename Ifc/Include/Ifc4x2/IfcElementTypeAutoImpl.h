...
#ifndef _IFC4X2_IFCELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcElementType : public IfcTypeProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcElementType, IfcElementType> object.
*/
typedef OdSmartPtr<IfcElementType> IfcElementTypePtr;

} // namespace

#endif // _IFC4X2_IFCELEMENTTYPE_AUTO_IMPL_H
