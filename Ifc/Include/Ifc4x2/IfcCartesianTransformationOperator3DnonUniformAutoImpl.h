...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCartesianTransformationOperator3DnonUniform, IfcCartesianTransformationOperator3DnonUniform> object.
*/
