...
#ifndef _IFC4X2_IFCTABLEROW_AUTO_IMPL_H
#define _IFC4X2_IFCTABLEROW_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTableRow : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTableRow);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTableRow, IfcTableRow> object.
*/
typedef OdSmartPtr<IfcTableRow> IfcTableRowPtr;

} // namespace

#endif // _IFC4X2_IFCTABLEROW_AUTO_IMPL_H
