...
#ifndef _IFC4X2_IFCTEXTUREVERTEXLIST_AUTO_IMPL_H
#define _IFC4X2_IFCTEXTUREVERTEXLIST_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTextureVertexList : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTextureVertexList);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTextureVertexList, IfcTextureVertexList> object.
*/
typedef OdSmartPtr<IfcTextureVertexList> IfcTextureVertexListPtr;

} // namespace

#endif // _IFC4X2_IFCTEXTUREVERTEXLIST_AUTO_IMPL_H
