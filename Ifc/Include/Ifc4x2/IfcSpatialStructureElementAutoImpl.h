...
#ifndef _IFC4X2_IFCSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
#define _IFC4X2_IFCSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSpatialStructureElement : public IfcSpatialElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcSpatialStructureElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSpatialStructureElement, IfcSpatialStructureElement> object.
*/
typedef OdSmartPtr<IfcSpatialStructureElement> IfcSpatialStructureElementPtr;

} // namespace

#endif // _IFC4X2_IFCSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
