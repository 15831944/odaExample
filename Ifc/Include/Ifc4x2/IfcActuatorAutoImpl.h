...
#ifndef _IFC4X2_IFCACTUATOR_AUTO_IMPL_H
#define _IFC4X2_IFCACTUATOR_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcActuator : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcActuator);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcActuator, IfcActuator> object.
*/
typedef OdSmartPtr<IfcActuator> IfcActuatorPtr;

} // namespace

#endif // _IFC4X2_IFCACTUATOR_AUTO_IMPL_H
