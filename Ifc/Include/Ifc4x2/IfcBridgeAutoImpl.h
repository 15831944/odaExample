...
#ifndef _IFC4X2_IFCBRIDGE_AUTO_IMPL_H
#define _IFC4X2_IFCBRIDGE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcBridge : public IfcFacility
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcBridge);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcBridge, IfcBridge> object.
*/
typedef OdSmartPtr<IfcBridge> IfcBridgePtr;

} // namespace

#endif // _IFC4X2_IFCBRIDGE_AUTO_IMPL_H
