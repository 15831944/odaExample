...
#ifndef _IFC4X2_IFCSTACKTERMINAL_AUTO_IMPL_H
#define _IFC4X2_IFCSTACKTERMINAL_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcStackTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcStackTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcStackTerminal, IfcStackTerminal> object.
*/
typedef OdSmartPtr<IfcStackTerminal> IfcStackTerminalPtr;

} // namespace

#endif // _IFC4X2_IFCSTACKTERMINAL_AUTO_IMPL_H
