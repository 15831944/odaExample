...
#ifndef _IFC4X2_IFCLABORRESOURCE_AUTO_IMPL_H
#define _IFC4X2_IFCLABORRESOURCE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcLaborResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcLaborResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcLaborResource, IfcLaborResource> object.
*/
typedef OdSmartPtr<IfcLaborResource> IfcLaborResourcePtr;

} // namespace

#endif // _IFC4X2_IFCLABORRESOURCE_AUTO_IMPL_H
