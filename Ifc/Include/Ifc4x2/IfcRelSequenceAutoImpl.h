...
#ifndef _IFC4X2_IFCRELSEQUENCE_AUTO_IMPL_H
#define _IFC4X2_IFCRELSEQUENCE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRelSequence : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRelSequence);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRelSequence, IfcRelSequence> object.
*/
typedef OdSmartPtr<IfcRelSequence> IfcRelSequencePtr;

} // namespace

#endif // _IFC4X2_IFCRELSEQUENCE_AUTO_IMPL_H
