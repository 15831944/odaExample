...
#ifndef _IFC4X2_IFCPROTECTIVEDEVICE_AUTO_IMPL_H
#define _IFC4X2_IFCPROTECTIVEDEVICE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcProtectiveDevice : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcProtectiveDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcProtectiveDevice, IfcProtectiveDevice> object.
*/
typedef OdSmartPtr<IfcProtectiveDevice> IfcProtectiveDevicePtr;

} // namespace

#endif // _IFC4X2_IFCPROTECTIVEDEVICE_AUTO_IMPL_H
