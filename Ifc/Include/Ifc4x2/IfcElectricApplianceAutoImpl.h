...
#ifndef _IFC4X2_IFCELECTRICAPPLIANCE_AUTO_IMPL_H
#define _IFC4X2_IFCELECTRICAPPLIANCE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcElectricAppliance : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcElectricAppliance);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcElectricAppliance, IfcElectricAppliance> object.
*/
typedef OdSmartPtr<IfcElectricAppliance> IfcElectricAppliancePtr;

} // namespace

#endif // _IFC4X2_IFCELECTRICAPPLIANCE_AUTO_IMPL_H
