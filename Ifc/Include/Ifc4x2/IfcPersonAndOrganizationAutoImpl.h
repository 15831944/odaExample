...
#ifndef _IFC4X2_IFCPERSONANDORGANIZATION_AUTO_IMPL_H
#define _IFC4X2_IFCPERSONANDORGANIZATION_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPersonAndOrganization : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcPersonAndOrganization);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPersonAndOrganization, IfcPersonAndOrganization> object.
*/
typedef OdSmartPtr<IfcPersonAndOrganization> IfcPersonAndOrganizationPtr;

} // namespace

#endif // _IFC4X2_IFCPERSONANDORGANIZATION_AUTO_IMPL_H
