...
#ifndef _IFC4X2_IFCPROPERTYTEMPLATE_AUTO_IMPL_H
#define _IFC4X2_IFCPROPERTYTEMPLATE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPropertyTemplate : public IfcPropertyTemplateDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcPropertyTemplate);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPropertyTemplate, IfcPropertyTemplate> object.
*/
typedef OdSmartPtr<IfcPropertyTemplate> IfcPropertyTemplatePtr;

} // namespace

#endif // _IFC4X2_IFCPROPERTYTEMPLATE_AUTO_IMPL_H
