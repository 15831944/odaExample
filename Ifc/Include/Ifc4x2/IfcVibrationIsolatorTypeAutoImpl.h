...
#ifndef _IFC4X2_IFCVIBRATIONISOLATORTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCVIBRATIONISOLATORTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcVibrationIsolatorType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcVibrationIsolatorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcVibrationIsolatorType, IfcVibrationIsolatorType> object.
*/
typedef OdSmartPtr<IfcVibrationIsolatorType> IfcVibrationIsolatorTypePtr;

} // namespace

#endif // _IFC4X2_IFCVIBRATIONISOLATORTYPE_AUTO_IMPL_H
