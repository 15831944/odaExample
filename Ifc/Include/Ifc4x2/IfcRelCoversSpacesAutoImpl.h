...
#ifndef _IFC4X2_IFCRELCOVERSSPACES_AUTO_IMPL_H
#define _IFC4X2_IFCRELCOVERSSPACES_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRelCoversSpaces : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRelCoversSpaces);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRelCoversSpaces, IfcRelCoversSpaces> object.
*/
typedef OdSmartPtr<IfcRelCoversSpaces> IfcRelCoversSpacesPtr;

} // namespace

#endif // _IFC4X2_IFCRELCOVERSSPACES_AUTO_IMPL_H
