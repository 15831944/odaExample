...
#ifndef _IFC4X2_IFCCHIMNEYTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCCHIMNEYTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcChimneyType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcChimneyType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcChimneyType, IfcChimneyType> object.
*/
typedef OdSmartPtr<IfcChimneyType> IfcChimneyTypePtr;

} // namespace

#endif // _IFC4X2_IFCCHIMNEYTYPE_AUTO_IMPL_H
