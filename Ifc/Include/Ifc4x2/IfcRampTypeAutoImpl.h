...
#ifndef _IFC4X2_IFCRAMPTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCRAMPTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRampType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRampType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRampType, IfcRampType> object.
*/
typedef OdSmartPtr<IfcRampType> IfcRampTypePtr;

} // namespace

#endif // _IFC4X2_IFCRAMPTYPE_AUTO_IMPL_H
