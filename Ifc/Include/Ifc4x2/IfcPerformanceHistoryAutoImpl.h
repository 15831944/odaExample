...
#ifndef _IFC4X2_IFCPERFORMANCEHISTORY_AUTO_IMPL_H
#define _IFC4X2_IFCPERFORMANCEHISTORY_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPerformanceHistory : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcPerformanceHistory);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPerformanceHistory, IfcPerformanceHistory> object.
*/
typedef OdSmartPtr<IfcPerformanceHistory> IfcPerformanceHistoryPtr;

} // namespace

#endif // _IFC4X2_IFCPERFORMANCEHISTORY_AUTO_IMPL_H
