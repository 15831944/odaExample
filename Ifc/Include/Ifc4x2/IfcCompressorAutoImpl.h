...
#ifndef _IFC4X2_IFCCOMPRESSOR_AUTO_IMPL_H
#define _IFC4X2_IFCCOMPRESSOR_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCompressor : public IfcFlowMovingDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCompressor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCompressor, IfcCompressor> object.
*/
typedef OdSmartPtr<IfcCompressor> IfcCompressorPtr;

} // namespace

#endif // _IFC4X2_IFCCOMPRESSOR_AUTO_IMPL_H
