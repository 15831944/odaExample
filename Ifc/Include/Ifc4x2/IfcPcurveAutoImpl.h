...
#ifndef _IFC4X2_IFCPCURVE_AUTO_IMPL_H
#define _IFC4X2_IFCPCURVE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPcurve : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcPcurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPcurve, IfcPcurve> object.
*/
typedef OdSmartPtr<IfcPcurve> IfcPcurvePtr;

} // namespace

#endif // _IFC4X2_IFCPCURVE_AUTO_IMPL_H
