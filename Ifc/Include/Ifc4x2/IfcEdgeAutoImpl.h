...
#ifndef _IFC4X2_IFCEDGE_AUTO_IMPL_H
#define _IFC4X2_IFCEDGE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcEdge : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcEdge);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcEdge, IfcEdge> object.
*/
typedef OdSmartPtr<IfcEdge> IfcEdgePtr;

} // namespace

#endif // _IFC4X2_IFCEDGE_AUTO_IMPL_H
