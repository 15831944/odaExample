...
#ifndef _IFC4X2_IFCCONDENSER_AUTO_IMPL_H
#define _IFC4X2_IFCCONDENSER_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCondenser : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCondenser);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCondenser, IfcCondenser> object.
*/
typedef OdSmartPtr<IfcCondenser> IfcCondenserPtr;

} // namespace

#endif // _IFC4X2_IFCCONDENSER_AUTO_IMPL_H
