...
#ifndef _IFC4X2_IFCWORKTIME_AUTO_IMPL_H
#define _IFC4X2_IFCWORKTIME_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcWorkTime : public IfcSchedulingTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcWorkTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcWorkTime, IfcWorkTime> object.
*/
typedef OdSmartPtr<IfcWorkTime> IfcWorkTimePtr;

} // namespace

#endif // _IFC4X2_IFCWORKTIME_AUTO_IMPL_H
