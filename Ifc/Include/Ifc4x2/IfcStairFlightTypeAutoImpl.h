...
#ifndef _IFC4X2_IFCSTAIRFLIGHTTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCSTAIRFLIGHTTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcStairFlightType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcStairFlightType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcStairFlightType, IfcStairFlightType> object.
*/
typedef OdSmartPtr<IfcStairFlightType> IfcStairFlightTypePtr;

} // namespace

#endif // _IFC4X2_IFCSTAIRFLIGHTTYPE_AUTO_IMPL_H
