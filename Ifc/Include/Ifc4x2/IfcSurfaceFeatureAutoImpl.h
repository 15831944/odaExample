...
#ifndef _IFC4X2_IFCSURFACEFEATURE_AUTO_IMPL_H
#define _IFC4X2_IFCSURFACEFEATURE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSurfaceFeature : public IfcFeatureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSurfaceFeature);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSurfaceFeature, IfcSurfaceFeature> object.
*/
typedef OdSmartPtr<IfcSurfaceFeature> IfcSurfaceFeaturePtr;

} // namespace

#endif // _IFC4X2_IFCSURFACEFEATURE_AUTO_IMPL_H
