...
#ifndef _IFC4X2_IFCALIGNMENT2DVERTICALSEGMENT_AUTO_IMPL_H
#define _IFC4X2_IFCALIGNMENT2DVERTICALSEGMENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcAlignment2DVerticalSegment : public IfcAlignment2DSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcAlignment2DVerticalSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcAlignment2DVerticalSegment, IfcAlignment2DVerticalSegment> object.
*/
typedef OdSmartPtr<IfcAlignment2DVerticalSegment> IfcAlignment2DVerticalSegmentPtr;

} // namespace

#endif // _IFC4X2_IFCALIGNMENT2DVERTICALSEGMENT_AUTO_IMPL_H
