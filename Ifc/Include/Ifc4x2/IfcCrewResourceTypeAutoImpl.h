...
#ifndef _IFC4X2_IFCCREWRESOURCETYPE_AUTO_IMPL_H
#define _IFC4X2_IFCCREWRESOURCETYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCrewResourceType : public IfcConstructionResourceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCrewResourceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCrewResourceType, IfcCrewResourceType> object.
*/
typedef OdSmartPtr<IfcCrewResourceType> IfcCrewResourceTypePtr;

} // namespace

#endif // _IFC4X2_IFCCREWRESOURCETYPE_AUTO_IMPL_H
