...
#ifndef _IFC4X2_IFCRAILING_AUTO_IMPL_H
#define _IFC4X2_IFCRAILING_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRailing : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRailing);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRailing, IfcRailing> object.
*/
typedef OdSmartPtr<IfcRailing> IfcRailingPtr;

} // namespace

#endif // _IFC4X2_IFCRAILING_AUTO_IMPL_H
