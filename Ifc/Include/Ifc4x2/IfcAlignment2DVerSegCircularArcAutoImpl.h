...
#ifndef _IFC4X2_IFCALIGNMENT2DVERSEGCIRCULARARC_AUTO_IMPL_H
#define _IFC4X2_IFCALIGNMENT2DVERSEGCIRCULARARC_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcAlignment2DVerSegCircularArc : public IfcAlignment2DVerticalSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcAlignment2DVerSegCircularArc);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcAlignment2DVerSegCircularArc, IfcAlignment2DVerSegCircularArc> object.
*/
typedef OdSmartPtr<IfcAlignment2DVerSegCircularArc> IfcAlignment2DVerSegCircularArcPtr;

} // namespace

#endif // _IFC4X2_IFCALIGNMENT2DVERSEGCIRCULARARC_AUTO_IMPL_H
