...
#ifndef _IFC4X2_IFCSOLARDEVICE_AUTO_IMPL_H
#define _IFC4X2_IFCSOLARDEVICE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSolarDevice : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSolarDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSolarDevice, IfcSolarDevice> object.
*/
typedef OdSmartPtr<IfcSolarDevice> IfcSolarDevicePtr;

} // namespace

#endif // _IFC4X2_IFCSOLARDEVICE_AUTO_IMPL_H
