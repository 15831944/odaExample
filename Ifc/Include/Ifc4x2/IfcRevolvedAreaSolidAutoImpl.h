...
#ifndef _IFC4X2_IFCREVOLVEDAREASOLID_AUTO_IMPL_H
#define _IFC4X2_IFCREVOLVEDAREASOLID_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRevolvedAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRevolvedAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRevolvedAreaSolid, IfcRevolvedAreaSolid> object.
*/
typedef OdSmartPtr<IfcRevolvedAreaSolid> IfcRevolvedAreaSolidPtr;

} // namespace

#endif // _IFC4X2_IFCREVOLVEDAREASOLID_AUTO_IMPL_H
