...
#ifndef _IFC4X2_IFCQUANTITYAREA_AUTO_IMPL_H
#define _IFC4X2_IFCQUANTITYAREA_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcQuantityArea : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcQuantityArea);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcQuantityArea, IfcQuantityArea> object.
*/
typedef OdSmartPtr<IfcQuantityArea> IfcQuantityAreaPtr;

} // namespace

#endif // _IFC4X2_IFCQUANTITYAREA_AUTO_IMPL_H
