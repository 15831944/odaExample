...
#ifndef _IFC4X2_IFCCOILTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCCOILTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCoilType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCoilType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCoilType, IfcCoilType> object.
*/
typedef OdSmartPtr<IfcCoilType> IfcCoilTypePtr;

} // namespace

#endif // _IFC4X2_IFCCOILTYPE_AUTO_IMPL_H
