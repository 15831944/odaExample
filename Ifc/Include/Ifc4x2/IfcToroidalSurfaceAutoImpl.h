...
#ifndef _IFC4X2_IFCTOROIDALSURFACE_AUTO_IMPL_H
#define _IFC4X2_IFCTOROIDALSURFACE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcToroidalSurface : public IfcElementarySurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcToroidalSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcToroidalSurface, IfcToroidalSurface> object.
*/
typedef OdSmartPtr<IfcToroidalSurface> IfcToroidalSurfacePtr;

} // namespace

#endif // _IFC4X2_IFCTOROIDALSURFACE_AUTO_IMPL_H
