...
#ifndef _IFC4X2_IFCUNITARYEQUIPMENTTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCUNITARYEQUIPMENTTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcUnitaryEquipmentType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcUnitaryEquipmentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcUnitaryEquipmentType, IfcUnitaryEquipmentType> object.
*/
typedef OdSmartPtr<IfcUnitaryEquipmentType> IfcUnitaryEquipmentTypePtr;

} // namespace

#endif // _IFC4X2_IFCUNITARYEQUIPMENTTYPE_AUTO_IMPL_H
