...
#ifndef _IFC4X2_IFCMECHANICALFASTENER_AUTO_IMPL_H
#define _IFC4X2_IFCMECHANICALFASTENER_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcMechanicalFastener : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcMechanicalFastener);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcMechanicalFastener, IfcMechanicalFastener> object.
*/
typedef OdSmartPtr<IfcMechanicalFastener> IfcMechanicalFastenerPtr;

} // namespace

#endif // _IFC4X2_IFCMECHANICALFASTENER_AUTO_IMPL_H
