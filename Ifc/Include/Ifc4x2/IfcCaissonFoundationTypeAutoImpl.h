...
#ifndef _IFC4X2_IFCCAISSONFOUNDATIONTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCCAISSONFOUNDATIONTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCaissonFoundationType : public IfcDeepFoundationType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCaissonFoundationType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCaissonFoundationType, IfcCaissonFoundationType> object.
*/
typedef OdSmartPtr<IfcCaissonFoundationType> IfcCaissonFoundationTypePtr;

} // namespace

#endif // _IFC4X2_IFCCAISSONFOUNDATIONTYPE_AUTO_IMPL_H
