...
#ifndef _IFC4X2_IFCCOOLEDBEAM_AUTO_IMPL_H
#define _IFC4X2_IFCCOOLEDBEAM_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCooledBeam : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCooledBeam);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCooledBeam, IfcCooledBeam> object.
*/
typedef OdSmartPtr<IfcCooledBeam> IfcCooledBeamPtr;

} // namespace

#endif // _IFC4X2_IFCCOOLEDBEAM_AUTO_IMPL_H
