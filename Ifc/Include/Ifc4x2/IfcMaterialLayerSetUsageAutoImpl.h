...
#ifndef _IFC4X2_IFCMATERIALLAYERSETUSAGE_AUTO_IMPL_H
#define _IFC4X2_IFCMATERIALLAYERSETUSAGE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcMaterialLayerSetUsage : public IfcMaterialUsageDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcMaterialLayerSetUsage);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcMaterialLayerSetUsage, IfcMaterialLayerSetUsage> object.
*/
typedef OdSmartPtr<IfcMaterialLayerSetUsage> IfcMaterialLayerSetUsagePtr;

} // namespace

#endif // _IFC4X2_IFCMATERIALLAYERSETUSAGE_AUTO_IMPL_H
