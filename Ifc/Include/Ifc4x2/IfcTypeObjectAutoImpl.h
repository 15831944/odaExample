...
#ifndef _IFC4X2_IFCTYPEOBJECT_AUTO_IMPL_H
#define _IFC4X2_IFCTYPEOBJECT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTypeObject : public IfcObjectDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTypeObject);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTypeObject, IfcTypeObject> object.
*/
typedef OdSmartPtr<IfcTypeObject> IfcTypeObjectPtr;

} // namespace

#endif // _IFC4X2_IFCTYPEOBJECT_AUTO_IMPL_H
