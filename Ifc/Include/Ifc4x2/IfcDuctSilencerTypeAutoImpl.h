...
#ifndef _IFC4X2_IFCDUCTSILENCERTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCDUCTSILENCERTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcDuctSilencerType : public IfcFlowTreatmentDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcDuctSilencerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcDuctSilencerType, IfcDuctSilencerType> object.
*/
typedef OdSmartPtr<IfcDuctSilencerType> IfcDuctSilencerTypePtr;

} // namespace

#endif // _IFC4X2_IFCDUCTSILENCERTYPE_AUTO_IMPL_H
