...
#ifndef _IFC4X2_IFCCOORDINATEREFERENCESYSTEM_AUTO_IMPL_H
#define _IFC4X2_IFCCOORDINATEREFERENCESYSTEM_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCoordinateReferenceSystem : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcCoordinateReferenceSystem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCoordinateReferenceSystem, IfcCoordinateReferenceSystem> object.
*/
typedef OdSmartPtr<IfcCoordinateReferenceSystem> IfcCoordinateReferenceSystemPtr;

} // namespace

#endif // _IFC4X2_IFCCOORDINATEREFERENCESYSTEM_AUTO_IMPL_H
