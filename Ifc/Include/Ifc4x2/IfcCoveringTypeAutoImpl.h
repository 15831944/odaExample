...
#ifndef _IFC4X2_IFCCOVERINGTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCCOVERINGTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCoveringType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCoveringType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCoveringType, IfcCoveringType> object.
*/
typedef OdSmartPtr<IfcCoveringType> IfcCoveringTypePtr;

} // namespace

#endif // _IFC4X2_IFCCOVERINGTYPE_AUTO_IMPL_H
