...
#ifndef _IFC4X2_IFCFACILITYPART_AUTO_IMPL_H
#define _IFC4X2_IFCFACILITYPART_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcFacilityPart : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcFacilityPart);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcFacilityPart, IfcFacilityPart> object.
*/
typedef OdSmartPtr<IfcFacilityPart> IfcFacilityPartPtr;

} // namespace

#endif // _IFC4X2_IFCFACILITYPART_AUTO_IMPL_H
