...
#ifndef _IFC4X2_IFCSTRUCTURALLOAD_AUTO_IMPL_H
#define _IFC4X2_IFCSTRUCTURALLOAD_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcStructuralLoad : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcStructuralLoad);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcStructuralLoad, IfcStructuralLoad> object.
*/
typedef OdSmartPtr<IfcStructuralLoad> IfcStructuralLoadPtr;

} // namespace

#endif // _IFC4X2_IFCSTRUCTURALLOAD_AUTO_IMPL_H
