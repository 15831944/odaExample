...
#ifndef _IFC4X2_IFCINVENTORY_AUTO_IMPL_H
#define _IFC4X2_IFCINVENTORY_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcInventory : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcInventory);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcInventory, IfcInventory> object.
*/
typedef OdSmartPtr<IfcInventory> IfcInventoryPtr;

} // namespace

#endif // _IFC4X2_IFCINVENTORY_AUTO_IMPL_H
