...
#ifndef _IFC4X2_IFCRECTANGULARPYRAMID_AUTO_IMPL_H
#define _IFC4X2_IFCRECTANGULARPYRAMID_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRectangularPyramid : public IfcCsgPrimitive3D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRectangularPyramid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRectangularPyramid, IfcRectangularPyramid> object.
*/
typedef OdSmartPtr<IfcRectangularPyramid> IfcRectangularPyramidPtr;

} // namespace

#endif // _IFC4X2_IFCRECTANGULARPYRAMID_AUTO_IMPL_H
