...
#ifndef _IFC4X2_IFCJUNCTIONBOX_AUTO_IMPL_H
#define _IFC4X2_IFCJUNCTIONBOX_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcJunctionBox : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcJunctionBox);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcJunctionBox, IfcJunctionBox> object.
*/
typedef OdSmartPtr<IfcJunctionBox> IfcJunctionBoxPtr;

} // namespace

#endif // _IFC4X2_IFCJUNCTIONBOX_AUTO_IMPL_H
