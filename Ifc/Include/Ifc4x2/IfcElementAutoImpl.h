...
#ifndef _IFC4X2_IFCELEMENT_AUTO_IMPL_H
#define _IFC4X2_IFCELEMENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcElement : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcElement, IfcElement> object.
*/
typedef OdSmartPtr<IfcElement> IfcElementPtr;

} // namespace

#endif // _IFC4X2_IFCELEMENT_AUTO_IMPL_H
