...
#ifndef _IFC4X2_IFCEVENTTIME_AUTO_IMPL_H
#define _IFC4X2_IFCEVENTTIME_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcEventTime : public IfcSchedulingTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcEventTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcEventTime, IfcEventTime> object.
*/
typedef OdSmartPtr<IfcEventTime> IfcEventTimePtr;

} // namespace

#endif // _IFC4X2_IFCEVENTTIME_AUTO_IMPL_H
