...
#ifndef _IFC4X2_IFCCHILLERTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCCHILLERTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcChillerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcChillerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcChillerType, IfcChillerType> object.
*/
typedef OdSmartPtr<IfcChillerType> IfcChillerTypePtr;

} // namespace

#endif // _IFC4X2_IFCCHILLERTYPE_AUTO_IMPL_H
