...
#ifndef _IFC4X2_IFCSPACETYPE_AUTO_IMPL_H
#define _IFC4X2_IFCSPACETYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSpaceType : public IfcSpatialStructureElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSpaceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSpaceType, IfcSpaceType> object.
*/
typedef OdSmartPtr<IfcSpaceType> IfcSpaceTypePtr;

} // namespace

#endif // _IFC4X2_IFCSPACETYPE_AUTO_IMPL_H
