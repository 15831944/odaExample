...
#ifndef _IFC4X2_IFCTASKTIMERECURRING_AUTO_IMPL_H
#define _IFC4X2_IFCTASKTIMERECURRING_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTaskTimeRecurring : public IfcTaskTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTaskTimeRecurring);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTaskTimeRecurring, IfcTaskTimeRecurring> object.
*/
typedef OdSmartPtr<IfcTaskTimeRecurring> IfcTaskTimeRecurringPtr;

} // namespace

#endif // _IFC4X2_IFCTASKTIMERECURRING_AUTO_IMPL_H
