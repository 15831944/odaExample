...
#ifndef _IFC4X2_IFCTANKTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCTANKTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTankType : public IfcFlowStorageDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTankType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTankType, IfcTankType> object.
*/
typedef OdSmartPtr<IfcTankType> IfcTankTypePtr;

} // namespace

#endif // _IFC4X2_IFCTANKTYPE_AUTO_IMPL_H
