...
#ifndef _IFC4X2_IFCCONIC_AUTO_IMPL_H
#define _IFC4X2_IFCCONIC_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcConic : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcConic);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcConic, IfcConic> object.
*/
typedef OdSmartPtr<IfcConic> IfcConicPtr;

} // namespace

#endif // _IFC4X2_IFCCONIC_AUTO_IMPL_H
