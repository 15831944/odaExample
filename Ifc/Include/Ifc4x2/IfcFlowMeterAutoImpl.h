...
#ifndef _IFC4X2_IFCFLOWMETER_AUTO_IMPL_H
#define _IFC4X2_IFCFLOWMETER_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcFlowMeter : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcFlowMeter);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcFlowMeter, IfcFlowMeter> object.
*/
typedef OdSmartPtr<IfcFlowMeter> IfcFlowMeterPtr;

} // namespace

#endif // _IFC4X2_IFCFLOWMETER_AUTO_IMPL_H
