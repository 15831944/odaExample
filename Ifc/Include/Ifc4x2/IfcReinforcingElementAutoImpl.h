...
#ifndef _IFC4X2_IFCREINFORCINGELEMENT_AUTO_IMPL_H
#define _IFC4X2_IFCREINFORCINGELEMENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcReinforcingElement : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcReinforcingElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcReinforcingElement, IfcReinforcingElement> object.
*/
typedef OdSmartPtr<IfcReinforcingElement> IfcReinforcingElementPtr;

} // namespace

#endif // _IFC4X2_IFCREINFORCINGELEMENT_AUTO_IMPL_H
