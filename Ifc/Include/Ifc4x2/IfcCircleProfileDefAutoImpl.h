...
#ifndef _IFC4X2_IFCCIRCLEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X2_IFCCIRCLEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCircleProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCircleProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCircleProfileDef, IfcCircleProfileDef> object.
*/
typedef OdSmartPtr<IfcCircleProfileDef> IfcCircleProfileDefPtr;

} // namespace

#endif // _IFC4X2_IFCCIRCLEPROFILEDEF_AUTO_IMPL_H
