...
#ifndef _IFC4X2_IFCBRIDGEPART_AUTO_IMPL_H
#define _IFC4X2_IFCBRIDGEPART_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcBridgePart : public IfcFacilityPart
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcBridgePart);
  //DOM-IGNORE-END
...
public:
  ...
  IfcBridgePartTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcBridgePartTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcBridgePartTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcBridgePart, IfcBridgePart> object.
*/
typedef OdSmartPtr<IfcBridgePart> IfcBridgePartPtr;

} // namespace

#endif // _IFC4X2_IFCBRIDGEPART_AUTO_IMPL_H
