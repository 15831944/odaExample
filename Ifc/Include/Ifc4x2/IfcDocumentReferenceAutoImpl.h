...
#ifndef _IFC4X2_IFCDOCUMENTREFERENCE_AUTO_IMPL_H
#define _IFC4X2_IFCDOCUMENTREFERENCE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcDocumentReference : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcDocumentReference);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcDocumentReference, IfcDocumentReference> object.
*/
typedef OdSmartPtr<IfcDocumentReference> IfcDocumentReferencePtr;

} // namespace

#endif // _IFC4X2_IFCDOCUMENTREFERENCE_AUTO_IMPL_H
