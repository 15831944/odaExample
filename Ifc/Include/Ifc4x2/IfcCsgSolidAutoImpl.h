...
#ifndef _IFC4X2_IFCCSGSOLID_AUTO_IMPL_H
#define _IFC4X2_IFCCSGSOLID_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCsgSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCsgSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCsgSolid, IfcCsgSolid> object.
*/
typedef OdSmartPtr<IfcCsgSolid> IfcCsgSolidPtr;

} // namespace

#endif // _IFC4X2_IFCCSGSOLID_AUTO_IMPL_H
