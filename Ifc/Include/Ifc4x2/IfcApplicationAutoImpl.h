...
#ifndef _IFC4X2_IFCAPPLICATION_AUTO_IMPL_H
#define _IFC4X2_IFCAPPLICATION_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcApplication : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcApplication);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcApplication, IfcApplication> object.
*/
typedef OdSmartPtr<IfcApplication> IfcApplicationPtr;

} // namespace

#endif // _IFC4X2_IFCAPPLICATION_AUTO_IMPL_H
