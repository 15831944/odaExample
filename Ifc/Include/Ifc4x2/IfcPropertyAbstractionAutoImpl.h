...
#ifndef _IFC4X2_IFCPROPERTYABSTRACTION_AUTO_IMPL_H
#define _IFC4X2_IFCPROPERTYABSTRACTION_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPropertyAbstraction : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcPropertyAbstraction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPropertyAbstraction, IfcPropertyAbstraction> object.
*/
typedef OdSmartPtr<IfcPropertyAbstraction> IfcPropertyAbstractionPtr;

} // namespace

#endif // _IFC4X2_IFCPROPERTYABSTRACTION_AUTO_IMPL_H
