...
#ifndef _IFC4X2_IFCCOOLEDBEAMTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCCOOLEDBEAMTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCooledBeamType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCooledBeamType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCooledBeamType, IfcCooledBeamType> object.
*/
typedef OdSmartPtr<IfcCooledBeamType> IfcCooledBeamTypePtr;

} // namespace

#endif // _IFC4X2_IFCCOOLEDBEAMTYPE_AUTO_IMPL_H
