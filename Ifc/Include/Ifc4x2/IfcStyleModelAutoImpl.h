...
#ifndef _IFC4X2_IFCSTYLEMODEL_AUTO_IMPL_H
#define _IFC4X2_IFCSTYLEMODEL_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcStyleModel : public IfcRepresentation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcStyleModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcStyleModel, IfcStyleModel> object.
*/
typedef OdSmartPtr<IfcStyleModel> IfcStyleModelPtr;

} // namespace

#endif // _IFC4X2_IFCSTYLEMODEL_AUTO_IMPL_H
