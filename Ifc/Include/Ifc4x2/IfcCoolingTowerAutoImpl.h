...
#ifndef _IFC4X2_IFCCOOLINGTOWER_AUTO_IMPL_H
#define _IFC4X2_IFCCOOLINGTOWER_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCoolingTower : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCoolingTower);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCoolingTower, IfcCoolingTower> object.
*/
typedef OdSmartPtr<IfcCoolingTower> IfcCoolingTowerPtr;

} // namespace

#endif // _IFC4X2_IFCCOOLINGTOWER_AUTO_IMPL_H
