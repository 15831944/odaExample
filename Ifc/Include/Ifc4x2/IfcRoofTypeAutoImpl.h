...
#ifndef _IFC4X2_IFCROOFTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCROOFTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRoofType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRoofType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRoofType, IfcRoofType> object.
*/
typedef OdSmartPtr<IfcRoofType> IfcRoofTypePtr;

} // namespace

#endif // _IFC4X2_IFCROOFTYPE_AUTO_IMPL_H
