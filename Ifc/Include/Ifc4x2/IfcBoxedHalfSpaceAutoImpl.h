...
#ifndef _IFC4X2_IFCBOXEDHALFSPACE_AUTO_IMPL_H
#define _IFC4X2_IFCBOXEDHALFSPACE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcBoxedHalfSpace : public IfcHalfSpaceSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcBoxedHalfSpace);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcBoxedHalfSpace, IfcBoxedHalfSpace> object.
*/
typedef OdSmartPtr<IfcBoxedHalfSpace> IfcBoxedHalfSpacePtr;

} // namespace

#endif // _IFC4X2_IFCBOXEDHALFSPACE_AUTO_IMPL_H
