...
#ifndef _IFC4X2_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
#define _IFC4X2_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcWindowLiningProperties : public IfcPreDefinedPropertySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcWindowLiningProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcWindowLiningProperties, IfcWindowLiningProperties> object.
*/
typedef OdSmartPtr<IfcWindowLiningProperties> IfcWindowLiningPropertiesPtr;

} // namespace

#endif // _IFC4X2_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
