...
#ifndef _IFC4X2_IFCINTERCEPTOR_AUTO_IMPL_H
#define _IFC4X2_IFCINTERCEPTOR_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcInterceptor : public IfcFlowTreatmentDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcInterceptor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcInterceptor, IfcInterceptor> object.
*/
typedef OdSmartPtr<IfcInterceptor> IfcInterceptorPtr;

} // namespace

#endif // _IFC4X2_IFCINTERCEPTOR_AUTO_IMPL_H
