...
#ifndef _IFC4X2_IFCARBITRARYOPENPROFILEDEF_AUTO_IMPL_H
#define _IFC4X2_IFCARBITRARYOPENPROFILEDEF_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcArbitraryOpenProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcArbitraryOpenProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcArbitraryOpenProfileDef, IfcArbitraryOpenProfileDef> object.
*/
typedef OdSmartPtr<IfcArbitraryOpenProfileDef> IfcArbitraryOpenProfileDefPtr;

} // namespace

#endif // _IFC4X2_IFCARBITRARYOPENPROFILEDEF_AUTO_IMPL_H
