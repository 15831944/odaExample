...
#ifndef _IFC4X2_IFCMATERIALLAYERSET_AUTO_IMPL_H
#define _IFC4X2_IFCMATERIALLAYERSET_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcMaterialLayerSet : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcMaterialLayerSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcMaterialLayerSet, IfcMaterialLayerSet> object.
*/
typedef OdSmartPtr<IfcMaterialLayerSet> IfcMaterialLayerSetPtr;

} // namespace

#endif // _IFC4X2_IFCMATERIALLAYERSET_AUTO_IMPL_H
