...
#ifndef _IFC4X2_IFCREGULARTIMESERIES_AUTO_IMPL_H
#define _IFC4X2_IFCREGULARTIMESERIES_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRegularTimeSeries : public IfcTimeSeries
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRegularTimeSeries);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRegularTimeSeries, IfcRegularTimeSeries> object.
*/
typedef OdSmartPtr<IfcRegularTimeSeries> IfcRegularTimeSeriesPtr;

} // namespace

#endif // _IFC4X2_IFCREGULARTIMESERIES_AUTO_IMPL_H
