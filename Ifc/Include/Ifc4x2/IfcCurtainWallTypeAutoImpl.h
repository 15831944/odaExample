...
#ifndef _IFC4X2_IFCCURTAINWALLTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCCURTAINWALLTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCurtainWallType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCurtainWallType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCurtainWallType, IfcCurtainWallType> object.
*/
typedef OdSmartPtr<IfcCurtainWallType> IfcCurtainWallTypePtr;

} // namespace

#endif // _IFC4X2_IFCCURTAINWALLTYPE_AUTO_IMPL_H
