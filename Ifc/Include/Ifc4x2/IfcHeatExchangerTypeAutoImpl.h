...
#ifndef _IFC4X2_IFCHEATEXCHANGERTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCHEATEXCHANGERTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcHeatExchangerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcHeatExchangerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcHeatExchangerType, IfcHeatExchangerType> object.
*/
typedef OdSmartPtr<IfcHeatExchangerType> IfcHeatExchangerTypePtr;

} // namespace

#endif // _IFC4X2_IFCHEATEXCHANGERTYPE_AUTO_IMPL_H
