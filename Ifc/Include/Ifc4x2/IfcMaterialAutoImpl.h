...
#ifndef _IFC4X2_IFCMATERIAL_AUTO_IMPL_H
#define _IFC4X2_IFCMATERIAL_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcMaterial : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcMaterial);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcMaterial, IfcMaterial> object.
*/
typedef OdSmartPtr<IfcMaterial> IfcMaterialPtr;

} // namespace

#endif // _IFC4X2_IFCMATERIAL_AUTO_IMPL_H
