...
#ifndef _IFC4X2_IFCCIRCLE_AUTO_IMPL_H
#define _IFC4X2_IFCCIRCLE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCircle : public IfcConic
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCircle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCircle, IfcCircle> object.
*/
typedef OdSmartPtr<IfcCircle> IfcCirclePtr;

} // namespace

#endif // _IFC4X2_IFCCIRCLE_AUTO_IMPL_H
