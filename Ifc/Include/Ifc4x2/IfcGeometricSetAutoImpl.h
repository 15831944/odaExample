...
#ifndef _IFC4X2_IFCGEOMETRICSET_AUTO_IMPL_H
#define _IFC4X2_IFCGEOMETRICSET_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcGeometricSet : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcGeometricSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcGeometricSet, IfcGeometricSet> object.
*/
typedef OdSmartPtr<IfcGeometricSet> IfcGeometricSetPtr;

} // namespace

#endif // _IFC4X2_IFCGEOMETRICSET_AUTO_IMPL_H
