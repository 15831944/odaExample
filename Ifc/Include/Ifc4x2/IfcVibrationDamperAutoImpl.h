...
#ifndef _IFC4X2_IFCVIBRATIONDAMPER_AUTO_IMPL_H
#define _IFC4X2_IFCVIBRATIONDAMPER_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcVibrationDamper : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcVibrationDamper);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcVibrationDamper, IfcVibrationDamper> object.
*/
typedef OdSmartPtr<IfcVibrationDamper> IfcVibrationDamperPtr;

} // namespace

#endif // _IFC4X2_IFCVIBRATIONDAMPER_AUTO_IMPL_H
