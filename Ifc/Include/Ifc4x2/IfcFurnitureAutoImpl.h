...
#ifndef _IFC4X2_IFCFURNITURE_AUTO_IMPL_H
#define _IFC4X2_IFCFURNITURE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcFurniture : public IfcFurnishingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcFurniture);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcFurniture, IfcFurniture> object.
*/
typedef OdSmartPtr<IfcFurniture> IfcFurniturePtr;

} // namespace

#endif // _IFC4X2_IFCFURNITURE_AUTO_IMPL_H
