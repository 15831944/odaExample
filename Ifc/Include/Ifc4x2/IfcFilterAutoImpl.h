...
#ifndef _IFC4X2_IFCFILTER_AUTO_IMPL_H
#define _IFC4X2_IFCFILTER_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcFilter : public IfcFlowTreatmentDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcFilter);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcFilter, IfcFilter> object.
*/
typedef OdSmartPtr<IfcFilter> IfcFilterPtr;

} // namespace

#endif // _IFC4X2_IFCFILTER_AUTO_IMPL_H
