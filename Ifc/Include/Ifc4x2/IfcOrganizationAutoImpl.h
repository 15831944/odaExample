...
#ifndef _IFC4X2_IFCORGANIZATION_AUTO_IMPL_H
#define _IFC4X2_IFCORGANIZATION_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcOrganization : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcOrganization);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcOrganization, IfcOrganization> object.
*/
typedef OdSmartPtr<IfcOrganization> IfcOrganizationPtr;

} // namespace

#endif // _IFC4X2_IFCORGANIZATION_AUTO_IMPL_H
