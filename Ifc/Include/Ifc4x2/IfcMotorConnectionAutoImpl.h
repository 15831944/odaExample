...
#ifndef _IFC4X2_IFCMOTORCONNECTION_AUTO_IMPL_H
#define _IFC4X2_IFCMOTORCONNECTION_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcMotorConnection : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcMotorConnection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcMotorConnection, IfcMotorConnection> object.
*/
typedef OdSmartPtr<IfcMotorConnection> IfcMotorConnectionPtr;

} // namespace

#endif // _IFC4X2_IFCMOTORCONNECTION_AUTO_IMPL_H
