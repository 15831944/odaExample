...
#ifndef _IFC4X2_IFCPLANARBOX_AUTO_IMPL_H
#define _IFC4X2_IFCPLANARBOX_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPlanarBox : public IfcPlanarExtent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcPlanarBox);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPlanarBox, IfcPlanarBox> object.
*/
typedef OdSmartPtr<IfcPlanarBox> IfcPlanarBoxPtr;

} // namespace

#endif // _IFC4X2_IFCPLANARBOX_AUTO_IMPL_H
