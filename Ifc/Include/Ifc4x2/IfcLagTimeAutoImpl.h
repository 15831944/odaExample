...
#ifndef _IFC4X2_IFCLAGTIME_AUTO_IMPL_H
#define _IFC4X2_IFCLAGTIME_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcLagTime : public IfcSchedulingTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcLagTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcLagTime, IfcLagTime> object.
*/
typedef OdSmartPtr<IfcLagTime> IfcLagTimePtr;

} // namespace

#endif // _IFC4X2_IFCLAGTIME_AUTO_IMPL_H
