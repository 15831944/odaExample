...
#ifndef _IFC4X2_IFCCSHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC4X2_IFCCSHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCShapeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCShapeProfileDef, IfcCShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcCShapeProfileDef> IfcCShapeProfileDefPtr;

} // namespace

#endif // _IFC4X2_IFCCSHAPEPROFILEDEF_AUTO_IMPL_H
