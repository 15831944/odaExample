...
#ifndef _IFC4X2_IFCRELCONNECTSPORTS_AUTO_IMPL_H
#define _IFC4X2_IFCRELCONNECTSPORTS_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRelConnectsPorts : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRelConnectsPorts);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRelConnectsPorts, IfcRelConnectsPorts> object.
*/
typedef OdSmartPtr<IfcRelConnectsPorts> IfcRelConnectsPortsPtr;

} // namespace

#endif // _IFC4X2_IFCRELCONNECTSPORTS_AUTO_IMPL_H
