...
#ifndef _IFC4X2_IFCRELDECLARES_AUTO_IMPL_H
#define _IFC4X2_IFCRELDECLARES_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRelDeclares : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRelDeclares);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRelDeclares, IfcRelDeclares> object.
*/
typedef OdSmartPtr<IfcRelDeclares> IfcRelDeclaresPtr;

} // namespace

#endif // _IFC4X2_IFCRELDECLARES_AUTO_IMPL_H
