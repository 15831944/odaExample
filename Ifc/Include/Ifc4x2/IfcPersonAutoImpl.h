...
#ifndef _IFC4X2_IFCPERSON_AUTO_IMPL_H
#define _IFC4X2_IFCPERSON_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPerson : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcPerson);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPerson, IfcPerson> object.
*/
typedef OdSmartPtr<IfcPerson> IfcPersonPtr;

} // namespace

#endif // _IFC4X2_IFCPERSON_AUTO_IMPL_H
