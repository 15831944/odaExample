...
#ifndef _IFC4X2_IFCCONTROLLERTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCCONTROLLERTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcControllerType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcControllerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcControllerType, IfcControllerType> object.
*/
typedef OdSmartPtr<IfcControllerType> IfcControllerTypePtr;

} // namespace

#endif // _IFC4X2_IFCCONTROLLERTYPE_AUTO_IMPL_H
