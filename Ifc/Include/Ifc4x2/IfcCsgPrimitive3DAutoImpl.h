...
#ifndef _IFC4X2_IFCCSGPRIMITIVE3D_AUTO_IMPL_H
#define _IFC4X2_IFCCSGPRIMITIVE3D_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCsgPrimitive3D : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcCsgPrimitive3D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCsgPrimitive3D, IfcCsgPrimitive3D> object.
*/
typedef OdSmartPtr<IfcCsgPrimitive3D> IfcCsgPrimitive3DPtr;

} // namespace

#endif // _IFC4X2_IFCCSGPRIMITIVE3D_AUTO_IMPL_H
