...
#ifndef _IFC4X2_IFCALIGNMENT2DHORIZONTAL_AUTO_IMPL_H
#define _IFC4X2_IFCALIGNMENT2DHORIZONTAL_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcAlignment2DHorizontal : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcAlignment2DHorizontal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcAlignment2DHorizontal, IfcAlignment2DHorizontal> object.
*/
typedef OdSmartPtr<IfcAlignment2DHorizontal> IfcAlignment2DHorizontalPtr;

} // namespace

#endif // _IFC4X2_IFCALIGNMENT2DHORIZONTAL_AUTO_IMPL_H
