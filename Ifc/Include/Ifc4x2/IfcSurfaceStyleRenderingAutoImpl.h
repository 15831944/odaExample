...
#ifndef _IFC4X2_IFCSURFACESTYLERENDERING_AUTO_IMPL_H
#define _IFC4X2_IFCSURFACESTYLERENDERING_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSurfaceStyleRendering : public IfcSurfaceStyleShading
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSurfaceStyleRendering);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSurfaceStyleRendering, IfcSurfaceStyleRendering> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleRendering> IfcSurfaceStyleRenderingPtr;

} // namespace

#endif // _IFC4X2_IFCSURFACESTYLERENDERING_AUTO_IMPL_H
