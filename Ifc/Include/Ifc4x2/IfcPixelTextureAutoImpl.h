...
#ifndef _IFC4X2_IFCPIXELTEXTURE_AUTO_IMPL_H
#define _IFC4X2_IFCPIXELTEXTURE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPixelTexture : public IfcSurfaceTexture
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcPixelTexture);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPixelTexture, IfcPixelTexture> object.
*/
typedef OdSmartPtr<IfcPixelTexture> IfcPixelTexturePtr;

} // namespace

#endif // _IFC4X2_IFCPIXELTEXTURE_AUTO_IMPL_H
