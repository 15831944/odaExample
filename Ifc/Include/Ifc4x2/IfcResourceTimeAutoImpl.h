...
#ifndef _IFC4X2_IFCRESOURCETIME_AUTO_IMPL_H
#define _IFC4X2_IFCRESOURCETIME_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcResourceTime : public IfcSchedulingTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcResourceTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcResourceTime, IfcResourceTime> object.
*/
typedef OdSmartPtr<IfcResourceTime> IfcResourceTimePtr;

} // namespace

#endif // _IFC4X2_IFCRESOURCETIME_AUTO_IMPL_H
