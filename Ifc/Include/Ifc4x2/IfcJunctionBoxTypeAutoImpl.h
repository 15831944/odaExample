...
#ifndef _IFC4X2_IFCJUNCTIONBOXTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCJUNCTIONBOXTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcJunctionBoxType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcJunctionBoxType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcJunctionBoxType, IfcJunctionBoxType> object.
*/
typedef OdSmartPtr<IfcJunctionBoxType> IfcJunctionBoxTypePtr;

} // namespace

#endif // _IFC4X2_IFCJUNCTIONBOXTYPE_AUTO_IMPL_H
