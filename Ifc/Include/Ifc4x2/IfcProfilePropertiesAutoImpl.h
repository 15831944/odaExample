...
#ifndef _IFC4X2_IFCPROFILEPROPERTIES_AUTO_IMPL_H
#define _IFC4X2_IFCPROFILEPROPERTIES_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcProfileProperties : public IfcExtendedProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcProfileProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcProfileProperties, IfcProfileProperties> object.
*/
typedef OdSmartPtr<IfcProfileProperties> IfcProfilePropertiesPtr;

} // namespace

#endif // _IFC4X2_IFCPROFILEPROPERTIES_AUTO_IMPL_H
