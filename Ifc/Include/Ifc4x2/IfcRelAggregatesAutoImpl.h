...
#ifndef _IFC4X2_IFCRELAGGREGATES_AUTO_IMPL_H
#define _IFC4X2_IFCRELAGGREGATES_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRelAggregates : public IfcRelDecomposes
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRelAggregates);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRelAggregates, IfcRelAggregates> object.
*/
typedef OdSmartPtr<IfcRelAggregates> IfcRelAggregatesPtr;

} // namespace

#endif // _IFC4X2_IFCRELAGGREGATES_AUTO_IMPL_H
