...
#ifndef _IFC4X2_IFCAXIS2PLACEMENT3D_AUTO_IMPL_H
#define _IFC4X2_IFCAXIS2PLACEMENT3D_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcAxis2Placement3D : public IfcPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcAxis2Placement3D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcAxis2Placement3D, IfcAxis2Placement3D> object.
*/
typedef OdSmartPtr<IfcAxis2Placement3D> IfcAxis2Placement3DPtr;

} // namespace

#endif // _IFC4X2_IFCAXIS2PLACEMENT3D_AUTO_IMPL_H
