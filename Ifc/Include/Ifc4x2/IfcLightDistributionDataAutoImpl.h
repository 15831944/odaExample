...
#ifndef _IFC4X2_IFCLIGHTDISTRIBUTIONDATA_AUTO_IMPL_H
#define _IFC4X2_IFCLIGHTDISTRIBUTIONDATA_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcLightDistributionData : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcLightDistributionData);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcLightDistributionData, IfcLightDistributionData> object.
*/
typedef OdSmartPtr<IfcLightDistributionData> IfcLightDistributionDataPtr;

} // namespace

#endif // _IFC4X2_IFCLIGHTDISTRIBUTIONDATA_AUTO_IMPL_H
