...
#ifndef _IFC4X2_IFCFAN_AUTO_IMPL_H
#define _IFC4X2_IFCFAN_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcFan : public IfcFlowMovingDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcFan);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcFan, IfcFan> object.
*/
typedef OdSmartPtr<IfcFan> IfcFanPtr;

} // namespace

#endif // _IFC4X2_IFCFAN_AUTO_IMPL_H
