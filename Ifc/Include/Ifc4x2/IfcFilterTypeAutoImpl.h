...
#ifndef _IFC4X2_IFCFILTERTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCFILTERTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcFilterType : public IfcFlowTreatmentDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcFilterType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcFilterType, IfcFilterType> object.
*/
typedef OdSmartPtr<IfcFilterType> IfcFilterTypePtr;

} // namespace

#endif // _IFC4X2_IFCFILTERTYPE_AUTO_IMPL_H
