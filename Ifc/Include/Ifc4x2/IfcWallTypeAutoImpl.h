...
#ifndef _IFC4X2_IFCWALLTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCWALLTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcWallType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcWallType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcWallType, IfcWallType> object.
*/
typedef OdSmartPtr<IfcWallType> IfcWallTypePtr;

} // namespace

#endif // _IFC4X2_IFCWALLTYPE_AUTO_IMPL_H
