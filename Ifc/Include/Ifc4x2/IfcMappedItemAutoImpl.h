...
#ifndef _IFC4X2_IFCMAPPEDITEM_AUTO_IMPL_H
#define _IFC4X2_IFCMAPPEDITEM_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcMappedItem : public IfcRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcMappedItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcMappedItem, IfcMappedItem> object.
*/
typedef OdSmartPtr<IfcMappedItem> IfcMappedItemPtr;

} // namespace

#endif // _IFC4X2_IFCMAPPEDITEM_AUTO_IMPL_H
