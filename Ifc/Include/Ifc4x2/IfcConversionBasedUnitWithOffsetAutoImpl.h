...
#ifndef _IFC4X2_IFCCONVERSIONBASEDUNITWITHOFFSET_AUTO_IMPL_H
#define _IFC4X2_IFCCONVERSIONBASEDUNITWITHOFFSET_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcConversionBasedUnitWithOffset : public IfcConversionBasedUnit
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcConversionBasedUnitWithOffset);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcConversionBasedUnitWithOffset, IfcConversionBasedUnitWithOffset> object.
*/
typedef OdSmartPtr<IfcConversionBasedUnitWithOffset> IfcConversionBasedUnitWithOffsetPtr;

} // namespace

#endif // _IFC4X2_IFCCONVERSIONBASEDUNITWITHOFFSET_AUTO_IMPL_H
