...
#ifndef _IFC4X2_IFCRELASSOCIATES_AUTO_IMPL_H
#define _IFC4X2_IFCRELASSOCIATES_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRelAssociates : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcRelAssociates);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRelAssociates, IfcRelAssociates> object.
*/
typedef OdSmartPtr<IfcRelAssociates> IfcRelAssociatesPtr;

} // namespace

#endif // _IFC4X2_IFCRELASSOCIATES_AUTO_IMPL_H
