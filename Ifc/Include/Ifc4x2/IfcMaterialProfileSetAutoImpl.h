...
#ifndef _IFC4X2_IFCMATERIALPROFILESET_AUTO_IMPL_H
#define _IFC4X2_IFCMATERIALPROFILESET_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcMaterialProfileSet : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcMaterialProfileSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcMaterialProfileSet, IfcMaterialProfileSet> object.
*/
typedef OdSmartPtr<IfcMaterialProfileSet> IfcMaterialProfileSetPtr;

} // namespace

#endif // _IFC4X2_IFCMATERIALPROFILESET_AUTO_IMPL_H
