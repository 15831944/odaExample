...
#ifndef _IFC4X2_IFCBUILDING_AUTO_IMPL_H
#define _IFC4X2_IFCBUILDING_AUTO_IMPL_H
...
*/
class IFC4X2_EXPORT IfcBuilding : public IfcFacility
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcBuilding);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcBuilding, IfcBuilding> object.
*/
typedef OdSmartPtr<IfcBuilding> IfcBuildingPtr;

} // namespace

#endif // _IFC4X2_IFCBUILDING_AUTO_IMPL_H
