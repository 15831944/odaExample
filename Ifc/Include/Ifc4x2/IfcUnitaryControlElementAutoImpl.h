...
#ifndef _IFC4X2_IFCUNITARYCONTROLELEMENT_AUTO_IMPL_H
#define _IFC4X2_IFCUNITARYCONTROLELEMENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcUnitaryControlElement : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcUnitaryControlElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcUnitaryControlElement, IfcUnitaryControlElement> object.
*/
typedef OdSmartPtr<IfcUnitaryControlElement> IfcUnitaryControlElementPtr;

} // namespace

#endif // _IFC4X2_IFCUNITARYCONTROLELEMENT_AUTO_IMPL_H
