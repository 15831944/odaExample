...
#ifndef _IFC4X2_IFCTRIANGULATEDFACESET_AUTO_IMPL_H
#define _IFC4X2_IFCTRIANGULATEDFACESET_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTriangulatedFaceSet : public IfcTessellatedFaceSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTriangulatedFaceSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTriangulatedFaceSet, IfcTriangulatedFaceSet> object.
*/
typedef OdSmartPtr<IfcTriangulatedFaceSet> IfcTriangulatedFaceSetPtr;

} // namespace

#endif // _IFC4X2_IFCTRIANGULATEDFACESET_AUTO_IMPL_H
