...
#ifndef _IFC4X2_IFCQUANTITYWEIGHT_AUTO_IMPL_H
#define _IFC4X2_IFCQUANTITYWEIGHT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcQuantityWeight : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcQuantityWeight);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcQuantityWeight, IfcQuantityWeight> object.
*/
typedef OdSmartPtr<IfcQuantityWeight> IfcQuantityWeightPtr;

} // namespace

#endif // _IFC4X2_IFCQUANTITYWEIGHT_AUTO_IMPL_H
