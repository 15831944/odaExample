...
#ifndef _IFC4X2_IFCFIXEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
#define _IFC4X2_IFCFIXEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcFixedReferenceSweptAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcFixedReferenceSweptAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcFixedReferenceSweptAreaSolid, IfcFixedReferenceSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcFixedReferenceSweptAreaSolid> IfcFixedReferenceSweptAreaSolidPtr;

} // namespace

#endif // _IFC4X2_IFCFIXEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
