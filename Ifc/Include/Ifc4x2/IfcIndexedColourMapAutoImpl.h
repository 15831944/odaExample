...
#ifndef _IFC4X2_IFCINDEXEDCOLOURMAP_AUTO_IMPL_H
#define _IFC4X2_IFCINDEXEDCOLOURMAP_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcIndexedColourMap : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcIndexedColourMap);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcIndexedColourMap, IfcIndexedColourMap> object.
*/
typedef OdSmartPtr<IfcIndexedColourMap> IfcIndexedColourMapPtr;

} // namespace

#endif // _IFC4X2_IFCINDEXEDCOLOURMAP_AUTO_IMPL_H
