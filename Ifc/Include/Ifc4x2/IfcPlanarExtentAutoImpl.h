...
#ifndef _IFC4X2_IFCPLANAREXTENT_AUTO_IMPL_H
#define _IFC4X2_IFCPLANAREXTENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPlanarExtent : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcPlanarExtent);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPlanarExtent, IfcPlanarExtent> object.
*/
typedef OdSmartPtr<IfcPlanarExtent> IfcPlanarExtentPtr;

} // namespace

#endif // _IFC4X2_IFCPLANAREXTENT_AUTO_IMPL_H
