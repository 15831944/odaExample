...
#ifndef _IFC4X2_IFCCONNECTIONPOINTGEOMETRY_AUTO_IMPL_H
#define _IFC4X2_IFCCONNECTIONPOINTGEOMETRY_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcConnectionPointGeometry : public IfcConnectionGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcConnectionPointGeometry);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcConnectionPointGeometry, IfcConnectionPointGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionPointGeometry> IfcConnectionPointGeometryPtr;

} // namespace

#endif // _IFC4X2_IFCCONNECTIONPOINTGEOMETRY_AUTO_IMPL_H
