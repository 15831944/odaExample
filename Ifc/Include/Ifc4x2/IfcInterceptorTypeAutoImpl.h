...
#ifndef _IFC4X2_IFCINTERCEPTORTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCINTERCEPTORTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcInterceptorType : public IfcFlowTreatmentDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcInterceptorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcInterceptorType, IfcInterceptorType> object.
*/
typedef OdSmartPtr<IfcInterceptorType> IfcInterceptorTypePtr;

} // namespace

#endif // _IFC4X2_IFCINTERCEPTORTYPE_AUTO_IMPL_H
