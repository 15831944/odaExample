...
#ifndef _IFC4X2_IFCGEOGRAPHICELEMENT_AUTO_IMPL_H
#define _IFC4X2_IFCGEOGRAPHICELEMENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcGeographicElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcGeographicElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcGeographicElement, IfcGeographicElement> object.
*/
typedef OdSmartPtr<IfcGeographicElement> IfcGeographicElementPtr;

} // namespace

#endif // _IFC4X2_IFCGEOGRAPHICELEMENT_AUTO_IMPL_H
