...
#ifndef _IFC4X2_IFCCOLUMNTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCCOLUMNTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcColumnType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcColumnType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcColumnType, IfcColumnType> object.
*/
typedef OdSmartPtr<IfcColumnType> IfcColumnTypePtr;

} // namespace

#endif // _IFC4X2_IFCCOLUMNTYPE_AUTO_IMPL_H
