...
#ifndef _IFC4X2_IFCPRESENTATIONSTYLE_AUTO_IMPL_H
#define _IFC4X2_IFCPRESENTATIONSTYLE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPresentationStyle : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcPresentationStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPresentationStyle, IfcPresentationStyle> object.
*/
typedef OdSmartPtr<IfcPresentationStyle> IfcPresentationStylePtr;

} // namespace

#endif // _IFC4X2_IFCPRESENTATIONSTYLE_AUTO_IMPL_H
