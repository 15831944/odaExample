...
#ifndef _IFC4X2_IFCREINFORCINGMESH_AUTO_IMPL_H
#define _IFC4X2_IFCREINFORCINGMESH_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcReinforcingMesh : public IfcReinforcingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcReinforcingMesh);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcReinforcingMesh, IfcReinforcingMesh> object.
*/
typedef OdSmartPtr<IfcReinforcingMesh> IfcReinforcingMeshPtr;

} // namespace

#endif // _IFC4X2_IFCREINFORCINGMESH_AUTO_IMPL_H
