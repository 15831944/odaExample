...
#ifndef _IFC4X2_IFCMATERIALCONSTITUENT_AUTO_IMPL_H
#define _IFC4X2_IFCMATERIALCONSTITUENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcMaterialConstituent : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcMaterialConstituent);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcMaterialConstituent, IfcMaterialConstituent> object.
*/
typedef OdSmartPtr<IfcMaterialConstituent> IfcMaterialConstituentPtr;

} // namespace

#endif // _IFC4X2_IFCMATERIALCONSTITUENT_AUTO_IMPL_H
