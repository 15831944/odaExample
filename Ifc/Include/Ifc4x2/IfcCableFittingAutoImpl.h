...
#ifndef _IFC4X2_IFCCABLEFITTING_AUTO_IMPL_H
#define _IFC4X2_IFCCABLEFITTING_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCableFitting : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCableFitting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCableFitting, IfcCableFitting> object.
*/
typedef OdSmartPtr<IfcCableFitting> IfcCableFittingPtr;

} // namespace

#endif // _IFC4X2_IFCCABLEFITTING_AUTO_IMPL_H
