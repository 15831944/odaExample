...
#ifndef _IFC4X2_IFCRELCOVERSBLDGELEMENTS_AUTO_IMPL_H
#define _IFC4X2_IFCRELCOVERSBLDGELEMENTS_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRelCoversBldgElements : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRelCoversBldgElements);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRelCoversBldgElements, IfcRelCoversBldgElements> object.
*/
typedef OdSmartPtr<IfcRelCoversBldgElements> IfcRelCoversBldgElementsPtr;

} // namespace

#endif // _IFC4X2_IFCRELCOVERSBLDGELEMENTS_AUTO_IMPL_H
