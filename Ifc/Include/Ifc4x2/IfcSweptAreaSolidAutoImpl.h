...
#ifndef _IFC4X2_IFCSWEPTAREASOLID_AUTO_IMPL_H
#define _IFC4X2_IFCSWEPTAREASOLID_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSweptAreaSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcSweptAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSweptAreaSolid, IfcSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcSweptAreaSolid> IfcSweptAreaSolidPtr;

} // namespace

#endif // _IFC4X2_IFCSWEPTAREASOLID_AUTO_IMPL_H
