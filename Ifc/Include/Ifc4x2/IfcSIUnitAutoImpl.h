...
#ifndef _IFC4X2_IFCSIUNIT_AUTO_IMPL_H
#define _IFC4X2_IFCSIUNIT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSIUnit : public IfcNamedUnit
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSIUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSIUnit, IfcSIUnit> object.
*/
typedef OdSmartPtr<IfcSIUnit> IfcSIUnitPtr;

} // namespace

#endif // _IFC4X2_IFCSIUNIT_AUTO_IMPL_H
