...
#ifndef _IFC4X2_IFCTESSELLATEDFACESET_AUTO_IMPL_H
#define _IFC4X2_IFCTESSELLATEDFACESET_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTessellatedFaceSet : public IfcTessellatedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcTessellatedFaceSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTessellatedFaceSet, IfcTessellatedFaceSet> object.
*/
typedef OdSmartPtr<IfcTessellatedFaceSet> IfcTessellatedFaceSetPtr;

} // namespace

#endif // _IFC4X2_IFCTESSELLATEDFACESET_AUTO_IMPL_H
