...
#ifndef _IFC4X2_IFCCONTEXTDEPENDENTUNIT_AUTO_IMPL_H
#define _IFC4X2_IFCCONTEXTDEPENDENTUNIT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcContextDependentUnit : public IfcNamedUnit
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcContextDependentUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcContextDependentUnit, IfcContextDependentUnit> object.
*/
typedef OdSmartPtr<IfcContextDependentUnit> IfcContextDependentUnitPtr;

} // namespace

#endif // _IFC4X2_IFCCONTEXTDEPENDENTUNIT_AUTO_IMPL_H
