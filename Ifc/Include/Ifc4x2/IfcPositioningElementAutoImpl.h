...
#ifndef _IFC4X2_IFCPOSITIONINGELEMENT_AUTO_IMPL_H
#define _IFC4X2_IFCPOSITIONINGELEMENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPositioningElement : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcPositioningElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPositioningElement, IfcPositioningElement> object.
*/
typedef OdSmartPtr<IfcPositioningElement> IfcPositioningElementPtr;

} // namespace

#endif // _IFC4X2_IFCPOSITIONINGELEMENT_AUTO_IMPL_H
