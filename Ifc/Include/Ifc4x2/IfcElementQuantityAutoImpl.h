...
#ifndef _IFC4X2_IFCELEMENTQUANTITY_AUTO_IMPL_H
#define _IFC4X2_IFCELEMENTQUANTITY_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcElementQuantity : public IfcQuantitySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcElementQuantity);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcElementQuantity, IfcElementQuantity> object.
*/
typedef OdSmartPtr<IfcElementQuantity> IfcElementQuantityPtr;

} // namespace

#endif // _IFC4X2_IFCELEMENTQUANTITY_AUTO_IMPL_H
