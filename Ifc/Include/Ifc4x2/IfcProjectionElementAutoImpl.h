...
#ifndef _IFC4X2_IFCPROJECTIONELEMENT_AUTO_IMPL_H
#define _IFC4X2_IFCPROJECTIONELEMENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcProjectionElement : public IfcFeatureElementAddition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcProjectionElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcProjectionElement, IfcProjectionElement> object.
*/
typedef OdSmartPtr<IfcProjectionElement> IfcProjectionElementPtr;

} // namespace

#endif // _IFC4X2_IFCPROJECTIONELEMENT_AUTO_IMPL_H
