...
#ifndef _IFC4X2_IFCACTIONREQUEST_AUTO_IMPL_H
#define _IFC4X2_IFCACTIONREQUEST_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcActionRequest : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcActionRequest);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcActionRequest, IfcActionRequest> object.
*/
typedef OdSmartPtr<IfcActionRequest> IfcActionRequestPtr;

} // namespace

#endif // _IFC4X2_IFCACTIONREQUEST_AUTO_IMPL_H
