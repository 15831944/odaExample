...
#ifndef _IFC4X2_IFCPERMIT_AUTO_IMPL_H
#define _IFC4X2_IFCPERMIT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPermit : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcPermit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPermit, IfcPermit> object.
*/
typedef OdSmartPtr<IfcPermit> IfcPermitPtr;

} // namespace

#endif // _IFC4X2_IFCPERMIT_AUTO_IMPL_H
