...
#ifndef _IFC4X2_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
#define _IFC4X2_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPermeableCoveringProperties : public IfcPreDefinedPropertySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcPermeableCoveringProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPermeableCoveringProperties, IfcPermeableCoveringProperties> object.
*/
typedef OdSmartPtr<IfcPermeableCoveringProperties> IfcPermeableCoveringPropertiesPtr;

} // namespace

#endif // _IFC4X2_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
