...
#ifndef _IFC4X2_IFCFASTENERTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCFASTENERTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcFastenerType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcFastenerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcFastenerType, IfcFastenerType> object.
*/
typedef OdSmartPtr<IfcFastenerType> IfcFastenerTypePtr;

} // namespace

#endif // _IFC4X2_IFCFASTENERTYPE_AUTO_IMPL_H
