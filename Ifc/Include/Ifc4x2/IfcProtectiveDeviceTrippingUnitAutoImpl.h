...
#ifndef _IFC4X2_IFCPROTECTIVEDEVICETRIPPINGUNIT_AUTO_IMPL_H
#define _IFC4X2_IFCPROTECTIVEDEVICETRIPPINGUNIT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcProtectiveDeviceTrippingUnit : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcProtectiveDeviceTrippingUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcProtectiveDeviceTrippingUnit, IfcProtectiveDeviceTrippingUnit> object.
*/
typedef OdSmartPtr<IfcProtectiveDeviceTrippingUnit> IfcProtectiveDeviceTrippingUnitPtr;

} // namespace

#endif // _IFC4X2_IFCPROTECTIVEDEVICETRIPPINGUNIT_AUTO_IMPL_H
