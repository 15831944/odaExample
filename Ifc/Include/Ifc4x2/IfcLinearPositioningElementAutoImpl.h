...
#ifndef _IFC4X2_IFCLINEARPOSITIONINGELEMENT_AUTO_IMPL_H
#define _IFC4X2_IFCLINEARPOSITIONINGELEMENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcLinearPositioningElement : public IfcPositioningElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcLinearPositioningElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcLinearPositioningElement, IfcLinearPositioningElement> object.
*/
typedef OdSmartPtr<IfcLinearPositioningElement> IfcLinearPositioningElementPtr;

} // namespace

#endif // _IFC4X2_IFCLINEARPOSITIONINGELEMENT_AUTO_IMPL_H
