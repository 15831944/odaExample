...
#ifndef _IFC4X2_IFCSHADINGDEVICETYPE_AUTO_IMPL_H
#define _IFC4X2_IFCSHADINGDEVICETYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcShadingDeviceType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcShadingDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcShadingDeviceType, IfcShadingDeviceType> object.
*/
typedef OdSmartPtr<IfcShadingDeviceType> IfcShadingDeviceTypePtr;

} // namespace

#endif // _IFC4X2_IFCSHADINGDEVICETYPE_AUTO_IMPL_H
