...
#ifndef _IFC4X2_IFCSENSORTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCSENSORTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSensorType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSensorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSensorType, IfcSensorType> object.
*/
typedef OdSmartPtr<IfcSensorType> IfcSensorTypePtr;

} // namespace

#endif // _IFC4X2_IFCSENSORTYPE_AUTO_IMPL_H
