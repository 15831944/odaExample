...
#ifndef _IFC4X2_IFCTANK_AUTO_IMPL_H
#define _IFC4X2_IFCTANK_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTank : public IfcFlowStorageDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTank);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTank, IfcTank> object.
*/
typedef OdSmartPtr<IfcTank> IfcTankPtr;

} // namespace

#endif // _IFC4X2_IFCTANK_AUTO_IMPL_H
