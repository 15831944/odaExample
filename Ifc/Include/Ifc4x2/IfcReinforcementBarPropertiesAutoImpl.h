...
#ifndef _IFC4X2_IFCREINFORCEMENTBARPROPERTIES_AUTO_IMPL_H
#define _IFC4X2_IFCREINFORCEMENTBARPROPERTIES_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcReinforcementBarProperties : public IfcPreDefinedProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcReinforcementBarProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcReinforcementBarProperties, IfcReinforcementBarProperties> object.
*/
typedef OdSmartPtr<IfcReinforcementBarProperties> IfcReinforcementBarPropertiesPtr;

} // namespace

#endif // _IFC4X2_IFCREINFORCEMENTBARPROPERTIES_AUTO_IMPL_H
