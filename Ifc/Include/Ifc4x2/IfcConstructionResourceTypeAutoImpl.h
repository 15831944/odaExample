...
#ifndef _IFC4X2_IFCCONSTRUCTIONRESOURCETYPE_AUTO_IMPL_H
#define _IFC4X2_IFCCONSTRUCTIONRESOURCETYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcConstructionResourceType : public IfcTypeResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcConstructionResourceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcConstructionResourceType, IfcConstructionResourceType> object.
*/
typedef OdSmartPtr<IfcConstructionResourceType> IfcConstructionResourceTypePtr;

} // namespace

#endif // _IFC4X2_IFCCONSTRUCTIONRESOURCETYPE_AUTO_IMPL_H
