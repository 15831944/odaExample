...
#ifndef _IFC4X2_IFCEVAPORATORTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCEVAPORATORTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcEvaporatorType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcEvaporatorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcEvaporatorType, IfcEvaporatorType> object.
*/
typedef OdSmartPtr<IfcEvaporatorType> IfcEvaporatorTypePtr;

} // namespace

#endif // _IFC4X2_IFCEVAPORATORTYPE_AUTO_IMPL_H
