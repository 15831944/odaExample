...
#ifndef _IFC4X2_IFCQUANTITYVOLUME_AUTO_IMPL_H
#define _IFC4X2_IFCQUANTITYVOLUME_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcQuantityVolume : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcQuantityVolume);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcQuantityVolume, IfcQuantityVolume> object.
*/
typedef OdSmartPtr<IfcQuantityVolume> IfcQuantityVolumePtr;

} // namespace

#endif // _IFC4X2_IFCQUANTITYVOLUME_AUTO_IMPL_H
