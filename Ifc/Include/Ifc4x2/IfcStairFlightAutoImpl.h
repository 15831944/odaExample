...
#ifndef _IFC4X2_IFCSTAIRFLIGHT_AUTO_IMPL_H
#define _IFC4X2_IFCSTAIRFLIGHT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcStairFlight : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcStairFlight);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcStairFlight, IfcStairFlight> object.
*/
typedef OdSmartPtr<IfcStairFlight> IfcStairFlightPtr;

} // namespace

#endif // _IFC4X2_IFCSTAIRFLIGHT_AUTO_IMPL_H
