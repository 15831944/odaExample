...
#ifndef _IFC4X2_IFCLIGHTSOURCE_AUTO_IMPL_H
#define _IFC4X2_IFCLIGHTSOURCE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcLightSource : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcLightSource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcLightSource, IfcLightSource> object.
*/
typedef OdSmartPtr<IfcLightSource> IfcLightSourcePtr;

} // namespace

#endif // _IFC4X2_IFCLIGHTSOURCE_AUTO_IMPL_H
