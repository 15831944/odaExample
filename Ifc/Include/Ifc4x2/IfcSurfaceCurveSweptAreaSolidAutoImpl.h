...
#ifndef _IFC4X2_IFCSURFACECURVESWEPTAREASOLID_AUTO_IMPL_H
#define _IFC4X2_IFCSURFACECURVESWEPTAREASOLID_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSurfaceCurveSweptAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSurfaceCurveSweptAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSurfaceCurveSweptAreaSolid, IfcSurfaceCurveSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcSurfaceCurveSweptAreaSolid> IfcSurfaceCurveSweptAreaSolidPtr;

} // namespace

#endif // _IFC4X2_IFCSURFACECURVESWEPTAREASOLID_AUTO_IMPL_H
