...
#ifndef _IFC4X2_IFCTABLECOLUMN_AUTO_IMPL_H
#define _IFC4X2_IFCTABLECOLUMN_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTableColumn : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTableColumn);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTableColumn, IfcTableColumn> object.
*/
typedef OdSmartPtr<IfcTableColumn> IfcTableColumnPtr;

} // namespace

#endif // _IFC4X2_IFCTABLECOLUMN_AUTO_IMPL_H
