...
#ifndef _IFC4X2_IFCADVANCEDBREPWITHVOIDS_AUTO_IMPL_H
#define _IFC4X2_IFCADVANCEDBREPWITHVOIDS_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcAdvancedBrepWithVoids : public IfcAdvancedBrep
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcAdvancedBrepWithVoids);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcAdvancedBrepWithVoids, IfcAdvancedBrepWithVoids> object.
*/
typedef OdSmartPtr<IfcAdvancedBrepWithVoids> IfcAdvancedBrepWithVoidsPtr;

} // namespace

#endif // _IFC4X2_IFCADVANCEDBREPWITHVOIDS_AUTO_IMPL_H
