...
#ifndef _IFC4X2_IFCGROUP_AUTO_IMPL_H
#define _IFC4X2_IFCGROUP_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcGroup : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcGroup);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcGroup, IfcGroup> object.
*/
typedef OdSmartPtr<IfcGroup> IfcGroupPtr;

} // namespace

#endif // _IFC4X2_IFCGROUP_AUTO_IMPL_H
