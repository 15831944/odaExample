...
#ifndef _IFC4X2_IFCBEARINGTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCBEARINGTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcBearingType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcBearingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcBearingType, IfcBearingType> object.
*/
typedef OdSmartPtr<IfcBearingType> IfcBearingTypePtr;

} // namespace

#endif // _IFC4X2_IFCBEARINGTYPE_AUTO_IMPL_H
