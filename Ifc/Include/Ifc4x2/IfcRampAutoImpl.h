...
#ifndef _IFC4X2_IFCRAMP_AUTO_IMPL_H
#define _IFC4X2_IFCRAMP_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRamp : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRamp);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRamp, IfcRamp> object.
*/
typedef OdSmartPtr<IfcRamp> IfcRampPtr;

} // namespace

#endif // _IFC4X2_IFCRAMP_AUTO_IMPL_H
