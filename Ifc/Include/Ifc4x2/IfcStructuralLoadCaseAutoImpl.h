...
#ifndef _IFC4X2_IFCSTRUCTURALLOADCASE_AUTO_IMPL_H
#define _IFC4X2_IFCSTRUCTURALLOADCASE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcStructuralLoadCase : public IfcStructuralLoadGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcStructuralLoadCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcStructuralLoadCase, IfcStructuralLoadCase> object.
*/
typedef OdSmartPtr<IfcStructuralLoadCase> IfcStructuralLoadCasePtr;

} // namespace

#endif // _IFC4X2_IFCSTRUCTURALLOADCASE_AUTO_IMPL_H
