...
#ifndef _IFC4X2_IFCDUCTSEGMENTTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCDUCTSEGMENTTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcDuctSegmentType : public IfcFlowSegmentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcDuctSegmentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcDuctSegmentType, IfcDuctSegmentType> object.
*/
typedef OdSmartPtr<IfcDuctSegmentType> IfcDuctSegmentTypePtr;

} // namespace

#endif // _IFC4X2_IFCDUCTSEGMENTTYPE_AUTO_IMPL_H
