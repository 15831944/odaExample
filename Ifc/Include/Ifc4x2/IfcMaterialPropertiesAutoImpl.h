...
#ifndef _IFC4X2_IFCMATERIALPROPERTIES_AUTO_IMPL_H
#define _IFC4X2_IFCMATERIALPROPERTIES_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcMaterialProperties : public IfcExtendedProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcMaterialProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcMaterialProperties, IfcMaterialProperties> object.
*/
typedef OdSmartPtr<IfcMaterialProperties> IfcMaterialPropertiesPtr;

} // namespace

#endif // _IFC4X2_IFCMATERIALPROPERTIES_AUTO_IMPL_H
