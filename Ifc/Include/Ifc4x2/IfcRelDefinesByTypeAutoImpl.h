...
#ifndef _IFC4X2_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRelDefinesByType : public IfcRelDefines
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRelDefinesByType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRelDefinesByType, IfcRelDefinesByType> object.
*/
typedef OdSmartPtr<IfcRelDefinesByType> IfcRelDefinesByTypePtr;

} // namespace

#endif // _IFC4X2_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
