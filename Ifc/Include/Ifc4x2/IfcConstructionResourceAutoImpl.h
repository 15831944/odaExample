...
#ifndef _IFC4X2_IFCCONSTRUCTIONRESOURCE_AUTO_IMPL_H
#define _IFC4X2_IFCCONSTRUCTIONRESOURCE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcConstructionResource : public IfcResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcConstructionResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcConstructionResource, IfcConstructionResource> object.
*/
typedef OdSmartPtr<IfcConstructionResource> IfcConstructionResourcePtr;

} // namespace

#endif // _IFC4X2_IFCCONSTRUCTIONRESOURCE_AUTO_IMPL_H
