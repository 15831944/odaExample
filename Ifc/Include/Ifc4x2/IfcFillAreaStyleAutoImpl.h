...
#ifndef _IFC4X2_IFCFILLAREASTYLE_AUTO_IMPL_H
#define _IFC4X2_IFCFILLAREASTYLE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcFillAreaStyle : public IfcPresentationStyle
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcFillAreaStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcFillAreaStyle, IfcFillAreaStyle> object.
*/
typedef OdSmartPtr<IfcFillAreaStyle> IfcFillAreaStylePtr;

} // namespace

#endif // _IFC4X2_IFCFILLAREASTYLE_AUTO_IMPL_H
