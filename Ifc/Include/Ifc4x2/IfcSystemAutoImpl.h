...
#ifndef _IFC4X2_IFCSYSTEM_AUTO_IMPL_H
#define _IFC4X2_IFCSYSTEM_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSystem : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSystem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSystem, IfcSystem> object.
*/
typedef OdSmartPtr<IfcSystem> IfcSystemPtr;

} // namespace

#endif // _IFC4X2_IFCSYSTEM_AUTO_IMPL_H
