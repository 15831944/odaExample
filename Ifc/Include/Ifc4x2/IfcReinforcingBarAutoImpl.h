...
#ifndef _IFC4X2_IFCREINFORCINGBAR_AUTO_IMPL_H
#define _IFC4X2_IFCREINFORCINGBAR_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcReinforcingBar : public IfcReinforcingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcReinforcingBar);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcReinforcingBar, IfcReinforcingBar> object.
*/
typedef OdSmartPtr<IfcReinforcingBar> IfcReinforcingBarPtr;

} // namespace

#endif // _IFC4X2_IFCREINFORCINGBAR_AUTO_IMPL_H
