...
#ifndef _IFC4X2_IFCAIRTERMINALBOX_AUTO_IMPL_H
#define _IFC4X2_IFCAIRTERMINALBOX_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcAirTerminalBox : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcAirTerminalBox);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcAirTerminalBox, IfcAirTerminalBox> object.
*/
typedef OdSmartPtr<IfcAirTerminalBox> IfcAirTerminalBoxPtr;

} // namespace

#endif // _IFC4X2_IFCAIRTERMINALBOX_AUTO_IMPL_H
