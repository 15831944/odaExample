...
#ifndef _IFC4X2_IFCSANITARYTERMINAL_AUTO_IMPL_H
#define _IFC4X2_IFCSANITARYTERMINAL_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSanitaryTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSanitaryTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSanitaryTerminal, IfcSanitaryTerminal> object.
*/
typedef OdSmartPtr<IfcSanitaryTerminal> IfcSanitaryTerminalPtr;

} // namespace

#endif // _IFC4X2_IFCSANITARYTERMINAL_AUTO_IMPL_H
