...
#ifndef _IFC4X2_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRampFlightType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRampFlightType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRampFlightType, IfcRampFlightType> object.
*/
typedef OdSmartPtr<IfcRampFlightType> IfcRampFlightTypePtr;

} // namespace

#endif // _IFC4X2_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
