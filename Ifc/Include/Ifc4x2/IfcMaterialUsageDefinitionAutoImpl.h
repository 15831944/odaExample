...
#ifndef _IFC4X2_IFCMATERIALUSAGEDEFINITION_AUTO_IMPL_H
#define _IFC4X2_IFCMATERIALUSAGEDEFINITION_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcMaterialUsageDefinition : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcMaterialUsageDefinition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcMaterialUsageDefinition, IfcMaterialUsageDefinition> object.
*/
typedef OdSmartPtr<IfcMaterialUsageDefinition> IfcMaterialUsageDefinitionPtr;

} // namespace

#endif // _IFC4X2_IFCMATERIALUSAGEDEFINITION_AUTO_IMPL_H
