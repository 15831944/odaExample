...
#ifndef _IFC4X2_IFCSTAIRTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCSTAIRTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcStairType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcStairType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcStairType, IfcStairType> object.
*/
typedef OdSmartPtr<IfcStairType> IfcStairTypePtr;

} // namespace

#endif // _IFC4X2_IFCSTAIRTYPE_AUTO_IMPL_H
