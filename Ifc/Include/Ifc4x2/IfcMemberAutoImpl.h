...
#ifndef _IFC4X2_IFCMEMBER_AUTO_IMPL_H
#define _IFC4X2_IFCMEMBER_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcMember : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcMember);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcMember, IfcMember> object.
*/
typedef OdSmartPtr<IfcMember> IfcMemberPtr;

} // namespace

#endif // _IFC4X2_IFCMEMBER_AUTO_IMPL_H
