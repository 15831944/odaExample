...
#ifndef _IFC4X2_IFCIMAGETEXTURE_AUTO_IMPL_H
#define _IFC4X2_IFCIMAGETEXTURE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcImageTexture : public IfcSurfaceTexture
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcImageTexture);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcImageTexture, IfcImageTexture> object.
*/
typedef OdSmartPtr<IfcImageTexture> IfcImageTexturePtr;

} // namespace

#endif // _IFC4X2_IFCIMAGETEXTURE_AUTO_IMPL_H
