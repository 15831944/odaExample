...
#ifndef _IFC4X2_IFCCURTAINWALL_AUTO_IMPL_H
#define _IFC4X2_IFCCURTAINWALL_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCurtainWall : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCurtainWall);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCurtainWall, IfcCurtainWall> object.
*/
typedef OdSmartPtr<IfcCurtainWall> IfcCurtainWallPtr;

} // namespace

#endif // _IFC4X2_IFCCURTAINWALL_AUTO_IMPL_H
