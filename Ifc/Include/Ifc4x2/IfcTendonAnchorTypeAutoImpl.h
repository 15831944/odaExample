...
#ifndef _IFC4X2_IFCTENDONANCHORTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCTENDONANCHORTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTendonAnchorType : public IfcReinforcingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTendonAnchorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTendonAnchorType, IfcTendonAnchorType> object.
*/
typedef OdSmartPtr<IfcTendonAnchorType> IfcTendonAnchorTypePtr;

} // namespace

#endif // _IFC4X2_IFCTENDONANCHORTYPE_AUTO_IMPL_H
