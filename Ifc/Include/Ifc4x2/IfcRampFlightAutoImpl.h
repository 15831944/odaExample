...
#ifndef _IFC4X2_IFCRAMPFLIGHT_AUTO_IMPL_H
#define _IFC4X2_IFCRAMPFLIGHT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRampFlight : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRampFlight);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRampFlight, IfcRampFlight> object.
*/
typedef OdSmartPtr<IfcRampFlight> IfcRampFlightPtr;

} // namespace

#endif // _IFC4X2_IFCRAMPFLIGHT_AUTO_IMPL_H
