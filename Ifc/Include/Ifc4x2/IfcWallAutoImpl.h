...
#ifndef _IFC4X2_IFCWALL_AUTO_IMPL_H
#define _IFC4X2_IFCWALL_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcWall : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcWall);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcWall, IfcWall> object.
*/
typedef OdSmartPtr<IfcWall> IfcWallPtr;

} // namespace

#endif // _IFC4X2_IFCWALL_AUTO_IMPL_H
