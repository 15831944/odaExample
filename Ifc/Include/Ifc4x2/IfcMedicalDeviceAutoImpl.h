...
#ifndef _IFC4X2_IFCMEDICALDEVICE_AUTO_IMPL_H
#define _IFC4X2_IFCMEDICALDEVICE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcMedicalDevice : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcMedicalDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcMedicalDevice, IfcMedicalDevice> object.
*/
typedef OdSmartPtr<IfcMedicalDevice> IfcMedicalDevicePtr;

} // namespace

#endif // _IFC4X2_IFCMEDICALDEVICE_AUTO_IMPL_H
