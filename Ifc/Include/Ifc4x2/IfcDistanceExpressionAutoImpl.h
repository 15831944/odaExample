...
#ifndef _IFC4X2_IFCDISTANCEEXPRESSION_AUTO_IMPL_H
#define _IFC4X2_IFCDISTANCEEXPRESSION_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcDistanceExpression : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcDistanceExpression);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcDistanceExpression, IfcDistanceExpression> object.
*/
typedef OdSmartPtr<IfcDistanceExpression> IfcDistanceExpressionPtr;

} // namespace

#endif // _IFC4X2_IFCDISTANCEEXPRESSION_AUTO_IMPL_H
