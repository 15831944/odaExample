...
#ifndef _IFC4X2_IFCSCHEDULINGTIME_AUTO_IMPL_H
#define _IFC4X2_IFCSCHEDULINGTIME_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSchedulingTime : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcSchedulingTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSchedulingTime, IfcSchedulingTime> object.
*/
typedef OdSmartPtr<IfcSchedulingTime> IfcSchedulingTimePtr;

} // namespace

#endif // _IFC4X2_IFCSCHEDULINGTIME_AUTO_IMPL_H
