...
#ifndef _IFC4X2_IFCSTRUCTURALRESULTGROUP_AUTO_IMPL_H
#define _IFC4X2_IFCSTRUCTURALRESULTGROUP_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcStructuralResultGroup : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcStructuralResultGroup);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcStructuralResultGroup, IfcStructuralResultGroup> object.
*/
typedef OdSmartPtr<IfcStructuralResultGroup> IfcStructuralResultGroupPtr;

} // namespace

#endif // _IFC4X2_IFCSTRUCTURALRESULTGROUP_AUTO_IMPL_H
