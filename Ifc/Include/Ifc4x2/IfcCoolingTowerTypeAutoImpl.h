...
#ifndef _IFC4X2_IFCCOOLINGTOWERTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCCOOLINGTOWERTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCoolingTowerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCoolingTowerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCoolingTowerType, IfcCoolingTowerType> object.
*/
typedef OdSmartPtr<IfcCoolingTowerType> IfcCoolingTowerTypePtr;

} // namespace

#endif // _IFC4X2_IFCCOOLINGTOWERTYPE_AUTO_IMPL_H
