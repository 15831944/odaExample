...
#ifndef _IFC4X2_IFCMATERIALRELATIONSHIP_AUTO_IMPL_H
#define _IFC4X2_IFCMATERIALRELATIONSHIP_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcMaterialRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcMaterialRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcMaterialRelationship, IfcMaterialRelationship> object.
*/
typedef OdSmartPtr<IfcMaterialRelationship> IfcMaterialRelationshipPtr;

} // namespace

#endif // _IFC4X2_IFCMATERIALRELATIONSHIP_AUTO_IMPL_H
