...
#ifndef _IFC4X2_IFCCOVERING_AUTO_IMPL_H
#define _IFC4X2_IFCCOVERING_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCovering : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCovering);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCovering, IfcCovering> object.
*/
typedef OdSmartPtr<IfcCovering> IfcCoveringPtr;

} // namespace

#endif // _IFC4X2_IFCCOVERING_AUTO_IMPL_H
