...
#ifndef _IFC4X2_IFCFASTENER_AUTO_IMPL_H
#define _IFC4X2_IFCFASTENER_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcFastener : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcFastener);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcFastener, IfcFastener> object.
*/
typedef OdSmartPtr<IfcFastener> IfcFastenerPtr;

} // namespace

#endif // _IFC4X2_IFCFASTENER_AUTO_IMPL_H
