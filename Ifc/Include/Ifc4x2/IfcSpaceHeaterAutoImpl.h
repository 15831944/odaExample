...
#ifndef _IFC4X2_IFCSPACEHEATER_AUTO_IMPL_H
#define _IFC4X2_IFCSPACEHEATER_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSpaceHeater : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSpaceHeater);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSpaceHeater, IfcSpaceHeater> object.
*/
typedef OdSmartPtr<IfcSpaceHeater> IfcSpaceHeaterPtr;

} // namespace

#endif // _IFC4X2_IFCSPACEHEATER_AUTO_IMPL_H
