...
#ifndef _IFC4X2_IFCCOMPOSITECURVESEGMENT_AUTO_IMPL_H
#define _IFC4X2_IFCCOMPOSITECURVESEGMENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCompositeCurveSegment : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCompositeCurveSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCompositeCurveSegment, IfcCompositeCurveSegment> object.
*/
typedef OdSmartPtr<IfcCompositeCurveSegment> IfcCompositeCurveSegmentPtr;

} // namespace

#endif // _IFC4X2_IFCCOMPOSITECURVESEGMENT_AUTO_IMPL_H
