...
#ifndef _IFC4X2_IFCTASKTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCTASKTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTaskType : public IfcTypeProcess
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTaskType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTaskType, IfcTaskType> object.
*/
typedef OdSmartPtr<IfcTaskType> IfcTaskTypePtr;

} // namespace

#endif // _IFC4X2_IFCTASKTYPE_AUTO_IMPL_H
