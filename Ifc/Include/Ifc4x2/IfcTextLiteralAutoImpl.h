...
#ifndef _IFC4X2_IFCTEXTLITERAL_AUTO_IMPL_H
#define _IFC4X2_IFCTEXTLITERAL_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTextLiteral : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTextLiteral);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTextLiteral, IfcTextLiteral> object.
*/
typedef OdSmartPtr<IfcTextLiteral> IfcTextLiteralPtr;

} // namespace

#endif // _IFC4X2_IFCTEXTLITERAL_AUTO_IMPL_H
