...
#ifndef _IFC4X2_IFCTENDONCONDUITTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCTENDONCONDUITTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTendonConduitType : public IfcReinforcingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTendonConduitType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTendonConduitType, IfcTendonConduitType> object.
*/
typedef OdSmartPtr<IfcTendonConduitType> IfcTendonConduitTypePtr;

} // namespace

#endif // _IFC4X2_IFCTENDONCONDUITTYPE_AUTO_IMPL_H
