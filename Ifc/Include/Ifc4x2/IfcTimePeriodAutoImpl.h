...
#ifndef _IFC4X2_IFCTIMEPERIOD_AUTO_IMPL_H
#define _IFC4X2_IFCTIMEPERIOD_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTimePeriod : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTimePeriod);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTimePeriod, IfcTimePeriod> object.
*/
typedef OdSmartPtr<IfcTimePeriod> IfcTimePeriodPtr;

} // namespace

#endif // _IFC4X2_IFCTIMEPERIOD_AUTO_IMPL_H
