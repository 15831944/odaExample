...
#ifndef _IFC4X2_IFCCOMMUNICATIONSAPPLIANCE_AUTO_IMPL_H
#define _IFC4X2_IFCCOMMUNICATIONSAPPLIANCE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCommunicationsAppliance : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCommunicationsAppliance);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCommunicationsAppliance, IfcCommunicationsAppliance> object.
*/
typedef OdSmartPtr<IfcCommunicationsAppliance> IfcCommunicationsAppliancePtr;

} // namespace

#endif // _IFC4X2_IFCCOMMUNICATIONSAPPLIANCE_AUTO_IMPL_H
