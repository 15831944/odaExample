...
#ifndef _IFC4X2_IFCBSPLINESURFACE_AUTO_IMPL_H
#define _IFC4X2_IFCBSPLINESURFACE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcBSplineSurface : public IfcBoundedSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcBSplineSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcBSplineSurface, IfcBSplineSurface> object.
*/
typedef OdSmartPtr<IfcBSplineSurface> IfcBSplineSurfacePtr;

} // namespace

#endif // _IFC4X2_IFCBSPLINESURFACE_AUTO_IMPL_H
