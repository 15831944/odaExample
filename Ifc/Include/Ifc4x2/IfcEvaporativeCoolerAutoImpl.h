...
#ifndef _IFC4X2_IFCEVAPORATIVECOOLER_AUTO_IMPL_H
#define _IFC4X2_IFCEVAPORATIVECOOLER_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcEvaporativeCooler : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcEvaporativeCooler);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcEvaporativeCooler, IfcEvaporativeCooler> object.
*/
typedef OdSmartPtr<IfcEvaporativeCooler> IfcEvaporativeCoolerPtr;

} // namespace

#endif // _IFC4X2_IFCEVAPORATIVECOOLER_AUTO_IMPL_H
