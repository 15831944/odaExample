...
#ifndef _IFC4X2_IFCRIGHTCIRCULARCONE_AUTO_IMPL_H
#define _IFC4X2_IFCRIGHTCIRCULARCONE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRightCircularCone : public IfcCsgPrimitive3D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRightCircularCone);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRightCircularCone, IfcRightCircularCone> object.
*/
typedef OdSmartPtr<IfcRightCircularCone> IfcRightCircularConePtr;

} // namespace

#endif // _IFC4X2_IFCRIGHTCIRCULARCONE_AUTO_IMPL_H
