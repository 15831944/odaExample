...
#ifndef _IFC4X2_IFCBUILDINGELEMENTPART_AUTO_IMPL_H
#define _IFC4X2_IFCBUILDINGELEMENTPART_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcBuildingElementPart : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcBuildingElementPart);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcBuildingElementPart, IfcBuildingElementPart> object.
*/
typedef OdSmartPtr<IfcBuildingElementPart> IfcBuildingElementPartPtr;

} // namespace

#endif // _IFC4X2_IFCBUILDINGELEMENTPART_AUTO_IMPL_H
