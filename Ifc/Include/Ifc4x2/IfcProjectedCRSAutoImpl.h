...
#ifndef _IFC4X2_IFCPROJECTEDCRS_AUTO_IMPL_H
#define _IFC4X2_IFCPROJECTEDCRS_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcProjectedCRS : public IfcCoordinateReferenceSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcProjectedCRS);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcProjectedCRS, IfcProjectedCRS> object.
*/
typedef OdSmartPtr<IfcProjectedCRS> IfcProjectedCRSPtr;

} // namespace

#endif // _IFC4X2_IFCPROJECTEDCRS_AUTO_IMPL_H
