...
#ifndef _IFC4X2_IFCOUTLET_AUTO_IMPL_H
#define _IFC4X2_IFCOUTLET_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcOutlet : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcOutlet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcOutlet, IfcOutlet> object.
*/
typedef OdSmartPtr<IfcOutlet> IfcOutletPtr;

} // namespace

#endif // _IFC4X2_IFCOUTLET_AUTO_IMPL_H
