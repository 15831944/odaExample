...
#ifndef _IFC4X2_IFCTRANSFORMER_AUTO_IMPL_H
#define _IFC4X2_IFCTRANSFORMER_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTransformer : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTransformer);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTransformer, IfcTransformer> object.
*/
typedef OdSmartPtr<IfcTransformer> IfcTransformerPtr;

} // namespace

#endif // _IFC4X2_IFCTRANSFORMER_AUTO_IMPL_H
