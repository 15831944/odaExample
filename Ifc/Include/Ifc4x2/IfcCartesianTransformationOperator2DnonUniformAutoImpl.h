...
#ifndef _IFC4X2_IFCCARTESIANTRANSFORMATIONOPERATOR2DNONUNIFORM_AUTO_IMPL_H
#define _IFC4X2_IFCCARTESIANTRANSFORMATIONOPERATOR2DNONUNIFORM_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCartesianTransformationOperator2DnonUniform : public IfcCartesianTransformationOperator2D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCartesianTransformationOperator2DnonUniform);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCartesianTransformationOperator2DnonUniform, IfcCartesianTransformationOperator2DnonUniform> object.
*/
typedef OdSmartPtr<IfcCartesianTransformationOperator2DnonUniform> IfcCartesianTransformationOperator2DnonUniformPtr;

} // namespace

#endif // _IFC4X2_IFCCARTESIANTRANSFORMATIONOPERATOR2DNONUNIFORM_AUTO_IMPL_H
