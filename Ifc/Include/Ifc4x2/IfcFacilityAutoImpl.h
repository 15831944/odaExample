...
#ifndef _IFC4X2_IFCFACILITY_AUTO_IMPL_H
#define _IFC4X2_IFCFACILITY_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcFacility : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcFacility);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcFacility, IfcFacility> object.
*/
typedef OdSmartPtr<IfcFacility> IfcFacilityPtr;

} // namespace

#endif // _IFC4X2_IFCFACILITY_AUTO_IMPL_H
