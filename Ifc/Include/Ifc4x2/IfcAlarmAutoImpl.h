...
#ifndef _IFC4X2_IFCALARM_AUTO_IMPL_H
#define _IFC4X2_IFCALARM_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcAlarm : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcAlarm);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcAlarm, IfcAlarm> object.
*/
typedef OdSmartPtr<IfcAlarm> IfcAlarmPtr;

} // namespace

#endif // _IFC4X2_IFCALARM_AUTO_IMPL_H
