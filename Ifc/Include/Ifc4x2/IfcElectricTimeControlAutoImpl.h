...
#ifndef _IFC4X2_IFCELECTRICTIMECONTROL_AUTO_IMPL_H
#define _IFC4X2_IFCELECTRICTIMECONTROL_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcElectricTimeControl : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcElectricTimeControl);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcElectricTimeControl, IfcElectricTimeControl> object.
*/
typedef OdSmartPtr<IfcElectricTimeControl> IfcElectricTimeControlPtr;

} // namespace

#endif // _IFC4X2_IFCELECTRICTIMECONTROL_AUTO_IMPL_H
