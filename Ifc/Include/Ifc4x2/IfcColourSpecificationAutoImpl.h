...
#ifndef _IFC4X2_IFCCOLOURSPECIFICATION_AUTO_IMPL_H
#define _IFC4X2_IFCCOLOURSPECIFICATION_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcColourSpecification : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcColourSpecification);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcColourSpecification, IfcColourSpecification> object.
*/
typedef OdSmartPtr<IfcColourSpecification> IfcColourSpecificationPtr;

} // namespace

#endif // _IFC4X2_IFCCOLOURSPECIFICATION_AUTO_IMPL_H
