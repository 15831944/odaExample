...
#ifndef _IFC4X2_IFCSURFACESTYLELIGHTING_AUTO_IMPL_H
#define _IFC4X2_IFCSURFACESTYLELIGHTING_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSurfaceStyleLighting : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSurfaceStyleLighting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSurfaceStyleLighting, IfcSurfaceStyleLighting> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleLighting> IfcSurfaceStyleLightingPtr;

} // namespace

#endif // _IFC4X2_IFCSURFACESTYLELIGHTING_AUTO_IMPL_H
