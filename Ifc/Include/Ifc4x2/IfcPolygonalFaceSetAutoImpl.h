...
#ifndef _IFC4X2_IFCPOLYGONALFACESET_AUTO_IMPL_H
#define _IFC4X2_IFCPOLYGONALFACESET_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPolygonalFaceSet : public IfcTessellatedFaceSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcPolygonalFaceSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPolygonalFaceSet, IfcPolygonalFaceSet> object.
*/
typedef OdSmartPtr<IfcPolygonalFaceSet> IfcPolygonalFaceSetPtr;

} // namespace

#endif // _IFC4X2_IFCPOLYGONALFACESET_AUTO_IMPL_H
