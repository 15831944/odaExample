...
#ifndef _IFC4X2_IFCEVENTTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCEVENTTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcEventType : public IfcTypeProcess
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcEventType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcEventType, IfcEventType> object.
*/
typedef OdSmartPtr<IfcEventType> IfcEventTypePtr;

} // namespace

#endif // _IFC4X2_IFCEVENTTYPE_AUTO_IMPL_H
