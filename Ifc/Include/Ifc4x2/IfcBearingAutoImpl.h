...
#ifndef _IFC4X2_IFCBEARING_AUTO_IMPL_H
#define _IFC4X2_IFCBEARING_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcBearing : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcBearing);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcBearing, IfcBearing> object.
*/
typedef OdSmartPtr<IfcBearing> IfcBearingPtr;

} // namespace

#endif // _IFC4X2_IFCBEARING_AUTO_IMPL_H
