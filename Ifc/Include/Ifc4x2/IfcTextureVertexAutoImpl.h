...
#ifndef _IFC4X2_IFCTEXTUREVERTEX_AUTO_IMPL_H
#define _IFC4X2_IFCTEXTUREVERTEX_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTextureVertex : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTextureVertex);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTextureVertex, IfcTextureVertex> object.
*/
typedef OdSmartPtr<IfcTextureVertex> IfcTextureVertexPtr;

} // namespace

#endif // _IFC4X2_IFCTEXTUREVERTEX_AUTO_IMPL_H
