...
#ifndef _IFC4X2_IFCPROPERTYDEPENDENCYRELATIONSHIP_AUTO_IMPL_H
#define _IFC4X2_IFCPROPERTYDEPENDENCYRELATIONSHIP_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPropertyDependencyRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcPropertyDependencyRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPropertyDependencyRelationship, IfcPropertyDependencyRelationship> object.
*/
typedef OdSmartPtr<IfcPropertyDependencyRelationship> IfcPropertyDependencyRelationshipPtr;

} // namespace

#endif // _IFC4X2_IFCPROPERTYDEPENDENCYRELATIONSHIP_AUTO_IMPL_H
