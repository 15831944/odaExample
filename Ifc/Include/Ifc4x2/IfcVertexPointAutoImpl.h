...
#ifndef _IFC4X2_IFCVERTEXPOINT_AUTO_IMPL_H
#define _IFC4X2_IFCVERTEXPOINT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcVertexPoint : public IfcVertex
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcVertexPoint);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcVertexPoint, IfcVertexPoint> object.
*/
typedef OdSmartPtr<IfcVertexPoint> IfcVertexPointPtr;

} // namespace

#endif // _IFC4X2_IFCVERTEXPOINT_AUTO_IMPL_H
