...
#ifndef _IFC4X2_IFCRELASSIGNSTOPROCESS_AUTO_IMPL_H
#define _IFC4X2_IFCRELASSIGNSTOPROCESS_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRelAssignsToProcess : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRelAssignsToProcess);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRelAssignsToProcess, IfcRelAssignsToProcess> object.
*/
typedef OdSmartPtr<IfcRelAssignsToProcess> IfcRelAssignsToProcessPtr;

} // namespace

#endif // _IFC4X2_IFCRELASSIGNSTOPROCESS_AUTO_IMPL_H
