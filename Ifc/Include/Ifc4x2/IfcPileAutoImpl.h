...
#ifndef _IFC4X2_IFCPILE_AUTO_IMPL_H
#define _IFC4X2_IFCPILE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPile : public IfcDeepFoundation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcPile);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPile, IfcPile> object.
*/
typedef OdSmartPtr<IfcPile> IfcPilePtr;

} // namespace

#endif // _IFC4X2_IFCPILE_AUTO_IMPL_H
