...
#ifndef _IFC4X2_IFCDAMPERTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCDAMPERTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcDamperType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcDamperType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcDamperType, IfcDamperType> object.
*/
typedef OdSmartPtr<IfcDamperType> IfcDamperTypePtr;

} // namespace

#endif // _IFC4X2_IFCDAMPERTYPE_AUTO_IMPL_H
