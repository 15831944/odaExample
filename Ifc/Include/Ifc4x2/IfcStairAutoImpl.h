...
#ifndef _IFC4X2_IFCSTAIR_AUTO_IMPL_H
#define _IFC4X2_IFCSTAIR_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcStair : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcStair);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcStair, IfcStair> object.
*/
typedef OdSmartPtr<IfcStair> IfcStairPtr;

} // namespace

#endif // _IFC4X2_IFCSTAIR_AUTO_IMPL_H
