...
#ifndef _IFC4X2_IFCTRANSPORTELEMENTTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCTRANSPORTELEMENTTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTransportElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTransportElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTransportElementType, IfcTransportElementType> object.
*/
typedef OdSmartPtr<IfcTransportElementType> IfcTransportElementTypePtr;

} // namespace

#endif // _IFC4X2_IFCTRANSPORTELEMENTTYPE_AUTO_IMPL_H
