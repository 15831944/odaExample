...
#ifndef _IFC4X2_IFCBOUNDARYEDGECONDITION_AUTO_IMPL_H
#define _IFC4X2_IFCBOUNDARYEDGECONDITION_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcBoundaryEdgeCondition : public IfcBoundaryCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcBoundaryEdgeCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcBoundaryEdgeCondition, IfcBoundaryEdgeCondition> object.
*/
typedef OdSmartPtr<IfcBoundaryEdgeCondition> IfcBoundaryEdgeConditionPtr;

} // namespace

#endif // _IFC4X2_IFCBOUNDARYEDGECONDITION_AUTO_IMPL_H
