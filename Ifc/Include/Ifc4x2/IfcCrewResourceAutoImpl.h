...
#ifndef _IFC4X2_IFCCREWRESOURCE_AUTO_IMPL_H
#define _IFC4X2_IFCCREWRESOURCE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCrewResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCrewResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCrewResource, IfcCrewResource> object.
*/
typedef OdSmartPtr<IfcCrewResource> IfcCrewResourcePtr;

} // namespace

#endif // _IFC4X2_IFCCREWRESOURCE_AUTO_IMPL_H
