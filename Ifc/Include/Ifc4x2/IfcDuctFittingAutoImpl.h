...
#ifndef _IFC4X2_IFCDUCTFITTING_AUTO_IMPL_H
#define _IFC4X2_IFCDUCTFITTING_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcDuctFitting : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcDuctFitting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcDuctFitting, IfcDuctFitting> object.
*/
typedef OdSmartPtr<IfcDuctFitting> IfcDuctFittingPtr;

} // namespace

#endif // _IFC4X2_IFCDUCTFITTING_AUTO_IMPL_H
