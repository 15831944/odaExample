...
#ifndef _IFC4X2_IFCQUANTITYTIME_AUTO_IMPL_H
#define _IFC4X2_IFCQUANTITYTIME_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcQuantityTime : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcQuantityTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcQuantityTime, IfcQuantityTime> object.
*/
typedef OdSmartPtr<IfcQuantityTime> IfcQuantityTimePtr;

} // namespace

#endif // _IFC4X2_IFCQUANTITYTIME_AUTO_IMPL_H
