...
#ifndef _IFC4X2_IFCSIMPLEPROPERTYTEMPLATE_AUTO_IMPL_H
#define _IFC4X2_IFCSIMPLEPROPERTYTEMPLATE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSimplePropertyTemplate : public IfcPropertyTemplate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSimplePropertyTemplate);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSimplePropertyTemplate, IfcSimplePropertyTemplate> object.
*/
typedef OdSmartPtr<IfcSimplePropertyTemplate> IfcSimplePropertyTemplatePtr;

} // namespace

#endif // _IFC4X2_IFCSIMPLEPROPERTYTEMPLATE_AUTO_IMPL_H
