...
#ifndef _IFC4X2_IFCRIGHTCIRCULARCYLINDER_AUTO_IMPL_H
#define _IFC4X2_IFCRIGHTCIRCULARCYLINDER_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRightCircularCylinder : public IfcCsgPrimitive3D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRightCircularCylinder);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRightCircularCylinder, IfcRightCircularCylinder> object.
*/
typedef OdSmartPtr<IfcRightCircularCylinder> IfcRightCircularCylinderPtr;

} // namespace

#endif // _IFC4X2_IFCRIGHTCIRCULARCYLINDER_AUTO_IMPL_H
