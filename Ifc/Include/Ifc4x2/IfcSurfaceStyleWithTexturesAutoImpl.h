...
#ifndef _IFC4X2_IFCSURFACESTYLEWITHTEXTURES_AUTO_IMPL_H
#define _IFC4X2_IFCSURFACESTYLEWITHTEXTURES_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSurfaceStyleWithTextures : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSurfaceStyleWithTextures);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSurfaceStyleWithTextures, IfcSurfaceStyleWithTextures> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleWithTextures> IfcSurfaceStyleWithTexturesPtr;

} // namespace

#endif // _IFC4X2_IFCSURFACESTYLEWITHTEXTURES_AUTO_IMPL_H
