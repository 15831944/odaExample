...
#ifndef _IFC4X2_IFCRECURRENCEPATTERN_AUTO_IMPL_H
#define _IFC4X2_IFCRECURRENCEPATTERN_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRecurrencePattern : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRecurrencePattern);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRecurrencePattern, IfcRecurrencePattern> object.
*/
typedef OdSmartPtr<IfcRecurrencePattern> IfcRecurrencePatternPtr;

} // namespace

#endif // _IFC4X2_IFCRECURRENCEPATTERN_AUTO_IMPL_H
