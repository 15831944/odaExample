...
#ifndef _IFC4X2_IFCSURFACESTYLE_AUTO_IMPL_H
#define _IFC4X2_IFCSURFACESTYLE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSurfaceStyle : public IfcPresentationStyle
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSurfaceStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSurfaceStyle, IfcSurfaceStyle> object.
*/
typedef OdSmartPtr<IfcSurfaceStyle> IfcSurfaceStylePtr;

} // namespace

#endif // _IFC4X2_IFCSURFACESTYLE_AUTO_IMPL_H
