...
#ifndef _IFC4X2_IFCREINFORCINGBARTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCREINFORCINGBARTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcReinforcingBarType : public IfcReinforcingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcReinforcingBarType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcReinforcingBarType, IfcReinforcingBarType> object.
*/
typedef OdSmartPtr<IfcReinforcingBarType> IfcReinforcingBarTypePtr;

} // namespace

#endif // _IFC4X2_IFCREINFORCINGBARTYPE_AUTO_IMPL_H
