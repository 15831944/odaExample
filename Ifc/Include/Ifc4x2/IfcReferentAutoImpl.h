...
#ifndef _IFC4X2_IFCREFERENT_AUTO_IMPL_H
#define _IFC4X2_IFCREFERENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcReferent : public IfcPositioningElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcReferent);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcReferent, IfcReferent> object.
*/
typedef OdSmartPtr<IfcReferent> IfcReferentPtr;

} // namespace

#endif // _IFC4X2_IFCREFERENT_AUTO_IMPL_H
