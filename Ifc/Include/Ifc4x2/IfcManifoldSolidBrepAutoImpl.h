...
#ifndef _IFC4X2_IFCMANIFOLDSOLIDBREP_AUTO_IMPL_H
#define _IFC4X2_IFCMANIFOLDSOLIDBREP_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcManifoldSolidBrep : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcManifoldSolidBrep);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcManifoldSolidBrep, IfcManifoldSolidBrep> object.
*/
typedef OdSmartPtr<IfcManifoldSolidBrep> IfcManifoldSolidBrepPtr;

} // namespace

#endif // _IFC4X2_IFCMANIFOLDSOLIDBREP_AUTO_IMPL_H
