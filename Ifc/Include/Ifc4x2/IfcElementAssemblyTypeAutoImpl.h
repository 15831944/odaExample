...
#ifndef _IFC4X2_IFCELEMENTASSEMBLYTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCELEMENTASSEMBLYTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcElementAssemblyType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcElementAssemblyType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcElementAssemblyType, IfcElementAssemblyType> object.
*/
typedef OdSmartPtr<IfcElementAssemblyType> IfcElementAssemblyTypePtr;

} // namespace

#endif // _IFC4X2_IFCELEMENTASSEMBLYTYPE_AUTO_IMPL_H
