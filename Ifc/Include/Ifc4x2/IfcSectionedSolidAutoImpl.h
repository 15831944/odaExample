...
#ifndef _IFC4X2_IFCSECTIONEDSOLID_AUTO_IMPL_H
#define _IFC4X2_IFCSECTIONEDSOLID_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSectionedSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcSectionedSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSectionedSolid, IfcSectionedSolid> object.
*/
typedef OdSmartPtr<IfcSectionedSolid> IfcSectionedSolidPtr;

} // namespace

#endif // _IFC4X2_IFCSECTIONEDSOLID_AUTO_IMPL_H
