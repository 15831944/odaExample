...
#ifndef _IFC4X2_IFCTYPEPROCESS_AUTO_IMPL_H
#define _IFC4X2_IFCTYPEPROCESS_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTypeProcess : public IfcTypeObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcTypeProcess);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTypeProcess, IfcTypeProcess> object.
*/
typedef OdSmartPtr<IfcTypeProcess> IfcTypeProcessPtr;

} // namespace

#endif // _IFC4X2_IFCTYPEPROCESS_AUTO_IMPL_H
