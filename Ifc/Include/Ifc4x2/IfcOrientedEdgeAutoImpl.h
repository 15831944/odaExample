...
#ifndef _IFC4X2_IFCORIENTEDEDGE_AUTO_IMPL_H
#define _IFC4X2_IFCORIENTEDEDGE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcOrientedEdge : public IfcEdge
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcOrientedEdge);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcOrientedEdge, IfcOrientedEdge> object.
*/
typedef OdSmartPtr<IfcOrientedEdge> IfcOrientedEdgePtr;

} // namespace

#endif // _IFC4X2_IFCORIENTEDEDGE_AUTO_IMPL_H
