...
#ifndef _IFC4X2_IFCPREDEFINEDITEM_AUTO_IMPL_H
#define _IFC4X2_IFCPREDEFINEDITEM_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPreDefinedItem : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcPreDefinedItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPreDefinedItem, IfcPreDefinedItem> object.
*/
typedef OdSmartPtr<IfcPreDefinedItem> IfcPreDefinedItemPtr;

} // namespace

#endif // _IFC4X2_IFCPREDEFINEDITEM_AUTO_IMPL_H
