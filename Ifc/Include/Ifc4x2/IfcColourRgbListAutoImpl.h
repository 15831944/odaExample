...
#ifndef _IFC4X2_IFCCOLOURRGBLIST_AUTO_IMPL_H
#define _IFC4X2_IFCCOLOURRGBLIST_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcColourRgbList : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcColourRgbList);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcColourRgbList, IfcColourRgbList> object.
*/
typedef OdSmartPtr<IfcColourRgbList> IfcColourRgbListPtr;

} // namespace

#endif // _IFC4X2_IFCCOLOURRGBLIST_AUTO_IMPL_H
