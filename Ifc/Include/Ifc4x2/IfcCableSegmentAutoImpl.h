...
#ifndef _IFC4X2_IFCCABLESEGMENT_AUTO_IMPL_H
#define _IFC4X2_IFCCABLESEGMENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCableSegment : public IfcFlowSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCableSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCableSegment, IfcCableSegment> object.
*/
typedef OdSmartPtr<IfcCableSegment> IfcCableSegmentPtr;

} // namespace

#endif // _IFC4X2_IFCCABLESEGMENT_AUTO_IMPL_H
