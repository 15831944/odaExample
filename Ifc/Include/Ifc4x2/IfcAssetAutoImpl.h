...
#ifndef _IFC4X2_IFCASSET_AUTO_IMPL_H
#define _IFC4X2_IFCASSET_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcAsset : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcAsset);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcAsset, IfcAsset> object.
*/
typedef OdSmartPtr<IfcAsset> IfcAssetPtr;

} // namespace

#endif // _IFC4X2_IFCASSET_AUTO_IMPL_H
