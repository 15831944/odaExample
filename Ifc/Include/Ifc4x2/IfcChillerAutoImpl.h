...
#ifndef _IFC4X2_IFCCHILLER_AUTO_IMPL_H
#define _IFC4X2_IFCCHILLER_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcChiller : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcChiller);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcChiller, IfcChiller> object.
*/
typedef OdSmartPtr<IfcChiller> IfcChillerPtr;

} // namespace

#endif // _IFC4X2_IFCCHILLER_AUTO_IMPL_H
