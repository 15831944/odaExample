...
#ifndef _IFC4X2_IFCCABLEFITTINGTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCCABLEFITTINGTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCableFittingType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCableFittingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCableFittingType, IfcCableFittingType> object.
*/
typedef OdSmartPtr<IfcCableFittingType> IfcCableFittingTypePtr;

} // namespace

#endif // _IFC4X2_IFCCABLEFITTINGTYPE_AUTO_IMPL_H
