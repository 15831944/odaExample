...
#ifndef _IFC4X2_IFCRAILINGTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCRAILINGTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRailingType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRailingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRailingType, IfcRailingType> object.
*/
typedef OdSmartPtr<IfcRailingType> IfcRailingTypePtr;

} // namespace

#endif // _IFC4X2_IFCRAILINGTYPE_AUTO_IMPL_H
