...
#ifndef _IFC4X2_IFCCONTEXT_AUTO_IMPL_H
#define _IFC4X2_IFCCONTEXT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcContext : public IfcObjectDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcContext);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcContext, IfcContext> object.
*/
typedef OdSmartPtr<IfcContext> IfcContextPtr;

} // namespace

#endif // _IFC4X2_IFCCONTEXT_AUTO_IMPL_H
