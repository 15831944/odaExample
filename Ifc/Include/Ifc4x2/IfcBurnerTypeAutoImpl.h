...
#ifndef _IFC4X2_IFCBURNERTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCBURNERTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcBurnerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcBurnerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcBurnerType, IfcBurnerType> object.
*/
typedef OdSmartPtr<IfcBurnerType> IfcBurnerTypePtr;

} // namespace

#endif // _IFC4X2_IFCBURNERTYPE_AUTO_IMPL_H
