...
#ifndef _IFC4X2_IFCPORT_AUTO_IMPL_H
#define _IFC4X2_IFCPORT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPort : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcPort);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPort, IfcPort> object.
*/
typedef OdSmartPtr<IfcPort> IfcPortPtr;

} // namespace

#endif // _IFC4X2_IFCPORT_AUTO_IMPL_H
