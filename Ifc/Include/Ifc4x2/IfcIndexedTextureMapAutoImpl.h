...
#ifndef _IFC4X2_IFCINDEXEDTEXTUREMAP_AUTO_IMPL_H
#define _IFC4X2_IFCINDEXEDTEXTUREMAP_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcIndexedTextureMap : public IfcTextureCoordinate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcIndexedTextureMap);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcIndexedTextureMap, IfcIndexedTextureMap> object.
*/
typedef OdSmartPtr<IfcIndexedTextureMap> IfcIndexedTextureMapPtr;

} // namespace

#endif // _IFC4X2_IFCINDEXEDTEXTUREMAP_AUTO_IMPL_H
