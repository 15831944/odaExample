...
#ifndef _IFC4X2_IFCSTYLEDITEM_AUTO_IMPL_H
#define _IFC4X2_IFCSTYLEDITEM_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcStyledItem : public IfcRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcStyledItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcStyledItem, IfcStyledItem> object.
*/
typedef OdSmartPtr<IfcStyledItem> IfcStyledItemPtr;

} // namespace

#endif // _IFC4X2_IFCSTYLEDITEM_AUTO_IMPL_H
