...
#ifndef _IFC4X2_IFCSOLARDEVICETYPE_AUTO_IMPL_H
#define _IFC4X2_IFCSOLARDEVICETYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSolarDeviceType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSolarDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSolarDeviceType, IfcSolarDeviceType> object.
*/
typedef OdSmartPtr<IfcSolarDeviceType> IfcSolarDeviceTypePtr;

} // namespace

#endif // _IFC4X2_IFCSOLARDEVICETYPE_AUTO_IMPL_H
