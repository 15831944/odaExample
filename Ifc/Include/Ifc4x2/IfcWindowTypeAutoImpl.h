...
#ifndef _IFC4X2_IFCWINDOWTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCWINDOWTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcWindowType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcWindowType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcWindowType, IfcWindowType> object.
*/
typedef OdSmartPtr<IfcWindowType> IfcWindowTypePtr;

} // namespace

#endif // _IFC4X2_IFCWINDOWTYPE_AUTO_IMPL_H
