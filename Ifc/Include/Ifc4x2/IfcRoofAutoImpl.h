...
#ifndef _IFC4X2_IFCROOF_AUTO_IMPL_H
#define _IFC4X2_IFCROOF_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRoof : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRoof);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRoof, IfcRoof> object.
*/
typedef OdSmartPtr<IfcRoof> IfcRoofPtr;

} // namespace

#endif // _IFC4X2_IFCROOF_AUTO_IMPL_H
