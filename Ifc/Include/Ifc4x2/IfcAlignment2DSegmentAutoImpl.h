...
#ifndef _IFC4X2_IFCALIGNMENT2DSEGMENT_AUTO_IMPL_H
#define _IFC4X2_IFCALIGNMENT2DSEGMENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcAlignment2DSegment : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcAlignment2DSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcAlignment2DSegment, IfcAlignment2DSegment> object.
*/
typedef OdSmartPtr<IfcAlignment2DSegment> IfcAlignment2DSegmentPtr;

} // namespace

#endif // _IFC4X2_IFCALIGNMENT2DSEGMENT_AUTO_IMPL_H
