...
#ifndef _IFC4X2_IFCPOLYGONALBOUNDEDHALFSPACE_AUTO_IMPL_H
#define _IFC4X2_IFCPOLYGONALBOUNDEDHALFSPACE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPolygonalBoundedHalfSpace : public IfcHalfSpaceSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcPolygonalBoundedHalfSpace);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPolygonalBoundedHalfSpace, IfcPolygonalBoundedHalfSpace> object.
*/
typedef OdSmartPtr<IfcPolygonalBoundedHalfSpace> IfcPolygonalBoundedHalfSpacePtr;

} // namespace

#endif // _IFC4X2_IFCPOLYGONALBOUNDEDHALFSPACE_AUTO_IMPL_H
