...
#ifndef _IFC4X2_IFCPOSTALADDRESS_AUTO_IMPL_H
#define _IFC4X2_IFCPOSTALADDRESS_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPostalAddress : public IfcAddress
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcPostalAddress);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPostalAddress, IfcPostalAddress> object.
*/
typedef OdSmartPtr<IfcPostalAddress> IfcPostalAddressPtr;

} // namespace

#endif // _IFC4X2_IFCPOSTALADDRESS_AUTO_IMPL_H
