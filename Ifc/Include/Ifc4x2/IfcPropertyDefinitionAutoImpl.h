...
#ifndef _IFC4X2_IFCPROPERTYDEFINITION_AUTO_IMPL_H
#define _IFC4X2_IFCPROPERTYDEFINITION_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcPropertyDefinition : public IfcRoot
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcPropertyDefinition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcPropertyDefinition, IfcPropertyDefinition> object.
*/
typedef OdSmartPtr<IfcPropertyDefinition> IfcPropertyDefinitionPtr;

} // namespace

#endif // _IFC4X2_IFCPROPERTYDEFINITION_AUTO_IMPL_H
