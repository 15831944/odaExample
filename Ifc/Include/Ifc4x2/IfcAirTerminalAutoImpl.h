...
#ifndef _IFC4X2_IFCAIRTERMINAL_AUTO_IMPL_H
#define _IFC4X2_IFCAIRTERMINAL_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcAirTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcAirTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcAirTerminal, IfcAirTerminal> object.
*/
typedef OdSmartPtr<IfcAirTerminal> IfcAirTerminalPtr;

} // namespace

#endif // _IFC4X2_IFCAIRTERMINAL_AUTO_IMPL_H
