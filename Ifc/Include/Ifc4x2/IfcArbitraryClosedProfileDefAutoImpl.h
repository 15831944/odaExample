...
#ifndef _IFC4X2_IFCARBITRARYCLOSEDPROFILEDEF_AUTO_IMPL_H
#define _IFC4X2_IFCARBITRARYCLOSEDPROFILEDEF_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcArbitraryClosedProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcArbitraryClosedProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcArbitraryClosedProfileDef, IfcArbitraryClosedProfileDef> object.
*/
typedef OdSmartPtr<IfcArbitraryClosedProfileDef> IfcArbitraryClosedProfileDefPtr;

} // namespace

#endif // _IFC4X2_IFCARBITRARYCLOSEDPROFILEDEF_AUTO_IMPL_H
