...
#ifndef _IFC4X2_IFCCONNECTEDFACESET_AUTO_IMPL_H
#define _IFC4X2_IFCCONNECTEDFACESET_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcConnectedFaceSet : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcConnectedFaceSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcConnectedFaceSet, IfcConnectedFaceSet> object.
*/
typedef OdSmartPtr<IfcConnectedFaceSet> IfcConnectedFaceSetPtr;

} // namespace

#endif // _IFC4X2_IFCCONNECTEDFACESET_AUTO_IMPL_H
