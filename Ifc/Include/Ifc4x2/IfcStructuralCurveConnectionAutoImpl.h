...
#ifndef _IFC4X2_IFCSTRUCTURALCURVECONNECTION_AUTO_IMPL_H
#define _IFC4X2_IFCSTRUCTURALCURVECONNECTION_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcStructuralCurveConnection : public IfcStructuralConnection
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcStructuralCurveConnection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcStructuralCurveConnection, IfcStructuralCurveConnection> object.
*/
typedef OdSmartPtr<IfcStructuralCurveConnection> IfcStructuralCurveConnectionPtr;

} // namespace

#endif // _IFC4X2_IFCSTRUCTURALCURVECONNECTION_AUTO_IMPL_H
