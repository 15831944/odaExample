...
#ifndef _IFC4X2_IFCACTUATORTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCACTUATORTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcActuatorType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcActuatorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcActuatorType, IfcActuatorType> object.
*/
typedef OdSmartPtr<IfcActuatorType> IfcActuatorTypePtr;

} // namespace

#endif // _IFC4X2_IFCACTUATORTYPE_AUTO_IMPL_H
