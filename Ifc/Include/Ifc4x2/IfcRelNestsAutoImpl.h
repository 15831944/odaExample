...
#ifndef _IFC4X2_IFCRELNESTS_AUTO_IMPL_H
#define _IFC4X2_IFCRELNESTS_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRelNests : public IfcRelDecomposes
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRelNests);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRelNests, IfcRelNests> object.
*/
typedef OdSmartPtr<IfcRelNests> IfcRelNestsPtr;

} // namespace

#endif // _IFC4X2_IFCRELNESTS_AUTO_IMPL_H
