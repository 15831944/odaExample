...
#ifndef _IFC4X2_IFCCOSTVALUE_AUTO_IMPL_H
#define _IFC4X2_IFCCOSTVALUE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCostValue : public IfcAppliedValue
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCostValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCostValue, IfcCostValue> object.
*/
typedef OdSmartPtr<IfcCostValue> IfcCostValuePtr;

} // namespace

#endif // _IFC4X2_IFCCOSTVALUE_AUTO_IMPL_H
