...
#ifndef _IFC4X2_IFCQUANTITYCOUNT_AUTO_IMPL_H
#define _IFC4X2_IFCQUANTITYCOUNT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcQuantityCount : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcQuantityCount);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcQuantityCount, IfcQuantityCount> object.
*/
typedef OdSmartPtr<IfcQuantityCount> IfcQuantityCountPtr;

} // namespace

#endif // _IFC4X2_IFCQUANTITYCOUNT_AUTO_IMPL_H
