...
#ifndef _IFC4X2_IFCRELASSIGNSTORESOURCE_AUTO_IMPL_H
#define _IFC4X2_IFCRELASSIGNSTORESOURCE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcRelAssignsToResource : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcRelAssignsToResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcRelAssignsToResource, IfcRelAssignsToResource> object.
*/
typedef OdSmartPtr<IfcRelAssignsToResource> IfcRelAssignsToResourcePtr;

} // namespace

#endif // _IFC4X2_IFCRELASSIGNSTORESOURCE_AUTO_IMPL_H
