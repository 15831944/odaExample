...
#ifndef _IFC4X2_IFCSHELLBASEDSURFACEMODEL_AUTO_IMPL_H
#define _IFC4X2_IFCSHELLBASEDSURFACEMODEL_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcShellBasedSurfaceModel : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcShellBasedSurfaceModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcShellBasedSurfaceModel, IfcShellBasedSurfaceModel> object.
*/
typedef OdSmartPtr<IfcShellBasedSurfaceModel> IfcShellBasedSurfaceModelPtr;

} // namespace

#endif // _IFC4X2_IFCSHELLBASEDSURFACEMODEL_AUTO_IMPL_H
