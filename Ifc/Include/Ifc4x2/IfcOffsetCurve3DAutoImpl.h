...
#ifndef _IFC4X2_IFCOFFSETCURVE3D_AUTO_IMPL_H
#define _IFC4X2_IFCOFFSETCURVE3D_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcOffsetCurve3D : public IfcOffsetCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcOffsetCurve3D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcOffsetCurve3D, IfcOffsetCurve3D> object.
*/
typedef OdSmartPtr<IfcOffsetCurve3D> IfcOffsetCurve3DPtr;

} // namespace

#endif // _IFC4X2_IFCOFFSETCURVE3D_AUTO_IMPL_H
