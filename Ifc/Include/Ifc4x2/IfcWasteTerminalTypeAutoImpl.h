...
#ifndef _IFC4X2_IFCWASTETERMINALTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCWASTETERMINALTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcWasteTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcWasteTerminalType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcWasteTerminalType, IfcWasteTerminalType> object.
*/
typedef OdSmartPtr<IfcWasteTerminalType> IfcWasteTerminalTypePtr;

} // namespace

#endif // _IFC4X2_IFCWASTETERMINALTYPE_AUTO_IMPL_H
