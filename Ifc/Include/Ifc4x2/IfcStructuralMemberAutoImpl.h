...
#ifndef _IFC4X2_IFCSTRUCTURALMEMBER_AUTO_IMPL_H
#define _IFC4X2_IFCSTRUCTURALMEMBER_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcStructuralMember : public IfcStructuralItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4x2::IfcStructuralMember);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcStructuralMember, IfcStructuralMember> object.
*/
typedef OdSmartPtr<IfcStructuralMember> IfcStructuralMemberPtr;

} // namespace

#endif // _IFC4X2_IFCSTRUCTURALMEMBER_AUTO_IMPL_H
