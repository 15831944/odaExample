...
#ifndef _IFC4X2_IFCTEXTUREMAP_AUTO_IMPL_H
#define _IFC4X2_IFCTEXTUREMAP_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTextureMap : public IfcTextureCoordinate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTextureMap);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTextureMap, IfcTextureMap> object.
*/
typedef OdSmartPtr<IfcTextureMap> IfcTextureMapPtr;

} // namespace

#endif // _IFC4X2_IFCTEXTUREMAP_AUTO_IMPL_H
