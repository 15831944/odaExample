...
#ifndef _IFC4X2_IFCTRIANGULATEDIRREGULARNETWORK_AUTO_IMPL_H
#define _IFC4X2_IFCTRIANGULATEDIRREGULARNETWORK_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcTriangulatedIrregularNetwork : public IfcTriangulatedFaceSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcTriangulatedIrregularNetwork);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcTriangulatedIrregularNetwork, IfcTriangulatedIrregularNetwork> object.
*/
typedef OdSmartPtr<IfcTriangulatedIrregularNetwork> IfcTriangulatedIrregularNetworkPtr;

} // namespace

#endif // _IFC4X2_IFCTRIANGULATEDIRREGULARNETWORK_AUTO_IMPL_H
