...
#ifndef _IFC4X2_IFCPROJECTORDER_AUTO_IMPL_H
#define _IFC4X2_IFCPROJECTORDER_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcProjectOrder : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcProjectOrder);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcProjectOrder, IfcProjectOrder> object.
*/
typedef OdSmartPtr<IfcProjectOrder> IfcProjectOrderPtr;

} // namespace

#endif // _IFC4X2_IFCPROJECTORDER_AUTO_IMPL_H
