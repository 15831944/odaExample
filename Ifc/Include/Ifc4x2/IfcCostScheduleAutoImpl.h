...
#ifndef _IFC4X2_IFCCOSTSCHEDULE_AUTO_IMPL_H
#define _IFC4X2_IFCCOSTSCHEDULE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcCostSchedule : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcCostSchedule);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcCostSchedule, IfcCostSchedule> object.
*/
typedef OdSmartPtr<IfcCostSchedule> IfcCostSchedulePtr;

} // namespace

#endif // _IFC4X2_IFCCOSTSCHEDULE_AUTO_IMPL_H
