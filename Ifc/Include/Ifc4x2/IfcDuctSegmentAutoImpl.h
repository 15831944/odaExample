...
#ifndef _IFC4X2_IFCDUCTSEGMENT_AUTO_IMPL_H
#define _IFC4X2_IFCDUCTSEGMENT_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcDuctSegment : public IfcFlowSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcDuctSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcDuctSegment, IfcDuctSegment> object.
*/
typedef OdSmartPtr<IfcDuctSegment> IfcDuctSegmentPtr;

} // namespace

#endif // _IFC4X2_IFCDUCTSEGMENT_AUTO_IMPL_H
