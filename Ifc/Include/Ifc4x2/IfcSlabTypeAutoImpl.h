...
#ifndef _IFC4X2_IFCSLABTYPE_AUTO_IMPL_H
#define _IFC4X2_IFCSLABTYPE_AUTO_IMPL_H
...
class IFC4X2_EXPORT IfcSlabType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4x2::IfcSlabType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4x2::IfcSlabType, IfcSlabType> object.
*/
typedef OdSmartPtr<IfcSlabType> IfcSlabTypePtr;

} // namespace

#endif // _IFC4X2_IFCSLABTYPE_AUTO_IMPL_H
