...
#ifndef _IFC2X2_FINAL_IFCDOCUMENTINFORMATION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDOCUMENTINFORMATION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDocumentInformation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDocumentInformation);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_DocumentId;   // IfcIdentifier
  OdAnsiString m_Name;   // IfcLabel
  OdAnsiString m_Description;   // IfcText  [optional]
  OdDAI::OdDAIObjectIdSet m_DocumentReferences; // SET [1:?] of IfcDocumentReference [optional]

  OdAnsiString m_Purpose;   // IfcText  [optional]
  OdAnsiString m_IntendedUse;   // IfcText  [optional]
  OdAnsiString m_Scope;   // IfcText  [optional]
  OdAnsiString m_Revision;   // IfcLabel  [optional]
  OdDAI::Select m_DocumentOwner;   // IfcActorSelect  [optional]
  OdDAI::Set<OdDAI::Select> m_Editors; // SET [1:?] of IfcActorSelect [optional]

  OdDAIObjectId m_CreationTime;   // IfcDateAndTime  [optional]
  OdDAIObjectId m_LastRevisionTime;   // IfcDateAndTime  [optional]
  OdDAIObjectId m_ElectronicFormat;   // IfcDocumentElectronicFormat  [optional]
  OdDAIObjectId m_ValidFrom;   // IfcCalendarDate  [optional]
  OdDAIObjectId m_ValidUntil;   // IfcCalendarDate  [optional]
  OdDAI::Enum m_Confidentiality;   // IfcDocumentConfidentialityEnum  [optional]
  OdDAI::Enum m_Status;   // IfcDocumentStatusEnum  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDocumentInformation, IfcDocumentInformation> object.
*/
typedef OdSmartPtr<IfcDocumentInformation> IfcDocumentInformationPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDOCUMENTINFORMATION_AUTO_IMPL_H
