...
#ifndef _IFC2X2_FINAL_IFCDRAUGHTINGCALLOUT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDRAUGHTINGCALLOUT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDraughtingCallout : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDraughtingCallout);
  //DOM-IGNORE-END
...
public:
  ...
  void getContents(OdArray<OdDAI::Select >& Contents) const;
  void getContentsWrapperArray(OdArray<IfcDraughtingCalloutElement>& Contents) const;
  OdDAI::Set<OdDAI::Select>& contents();
  void getInvIsRelatedFromCallout(OdDAIObjectIds& IsRelatedFromCallout) const;
  void getInvIsRelatedToCallout(OdDAIObjectIds& IsRelatedToCallout) const;
...
protected:
  // Fields declaration: 
  OdDAI::Set<OdDAI::Select> m_Contents; // SET [1:?] of IfcDraughtingCalloutElement
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDraughtingCallout, IfcDraughtingCallout> object.
*/
typedef OdSmartPtr<IfcDraughtingCallout> IfcDraughtingCalloutPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDRAUGHTINGCALLOUT_AUTO_IMPL_H
