...
#ifndef _IFC2X2_FINAL_IFCREPRESENTATIONMAP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCREPRESENTATIONMAP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRepresentationMap : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRepresentationMap);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRepresentationMap, IfcRepresentationMap> object.
*/
typedef OdSmartPtr<IfcRepresentationMap> IfcRepresentationMapPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCREPRESENTATIONMAP_AUTO_IMPL_H
