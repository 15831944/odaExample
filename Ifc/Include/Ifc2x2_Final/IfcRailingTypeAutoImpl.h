...
#ifndef _IFC2X2_FINAL_IFCRAILINGTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRAILINGTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRailingType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRailingType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcRailingTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcRailingTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcRailingTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRailingType, IfcRailingType> object.
*/
typedef OdSmartPtr<IfcRailingType> IfcRailingTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRAILINGTYPE_AUTO_IMPL_H
