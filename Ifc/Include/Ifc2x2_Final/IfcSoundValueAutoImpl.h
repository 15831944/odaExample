...
#ifndef _IFC2X2_FINAL_IFCSOUNDVALUE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSOUNDVALUE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSoundValue : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSoundValue);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getSoundLevelTimeSeries() const;
  void setSoundLevelTimeSeries(const OdDAIObjectId& SoundLevelTimeSeries);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_SoundLevelTimeSeries;   // IfcTimeSeries  [optional]
  double m_Frequency;   // IfcFrequencyMeasure
  OdDAI::Select m_SoundLevelSingleValue;   // IfcDerivedMeasureValue  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSoundValue, IfcSoundValue> object.
*/
typedef OdSmartPtr<IfcSoundValue> IfcSoundValuePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSOUNDVALUE_AUTO_IMPL_H
