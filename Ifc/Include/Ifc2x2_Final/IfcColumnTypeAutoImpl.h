...
#ifndef _IFC2X2_FINAL_IFCCOLUMNTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCOLUMNTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcColumnType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcColumnType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcColumnTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcColumnType, IfcColumnType> object.
*/
typedef OdSmartPtr<IfcColumnType> IfcColumnTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCOLUMNTYPE_AUTO_IMPL_H
