...
#ifndef _IFC2X2_FINAL_IFCSURFACECURVESWEPTAREASOLID_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSURFACECURVESWEPTAREASOLID_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSurfaceCurveSweptAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSurfaceCurveSweptAreaSolid);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getReferenceSurface() const;
  void setReferenceSurface(const OdDAIObjectId& ReferenceSurface);
...
protected:
  ...
  double m_StartParam;   // IfcParameterValue
  double m_EndParam;   // IfcParameterValue
  OdDAIObjectId m_ReferenceSurface;   // IfcSurface
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSurfaceCurveSweptAreaSolid, IfcSurfaceCurveSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcSurfaceCurveSweptAreaSolid> IfcSurfaceCurveSweptAreaSolidPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSURFACECURVESWEPTAREASOLID_AUTO_IMPL_H
