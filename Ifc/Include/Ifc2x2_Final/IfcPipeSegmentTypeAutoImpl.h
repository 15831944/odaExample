...
#ifndef _IFC2X2_FINAL_IFCPIPESEGMENTTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPIPESEGMENTTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPipeSegmentType : public IfcFlowSegmentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPipeSegmentType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcPipeSegmentTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcPipeSegmentTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcPipeSegmentTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPipeSegmentType, IfcPipeSegmentType> object.
*/
typedef OdSmartPtr<IfcPipeSegmentType> IfcPipeSegmentTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPIPESEGMENTTYPE_AUTO_IMPL_H
