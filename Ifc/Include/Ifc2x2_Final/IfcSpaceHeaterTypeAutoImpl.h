...
#ifndef _IFC2X2_FINAL_IFCSPACEHEATERTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSPACEHEATERTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSpaceHeaterType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSpaceHeaterType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcSpaceHeaterTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcSpaceHeaterTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSpaceHeaterTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSpaceHeaterType, IfcSpaceHeaterType> object.
*/
typedef OdSmartPtr<IfcSpaceHeaterType> IfcSpaceHeaterTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSPACEHEATERTYPE_AUTO_IMPL_H
