...
#ifndef _IFC2X2_FINAL_IFCBUILDINGELEMENTPROXY_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCBUILDINGELEMENTPROXY_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcBuildingElementProxy : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcBuildingElementProxy);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcBuildingElementProxy, IfcBuildingElementProxy> object.
*/
typedef OdSmartPtr<IfcBuildingElementProxy> IfcBuildingElementProxyPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCBUILDINGELEMENTPROXY_AUTO_IMPL_H
