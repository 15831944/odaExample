...
#ifndef _IFC2X2_FINAL_IFCCABLESEGMENTTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCABLESEGMENTTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCableSegmentType : public IfcFlowSegmentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCableSegmentType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCableSegmentTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCableSegmentType, IfcCableSegmentType> object.
*/
typedef OdSmartPtr<IfcCableSegmentType> IfcCableSegmentTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCABLESEGMENTTYPE_AUTO_IMPL_H
