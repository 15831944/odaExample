...
#ifndef _IFC2X2_FINAL_IFCCOMPOSITECURVE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCOMPOSITECURVE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCompositeCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCompositeCurve);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_Segments; // LIST [1:?] of IfcCompositeCurveSegment
  OdDAI::Logical m_SelfIntersect;   // LOGICAL
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCompositeCurve, IfcCompositeCurve> object.
*/
typedef OdSmartPtr<IfcCompositeCurve> IfcCompositeCurvePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCOMPOSITECURVE_AUTO_IMPL_H
