...
#ifndef _IFC2X2_FINAL_IFCWORKCONTROL_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCWORKCONTROL_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcWorkControl : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcWorkControl);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Select m_StartTime;   // IfcDateTimeSelect
  OdDAI::Select m_FinishTime;   // IfcDateTimeSelect  [optional]
  OdDAI::Enum m_WorkControlType;   // IfcWorkControlTypeEnum  [optional]
  OdAnsiString m_UserDefinedControlType;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcWorkControl, IfcWorkControl> object.
*/
typedef OdSmartPtr<IfcWorkControl> IfcWorkControlPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCWORKCONTROL_AUTO_IMPL_H
