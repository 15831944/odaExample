...
#ifndef _IFC2X2_FINAL_IFCTEXTLITERALWITHEXTENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTEXTLITERALWITHEXTENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTextLiteralWithExtent : public IfcTextLiteral
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTextLiteralWithExtent);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTextLiteralWithExtent, IfcTextLiteralWithExtent> object.
*/
typedef OdSmartPtr<IfcTextLiteralWithExtent> IfcTextLiteralWithExtentPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTEXTLITERALWITHEXTENT_AUTO_IMPL_H
