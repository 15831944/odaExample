...
#ifndef _IFC2X2_FINAL_IFCRELASSOCIATESDOCUMENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELASSOCIATESDOCUMENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelAssociatesDocument : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelAssociatesDocument);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_RelatingDocument;   // IfcDocumentSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelAssociatesDocument, IfcRelAssociatesDocument> object.
*/
typedef OdSmartPtr<IfcRelAssociatesDocument> IfcRelAssociatesDocumentPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELASSOCIATESDOCUMENT_AUTO_IMPL_H
