...
#ifndef _IFC2X2_FINAL_IFCFACETEDBREPWITHVOIDS_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCFACETEDBREPWITHVOIDS_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcFacetedBrepWithVoids : public IfcManifoldSolidBrep
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcFacetedBrepWithVoids);
  //DOM-IGNORE-END
...
public:
  ...
  void getVoids(OdDAIObjectIds& Voids) const;
  OdDAI::OdDAIObjectIdSet& voids();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_Voids; // SET [1:?] of IfcClosedShell
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcFacetedBrepWithVoids, IfcFacetedBrepWithVoids> object.
*/
typedef OdSmartPtr<IfcFacetedBrepWithVoids> IfcFacetedBrepWithVoidsPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCFACETEDBREPWITHVOIDS_AUTO_IMPL_H
