...
#ifndef _IFC2X2_FINAL_IFCPOINTONCURVE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPOINTONCURVE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPointOnCurve : public IfcPoint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPointOnCurve);
  //DOM-IGNORE-END
...
public:
  ...
  double getPointParameter() const;
  void setPointParameter(double PointParameter);
...
protected:
  ...
  double m_PointParameter;   // IfcParameterValue
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPointOnCurve, IfcPointOnCurve> object.
*/
typedef OdSmartPtr<IfcPointOnCurve> IfcPointOnCurvePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPOINTONCURVE_AUTO_IMPL_H
