...
#ifndef _IFC2X2_FINAL_IFCPROPERTYDEPENDENCYRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPROPERTYDEPENDENCYRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPropertyDependencyRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPropertyDependencyRelationship);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_DependingProperty;   // IfcProperty
  OdDAIObjectId m_DependantProperty;   // IfcProperty
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPropertyDependencyRelationship, IfcPropertyDependencyRelationship> object.
*/
typedef OdSmartPtr<IfcPropertyDependencyRelationship> IfcPropertyDependencyRelationshipPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPROPERTYDEPENDENCYRELATIONSHIP_AUTO_IMPL_H
