...
#ifndef _IFC2X2_FINAL_IFCTUBEBUNDLETYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTUBEBUNDLETYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTubeBundleType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTubeBundleType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcTubeBundleTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcTubeBundleTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcTubeBundleTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTubeBundleType, IfcTubeBundleType> object.
*/
typedef OdSmartPtr<IfcTubeBundleType> IfcTubeBundleTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTUBEBUNDLETYPE_AUTO_IMPL_H
