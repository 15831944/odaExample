...
#ifndef _IFC2X2_FINAL_IFCTANKTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTANKTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTankType : public IfcFlowStorageDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTankType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcTankTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcTankTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcTankTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTankType, IfcTankType> object.
*/
typedef OdSmartPtr<IfcTankType> IfcTankTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTANKTYPE_AUTO_IMPL_H
