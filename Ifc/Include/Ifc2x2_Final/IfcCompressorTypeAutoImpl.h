...
#ifndef _IFC2X2_FINAL_IFCCOMPRESSORTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCOMPRESSORTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCompressorType : public IfcFlowMovingDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCompressorType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcCompressorTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcCompressorTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCompressorTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCompressorType, IfcCompressorType> object.
*/
typedef OdSmartPtr<IfcCompressorType> IfcCompressorTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCOMPRESSORTYPE_AUTO_IMPL_H
