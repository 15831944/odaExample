...
#ifndef _IFC2X2_FINAL_IFCANNOTATION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCANNOTATION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcAnnotation : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcAnnotation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcAnnotation, IfcAnnotation> object.
*/
typedef OdSmartPtr<IfcAnnotation> IfcAnnotationPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCANNOTATION_AUTO_IMPL_H
