...
#ifndef _IFC2X2_FINAL_IFCCONSTRAINT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCONSTRAINT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcConstraint : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcConstraint);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Select m_CreationTime;   // IfcDateTimeSelect  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcConstraint, IfcConstraint> object.
*/
typedef OdSmartPtr<IfcConstraint> IfcConstraintPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCONSTRAINT_AUTO_IMPL_H
