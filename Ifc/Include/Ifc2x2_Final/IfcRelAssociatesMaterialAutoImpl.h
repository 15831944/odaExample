...
#ifndef _IFC2X2_FINAL_IFCRELASSOCIATESMATERIAL_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELASSOCIATESMATERIAL_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelAssociatesMaterial : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelAssociatesMaterial);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_RelatingMaterial;   // IfcMaterialSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelAssociatesMaterial, IfcRelAssociatesMaterial> object.
*/
typedef OdSmartPtr<IfcRelAssociatesMaterial> IfcRelAssociatesMaterialPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELASSOCIATESMATERIAL_AUTO_IMPL_H
