...
#ifndef _IFC2X2_FINAL_IFCRELASSIGNSTOPROCESS_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELASSIGNSTOPROCESS_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelAssignsToProcess : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelAssignsToProcess);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getQuantityInProcess() const;
  void setQuantityInProcess(const OdDAIObjectId& QuantityInProcess);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatingProcess;   // IfcProcess
  OdDAIObjectId m_QuantityInProcess;   // IfcMeasureWithUnit  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelAssignsToProcess, IfcRelAssignsToProcess> object.
*/
typedef OdSmartPtr<IfcRelAssignsToProcess> IfcRelAssignsToProcessPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELASSIGNSTOPROCESS_AUTO_IMPL_H
