...
#ifndef _IFC2X2_FINAL_IFCPOLYLINE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPOLYLINE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPolyline : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPolyline);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& points();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_Points; // LIST [2:?] of IfcCartesianPoint
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPolyline, IfcPolyline> object.
*/
typedef OdSmartPtr<IfcPolyline> IfcPolylinePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPOLYLINE_AUTO_IMPL_H
