...
#ifndef _IFC2X2_FINAL_IFCEDGELOOP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCEDGELOOP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcEdgeLoop : public IfcLoop
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcEdgeLoop);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcEdgeLoop, IfcEdgeLoop> object.
*/
typedef OdSmartPtr<IfcEdgeLoop> IfcEdgeLoopPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCEDGELOOP_AUTO_IMPL_H
