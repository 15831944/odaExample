...
#ifndef _IFC2X2_FINAL_IFCTEXTUREMAP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTEXTUREMAP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTextureMap : public IfcTextureCoordinate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTextureMap);
  //DOM-IGNORE-END
...
public:
  ...
  void getVertexBasedTextures(OdDAIObjectIds& VertexBasedTextures) const;
  OdDAI::OdDAIObjectIdSet& vertexBasedTextures();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_VertexBasedTextures; // SET [1:?] of IfcVertexBasedTextureMap [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTextureMap, IfcTextureMap> object.
*/
typedef OdSmartPtr<IfcTextureMap> IfcTextureMapPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTEXTUREMAP_AUTO_IMPL_H
