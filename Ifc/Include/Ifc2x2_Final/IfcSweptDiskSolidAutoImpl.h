...
#ifndef _IFC2X2_FINAL_IFCSWEPTDISKSOLID_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSWEPTDISKSOLID_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSweptDiskSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSweptDiskSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSweptDiskSolid, IfcSweptDiskSolid> object.
*/
typedef OdSmartPtr<IfcSweptDiskSolid> IfcSweptDiskSolidPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSWEPTDISKSOLID_AUTO_IMPL_H
