...
#ifndef _IFC2X2_FINAL_IFCDERIVEDUNITELEMENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDERIVEDUNITELEMENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDerivedUnitElement : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDerivedUnitElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDerivedUnitElement, IfcDerivedUnitElement> object.
*/
typedef OdSmartPtr<IfcDerivedUnitElement> IfcDerivedUnitElementPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDERIVEDUNITELEMENT_AUTO_IMPL_H
