...
#ifndef _IFC2X2_FINAL_IFCSERVICELIFEFACTOR_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSERVICELIFEFACTOR_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcServiceLifeFactor : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcServiceLifeFactor);
  //DOM-IGNORE-END
...
public:
  ...
  IfcServiceLifeFactorTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcServiceLifeFactorTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcServiceLifeFactorTypeEnum
  OdDAI::Select m_UpperValue;   // IfcMeasureValue  [optional]
  OdDAI::Select m_MostUsedValue;   // IfcMeasureValue
  OdDAI::Select m_LowerValue;   // IfcMeasureValue  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcServiceLifeFactor, IfcServiceLifeFactor> object.
*/
typedef OdSmartPtr<IfcServiceLifeFactor> IfcServiceLifeFactorPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSERVICELIFEFACTOR_AUTO_IMPL_H
