...
#ifndef _IFC2X2_FINAL_IFCBOILERTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCBOILERTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcBoilerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcBoilerType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcBoilerTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcBoilerTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcBoilerTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcBoilerType, IfcBoilerType> object.
*/
typedef OdSmartPtr<IfcBoilerType> IfcBoilerTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCBOILERTYPE_AUTO_IMPL_H
