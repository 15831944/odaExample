...
#ifndef _IFC2X2_FINAL_IFCDUCTFITTINGTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDUCTFITTINGTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDuctFittingType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDuctFittingType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcDuctFittingTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcDuctFittingTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcDuctFittingTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDuctFittingType, IfcDuctFittingType> object.
*/
typedef OdSmartPtr<IfcDuctFittingType> IfcDuctFittingTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDUCTFITTINGTYPE_AUTO_IMPL_H
