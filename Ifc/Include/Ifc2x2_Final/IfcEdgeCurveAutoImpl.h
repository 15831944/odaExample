...
#ifndef _IFC2X2_FINAL_IFCEDGECURVE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCEDGECURVE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcEdgeCurve : public IfcEdge
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcEdgeCurve);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getEdgeGeometry() const;
  void setEdgeGeometry(const OdDAIObjectId& EdgeGeometry);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_EdgeGeometry;   // IfcCurve
  OdDAI::Boolean m_SameSense;   // BOOLEAN
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcEdgeCurve, IfcEdgeCurve> object.
*/
typedef OdSmartPtr<IfcEdgeCurve> IfcEdgeCurvePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCEDGECURVE_AUTO_IMPL_H
