...
#ifndef _IFC2X2_FINAL_IFCIRREGULARTIMESERIESVALUE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCIRREGULARTIMESERIESVALUE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcIrregularTimeSeriesValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcIrregularTimeSeriesValue);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_TimeStamp;   // IfcDateTimeSelect
  OdDAI::List<OdDAI::Select> m_ListValues; // LIST [1:?] of IfcValue
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcIrregularTimeSeriesValue, IfcIrregularTimeSeriesValue> object.
*/
typedef OdSmartPtr<IfcIrregularTimeSeriesValue> IfcIrregularTimeSeriesValuePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCIRREGULARTIMESERIESVALUE_AUTO_IMPL_H
