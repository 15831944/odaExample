...
#ifndef _IFC2X2_FINAL_IFCCONNECTIONPORTGEOMETRY_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCONNECTIONPORTGEOMETRY_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcConnectionPortGeometry : public IfcConnectionGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcConnectionPortGeometry);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getProfileOfPort() const;
  void setProfileOfPort(const OdDAIObjectId& ProfileOfPort);
...
protected:
  // Fields declaration: 
  OdDAI::Select m_LocationAtRelatingElement;   // IfcAxis2Placement
  OdDAI::Select m_LocationAtRelatedElement;   // IfcAxis2Placement  [optional]
  OdDAIObjectId m_ProfileOfPort;   // IfcProfileDef
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcConnectionPortGeometry, IfcConnectionPortGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionPortGeometry> IfcConnectionPortGeometryPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCONNECTIONPORTGEOMETRY_AUTO_IMPL_H
