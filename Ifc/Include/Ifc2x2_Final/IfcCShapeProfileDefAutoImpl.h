...
#ifndef _IFC2X2_FINAL_IFCCSHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCSHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCShapeProfileDef);
  //DOM-IGNORE-END
...
public:
  ...
  double getInternalFilletRadius() const;
  void setInternalFilletRadius(double InternalFilletRadius);
...
protected:
  ...
  IfcPositiveLengthMeasure m_Width;   // IfcPositiveLengthMeasure
  IfcPositiveLengthMeasure m_WallThickness;   // IfcPositiveLengthMeasure
  IfcPositiveLengthMeasure m_Girth;   // IfcPositiveLengthMeasure
  IfcPositiveLengthMeasure m_InternalFilletRadius;   // IfcPositiveLengthMeasure  [optional]
  IfcPositiveLengthMeasure m_CentreOfGravityInX;   // IfcPositiveLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCShapeProfileDef, IfcCShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcCShapeProfileDef> IfcCShapeProfileDefPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCSHAPEPROFILEDEF_AUTO_IMPL_H
