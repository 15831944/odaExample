...
#ifndef _IFC2X2_FINAL_IFCSURFACEOFREVOLUTION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSURFACEOFREVOLUTION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSurfaceOfRevolution : public IfcSweptSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSurfaceOfRevolution);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getAxisPosition() const;
  void setAxisPosition(const OdDAIObjectId& AxisPosition);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_AxisPosition;   // IfcAxis1Placement
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSurfaceOfRevolution, IfcSurfaceOfRevolution> object.
*/
typedef OdSmartPtr<IfcSurfaceOfRevolution> IfcSurfaceOfRevolutionPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSURFACEOFREVOLUTION_AUTO_IMPL_H
