...
#ifndef _IFC2X2_FINAL_IFCPROPERTYREFERENCEVALUE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPROPERTYREFERENCEVALUE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPropertyReferenceValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPropertyReferenceValue);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Select m_PropertyReference;   // IfcObjectReferenceSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPropertyReferenceValue, IfcPropertyReferenceValue> object.
*/
typedef OdSmartPtr<IfcPropertyReferenceValue> IfcPropertyReferenceValuePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPROPERTYREFERENCEVALUE_AUTO_IMPL_H
