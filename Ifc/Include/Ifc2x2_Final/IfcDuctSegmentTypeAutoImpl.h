...
#ifndef _IFC2X2_FINAL_IFCDUCTSEGMENTTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDUCTSEGMENTTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDuctSegmentType : public IfcFlowSegmentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDuctSegmentType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcDuctSegmentTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcDuctSegmentTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcDuctSegmentTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDuctSegmentType, IfcDuctSegmentType> object.
*/
typedef OdSmartPtr<IfcDuctSegmentType> IfcDuctSegmentTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDUCTSEGMENTTYPE_AUTO_IMPL_H
