...
#ifndef _IFC2X2_FINAL_IFCGEOMETRICREPRESENTATIONSUBCONTEXT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCGEOMETRICREPRESENTATIONSUBCONTEXT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcGeometricRepresentationSubContext : public IfcGeometricRepresentationContext
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcGeometricRepresentationSubContext);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_ParentContext;   // IfcGeometricRepresentationContext
  IfcPositiveRatioMeasure m_TargetScale;   // IfcPositiveRatioMeasure  [optional]
  OdDAI::Enum m_TargetView;   // IfcGeometricProjectionEnum
  OdAnsiString m_UserDefinedTargetView;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcGeometricRepresentationSubContext, IfcGeometricRepresentationSubContext> object.
*/
typedef OdSmartPtr<IfcGeometricRepresentationSubContext> IfcGeometricRepresentationSubContextPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCGEOMETRICREPRESENTATIONSUBCONTEXT_AUTO_IMPL_H
