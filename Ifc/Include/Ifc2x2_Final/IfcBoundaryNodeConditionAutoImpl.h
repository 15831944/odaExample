...
#ifndef _IFC2X2_FINAL_IFCBOUNDARYNODECONDITION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCBOUNDARYNODECONDITION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcBoundaryNodeCondition : public IfcBoundaryCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcBoundaryNodeCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcBoundaryNodeCondition, IfcBoundaryNodeCondition> object.
*/
typedef OdSmartPtr<IfcBoundaryNodeCondition> IfcBoundaryNodeConditionPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCBOUNDARYNODECONDITION_AUTO_IMPL_H
