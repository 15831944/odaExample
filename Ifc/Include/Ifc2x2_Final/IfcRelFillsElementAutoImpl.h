...
#ifndef _IFC2X2_FINAL_IFCRELFILLSELEMENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELFILLSELEMENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelFillsElement : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelFillsElement);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAIObjectId m_RelatedBuildingElement;   // IfcElement
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelFillsElement, IfcRelFillsElement> object.
*/
typedef OdSmartPtr<IfcRelFillsElement> IfcRelFillsElementPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELFILLSELEMENT_AUTO_IMPL_H
