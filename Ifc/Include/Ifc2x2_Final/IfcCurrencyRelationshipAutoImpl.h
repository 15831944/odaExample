...
#ifndef _IFC2X2_FINAL_IFCCURRENCYRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCURRENCYRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCurrencyRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCurrencyRelationship);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAIObjectId m_RateDateTime;   // IfcDateAndTime
  OdDAIObjectId m_RateSource;   // IfcLibraryInformation  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCurrencyRelationship, IfcCurrencyRelationship> object.
*/
typedef OdSmartPtr<IfcCurrencyRelationship> IfcCurrencyRelationshipPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCURRENCYRELATIONSHIP_AUTO_IMPL_H
