...
#ifndef _IFC2X2_FINAL_IFCCONSTRUCTIONRESOURCE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCONSTRUCTIONRESOURCE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcConstructionResource : public IfcResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcConstructionResource);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_ResourceIdentifier;   // IfcIdentifier  [optional]
  OdAnsiString m_ResourceGroup;   // IfcLabel  [optional]
  OdDAI::Enum m_ResourceConsumption;   // IfcResourceConsumptionEnum  [optional]
  OdDAIObjectId m_BaseQuantity;   // IfcMeasureWithUnit  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcConstructionResource, IfcConstructionResource> object.
*/
typedef OdSmartPtr<IfcConstructionResource> IfcConstructionResourcePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCONSTRUCTIONRESOURCE_AUTO_IMPL_H
