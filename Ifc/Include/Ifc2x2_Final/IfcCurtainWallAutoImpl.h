...
#ifndef _IFC2X2_FINAL_IFCCURTAINWALL_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCURTAINWALL_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCurtainWall : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCurtainWall);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCurtainWall, IfcCurtainWall> object.
*/
typedef OdSmartPtr<IfcCurtainWall> IfcCurtainWallPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCURTAINWALL_AUTO_IMPL_H
