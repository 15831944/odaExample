...
#ifndef _IFC2X2_FINAL_IFCLIBRARYREFERENCE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCLIBRARYREFERENCE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcLibraryReference : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcLibraryReference);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvReferenceIntoLibrary(OdDAIObjectIds& ReferenceIntoLibrary) const;
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcLibraryReference, IfcLibraryReference> object.
*/
typedef OdSmartPtr<IfcLibraryReference> IfcLibraryReferencePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCLIBRARYREFERENCE_AUTO_IMPL_H
