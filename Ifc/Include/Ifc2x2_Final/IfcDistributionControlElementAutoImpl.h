...
#ifndef _IFC2X2_FINAL_IFCDISTRIBUTIONCONTROLELEMENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDISTRIBUTIONCONTROLELEMENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDistributionControlElement : public IfcDistributionElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDistributionControlElement);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getControlElementId() const;
  void setControlElementId(const OdAnsiString& ControlElementId);
...
protected:
  // Fields declaration: 
  OdAnsiString m_ControlElementId;   // IfcIdentifier  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDistributionControlElement, IfcDistributionControlElement> object.
*/
typedef OdSmartPtr<IfcDistributionControlElement> IfcDistributionControlElementPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDISTRIBUTIONCONTROLELEMENT_AUTO_IMPL_H
