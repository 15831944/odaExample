...
#ifndef _IFC2X2_FINAL_IFCSYMBOLSTYLE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSYMBOLSTYLE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSymbolStyle : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSymbolStyle);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Select m_StyleOfSymbol;   // IfcSymbolStyleSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSymbolStyle, IfcSymbolStyle> object.
*/
typedef OdSmartPtr<IfcSymbolStyle> IfcSymbolStylePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSYMBOLSTYLE_AUTO_IMPL_H
