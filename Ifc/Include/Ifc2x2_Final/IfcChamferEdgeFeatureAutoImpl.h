...
#ifndef _IFC2X2_FINAL_IFCCHAMFEREDGEFEATURE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCHAMFEREDGEFEATURE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcChamferEdgeFeature : public IfcEdgeFeature
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcChamferEdgeFeature);
  //DOM-IGNORE-END
...
protected:
  ...
  IfcPositiveLengthMeasure m_Height;   // IfcPositiveLengthMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcChamferEdgeFeature, IfcChamferEdgeFeature> object.
*/
typedef OdSmartPtr<IfcChamferEdgeFeature> IfcChamferEdgeFeaturePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCHAMFEREDGEFEATURE_AUTO_IMPL_H
