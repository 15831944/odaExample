...
#ifndef _IFC2X2_FINAL_IFCCOMPOSITEPROFILEDEF_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCOMPOSITEPROFILEDEF_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCompositeProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCompositeProfileDef);
  //DOM-IGNORE-END
...
public:
  ...
  void getProfiles(OdDAIObjectIds& Profiles) const;
  OdDAI::OdDAIObjectIdSet& profiles();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_Profiles; // SET [2:?] of IfcProfileDef
  OdAnsiString m_Label;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCompositeProfileDef, IfcCompositeProfileDef> object.
*/
typedef OdSmartPtr<IfcCompositeProfileDef> IfcCompositeProfileDefPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCOMPOSITEPROFILEDEF_AUTO_IMPL_H
