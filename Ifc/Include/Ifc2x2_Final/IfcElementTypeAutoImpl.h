...
#ifndef _IFC2X2_FINAL_IFCELEMENTTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCELEMENTTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcElementType : public IfcTypeProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcElementType, IfcElementType> object.
*/
typedef OdSmartPtr<IfcElementType> IfcElementTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCELEMENTTYPE_AUTO_IMPL_H
