...
#ifndef _IFC2X2_FINAL_IFCSTRUCTURALCONNECTION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTRUCTURALCONNECTION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStructuralConnection : public IfcStructuralItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcStructuralConnection);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvConnectsStructuralMembers(OdDAIObjectIds& ConnectsStructuralMembers) const;
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStructuralConnection, IfcStructuralConnection> object.
*/
typedef OdSmartPtr<IfcStructuralConnection> IfcStructuralConnectionPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTRUCTURALCONNECTION_AUTO_IMPL_H
