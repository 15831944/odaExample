...
#ifndef _IFC2X2_FINAL_IFCMETRIC_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCMETRIC_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcMetric : public IfcConstraint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcMetric);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcMetric, IfcMetric> object.
*/
typedef OdSmartPtr<IfcMetric> IfcMetricPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCMETRIC_AUTO_IMPL_H
