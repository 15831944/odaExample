...
#ifndef _IFC2X2_FINAL_IFCORGANIZATION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCORGANIZATION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcOrganization : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcOrganization);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcOrganization, IfcOrganization> object.
*/
typedef OdSmartPtr<IfcOrganization> IfcOrganizationPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCORGANIZATION_AUTO_IMPL_H
