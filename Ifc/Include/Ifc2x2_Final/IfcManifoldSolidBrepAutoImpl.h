...
#ifndef _IFC2X2_FINAL_IFCMANIFOLDSOLIDBREP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCMANIFOLDSOLIDBREP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcManifoldSolidBrep : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcManifoldSolidBrep);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getOuter() const;
  void setOuter(const OdDAIObjectId& Outer);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Outer;   // IfcClosedShell
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcManifoldSolidBrep, IfcManifoldSolidBrep> object.
*/
typedef OdSmartPtr<IfcManifoldSolidBrep> IfcManifoldSolidBrepPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCMANIFOLDSOLIDBREP_AUTO_IMPL_H
