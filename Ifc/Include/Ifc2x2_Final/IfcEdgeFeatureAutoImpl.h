...
#ifndef _IFC2X2_FINAL_IFCEDGEFEATURE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCEDGEFEATURE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcEdgeFeature : public IfcFeatureElementSubtraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcEdgeFeature);
  //DOM-IGNORE-END
...
public:
  ...
  void setFeatureLength(double FeatureLength);
...
protected:
  // Fields declaration: 
  IfcPositiveLengthMeasure m_FeatureLength;   // IfcPositiveLengthMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcEdgeFeature, IfcEdgeFeature> object.
*/
typedef OdSmartPtr<IfcEdgeFeature> IfcEdgeFeaturePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCEDGEFEATURE_AUTO_IMPL_H
