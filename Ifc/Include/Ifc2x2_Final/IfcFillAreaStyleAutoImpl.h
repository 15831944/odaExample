...
#ifndef _IFC2X2_FINAL_IFCFILLAREASTYLE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCFILLAREASTYLE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcFillAreaStyle : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcFillAreaStyle);
  //DOM-IGNORE-END
...
public:
  ...
  void getFillStyles(OdArray<OdDAI::Select >& FillStyles) const;
  void getFillStylesWrapperArray(OdArray<IfcFillStyleSelect>& FillStyles) const;
  OdDAI::Set<OdDAI::Select>& fillStyles();
...
protected:
  // Fields declaration: 
  OdDAI::Set<OdDAI::Select> m_FillStyles; // SET [1:?] of IfcFillStyleSelect
  OdAnsiString m_Name;   // IfcLabel
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcFillAreaStyle, IfcFillAreaStyle> object.
*/
typedef OdSmartPtr<IfcFillAreaStyle> IfcFillAreaStylePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCFILLAREASTYLE_AUTO_IMPL_H
