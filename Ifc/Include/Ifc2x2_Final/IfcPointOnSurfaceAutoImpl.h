...
#ifndef _IFC2X2_FINAL_IFCPOINTONSURFACE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPOINTONSURFACE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPointOnSurface : public IfcPoint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPointOnSurface);
  //DOM-IGNORE-END
...
public:
  ...
  double getPointParameterU() const;
  void setPointParameterU(double PointParameterU);
  double getPointParameterV() const;
  void setPointParameterV(double PointParameterV);
...
protected:
  ...
  double m_PointParameterU;   // IfcParameterValue
  double m_PointParameterV;   // IfcParameterValue
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPointOnSurface, IfcPointOnSurface> object.
*/
typedef OdSmartPtr<IfcPointOnSurface> IfcPointOnSurfacePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPOINTONSURFACE_AUTO_IMPL_H
