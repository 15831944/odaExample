...
#ifndef _IFC2X2_FINAL_IFCRELASSIGNS_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELASSIGNS_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelAssigns : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelAssigns);
  //DOM-IGNORE-END
...
public:
  ...
  IfcObjectTypeEnum getRelatedObjectsType() const;
  void setRelatedObjectsType(IfcObjectTypeEnum RelatedObjectsType);
...
protected:
  ...
  OdDAI::Enum m_RelatedObjectsType;   // IfcObjectTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelAssigns, IfcRelAssigns> object.
*/
typedef OdSmartPtr<IfcRelAssigns> IfcRelAssignsPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELASSIGNS_AUTO_IMPL_H
