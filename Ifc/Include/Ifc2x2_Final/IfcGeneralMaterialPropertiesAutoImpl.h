...
#ifndef _IFC2X2_FINAL_IFCGENERALMATERIALPROPERTIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCGENERALMATERIALPROPERTIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcGeneralMaterialProperties : public IfcMaterialProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcGeneralMaterialProperties);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_MolecularWeight;   // IfcMolecularWeightMeasure  [optional]
  IfcNormalisedRatioMeasure m_Porosity;   // IfcNormalisedRatioMeasure  [optional]
  double m_MassDensity;   // IfcMassDensityMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcGeneralMaterialProperties, IfcGeneralMaterialProperties> object.
*/
typedef OdSmartPtr<IfcGeneralMaterialProperties> IfcGeneralMaterialPropertiesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCGENERALMATERIALPROPERTIES_AUTO_IMPL_H
