...
#ifndef _IFC2X2_FINAL_IFCTABLE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTABLE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTable : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTable);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_Name;   // STRING
  OdDAI::OdDAIObjectIdList m_Rows; // LIST [1:?] of IfcTableRow
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTable, IfcTable> object.
*/
typedef OdSmartPtr<IfcTable> IfcTablePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTABLE_AUTO_IMPL_H
