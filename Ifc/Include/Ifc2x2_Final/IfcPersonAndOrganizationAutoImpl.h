...
#ifndef _IFC2X2_FINAL_IFCPERSONANDORGANIZATION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPERSONANDORGANIZATION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPersonAndOrganization : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPersonAndOrganization);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPersonAndOrganization, IfcPersonAndOrganization> object.
*/
typedef OdSmartPtr<IfcPersonAndOrganization> IfcPersonAndOrganizationPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPERSONANDORGANIZATION_AUTO_IMPL_H
