...
#ifndef _IFC2X2_FINAL_IFCFILTERTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCFILTERTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcFilterType : public IfcFlowTreatmentDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcFilterType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcFilterTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcFilterTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcFilterTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcFilterType, IfcFilterType> object.
*/
typedef OdSmartPtr<IfcFilterType> IfcFilterTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCFILTERTYPE_AUTO_IMPL_H
