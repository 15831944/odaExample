...
#ifndef _IFC2X2_FINAL_IFCCOSTSCHEDULE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCOSTSCHEDULE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCostSchedule : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCostSchedule);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Select m_PreparedBy;   // IfcActorSelect  [optional]
  OdDAI::Select m_SubmittedOn;   // IfcDateTimeSelect  [optional]
  OdAnsiString m_Status;   // IfcLabel  [optional]
  OdDAI::Set<OdDAI::Select> m_TargetUsers; // SET [1:?] of IfcActorSelect [optional]

  OdDAI::Select m_UpdateDate;   // IfcDateTimeSelect  [optional]
  OdAnsiString m_ID;   // IfcIdentifier
  OdDAI::Enum m_PredefinedType;   // IfcCostScheduleTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCostSchedule, IfcCostSchedule> object.
*/
typedef OdSmartPtr<IfcCostSchedule> IfcCostSchedulePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCOSTSCHEDULE_AUTO_IMPL_H
