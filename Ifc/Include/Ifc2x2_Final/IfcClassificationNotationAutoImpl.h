...
#ifndef _IFC2X2_FINAL_IFCCLASSIFICATIONNOTATION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCLASSIFICATIONNOTATION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcClassificationNotation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcClassificationNotation);
  //DOM-IGNORE-END
...
public:
  ...
  void getNotationFacets(OdDAIObjectIds& NotationFacets) const;
  OdDAI::OdDAIObjectIdSet& notationFacets();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_NotationFacets; // SET [1:?] of IfcClassificationNotationFacet
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcClassificationNotation, IfcClassificationNotation> object.
*/
typedef OdSmartPtr<IfcClassificationNotation> IfcClassificationNotationPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCLASSIFICATIONNOTATION_AUTO_IMPL_H
