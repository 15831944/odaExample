...
#ifndef _IFC2X2_FINAL_IFCCSGSOLID_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCSGSOLID_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCsgSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCsgSolid);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_TreeRootExpression;   // IfcCsgSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCsgSolid, IfcCsgSolid> object.
*/
typedef OdSmartPtr<IfcCsgSolid> IfcCsgSolidPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCSGSOLID_AUTO_IMPL_H
