...
#ifndef _IFC2X2_FINAL_IFCCOLOURRGB_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCOLOURRGB_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcColourRgb : public IfcColourSpecification
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcColourRgb);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  IfcNormalisedRatioMeasure m_Red;   // IfcNormalisedRatioMeasure
  IfcNormalisedRatioMeasure m_Green;   // IfcNormalisedRatioMeasure
  IfcNormalisedRatioMeasure m_Blue;   // IfcNormalisedRatioMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcColourRgb, IfcColourRgb> object.
*/
typedef OdSmartPtr<IfcColourRgb> IfcColourRgbPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCOLOURRGB_AUTO_IMPL_H
