...
#ifndef _IFC2X2_FINAL_IFCDISTRIBUTIONFLOWELEMENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDISTRIBUTIONFLOWELEMENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDistributionFlowElement : public IfcDistributionElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDistributionFlowElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDistributionFlowElement, IfcDistributionFlowElement> object.
*/
typedef OdSmartPtr<IfcDistributionFlowElement> IfcDistributionFlowElementPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDISTRIBUTIONFLOWELEMENT_AUTO_IMPL_H
