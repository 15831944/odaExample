...
#ifndef _IFC2X2_FINAL_IFCAPPLIEDVALUERELATIONSHIP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCAPPLIEDVALUERELATIONSHIP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcAppliedValueRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcAppliedValueRelationship);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getComponentOfTotal() const;
  void setComponentOfTotal(const OdDAIObjectId& ComponentOfTotal);
  void getComponents(OdDAIObjectIds& Components) const;
  OdDAI::OdDAIObjectIdSet& components();
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_ComponentOfTotal;   // IfcAppliedValue
  OdDAI::OdDAIObjectIdSet m_Components; // SET [1:?] of IfcAppliedValue
  OdDAI::Enum m_ArithmeticOperator;   // IfcArithmeticOperatorEnum
  OdAnsiString m_Name;   // IfcLabel  [optional]
  OdAnsiString m_Description;   // IfcText  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcAppliedValueRelationship, IfcAppliedValueRelationship> object.
*/
typedef OdSmartPtr<IfcAppliedValueRelationship> IfcAppliedValueRelationshipPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCAPPLIEDVALUERELATIONSHIP_AUTO_IMPL_H
