...
#ifndef _IFC2X2_FINAL_IFCWINDOW_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCWINDOW_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcWindow : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcWindow);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcWindow, IfcWindow> object.
*/
typedef OdSmartPtr<IfcWindow> IfcWindowPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCWINDOW_AUTO_IMPL_H
