...
#ifndef _IFC2X2_FINAL_IFCFACESURFACE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCFACESURFACE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcFaceSurface : public IfcFace
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcFaceSurface);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getFaceSurface() const;
  void setFaceSurface(const OdDAIObjectId& FaceSurface);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_FaceSurface;   // IfcSurface
  OdDAI::Boolean m_SameSense;   // BOOLEAN
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcFaceSurface, IfcFaceSurface> object.
*/
typedef OdSmartPtr<IfcFaceSurface> IfcFaceSurfacePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCFACESURFACE_AUTO_IMPL_H
