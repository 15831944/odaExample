...
#ifndef _IFC2X2_FINAL_IFCPHYSICALSIMPLEQUANTITY_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPHYSICALSIMPLEQUANTITY_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPhysicalSimpleQuantity : public IfcPhysicalQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcPhysicalSimpleQuantity);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Unit;   // IfcNamedUnit  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPhysicalSimpleQuantity, IfcPhysicalSimpleQuantity> object.
*/
typedef OdSmartPtr<IfcPhysicalSimpleQuantity> IfcPhysicalSimpleQuantityPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPHYSICALSIMPLEQUANTITY_AUTO_IMPL_H
