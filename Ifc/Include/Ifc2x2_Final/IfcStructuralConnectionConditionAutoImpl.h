...
#ifndef _IFC2X2_FINAL_IFCSTRUCTURALCONNECTIONCONDITION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTRUCTURALCONNECTIONCONDITION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStructuralConnectionCondition : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcStructuralConnectionCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStructuralConnectionCondition, IfcStructuralConnectionCondition> object.
*/
typedef OdSmartPtr<IfcStructuralConnectionCondition> IfcStructuralConnectionConditionPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTRUCTURALCONNECTIONCONDITION_AUTO_IMPL_H
