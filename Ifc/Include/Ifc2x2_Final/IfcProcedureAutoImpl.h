...
#ifndef _IFC2X2_FINAL_IFCPROCEDURE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPROCEDURE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcProcedure : public IfcProcess
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcProcedure);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_ProcedureID;   // IfcIdentifier
  OdDAI::Enum m_ProcedureType;   // IfcProcedureTypeEnum
  OdAnsiString m_UserDefinedProcedureType;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcProcedure, IfcProcedure> object.
*/
typedef OdSmartPtr<IfcProcedure> IfcProcedurePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPROCEDURE_AUTO_IMPL_H
