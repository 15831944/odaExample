...
#ifndef _IFC2X2_FINAL_IFCIMAGETEXTURE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCIMAGETEXTURE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcImageTexture : public IfcSurfaceTexture
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcImageTexture);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_UrlReference;   // IfcIdentifier
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcImageTexture, IfcImageTexture> object.
*/
typedef OdSmartPtr<IfcImageTexture> IfcImageTexturePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCIMAGETEXTURE_AUTO_IMPL_H
