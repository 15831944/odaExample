...
#ifndef _IFC2X2_FINAL_IFCPRESENTATIONSTYLEASSIGNMENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPRESENTATIONSTYLEASSIGNMENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPresentationStyleAssignment : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPresentationStyleAssignment);
  //DOM-IGNORE-END
...
public:
  ...
  void getStyles(OdArray<OdDAI::Select >& Styles) const;
  void getStylesWrapperArray(OdArray<IfcPresentationStyleSelect>& Styles) const;
  OdDAI::Set<OdDAI::Select>& styles();
...
protected:
  // Fields declaration: 
  OdDAI::Set<OdDAI::Select> m_Styles; // SET [1:?] of IfcPresentationStyleSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPresentationStyleAssignment, IfcPresentationStyleAssignment> object.
*/
typedef OdSmartPtr<IfcPresentationStyleAssignment> IfcPresentationStyleAssignmentPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPRESENTATIONSTYLEASSIGNMENT_AUTO_IMPL_H
