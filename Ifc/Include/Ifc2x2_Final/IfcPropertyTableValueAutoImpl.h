...
#ifndef _IFC2X2_FINAL_IFCPROPERTYTABLEVALUE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPROPERTYTABLEVALUE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPropertyTableValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPropertyTableValue);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::List<OdDAI::Select> m_DefiningValues; // LIST [1:?] of IfcValue
  OdDAI::List<OdDAI::Select> m_DefinedValues; // LIST [1:?] of IfcValue
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPropertyTableValue, IfcPropertyTableValue> object.
*/
typedef OdSmartPtr<IfcPropertyTableValue> IfcPropertyTableValuePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPROPERTYTABLEVALUE_AUTO_IMPL_H
