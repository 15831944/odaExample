...
#ifndef _IFC2X2_FINAL_IFCCARTESIANPOINT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCARTESIANPOINT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCartesianPoint : public IfcPoint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCartesianPoint);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::DoubleList m_Coordinates; // LIST [1:3] of IfcLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCartesianPoint, IfcCartesianPoint> object.
*/
typedef OdSmartPtr<IfcCartesianPoint> IfcCartesianPointPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCARTESIANPOINT_AUTO_IMPL_H
