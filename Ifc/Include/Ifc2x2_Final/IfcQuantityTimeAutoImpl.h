...
#ifndef _IFC2X2_FINAL_IFCQUANTITYTIME_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCQUANTITYTIME_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcQuantityTime : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcQuantityTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcQuantityTime, IfcQuantityTime> object.
*/
typedef OdSmartPtr<IfcQuantityTime> IfcQuantityTimePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCQUANTITYTIME_AUTO_IMPL_H
