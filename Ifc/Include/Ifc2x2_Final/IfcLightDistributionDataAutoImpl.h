...
#ifndef _IFC2X2_FINAL_IFCLIGHTDISTRIBUTIONDATA_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCLIGHTDISTRIBUTIONDATA_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcLightDistributionData : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcLightDistributionData);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcLightDistributionData, IfcLightDistributionData> object.
*/
typedef OdSmartPtr<IfcLightDistributionData> IfcLightDistributionDataPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCLIGHTDISTRIBUTIONDATA_AUTO_IMPL_H
