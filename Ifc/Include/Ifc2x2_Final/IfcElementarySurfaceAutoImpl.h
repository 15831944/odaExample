...
#ifndef _IFC2X2_FINAL_IFCELEMENTARYSURFACE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCELEMENTARYSURFACE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcElementarySurface : public IfcSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcElementarySurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcElementarySurface, IfcElementarySurface> object.
*/
typedef OdSmartPtr<IfcElementarySurface> IfcElementarySurfacePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCELEMENTARYSURFACE_AUTO_IMPL_H
