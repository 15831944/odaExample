...
#ifndef _IFC2X2_FINAL_IFCREVOLVEDAREASOLID_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCREVOLVEDAREASOLID_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRevolvedAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRevolvedAreaSolid);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Axis;   // IfcAxis1Placement
  double m_Angle;   // IfcPlaneAngleMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRevolvedAreaSolid, IfcRevolvedAreaSolid> object.
*/
typedef OdSmartPtr<IfcRevolvedAreaSolid> IfcRevolvedAreaSolidPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCREVOLVEDAREASOLID_AUTO_IMPL_H
