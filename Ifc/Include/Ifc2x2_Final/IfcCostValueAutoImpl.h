...
#ifndef _IFC2X2_FINAL_IFCCOSTVALUE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCOSTVALUE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCostValue : public IfcAppliedValue
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCostValue);
  //DOM-IGNORE-END
...
protected:
  ...
  OdAnsiString m_Condition;   // IfcText  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCostValue, IfcCostValue> object.
*/
typedef OdSmartPtr<IfcCostValue> IfcCostValuePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCOSTVALUE_AUTO_IMPL_H
