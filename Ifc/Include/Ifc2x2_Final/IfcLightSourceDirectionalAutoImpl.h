...
#ifndef _IFC2X2_FINAL_IFCLIGHTSOURCEDIRECTIONAL_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCLIGHTSOURCEDIRECTIONAL_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcLightSourceDirectional : public IfcLightSource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcLightSourceDirectional);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcLightSourceDirectional, IfcLightSourceDirectional> object.
*/
typedef OdSmartPtr<IfcLightSourceDirectional> IfcLightSourceDirectionalPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCLIGHTSOURCEDIRECTIONAL_AUTO_IMPL_H
