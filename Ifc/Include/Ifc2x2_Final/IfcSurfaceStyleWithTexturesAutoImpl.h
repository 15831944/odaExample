...
#ifndef _IFC2X2_FINAL_IFCSURFACESTYLEWITHTEXTURES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSURFACESTYLEWITHTEXTURES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSurfaceStyleWithTextures : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSurfaceStyleWithTextures);
  //DOM-IGNORE-END
...
public:
  ...
  void getTextures(OdDAIObjectIds& Textures) const;
  OdDAI::OdDAIObjectIdSet& textures();
  void getInvHasTextureCoordinates(OdDAIObjectIds& HasTextureCoordinates) const;
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_Textures; // SET [1:?] of IfcSurfaceTexture
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSurfaceStyleWithTextures, IfcSurfaceStyleWithTextures> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleWithTextures> IfcSurfaceStyleWithTexturesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSURFACESTYLEWITHTEXTURES_AUTO_IMPL_H
