...
#ifndef _IFC2X2_FINAL_IFCREFERENCESVALUEDOCUMENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCREFERENCESVALUEDOCUMENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcReferencesValueDocument : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcReferencesValueDocument);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdSet& referencingValues();
...
protected:
  ...
  OdDAI::OdDAIObjectIdSet m_ReferencingValues; // SET [1:?] of IfcAppliedValue
  OdAnsiString m_Name;   // IfcLabel  [optional]
  OdAnsiString m_Description;   // IfcText  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcReferencesValueDocument, IfcReferencesValueDocument> object.
*/
typedef OdSmartPtr<IfcReferencesValueDocument> IfcReferencesValueDocumentPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCREFERENCESVALUEDOCUMENT_AUTO_IMPL_H
