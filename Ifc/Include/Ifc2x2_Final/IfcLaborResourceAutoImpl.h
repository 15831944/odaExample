...
#ifndef _IFC2X2_FINAL_IFCLABORRESOURCE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCLABORRESOURCE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcLaborResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcLaborResource);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getSkillSet() const;
  void setSkillSet(const OdAnsiString& SkillSet);
...
protected:
  // Fields declaration: 
  OdAnsiString m_SkillSet;   // IfcText  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcLaborResource, IfcLaborResource> object.
*/
typedef OdSmartPtr<IfcLaborResource> IfcLaborResourcePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCLABORRESOURCE_AUTO_IMPL_H
