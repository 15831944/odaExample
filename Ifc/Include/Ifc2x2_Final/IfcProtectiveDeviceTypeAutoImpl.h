...
#ifndef _IFC2X2_FINAL_IFCPROTECTIVEDEVICETYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPROTECTIVEDEVICETYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcProtectiveDeviceType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcProtectiveDeviceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcProtectiveDeviceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcProtectiveDeviceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcProtectiveDeviceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcProtectiveDeviceType, IfcProtectiveDeviceType> object.
*/
typedef OdSmartPtr<IfcProtectiveDeviceType> IfcProtectiveDeviceTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPROTECTIVEDEVICETYPE_AUTO_IMPL_H
