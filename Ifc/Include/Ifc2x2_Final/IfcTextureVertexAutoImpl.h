...
#ifndef _IFC2X2_FINAL_IFCTEXTUREVERTEX_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTEXTUREVERTEX_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTextureVertex : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTextureVertex);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::DoubleList m_Coordinates; // LIST [2:2] of IfcParameterValue
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTextureVertex, IfcTextureVertex> object.
*/
typedef OdSmartPtr<IfcTextureVertex> IfcTextureVertexPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTEXTUREVERTEX_AUTO_IMPL_H
