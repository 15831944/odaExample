...
#ifndef _IFC2X2_FINAL_IFCCONIC_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCONIC_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcConic : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcConic);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_Position;   // IfcAxis2Placement
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcConic, IfcConic> object.
*/
typedef OdSmartPtr<IfcConic> IfcConicPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCONIC_AUTO_IMPL_H
