...
#ifndef _IFC2X2_FINAL_IFCRELASSOCIATESAPPROVAL_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELASSOCIATESAPPROVAL_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelAssociatesApproval : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelAssociatesApproval);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelAssociatesApproval, IfcRelAssociatesApproval> object.
*/
typedef OdSmartPtr<IfcRelAssociatesApproval> IfcRelAssociatesApprovalPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELASSOCIATESAPPROVAL_AUTO_IMPL_H
