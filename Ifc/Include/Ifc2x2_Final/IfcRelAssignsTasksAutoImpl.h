...
#ifndef _IFC2X2_FINAL_IFCRELASSIGNSTASKS_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELASSIGNSTASKS_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelAssignsTasks : public IfcRelAssignsToControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelAssignsTasks);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelAssignsTasks, IfcRelAssignsTasks> object.
*/
typedef OdSmartPtr<IfcRelAssignsTasks> IfcRelAssignsTasksPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELASSIGNSTASKS_AUTO_IMPL_H
