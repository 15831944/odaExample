...
#ifndef _IFC2X2_FINAL_IFCSOLIDMODEL_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSOLIDMODEL_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSolidModel : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcSolidModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSolidModel, IfcSolidModel> object.
*/
typedef OdSmartPtr<IfcSolidModel> IfcSolidModelPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSOLIDMODEL_AUTO_IMPL_H
