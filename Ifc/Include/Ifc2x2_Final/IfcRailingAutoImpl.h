...
#ifndef _IFC2X2_FINAL_IFCRAILING_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRAILING_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRailing : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRailing);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcRailingTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRailing, IfcRailing> object.
*/
typedef OdSmartPtr<IfcRailing> IfcRailingPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRAILING_AUTO_IMPL_H
