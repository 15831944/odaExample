...
#ifndef _IFC2X2_FINAL_IFCCOOLEDBEAMTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCOOLEDBEAMTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCooledBeamType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCooledBeamType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcCooledBeamTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcCooledBeamTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCooledBeamTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCooledBeamType, IfcCooledBeamType> object.
*/
typedef OdSmartPtr<IfcCooledBeamType> IfcCooledBeamTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCOOLEDBEAMTYPE_AUTO_IMPL_H
