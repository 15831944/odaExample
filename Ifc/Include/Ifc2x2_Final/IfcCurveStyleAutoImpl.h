...
#ifndef _IFC2X2_FINAL_IFCCURVESTYLE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCURVESTYLE_AUTO_IMPL_H
...
*/
class IFC2X2_FINAL_EXPORT IfcCurveStyle : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCurveStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCurveStyle, IfcCurveStyle> object.
*/
typedef OdSmartPtr<IfcCurveStyle> IfcCurveStylePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCURVESTYLE_AUTO_IMPL_H
