...
#ifndef _IFC2X2_FINAL_IFCACTOR_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCACTOR_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcActor : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcActor);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvIsActingUpon(OdDAIObjectIds& IsActingUpon) const;
...
protected:
  // Fields declaration: 
  OdDAI::Select m_TheActor;   // IfcActorSelect
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcActor, IfcActor> object.
*/
typedef OdSmartPtr<IfcActor> IfcActorPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCACTOR_AUTO_IMPL_H
