...
#ifndef _IFC2X2_FINAL_IFCCARTESIANTRANSFORMATIONOPERATOR3DNONUNIFORM_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCARTESIANTRANSFORMATIONOPERATOR3DNONUNIFORM_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCartesianTransformationOperator3DnonUniform : public IfcCartesianTransformationOperator3D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCartesianTransformationOperator3DnonUniform);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_Scale2;   // REAL  [optional]
  double m_Scale3;   // REAL  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCartesianTransformationOperator3DnonUniform, IfcCartesianTransformationOperator3DnonUniform> object.
*/
typedef OdSmartPtr<IfcCartesianTransformationOperator3DnonUniform> IfcCartesianTransformationOperator3DnonUniformPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCARTESIANTRANSFORMATIONOPERATOR3DNONUNIFORM_AUTO_IMPL_H
