...
#ifndef _IFC2X2_FINAL_IFCSTAIRFLIGHTTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTAIRFLIGHTTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStairFlightType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcStairFlightType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcStairFlightTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStairFlightType, IfcStairFlightType> object.
*/
typedef OdSmartPtr<IfcStairFlightType> IfcStairFlightTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTAIRFLIGHTTYPE_AUTO_IMPL_H
