...
#ifndef _IFC2X2_FINAL_IFCSTRUCTURALPROFILEPROPERTIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTRUCTURALPROFILEPROPERTIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStructuralProfileProperties : public IfcGeneralProfileProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcStructuralProfileProperties);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_TorsionalConstantX;   // IfcMomentOfInertiaMeasure  [optional]
  double m_MomentOfInertiaYZ;   // IfcMomentOfInertiaMeasure  [optional]
  double m_MomentOfInertiaY;   // IfcMomentOfInertiaMeasure  [optional]
  double m_MomentOfInertiaZ;   // IfcMomentOfInertiaMeasure  [optional]
  double m_WarpingConstant;   // IfcWarpingConstantMeasure  [optional]
  double m_ShearCentreZ;   // IfcLengthMeasure  [optional]
  double m_ShearCentreY;   // IfcLengthMeasure  [optional]
  double m_ShearDeformationAreaZ;   // IfcAreaMeasure  [optional]
  double m_ShearDeformationAreaY;   // IfcAreaMeasure  [optional]
  double m_MaximumSectionModulusY;   // IfcSectionModulusMeasure  [optional]
  double m_MinimumSectionModulusY;   // IfcSectionModulusMeasure  [optional]
  double m_MaximumSectionModulusZ;   // IfcSectionModulusMeasure  [optional]
  double m_MinimumSectionModulusZ;   // IfcSectionModulusMeasure  [optional]
  double m_TorsionalSectionModulus;   // IfcSectionModulusMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStructuralProfileProperties, IfcStructuralProfileProperties> object.
*/
typedef OdSmartPtr<IfcStructuralProfileProperties> IfcStructuralProfilePropertiesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTRUCTURALPROFILEPROPERTIES_AUTO_IMPL_H
