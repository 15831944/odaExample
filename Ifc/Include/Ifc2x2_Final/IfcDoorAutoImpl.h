...
#ifndef _IFC2X2_FINAL_IFCDOOR_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDOOR_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDoor : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDoor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDoor, IfcDoor> object.
*/
typedef OdSmartPtr<IfcDoor> IfcDoorPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDOOR_AUTO_IMPL_H
