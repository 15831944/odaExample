...
#ifndef _IFC2X2_FINAL_IFCLIBRARYINFORMATION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCLIBRARYINFORMATION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcLibraryInformation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcLibraryInformation);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getPublisher() const;
  void setPublisher(const OdDAIObjectId& Publisher);
  const OdDAIObjectId& getVersionDate() const;
  void setVersionDate(const OdDAIObjectId& VersionDate);
  void getLibraryReference(OdDAIObjectIds& LibraryReference) const;
  OdDAI::OdDAIObjectIdSet& libraryReference();
...
protected:
  ...
  OdAnsiString m_Version;   // IfcLabel  [optional]
  OdDAIObjectId m_Publisher;   // IfcOrganization  [optional]
  OdDAIObjectId m_VersionDate;   // IfcCalendarDate  [optional]
  OdDAI::OdDAIObjectIdSet m_LibraryReference; // SET [1:?] of IfcLibraryReference [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcLibraryInformation, IfcLibraryInformation> object.
*/
typedef OdSmartPtr<IfcLibraryInformation> IfcLibraryInformationPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCLIBRARYINFORMATION_AUTO_IMPL_H
