...
#ifndef _IFC2X2_FINAL_IFCCLASSIFICATIONREFERENCE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCLASSIFICATIONREFERENCE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcClassificationReference : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcClassificationReference);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getReferencedSource() const;
  void setReferencedSource(const OdDAIObjectId& ReferencedSource);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_ReferencedSource;   // IfcClassification  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcClassificationReference, IfcClassificationReference> object.
*/
typedef OdSmartPtr<IfcClassificationReference> IfcClassificationReferencePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCLASSIFICATIONREFERENCE_AUTO_IMPL_H
