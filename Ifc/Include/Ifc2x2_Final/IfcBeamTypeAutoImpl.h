...
#ifndef _IFC2X2_FINAL_IFCBEAMTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCBEAMTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcBeamType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcBeamType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcBeamTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcBeamType, IfcBeamType> object.
*/
typedef OdSmartPtr<IfcBeamType> IfcBeamTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCBEAMTYPE_AUTO_IMPL_H
