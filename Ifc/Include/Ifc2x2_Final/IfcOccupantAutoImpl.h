...
#ifndef _IFC2X2_FINAL_IFCOCCUPANT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCOCCUPANT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcOccupant : public IfcActor
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcOccupant);
  //DOM-IGNORE-END
...
public:
  ...
  IfcOccupantTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcOccupantTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcOccupantTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcOccupant, IfcOccupant> object.
*/
typedef OdSmartPtr<IfcOccupant> IfcOccupantPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCOCCUPANT_AUTO_IMPL_H
