...
#ifndef _IFC2X2_FINAL_IFCRELASSOCIATESAPPLIEDVALUE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELASSOCIATESAPPLIEDVALUE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelAssociatesAppliedValue : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelAssociatesAppliedValue);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatingAppliedValue() const;
  void setRelatingAppliedValue(const OdDAIObjectId& RelatingAppliedValue);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatingAppliedValue;   // IfcAppliedValue
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelAssociatesAppliedValue, IfcRelAssociatesAppliedValue> object.
*/
typedef OdSmartPtr<IfcRelAssociatesAppliedValue> IfcRelAssociatesAppliedValuePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELASSOCIATESAPPLIEDVALUE_AUTO_IMPL_H
