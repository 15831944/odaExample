...
#ifndef _IFC2X2_FINAL_IFCFACEBASEDSURFACEMODEL_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCFACEBASEDSURFACEMODEL_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcFaceBasedSurfaceModel : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcFaceBasedSurfaceModel);
  //DOM-IGNORE-END
...
public:
  ...
  void getFbsmFaces(OdDAIObjectIds& FbsmFaces) const;
  OdDAI::OdDAIObjectIdSet& fbsmFaces();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_FbsmFaces; // SET [1:?] of IfcConnectedFaceSet
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcFaceBasedSurfaceModel, IfcFaceBasedSurfaceModel> object.
*/
typedef OdSmartPtr<IfcFaceBasedSurfaceModel> IfcFaceBasedSurfaceModelPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCFACEBASEDSURFACEMODEL_AUTO_IMPL_H
