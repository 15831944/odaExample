...
#ifndef _IFC2X2_FINAL_IFCSUBEDGE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSUBEDGE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSubedge : public IfcEdge
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSubedge);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getParentEdge() const;
  void setParentEdge(const OdDAIObjectId& ParentEdge);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_ParentEdge;   // IfcEdge
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSubedge, IfcSubedge> object.
*/
typedef OdSmartPtr<IfcSubedge> IfcSubedgePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSUBEDGE_AUTO_IMPL_H
