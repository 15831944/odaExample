...
#ifndef _IFC2X2_FINAL_IFCACTIONREQUEST_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCACTIONREQUEST_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcActionRequest : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcActionRequest);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getRequestID() const;
  void setRequestID(const OdAnsiString& RequestID);
...
protected:
  // Fields declaration: 
  OdAnsiString m_RequestID;   // IfcIdentifier
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcActionRequest, IfcActionRequest> object.
*/
typedef OdSmartPtr<IfcActionRequest> IfcActionRequestPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCACTIONREQUEST_AUTO_IMPL_H
