...
#ifndef _IFC2X2_FINAL_IFCSTRUCTURALLINEARACTIONVARYING_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTRUCTURALLINEARACTIONVARYING_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStructuralLinearActionVarying : public IfcStructuralLinearAction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcStructuralLinearActionVarying);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& subsequentAppliedLoads();
...
protected:
  ...
  OdDAI::OdDAIObjectIdList m_SubsequentAppliedLoads; // LIST [1:?] of IfcStructuralLoad
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStructuralLinearActionVarying, IfcStructuralLinearActionVarying> object.
*/
typedef OdSmartPtr<IfcStructuralLinearActionVarying> IfcStructuralLinearActionVaryingPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTRUCTURALLINEARACTIONVARYING_AUTO_IMPL_H
