...
#ifndef _IFC2X2_FINAL_IFCPIPEFITTINGTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPIPEFITTINGTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPipeFittingType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPipeFittingType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcPipeFittingTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcPipeFittingTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcPipeFittingTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPipeFittingType, IfcPipeFittingType> object.
*/
typedef OdSmartPtr<IfcPipeFittingType> IfcPipeFittingTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPIPEFITTINGTYPE_AUTO_IMPL_H
