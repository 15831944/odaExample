...
#ifndef _IFC2X2_FINAL_IFCIRREGULARTIMESERIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCIRREGULARTIMESERIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcIrregularTimeSeries : public IfcTimeSeries
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcIrregularTimeSeries);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_Values; // LIST [1:?] of IfcIrregularTimeSeriesValue
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcIrregularTimeSeries, IfcIrregularTimeSeries> object.
*/
typedef OdSmartPtr<IfcIrregularTimeSeries> IfcIrregularTimeSeriesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCIRREGULARTIMESERIES_AUTO_IMPL_H
