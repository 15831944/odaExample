...
#ifndef _IFC2X2_FINAL_IFCSTACKTERMINALTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTACKTERMINALTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStackTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcStackTerminalType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcStackTerminalTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStackTerminalType, IfcStackTerminalType> object.
*/
typedef OdSmartPtr<IfcStackTerminalType> IfcStackTerminalTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTACKTERMINALTYPE_AUTO_IMPL_H
