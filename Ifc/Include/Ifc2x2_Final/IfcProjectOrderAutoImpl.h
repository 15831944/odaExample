...
#ifndef _IFC2X2_FINAL_IFCPROJECTORDER_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPROJECTORDER_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcProjectOrder : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcProjectOrder);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Enum m_PredefinedType;   // IfcProjectOrderTypeEnum
  OdAnsiString m_Status;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcProjectOrder, IfcProjectOrder> object.
*/
typedef OdSmartPtr<IfcProjectOrder> IfcProjectOrderPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPROJECTORDER_AUTO_IMPL_H
