...
#ifndef _IFC2X2_FINAL_IFCCHILLERTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCHILLERTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcChillerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcChillerType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcChillerTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcChillerTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcChillerTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcChillerType, IfcChillerType> object.
*/
typedef OdSmartPtr<IfcChillerType> IfcChillerTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCHILLERTYPE_AUTO_IMPL_H
