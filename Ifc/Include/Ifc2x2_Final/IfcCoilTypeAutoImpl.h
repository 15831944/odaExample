...
#ifndef _IFC2X2_FINAL_IFCCOILTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCOILTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCoilType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCoilType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcCoilTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcCoilTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCoilTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCoilType, IfcCoilType> object.
*/
typedef OdSmartPtr<IfcCoilType> IfcCoilTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCOILTYPE_AUTO_IMPL_H
