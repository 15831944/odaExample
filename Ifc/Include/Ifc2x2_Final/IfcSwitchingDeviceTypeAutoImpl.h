...
#ifndef _IFC2X2_FINAL_IFCSWITCHINGDEVICETYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSWITCHINGDEVICETYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSwitchingDeviceType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSwitchingDeviceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcSwitchingDeviceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcSwitchingDeviceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSwitchingDeviceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSwitchingDeviceType, IfcSwitchingDeviceType> object.
*/
typedef OdSmartPtr<IfcSwitchingDeviceType> IfcSwitchingDeviceTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSWITCHINGDEVICETYPE_AUTO_IMPL_H
