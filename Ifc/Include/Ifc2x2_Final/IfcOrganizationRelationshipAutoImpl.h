...
#ifndef _IFC2X2_FINAL_IFCORGANIZATIONRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCORGANIZATIONRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcOrganizationRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcOrganizationRelationship);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatingOrganization() const;
  void setRelatingOrganization(const OdDAIObjectId& RelatingOrganization);
  void getRelatedOrganizations(OdDAIObjectIds& RelatedOrganizations) const;
  OdDAI::OdDAIObjectIdSet& relatedOrganizations();
...
protected:
  ...
  OdDAIObjectId m_RelatingOrganization;   // IfcOrganization
  OdDAI::OdDAIObjectIdSet m_RelatedOrganizations; // SET [1:?] of IfcOrganization
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcOrganizationRelationship, IfcOrganizationRelationship> object.
*/
typedef OdSmartPtr<IfcOrganizationRelationship> IfcOrganizationRelationshipPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCORGANIZATIONRELATIONSHIP_AUTO_IMPL_H
