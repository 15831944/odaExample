...
#ifndef _IFC2X2_FINAL_IFCROUNDEDEDGEFEATURE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCROUNDEDEDGEFEATURE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRoundedEdgeFeature : public IfcEdgeFeature
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRoundedEdgeFeature);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRoundedEdgeFeature, IfcRoundedEdgeFeature> object.
*/
typedef OdSmartPtr<IfcRoundedEdgeFeature> IfcRoundedEdgeFeaturePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCROUNDEDEDGEFEATURE_AUTO_IMPL_H
