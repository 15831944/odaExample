...
#ifndef _IFC2X2_FINAL_IFCAXIS1PLACEMENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCAXIS1PLACEMENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcAxis1Placement : public IfcPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcAxis1Placement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcAxis1Placement, IfcAxis1Placement> object.
*/
typedef OdSmartPtr<IfcAxis1Placement> IfcAxis1PlacementPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCAXIS1PLACEMENT_AUTO_IMPL_H
