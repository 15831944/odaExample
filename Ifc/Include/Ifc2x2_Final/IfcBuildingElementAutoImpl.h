...
#ifndef _IFC2X2_FINAL_IFCBUILDINGELEMENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCBUILDINGELEMENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcBuildingElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcBuildingElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcBuildingElement, IfcBuildingElement> object.
*/
typedef OdSmartPtr<IfcBuildingElement> IfcBuildingElementPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCBUILDINGELEMENT_AUTO_IMPL_H
