...
#ifndef _IFC2X2_FINAL_IFCRELASSOCIATESLIBRARY_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELASSOCIATESLIBRARY_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelAssociatesLibrary : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelAssociatesLibrary);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_RelatingLibrary;   // IfcLibrarySelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelAssociatesLibrary, IfcRelAssociatesLibrary> object.
*/
typedef OdSmartPtr<IfcRelAssociatesLibrary> IfcRelAssociatesLibraryPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELASSOCIATESLIBRARY_AUTO_IMPL_H
