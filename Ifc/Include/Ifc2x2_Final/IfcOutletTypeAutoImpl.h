...
#ifndef _IFC2X2_FINAL_IFCOUTLETTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCOUTLETTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcOutletType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcOutletType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcOutletTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcOutletTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcOutletTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcOutletType, IfcOutletType> object.
*/
typedef OdSmartPtr<IfcOutletType> IfcOutletTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCOUTLETTYPE_AUTO_IMPL_H
