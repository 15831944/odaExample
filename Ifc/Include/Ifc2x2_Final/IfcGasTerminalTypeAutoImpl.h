...
#ifndef _IFC2X2_FINAL_IFCGASTERMINALTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCGASTERMINALTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcGasTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcGasTerminalType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcGasTerminalTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcGasTerminalTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcGasTerminalTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcGasTerminalType, IfcGasTerminalType> object.
*/
typedef OdSmartPtr<IfcGasTerminalType> IfcGasTerminalTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCGASTERMINALTYPE_AUTO_IMPL_H
