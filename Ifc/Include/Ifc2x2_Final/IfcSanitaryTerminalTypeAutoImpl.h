...
#ifndef _IFC2X2_FINAL_IFCSANITARYTERMINALTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSANITARYTERMINALTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSanitaryTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSanitaryTerminalType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcSanitaryTerminalTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcSanitaryTerminalTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSanitaryTerminalTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSanitaryTerminalType, IfcSanitaryTerminalType> object.
*/
typedef OdSmartPtr<IfcSanitaryTerminalType> IfcSanitaryTerminalTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSANITARYTERMINALTYPE_AUTO_IMPL_H
