...
#ifndef _IFC2X2_FINAL_IFCRELDEFINES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELDEFINES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelDefines : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelDefines);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelDefines, IfcRelDefines> object.
*/
typedef OdSmartPtr<IfcRelDefines> IfcRelDefinesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELDEFINES_AUTO_IMPL_H
