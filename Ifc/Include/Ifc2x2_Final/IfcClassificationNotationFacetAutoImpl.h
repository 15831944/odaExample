...
#ifndef _IFC2X2_FINAL_IFCCLASSIFICATIONNOTATIONFACET_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCLASSIFICATIONNOTATIONFACET_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcClassificationNotationFacet : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcClassificationNotationFacet);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getNotationValue() const;
  void setNotationValue(const OdAnsiString& NotationValue);
...
protected:
  // Fields declaration: 
  OdAnsiString m_NotationValue;   // IfcLabel
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcClassificationNotationFacet, IfcClassificationNotationFacet> object.
*/
typedef OdSmartPtr<IfcClassificationNotationFacet> IfcClassificationNotationFacetPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCLASSIFICATIONNOTATIONFACET_AUTO_IMPL_H
