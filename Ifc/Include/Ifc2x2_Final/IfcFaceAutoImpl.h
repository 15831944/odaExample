...
#ifndef _IFC2X2_FINAL_IFCFACE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCFACE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcFace : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcFace);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcFace, IfcFace> object.
*/
typedef OdSmartPtr<IfcFace> IfcFacePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCFACE_AUTO_IMPL_H
