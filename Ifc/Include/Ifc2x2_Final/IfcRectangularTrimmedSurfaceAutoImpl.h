...
#ifndef _IFC2X2_FINAL_IFCRECTANGULARTRIMMEDSURFACE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRECTANGULARTRIMMEDSURFACE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRectangularTrimmedSurface : public IfcBoundedSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRectangularTrimmedSurface);
  //DOM-IGNORE-END
...
protected:
  ...
  double m_U1;   // IfcParameterValue
  double m_V1;   // IfcParameterValue
  double m_U2;   // IfcParameterValue
  double m_V2;   // IfcParameterValue
  OdDAI::Boolean m_Usense;   // BOOLEAN
  OdDAI::Boolean m_Vsense;   // BOOLEAN
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRectangularTrimmedSurface, IfcRectangularTrimmedSurface> object.
*/
typedef OdSmartPtr<IfcRectangularTrimmedSurface> IfcRectangularTrimmedSurfacePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRECTANGULARTRIMMEDSURFACE_AUTO_IMPL_H
