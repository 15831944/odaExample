...
#ifndef _IFC2X2_FINAL_IFCPRODUCTSOFCOMBUSTIONPROPERTIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPRODUCTSOFCOMBUSTIONPROPERTIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcProductsOfCombustionProperties : public IfcMaterialProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcProductsOfCombustionProperties);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_SpecificHeatCapacity;   // IfcSpecificHeatCapacityMeasure  [optional]
  IfcPositiveRatioMeasure m_N20Content;   // IfcPositiveRatioMeasure  [optional]
  IfcPositiveRatioMeasure m_COContent;   // IfcPositiveRatioMeasure  [optional]
  IfcPositiveRatioMeasure m_CO2Content;   // IfcPositiveRatioMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcProductsOfCombustionProperties, IfcProductsOfCombustionProperties> object.
*/
typedef OdSmartPtr<IfcProductsOfCombustionProperties> IfcProductsOfCombustionPropertiesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPRODUCTSOFCOMBUSTIONPROPERTIES_AUTO_IMPL_H
