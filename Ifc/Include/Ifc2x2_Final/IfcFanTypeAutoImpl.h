...
#ifndef _IFC2X2_FINAL_IFCFANTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCFANTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcFanType : public IfcFlowMovingDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcFanType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcFanTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcFanTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcFanTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcFanType, IfcFanType> object.
*/
typedef OdSmartPtr<IfcFanType> IfcFanTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCFANTYPE_AUTO_IMPL_H
