...
#ifndef _IFC2X2_FINAL_IFCONEDIRECTIONREPEATFACTOR_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCONEDIRECTIONREPEATFACTOR_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcOneDirectionRepeatFactor : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcOneDirectionRepeatFactor);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRepeatFactor() const;
  void setRepeatFactor(const OdDAIObjectId& RepeatFactor);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RepeatFactor;   // IfcVector
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcOneDirectionRepeatFactor, IfcOneDirectionRepeatFactor> object.
*/
typedef OdSmartPtr<IfcOneDirectionRepeatFactor> IfcOneDirectionRepeatFactorPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCONEDIRECTIONREPEATFACTOR_AUTO_IMPL_H
