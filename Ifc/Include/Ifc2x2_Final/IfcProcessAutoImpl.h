...
#ifndef _IFC2X2_FINAL_IFCPROCESS_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPROCESS_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcProcess : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcProcess);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcProcess, IfcProcess> object.
*/
typedef OdSmartPtr<IfcProcess> IfcProcessPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPROCESS_AUTO_IMPL_H
