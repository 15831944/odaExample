...
#ifndef _IFC2X2_FINAL_IFCMONETARYUNIT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCMONETARYUNIT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcMonetaryUnit : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcMonetaryUnit);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_Currency;   // IfcCurrencyEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcMonetaryUnit, IfcMonetaryUnit> object.
*/
typedef OdSmartPtr<IfcMonetaryUnit> IfcMonetaryUnitPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCMONETARYUNIT_AUTO_IMPL_H
