...
#ifndef _IFC2X2_FINAL_IFCSTAIR_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTAIR_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStair : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcStair);
  //DOM-IGNORE-END
...
public:
  ...
  IfcStairTypeEnum getShapeType() const;
  void setShapeType(IfcStairTypeEnum ShapeType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_ShapeType;   // IfcStairTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStair, IfcStair> object.
*/
typedef OdSmartPtr<IfcStair> IfcStairPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTAIR_AUTO_IMPL_H
