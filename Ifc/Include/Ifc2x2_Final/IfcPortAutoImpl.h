...
#ifndef _IFC2X2_FINAL_IFCPORT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPORT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPort : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcPort);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPort, IfcPort> object.
*/
typedef OdSmartPtr<IfcPort> IfcPortPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPORT_AUTO_IMPL_H
