...
#ifndef _IFC2X2_FINAL_IFCLIGHTFIXTURETYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCLIGHTFIXTURETYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcLightFixtureType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcLightFixtureType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcLightFixtureTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcLightFixtureTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcLightFixtureTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcLightFixtureType, IfcLightFixtureType> object.
*/
typedef OdSmartPtr<IfcLightFixtureType> IfcLightFixtureTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCLIGHTFIXTURETYPE_AUTO_IMPL_H
