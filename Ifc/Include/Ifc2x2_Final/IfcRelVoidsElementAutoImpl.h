...
#ifndef _IFC2X2_FINAL_IFCRELVOIDSELEMENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELVOIDSELEMENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelVoidsElement : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelVoidsElement);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatedOpeningElement() const;
...
protected:
  ...
  OdDAIObjectId m_RelatedOpeningElement;   // IfcFeatureElementSubtraction
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelVoidsElement, IfcRelVoidsElement> object.
*/
typedef OdSmartPtr<IfcRelVoidsElement> IfcRelVoidsElementPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELVOIDSELEMENT_AUTO_IMPL_H
