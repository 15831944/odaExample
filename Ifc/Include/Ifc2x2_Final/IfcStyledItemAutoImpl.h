...
#ifndef _IFC2X2_FINAL_IFCSTYLEDITEM_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTYLEDITEM_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStyledItem : public IfcRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcStyledItem);
  //DOM-IGNORE-END
...
public:
  ...
  void getStyles(OdDAIObjectIds& Styles) const;
  OdDAI::OdDAIObjectIdSet& styles();
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Item;   // IfcRepresentationItem
  OdDAI::OdDAIObjectIdSet m_Styles; // SET [1:?] of IfcPresentationStyleAssignment
  OdAnsiString m_Name;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStyledItem, IfcStyledItem> object.
*/
typedef OdSmartPtr<IfcStyledItem> IfcStyledItemPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTYLEDITEM_AUTO_IMPL_H
