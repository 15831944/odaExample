...
#ifndef _IFC2X2_FINAL_IFCORDERACTION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCORDERACTION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcOrderAction : public IfcTask
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcOrderAction);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getActionID() const;
  void setActionID(const OdAnsiString& ActionID);
...
protected:
  // Fields declaration: 
  OdAnsiString m_ActionID;   // IfcIdentifier
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcOrderAction, IfcOrderAction> object.
*/
typedef OdSmartPtr<IfcOrderAction> IfcOrderActionPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCORDERACTION_AUTO_IMPL_H
