...
#ifndef _IFC2X2_FINAL_IFCCOMPLEXPROPERTY_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCOMPLEXPROPERTY_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcComplexProperty : public IfcProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcComplexProperty);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_UsageName;   // IfcIdentifier
  OdDAI::OdDAIObjectIdSet m_HasProperties; // SET [1:?] of IfcProperty
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcComplexProperty, IfcComplexProperty> object.
*/
typedef OdSmartPtr<IfcComplexProperty> IfcComplexPropertyPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCOMPLEXPROPERTY_AUTO_IMPL_H
