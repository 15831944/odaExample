...
#ifndef _IFC2X2_FINAL_IFCWORKPLAN_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCWORKPLAN_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcWorkPlan : public IfcWorkControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcWorkPlan);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcWorkPlan, IfcWorkPlan> object.
*/
typedef OdSmartPtr<IfcWorkPlan> IfcWorkPlanPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCWORKPLAN_AUTO_IMPL_H
