...
#ifndef _IFC2X2_FINAL_IFCPROXY_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPROXY_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcProxy : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcProxy);
  //DOM-IGNORE-END
...
public:
  ...
  IfcObjectTypeEnum getProxyType() const;
  void setProxyType(IfcObjectTypeEnum ProxyType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_ProxyType;   // IfcObjectTypeEnum
  OdAnsiString m_Tag;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcProxy, IfcProxy> object.
*/
typedef OdSmartPtr<IfcProxy> IfcProxyPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPROXY_AUTO_IMPL_H
