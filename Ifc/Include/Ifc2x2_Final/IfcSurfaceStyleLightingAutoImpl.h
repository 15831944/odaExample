...
#ifndef _IFC2X2_FINAL_IFCSURFACESTYLELIGHTING_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSURFACESTYLELIGHTING_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSurfaceStyleLighting : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSurfaceStyleLighting);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_DiffuseTransmissionColour;   // IfcColourRgb
  OdDAIObjectId m_DiffuseReflectionColour;   // IfcColourRgb
  OdDAIObjectId m_TransmissionColour;   // IfcColourRgb
  OdDAIObjectId m_ReflectanceColour;   // IfcColourRgb
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSurfaceStyleLighting, IfcSurfaceStyleLighting> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleLighting> IfcSurfaceStyleLightingPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSURFACESTYLELIGHTING_AUTO_IMPL_H
