...
#ifndef _IFC2X2_FINAL_IFCUSHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCUSHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcUShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcUShapeProfileDef);
  //DOM-IGNORE-END
...
protected:
  ...
  IfcPositiveLengthMeasure m_EdgeRadius;   // IfcPositiveLengthMeasure  [optional]
  double m_FlangeSlope;   // IfcPlaneAngleMeasure  [optional]
  IfcPositiveLengthMeasure m_CentreOfGravityInX;   // IfcPositiveLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcUShapeProfileDef, IfcUShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcUShapeProfileDef> IfcUShapeProfileDefPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCUSHAPEPROFILEDEF_AUTO_IMPL_H
