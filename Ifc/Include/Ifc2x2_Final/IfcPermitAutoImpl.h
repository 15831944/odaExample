...
#ifndef _IFC2X2_FINAL_IFCPERMIT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPERMIT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPermit : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPermit);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getPermitID() const;
  void setPermitID(const OdAnsiString& PermitID);
...
protected:
  // Fields declaration: 
  OdAnsiString m_PermitID;   // IfcIdentifier
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPermit, IfcPermit> object.
*/
typedef OdSmartPtr<IfcPermit> IfcPermitPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPERMIT_AUTO_IMPL_H
