...
#ifndef _IFC2X2_FINAL_IFCSHAPEASPECT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSHAPEASPECT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcShapeAspect : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcShapeAspect);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_ShapeRepresentations; // LIST [1:?] of IfcShapeRepresentation
  OdAnsiString m_Name;   // IfcLabel  [optional]
  OdAnsiString m_Description;   // IfcText  [optional]
  OdDAI::Logical m_ProductDefinitional;   // LOGICAL
  OdDAIObjectId m_PartOfProductDefinitionShape;   // IfcProductDefinitionShape
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcShapeAspect, IfcShapeAspect> object.
*/
typedef OdSmartPtr<IfcShapeAspect> IfcShapeAspectPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSHAPEASPECT_AUTO_IMPL_H
