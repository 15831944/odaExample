...
#ifndef _IFC2X2_FINAL_IFCBOUNDINGBOX_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCBOUNDINGBOX_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcBoundingBox : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcBoundingBox);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getCorner() const;
  void setCorner(const OdDAIObjectId& Corner);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Corner;   // IfcCartesianPoint
  IfcPositiveLengthMeasure m_XDim;   // IfcPositiveLengthMeasure
  IfcPositiveLengthMeasure m_YDim;   // IfcPositiveLengthMeasure
  IfcPositiveLengthMeasure m_ZDim;   // IfcPositiveLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcBoundingBox, IfcBoundingBox> object.
*/
typedef OdSmartPtr<IfcBoundingBox> IfcBoundingBoxPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCBOUNDINGBOX_AUTO_IMPL_H
