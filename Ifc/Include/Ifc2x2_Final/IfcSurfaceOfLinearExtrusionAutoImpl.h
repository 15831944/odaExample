...
#ifndef _IFC2X2_FINAL_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSurfaceOfLinearExtrusion : public IfcSweptSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSurfaceOfLinearExtrusion);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_ExtrudedDirection;   // IfcDirection
  double m_Depth;   // IfcLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSurfaceOfLinearExtrusion, IfcSurfaceOfLinearExtrusion> object.
*/
typedef OdSmartPtr<IfcSurfaceOfLinearExtrusion> IfcSurfaceOfLinearExtrusionPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
