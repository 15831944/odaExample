...
#ifndef _IFC2X2_FINAL_IFCELECTRICAPPLIANCETYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCELECTRICAPPLIANCETYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcElectricApplianceType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcElectricApplianceType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcElectricApplianceTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcElectricApplianceTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcElectricApplianceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcElectricApplianceType, IfcElectricApplianceType> object.
*/
typedef OdSmartPtr<IfcElectricApplianceType> IfcElectricApplianceTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCELECTRICAPPLIANCETYPE_AUTO_IMPL_H
