...
#ifndef _IFC2X2_FINAL_IFCCLASSIFICATION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCLASSIFICATION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcClassification : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcClassification);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getEditionDate() const;
  void setEditionDate(const OdDAIObjectId& EditionDate);
  const OdAnsiString& getName() const;
  void setName(const OdAnsiString& Name);
  void getInvContains(OdDAIObjectIds& Contains) const;
...
protected:
  // Fields declaration: 
  OdAnsiString m_Source;   // IfcLabel
  OdAnsiString m_Edition;   // IfcLabel
  OdDAIObjectId m_EditionDate;   // IfcCalendarDate  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcClassification, IfcClassification> object.
*/
typedef OdSmartPtr<IfcClassification> IfcClassificationPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCLASSIFICATION_AUTO_IMPL_H
