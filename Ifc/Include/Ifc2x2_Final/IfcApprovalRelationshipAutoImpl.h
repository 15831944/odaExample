...
#ifndef _IFC2X2_FINAL_IFCAPPROVALRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCAPPROVALRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcApprovalRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcApprovalRelationship);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatedApproval() const;
  void setRelatedApproval(const OdDAIObjectId& RelatedApproval);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatedApproval;   // IfcApproval
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcApprovalRelationship, IfcApprovalRelationship> object.
*/
typedef OdSmartPtr<IfcApprovalRelationship> IfcApprovalRelationshipPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCAPPROVALRELATIONSHIP_AUTO_IMPL_H
