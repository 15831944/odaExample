...
#ifndef _IFC2X2_FINAL_IFCELECTRICHEATERTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCELECTRICHEATERTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcElectricHeaterType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcElectricHeaterType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcElectricHeaterTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcElectricHeaterTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcElectricHeaterTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcElectricHeaterType, IfcElectricHeaterType> object.
*/
typedef OdSmartPtr<IfcElectricHeaterType> IfcElectricHeaterTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCELECTRICHEATERTYPE_AUTO_IMPL_H
