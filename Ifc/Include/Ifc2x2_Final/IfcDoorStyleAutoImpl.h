...
#ifndef _IFC2X2_FINAL_IFCDOORSTYLE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDOORSTYLE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDoorStyle : public IfcTypeProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDoorStyle);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_OperationType;   // IfcDoorStyleOperationEnum
  OdDAI::Enum m_ConstructionType;   // IfcDoorStyleConstructionEnum
  OdDAI::Boolean m_ParameterTakesPrecedence;   // BOOLEAN
  OdDAI::Boolean m_Sizeable;   // BOOLEAN
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDoorStyle, IfcDoorStyle> object.
*/
typedef OdSmartPtr<IfcDoorStyle> IfcDoorStylePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDOORSTYLE_AUTO_IMPL_H
