...
#ifndef _IFC2X2_FINAL_IFCSTRUCTURALANALYSISMODEL_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTRUCTURALANALYSISMODEL_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStructuralAnalysisModel : public IfcSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcStructuralAnalysisModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStructuralAnalysisModel, IfcStructuralAnalysisModel> object.
*/
typedef OdSmartPtr<IfcStructuralAnalysisModel> IfcStructuralAnalysisModelPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTRUCTURALANALYSISMODEL_AUTO_IMPL_H
