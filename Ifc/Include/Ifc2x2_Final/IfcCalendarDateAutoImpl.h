...
#ifndef _IFC2X2_FINAL_IFCCALENDARDATE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCALENDARDATE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCalendarDate : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCalendarDate);
  //DOM-IGNORE-END
...
public:
  ...
  int getDayComponent() const;
  void setDayComponent(int DayComponent);
  int getMonthComponent() const;
  void setMonthComponent(int MonthComponent);
  int getYearComponent() const;
  void setYearComponent(int YearComponent);
...
protected:
  // Fields declaration: 
  int m_DayComponent;   // IfcDayInMonthNumber
  int m_MonthComponent;   // IfcMonthInYearNumber
  int m_YearComponent;   // IfcYearNumber
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCalendarDate, IfcCalendarDate> object.
*/
typedef OdSmartPtr<IfcCalendarDate> IfcCalendarDatePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCALENDARDATE_AUTO_IMPL_H
