...
#ifndef _IFC2X2_FINAL_IFCPERSON_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPERSON_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPerson : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPerson);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_Id;   // IfcIdentifier  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPerson, IfcPerson> object.
*/
typedef OdSmartPtr<IfcPerson> IfcPersonPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPERSON_AUTO_IMPL_H
