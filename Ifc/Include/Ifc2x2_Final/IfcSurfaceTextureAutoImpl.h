...
#ifndef _IFC2X2_FINAL_IFCSURFACETEXTURE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSURFACETEXTURE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSurfaceTexture : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcSurfaceTexture);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Boolean m_RepeatS;   // BOOLEAN
  OdDAI::Boolean m_RepeatT;   // BOOLEAN
  OdDAI::Enum m_TextureType;   // IfcSurfaceTextureEnum
  OdDAIObjectId m_TextureTransform;   // IfcCartesianTransformationOperator2D  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSurfaceTexture, IfcSurfaceTexture> object.
*/
typedef OdSmartPtr<IfcSurfaceTexture> IfcSurfaceTexturePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSURFACETEXTURE_AUTO_IMPL_H
