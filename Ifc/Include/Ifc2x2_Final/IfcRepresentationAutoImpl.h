...
#ifndef _IFC2X2_FINAL_IFCREPRESENTATION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCREPRESENTATION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRepresentation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRepresentation, IfcRepresentation> object.
*/
typedef OdSmartPtr<IfcRepresentation> IfcRepresentationPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCREPRESENTATION_AUTO_IMPL_H
