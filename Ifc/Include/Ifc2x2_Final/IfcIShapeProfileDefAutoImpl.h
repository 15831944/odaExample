...
#ifndef _IFC2X2_FINAL_IFCISHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCISHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcIShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcIShapeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcIShapeProfileDef, IfcIShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcIShapeProfileDef> IfcIShapeProfileDefPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCISHAPEPROFILEDEF_AUTO_IMPL_H
