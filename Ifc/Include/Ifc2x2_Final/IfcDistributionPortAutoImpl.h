...
#ifndef _IFC2X2_FINAL_IFCDISTRIBUTIONPORT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDISTRIBUTIONPORT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDistributionPort : public IfcPort
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDistributionPort);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDistributionPort, IfcDistributionPort> object.
*/
typedef OdSmartPtr<IfcDistributionPort> IfcDistributionPortPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDISTRIBUTIONPORT_AUTO_IMPL_H
