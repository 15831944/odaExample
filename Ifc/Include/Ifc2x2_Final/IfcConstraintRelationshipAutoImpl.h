...
#ifndef _IFC2X2_FINAL_IFCCONSTRAINTRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCONSTRAINTRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcConstraintRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcConstraintRelationship);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdSet& relatedConstraints();
...
protected:
  ...
  OdDAI::OdDAIObjectIdSet m_RelatedConstraints; // SET [1:?] of IfcConstraint
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcConstraintRelationship, IfcConstraintRelationship> object.
*/
typedef OdSmartPtr<IfcConstraintRelationship> IfcConstraintRelationshipPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCONSTRAINTRELATIONSHIP_AUTO_IMPL_H
