...
#ifndef _IFC2X2_FINAL_IFCDIMENSIONCURVE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDIMENSIONCURVE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDimensionCurve : public IfcAnnotationCurveOccurrence
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDimensionCurve);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvAnnotatedBySymbols(OdDAIObjectIds& AnnotatedBySymbols) const;
...
protected:
  using IfcStyledItem::getAttr;
  using IfcStyledItem::putAttr;
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDimensionCurve, IfcDimensionCurve> object.
*/
typedef OdSmartPtr<IfcDimensionCurve> IfcDimensionCurvePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDIMENSIONCURVE_AUTO_IMPL_H
