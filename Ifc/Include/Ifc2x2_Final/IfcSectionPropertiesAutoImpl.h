...
#ifndef _IFC2X2_FINAL_IFCSECTIONPROPERTIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSECTIONPROPERTIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSectionProperties : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSectionProperties);
  //DOM-IGNORE-END
...
public:
  ...
  IfcSectionTypeEnum getSectionType() const;
  void setSectionType(IfcSectionTypeEnum SectionType);
  const OdDAIObjectId& getStartProfile() const;
  void setStartProfile(const OdDAIObjectId& StartProfile);
  const OdDAIObjectId& getEndProfile() const;
  void setEndProfile(const OdDAIObjectId& EndProfile);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_SectionType;   // IfcSectionTypeEnum
  OdDAIObjectId m_StartProfile;   // IfcProfileDef
  OdDAIObjectId m_EndProfile;   // IfcProfileDef  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSectionProperties, IfcSectionProperties> object.
*/
typedef OdSmartPtr<IfcSectionProperties> IfcSectionPropertiesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSECTIONPROPERTIES_AUTO_IMPL_H
