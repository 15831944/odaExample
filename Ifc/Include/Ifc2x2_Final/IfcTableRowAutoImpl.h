...
#ifndef _IFC2X2_FINAL_IFCTABLEROW_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTABLEROW_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTableRow : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTableRow);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::List<OdDAI::Select> m_RowCells; // LIST [1:?] of IfcValue
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTableRow, IfcTableRow> object.
*/
typedef OdSmartPtr<IfcTableRow> IfcTableRowPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTABLEROW_AUTO_IMPL_H
