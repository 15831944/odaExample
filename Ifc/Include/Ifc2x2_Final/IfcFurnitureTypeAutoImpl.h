...
#ifndef _IFC2X2_FINAL_IFCFURNITURETYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCFURNITURETYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcFurnitureType : public IfcFurnishingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcFurnitureType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcFurnitureType, IfcFurnitureType> object.
*/
typedef OdSmartPtr<IfcFurnitureType> IfcFurnitureTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCFURNITURETYPE_AUTO_IMPL_H
