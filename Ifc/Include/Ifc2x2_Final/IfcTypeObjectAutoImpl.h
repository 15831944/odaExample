...
#ifndef _IFC2X2_FINAL_IFCTYPEOBJECT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTYPEOBJECT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTypeObject : public IfcPropertyDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTypeObject);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& hasPropertySets();
  void getInvObjectTypeOf(OdDAIObjectIds& ObjectTypeOf) const;
...
protected:
  // Fields declaration: 
  OdAnsiString m_ApplicableOccurrence;   // IfcLabel  [optional]
  OdDAI::OdDAIObjectIdList m_HasPropertySets; // LIST [1:?] of IfcPropertySetDefinition [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTypeObject, IfcTypeObject> object.
*/
typedef OdSmartPtr<IfcTypeObject> IfcTypeObjectPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTYPEOBJECT_AUTO_IMPL_H
