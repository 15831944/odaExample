...
#ifndef _IFC2X2_FINAL_IFCCOVERING_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCOVERING_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCovering : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCovering);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvCovers(OdDAIObjectIds& Covers) const;
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCovering, IfcCovering> object.
*/
typedef OdSmartPtr<IfcCovering> IfcCoveringPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCOVERING_AUTO_IMPL_H
