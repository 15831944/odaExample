...
#ifndef _IFC2X2_FINAL_IFCFACEBOUND_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCFACEBOUND_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcFaceBound : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcFaceBound);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getBound() const;
  void setBound(const OdDAIObjectId& Bound);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Bound;   // IfcLoop
  OdDAI::Boolean m_Orientation;   // BOOLEAN
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcFaceBound, IfcFaceBound> object.
*/
typedef OdSmartPtr<IfcFaceBound> IfcFaceBoundPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCFACEBOUND_AUTO_IMPL_H
