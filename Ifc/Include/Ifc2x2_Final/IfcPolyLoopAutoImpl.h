...
#ifndef _IFC2X2_FINAL_IFCPOLYLOOP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPOLYLOOP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPolyLoop : public IfcLoop
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPolyLoop);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& polygon();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_Polygon; // LIST [3:?] of IfcCartesianPoint
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPolyLoop, IfcPolyLoop> object.
*/
typedef OdSmartPtr<IfcPolyLoop> IfcPolyLoopPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPOLYLOOP_AUTO_IMPL_H
