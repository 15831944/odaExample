...
#ifndef _IFC2X2_FINAL_IFCRELASSIGNSTOGROUP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELASSIGNSTOGROUP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelAssignsToGroup : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelAssignsToGroup);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatingGroup() const;
  void setRelatingGroup(const OdDAIObjectId& RelatingGroup);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatingGroup;   // IfcGroup
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelAssignsToGroup, IfcRelAssignsToGroup> object.
*/
typedef OdSmartPtr<IfcRelAssignsToGroup> IfcRelAssignsToGroupPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELASSIGNSTOGROUP_AUTO_IMPL_H
