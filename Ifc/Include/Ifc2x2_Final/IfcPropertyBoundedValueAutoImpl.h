...
#ifndef _IFC2X2_FINAL_IFCPROPERTYBOUNDEDVALUE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPROPERTYBOUNDEDVALUE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPropertyBoundedValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPropertyBoundedValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPropertyBoundedValue, IfcPropertyBoundedValue> object.
*/
typedef OdSmartPtr<IfcPropertyBoundedValue> IfcPropertyBoundedValuePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPROPERTYBOUNDEDVALUE_AUTO_IMPL_H
