...
#ifndef _IFC2X2_FINAL_IFCCIRCLEHOLLOWPROFILEDEF_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCIRCLEHOLLOWPROFILEDEF_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCircleHollowProfileDef : public IfcCircleProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCircleHollowProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCircleHollowProfileDef, IfcCircleHollowProfileDef> object.
*/
typedef OdSmartPtr<IfcCircleHollowProfileDef> IfcCircleHollowProfileDefPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCIRCLEHOLLOWPROFILEDEF_AUTO_IMPL_H
