...
#ifndef _IFC2X2_FINAL_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPermeableCoveringProperties : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPermeableCoveringProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPermeableCoveringProperties, IfcPermeableCoveringProperties> object.
*/
typedef OdSmartPtr<IfcPermeableCoveringProperties> IfcPermeableCoveringPropertiesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
