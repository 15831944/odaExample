...
#ifndef _IFC2X2_FINAL_IFCZONE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcZone : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcZone);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcZone, IfcZone> object.
*/
typedef OdSmartPtr<IfcZone> IfcZonePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCZONE_AUTO_IMPL_H
