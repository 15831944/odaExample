...
#ifndef _IFC2X2_FINAL_IFCPRODUCTDEFINITIONSHAPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPRODUCTDEFINITIONSHAPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcProductDefinitionShape : public IfcProductRepresentation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcProductDefinitionShape);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcProductDefinitionShape, IfcProductDefinitionShape> object.
*/
typedef OdSmartPtr<IfcProductDefinitionShape> IfcProductDefinitionShapePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPRODUCTDEFINITIONSHAPE_AUTO_IMPL_H
