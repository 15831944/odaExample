...
#ifndef _IFC2X2_FINAL_IFCREINFORCEMENTBARPROPERTIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCREINFORCEMENTBARPROPERTIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcReinforcementBarProperties : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcReinforcementBarProperties);
  //DOM-IGNORE-END
...
public:
  ...
  double getBarCount() const;
  void setBarCount(double BarCount);
...
protected:
  ...
  double m_BarCount;   // IfcCountMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcReinforcementBarProperties, IfcReinforcementBarProperties> object.
*/
typedef OdSmartPtr<IfcReinforcementBarProperties> IfcReinforcementBarPropertiesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCREINFORCEMENTBARPROPERTIES_AUTO_IMPL_H
