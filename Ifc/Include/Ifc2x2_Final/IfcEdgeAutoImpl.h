...
#ifndef _IFC2X2_FINAL_IFCEDGE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCEDGE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcEdge : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcEdge);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_EdgeStart;   // IfcVertex
  OdDAIObjectId m_EdgeEnd;   // IfcVertex
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcEdge, IfcEdge> object.
*/
typedef OdSmartPtr<IfcEdge> IfcEdgePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCEDGE_AUTO_IMPL_H
