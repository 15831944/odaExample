...
#ifndef _IFC2X2_FINAL_IFCCLASSIFICATIONITEM_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCLASSIFICATIONITEM_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcClassificationItem : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcClassificationItem);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getNotation() const;
  void setNotation(const OdDAIObjectId& Notation);
  const OdDAIObjectId& getItemOf() const;
  void setItemOf(const OdDAIObjectId& ItemOf);
  const OdAnsiString& getTitle() const;
  void setTitle(const OdAnsiString& Title);
  void getInvIsClassifiedItemIn(OdDAIObjectIds& IsClassifiedItemIn) const;
  void getInvIsClassifyingItemIn(OdDAIObjectIds& IsClassifyingItemIn) const;
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Notation;   // IfcClassificationNotationFacet
  OdDAIObjectId m_ItemOf;   // IfcClassification  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcClassificationItem, IfcClassificationItem> object.
*/
typedef OdSmartPtr<IfcClassificationItem> IfcClassificationItemPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCLASSIFICATIONITEM_AUTO_IMPL_H
