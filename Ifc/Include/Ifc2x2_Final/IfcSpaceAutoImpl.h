...
#ifndef _IFC2X2_FINAL_IFCSPACE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSPACE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSpace : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSpace);
  //DOM-IGNORE-END
...
public:
  ...
  IfcInternalOrExternalEnum getInteriorOrExteriorSpace() const;
  void setInteriorOrExteriorSpace(IfcInternalOrExternalEnum InteriorOrExteriorSpace);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_InteriorOrExteriorSpace;   // IfcInternalOrExternalEnum
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSpace, IfcSpace> object.
*/
typedef OdSmartPtr<IfcSpace> IfcSpacePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSPACE_AUTO_IMPL_H
