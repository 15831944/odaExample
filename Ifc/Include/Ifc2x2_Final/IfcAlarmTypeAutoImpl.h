...
#ifndef _IFC2X2_FINAL_IFCALARMTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCALARMTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcAlarmType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcAlarmType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcAlarmTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcAlarmTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcAlarmTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcAlarmType, IfcAlarmType> object.
*/
typedef OdSmartPtr<IfcAlarmType> IfcAlarmTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCALARMTYPE_AUTO_IMPL_H
