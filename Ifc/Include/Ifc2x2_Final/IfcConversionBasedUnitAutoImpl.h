...
#ifndef _IFC2X2_FINAL_IFCCONVERSIONBASEDUNIT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCONVERSIONBASEDUNIT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcConversionBasedUnit : public IfcNamedUnit
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcConversionBasedUnit);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAIObjectId m_ConversionFactor;   // IfcMeasureWithUnit
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcConversionBasedUnit, IfcConversionBasedUnit> object.
*/
typedef OdSmartPtr<IfcConversionBasedUnit> IfcConversionBasedUnitPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCONVERSIONBASEDUNIT_AUTO_IMPL_H
