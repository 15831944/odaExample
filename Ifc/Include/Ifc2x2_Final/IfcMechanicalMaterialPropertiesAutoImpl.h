...
#ifndef _IFC2X2_FINAL_IFCMECHANICALMATERIALPROPERTIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCMECHANICALMATERIALPROPERTIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcMechanicalMaterialProperties : public IfcMaterialProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcMechanicalMaterialProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcMechanicalMaterialProperties, IfcMechanicalMaterialProperties> object.
*/
typedef OdSmartPtr<IfcMechanicalMaterialProperties> IfcMechanicalMaterialPropertiesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCMECHANICALMATERIALPROPERTIES_AUTO_IMPL_H
