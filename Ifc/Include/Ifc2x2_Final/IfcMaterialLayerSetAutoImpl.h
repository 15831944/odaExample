...
#ifndef _IFC2X2_FINAL_IFCMATERIALLAYERSET_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCMATERIALLAYERSET_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcMaterialLayerSet : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcMaterialLayerSet);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& materialLayers();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_MaterialLayers; // LIST [1:?] of IfcMaterialLayer
  OdAnsiString m_LayerSetName;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcMaterialLayerSet, IfcMaterialLayerSet> object.
*/
typedef OdSmartPtr<IfcMaterialLayerSet> IfcMaterialLayerSetPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCMATERIALLAYERSET_AUTO_IMPL_H
