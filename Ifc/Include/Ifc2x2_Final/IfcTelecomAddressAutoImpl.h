...
#ifndef _IFC2X2_FINAL_IFCTELECOMADDRESS_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTELECOMADDRESS_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTelecomAddress : public IfcAddress
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTelecomAddress);
  //DOM-IGNORE-END
...
protected:
  ...
  OdAnsiString m_WWWHomePageURL;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTelecomAddress, IfcTelecomAddress> object.
*/
typedef OdSmartPtr<IfcTelecomAddress> IfcTelecomAddressPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTELECOMADDRESS_AUTO_IMPL_H
