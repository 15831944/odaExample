...
#ifndef _IFC2X2_FINAL_IFCMATERIALLAYER_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCMATERIALLAYER_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcMaterialLayer : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcMaterialLayer);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::Boolean getIsVentilated() const;
  void setIsVentilated(OdDAI::Boolean IsVentilated);
...
protected:
  ...
  IfcPositiveLengthMeasure m_LayerThickness;   // IfcPositiveLengthMeasure
  OdDAI::Boolean m_IsVentilated;   // IfcBoolean  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcMaterialLayer, IfcMaterialLayer> object.
*/
typedef OdSmartPtr<IfcMaterialLayer> IfcMaterialLayerPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCMATERIALLAYER_AUTO_IMPL_H
