...
#ifndef _IFC2X2_FINAL_IFCMEMBERTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCMEMBERTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcMemberType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcMemberType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcMemberTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcMemberTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcMemberTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcMemberType, IfcMemberType> object.
*/
typedef OdSmartPtr<IfcMemberType> IfcMemberTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCMEMBERTYPE_AUTO_IMPL_H
