...
#ifndef _IFC2X2_FINAL_IFCFLOWINSTRUMENTTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCFLOWINSTRUMENTTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcFlowInstrumentType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcFlowInstrumentType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcFlowInstrumentTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcFlowInstrumentTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcFlowInstrumentTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcFlowInstrumentType, IfcFlowInstrumentType> object.
*/
typedef OdSmartPtr<IfcFlowInstrumentType> IfcFlowInstrumentTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCFLOWINSTRUMENTTYPE_AUTO_IMPL_H
