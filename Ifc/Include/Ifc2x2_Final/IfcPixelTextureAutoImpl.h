...
#ifndef _IFC2X2_FINAL_IFCPIXELTEXTURE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPIXELTEXTURE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPixelTexture : public IfcSurfaceTexture
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPixelTexture);
  //DOM-IGNORE-END
...
public:
  ...
  void getPixel(OdArray<OdAnsiString >& Pixel) const;
  OdDAI::OdAnsiStringList& pixel();
...
protected:
  // Fields declaration: 
  int m_Width;   // IfcInteger
  int m_Height;   // IfcInteger
  int m_ColourComponents;   // IfcInteger
  OdDAI::OdAnsiStringList m_Pixel; // LIST [1:?] of STRING(10)
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPixelTexture, IfcPixelTexture> object.
*/
typedef OdSmartPtr<IfcPixelTexture> IfcPixelTexturePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPIXELTEXTURE_AUTO_IMPL_H
