...
#ifndef _IFC2X2_FINAL_IFCTYPEPRODUCT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTYPEPRODUCT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTypeProduct : public IfcTypeObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTypeProduct);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& representationMaps();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_RepresentationMaps; // LIST [1:?] of IfcRepresentationMap [optional]

  OdAnsiString m_Tag;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTypeProduct, IfcTypeProduct> object.
*/
typedef OdSmartPtr<IfcTypeProduct> IfcTypeProductPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTYPEPRODUCT_AUTO_IMPL_H
