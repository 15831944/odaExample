...
#ifndef _IFC2X2_FINAL_IFCPROPERTYCONSTRAINTRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPROPERTYCONSTRAINTRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPropertyConstraintRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPropertyConstraintRelationship);
  //DOM-IGNORE-END
...
public:
  ...
  void getRelatedProperties(OdDAIObjectIds& RelatedProperties) const;
  OdDAI::OdDAIObjectIdSet& relatedProperties();
...
protected:
  ...
  OdDAI::OdDAIObjectIdSet m_RelatedProperties; // SET [1:?] of IfcProperty
  OdAnsiString m_Name;   // IfcLabel  [optional]
  OdAnsiString m_Description;   // IfcText  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPropertyConstraintRelationship, IfcPropertyConstraintRelationship> object.
*/
typedef OdSmartPtr<IfcPropertyConstraintRelationship> IfcPropertyConstraintRelationshipPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPROPERTYCONSTRAINTRELATIONSHIP_AUTO_IMPL_H
