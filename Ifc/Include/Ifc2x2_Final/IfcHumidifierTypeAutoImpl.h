...
#ifndef _IFC2X2_FINAL_IFCHUMIDIFIERTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCHUMIDIFIERTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcHumidifierType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcHumidifierType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcHumidifierTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcHumidifierType, IfcHumidifierType> object.
*/
typedef OdSmartPtr<IfcHumidifierType> IfcHumidifierTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCHUMIDIFIERTYPE_AUTO_IMPL_H
