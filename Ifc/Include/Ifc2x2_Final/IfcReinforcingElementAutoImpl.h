...
#ifndef _IFC2X2_FINAL_IFCREINFORCINGELEMENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCREINFORCINGELEMENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcReinforcingElement : public IfcBuildingElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcReinforcingElement);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_SteelGrade;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcReinforcingElement, IfcReinforcingElement> object.
*/
typedef OdSmartPtr<IfcReinforcingElement> IfcReinforcingElementPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCREINFORCINGELEMENT_AUTO_IMPL_H
