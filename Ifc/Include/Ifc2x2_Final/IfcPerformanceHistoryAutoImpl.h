...
#ifndef _IFC2X2_FINAL_IFCPERFORMANCEHISTORY_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPERFORMANCEHISTORY_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPerformanceHistory : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPerformanceHistory);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPerformanceHistory, IfcPerformanceHistory> object.
*/
typedef OdSmartPtr<IfcPerformanceHistory> IfcPerformanceHistoryPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPERFORMANCEHISTORY_AUTO_IMPL_H
