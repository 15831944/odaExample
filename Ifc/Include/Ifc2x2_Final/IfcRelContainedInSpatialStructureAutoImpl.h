...
#ifndef _IFC2X2_FINAL_IFCRELCONTAINEDINSPATIALSTRUCTURE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELCONTAINEDINSPATIALSTRUCTURE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelContainedInSpatialStructure : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelContainedInSpatialStructure);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdSet& relatedElements();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_RelatedElements; // SET [1:?] of IfcProduct
  OdDAIObjectId m_RelatingStructure;   // IfcSpatialStructureElement
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelContainedInSpatialStructure, IfcRelContainedInSpatialStructure> object.
*/
typedef OdSmartPtr<IfcRelContainedInSpatialStructure> IfcRelContainedInSpatialStructurePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELCONTAINEDINSPATIALSTRUCTURE_AUTO_IMPL_H
