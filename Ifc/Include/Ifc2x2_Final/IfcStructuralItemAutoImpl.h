...
#ifndef _IFC2X2_FINAL_IFCSTRUCTURALITEM_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTRUCTURALITEM_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStructuralItem : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcStructuralItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStructuralItem, IfcStructuralItem> object.
*/
typedef OdSmartPtr<IfcStructuralItem> IfcStructuralItemPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTRUCTURALITEM_AUTO_IMPL_H
