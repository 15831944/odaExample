...
#ifndef _IFC2X2_FINAL_IFCEXTERNALREFERENCE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCEXTERNALREFERENCE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcExternalReference : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcExternalReference);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getItemReference() const;
  void setItemReference(const OdAnsiString& ItemReference);
...
protected:
  // Fields declaration: 
  OdAnsiString m_Location;   // IfcLabel  [optional]
  OdAnsiString m_ItemReference;   // IfcIdentifier  [optional]
  OdAnsiString m_Name;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcExternalReference, IfcExternalReference> object.
*/
typedef OdSmartPtr<IfcExternalReference> IfcExternalReferencePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCEXTERNALREFERENCE_AUTO_IMPL_H
