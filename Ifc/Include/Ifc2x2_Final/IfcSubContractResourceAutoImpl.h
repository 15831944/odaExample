...
#ifndef _IFC2X2_FINAL_IFCSUBCONTRACTRESOURCE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSUBCONTRACTRESOURCE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSubContractResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSubContractResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSubContractResource, IfcSubContractResource> object.
*/
typedef OdSmartPtr<IfcSubContractResource> IfcSubContractResourcePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSUBCONTRACTRESOURCE_AUTO_IMPL_H
