...
#ifndef _IFC2X2_FINAL_IFCPOSTALADDRESS_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPOSTALADDRESS_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPostalAddress : public IfcAddress
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPostalAddress);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdAnsiStringList& addressLines();
...
protected:
  // Fields declaration: 
  OdAnsiString m_InternalLocation;   // IfcLabel  [optional]
  OdDAI::OdAnsiStringList m_AddressLines; // LIST [1:?] of IfcLabel [optional]

  OdAnsiString m_PostalBox;   // IfcLabel  [optional]
  OdAnsiString m_Town;   // IfcLabel  [optional]
  OdAnsiString m_Region;   // IfcLabel  [optional]
  OdAnsiString m_PostalCode;   // IfcLabel  [optional]
  OdAnsiString m_Country;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPostalAddress, IfcPostalAddress> object.
*/
typedef OdSmartPtr<IfcPostalAddress> IfcPostalAddressPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPOSTALADDRESS_AUTO_IMPL_H
