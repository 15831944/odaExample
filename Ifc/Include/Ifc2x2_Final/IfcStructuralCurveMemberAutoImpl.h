...
#ifndef _IFC2X2_FINAL_IFCSTRUCTURALCURVEMEMBER_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTRUCTURALCURVEMEMBER_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStructuralCurveMember : public IfcStructuralMember
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcStructuralCurveMember);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStructuralCurveMember, IfcStructuralCurveMember> object.
*/
typedef OdSmartPtr<IfcStructuralCurveMember> IfcStructuralCurveMemberPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTRUCTURALCURVEMEMBER_AUTO_IMPL_H
