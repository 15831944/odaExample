...
#ifndef _IFC2X2_FINAL_IFCSHAPEREPRESENTATION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSHAPEREPRESENTATION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcShapeRepresentation : public IfcRepresentation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcShapeRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcShapeRepresentation, IfcShapeRepresentation> object.
*/
typedef OdSmartPtr<IfcShapeRepresentation> IfcShapeRepresentationPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSHAPEREPRESENTATION_AUTO_IMPL_H
