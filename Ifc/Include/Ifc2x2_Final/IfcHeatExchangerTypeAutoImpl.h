...
#ifndef _IFC2X2_FINAL_IFCHEATEXCHANGERTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCHEATEXCHANGERTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcHeatExchangerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcHeatExchangerType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcHeatExchangerTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcHeatExchangerTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcHeatExchangerTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcHeatExchangerType, IfcHeatExchangerType> object.
*/
typedef OdSmartPtr<IfcHeatExchangerType> IfcHeatExchangerTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCHEATEXCHANGERTYPE_AUTO_IMPL_H
