...
#ifndef _IFC2X2_FINAL_IFCOFFSETCURVE3D_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCOFFSETCURVE3D_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcOffsetCurve3D : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcOffsetCurve3D);
  //DOM-IGNORE-END
...
protected:
  ...
  double m_Distance;   // IfcLengthMeasure
  OdDAI::Logical m_SelfIntersect;   // LOGICAL
  OdDAIObjectId m_RefDirection;   // IfcDirection
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcOffsetCurve3D, IfcOffsetCurve3D> object.
*/
typedef OdSmartPtr<IfcOffsetCurve3D> IfcOffsetCurve3DPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCOFFSETCURVE3D_AUTO_IMPL_H
