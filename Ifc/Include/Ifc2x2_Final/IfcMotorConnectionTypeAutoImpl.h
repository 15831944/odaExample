...
#ifndef _IFC2X2_FINAL_IFCMOTORCONNECTIONTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCMOTORCONNECTIONTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcMotorConnectionType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcMotorConnectionType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcMotorConnectionTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcMotorConnectionTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcMotorConnectionTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcMotorConnectionType, IfcMotorConnectionType> object.
*/
typedef OdSmartPtr<IfcMotorConnectionType> IfcMotorConnectionTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCMOTORCONNECTIONTYPE_AUTO_IMPL_H
