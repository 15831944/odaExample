...
#ifndef _IFC2X2_FINAL_IFCDIRECTION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDIRECTION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDirection : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDirection);
  //DOM-IGNORE-END
...
public:
  ...
  void getDirectionRatios(OdArray<double >& DirectionRatios) const;
  OdDAI::DoubleList& directionRatios();
...
protected:
  // Fields declaration: 
  OdDAI::DoubleList m_DirectionRatios; // LIST [2:3] of REAL
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDirection, IfcDirection> object.
*/
typedef OdSmartPtr<IfcDirection> IfcDirectionPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDIRECTION_AUTO_IMPL_H
