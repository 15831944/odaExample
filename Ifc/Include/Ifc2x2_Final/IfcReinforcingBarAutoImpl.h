...
#ifndef _IFC2X2_FINAL_IFCREINFORCINGBAR_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCREINFORCINGBAR_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcReinforcingBar : public IfcReinforcingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcReinforcingBar);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Enum m_BarRole;   // IfcReinforcingBarRoleEnum
  OdDAI::Enum m_BarSurface;   // IfcReinforcingBarSurfaceEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcReinforcingBar, IfcReinforcingBar> object.
*/
typedef OdSmartPtr<IfcReinforcingBar> IfcReinforcingBarPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCREINFORCINGBAR_AUTO_IMPL_H
