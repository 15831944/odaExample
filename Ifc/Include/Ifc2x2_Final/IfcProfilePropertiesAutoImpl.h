...
#ifndef _IFC2X2_FINAL_IFCPROFILEPROPERTIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPROFILEPROPERTIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcProfileProperties : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcProfileProperties);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAIObjectId m_ProfileDefinition;   // IfcProfileDef  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcProfileProperties, IfcProfileProperties> object.
*/
typedef OdSmartPtr<IfcProfileProperties> IfcProfilePropertiesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPROFILEPROPERTIES_AUTO_IMPL_H
