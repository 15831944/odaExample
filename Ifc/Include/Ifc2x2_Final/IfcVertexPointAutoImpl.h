...
#ifndef _IFC2X2_FINAL_IFCVERTEXPOINT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCVERTEXPOINT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcVertexPoint : public IfcVertex
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcVertexPoint);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getVertexGeometry() const;
  void setVertexGeometry(const OdDAIObjectId& VertexGeometry);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_VertexGeometry;   // IfcPoint
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcVertexPoint, IfcVertexPoint> object.
*/
typedef OdSmartPtr<IfcVertexPoint> IfcVertexPointPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCVERTEXPOINT_AUTO_IMPL_H
