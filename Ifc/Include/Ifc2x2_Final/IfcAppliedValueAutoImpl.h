...
#ifndef _IFC2X2_FINAL_IFCAPPLIEDVALUE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCAPPLIEDVALUE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcAppliedValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcAppliedValue);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvValuesReferenced(OdDAIObjectIds& ValuesReferenced) const;
...
protected:
  ...
  OdDAI::Select m_ApplicableDate;   // IfcDateTimeSelect  [optional]
  OdDAI::Select m_FixedUntilDate;   // IfcDateTimeSelect  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcAppliedValue, IfcAppliedValue> object.
*/
typedef OdSmartPtr<IfcAppliedValue> IfcAppliedValuePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCAPPLIEDVALUE_AUTO_IMPL_H
