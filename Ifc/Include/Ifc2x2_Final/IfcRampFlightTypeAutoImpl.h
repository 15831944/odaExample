...
#ifndef _IFC2X2_FINAL_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRampFlightType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRampFlightType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcRampFlightTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcRampFlightTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcRampFlightTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRampFlightType, IfcRampFlightType> object.
*/
typedef OdSmartPtr<IfcRampFlightType> IfcRampFlightTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
