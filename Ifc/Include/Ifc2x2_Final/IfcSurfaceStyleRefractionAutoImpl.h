...
#ifndef _IFC2X2_FINAL_IFCSURFACESTYLEREFRACTION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSURFACESTYLEREFRACTION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSurfaceStyleRefraction : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSurfaceStyleRefraction);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_RefractionIndex;   // IfcReal  [optional]
  double m_DispersionFactor;   // IfcReal  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSurfaceStyleRefraction, IfcSurfaceStyleRefraction> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleRefraction> IfcSurfaceStyleRefractionPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSURFACESTYLEREFRACTION_AUTO_IMPL_H
