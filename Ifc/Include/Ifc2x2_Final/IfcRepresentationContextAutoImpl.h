...
#ifndef _IFC2X2_FINAL_IFCREPRESENTATIONCONTEXT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCREPRESENTATIONCONTEXT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRepresentationContext : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRepresentationContext);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRepresentationContext, IfcRepresentationContext> object.
*/
typedef OdSmartPtr<IfcRepresentationContext> IfcRepresentationContextPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCREPRESENTATIONCONTEXT_AUTO_IMPL_H
