...
#ifndef _IFC2X2_FINAL_IFCSURFACESTYLE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSURFACESTYLE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSurfaceStyle : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSurfaceStyle);
  //DOM-IGNORE-END
...
public:
  ...
  IfcSurfaceSide getSide() const;
  void setSide(IfcSurfaceSide Side);
  const OdAnsiString& getName() const;
  void setName(const OdAnsiString& Name);
  void getStyles(OdArray<OdDAI::Select >& Styles) const;
  void getStylesWrapperArray(OdArray<IfcSurfaceStyleElementSelect>& Styles) const;
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_Side;   // IfcSurfaceSide
  OdAnsiString m_Name;   // IfcLabel
  OdDAI::Set<OdDAI::Select> m_Styles; // SET [1:5] of IfcSurfaceStyleElementSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSurfaceStyle, IfcSurfaceStyle> object.
*/
typedef OdSmartPtr<IfcSurfaceStyle> IfcSurfaceStylePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSURFACESTYLE_AUTO_IMPL_H
