...
#ifndef _IFC2X2_FINAL_IFCSTRUCTURALREACTION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTRUCTURALREACTION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStructuralReaction : public IfcStructuralActivity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcStructuralReaction);
  //DOM-IGNORE-END
...
protected:
  using IfcStructuralActivity::getAttr;
  using IfcStructuralActivity::putAttr;
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStructuralReaction, IfcStructuralReaction> object.
*/
typedef OdSmartPtr<IfcStructuralReaction> IfcStructuralReactionPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTRUCTURALREACTION_AUTO_IMPL_H
