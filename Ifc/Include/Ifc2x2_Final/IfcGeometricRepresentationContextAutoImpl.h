...
#ifndef _IFC2X2_FINAL_IFCGEOMETRICREPRESENTATIONCONTEXT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCGEOMETRICREPRESENTATIONCONTEXT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcGeometricRepresentationContext : public IfcRepresentationContext
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcGeometricRepresentationContext);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  int m_CoordinateSpaceDimension;   // IfcDimensionCount
  double m_Precision;   // REAL  [optional]
  OdDAI::Select m_WorldCoordinateSystem;   // IfcAxis2Placement
  OdDAIObjectId m_TrueNorth;   // IfcDirection  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcGeometricRepresentationContext, IfcGeometricRepresentationContext> object.
*/
typedef OdSmartPtr<IfcGeometricRepresentationContext> IfcGeometricRepresentationContextPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCGEOMETRICREPRESENTATIONCONTEXT_AUTO_IMPL_H
