...
#ifndef _IFC2X2_FINAL_IFCDUCTSILENCERTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDUCTSILENCERTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDuctSilencerType : public IfcFlowTreatmentDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDuctSilencerType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcDuctSilencerTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcDuctSilencerTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcDuctSilencerTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDuctSilencerType, IfcDuctSilencerType> object.
*/
typedef OdSmartPtr<IfcDuctSilencerType> IfcDuctSilencerTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDUCTSILENCERTYPE_AUTO_IMPL_H
