...
#ifndef _IFC2X2_FINAL_IFCSIUNIT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSIUNIT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSIUnit : public IfcNamedUnit
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSIUnit);
  //DOM-IGNORE-END
...
public:
  ...
  IfcSIPrefix getPrefix() const;
  void setPrefix(IfcSIPrefix Prefix);
  IfcSIUnitName getName() const;
  void setName(IfcSIUnitName Name);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_Prefix;   // IfcSIPrefix  [optional]
  OdDAI::Enum m_Name;   // IfcSIUnitName
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSIUnit, IfcSIUnit> object.
*/
typedef OdSmartPtr<IfcSIUnit> IfcSIUnitPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSIUNIT_AUTO_IMPL_H
