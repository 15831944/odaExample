...
#ifndef _IFC2X2_FINAL_IFCLIGHTSOURCEPOSITIONAL_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCLIGHTSOURCEPOSITIONAL_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcLightSourcePositional : public IfcLightSource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcLightSourcePositional);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcLightSourcePositional, IfcLightSourcePositional> object.
*/
typedef OdSmartPtr<IfcLightSourcePositional> IfcLightSourcePositionalPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCLIGHTSOURCEPOSITIONAL_AUTO_IMPL_H
