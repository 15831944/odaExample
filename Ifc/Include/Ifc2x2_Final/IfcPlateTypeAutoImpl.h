...
#ifndef _IFC2X2_FINAL_IFCPLATETYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPLATETYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPlateType : public IfcBuildingElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPlateType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcPlateTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPlateType, IfcPlateType> object.
*/
typedef OdSmartPtr<IfcPlateType> IfcPlateTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPLATETYPE_AUTO_IMPL_H
