...
#ifndef _IFC2X2_FINAL_IFCMECHANICALFASTENER_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCMECHANICALFASTENER_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcMechanicalFastener : public IfcFastener
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcMechanicalFastener);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcMechanicalFastener, IfcMechanicalFastener> object.
*/
typedef OdSmartPtr<IfcMechanicalFastener> IfcMechanicalFastenerPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCMECHANICALFASTENER_AUTO_IMPL_H
