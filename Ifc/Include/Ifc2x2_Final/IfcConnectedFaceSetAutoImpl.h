...
#ifndef _IFC2X2_FINAL_IFCCONNECTEDFACESET_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCONNECTEDFACESET_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcConnectedFaceSet : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcConnectedFaceSet);
  //DOM-IGNORE-END
...
public:
  ...
  void getCfsFaces(OdDAIObjectIds& CfsFaces) const;
  OdDAI::OdDAIObjectIdSet& cfsFaces();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_CfsFaces; // SET [1:?] of IfcFace
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcConnectedFaceSet, IfcConnectedFaceSet> object.
*/
typedef OdSmartPtr<IfcConnectedFaceSet> IfcConnectedFaceSetPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCONNECTEDFACESET_AUTO_IMPL_H
