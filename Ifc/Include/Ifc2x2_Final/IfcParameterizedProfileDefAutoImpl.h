...
#ifndef _IFC2X2_FINAL_IFCPARAMETERIZEDPROFILEDEF_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPARAMETERIZEDPROFILEDEF_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcParameterizedProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcParameterizedProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcParameterizedProfileDef, IfcParameterizedProfileDef> object.
*/
typedef OdSmartPtr<IfcParameterizedProfileDef> IfcParameterizedProfileDefPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPARAMETERIZEDPROFILEDEF_AUTO_IMPL_H
