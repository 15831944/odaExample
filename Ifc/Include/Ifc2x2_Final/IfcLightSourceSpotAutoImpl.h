...
#ifndef _IFC2X2_FINAL_IFCLIGHTSOURCESPOT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCLIGHTSOURCESPOT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcLightSourceSpot : public IfcLightSourcePositional
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcLightSourceSpot);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Orientation;   // IfcDirection
  double m_ConcentrationExponent;   // IfcReal  [optional]
  IfcPositivePlaneAngleMeasure m_SpreadAngle;   // IfcPositivePlaneAngleMeasure
  IfcPositivePlaneAngleMeasure m_BeamWidthAngle;   // IfcPositivePlaneAngleMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcLightSourceSpot, IfcLightSourceSpot> object.
*/
typedef OdSmartPtr<IfcLightSourceSpot> IfcLightSourceSpotPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCLIGHTSOURCESPOT_AUTO_IMPL_H
