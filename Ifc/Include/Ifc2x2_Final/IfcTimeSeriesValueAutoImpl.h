...
#ifndef _IFC2X2_FINAL_IFCTIMESERIESVALUE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTIMESERIESVALUE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTimeSeriesValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTimeSeriesValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTimeSeriesValue, IfcTimeSeriesValue> object.
*/
typedef OdSmartPtr<IfcTimeSeriesValue> IfcTimeSeriesValuePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTIMESERIESVALUE_AUTO_IMPL_H
