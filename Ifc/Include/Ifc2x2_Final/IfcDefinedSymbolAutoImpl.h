...
#ifndef _IFC2X2_FINAL_IFCDEFINEDSYMBOL_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDEFINEDSYMBOL_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDefinedSymbol : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDefinedSymbol);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getTarget() const;
  void setTarget(const OdDAIObjectId& Target);
...
protected:
  // Fields declaration: 
  OdDAI::Select m_Definition;   // IfcDefinedSymbolSelect
  OdDAIObjectId m_Target;   // IfcCartesianTransformationOperator2D
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDefinedSymbol, IfcDefinedSymbol> object.
*/
typedef OdSmartPtr<IfcDefinedSymbol> IfcDefinedSymbolPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDEFINEDSYMBOL_AUTO_IMPL_H
