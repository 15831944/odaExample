...
#ifndef _IFC2X2_FINAL_IFCCOVERINGTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCOVERINGTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCoveringType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCoveringType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCoveringTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCoveringType, IfcCoveringType> object.
*/
typedef OdSmartPtr<IfcCoveringType> IfcCoveringTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCOVERINGTYPE_AUTO_IMPL_H
