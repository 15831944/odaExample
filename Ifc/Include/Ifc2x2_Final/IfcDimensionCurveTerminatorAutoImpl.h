...
#ifndef _IFC2X2_FINAL_IFCDIMENSIONCURVETERMINATOR_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDIMENSIONCURVETERMINATOR_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDimensionCurveTerminator : public IfcTerminatorSymbol
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDimensionCurveTerminator);
  //DOM-IGNORE-END
...
public:
  ...
  IfcDimensionExtentUsage getRole() const;
  void setRole(IfcDimensionExtentUsage Role);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_Role;   // IfcDimensionExtentUsage
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDimensionCurveTerminator, IfcDimensionCurveTerminator> object.
*/
typedef OdSmartPtr<IfcDimensionCurveTerminator> IfcDimensionCurveTerminatorPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDIMENSIONCURVETERMINATOR_AUTO_IMPL_H
