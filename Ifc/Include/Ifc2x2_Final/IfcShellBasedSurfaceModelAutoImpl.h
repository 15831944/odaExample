...
#ifndef _IFC2X2_FINAL_IFCSHELLBASEDSURFACEMODEL_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSHELLBASEDSURFACEMODEL_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcShellBasedSurfaceModel : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcShellBasedSurfaceModel);
  //DOM-IGNORE-END
...
public:
  ...
  void getSbsmBoundary(OdArray<OdDAI::Select >& SbsmBoundary) const;
  void getSbsmBoundaryWrapperArray(OdArray<IfcShell>& SbsmBoundary) const;
  OdDAI::Set<OdDAI::Select>& sbsmBoundary();
...
protected:
  // Fields declaration: 
  OdDAI::Set<OdDAI::Select> m_SbsmBoundary; // SET [1:?] of IfcShell
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcShellBasedSurfaceModel, IfcShellBasedSurfaceModel> object.
*/
typedef OdSmartPtr<IfcShellBasedSurfaceModel> IfcShellBasedSurfaceModelPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSHELLBASEDSURFACEMODEL_AUTO_IMPL_H
