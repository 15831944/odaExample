...
#ifndef _IFC2X2_FINAL_IFCTIMESERIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTIMESERIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTimeSeries : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcTimeSeries);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Select m_EndTime;   // IfcDateTimeSelect
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTimeSeries, IfcTimeSeries> object.
*/
typedef OdSmartPtr<IfcTimeSeries> IfcTimeSeriesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTIMESERIES_AUTO_IMPL_H
