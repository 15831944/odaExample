...
#ifndef _IFC2X2_FINAL_IFCORIENTEDEDGE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCORIENTEDEDGE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcOrientedEdge : public IfcEdge
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcOrientedEdge);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_EdgeElement;   // IfcEdge
  OdDAI::Boolean m_Orientation;   // BOOLEAN
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcOrientedEdge, IfcOrientedEdge> object.
*/
typedef OdSmartPtr<IfcOrientedEdge> IfcOrientedEdgePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCORIENTEDEDGE_AUTO_IMPL_H
