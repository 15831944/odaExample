...
#ifndef _IFC2X2_FINAL_IFCWALLTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCWALLTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcWallType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcWallType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcWallTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcWallType, IfcWallType> object.
*/
typedef OdSmartPtr<IfcWallType> IfcWallTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCWALLTYPE_AUTO_IMPL_H
