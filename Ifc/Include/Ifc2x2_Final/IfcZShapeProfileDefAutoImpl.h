...
#ifndef _IFC2X2_FINAL_IFCZSHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCZSHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcZShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcZShapeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcZShapeProfileDef, IfcZShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcZShapeProfileDef> IfcZShapeProfileDefPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCZSHAPEPROFILEDEF_AUTO_IMPL_H
