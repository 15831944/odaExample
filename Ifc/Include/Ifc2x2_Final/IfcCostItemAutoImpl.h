...
#ifndef _IFC2X2_FINAL_IFCCOSTITEM_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCOSTITEM_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCostItem : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCostItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCostItem, IfcCostItem> object.
*/
typedef OdSmartPtr<IfcCostItem> IfcCostItemPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCOSTITEM_AUTO_IMPL_H
