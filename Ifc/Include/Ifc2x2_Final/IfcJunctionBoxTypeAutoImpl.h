...
#ifndef _IFC2X2_FINAL_IFCJUNCTIONBOXTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCJUNCTIONBOXTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcJunctionBoxType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcJunctionBoxType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcJunctionBoxTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcJunctionBoxTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcJunctionBoxTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcJunctionBoxType, IfcJunctionBoxType> object.
*/
typedef OdSmartPtr<IfcJunctionBoxType> IfcJunctionBoxTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCJUNCTIONBOXTYPE_AUTO_IMPL_H
