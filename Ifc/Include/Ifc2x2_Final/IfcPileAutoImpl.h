...
#ifndef _IFC2X2_FINAL_IFCPILE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPILE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPile : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPile);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcPileTypeEnum
  OdDAI::Enum m_ConstructionType;   // IfcPileConstructionEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPile, IfcPile> object.
*/
typedef OdSmartPtr<IfcPile> IfcPilePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPILE_AUTO_IMPL_H
