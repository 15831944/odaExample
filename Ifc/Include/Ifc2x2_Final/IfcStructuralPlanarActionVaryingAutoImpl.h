...
#ifndef _IFC2X2_FINAL_IFCSTRUCTURALPLANARACTIONVARYING_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTRUCTURALPLANARACTIONVARYING_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStructuralPlanarActionVarying : public IfcStructuralPlanarAction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcStructuralPlanarActionVarying);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::OdDAIObjectIdList m_SubsequentAppliedLoads; // LIST [2:?] of IfcStructuralLoad
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStructuralPlanarActionVarying, IfcStructuralPlanarActionVarying> object.
*/
typedef OdSmartPtr<IfcStructuralPlanarActionVarying> IfcStructuralPlanarActionVaryingPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTRUCTURALPLANARACTIONVARYING_AUTO_IMPL_H
