...
#ifndef _IFC2X2_FINAL_IFCAPPROVALACTORRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCAPPROVALACTORRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcApprovalActorRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcApprovalActorRelationship);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRole() const;
  void setRole(const OdDAIObjectId& Role);
...
protected:
  // Fields declaration: 
  OdDAI::Select m_Actor;   // IfcActorSelect
  OdDAIObjectId m_Approval;   // IfcApproval
  OdDAIObjectId m_Role;   // IfcActorRole
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcApprovalActorRelationship, IfcApprovalActorRelationship> object.
*/
typedef OdSmartPtr<IfcApprovalActorRelationship> IfcApprovalActorRelationshipPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCAPPROVALACTORRELATIONSHIP_AUTO_IMPL_H
