...
#ifndef _IFC2X2_FINAL_IFCCONSTRAINTAGGREGATIONRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCONSTRAINTAGGREGATIONRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcConstraintAggregationRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcConstraintAggregationRelationship);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Enum m_LogicalAggregator;   // IfcLogicalOperatorEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcConstraintAggregationRelationship, IfcConstraintAggregationRelationship> object.
*/
typedef OdSmartPtr<IfcConstraintAggregationRelationship> IfcConstraintAggregationRelationshipPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCONSTRAINTAGGREGATIONRELATIONSHIP_AUTO_IMPL_H
