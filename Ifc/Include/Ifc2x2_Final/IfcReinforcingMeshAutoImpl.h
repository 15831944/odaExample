...
#ifndef _IFC2X2_FINAL_IFCREINFORCINGMESH_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCREINFORCINGMESH_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcReinforcingMesh : public IfcReinforcingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcReinforcingMesh);
  //DOM-IGNORE-END
...
protected:
  ...
  IfcPositiveLengthMeasure m_LongitudinalBarNominalDiameter;   // IfcPositiveLengthMeasure
  IfcPositiveLengthMeasure m_TransverseBarNominalDiameter;   // IfcPositiveLengthMeasure
  double m_LongitudinalBarCrossSectionArea;   // IfcAreaMeasure
  double m_TransverseBarCrossSectionArea;   // IfcAreaMeasure
  IfcPositiveLengthMeasure m_LongitudinalBarSpacing;   // IfcPositiveLengthMeasure
  IfcPositiveLengthMeasure m_TransverseBarSpacing;   // IfcPositiveLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcReinforcingMesh, IfcReinforcingMesh> object.
*/
typedef OdSmartPtr<IfcReinforcingMesh> IfcReinforcingMeshPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCREINFORCINGMESH_AUTO_IMPL_H
