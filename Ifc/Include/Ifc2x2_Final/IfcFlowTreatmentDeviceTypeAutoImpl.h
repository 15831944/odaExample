...
#ifndef _IFC2X2_FINAL_IFCFLOWTREATMENTDEVICETYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCFLOWTREATMENTDEVICETYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcFlowTreatmentDeviceType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcFlowTreatmentDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcFlowTreatmentDeviceType, IfcFlowTreatmentDeviceType> object.
*/
typedef OdSmartPtr<IfcFlowTreatmentDeviceType> IfcFlowTreatmentDeviceTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCFLOWTREATMENTDEVICETYPE_AUTO_IMPL_H
