...
#ifndef _IFC2X2_FINAL_IFCRELCONNECTSSTRUCTURALACTIVITY_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELCONNECTSSTRUCTURALACTIVITY_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelConnectsStructuralActivity : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelConnectsStructuralActivity);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatedStructuralActivity() const;
  void setRelatedStructuralActivity(const OdDAIObjectId& RelatedStructuralActivity);
...
protected:
  // Fields declaration: 
  OdDAI::Select m_RelatingElement;   // IfcStructuralActivityAssignmentSelect
  OdDAIObjectId m_RelatedStructuralActivity;   // IfcStructuralActivity
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelConnectsStructuralActivity, IfcRelConnectsStructuralActivity> object.
*/
typedef OdSmartPtr<IfcRelConnectsStructuralActivity> IfcRelConnectsStructuralActivityPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELCONNECTSSTRUCTURALACTIVITY_AUTO_IMPL_H
