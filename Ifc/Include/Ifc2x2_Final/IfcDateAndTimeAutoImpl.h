...
#ifndef _IFC2X2_FINAL_IFCDATEANDTIME_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDATEANDTIME_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDateAndTime : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDateAndTime);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getDateComponent() const;
  void setDateComponent(const OdDAIObjectId& DateComponent);
  const OdDAIObjectId& getTimeComponent() const;
  void setTimeComponent(const OdDAIObjectId& TimeComponent);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_DateComponent;   // IfcCalendarDate
  OdDAIObjectId m_TimeComponent;   // IfcLocalTime
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDateAndTime, IfcDateAndTime> object.
*/
typedef OdSmartPtr<IfcDateAndTime> IfcDateAndTimePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDATEANDTIME_AUTO_IMPL_H
