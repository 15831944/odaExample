...
#ifndef _IFC2X2_FINAL_IFCRELCONNECTSPORTTOELEMENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELCONNECTSPORTTOELEMENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelConnectsPortToElement : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelConnectsPortToElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelConnectsPortToElement, IfcRelConnectsPortToElement> object.
*/
typedef OdSmartPtr<IfcRelConnectsPortToElement> IfcRelConnectsPortToElementPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELCONNECTSPORTTOELEMENT_AUTO_IMPL_H
