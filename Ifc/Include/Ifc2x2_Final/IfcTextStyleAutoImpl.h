...
#ifndef _IFC2X2_FINAL_IFCTEXTSTYLE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTEXTSTYLE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTextStyle : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTextStyle);
  //DOM-IGNORE-END
...
public:
  ...
  IfcCharacterStyleSelect characterGlyphAppearance();
  void getTextStyles(OdArray<OdDAI::Select >& TextStyles) const;
  void getTextStylesWrapperArray(OdArray<IfcTextStyleSelect>& TextStyles) const;
  OdDAI::Set<OdDAI::Select>& textStyles();
...
protected:
  ...
  OdDAI::Select m_CharacterGlyphAppearance;   // IfcCharacterStyleSelect  [optional]
  OdDAI::Set<OdDAI::Select> m_TextStyles; // SET [1:3] of IfcTextStyleSelect [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTextStyle, IfcTextStyle> object.
*/
typedef OdSmartPtr<IfcTextStyle> IfcTextStylePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTEXTSTYLE_AUTO_IMPL_H
