...
#ifndef _IFC2X2_FINAL_IFCDOCUMENTREFERENCE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDOCUMENTREFERENCE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDocumentReference : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDocumentReference);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvReferenceToDocument(OdDAIObjectIds& ReferenceToDocument) const;
...
protected:
  using IfcExternalReference::getAttr;
  using IfcExternalReference::putAttr;
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDocumentReference, IfcDocumentReference> object.
*/
typedef OdSmartPtr<IfcDocumentReference> IfcDocumentReferencePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDOCUMENTREFERENCE_AUTO_IMPL_H
