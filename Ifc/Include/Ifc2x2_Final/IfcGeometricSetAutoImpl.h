...
#ifndef _IFC2X2_FINAL_IFCGEOMETRICSET_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCGEOMETRICSET_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcGeometricSet : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcGeometricSet);
  //DOM-IGNORE-END
...
public:
  ...
  void getElements(OdArray<OdDAI::Select >& Elements) const;
  void getElementsWrapperArray(OdArray<IfcGeometricSetSelect>& Elements) const;
  OdDAI::Set<OdDAI::Select>& elements();
...
protected:
  // Fields declaration: 
  OdDAI::Set<OdDAI::Select> m_Elements; // SET [1:?] of IfcGeometricSetSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcGeometricSet, IfcGeometricSet> object.
*/
typedef OdSmartPtr<IfcGeometricSet> IfcGeometricSetPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCGEOMETRICSET_AUTO_IMPL_H
