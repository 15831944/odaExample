...
#ifndef _IFC2X2_FINAL_IFCTEXTURECOORDINATE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTEXTURECOORDINATE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTextureCoordinate : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcTextureCoordinate);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getTexture() const;
  void setTexture(const OdDAIObjectId& Texture);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Texture;   // IfcSurfaceStyleWithTextures
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTextureCoordinate, IfcTextureCoordinate> object.
*/
typedef OdSmartPtr<IfcTextureCoordinate> IfcTextureCoordinatePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTEXTURECOORDINATE_AUTO_IMPL_H
