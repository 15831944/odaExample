...
#ifndef _IFC2X2_FINAL_IFCLAMPTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCLAMPTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcLampType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcLampType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcLampTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcLampTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcLampTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcLampType, IfcLampType> object.
*/
typedef OdSmartPtr<IfcLampType> IfcLampTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCLAMPTYPE_AUTO_IMPL_H
