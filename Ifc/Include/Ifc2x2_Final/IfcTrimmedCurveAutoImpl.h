...
#ifndef _IFC2X2_FINAL_IFCTRIMMEDCURVE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTRIMMEDCURVE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTrimmedCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTrimmedCurve);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Set<OdDAI::Select> m_Trim1; // SET [1:2] of IfcTrimmingSelect
  OdDAI::Set<OdDAI::Select> m_Trim2; // SET [1:2] of IfcTrimmingSelect
  OdDAI::Boolean m_SenseAgreement;   // BOOLEAN
  OdDAI::Enum m_MasterRepresentation;   // IfcTrimmingPreference
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTrimmedCurve, IfcTrimmedCurve> object.
*/
typedef OdSmartPtr<IfcTrimmedCurve> IfcTrimmedCurvePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTRIMMEDCURVE_AUTO_IMPL_H
