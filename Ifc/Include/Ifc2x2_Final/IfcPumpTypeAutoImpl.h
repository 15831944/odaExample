...
#ifndef _IFC2X2_FINAL_IFCPUMPTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPUMPTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPumpType : public IfcFlowMovingDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPumpType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcPumpTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcPumpTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcPumpTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPumpType, IfcPumpType> object.
*/
typedef OdSmartPtr<IfcPumpType> IfcPumpTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPUMPTYPE_AUTO_IMPL_H
