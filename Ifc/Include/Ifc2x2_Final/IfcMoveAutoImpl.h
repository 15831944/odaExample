...
#ifndef _IFC2X2_FINAL_IFCMOVE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCMOVE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcMove : public IfcTask
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcMove);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::OdAnsiStringList m_PunchList; // LIST [1:?] of IfcText [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcMove, IfcMove> object.
*/
typedef OdSmartPtr<IfcMove> IfcMovePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCMOVE_AUTO_IMPL_H
