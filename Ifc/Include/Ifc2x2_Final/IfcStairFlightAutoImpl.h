...
#ifndef _IFC2X2_FINAL_IFCSTAIRFLIGHT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTAIRFLIGHT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStairFlight : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcStairFlight);
  //DOM-IGNORE-END
...
public:
  ...
  int getNumberOfRiser() const;
  void setNumberOfRiser(int NumberOfRiser);
...
protected:
  // Fields declaration: 
  int m_NumberOfRiser;   // INTEGER  [optional]
  int m_NumberOfTreads;   // INTEGER  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStairFlight, IfcStairFlight> object.
*/
typedef OdSmartPtr<IfcStairFlight> IfcStairFlightPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTAIRFLIGHT_AUTO_IMPL_H
