...
#ifndef _IFC2X2_FINAL_IFCBOUNDARYNODECONDITIONWARPING_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCBOUNDARYNODECONDITIONWARPING_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcBoundaryNodeConditionWarping : public IfcBoundaryNodeCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcBoundaryNodeConditionWarping);
  //DOM-IGNORE-END
...
public:
  ...
  double getWarpingStiffness() const;
  void setWarpingStiffness(double WarpingStiffness);
...
protected:
  // Fields declaration: 
  double m_WarpingStiffness;   // IfcWarpingMomentMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcBoundaryNodeConditionWarping, IfcBoundaryNodeConditionWarping> object.
*/
typedef OdSmartPtr<IfcBoundaryNodeConditionWarping> IfcBoundaryNodeConditionWarpingPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCBOUNDARYNODECONDITIONWARPING_AUTO_IMPL_H
