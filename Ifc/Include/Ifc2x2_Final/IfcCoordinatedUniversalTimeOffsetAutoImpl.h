...
#ifndef _IFC2X2_FINAL_IFCCOORDINATEDUNIVERSALTIMEOFFSET_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCOORDINATEDUNIVERSALTIMEOFFSET_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCoordinatedUniversalTimeOffset : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCoordinatedUniversalTimeOffset);
  //DOM-IGNORE-END
...
public:
  ...
  void setHourOffset(int HourOffset);
  int getMinuteOffset() const;
  void setMinuteOffset(int MinuteOffset);
  IfcAheadOrBehind getSense() const;
  void setSense(IfcAheadOrBehind Sense);
...
protected:
  // Fields declaration: 
  int m_HourOffset;   // IfcHourInDay
  int m_MinuteOffset;   // IfcMinuteInHour  [optional]
  OdDAI::Enum m_Sense;   // IfcAheadOrBehind
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCoordinatedUniversalTimeOffset, IfcCoordinatedUniversalTimeOffset> object.
*/
typedef OdSmartPtr<IfcCoordinatedUniversalTimeOffset> IfcCoordinatedUniversalTimeOffsetPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCOORDINATEDUNIVERSALTIMEOFFSET_AUTO_IMPL_H
