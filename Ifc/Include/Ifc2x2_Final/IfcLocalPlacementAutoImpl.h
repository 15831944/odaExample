...
#ifndef _IFC2X2_FINAL_IFCLOCALPLACEMENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCLOCALPLACEMENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcLocalPlacement : public IfcObjectPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcLocalPlacement);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Select m_RelativePlacement;   // IfcAxis2Placement
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcLocalPlacement, IfcLocalPlacement> object.
*/
typedef OdSmartPtr<IfcLocalPlacement> IfcLocalPlacementPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCLOCALPLACEMENT_AUTO_IMPL_H
