...
#ifndef _IFC2X2_FINAL_IFCEVAPORATORTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCEVAPORATORTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcEvaporatorType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcEvaporatorType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcEvaporatorTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcEvaporatorTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcEvaporatorTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcEvaporatorType, IfcEvaporatorType> object.
*/
typedef OdSmartPtr<IfcEvaporatorType> IfcEvaporatorTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCEVAPORATORTYPE_AUTO_IMPL_H
