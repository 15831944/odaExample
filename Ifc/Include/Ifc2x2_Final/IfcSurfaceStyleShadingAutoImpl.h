...
#ifndef _IFC2X2_FINAL_IFCSURFACESTYLESHADING_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSURFACESTYLESHADING_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSurfaceStyleShading : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSurfaceStyleShading);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_SurfaceColour;   // IfcColourRgb
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSurfaceStyleShading, IfcSurfaceStyleShading> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleShading> IfcSurfaceStyleShadingPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSURFACESTYLESHADING_AUTO_IMPL_H
