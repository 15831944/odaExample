...
#ifndef _IFC2X2_FINAL_IFCCARTESIANTRANSFORMATIONOPERATOR2DNONUNIFORM_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCARTESIANTRANSFORMATIONOPERATOR2DNONUNIFORM_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCartesianTransformationOperator2DnonUniform : public IfcCartesianTransformationOperator2D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCartesianTransformationOperator2DnonUniform);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCartesianTransformationOperator2DnonUniform, IfcCartesianTransformationOperator2DnonUniform> object.
*/
typedef OdSmartPtr<IfcCartesianTransformationOperator2DnonUniform> IfcCartesianTransformationOperator2DnonUniformPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCARTESIANTRANSFORMATIONOPERATOR2DNONUNIFORM_AUTO_IMPL_H
