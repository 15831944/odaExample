...
#ifndef _IFC2X2_FINAL_IFCOBJECTIVE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCOBJECTIVE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcObjective : public IfcConstraint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcObjective);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getBenchmarkValues() const;
  void setBenchmarkValues(const OdDAIObjectId& BenchmarkValues);
  const OdDAIObjectId& getResultValues() const;
  void setResultValues(const OdDAIObjectId& ResultValues);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_BenchmarkValues;   // IfcMetric  [optional]
  OdDAIObjectId m_ResultValues;   // IfcMetric  [optional]
  OdDAI::Enum m_ObjectiveQualifier;   // IfcObjectiveEnum
  OdAnsiString m_UserDefinedQualifier;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcObjective, IfcObjective> object.
*/
typedef OdSmartPtr<IfcObjective> IfcObjectivePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCOBJECTIVE_AUTO_IMPL_H
