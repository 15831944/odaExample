...
#ifndef _IFC2X2_FINAL_IFCSLABTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSLABTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSlabType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSlabType);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSlabTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSlabType, IfcSlabType> object.
*/
typedef OdSmartPtr<IfcSlabType> IfcSlabTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSLABTYPE_AUTO_IMPL_H
