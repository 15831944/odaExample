...
#ifndef _IFC2X2_FINAL_IFCELEMENTQUANTITY_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCELEMENTQUANTITY_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcElementQuantity : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcElementQuantity);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcElementQuantity, IfcElementQuantity> object.
*/
typedef OdSmartPtr<IfcElementQuantity> IfcElementQuantityPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCELEMENTQUANTITY_AUTO_IMPL_H
