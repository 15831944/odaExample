...
#ifndef _IFC2X2_FINAL_IFCCONDITIONCRITERION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCONDITIONCRITERION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcConditionCriterion : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcConditionCriterion);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_Criterion;   // IfcConditionCriterionSelect
  OdDAI::Select m_CriterionDateTime;   // IfcDateTimeSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcConditionCriterion, IfcConditionCriterion> object.
*/
typedef OdSmartPtr<IfcConditionCriterion> IfcConditionCriterionPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCONDITIONCRITERION_AUTO_IMPL_H
