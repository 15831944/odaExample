...
#ifndef _IFC2X2_FINAL_IFCQUANTITYWEIGHT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCQUANTITYWEIGHT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcQuantityWeight : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcQuantityWeight);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcQuantityWeight, IfcQuantityWeight> object.
*/
typedef OdSmartPtr<IfcQuantityWeight> IfcQuantityWeightPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCQUANTITYWEIGHT_AUTO_IMPL_H
