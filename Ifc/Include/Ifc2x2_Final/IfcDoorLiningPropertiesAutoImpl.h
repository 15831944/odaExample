...
#ifndef _IFC2X2_FINAL_IFCDOORLININGPROPERTIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDOORLININGPROPERTIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDoorLiningProperties : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDoorLiningProperties);
  //DOM-IGNORE-END
...
protected:
  ...
  IfcPositiveLengthMeasure m_ThresholdThickness;   // IfcPositiveLengthMeasure  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDoorLiningProperties, IfcDoorLiningProperties> object.
*/
typedef OdSmartPtr<IfcDoorLiningProperties> IfcDoorLiningPropertiesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDOORLININGPROPERTIES_AUTO_IMPL_H
