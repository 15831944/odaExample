...
#ifndef _IFC2X2_FINAL_IFCCONDENSERTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCONDENSERTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCondenserType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCondenserType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcCondenserTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcCondenserTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCondenserTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCondenserType, IfcCondenserType> object.
*/
typedef OdSmartPtr<IfcCondenserType> IfcCondenserTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCONDENSERTYPE_AUTO_IMPL_H
