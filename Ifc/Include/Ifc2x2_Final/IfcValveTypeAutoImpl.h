...
#ifndef _IFC2X2_FINAL_IFCVALVETYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCVALVETYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcValveType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcValveType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcValveTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcValveTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcValveTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcValveType, IfcValveType> object.
*/
typedef OdSmartPtr<IfcValveType> IfcValveTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCVALVETYPE_AUTO_IMPL_H
