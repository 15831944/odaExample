...
#ifndef _IFC2X2_FINAL_IFCTRANSFORMERTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTRANSFORMERTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTransformerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTransformerType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcTransformerTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcTransformerTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcTransformerTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTransformerType, IfcTransformerType> object.
*/
typedef OdSmartPtr<IfcTransformerType> IfcTransformerTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTRANSFORMERTYPE_AUTO_IMPL_H
