...
#ifndef _IFC2X2_FINAL_IFCAPPROVAL_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCAPPROVAL_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcApproval : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcApproval);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getApprovalStatus() const;
  void setApprovalStatus(const OdAnsiString& ApprovalStatus);
  const OdAnsiString& getApprovalLevel() const;
  void setApprovalLevel(const OdAnsiString& ApprovalLevel);
  const OdAnsiString& getApprovalQualifier() const;
  void setApprovalQualifier(const OdAnsiString& ApprovalQualifier);
  const OdAnsiString& getName() const;
  void setName(const OdAnsiString& Name);
  const OdAnsiString& getIdentifier() const;
  void setIdentifier(const OdAnsiString& Identifier);
  void getInvActors(OdDAIObjectIds& Actors) const;
...
protected:
  ...
  OdDAI::Select m_ApprovalDateTime;   // IfcDateTimeSelect
  OdAnsiString m_ApprovalStatus;   // IfcLabel  [optional]
  OdAnsiString m_ApprovalLevel;   // IfcLabel  [optional]
  OdAnsiString m_ApprovalQualifier;   // IfcText  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcApproval, IfcApproval> object.
*/
typedef OdSmartPtr<IfcApproval> IfcApprovalPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCAPPROVAL_AUTO_IMPL_H
