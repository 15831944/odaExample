...
#ifndef _IFC2X2_FINAL_IFCRELSPACEBOUNDARY_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELSPACEBOUNDARY_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelSpaceBoundary : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelSpaceBoundary);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAIObjectId m_RelatedBuildingElement;   // IfcElement  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelSpaceBoundary, IfcRelSpaceBoundary> object.
*/
typedef OdSmartPtr<IfcRelSpaceBoundary> IfcRelSpaceBoundaryPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELSPACEBOUNDARY_AUTO_IMPL_H
