...
#ifndef _IFC2X2_FINAL_IFCSENSORTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSENSORTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSensorType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSensorType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcSensorTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcSensorTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcSensorTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSensorType, IfcSensorType> object.
*/
typedef OdSmartPtr<IfcSensorType> IfcSensorTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSENSORTYPE_AUTO_IMPL_H
