...
#ifndef _IFC2X2_FINAL_IFCTASK_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTASK_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTask : public IfcProcess
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTask);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::Boolean m_IsMilestone;   // BOOLEAN
  int m_Priority;   // INTEGER  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTask, IfcTask> object.
*/
typedef OdSmartPtr<IfcTask> IfcTaskPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTASK_AUTO_IMPL_H
