...
#ifndef _IFC2X2_FINAL_IFCAPPLICATION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCAPPLICATION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcApplication : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcApplication);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcApplication, IfcApplication> object.
*/
typedef OdSmartPtr<IfcApplication> IfcApplicationPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCAPPLICATION_AUTO_IMPL_H
