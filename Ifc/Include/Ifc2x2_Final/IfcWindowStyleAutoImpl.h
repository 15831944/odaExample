...
#ifndef _IFC2X2_FINAL_IFCWINDOWSTYLE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCWINDOWSTYLE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcWindowStyle : public IfcTypeProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcWindowStyle);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_ConstructionType;   // IfcWindowStyleConstructionEnum
  OdDAI::Enum m_OperationType;   // IfcWindowStyleOperationEnum
  OdDAI::Boolean m_ParameterTakesPrecedence;   // BOOLEAN
  OdDAI::Boolean m_Sizeable;   // BOOLEAN
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcWindowStyle, IfcWindowStyle> object.
*/
typedef OdSmartPtr<IfcWindowStyle> IfcWindowStylePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCWINDOWSTYLE_AUTO_IMPL_H
