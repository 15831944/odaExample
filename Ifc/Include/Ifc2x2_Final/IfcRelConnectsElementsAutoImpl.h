...
#ifndef _IFC2X2_FINAL_IFCRELCONNECTSELEMENTS_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELCONNECTSELEMENTS_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelConnectsElements : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelConnectsElements);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelConnectsElements, IfcRelConnectsElements> object.
*/
typedef OdSmartPtr<IfcRelConnectsElements> IfcRelConnectsElementsPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELCONNECTSELEMENTS_AUTO_IMPL_H
