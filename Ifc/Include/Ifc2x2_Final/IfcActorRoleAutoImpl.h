...
#ifndef _IFC2X2_FINAL_IFCACTORROLE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCACTORROLE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcActorRole : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcActorRole);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcActorRole, IfcActorRole> object.
*/
typedef OdSmartPtr<IfcActorRole> IfcActorRolePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCACTORROLE_AUTO_IMPL_H
