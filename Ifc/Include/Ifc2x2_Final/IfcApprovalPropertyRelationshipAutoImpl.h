...
#ifndef _IFC2X2_FINAL_IFCAPPROVALPROPERTYRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCAPPROVALPROPERTYRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcApprovalPropertyRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcApprovalPropertyRelationship);
  //DOM-IGNORE-END
...
public:
  ...
  void getApprovedProperties(OdDAIObjectIds& ApprovedProperties) const;
  OdDAI::OdDAIObjectIdSet& approvedProperties();
  const OdDAIObjectId& getApproval() const;
  void setApproval(const OdDAIObjectId& Approval);
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_ApprovedProperties; // SET [1:?] of IfcProperty
  OdDAIObjectId m_Approval;   // IfcApproval
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcApprovalPropertyRelationship, IfcApprovalPropertyRelationship> object.
*/
typedef OdSmartPtr<IfcApprovalPropertyRelationship> IfcApprovalPropertyRelationshipPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCAPPROVALPROPERTYRELATIONSHIP_AUTO_IMPL_H
