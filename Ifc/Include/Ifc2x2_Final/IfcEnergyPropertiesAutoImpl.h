...
#ifndef _IFC2X2_FINAL_IFCENERGYPROPERTIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCENERGYPROPERTIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcEnergyProperties : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcEnergyProperties);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_EnergySequence;   // IfcEnergySequenceEnum  [optional]
  OdAnsiString m_UserDefinedEnergySequence;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcEnergyProperties, IfcEnergyProperties> object.
*/
typedef OdSmartPtr<IfcEnergyProperties> IfcEnergyPropertiesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCENERGYPROPERTIES_AUTO_IMPL_H
