...
#ifndef _IFC2X2_FINAL_IFCRELASSOCIATESCLASSIFICATION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELASSOCIATESCLASSIFICATION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelAssociatesClassification : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelAssociatesClassification);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_RelatingClassification;   // IfcClassificationNotationSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelAssociatesClassification, IfcRelAssociatesClassification> object.
*/
typedef OdSmartPtr<IfcRelAssociatesClassification> IfcRelAssociatesClassificationPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELASSOCIATESCLASSIFICATION_AUTO_IMPL_H
