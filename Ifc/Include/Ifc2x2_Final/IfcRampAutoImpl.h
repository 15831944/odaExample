...
#ifndef _IFC2X2_FINAL_IFCRAMP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRAMP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRamp : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRamp);
  //DOM-IGNORE-END
...
public:
  ...
  IfcRampTypeEnum getShapeType() const;
  void setShapeType(IfcRampTypeEnum ShapeType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_ShapeType;   // IfcRampTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRamp, IfcRamp> object.
*/
typedef OdSmartPtr<IfcRamp> IfcRampPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRAMP_AUTO_IMPL_H
