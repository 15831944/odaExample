...
#ifndef _IFC2X2_FINAL_IFCTEXTSTYLEWITHMIRROR_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTEXTSTYLEWITHMIRROR_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTextStyleWithMirror : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTextStyleWithMirror);
  //DOM-IGNORE-END
...
public:
  ...
  IfcAxis2Placement mirrorPlacement();
...
protected:
  // Fields declaration: 
  OdDAI::Select m_MirrorPlacement;   // IfcAxis2Placement
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTextStyleWithMirror, IfcTextStyleWithMirror> object.
*/
typedef OdSmartPtr<IfcTextStyleWithMirror> IfcTextStyleWithMirrorPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTEXTSTYLEWITHMIRROR_AUTO_IMPL_H
