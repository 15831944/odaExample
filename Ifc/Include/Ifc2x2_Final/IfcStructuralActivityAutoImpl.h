...
#ifndef _IFC2X2_FINAL_IFCSTRUCTURALACTIVITY_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTRUCTURALACTIVITY_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStructuralActivity : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcStructuralActivity);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAIObjectId getInvAssignedToStructuralItem() const;
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStructuralActivity, IfcStructuralActivity> object.
*/
typedef OdSmartPtr<IfcStructuralActivity> IfcStructuralActivityPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTRUCTURALACTIVITY_AUTO_IMPL_H
