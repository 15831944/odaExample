...
#ifndef _IFC2X2_FINAL_IFCSTRUCTURALMEMBER_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSTRUCTURALMEMBER_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcStructuralMember : public IfcStructuralItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcStructuralMember);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvConnectedBy(OdDAIObjectIds& ConnectedBy) const;
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcStructuralMember, IfcStructuralMember> object.
*/
typedef OdSmartPtr<IfcStructuralMember> IfcStructuralMemberPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSTRUCTURALMEMBER_AUTO_IMPL_H
