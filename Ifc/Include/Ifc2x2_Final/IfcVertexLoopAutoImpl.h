...
#ifndef _IFC2X2_FINAL_IFCVERTEXLOOP_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCVERTEXLOOP_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcVertexLoop : public IfcLoop
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcVertexLoop);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getLoopVertex() const;
  void setLoopVertex(const OdDAIObjectId& LoopVertex);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_LoopVertex;   // IfcVertex
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcVertexLoop, IfcVertexLoop> object.
*/
typedef OdSmartPtr<IfcVertexLoop> IfcVertexLoopPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCVERTEXLOOP_AUTO_IMPL_H
