...
#ifndef _IFC2X2_FINAL_IFCSITE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSITE_AUTO_IMPL_H
...
*/
class IFC2X2_FINAL_EXPORT IfcSite : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSite);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSite, IfcSite> object.
*/
typedef OdSmartPtr<IfcSite> IfcSitePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSITE_AUTO_IMPL_H
