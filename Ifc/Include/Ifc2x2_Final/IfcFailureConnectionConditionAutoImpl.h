...
#ifndef _IFC2X2_FINAL_IFCFAILURECONNECTIONCONDITION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCFAILURECONNECTIONCONDITION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcFailureConnectionCondition : public IfcStructuralConnectionCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcFailureConnectionCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcFailureConnectionCondition, IfcFailureConnectionCondition> object.
*/
typedef OdSmartPtr<IfcFailureConnectionCondition> IfcFailureConnectionConditionPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCFAILURECONNECTIONCONDITION_AUTO_IMPL_H
