...
#ifndef _IFC2X2_FINAL_IFCHALFSPACESOLID_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCHALFSPACESOLID_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcHalfSpaceSolid : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcHalfSpaceSolid);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getBaseSurface() const;
  void setBaseSurface(const OdDAIObjectId& BaseSurface);
  OdDAI::Boolean getAgreementFlag() const;
  void setAgreementFlag(OdDAI::Boolean AgreementFlag);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_BaseSurface;   // IfcSurface
  OdDAI::Boolean m_AgreementFlag;   // BOOLEAN
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcHalfSpaceSolid, IfcHalfSpaceSolid> object.
*/
typedef OdSmartPtr<IfcHalfSpaceSolid> IfcHalfSpaceSolidPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCHALFSPACESOLID_AUTO_IMPL_H
