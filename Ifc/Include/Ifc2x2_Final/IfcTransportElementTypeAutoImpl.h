...
#ifndef _IFC2X2_FINAL_IFCTRANSPORTELEMENTTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTRANSPORTELEMENTTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTransportElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTransportElementType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcTransportElementTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcTransportElementTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcTransportElementTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTransportElementType, IfcTransportElementType> object.
*/
typedef OdSmartPtr<IfcTransportElementType> IfcTransportElementTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTRANSPORTELEMENTTYPE_AUTO_IMPL_H
