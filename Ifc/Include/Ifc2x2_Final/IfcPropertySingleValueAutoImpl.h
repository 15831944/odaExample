...
#ifndef _IFC2X2_FINAL_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPropertySingleValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPropertySingleValue);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_NominalValue;   // IfcValue
  OdDAI::Select m_Unit;   // IfcUnit  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPropertySingleValue, IfcPropertySingleValue> object.
*/
typedef OdSmartPtr<IfcPropertySingleValue> IfcPropertySingleValuePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
