...
#ifndef _IFC2X2_FINAL_IFCPLANAREXTENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPLANAREXTENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPlanarExtent : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPlanarExtent);
  //DOM-IGNORE-END
...
public:
  ...
  double getSizeInX() const;
  void setSizeInX(double SizeInX);
  double getSizeInY() const;
  void setSizeInY(double SizeInY);
...
protected:
  // Fields declaration: 
  double m_SizeInX;   // IfcLengthMeasure
  double m_SizeInY;   // IfcLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPlanarExtent, IfcPlanarExtent> object.
*/
typedef OdSmartPtr<IfcPlanarExtent> IfcPlanarExtentPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPLANAREXTENT_AUTO_IMPL_H
