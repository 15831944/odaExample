...
#ifndef _IFC2X2_FINAL_IFCCONTROLLERTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCONTROLLERTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcControllerType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcControllerType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcControllerTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcControllerTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcControllerTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcControllerType, IfcControllerType> object.
*/
typedef OdSmartPtr<IfcControllerType> IfcControllerTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCONTROLLERTYPE_AUTO_IMPL_H
