...
#ifndef _IFC2X2_FINAL_IFCRELPROJECTSELEMENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELPROJECTSELEMENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelProjectsElement : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelProjectsElement);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatedFeatureElement() const;
  void setRelatedFeatureElement(const OdDAIObjectId& RelatedFeatureElement);
...
protected:
  ...
  OdDAIObjectId m_RelatedFeatureElement;   // IfcFeatureElementAddition
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelProjectsElement, IfcRelProjectsElement> object.
*/
typedef OdSmartPtr<IfcRelProjectsElement> IfcRelProjectsElementPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELPROJECTSELEMENT_AUTO_IMPL_H
