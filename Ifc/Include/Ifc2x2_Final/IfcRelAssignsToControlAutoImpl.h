...
#ifndef _IFC2X2_FINAL_IFCRELASSIGNSTOCONTROL_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELASSIGNSTOCONTROL_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelAssignsToControl : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelAssignsToControl);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatingControl() const;
  void setRelatingControl(const OdDAIObjectId& RelatingControl);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatingControl;   // IfcControl
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelAssignsToControl, IfcRelAssignsToControl> object.
*/
typedef OdSmartPtr<IfcRelAssignsToControl> IfcRelAssignsToControlPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELASSIGNSTOCONTROL_AUTO_IMPL_H
