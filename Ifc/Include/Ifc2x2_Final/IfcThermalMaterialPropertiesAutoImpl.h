...
#ifndef _IFC2X2_FINAL_IFCTHERMALMATERIALPROPERTIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTHERMALMATERIALPROPERTIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcThermalMaterialProperties : public IfcMaterialProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcThermalMaterialProperties);
  //DOM-IGNORE-END
...
protected:
  ...
  double m_BoilingPoint;   // IfcThermodynamicTemperatureMeasure  [optional]
  double m_FreezingPoint;   // IfcThermodynamicTemperatureMeasure  [optional]
  double m_ThermalConductivity;   // IfcThermalConductivityMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcThermalMaterialProperties, IfcThermalMaterialProperties> object.
*/
typedef OdSmartPtr<IfcThermalMaterialProperties> IfcThermalMaterialPropertiesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTHERMALMATERIALPROPERTIES_AUTO_IMPL_H
