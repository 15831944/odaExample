...
#ifndef _IFC2X2_FINAL_IFCELECTRICMOTORTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCELECTRICMOTORTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcElectricMotorType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcElectricMotorType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcElectricMotorTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcElectricMotorTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcElectricMotorTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcElectricMotorType, IfcElectricMotorType> object.
*/
typedef OdSmartPtr<IfcElectricMotorType> IfcElectricMotorTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCELECTRICMOTORTYPE_AUTO_IMPL_H
