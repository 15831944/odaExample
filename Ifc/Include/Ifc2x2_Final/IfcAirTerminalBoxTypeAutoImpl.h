...
#ifndef _IFC2X2_FINAL_IFCAIRTERMINALBOXTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCAIRTERMINALBOXTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcAirTerminalBoxType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcAirTerminalBoxType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcAirTerminalBoxTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcAirTerminalBoxTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcAirTerminalBoxTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcAirTerminalBoxType, IfcAirTerminalBoxType> object.
*/
typedef OdSmartPtr<IfcAirTerminalBoxType> IfcAirTerminalBoxTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCAIRTERMINALBOXTYPE_AUTO_IMPL_H
