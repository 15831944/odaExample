...
#ifndef _IFC2X2_FINAL_IFCLIGHTSOURCE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCLIGHTSOURCE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcLightSource : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcLightSource);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAIObjectId m_LightColour;   // IfcColourRgb
  IfcNormalisedRatioMeasure m_AmbientIntensity;   // IfcNormalisedRatioMeasure  [optional]
  IfcNormalisedRatioMeasure m_Intensity;   // IfcNormalisedRatioMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcLightSource, IfcLightSource> object.
*/
typedef OdSmartPtr<IfcLightSource> IfcLightSourcePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCLIGHTSOURCE_AUTO_IMPL_H
