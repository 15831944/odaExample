...
#ifndef _IFC2X2_FINAL_IFCELECTRICALBASEPROPERTIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCELECTRICALBASEPROPERTIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcElectricalBaseProperties : public IfcEnergyProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcElectricalBaseProperties);
  //DOM-IGNORE-END
...
protected:
  ...
  double m_InputVoltage;   // IfcElectricVoltageMeasure
  double m_InputFrequency;   // IfcFrequencyMeasure
  ...
  int m_InputPhase;   // INTEGER
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcElectricalBaseProperties, IfcElectricalBaseProperties> object.
*/
typedef OdSmartPtr<IfcElectricalBaseProperties> IfcElectricalBasePropertiesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCELECTRICALBASEPROPERTIES_AUTO_IMPL_H
