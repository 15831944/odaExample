...
#ifndef _IFC2X2_FINAL_IFCRELASSOCIATES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELASSOCIATES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelAssociates : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelAssociates);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_RelatedObjects; // SET [1:?] of IfcRoot
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelAssociates, IfcRelAssociates> object.
*/
typedef OdSmartPtr<IfcRelAssociates> IfcRelAssociatesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELASSOCIATES_AUTO_IMPL_H
