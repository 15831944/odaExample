...
#ifndef _IFC2X2_FINAL_IFCBOUNDARYCONDITION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCBOUNDARYCONDITION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcBoundaryCondition : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcBoundaryCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcBoundaryCondition, IfcBoundaryCondition> object.
*/
typedef OdSmartPtr<IfcBoundaryCondition> IfcBoundaryConditionPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCBOUNDARYCONDITION_AUTO_IMPL_H
