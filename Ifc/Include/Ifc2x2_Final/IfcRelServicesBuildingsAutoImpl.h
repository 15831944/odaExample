...
#ifndef _IFC2X2_FINAL_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelServicesBuildings : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelServicesBuildings);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatingSystem() const;
  void setRelatingSystem(const OdDAIObjectId& RelatingSystem);
  void getRelatedBuildings(OdDAIObjectIds& RelatedBuildings) const;
  OdDAI::OdDAIObjectIdSet& relatedBuildings();
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatingSystem;   // IfcSystem
  OdDAI::OdDAIObjectIdSet m_RelatedBuildings; // SET [1:?] of IfcSpatialStructureElement
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelServicesBuildings, IfcRelServicesBuildings> object.
*/
typedef OdSmartPtr<IfcRelServicesBuildings> IfcRelServicesBuildingsPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
