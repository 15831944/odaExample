...
#ifndef _IFC2X2_FINAL_IFCCOOLINGTOWERTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCCOOLINGTOWERTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcCoolingTowerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcCoolingTowerType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcCoolingTowerTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcCoolingTowerTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcCoolingTowerTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcCoolingTowerType, IfcCoolingTowerType> object.
*/
typedef OdSmartPtr<IfcCoolingTowerType> IfcCoolingTowerTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCCOOLINGTOWERTYPE_AUTO_IMPL_H
