...
#ifndef _IFC2X2_FINAL_IFCBUILDINGSTOREY_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCBUILDINGSTOREY_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcBuildingStorey : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcBuildingStorey);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_Elevation;   // IfcLengthMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcBuildingStorey, IfcBuildingStorey> object.
*/
typedef OdSmartPtr<IfcBuildingStorey> IfcBuildingStoreyPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCBUILDINGSTOREY_AUTO_IMPL_H
