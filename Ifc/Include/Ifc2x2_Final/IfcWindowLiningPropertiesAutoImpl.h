...
#ifndef _IFC2X2_FINAL_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcWindowLiningProperties : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcWindowLiningProperties);
  //DOM-IGNORE-END
...
protected:
  ...
  IfcPositiveLengthMeasure m_LiningThickness;   // IfcPositiveLengthMeasure  [optional]
  IfcPositiveLengthMeasure m_TransomThickness;   // IfcPositiveLengthMeasure  [optional]
  IfcPositiveLengthMeasure m_MullionThickness;   // IfcPositiveLengthMeasure  [optional]
  IfcNormalisedRatioMeasure m_FirstTransomOffset;   // IfcNormalisedRatioMeasure  [optional]
  IfcNormalisedRatioMeasure m_SecondTransomOffset;   // IfcNormalisedRatioMeasure  [optional]
  IfcNormalisedRatioMeasure m_FirstMullionOffset;   // IfcNormalisedRatioMeasure  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcWindowLiningProperties, IfcWindowLiningProperties> object.
*/
typedef OdSmartPtr<IfcWindowLiningProperties> IfcWindowLiningPropertiesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
