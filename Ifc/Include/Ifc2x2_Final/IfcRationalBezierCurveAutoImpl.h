...
#ifndef _IFC2X2_FINAL_IFCRATIONALBEZIERCURVE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRATIONALBEZIERCURVE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRationalBezierCurve : public IfcBezierCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRationalBezierCurve);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::DoubleList m_WeightsData; // LIST [2:?] of REAL
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRationalBezierCurve, IfcRationalBezierCurve> object.
*/
typedef OdSmartPtr<IfcRationalBezierCurve> IfcRationalBezierCurvePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRATIONALBEZIERCURVE_AUTO_IMPL_H
