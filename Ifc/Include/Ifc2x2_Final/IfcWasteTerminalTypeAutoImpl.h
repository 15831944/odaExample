...
#ifndef _IFC2X2_FINAL_IFCWASTETERMINALTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCWASTETERMINALTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcWasteTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcWasteTerminalType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcWasteTerminalTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcWasteTerminalTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcWasteTerminalTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcWasteTerminalType, IfcWasteTerminalType> object.
*/
typedef OdSmartPtr<IfcWasteTerminalType> IfcWasteTerminalTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCWASTETERMINALTYPE_AUTO_IMPL_H
