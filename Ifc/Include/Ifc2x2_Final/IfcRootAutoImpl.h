...
#ifndef _IFC2X2_FINAL_IFCROOT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCROOT_AUTO_IMPL_H
...
*/
class IFC2X2_FINAL_EXPORT IfcRoot : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcRoot);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAIObjectId m_OwnerHistory;   // IfcOwnerHistory
  OdAnsiString m_Name;   // IfcLabel  [optional]
  OdAnsiString m_Description;   // IfcText  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRoot, IfcRoot> object.
*/
typedef OdSmartPtr<IfcRoot> IfcRootPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCROOT_AUTO_IMPL_H
