...
#ifndef _IFC2X2_FINAL_IFCPLACEMENT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPLACEMENT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPlacement : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcPlacement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPlacement, IfcPlacement> object.
*/
typedef OdSmartPtr<IfcPlacement> IfcPlacementPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPLACEMENT_AUTO_IMPL_H
