...
#ifndef _IFC2X2_FINAL_IFCFEATUREELEMENTSUBTRACTION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCFEATUREELEMENTSUBTRACTION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcFeatureElementSubtraction : public IfcFeatureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcFeatureElementSubtraction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcFeatureElementSubtraction, IfcFeatureElementSubtraction> object.
*/
typedef OdSmartPtr<IfcFeatureElementSubtraction> IfcFeatureElementSubtractionPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCFEATUREELEMENTSUBTRACTION_AUTO_IMPL_H
