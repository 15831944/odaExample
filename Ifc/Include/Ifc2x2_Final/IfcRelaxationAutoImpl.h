...
#ifndef _IFC2X2_FINAL_IFCRELAXATION_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELAXATION_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelaxation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelaxation);
  //DOM-IGNORE-END
...
public:
  ...
  double getRelaxationValue() const;
  void setRelaxationValue(double RelaxationValue);
  double getInitialStress() const;
  void setInitialStress(double InitialStress);
...
protected:
  // Fields declaration: 
  IfcNormalisedRatioMeasure m_RelaxationValue;   // IfcNormalisedRatioMeasure
  IfcNormalisedRatioMeasure m_InitialStress;   // IfcNormalisedRatioMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelaxation, IfcRelaxation> object.
*/
typedef OdSmartPtr<IfcRelaxation> IfcRelaxationPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELAXATION_AUTO_IMPL_H
