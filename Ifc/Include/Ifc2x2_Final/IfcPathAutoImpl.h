...
#ifndef _IFC2X2_FINAL_IFCPATH_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPATH_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcPath : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcPath);
  //DOM-IGNORE-END
...
public:
  ...
  void getEdgeList(OdDAIObjectIds& EdgeList) const;
  OdDAI::OdDAIObjectIdList& edgeList();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_EdgeList; // LIST [1:?] of IfcOrientedEdge
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcPath, IfcPath> object.
*/
typedef OdSmartPtr<IfcPath> IfcPathPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPATH_AUTO_IMPL_H
