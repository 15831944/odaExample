...
#ifndef _IFC2X2_FINAL_IFCSYSTEM_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSYSTEM_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSystem : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcSystem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSystem, IfcSystem> object.
*/
typedef OdSmartPtr<IfcSystem> IfcSystemPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSYSTEM_AUTO_IMPL_H
