...
#ifndef _IFC2X2_FINAL_IFCROOF_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCROOF_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRoof : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRoof);
  //DOM-IGNORE-END
...
public:
  ...
  IfcRoofTypeEnum getShapeType() const;
  void setShapeType(IfcRoofTypeEnum ShapeType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_ShapeType;   // IfcRoofTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRoof, IfcRoof> object.
*/
typedef OdSmartPtr<IfcRoof> IfcRoofPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCROOF_AUTO_IMPL_H
