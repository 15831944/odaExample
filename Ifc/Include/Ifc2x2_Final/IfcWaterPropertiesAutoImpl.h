...
#ifndef _IFC2X2_FINAL_IFCWATERPROPERTIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCWATERPROPERTIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcWaterProperties : public IfcMaterialProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcWaterProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcWaterProperties, IfcWaterProperties> object.
*/
typedef OdSmartPtr<IfcWaterProperties> IfcWaterPropertiesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCWATERPROPERTIES_AUTO_IMPL_H
