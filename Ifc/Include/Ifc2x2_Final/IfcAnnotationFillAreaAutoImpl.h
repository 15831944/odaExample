...
#ifndef _IFC2X2_FINAL_IFCANNOTATIONFILLAREA_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCANNOTATIONFILLAREA_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcAnnotationFillArea : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcAnnotationFillArea);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_Boundaries; // SET [1:?] of IfcCurve
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcAnnotationFillArea, IfcAnnotationFillArea> object.
*/
typedef OdSmartPtr<IfcAnnotationFillArea> IfcAnnotationFillAreaPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCANNOTATIONFILLAREA_AUTO_IMPL_H
