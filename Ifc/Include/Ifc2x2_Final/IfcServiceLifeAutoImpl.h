...
#ifndef _IFC2X2_FINAL_IFCSERVICELIFE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSERVICELIFE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcServiceLife : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcServiceLife);
  //DOM-IGNORE-END
...
public:
  ...
  IfcServiceLifeTypeEnum getServiceLifeType() const;
  void setServiceLifeType(IfcServiceLifeTypeEnum ServiceLifeType);
  double getServiceLifeDuration() const;
  void setServiceLifeDuration(double ServiceLifeDuration);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_ServiceLifeType;   // IfcServiceLifeTypeEnum
  double m_ServiceLifeDuration;   // IfcTimeMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcServiceLife, IfcServiceLife> object.
*/
typedef OdSmartPtr<IfcServiceLife> IfcServiceLifePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSERVICELIFE_AUTO_IMPL_H
