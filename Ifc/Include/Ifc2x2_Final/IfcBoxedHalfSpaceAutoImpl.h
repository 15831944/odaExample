...
#ifndef _IFC2X2_FINAL_IFCBOXEDHALFSPACE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCBOXEDHALFSPACE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcBoxedHalfSpace : public IfcHalfSpaceSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcBoxedHalfSpace);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getEnclosure() const;
  void setEnclosure(const OdDAIObjectId& Enclosure);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Enclosure;   // IfcBoundingBox
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcBoxedHalfSpace, IfcBoxedHalfSpace> object.
*/
typedef OdSmartPtr<IfcBoxedHalfSpace> IfcBoxedHalfSpacePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCBOXEDHALFSPACE_AUTO_IMPL_H
