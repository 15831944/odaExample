...
#ifndef _IFC2X2_FINAL_IFCRELNESTS_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELNESTS_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelNests : public IfcRelDecomposes
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelNests);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelNests, IfcRelNests> object.
*/
typedef OdSmartPtr<IfcRelNests> IfcRelNestsPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELNESTS_AUTO_IMPL_H
