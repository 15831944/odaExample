...
#ifndef _IFC2X2_FINAL_IFCELLIPSEPROFILEDEF_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCELLIPSEPROFILEDEF_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcEllipseProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcEllipseProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcEllipseProfileDef, IfcEllipseProfileDef> object.
*/
typedef OdSmartPtr<IfcEllipseProfileDef> IfcEllipseProfileDefPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCELLIPSEPROFILEDEF_AUTO_IMPL_H
