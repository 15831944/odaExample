...
#ifndef _IFC2X2_FINAL_IFCASSET_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCASSET_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcAsset : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcAsset);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getAssetID() const;
...
protected:
  // Fields declaration: 
  OdAnsiString m_AssetID;   // IfcIdentifier
  OdDAIObjectId m_OriginalValue;   // IfcCostValue
  OdDAIObjectId m_CurrentValue;   // IfcCostValue
  OdDAIObjectId m_TotalReplacementCost;   // IfcCostValue
  OdDAI::Select m_Owner;   // IfcActorSelect
  OdDAI::Select m_User;   // IfcActorSelect
  OdDAIObjectId m_ResponsiblePerson;   // IfcPerson
  OdDAIObjectId m_IncorporationDate;   // IfcCalendarDate
  OdDAIObjectId m_DepreciatedValue;   // IfcCostValue
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcAsset, IfcAsset> object.
*/
typedef OdSmartPtr<IfcAsset> IfcAssetPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCASSET_AUTO_IMPL_H
