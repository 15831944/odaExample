...
#ifndef _IFC2X2_FINAL_IFCPROPERTY_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCPROPERTY_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcProperty : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcProperty);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_Name;   // IfcIdentifier
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcProperty, IfcProperty> object.
*/
typedef OdSmartPtr<IfcProperty> IfcPropertyPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCPROPERTY_AUTO_IMPL_H
