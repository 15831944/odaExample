...
#ifndef _IFC2X2_FINAL_IFCBOOLEANRESULT_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCBOOLEANRESULT_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcBooleanResult : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcBooleanResult);
  //DOM-IGNORE-END
...
public:
  ...
  IfcBooleanOperator getOperator() const;
  void setOperator(IfcBooleanOperator Operator);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_Operator;   // IfcBooleanOperator
  OdDAI::Select m_FirstOperand;   // IfcBooleanOperand
  OdDAI::Select m_SecondOperand;   // IfcBooleanOperand
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcBooleanResult, IfcBooleanResult> object.
*/
typedef OdSmartPtr<IfcBooleanResult> IfcBooleanResultPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCBOOLEANRESULT_AUTO_IMPL_H
