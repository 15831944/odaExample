...
#ifndef _IFC2X2_FINAL_IFCFLOWMETERTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCFLOWMETERTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcFlowMeterType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcFlowMeterType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcFlowMeterTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcFlowMeterTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcFlowMeterTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcFlowMeterType, IfcFlowMeterType> object.
*/
typedef OdSmartPtr<IfcFlowMeterType> IfcFlowMeterTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCFLOWMETERTYPE_AUTO_IMPL_H
