...
#ifndef _IFC2X2_FINAL_IFCINVENTORY_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCINVENTORY_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcInventory : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcInventory);
  //DOM-IGNORE-END
...
public:
  ...
  IfcInventoryTypeEnum getInventoryType() const;
  void setInventoryType(IfcInventoryTypeEnum InventoryType);
  IfcActorSelect jurisdiction();
  void getResponsiblePersons(OdDAIObjectIds& ResponsiblePersons) const;
  OdDAI::OdDAIObjectIdSet& responsiblePersons();
  const OdDAIObjectId& getLastUpdateDate() const;
  void setLastUpdateDate(const OdDAIObjectId& LastUpdateDate);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_InventoryType;   // IfcInventoryTypeEnum
  OdDAI::Select m_Jurisdiction;   // IfcActorSelect
  OdDAI::OdDAIObjectIdSet m_ResponsiblePersons; // SET [1:?] of IfcPerson
  OdDAIObjectId m_LastUpdateDate;   // IfcCalendarDate
  OdDAIObjectId m_CurrentValue;   // IfcCostValue  [optional]
  OdDAIObjectId m_OriginalValue;   // IfcCostValue  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcInventory, IfcInventory> object.
*/
typedef OdSmartPtr<IfcInventory> IfcInventoryPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCINVENTORY_AUTO_IMPL_H
