...
#ifndef _IFC2X2_FINAL_IFCDAMPERTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCDAMPERTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcDamperType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcDamperType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcDamperType, IfcDamperType> object.
*/
typedef OdSmartPtr<IfcDamperType> IfcDamperTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCDAMPERTYPE_AUTO_IMPL_H
