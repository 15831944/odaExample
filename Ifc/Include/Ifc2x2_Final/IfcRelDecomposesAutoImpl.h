...
#ifndef _IFC2X2_FINAL_IFCRELDECOMPOSES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCRELDECOMPOSES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRelDecomposes : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcRelDecomposes);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRelDecomposes, IfcRelDecomposes> object.
*/
typedef OdSmartPtr<IfcRelDecomposes> IfcRelDecomposesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCRELDECOMPOSES_AUTO_IMPL_H
