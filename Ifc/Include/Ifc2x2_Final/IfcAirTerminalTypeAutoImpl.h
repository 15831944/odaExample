...
#ifndef _IFC2X2_FINAL_IFCAIRTERMINALTYPE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCAIRTERMINALTYPE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcAirTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcAirTerminalType);
  //DOM-IGNORE-END
...
public:
  ...
  IfcAirTerminalTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcAirTerminalTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcAirTerminalTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcAirTerminalType, IfcAirTerminalType> object.
*/
typedef OdSmartPtr<IfcAirTerminalType> IfcAirTerminalTypePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCAIRTERMINALTYPE_AUTO_IMPL_H
