...
#ifndef _IFC2X2_FINAL_IFCSWEPTAREASOLID_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSWEPTAREASOLID_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSweptAreaSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcSweptAreaSolid);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_SweptArea;   // IfcProfileDef
  OdDAIObjectId m_Position;   // IfcAxis2Placement3D
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSweptAreaSolid, IfcSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcSweptAreaSolid> IfcSweptAreaSolidPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSWEPTAREASOLID_AUTO_IMPL_H
