...
#ifndef _IFC2X2_FINAL_IFCREGULARTIMESERIES_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCREGULARTIMESERIES_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcRegularTimeSeries : public IfcTimeSeries
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcRegularTimeSeries);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_TimeStep;   // IfcTimeMeasure
  OdDAI::OdDAIObjectIdList m_Values; // LIST [1:?] of IfcTimeSeriesValue
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcRegularTimeSeries, IfcRegularTimeSeries> object.
*/
typedef OdSmartPtr<IfcRegularTimeSeries> IfcRegularTimeSeriesPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCREGULARTIMESERIES_AUTO_IMPL_H
