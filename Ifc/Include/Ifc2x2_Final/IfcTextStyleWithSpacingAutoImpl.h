...
#ifndef _IFC2X2_FINAL_IFCTEXTSTYLEWITHSPACING_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCTEXTSTYLEWITHSPACING_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcTextStyleWithSpacing : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x2_final::IfcTextStyleWithSpacing);
  //DOM-IGNORE-END
...
public:
  ...
  IfcCharacterSpacingSelect characterSpacing();
...
protected:
  // Fields declaration: 
  OdDAI::Select m_CharacterSpacing;   // IfcCharacterSpacingSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcTextStyleWithSpacing, IfcTextStyleWithSpacing> object.
*/
typedef OdSmartPtr<IfcTextStyleWithSpacing> IfcTextStyleWithSpacingPtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCTEXTSTYLEWITHSPACING_AUTO_IMPL_H
