...
#ifndef _IFC2X2_FINAL_IFCSWEPTSURFACE_AUTO_IMPL_H
#define _IFC2X2_FINAL_IFCSWEPTSURFACE_AUTO_IMPL_H
...
class IFC2X2_FINAL_EXPORT IfcSweptSurface : public IfcSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x2_final::IfcSweptSurface);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getSweptCurve() const;
  void setSweptCurve(const OdDAIObjectId& SweptCurve);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_SweptCurve;   // IfcProfileDef
  OdDAIObjectId m_Position;   // IfcAxis2Placement3D
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x2_final::IfcSweptSurface, IfcSweptSurface> object.
*/
typedef OdSmartPtr<IfcSweptSurface> IfcSweptSurfacePtr;

} // namespace

#endif // _IFC2X2_FINAL_IFCSWEPTSURFACE_AUTO_IMPL_H
