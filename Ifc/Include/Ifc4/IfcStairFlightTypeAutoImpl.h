...
#ifndef _IFC4_IFCSTAIRFLIGHTTYPE_AUTO_IMPL_H
#define _IFC4_IFCSTAIRFLIGHTTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStairFlightType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStairFlightType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStairFlightType, IfcStairFlightType> object.
*/
typedef OdSmartPtr<IfcStairFlightType> IfcStairFlightTypePtr;

} // namespace

#endif // _IFC4_IFCSTAIRFLIGHTTYPE_AUTO_IMPL_H
