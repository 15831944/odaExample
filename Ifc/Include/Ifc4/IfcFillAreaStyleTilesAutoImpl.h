...
#ifndef _IFC4_IFCFILLAREASTYLETILES_AUTO_IMPL_H
#define _IFC4_IFCFILLAREASTYLETILES_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFillAreaStyleTiles : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFillAreaStyleTiles);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFillAreaStyleTiles, IfcFillAreaStyleTiles> object.
*/
typedef OdSmartPtr<IfcFillAreaStyleTiles> IfcFillAreaStyleTilesPtr;

} // namespace

#endif // _IFC4_IFCFILLAREASTYLETILES_AUTO_IMPL_H
