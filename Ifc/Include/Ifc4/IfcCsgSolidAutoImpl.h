...
#ifndef _IFC4_IFCCSGSOLID_AUTO_IMPL_H
#define _IFC4_IFCCSGSOLID_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCsgSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCsgSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCsgSolid, IfcCsgSolid> object.
*/
typedef OdSmartPtr<IfcCsgSolid> IfcCsgSolidPtr;

} // namespace

#endif // _IFC4_IFCCSGSOLID_AUTO_IMPL_H
