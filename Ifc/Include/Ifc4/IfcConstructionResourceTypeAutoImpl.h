...
#ifndef _IFC4_IFCCONSTRUCTIONRESOURCETYPE_AUTO_IMPL_H
#define _IFC4_IFCCONSTRUCTIONRESOURCETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcConstructionResourceType : public IfcTypeResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcConstructionResourceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcConstructionResourceType, IfcConstructionResourceType> object.
*/
typedef OdSmartPtr<IfcConstructionResourceType> IfcConstructionResourceTypePtr;

} // namespace

#endif // _IFC4_IFCCONSTRUCTIONRESOURCETYPE_AUTO_IMPL_H
