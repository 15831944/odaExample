...
#ifndef _IFC4_IFCMATERIALCLASSIFICATIONRELATIONSHIP_AUTO_IMPL_H
#define _IFC4_IFCMATERIALCLASSIFICATIONRELATIONSHIP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMaterialClassificationRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMaterialClassificationRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMaterialClassificationRelationship, IfcMaterialClassificationRelationship> object.
*/
typedef OdSmartPtr<IfcMaterialClassificationRelationship> IfcMaterialClassificationRelationshipPtr;

} // namespace

#endif // _IFC4_IFCMATERIALCLASSIFICATIONRELATIONSHIP_AUTO_IMPL_H
