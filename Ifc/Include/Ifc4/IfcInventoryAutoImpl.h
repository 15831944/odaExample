...
#ifndef _IFC4_IFCINVENTORY_AUTO_IMPL_H
#define _IFC4_IFCINVENTORY_AUTO_IMPL_H
...
class IFC4_EXPORT IfcInventory : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcInventory);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcInventory, IfcInventory> object.
*/
typedef OdSmartPtr<IfcInventory> IfcInventoryPtr;

} // namespace

#endif // _IFC4_IFCINVENTORY_AUTO_IMPL_H
