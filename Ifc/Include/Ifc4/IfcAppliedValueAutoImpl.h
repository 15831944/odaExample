...
#ifndef _IFC4_IFCAPPLIEDVALUE_AUTO_IMPL_H
#define _IFC4_IFCAPPLIEDVALUE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcAppliedValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcAppliedValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcAppliedValue, IfcAppliedValue> object.
*/
typedef OdSmartPtr<IfcAppliedValue> IfcAppliedValuePtr;

} // namespace

#endif // _IFC4_IFCAPPLIEDVALUE_AUTO_IMPL_H
