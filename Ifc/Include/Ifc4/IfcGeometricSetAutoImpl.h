...
#ifndef _IFC4_IFCGEOMETRICSET_AUTO_IMPL_H
#define _IFC4_IFCGEOMETRICSET_AUTO_IMPL_H
...
class IFC4_EXPORT IfcGeometricSet : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcGeometricSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcGeometricSet, IfcGeometricSet> object.
*/
typedef OdSmartPtr<IfcGeometricSet> IfcGeometricSetPtr;

} // namespace

#endif // _IFC4_IFCGEOMETRICSET_AUTO_IMPL_H
