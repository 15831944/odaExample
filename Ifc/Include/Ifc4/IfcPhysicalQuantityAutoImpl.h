...
#ifndef _IFC4_IFCPHYSICALQUANTITY_AUTO_IMPL_H
#define _IFC4_IFCPHYSICALQUANTITY_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPhysicalQuantity : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcPhysicalQuantity);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPhysicalQuantity, IfcPhysicalQuantity> object.
*/
typedef OdSmartPtr<IfcPhysicalQuantity> IfcPhysicalQuantityPtr;

} // namespace

#endif // _IFC4_IFCPHYSICALQUANTITY_AUTO_IMPL_H
