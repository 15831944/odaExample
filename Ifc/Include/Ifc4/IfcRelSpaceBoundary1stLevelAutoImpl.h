...
#ifndef _IFC4_IFCRELSPACEBOUNDARY1STLEVEL_AUTO_IMPL_H
#define _IFC4_IFCRELSPACEBOUNDARY1STLEVEL_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelSpaceBoundary1stLevel : public IfcRelSpaceBoundary
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelSpaceBoundary1stLevel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelSpaceBoundary1stLevel, IfcRelSpaceBoundary1stLevel> object.
*/
typedef OdSmartPtr<IfcRelSpaceBoundary1stLevel> IfcRelSpaceBoundary1stLevelPtr;

} // namespace

#endif // _IFC4_IFCRELSPACEBOUNDARY1STLEVEL_AUTO_IMPL_H
