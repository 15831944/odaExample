...
#ifndef _IFC4_IFCJUNCTIONBOX_AUTO_IMPL_H
#define _IFC4_IFCJUNCTIONBOX_AUTO_IMPL_H
...
class IFC4_EXPORT IfcJunctionBox : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcJunctionBox);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcJunctionBox, IfcJunctionBox> object.
*/
typedef OdSmartPtr<IfcJunctionBox> IfcJunctionBoxPtr;

} // namespace

#endif // _IFC4_IFCJUNCTIONBOX_AUTO_IMPL_H
