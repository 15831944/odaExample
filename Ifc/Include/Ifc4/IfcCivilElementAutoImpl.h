...
#ifndef _IFC4_IFCCIVILELEMENT_AUTO_IMPL_H
#define _IFC4_IFCCIVILELEMENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCivilElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCivilElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCivilElement, IfcCivilElement> object.
*/
typedef OdSmartPtr<IfcCivilElement> IfcCivilElementPtr;

} // namespace

#endif // _IFC4_IFCCIVILELEMENT_AUTO_IMPL_H
