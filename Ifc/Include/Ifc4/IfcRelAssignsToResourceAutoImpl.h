...
#ifndef _IFC4_IFCRELASSIGNSTORESOURCE_AUTO_IMPL_H
#define _IFC4_IFCRELASSIGNSTORESOURCE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelAssignsToResource : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelAssignsToResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelAssignsToResource, IfcRelAssignsToResource> object.
*/
typedef OdSmartPtr<IfcRelAssignsToResource> IfcRelAssignsToResourcePtr;

} // namespace

#endif // _IFC4_IFCRELASSIGNSTORESOURCE_AUTO_IMPL_H
