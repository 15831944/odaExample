...
#ifndef _IFC4_IFCPRESENTATIONSTYLE_AUTO_IMPL_H
#define _IFC4_IFCPRESENTATIONSTYLE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPresentationStyle : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcPresentationStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPresentationStyle, IfcPresentationStyle> object.
*/
typedef OdSmartPtr<IfcPresentationStyle> IfcPresentationStylePtr;

} // namespace

#endif // _IFC4_IFCPRESENTATIONSTYLE_AUTO_IMPL_H
