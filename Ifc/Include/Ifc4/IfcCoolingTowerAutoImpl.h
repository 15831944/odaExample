...
#ifndef _IFC4_IFCCOOLINGTOWER_AUTO_IMPL_H
#define _IFC4_IFCCOOLINGTOWER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCoolingTower : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCoolingTower);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCoolingTower, IfcCoolingTower> object.
*/
typedef OdSmartPtr<IfcCoolingTower> IfcCoolingTowerPtr;

} // namespace

#endif // _IFC4_IFCCOOLINGTOWER_AUTO_IMPL_H
