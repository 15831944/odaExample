...
#ifndef _IFC4_IFCBOUNDEDCURVE_AUTO_IMPL_H
#define _IFC4_IFCBOUNDEDCURVE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBoundedCurve : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcBoundedCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBoundedCurve, IfcBoundedCurve> object.
*/
typedef OdSmartPtr<IfcBoundedCurve> IfcBoundedCurvePtr;

} // namespace

#endif // _IFC4_IFCBOUNDEDCURVE_AUTO_IMPL_H
