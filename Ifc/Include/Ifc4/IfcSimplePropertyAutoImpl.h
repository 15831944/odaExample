...
#ifndef _IFC4_IFCSIMPLEPROPERTY_AUTO_IMPL_H
#define _IFC4_IFCSIMPLEPROPERTY_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSimpleProperty : public IfcProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcSimpleProperty);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSimpleProperty, IfcSimpleProperty> object.
*/
typedef OdSmartPtr<IfcSimpleProperty> IfcSimplePropertyPtr;

} // namespace

#endif // _IFC4_IFCSIMPLEPROPERTY_AUTO_IMPL_H
