...
#ifndef _IFC4_IFCVECTOR_AUTO_IMPL_H
#define _IFC4_IFCVECTOR_AUTO_IMPL_H
...
class IFC4_EXPORT IfcVector : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcVector);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcVector, IfcVector> object.
*/
typedef OdSmartPtr<IfcVector> IfcVectorPtr;

} // namespace

#endif // _IFC4_IFCVECTOR_AUTO_IMPL_H
