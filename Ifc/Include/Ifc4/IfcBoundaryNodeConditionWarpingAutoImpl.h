...
#ifndef _IFC4_IFCBOUNDARYNODECONDITIONWARPING_AUTO_IMPL_H
#define _IFC4_IFCBOUNDARYNODECONDITIONWARPING_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBoundaryNodeConditionWarping : public IfcBoundaryNodeCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBoundaryNodeConditionWarping);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBoundaryNodeConditionWarping, IfcBoundaryNodeConditionWarping> object.
*/
typedef OdSmartPtr<IfcBoundaryNodeConditionWarping> IfcBoundaryNodeConditionWarpingPtr;

} // namespace

#endif // _IFC4_IFCBOUNDARYNODECONDITIONWARPING_AUTO_IMPL_H
