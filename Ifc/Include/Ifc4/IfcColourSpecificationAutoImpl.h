...
#ifndef _IFC4_IFCCOLOURSPECIFICATION_AUTO_IMPL_H
#define _IFC4_IFCCOLOURSPECIFICATION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcColourSpecification : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcColourSpecification);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcColourSpecification, IfcColourSpecification> object.
*/
typedef OdSmartPtr<IfcColourSpecification> IfcColourSpecificationPtr;

} // namespace

#endif // _IFC4_IFCCOLOURSPECIFICATION_AUTO_IMPL_H
