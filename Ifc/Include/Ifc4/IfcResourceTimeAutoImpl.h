...
#ifndef _IFC4_IFCRESOURCETIME_AUTO_IMPL_H
#define _IFC4_IFCRESOURCETIME_AUTO_IMPL_H
...
class IFC4_EXPORT IfcResourceTime : public IfcSchedulingTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcResourceTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcResourceTime, IfcResourceTime> object.
*/
typedef OdSmartPtr<IfcResourceTime> IfcResourceTimePtr;

} // namespace

#endif // _IFC4_IFCRESOURCETIME_AUTO_IMPL_H
