...
#ifndef _IFC4_IFCUNITARYCONTROLELEMENTTYPE_AUTO_IMPL_H
#define _IFC4_IFCUNITARYCONTROLELEMENTTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcUnitaryControlElementType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcUnitaryControlElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcUnitaryControlElementType, IfcUnitaryControlElementType> object.
*/
typedef OdSmartPtr<IfcUnitaryControlElementType> IfcUnitaryControlElementTypePtr;

} // namespace

#endif // _IFC4_IFCUNITARYCONTROLELEMENTTYPE_AUTO_IMPL_H
