...
#ifndef _IFC4_IFCSTRUCTURALLOADSINGLEFORCEWARPING_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALLOADSINGLEFORCEWARPING_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralLoadSingleForceWarping : public IfcStructuralLoadSingleForce
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStructuralLoadSingleForceWarping);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralLoadSingleForceWarping, IfcStructuralLoadSingleForceWarping> object.
*/
typedef OdSmartPtr<IfcStructuralLoadSingleForceWarping> IfcStructuralLoadSingleForceWarpingPtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALLOADSINGLEFORCEWARPING_AUTO_IMPL_H
