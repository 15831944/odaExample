...
#ifndef _IFC4_IFCCABLEFITTINGTYPE_AUTO_IMPL_H
#define _IFC4_IFCCABLEFITTINGTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCableFittingType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCableFittingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCableFittingType, IfcCableFittingType> object.
*/
typedef OdSmartPtr<IfcCableFittingType> IfcCableFittingTypePtr;

} // namespace

#endif // _IFC4_IFCCABLEFITTINGTYPE_AUTO_IMPL_H
