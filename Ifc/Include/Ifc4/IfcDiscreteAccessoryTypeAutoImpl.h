...
#ifndef _IFC4_IFCDISCRETEACCESSORYTYPE_AUTO_IMPL_H
#define _IFC4_IFCDISCRETEACCESSORYTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDiscreteAccessoryType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDiscreteAccessoryType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDiscreteAccessoryType, IfcDiscreteAccessoryType> object.
*/
typedef OdSmartPtr<IfcDiscreteAccessoryType> IfcDiscreteAccessoryTypePtr;

} // namespace

#endif // _IFC4_IFCDISCRETEACCESSORYTYPE_AUTO_IMPL_H
