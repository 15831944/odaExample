...
#ifndef _IFC4_IFCCHILLER_AUTO_IMPL_H
#define _IFC4_IFCCHILLER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcChiller : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcChiller);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcChiller, IfcChiller> object.
*/
typedef OdSmartPtr<IfcChiller> IfcChillerPtr;

} // namespace

#endif // _IFC4_IFCCHILLER_AUTO_IMPL_H
