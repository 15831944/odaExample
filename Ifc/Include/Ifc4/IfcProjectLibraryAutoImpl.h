...
#ifndef _IFC4_IFCPROJECTLIBRARY_AUTO_IMPL_H
#define _IFC4_IFCPROJECTLIBRARY_AUTO_IMPL_H
...
class IFC4_EXPORT IfcProjectLibrary : public IfcContext
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcProjectLibrary);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcProjectLibrary, IfcProjectLibrary> object.
*/
typedef OdSmartPtr<IfcProjectLibrary> IfcProjectLibraryPtr;

} // namespace

#endif // _IFC4_IFCPROJECTLIBRARY_AUTO_IMPL_H
