...
#ifndef _IFC4_IFCRELFLOWCONTROLELEMENTS_AUTO_IMPL_H
#define _IFC4_IFCRELFLOWCONTROLELEMENTS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelFlowControlElements : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelFlowControlElements);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelFlowControlElements, IfcRelFlowControlElements> object.
*/
typedef OdSmartPtr<IfcRelFlowControlElements> IfcRelFlowControlElementsPtr;

} // namespace

#endif // _IFC4_IFCRELFLOWCONTROLELEMENTS_AUTO_IMPL_H
