...
#ifndef _IFC4_IFCCOSTSCHEDULE_AUTO_IMPL_H
#define _IFC4_IFCCOSTSCHEDULE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCostSchedule : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCostSchedule);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCostSchedule, IfcCostSchedule> object.
*/
typedef OdSmartPtr<IfcCostSchedule> IfcCostSchedulePtr;

} // namespace

#endif // _IFC4_IFCCOSTSCHEDULE_AUTO_IMPL_H
