...
#ifndef _IFC4_IFCCARTESIANPOINTLIST2D_AUTO_IMPL_H
#define _IFC4_IFCCARTESIANPOINTLIST2D_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCartesianPointList2D : public IfcCartesianPointList
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCartesianPointList2D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCartesianPointList2D, IfcCartesianPointList2D> object.
*/
typedef OdSmartPtr<IfcCartesianPointList2D> IfcCartesianPointList2DPtr;

} // namespace

#endif // _IFC4_IFCCARTESIANPOINTLIST2D_AUTO_IMPL_H
