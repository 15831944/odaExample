...
#ifndef _IFC4_IFCCOLUMNTYPE_AUTO_IMPL_H
#define _IFC4_IFCCOLUMNTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcColumnType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcColumnType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcColumnType, IfcColumnType> object.
*/
typedef OdSmartPtr<IfcColumnType> IfcColumnTypePtr;

} // namespace

#endif // _IFC4_IFCCOLUMNTYPE_AUTO_IMPL_H
