...
#ifndef _IFC4_IFCFURNISHINGELEMENT_AUTO_IMPL_H
#define _IFC4_IFCFURNISHINGELEMENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFurnishingElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFurnishingElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFurnishingElement, IfcFurnishingElement> object.
*/
typedef OdSmartPtr<IfcFurnishingElement> IfcFurnishingElementPtr;

} // namespace

#endif // _IFC4_IFCFURNISHINGELEMENT_AUTO_IMPL_H
