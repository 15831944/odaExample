...
#ifndef _IFC4_IFCPRODUCTREPRESENTATION_AUTO_IMPL_H
#define _IFC4_IFCPRODUCTREPRESENTATION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcProductRepresentation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcProductRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcProductRepresentation, IfcProductRepresentation> object.
*/
typedef OdSmartPtr<IfcProductRepresentation> IfcProductRepresentationPtr;

} // namespace

#endif // _IFC4_IFCPRODUCTREPRESENTATION_AUTO_IMPL_H
