...
#ifndef _IFC4_IFCPROFILEDEF_AUTO_IMPL_H
#define _IFC4_IFCPROFILEDEF_AUTO_IMPL_H
...
/** \details
  ...
  * IfcLibraryReference.Location and .Name or .ReferencedLibrary further describe the library.
  ...
  \remarks
  Changed from ABSTRACT to non-abstract for uses which do not require an explicitly defined geometry. 
  Added inverse attributes HasProperties and HasExternalReference.
*/
class IFC4_EXPORT IfcProfileDef : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcProfileDef, IfcProfileDef> object.
*/
typedef OdSmartPtr<IfcProfileDef> IfcProfileDefPtr;

} // namespace

#endif // _IFC4_IFCPROFILEDEF_AUTO_IMPL_H
