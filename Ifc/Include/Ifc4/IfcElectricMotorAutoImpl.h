...
#ifndef _IFC4_IFCELECTRICMOTOR_AUTO_IMPL_H
#define _IFC4_IFCELECTRICMOTOR_AUTO_IMPL_H
...
class IFC4_EXPORT IfcElectricMotor : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcElectricMotor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcElectricMotor, IfcElectricMotor> object.
*/
typedef OdSmartPtr<IfcElectricMotor> IfcElectricMotorPtr;

} // namespace

#endif // _IFC4_IFCELECTRICMOTOR_AUTO_IMPL_H
