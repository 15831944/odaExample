...
#ifndef _IFC4_IFCBUILDINGELEMENT_AUTO_IMPL_H
#define _IFC4_IFCBUILDINGELEMENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBuildingElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcBuildingElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBuildingElement, IfcBuildingElement> object.
*/
typedef OdSmartPtr<IfcBuildingElement> IfcBuildingElementPtr;

} // namespace

#endif // _IFC4_IFCBUILDINGELEMENT_AUTO_IMPL_H
