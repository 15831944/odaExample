...
#ifndef _IFC4_IFCMATERIALLIST_AUTO_IMPL_H
#define _IFC4_IFCMATERIALLIST_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMaterialList : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMaterialList);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMaterialList, IfcMaterialList> object.
*/
typedef OdSmartPtr<IfcMaterialList> IfcMaterialListPtr;

} // namespace

#endif // _IFC4_IFCMATERIALLIST_AUTO_IMPL_H
