...
#ifndef _IFC4_IFCSLABELEMENTEDCASE_AUTO_IMPL_H
#define _IFC4_IFCSLABELEMENTEDCASE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSlabElementedCase : public IfcSlab
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSlabElementedCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSlabElementedCase, IfcSlabElementedCase> object.
*/
typedef OdSmartPtr<IfcSlabElementedCase> IfcSlabElementedCasePtr;

} // namespace

#endif // _IFC4_IFCSLABELEMENTEDCASE_AUTO_IMPL_H
