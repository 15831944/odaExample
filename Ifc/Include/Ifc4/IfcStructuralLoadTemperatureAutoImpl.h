...
#ifndef _IFC4_IFCSTRUCTURALLOADTEMPERATURE_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALLOADTEMPERATURE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralLoadTemperature : public IfcStructuralLoadStatic
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStructuralLoadTemperature);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralLoadTemperature, IfcStructuralLoadTemperature> object.
*/
typedef OdSmartPtr<IfcStructuralLoadTemperature> IfcStructuralLoadTemperaturePtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALLOADTEMPERATURE_AUTO_IMPL_H
