...
#ifndef _IFC4_IFCTYPEOBJECT_AUTO_IMPL_H
#define _IFC4_IFCTYPEOBJECT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTypeObject : public IfcObjectDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTypeObject);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTypeObject, IfcTypeObject> object.
*/
typedef OdSmartPtr<IfcTypeObject> IfcTypeObjectPtr;

} // namespace

#endif // _IFC4_IFCTYPEOBJECT_AUTO_IMPL_H
