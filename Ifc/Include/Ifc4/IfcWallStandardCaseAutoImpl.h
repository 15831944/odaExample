...
#ifndef _IFC4_IFCWALLSTANDARDCASE_AUTO_IMPL_H
#define _IFC4_IFCWALLSTANDARDCASE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcWallStandardCase : public IfcWall
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcWallStandardCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcWallStandardCase, IfcWallStandardCase> object.
*/
typedef OdSmartPtr<IfcWallStandardCase> IfcWallStandardCasePtr;

} // namespace

#endif // _IFC4_IFCWALLSTANDARDCASE_AUTO_IMPL_H
