...
#ifndef _IFC4_IFCRELASSOCIATESLIBRARY_AUTO_IMPL_H
#define _IFC4_IFCRELASSOCIATESLIBRARY_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelAssociatesLibrary : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelAssociatesLibrary);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelAssociatesLibrary, IfcRelAssociatesLibrary> object.
*/
typedef OdSmartPtr<IfcRelAssociatesLibrary> IfcRelAssociatesLibraryPtr;

} // namespace

#endif // _IFC4_IFCRELASSOCIATESLIBRARY_AUTO_IMPL_H
