...
#ifndef _IFC4_IFCSHADINGDEVICETYPE_AUTO_IMPL_H
#define _IFC4_IFCSHADINGDEVICETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcShadingDeviceType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcShadingDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcShadingDeviceType, IfcShadingDeviceType> object.
*/
typedef OdSmartPtr<IfcShadingDeviceType> IfcShadingDeviceTypePtr;

} // namespace

#endif // _IFC4_IFCSHADINGDEVICETYPE_AUTO_IMPL_H
