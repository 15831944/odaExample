...
#ifndef _IFC4_IFCFLOWTERMINALTYPE_AUTO_IMPL_H
#define _IFC4_IFCFLOWTERMINALTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFlowTerminalType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcFlowTerminalType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFlowTerminalType, IfcFlowTerminalType> object.
*/
typedef OdSmartPtr<IfcFlowTerminalType> IfcFlowTerminalTypePtr;

} // namespace

#endif // _IFC4_IFCFLOWTERMINALTYPE_AUTO_IMPL_H
