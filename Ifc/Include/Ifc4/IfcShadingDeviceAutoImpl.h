...
#ifndef _IFC4_IFCSHADINGDEVICE_AUTO_IMPL_H
#define _IFC4_IFCSHADINGDEVICE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcShadingDevice : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcShadingDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcShadingDevice, IfcShadingDevice> object.
*/
typedef OdSmartPtr<IfcShadingDevice> IfcShadingDevicePtr;

} // namespace

#endif // _IFC4_IFCSHADINGDEVICE_AUTO_IMPL_H
