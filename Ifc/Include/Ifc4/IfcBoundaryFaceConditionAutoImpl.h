...
#ifndef _IFC4_IFCBOUNDARYFACECONDITION_AUTO_IMPL_H
#define _IFC4_IFCBOUNDARYFACECONDITION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBoundaryFaceCondition : public IfcBoundaryCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBoundaryFaceCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBoundaryFaceCondition, IfcBoundaryFaceCondition> object.
*/
typedef OdSmartPtr<IfcBoundaryFaceCondition> IfcBoundaryFaceConditionPtr;

} // namespace

#endif // _IFC4_IFCBOUNDARYFACECONDITION_AUTO_IMPL_H
