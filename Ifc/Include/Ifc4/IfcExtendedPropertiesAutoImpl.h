...
#ifndef _IFC4_IFCEXTENDEDPROPERTIES_AUTO_IMPL_H
#define _IFC4_IFCEXTENDEDPROPERTIES_AUTO_IMPL_H
...
class IFC4_EXPORT IfcExtendedProperties : public IfcPropertyAbstraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcExtendedProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcExtendedProperties, IfcExtendedProperties> object.
*/
typedef OdSmartPtr<IfcExtendedProperties> IfcExtendedPropertiesPtr;

} // namespace

#endif // _IFC4_IFCEXTENDEDPROPERTIES_AUTO_IMPL_H
