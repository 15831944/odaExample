...
#ifndef _IFC4_IFCRELCONNECTSPATHELEMENTS_AUTO_IMPL_H
#define _IFC4_IFCRELCONNECTSPATHELEMENTS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelConnectsPathElements : public IfcRelConnectsElements
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelConnectsPathElements);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelConnectsPathElements, IfcRelConnectsPathElements> object.
*/
typedef OdSmartPtr<IfcRelConnectsPathElements> IfcRelConnectsPathElementsPtr;

} // namespace

#endif // _IFC4_IFCRELCONNECTSPATHELEMENTS_AUTO_IMPL_H
