...
#ifndef _IFC4_IFCOBJECTPLACEMENT_AUTO_IMPL_H
#define _IFC4_IFCOBJECTPLACEMENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcObjectPlacement : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcObjectPlacement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcObjectPlacement, IfcObjectPlacement> object.
*/
typedef OdSmartPtr<IfcObjectPlacement> IfcObjectPlacementPtr;

} // namespace

#endif // _IFC4_IFCOBJECTPLACEMENT_AUTO_IMPL_H
