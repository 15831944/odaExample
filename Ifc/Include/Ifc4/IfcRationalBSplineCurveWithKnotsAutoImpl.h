...
#ifndef _IFC4_IFCRATIONALBSPLINECURVEWITHKNOTS_AUTO_IMPL_H
#define _IFC4_IFCRATIONALBSPLINECURVEWITHKNOTS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRationalBSplineCurveWithKnots : public IfcBSplineCurveWithKnots
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRationalBSplineCurveWithKnots);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRationalBSplineCurveWithKnots, IfcRationalBSplineCurveWithKnots> object.
*/
typedef OdSmartPtr<IfcRationalBSplineCurveWithKnots> IfcRationalBSplineCurveWithKnotsPtr;

} // namespace

#endif // _IFC4_IFCRATIONALBSPLINECURVEWITHKNOTS_AUTO_IMPL_H
