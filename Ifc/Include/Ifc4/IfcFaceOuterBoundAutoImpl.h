...
#ifndef _IFC4_IFCFACEOUTERBOUND_AUTO_IMPL_H
#define _IFC4_IFCFACEOUTERBOUND_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFaceOuterBound : public IfcFaceBound
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFaceOuterBound);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFaceOuterBound, IfcFaceOuterBound> object.
*/
typedef OdSmartPtr<IfcFaceOuterBound> IfcFaceOuterBoundPtr;

} // namespace

#endif // _IFC4_IFCFACEOUTERBOUND_AUTO_IMPL_H
