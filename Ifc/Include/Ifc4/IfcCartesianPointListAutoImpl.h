...
#ifndef _IFC4_IFCCARTESIANPOINTLIST_AUTO_IMPL_H
#define _IFC4_IFCCARTESIANPOINTLIST_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCartesianPointList : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcCartesianPointList);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCartesianPointList, IfcCartesianPointList> object.
*/
typedef OdSmartPtr<IfcCartesianPointList> IfcCartesianPointListPtr;

} // namespace

#endif // _IFC4_IFCCARTESIANPOINTLIST_AUTO_IMPL_H
