...
#ifndef _IFC4_IFCBUILDINGELEMENTTYPE_AUTO_IMPL_H
#define _IFC4_IFCBUILDINGELEMENTTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBuildingElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcBuildingElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBuildingElementType, IfcBuildingElementType> object.
*/
typedef OdSmartPtr<IfcBuildingElementType> IfcBuildingElementTypePtr;

} // namespace

#endif // _IFC4_IFCBUILDINGELEMENTTYPE_AUTO_IMPL_H
