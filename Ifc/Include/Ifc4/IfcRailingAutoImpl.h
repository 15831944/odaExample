...
#ifndef _IFC4_IFCRAILING_AUTO_IMPL_H
#define _IFC4_IFCRAILING_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRailing : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRailing);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRailing, IfcRailing> object.
*/
typedef OdSmartPtr<IfcRailing> IfcRailingPtr;

} // namespace

#endif // _IFC4_IFCRAILING_AUTO_IMPL_H
