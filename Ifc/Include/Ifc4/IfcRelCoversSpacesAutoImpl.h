...
#ifndef _IFC4_IFCRELCOVERSSPACES_AUTO_IMPL_H
#define _IFC4_IFCRELCOVERSSPACES_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelCoversSpaces : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelCoversSpaces);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelCoversSpaces, IfcRelCoversSpaces> object.
*/
typedef OdSmartPtr<IfcRelCoversSpaces> IfcRelCoversSpacesPtr;

} // namespace

#endif // _IFC4_IFCRELCOVERSSPACES_AUTO_IMPL_H
