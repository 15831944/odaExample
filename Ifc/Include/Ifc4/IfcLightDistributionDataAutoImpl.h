...
#ifndef _IFC4_IFCLIGHTDISTRIBUTIONDATA_AUTO_IMPL_H
#define _IFC4_IFCLIGHTDISTRIBUTIONDATA_AUTO_IMPL_H
...
class IFC4_EXPORT IfcLightDistributionData : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcLightDistributionData);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcLightDistributionData, IfcLightDistributionData> object.
*/
typedef OdSmartPtr<IfcLightDistributionData> IfcLightDistributionDataPtr;

} // namespace

#endif // _IFC4_IFCLIGHTDISTRIBUTIONDATA_AUTO_IMPL_H
