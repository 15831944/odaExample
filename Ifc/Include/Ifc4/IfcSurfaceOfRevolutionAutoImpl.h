...
#ifndef _IFC4_IFCSURFACEOFREVOLUTION_AUTO_IMPL_H
#define _IFC4_IFCSURFACEOFREVOLUTION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSurfaceOfRevolution : public IfcSweptSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSurfaceOfRevolution);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSurfaceOfRevolution, IfcSurfaceOfRevolution> object.
*/
typedef OdSmartPtr<IfcSurfaceOfRevolution> IfcSurfaceOfRevolutionPtr;

} // namespace

#endif // _IFC4_IFCSURFACEOFREVOLUTION_AUTO_IMPL_H
