...
#ifndef _IFC4_IFCMAPCONVERSION_AUTO_IMPL_H
#define _IFC4_IFCMAPCONVERSION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMapConversion : public IfcCoordinateOperation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMapConversion);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMapConversion, IfcMapConversion> object.
*/
typedef OdSmartPtr<IfcMapConversion> IfcMapConversionPtr;

} // namespace

#endif // _IFC4_IFCMAPCONVERSION_AUTO_IMPL_H
