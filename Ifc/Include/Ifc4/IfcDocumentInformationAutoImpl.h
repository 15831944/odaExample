...
#ifndef _IFC4_IFCDOCUMENTINFORMATION_AUTO_IMPL_H
#define _IFC4_IFCDOCUMENTINFORMATION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDocumentInformation : public IfcExternalInformation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDocumentInformation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDocumentInformation, IfcDocumentInformation> object.
*/
typedef OdSmartPtr<IfcDocumentInformation> IfcDocumentInformationPtr;

} // namespace

#endif // _IFC4_IFCDOCUMENTINFORMATION_AUTO_IMPL_H
