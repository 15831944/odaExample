...
#ifndef _IFC4_IFCBOUNDARYNODECONDITION_AUTO_IMPL_H
#define _IFC4_IFCBOUNDARYNODECONDITION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBoundaryNodeCondition : public IfcBoundaryCondition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBoundaryNodeCondition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBoundaryNodeCondition, IfcBoundaryNodeCondition> object.
*/
typedef OdSmartPtr<IfcBoundaryNodeCondition> IfcBoundaryNodeConditionPtr;

} // namespace

#endif // _IFC4_IFCBOUNDARYNODECONDITION_AUTO_IMPL_H
