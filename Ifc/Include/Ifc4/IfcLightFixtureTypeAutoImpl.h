...
#ifndef _IFC4_IFCLIGHTFIXTURETYPE_AUTO_IMPL_H
#define _IFC4_IFCLIGHTFIXTURETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcLightFixtureType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcLightFixtureType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcLightFixtureType, IfcLightFixtureType> object.
*/
typedef OdSmartPtr<IfcLightFixtureType> IfcLightFixtureTypePtr;

} // namespace

#endif // _IFC4_IFCLIGHTFIXTURETYPE_AUTO_IMPL_H
