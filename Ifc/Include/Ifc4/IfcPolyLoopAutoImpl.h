...
#ifndef _IFC4_IFCPOLYLOOP_AUTO_IMPL_H
#define _IFC4_IFCPOLYLOOP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPolyLoop : public IfcLoop
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPolyLoop);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPolyLoop, IfcPolyLoop> object.
*/
typedef OdSmartPtr<IfcPolyLoop> IfcPolyLoopPtr;

} // namespace

#endif // _IFC4_IFCPOLYLOOP_AUTO_IMPL_H
