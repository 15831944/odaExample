...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcGeometricRepresentationSubContext, IfcGeometricRepresentationSubContext> object.
*/
typedef OdSmartPtr<IfcGeometricRepresentationSubContext> IfcGeometricRepresentationSubContextPtr;

} // namespace

#endif // _IFC4_IFCGEOMETRICREPRESENTATIONSUBCONTEXT_AUTO_IMPL_H
