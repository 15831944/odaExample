...
#ifndef _IFC4_IFCREPRESENTATIONCONTEXT_AUTO_IMPL_H
#define _IFC4_IFCREPRESENTATIONCONTEXT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRepresentationContext : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcRepresentationContext);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRepresentationContext, IfcRepresentationContext> object.
*/
typedef OdSmartPtr<IfcRepresentationContext> IfcRepresentationContextPtr;

} // namespace

#endif // _IFC4_IFCREPRESENTATIONCONTEXT_AUTO_IMPL_H
