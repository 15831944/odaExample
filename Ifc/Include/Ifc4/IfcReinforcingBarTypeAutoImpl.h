...
#ifndef _IFC4_IFCREINFORCINGBARTYPE_AUTO_IMPL_H
#define _IFC4_IFCREINFORCINGBARTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcReinforcingBarType : public IfcReinforcingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcReinforcingBarType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcReinforcingBarType, IfcReinforcingBarType> object.
*/
typedef OdSmartPtr<IfcReinforcingBarType> IfcReinforcingBarTypePtr;

} // namespace

#endif // _IFC4_IFCREINFORCINGBARTYPE_AUTO_IMPL_H
