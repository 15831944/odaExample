...
#ifndef _IFC4_IFCINDEXEDPOLYGONALFACE_AUTO_IMPL_H
#define _IFC4_IFCINDEXEDPOLYGONALFACE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcIndexedPolygonalFace : public IfcTessellatedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcIndexedPolygonalFace);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcIndexedPolygonalFace, IfcIndexedPolygonalFace> object.
*/
typedef OdSmartPtr<IfcIndexedPolygonalFace> IfcIndexedPolygonalFacePtr;

} // namespace

#endif // _IFC4_IFCINDEXEDPOLYGONALFACE_AUTO_IMPL_H
