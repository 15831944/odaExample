...
#ifndef _IFC4_IFCGRID_AUTO_IMPL_H
#define _IFC4_IFCGRID_AUTO_IMPL_H
...
class IFC4_EXPORT IfcGrid : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcGrid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcGrid, IfcGrid> object.
*/
typedef OdSmartPtr<IfcGrid> IfcGridPtr;

} // namespace

#endif // _IFC4_IFCGRID_AUTO_IMPL_H
