...
#ifndef _IFC4_IFCRECTANGLEPROFILEDEF_AUTO_IMPL_H
#define _IFC4_IFCRECTANGLEPROFILEDEF_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRectangleProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRectangleProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRectangleProfileDef, IfcRectangleProfileDef> object.
*/
typedef OdSmartPtr<IfcRectangleProfileDef> IfcRectangleProfileDefPtr;

} // namespace

#endif // _IFC4_IFCRECTANGLEPROFILEDEF_AUTO_IMPL_H
