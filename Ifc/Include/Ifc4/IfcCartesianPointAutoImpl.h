...
#ifndef _IFC4_IFCCARTESIANPOINT_AUTO_IMPL_H
#define _IFC4_IFCCARTESIANPOINT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCartesianPoint : public IfcPoint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCartesianPoint);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCartesianPoint, IfcCartesianPoint> object.
*/
typedef OdSmartPtr<IfcCartesianPoint> IfcCartesianPointPtr;

} // namespace

#endif // _IFC4_IFCCARTESIANPOINT_AUTO_IMPL_H
