...
#ifndef _IFC4_IFCPOLYGONALFACESET_AUTO_IMPL_H
#define _IFC4_IFCPOLYGONALFACESET_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPolygonalFaceSet : public IfcTessellatedFaceSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPolygonalFaceSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPolygonalFaceSet, IfcPolygonalFaceSet> object.
*/
typedef OdSmartPtr<IfcPolygonalFaceSet> IfcPolygonalFaceSetPtr;

} // namespace

#endif // _IFC4_IFCPOLYGONALFACESET_AUTO_IMPL_H
