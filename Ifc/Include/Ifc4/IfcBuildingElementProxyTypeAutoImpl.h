...
#ifndef _IFC4_IFCBUILDINGELEMENTPROXYTYPE_AUTO_IMPL_H
#define _IFC4_IFCBUILDINGELEMENTPROXYTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBuildingElementProxyType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBuildingElementProxyType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBuildingElementProxyType, IfcBuildingElementProxyType> object.
*/
typedef OdSmartPtr<IfcBuildingElementProxyType> IfcBuildingElementProxyTypePtr;

} // namespace

#endif // _IFC4_IFCBUILDINGELEMENTPROXYTYPE_AUTO_IMPL_H
