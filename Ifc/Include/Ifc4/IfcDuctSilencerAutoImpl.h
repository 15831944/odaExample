...
#ifndef _IFC4_IFCDUCTSILENCER_AUTO_IMPL_H
#define _IFC4_IFCDUCTSILENCER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDuctSilencer : public IfcFlowTreatmentDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDuctSilencer);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDuctSilencer, IfcDuctSilencer> object.
*/
typedef OdSmartPtr<IfcDuctSilencer> IfcDuctSilencerPtr;

} // namespace

#endif // _IFC4_IFCDUCTSILENCER_AUTO_IMPL_H
