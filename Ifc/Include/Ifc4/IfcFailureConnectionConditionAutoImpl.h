...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFailureConnectionCondition, IfcFailureConnectionCondition> object.
*/
typedef OdSmartPtr<IfcFailureConnectionCondition> IfcFailureConnectionConditionPtr;

} // namespace

#endif // _IFC4_IFCFAILURECONNECTIONCONDITION_AUTO_IMPL_H
