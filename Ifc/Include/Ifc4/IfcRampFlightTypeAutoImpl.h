...
#ifndef _IFC4_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
#define _IFC4_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRampFlightType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRampFlightType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRampFlightType, IfcRampFlightType> object.
*/
typedef OdSmartPtr<IfcRampFlightType> IfcRampFlightTypePtr;

} // namespace

#endif // _IFC4_IFCRAMPFLIGHTTYPE_AUTO_IMPL_H
