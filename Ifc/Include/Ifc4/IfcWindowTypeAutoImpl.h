...
#ifndef _IFC4_IFCWINDOWTYPE_AUTO_IMPL_H
#define _IFC4_IFCWINDOWTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcWindowType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcWindowType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcWindowType, IfcWindowType> object.
*/
typedef OdSmartPtr<IfcWindowType> IfcWindowTypePtr;

} // namespace

#endif // _IFC4_IFCWINDOWTYPE_AUTO_IMPL_H
