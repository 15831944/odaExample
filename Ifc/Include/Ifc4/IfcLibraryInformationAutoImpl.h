...
#ifndef _IFC4_IFCLIBRARYINFORMATION_AUTO_IMPL_H
#define _IFC4_IFCLIBRARYINFORMATION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcLibraryInformation : public IfcExternalInformation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcLibraryInformation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcLibraryInformation, IfcLibraryInformation> object.
*/
typedef OdSmartPtr<IfcLibraryInformation> IfcLibraryInformationPtr;

} // namespace

#endif // _IFC4_IFCLIBRARYINFORMATION_AUTO_IMPL_H
