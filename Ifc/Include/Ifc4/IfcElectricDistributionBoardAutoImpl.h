...
#ifndef _IFC4_IFCELECTRICDISTRIBUTIONBOARD_AUTO_IMPL_H
#define _IFC4_IFCELECTRICDISTRIBUTIONBOARD_AUTO_IMPL_H
...
class IFC4_EXPORT IfcElectricDistributionBoard : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcElectricDistributionBoard);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcElectricDistributionBoard, IfcElectricDistributionBoard> object.
*/
typedef OdSmartPtr<IfcElectricDistributionBoard> IfcElectricDistributionBoardPtr;

} // namespace

#endif // _IFC4_IFCELECTRICDISTRIBUTIONBOARD_AUTO_IMPL_H
