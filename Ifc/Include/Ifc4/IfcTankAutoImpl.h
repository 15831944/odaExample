...
#ifndef _IFC4_IFCTANK_AUTO_IMPL_H
#define _IFC4_IFCTANK_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTank : public IfcFlowStorageDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTank);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTank, IfcTank> object.
*/
typedef OdSmartPtr<IfcTank> IfcTankPtr;

} // namespace

#endif // _IFC4_IFCTANK_AUTO_IMPL_H
