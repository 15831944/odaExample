...
#ifndef _IFC4_IFCCURTAINWALLTYPE_AUTO_IMPL_H
#define _IFC4_IFCCURTAINWALLTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCurtainWallType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCurtainWallType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCurtainWallType, IfcCurtainWallType> object.
*/
typedef OdSmartPtr<IfcCurtainWallType> IfcCurtainWallTypePtr;

} // namespace

#endif // _IFC4_IFCCURTAINWALLTYPE_AUTO_IMPL_H
