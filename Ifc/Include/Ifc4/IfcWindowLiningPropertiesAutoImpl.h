...
#ifndef _IFC4_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
#define _IFC4_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
...
class IFC4_EXPORT IfcWindowLiningProperties : public IfcPreDefinedPropertySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcWindowLiningProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcWindowLiningProperties, IfcWindowLiningProperties> object.
*/
typedef OdSmartPtr<IfcWindowLiningProperties> IfcWindowLiningPropertiesPtr;

} // namespace

#endif // _IFC4_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
