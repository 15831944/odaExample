...
#ifndef _IFC4_IFCROOT_AUTO_IMPL_H
#define _IFC4_IFCROOT_AUTO_IMPL_H
...
/** \details
  ...
  \remarks
  The attribute <c>OwnerHistory</c> has been made OPTIONAL.
*/
class IFC4_EXPORT IfcRoot : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcRoot);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRoot, IfcRoot> object.
*/
typedef OdSmartPtr<IfcRoot> IfcRootPtr;

} // namespace

#endif // _IFC4_IFCROOT_AUTO_IMPL_H
