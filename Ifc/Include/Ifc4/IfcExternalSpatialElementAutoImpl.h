...
#ifndef _IFC4_IFCEXTERNALSPATIALELEMENT_AUTO_IMPL_H
#define _IFC4_IFCEXTERNALSPATIALELEMENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcExternalSpatialElement : public IfcExternalSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcExternalSpatialElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcExternalSpatialElement, IfcExternalSpatialElement> object.
*/
typedef OdSmartPtr<IfcExternalSpatialElement> IfcExternalSpatialElementPtr;

} // namespace

#endif // _IFC4_IFCEXTERNALSPATIALELEMENT_AUTO_IMPL_H
