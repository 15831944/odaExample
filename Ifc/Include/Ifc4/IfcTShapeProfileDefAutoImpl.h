...
#ifndef _IFC4_IFCTSHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC4_IFCTSHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTShapeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTShapeProfileDef, IfcTShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcTShapeProfileDef> IfcTShapeProfileDefPtr;

} // namespace

#endif // _IFC4_IFCTSHAPEPROFILEDEF_AUTO_IMPL_H
