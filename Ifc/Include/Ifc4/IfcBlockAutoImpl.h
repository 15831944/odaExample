...
#ifndef _IFC4_IFCBLOCK_AUTO_IMPL_H
#define _IFC4_IFCBLOCK_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBlock : public IfcCsgPrimitive3D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBlock);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBlock, IfcBlock> object.
*/
typedef OdSmartPtr<IfcBlock> IfcBlockPtr;

} // namespace

#endif // _IFC4_IFCBLOCK_AUTO_IMPL_H
