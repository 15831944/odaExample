...
#ifndef _IFC4_IFCFILTERTYPE_AUTO_IMPL_H
#define _IFC4_IFCFILTERTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFilterType : public IfcFlowTreatmentDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFilterType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFilterType, IfcFilterType> object.
*/
typedef OdSmartPtr<IfcFilterType> IfcFilterTypePtr;

} // namespace

#endif // _IFC4_IFCFILTERTYPE_AUTO_IMPL_H
