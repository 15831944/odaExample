...
#ifndef _IFC4_IFCHALFSPACESOLID_AUTO_IMPL_H
#define _IFC4_IFCHALFSPACESOLID_AUTO_IMPL_H
...
class IFC4_EXPORT IfcHalfSpaceSolid : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcHalfSpaceSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcHalfSpaceSolid, IfcHalfSpaceSolid> object.
*/
typedef OdSmartPtr<IfcHalfSpaceSolid> IfcHalfSpaceSolidPtr;

} // namespace

#endif // _IFC4_IFCHALFSPACESOLID_AUTO_IMPL_H
