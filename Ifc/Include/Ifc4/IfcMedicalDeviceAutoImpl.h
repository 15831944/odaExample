...
#ifndef _IFC4_IFCMEDICALDEVICE_AUTO_IMPL_H
#define _IFC4_IFCMEDICALDEVICE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMedicalDevice : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMedicalDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMedicalDevice, IfcMedicalDevice> object.
*/
typedef OdSmartPtr<IfcMedicalDevice> IfcMedicalDevicePtr;

} // namespace

#endif // _IFC4_IFCMEDICALDEVICE_AUTO_IMPL_H
