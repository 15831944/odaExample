...
#ifndef _IFC4_IFCPRESENTATIONLAYERASSIGNMENT_AUTO_IMPL_H
#define _IFC4_IFCPRESENTATIONLAYERASSIGNMENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPresentationLayerAssignment : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPresentationLayerAssignment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPresentationLayerAssignment, IfcPresentationLayerAssignment> object.
*/
typedef OdSmartPtr<IfcPresentationLayerAssignment> IfcPresentationLayerAssignmentPtr;

} // namespace

#endif // _IFC4_IFCPRESENTATIONLAYERASSIGNMENT_AUTO_IMPL_H
