...
#ifndef _IFC4_IFCARBITRARYPROFILEDEFWITHVOIDS_AUTO_IMPL_H
#define _IFC4_IFCARBITRARYPROFILEDEFWITHVOIDS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcArbitraryProfileDefWithVoids : public IfcArbitraryClosedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcArbitraryProfileDefWithVoids);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcArbitraryProfileDefWithVoids, IfcArbitraryProfileDefWithVoids> object.
*/
typedef OdSmartPtr<IfcArbitraryProfileDefWithVoids> IfcArbitraryProfileDefWithVoidsPtr;

} // namespace

#endif // _IFC4_IFCARBITRARYPROFILEDEFWITHVOIDS_AUTO_IMPL_H
