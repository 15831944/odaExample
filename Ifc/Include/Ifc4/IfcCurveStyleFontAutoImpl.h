...
#ifndef _IFC4_IFCCURVESTYLEFONT_AUTO_IMPL_H
#define _IFC4_IFCCURVESTYLEFONT_AUTO_IMPL_H
...
*/
class IFC4_EXPORT IfcCurveStyleFont : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCurveStyleFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCurveStyleFont, IfcCurveStyleFont> object.
*/
typedef OdSmartPtr<IfcCurveStyleFont> IfcCurveStyleFontPtr;

} // namespace

#endif // _IFC4_IFCCURVESTYLEFONT_AUTO_IMPL_H
