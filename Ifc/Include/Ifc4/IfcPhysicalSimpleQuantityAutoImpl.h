...
#ifndef _IFC4_IFCPHYSICALSIMPLEQUANTITY_AUTO_IMPL_H
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPhysicalSimpleQuantity, IfcPhysicalSimpleQuantity> object.
*/
typedef OdSmartPtr<IfcPhysicalSimpleQuantity> IfcPhysicalSimpleQuantityPtr;

} // namespace

#endif // _IFC4_IFCPHYSICALSIMPLEQUANTITY_AUTO_IMPL_H
