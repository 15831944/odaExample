...
#ifndef _IFC4_IFCSTRUCTURALPOINTCONNECTION_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALPOINTCONNECTION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralPointConnection : public IfcStructuralConnection
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStructuralPointConnection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralPointConnection, IfcStructuralPointConnection> object.
*/
typedef OdSmartPtr<IfcStructuralPointConnection> IfcStructuralPointConnectionPtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALPOINTCONNECTION_AUTO_IMPL_H
