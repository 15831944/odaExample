...
#ifndef _IFC4_IFCLABORRESOURCE_AUTO_IMPL_H
#define _IFC4_IFCLABORRESOURCE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcLaborResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcLaborResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcLaborResource, IfcLaborResource> object.
*/
typedef OdSmartPtr<IfcLaborResource> IfcLaborResourcePtr;

} // namespace

#endif // _IFC4_IFCLABORRESOURCE_AUTO_IMPL_H
