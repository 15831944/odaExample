...
#ifndef _IFC4_IFCCONSTRUCTIONMATERIALRESOURCE_AUTO_IMPL_H
#define _IFC4_IFCCONSTRUCTIONMATERIALRESOURCE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcConstructionMaterialResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcConstructionMaterialResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcConstructionMaterialResource, IfcConstructionMaterialResource> object.
*/
typedef OdSmartPtr<IfcConstructionMaterialResource> IfcConstructionMaterialResourcePtr;

} // namespace

#endif // _IFC4_IFCCONSTRUCTIONMATERIALRESOURCE_AUTO_IMPL_H
