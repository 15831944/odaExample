...
#ifndef _IFC4_IFCSURFACEREINFORCEMENTAREA_AUTO_IMPL_H
#define _IFC4_IFCSURFACEREINFORCEMENTAREA_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSurfaceReinforcementArea : public IfcStructuralLoadOrResult
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSurfaceReinforcementArea);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSurfaceReinforcementArea, IfcSurfaceReinforcementArea> object.
*/
typedef OdSmartPtr<IfcSurfaceReinforcementArea> IfcSurfaceReinforcementAreaPtr;

} // namespace

#endif // _IFC4_IFCSURFACEREINFORCEMENTAREA_AUTO_IMPL_H
