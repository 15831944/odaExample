...
#ifndef _IFC4_IFCACTIONREQUEST_AUTO_IMPL_H
#define _IFC4_IFCACTIONREQUEST_AUTO_IMPL_H
...
class IFC4_EXPORT IfcActionRequest : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcActionRequest);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcActionRequest, IfcActionRequest> object.
*/
typedef OdSmartPtr<IfcActionRequest> IfcActionRequestPtr;

} // namespace

#endif // _IFC4_IFCACTIONREQUEST_AUTO_IMPL_H
