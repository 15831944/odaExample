...
#ifndef _IFC4_IFCLSHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC4_IFCLSHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC4_EXPORT IfcLShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcLShapeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcLShapeProfileDef, IfcLShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcLShapeProfileDef> IfcLShapeProfileDefPtr;

} // namespace

#endif // _IFC4_IFCLSHAPEPROFILEDEF_AUTO_IMPL_H
