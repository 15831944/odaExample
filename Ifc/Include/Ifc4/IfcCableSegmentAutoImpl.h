...
#ifndef _IFC4_IFCCABLESEGMENT_AUTO_IMPL_H
#define _IFC4_IFCCABLESEGMENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCableSegment : public IfcFlowSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCableSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCableSegment, IfcCableSegment> object.
*/
typedef OdSmartPtr<IfcCableSegment> IfcCableSegmentPtr;

} // namespace

#endif // _IFC4_IFCCABLESEGMENT_AUTO_IMPL_H
