...
#ifndef _IFC4_IFCBUILDINGELEMENTPROXY_AUTO_IMPL_H
#define _IFC4_IFCBUILDINGELEMENTPROXY_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBuildingElementProxy : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBuildingElementProxy);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBuildingElementProxy, IfcBuildingElementProxy> object.
*/
typedef OdSmartPtr<IfcBuildingElementProxy> IfcBuildingElementProxyPtr;

} // namespace

#endif // _IFC4_IFCBUILDINGELEMENTPROXY_AUTO_IMPL_H
