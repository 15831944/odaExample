...
#ifndef _IFC4_IFCRELNESTS_AUTO_IMPL_H
#define _IFC4_IFCRELNESTS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelNests : public IfcRelDecomposes
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelNests);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelNests, IfcRelNests> object.
*/
typedef OdSmartPtr<IfcRelNests> IfcRelNestsPtr;

} // namespace

#endif // _IFC4_IFCRELNESTS_AUTO_IMPL_H
