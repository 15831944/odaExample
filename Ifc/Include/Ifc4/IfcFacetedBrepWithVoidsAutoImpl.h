...
#ifndef _IFC4_IFCFACETEDBREPWITHVOIDS_AUTO_IMPL_H
#define _IFC4_IFCFACETEDBREPWITHVOIDS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFacetedBrepWithVoids : public IfcFacetedBrep
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFacetedBrepWithVoids);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFacetedBrepWithVoids, IfcFacetedBrepWithVoids> object.
*/
typedef OdSmartPtr<IfcFacetedBrepWithVoids> IfcFacetedBrepWithVoidsPtr;

} // namespace

#endif // _IFC4_IFCFACETEDBREPWITHVOIDS_AUTO_IMPL_H
