...
#ifndef _IFC4_IFCINTERSECTIONCURVE_AUTO_IMPL_H
#define _IFC4_IFCINTERSECTIONCURVE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcIntersectionCurve : public IfcSurfaceCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcIntersectionCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcIntersectionCurve, IfcIntersectionCurve> object.
*/
typedef OdSmartPtr<IfcIntersectionCurve> IfcIntersectionCurvePtr;

} // namespace

#endif // _IFC4_IFCINTERSECTIONCURVE_AUTO_IMPL_H
