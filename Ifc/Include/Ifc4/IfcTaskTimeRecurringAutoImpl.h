...
#ifndef _IFC4_IFCTASKTIMERECURRING_AUTO_IMPL_H
#define _IFC4_IFCTASKTIMERECURRING_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTaskTimeRecurring : public IfcTaskTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTaskTimeRecurring);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTaskTimeRecurring, IfcTaskTimeRecurring> object.
*/
typedef OdSmartPtr<IfcTaskTimeRecurring> IfcTaskTimeRecurringPtr;

} // namespace

#endif // _IFC4_IFCTASKTIMERECURRING_AUTO_IMPL_H
