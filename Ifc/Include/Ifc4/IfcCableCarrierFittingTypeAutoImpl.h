...
#ifndef _IFC4_IFCCABLECARRIERFITTINGTYPE_AUTO_IMPL_H
#define _IFC4_IFCCABLECARRIERFITTINGTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCableCarrierFittingType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCableCarrierFittingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCableCarrierFittingType, IfcCableCarrierFittingType> object.
*/
typedef OdSmartPtr<IfcCableCarrierFittingType> IfcCableCarrierFittingTypePtr;

} // namespace

#endif // _IFC4_IFCCABLECARRIERFITTINGTYPE_AUTO_IMPL_H
