...
#ifndef _IFC4_IFCTASKTIME_AUTO_IMPL_H
#define _IFC4_IFCTASKTIME_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTaskTime : public IfcSchedulingTime
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTaskTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTaskTime, IfcTaskTime> object.
*/
typedef OdSmartPtr<IfcTaskTime> IfcTaskTimePtr;

} // namespace

#endif // _IFC4_IFCTASKTIME_AUTO_IMPL_H
