...
#ifndef _IFC4_IFCTRANSFORMER_AUTO_IMPL_H
#define _IFC4_IFCTRANSFORMER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTransformer : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTransformer);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTransformer, IfcTransformer> object.
*/
typedef OdSmartPtr<IfcTransformer> IfcTransformerPtr;

} // namespace

#endif // _IFC4_IFCTRANSFORMER_AUTO_IMPL_H
