...
#ifndef _IFC4_IFCSUBCONTRACTRESOURCETYPE_AUTO_IMPL_H
#define _IFC4_IFCSUBCONTRACTRESOURCETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSubContractResourceType : public IfcConstructionResourceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSubContractResourceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSubContractResourceType, IfcSubContractResourceType> object.
*/
typedef OdSmartPtr<IfcSubContractResourceType> IfcSubContractResourceTypePtr;

} // namespace

#endif // _IFC4_IFCSUBCONTRACTRESOURCETYPE_AUTO_IMPL_H
