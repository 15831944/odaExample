...
#ifndef _IFC4_IFCWINDOWPANELPROPERTIES_AUTO_IMPL_H
#define _IFC4_IFCWINDOWPANELPROPERTIES_AUTO_IMPL_H
...
class IFC4_EXPORT IfcWindowPanelProperties : public IfcPreDefinedPropertySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcWindowPanelProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcWindowPanelProperties, IfcWindowPanelProperties> object.
*/
typedef OdSmartPtr<IfcWindowPanelProperties> IfcWindowPanelPropertiesPtr;

} // namespace

#endif // _IFC4_IFCWINDOWPANELPROPERTIES_AUTO_IMPL_H
