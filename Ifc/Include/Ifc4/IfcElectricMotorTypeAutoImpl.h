...
#ifndef _IFC4_IFCELECTRICMOTORTYPE_AUTO_IMPL_H
#define _IFC4_IFCELECTRICMOTORTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcElectricMotorType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcElectricMotorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcElectricMotorType, IfcElectricMotorType> object.
*/
typedef OdSmartPtr<IfcElectricMotorType> IfcElectricMotorTypePtr;

} // namespace

#endif // _IFC4_IFCELECTRICMOTORTYPE_AUTO_IMPL_H
