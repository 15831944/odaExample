...
#ifndef _IFC4_IFCPROTECTIVEDEVICETRIPPINGUNIT_AUTO_IMPL_H
#define _IFC4_IFCPROTECTIVEDEVICETRIPPINGUNIT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcProtectiveDeviceTrippingUnit : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcProtectiveDeviceTrippingUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcProtectiveDeviceTrippingUnit, IfcProtectiveDeviceTrippingUnit> object.
*/
typedef OdSmartPtr<IfcProtectiveDeviceTrippingUnit> IfcProtectiveDeviceTrippingUnitPtr;

} // namespace

#endif // _IFC4_IFCPROTECTIVEDEVICETRIPPINGUNIT_AUTO_IMPL_H
