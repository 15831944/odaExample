...
#ifndef _IFC4_IFCREINFORCEMENTBARPROPERTIES_AUTO_IMPL_H
#define _IFC4_IFCREINFORCEMENTBARPROPERTIES_AUTO_IMPL_H
...
class IFC4_EXPORT IfcReinforcementBarProperties : public IfcPreDefinedProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcReinforcementBarProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcReinforcementBarProperties, IfcReinforcementBarProperties> object.
*/
typedef OdSmartPtr<IfcReinforcementBarProperties> IfcReinforcementBarPropertiesPtr;

} // namespace

#endif // _IFC4_IFCREINFORCEMENTBARPROPERTIES_AUTO_IMPL_H
