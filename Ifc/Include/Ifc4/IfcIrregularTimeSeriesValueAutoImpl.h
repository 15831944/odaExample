...
#ifndef _IFC4_IFCIRREGULARTIMESERIESVALUE_AUTO_IMPL_H
#define _IFC4_IFCIRREGULARTIMESERIESVALUE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcIrregularTimeSeriesValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcIrregularTimeSeriesValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcIrregularTimeSeriesValue, IfcIrregularTimeSeriesValue> object.
*/
typedef OdSmartPtr<IfcIrregularTimeSeriesValue> IfcIrregularTimeSeriesValuePtr;

} // namespace

#endif // _IFC4_IFCIRREGULARTIMESERIESVALUE_AUTO_IMPL_H
