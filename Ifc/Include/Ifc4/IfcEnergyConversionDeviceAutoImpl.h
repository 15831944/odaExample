...
#ifndef _IFC4_IFCENERGYCONVERSIONDEVICE_AUTO_IMPL_H
#define _IFC4_IFCENERGYCONVERSIONDEVICE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcEnergyConversionDevice : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcEnergyConversionDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcEnergyConversionDevice, IfcEnergyConversionDevice> object.
*/
typedef OdSmartPtr<IfcEnergyConversionDevice> IfcEnergyConversionDevicePtr;

} // namespace

#endif // _IFC4_IFCENERGYCONVERSIONDEVICE_AUTO_IMPL_H
