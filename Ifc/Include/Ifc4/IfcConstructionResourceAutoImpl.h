...
#ifndef _IFC4_IFCCONSTRUCTIONRESOURCE_AUTO_IMPL_H
#define _IFC4_IFCCONSTRUCTIONRESOURCE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcConstructionResource : public IfcResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcConstructionResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcConstructionResource, IfcConstructionResource> object.
*/
typedef OdSmartPtr<IfcConstructionResource> IfcConstructionResourcePtr;

} // namespace

#endif // _IFC4_IFCCONSTRUCTIONRESOURCE_AUTO_IMPL_H
