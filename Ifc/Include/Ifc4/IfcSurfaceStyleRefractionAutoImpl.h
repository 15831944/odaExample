...
#ifndef _IFC4_IFCSURFACESTYLEREFRACTION_AUTO_IMPL_H
#define _IFC4_IFCSURFACESTYLEREFRACTION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSurfaceStyleRefraction : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSurfaceStyleRefraction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSurfaceStyleRefraction, IfcSurfaceStyleRefraction> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleRefraction> IfcSurfaceStyleRefractionPtr;

} // namespace

#endif // _IFC4_IFCSURFACESTYLEREFRACTION_AUTO_IMPL_H
