...
#ifndef _IFC4_IFCSTRUCTURALPOINTACTION_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALPOINTACTION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralPointAction : public IfcStructuralAction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStructuralPointAction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralPointAction, IfcStructuralPointAction> object.
*/
typedef OdSmartPtr<IfcStructuralPointAction> IfcStructuralPointActionPtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALPOINTACTION_AUTO_IMPL_H
