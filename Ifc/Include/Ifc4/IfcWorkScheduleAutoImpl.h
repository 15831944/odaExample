...
#ifndef _IFC4_IFCWORKSCHEDULE_AUTO_IMPL_H
#define _IFC4_IFCWORKSCHEDULE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcWorkSchedule : public IfcWorkControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcWorkSchedule);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcWorkSchedule, IfcWorkSchedule> object.
*/
typedef OdSmartPtr<IfcWorkSchedule> IfcWorkSchedulePtr;

} // namespace

#endif // _IFC4_IFCWORKSCHEDULE_AUTO_IMPL_H
