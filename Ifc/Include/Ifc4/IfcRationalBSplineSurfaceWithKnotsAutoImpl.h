...
#ifndef _IFC4_IFCRATIONALBSPLINESURFACEWITHKNOTS_AUTO_IMPL_H
#define _IFC4_IFCRATIONALBSPLINESURFACEWITHKNOTS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRationalBSplineSurfaceWithKnots : public IfcBSplineSurfaceWithKnots
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRationalBSplineSurfaceWithKnots);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRationalBSplineSurfaceWithKnots, IfcRationalBSplineSurfaceWithKnots> object.
*/
typedef OdSmartPtr<IfcRationalBSplineSurfaceWithKnots> IfcRationalBSplineSurfaceWithKnotsPtr;

} // namespace

#endif // _IFC4_IFCRATIONALBSPLINESURFACEWITHKNOTS_AUTO_IMPL_H
