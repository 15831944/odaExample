...
#ifndef _IFC4_IFCTOPOLOGYREPRESENTATION_AUTO_IMPL_H
#define _IFC4_IFCTOPOLOGYREPRESENTATION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTopologyRepresentation : public IfcShapeModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTopologyRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTopologyRepresentation, IfcTopologyRepresentation> object.
*/
typedef OdSmartPtr<IfcTopologyRepresentation> IfcTopologyRepresentationPtr;

} // namespace

#endif // _IFC4_IFCTOPOLOGYREPRESENTATION_AUTO_IMPL_H
