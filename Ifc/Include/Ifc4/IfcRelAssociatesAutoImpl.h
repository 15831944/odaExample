...
#ifndef _IFC4_IFCRELASSOCIATES_AUTO_IMPL_H
#define _IFC4_IFCRELASSOCIATES_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelAssociates : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcRelAssociates);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelAssociates, IfcRelAssociates> object.
*/
typedef OdSmartPtr<IfcRelAssociates> IfcRelAssociatesPtr;

} // namespace

#endif // _IFC4_IFCRELASSOCIATES_AUTO_IMPL_H
