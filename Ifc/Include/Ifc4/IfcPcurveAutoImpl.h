...
#ifndef _IFC4_IFCPCURVE_AUTO_IMPL_H
#define _IFC4_IFCPCURVE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPcurve : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPcurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPcurve, IfcPcurve> object.
*/
typedef OdSmartPtr<IfcPcurve> IfcPcurvePtr;

} // namespace

#endif // _IFC4_IFCPCURVE_AUTO_IMPL_H
