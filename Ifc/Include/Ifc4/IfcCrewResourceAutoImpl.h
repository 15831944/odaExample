...
#ifndef _IFC4_IFCCREWRESOURCE_AUTO_IMPL_H
#define _IFC4_IFCCREWRESOURCE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCrewResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCrewResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCrewResource, IfcCrewResource> object.
*/
typedef OdSmartPtr<IfcCrewResource> IfcCrewResourcePtr;

} // namespace

#endif // _IFC4_IFCCREWRESOURCE_AUTO_IMPL_H
