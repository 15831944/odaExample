...
#ifndef _IFC4_IFCUSHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC4_IFCUSHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC4_EXPORT IfcUShapeProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcUShapeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcUShapeProfileDef, IfcUShapeProfileDef> object.
*/
typedef OdSmartPtr<IfcUShapeProfileDef> IfcUShapeProfileDefPtr;

} // namespace

#endif // _IFC4_IFCUSHAPEPROFILEDEF_AUTO_IMPL_H
