...
#ifndef _IFC4_IFCFOOTING_AUTO_IMPL_H
#define _IFC4_IFCFOOTING_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFooting : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFooting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFooting, IfcFooting> object.
*/
typedef OdSmartPtr<IfcFooting> IfcFootingPtr;

} // namespace

#endif // _IFC4_IFCFOOTING_AUTO_IMPL_H
