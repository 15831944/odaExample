...
#ifndef _IFC4_IFCMOTORCONNECTION_AUTO_IMPL_H
#define _IFC4_IFCMOTORCONNECTION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMotorConnection : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMotorConnection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMotorConnection, IfcMotorConnection> object.
*/
typedef OdSmartPtr<IfcMotorConnection> IfcMotorConnectionPtr;

} // namespace

#endif // _IFC4_IFCMOTORCONNECTION_AUTO_IMPL_H
