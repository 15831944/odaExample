...
#ifndef _IFC4_IFCFLOWTERMINAL_AUTO_IMPL_H
#define _IFC4_IFCFLOWTERMINAL_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFlowTerminal : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFlowTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFlowTerminal, IfcFlowTerminal> object.
*/
typedef OdSmartPtr<IfcFlowTerminal> IfcFlowTerminalPtr;

} // namespace

#endif // _IFC4_IFCFLOWTERMINAL_AUTO_IMPL_H
