...
#ifndef _IFC4_IFCFLOWTREATMENTDEVICE_AUTO_IMPL_H
#define _IFC4_IFCFLOWTREATMENTDEVICE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFlowTreatmentDevice : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFlowTreatmentDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFlowTreatmentDevice, IfcFlowTreatmentDevice> object.
*/
typedef OdSmartPtr<IfcFlowTreatmentDevice> IfcFlowTreatmentDevicePtr;

} // namespace

#endif // _IFC4_IFCFLOWTREATMENTDEVICE_AUTO_IMPL_H
