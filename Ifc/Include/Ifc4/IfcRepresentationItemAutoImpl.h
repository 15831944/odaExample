...
#ifndef _IFC4_IFCREPRESENTATIONITEM_AUTO_IMPL_H
#define _IFC4_IFCREPRESENTATIONITEM_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRepresentationItem : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcRepresentationItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRepresentationItem, IfcRepresentationItem> object.
*/
typedef OdSmartPtr<IfcRepresentationItem> IfcRepresentationItemPtr;

} // namespace

#endif // _IFC4_IFCREPRESENTATIONITEM_AUTO_IMPL_H
