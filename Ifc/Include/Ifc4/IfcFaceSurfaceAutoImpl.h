...
#ifndef _IFC4_IFCFACESURFACE_AUTO_IMPL_H
#define _IFC4_IFCFACESURFACE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFaceSurface : public IfcFace
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFaceSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFaceSurface, IfcFaceSurface> object.
*/
typedef OdSmartPtr<IfcFaceSurface> IfcFaceSurfacePtr;

} // namespace

#endif // _IFC4_IFCFACESURFACE_AUTO_IMPL_H
