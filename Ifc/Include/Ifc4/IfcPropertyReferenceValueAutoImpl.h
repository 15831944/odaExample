...
#ifndef _IFC4_IFCPROPERTYREFERENCEVALUE_AUTO_IMPL_H
#define _IFC4_IFCPROPERTYREFERENCEVALUE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPropertyReferenceValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPropertyReferenceValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPropertyReferenceValue, IfcPropertyReferenceValue> object.
*/
typedef OdSmartPtr<IfcPropertyReferenceValue> IfcPropertyReferenceValuePtr;

} // namespace

#endif // _IFC4_IFCPROPERTYREFERENCEVALUE_AUTO_IMPL_H
