...
#ifndef _IFC4_IFCFLOWSTORAGEDEVICETYPE_AUTO_IMPL_H
#define _IFC4_IFCFLOWSTORAGEDEVICETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFlowStorageDeviceType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcFlowStorageDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFlowStorageDeviceType, IfcFlowStorageDeviceType> object.
*/
typedef OdSmartPtr<IfcFlowStorageDeviceType> IfcFlowStorageDeviceTypePtr;

} // namespace

#endif // _IFC4_IFCFLOWSTORAGEDEVICETYPE_AUTO_IMPL_H
