...
#ifndef _IFC4_IFCMATERIALPROFILESETUSAGETAPERING_AUTO_IMPL_H
#define _IFC4_IFCMATERIALPROFILESETUSAGETAPERING_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMaterialProfileSetUsageTapering : public IfcMaterialProfileSetUsage
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMaterialProfileSetUsageTapering);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMaterialProfileSetUsageTapering, IfcMaterialProfileSetUsageTapering> object.
*/
typedef OdSmartPtr<IfcMaterialProfileSetUsageTapering> IfcMaterialProfileSetUsageTaperingPtr;

} // namespace

#endif // _IFC4_IFCMATERIALPROFILESETUSAGETAPERING_AUTO_IMPL_H
