...
#ifndef _IFC4_IFCCABLEFITTING_AUTO_IMPL_H
#define _IFC4_IFCCABLEFITTING_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCableFitting : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCableFitting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCableFitting, IfcCableFitting> object.
*/
typedef OdSmartPtr<IfcCableFitting> IfcCableFittingPtr;

} // namespace

#endif // _IFC4_IFCCABLEFITTING_AUTO_IMPL_H
