...
#ifndef _IFC4_IFCSUBEDGE_AUTO_IMPL_H
#define _IFC4_IFCSUBEDGE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSubedge : public IfcEdge
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSubedge);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSubedge, IfcSubedge> object.
*/
typedef OdSmartPtr<IfcSubedge> IfcSubedgePtr;

} // namespace

#endif // _IFC4_IFCSUBEDGE_AUTO_IMPL_H
