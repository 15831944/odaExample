...
#ifndef _IFC4_IFCDISTRIBUTIONELEMENT_AUTO_IMPL_H
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDistributionElement, IfcDistributionElement> object.
*/
typedef OdSmartPtr<IfcDistributionElement> IfcDistributionElementPtr;

} // namespace

#endif // _IFC4_IFCDISTRIBUTIONELEMENT_AUTO_IMPL_H
