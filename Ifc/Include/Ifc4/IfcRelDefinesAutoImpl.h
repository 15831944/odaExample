...
#ifndef _IFC4_IFCRELDEFINES_AUTO_IMPL_H
#define _IFC4_IFCRELDEFINES_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelDefines : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcRelDefines);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelDefines, IfcRelDefines> object.
*/
typedef OdSmartPtr<IfcRelDefines> IfcRelDefinesPtr;

} // namespace

#endif // _IFC4_IFCRELDEFINES_AUTO_IMPL_H
