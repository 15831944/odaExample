...
#ifndef _IFC4_IFCTENDONANCHORTYPE_AUTO_IMPL_H
#define _IFC4_IFCTENDONANCHORTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTendonAnchorType : public IfcReinforcingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTendonAnchorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTendonAnchorType, IfcTendonAnchorType> object.
*/
typedef OdSmartPtr<IfcTendonAnchorType> IfcTendonAnchorTypePtr;

} // namespace

#endif // _IFC4_IFCTENDONANCHORTYPE_AUTO_IMPL_H
