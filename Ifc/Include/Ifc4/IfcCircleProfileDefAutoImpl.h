...
#ifndef _IFC4_IFCCIRCLEPROFILEDEF_AUTO_IMPL_H
#define _IFC4_IFCCIRCLEPROFILEDEF_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCircleProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCircleProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCircleProfileDef, IfcCircleProfileDef> object.
*/
typedef OdSmartPtr<IfcCircleProfileDef> IfcCircleProfileDefPtr;

} // namespace

#endif // _IFC4_IFCCIRCLEPROFILEDEF_AUTO_IMPL_H
