...
#ifndef _IFC4_IFCRIGHTCIRCULARCYLINDER_AUTO_IMPL_H
#define _IFC4_IFCRIGHTCIRCULARCYLINDER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRightCircularCylinder : public IfcCsgPrimitive3D
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRightCircularCylinder);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRightCircularCylinder, IfcRightCircularCylinder> object.
*/
typedef OdSmartPtr<IfcRightCircularCylinder> IfcRightCircularCylinderPtr;

} // namespace

#endif // _IFC4_IFCRIGHTCIRCULARCYLINDER_AUTO_IMPL_H
