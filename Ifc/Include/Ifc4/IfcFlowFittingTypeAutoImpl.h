...
#ifndef _IFC4_IFCFLOWFITTINGTYPE_AUTO_IMPL_H
#define _IFC4_IFCFLOWFITTINGTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFlowFittingType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcFlowFittingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFlowFittingType, IfcFlowFittingType> object.
*/
typedef OdSmartPtr<IfcFlowFittingType> IfcFlowFittingTypePtr;

} // namespace

#endif // _IFC4_IFCFLOWFITTINGTYPE_AUTO_IMPL_H
