...
#ifndef _IFC4_IFCADVANCEDBREP_AUTO_IMPL_H
#define _IFC4_IFCADVANCEDBREP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcAdvancedBrep : public IfcManifoldSolidBrep
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcAdvancedBrep);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcAdvancedBrep, IfcAdvancedBrep> object.
*/
typedef OdSmartPtr<IfcAdvancedBrep> IfcAdvancedBrepPtr;

} // namespace

#endif // _IFC4_IFCADVANCEDBREP_AUTO_IMPL_H
