...
#ifndef _IFC4_IFCCONSTRUCTIONEQUIPMENTRESOURCE_AUTO_IMPL_H
#define _IFC4_IFCCONSTRUCTIONEQUIPMENTRESOURCE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcConstructionEquipmentResource : public IfcConstructionResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcConstructionEquipmentResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcConstructionEquipmentResource, IfcConstructionEquipmentResource> object.
*/
typedef OdSmartPtr<IfcConstructionEquipmentResource> IfcConstructionEquipmentResourcePtr;

} // namespace

#endif // _IFC4_IFCCONSTRUCTIONEQUIPMENTRESOURCE_AUTO_IMPL_H
