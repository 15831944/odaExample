...
#ifndef _IFC4_IFCOPENINGELEMENT_AUTO_IMPL_H
#define _IFC4_IFCOPENINGELEMENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcOpeningElement : public IfcFeatureElementSubtraction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcOpeningElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcOpeningElement, IfcOpeningElement> object.
*/
typedef OdSmartPtr<IfcOpeningElement> IfcOpeningElementPtr;

} // namespace

#endif // _IFC4_IFCOPENINGELEMENT_AUTO_IMPL_H
