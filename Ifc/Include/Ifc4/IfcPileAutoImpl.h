...
#ifndef _IFC4_IFCPILE_AUTO_IMPL_H
#define _IFC4_IFCPILE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPile : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPile);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPile, IfcPile> object.
*/
typedef OdSmartPtr<IfcPile> IfcPilePtr;

} // namespace

#endif // _IFC4_IFCPILE_AUTO_IMPL_H
