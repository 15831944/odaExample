...
#ifndef _IFC4_IFCSWITCHINGDEVICE_AUTO_IMPL_H
#define _IFC4_IFCSWITCHINGDEVICE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSwitchingDevice : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSwitchingDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSwitchingDevice, IfcSwitchingDevice> object.
*/
typedef OdSmartPtr<IfcSwitchingDevice> IfcSwitchingDevicePtr;

} // namespace

#endif // _IFC4_IFCSWITCHINGDEVICE_AUTO_IMPL_H
