...
#ifndef _IFC4_IFCRELATIONSHIP_AUTO_IMPL_H
#define _IFC4_IFCRELATIONSHIP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelationship : public IfcRoot
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelationship, IfcRelationship> object.
*/
typedef OdSmartPtr<IfcRelationship> IfcRelationshipPtr;

} // namespace

#endif // _IFC4_IFCRELATIONSHIP_AUTO_IMPL_H
