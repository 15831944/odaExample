...
#ifndef _IFC4_IFCMATERIALPROFILEWITHOFFSETS_AUTO_IMPL_H
#define _IFC4_IFCMATERIALPROFILEWITHOFFSETS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMaterialProfileWithOffsets : public IfcMaterialProfile
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMaterialProfileWithOffsets);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMaterialProfileWithOffsets, IfcMaterialProfileWithOffsets> object.
*/
typedef OdSmartPtr<IfcMaterialProfileWithOffsets> IfcMaterialProfileWithOffsetsPtr;

} // namespace

#endif // _IFC4_IFCMATERIALPROFILEWITHOFFSETS_AUTO_IMPL_H
