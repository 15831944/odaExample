...
#ifndef _IFC4_IFCSTRUCTURALCURVEREACTION_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALCURVEREACTION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralCurveReaction : public IfcStructuralReaction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStructuralCurveReaction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralCurveReaction, IfcStructuralCurveReaction> object.
*/
typedef OdSmartPtr<IfcStructuralCurveReaction> IfcStructuralCurveReactionPtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALCURVEREACTION_AUTO_IMPL_H
