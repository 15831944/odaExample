...
#ifndef _IFC4_IFCANNOTATIONFILLAREA_AUTO_IMPL_H
#define _IFC4_IFCANNOTATIONFILLAREA_AUTO_IMPL_H
...
class IFC4_EXPORT IfcAnnotationFillArea : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcAnnotationFillArea);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcAnnotationFillArea, IfcAnnotationFillArea> object.
*/
typedef OdSmartPtr<IfcAnnotationFillArea> IfcAnnotationFillAreaPtr;

} // namespace

#endif // _IFC4_IFCANNOTATIONFILLAREA_AUTO_IMPL_H
