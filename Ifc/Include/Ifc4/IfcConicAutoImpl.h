...
#ifndef _IFC4_IFCCONIC_AUTO_IMPL_H
#define _IFC4_IFCCONIC_AUTO_IMPL_H
...
class IFC4_EXPORT IfcConic : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcConic);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcConic, IfcConic> object.
*/
typedef OdSmartPtr<IfcConic> IfcConicPtr;

} // namespace

#endif // _IFC4_IFCCONIC_AUTO_IMPL_H
