...
#ifndef _IFC4_IFCPROPERTYSET_AUTO_IMPL_H
#define _IFC4_IFCPROPERTYSET_AUTO_IMPL_H
...
/** \details
  The IfcPropertySet contains properties within a property tree. 
  ...
  The specification supposes usage of the naming convention "Pset_Xxx".
  Such naming convention is applied to the property sets that are defined 
  as part of this specification and be used as the value of the Name attribute.
  ...
  * External reference: subtypes of IfcRelAssociates are used to provide a link to a classification system, 
  or external library providing further reference to the property set. Accessible by inverse attribute HasAssociations.

  \remarks
  All statically defined property set entities are no longer subtypes of IfcPropertySet starting from Ifc4.
*/
class IFC4_EXPORT IfcPropertySet : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPropertySet);
  //DOM-IGNORE-END
...
public:
  ...
  /** \details
  Retrieves the contained set of properties.
  \param HasProperties [out] Receives an array of Data Access Interface (DAI) identifiers that represent properties in the property set.
  */
  void getHasProperties(OdDAIObjectIds& HasProperties) const;

  /** \details
  Retrieves the contained set of properties.
  \returns
  An array of Data Access Interface (DAI) identifiers that represent properties in the property set.
  */
  OdDAI::OdDAIObjectIdSet& hasProperties();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_HasProperties; // SET [1:?] of IfcProperty
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPropertySet, IfcPropertySet> object.
*/
typedef OdSmartPtr<IfcPropertySet> IfcPropertySetPtr;

} // namespace

#endif // _IFC4_IFCPROPERTYSET_AUTO_IMPL_H
