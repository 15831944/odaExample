...
#ifndef _IFC4_IFCFACETEDBREP_AUTO_IMPL_H
#define _IFC4_IFCFACETEDBREP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFacetedBrep : public IfcManifoldSolidBrep
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFacetedBrep);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFacetedBrep, IfcFacetedBrep> object.
*/
typedef OdSmartPtr<IfcFacetedBrep> IfcFacetedBrepPtr;

} // namespace

#endif // _IFC4_IFCFACETEDBREP_AUTO_IMPL_H
