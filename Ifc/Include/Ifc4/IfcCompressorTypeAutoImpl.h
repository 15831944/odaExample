...
#ifndef _IFC4_IFCCOMPRESSORTYPE_AUTO_IMPL_H
#define _IFC4_IFCCOMPRESSORTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCompressorType : public IfcFlowMovingDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCompressorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCompressorType, IfcCompressorType> object.
*/
typedef OdSmartPtr<IfcCompressorType> IfcCompressorTypePtr;

} // namespace

#endif // _IFC4_IFCCOMPRESSORTYPE_AUTO_IMPL_H
