...
#ifndef _IFC4_IFCPREDEFINEDPROPERTYSET_AUTO_IMPL_H
#define _IFC4_IFCPREDEFINEDPROPERTYSET_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPreDefinedPropertySet : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcPreDefinedPropertySet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPreDefinedPropertySet, IfcPreDefinedPropertySet> object.
*/
typedef OdSmartPtr<IfcPreDefinedPropertySet> IfcPreDefinedPropertySetPtr;

} // namespace

#endif // _IFC4_IFCPREDEFINEDPROPERTYSET_AUTO_IMPL_H
