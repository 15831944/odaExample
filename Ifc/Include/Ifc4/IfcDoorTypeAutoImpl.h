...
#ifndef _IFC4_IFCDOORTYPE_AUTO_IMPL_H
#define _IFC4_IFCDOORTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDoorType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDoorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDoorType, IfcDoorType> object.
*/
typedef OdSmartPtr<IfcDoorType> IfcDoorTypePtr;

} // namespace

#endif // _IFC4_IFCDOORTYPE_AUTO_IMPL_H
