...
#ifndef _IFC4_IFCGEOMETRICCURVESET_AUTO_IMPL_H
#define _IFC4_IFCGEOMETRICCURVESET_AUTO_IMPL_H
...
class IFC4_EXPORT IfcGeometricCurveSet : public IfcGeometricSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcGeometricCurveSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcGeometricCurveSet, IfcGeometricCurveSet> object.
*/
typedef OdSmartPtr<IfcGeometricCurveSet> IfcGeometricCurveSetPtr;

} // namespace

#endif // _IFC4_IFCGEOMETRICCURVESET_AUTO_IMPL_H
