...
#ifndef _IFC4_IFCADVANCEDBREPWITHVOIDS_AUTO_IMPL_H
#define _IFC4_IFCADVANCEDBREPWITHVOIDS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcAdvancedBrepWithVoids : public IfcAdvancedBrep
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcAdvancedBrepWithVoids);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcAdvancedBrepWithVoids, IfcAdvancedBrepWithVoids> object.
*/
typedef OdSmartPtr<IfcAdvancedBrepWithVoids> IfcAdvancedBrepWithVoidsPtr;

} // namespace

#endif // _IFC4_IFCADVANCEDBREPWITHVOIDS_AUTO_IMPL_H
