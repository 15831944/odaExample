...
#ifndef _IFC4_IFCINDEXEDTRIANGLETEXTUREMAP_AUTO_IMPL_H
#define _IFC4_IFCINDEXEDTRIANGLETEXTUREMAP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcIndexedTriangleTextureMap : public IfcIndexedTextureMap
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcIndexedTriangleTextureMap);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcIndexedTriangleTextureMap, IfcIndexedTriangleTextureMap> object.
*/
typedef OdSmartPtr<IfcIndexedTriangleTextureMap> IfcIndexedTriangleTextureMapPtr;

} // namespace

#endif // _IFC4_IFCINDEXEDTRIANGLETEXTUREMAP_AUTO_IMPL_H
