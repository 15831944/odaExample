...
#ifndef _IFC4_IFCSTRUCTURALLOADPLANARFORCE_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALLOADPLANARFORCE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralLoadPlanarForce : public IfcStructuralLoadStatic
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStructuralLoadPlanarForce);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralLoadPlanarForce, IfcStructuralLoadPlanarForce> object.
*/
typedef OdSmartPtr<IfcStructuralLoadPlanarForce> IfcStructuralLoadPlanarForcePtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALLOADPLANARFORCE_AUTO_IMPL_H
