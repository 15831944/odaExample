...
#ifndef _IFC4_IFCPREDEFINEDCOLOUR_AUTO_IMPL_H
#define _IFC4_IFCPREDEFINEDCOLOUR_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPreDefinedColour : public IfcPreDefinedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcPreDefinedColour);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPreDefinedColour, IfcPreDefinedColour> object.
*/
typedef OdSmartPtr<IfcPreDefinedColour> IfcPreDefinedColourPtr;

} // namespace

#endif // _IFC4_IFCPREDEFINEDCOLOUR_AUTO_IMPL_H
