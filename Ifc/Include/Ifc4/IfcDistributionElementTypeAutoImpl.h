...
#ifndef _IFC4_IFCDISTRIBUTIONELEMENTTYPE_AUTO_IMPL_H
#define _IFC4_IFCDISTRIBUTIONELEMENTTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDistributionElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDistributionElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDistributionElementType, IfcDistributionElementType> object.
*/
typedef OdSmartPtr<IfcDistributionElementType> IfcDistributionElementTypePtr;

} // namespace

#endif // _IFC4_IFCDISTRIBUTIONELEMENTTYPE_AUTO_IMPL_H
