...
#ifndef _IFC4_IFCBSPLINESURFACEWITHKNOTS_AUTO_IMPL_H
#define _IFC4_IFCBSPLINESURFACEWITHKNOTS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBSplineSurfaceWithKnots : public IfcBSplineSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBSplineSurfaceWithKnots);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBSplineSurfaceWithKnots, IfcBSplineSurfaceWithKnots> object.
*/
typedef OdSmartPtr<IfcBSplineSurfaceWithKnots> IfcBSplineSurfaceWithKnotsPtr;

} // namespace

#endif // _IFC4_IFCBSPLINESURFACEWITHKNOTS_AUTO_IMPL_H
