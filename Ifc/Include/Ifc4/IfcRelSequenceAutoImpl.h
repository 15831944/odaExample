...
#ifndef _IFC4_IFCRELSEQUENCE_AUTO_IMPL_H
#define _IFC4_IFCRELSEQUENCE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelSequence : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelSequence);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelSequence, IfcRelSequence> object.
*/
typedef OdSmartPtr<IfcRelSequence> IfcRelSequencePtr;

} // namespace

#endif // _IFC4_IFCRELSEQUENCE_AUTO_IMPL_H
