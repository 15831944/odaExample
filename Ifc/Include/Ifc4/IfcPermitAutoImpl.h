...
#ifndef _IFC4_IFCPERMIT_AUTO_IMPL_H
#define _IFC4_IFCPERMIT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPermit : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPermit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPermit, IfcPermit> object.
*/
typedef OdSmartPtr<IfcPermit> IfcPermitPtr;

} // namespace

#endif // _IFC4_IFCPERMIT_AUTO_IMPL_H
