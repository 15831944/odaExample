...
#ifndef _IFC4_IFCCONNECTIONPOINTGEOMETRY_AUTO_IMPL_H
#define _IFC4_IFCCONNECTIONPOINTGEOMETRY_AUTO_IMPL_H
...
class IFC4_EXPORT IfcConnectionPointGeometry : public IfcConnectionGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcConnectionPointGeometry);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcConnectionPointGeometry, IfcConnectionPointGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionPointGeometry> IfcConnectionPointGeometryPtr;

} // namespace

#endif // _IFC4_IFCCONNECTIONPOINTGEOMETRY_AUTO_IMPL_H
