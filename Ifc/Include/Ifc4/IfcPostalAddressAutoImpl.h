...
#ifndef _IFC4_IFCPOSTALADDRESS_AUTO_IMPL_H
#define _IFC4_IFCPOSTALADDRESS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPostalAddress : public IfcAddress
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPostalAddress);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPostalAddress, IfcPostalAddress> object.
*/
typedef OdSmartPtr<IfcPostalAddress> IfcPostalAddressPtr;

} // namespace

#endif // _IFC4_IFCPOSTALADDRESS_AUTO_IMPL_H
