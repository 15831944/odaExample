...
#ifndef _IFC4_IFCSTAIRTYPE_AUTO_IMPL_H
#define _IFC4_IFCSTAIRTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStairType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStairType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStairType, IfcStairType> object.
*/
typedef OdSmartPtr<IfcStairType> IfcStairTypePtr;

} // namespace

#endif // _IFC4_IFCSTAIRTYPE_AUTO_IMPL_H
