...
#ifndef _IFC4_IFCCONDENSER_AUTO_IMPL_H
#define _IFC4_IFCCONDENSER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCondenser : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCondenser);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCondenser, IfcCondenser> object.
*/
typedef OdSmartPtr<IfcCondenser> IfcCondenserPtr;

} // namespace

#endif // _IFC4_IFCCONDENSER_AUTO_IMPL_H
