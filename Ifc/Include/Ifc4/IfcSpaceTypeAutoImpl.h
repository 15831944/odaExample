...
#ifndef _IFC4_IFCSPACETYPE_AUTO_IMPL_H
#define _IFC4_IFCSPACETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSpaceType : public IfcSpatialStructureElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSpaceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSpaceType, IfcSpaceType> object.
*/
typedef OdSmartPtr<IfcSpaceType> IfcSpaceTypePtr;

} // namespace

#endif // _IFC4_IFCSPACETYPE_AUTO_IMPL_H
