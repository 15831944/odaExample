...
#ifndef _IFC4_IFCRELSPACEBOUNDARY2NDLEVEL_AUTO_IMPL_H
#define _IFC4_IFCRELSPACEBOUNDARY2NDLEVEL_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelSpaceBoundary2ndLevel : public IfcRelSpaceBoundary1stLevel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelSpaceBoundary2ndLevel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelSpaceBoundary2ndLevel, IfcRelSpaceBoundary2ndLevel> object.
*/
typedef OdSmartPtr<IfcRelSpaceBoundary2ndLevel> IfcRelSpaceBoundary2ndLevelPtr;

} // namespace

#endif // _IFC4_IFCRELSPACEBOUNDARY2NDLEVEL_AUTO_IMPL_H
