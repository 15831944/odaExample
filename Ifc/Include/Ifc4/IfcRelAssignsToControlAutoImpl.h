...
#ifndef _IFC4_IFCRELASSIGNSTOCONTROL_AUTO_IMPL_H
#define _IFC4_IFCRELASSIGNSTOCONTROL_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelAssignsToControl : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelAssignsToControl);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelAssignsToControl, IfcRelAssignsToControl> object.
*/
typedef OdSmartPtr<IfcRelAssignsToControl> IfcRelAssignsToControlPtr;

} // namespace

#endif // _IFC4_IFCRELASSIGNSTOCONTROL_AUTO_IMPL_H
