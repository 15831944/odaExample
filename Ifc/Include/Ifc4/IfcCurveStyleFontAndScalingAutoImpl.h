...
#ifndef _IFC4_IFCCURVESTYLEFONTANDSCALING_AUTO_IMPL_H
#define _IFC4_IFCCURVESTYLEFONTANDSCALING_AUTO_IMPL_H
...
*/
class IFC4_EXPORT IfcCurveStyleFontAndScaling : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCurveStyleFontAndScaling);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCurveStyleFontAndScaling, IfcCurveStyleFontAndScaling> object.
*/
typedef OdSmartPtr<IfcCurveStyleFontAndScaling> IfcCurveStyleFontAndScalingPtr;

} // namespace

#endif // _IFC4_IFCCURVESTYLEFONTANDSCALING_AUTO_IMPL_H
