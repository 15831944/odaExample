...
#ifndef _IFC4_IFCASSET_AUTO_IMPL_H
#define _IFC4_IFCASSET_AUTO_IMPL_H
...
class IFC4_EXPORT IfcAsset : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcAsset);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcAsset, IfcAsset> object.
*/
typedef OdSmartPtr<IfcAsset> IfcAssetPtr;

} // namespace

#endif // _IFC4_IFCASSET_AUTO_IMPL_H
