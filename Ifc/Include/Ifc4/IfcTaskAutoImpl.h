...
#ifndef _IFC4_IFCTASK_AUTO_IMPL_H
#define _IFC4_IFCTASK_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTask : public IfcProcess
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTask);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTask, IfcTask> object.
*/
typedef OdSmartPtr<IfcTask> IfcTaskPtr;

} // namespace

#endif // _IFC4_IFCTASK_AUTO_IMPL_H
