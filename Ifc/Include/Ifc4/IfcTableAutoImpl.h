...
#ifndef _IFC4_IFCTABLE_AUTO_IMPL_H
#define _IFC4_IFCTABLE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTable : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTable);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTable, IfcTable> object.
*/
typedef OdSmartPtr<IfcTable> IfcTablePtr;

} // namespace

#endif // _IFC4_IFCTABLE_AUTO_IMPL_H
