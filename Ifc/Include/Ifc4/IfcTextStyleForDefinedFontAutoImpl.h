...
#ifndef _IFC4_IFCTEXTSTYLEFORDEFINEDFONT_AUTO_IMPL_H
#define _IFC4_IFCTEXTSTYLEFORDEFINEDFONT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTextStyleForDefinedFont : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTextStyleForDefinedFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTextStyleForDefinedFont, IfcTextStyleForDefinedFont> object.
*/
typedef OdSmartPtr<IfcTextStyleForDefinedFont> IfcTextStyleForDefinedFontPtr;

} // namespace

#endif // _IFC4_IFCTEXTSTYLEFORDEFINEDFONT_AUTO_IMPL_H
