...
#ifndef _IFC4_IFCGRIDPLACEMENT_AUTO_IMPL_H
#define _IFC4_IFCGRIDPLACEMENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcGridPlacement : public IfcObjectPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcGridPlacement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcGridPlacement, IfcGridPlacement> object.
*/
typedef OdSmartPtr<IfcGridPlacement> IfcGridPlacementPtr;

} // namespace

#endif // _IFC4_IFCGRIDPLACEMENT_AUTO_IMPL_H
