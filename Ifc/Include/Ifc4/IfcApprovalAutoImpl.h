...
#ifndef _IFC4_IFCAPPROVAL_AUTO_IMPL_H
#define _IFC4_IFCAPPROVAL_AUTO_IMPL_H
...
class IFC4_EXPORT IfcApproval : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcApproval);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcApproval, IfcApproval> object.
*/
typedef OdSmartPtr<IfcApproval> IfcApprovalPtr;

} // namespace

#endif // _IFC4_IFCAPPROVAL_AUTO_IMPL_H
