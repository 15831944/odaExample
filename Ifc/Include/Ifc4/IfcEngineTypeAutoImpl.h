...
#ifndef _IFC4_IFCENGINETYPE_AUTO_IMPL_H
#define _IFC4_IFCENGINETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcEngineType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcEngineType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcEngineType, IfcEngineType> object.
*/
typedef OdSmartPtr<IfcEngineType> IfcEngineTypePtr;

} // namespace

#endif // _IFC4_IFCENGINETYPE_AUTO_IMPL_H
