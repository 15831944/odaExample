...
#ifndef _IFC4_IFCSHAPEASPECT_AUTO_IMPL_H
#define _IFC4_IFCSHAPEASPECT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcShapeAspect : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcShapeAspect);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcShapeAspect, IfcShapeAspect> object.
*/
typedef OdSmartPtr<IfcShapeAspect> IfcShapeAspectPtr;

} // namespace

#endif // _IFC4_IFCSHAPEASPECT_AUTO_IMPL_H
