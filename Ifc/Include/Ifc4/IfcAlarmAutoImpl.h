...
#ifndef _IFC4_IFCALARM_AUTO_IMPL_H
#define _IFC4_IFCALARM_AUTO_IMPL_H
...
class IFC4_EXPORT IfcAlarm : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcAlarm);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcAlarm, IfcAlarm> object.
*/
typedef OdSmartPtr<IfcAlarm> IfcAlarmPtr;

} // namespace

#endif // _IFC4_IFCALARM_AUTO_IMPL_H
