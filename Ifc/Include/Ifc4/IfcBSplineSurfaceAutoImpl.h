...
#ifndef _IFC4_IFCBSPLINESURFACE_AUTO_IMPL_H
#define _IFC4_IFCBSPLINESURFACE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBSplineSurface : public IfcBoundedSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcBSplineSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBSplineSurface, IfcBSplineSurface> object.
*/
typedef OdSmartPtr<IfcBSplineSurface> IfcBSplineSurfacePtr;

} // namespace

#endif // _IFC4_IFCBSPLINESURFACE_AUTO_IMPL_H
