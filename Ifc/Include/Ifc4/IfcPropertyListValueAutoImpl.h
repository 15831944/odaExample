...
#ifndef _IFC4_IFCPROPERTYLISTVALUE_AUTO_IMPL_H
#define _IFC4_IFCPROPERTYLISTVALUE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPropertyListValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPropertyListValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPropertyListValue, IfcPropertyListValue> object.
*/
typedef OdSmartPtr<IfcPropertyListValue> IfcPropertyListValuePtr;

} // namespace

#endif // _IFC4_IFCPROPERTYLISTVALUE_AUTO_IMPL_H
