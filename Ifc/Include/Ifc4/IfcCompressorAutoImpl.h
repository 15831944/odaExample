...
#ifndef _IFC4_IFCCOMPRESSOR_AUTO_IMPL_H
#define _IFC4_IFCCOMPRESSOR_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCompressor : public IfcFlowMovingDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCompressor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCompressor, IfcCompressor> object.
*/
typedef OdSmartPtr<IfcCompressor> IfcCompressorPtr;

} // namespace

#endif // _IFC4_IFCCOMPRESSOR_AUTO_IMPL_H
