...
#ifndef _IFC4_IFCMECHANICALFASTENERTYPE_AUTO_IMPL_H
#define _IFC4_IFCMECHANICALFASTENERTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMechanicalFastenerType : public IfcElementComponentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMechanicalFastenerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMechanicalFastenerType, IfcMechanicalFastenerType> object.
*/
typedef OdSmartPtr<IfcMechanicalFastenerType> IfcMechanicalFastenerTypePtr;

} // namespace

#endif // _IFC4_IFCMECHANICALFASTENERTYPE_AUTO_IMPL_H
