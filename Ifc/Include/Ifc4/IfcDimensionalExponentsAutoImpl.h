...
class IFC4_EXPORT IfcDimensionalExponents : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDimensionalExponents, IfcDimensionalExponents> object.
*/
