...
#ifndef _IFC4_IFCEVAPORATIVECOOLER_AUTO_IMPL_H
#define _IFC4_IFCEVAPORATIVECOOLER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcEvaporativeCooler : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcEvaporativeCooler);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcEvaporativeCooler, IfcEvaporativeCooler> object.
*/
typedef OdSmartPtr<IfcEvaporativeCooler> IfcEvaporativeCoolerPtr;

} // namespace

#endif // _IFC4_IFCEVAPORATIVECOOLER_AUTO_IMPL_H
