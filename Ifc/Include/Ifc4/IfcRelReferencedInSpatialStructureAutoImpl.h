...
#ifndef _IFC4_IFCRELREFERENCEDINSPATIALSTRUCTURE_AUTO_IMPL_H
#define _IFC4_IFCRELREFERENCEDINSPATIALSTRUCTURE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelReferencedInSpatialStructure : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelReferencedInSpatialStructure);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelReferencedInSpatialStructure, IfcRelReferencedInSpatialStructure> object.
*/
typedef OdSmartPtr<IfcRelReferencedInSpatialStructure> IfcRelReferencedInSpatialStructurePtr;

} // namespace

#endif // _IFC4_IFCRELREFERENCEDINSPATIALSTRUCTURE_AUTO_IMPL_H
