...
#ifndef _IFC4_IFCFLOWMOVINGDEVICE_AUTO_IMPL_H
#define _IFC4_IFCFLOWMOVINGDEVICE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFlowMovingDevice : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFlowMovingDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFlowMovingDevice, IfcFlowMovingDevice> object.
*/
typedef OdSmartPtr<IfcFlowMovingDevice> IfcFlowMovingDevicePtr;

} // namespace

#endif // _IFC4_IFCFLOWMOVINGDEVICE_AUTO_IMPL_H
