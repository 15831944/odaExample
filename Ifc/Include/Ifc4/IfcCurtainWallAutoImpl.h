...
#ifndef _IFC4_IFCCURTAINWALL_AUTO_IMPL_H
#define _IFC4_IFCCURTAINWALL_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCurtainWall : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCurtainWall);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCurtainWall, IfcCurtainWall> object.
*/
typedef OdSmartPtr<IfcCurtainWall> IfcCurtainWallPtr;

} // namespace

#endif // _IFC4_IFCCURTAINWALL_AUTO_IMPL_H
