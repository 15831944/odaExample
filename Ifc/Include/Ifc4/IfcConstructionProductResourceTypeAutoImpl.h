...
#ifndef _IFC4_IFCCONSTRUCTIONPRODUCTRESOURCETYPE_AUTO_IMPL_H
#define _IFC4_IFCCONSTRUCTIONPRODUCTRESOURCETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcConstructionProductResourceType : public IfcConstructionResourceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcConstructionProductResourceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcConstructionProductResourceType, IfcConstructionProductResourceType> object.
*/
typedef OdSmartPtr<IfcConstructionProductResourceType> IfcConstructionProductResourceTypePtr;

} // namespace

#endif // _IFC4_IFCCONSTRUCTIONPRODUCTRESOURCETYPE_AUTO_IMPL_H
