...
#ifndef _IFC4_IFCSANITARYTERMINAL_AUTO_IMPL_H
#define _IFC4_IFCSANITARYTERMINAL_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSanitaryTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSanitaryTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSanitaryTerminal, IfcSanitaryTerminal> object.
*/
typedef OdSmartPtr<IfcSanitaryTerminal> IfcSanitaryTerminalPtr;

} // namespace

#endif // _IFC4_IFCSANITARYTERMINAL_AUTO_IMPL_H
