...
#ifndef _IFC4_IFCELECTRICAPPLIANCETYPE_AUTO_IMPL_H
#define _IFC4_IFCELECTRICAPPLIANCETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcElectricApplianceType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcElectricApplianceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcElectricApplianceType, IfcElectricApplianceType> object.
*/
typedef OdSmartPtr<IfcElectricApplianceType> IfcElectricApplianceTypePtr;

} // namespace

#endif // _IFC4_IFCELECTRICAPPLIANCETYPE_AUTO_IMPL_H
