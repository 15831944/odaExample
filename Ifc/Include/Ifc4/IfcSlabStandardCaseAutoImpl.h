...
#ifndef _IFC4_IFCSLABSTANDARDCASE_AUTO_IMPL_H
#define _IFC4_IFCSLABSTANDARDCASE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSlabStandardCase : public IfcSlab
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSlabStandardCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSlabStandardCase, IfcSlabStandardCase> object.
*/
typedef OdSmartPtr<IfcSlabStandardCase> IfcSlabStandardCasePtr;

} // namespace

#endif // _IFC4_IFCSLABSTANDARDCASE_AUTO_IMPL_H
