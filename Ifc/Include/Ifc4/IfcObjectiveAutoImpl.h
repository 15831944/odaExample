...
#ifndef _IFC4_IFCOBJECTIVE_AUTO_IMPL_H
#define _IFC4_IFCOBJECTIVE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcObjective : public IfcConstraint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcObjective);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcObjective, IfcObjective> object.
*/
typedef OdSmartPtr<IfcObjective> IfcObjectivePtr;

} // namespace

#endif // _IFC4_IFCOBJECTIVE_AUTO_IMPL_H
