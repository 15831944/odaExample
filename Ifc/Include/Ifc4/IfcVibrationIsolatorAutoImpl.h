...
#ifndef _IFC4_IFCVIBRATIONISOLATOR_AUTO_IMPL_H
#define _IFC4_IFCVIBRATIONISOLATOR_AUTO_IMPL_H
...
class IFC4_EXPORT IfcVibrationIsolator : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcVibrationIsolator);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcVibrationIsolator, IfcVibrationIsolator> object.
*/
typedef OdSmartPtr<IfcVibrationIsolator> IfcVibrationIsolatorPtr;

} // namespace

#endif // _IFC4_IFCVIBRATIONISOLATOR_AUTO_IMPL_H
