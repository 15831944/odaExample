...
#ifndef _IFC4_IFCCABLESEGMENTTYPE_AUTO_IMPL_H
#define _IFC4_IFCCABLESEGMENTTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCableSegmentType : public IfcFlowSegmentType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCableSegmentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCableSegmentType, IfcCableSegmentType> object.
*/
typedef OdSmartPtr<IfcCableSegmentType> IfcCableSegmentTypePtr;

} // namespace

#endif // _IFC4_IFCCABLESEGMENTTYPE_AUTO_IMPL_H
