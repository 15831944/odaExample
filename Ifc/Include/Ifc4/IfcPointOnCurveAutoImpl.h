...
#ifndef _IFC4_IFCPOINTONCURVE_AUTO_IMPL_H
#define _IFC4_IFCPOINTONCURVE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPointOnCurve : public IfcPoint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPointOnCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPointOnCurve, IfcPointOnCurve> object.
*/
typedef OdSmartPtr<IfcPointOnCurve> IfcPointOnCurvePtr;

} // namespace

#endif // _IFC4_IFCPOINTONCURVE_AUTO_IMPL_H
