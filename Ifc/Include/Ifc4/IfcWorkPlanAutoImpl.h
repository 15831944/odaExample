...
#ifndef _IFC4_IFCWORKPLAN_AUTO_IMPL_H
#define _IFC4_IFCWORKPLAN_AUTO_IMPL_H
...
class IFC4_EXPORT IfcWorkPlan : public IfcWorkControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcWorkPlan);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcWorkPlan, IfcWorkPlan> object.
*/
typedef OdSmartPtr<IfcWorkPlan> IfcWorkPlanPtr;

} // namespace

#endif // _IFC4_IFCWORKPLAN_AUTO_IMPL_H
