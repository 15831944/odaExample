...
#ifndef _IFC4_IFCSTRUCTURALRESULTGROUP_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALRESULTGROUP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralResultGroup : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStructuralResultGroup);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralResultGroup, IfcStructuralResultGroup> object.
*/
typedef OdSmartPtr<IfcStructuralResultGroup> IfcStructuralResultGroupPtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALRESULTGROUP_AUTO_IMPL_H
