...
#ifndef _IFC4_IFCEDGELOOP_AUTO_IMPL_H
#define _IFC4_IFCEDGELOOP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcEdgeLoop : public IfcLoop
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcEdgeLoop);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcEdgeLoop, IfcEdgeLoop> object.
*/
typedef OdSmartPtr<IfcEdgeLoop> IfcEdgeLoopPtr;

} // namespace

#endif // _IFC4_IFCEDGELOOP_AUTO_IMPL_H
