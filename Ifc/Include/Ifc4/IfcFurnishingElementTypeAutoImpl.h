...
#ifndef _IFC4_IFCFURNISHINGELEMENTTYPE_AUTO_IMPL_H
#define _IFC4_IFCFURNISHINGELEMENTTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFurnishingElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFurnishingElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFurnishingElementType, IfcFurnishingElementType> object.
*/
typedef OdSmartPtr<IfcFurnishingElementType> IfcFurnishingElementTypePtr;

} // namespace

#endif // _IFC4_IFCFURNISHINGELEMENTTYPE_AUTO_IMPL_H
