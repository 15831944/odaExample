...
#ifndef _IFC4_IFCSWEPTSURFACE_AUTO_IMPL_H
#define _IFC4_IFCSWEPTSURFACE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSweptSurface : public IfcSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcSweptSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSweptSurface, IfcSweptSurface> object.
*/
typedef OdSmartPtr<IfcSweptSurface> IfcSweptSurfacePtr;

} // namespace

#endif // _IFC4_IFCSWEPTSURFACE_AUTO_IMPL_H
