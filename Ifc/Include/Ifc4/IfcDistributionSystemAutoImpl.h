...
#ifndef _IFC4_IFCDISTRIBUTIONSYSTEM_AUTO_IMPL_H
#define _IFC4_IFCDISTRIBUTIONSYSTEM_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDistributionSystem : public IfcSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDistributionSystem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDistributionSystem, IfcDistributionSystem> object.
*/
typedef OdSmartPtr<IfcDistributionSystem> IfcDistributionSystemPtr;

} // namespace

#endif // _IFC4_IFCDISTRIBUTIONSYSTEM_AUTO_IMPL_H
