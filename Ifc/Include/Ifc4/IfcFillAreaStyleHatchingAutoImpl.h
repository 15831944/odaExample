...
#ifndef _IFC4_IFCFILLAREASTYLEHATCHING_AUTO_IMPL_H
#define _IFC4_IFCFILLAREASTYLEHATCHING_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFillAreaStyleHatching : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFillAreaStyleHatching);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFillAreaStyleHatching, IfcFillAreaStyleHatching> object.
*/
typedef OdSmartPtr<IfcFillAreaStyleHatching> IfcFillAreaStyleHatchingPtr;

} // namespace

#endif // _IFC4_IFCFILLAREASTYLEHATCHING_AUTO_IMPL_H
