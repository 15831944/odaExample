...
#ifndef _IFC4_IFCSTRUCTURALPLANARACTION_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALPLANARACTION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralPlanarAction : public IfcStructuralSurfaceAction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStructuralPlanarAction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralPlanarAction, IfcStructuralPlanarAction> object.
*/
typedef OdSmartPtr<IfcStructuralPlanarAction> IfcStructuralPlanarActionPtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALPLANARACTION_AUTO_IMPL_H
