...
#ifndef _IFC4_IFCACTUATOR_AUTO_IMPL_H
#define _IFC4_IFCACTUATOR_AUTO_IMPL_H
...
class IFC4_EXPORT IfcActuator : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcActuator);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcActuator, IfcActuator> object.
*/
typedef OdSmartPtr<IfcActuator> IfcActuatorPtr;

} // namespace

#endif // _IFC4_IFCACTUATOR_AUTO_IMPL_H
