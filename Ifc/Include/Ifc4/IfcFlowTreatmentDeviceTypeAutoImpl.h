...
#ifndef _IFC4_IFCFLOWTREATMENTDEVICETYPE_AUTO_IMPL_H
#define _IFC4_IFCFLOWTREATMENTDEVICETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFlowTreatmentDeviceType : public IfcDistributionFlowElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcFlowTreatmentDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFlowTreatmentDeviceType, IfcFlowTreatmentDeviceType> object.
*/
typedef OdSmartPtr<IfcFlowTreatmentDeviceType> IfcFlowTreatmentDeviceTypePtr;

} // namespace

#endif // _IFC4_IFCFLOWTREATMENTDEVICETYPE_AUTO_IMPL_H
