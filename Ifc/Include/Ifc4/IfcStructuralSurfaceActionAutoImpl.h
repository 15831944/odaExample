...
#ifndef _IFC4_IFCSTRUCTURALSURFACEACTION_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALSURFACEACTION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralSurfaceAction : public IfcStructuralAction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStructuralSurfaceAction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralSurfaceAction, IfcStructuralSurfaceAction> object.
*/
typedef OdSmartPtr<IfcStructuralSurfaceAction> IfcStructuralSurfaceActionPtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALSURFACEACTION_AUTO_IMPL_H
