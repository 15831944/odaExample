...
#ifndef _IFC4_IFCRELCONNECTSWITHECCENTRICITY_AUTO_IMPL_H
#define _IFC4_IFCRELCONNECTSWITHECCENTRICITY_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelConnectsWithEccentricity : public IfcRelConnectsStructuralMember
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelConnectsWithEccentricity);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelConnectsWithEccentricity, IfcRelConnectsWithEccentricity> object.
*/
typedef OdSmartPtr<IfcRelConnectsWithEccentricity> IfcRelConnectsWithEccentricityPtr;

} // namespace

#endif // _IFC4_IFCRELCONNECTSWITHECCENTRICITY_AUTO_IMPL_H
