...
#ifndef _IFC4_IFCRELDEFINESBYTEMPLATE_AUTO_IMPL_H
#define _IFC4_IFCRELDEFINESBYTEMPLATE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelDefinesByTemplate : public IfcRelDefines
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelDefinesByTemplate);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelDefinesByTemplate, IfcRelDefinesByTemplate> object.
*/
typedef OdSmartPtr<IfcRelDefinesByTemplate> IfcRelDefinesByTemplatePtr;

} // namespace

#endif // _IFC4_IFCRELDEFINESBYTEMPLATE_AUTO_IMPL_H
