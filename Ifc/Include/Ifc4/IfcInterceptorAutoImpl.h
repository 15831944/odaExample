...
#ifndef _IFC4_IFCINTERCEPTOR_AUTO_IMPL_H
#define _IFC4_IFCINTERCEPTOR_AUTO_IMPL_H
...
class IFC4_EXPORT IfcInterceptor : public IfcFlowTreatmentDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcInterceptor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcInterceptor, IfcInterceptor> object.
*/
typedef OdSmartPtr<IfcInterceptor> IfcInterceptorPtr;

} // namespace

#endif // _IFC4_IFCINTERCEPTOR_AUTO_IMPL_H
