...
#ifndef _IFC4_IFCSTRUCTURALSURFACEMEMBERVARYING_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALSURFACEMEMBERVARYING_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralSurfaceMemberVarying : public IfcStructuralSurfaceMember
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStructuralSurfaceMemberVarying);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralSurfaceMemberVarying, IfcStructuralSurfaceMemberVarying> object.
*/
typedef OdSmartPtr<IfcStructuralSurfaceMemberVarying> IfcStructuralSurfaceMemberVaryingPtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALSURFACEMEMBERVARYING_AUTO_IMPL_H
