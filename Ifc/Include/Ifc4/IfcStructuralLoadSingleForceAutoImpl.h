...
#ifndef _IFC4_IFCSTRUCTURALLOADSINGLEFORCE_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALLOADSINGLEFORCE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralLoadSingleForce : public IfcStructuralLoadStatic
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStructuralLoadSingleForce);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralLoadSingleForce, IfcStructuralLoadSingleForce> object.
*/
typedef OdSmartPtr<IfcStructuralLoadSingleForce> IfcStructuralLoadSingleForcePtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALLOADSINGLEFORCE_AUTO_IMPL_H
