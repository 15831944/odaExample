...
#ifndef _IFC4_IFCDUCTFITTING_AUTO_IMPL_H
#define _IFC4_IFCDUCTFITTING_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDuctFitting : public IfcFlowFitting
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDuctFitting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDuctFitting, IfcDuctFitting> object.
*/
typedef OdSmartPtr<IfcDuctFitting> IfcDuctFittingPtr;

} // namespace

#endif // _IFC4_IFCDUCTFITTING_AUTO_IMPL_H
