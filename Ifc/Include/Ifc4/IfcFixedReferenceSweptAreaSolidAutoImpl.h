...
#ifndef _IFC4_IFCFIXEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
#define _IFC4_IFCFIXEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFixedReferenceSweptAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFixedReferenceSweptAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFixedReferenceSweptAreaSolid, IfcFixedReferenceSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcFixedReferenceSweptAreaSolid> IfcFixedReferenceSweptAreaSolidPtr;

} // namespace

#endif // _IFC4_IFCFIXEDREFERENCESWEPTAREASOLID_AUTO_IMPL_H
