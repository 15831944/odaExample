...
#ifndef _IFC4_IFCPROTECTIVEDEVICETRIPPINGUNITTYPE_AUTO_IMPL_H
#define _IFC4_IFCPROTECTIVEDEVICETRIPPINGUNITTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcProtectiveDeviceTrippingUnitType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcProtectiveDeviceTrippingUnitType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcProtectiveDeviceTrippingUnitType, IfcProtectiveDeviceTrippingUnitType> object.
*/
typedef OdSmartPtr<IfcProtectiveDeviceTrippingUnitType> IfcProtectiveDeviceTrippingUnitTypePtr;

} // namespace

#endif // _IFC4_IFCPROTECTIVEDEVICETRIPPINGUNITTYPE_AUTO_IMPL_H
