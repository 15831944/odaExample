...
#ifndef _IFC4_IFCREFERENCE_AUTO_IMPL_H
#define _IFC4_IFCREFERENCE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcReference : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcReference);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcReference, IfcReference> object.
*/
typedef OdSmartPtr<IfcReference> IfcReferencePtr;

} // namespace

#endif // _IFC4_IFCREFERENCE_AUTO_IMPL_H
