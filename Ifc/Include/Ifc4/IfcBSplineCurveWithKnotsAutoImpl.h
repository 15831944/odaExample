...
#ifndef _IFC4_IFCBSPLINECURVEWITHKNOTS_AUTO_IMPL_H
#define _IFC4_IFCBSPLINECURVEWITHKNOTS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBSplineCurveWithKnots : public IfcBSplineCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBSplineCurveWithKnots);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBSplineCurveWithKnots, IfcBSplineCurveWithKnots> object.
*/
typedef OdSmartPtr<IfcBSplineCurveWithKnots> IfcBSplineCurveWithKnotsPtr;

} // namespace

#endif // _IFC4_IFCBSPLINECURVEWITHKNOTS_AUTO_IMPL_H
