...
#ifndef _IFC4_IFCFEATUREELEMENTSUBTRACTION_AUTO_IMPL_H
#define _IFC4_IFCFEATUREELEMENTSUBTRACTION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFeatureElementSubtraction : public IfcFeatureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcFeatureElementSubtraction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFeatureElementSubtraction, IfcFeatureElementSubtraction> object.
*/
typedef OdSmartPtr<IfcFeatureElementSubtraction> IfcFeatureElementSubtractionPtr;

} // namespace

#endif // _IFC4_IFCFEATUREELEMENTSUBTRACTION_AUTO_IMPL_H
