...
#ifndef _IFC4_IFCTYPERESOURCE_AUTO_IMPL_H
#define _IFC4_IFCTYPERESOURCE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTypeResource : public IfcTypeObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcTypeResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTypeResource, IfcTypeResource> object.
*/
typedef OdSmartPtr<IfcTypeResource> IfcTypeResourcePtr;

} // namespace

#endif // _IFC4_IFCTYPERESOURCE_AUTO_IMPL_H
