...
#ifndef _IFC4_IFCMATERIALLAYERSET_AUTO_IMPL_H
#define _IFC4_IFCMATERIALLAYERSET_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMaterialLayerSet : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMaterialLayerSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMaterialLayerSet, IfcMaterialLayerSet> object.
*/
typedef OdSmartPtr<IfcMaterialLayerSet> IfcMaterialLayerSetPtr;

} // namespace

#endif // _IFC4_IFCMATERIALLAYERSET_AUTO_IMPL_H
