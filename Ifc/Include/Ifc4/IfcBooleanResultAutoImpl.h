...
#ifndef _IFC4_IFCBOOLEANRESULT_AUTO_IMPL_H
#define _IFC4_IFCBOOLEANRESULT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBooleanResult : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBooleanResult);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBooleanResult, IfcBooleanResult> object.
*/
typedef OdSmartPtr<IfcBooleanResult> IfcBooleanResultPtr;

} // namespace

#endif // _IFC4_IFCBOOLEANRESULT_AUTO_IMPL_H
