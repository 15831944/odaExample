...
#ifndef _IFC4_IFCBOILER_AUTO_IMPL_H
#define _IFC4_IFCBOILER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBoiler : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBoiler);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBoiler, IfcBoiler> object.
*/
typedef OdSmartPtr<IfcBoiler> IfcBoilerPtr;

} // namespace

#endif // _IFC4_IFCBOILER_AUTO_IMPL_H
