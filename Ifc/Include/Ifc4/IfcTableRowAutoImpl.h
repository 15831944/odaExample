...
#ifndef _IFC4_IFCTABLEROW_AUTO_IMPL_H
#define _IFC4_IFCTABLEROW_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTableRow : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTableRow);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTableRow, IfcTableRow> object.
*/
typedef OdSmartPtr<IfcTableRow> IfcTableRowPtr;

} // namespace

#endif // _IFC4_IFCTABLEROW_AUTO_IMPL_H
