...
#ifndef _IFC4_IFCCOMMUNICATIONSAPPLIANCETYPE_AUTO_IMPL_H
#define _IFC4_IFCCOMMUNICATIONSAPPLIANCETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCommunicationsApplianceType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCommunicationsApplianceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCommunicationsApplianceType, IfcCommunicationsApplianceType> object.
*/
typedef OdSmartPtr<IfcCommunicationsApplianceType> IfcCommunicationsApplianceTypePtr;

} // namespace

#endif // _IFC4_IFCCOMMUNICATIONSAPPLIANCETYPE_AUTO_IMPL_H
