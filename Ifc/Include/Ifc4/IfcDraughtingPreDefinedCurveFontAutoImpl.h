...
#ifndef _IFC4_IFCDRAUGHTINGPREDEFINEDCURVEFONT_AUTO_IMPL_H
#define _IFC4_IFCDRAUGHTINGPREDEFINEDCURVEFONT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDraughtingPreDefinedCurveFont : public IfcPreDefinedCurveFont
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDraughtingPreDefinedCurveFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDraughtingPreDefinedCurveFont, IfcDraughtingPreDefinedCurveFont> object.
*/
typedef OdSmartPtr<IfcDraughtingPreDefinedCurveFont> IfcDraughtingPreDefinedCurveFontPtr;

} // namespace

#endif // _IFC4_IFCDRAUGHTINGPREDEFINEDCURVEFONT_AUTO_IMPL_H
