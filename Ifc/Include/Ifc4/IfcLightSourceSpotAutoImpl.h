...
#ifndef _IFC4_IFCLIGHTSOURCESPOT_AUTO_IMPL_H
#define _IFC4_IFCLIGHTSOURCESPOT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcLightSourceSpot : public IfcLightSourcePositional
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcLightSourceSpot);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcLightSourceSpot, IfcLightSourceSpot> object.
*/
typedef OdSmartPtr<IfcLightSourceSpot> IfcLightSourceSpotPtr;

} // namespace

#endif // _IFC4_IFCLIGHTSOURCESPOT_AUTO_IMPL_H
