...
#ifndef _IFC4_IFCRESOURCELEVELRELATIONSHIP_AUTO_IMPL_H
#define _IFC4_IFCRESOURCELEVELRELATIONSHIP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcResourceLevelRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcResourceLevelRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcResourceLevelRelationship, IfcResourceLevelRelationship> object.
*/
typedef OdSmartPtr<IfcResourceLevelRelationship> IfcResourceLevelRelationshipPtr;

} // namespace

#endif // _IFC4_IFCRESOURCELEVELRELATIONSHIP_AUTO_IMPL_H
