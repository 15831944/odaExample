...
#ifndef _IFC4_IFCDUCTFITTINGTYPE_AUTO_IMPL_H
#define _IFC4_IFCDUCTFITTINGTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDuctFittingType : public IfcFlowFittingType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDuctFittingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDuctFittingType, IfcDuctFittingType> object.
*/
typedef OdSmartPtr<IfcDuctFittingType> IfcDuctFittingTypePtr;

} // namespace

#endif // _IFC4_IFCDUCTFITTINGTYPE_AUTO_IMPL_H
