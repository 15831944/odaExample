...
#ifndef _IFC4_IFCEVAPORATIVECOOLERTYPE_AUTO_IMPL_H
#define _IFC4_IFCEVAPORATIVECOOLERTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcEvaporativeCoolerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcEvaporativeCoolerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcEvaporativeCoolerType, IfcEvaporativeCoolerType> object.
*/
typedef OdSmartPtr<IfcEvaporativeCoolerType> IfcEvaporativeCoolerTypePtr;

} // namespace

#endif // _IFC4_IFCEVAPORATIVECOOLERTYPE_AUTO_IMPL_H
