...
#ifndef _IFC4_IFCMEMBERTYPE_AUTO_IMPL_H
#define _IFC4_IFCMEMBERTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMemberType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMemberType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMemberType, IfcMemberType> object.
*/
typedef OdSmartPtr<IfcMemberType> IfcMemberTypePtr;

} // namespace

#endif // _IFC4_IFCMEMBERTYPE_AUTO_IMPL_H
