...
#ifndef _IFC4_IFCAIRTERMINALTYPE_AUTO_IMPL_H
#define _IFC4_IFCAIRTERMINALTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcAirTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcAirTerminalType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcAirTerminalType, IfcAirTerminalType> object.
*/
typedef OdSmartPtr<IfcAirTerminalType> IfcAirTerminalTypePtr;

} // namespace

#endif // _IFC4_IFCAIRTERMINALTYPE_AUTO_IMPL_H
