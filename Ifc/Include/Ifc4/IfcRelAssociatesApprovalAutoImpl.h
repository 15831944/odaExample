...
#ifndef _IFC4_IFCRELASSOCIATESAPPROVAL_AUTO_IMPL_H
#define _IFC4_IFCRELASSOCIATESAPPROVAL_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelAssociatesApproval : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelAssociatesApproval);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelAssociatesApproval, IfcRelAssociatesApproval> object.
*/
typedef OdSmartPtr<IfcRelAssociatesApproval> IfcRelAssociatesApprovalPtr;

} // namespace

#endif // _IFC4_IFCRELASSOCIATESAPPROVAL_AUTO_IMPL_H
