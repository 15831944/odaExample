...
#ifndef _IFC4_IFCTEXTSTYLE_AUTO_IMPL_H
#define _IFC4_IFCTEXTSTYLE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTextStyle : public IfcPresentationStyle
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTextStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTextStyle, IfcTextStyle> object.
*/
typedef OdSmartPtr<IfcTextStyle> IfcTextStylePtr;

} // namespace

#endif // _IFC4_IFCTEXTSTYLE_AUTO_IMPL_H
