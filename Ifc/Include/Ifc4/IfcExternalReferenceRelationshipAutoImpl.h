...
#ifndef _IFC4_IFCEXTERNALREFERENCERELATIONSHIP_AUTO_IMPL_H
#define _IFC4_IFCEXTERNALREFERENCERELATIONSHIP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcExternalReferenceRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcExternalReferenceRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcExternalReferenceRelationship, IfcExternalReferenceRelationship> object.
*/
typedef OdSmartPtr<IfcExternalReferenceRelationship> IfcExternalReferenceRelationshipPtr;

} // namespace

#endif // _IFC4_IFCEXTERNALREFERENCERELATIONSHIP_AUTO_IMPL_H
