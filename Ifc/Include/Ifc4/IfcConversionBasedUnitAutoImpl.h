...
#ifndef _IFC4_IFCCONVERSIONBASEDUNIT_AUTO_IMPL_H
#define _IFC4_IFCCONVERSIONBASEDUNIT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcConversionBasedUnit : public IfcNamedUnit
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcConversionBasedUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcConversionBasedUnit, IfcConversionBasedUnit> object.
*/
typedef OdSmartPtr<IfcConversionBasedUnit> IfcConversionBasedUnitPtr;

} // namespace

#endif // _IFC4_IFCCONVERSIONBASEDUNIT_AUTO_IMPL_H
