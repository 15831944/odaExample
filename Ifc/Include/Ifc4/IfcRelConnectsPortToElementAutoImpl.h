...
#ifndef _IFC4_IFCRELCONNECTSPORTTOELEMENT_AUTO_IMPL_H
#define _IFC4_IFCRELCONNECTSPORTTOELEMENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelConnectsPortToElement : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelConnectsPortToElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelConnectsPortToElement, IfcRelConnectsPortToElement> object.
*/
typedef OdSmartPtr<IfcRelConnectsPortToElement> IfcRelConnectsPortToElementPtr;

} // namespace

#endif // _IFC4_IFCRELCONNECTSPORTTOELEMENT_AUTO_IMPL_H
