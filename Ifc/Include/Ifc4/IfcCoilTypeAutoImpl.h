...
#ifndef _IFC4_IFCCOILTYPE_AUTO_IMPL_H
#define _IFC4_IFCCOILTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCoilType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCoilType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCoilType, IfcCoilType> object.
*/
typedef OdSmartPtr<IfcCoilType> IfcCoilTypePtr;

} // namespace

#endif // _IFC4_IFCCOILTYPE_AUTO_IMPL_H
