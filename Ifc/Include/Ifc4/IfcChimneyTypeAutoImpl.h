...
#ifndef _IFC4_IFCCHIMNEYTYPE_AUTO_IMPL_H
#define _IFC4_IFCCHIMNEYTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcChimneyType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcChimneyType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcChimneyType, IfcChimneyType> object.
*/
typedef OdSmartPtr<IfcChimneyType> IfcChimneyTypePtr;

} // namespace

#endif // _IFC4_IFCCHIMNEYTYPE_AUTO_IMPL_H
