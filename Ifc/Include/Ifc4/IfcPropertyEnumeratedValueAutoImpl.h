...
#ifndef _IFC4_IFCPROPERTYENUMERATEDVALUE_AUTO_IMPL_H
#define _IFC4_IFCPROPERTYENUMERATEDVALUE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPropertyEnumeratedValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPropertyEnumeratedValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPropertyEnumeratedValue, IfcPropertyEnumeratedValue> object.
*/
typedef OdSmartPtr<IfcPropertyEnumeratedValue> IfcPropertyEnumeratedValuePtr;

} // namespace

#endif // _IFC4_IFCPROPERTYENUMERATEDVALUE_AUTO_IMPL_H
