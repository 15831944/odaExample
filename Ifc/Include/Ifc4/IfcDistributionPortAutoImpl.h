...
#ifndef _IFC4_IFCDISTRIBUTIONPORT_AUTO_IMPL_H
#define _IFC4_IFCDISTRIBUTIONPORT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDistributionPort : public IfcPort
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDistributionPort);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDistributionPort, IfcDistributionPort> object.
*/
typedef OdSmartPtr<IfcDistributionPort> IfcDistributionPortPtr;

} // namespace

#endif // _IFC4_IFCDISTRIBUTIONPORT_AUTO_IMPL_H
