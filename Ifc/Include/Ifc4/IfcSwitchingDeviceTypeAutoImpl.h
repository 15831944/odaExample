...
#ifndef _IFC4_IFCSWITCHINGDEVICETYPE_AUTO_IMPL_H
#define _IFC4_IFCSWITCHINGDEVICETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSwitchingDeviceType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSwitchingDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSwitchingDeviceType, IfcSwitchingDeviceType> object.
*/
typedef OdSmartPtr<IfcSwitchingDeviceType> IfcSwitchingDeviceTypePtr;

} // namespace

#endif // _IFC4_IFCSWITCHINGDEVICETYPE_AUTO_IMPL_H
