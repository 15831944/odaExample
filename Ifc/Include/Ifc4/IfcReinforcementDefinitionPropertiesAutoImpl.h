...
#ifndef _IFC4_IFCREINFORCEMENTDEFINITIONPROPERTIES_AUTO_IMPL_H
#define _IFC4_IFCREINFORCEMENTDEFINITIONPROPERTIES_AUTO_IMPL_H
...
class IFC4_EXPORT IfcReinforcementDefinitionProperties : public IfcPreDefinedPropertySet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcReinforcementDefinitionProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcReinforcementDefinitionProperties, IfcReinforcementDefinitionProperties> object.
*/
typedef OdSmartPtr<IfcReinforcementDefinitionProperties> IfcReinforcementDefinitionPropertiesPtr;

} // namespace

#endif // _IFC4_IFCREINFORCEMENTDEFINITIONPROPERTIES_AUTO_IMPL_H
