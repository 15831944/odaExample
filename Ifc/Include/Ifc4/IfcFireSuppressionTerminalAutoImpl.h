...
#ifndef _IFC4_IFCFIRESUPPRESSIONTERMINAL_AUTO_IMPL_H
#define _IFC4_IFCFIRESUPPRESSIONTERMINAL_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFireSuppressionTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFireSuppressionTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFireSuppressionTerminal, IfcFireSuppressionTerminal> object.
*/
typedef OdSmartPtr<IfcFireSuppressionTerminal> IfcFireSuppressionTerminalPtr;

} // namespace

#endif // _IFC4_IFCFIRESUPPRESSIONTERMINAL_AUTO_IMPL_H
