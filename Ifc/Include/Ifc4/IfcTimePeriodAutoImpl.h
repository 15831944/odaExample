...
#ifndef _IFC4_IFCTIMEPERIOD_AUTO_IMPL_H
#define _IFC4_IFCTIMEPERIOD_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTimePeriod : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTimePeriod);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTimePeriod, IfcTimePeriod> object.
*/
typedef OdSmartPtr<IfcTimePeriod> IfcTimePeriodPtr;

} // namespace

#endif // _IFC4_IFCTIMEPERIOD_AUTO_IMPL_H
