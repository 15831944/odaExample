...
#ifndef _IFC4_IFCRELSPACEBOUNDARY_AUTO_IMPL_H
#define _IFC4_IFCRELSPACEBOUNDARY_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelSpaceBoundary : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelSpaceBoundary);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelSpaceBoundary, IfcRelSpaceBoundary> object.
*/
typedef OdSmartPtr<IfcRelSpaceBoundary> IfcRelSpaceBoundaryPtr;

} // namespace

#endif // _IFC4_IFCRELSPACEBOUNDARY_AUTO_IMPL_H
