...
#ifndef _IFC4_IFCDISTRIBUTIONFLOWELEMENT_AUTO_IMPL_H
#define _IFC4_IFCDISTRIBUTIONFLOWELEMENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDistributionFlowElement : public IfcDistributionElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDistributionFlowElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDistributionFlowElement, IfcDistributionFlowElement> object.
*/
typedef OdSmartPtr<IfcDistributionFlowElement> IfcDistributionFlowElementPtr;

} // namespace

#endif // _IFC4_IFCDISTRIBUTIONFLOWELEMENT_AUTO_IMPL_H
