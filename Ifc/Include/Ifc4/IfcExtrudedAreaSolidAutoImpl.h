...
#ifndef _IFC4_IFCEXTRUDEDAREASOLID_AUTO_IMPL_H
#define _IFC4_IFCEXTRUDEDAREASOLID_AUTO_IMPL_H
...
class IFC4_EXPORT IfcExtrudedAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcExtrudedAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcExtrudedAreaSolid, IfcExtrudedAreaSolid> object.
*/
typedef OdSmartPtr<IfcExtrudedAreaSolid> IfcExtrudedAreaSolidPtr;

} // namespace

#endif // _IFC4_IFCEXTRUDEDAREASOLID_AUTO_IMPL_H
