...
#ifndef _IFC4_IFCTYPEPRODUCT_AUTO_IMPL_H
#define _IFC4_IFCTYPEPRODUCT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTypeProduct : public IfcTypeObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTypeProduct);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTypeProduct, IfcTypeProduct> object.
*/
typedef OdSmartPtr<IfcTypeProduct> IfcTypeProductPtr;

} // namespace

#endif // _IFC4_IFCTYPEPRODUCT_AUTO_IMPL_H
