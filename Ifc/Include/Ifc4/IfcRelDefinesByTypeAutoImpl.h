...
#ifndef _IFC4_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
#define _IFC4_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelDefinesByType : public IfcRelDefines
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelDefinesByType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelDefinesByType, IfcRelDefinesByType> object.
*/
typedef OdSmartPtr<IfcRelDefinesByType> IfcRelDefinesByTypePtr;

} // namespace

#endif // _IFC4_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
