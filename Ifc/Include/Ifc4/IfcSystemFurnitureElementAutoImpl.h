...
#ifndef _IFC4_IFCSYSTEMFURNITUREELEMENT_AUTO_IMPL_H
#define _IFC4_IFCSYSTEMFURNITUREELEMENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSystemFurnitureElement : public IfcFurnishingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSystemFurnitureElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSystemFurnitureElement, IfcSystemFurnitureElement> object.
*/
typedef OdSmartPtr<IfcSystemFurnitureElement> IfcSystemFurnitureElementPtr;

} // namespace

#endif // _IFC4_IFCSYSTEMFURNITUREELEMENT_AUTO_IMPL_H
