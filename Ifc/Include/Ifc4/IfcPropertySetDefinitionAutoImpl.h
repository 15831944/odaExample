...
#ifndef _IFC4_IFCPROPERTYSETDEFINITION_AUTO_IMPL_H
#define _IFC4_IFCPROPERTYSETDEFINITION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPropertySetDefinition : public IfcPropertyDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcPropertySetDefinition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPropertySetDefinition, IfcPropertySetDefinition> object.
*/
typedef OdSmartPtr<IfcPropertySetDefinition> IfcPropertySetDefinitionPtr;

} // namespace

#endif // _IFC4_IFCPROPERTYSETDEFINITION_AUTO_IMPL_H
