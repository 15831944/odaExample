...
#ifndef _IFC4_IFCFLOWSTORAGEDEVICE_AUTO_IMPL_H
#define _IFC4_IFCFLOWSTORAGEDEVICE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFlowStorageDevice : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFlowStorageDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFlowStorageDevice, IfcFlowStorageDevice> object.
*/
typedef OdSmartPtr<IfcFlowStorageDevice> IfcFlowStorageDevicePtr;

} // namespace

#endif // _IFC4_IFCFLOWSTORAGEDEVICE_AUTO_IMPL_H
