...
#ifndef _IFC4_IFCPROJECTEDCRS_AUTO_IMPL_H
#define _IFC4_IFCPROJECTEDCRS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcProjectedCRS : public IfcCoordinateReferenceSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcProjectedCRS);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcProjectedCRS, IfcProjectedCRS> object.
*/
typedef OdSmartPtr<IfcProjectedCRS> IfcProjectedCRSPtr;

} // namespace

#endif // _IFC4_IFCPROJECTEDCRS_AUTO_IMPL_H
