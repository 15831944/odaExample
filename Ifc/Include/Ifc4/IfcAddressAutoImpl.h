...
#ifndef _IFC4_IFCADDRESS_AUTO_IMPL_H
#define _IFC4_IFCADDRESS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcAddress : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcAddress);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcAddress, IfcAddress> object.
*/
typedef OdSmartPtr<IfcAddress> IfcAddressPtr;

} // namespace

#endif // _IFC4_IFCADDRESS_AUTO_IMPL_H
