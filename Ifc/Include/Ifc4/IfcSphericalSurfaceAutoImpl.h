...
#ifndef _IFC4_IFCSPHERICALSURFACE_AUTO_IMPL_H
#define _IFC4_IFCSPHERICALSURFACE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSphericalSurface : public IfcElementarySurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSphericalSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSphericalSurface, IfcSphericalSurface> object.
*/
typedef OdSmartPtr<IfcSphericalSurface> IfcSphericalSurfacePtr;

} // namespace

#endif // _IFC4_IFCSPHERICALSURFACE_AUTO_IMPL_H
