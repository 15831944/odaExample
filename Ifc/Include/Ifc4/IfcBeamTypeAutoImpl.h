...
#ifndef _IFC4_IFCBEAMTYPE_AUTO_IMPL_H
#define _IFC4_IFCBEAMTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBeamType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBeamType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBeamType, IfcBeamType> object.
*/
typedef OdSmartPtr<IfcBeamType> IfcBeamTypePtr;

} // namespace

#endif // _IFC4_IFCBEAMTYPE_AUTO_IMPL_H
