...
#ifndef _IFC4_IFCMATERIALDEFINITIONREPRESENTATION_AUTO_IMPL_H
#define _IFC4_IFCMATERIALDEFINITIONREPRESENTATION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMaterialDefinitionRepresentation : public IfcProductRepresentation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMaterialDefinitionRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMaterialDefinitionRepresentation, IfcMaterialDefinitionRepresentation> object.
*/
typedef OdSmartPtr<IfcMaterialDefinitionRepresentation> IfcMaterialDefinitionRepresentationPtr;

} // namespace

#endif // _IFC4_IFCMATERIALDEFINITIONREPRESENTATION_AUTO_IMPL_H
