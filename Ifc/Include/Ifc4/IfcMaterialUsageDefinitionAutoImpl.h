...
#ifndef _IFC4_IFCMATERIALUSAGEDEFINITION_AUTO_IMPL_H
#define _IFC4_IFCMATERIALUSAGEDEFINITION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMaterialUsageDefinition : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcMaterialUsageDefinition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMaterialUsageDefinition, IfcMaterialUsageDefinition> object.
*/
typedef OdSmartPtr<IfcMaterialUsageDefinition> IfcMaterialUsageDefinitionPtr;

} // namespace

#endif // _IFC4_IFCMATERIALUSAGEDEFINITION_AUTO_IMPL_H
