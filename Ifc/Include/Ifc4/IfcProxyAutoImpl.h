...
#ifndef _IFC4_IFCPROXY_AUTO_IMPL_H
#define _IFC4_IFCPROXY_AUTO_IMPL_H
...
class IFC4_EXPORT IfcProxy : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcProxy);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcProxy, IfcProxy> object.
*/
typedef OdSmartPtr<IfcProxy> IfcProxyPtr;

} // namespace

#endif // _IFC4_IFCPROXY_AUTO_IMPL_H
