...
#ifndef _IFC4_IFCTESSELLATEDITEM_AUTO_IMPL_H
#define _IFC4_IFCTESSELLATEDITEM_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTessellatedItem : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcTessellatedItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTessellatedItem, IfcTessellatedItem> object.
*/
typedef OdSmartPtr<IfcTessellatedItem> IfcTessellatedItemPtr;

} // namespace

#endif // _IFC4_IFCTESSELLATEDITEM_AUTO_IMPL_H
