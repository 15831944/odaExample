...
#ifndef _IFC4_IFCELEMENTASSEMBLY_AUTO_IMPL_H
#define _IFC4_IFCELEMENTASSEMBLY_AUTO_IMPL_H
...
class IFC4_EXPORT IfcElementAssembly : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcElementAssembly);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcElementAssembly, IfcElementAssembly> object.
*/
typedef OdSmartPtr<IfcElementAssembly> IfcElementAssemblyPtr;

} // namespace

#endif // _IFC4_IFCELEMENTASSEMBLY_AUTO_IMPL_H
