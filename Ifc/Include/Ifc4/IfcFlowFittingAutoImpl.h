...
#ifndef _IFC4_IFCFLOWFITTING_AUTO_IMPL_H
#define _IFC4_IFCFLOWFITTING_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFlowFitting : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFlowFitting);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFlowFitting, IfcFlowFitting> object.
*/
typedef OdSmartPtr<IfcFlowFitting> IfcFlowFittingPtr;

} // namespace

#endif // _IFC4_IFCFLOWFITTING_AUTO_IMPL_H
