...
#ifndef _IFC4_IFCFACEBOUND_AUTO_IMPL_H
#define _IFC4_IFCFACEBOUND_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFaceBound : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFaceBound);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFaceBound, IfcFaceBound> object.
*/
typedef OdSmartPtr<IfcFaceBound> IfcFaceBoundPtr;

} // namespace

#endif // _IFC4_IFCFACEBOUND_AUTO_IMPL_H
