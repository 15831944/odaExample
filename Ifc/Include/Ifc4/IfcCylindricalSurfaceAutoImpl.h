...
#ifndef _IFC4_IFCCYLINDRICALSURFACE_AUTO_IMPL_H
#define _IFC4_IFCCYLINDRICALSURFACE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCylindricalSurface : public IfcElementarySurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCylindricalSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCylindricalSurface, IfcCylindricalSurface> object.
*/
typedef OdSmartPtr<IfcCylindricalSurface> IfcCylindricalSurfacePtr;

} // namespace

#endif // _IFC4_IFCCYLINDRICALSURFACE_AUTO_IMPL_H
