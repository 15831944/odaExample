...
#ifndef _IFC4_IFCTEXTUREVERTEXLIST_AUTO_IMPL_H
#define _IFC4_IFCTEXTUREVERTEXLIST_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTextureVertexList : public IfcPresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTextureVertexList);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTextureVertexList, IfcTextureVertexList> object.
*/
typedef OdSmartPtr<IfcTextureVertexList> IfcTextureVertexListPtr;

} // namespace

#endif // _IFC4_IFCTEXTUREVERTEXLIST_AUTO_IMPL_H
