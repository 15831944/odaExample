...
#ifndef _IFC4_IFCCIRCLEHOLLOWPROFILEDEF_AUTO_IMPL_H
#define _IFC4_IFCCIRCLEHOLLOWPROFILEDEF_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCircleHollowProfileDef : public IfcCircleProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCircleHollowProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCircleHollowProfileDef, IfcCircleHollowProfileDef> object.
*/
typedef OdSmartPtr<IfcCircleHollowProfileDef> IfcCircleHollowProfileDefPtr;

} // namespace

#endif // _IFC4_IFCCIRCLEHOLLOWPROFILEDEF_AUTO_IMPL_H
