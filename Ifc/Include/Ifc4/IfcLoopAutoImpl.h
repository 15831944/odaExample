...
#ifndef _IFC4_IFCLOOP_AUTO_IMPL_H
#define _IFC4_IFCLOOP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcLoop : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcLoop);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcLoop, IfcLoop> object.
*/
typedef OdSmartPtr<IfcLoop> IfcLoopPtr;

} // namespace

#endif // _IFC4_IFCLOOP_AUTO_IMPL_H
