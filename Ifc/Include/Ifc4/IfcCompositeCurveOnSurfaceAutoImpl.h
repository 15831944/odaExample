...
#ifndef _IFC4_IFCCOMPOSITECURVEONSURFACE_AUTO_IMPL_H
#define _IFC4_IFCCOMPOSITECURVEONSURFACE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCompositeCurveOnSurface : public IfcCompositeCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCompositeCurveOnSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCompositeCurveOnSurface, IfcCompositeCurveOnSurface> object.
*/
typedef OdSmartPtr<IfcCompositeCurveOnSurface> IfcCompositeCurveOnSurfacePtr;

} // namespace

#endif // _IFC4_IFCCOMPOSITECURVEONSURFACE_AUTO_IMPL_H
