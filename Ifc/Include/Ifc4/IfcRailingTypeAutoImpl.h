...
#ifndef _IFC4_IFCRAILINGTYPE_AUTO_IMPL_H
#define _IFC4_IFCRAILINGTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRailingType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRailingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRailingType, IfcRailingType> object.
*/
typedef OdSmartPtr<IfcRailingType> IfcRailingTypePtr;

} // namespace

#endif // _IFC4_IFCRAILINGTYPE_AUTO_IMPL_H
