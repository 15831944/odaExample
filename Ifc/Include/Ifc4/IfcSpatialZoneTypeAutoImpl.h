...
#ifndef _IFC4_IFCSPATIALZONETYPE_AUTO_IMPL_H
#define _IFC4_IFCSPATIALZONETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSpatialZoneType : public IfcSpatialElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSpatialZoneType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSpatialZoneType, IfcSpatialZoneType> object.
*/
typedef OdSmartPtr<IfcSpatialZoneType> IfcSpatialZoneTypePtr;

} // namespace

#endif // _IFC4_IFCSPATIALZONETYPE_AUTO_IMPL_H
