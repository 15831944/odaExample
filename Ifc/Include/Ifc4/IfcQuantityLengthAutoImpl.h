...
#ifndef _IFC4_IFCQUANTITYLENGTH_AUTO_IMPL_H
#define _IFC4_IFCQUANTITYLENGTH_AUTO_IMPL_H
...
class IFC4_EXPORT IfcQuantityLength : public IfcPhysicalSimpleQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcQuantityLength);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcQuantityLength, IfcQuantityLength> object.
*/
typedef OdSmartPtr<IfcQuantityLength> IfcQuantityLengthPtr;

} // namespace

#endif // _IFC4_IFCQUANTITYLENGTH_AUTO_IMPL_H
