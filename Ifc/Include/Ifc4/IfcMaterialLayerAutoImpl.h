...
#ifndef _IFC4_IFCMATERIALLAYER_AUTO_IMPL_H
#define _IFC4_IFCMATERIALLAYER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMaterialLayer : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMaterialLayer);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMaterialLayer, IfcMaterialLayer> object.
*/
typedef OdSmartPtr<IfcMaterialLayer> IfcMaterialLayerPtr;

} // namespace

#endif // _IFC4_IFCMATERIALLAYER_AUTO_IMPL_H
