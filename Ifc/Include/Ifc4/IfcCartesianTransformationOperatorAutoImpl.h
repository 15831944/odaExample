...
#ifndef _IFC4_IFCCARTESIANTRANSFORMATIONOPERATOR_AUTO_IMPL_H
#define _IFC4_IFCCARTESIANTRANSFORMATIONOPERATOR_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCartesianTransformationOperator : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcCartesianTransformationOperator);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCartesianTransformationOperator, IfcCartesianTransformationOperator> object.
*/
typedef OdSmartPtr<IfcCartesianTransformationOperator> IfcCartesianTransformationOperatorPtr;

} // namespace

#endif // _IFC4_IFCCARTESIANTRANSFORMATIONOPERATOR_AUTO_IMPL_H
