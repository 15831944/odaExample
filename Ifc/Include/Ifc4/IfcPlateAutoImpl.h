...
#ifndef _IFC4_IFCPLATE_AUTO_IMPL_H
#define _IFC4_IFCPLATE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPlate : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPlate);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPlate, IfcPlate> object.
*/
typedef OdSmartPtr<IfcPlate> IfcPlatePtr;

} // namespace

#endif // _IFC4_IFCPLATE_AUTO_IMPL_H
