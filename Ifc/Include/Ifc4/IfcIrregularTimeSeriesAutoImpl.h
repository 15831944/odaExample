...
#ifndef _IFC4_IFCIRREGULARTIMESERIES_AUTO_IMPL_H
#define _IFC4_IFCIRREGULARTIMESERIES_AUTO_IMPL_H
...
class IFC4_EXPORT IfcIrregularTimeSeries : public IfcTimeSeries
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcIrregularTimeSeries);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcIrregularTimeSeries, IfcIrregularTimeSeries> object.
*/
typedef OdSmartPtr<IfcIrregularTimeSeries> IfcIrregularTimeSeriesPtr;

} // namespace

#endif // _IFC4_IFCIRREGULARTIMESERIES_AUTO_IMPL_H
