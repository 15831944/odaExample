...
#ifndef _IFC4_IFCDERIVEDPROFILEDEF_AUTO_IMPL_H
#define _IFC4_IFCDERIVEDPROFILEDEF_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDerivedProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDerivedProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDerivedProfileDef, IfcDerivedProfileDef> object.
*/
typedef OdSmartPtr<IfcDerivedProfileDef> IfcDerivedProfileDefPtr;

} // namespace

#endif // _IFC4_IFCDERIVEDPROFILEDEF_AUTO_IMPL_H
