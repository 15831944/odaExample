...
#ifndef _IFC4_IFCSURFACESTYLE_AUTO_IMPL_H
#define _IFC4_IFCSURFACESTYLE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSurfaceStyle : public IfcPresentationStyle
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSurfaceStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSurfaceStyle, IfcSurfaceStyle> object.
*/
typedef OdSmartPtr<IfcSurfaceStyle> IfcSurfaceStylePtr;

} // namespace

#endif // _IFC4_IFCSURFACESTYLE_AUTO_IMPL_H
