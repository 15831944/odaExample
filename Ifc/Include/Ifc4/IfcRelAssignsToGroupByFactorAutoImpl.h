...
#ifndef _IFC4_IFCRELASSIGNSTOGROUPBYFACTOR_AUTO_IMPL_H
#define _IFC4_IFCRELASSIGNSTOGROUPBYFACTOR_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelAssignsToGroupByFactor : public IfcRelAssignsToGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelAssignsToGroupByFactor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelAssignsToGroupByFactor, IfcRelAssignsToGroupByFactor> object.
*/
typedef OdSmartPtr<IfcRelAssignsToGroupByFactor> IfcRelAssignsToGroupByFactorPtr;

} // namespace

#endif // _IFC4_IFCRELASSIGNSTOGROUPBYFACTOR_AUTO_IMPL_H
