...
#ifndef _IFC4_IFCVALVETYPE_AUTO_IMPL_H
#define _IFC4_IFCVALVETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcValveType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcValveType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcValveType, IfcValveType> object.
*/
typedef OdSmartPtr<IfcValveType> IfcValveTypePtr;

} // namespace

#endif // _IFC4_IFCVALVETYPE_AUTO_IMPL_H
