...
#ifndef _IFC4_IFCHUMIDIFIER_AUTO_IMPL_H
#define _IFC4_IFCHUMIDIFIER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcHumidifier : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcHumidifier);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcHumidifier, IfcHumidifier> object.
*/
typedef OdSmartPtr<IfcHumidifier> IfcHumidifierPtr;

} // namespace

#endif // _IFC4_IFCHUMIDIFIER_AUTO_IMPL_H
