...
#ifndef _IFC4_IFCTYPEPROCESS_AUTO_IMPL_H
#define _IFC4_IFCTYPEPROCESS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTypeProcess : public IfcTypeObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcTypeProcess);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTypeProcess, IfcTypeProcess> object.
*/
typedef OdSmartPtr<IfcTypeProcess> IfcTypeProcessPtr;

} // namespace

#endif // _IFC4_IFCTYPEPROCESS_AUTO_IMPL_H
