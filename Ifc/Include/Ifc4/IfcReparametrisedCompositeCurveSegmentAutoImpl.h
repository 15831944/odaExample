...
#ifndef _IFC4_IFCREPARAMETRISEDCOMPOSITECURVESEGMENT_AUTO_IMPL_H
#define _IFC4_IFCREPARAMETRISEDCOMPOSITECURVESEGMENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcReparametrisedCompositeCurveSegment : public IfcCompositeCurveSegment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcReparametrisedCompositeCurveSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcReparametrisedCompositeCurveSegment, IfcReparametrisedCompositeCurveSegment> object.
*/
typedef OdSmartPtr<IfcReparametrisedCompositeCurveSegment> IfcReparametrisedCompositeCurveSegmentPtr;

} // namespace

#endif // _IFC4_IFCREPARAMETRISEDCOMPOSITECURVESEGMENT_AUTO_IMPL_H
