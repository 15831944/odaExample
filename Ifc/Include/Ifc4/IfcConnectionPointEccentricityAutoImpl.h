...
#ifndef _IFC4_IFCCONNECTIONPOINTECCENTRICITY_AUTO_IMPL_H
#define _IFC4_IFCCONNECTIONPOINTECCENTRICITY_AUTO_IMPL_H
...
class IFC4_EXPORT IfcConnectionPointEccentricity : public IfcConnectionPointGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcConnectionPointEccentricity);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcConnectionPointEccentricity, IfcConnectionPointEccentricity> object.
*/
typedef OdSmartPtr<IfcConnectionPointEccentricity> IfcConnectionPointEccentricityPtr;

} // namespace

#endif // _IFC4_IFCCONNECTIONPOINTECCENTRICITY_AUTO_IMPL_H
