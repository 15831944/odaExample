...
#ifndef _IFC4_IFCAUDIOVISUALAPPLIANCETYPE_AUTO_IMPL_H
#define _IFC4_IFCAUDIOVISUALAPPLIANCETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcAudioVisualApplianceType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcAudioVisualApplianceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcAudioVisualApplianceType, IfcAudioVisualApplianceType> object.
*/
typedef OdSmartPtr<IfcAudioVisualApplianceType> IfcAudioVisualApplianceTypePtr;

} // namespace

#endif // _IFC4_IFCAUDIOVISUALAPPLIANCETYPE_AUTO_IMPL_H
