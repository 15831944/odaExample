...
#ifndef _IFC4_IFCEXTERNALSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
#define _IFC4_IFCEXTERNALSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcExternalSpatialStructureElement : public IfcSpatialElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcExternalSpatialStructureElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcExternalSpatialStructureElement, IfcExternalSpatialStructureElement> object.
*/
typedef OdSmartPtr<IfcExternalSpatialStructureElement> IfcExternalSpatialStructureElementPtr;

} // namespace

#endif // _IFC4_IFCEXTERNALSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
