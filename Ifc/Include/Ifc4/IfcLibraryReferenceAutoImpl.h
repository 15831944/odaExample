...
#ifndef _IFC4_IFCLIBRARYREFERENCE_AUTO_IMPL_H
#define _IFC4_IFCLIBRARYREFERENCE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcLibraryReference : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcLibraryReference);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcLibraryReference, IfcLibraryReference> object.
*/
typedef OdSmartPtr<IfcLibraryReference> IfcLibraryReferencePtr;

} // namespace

#endif // _IFC4_IFCLIBRARYREFERENCE_AUTO_IMPL_H
