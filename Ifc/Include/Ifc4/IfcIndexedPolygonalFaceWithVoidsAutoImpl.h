...
#ifndef _IFC4_IFCINDEXEDPOLYGONALFACEWITHVOIDS_AUTO_IMPL_H
#define _IFC4_IFCINDEXEDPOLYGONALFACEWITHVOIDS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcIndexedPolygonalFaceWithVoids : public IfcIndexedPolygonalFace
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcIndexedPolygonalFaceWithVoids);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcIndexedPolygonalFaceWithVoids, IfcIndexedPolygonalFaceWithVoids> object.
*/
typedef OdSmartPtr<IfcIndexedPolygonalFaceWithVoids> IfcIndexedPolygonalFaceWithVoidsPtr;

} // namespace

#endif // _IFC4_IFCINDEXEDPOLYGONALFACEWITHVOIDS_AUTO_IMPL_H
