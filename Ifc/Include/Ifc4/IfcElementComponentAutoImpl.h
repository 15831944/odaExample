...
#ifndef _IFC4_IFCELEMENTCOMPONENT_AUTO_IMPL_H
#define _IFC4_IFCELEMENTCOMPONENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcElementComponent : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcElementComponent);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcElementComponent, IfcElementComponent> object.
*/
typedef OdSmartPtr<IfcElementComponent> IfcElementComponentPtr;

} // namespace

#endif // _IFC4_IFCELEMENTCOMPONENT_AUTO_IMPL_H
