...
#ifndef _IFC4_IFCSTACKTERMINAL_AUTO_IMPL_H
#define _IFC4_IFCSTACKTERMINAL_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStackTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStackTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStackTerminal, IfcStackTerminal> object.
*/
typedef OdSmartPtr<IfcStackTerminal> IfcStackTerminalPtr;

} // namespace

#endif // _IFC4_IFCSTACKTERMINAL_AUTO_IMPL_H
