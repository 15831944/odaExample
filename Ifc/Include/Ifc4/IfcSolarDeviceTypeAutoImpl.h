...
#ifndef _IFC4_IFCSOLARDEVICETYPE_AUTO_IMPL_H
#define _IFC4_IFCSOLARDEVICETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSolarDeviceType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSolarDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSolarDeviceType, IfcSolarDeviceType> object.
*/
typedef OdSmartPtr<IfcSolarDeviceType> IfcSolarDeviceTypePtr;

} // namespace

#endif // _IFC4_IFCSOLARDEVICETYPE_AUTO_IMPL_H
