...
#ifndef _IFC4_IFCRELCONTAINEDINSPATIALSTRUCTURE_AUTO_IMPL_H
#define _IFC4_IFCRELCONTAINEDINSPATIALSTRUCTURE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelContainedInSpatialStructure : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelContainedInSpatialStructure);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelContainedInSpatialStructure, IfcRelContainedInSpatialStructure> object.
*/
typedef OdSmartPtr<IfcRelContainedInSpatialStructure> IfcRelContainedInSpatialStructurePtr;

} // namespace

#endif // _IFC4_IFCRELCONTAINEDINSPATIALSTRUCTURE_AUTO_IMPL_H
