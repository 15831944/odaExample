...
#ifndef _IFC4_IFCHEATEXCHANGERTYPE_AUTO_IMPL_H
#define _IFC4_IFCHEATEXCHANGERTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcHeatExchangerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcHeatExchangerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcHeatExchangerType, IfcHeatExchangerType> object.
*/
typedef OdSmartPtr<IfcHeatExchangerType> IfcHeatExchangerTypePtr;

} // namespace

#endif // _IFC4_IFCHEATEXCHANGERTYPE_AUTO_IMPL_H
