...
#ifndef _IFC4_IFCANNOTATION_AUTO_IMPL_H
#define _IFC4_IFCANNOTATION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcAnnotation : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcAnnotation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcAnnotation, IfcAnnotation> object.
*/
typedef OdSmartPtr<IfcAnnotation> IfcAnnotationPtr;

} // namespace

#endif // _IFC4_IFCANNOTATION_AUTO_IMPL_H
