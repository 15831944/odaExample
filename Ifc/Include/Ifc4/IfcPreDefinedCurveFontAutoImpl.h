...
#ifndef _IFC4_IFCPREDEFINEDCURVEFONT_AUTO_IMPL_H
#define _IFC4_IFCPREDEFINEDCURVEFONT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPreDefinedCurveFont : public IfcPreDefinedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcPreDefinedCurveFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPreDefinedCurveFont, IfcPreDefinedCurveFont> object.
*/
typedef OdSmartPtr<IfcPreDefinedCurveFont> IfcPreDefinedCurveFontPtr;

} // namespace

#endif // _IFC4_IFCPREDEFINEDCURVEFONT_AUTO_IMPL_H
