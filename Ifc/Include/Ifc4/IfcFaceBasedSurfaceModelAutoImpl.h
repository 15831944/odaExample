...
#ifndef _IFC4_IFCFACEBASEDSURFACEMODEL_AUTO_IMPL_H
#define _IFC4_IFCFACEBASEDSURFACEMODEL_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFaceBasedSurfaceModel : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFaceBasedSurfaceModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFaceBasedSurfaceModel, IfcFaceBasedSurfaceModel> object.
*/
typedef OdSmartPtr<IfcFaceBasedSurfaceModel> IfcFaceBasedSurfaceModelPtr;

} // namespace

#endif // _IFC4_IFCFACEBASEDSURFACEMODEL_AUTO_IMPL_H
