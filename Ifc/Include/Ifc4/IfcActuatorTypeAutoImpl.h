...
#ifndef _IFC4_IFCACTUATORTYPE_AUTO_IMPL_H
#define _IFC4_IFCACTUATORTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcActuatorType : public IfcDistributionControlElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcActuatorType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcActuatorType, IfcActuatorType> object.
*/
typedef OdSmartPtr<IfcActuatorType> IfcActuatorTypePtr;

} // namespace

#endif // _IFC4_IFCACTUATORTYPE_AUTO_IMPL_H
