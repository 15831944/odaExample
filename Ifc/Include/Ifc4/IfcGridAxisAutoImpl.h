...
#ifndef _IFC4_IFCGRIDAXIS_AUTO_IMPL_H
#define _IFC4_IFCGRIDAXIS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcGridAxis : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcGridAxis);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcGridAxis, IfcGridAxis> object.
*/
typedef OdSmartPtr<IfcGridAxis> IfcGridAxisPtr;

} // namespace

#endif // _IFC4_IFCGRIDAXIS_AUTO_IMPL_H
