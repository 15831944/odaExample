...
#ifndef _IFC4_IFCBUILDINGELEMENTPART_AUTO_IMPL_H
#define _IFC4_IFCBUILDINGELEMENTPART_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBuildingElementPart : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBuildingElementPart);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBuildingElementPart, IfcBuildingElementPart> object.
*/
typedef OdSmartPtr<IfcBuildingElementPart> IfcBuildingElementPartPtr;

} // namespace

#endif // _IFC4_IFCBUILDINGELEMENTPART_AUTO_IMPL_H
