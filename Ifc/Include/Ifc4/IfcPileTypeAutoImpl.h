...
#ifndef _IFC4_IFCPILETYPE_AUTO_IMPL_H
#define _IFC4_IFCPILETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPileType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPileType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPileType, IfcPileType> object.
*/
typedef OdSmartPtr<IfcPileType> IfcPileTypePtr;

} // namespace

#endif // _IFC4_IFCPILETYPE_AUTO_IMPL_H
