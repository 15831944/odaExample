...
#ifndef _IFC4_IFCRESOURCEAPPROVALRELATIONSHIP_AUTO_IMPL_H
#define _IFC4_IFCRESOURCEAPPROVALRELATIONSHIP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcResourceApprovalRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcResourceApprovalRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcResourceApprovalRelationship, IfcResourceApprovalRelationship> object.
*/
typedef OdSmartPtr<IfcResourceApprovalRelationship> IfcResourceApprovalRelationshipPtr;

} // namespace

#endif // _IFC4_IFCRESOURCEAPPROVALRELATIONSHIP_AUTO_IMPL_H
