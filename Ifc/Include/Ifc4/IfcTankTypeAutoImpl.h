...
#ifndef _IFC4_IFCTANKTYPE_AUTO_IMPL_H
#define _IFC4_IFCTANKTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTankType : public IfcFlowStorageDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTankType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTankType, IfcTankType> object.
*/
typedef OdSmartPtr<IfcTankType> IfcTankTypePtr;

} // namespace

#endif // _IFC4_IFCTANKTYPE_AUTO_IMPL_H
