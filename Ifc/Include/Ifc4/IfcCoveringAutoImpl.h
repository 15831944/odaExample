...
#ifndef _IFC4_IFCCOVERING_AUTO_IMPL_H
#define _IFC4_IFCCOVERING_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCovering : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCovering);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCovering, IfcCovering> object.
*/
typedef OdSmartPtr<IfcCovering> IfcCoveringPtr;

} // namespace

#endif // _IFC4_IFCCOVERING_AUTO_IMPL_H
