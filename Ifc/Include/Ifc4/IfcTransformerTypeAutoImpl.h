...
#ifndef _IFC4_IFCTRANSFORMERTYPE_AUTO_IMPL_H
#define _IFC4_IFCTRANSFORMERTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTransformerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTransformerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTransformerType, IfcTransformerType> object.
*/
typedef OdSmartPtr<IfcTransformerType> IfcTransformerTypePtr;

} // namespace

#endif // _IFC4_IFCTRANSFORMERTYPE_AUTO_IMPL_H
