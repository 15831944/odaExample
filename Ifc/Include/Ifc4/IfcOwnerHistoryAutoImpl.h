...
#ifndef _IFC4_IFCOWNERHISTORY_AUTO_IMPL_H
#define _IFC4_IFCOWNERHISTORY_AUTO_IMPL_H
...
class IFC4_EXPORT IfcOwnerHistory : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcOwnerHistory);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcOwnerHistory, IfcOwnerHistory> object.
*/
typedef OdSmartPtr<IfcOwnerHistory> IfcOwnerHistoryPtr;

} // namespace

#endif // _IFC4_IFCOWNERHISTORY_AUTO_IMPL_H
