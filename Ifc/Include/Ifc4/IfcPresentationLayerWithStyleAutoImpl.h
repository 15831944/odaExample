...
#ifndef _IFC4_IFCPRESENTATIONLAYERWITHSTYLE_AUTO_IMPL_H
#define _IFC4_IFCPRESENTATIONLAYERWITHSTYLE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPresentationLayerWithStyle : public IfcPresentationLayerAssignment
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPresentationLayerWithStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPresentationLayerWithStyle, IfcPresentationLayerWithStyle> object.
*/
typedef OdSmartPtr<IfcPresentationLayerWithStyle> IfcPresentationLayerWithStylePtr;

} // namespace

#endif // _IFC4_IFCPRESENTATIONLAYERWITHSTYLE_AUTO_IMPL_H
