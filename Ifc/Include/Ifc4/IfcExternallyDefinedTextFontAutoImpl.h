...
#ifndef _IFC4_IFCEXTERNALLYDEFINEDTEXTFONT_AUTO_IMPL_H
#define _IFC4_IFCEXTERNALLYDEFINEDTEXTFONT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcExternallyDefinedTextFont : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcExternallyDefinedTextFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcExternallyDefinedTextFont, IfcExternallyDefinedTextFont> object.
*/
typedef OdSmartPtr<IfcExternallyDefinedTextFont> IfcExternallyDefinedTextFontPtr;

} // namespace

#endif // _IFC4_IFCEXTERNALLYDEFINEDTEXTFONT_AUTO_IMPL_H
