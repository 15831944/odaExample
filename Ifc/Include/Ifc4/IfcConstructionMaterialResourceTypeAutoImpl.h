...
#ifndef _IFC4_IFCCONSTRUCTIONMATERIALRESOURCETYPE_AUTO_IMPL_H
#define _IFC4_IFCCONSTRUCTIONMATERIALRESOURCETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcConstructionMaterialResourceType : public IfcConstructionResourceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcConstructionMaterialResourceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcConstructionMaterialResourceType, IfcConstructionMaterialResourceType> object.
*/
typedef OdSmartPtr<IfcConstructionMaterialResourceType> IfcConstructionMaterialResourceTypePtr;

} // namespace

#endif // _IFC4_IFCCONSTRUCTIONMATERIALRESOURCETYPE_AUTO_IMPL_H
