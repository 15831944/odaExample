...
#ifndef _IFC4_IFCSURFACESTYLERENDERING_AUTO_IMPL_H
#define _IFC4_IFCSURFACESTYLERENDERING_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSurfaceStyleRendering : public IfcSurfaceStyleShading
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSurfaceStyleRendering);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSurfaceStyleRendering, IfcSurfaceStyleRendering> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleRendering> IfcSurfaceStyleRenderingPtr;

} // namespace

#endif // _IFC4_IFCSURFACESTYLERENDERING_AUTO_IMPL_H
