...
#ifndef _IFC4_IFCRELCONNECTSSTRUCTURALACTIVITY_AUTO_IMPL_H
#define _IFC4_IFCRELCONNECTSSTRUCTURALACTIVITY_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelConnectsStructuralActivity : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelConnectsStructuralActivity);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelConnectsStructuralActivity, IfcRelConnectsStructuralActivity> object.
*/
typedef OdSmartPtr<IfcRelConnectsStructuralActivity> IfcRelConnectsStructuralActivityPtr;

} // namespace

#endif // _IFC4_IFCRELCONNECTSSTRUCTURALACTIVITY_AUTO_IMPL_H
