...
#ifndef _IFC4_IFCEDGE_AUTO_IMPL_H
#define _IFC4_IFCEDGE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcEdge : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcEdge);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcEdge, IfcEdge> object.
*/
typedef OdSmartPtr<IfcEdge> IfcEdgePtr;

} // namespace

#endif // _IFC4_IFCEDGE_AUTO_IMPL_H
