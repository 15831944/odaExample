...
#ifndef _IFC4_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
#define _IFC4_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPropertySingleValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPropertySingleValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPropertySingleValue, IfcPropertySingleValue> object.
*/
typedef OdSmartPtr<IfcPropertySingleValue> IfcPropertySingleValuePtr;

} // namespace

#endif // _IFC4_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
