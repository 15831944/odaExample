...
#ifndef _IFC4_IFCDUCTSILENCERTYPE_AUTO_IMPL_H
#define _IFC4_IFCDUCTSILENCERTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDuctSilencerType : public IfcFlowTreatmentDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDuctSilencerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDuctSilencerType, IfcDuctSilencerType> object.
*/
typedef OdSmartPtr<IfcDuctSilencerType> IfcDuctSilencerTypePtr;

} // namespace

#endif // _IFC4_IFCDUCTSILENCERTYPE_AUTO_IMPL_H
