...
#ifndef _IFC4_IFCCOORDINATEOPERATION_AUTO_IMPL_H
#define _IFC4_IFCCOORDINATEOPERATION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCoordinateOperation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcCoordinateOperation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCoordinateOperation, IfcCoordinateOperation> object.
*/
typedef OdSmartPtr<IfcCoordinateOperation> IfcCoordinateOperationPtr;

} // namespace

#endif // _IFC4_IFCCOORDINATEOPERATION_AUTO_IMPL_H
