...
#ifndef _IFC4_IFCFURNITURETYPE_AUTO_IMPL_H
#define _IFC4_IFCFURNITURETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFurnitureType : public IfcFurnishingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFurnitureType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFurnitureType, IfcFurnitureType> object.
*/
typedef OdSmartPtr<IfcFurnitureType> IfcFurnitureTypePtr;

} // namespace

#endif // _IFC4_IFCFURNITURETYPE_AUTO_IMPL_H
