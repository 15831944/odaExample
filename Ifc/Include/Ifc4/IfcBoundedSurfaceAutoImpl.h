...
#ifndef _IFC4_IFCBOUNDEDSURFACE_AUTO_IMPL_H
#define _IFC4_IFCBOUNDEDSURFACE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBoundedSurface : public IfcSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcBoundedSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBoundedSurface, IfcBoundedSurface> object.
*/
typedef OdSmartPtr<IfcBoundedSurface> IfcBoundedSurfacePtr;

} // namespace

#endif // _IFC4_IFCBOUNDEDSURFACE_AUTO_IMPL_H
