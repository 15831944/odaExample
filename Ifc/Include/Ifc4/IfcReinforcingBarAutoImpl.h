...
#ifndef _IFC4_IFCREINFORCINGBAR_AUTO_IMPL_H
#define _IFC4_IFCREINFORCINGBAR_AUTO_IMPL_H
...
class IFC4_EXPORT IfcReinforcingBar : public IfcReinforcingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcReinforcingBar);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcReinforcingBar, IfcReinforcingBar> object.
*/
typedef OdSmartPtr<IfcReinforcingBar> IfcReinforcingBarPtr;

} // namespace

#endif // _IFC4_IFCREINFORCINGBAR_AUTO_IMPL_H
