...
#ifndef _IFC4_IFCAIRTERMINAL_AUTO_IMPL_H
#define _IFC4_IFCAIRTERMINAL_AUTO_IMPL_H
...
class IFC4_EXPORT IfcAirTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcAirTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcAirTerminal, IfcAirTerminal> object.
*/
typedef OdSmartPtr<IfcAirTerminal> IfcAirTerminalPtr;

} // namespace

#endif // _IFC4_IFCAIRTERMINAL_AUTO_IMPL_H
