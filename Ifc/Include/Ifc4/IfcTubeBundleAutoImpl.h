...
#ifndef _IFC4_IFCTUBEBUNDLE_AUTO_IMPL_H
#define _IFC4_IFCTUBEBUNDLE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTubeBundle : public IfcEnergyConversionDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTubeBundle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTubeBundle, IfcTubeBundle> object.
*/
typedef OdSmartPtr<IfcTubeBundle> IfcTubeBundlePtr;

} // namespace

#endif // _IFC4_IFCTUBEBUNDLE_AUTO_IMPL_H
