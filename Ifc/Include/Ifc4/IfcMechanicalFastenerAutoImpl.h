...
#ifndef _IFC4_IFCMECHANICALFASTENER_AUTO_IMPL_H
#define _IFC4_IFCMECHANICALFASTENER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMechanicalFastener : public IfcElementComponent
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMechanicalFastener);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMechanicalFastener, IfcMechanicalFastener> object.
*/
typedef OdSmartPtr<IfcMechanicalFastener> IfcMechanicalFastenerPtr;

} // namespace

#endif // _IFC4_IFCMECHANICALFASTENER_AUTO_IMPL_H
