...
#ifndef _IFC4_IFCCREWRESOURCETYPE_AUTO_IMPL_H
#define _IFC4_IFCCREWRESOURCETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCrewResourceType : public IfcConstructionResourceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCrewResourceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCrewResourceType, IfcCrewResourceType> object.
*/
typedef OdSmartPtr<IfcCrewResourceType> IfcCrewResourceTypePtr;

} // namespace

#endif // _IFC4_IFCCREWRESOURCETYPE_AUTO_IMPL_H
