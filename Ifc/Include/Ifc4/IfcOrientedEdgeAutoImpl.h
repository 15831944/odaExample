...
#ifndef _IFC4_IFCORIENTEDEDGE_AUTO_IMPL_H
#define _IFC4_IFCORIENTEDEDGE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcOrientedEdge : public IfcEdge
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcOrientedEdge);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcOrientedEdge, IfcOrientedEdge> object.
*/
typedef OdSmartPtr<IfcOrientedEdge> IfcOrientedEdgePtr;

} // namespace

#endif // _IFC4_IFCORIENTEDEDGE_AUTO_IMPL_H
