...
#ifndef _IFC4_IFCREINFORCINGMESH_AUTO_IMPL_H
#define _IFC4_IFCREINFORCINGMESH_AUTO_IMPL_H
...
class IFC4_EXPORT IfcReinforcingMesh : public IfcReinforcingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcReinforcingMesh);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcReinforcingMesh, IfcReinforcingMesh> object.
*/
typedef OdSmartPtr<IfcReinforcingMesh> IfcReinforcingMeshPtr;

} // namespace

#endif // _IFC4_IFCREINFORCINGMESH_AUTO_IMPL_H
