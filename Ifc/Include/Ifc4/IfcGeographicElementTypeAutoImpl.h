...
#ifndef _IFC4_IFCGEOGRAPHICELEMENTTYPE_AUTO_IMPL_H
#define _IFC4_IFCGEOGRAPHICELEMENTTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcGeographicElementType : public IfcElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcGeographicElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcGeographicElementType, IfcGeographicElementType> object.
*/
typedef OdSmartPtr<IfcGeographicElementType> IfcGeographicElementTypePtr;

} // namespace

#endif // _IFC4_IFCGEOGRAPHICELEMENTTYPE_AUTO_IMPL_H
