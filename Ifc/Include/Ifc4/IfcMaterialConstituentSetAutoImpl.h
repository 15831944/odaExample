...
#ifndef _IFC4_IFCMATERIALCONSTITUENTSET_AUTO_IMPL_H
#define _IFC4_IFCMATERIALCONSTITUENTSET_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMaterialConstituentSet : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMaterialConstituentSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMaterialConstituentSet, IfcMaterialConstituentSet> object.
*/
typedef OdSmartPtr<IfcMaterialConstituentSet> IfcMaterialConstituentSetPtr;

} // namespace

#endif // _IFC4_IFCMATERIALCONSTITUENTSET_AUTO_IMPL_H
