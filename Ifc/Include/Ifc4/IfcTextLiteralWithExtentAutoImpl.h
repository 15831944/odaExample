...
#ifndef _IFC4_IFCTEXTLITERALWITHEXTENT_AUTO_IMPL_H
#define _IFC4_IFCTEXTLITERALWITHEXTENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTextLiteralWithExtent : public IfcTextLiteral
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTextLiteralWithExtent);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTextLiteralWithExtent, IfcTextLiteralWithExtent> object.
*/
typedef OdSmartPtr<IfcTextLiteralWithExtent> IfcTextLiteralWithExtentPtr;

} // namespace

#endif // _IFC4_IFCTEXTLITERALWITHEXTENT_AUTO_IMPL_H
