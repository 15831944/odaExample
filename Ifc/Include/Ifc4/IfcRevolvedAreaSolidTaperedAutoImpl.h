...
#ifndef _IFC4_IFCREVOLVEDAREASOLIDTAPERED_AUTO_IMPL_H
#define _IFC4_IFCREVOLVEDAREASOLIDTAPERED_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRevolvedAreaSolidTapered : public IfcRevolvedAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRevolvedAreaSolidTapered);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRevolvedAreaSolidTapered, IfcRevolvedAreaSolidTapered> object.
*/
typedef OdSmartPtr<IfcRevolvedAreaSolidTapered> IfcRevolvedAreaSolidTaperedPtr;

} // namespace

#endif // _IFC4_IFCREVOLVEDAREASOLIDTAPERED_AUTO_IMPL_H
