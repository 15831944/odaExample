...
#ifndef _IFC4_IFCRELAGGREGATES_AUTO_IMPL_H
#define _IFC4_IFCRELAGGREGATES_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelAggregates : public IfcRelDecomposes
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelAggregates);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelAggregates, IfcRelAggregates> object.
*/
typedef OdSmartPtr<IfcRelAggregates> IfcRelAggregatesPtr;

} // namespace

#endif // _IFC4_IFCRELAGGREGATES_AUTO_IMPL_H
