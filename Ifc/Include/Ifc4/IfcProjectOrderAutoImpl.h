...
#ifndef _IFC4_IFCPROJECTORDER_AUTO_IMPL_H
#define _IFC4_IFCPROJECTORDER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcProjectOrder : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcProjectOrder);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcProjectOrder, IfcProjectOrder> object.
*/
typedef OdSmartPtr<IfcProjectOrder> IfcProjectOrderPtr;

} // namespace

#endif // _IFC4_IFCPROJECTORDER_AUTO_IMPL_H
