...
#ifndef _IFC4_IFCPUMP_AUTO_IMPL_H
#define _IFC4_IFCPUMP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPump : public IfcFlowMovingDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPump);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPump, IfcPump> object.
*/
typedef OdSmartPtr<IfcPump> IfcPumpPtr;

} // namespace

#endif // _IFC4_IFCPUMP_AUTO_IMPL_H
