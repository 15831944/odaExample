...
#ifndef _IFC4_IFCDOOR_AUTO_IMPL_H
#define _IFC4_IFCDOOR_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDoor : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDoor, IfcDoor> object.
*/
typedef OdSmartPtr<IfcDoor> IfcDoorPtr;

} // namespace

#endif // _IFC4_IFCDOOR_AUTO_IMPL_H
