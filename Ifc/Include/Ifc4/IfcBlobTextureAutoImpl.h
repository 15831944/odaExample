...
#ifndef _IFC4_IFCBLOBTEXTURE_AUTO_IMPL_H
#define _IFC4_IFCBLOBTEXTURE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBlobTexture : public IfcSurfaceTexture
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBlobTexture);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBlobTexture, IfcBlobTexture> object.
*/
typedef OdSmartPtr<IfcBlobTexture> IfcBlobTexturePtr;

} // namespace

#endif // _IFC4_IFCBLOBTEXTURE_AUTO_IMPL_H
