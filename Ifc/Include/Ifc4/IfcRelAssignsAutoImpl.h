...
#ifndef _IFC4_IFCRELASSIGNS_AUTO_IMPL_H
#define _IFC4_IFCRELASSIGNS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelAssigns : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcRelAssigns);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelAssigns, IfcRelAssigns> object.
*/
typedef OdSmartPtr<IfcRelAssigns> IfcRelAssignsPtr;

} // namespace

#endif // _IFC4_IFCRELASSIGNS_AUTO_IMPL_H
