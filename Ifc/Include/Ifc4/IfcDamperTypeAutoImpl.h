...
#ifndef _IFC4_IFCDAMPERTYPE_AUTO_IMPL_H
#define _IFC4_IFCDAMPERTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDamperType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDamperType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDamperType, IfcDamperType> object.
*/
typedef OdSmartPtr<IfcDamperType> IfcDamperTypePtr;

} // namespace

#endif // _IFC4_IFCDAMPERTYPE_AUTO_IMPL_H
