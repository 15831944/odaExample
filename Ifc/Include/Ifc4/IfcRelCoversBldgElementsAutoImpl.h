...
#ifndef _IFC4_IFCRELCOVERSBLDGELEMENTS_AUTO_IMPL_H
#define _IFC4_IFCRELCOVERSBLDGELEMENTS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelCoversBldgElements : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelCoversBldgElements);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelCoversBldgElements, IfcRelCoversBldgElements> object.
*/
typedef OdSmartPtr<IfcRelCoversBldgElements> IfcRelCoversBldgElementsPtr;

} // namespace

#endif // _IFC4_IFCRELCOVERSBLDGELEMENTS_AUTO_IMPL_H
