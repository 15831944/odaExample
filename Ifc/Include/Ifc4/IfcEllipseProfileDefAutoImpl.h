...
#ifndef _IFC4_IFCELLIPSEPROFILEDEF_AUTO_IMPL_H
#define _IFC4_IFCELLIPSEPROFILEDEF_AUTO_IMPL_H
...
class IFC4_EXPORT IfcEllipseProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcEllipseProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcEllipseProfileDef, IfcEllipseProfileDef> object.
*/
typedef OdSmartPtr<IfcEllipseProfileDef> IfcEllipseProfileDefPtr;

} // namespace

#endif // _IFC4_IFCELLIPSEPROFILEDEF_AUTO_IMPL_H
