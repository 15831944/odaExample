...
#ifndef _IFC4_IFCFURNITURE_AUTO_IMPL_H
#define _IFC4_IFCFURNITURE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFurniture : public IfcFurnishingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFurniture);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFurniture, IfcFurniture> object.
*/
typedef OdSmartPtr<IfcFurniture> IfcFurniturePtr;

} // namespace

#endif // _IFC4_IFCFURNITURE_AUTO_IMPL_H
