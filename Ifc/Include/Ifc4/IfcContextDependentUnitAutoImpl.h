...
#ifndef _IFC4_IFCCONTEXTDEPENDENTUNIT_AUTO_IMPL_H
#define _IFC4_IFCCONTEXTDEPENDENTUNIT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcContextDependentUnit : public IfcNamedUnit
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcContextDependentUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcContextDependentUnit, IfcContextDependentUnit> object.
*/
typedef OdSmartPtr<IfcContextDependentUnit> IfcContextDependentUnitPtr;

} // namespace

#endif // _IFC4_IFCCONTEXTDEPENDENTUNIT_AUTO_IMPL_H
