...
#ifndef _IFC4_IFCFLOWMETER_AUTO_IMPL_H
#define _IFC4_IFCFLOWMETER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFlowMeter : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFlowMeter);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFlowMeter, IfcFlowMeter> object.
*/
typedef OdSmartPtr<IfcFlowMeter> IfcFlowMeterPtr;

} // namespace

#endif // _IFC4_IFCFLOWMETER_AUTO_IMPL_H
