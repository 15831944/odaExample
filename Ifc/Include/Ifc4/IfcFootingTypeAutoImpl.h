...
#ifndef _IFC4_IFCFOOTINGTYPE_AUTO_IMPL_H
#define _IFC4_IFCFOOTINGTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFootingType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFootingType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFootingType, IfcFootingType> object.
*/
typedef OdSmartPtr<IfcFootingType> IfcFootingTypePtr;

} // namespace

#endif // _IFC4_IFCFOOTINGTYPE_AUTO_IMPL_H
