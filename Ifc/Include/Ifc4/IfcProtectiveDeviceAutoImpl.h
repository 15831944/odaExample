...
#ifndef _IFC4_IFCPROTECTIVEDEVICE_AUTO_IMPL_H
#define _IFC4_IFCPROTECTIVEDEVICE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcProtectiveDevice : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcProtectiveDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcProtectiveDevice, IfcProtectiveDevice> object.
*/
typedef OdSmartPtr<IfcProtectiveDevice> IfcProtectiveDevicePtr;

} // namespace

#endif // _IFC4_IFCPROTECTIVEDEVICE_AUTO_IMPL_H
