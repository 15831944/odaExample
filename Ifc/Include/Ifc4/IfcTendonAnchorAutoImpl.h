...
#ifndef _IFC4_IFCTENDONANCHOR_AUTO_IMPL_H
#define _IFC4_IFCTENDONANCHOR_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTendonAnchor : public IfcReinforcingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTendonAnchor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTendonAnchor, IfcTendonAnchor> object.
*/
typedef OdSmartPtr<IfcTendonAnchor> IfcTendonAnchorPtr;

} // namespace

#endif // _IFC4_IFCTENDONANCHOR_AUTO_IMPL_H
