...
#ifndef _IFC4_IFCCURRENCYRELATIONSHIP_AUTO_IMPL_H
#define _IFC4_IFCCURRENCYRELATIONSHIP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCurrencyRelationship : public IfcResourceLevelRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCurrencyRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCurrencyRelationship, IfcCurrencyRelationship> object.
*/
typedef OdSmartPtr<IfcCurrencyRelationship> IfcCurrencyRelationshipPtr;

} // namespace

#endif // _IFC4_IFCCURRENCYRELATIONSHIP_AUTO_IMPL_H
