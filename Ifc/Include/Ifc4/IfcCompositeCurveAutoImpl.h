...
#ifndef _IFC4_IFCCOMPOSITECURVE_AUTO_IMPL_H
#define _IFC4_IFCCOMPOSITECURVE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCompositeCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCompositeCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCompositeCurve, IfcCompositeCurve> object.
*/
typedef OdSmartPtr<IfcCompositeCurve> IfcCompositeCurvePtr;

} // namespace

#endif // _IFC4_IFCCOMPOSITECURVE_AUTO_IMPL_H
