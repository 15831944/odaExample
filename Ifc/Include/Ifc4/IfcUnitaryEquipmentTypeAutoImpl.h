...
#ifndef _IFC4_IFCUNITARYEQUIPMENTTYPE_AUTO_IMPL_H
#define _IFC4_IFCUNITARYEQUIPMENTTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcUnitaryEquipmentType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcUnitaryEquipmentType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcUnitaryEquipmentType, IfcUnitaryEquipmentType> object.
*/
typedef OdSmartPtr<IfcUnitaryEquipmentType> IfcUnitaryEquipmentTypePtr;

} // namespace

#endif // _IFC4_IFCUNITARYEQUIPMENTTYPE_AUTO_IMPL_H
