...
#ifndef _IFC4_IFCWINDOWSTYLE_AUTO_IMPL_H
#define _IFC4_IFCWINDOWSTYLE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcWindowStyle : public IfcTypeProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcWindowStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcWindowStyle, IfcWindowStyle> object.
*/
typedef OdSmartPtr<IfcWindowStyle> IfcWindowStylePtr;

} // namespace

#endif // _IFC4_IFCWINDOWSTYLE_AUTO_IMPL_H
