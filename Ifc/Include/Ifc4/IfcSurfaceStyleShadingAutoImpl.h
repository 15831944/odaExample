...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSurfaceStyleShading, IfcSurfaceStyleShading> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleShading> IfcSurfaceStyleShadingPtr;

} // namespace

#endif // _IFC4_IFCSURFACESTYLESHADING_AUTO_IMPL_H
