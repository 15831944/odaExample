...
#ifndef _IFC4_IFCMATERIALPROFILE_AUTO_IMPL_H
#define _IFC4_IFCMATERIALPROFILE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMaterialProfile : public IfcMaterialDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMaterialProfile);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMaterialProfile, IfcMaterialProfile> object.
*/
typedef OdSmartPtr<IfcMaterialProfile> IfcMaterialProfilePtr;

} // namespace

#endif // _IFC4_IFCMATERIALPROFILE_AUTO_IMPL_H
