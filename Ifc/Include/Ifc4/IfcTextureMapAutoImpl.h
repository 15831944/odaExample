...
#ifndef _IFC4_IFCTEXTUREMAP_AUTO_IMPL_H
#define _IFC4_IFCTEXTUREMAP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTextureMap : public IfcTextureCoordinate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTextureMap);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTextureMap, IfcTextureMap> object.
*/
typedef OdSmartPtr<IfcTextureMap> IfcTextureMapPtr;

} // namespace

#endif // _IFC4_IFCTEXTUREMAP_AUTO_IMPL_H
