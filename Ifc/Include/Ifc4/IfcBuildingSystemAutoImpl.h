...
#ifndef _IFC4_IFCBUILDINGSYSTEM_AUTO_IMPL_H
#define _IFC4_IFCBUILDINGSYSTEM_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBuildingSystem : public IfcSystem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBuildingSystem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBuildingSystem, IfcBuildingSystem> object.
*/
typedef OdSmartPtr<IfcBuildingSystem> IfcBuildingSystemPtr;

} // namespace

#endif // _IFC4_IFCBUILDINGSYSTEM_AUTO_IMPL_H
