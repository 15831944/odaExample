...
#ifndef _IFC4_IFCSPACE_AUTO_IMPL_H
#define _IFC4_IFCSPACE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSpace : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSpace);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSpace, IfcSpace> object.
*/
typedef OdSmartPtr<IfcSpace> IfcSpacePtr;

} // namespace

#endif // _IFC4_IFCSPACE_AUTO_IMPL_H
