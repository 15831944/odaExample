...
#ifndef _IFC4_IFCLIGHTFIXTURE_AUTO_IMPL_H
#define _IFC4_IFCLIGHTFIXTURE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcLightFixture : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcLightFixture);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcLightFixture, IfcLightFixture> object.
*/
typedef OdSmartPtr<IfcLightFixture> IfcLightFixturePtr;

} // namespace

#endif // _IFC4_IFCLIGHTFIXTURE_AUTO_IMPL_H
