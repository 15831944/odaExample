...
#ifndef _IFC4_IFCPROTECTIVEDEVICETYPE_AUTO_IMPL_H
#define _IFC4_IFCPROTECTIVEDEVICETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcProtectiveDeviceType : public IfcFlowControllerType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcProtectiveDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcProtectiveDeviceType, IfcProtectiveDeviceType> object.
*/
typedef OdSmartPtr<IfcProtectiveDeviceType> IfcProtectiveDeviceTypePtr;

} // namespace

#endif // _IFC4_IFCPROTECTIVEDEVICETYPE_AUTO_IMPL_H
