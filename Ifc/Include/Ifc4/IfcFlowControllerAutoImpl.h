...
#ifndef _IFC4_IFCFLOWCONTROLLER_AUTO_IMPL_H
#define _IFC4_IFCFLOWCONTROLLER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFlowController : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFlowController);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFlowController, IfcFlowController> object.
*/
typedef OdSmartPtr<IfcFlowController> IfcFlowControllerPtr;

} // namespace

#endif // _IFC4_IFCFLOWCONTROLLER_AUTO_IMPL_H
