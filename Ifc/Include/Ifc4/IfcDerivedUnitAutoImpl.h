...
#ifndef _IFC4_IFCDERIVEDUNIT_AUTO_IMPL_H
#define _IFC4_IFCDERIVEDUNIT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDerivedUnit : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDerivedUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDerivedUnit, IfcDerivedUnit> object.
*/
typedef OdSmartPtr<IfcDerivedUnit> IfcDerivedUnitPtr;

} // namespace

#endif // _IFC4_IFCDERIVEDUNIT_AUTO_IMPL_H
