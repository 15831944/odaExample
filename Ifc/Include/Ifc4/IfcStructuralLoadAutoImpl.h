...
#ifndef _IFC4_IFCSTRUCTURALLOAD_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALLOAD_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralLoad : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcStructuralLoad);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralLoad, IfcStructuralLoad> object.
*/
typedef OdSmartPtr<IfcStructuralLoad> IfcStructuralLoadPtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALLOAD_AUTO_IMPL_H
