...
#ifndef _IFC4_IFCREPRESENTATIONMAP_AUTO_IMPL_H
#define _IFC4_IFCREPRESENTATIONMAP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRepresentationMap : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRepresentationMap);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRepresentationMap, IfcRepresentationMap> object.
*/
typedef OdSmartPtr<IfcRepresentationMap> IfcRepresentationMapPtr;

} // namespace

#endif // _IFC4_IFCREPRESENTATIONMAP_AUTO_IMPL_H
