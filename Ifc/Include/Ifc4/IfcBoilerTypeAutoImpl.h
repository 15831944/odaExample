...
#ifndef _IFC4_IFCBOILERTYPE_AUTO_IMPL_H
#define _IFC4_IFCBOILERTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBoilerType : public IfcEnergyConversionDeviceType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBoilerType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBoilerType, IfcBoilerType> object.
*/
typedef OdSmartPtr<IfcBoilerType> IfcBoilerTypePtr;

} // namespace

#endif // _IFC4_IFCBOILERTYPE_AUTO_IMPL_H
