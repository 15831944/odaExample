...
#ifndef _IFC4_IFCMEASUREWITHUNIT_AUTO_IMPL_H
#define _IFC4_IFCMEASUREWITHUNIT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMeasureWithUnit : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMeasureWithUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMeasureWithUnit, IfcMeasureWithUnit> object.
*/
typedef OdSmartPtr<IfcMeasureWithUnit> IfcMeasureWithUnitPtr;

} // namespace

#endif // _IFC4_IFCMEASUREWITHUNIT_AUTO_IMPL_H
