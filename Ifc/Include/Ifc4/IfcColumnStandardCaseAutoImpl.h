...
#ifndef _IFC4_IFCCOLUMNSTANDARDCASE_AUTO_IMPL_H
#define _IFC4_IFCCOLUMNSTANDARDCASE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcColumnStandardCase : public IfcColumn
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcColumnStandardCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcColumnStandardCase, IfcColumnStandardCase> object.
*/
typedef OdSmartPtr<IfcColumnStandardCase> IfcColumnStandardCasePtr;

} // namespace

#endif // _IFC4_IFCCOLUMNSTANDARDCASE_AUTO_IMPL_H
