...
#ifndef _IFC4_IFCCOVERINGTYPE_AUTO_IMPL_H
#define _IFC4_IFCCOVERINGTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCoveringType : public IfcBuildingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCoveringType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCoveringType, IfcCoveringType> object.
*/
typedef OdSmartPtr<IfcCoveringType> IfcCoveringTypePtr;

} // namespace

#endif // _IFC4_IFCCOVERINGTYPE_AUTO_IMPL_H
