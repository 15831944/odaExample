...
#ifndef _IFC4_IFCCONVERSIONBASEDUNITWITHOFFSET_AUTO_IMPL_H
#define _IFC4_IFCCONVERSIONBASEDUNITWITHOFFSET_AUTO_IMPL_H
...
class IFC4_EXPORT IfcConversionBasedUnitWithOffset : public IfcConversionBasedUnit
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcConversionBasedUnitWithOffset);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcConversionBasedUnitWithOffset, IfcConversionBasedUnitWithOffset> object.
*/
typedef OdSmartPtr<IfcConversionBasedUnitWithOffset> IfcConversionBasedUnitWithOffsetPtr;

} // namespace

#endif // _IFC4_IFCCONVERSIONBASEDUNITWITHOFFSET_AUTO_IMPL_H
