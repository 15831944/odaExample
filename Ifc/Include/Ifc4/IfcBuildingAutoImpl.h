...
#ifndef _IFC4_IFCBUILDING_AUTO_IMPL_H
#define _IFC4_IFCBUILDING_AUTO_IMPL_H
...
*/
class IFC4_EXPORT IfcBuilding : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBuilding);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBuilding, IfcBuilding> object.
*/
typedef OdSmartPtr<IfcBuilding> IfcBuildingPtr;

} // namespace

#endif // _IFC4_IFCBUILDING_AUTO_IMPL_H
