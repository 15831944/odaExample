...
#ifndef _IFC4_IFCSIMPLEPROPERTYTEMPLATE_AUTO_IMPL_H
#define _IFC4_IFCSIMPLEPROPERTYTEMPLATE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSimplePropertyTemplate : public IfcPropertyTemplate
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSimplePropertyTemplate);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSimplePropertyTemplate, IfcSimplePropertyTemplate> object.
*/
typedef OdSmartPtr<IfcSimplePropertyTemplate> IfcSimplePropertyTemplatePtr;

} // namespace

#endif // _IFC4_IFCSIMPLEPROPERTYTEMPLATE_AUTO_IMPL_H
