...
#ifndef _IFC4_IFCRELASSOCIATESCONSTRAINT_AUTO_IMPL_H
#define _IFC4_IFCRELASSOCIATESCONSTRAINT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelAssociatesConstraint : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelAssociatesConstraint);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelAssociatesConstraint, IfcRelAssociatesConstraint> object.
*/
typedef OdSmartPtr<IfcRelAssociatesConstraint> IfcRelAssociatesConstraintPtr;

} // namespace

#endif // _IFC4_IFCRELASSOCIATESCONSTRAINT_AUTO_IMPL_H
