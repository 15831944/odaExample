...
#ifndef _IFC4_IFCAPPLICATION_AUTO_IMPL_H
#define _IFC4_IFCAPPLICATION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcApplication : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcApplication);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcApplication, IfcApplication> object.
*/
typedef OdSmartPtr<IfcApplication> IfcApplicationPtr;

} // namespace

#endif // _IFC4_IFCAPPLICATION_AUTO_IMPL_H
