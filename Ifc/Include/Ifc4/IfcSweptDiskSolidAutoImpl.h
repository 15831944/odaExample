...
#ifndef _IFC4_IFCSWEPTDISKSOLID_AUTO_IMPL_H
#define _IFC4_IFCSWEPTDISKSOLID_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSweptDiskSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSweptDiskSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSweptDiskSolid, IfcSweptDiskSolid> object.
*/
typedef OdSmartPtr<IfcSweptDiskSolid> IfcSweptDiskSolidPtr;

} // namespace

#endif // _IFC4_IFCSWEPTDISKSOLID_AUTO_IMPL_H
