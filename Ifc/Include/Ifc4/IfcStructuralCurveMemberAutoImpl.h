...
#ifndef _IFC4_IFCSTRUCTURALCURVEMEMBER_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALCURVEMEMBER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralCurveMember : public IfcStructuralMember
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStructuralCurveMember);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralCurveMember, IfcStructuralCurveMember> object.
*/
typedef OdSmartPtr<IfcStructuralCurveMember> IfcStructuralCurveMemberPtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALCURVEMEMBER_AUTO_IMPL_H
