...
#ifndef _IFC4_IFCELECTRICFLOWSTORAGEDEVICE_AUTO_IMPL_H
#define _IFC4_IFCELECTRICFLOWSTORAGEDEVICE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcElectricFlowStorageDevice : public IfcFlowStorageDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcElectricFlowStorageDevice);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcElectricFlowStorageDevice, IfcElectricFlowStorageDevice> object.
*/
typedef OdSmartPtr<IfcElectricFlowStorageDevice> IfcElectricFlowStorageDevicePtr;

} // namespace

#endif // _IFC4_IFCELECTRICFLOWSTORAGEDEVICE_AUTO_IMPL_H
