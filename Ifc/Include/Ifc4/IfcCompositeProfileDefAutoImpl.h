...
#ifndef _IFC4_IFCCOMPOSITEPROFILEDEF_AUTO_IMPL_H
#define _IFC4_IFCCOMPOSITEPROFILEDEF_AUTO_IMPL_H
...
class IFC4_EXPORT IfcCompositeProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCompositeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCompositeProfileDef, IfcCompositeProfileDef> object.
*/
typedef OdSmartPtr<IfcCompositeProfileDef> IfcCompositeProfileDefPtr;

} // namespace

#endif // _IFC4_IFCCOMPOSITEPROFILEDEF_AUTO_IMPL_H
