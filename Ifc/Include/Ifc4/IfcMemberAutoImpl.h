...
#ifndef _IFC4_IFCMEMBER_AUTO_IMPL_H
#define _IFC4_IFCMEMBER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMember : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMember);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMember, IfcMember> object.
*/
typedef OdSmartPtr<IfcMember> IfcMemberPtr;

} // namespace

#endif // _IFC4_IFCMEMBER_AUTO_IMPL_H
