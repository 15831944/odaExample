...
#ifndef _IFC4_IFCCURVESTYLE_AUTO_IMPL_H
#define _IFC4_IFCCURVESTYLE_AUTO_IMPL_H
...
/** \details
  ...
  \remarks
  Type changed from BOOLEAN to IfcBoolean.
*/
class IFC4_EXPORT IfcCurveStyle : public IfcPresentationStyle
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcCurveStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcCurveStyle, IfcCurveStyle> object.
*/
typedef OdSmartPtr<IfcCurveStyle> IfcCurveStylePtr;

} // namespace

#endif // _IFC4_IFCCURVESTYLE_AUTO_IMPL_H
