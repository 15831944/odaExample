...
#ifndef _IFC4_IFCRAMPFLIGHT_AUTO_IMPL_H
#define _IFC4_IFCRAMPFLIGHT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRampFlight : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRampFlight);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRampFlight, IfcRampFlight> object.
*/
typedef OdSmartPtr<IfcRampFlight> IfcRampFlightPtr;

} // namespace

#endif // _IFC4_IFCRAMPFLIGHT_AUTO_IMPL_H
