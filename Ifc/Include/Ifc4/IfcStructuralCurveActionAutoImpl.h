...
#ifndef _IFC4_IFCSTRUCTURALCURVEACTION_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALCURVEACTION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralCurveAction : public IfcStructuralAction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStructuralCurveAction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralCurveAction, IfcStructuralCurveAction> object.
*/
typedef OdSmartPtr<IfcStructuralCurveAction> IfcStructuralCurveActionPtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALCURVEACTION_AUTO_IMPL_H
