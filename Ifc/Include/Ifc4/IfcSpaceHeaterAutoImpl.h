...
#ifndef _IFC4_IFCSPACEHEATER_AUTO_IMPL_H
#define _IFC4_IFCSPACEHEATER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSpaceHeater : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSpaceHeater);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSpaceHeater, IfcSpaceHeater> object.
*/
typedef OdSmartPtr<IfcSpaceHeater> IfcSpaceHeaterPtr;

} // namespace

#endif // _IFC4_IFCSPACEHEATER_AUTO_IMPL_H
