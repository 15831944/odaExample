...
#ifndef _IFC4_IFCCONNECTEDFACESET_AUTO_IMPL_H
#define _IFC4_IFCCONNECTEDFACESET_AUTO_IMPL_H
...
class IFC4_EXPORT IfcConnectedFaceSet : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcConnectedFaceSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcConnectedFaceSet, IfcConnectedFaceSet> object.
*/
typedef OdSmartPtr<IfcConnectedFaceSet> IfcConnectedFaceSetPtr;

} // namespace

#endif // _IFC4_IFCCONNECTEDFACESET_AUTO_IMPL_H
