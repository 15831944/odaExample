...
#ifndef _IFC4_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
#define _IFC4_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSurfaceOfLinearExtrusion : public IfcSweptSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSurfaceOfLinearExtrusion);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSurfaceOfLinearExtrusion, IfcSurfaceOfLinearExtrusion> object.
*/
typedef OdSmartPtr<IfcSurfaceOfLinearExtrusion> IfcSurfaceOfLinearExtrusionPtr;

} // namespace

#endif // _IFC4_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
