...
#ifndef _IFC4_IFCCONNECTIONCURVEGEOMETRY_AUTO_IMPL_H
#define _IFC4_IFCCONNECTIONCURVEGEOMETRY_AUTO_IMPL_H
...
class IFC4_EXPORT IfcConnectionCurveGeometry : public IfcConnectionGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcConnectionCurveGeometry);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcConnectionCurveGeometry, IfcConnectionCurveGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionCurveGeometry> IfcConnectionCurveGeometryPtr;

} // namespace

#endif // _IFC4_IFCCONNECTIONCURVEGEOMETRY_AUTO_IMPL_H
