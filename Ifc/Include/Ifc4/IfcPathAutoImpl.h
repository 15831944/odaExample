...
#ifndef _IFC4_IFCPATH_AUTO_IMPL_H
#define _IFC4_IFCPATH_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPath : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcPath);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPath, IfcPath> object.
*/
typedef OdSmartPtr<IfcPath> IfcPathPtr;

} // namespace

#endif // _IFC4_IFCPATH_AUTO_IMPL_H
