...
#ifndef _IFC4_IFCSECTIONEDSPINE_AUTO_IMPL_H
#define _IFC4_IFCSECTIONEDSPINE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSectionedSpine : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSectionedSpine);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSectionedSpine, IfcSectionedSpine> object.
*/
typedef OdSmartPtr<IfcSectionedSpine> IfcSectionedSpinePtr;

} // namespace

#endif // _IFC4_IFCSECTIONEDSPINE_AUTO_IMPL_H
