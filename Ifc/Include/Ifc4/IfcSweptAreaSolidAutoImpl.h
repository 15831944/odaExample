...
#ifndef _IFC4_IFCSWEPTAREASOLID_AUTO_IMPL_H
#define _IFC4_IFCSWEPTAREASOLID_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSweptAreaSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcSweptAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSweptAreaSolid, IfcSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcSweptAreaSolid> IfcSweptAreaSolidPtr;

} // namespace

#endif // _IFC4_IFCSWEPTAREASOLID_AUTO_IMPL_H
