...
#ifndef _IFC4_IFCINDEXEDPOLYCURVE_AUTO_IMPL_H
#define _IFC4_IFCINDEXEDPOLYCURVE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcIndexedPolyCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcIndexedPolyCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcIndexedPolyCurve, IfcIndexedPolyCurve> object.
*/
typedef OdSmartPtr<IfcIndexedPolyCurve> IfcIndexedPolyCurvePtr;

} // namespace

#endif // _IFC4_IFCINDEXEDPOLYCURVE_AUTO_IMPL_H
