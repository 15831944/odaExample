...
#ifndef _IFC4_IFCRELCONNECTSWITHREALIZINGELEMENTS_AUTO_IMPL_H
#define _IFC4_IFCRELCONNECTSWITHREALIZINGELEMENTS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelConnectsWithRealizingElements : public IfcRelConnectsElements
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelConnectsWithRealizingElements);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelConnectsWithRealizingElements, IfcRelConnectsWithRealizingElements> object.
*/
typedef OdSmartPtr<IfcRelConnectsWithRealizingElements> IfcRelConnectsWithRealizingElementsPtr;

} // namespace

#endif // _IFC4_IFCRELCONNECTSWITHREALIZINGELEMENTS_AUTO_IMPL_H
