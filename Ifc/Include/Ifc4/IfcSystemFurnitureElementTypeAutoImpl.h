...
#ifndef _IFC4_IFCSYSTEMFURNITUREELEMENTTYPE_AUTO_IMPL_H
#define _IFC4_IFCSYSTEMFURNITUREELEMENTTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSystemFurnitureElementType : public IfcFurnishingElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcSystemFurnitureElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSystemFurnitureElementType, IfcSystemFurnitureElementType> object.
*/
typedef OdSmartPtr<IfcSystemFurnitureElementType> IfcSystemFurnitureElementTypePtr;

} // namespace

#endif // _IFC4_IFCSYSTEMFURNITUREELEMENTTYPE_AUTO_IMPL_H
