...
#ifndef _IFC4_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
#define _IFC4_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRelServicesBuildings : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRelServicesBuildings);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRelServicesBuildings, IfcRelServicesBuildings> object.
*/
typedef OdSmartPtr<IfcRelServicesBuildings> IfcRelServicesBuildingsPtr;

} // namespace

#endif // _IFC4_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
