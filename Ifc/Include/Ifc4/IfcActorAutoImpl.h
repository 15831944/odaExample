...
#ifndef _IFC4_IFCACTOR_AUTO_IMPL_H
#define _IFC4_IFCACTOR_AUTO_IMPL_H
...
class IFC4_EXPORT IfcActor : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcActor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcActor, IfcActor> object.
*/
typedef OdSmartPtr<IfcActor> IfcActorPtr;

} // namespace

#endif // _IFC4_IFCACTOR_AUTO_IMPL_H
