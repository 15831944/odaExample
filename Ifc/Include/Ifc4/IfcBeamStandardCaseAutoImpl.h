...
#ifndef _IFC4_IFCBEAMSTANDARDCASE_AUTO_IMPL_H
#define _IFC4_IFCBEAMSTANDARDCASE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcBeamStandardCase : public IfcBeam
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcBeamStandardCase);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcBeamStandardCase, IfcBeamStandardCase> object.
*/
typedef OdSmartPtr<IfcBeamStandardCase> IfcBeamStandardCasePtr;

} // namespace

#endif // _IFC4_IFCBEAMSTANDARDCASE_AUTO_IMPL_H
