...
#ifndef _IFC4_IFCSTACKTERMINALTYPE_AUTO_IMPL_H
#define _IFC4_IFCSTACKTERMINALTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStackTerminalType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStackTerminalType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStackTerminalType, IfcStackTerminalType> object.
*/
typedef OdSmartPtr<IfcStackTerminalType> IfcStackTerminalTypePtr;

} // namespace

#endif // _IFC4_IFCSTACKTERMINALTYPE_AUTO_IMPL_H
