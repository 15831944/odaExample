...
#ifndef _IFC4_IFCMIRROREDPROFILEDEF_AUTO_IMPL_H
#define _IFC4_IFCMIRROREDPROFILEDEF_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMirroredProfileDef : public IfcDerivedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMirroredProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMirroredProfileDef, IfcMirroredProfileDef> object.
*/
typedef OdSmartPtr<IfcMirroredProfileDef> IfcMirroredProfileDefPtr;

} // namespace

#endif // _IFC4_IFCMIRROREDPROFILEDEF_AUTO_IMPL_H
