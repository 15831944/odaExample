...
#ifndef _IFC4_IFCFAN_AUTO_IMPL_H
#define _IFC4_IFCFAN_AUTO_IMPL_H
...
class IFC4_EXPORT IfcFan : public IfcFlowMovingDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcFan);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcFan, IfcFan> object.
*/
typedef OdSmartPtr<IfcFan> IfcFanPtr;

} // namespace

#endif // _IFC4_IFCFAN_AUTO_IMPL_H
