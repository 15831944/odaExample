...
#ifndef _IFC4_IFCSTRUCTURALLINEARACTION_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALLINEARACTION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralLinearAction : public IfcStructuralCurveAction
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStructuralLinearAction);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralLinearAction, IfcStructuralLinearAction> object.
*/
typedef OdSmartPtr<IfcStructuralLinearAction> IfcStructuralLinearActionPtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALLINEARACTION_AUTO_IMPL_H
