...
#ifndef _IFC4_IFCPREDEFINEDTEXTFONT_AUTO_IMPL_H
#define _IFC4_IFCPREDEFINEDTEXTFONT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcPreDefinedTextFont : public IfcPreDefinedItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcPreDefinedTextFont);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcPreDefinedTextFont, IfcPreDefinedTextFont> object.
*/
typedef OdSmartPtr<IfcPreDefinedTextFont> IfcPreDefinedTextFontPtr;

} // namespace

#endif // _IFC4_IFCPREDEFINEDTEXTFONT_AUTO_IMPL_H
