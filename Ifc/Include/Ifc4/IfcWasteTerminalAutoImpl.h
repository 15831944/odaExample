...
#ifndef _IFC4_IFCWASTETERMINAL_AUTO_IMPL_H
#define _IFC4_IFCWASTETERMINAL_AUTO_IMPL_H
...
class IFC4_EXPORT IfcWasteTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcWasteTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcWasteTerminal, IfcWasteTerminal> object.
*/
typedef OdSmartPtr<IfcWasteTerminal> IfcWasteTerminalPtr;

} // namespace

#endif // _IFC4_IFCWASTETERMINAL_AUTO_IMPL_H
