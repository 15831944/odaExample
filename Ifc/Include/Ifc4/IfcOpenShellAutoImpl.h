...
#ifndef _IFC4_IFCOPENSHELL_AUTO_IMPL_H
#define _IFC4_IFCOPENSHELL_AUTO_IMPL_H
...
class IFC4_EXPORT IfcOpenShell : public IfcConnectedFaceSet
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcOpenShell);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcOpenShell, IfcOpenShell> object.
*/
typedef OdSmartPtr<IfcOpenShell> IfcOpenShellPtr;

} // namespace

#endif // _IFC4_IFCOPENSHELL_AUTO_IMPL_H
