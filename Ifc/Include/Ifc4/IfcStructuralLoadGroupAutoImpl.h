...
#ifndef _IFC4_IFCSTRUCTURALLOADGROUP_AUTO_IMPL_H
#define _IFC4_IFCSTRUCTURALLOADGROUP_AUTO_IMPL_H
...
class IFC4_EXPORT IfcStructuralLoadGroup : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcStructuralLoadGroup);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcStructuralLoadGroup, IfcStructuralLoadGroup> object.
*/
typedef OdSmartPtr<IfcStructuralLoadGroup> IfcStructuralLoadGroupPtr;

} // namespace

#endif // _IFC4_IFCSTRUCTURALLOADGROUP_AUTO_IMPL_H
