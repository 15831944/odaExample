...
#ifndef _IFC4_IFCCLASSIFICATION_AUTO_IMPL_H
#define _IFC4_IFCCLASSIFICATION_AUTO_IMPL_H
...
class IFC4_EXPORT IfcClassification : public IfcExternalInformation
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcClassification);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcClassification, IfcClassification> object.
*/
typedef OdSmartPtr<IfcClassification> IfcClassificationPtr;

} // namespace

#endif // _IFC4_IFCCLASSIFICATION_AUTO_IMPL_H
