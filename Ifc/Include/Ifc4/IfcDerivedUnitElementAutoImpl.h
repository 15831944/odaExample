...
#ifndef _IFC4_IFCDERIVEDUNITELEMENT_AUTO_IMPL_H
#define _IFC4_IFCDERIVEDUNITELEMENT_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDerivedUnitElement : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDerivedUnitElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDerivedUnitElement, IfcDerivedUnitElement> object.
*/
typedef OdSmartPtr<IfcDerivedUnitElement> IfcDerivedUnitElementPtr;

} // namespace

#endif // _IFC4_IFCDERIVEDUNITELEMENT_AUTO_IMPL_H
