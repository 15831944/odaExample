...
#ifndef _IFC4_IFCWINDOW_AUTO_IMPL_H
#define _IFC4_IFCWINDOW_AUTO_IMPL_H
...
class IFC4_EXPORT IfcWindow : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcWindow);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcWindow, IfcWindow> object.
*/
typedef OdSmartPtr<IfcWindow> IfcWindowPtr;

} // namespace

#endif // _IFC4_IFCWINDOW_AUTO_IMPL_H
