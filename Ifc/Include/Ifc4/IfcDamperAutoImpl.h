...
#ifndef _IFC4_IFCDAMPER_AUTO_IMPL_H
#define _IFC4_IFCDAMPER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDamper : public IfcFlowController
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcDamper);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDamper, IfcDamper> object.
*/
typedef OdSmartPtr<IfcDamper> IfcDamperPtr;

} // namespace

#endif // _IFC4_IFCDAMPER_AUTO_IMPL_H
