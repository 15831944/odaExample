...
#ifndef _IFC4_IFCRECTANGULARTRIMMEDSURFACE_AUTO_IMPL_H
#define _IFC4_IFCRECTANGULARTRIMMEDSURFACE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcRectangularTrimmedSurface : public IfcBoundedSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcRectangularTrimmedSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcRectangularTrimmedSurface, IfcRectangularTrimmedSurface> object.
*/
typedef OdSmartPtr<IfcRectangularTrimmedSurface> IfcRectangularTrimmedSurfacePtr;

} // namespace

#endif // _IFC4_IFCRECTANGULARTRIMMEDSURFACE_AUTO_IMPL_H
