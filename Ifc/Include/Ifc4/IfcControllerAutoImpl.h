...
#ifndef _IFC4_IFCCONTROLLER_AUTO_IMPL_H
#define _IFC4_IFCCONTROLLER_AUTO_IMPL_H
...
class IFC4_EXPORT IfcController : public IfcDistributionControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcController);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcController, IfcController> object.
*/
typedef OdSmartPtr<IfcController> IfcControllerPtr;

} // namespace

#endif // _IFC4_IFCCONTROLLER_AUTO_IMPL_H
