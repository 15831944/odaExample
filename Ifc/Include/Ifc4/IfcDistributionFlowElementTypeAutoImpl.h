...
#ifndef _IFC4_IFCDISTRIBUTIONFLOWELEMENTTYPE_AUTO_IMPL_H
#define _IFC4_IFCDISTRIBUTIONFLOWELEMENTTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcDistributionFlowElementType : public IfcDistributionElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcDistributionFlowElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcDistributionFlowElementType, IfcDistributionFlowElementType> object.
*/
typedef OdSmartPtr<IfcDistributionFlowElementType> IfcDistributionFlowElementTypePtr;

} // namespace

#endif // _IFC4_IFCDISTRIBUTIONFLOWELEMENTTYPE_AUTO_IMPL_H
