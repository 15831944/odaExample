...
#ifndef _IFC4_IFCSPATIALSTRUCTUREELEMENTTYPE_AUTO_IMPL_H
#define _IFC4_IFCSPATIALSTRUCTUREELEMENTTYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcSpatialStructureElementType : public IfcSpatialElementType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc4::IfcSpatialStructureElementType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcSpatialStructureElementType, IfcSpatialStructureElementType> object.
*/
typedef OdSmartPtr<IfcSpatialStructureElementType> IfcSpatialStructureElementTypePtr;

} // namespace

#endif // _IFC4_IFCSPATIALSTRUCTUREELEMENTTYPE_AUTO_IMPL_H
