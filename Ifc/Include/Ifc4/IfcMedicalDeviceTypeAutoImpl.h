...
#ifndef _IFC4_IFCMEDICALDEVICETYPE_AUTO_IMPL_H
#define _IFC4_IFCMEDICALDEVICETYPE_AUTO_IMPL_H
...
class IFC4_EXPORT IfcMedicalDeviceType : public IfcFlowTerminalType
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcMedicalDeviceType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcMedicalDeviceType, IfcMedicalDeviceType> object.
*/
typedef OdSmartPtr<IfcMedicalDeviceType> IfcMedicalDeviceTypePtr;

} // namespace

#endif // _IFC4_IFCMEDICALDEVICETYPE_AUTO_IMPL_H
