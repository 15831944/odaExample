...
#ifndef _IFC4_IFCTRAPEZIUMPROFILEDEF_AUTO_IMPL_H
#define _IFC4_IFCTRAPEZIUMPROFILEDEF_AUTO_IMPL_H
...
class IFC4_EXPORT IfcTrapeziumProfileDef : public IfcParameterizedProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc4::IfcTrapeziumProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc4::IfcTrapeziumProfileDef, IfcTrapeziumProfileDef> object.
*/
typedef OdSmartPtr<IfcTrapeziumProfileDef> IfcTrapeziumProfileDefPtr;

} // namespace

#endif // _IFC4_IFCTRAPEZIUMPROFILEDEF_AUTO_IMPL_H
