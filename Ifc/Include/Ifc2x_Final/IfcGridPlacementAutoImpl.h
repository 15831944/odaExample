...
#ifndef _IFC2X_FINAL_IFCGRIDPLACEMENT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCGRIDPLACEMENT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcGridPlacement : public IfcObjectPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcGridPlacement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcGridPlacement, IfcGridPlacement> object.
*/
typedef OdSmartPtr<IfcGridPlacement> IfcGridPlacementPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCGRIDPLACEMENT_AUTO_IMPL_H
