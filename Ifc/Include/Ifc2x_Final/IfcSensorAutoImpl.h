...
#ifndef _IFC2X_FINAL_IFCSENSOR_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSENSOR_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSensor : public IfcControlElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcSensor);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSensor, IfcSensor> object.
*/
typedef OdSmartPtr<IfcSensor> IfcSensorPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSENSOR_AUTO_IMPL_H
