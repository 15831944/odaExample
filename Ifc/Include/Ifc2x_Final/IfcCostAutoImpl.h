...
#ifndef _IFC2X_FINAL_IFCCOST_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCOST_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCost : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCost);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& quantities();
...
protected:
  // Fields declaration: 
  OdAnsiString m_ContextDescription;   // IfcLabel
  OdDAIObjectId m_ElementCost;   // IfcCostValue  [optional]
  OdDAIObjectId m_ExtensionCost;   // IfcCostValue  [optional]
  OdDAI::Enum m_CostUse;   // IfcCostUseEnum
  OdDAIObjectId m_PreparedOn;   // IfcCalendarDate  [optional]
  OdDAI::OdDAIObjectIdList m_Quantities; // LIST [1:?] of IfcCostQuantity [optional]

  OdAnsiString m_CostType;   // IfcLabel
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCost, IfcCost> object.
*/
typedef OdSmartPtr<IfcCost> IfcCostPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCOST_AUTO_IMPL_H
