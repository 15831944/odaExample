...
#ifndef _IFC2X_FINAL_IFCLOCALPLACEMENT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCLOCALPLACEMENT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcLocalPlacement : public IfcObjectPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcLocalPlacement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcLocalPlacement, IfcLocalPlacement> object.
*/
typedef OdSmartPtr<IfcLocalPlacement> IfcLocalPlacementPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCLOCALPLACEMENT_AUTO_IMPL_H
