...
#ifndef _IFC2X_FINAL_IFCELEMENTARYSURFACE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCELEMENTARYSURFACE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcElementarySurface : public IfcSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcElementarySurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcElementarySurface, IfcElementarySurface> object.
*/
typedef OdSmartPtr<IfcElementarySurface> IfcElementarySurfacePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCELEMENTARYSURFACE_AUTO_IMPL_H
