...
#ifndef _IFC2X_FINAL_IFCBOOLEANRESULT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCBOOLEANRESULT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcBooleanResult : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcBooleanResult);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcBooleanResult, IfcBooleanResult> object.
*/
typedef OdSmartPtr<IfcBooleanResult> IfcBooleanResultPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCBOOLEANRESULT_AUTO_IMPL_H
