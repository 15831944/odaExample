...
#ifndef _IFC2X_FINAL_IFCCOSTMODIFIERVALUE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCOSTMODIFIERVALUE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCostModifierValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCostModifierValue);
  //DOM-IGNORE-END
...
public:
  ...
  double getModifierAmount() const;
...
protected:
  // Fields declaration: 
  double m_ModifierAmount;   // IfcMonetaryMeasure
  OdDAI::Enum m_Currency;   // IfcCurrencyEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCostModifierValue, IfcCostModifierValue> object.
*/
typedef OdSmartPtr<IfcCostModifierValue> IfcCostModifierValuePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCOSTMODIFIERVALUE_AUTO_IMPL_H
