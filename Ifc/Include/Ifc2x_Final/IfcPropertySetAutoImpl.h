...
#ifndef _IFC2X_FINAL_IFCPROPERTYSET_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPROPERTYSET_AUTO_IMPL_H
...
*/
class IFC2X_FINAL_EXPORT IfcPropertySet : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcPropertySet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPropertySet, IfcPropertySet> object.
*/
typedef OdSmartPtr<IfcPropertySet> IfcPropertySetPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPROPERTYSET_AUTO_IMPL_H
