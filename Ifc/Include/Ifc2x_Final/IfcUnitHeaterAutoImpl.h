...
#ifndef _IFC2X_FINAL_IFCUNITHEATER_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCUNITHEATER_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcUnitHeater : public IfcHeatTransferDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcUnitHeater);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcUnitHeater, IfcUnitHeater> object.
*/
typedef OdSmartPtr<IfcUnitHeater> IfcUnitHeaterPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCUNITHEATER_AUTO_IMPL_H
