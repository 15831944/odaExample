...
#ifndef _IFC2X_FINAL_IFCCLASSIFICATIONNOTATION_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCLASSIFICATIONNOTATION_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcClassificationNotation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcClassificationNotation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcClassificationNotation, IfcClassificationNotation> object.
*/
typedef OdSmartPtr<IfcClassificationNotation> IfcClassificationNotationPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCLASSIFICATIONNOTATION_AUTO_IMPL_H
