...
#ifndef _IFC2X_FINAL_IFCPHYSICALQUANTITY_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPHYSICALQUANTITY_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcPhysicalQuantity : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcPhysicalQuantity);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPhysicalQuantity, IfcPhysicalQuantity> object.
*/
typedef OdSmartPtr<IfcPhysicalQuantity> IfcPhysicalQuantityPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPHYSICALQUANTITY_AUTO_IMPL_H
