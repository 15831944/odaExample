...
#ifndef _IFC2X_FINAL_IFCREFERENCEVERTEX_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCREFERENCEVERTEX_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcReferenceVertex : public IfcReferenceGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcReferenceVertex);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getVertex() const;
  void setVertex(const OdDAIObjectId& Vertex);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Vertex;   // IfcVertex
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcReferenceVertex, IfcReferenceVertex> object.
*/
typedef OdSmartPtr<IfcReferenceVertex> IfcReferenceVertexPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCREFERENCEVERTEX_AUTO_IMPL_H
