...
#ifndef _IFC2X_FINAL_IFCTRAPEZIUMPROFILEDEF_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCTRAPEZIUMPROFILEDEF_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcTrapeziumProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcTrapeziumProfileDef);
  //DOM-IGNORE-END
...
public:
  ...
  double getBottomXDim() const;
  void setBottomXDim(double BottomXDim);
  double getTopXDim() const;
  void setTopXDim(double TopXDim);
  double getYDim() const;
  void setYDim(double YDim);
  double getTopXOffset() const;
...
protected:
  ...
  IfcPositiveLengthMeasure m_BottomXDim;   // IfcPositiveLengthMeasure
  IfcPositiveLengthMeasure m_TopXDim;   // IfcPositiveLengthMeasure
  IfcPositiveLengthMeasure m_YDim;   // IfcPositiveLengthMeasure
  double m_TopXOffset;   // IfcLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcTrapeziumProfileDef, IfcTrapeziumProfileDef> object.
*/
typedef OdSmartPtr<IfcTrapeziumProfileDef> IfcTrapeziumProfileDefPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCTRAPEZIUMPROFILEDEF_AUTO_IMPL_H
