...
#ifndef _IFC2X_FINAL_IFCRELASSIGNSTOGROUP_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRELASSIGNSTOGROUP_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRelAssignsToGroup : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRelAssignsToGroup);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRelAssignsToGroup, IfcRelAssignsToGroup> object.
*/
typedef OdSmartPtr<IfcRelAssignsToGroup> IfcRelAssignsToGroupPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRELASSIGNSTOGROUP_AUTO_IMPL_H
