...
#ifndef _IFC2X_FINAL_IFCLABORRESOURCE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCLABORRESOURCE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcLaborResource : public IfcResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcLaborResource);
  //DOM-IGNORE-END
...
public:
  ...
  void getSkillSet(OdArray<OdAnsiString >& SkillSet) const;
  OdDAI::OdAnsiStringSet& skillSet();
...
protected:
  ...
  OdDAI::OdAnsiStringSet m_SkillSet; // SET [1:?] of IfcLabel [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcLaborResource, IfcLaborResource> object.
*/
typedef OdSmartPtr<IfcLaborResource> IfcLaborResourcePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCLABORRESOURCE_AUTO_IMPL_H
