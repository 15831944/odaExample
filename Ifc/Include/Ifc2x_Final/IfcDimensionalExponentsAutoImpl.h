...
#ifndef _IFC2X_FINAL_IFCDIMENSIONALEXPONENTS_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCDIMENSIONALEXPONENTS_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcDimensionalExponents : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcDimensionalExponents);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcDimensionalExponents, IfcDimensionalExponents> object.
*/
typedef OdSmartPtr<IfcDimensionalExponents> IfcDimensionalExponentsPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCDIMENSIONALEXPONENTS_AUTO_IMPL_H
