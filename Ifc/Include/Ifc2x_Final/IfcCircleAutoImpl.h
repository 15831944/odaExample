...
#ifndef _IFC2X_FINAL_IFCCIRCLE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCIRCLE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCircle : public IfcConic
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCircle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCircle, IfcCircle> object.
*/
typedef OdSmartPtr<IfcCircle> IfcCirclePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCIRCLE_AUTO_IMPL_H
