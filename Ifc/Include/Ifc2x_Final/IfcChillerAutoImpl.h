...
#ifndef _IFC2X_FINAL_IFCCHILLER_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCHILLER_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcChiller : public IfcHeatTransferDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcChiller);
  //DOM-IGNORE-END
...
public:
  ...
  IfcChillerTypeEnum getChillerType() const;
  void setChillerType(IfcChillerTypeEnum ChillerType);
  double getNominalCoolingCapacity() const;
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_ChillerType;   // IfcChillerTypeEnum
  double m_NominalCoolingCapacity;   // IfcPowerMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcChiller, IfcChiller> object.
*/
typedef OdSmartPtr<IfcChiller> IfcChillerPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCHILLER_AUTO_IMPL_H
