...
#ifndef _IFC2X_FINAL_IFCACTIONTIMECONTROL_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCACTIONTIMECONTROL_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcActionTimeControl : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcActionTimeControl);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getConstraintType() const;
  void setConstraintType(const OdAnsiString& ConstraintType);
  IfcDateTimeSelect contraintTime();
...
protected:
  // Fields declaration: 
  OdAnsiString m_ConstraintType;   // IfcLabel
  OdDAI::Select m_ContraintTime;   // IfcDateTimeSelect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcActionTimeControl, IfcActionTimeControl> object.
*/
typedef OdSmartPtr<IfcActionTimeControl> IfcActionTimeControlPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCACTIONTIMECONTROL_AUTO_IMPL_H
