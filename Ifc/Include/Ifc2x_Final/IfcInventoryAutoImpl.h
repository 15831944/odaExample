...
#ifndef _IFC2X_FINAL_IFCINVENTORY_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCINVENTORY_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcInventory : public IfcGroup
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcInventory);
  //DOM-IGNORE-END
...
public:
  ...
  IfcInventoryTypeEnum getDefinedType() const;
  void setDefinedType(IfcInventoryTypeEnum DefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_DefinedType;   // IfcInventoryTypeEnum
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcInventory, IfcInventory> object.
*/
typedef OdSmartPtr<IfcInventory> IfcInventoryPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCINVENTORY_AUTO_IMPL_H
