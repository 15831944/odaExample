...
#ifndef _IFC2X_FINAL_IFCELLIPSEPROFILEDEF_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCELLIPSEPROFILEDEF_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcEllipseProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcEllipseProfileDef);
  //DOM-IGNORE-END
...
public:
  ...
  void setSemiAxis1(double SemiAxis1);
  double getSemiAxis2() const;
  void setSemiAxis2(double SemiAxis2);
...
protected:
  ...
  IfcPositiveLengthMeasure m_SemiAxis1;   // IfcPositiveLengthMeasure
  IfcPositiveLengthMeasure m_SemiAxis2;   // IfcPositiveLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcEllipseProfileDef, IfcEllipseProfileDef> object.
*/
typedef OdSmartPtr<IfcEllipseProfileDef> IfcEllipseProfileDefPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCELLIPSEPROFILEDEF_AUTO_IMPL_H
