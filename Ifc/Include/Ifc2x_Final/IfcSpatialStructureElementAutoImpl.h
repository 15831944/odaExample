...
#ifndef _IFC2X_FINAL_IFCSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSpatialStructureElement : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcSpatialStructureElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSpatialStructureElement, IfcSpatialStructureElement> object.
*/
typedef OdSmartPtr<IfcSpatialStructureElement> IfcSpatialStructureElementPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSPATIALSTRUCTUREELEMENT_AUTO_IMPL_H
