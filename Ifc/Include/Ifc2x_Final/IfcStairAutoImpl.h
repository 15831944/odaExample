...
#ifndef _IFC2X_FINAL_IFCSTAIR_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSTAIR_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcStair : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcStair);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcStair, IfcStair> object.
*/
typedef OdSmartPtr<IfcStair> IfcStairPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSTAIR_AUTO_IMPL_H
