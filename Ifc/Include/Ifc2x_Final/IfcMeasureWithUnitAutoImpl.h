...
#ifndef _IFC2X_FINAL_IFCMEASUREWITHUNIT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCMEASUREWITHUNIT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcMeasureWithUnit : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcMeasureWithUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcMeasureWithUnit, IfcMeasureWithUnit> object.
*/
typedef OdSmartPtr<IfcMeasureWithUnit> IfcMeasureWithUnitPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCMEASUREWITHUNIT_AUTO_IMPL_H
