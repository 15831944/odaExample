...
#ifndef _IFC2X_FINAL_IFCPROPERTYENUMERATION_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPROPERTYENUMERATION_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcPropertyEnumeration : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcPropertyEnumeration);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPropertyEnumeration, IfcPropertyEnumeration> object.
*/
typedef OdSmartPtr<IfcPropertyEnumeration> IfcPropertyEnumerationPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPROPERTYENUMERATION_AUTO_IMPL_H
