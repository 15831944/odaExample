...
#ifndef _IFC2X_FINAL_IFCRELFILLSELEMENT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRELFILLSELEMENT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRelFillsElement : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRelFillsElement);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatingOpeningElement() const;
  void setRelatingOpeningElement(const OdDAIObjectId& RelatingOpeningElement);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatingOpeningElement;   // IfcOpeningElement
  OdDAIObjectId m_RelatedBuildingElement;   // IfcBuildingElement
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRelFillsElement, IfcRelFillsElement> object.
*/
typedef OdSmartPtr<IfcRelFillsElement> IfcRelFillsElementPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRELFILLSELEMENT_AUTO_IMPL_H
