...
public:
  ...
  OdDAI::DoubleList& tubeFluidEnteringTemperature();
  void getTubeFluidLeavingTemperature(OdArray<double >& TubeFluidLeavingTemperature) const;
  OdDAI::DoubleList& tubeFluidLeavingTemperature();
  ...
  OdDAI::DoubleList& shellFluidLeavingTemperature();
  void getShellFluidEnteringTemperature(OdArray<double >& ShellFluidEnteringTemperature) const;
  OdDAI::DoubleList& shellFluidEnteringTemperature();
...
protected:
  ...
  OdDAI::DoubleList m_TubeFluidEnteringTemperature; // LIST [1:2] of IfcThermodynamicTemperatureMeasure [optional]

  OdDAI::DoubleList m_TubeFluidLeavingTemperature; // LIST [1:2] of IfcThermodynamicTemperatureMeasure [optional]
  ...
  OdDAI::DoubleList m_ShellFluidLeavingTemperature; // LIST [1:2] of IfcThermodynamicTemperatureMeasure [optional]

  OdDAI::DoubleList m_ShellFluidEnteringTemperature; // LIST [1:2] of IfcThermodynamicTemperatureMeasure [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcTubeBundle, IfcTubeBundle> object.
*/
typedef OdSmartPtr<IfcTubeBundle> IfcTubeBundlePtr;
