...
#ifndef _IFC2X_FINAL_IFCRAMP_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRAMP_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRamp : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRamp);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRamp, IfcRamp> object.
*/
typedef OdSmartPtr<IfcRamp> IfcRampPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRAMP_AUTO_IMPL_H
