...
#ifndef _IFC2X_FINAL_IFCELEMENTQUANTITY_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCELEMENTQUANTITY_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcElementQuantity : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcElementQuantity);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_MethodOfMeasurement;   // IfcLabel
  OdDAI::OdDAIObjectIdSet m_Quantities; // SET [1:?] of IfcPhysicalQuantity
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcElementQuantity, IfcElementQuantity> object.
*/
typedef OdSmartPtr<IfcElementQuantity> IfcElementQuantityPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCELEMENTQUANTITY_AUTO_IMPL_H
