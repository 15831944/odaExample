...
#ifndef _IFC2X_FINAL_IFCFACESURFACE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCFACESURFACE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcFaceSurface : public IfcFace
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcFaceSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcFaceSurface, IfcFaceSurface> object.
*/
typedef OdSmartPtr<IfcFaceSurface> IfcFaceSurfacePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCFACESURFACE_AUTO_IMPL_H
