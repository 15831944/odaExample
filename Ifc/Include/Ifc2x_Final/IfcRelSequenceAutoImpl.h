...
#ifndef _IFC2X_FINAL_IFCRELSEQUENCE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRELSEQUENCE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRelSequence : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRelSequence);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRelSequence, IfcRelSequence> object.
*/
typedef OdSmartPtr<IfcRelSequence> IfcRelSequencePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRELSEQUENCE_AUTO_IMPL_H
