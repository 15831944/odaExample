...
#ifndef _IFC2X_FINAL_IFCPRESENTATIONLIGHTSOURCE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPRESENTATIONLIGHTSOURCE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcPresentationLightSource : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcPresentationLightSource);
  //DOM-IGNORE-END
...
public:
  ...
  void getColor(OdArray<double >& Color) const;
  OdDAI::DoubleList& color();
  double getAmbientIntensity() const;
  void setAmbientIntensity(double AmbientIntensity);
  double getIntensity() const;
  void setIntensity(double Intensity);
  const OdDAIObjectId& getInContext() const;
  void setInContext(const OdDAIObjectId& InContext);
...
protected:
  // Fields declaration: 
  OdDAI::DoubleList m_Color; // IfcColorRGB
  IfcNormalisedRatioMeasure m_AmbientIntensity;   // IfcNormalisedRatioMeasure
  IfcNormalisedRatioMeasure m_Intensity;   // IfcNormalisedRatioMeasure
  OdDAIObjectId m_InContext;   // IfcGeometricRepresentationContext
  OdAnsiString m_Name;   // IfcLabel
  OdAnsiString m_Description;   // IfcText  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPresentationLightSource, IfcPresentationLightSource> object.
*/
typedef OdSmartPtr<IfcPresentationLightSource> IfcPresentationLightSourcePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPRESENTATIONLIGHTSOURCE_AUTO_IMPL_H
