...
#ifndef _IFC2X_FINAL_IFCVECTOR_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCVECTOR_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcVector : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcVector);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcVector, IfcVector> object.
*/
typedef OdSmartPtr<IfcVector> IfcVectorPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCVECTOR_AUTO_IMPL_H
