...
#ifndef _IFC2X_FINAL_IFCCONIC_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCONIC_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcConic : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcConic);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcConic, IfcConic> object.
*/
typedef OdSmartPtr<IfcConic> IfcConicPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCONIC_AUTO_IMPL_H
