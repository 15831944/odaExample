...
#ifndef _IFC2X_FINAL_IFCCOMPOSITECURVESEGMENT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCOMPOSITECURVESEGMENT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCompositeCurveSegment : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCompositeCurveSegment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCompositeCurveSegment, IfcCompositeCurveSegment> object.
*/
typedef OdSmartPtr<IfcCompositeCurveSegment> IfcCompositeCurveSegmentPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCOMPOSITECURVESEGMENT_AUTO_IMPL_H
