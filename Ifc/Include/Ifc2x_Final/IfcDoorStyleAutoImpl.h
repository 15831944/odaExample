...
#ifndef _IFC2X_FINAL_IFCDOORSTYLE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCDOORSTYLE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcDoorStyle : public IfcTypeProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcDoorStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcDoorStyle, IfcDoorStyle> object.
*/
typedef OdSmartPtr<IfcDoorStyle> IfcDoorStylePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCDOORSTYLE_AUTO_IMPL_H
