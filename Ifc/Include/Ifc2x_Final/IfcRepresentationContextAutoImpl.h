...
#ifndef _IFC2X_FINAL_IFCREPRESENTATIONCONTEXT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCREPRESENTATIONCONTEXT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRepresentationContext : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRepresentationContext);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRepresentationContext, IfcRepresentationContext> object.
*/
typedef OdSmartPtr<IfcRepresentationContext> IfcRepresentationContextPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCREPRESENTATIONCONTEXT_AUTO_IMPL_H
