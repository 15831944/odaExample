...
#ifndef _IFC2X_FINAL_IFCBOXEDHALFSPACE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCBOXEDHALFSPACE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcBoxedHalfSpace : public IfcHalfSpaceSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcBoxedHalfSpace);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcBoxedHalfSpace, IfcBoxedHalfSpace> object.
*/
typedef OdSmartPtr<IfcBoxedHalfSpace> IfcBoxedHalfSpacePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCBOXEDHALFSPACE_AUTO_IMPL_H
