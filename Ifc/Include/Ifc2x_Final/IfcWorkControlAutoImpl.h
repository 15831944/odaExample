...
#ifndef _IFC2X_FINAL_IFCWORKCONTROL_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCWORKCONTROL_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcWorkControl : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcWorkControl);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getCreationDate() const;
  void setCreationDate(const OdDAIObjectId& CreationDate);
  void getCreators(OdDAIObjectIds& Creators) const;
  OdDAI::OdDAIObjectIdSet& creators();
  ...
  const OdDAIObjectId& getStartTime() const;
  void setStartTime(const OdDAIObjectId& StartTime);
  const OdDAIObjectId& getFinishTime() const;
  void setFinishTime(const OdDAIObjectId& FinishTime);
...
protected:
  // Fields declaration: 
  OdAnsiString m_Identifier;   // IfcIdentifier
  OdDAIObjectId m_CreationDate;   // IfcCalendarDate
  OdDAI::OdDAIObjectIdSet m_Creators; // SET [1:?] of IfcPerson [optional]
  ...
  OdDAIObjectId m_StartTime;   // IfcCalendarDate
  OdDAIObjectId m_FinishTime;   // IfcCalendarDate  [optional]
  OdDAI::Enum m_WorkControlType;   // IfcWorkControlTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcWorkControl, IfcWorkControl> object.
*/
typedef OdSmartPtr<IfcWorkControl> IfcWorkControlPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCWORKCONTROL_AUTO_IMPL_H
