...
#ifndef _IFC2X_FINAL_IFCLINE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCLINE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcLine : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcLine);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcLine, IfcLine> object.
*/
typedef OdSmartPtr<IfcLine> IfcLinePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCLINE_AUTO_IMPL_H
