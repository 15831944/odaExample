...
#ifndef _IFC2X_FINAL_IFCSIUNIT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSIUNIT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSIUnit : public IfcNamedUnit
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcSIUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSIUnit, IfcSIUnit> object.
*/
typedef OdSmartPtr<IfcSIUnit> IfcSIUnitPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSIUNIT_AUTO_IMPL_H
