...
#ifndef _IFC2X_FINAL_IFCISHAPEPROFILEDEF_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCISHAPEPROFILEDEF_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcIshapeProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcIshapeProfileDef);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Position;   // IfcAxis2Placement2D
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcIshapeProfileDef, IfcIshapeProfileDef> object.
*/
typedef OdSmartPtr<IfcIshapeProfileDef> IfcIshapeProfileDefPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCISHAPEPROFILEDEF_AUTO_IMPL_H
