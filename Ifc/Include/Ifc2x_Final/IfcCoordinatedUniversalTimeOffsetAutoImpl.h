...
#ifndef _IFC2X_FINAL_IFCCOORDINATEDUNIVERSALTIMEOFFSET_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCOORDINATEDUNIVERSALTIMEOFFSET_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCoordinatedUniversalTimeOffset : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCoordinatedUniversalTimeOffset);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCoordinatedUniversalTimeOffset, IfcCoordinatedUniversalTimeOffset> object.
*/
typedef OdSmartPtr<IfcCoordinatedUniversalTimeOffset> IfcCoordinatedUniversalTimeOffsetPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCOORDINATEDUNIVERSALTIMEOFFSET_AUTO_IMPL_H
