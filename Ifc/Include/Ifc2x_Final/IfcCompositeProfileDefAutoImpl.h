...
#ifndef _IFC2X_FINAL_IFCCOMPOSITEPROFILEDEF_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCOMPOSITEPROFILEDEF_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCompositeProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCompositeProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCompositeProfileDef, IfcCompositeProfileDef> object.
*/
typedef OdSmartPtr<IfcCompositeProfileDef> IfcCompositeProfileDefPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCOMPOSITEPROFILEDEF_AUTO_IMPL_H
