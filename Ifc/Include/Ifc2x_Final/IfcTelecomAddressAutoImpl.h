...
#ifndef _IFC2X_FINAL_IFCTELECOMADDRESS_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCTELECOMADDRESS_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcTelecomAddress : public IfcAddress
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcTelecomAddress);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcTelecomAddress, IfcTelecomAddress> object.
*/
typedef OdSmartPtr<IfcTelecomAddress> IfcTelecomAddressPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCTELECOMADDRESS_AUTO_IMPL_H
