...
#ifndef _IFC2X_FINAL_IFCQUANTITYVOLUME_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCQUANTITYVOLUME_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcQuantityVolume : public IfcPhysicalQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcQuantityVolume);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcQuantityVolume, IfcQuantityVolume> object.
*/
typedef OdSmartPtr<IfcQuantityVolume> IfcQuantityVolumePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCQUANTITYVOLUME_AUTO_IMPL_H
