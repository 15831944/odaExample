...
#ifndef _IFC2X_FINAL_IFCVERTEXPOINT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCVERTEXPOINT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcVertexPoint : public IfcVertex
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcVertexPoint);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcVertexPoint, IfcVertexPoint> object.
*/
typedef OdSmartPtr<IfcVertexPoint> IfcVertexPointPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCVERTEXPOINT_AUTO_IMPL_H
