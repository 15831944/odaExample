...
#ifndef _IFC2X_FINAL_IFCCLASSIFICATIONNOTATIONFACET_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCLASSIFICATIONNOTATIONFACET_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcClassificationNotationFacet : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcClassificationNotationFacet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcClassificationNotationFacet, IfcClassificationNotationFacet> object.
*/
typedef OdSmartPtr<IfcClassificationNotationFacet> IfcClassificationNotationFacetPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCLASSIFICATIONNOTATIONFACET_AUTO_IMPL_H
