...
#ifndef _IFC2X_FINAL_IFCTRIMMEDCURVE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCTRIMMEDCURVE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcTrimmedCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcTrimmedCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcTrimmedCurve, IfcTrimmedCurve> object.
*/
typedef OdSmartPtr<IfcTrimmedCurve> IfcTrimmedCurvePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCTRIMMEDCURVE_AUTO_IMPL_H
