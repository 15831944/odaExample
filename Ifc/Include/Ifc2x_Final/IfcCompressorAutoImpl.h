...
#ifndef _IFC2X_FINAL_IFCCOMPRESSOR_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCOMPRESSOR_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCompressor : public IfcFluidMovingDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCompressor);
  //DOM-IGNORE-END
...
public:
  ...
  IfcCompressorTypeEnum getCompressorType() const;
  void setCompressorType(IfcCompressorTypeEnum CompressorType);
  OdDAI::Boolean getHotGasBypass() const;
  void setHotGasBypass(OdDAI::Boolean HotGasBypass);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_CompressorType;   // IfcCompressorTypeEnum
  OdDAI::Boolean m_HotGasBypass;   // IfcBoolean  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCompressor, IfcCompressor> object.
*/
typedef OdSmartPtr<IfcCompressor> IfcCompressorPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCOMPRESSOR_AUTO_IMPL_H
