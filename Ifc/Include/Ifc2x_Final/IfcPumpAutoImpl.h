...
#ifndef _IFC2X_FINAL_IFCPUMP_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPUMP_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcPump : public IfcFluidMovingDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcPump);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PumpType;   // IfcPumpTypeEnum
  double m_NetPositiveSuctionHead;   // IfcPressureMeasure  [optional]
  OdDAI::Select m_ImpellerSealMaterial;   // IfcMaterialSelect  [optional]
  OdDAI::Enum m_PumpBaseType;   // IfcPumpBaseTypeEnum  [optional]
  OdDAI::Enum m_MotorDriveType;   // IfcMoterConnectionTypeEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPump, IfcPump> object.
*/
typedef OdSmartPtr<IfcPump> IfcPumpPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPUMP_AUTO_IMPL_H
