...
#ifndef _IFC2X_FINAL_IFCDOORPANELPROPERTIES_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCDOORPANELPROPERTIES_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcDoorPanelProperties : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcDoorPanelProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcDoorPanelProperties, IfcDoorPanelProperties> object.
*/
typedef OdSmartPtr<IfcDoorPanelProperties> IfcDoorPanelPropertiesPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCDOORPANELPROPERTIES_AUTO_IMPL_H
