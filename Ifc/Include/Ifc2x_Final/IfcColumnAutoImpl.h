...
#ifndef _IFC2X_FINAL_IFCCOLUMN_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcColumn : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcColumn);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcColumn, IfcColumn> object.
*/
typedef OdSmartPtr<IfcColumn> IfcColumnPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCOLUMN_AUTO_IMPL_H
