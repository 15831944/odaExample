...
#ifndef _IFC2X_FINAL_IFCPROFILEDEF_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPROFILEDEF_AUTO_IMPL_H
...
*/
class IFC2X_FINAL_EXPORT IfcProfileDef : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcProfileDef, IfcProfileDef> object.
*/
typedef OdSmartPtr<IfcProfileDef> IfcProfileDefPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPROFILEDEF_AUTO_IMPL_H
