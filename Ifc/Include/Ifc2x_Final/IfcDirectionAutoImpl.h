...
#ifndef _IFC2X_FINAL_IFCDIRECTION_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCDIRECTION_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcDirection : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcDirection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcDirection, IfcDirection> object.
*/
typedef OdSmartPtr<IfcDirection> IfcDirectionPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCDIRECTION_AUTO_IMPL_H
