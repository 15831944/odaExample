...
#ifndef _IFC2X_FINAL_IFCROUNDEDRECTANGLEPROFILEDEF_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCROUNDEDRECTANGLEPROFILEDEF_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRoundedRectangleProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRoundedRectangleProfileDef);
  //DOM-IGNORE-END
...
public:
  ...
  double getRoundingRadius() const;
  void setRoundingRadius(double RoundingRadius);
...
protected:
  ...
  IfcPositiveLengthMeasure m_XDim;   // IfcPositiveLengthMeasure
  IfcPositiveLengthMeasure m_YDim;   // IfcPositiveLengthMeasure
  IfcPositiveLengthMeasure m_RoundingRadius;   // IfcPositiveLengthMeasure
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRoundedRectangleProfileDef, IfcRoundedRectangleProfileDef> object.
*/
typedef OdSmartPtr<IfcRoundedRectangleProfileDef> IfcRoundedRectangleProfileDefPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCROUNDEDRECTANGLEPROFILEDEF_AUTO_IMPL_H
