...
#ifndef _IFC2X_FINAL_IFCPROPERTYTABLEVALUE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPROPERTYTABLEVALUE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcPropertyTableValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcPropertyTableValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPropertyTableValue, IfcPropertyTableValue> object.
*/
typedef OdSmartPtr<IfcPropertyTableValue> IfcPropertyTableValuePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPROPERTYTABLEVALUE_AUTO_IMPL_H
