...
#ifndef _IFC2X_FINAL_IFCCLASSIFICATIONREFERENCE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCLASSIFICATIONREFERENCE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcClassificationReference : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcClassificationReference);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcClassificationReference, IfcClassificationReference> object.
*/
typedef OdSmartPtr<IfcClassificationReference> IfcClassificationReferencePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCLASSIFICATIONREFERENCE_AUTO_IMPL_H
