...
#ifndef _IFC2X_FINAL_IFCFACEBOUND_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCFACEBOUND_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcFaceBound : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcFaceBound);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcFaceBound, IfcFaceBound> object.
*/
typedef OdSmartPtr<IfcFaceBound> IfcFaceBoundPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCFACEBOUND_AUTO_IMPL_H
