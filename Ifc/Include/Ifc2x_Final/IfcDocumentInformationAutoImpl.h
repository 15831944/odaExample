...
#ifndef _IFC2X_FINAL_IFCDOCUMENTINFORMATION_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCDOCUMENTINFORMATION_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcDocumentInformation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcDocumentInformation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcDocumentInformation, IfcDocumentInformation> object.
*/
typedef OdSmartPtr<IfcDocumentInformation> IfcDocumentInformationPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCDOCUMENTINFORMATION_AUTO_IMPL_H
