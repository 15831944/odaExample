...
#ifndef _IFC2X_FINAL_IFCPROXY_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPROXY_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcProxy : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcProxy);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcProxy, IfcProxy> object.
*/
typedef OdSmartPtr<IfcProxy> IfcProxyPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPROXY_AUTO_IMPL_H
