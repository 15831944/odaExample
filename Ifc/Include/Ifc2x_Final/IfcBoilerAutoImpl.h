...
#ifndef _IFC2X_FINAL_IFCBOILER_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCBOILER_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcBoiler : public IfcHeatTransferDevice
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcBoiler);
  //DOM-IGNORE-END
...
public:
  ...
  IfcBoilerTypeEnum getBoilerType() const;
  void setBoilerType(IfcBoilerTypeEnum BoilerType);
  ...
  double getEnergyInputRate() const;
  void setEnergyInputRate(double EnergyInputRate);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_BoilerType;   // IfcBoilerTypeEnum
  double m_HeatOutput;   // IfcPowerMeasure  [optional]
  double m_PressureRating;   // IfcPressureMeasure  [optional]
  double m_EnergyInputRate;   // IfcVolumetricFlowRateMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcBoiler, IfcBoiler> object.
*/
typedef OdSmartPtr<IfcBoiler> IfcBoilerPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCBOILER_AUTO_IMPL_H
