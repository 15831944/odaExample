...
#ifndef _IFC2X_FINAL_IFCRECTANGULARTRIMMEDSURFACE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRECTANGULARTRIMMEDSURFACE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRectangularTrimmedSurface : public IfcBoundedSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRectangularTrimmedSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRectangularTrimmedSurface, IfcRectangularTrimmedSurface> object.
*/
typedef OdSmartPtr<IfcRectangularTrimmedSurface> IfcRectangularTrimmedSurfacePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRECTANGULARTRIMMEDSURFACE_AUTO_IMPL_H
