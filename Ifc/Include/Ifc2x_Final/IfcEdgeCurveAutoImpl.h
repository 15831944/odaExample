...
#ifndef _IFC2X_FINAL_IFCEDGECURVE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCEDGECURVE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcEdgeCurve : public IfcEdge
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcEdgeCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcEdgeCurve, IfcEdgeCurve> object.
*/
typedef OdSmartPtr<IfcEdgeCurve> IfcEdgeCurvePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCEDGECURVE_AUTO_IMPL_H
