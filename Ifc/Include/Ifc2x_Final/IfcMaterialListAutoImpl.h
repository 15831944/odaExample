...
#ifndef _IFC2X_FINAL_IFCMATERIALLIST_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCMATERIALLIST_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcMaterialList : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcMaterialList);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcMaterialList, IfcMaterialList> object.
*/
typedef OdSmartPtr<IfcMaterialList> IfcMaterialListPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCMATERIALLIST_AUTO_IMPL_H
