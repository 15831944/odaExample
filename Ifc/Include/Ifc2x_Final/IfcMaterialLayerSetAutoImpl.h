...
#ifndef _IFC2X_FINAL_IFCMATERIALLAYERSET_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCMATERIALLAYERSET_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcMaterialLayerSet : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcMaterialLayerSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcMaterialLayerSet, IfcMaterialLayerSet> object.
*/
typedef OdSmartPtr<IfcMaterialLayerSet> IfcMaterialLayerSetPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCMATERIALLAYERSET_AUTO_IMPL_H
