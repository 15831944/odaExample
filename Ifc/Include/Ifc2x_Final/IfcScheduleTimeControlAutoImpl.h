...
#ifndef _IFC2X_FINAL_IFCSCHEDULETIMECONTROL_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSCHEDULETIMECONTROL_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcScheduleTimeControl : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcScheduleTimeControl);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getActualStart() const;
  void setActualStart(const OdDAIObjectId& ActualStart);
  const OdDAIObjectId& getEarlyStart() const;
  void setEarlyStart(const OdDAIObjectId& EarlyStart);
  const OdDAIObjectId& getLateStart() const;
  void setLateStart(const OdDAIObjectId& LateStart);
  const OdDAIObjectId& getScheduleStart() const;
  void setScheduleStart(const OdDAIObjectId& ScheduleStart);
  const OdDAIObjectId& getActualFinish() const;
  void setActualFinish(const OdDAIObjectId& ActualFinish);
  const OdDAIObjectId& getEarlyFinish() const;
  void setEarlyFinish(const OdDAIObjectId& EarlyFinish);
  const OdDAIObjectId& getLateFinish() const;
  void setLateFinish(const OdDAIObjectId& LateFinish);
  const OdDAIObjectId& getScheduleFinish() const;
  void setScheduleFinish(const OdDAIObjectId& ScheduleFinish);
  ...
  const OdDAIObjectId& getStatusTime() const;
  void setStatusTime(const OdDAIObjectId& StatusTime);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_ActualStart;   // IfcCalendarDate  [optional]
  OdDAIObjectId m_EarlyStart;   // IfcCalendarDate  [optional]
  OdDAIObjectId m_LateStart;   // IfcCalendarDate  [optional]
  OdDAIObjectId m_ScheduleStart;   // IfcCalendarDate  [optional]
  OdDAIObjectId m_ActualFinish;   // IfcCalendarDate  [optional]
  OdDAIObjectId m_EarlyFinish;   // IfcCalendarDate  [optional]
  OdDAIObjectId m_LateFinish;   // IfcCalendarDate  [optional]
  OdDAIObjectId m_ScheduleFinish;   // IfcCalendarDate  [optional]
  ...
  OdDAIObjectId m_StatusTime;   // IfcCalendarDate  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcScheduleTimeControl, IfcScheduleTimeControl> object.
*/
typedef OdSmartPtr<IfcScheduleTimeControl> IfcScheduleTimeControlPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSCHEDULETIMECONTROL_AUTO_IMPL_H
