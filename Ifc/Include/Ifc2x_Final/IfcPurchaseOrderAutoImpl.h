...
#ifndef _IFC2X_FINAL_IFCPURCHASEORDER_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPURCHASEORDER_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcPurchaseOrder : public IfcProjectOrder
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcPurchaseOrder);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RequiredDate;   // IfcCalendarDate  [optional]
  OdDAIObjectId m_ScheduledDate;   // IfcCalendarDate  [optional]
  OdDAIObjectId m_ActualDate;   // IfcCalendarDate  [optional]
  OdDAI::Boolean m_IsFOB;   // BOOLEAN  [optional]
  OdAnsiString m_ShipMethod;   // IfcLabel  [optional]
  OdDAIObjectId m_PurchaseItems;   // IfcCostSchedule  [optional]
  OdDAIObjectId m_TotalCost;   // IfcCostValue  [optional]
  OdDAI::Enum m_Status;   // IfcPurchaseOrderStatusEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPurchaseOrder, IfcPurchaseOrder> object.
*/
typedef OdSmartPtr<IfcPurchaseOrder> IfcPurchaseOrderPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPURCHASEORDER_AUTO_IMPL_H
