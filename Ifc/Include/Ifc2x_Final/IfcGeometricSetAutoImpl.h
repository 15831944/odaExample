...
#ifndef _IFC2X_FINAL_IFCGEOMETRICSET_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCGEOMETRICSET_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcGeometricSet : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcGeometricSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcGeometricSet, IfcGeometricSet> object.
*/
typedef OdSmartPtr<IfcGeometricSet> IfcGeometricSetPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCGEOMETRICSET_AUTO_IMPL_H
