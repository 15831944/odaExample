...
#ifndef _IFC2X_FINAL_IFCTABLE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCTABLE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcTable : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcTable);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcTable, IfcTable> object.
*/
typedef OdSmartPtr<IfcTable> IfcTablePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCTABLE_AUTO_IMPL_H
