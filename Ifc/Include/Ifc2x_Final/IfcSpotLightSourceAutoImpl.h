...
#ifndef _IFC2X_FINAL_IFCSPOTLIGHTSOURCE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSPOTLIGHTSOURCE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSpotLightSource : public IfcPointLightSource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcSpotLightSource);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getDirection() const;
  void setDirection(const OdDAIObjectId& Direction);
...
protected:
  // Fields declaration: 
  IfcPositivePlaneAngleMeasure m_SpreadAngle;   // IfcPositivePlaneAngleMeasure
  IfcPositivePlaneAngleMeasure m_CutOffAngle;   // IfcPositivePlaneAngleMeasure
  IfcPositiveLengthMeasure m_Radius;   // IfcPositiveLengthMeasure  [optional]
  OdDAIObjectId m_Direction;   // IfcDirection
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSpotLightSource, IfcSpotLightSource> object.
*/
typedef OdSmartPtr<IfcSpotLightSource> IfcSpotLightSourcePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSPOTLIGHTSOURCE_AUTO_IMPL_H
