...
#ifndef _IFC2X_FINAL_IFCSURFACERENDERINGPROPERTIES_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSURFACERENDERINGPROPERTIES_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSurfaceRenderingProperties : public IfcSurfaceShadingProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcSurfaceRenderingProperties);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  IfcNormalisedRatioMeasure m_AmbientIntensity;   // IfcNormalisedRatioMeasure
  OdDAI::DoubleList m_DiffuseColor; // IfcColorRGB
  IfcNormalisedRatioMeasure m_Transparency;   // IfcNormalisedRatioMeasure
  OdDAI::DoubleList m_EmmisiveColor; // IfcColorRGB [optional]

  IfcNormalisedRatioMeasure m_SpecularIntensity;   // IfcNormalisedRatioMeasure  [optional]
  OdDAI::DoubleList m_SpecularColor; // IfcColorRGB [optional]

};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSurfaceRenderingProperties, IfcSurfaceRenderingProperties> object.
*/
typedef OdSmartPtr<IfcSurfaceRenderingProperties> IfcSurfaceRenderingPropertiesPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSURFACERENDERINGPROPERTIES_AUTO_IMPL_H
