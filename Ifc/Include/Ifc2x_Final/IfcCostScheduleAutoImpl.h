...
#ifndef _IFC2X_FINAL_IFCCOSTSCHEDULE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCOSTSCHEDULE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCostSchedule : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCostSchedule);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::Set<OdDAI::Select>& approvedBy();
  ...
  OdDAI::OdDAIObjectIdList& costElements();
  ...
  OdDAI::OdAnsiStringList& comments();
  ...
  OdDAI::Set<OdDAI::Select>& targetUsers();
...
protected:
  // Fields declaration: 
  OdAnsiString m_Title;   // IfcLabel
  OdDAI::Select m_SubmittedBy;   // IfcActorSelect  [optional]
  OdDAI::Set<OdDAI::Select> m_ApprovedBy; // SET [1:?] of IfcActorSelect [optional]

  OdDAIObjectId m_PreparedBy;   // IfcPerson
  OdDAIObjectId m_SubmittedOn;   // IfcCalendarDate  [optional]
  OdDAIObjectId m_TotalCost;   // IfcCostValue
  OdDAI::OdDAIObjectIdList m_CostElements; // LIST [1:?] of IfcCost [optional]

  OdAnsiString m_Status;   // IfcLabel
  OdAnsiString m_IntendedUse;   // IfcText  [optional]
  OdDAI::OdAnsiStringList m_Comments; // LIST [1:?] of IfcText [optional]

  OdDAI::Set<OdDAI::Select> m_TargetUsers; // SET [1:?] of IfcActorSelect [optional]

  OdDAIObjectId m_ValidFromDate;   // IfcCalendarDate  [optional]
  OdDAIObjectId m_ValidToDate;   // IfcCalendarDate  [optional]
  OdDAIObjectId m_UpdateDate;   // IfcCalendarDate  [optional]
  OdAnsiString m_ScheduleNumber;   // IfcIdentifier
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCostSchedule, IfcCostSchedule> object.
*/
typedef OdSmartPtr<IfcCostSchedule> IfcCostSchedulePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCOSTSCHEDULE_AUTO_IMPL_H
