...
#ifndef _IFC2X_FINAL_IFCTHERMALMATERIALPROPERTIES_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCTHERMALMATERIALPROPERTIES_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcThermalMaterialProperties : public IfcMaterialProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcThermalMaterialProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcThermalMaterialProperties, IfcThermalMaterialProperties> object.
*/
typedef OdSmartPtr<IfcThermalMaterialProperties> IfcThermalMaterialPropertiesPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCTHERMALMATERIALPROPERTIES_AUTO_IMPL_H
