...
#ifndef _IFC2X_FINAL_IFCWINDOWPANELPROPERTIES_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCWINDOWPANELPROPERTIES_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcWindowPanelProperties : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcWindowPanelProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcWindowPanelProperties, IfcWindowPanelProperties> object.
*/
typedef OdSmartPtr<IfcWindowPanelProperties> IfcWindowPanelPropertiesPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCWINDOWPANELPROPERTIES_AUTO_IMPL_H
