...
#ifndef _IFC2X_FINAL_IFCCONNECTIONPORTGEOMETRY_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCONNECTIONPORTGEOMETRY_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcConnectionPortGeometry : public IfcConnectionGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcConnectionPortGeometry);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcConnectionPortGeometry, IfcConnectionPortGeometry> object.
*/
typedef OdSmartPtr<IfcConnectionPortGeometry> IfcConnectionPortGeometryPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCONNECTIONPORTGEOMETRY_AUTO_IMPL_H
