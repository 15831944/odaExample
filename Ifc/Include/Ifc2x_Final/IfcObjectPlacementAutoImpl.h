...
class IFC2X_FINAL_EXPORT IfcObjectPlacement : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcObjectPlacement, IfcObjectPlacement> object.
*/
