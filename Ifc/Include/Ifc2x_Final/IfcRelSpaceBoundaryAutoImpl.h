...
#ifndef _IFC2X_FINAL_IFCRELSPACEBOUNDARY_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRELSPACEBOUNDARY_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRelSpaceBoundary : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRelSpaceBoundary);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getRelatingSpace() const;
  void setRelatingSpace(const OdDAIObjectId& RelatingSpace);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_RelatingSpace;   // IfcSpace
  OdDAIObjectId m_RelatedBuildingElement;   // IfcBuildingElement  [optional]
  OdDAIObjectId m_ConnectionGeometry;   // IfcConnectionSurfaceGeometry  [optional]
  OdDAI::Enum m_PhysicalOrVirtualBoundary;   // IfcPhysicalOrVirtualEnum
  OdDAI::Enum m_InternalOrExternalBoundary;   // IfcInternalOrExternalEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRelSpaceBoundary, IfcRelSpaceBoundary> object.
*/
typedef OdSmartPtr<IfcRelSpaceBoundary> IfcRelSpaceBoundaryPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRELSPACEBOUNDARY_AUTO_IMPL_H
