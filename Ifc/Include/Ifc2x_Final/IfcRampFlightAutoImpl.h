...
#ifndef _IFC2X_FINAL_IFCRAMPFLIGHT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRAMPFLIGHT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRampFlight : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRampFlight);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRampFlight, IfcRampFlight> object.
*/
typedef OdSmartPtr<IfcRampFlight> IfcRampFlightPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRAMPFLIGHT_AUTO_IMPL_H
