...
#ifndef _IFC2X_FINAL_IFCDISCRETEELEMENT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCDISCRETEELEMENT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcDiscreteElement : public IfcEquipmentElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcDiscreteElement);
  //DOM-IGNORE-END
...
public:
  ...
  IfcDiscreteElementTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcDiscreteElementTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcDiscreteElementTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcDiscreteElement, IfcDiscreteElement> object.
*/
typedef OdSmartPtr<IfcDiscreteElement> IfcDiscreteElementPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCDISCRETEELEMENT_AUTO_IMPL_H
