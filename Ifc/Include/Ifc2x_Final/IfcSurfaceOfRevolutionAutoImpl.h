...
#ifndef _IFC2X_FINAL_IFCSURFACEOFREVOLUTION_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSURFACEOFREVOLUTION_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSurfaceOfRevolution : public IfcSweptSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcSurfaceOfRevolution);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSurfaceOfRevolution, IfcSurfaceOfRevolution> object.
*/
typedef OdSmartPtr<IfcSurfaceOfRevolution> IfcSurfaceOfRevolutionPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSURFACEOFREVOLUTION_AUTO_IMPL_H
