...
#ifndef _IFC2X_FINAL_IFCREFERENCEFACE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCREFERENCEFACE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcReferenceFace : public IfcReferenceGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcReferenceFace);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getFace() const;
  void setFace(const OdDAIObjectId& Face);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Face;   // IfcFace
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcReferenceFace, IfcReferenceFace> object.
*/
typedef OdSmartPtr<IfcReferenceFace> IfcReferenceFacePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCREFERENCEFACE_AUTO_IMPL_H
