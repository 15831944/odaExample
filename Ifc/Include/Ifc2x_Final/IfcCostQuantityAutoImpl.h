...
#ifndef _IFC2X_FINAL_IFCCOSTQUANTITY_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCOSTQUANTITY_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCostQuantity : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCostQuantity);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAIObjectId m_FinalQuantity;   // IfcMeasureWithUnit  [optional]
  IfcPositiveRatioMeasure m_WasteFactor;   // IfcPositiveRatioMeasure  [optional]
  double m_RoundOffIncrement;   // IfcReal
  OdDAI::Enum m_RoundOffBasis;   // IfcQuantityRoundOffBasisEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCostQuantity, IfcCostQuantity> object.
*/
typedef OdSmartPtr<IfcCostQuantity> IfcCostQuantityPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCOSTQUANTITY_AUTO_IMPL_H
