...
#ifndef _IFC2X_FINAL_IFCCOVERING_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCOVERING_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCovering : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCovering);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCovering, IfcCovering> object.
*/
typedef OdSmartPtr<IfcCovering> IfcCoveringPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCOVERING_AUTO_IMPL_H
