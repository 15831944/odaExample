...
#ifndef _IFC2X_FINAL_IFCLIBRARYINFORMATION_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCLIBRARYINFORMATION_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcLibraryInformation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcLibraryInformation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcLibraryInformation, IfcLibraryInformation> object.
*/
typedef OdSmartPtr<IfcLibraryInformation> IfcLibraryInformationPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCLIBRARYINFORMATION_AUTO_IMPL_H
