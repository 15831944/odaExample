...
#ifndef _IFC2X_FINAL_IFCPROPERTYDEFINITION_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPROPERTYDEFINITION_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcPropertyDefinition : public IfcRoot
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcPropertyDefinition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPropertyDefinition, IfcPropertyDefinition> object.
*/
typedef OdSmartPtr<IfcPropertyDefinition> IfcPropertyDefinitionPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPROPERTYDEFINITION_AUTO_IMPL_H
