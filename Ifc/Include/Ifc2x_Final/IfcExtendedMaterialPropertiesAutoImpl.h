...
#ifndef _IFC2X_FINAL_IFCEXTENDEDMATERIALPROPERTIES_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCEXTENDEDMATERIALPROPERTIES_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcExtendedMaterialProperties : public IfcMaterialProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcExtendedMaterialProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcExtendedMaterialProperties, IfcExtendedMaterialProperties> object.
*/
typedef OdSmartPtr<IfcExtendedMaterialProperties> IfcExtendedMaterialPropertiesPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCEXTENDEDMATERIALPROPERTIES_AUTO_IMPL_H
