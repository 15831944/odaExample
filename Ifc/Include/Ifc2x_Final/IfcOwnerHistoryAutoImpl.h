...
#ifndef _IFC2X_FINAL_IFCOWNERHISTORY_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCOWNERHISTORY_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcOwnerHistory : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcOwnerHistory);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcOwnerHistory, IfcOwnerHistory> object.
*/
typedef OdSmartPtr<IfcOwnerHistory> IfcOwnerHistoryPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCOWNERHISTORY_AUTO_IMPL_H
