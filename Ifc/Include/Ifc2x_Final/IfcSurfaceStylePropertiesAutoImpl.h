...
#ifndef _IFC2X_FINAL_IFCSURFACESTYLEPROPERTIES_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSURFACESTYLEPROPERTIES_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSurfaceStyleProperties : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcSurfaceStyleProperties);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getUsageIdentifier() const;
  void setUsageIdentifier(const OdAnsiString& UsageIdentifier);
...
protected:
  // Fields declaration: 
  OdAnsiString m_UsageIdentifier;   // IfcLabel  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSurfaceStyleProperties, IfcSurfaceStyleProperties> object.
*/
typedef OdSmartPtr<IfcSurfaceStyleProperties> IfcSurfaceStylePropertiesPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSURFACESTYLEPROPERTIES_AUTO_IMPL_H
