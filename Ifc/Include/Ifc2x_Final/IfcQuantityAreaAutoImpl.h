...
#ifndef _IFC2X_FINAL_IFCQUANTITYAREA_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCQUANTITYAREA_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcQuantityArea : public IfcPhysicalQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcQuantityArea);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcQuantityArea, IfcQuantityArea> object.
*/
typedef OdSmartPtr<IfcQuantityArea> IfcQuantityAreaPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCQUANTITYAREA_AUTO_IMPL_H
