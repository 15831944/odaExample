...
#ifndef _IFC2X_FINAL_IFCMATERIAL_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCMATERIAL_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcMaterial : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcMaterial);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcMaterial, IfcMaterial> object.
*/
typedef OdSmartPtr<IfcMaterial> IfcMaterialPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCMATERIAL_AUTO_IMPL_H
