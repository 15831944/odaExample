...
#ifndef _IFC2X_FINAL_IFCGENERALMATERIALPROPERTIES_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCGENERALMATERIALPROPERTIES_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcGeneralMaterialProperties : public IfcMaterialProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcGeneralMaterialProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcGeneralMaterialProperties, IfcGeneralMaterialProperties> object.
*/
typedef OdSmartPtr<IfcGeneralMaterialProperties> IfcGeneralMaterialPropertiesPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCGENERALMATERIALPROPERTIES_AUTO_IMPL_H
