...
#ifndef _IFC2X_FINAL_IFCCREWRESOURCE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCREWRESOURCE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCrewResource : public IfcResource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCrewResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCrewResource, IfcCrewResource> object.
*/
typedef OdSmartPtr<IfcCrewResource> IfcCrewResourcePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCREWRESOURCE_AUTO_IMPL_H
