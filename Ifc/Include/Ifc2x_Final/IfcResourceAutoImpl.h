...
#ifndef _IFC2X_FINAL_IFCRESOURCE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRESOURCE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcResource : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcResource);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAIObjectId m_BaseUnit;   // IfcMeasureWithUnit  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcResource, IfcResource> object.
*/
typedef OdSmartPtr<IfcResource> IfcResourcePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRESOURCE_AUTO_IMPL_H
