...
#ifndef _IFC2X_FINAL_IFCROOF_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCROOF_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRoof : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRoof);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRoof, IfcRoof> object.
*/
typedef OdSmartPtr<IfcRoof> IfcRoofPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCROOF_AUTO_IMPL_H
