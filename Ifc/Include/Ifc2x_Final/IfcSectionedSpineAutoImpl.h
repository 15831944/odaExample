...
#ifndef _IFC2X_FINAL_IFCSECTIONEDSPINE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSECTIONEDSPINE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSectionedSpine : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcSectionedSpine);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSectionedSpine, IfcSectionedSpine> object.
*/
typedef OdSmartPtr<IfcSectionedSpine> IfcSectionedSpinePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSECTIONEDSPINE_AUTO_IMPL_H
