...
#ifndef _IFC2X_FINAL_IFCAPPROVALUSAGE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCAPPROVALUSAGE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcApprovalUsage : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcApprovalUsage);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcApprovalUsage, IfcApprovalUsage> object.
*/
typedef OdSmartPtr<IfcApprovalUsage> IfcApprovalUsagePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCAPPROVALUSAGE_AUTO_IMPL_H
