...
#ifndef _IFC2X_FINAL_IFCOPENINGELEMENT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCOPENINGELEMENT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcOpeningElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcOpeningElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcOpeningElement, IfcOpeningElement> object.
*/
typedef OdSmartPtr<IfcOpeningElement> IfcOpeningElementPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCOPENINGELEMENT_AUTO_IMPL_H
