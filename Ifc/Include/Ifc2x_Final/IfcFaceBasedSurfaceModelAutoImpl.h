...
#ifndef _IFC2X_FINAL_IFCFACEBASEDSURFACEMODEL_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCFACEBASEDSURFACEMODEL_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcFaceBasedSurfaceModel : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcFaceBasedSurfaceModel);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcFaceBasedSurfaceModel, IfcFaceBasedSurfaceModel> object.
*/
typedef OdSmartPtr<IfcFaceBasedSurfaceModel> IfcFaceBasedSurfaceModelPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCFACEBASEDSURFACEMODEL_AUTO_IMPL_H
