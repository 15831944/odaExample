...
#ifndef _IFC2X_FINAL_IFCCOMPLEXPROPERTY_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCOMPLEXPROPERTY_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcComplexProperty : public IfcProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcComplexProperty);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& hasProperties();
...
protected:
  ...
  OdDAI::OdDAIObjectIdList m_HasProperties; // LIST [1:?] of IfcProperty
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcComplexProperty, IfcComplexProperty> object.
*/
typedef OdSmartPtr<IfcComplexProperty> IfcComplexPropertyPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCOMPLEXPROPERTY_AUTO_IMPL_H
