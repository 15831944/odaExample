...
#ifndef _IFC2X_FINAL_IFCOBJECTIVE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCOBJECTIVE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcObjective : public IfcConstraint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcObjective);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& benchmarkValues();
  void getResultValues(OdDAIObjectIds& ResultValues) const;
  OdDAI::OdDAIObjectIdList& resultValues();
...
protected:
  ...
  OdDAI::OdDAIObjectIdList m_BenchmarkValues; // LIST of IfcMetric
  OdDAI::OdDAIObjectIdList m_ResultValues; // LIST of IfcMetric
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcObjective, IfcObjective> object.
*/
typedef OdSmartPtr<IfcObjective> IfcObjectivePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCOBJECTIVE_AUTO_IMPL_H
