...
#ifndef _IFC2X_FINAL_IFCGRID_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCGRID_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcGrid : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcGrid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcGrid, IfcGrid> object.
*/
typedef OdSmartPtr<IfcGrid> IfcGridPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCGRID_AUTO_IMPL_H
