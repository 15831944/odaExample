...
#ifndef _IFC2X_FINAL_IFCCARTESIANPOINT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCARTESIANPOINT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCartesianPoint : public IfcPoint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCartesianPoint);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCartesianPoint, IfcCartesianPoint> object.
*/
typedef OdSmartPtr<IfcCartesianPoint> IfcCartesianPointPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCARTESIANPOINT_AUTO_IMPL_H
