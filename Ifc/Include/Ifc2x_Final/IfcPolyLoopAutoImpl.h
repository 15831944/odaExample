...
#ifndef _IFC2X_FINAL_IFCPOLYLOOP_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPOLYLOOP_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcPolyLoop : public IfcLoop
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcPolyLoop);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPolyLoop, IfcPolyLoop> object.
*/
typedef OdSmartPtr<IfcPolyLoop> IfcPolyLoopPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPOLYLOOP_AUTO_IMPL_H
