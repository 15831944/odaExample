...
#ifndef _IFC2X_FINAL_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcPropertySingleValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcPropertySingleValue);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPropertySingleValue, IfcPropertySingleValue> object.
*/
typedef OdSmartPtr<IfcPropertySingleValue> IfcPropertySingleValuePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPROPERTYSINGLEVALUE_AUTO_IMPL_H
