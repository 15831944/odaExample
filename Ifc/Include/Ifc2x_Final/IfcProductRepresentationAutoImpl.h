...
#ifndef _IFC2X_FINAL_IFCPRODUCTREPRESENTATION_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPRODUCTREPRESENTATION_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcProductRepresentation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcProductRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcProductRepresentation, IfcProductRepresentation> object.
*/
typedef OdSmartPtr<IfcProductRepresentation> IfcProductRepresentationPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPRODUCTREPRESENTATION_AUTO_IMPL_H
