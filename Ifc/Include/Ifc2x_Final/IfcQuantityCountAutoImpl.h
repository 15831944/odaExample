...
#ifndef _IFC2X_FINAL_IFCQUANTITYCOUNT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCQUANTITYCOUNT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcQuantityCount : public IfcPhysicalQuantity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcQuantityCount);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcQuantityCount, IfcQuantityCount> object.
*/
typedef OdSmartPtr<IfcQuantityCount> IfcQuantityCountPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCQUANTITYCOUNT_AUTO_IMPL_H
