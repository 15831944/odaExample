...
#ifndef _IFC2X_FINAL_IFCBEAM_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCBEAM_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcBeam : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcBeam);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcBeam, IfcBeam> object.
*/
typedef OdSmartPtr<IfcBeam> IfcBeamPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCBEAM_AUTO_IMPL_H
