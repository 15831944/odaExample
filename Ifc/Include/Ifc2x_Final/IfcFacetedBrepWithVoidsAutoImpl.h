...
#ifndef _IFC2X_FINAL_IFCFACETEDBREPWITHVOIDS_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCFACETEDBREPWITHVOIDS_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcFacetedBrepWithVoids : public IfcManifoldSolidBrep
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcFacetedBrepWithVoids);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcFacetedBrepWithVoids, IfcFacetedBrepWithVoids> object.
*/
typedef OdSmartPtr<IfcFacetedBrepWithVoids> IfcFacetedBrepWithVoidsPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCFACETEDBREPWITHVOIDS_AUTO_IMPL_H
