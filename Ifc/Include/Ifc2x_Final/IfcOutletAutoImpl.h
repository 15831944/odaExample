...
#ifndef _IFC2X_FINAL_IFCOUTLET_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCOUTLET_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcOutlet : public IfcElectricalElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcOutlet);
  //DOM-IGNORE-END
...
public:
  ...
  IfcOutletTypeEnum getOutletType() const;
  void setOutletType(IfcOutletTypeEnum OutletType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_OutletType;   // IfcOutletTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcOutlet, IfcOutlet> object.
*/
typedef OdSmartPtr<IfcOutlet> IfcOutletPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCOUTLET_AUTO_IMPL_H
