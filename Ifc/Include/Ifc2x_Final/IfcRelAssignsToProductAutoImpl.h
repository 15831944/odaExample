...
#ifndef _IFC2X_FINAL_IFCRELASSIGNSTOPRODUCT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRELASSIGNSTOPRODUCT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRelAssignsToProduct : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRelAssignsToProduct);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRelAssignsToProduct, IfcRelAssignsToProduct> object.
*/
typedef OdSmartPtr<IfcRelAssignsToProduct> IfcRelAssignsToProductPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRELASSIGNSTOPRODUCT_AUTO_IMPL_H
