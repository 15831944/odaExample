...
#ifndef _IFC2X_FINAL_IFCCOMPOSITECURVE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCOMPOSITECURVE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCompositeCurve : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCompositeCurve);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCompositeCurve, IfcCompositeCurve> object.
*/
typedef OdSmartPtr<IfcCompositeCurve> IfcCompositeCurvePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCOMPOSITECURVE_AUTO_IMPL_H
