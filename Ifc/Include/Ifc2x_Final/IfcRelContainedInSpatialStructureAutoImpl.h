...
#ifndef _IFC2X_FINAL_IFCRELCONTAINEDINSPATIALSTRUCTURE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRELCONTAINEDINSPATIALSTRUCTURE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRelContainedInSpatialStructure : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRelContainedInSpatialStructure);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_RelatedElements; // SET [1:?] of IfcElement
  OdDAIObjectId m_RelatingStructure;   // IfcSpatialStructureElement
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRelContainedInSpatialStructure, IfcRelContainedInSpatialStructure> object.
*/
typedef OdSmartPtr<IfcRelContainedInSpatialStructure> IfcRelContainedInSpatialStructurePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRELCONTAINEDINSPATIALSTRUCTURE_AUTO_IMPL_H
