...
#ifndef _IFC2X_FINAL_IFCSURFACEEXTENDEDPROPERTIES_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSURFACEEXTENDEDPROPERTIES_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSurfaceExtendedProperties : public IfcSurfaceStyleProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcSurfaceExtendedProperties);
  //DOM-IGNORE-END
...
public:
  ...
  void getExtendedProperties(OdDAIObjectIds& ExtendedProperties) const;
  OdDAI::OdDAIObjectIdSet& extendedProperties();
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdSet m_ExtendedProperties; // SET [1:?] of IfcProperty
  OdAnsiString m_Description;   // IfcText  [optional]
  OdAnsiString m_Name;   // IfcLabel
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSurfaceExtendedProperties, IfcSurfaceExtendedProperties> object.
*/
typedef OdSmartPtr<IfcSurfaceExtendedProperties> IfcSurfaceExtendedPropertiesPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSURFACEEXTENDEDPROPERTIES_AUTO_IMPL_H
