...
#ifndef _IFC2X_FINAL_IFCLIBRARYREFERENCE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCLIBRARYREFERENCE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcLibraryReference : public IfcExternalReference
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcLibraryReference);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcLibraryReference, IfcLibraryReference> object.
*/
typedef OdSmartPtr<IfcLibraryReference> IfcLibraryReferencePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCLIBRARYREFERENCE_AUTO_IMPL_H
