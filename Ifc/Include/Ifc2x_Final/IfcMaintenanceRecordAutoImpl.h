...
#ifndef _IFC2X_FINAL_IFCMAINTENANCERECORD_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCMAINTENANCERECORD_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcMaintenanceRecord : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcMaintenanceRecord);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_Records; // LIST [1:?] of IfcRelMaintenanceEvent
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcMaintenanceRecord, IfcMaintenanceRecord> object.
*/
typedef OdSmartPtr<IfcMaintenanceRecord> IfcMaintenanceRecordPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCMAINTENANCERECORD_AUTO_IMPL_H
