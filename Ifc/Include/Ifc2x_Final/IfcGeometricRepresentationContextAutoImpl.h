...
#ifndef _IFC2X_FINAL_IFCGEOMETRICREPRESENTATIONCONTEXT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCGEOMETRICREPRESENTATIONCONTEXT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcGeometricRepresentationContext : public IfcRepresentationContext
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcGeometricRepresentationContext);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcGeometricRepresentationContext, IfcGeometricRepresentationContext> object.
*/
typedef OdSmartPtr<IfcGeometricRepresentationContext> IfcGeometricRepresentationContextPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCGEOMETRICREPRESENTATIONCONTEXT_AUTO_IMPL_H
