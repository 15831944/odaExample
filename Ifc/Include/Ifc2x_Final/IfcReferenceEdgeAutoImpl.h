...
#ifndef _IFC2X_FINAL_IFCREFERENCEEDGE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCREFERENCEEDGE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcReferenceEdge : public IfcReferenceGeometry
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcReferenceEdge);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getEdge() const;
  void setEdge(const OdDAIObjectId& Edge);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Edge;   // IfcEdge
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcReferenceEdge, IfcReferenceEdge> object.
*/
typedef OdSmartPtr<IfcReferenceEdge> IfcReferenceEdgePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCREFERENCEEDGE_AUTO_IMPL_H
