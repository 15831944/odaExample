...
#ifndef _IFC2X_FINAL_IFCPROCESS_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPROCESS_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcProcess : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcProcess);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getProductivity() const;
  void setProductivity(const OdDAIObjectId& Productivity);
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_Productivity;   // IfcMeasureWithUnit  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcProcess, IfcProcess> object.
*/
typedef OdSmartPtr<IfcProcess> IfcProcessPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPROCESS_AUTO_IMPL_H
