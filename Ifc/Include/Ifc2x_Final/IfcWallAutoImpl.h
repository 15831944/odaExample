...
#ifndef _IFC2X_FINAL_IFCWALL_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCWALL_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcWall : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcWall);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcWall, IfcWall> object.
*/
typedef OdSmartPtr<IfcWall> IfcWallPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCWALL_AUTO_IMPL_H
