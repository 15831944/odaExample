...
#ifndef _IFC2X_FINAL_IFCMETRICVALUE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCMETRICVALUE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcMetricValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcMetricValue);
  //DOM-IGNORE-END
...
public:
  ...
  IfcMetricDataEnum getDataType() const;
  void setDataType(IfcMetricDataEnum DataType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_DataType;   // IfcMetricDataEnum
  OdDAI::Select m_DataValue;   // IfcMetricValueSelect
  OdAnsiString m_ValueSource;   // IfcLabel
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcMetricValue, IfcMetricValue> object.
*/
typedef OdSmartPtr<IfcMetricValue> IfcMetricValuePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCMETRICVALUE_AUTO_IMPL_H
