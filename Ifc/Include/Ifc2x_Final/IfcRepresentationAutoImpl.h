...
#ifndef _IFC2X_FINAL_IFCREPRESENTATION_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCREPRESENTATION_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRepresentation : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRepresentation);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRepresentation, IfcRepresentation> object.
*/
typedef OdSmartPtr<IfcRepresentation> IfcRepresentationPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCREPRESENTATION_AUTO_IMPL_H
