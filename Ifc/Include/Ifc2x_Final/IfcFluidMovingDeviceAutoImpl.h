...
#ifndef _IFC2X_FINAL_IFCFLUIDMOVINGDEVICE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCFLUIDMOVINGDEVICE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcFluidMovingDevice : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcFluidMovingDevice);
  //DOM-IGNORE-END
...
protected:
  ...
  double m_ImpellerDiameter;   // IfcLengthMeasure  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcFluidMovingDevice, IfcFluidMovingDevice> object.
*/
typedef OdSmartPtr<IfcFluidMovingDevice> IfcFluidMovingDevicePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCFLUIDMOVINGDEVICE_AUTO_IMPL_H
