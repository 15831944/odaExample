...
#ifndef _IFC2X_FINAL_IFCPOLYLINE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPOLYLINE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcPolyline : public IfcBoundedCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcPolyline);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPolyline, IfcPolyline> object.
*/
typedef OdSmartPtr<IfcPolyline> IfcPolylinePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPOLYLINE_AUTO_IMPL_H
