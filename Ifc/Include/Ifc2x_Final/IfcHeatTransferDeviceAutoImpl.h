...
#ifndef _IFC2X_FINAL_IFCHEATTRANSFERDEVICE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCHEATTRANSFERDEVICE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcHeatTransferDevice : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcHeatTransferDevice);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  double m_HeatTransferRate;   // IfcPowerMeasure  [optional]
  IfcPositiveRatioMeasure m_ThermalEfficiency;   // IfcPositiveRatioMeasure  [optional]
  OdDAI::Enum m_PrimaryEnergySource;   // IfcEnergySourceEnum  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcHeatTransferDevice, IfcHeatTransferDevice> object.
*/
typedef OdSmartPtr<IfcHeatTransferDevice> IfcHeatTransferDevicePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCHEATTRANSFERDEVICE_AUTO_IMPL_H
