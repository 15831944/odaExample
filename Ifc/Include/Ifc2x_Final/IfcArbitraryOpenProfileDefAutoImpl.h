...
#ifndef _IFC2X_FINAL_IFCARBITRARYOPENPROFILEDEF_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCARBITRARYOPENPROFILEDEF_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcArbitraryOpenProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcArbitraryOpenProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcArbitraryOpenProfileDef, IfcArbitraryOpenProfileDef> object.
*/
typedef OdSmartPtr<IfcArbitraryOpenProfileDef> IfcArbitraryOpenProfileDefPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCARBITRARYOPENPROFILEDEF_AUTO_IMPL_H
