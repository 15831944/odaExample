...
#ifndef _IFC2X_FINAL_IFCCONNECTIONCONSTRAINT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCONNECTIONCONSTRAINT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcConnectionConstraint : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcConnectionConstraint);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Logical m_WaterproofingRequired;   // LOGICAL
  OdDAI::Logical m_VentilationRequired;   // LOGICAL
  OdDAI::Enum m_JoinType;   // IfcJointEnum
  IfcPositiveLengthMeasure m_RangeOfMovement;   // IfcPositiveLengthMeasure
  double m_FireRating;   // IfcTimeMeasure
  OdDAIObjectId m_ConstraintOf;   // IfcRelConnectsElements
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcConnectionConstraint, IfcConnectionConstraint> object.
*/
typedef OdSmartPtr<IfcConnectionConstraint> IfcConnectionConstraintPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCONNECTIONCONSTRAINT_AUTO_IMPL_H
