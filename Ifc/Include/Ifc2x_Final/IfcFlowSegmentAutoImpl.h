...
#ifndef _IFC2X_FINAL_IFCFLOWSEGMENT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCFLOWSEGMENT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcFlowSegment : public IfcDistributionFlowElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcFlowSegment);
  //DOM-IGNORE-END
...
public:
  ...
  IfcFlowSegmentTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcFlowSegmentTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcFlowSegmentTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcFlowSegment, IfcFlowSegment> object.
*/
typedef OdSmartPtr<IfcFlowSegment> IfcFlowSegmentPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCFLOWSEGMENT_AUTO_IMPL_H
