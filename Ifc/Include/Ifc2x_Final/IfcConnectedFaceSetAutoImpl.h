...
#ifndef _IFC2X_FINAL_IFCCONNECTEDFACESET_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCONNECTEDFACESET_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcConnectedFaceSet : public IfcTopologicalRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcConnectedFaceSet);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcConnectedFaceSet, IfcConnectedFaceSet> object.
*/
typedef OdSmartPtr<IfcConnectedFaceSet> IfcConnectedFaceSetPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCONNECTEDFACESET_AUTO_IMPL_H
