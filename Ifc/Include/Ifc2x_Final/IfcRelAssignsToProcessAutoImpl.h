...
#ifndef _IFC2X_FINAL_IFCRELASSIGNSTOPROCESS_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRELASSIGNSTOPROCESS_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRelAssignsToProcess : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRelAssignsToProcess);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRelAssignsToProcess, IfcRelAssignsToProcess> object.
*/
typedef OdSmartPtr<IfcRelAssignsToProcess> IfcRelAssignsToProcessPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRELASSIGNSTOPROCESS_AUTO_IMPL_H
