...
#ifndef _IFC2X_FINAL_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRelDefinesByType : public IfcRelDefines
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRelDefinesByType);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRelDefinesByType, IfcRelDefinesByType> object.
*/
typedef OdSmartPtr<IfcRelDefinesByType> IfcRelDefinesByTypePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRELDEFINESBYTYPE_AUTO_IMPL_H
