...
#ifndef _IFC2X_FINAL_IFCUNITASSIGNMENT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCUNITASSIGNMENT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcUnitAssignment : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcUnitAssignment);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcUnitAssignment, IfcUnitAssignment> object.
*/
typedef OdSmartPtr<IfcUnitAssignment> IfcUnitAssignmentPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCUNITASSIGNMENT_AUTO_IMPL_H
