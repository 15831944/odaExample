...
#ifndef _IFC2X_FINAL_IFCORGANIZATIONRELATIONSHIP_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCORGANIZATIONRELATIONSHIP_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcOrganizationRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcOrganizationRelationship);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcOrganizationRelationship, IfcOrganizationRelationship> object.
*/
typedef OdSmartPtr<IfcOrganizationRelationship> IfcOrganizationRelationshipPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCORGANIZATIONRELATIONSHIP_AUTO_IMPL_H
