...
#ifndef _IFC2X_FINAL_IFCBUILDING_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCBUILDING_AUTO_IMPL_H
...
*/
class IFC2X_FINAL_EXPORT IfcBuilding : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcBuilding);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcBuilding, IfcBuilding> object.
*/
typedef OdSmartPtr<IfcBuilding> IfcBuildingPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCBUILDING_AUTO_IMPL_H
