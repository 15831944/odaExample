...
#ifndef _IFC2X_FINAL_IFCMETRICBENCHMARK_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCMETRICBENCHMARK_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcMetricBenchmark : public IfcMetric
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcMetricBenchmark);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcMetricBenchmark, IfcMetricBenchmark> object.
*/
typedef OdSmartPtr<IfcMetricBenchmark> IfcMetricBenchmarkPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCMETRICBENCHMARK_AUTO_IMPL_H
