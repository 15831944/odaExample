...
#ifndef _IFC2X_FINAL_IFCHYGROSCOPICMATERIALPROPERTIES_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCHYGROSCOPICMATERIALPROPERTIES_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcHygroscopicMaterialProperties : public IfcMaterialProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcHygroscopicMaterialProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcHygroscopicMaterialProperties, IfcHygroscopicMaterialProperties> object.
*/
typedef OdSmartPtr<IfcHygroscopicMaterialProperties> IfcHygroscopicMaterialPropertiesPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCHYGROSCOPICMATERIALPROPERTIES_AUTO_IMPL_H
