...
#ifndef _IFC2X_FINAL_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRelServicesBuildings : public IfcRelConnects
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRelServicesBuildings);
  //DOM-IGNORE-END
...
protected:
  ...
  OdDAI::OdDAIObjectIdSet m_RelatedBuildings; // SET [1:?] of IfcBuilding
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRelServicesBuildings, IfcRelServicesBuildings> object.
*/
typedef OdSmartPtr<IfcRelServicesBuildings> IfcRelServicesBuildingsPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRELSERVICESBUILDINGS_AUTO_IMPL_H
