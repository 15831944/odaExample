...
#ifndef _IFC2X_FINAL_IFCPROPERTYSETDEFINITION_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPROPERTYSETDEFINITION_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcPropertySetDefinition : public IfcPropertyDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcPropertySetDefinition);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPropertySetDefinition, IfcPropertySetDefinition> object.
*/
typedef OdSmartPtr<IfcPropertySetDefinition> IfcPropertySetDefinitionPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPROPERTYSETDEFINITION_AUTO_IMPL_H
