...
#ifndef _IFC2X_FINAL_IFCTYPEPRODUCT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCTYPEPRODUCT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcTypeProduct : public IfcTypeObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcTypeProduct);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcTypeProduct, IfcTypeProduct> object.
*/
typedef OdSmartPtr<IfcTypeProduct> IfcTypeProductPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCTYPEPRODUCT_AUTO_IMPL_H
