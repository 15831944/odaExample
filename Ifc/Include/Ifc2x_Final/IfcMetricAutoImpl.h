...
#ifndef _IFC2X_FINAL_IFCMETRIC_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCMETRIC_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcMetric : public IfcConstraint
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcMetric);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::OdDAIObjectIdList m_Values; // LIST [1:?] of IfcMetricValue
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcMetric, IfcMetric> object.
*/
typedef OdSmartPtr<IfcMetric> IfcMetricPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCMETRIC_AUTO_IMPL_H
