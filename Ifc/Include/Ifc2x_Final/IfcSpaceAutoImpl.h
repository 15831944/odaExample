...
#ifndef _IFC2X_FINAL_IFCSPACE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSPACE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSpace : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcSpace);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSpace, IfcSpace> object.
*/
typedef OdSmartPtr<IfcSpace> IfcSpacePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSPACE_AUTO_IMPL_H
