...
#ifndef _IFC2X_FINAL_IFCSURFACESTYLE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSURFACESTYLE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSurfaceStyle : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcSurfaceStyle);
  //DOM-IGNORE-END
...
public:
  ...
  void getInvUsages(OdDAIObjectIds& Usages) const;
...
protected:
  ...
  OdDAI::OdDAIObjectIdSet m_Properties; // SET [1:?] of IfcSurfaceStyleProperties

  // Declare friend classes for inverse attributes functionality: 
  friend class IfcSurfaceStyleUsage;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSurfaceStyle, IfcSurfaceStyle> object.
*/
typedef OdSmartPtr<IfcSurfaceStyle> IfcSurfaceStylePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSURFACESTYLE_AUTO_IMPL_H
