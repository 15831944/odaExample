...
#ifndef _IFC2X_FINAL_IFCREFERENCEGEOMETRY_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCREFERENCEGEOMETRY_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcReferenceGeometry : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcReferenceGeometry);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_Placement;   // IfcAxis2Placement  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcReferenceGeometry, IfcReferenceGeometry> object.
*/
typedef OdSmartPtr<IfcReferenceGeometry> IfcReferenceGeometryPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCREFERENCEGEOMETRY_AUTO_IMPL_H
