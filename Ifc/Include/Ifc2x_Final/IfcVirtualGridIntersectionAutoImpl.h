...
#ifndef _IFC2X_FINAL_IFCVIRTUALGRIDINTERSECTION_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCVIRTUALGRIDINTERSECTION_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcVirtualGridIntersection : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcVirtualGridIntersection);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcVirtualGridIntersection, IfcVirtualGridIntersection> object.
*/
typedef OdSmartPtr<IfcVirtualGridIntersection> IfcVirtualGridIntersectionPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCVIRTUALGRIDINTERSECTION_AUTO_IMPL_H
