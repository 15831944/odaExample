...
#ifndef _IFC2X_FINAL_IFCELECTRICALELEMENT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCELECTRICALELEMENT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcElectricalElement : public IfcElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcElectricalElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcElectricalElement, IfcElectricalElement> object.
*/
typedef OdSmartPtr<IfcElectricalElement> IfcElectricalElementPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCELECTRICALELEMENT_AUTO_IMPL_H
