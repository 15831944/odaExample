...
#ifndef _IFC2X_FINAL_IFCCOSTMODIFIER_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCOSTMODIFIER_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCostModifier : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCostModifier);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_Purpose;   // IfcText
  OdDAI::Select m_ModifierValue;   // IfcCostModifierValueSelect
  OdDAIObjectId m_ModifierDate;   // IfcCalendarDate
  OdDAI::Enum m_CostOperator;   // IfcCostOperatorEnum
  OdDAI::Enum m_ModifierBasis;   // IfcCostModifierBasisEnum  [optional]
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCostModifier, IfcCostModifier> object.
*/
typedef OdSmartPtr<IfcCostModifier> IfcCostModifierPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCOSTMODIFIER_AUTO_IMPL_H
