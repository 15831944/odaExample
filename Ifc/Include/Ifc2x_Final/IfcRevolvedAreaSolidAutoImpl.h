...
#ifndef _IFC2X_FINAL_IFCREVOLVEDAREASOLID_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCREVOLVEDAREASOLID_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRevolvedAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRevolvedAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRevolvedAreaSolid, IfcRevolvedAreaSolid> object.
*/
typedef OdSmartPtr<IfcRevolvedAreaSolid> IfcRevolvedAreaSolidPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCREVOLVEDAREASOLID_AUTO_IMPL_H
