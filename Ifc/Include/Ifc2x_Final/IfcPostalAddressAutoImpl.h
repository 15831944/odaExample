...
#ifndef _IFC2X_FINAL_IFCPOSTALADDRESS_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPOSTALADDRESS_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcPostalAddress : public IfcAddress
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcPostalAddress);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPostalAddress, IfcPostalAddress> object.
*/
typedef OdSmartPtr<IfcPostalAddress> IfcPostalAddressPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPOSTALADDRESS_AUTO_IMPL_H
