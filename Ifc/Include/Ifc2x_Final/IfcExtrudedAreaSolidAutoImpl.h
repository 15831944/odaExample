...
#ifndef _IFC2X_FINAL_IFCEXTRUDEDAREASOLID_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCEXTRUDEDAREASOLID_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcExtrudedAreaSolid : public IfcSweptAreaSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcExtrudedAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcExtrudedAreaSolid, IfcExtrudedAreaSolid> object.
*/
typedef OdSmartPtr<IfcExtrudedAreaSolid> IfcExtrudedAreaSolidPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCEXTRUDEDAREASOLID_AUTO_IMPL_H
