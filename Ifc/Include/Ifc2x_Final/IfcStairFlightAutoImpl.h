...
#ifndef _IFC2X_FINAL_IFCSTAIRFLIGHT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSTAIRFLIGHT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcStairFlight : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcStairFlight);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcStairFlight, IfcStairFlight> object.
*/
typedef OdSmartPtr<IfcStairFlight> IfcStairFlightPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSTAIRFLIGHT_AUTO_IMPL_H
