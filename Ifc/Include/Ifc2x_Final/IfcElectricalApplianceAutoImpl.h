...
#ifndef _IFC2X_FINAL_IFCELECTRICALAPPLIANCE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCELECTRICALAPPLIANCE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcElectricalAppliance : public IfcElectricalElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcElectricalAppliance);
  //DOM-IGNORE-END
...
public:
  ...
  IfcElectricalApplianceTypeEnum getApplianceType() const;
  void setApplianceType(IfcElectricalApplianceTypeEnum ApplianceType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_ApplianceType;   // IfcElectricalApplianceTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcElectricalAppliance, IfcElectricalAppliance> object.
*/
typedef OdSmartPtr<IfcElectricalAppliance> IfcElectricalAppliancePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCELECTRICALAPPLIANCE_AUTO_IMPL_H
