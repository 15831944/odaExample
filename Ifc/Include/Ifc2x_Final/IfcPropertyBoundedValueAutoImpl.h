...
#ifndef _IFC2X_FINAL_IFCPROPERTYBOUNDEDVALUE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPROPERTYBOUNDEDVALUE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcPropertyBoundedValue : public IfcSimpleProperty
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcPropertyBoundedValue);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Select m_UpperBoundValue;   // IfcValue
  OdDAI::Select m_LowerBoundValue;   // IfcValue
  OdDAI::Select m_Unit;   // IfcUnit  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPropertyBoundedValue, IfcPropertyBoundedValue> object.
*/
typedef OdSmartPtr<IfcPropertyBoundedValue> IfcPropertyBoundedValuePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPROPERTYBOUNDEDVALUE_AUTO_IMPL_H
