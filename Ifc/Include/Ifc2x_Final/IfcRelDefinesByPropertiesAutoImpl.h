...
#ifndef _IFC2X_FINAL_IFCRELDEFINESBYPROPERTIES_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRELDEFINESBYPROPERTIES_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRelDefinesByProperties : public IfcRelDefines
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRelDefinesByProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRelDefinesByProperties, IfcRelDefinesByProperties> object.
*/
typedef OdSmartPtr<IfcRelDefinesByProperties> IfcRelDefinesByPropertiesPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRELDEFINESBYPROPERTIES_AUTO_IMPL_H
