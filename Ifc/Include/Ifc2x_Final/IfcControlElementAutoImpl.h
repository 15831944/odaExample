...
#ifndef _IFC2X_FINAL_IFCCONTROLELEMENT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCONTROLELEMENT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcControlElement : public IfcDistributionElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcControlElement);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_ControlElementId;   // IfcLabel
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcControlElement, IfcControlElement> object.
*/
typedef OdSmartPtr<IfcControlElement> IfcControlElementPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCONTROLELEMENT_AUTO_IMPL_H
