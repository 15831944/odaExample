...
#ifndef _IFC2X_FINAL_IFCRELASSOCIATESCLASSIFICATION_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRELASSOCIATESCLASSIFICATION_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRelAssociatesClassification : public IfcRelAssociates
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRelAssociatesClassification);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRelAssociatesClassification, IfcRelAssociatesClassification> object.
*/
typedef OdSmartPtr<IfcRelAssociatesClassification> IfcRelAssociatesClassificationPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRELASSOCIATESCLASSIFICATION_AUTO_IMPL_H
