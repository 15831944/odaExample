...
#ifndef _IFC2X_FINAL_IFCBOUNDINGBOX_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCBOUNDINGBOX_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcBoundingBox : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcBoundingBox);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcBoundingBox, IfcBoundingBox> object.
*/
typedef OdSmartPtr<IfcBoundingBox> IfcBoundingBoxPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCBOUNDINGBOX_AUTO_IMPL_H
