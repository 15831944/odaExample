...
#ifndef _IFC2X_FINAL_IFCCALENDARDATE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCALENDARDATE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCalendarDate : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCalendarDate);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCalendarDate, IfcCalendarDate> object.
*/
typedef OdSmartPtr<IfcCalendarDate> IfcCalendarDatePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCALENDARDATE_AUTO_IMPL_H
