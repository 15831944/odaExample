...
#ifndef _IFC2X_FINAL_IFCMATERIALLAYER_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCMATERIALLAYER_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcMaterialLayer : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcMaterialLayer);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcMaterialLayer, IfcMaterialLayer> object.
*/
typedef OdSmartPtr<IfcMaterialLayer> IfcMaterialLayerPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCMATERIALLAYER_AUTO_IMPL_H
