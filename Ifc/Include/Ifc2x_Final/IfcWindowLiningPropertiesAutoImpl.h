...
#ifndef _IFC2X_FINAL_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcWindowLiningProperties : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcWindowLiningProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcWindowLiningProperties, IfcWindowLiningProperties> object.
*/
typedef OdSmartPtr<IfcWindowLiningProperties> IfcWindowLiningPropertiesPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCWINDOWLININGPROPERTIES_AUTO_IMPL_H
