...
#ifndef _IFC2X_FINAL_IFCCLASSIFICATION_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCLASSIFICATION_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcClassification : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcClassification);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcClassification, IfcClassification> object.
*/
typedef OdSmartPtr<IfcClassification> IfcClassificationPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCLASSIFICATION_AUTO_IMPL_H
