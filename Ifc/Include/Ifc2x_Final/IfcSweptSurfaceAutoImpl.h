...
#ifndef _IFC2X_FINAL_IFCSWEPTSURFACE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSWEPTSURFACE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSweptSurface : public IfcSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcSweptSurface);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSweptSurface, IfcSweptSurface> object.
*/
typedef OdSmartPtr<IfcSweptSurface> IfcSweptSurfacePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSWEPTSURFACE_AUTO_IMPL_H
