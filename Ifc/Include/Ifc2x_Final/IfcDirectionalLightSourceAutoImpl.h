...
#ifndef _IFC2X_FINAL_IFCDIRECTIONALLIGHTSOURCE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCDIRECTIONALLIGHTSOURCE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcDirectionalLightSource : public IfcPresentationLightSource
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcDirectionalLightSource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcDirectionalLightSource, IfcDirectionalLightSource> object.
*/
typedef OdSmartPtr<IfcDirectionalLightSource> IfcDirectionalLightSourcePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCDIRECTIONALLIGHTSOURCE_AUTO_IMPL_H
