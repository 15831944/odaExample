...
#ifndef _IFC2X_FINAL_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSurfaceOfLinearExtrusion : public IfcSweptSurface
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcSurfaceOfLinearExtrusion);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSurfaceOfLinearExtrusion, IfcSurfaceOfLinearExtrusion> object.
*/
typedef OdSmartPtr<IfcSurfaceOfLinearExtrusion> IfcSurfaceOfLinearExtrusionPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSURFACEOFLINEAREXTRUSION_AUTO_IMPL_H
