...
#ifndef _IFC2X_FINAL_IFCCHANGEORDER_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCHANGEORDER_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcChangeOrder : public IfcProjectOrder
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcChangeOrder);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdAnsiString m_ChangeDescription;   // IfcText  [optional]
  OdAnsiString m_ReasonForChange;   // IfcText  [optional]
  ...
  OdDAI::Enum m_Status;   // IfcChangeOrderStatusEnum
  OdDAIObjectId m_ActualStartTime;   // IfcDateAndTime  [optional]
  OdDAIObjectId m_ActualFinishTime;   // IfcDateAndTime  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcChangeOrder, IfcChangeOrder> object.
*/
typedef OdSmartPtr<IfcChangeOrder> IfcChangeOrderPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCHANGEORDER_AUTO_IMPL_H
