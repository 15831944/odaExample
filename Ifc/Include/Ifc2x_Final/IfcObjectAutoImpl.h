...
#ifndef _IFC2X_FINAL_IFCOBJECT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCOBJECT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcObject : public IfcRoot
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcObject);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcObject, IfcObject> object.
*/
typedef OdSmartPtr<IfcObject> IfcObjectPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCOBJECT_AUTO_IMPL_H
