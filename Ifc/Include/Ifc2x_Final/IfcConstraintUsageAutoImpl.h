...
#ifndef _IFC2X_FINAL_IFCCONSTRAINTUSAGE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCONSTRAINTUSAGE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcConstraintUsage : public IfcControl
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcConstraintUsage);
  //DOM-IGNORE-END
...
public:
  ...
  IfcConstraintIntentEnum getIntent() const;
  void setIntent(IfcConstraintIntentEnum Intent);
  const OdDAIObjectId& getConstraint() const;
  void setConstraint(const OdDAIObjectId& Constraint);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_Intent;   // IfcConstraintIntentEnum
  OdDAIObjectId m_Constraint;   // IfcConstraint
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcConstraintUsage, IfcConstraintUsage> object.
*/
typedef OdSmartPtr<IfcConstraintUsage> IfcConstraintUsagePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCONSTRAINTUSAGE_AUTO_IMPL_H
