...
#ifndef _IFC2X_FINAL_IFCAXIS2PLACEMENT3D_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCAXIS2PLACEMENT3D_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcAxis2Placement3D : public IfcPlacement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcAxis2Placement3D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcAxis2Placement3D, IfcAxis2Placement3D> object.
*/
typedef OdSmartPtr<IfcAxis2Placement3D> IfcAxis2Placement3DPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCAXIS2PLACEMENT3D_AUTO_IMPL_H
