...
#ifndef _IFC2X_FINAL_IFCCONTEXTDEPENDENTUNIT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCONTEXTDEPENDENTUNIT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcContextDependentUnit : public IfcNamedUnit
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcContextDependentUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcContextDependentUnit, IfcContextDependentUnit> object.
*/
typedef OdSmartPtr<IfcContextDependentUnit> IfcContextDependentUnitPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCONTEXTDEPENDENTUNIT_AUTO_IMPL_H
