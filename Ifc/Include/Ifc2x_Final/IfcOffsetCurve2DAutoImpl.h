...
#ifndef _IFC2X_FINAL_IFCOFFSETCURVE2D_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCOFFSETCURVE2D_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcOffsetCurve2D : public IfcCurve
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcOffsetCurve2D);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcOffsetCurve2D, IfcOffsetCurve2D> object.
*/
typedef OdSmartPtr<IfcOffsetCurve2D> IfcOffsetCurve2DPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCOFFSETCURVE2D_AUTO_IMPL_H
