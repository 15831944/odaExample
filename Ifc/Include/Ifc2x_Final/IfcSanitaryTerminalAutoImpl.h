...
#ifndef _IFC2X_FINAL_IFCSANITARYTERMINAL_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSANITARYTERMINAL_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSanitaryTerminal : public IfcFlowTerminal
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcSanitaryTerminal);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSanitaryTerminal, IfcSanitaryTerminal> object.
*/
typedef OdSmartPtr<IfcSanitaryTerminal> IfcSanitaryTerminalPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSANITARYTERMINAL_AUTO_IMPL_H
