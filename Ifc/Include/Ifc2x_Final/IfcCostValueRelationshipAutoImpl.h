...
#ifndef _IFC2X_FINAL_IFCCOSTVALUERELATIONSHIP_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCOSTVALUERELATIONSHIP_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCostValueRelationship : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCostValueRelationship);
  //DOM-IGNORE-END
...
public:
  ...
  const OdDAIObjectId& getComponentOf() const;
  void setComponentOf(const OdDAIObjectId& ComponentOf);
  void getCostComponents(OdDAIObjectIds& CostComponents) const;
  OdDAI::OdDAIObjectIdSet& costComponents();
...
protected:
  // Fields declaration: 
  OdDAIObjectId m_ComponentOf;   // IfcCostValue
  OdDAI::OdDAIObjectIdSet m_CostComponents; // SET [1:?] of IfcCostValue
  OdAnsiString m_Description;   // IfcText  [optional]
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCostValueRelationship, IfcCostValueRelationship> object.
*/
typedef OdSmartPtr<IfcCostValueRelationship> IfcCostValueRelationshipPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCOSTVALUERELATIONSHIP_AUTO_IMPL_H
