...
#ifndef _IFC2X_FINAL_IFCMONETARYUNIT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCMONETARYUNIT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcMonetaryUnit : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcMonetaryUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcMonetaryUnit, IfcMonetaryUnit> object.
*/
typedef OdSmartPtr<IfcMonetaryUnit> IfcMonetaryUnitPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCMONETARYUNIT_AUTO_IMPL_H
