...
#ifndef _IFC2X_FINAL_IFCRELASSIGNSTORESOURCE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRELASSIGNSTORESOURCE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRelAssignsToResource : public IfcRelAssigns
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRelAssignsToResource);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRelAssignsToResource, IfcRelAssignsToResource> object.
*/
typedef OdSmartPtr<IfcRelAssignsToResource> IfcRelAssignsToResourcePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRELASSIGNSTORESOURCE_AUTO_IMPL_H
