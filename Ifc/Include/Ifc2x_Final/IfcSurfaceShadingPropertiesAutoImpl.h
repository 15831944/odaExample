...
#ifndef _IFC2X_FINAL_IFCSURFACESHADINGPROPERTIES_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSURFACESHADINGPROPERTIES_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSurfaceShadingProperties : public IfcSurfaceStyleProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcSurfaceShadingProperties);
  //DOM-IGNORE-END
...
public:
  ...
  void getAmbientColor(OdArray<double >& AmbientColor) const;
  OdDAI::DoubleList& ambientColor();
...
protected:
  // Fields declaration: 
  OdDAI::DoubleList m_AmbientColor; // IfcColorRGB
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSurfaceShadingProperties, IfcSurfaceShadingProperties> object.
*/
typedef OdSmartPtr<IfcSurfaceShadingProperties> IfcSurfaceShadingPropertiesPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSURFACESHADINGPROPERTIES_AUTO_IMPL_H
