...
#ifndef _IFC2X_FINAL_IFCRELASSIGNS_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRELASSIGNS_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRelAssigns : public IfcRelationship
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcRelAssigns);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRelAssigns, IfcRelAssigns> object.
*/
typedef OdSmartPtr<IfcRelAssigns> IfcRelAssignsPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRELASSIGNS_AUTO_IMPL_H
