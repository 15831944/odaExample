...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcHydronicHeater, IfcHydronicHeater> object.
*/
typedef OdSmartPtr<IfcHydronicHeater> IfcHydronicHeaterPtr;
