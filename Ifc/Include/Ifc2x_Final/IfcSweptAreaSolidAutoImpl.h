...
#ifndef _IFC2X_FINAL_IFCSWEPTAREASOLID_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSWEPTAREASOLID_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSweptAreaSolid : public IfcSolidModel
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcSweptAreaSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSweptAreaSolid, IfcSweptAreaSolid> object.
*/
typedef OdSmartPtr<IfcSweptAreaSolid> IfcSweptAreaSolidPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSWEPTAREASOLID_AUTO_IMPL_H
