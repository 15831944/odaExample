...
#ifndef _IFC2X_FINAL_IFCCLASSIFICATIONITEM_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCLASSIFICATIONITEM_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcClassificationItem : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcClassificationItem);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcClassificationItem, IfcClassificationItem> object.
*/
typedef OdSmartPtr<IfcClassificationItem> IfcClassificationItemPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCLASSIFICATIONITEM_AUTO_IMPL_H
