...
#ifndef _IFC2X_FINAL_IFCASSESSORY_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCASSESSORY_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcAssessory : public IfcEquipmentElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcAssessory);
  //DOM-IGNORE-END
...
public:
  ...
  const OdAnsiString& getMountingType() const;
  void setMountingType(const OdAnsiString& MountingType);
...
protected:
  // Fields declaration: 
  OdAnsiString m_MountingType;   // IfcLabel
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcAssessory, IfcAssessory> object.
*/
typedef OdSmartPtr<IfcAssessory> IfcAssessoryPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCASSESSORY_AUTO_IMPL_H
