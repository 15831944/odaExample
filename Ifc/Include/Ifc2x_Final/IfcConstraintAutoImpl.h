...
#ifndef _IFC2X_FINAL_IFCCONSTRAINT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCONSTRAINT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcConstraint : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcConstraint);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcConstraint, IfcConstraint> object.
*/
typedef OdSmartPtr<IfcConstraint> IfcConstraintPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCONSTRAINT_AUTO_IMPL_H
