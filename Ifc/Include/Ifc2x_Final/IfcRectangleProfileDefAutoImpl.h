...
#ifndef _IFC2X_FINAL_IFCRECTANGLEPROFILEDEF_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCRECTANGLEPROFILEDEF_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcRectangleProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcRectangleProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcRectangleProfileDef, IfcRectangleProfileDef> object.
*/
typedef OdSmartPtr<IfcRectangleProfileDef> IfcRectangleProfileDefPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCRECTANGLEPROFILEDEF_AUTO_IMPL_H
