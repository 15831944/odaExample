...
#ifndef _IFC2X_FINAL_IFCPROJECT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPROJECT_AUTO_IMPL_H
...
*/
class IFC2X_FINAL_EXPORT IfcProject : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcProject);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcProject, IfcProject> object.
*/
typedef OdSmartPtr<IfcProject> IfcProjectPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPROJECT_AUTO_IMPL_H
