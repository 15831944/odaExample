...
#ifndef _IFC2X_FINAL_IFCWINDOWSTYLE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCWINDOWSTYLE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcWindowStyle : public IfcTypeProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcWindowStyle);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcWindowStyle, IfcWindowStyle> object.
*/
typedef OdSmartPtr<IfcWindowStyle> IfcWindowStylePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCWINDOWSTYLE_AUTO_IMPL_H
