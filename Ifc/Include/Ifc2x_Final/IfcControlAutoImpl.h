...
#ifndef _IFC2X_FINAL_IFCCONTROL_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCONTROL_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcControl : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcControl);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcControl, IfcControl> object.
*/
typedef OdSmartPtr<IfcControl> IfcControlPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCONTROL_AUTO_IMPL_H
