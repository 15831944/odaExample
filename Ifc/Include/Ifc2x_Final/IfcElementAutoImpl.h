...
#ifndef _IFC2X_FINAL_IFCELEMENT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCELEMENT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcElement : public IfcProduct
{
  //DOM-IGNORE-BEGIN
  OD_EXP_NON_INSTANTIABLE_DECLARE_MEMBERS(OdIfc2x_final::IfcElement);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcElement, IfcElement> object.
*/
typedef OdSmartPtr<IfcElement> IfcElementPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCELEMENT_AUTO_IMPL_H
