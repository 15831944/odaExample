...
#ifndef _IFC2X_FINAL_IFCBUILDINGSTOREY_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCBUILDINGSTOREY_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcBuildingStorey : public IfcSpatialStructureElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcBuildingStorey);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcBuildingStorey, IfcBuildingStorey> object.
*/
typedef OdSmartPtr<IfcBuildingStorey> IfcBuildingStoreyPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCBUILDINGSTOREY_AUTO_IMPL_H
