...
#ifndef _IFC2X_FINAL_IFCSLAB_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCSLAB_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcSlab : public IfcBuildingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcSlab);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcSlab, IfcSlab> object.
*/
typedef OdSmartPtr<IfcSlab> IfcSlabPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCSLAB_AUTO_IMPL_H
