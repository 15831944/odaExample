...
#ifndef _IFC2X_FINAL_IFCPOLYGONALBOUNDEDHALFSPACE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPOLYGONALBOUNDEDHALFSPACE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcPolygonalBoundedHalfSpace : public IfcHalfSpaceSolid
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcPolygonalBoundedHalfSpace);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPolygonalBoundedHalfSpace, IfcPolygonalBoundedHalfSpace> object.
*/
typedef OdSmartPtr<IfcPolygonalBoundedHalfSpace> IfcPolygonalBoundedHalfSpacePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPOLYGONALBOUNDEDHALFSPACE_AUTO_IMPL_H
