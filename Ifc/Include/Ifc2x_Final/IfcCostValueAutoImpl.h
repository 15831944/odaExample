...
#ifndef _IFC2X_FINAL_IFCCOSTVALUE_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCOSTVALUE_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcCostValue : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcCostValue);
  //DOM-IGNORE-END
...
public:
  ...
  OdDAI::OdDAIObjectIdList& costModifiers();
...
protected:
  // Fields declaration: 
  double m_BaseCostValue;   // IfcMonetaryMeasure  [optional]
  double m_FinalCostValue;   // IfcMonetaryMeasure  [optional]
  OdDAI::Enum m_Currency;   // IfcCurrencyEnum  [optional]
  OdDAIObjectId m_UnitCostBasis;   // IfcMeasureWithUnit  [optional]
  OdAnsiString m_CostType;   // IfcLabel  [optional]
  OdDAIObjectId m_CostDate;   // IfcCalendarDate  [optional]
  OdDAI::OdDAIObjectIdList m_CostModifiers; // LIST [1:?] of IfcCostModifier [optional]


  // Declare friend classes for inverse attributes functionality: 
  friend class IfcCostValueRelationship;
  friend class IfcCostValueRelationship;
  friend class IfcReferencesCostDocument;
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcCostValue, IfcCostValue> object.
*/
typedef OdSmartPtr<IfcCostValue> IfcCostValuePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCOSTVALUE_AUTO_IMPL_H
