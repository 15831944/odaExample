...
#ifndef _IFC2X_FINAL_IFCDATEANDTIME_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCDATEANDTIME_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcDateAndTime : public OdIfc::OdIfcEntity
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcDateAndTime);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcDateAndTime, IfcDateAndTime> object.
*/
typedef OdSmartPtr<IfcDateAndTime> IfcDateAndTimePtr;

} // namespace

#endif // _IFC2X_FINAL_IFCDATEANDTIME_AUTO_IMPL_H
