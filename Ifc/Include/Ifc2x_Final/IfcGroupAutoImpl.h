...
#ifndef _IFC2X_FINAL_IFCGROUP_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCGROUP_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcGroup : public IfcObject
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcGroup);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcGroup, IfcGroup> object.
*/
typedef OdSmartPtr<IfcGroup> IfcGroupPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCGROUP_AUTO_IMPL_H
