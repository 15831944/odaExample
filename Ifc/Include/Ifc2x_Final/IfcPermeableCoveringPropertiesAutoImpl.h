...
#ifndef _IFC2X_FINAL_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcPermeableCoveringProperties : public IfcPropertySetDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcPermeableCoveringProperties);
  //DOM-IGNORE-END
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_OperationType;   // IfcPermeableCoveringOperationEnum
  OdDAI::Enum m_PanelPosition;   // IfcWindowPanelPositionEnum
  IfcPositiveLengthMeasure m_FrameDepth;   // IfcPositiveLengthMeasure  [optional]
  IfcPositiveLengthMeasure m_FrameThickness;   // IfcPositiveLengthMeasure  [optional]
  OdDAIObjectId m_ShapeAspectStyle;   // IfcShapeAspect
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcPermeableCoveringProperties, IfcPermeableCoveringProperties> object.
*/
typedef OdSmartPtr<IfcPermeableCoveringProperties> IfcPermeableCoveringPropertiesPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCPERMEABLECOVERINGPROPERTIES_AUTO_IMPL_H
