...
#ifndef _IFC2X_FINAL_IFCHALFSPACESOLID_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCHALFSPACESOLID_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcHalfSpaceSolid : public IfcGeometricRepresentationItem
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcHalfSpaceSolid);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcHalfSpaceSolid, IfcHalfSpaceSolid> object.
*/
typedef OdSmartPtr<IfcHalfSpaceSolid> IfcHalfSpaceSolidPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCHALFSPACESOLID_AUTO_IMPL_H
