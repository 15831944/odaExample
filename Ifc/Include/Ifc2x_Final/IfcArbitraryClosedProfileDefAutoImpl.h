...
#ifndef _IFC2X_FINAL_IFCARBITRARYCLOSEDPROFILEDEF_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCARBITRARYCLOSEDPROFILEDEF_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcArbitraryClosedProfileDef : public IfcProfileDef
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcArbitraryClosedProfileDef);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcArbitraryClosedProfileDef, IfcArbitraryClosedProfileDef> object.
*/
typedef OdSmartPtr<IfcArbitraryClosedProfileDef> IfcArbitraryClosedProfileDefPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCARBITRARYCLOSEDPROFILEDEF_AUTO_IMPL_H
