...
#ifndef _IFC2X_FINAL_IFCOPTICALMATERIALPROPERTIES_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCOPTICALMATERIALPROPERTIES_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcOpticalMaterialProperties : public IfcMaterialProperties
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcOpticalMaterialProperties);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcOpticalMaterialProperties, IfcOpticalMaterialProperties> object.
*/
typedef OdSmartPtr<IfcOpticalMaterialProperties> IfcOpticalMaterialPropertiesPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCOPTICALMATERIALPROPERTIES_AUTO_IMPL_H
