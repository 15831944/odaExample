...
#ifndef _IFC2X_FINAL_IFCCONVERSIONBASEDUNIT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCCONVERSIONBASEDUNIT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcConversionBasedUnit : public IfcNamedUnit
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcConversionBasedUnit);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcConversionBasedUnit, IfcConversionBasedUnit> object.
*/
typedef OdSmartPtr<IfcConversionBasedUnit> IfcConversionBasedUnitPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCCONVERSIONBASEDUNIT_AUTO_IMPL_H
