...
#ifndef _IFC2X_FINAL_IFCBUILTIN_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCBUILTIN_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcBuiltIn : public IfcFurnishingElement
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcBuiltIn);
  //DOM-IGNORE-END
...
public:
  ...
  IfcBuiltInTypeEnum getPredefinedType() const;
  void setPredefinedType(IfcBuiltInTypeEnum PredefinedType);
...
protected:
  // Fields declaration: 
  OdDAI::Enum m_PredefinedType;   // IfcBuiltInTypeEnum
};

/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcBuiltIn, IfcBuiltIn> object.
*/
typedef OdSmartPtr<IfcBuiltIn> IfcBuiltInPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCBUILTIN_AUTO_IMPL_H
