...
#ifndef _IFC2X_FINAL_IFCTYPEOBJECT_AUTO_IMPL_H
#define _IFC2X_FINAL_IFCTYPEOBJECT_AUTO_IMPL_H
...
class IFC2X_FINAL_EXPORT IfcTypeObject : public IfcPropertyDefinition
{
  //DOM-IGNORE-BEGIN
  OD_EXP_DECLARE_MEMBERS(OdIfc2x_final::IfcTypeObject);
  //DOM-IGNORE-END
...
/** \details
  A data type that represents a smart pointer to a <link OdIfc2x_final::IfcTypeObject, IfcTypeObject> object.
*/
typedef OdSmartPtr<IfcTypeObject> IfcTypeObjectPtr;

} // namespace

#endif // _IFC2X_FINAL_IFCTYPEOBJECT_AUTO_IMPL_H
