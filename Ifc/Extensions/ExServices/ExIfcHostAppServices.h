...
#ifndef _EX_IFC_HOST_APP_SERVICES_H_
#define _EX_IFC_HOST_APP_SERVICES_H_
...
*/
class OdExIfcHostAppProgressMeter : public OdDbHostAppProgressMeter
{
public:
  /** \details 
  Creates a new ODA IFC progress meter object.
  */
  OdExIfcHostAppProgressMeter();
...
private:
  OdExIfcHostAppProgressMeter m_progressMeter;
};

#endif  // _EX_IFC_HOST_APP_SERVICES_H_
