...
// OdExMvdXmlHostAppServices.h: interface for the OdExMvdXmlHostAppServices class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(ODA_ODEXMVDXMLHOSTAPPSERVICES_H_INCLUDED_)
#define ODA_ODEXMVDXMLHOSTAPPSERVICES_H_INCLUDED_
...
<group IFC_Protocol_Extensions_Classes>
*/
...
/** \details
  ...
  <group IFC_Protocol_Extensions_Classes>
*/
class OdExMvdXmlHostAppServices : public OdMvdXmlHostAppServices
{
public:
  /** \details
  Creates an instance of services for platform-dependent operations and progress metering.
  */
  OdExMvdXmlHostAppServices();
...
private:
  OdExMvdXmlHostAppProgressMeter m_progressMeter;
};


#endif // !defined(ODA_ODEXMVDXMLHOSTAPPSERVICES_H_INCLUDED_)
