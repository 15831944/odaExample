...
public:
  ...
  static void writeFaceDataToStlFile(const OdString& strFileName, const OdArray<OdIfcStlTriangleFace>& arrTriangles);
  static void addStlTriangle(const OdIfcStlTriangleFace& triangleData);
  static OdArray<OdIfcStlTriangleFace> getStlTriangles();
  static void clearStlTriangles();
private:
  static OdArray<OdIfcStlTriangleFace> m_arrTriangles;
};
