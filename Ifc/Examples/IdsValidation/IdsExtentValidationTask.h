...
#ifndef _IDS_EXTENT_VALIDATION_TASK_H
#define _IDS_EXTENT_VALIDATION_TASK_H
...
namespace OdIds
{
  class IDS_VALIDATION_EXPORT IdsExtentValidationTask : public OdDAI::ExtentValidationTask
  {
    //DOM-IGNORE-BEGIN
    ODRX_DECLARE_MEMBERS(IdsExtentValidationTask);
    //DOM-IGNORE-END

  public:

    IdsExtentValidationTask();
    static OdSmartPtr<IdsExtentValidationTask> createObject(OdAnsiString extantName);
  ...
  */
  typedef OdSmartPtr<IdsExtentValidationTask> IdsExtentValidationTaskPtr;
}
#endif // _IDS_EXTENT_VALIDATION_TASK_H
