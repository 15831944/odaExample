...
class ODIDS_DLLEXPORT OdIdsRequirementsTypeMaterial : public OdIdsMaterialType
{
  OdRxValue _uri;
  OdRxValue _use;
  OdRxValue _instructions;
public:
ODRX_DECLARE_MEMBERS(OdIdsRequirementsTypeMaterial);
  OdIdsRequirementsTypeMaterial();
  ~OdIdsRequirementsTypeMaterial();
...
typedef OdSmartPtr<OdIdsRequirementsTypeMaterial> OdIdsRequirementsTypeMaterialPtr;
typedef OdArray<OdIdsRequirementsTypeMaterialPtr> OdIdsRequirementsTypeMaterialPtrArray;

ODRX_DECLARE_VALUE_TYPE(OdIdsRequirementsTypeMaterialPtrArray, ODIDS_DLLEXPORT)
