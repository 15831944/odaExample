...
class ODIDS_DLLEXPORT OdIdsRequirementsTypeClassification : public OdIdsClassificationType
{
  OdRxValue _uri;
  OdRxValue _use;
  OdRxValue _instructions;
public:
ODRX_DECLARE_MEMBERS(OdIdsRequirementsTypeClassification);
  OdIdsRequirementsTypeClassification();
  ~OdIdsRequirementsTypeClassification();
...
typedef OdSmartPtr<OdIdsRequirementsTypeClassification> OdIdsRequirementsTypeClassificationPtr;
typedef OdArray<OdIdsRequirementsTypeClassificationPtr> OdIdsRequirementsTypeClassificationPtrArray;

ODRX_DECLARE_VALUE_TYPE(OdIdsRequirementsTypeClassificationPtrArray, ODIDS_DLLEXPORT)
