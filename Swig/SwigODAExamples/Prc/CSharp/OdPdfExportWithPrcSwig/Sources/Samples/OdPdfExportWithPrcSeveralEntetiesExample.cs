...
{
  public class OdPdfExportWithPrcSeveralEntetiesExample : OdPdfExportWithPrcExample
  {
    #region Interface
    public override string Description => "Creates and exports several entities into pdf as breps";
    #endregion
    ...
    public override void Execute(OdDbHostAppServices svcs, String pdfPath)
    {
      ...
      Execute(svcs, pdfPath, PDFExportParams.PRCSupport.kAsBrep, false, fillDatabase);
