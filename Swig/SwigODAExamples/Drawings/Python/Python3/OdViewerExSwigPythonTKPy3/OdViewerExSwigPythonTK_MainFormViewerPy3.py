...
from OdViewerExSwigPythonTK_ExAppServicesPy3 import *
from OdVectorizeFrameTKinterPy3 import *
from OdToolBarTkinterPy3 import *
...
class OdDemoViewerExSwigPythonTK_MainFormViewer_Py3(Tk):
    ...
    def InitMainForm(self):
        self.title("ODA Demo Python 3.x Viewer")
    ...
    def InitToolBar(self):
        self.Toolbar = OdToolBarTkinter_Py3(self,bd=1, relief=RIDGE)
    ...
    def InitVectorizeComponent(self):
        self.vectorizeComponent = OdVectorizeFrameTKinter_Py3(self, bg="gray")
    ...
    def FileOpenClick(self):
        ...
        if(dwgFilePath):
            ...
            #Open database
            self.pDatabase = self.hostApp.readFile(dwgFilePath,True,False,ODA_Kernel_Py3.kShareDenyNo,"")
