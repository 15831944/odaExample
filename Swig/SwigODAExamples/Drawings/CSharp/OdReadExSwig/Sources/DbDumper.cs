...
namespace OdReadExSwigMgd
{
  class DbDumper
  {
    private void dumpSummaryInfo(OdDbDatabase pDb)
    {
      OdDbDatabaseSummaryInfo sumInfo = TD_Db.oddbGetSummaryInfo(pDb);
      Console.WriteLine();
      Console.WriteLine("SummaryInfo:");

      String title = sumInfo.getTitle();
      String subject = sumInfo.getSubject();
      String Author = sumInfo.getAuthor();
      String Comments = sumInfo.getComments();
      String Keywords = sumInfo.getKeywords();
      String LastSavedBy = sumInfo.getLastSavedBy();
      String RevisionNumber = sumInfo.getRevisionNumber();
      Console.WriteLine("Title: = {0}", title);
      Console.WriteLine("Subject: = {0}", subject);
      Console.WriteLine("Author: = {0}", Author);
      Console.WriteLine("Comments: = {0}", Comments);
      Console.WriteLine("Keywords: = {0}", Keywords);
      Console.WriteLine("LastSavedBy: = {0}", LastSavedBy);
      Console.WriteLine("RevisionNumber: = {0}", RevisionNumber);

      int numCustoms = sumInfo.numCustomInfo();
      Console.WriteLine("Number of custom info: = {0}", numCustoms);
      for (int i = 0; i < numCustoms; i++)
      {
        String key = "";
        String value = "";
        sumInfo.getCustomSummaryInfo(i, ref key, ref value);
    ...
    void dumpHeader(OdDbDatabase pDb)
    {
      ...
      Console.WriteLine();
      Console.WriteLine("Filename: = {0}", OdExStringHelpers.shortenPath(pDb.getFilename()));
      ...
      Console.WriteLine("DIMBLK = {0}", OdExStringHelpers.toString(pDb.dimblk()));
      Console.WriteLine("DIMBLK1 = {0}", OdExStringHelpers.toString(pDb.dimblk1()));
      Console.WriteLine("DIMBLK2 = {0}", OdExStringHelpers.toString(pDb.dimblk2()));
      ...
      Console.WriteLine("DIMLDRBLK = {0}", OdExStringHelpers.toString(pDb.dimldrblk()));
      ...
      Console.WriteLine("DIMTXSTY = {0}", OdExStringHelpers.toString(pDb.dimtxsty()));
      ...
      Console.WriteLine("PUCSNAME = {0}", OdExStringHelpers.toString(pDb.getPUCSNAME()));
      ...
      Console.WriteLine("UCSNAME = {0}", OdExStringHelpers.toString(pDb.getUCSNAME()));
    ...
    void dumpLayers(OdDbDatabase pDb)
    {
      ...
      for (pIter.start(); !pIter.done(); pIter.step())
      {
        ...
        Console.WriteLine("Layer name: = {0}", TD_Db.getSymbolName(pRecord.objectId()));
        ...
        if (pRecord.numDashes() != 0)
        {
          ...
          for (int i = 0; i < pRecord.numDashes(); i++)
          {
            ...
            if (shapeNumber != 0 || text != "")
            {
              ...
              {
                buffer += ",R" + OdExStringHelpers.toDegreeString(pRecord.shapeRotationAt(i));
              }
    ...
    void dumpTextStyles(OdDbDatabase pDb)
    {
      ...
      for (pIter.start(); !pIter.done(); pIter.step())
      {
        ...
        Console.WriteLine("Obliquing Angle = {0}", OdExStringHelpers.toDegreeString(pRecord.obliquingAngle()));
        ...
        Console.WriteLine("Filename = {0}", OdExStringHelpers.shortenPath(pRecord.fileName()));
        Console.WriteLine("BigFont Filename = {0}", OdExStringHelpers.shortenPath(pRecord.bigFontFileName()));
    ...
    void dumpDimStyles(OdDbDatabase pDb)
    {
      ...
      for (pIter.start(); !pIter.done(); pIter.step())
      {
        ...
        Console.WriteLine((pRecord.isA().name()));
        Console.WriteLine("Name = {0}", (pRecord.getName()));
        Console.WriteLine("Arc Symbol = {0}", OdExStringHelpers.toArcSymbolTypeString(pRecord.getArcSymbolType()));
        ...
        Console.WriteLine("Extension Line 1 Linetype = {0}", OdExStringHelpers.toString(pRecord.getDimExt1Linetype()));
        Console.WriteLine("Extension Line 2 Linetype = {0}", OdExStringHelpers.toString(pRecord.getDimExt2Linetype()));
        Console.WriteLine("Dimension Line Linetype = {0}", OdExStringHelpers.toString(pRecord.getDimExt2Linetype()));
        ...
        Console.WriteLine("Jog Angle = {0}", OdExStringHelpers.toDegreeString(pRecord.getJogAngle()));
        ...
        Console.WriteLine("DIMBLK = {0}", OdExStringHelpers.toString(pRecord.dimblk()));
        Console.WriteLine("DIMBLK1 = {0}", OdExStringHelpers.toString(pRecord.dimblk1()));
        Console.WriteLine("DIMBLK2 = {0}", OdExStringHelpers.toString(pRecord.dimblk2()));
        ...
        Console.WriteLine("DIMLDRBLK = {0}", OdExStringHelpers.toString(pRecord.dimldrblk()));
        ...
        Console.WriteLine("DIMTXSTY = {0}", OdExStringHelpers.toString(pRecord.dimtxsty()));
    ...
    void dumpAbstractViewTableRecord(OdDbAbstractViewTableRecord pView)
    {
      ...
      Console.WriteLine("UCS Name = {0}", OdExStringHelpers.toString(pView.ucsName()));
      ...
      Console.WriteLine("Twist Angle = {0}", OdExStringHelpers.toDegreeString(pView.viewTwist()));
    ...
    void dumpViewports(OdDbDatabase pDb)
    {
      ...
      for (pIter.start(); !pIter.done(); pIter.step())
      {
        ...
        Console.WriteLine("Snap Angle = {0}", OdExStringHelpers.toDegreeString(pRecord.snapAngle()));
    ...
    void dumpMLineStyles(OdDbDatabase pDb)
    {
      ...
      for (; !pIter.done(); pIter.next())
      {
        ...
        Console.WriteLine("Start Angle = {0}", OdExStringHelpers.toDegreeString(pEntry.startAngle()));
        Console.WriteLine("End Angle = {0}", OdExStringHelpers.toDegreeString(pEntry.endAngle()));
        ...
        for (int i = 0; i < pEntry.numElements(); i++)
        {
          ...
          Console.WriteLine("Linetype = {0}", OdExStringHelpers.toString(linetypeId));
        }
      }
      MemoryManager.GetMemoryManager().StopTransaction(mTr);
    }
      ...
      for (; resbuf != null; resbuf = resbuf.next())
      {
        ...
        switch (OdDxfCode._getType(code))
        {
          ...
          case OdDxfCode.Type.Angle:
            rightString = OdExStringHelpers.toDegreeString(resbuf.getDouble());
            break;
