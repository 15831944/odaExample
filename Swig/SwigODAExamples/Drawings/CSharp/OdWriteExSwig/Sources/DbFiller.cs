      ...
      double[,] width =
  {
    ...
    void addLoftedSurfaces(OdDbObjectId btrId, int boxRow, int boxCol, OdDbObjectId layerId, OdDbObjectId styleId)
    {
      ...
      try
      {
        ...
        OdDbEntity e = null;
        ellipse.getTransformedCopy(mat, ref e);
    ...
    void addXRef(OdDbObjectId btrId, int boxRow, int boxCol, OdDbObjectId layerId, OdDbObjectId styleId)
    {
      ...
      /* Create a BlockTableRecord                                          */
      /**********************************************************************/
      OdDbBlockTableRecord pXRef = OdDbXRefManExt.addNewXRefDefBlock(pDb, "OdWriteEx_XRef.dwg", "XRefBlock", false);
    ...
    public void fillDatabase(OdDbDatabase pDb)
    {
      ...
      mMan.StopTransaction(mTr);
      mTr = mMan.StartTransaction();
      addMLeaders(pDb.getModelSpaceId(), 7, 3, odaLayer1Id, ttfStyleId);
      ...
      mMan.StopTransaction(mTr);
      mTr = mMan.StartTransaction();
      add3dSolidBox(pDb, 7, 5, odaLayer1Id, ttfStyleId);
      ...
      mMan.StopTransaction(mTr);
      mTr = mMan.StartTransaction();
      addBRepCylinder(pDb, 7, 6, odaLayer1Id, ttfStyleId);
      ...
      mMan.StopTransaction(mTr);
      mTr = mMan.StartTransaction();
      addSeamedCylinder(pDb, 7, 7, odaLayer1Id, ttfStyleId);
      ...
      mMan.StopTransaction(mTr);
      mTr = mMan.StartTransaction();
      addPointCloud(pDb, 7, 8, odaLayer1Id, ttfStyleId);
                            ...
                            OdDbObjectId noteStyleId)
    {
      ...
      /* Evaluate field                                                     */
      /**********************************************************************/
      pField1_1.evaluate((int)OdDbField.EvalOption.kAutomatic);
      ...
      /* Evaluate fields                                                    */
      /**********************************************************************/
      pField2_1.evaluate((int)OdDbField.EvalOption.kAutomatic);
      pField2_2.evaluate((int)OdDbField.EvalOption.kAutomatic);
      ...
      pMText.setLocation(point + new OdGeVector3d(w / 15.0, -h * 3.0 / 4.0, 0));
      pMText.setTextHeight(0.2);
      pMText.setAttachment(OdDbMText.AttachmentPoint.kTopLeft);
      pMText.setContents(("Sample Hyperlink"));
      pMText.setWidth(w * 7.0 / 8.0);
      pMText.setTextStyle(styleId);

      OdDbField pTextField3 = OdDbField.createObject();
      OdDbField pField3_1 = OdDbField.createObject();
      OdDbField pField3_2 = OdDbField.createObject();

      OdDbObjectId textFldId3 = pMText.setField("TEXT", pTextField3);
      OdDbObjectId fldId3_1 = pTextField3.setField("", pField3_1);
      OdDbObjectId fldId3_2 = pTextField3.setField("", pField3_2);

      pField3_1.setEvaluationOption(OdDbField.EvalOption.kAutomatic);
      String fc6 = ("\\AcVar \\href \"http://forum.opendesign.com/showthread.php?14172-How-do-I-add-a-hyperlink-to-an-MTEXT-entity##Open Design Alliance Forum > Teigha, C++ version#0\"");
      pField3_1.setFieldCode(fc6);

      OdDbEntityHyperlinkPE hpe = OdDbEntityHyperlinkPE.cast(pField3_1);
      OdDbHyperlinkCollection urls = hpe.getHyperlinkCollection(pField3_1);

      urls.addTail("http://forum.opendesign.com/showthread.php?14172-How-do-I-add-a-hyperlink-to-an-MTEXT-entity##ForumLink#0\"",
        "Open Design Alliance Forum > Teigha, C++ version");

      hpe.setHyperlinkCollection(pField3_1, urls);


      pField3_2.setEvaluationOption(OdDbField.EvalOption.kAutomatic);
      String fc8 = ("\\AcVar \\href \"http://www.opendesign.com##Open Design Alliance #1\"");
      pField3_2.setFieldCode(fc8);

      OdDbEntityHyperlinkPE hpe1 = OdDbEntityHyperlinkPE.cast(pField3_2);
      OdDbHyperlinkCollection urls1 = hpe.getHyperlinkCollection(pField3_2);

      urls1.addTail("http://www.opendesign.com##OpenDesignAlliance#1\"",
        "Open Design Alliance");

      hpe1.setHyperlinkCollection(pField3_2, urls1);

      pTextField3.setEvaluationOption(OdDbField.EvalOption.kAutomatic);
      String fc7 = "HyperLink sample %<\\_FldIdx 0>%  and  %<\\_FldIdx 1>%";
      pTextField3.setFieldCode(fc7, OdDbField.FieldCodeFlag.kTextField | OdDbField.FieldCodeFlag.kPreserveFields);

      pField3_1.evaluate((int)OdDbField.EvalOption.kAutomatic);
      pField3_2.evaluate((int)OdDbField.EvalOption.kAutomatic);
    ...
    #region FillNurbData
    void fillNurbData(OdGeNurbSurface nurbSurf, ref OdGeNurbCurve3dArray2d arrLoops, ref OdGeNurbCurve2dArray2d arrLoopsPar)
    {
      /********************************************************************/
    ...
    void addNURBSurface(OdDbDatabase pDb, int boxRow, int boxCol, OdDbObjectId layerId, OdDbObjectId styleId)
    {
      ...
      fillNurbData(nurbSurf, ref arrLoops, ref arrLoopsPar);
    ...
    void addPointCloud(OdDbDatabase pDb, int boxRow, int boxCol, OdDbObjectId layerId, OdDbObjectId styleId)
    {
      /**********************************************************************/
      /* Open the BlockTableRecord                                          */
      /**********************************************************************/
      ...
      addTextEnt(bBTR,
        ptUpperLeft + m_textOffset, ptUpperLeft + m_textOffset,
        "Point Cloud", m_textSize, TextHorzMode.kTextLeft, TextVertMode.kTextTop, layerId, styleId);
      ...
      /**********************************************************************/
      String pcgFileName = "bunny.pcg";

      OdGePoint3d p1 = new OdGePoint3d(), p2 = new OdGePoint3d();
      OdGeExtents3d extents = new OdGeExtents3d(p1, p2);
      OdGeVector3d translation = new OdGeVector3d();
      ...
      bool bFileAvailable;
      unchecked { bFileAvailable = TD_Db.odSystemServices().accessFile(pcgFileName, (int)FileAccessMode.kFileRead); }

      if (bFileAvailable)
      {
        OdRdFileBuf pcgFile = OdRdFileBuf.createObject(pcgFileName);

        bool canRead = true;
        // read pcg file version
        pcgFile.seek(3, FilerSeekType.kSeekFromStart);
        short pcgFileVer = OdPlatformStreamer.rdInt16(pcgFile);
        //seek to extents info
        if (pcgFileVer == 0x0003)
          pcgFile.seek(7, FilerSeekType.kSeekFromStart);
        else if (pcgFileVer == 0x0004)
          pcgFile.seek(19, FilerSeekType.kSeekFromStart);
        else
          canRead = false;
      ...
      OdGePoint3d location = EntityBoxes.getBoxCenter(boxRow, boxCol);
      ...
      /**********************************************************************/
      OdRxModule pPointCloudModule = Globals.odrxDynamicLinker().loadApp("AcDbPointCloudObj");

      if (pPointCloudModule != null)
      {
        /**********************************************************************/
        /* Create point cloud entity                                          */
        /**********************************************************************/
        OdDbPointCloud pPointCloud = null;
        TD_Db.oddbCreatePointCloudEntity(bBTR, ref pPointCloud, pcgFileName, String.Empty, location, scale);
