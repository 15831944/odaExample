...
{
  public class OdExCircleRadiusJigWinForms : OdExJigWinForms
  {
    public OdExCircleRadiusJigWinForms(Control targetControl, OdExCircleRadiusJig jig) : base(targetControl, jig)
    { }
