...
Public Class PDFParams
  ...
  Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
    ...
    ui_Compression = CUShort(prcCompressionList.SelectedIndex) 'new
    m_bLinearize = Linearize.Checked 'new

    m_bAsciiHex = AsciiHex.Checked ' new
    m_bIgnoreInvisible = chbIgnoreInv.Checked ' new
    ui_ColorPolicy = CUShort(colorPolicyList.SelectedIndex) 'new
    ui_SolidHatches = CUShort(solidHatchesList.SelectedIndex) ' new
    ui_GradientHatches = CUShort(gradientHatchesList.SelectedIndex) 'new
    ui_OtherHatches = CUShort(otherHatchesList.SelectedIndex) 'new
