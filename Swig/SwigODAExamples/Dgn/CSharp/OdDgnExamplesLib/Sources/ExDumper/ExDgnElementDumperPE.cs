...
namespace OdDgnExamplesMgdLib.ExDumper
{
  public abstract class OdExDgnDumper
  {
    ...
    public void writeFieldValue(string name, OdDgTextExtendedPropertiesImpl.OdDgTextExtendedProperties_LineSpacingType value)
    {
      ...
      switch (value)
      {
        case OdDgTextExtendedPropertiesImpl.OdDgTextExtendedProperties_LineSpacingType.kExact: val = "Exact"; break;
        case OdDgTextExtendedPropertiesImpl.OdDgTextExtendedProperties_LineSpacingType.kAutomatic: val = "Automatic"; break;
        case OdDgTextExtendedPropertiesImpl.OdDgTextExtendedProperties_LineSpacingType.kFromLineTop: val = "FromLineTop"; break;
        case OdDgTextExtendedPropertiesImpl.OdDgTextExtendedProperties_LineSpacingType.kAtLeast: val = "AtLeast"; break;
      }
      dumpFieldValue(val);
    }
    ...
    public void writeFieldValue(string name, OdDgGradientFill.OdDgGradientType value)
    {
      string strValue;

      switch (value)
      {
        case OdDgGradientFill.OdDgGradientType.kCurved:
          {
            strValue = "kCurved";
          }
          break;

        case OdDgGradientFill.OdDgGradientType.kCylindrical:
          {
            strValue = "kCylindrical";
          }
          break;

        case OdDgGradientFill.OdDgGradientType.kSpherical:
          {
            strValue = "kSpherical";
          }
          break;

        case OdDgGradientFill.OdDgGradientType.kHemispherical:
          {
    ...
    public void writeFieldValue(string name, Teigha.TG.OdDgMaterialType value)
    {
      string strValue;

      switch (value)
      {
        case Teigha.TG.OdDgMaterialType.kLevelOverride:
          {
            strValue = "kLevelOverride";
          }
          break;
        case Teigha.TG.OdDgMaterialType.kByLevelAssigned:
          {
  ...
  public class OdDgRxObjectDumperPE
  {
  ...
  public class OdDgElementDumperPE : OdDgRxObjectDumperPE
  {
            ...
            case OdDgAttributeLinkage.PrimaryIds.kHatch:
              {
                ...
                {
                  pDumper.writeFieldValue("  Pattern Type", (UInt32)pHatchPattern.getType());
                  ...
                  if (pHatchPattern.getType() == OdDgHatchPattern.PatternType.kDWGPattern)
                  {
                    OdDgDWGHatchPattern pDWGPattern = pHatchPattern as OdDgDWGHatchPattern;
                    ...
                    {
                      DWGHatchLine hatchLine = hatch[k];
                  ...
                  else if (pHatchPattern.getType() == OdDgHatchPattern.PatternType.kSymbolPattern)
                  {
                    OdDgSymbolHatchPattern pSymPattern = pHatchPattern as OdDgSymbolHatchPattern;
      ...
      if (xattributes.Count > 0)
      {
        for (int i = 0; i < xattributes.Count; ++i)
        {
          ...
          if (pBinXml != null)
          {
            ...
            /*const*/
            OdDgBinXMLNode pRoot = pBinXml.getRootNode();

            //for (UInt32 i = 0; i < pBinXml.getChildCount(); i++)
            //{
            //  OdDgBinXMLItemPtr pItem = pRoot->getChildItem(i);
            //
            //  if (!pItem->isXmlNode())
            //  {
            //  }
  ...
  //
  //----------------------------------------------------------
  public class OdDgDatabaseDumperPE : OdDgElementDumperPE
  {
  ...
  public class OdDgModelTableDumperPE : OdDgElementDumperPE
  {
  ...
  //
  //----------------------------------------------------------
  public class OdDgFontTableDumperPE : OdDgElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgModelDumperPE : OdDgElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgViewGroupTableDumperPE : OdDgElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgNamedViewTableDumperPE : OdDgElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgSharedCellDefinitionTableDumperPE : OdDgElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgTagDefinitionSetTableDumperPE : OdDgElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgNonModelElementCollectionPE : OdDgElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  //
  //----------------------------------------------------------
  public class OdDgTableRecordDumperPE : OdDgElementDumperPE
  {
    public override String getName(OdRxObject pObj)
    {
  ...
  public class OdDgLevelTableRecordDumperPE : OdDgTableRecordDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgLevelFilterTableRecordDumperPE : OdDgTableRecordDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgTableDumperPE : OdDgElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgLineStyleTableDumperPE : OdDgTableDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgLevelFilterTableDumperPE : OdDgTableDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgFontTableRecordDumperPE : OdDgTableRecordDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgTextStyleTableRecordDumperPE : OdDgTableRecordDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgDimStyleTableRecordDumperPE : OdDgTableRecordDumperPE
  {
  ...
  public class OdDgMultilineStyleTableRecordDumperPE : OdDgTableRecordDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgMaterialTableRecordDumperPE : OdDgTableRecordDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgLineStyleTableRecordDumperPE : OdDgTableRecordDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgLineStyleDefTableRecordDumperPE : OdDgTableRecordDumperPE
  {
    public override String getName(OdRxObject pObj)
    {
      OdDgTableRecord pRec = (OdDgTableRecord)pObj;
  ...
  public class OdDgDictionaryTableRecordDumperPE : OdDgTableRecordDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgRegAppTableRecordDumperPE : OdDgTableRecordDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgViewGroupDumperPE : OdDgElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgViewDumperPE : OdDgElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgLevelMaskDumperPE : OdDgElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgSharedCellDefinitionDumperPE : OdDgGraphicsElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgSharedCellReferenceDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgTagDefinitionSetDumperPE : OdDgElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgTagDefinitionDumperPE : OdDgElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
  ...
  public class OdDgColorTableDumperPE : OdDgElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgElementTemplateTableDumperPE : OdDgElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgApplicationDataDumperPE : OdDgElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgReferenceAttachmentHeaderDumperPE : OdDgElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgGraphicsElementDumperPE : OdDgElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgLine2dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgLine3dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgLineString2dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgLineString3dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgText2dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgText3dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgTextNode2dDumperPE : OdDgGraphicsElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgTextNode3dDumperPE : OdDgGraphicsElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgShape2dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgShape3dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgCurve2dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgCurve3dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgEllipse2dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgEllipse3dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgArc2dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgArc3dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgConeDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgComplexStringDumperPE : OdDgGraphicsElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgComplexShapeDumperPE : OdDgGraphicsElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgPointString2dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgPointString3dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgDimensionDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgMultilineDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgBSplineCurve2dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgBSplineCurve3dDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgSurfaceDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgSolidDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgMeshFaceLoopsDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgRasterAttachmentHeaderDumperPE : OdDgElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgRasterHeader2dDumperPE : OdDgGraphicsElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgRasterHeader3dDumperPE : OdDgGraphicsElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgRasterComponentDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgTagElementDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgCellHeader2dDumperPE : OdDgGraphicsElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgCellHeader3dDumperPE : OdDgGraphicsElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgDistantLightDumperPE : OdDgCellHeader3dDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgPointLightDumperPE : OdDgCellHeader3dDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgSpotLightDumperPE : OdDgCellHeader3dDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgAreaLightDumperPE : OdDgCellHeader3dDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgSkyOpeningLightDumperPE : OdDgCellHeader3dDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgBSplineSurfaceDumperPE : OdDgGraphicsElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgProxyElementDumperPE : OdDgElementDumperPE
  {
    protected override void dumpData(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dumpData(pObj, pDumper);
  ...
  public class OdDgComplexProxyElementDumperPE : OdDgProxyElementDumperPE
  {
    public override OdDgElementIterator createIterator(OdDgElement pElm, bool atBeginning, bool skipDeleted)
    {
  ...
  public class OdDgCompoundLineStyleResourceDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
  ...
  public class OdDgLineCodeResourceDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dump(pObj, pDumper);
  ...
  public class OdDgLinePointResourceDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dump(pObj, pDumper);
  ...
  public class OdDgPointSymbolResourceDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dump(pObj, pDumper);
  ...
  public class OdDgLinearAssociationDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dump(pObj, pDumper);
  ...
  public class OdDgIntersectAssociationDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dump(pObj, pDumper);
  ...
  public class OdDgArcAssociationDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dump(pObj, pDumper);
  ...
  public class OdDgMultilineAssociationDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dump(pObj, pDumper);
  ...
  public class OdDgBSplineCurveAssociationDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dump(pObj, pDumper);
  ...
  public class OdDgProjectionAssociationDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dump(pObj, pDumper);
  ...
  public class OdDgOriginAssociationDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dump(pObj, pDumper);
  ...
  public class OdDgIntersect2AssociationDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dump(pObj, pDumper);
  ...
  public class OdDgMeshVertexAssociationDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dump(pObj, pDumper);
  ...
  public class OdDgMeshEdgeAssociationDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dump(pObj, pDumper);
  ...
  public class OdDgBSplineSurfaceAssociationDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dump(pObj, pDumper);
  ...
  public class OdDgUnknownAssociationDumperPE : OdDgRxObjectDumperPE
  {
    public override void dump(OdRxObject pObj, OdExDgnDumper pDumper)
    {
      base.dump(pObj, pDumper);
