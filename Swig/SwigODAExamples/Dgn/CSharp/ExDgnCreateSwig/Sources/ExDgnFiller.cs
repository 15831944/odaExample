  ...
  class OdExDgnFiller : IDisposable
  {
    ...
    void addPatterns(int boxRow, int boxColumn)
    {
      ...
      //linear hatch
      {
        ...
        OdDgLinearHatchPattern pPattern = (OdDgLinearHatchPattern)OdDgLinearHatchPattern.createObject();
        pPattern.setSpace(m_pModel3d.convertWorkingUnitsToUORs(0.2));
        pPattern.setAngle(0.45);
      ...
      //cross hatch
      {
        ...
        OdDgCrossHatchPattern pCrossPattern = (OdDgCrossHatchPattern)OdDgCrossHatchPattern.createObject();
        pCrossPattern.setSpace1(m_pModel3d.convertWorkingUnitsToUORs(.1));
        pCrossPattern.setAngle1(.1);
        pCrossPattern.setSpace2(m_pModel3d.convertWorkingUnitsToUORs(.3));
      ...
      //symbol hatch
      {
        ...
        OdDgSymbolHatchPattern pSymbolHatch = (OdDgSymbolHatchPattern)OdDgSymbolHatchPattern.createObject();
        pSymbolHatch.setSpace1(m_pModel3d.convertWorkingUnitsToUORs(.1));
        pSymbolHatch.setAngle1(0.0);
        pSymbolHatch.setSpace2(m_pModel3d.convertWorkingUnitsToUORs(.1));
        pSymbolHatch.setAngle2(.5);
        pSymbolHatch.setScale(m_pModel3d.convertWorkingUnitsToUORs(.1));
