...
namespace OdKernelExamplesUIMgdLib.Export.Pdf
{
  ...
  {
    public static void Export<TPdfExportParamsFiller>(OdRxObject database, OdRxObject rxHostApp)
       where TPdfExportParamsFiller : OdExPdfExportParamsFiller, new()
    {
      ...
      try
      {
        ...
        using (PDFExportParams parametrsExport = formFillExportParameters.PdfExportParamsFiller.Generate(database, rxHostApp))
        {
