...
{
  public class OdExViewPanWpf : OdExViewPan, OdExViewFunctionalityInterface
  {
    private UserControl m_targetControl;

    public OdExViewPanWpf(UserControl TargetControl) : base()
    {
