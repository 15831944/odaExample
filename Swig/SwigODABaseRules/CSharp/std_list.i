...
%define SWIG_STD_LIST_MINIMUM(NAME, CSTYPE, CTYPE...)
%typemap(csinterfaces) NAME<CTYPE > "IDisposable, System.Collections.IEnumerable";
%typemap(cscode) NAME<CTYPE > %{
...
%}
  ...
  public:
    ...
    %extend {
      ...
      std::list<CTYPE>::iterator append() { return insert(self->end(), CTYPE()); }
    }
%enddef
...
namespace std {
  template<> class list<CTYPE > {
    SWIG_STD_LIST_MINIMUM(std::list, CSTYPE, CTYPE)
    SWIG_STD_LIST_EXTRA_OP_EQUALS_EQUALS(CSTYPE, CTYPE)
  };
}
%enddef

%define SWIG_OD_LIST_SPECIALIZE(CSTYPE, CTYPE...)
  template<> class OdList<CTYPE > {
    SWIG_STD_LIST_MINIMUM(OdList, CSTYPE, CTYPE)
    SWIG_STD_LIST_EXTRA_OP_EQUALS_EQUALS(CSTYPE, CTYPE)
  };
%enddef
...
namespace std {
  ...
  template<class T> class list {
    SWIG_STD_LIST_MINIMUM(std::list, T, T)
  };
}

template<class T> class OdList
{
    SWIG_STD_LIST_MINIMUM(OdList, T, T)
};
