...
public:
  ...
  virtual bool worldDraw(const OdDgDatabase* pDb, OdRxObjectPtr dwgDatabase, const OdString& strLayoutName, bool bShowLineWeight = true, OdGiWorldDraw* pWd = NULL) = 0;
  ...
  virtual void updateLayerTableByLevelTable(OdRxObjectPtr& pDwgDb, const OdDgLevelTablePtr& pDgLevelTable) = 0;
};
