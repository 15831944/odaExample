...
*/
class OdDgElementCompositeIterator : public OdDgElementIterator
{
  ODRX_DECLARE_MEMBERS(OdDgElementCompositeIterator);
public:
  OdDgElementCompositeIterator() { m_uActualIterator = 0; }

  virtual void addIterator(OdDgElementIteratorPtr pIter);

  virtual void start( bool atBeginning = true, bool skipErased = true);
  virtual bool done() const;
  virtual OdDgElementId item() const;
  virtual void step( bool forward = true, bool skipErased = true);
  virtual bool seek( const OdDgElementId& objectId);
private:
  OdArray<OdDgElementIteratorPtr> m_pIterArr;
  OdUInt32 m_uActualIterator;
};

typedef OdSmartPtr<OdDgElementCompositeIterator> OdDgElementCompositeIteratorPtr;

/**
  <group Dg_Extension_Classes>
*/
class OdDgElementCompositeIteratorImpl : public OdRxObjectImpl< OdDgElementCompositeIterator>
{
  public:
    OdDgElementCompositeIteratorImpl() {};
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgCurveElementDumperPE : public OdDgGraphicsElementDumperPE
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgTextStyleTableDumperPE : public OdDgTableDumperPE
{
public:
  virtual bool hasSubElements(OdDgElementPtr pElm) const { return true; }
};
/**
  <group Dg_Extension_Classes>
*/
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgPrototypeElementPE : public OdDgElementDumperPE
{
public:
  virtual OdString getName( OdRxObjectPtr pObj ) const
  {
    OdDgPrototypeElementPtr pRec = pObj;
    OdString s;
...
public:
  virtual OdString getName( OdRxObjectPtr pObj ) const
  {
    ...
    OdString s;
    s.format(L"<0x%04X> - %ls", (OdUInt64)(pRec->elementId().getHandle()), pRec->getName().c_str());
    return s;
  }
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgECSchemaDumperPE : public OdDgElementDumperPE
{
public:
  virtual void dumpData(OdRxObjectPtr pObj, OdExDgnDumper* pDumper) const;
  ...
  virtual OdDgElementIteratorPtr createIterator(OdDgElementPtr pElm, bool atBeginning = true, bool skipDeleted = true) const
  {
    OdDgECSchemaPtr pSchema = pElm;

    return pSchema->createIterator(atBeginning, skipDeleted);
  }
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgLine2dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgLine3dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgLineString2dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgLineString3dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
public:
  ...
  virtual OdDgElementIteratorPtr createIterator(OdDgElementPtr pElm, bool atBeginning = true, bool skipDeleted = true) const
  {
    OdDgRasterFramePtr pRasterFrame = pElm;

    OdDgElementCompositeIteratorPtr pCompositeIter = OdDgElementCompositeIterator::createObject();
    pCompositeIter->addIterator(pRasterFrame->createClipBoundaryElementIterator(atBeginning, skipDeleted));
    pCompositeIter->addIterator(pRasterFrame->createClipMaskElementIterator(atBeginning, skipDeleted));

    return pCompositeIter;
  }
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgShape2dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgShape3dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgCurve2dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgCurve3dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgEllipse2dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgEllipse3dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgArc2dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgArc3dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgPointString2dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgPointString3dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgBSplineCurve2dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgBSplineCurve3dDumperPE : public OdDgCurveElementDumperPE 
{
public:
  virtual void dumpData( OdRxObjectPtr pObj, OdExDgnDumper* pDumper ) const;
};
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgComplexShapeDumperPE : public OdDgCurveElementDumperPE
{
public:
  virtual OdDgElementIteratorPtr createIterator( OdDgElementPtr pElm, bool atBeginning = true, bool skipDeleted = true ) const
  {
...
/**
  <group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgComplexStringDumperPE : public OdDgCurveElementDumperPE
{
public:
  virtual OdDgElementIteratorPtr createIterator( OdDgElementPtr pElm, bool atBeginning = true, bool skipDeleted = true ) const
  {
...
<group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgTextTableElementDumperPE : public OdDgGraphicsElementDumperPE
{
public:
  virtual void dumpData(OdRxObjectPtr pObj, OdExDgnDumper* pDumper) const;
};
...
<group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgProxyGraphicsElementDumperPE : public OdDgElementDumperPE
{
public:
  virtual void dumpData(OdRxObjectPtr pObj, OdExDgnDumper* pDumper) const;
};
...
<group Dg_Extension_Classes>
*/
class TG_EXPORT OdDgComplexProxyGraphicsElementDumperPE : public OdDgProxyElementDumperPE
{
public:
  virtual OdDgElementIteratorPtr createIterator(OdDgElementPtr pElm, bool atBeginning = true, bool skipDeleted = true) const;
  virtual void dumpData(OdRxObjectPtr pObj, OdExDgnDumper* pDumper) const;
