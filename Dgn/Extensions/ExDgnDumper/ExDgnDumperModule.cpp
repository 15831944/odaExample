...
private:
  ...
  OdDgTextStyleTableDumperPE            m_textStyleTableDumper;
  ...
  OdDgECSchemaDumperPE                  m_ecSchemaDumper;
  ...
  OdDgPrototypeElementPE                m_tablePrototypeDumper;
  ...
  OdDgProxyGraphicsElementDumperPE      m_proxyGraphicsDumper;
  OdDgComplexProxyElementDumperPE       m_complexProxyDumper;
  OdDgComplexProxyGraphicsElementDumperPE m_complexProxyGraphicsDumper;

  OdDgTextTableElementDumperPE          m_textTableDumper;
...
void OdDgDumperImpl::initApp()
{
  ...
  OdDgElementCompositeIterator::rxInit();
  ...
  OdDgTextStyleTable::desc()->addX( OdDgElementDumperPE::desc(), &m_textStyleTableDumper);
  ...
  OdDgECSchema::desc()->addX( OdDgElementDumperPE::desc(), &m_ecSchemaDumper);
  ...
  OdDgPrototypeElement::desc()->addX(OdDgPrototypeElementPE::desc(), &m_tablePrototypeDumper );
  ...
  OdDgTableElement::desc()->addX(OdDgElementDumperPE::desc(), &m_textTableDumper);
  ...
  OdDgProxyGraphicsElement::desc()->addX(OdDgElementDumperPE::desc(), &m_proxyGraphicsDumper);
  OdDgComplexProxyGraphicsElement::desc()->addX(OdDgElementDumperPE::desc(), &m_complexProxyGraphicsDumper);
...
void OdDgDumperImpl::uninitApp()
{
  ...
  OdDgECSchema::desc()->delX(OdDgElementDumperPE::desc());
  ...
  OdDgPrototypeElement::desc()->delX( OdDgElementDumperPE::desc() );
  ...
  OdDgProxyGraphicsElement::desc()->delX(OdDgElementDumperPE::desc() );
  OdDgComplexProxyGraphicsElement::desc()->delX(OdDgElementDumperPE::desc() );

  OdDgTableElement::desc()->delX(OdDgElementDumperPE::desc());
  ...
  OdDgElementCompositeIterator::rxUninit();
