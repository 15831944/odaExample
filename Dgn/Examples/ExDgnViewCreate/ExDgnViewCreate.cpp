...
#endif
{
  ...
  /**********************************************************************/
  STD(cout) << "\nExDgnViewCreate sample program. Copyright (c) 2019, Open Design Alliance\n";
  ...
  if (bInvalidArgs)    
  {
    STD(cout)  << "\n\n\tusage: ExDgnViewCreate <filename> [-DO]";
    STD(cout)  << "\n\t-DO disables progress meter output.\n";
    return nRes;
  }
