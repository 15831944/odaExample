...
///////////////////////////////////////////////////////////////////////////////
/************************************************************************/
/* This console application creates DGN file with transformed cells.    */
/*                                                                      */
/* Calling sequence:                                                    */
/*                                                                      */
/* ExDgnCellTransform <filename> [-DO]                                  */
/*                                                                      */
...
#endif
{
  ...
  /**********************************************************************/
  STD(cout) << "\nExDgnCellTransform test program. Copyright (c) 2019, Open Design Alliance\n";
  ...
  if (bInvalidArgs)    
  {
    STD(cout)  << "\n\n\tusage: ExDgnCellTransform <filename> [-DO]";
    STD(cout)  << "\n\t-DO disables progress meter output.\n";
    return nRes;
  }
  ...
  try
  {
    ...
    /* Fill the database                                                */
    /********************************************************************/
    OdDgnCellTransformFiller filler(pDb);
    filler.fillModel2d();
    filler.fillModel3d();
