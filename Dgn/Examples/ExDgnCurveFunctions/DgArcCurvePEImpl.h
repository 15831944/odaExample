...
#ifndef _ODDGARCCURVEFUNCTIONS_INCLUDED
#define _ODDGARCCURVEFUNCTIONS_INCLUDED

#include "DgCurveElement2d.h"
#include "DgCurveElement3d.h"

/************************************************************************/
/* This class is the Curve Protocol Extension class for OdDgArc2d       */
/* objects.                                                             */ 
/************************************************************************/
class OdDgArcElement2dCurvePE : public OdDgCurveElement2dPE
{
public:
...
typedef OdSmartPtr<OdDgArcElement2dCurvePE> OdDgArcElement2dCurvePEPtr;

/************************************************************************/
/* This class is the Curve Protocol Extension class for OdDgArc3d       */
/* objects.                                                             */ 
/************************************************************************/
class OdDgArcElement3dCurvePE : public OdDgCurveElement3dPE
{
public:
...
typedef OdSmartPtr<OdDgArcElement3dCurvePE> OdDgArcElement3dCurvePEPtr;
