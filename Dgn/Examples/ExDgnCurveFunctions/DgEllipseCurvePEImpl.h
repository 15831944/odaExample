...
#ifndef _ODDGELLIPSECURVEFUNCTIONS_INCLUDED
#define _ODDGELLIPSECURVEFUNCTIONS_INCLUDED

#include "DgCurveElement2d.h"
#include "DgCurveElement3d.h"

/************************************************************************/
/* This class is the Curve Protocol Extension class for OdDgEllipse2d   */
/* objects.                                                             */ 
/************************************************************************/
class OdDgEllipseElement2dCurvePE : public OdDgCurveElement2dPE
{
public:
...
typedef OdSmartPtr<OdDgEllipseElement2dCurvePE> OdDgEllipseElement2dCurvePEPtr;

/************************************************************************/
/* This class is the Curve Protocol Extension class for OdDgEllipse3d   */
/* objects.                                                             */ 
/************************************************************************/
class OdDgEllipseElement3dCurvePE : public OdDgCurveElement3dPE
{
public:
...
typedef OdSmartPtr<OdDgEllipseElement3dCurvePE> OdDgEllipseElement3dCurvePEPtr;
