...
ODRX_DEFINE_DYNAMIC_MODULE(OdDgElementIntersectModule);

OdDgElementIntersectModule::OdDgElementIntersectModule()
{
}
...
void OdDgElementIntersectModule::initApp()
{
  if ( !OdDgElement::desc() )
  {
  ...
  OdDgGraphicsElement::desc()->addX( OdDgElementIntersectionPE::desc(), &_elmIntersectPE );
}

void OdDgElementIntersectModule::uninitApp()
{
  OdDgGraphicsElement::desc()->delX( OdDgElementIntersectionPE::desc() );
