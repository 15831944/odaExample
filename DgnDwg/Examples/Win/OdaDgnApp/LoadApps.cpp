...
//void CLoadApps::OnDrawItem(int nIDCtl, LPDRAWITEMSTRUCT lpDIS)
//{
//	if (nIDCtl == IDC_LOAD_APP) 
//	{
//		RECT rect;
...
//		const RECT rect0 = rect;
//		::FrameRect(lpDIS->hDC, &rect0, (HBRUSH)::GetStockObject(BLACK_BRUSH));
//	}
//}
