...
public class TeighaDGNJni {
   static {
    Log.i("JNI", "INFO: Loading libteigha_dgn_jni.so ");
        try {
            System.loadLibrary("teigha_dgn_jni");
            Log.i("JNI", "INFO: libteigha_dgn_jni.so is loaded");
        } catch (UnsatisfiedLinkError use1) {
            Log.e("JNI", "WARNING: Could not load libteigha_dgn_jni.so");
        }
    }
