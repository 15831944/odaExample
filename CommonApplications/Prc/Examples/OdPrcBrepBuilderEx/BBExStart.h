...
#ifndef BBEXSTART_INCLUDED
#define BBEXSTART_INCLUDED

enum BBCreationMode
{
#define ODPRCBBEXCASE(a, b, c, d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, d12, d13, d14) k##a,
#include "ExCases.h"
  kLastEx
#undef ODPRCBBEXCASE
};
