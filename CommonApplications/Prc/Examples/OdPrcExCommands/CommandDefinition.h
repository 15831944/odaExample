...
CMD_DEF (TESSDRAWMODE, L"Quasi variables")
CMD_DEF (BEHAVIORBITFIELDMODE, L"Quasi variables")


#define ODPRCCREATECASE(a, b, c, d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, d12, d13, d14) CMD_DEF( a , L"PRC create example")
