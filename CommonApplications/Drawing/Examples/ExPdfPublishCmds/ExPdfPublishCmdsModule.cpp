...
/************************************************************************/
/* ExPdfPublishCmdsModule.cpp: Defines the entry points for the DLL     */
/************************************************************************/
#include "OdaCommon.h"

#include "ExPdfPublishCmdsModule.h"
...
ODRX_DEFINE_DYNAMIC_MODULE(ExPdfPublishCmdsModule);


void ExPdfPublishCmdsModule::initApp()
{
...
void ExPdfPublishCmdsModule::uninitApp()
{
  OdEdCommandStackPtr pCommands = odedRegCmds();
#define CMD_DEF(CmdName, GroupName) \
